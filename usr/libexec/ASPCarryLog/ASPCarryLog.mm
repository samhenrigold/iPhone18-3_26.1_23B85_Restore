...
uint64_t Do_NVMeCTL_WL_Sweep()
{
  ...
  *(v17 + 12) = *(v5 + 28);
  ...
  else if (fwrite(v4, __size, 1uLL, v9))
  {
    v7 = 0;
  }
...
{
  v2 = a1;
  [NANDTelemetry_Base registerActivityWithIdentifier:"registerActivityWithIdentifier:XpcCriteria:ActivityQ:PersistentState:" XpcCriteria:"com.apple.nand.nandtelemetry_cadaily" ActivityQ:0 PersistentState:?];
  if (os_variant_has_internal_content())
  {
    v1 = xpc_dictionary_create(0, 0, 0);
    [NANDTelemetry_NandGBBSweepDaily setGBBXpcCritiria:v1];
    [(NANDTelemetry_Base *)NANDTelemetry_NandGBBSweepDaily registerActivityWithIdentifier:"com.apple.nand.automaticgbbsweep" XpcCriteria:v1 ActivityQ:v2 PersistentState:1];
  }
}

uint64_t iolog_hwlogger_to_legacy_format_conversion(FILE *a1, FILE *a2, int a3)
{
  v6 = malloc_type_malloc(0x8000uLL, 0x1000040451B5BE8uLL);
  v7 = malloc_type_malloc(0x80000uLL, 0x1000040451B5BE8uLL);
  v28 = v7;
  if (!v7)
  {
    v22 = 0;
  ...
  memset_pattern16(&v27, &unk_100094340, 0x400uLL);
  if (v6)
  {
    v24 = 0uLL;
    if (fread(&v24, 0x10uLL, 1uLL, a2) == 1 && (v24 & 0x3FFFF) == 0x5E)
    {
      ...
      __ptr = 262910;
      v30 = 24;
      fwrite(&__ptr, 0x10uLL, 1uLL, a1);
      v9 = fread(v6, 0x10uLL, 0x800uLL, a2);
      if (v9)
      {
        v10 = v9;
        while (1)
...
LABEL_15:
          ...
          while (v10);
          v17 = fread(v6, 0x10uLL, 0x800uLL, a2);
          v10 = v17;
          if (!v17)
          {
            v8 = v28;
      ...
      do
      {
        *(v25 + v20) = vbicq_s8(v21, vceqzq_s32(*(v25 + v20)));
        v20 += 16;
      }

      while (v20 != 72);
      sub_100001F4C(v25, a1);
      v8 = v28;
      v22 = 1;
      if (!v28)
      {
...
void sub_100001F4C(uint64_t a1, FILE *__stream)
{
  v2 = a1 + 40;
  v3 = *(a1 + 4);
  v4 = (a1 + 40 + 4 * v3);
...
BOOL iolog_is_from_hwlogger(FILE *a1)
{
  ...
  v3[1] = 0;
  fseek(a1, 0, 0);
  return fread(v3, 0x10uLL, 1uLL, a1) == 1 && (v3[0] & 0x3FFFF) == 0x5E && HIWORD(v3[0]) != 0;
}

void sub_1000020A0(unsigned int *a1, int *a2, FILE *__stream)
{
  v3 = *a2;
  if (*a2 >> 27 != 1)
  {
    ...
    *v38 = *(a2 + 7);
    ...
    if (v15 == 14)
    {
      v9 = (v16 << 8) & 0xFC0000 | (16 * (v16 & 0x3FF)) | (v38[0] << 24) | 0xE;
      LODWORD(v7) = *&v38[1];
      v10 = *&v38[5];
    }
    ...
    else
    {
      v17 = v15 & 0xF;
      LODWORD(v7) = *v38;
      HIDWORD(v18) = (v16 >> 8) & 0xF;
      LODWORD(v18) = *&v38[5];
      v19 = (v18 >> 8) & 0xBFFFFFFF | (((v16 >> 15) & 1) << 30);
      v20 = &a1[v16];
      v21 = v20[18];
      v12 = v20 + 18;
      v13 = v21;
      v22 = v17 == 3;
      v9 = v17 & 0xF8FFFFFF | (((v16 >> 12) & 7) << 24);
      if (!v22 || v13 >= 0x8000)
      {
        v10 = v8;
        LODWORD(v8) = v19;
...
LABEL_22:
  ...
  if (v5 != 15)
  {
    v6 = *(a2 + 6);
    v7 = *(a2 + 1);
    LODWORD(v8) = (BYTE5(v7) | (v6 << 23) & 0x40000000 | ((v6 & 0xF) << 24)) + 1;
    v9 = v5 & 0xF8FFFFFF | (((v6 >> 4) & 7) << 24);
    v10 = 16 * (v3 & 0x7FFFFFFu);
    v11 = &a1[*(a2 + 4)];
    v14 = v11[18];
    v12 = v11 + 18;
    LODWORD(v13) = v14;
LABEL_17:
    ...
    v24 = *(v23 + 16 * v13);
LABEL_21:
    *(v23 + 16 * v26) = v24 | 0xFFFFF0;
    v27 = *a1;
    --a1[(v13 >> 12) + 2];
    *v12 = v27;
    ++*(a1 + ((v27 >> 10) & 0x3FFFFC) + 8);
    goto LABEL_22;
  }
}

void sub_100002398(uint64_t a1, unsigned int a2, int a3, FILE *__stream)
{
  v4 = *(a1 + 72 + 4 * a2);
  if (!(v4 >> 15))
  {
    *(a1 + 72 + 4 * a2) = 0x8000;
    ...
    if ((*v5 & 0xF) != 0xE)
    {
      ...
      if (v7 > 16 * a3)
      {
        v8 = (16 * (a3 & 0x7FFFFFF)) | 0x80000000;
      }

      v9 = v8 - v7;
      if (v9 >> 23 <= 2)
      {
        v10 = ((2863311531u * v9) >> 32) & 0xFFFFF0;
      }
...
void sub_100002C58(char a1, int a2)
{
  if (a2)
  {
  ...
  v4[3] = &unk_10009C878;
  v5 = a1;
  SafeXpcActivityRegister("com.apple.nand.aspcarry_iolog", v3, qword_1000D8240, v4);
}
...
int main(int argc, const char **argv, const char **envp)
{
  ...
  v4 = os_log_create("com.apple.nand.aspcarry", "main");
  v5 = oslog;
  oslog = v4;
  ...
  v9 = dispatch_queue_create("com.apple.nand.aspcarry_xpc_activity_non_nand_serial_q", 0);
  v10 = qword_1000D8248;
  qword_1000D8248 = v9;
  ...
  sub_100002E64();
  checkInNandTelemetry_nandActivities(qword_1000D8240);
  checkInNandTelemetry_nonNandActivities(qword_1000D8248);
  dispatch_main();
}
...
void sub_100002E64()
{
  ...
  [Tasking startDpTaskingMonitorOnDispatchQ:qword_1000D8240 andWorkDir:@"/var/log/iolog_unsent"];
  SafeXpcActivityRegister("com.apple.nand.aspcarry_boot", 0, qword_1000D8240, &stru_10009C8B8);
  if ((os_variant_is_darwinos() & 1) == 0 && ASPCarryLog_isDiagnosticPipelineSupported())
  {
    SafeXpcActivityRegister("com.apple.nand.aspcarry_tasking", 0, qword_1000D8240, &stru_10009C8D8);
    v1 = objc_alloc_init(StateAccess);
    v2 = checkInternalBuild(v1);
    sub_100002C58(v2, 0);
  }
...
void sub_100002F28(void *a1, int a2)
{
  v3 = a1;
  v14 = 0u;
  v15 = 0u;
  v4 = objc_alloc_init(StateAccess);
  v5 = @"extract_upload";
  if (a2)
  {
    v5 = @"tasking";
  ...
  {
    v7 = [(StateAccess *)v4 getValueForKey:@"custom_xpc_settings" expectedType:2, v14, v15];
    v8 = [v7 valueForKey:v6];

    if (v8)
    {
      v9 = [v8 objectForKeyedSubscript:@"grace_period"];
      *&v14 = [v9 longLongValue];

      v10 = [v8 objectForKeyedSubscript:{@"delay", v14}];
      *(&v14 + 1) = [v10 longLongValue];

      v11 = [v8 objectForKeyedSubscript:@"interval"];
  ...
  v12 = XPC_ACTIVITY_INTERVAL_1_DAY;
  v13 = 900;
  if (!a2)
  {
    v13 = 600;
...
LABEL_10:
  ...
  ASPCarryLog_SetCriteria_RepeatingActivity(v3, &v14);
}

void sub_100003238(uint64_t a1, void *a2)
{
  v10 = a2;
  v3 = objc_autoreleasePoolPush();
  v4 = [ASPCarryLog_ExtractUpload alloc];
  v5 = objc_alloc_init(ASPCarryLog_NANDDriver);
  v6 = objc_alloc_init(ASPCarryLog_UploadDriver);
  v7 = objc_alloc_init(StateAccess);
  v8 = [(ASPCarryLog_ExtractUpload *)v4 initWithNandDriver:v5 UploadDriver:v6 StateManager:v7 workDirectory:@"/var/log/iolog_unsent" internalBuild:*(a1 + 32)];

  v9 = [[ASPCarryLog_XpcActivityMgr alloc] initWithXpcActivity:v10];
  [(ASPCarryLog_ExtractUpload *)v8 tryExtractUpload:v9];

  objc_autoreleasePoolPop(v3);
}

void sub_100003338(int a1)
{
  if (a1)
  {
    v1 = xpc_dictionary_create(0, 0, 0);
  ...
  SafeXpcActivityRegister("com.apple.nand.aspcarry_tasking", v1, qword_1000D8240, &stru_10009C8D8);
}

void sub_1000033B0(id a1, OS_xpc_object *a2)
{
  v2 = a2;
  if ((os_variant_is_darwinos() & 1) == 0 && ASPCarryLog_isDiagnosticPipelineSupported())
  {
    v3 = objc_autoreleasePoolPush();
    v4 = [[Tasking alloc] initWithWorkDir:@"/var/log/iolog_unsent"];
    v5 = objc_alloc_init(ASPCarryLog_NANDDriver);
    v6 = objc_alloc_init(ASPCarryLog_UploadDriver);
    [(Tasking *)v4 LoadTasking];
    v7 = [ASPCarryMainState alloc];
    v8 = objc_alloc_init(StateAccess);
    v9 = [(ASPCarryLogStateMachine *)v7 initWithStateManager:v8 TaskingManager:v4 NANDDriver:v5 UploadDriver:v6 WorkDirectory:@"/var/log/iolog_unsent"];
    ...
    {
      *v11 = 0;
      _os_log_impl(&_mh_execute_header, v10, OS_LOG_TYPE_DEFAULT, "ASPCarryLog daily xpc activity registered", v11, 2u);
    }
...
void sub_100003510(id a1, OS_xpc_object *a2)
{
  v2 = a2;
  v3 = objc_autoreleasePoolPush();
  v4 = [[Tasking alloc] initWithWorkDir:@"/var/log/iolog_unsent"];
  v5 = objc_alloc_init(ASPCarryLog_UploadDriver);
  v6 = objc_alloc_init(ASPCarryLog_NANDDriver);
  v7 = [[StatsMagezine alloc] initWithNandDriver:v6];
  [(Tasking *)v4 LoadTasking];
  v8 = [ASPCarryMainState alloc];
  v9 = objc_alloc_init(StateAccess);
  v10 = [(ASPCarryLogStateMachine *)v8 initWithStateManager:v9 TaskingManager:v4 NANDDriver:v6 UploadDriver:v5 WorkDirectory:@"/var/log/iolog_unsent"];
  ...
  if (a2)
  {
    if (a2 == 2)
    {
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
      {
        ...
        *(&buf + 4) = v51;
        _os_log_error_impl(&_mh_execute_header, v48, OS_LOG_TYPE_ERROR, "ERROR: compression failed with err %s.\n", &buf, 0xCu);
      }
...
id DateTimeToStr(void *a1)
{
  ...
  v5 = [NSTimeZone timeZoneWithName:@"UTC"];
  [v3 setTimeZone:v5];

  v6 = [v3 stringFromDate:v1];
...
BOOL diskFreeSpaceBelowLimit(unint64_t a1)
{
  ...
  if (v2)
  {
    v4 = [v2 objectForKeyedSubscript:kMGQDiskUsageTotalDataAvailable];
...
void sub_100007558(id a1)
{
  ...
  {
    v2 = v1;
    v3 = [[NSString alloc] initWithString:v1];
    v4 = qword_1000D8250;
    qword_1000D8250 = v3;
...
uint64_t ASPCarryLog_UploadFileToDP(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6)
{
  ...
  v28[2] = @"mobile";
  v18 = [NSDictionary dictionaryWithObjects:v28 forKeys:v27 count:3];
  [v17 setAttributes:v18 ofItemAtPath:v11 error:0];
...
void disableFileBackUp(void *a1)
{
  ...
  v9 = 0;
  v3 = [v2 setResourceValue:&__kCFBooleanTrue forKey:NSURLIsExcludedFromBackupKey error:&v9];
  v4 = v9;
  v5 = oslog;
  if (v3)
  {
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 136315138;
      v11 = v8;
      _os_log_impl(&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "Excluded %s from backup.", buf, 0xCu);
    }
  }
...
void ASPCarryLog_SetCriteria_RepeatingActivity(void *a1, uint64_t a2)
{
  ...
  xpc_dictionary_set_int64(xdict, XPC_ACTIVITY_DELAY, *(a2 + 8));
  ...
  xpc_dictionary_set_int64(xdict, XPC_ACTIVITY_INTERVAL, *(a2 + 16));
  xpc_dictionary_set_BOOL(xdict, XPC_ACTIVITY_ALLOW_BATTERY, *(a2 + 24));
}
      ...
      if (v6)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v11 = v7;
            if (stat([v7 fileSystemRepresentation], &v37))
            {
              v24 = [NSException exceptionWithName:@"InputFileStatError" reason:0 userInfo:0];
            ...
            {
              v23 = [NSException exceptionWithName:@"ArchiveWriteHeaderError" reason:0 userInfo:0];
              objc_exception_throw(v23);
            }

            v14 = v7;
            v15 = open([v7 fileSystemRepresentation], 0);
            v16 = v15;
            if (v15 < 0)
            {
LABEL_32:
              v22 = [NSException exceptionWithName:v8 reason:0 userInfo:0];
              objc_exception_throw(v22);
            }

            for (i = read(v15, v40, 0x2000uLL); i >= 1; i = read(v16, v40, 0x2000uLL))
            {
              if ((i & 0x7FFFFFFF) != archive_write_data())
              {
                v8 = @"ArchiveWriteError";
                goto LABEL_32;
              }
            }
    ...
    v25 = @"OpenDestFileError";
LABEL_37:
    v26 = [NSException exceptionWithName:v25 reason:0 userInfo:0];
  ...
  do
  {
    ...
    {
      header_position = archive_read_header_position();
      archive_read_free();
      lseek(v5, header_position, 0);
      goto LABEL_4;
    }
  }
...
id GetiCloudPlanSizeGB()
{
  if (objc_opt_class() && objc_opt_class())
  {
    ...
    {
      v2 = v1;
      v3 = [v1 aa_lastKnownQuota];
      v4 = +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", [v3 unsignedLongLongValue] >> 30);
    }
...
void SafeXpcActivityRegister(const char *a1, void *a2, void *a3, void *a4)
{
  ...
  handler[2] = sub_10000837C;
  handler[3] = &unk_10009C968;
  v11 = a2;
  v12 = a3;
  v13 = a4;
  v7 = v13;
...
void sub_10000837C(uint64_t a1, void *a2)
{
  v3 = a2;
  ...
  if (state == 2)
  {
    ...
    {
      if (!xpc_activity_set_state(v3, 3) && os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
      {
        sub_1000493D8();
      }
    }
...
void sub_100008584(uint64_t a1)
{
  v2 = (a1 + 32);
...
LABEL_14:
  ...
  if (!xpc_activity_set_state(*v2, 3))
  {
    ...
    if (os_log_type_enabled(oslog, OS_LOG_TYPE_ERROR))
    {
      sub_1000495A4(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
}
  ...
  if (a2 >> 3)
  {
    ...
    do
    {
      ...
      if (HIDWORD(v8))
      {
        ...
        {
          v5 = a1 + 2;
          v10 = [NSNumber numberWithUnsignedLongLong:a1[1]];
...
id sub_10000ADE4(uint64_t a1)
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "Sigterm was received, Stopping sweeps.", v4, 2u);
  }

  return [*(a1 + 32) setWasSigtermReceived:1];
}

uint64_t validateCurTaskingInfo(void *a1)
{
  v1 = a1;
  v2 = [v1 objectForKeyedSubscript:@"dsreply_pending"];
  v3 = [v1 objectForKeyedSubscript:@"endtime"];
  if (!v1)
  {
    goto LABEL_17;
  }

  v4 = [v1 objectForKeyedSubscript:@"id"];
  objc_opt_class();
  ...
  v5 = [v1 objectForKeyedSubscript:@"device_id"];
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
LABEL_10:
...
LABEL_11:
  ...
  v6 = [v1 objectForKeyedSubscript:@"upload_size_limit_bytes"];
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
...
uint64_t checkInternalBuild(void *a1)
{
  ...
  {
    v4 = [v1 getValueForKey:@"test_force_customer_build" expectedType:0];
    v3 = [v4 isEqualToString:@"yes"] ^ 1;
  }
...
void setTaskingInfoToLegacyUIDomain(void *a1, void *a2, void *a3, uint64_t a4, void *a5, int a6)
{
  if (a6)
  {
    ...
    v15 = [NSString stringWithFormat:@"Tasking id: %@\nEnd time: %@\nTotal uploaded bytes: %@\nLast upload file: %@\n", v12, v11, v14, v10];
...
uint64_t sub_10000E89C(uint64_t result, uint64_t a2)
{
  *(result + 40) = *(a2 + 40);
  *(a2 + 40) = 0;
  return result;
...
void sub_10000E8B4(uint64_t a1, void *a2)
{
  v3 = a2;
...
void sub_10000FF98(uint64_t a1)
{
  ...
  v3 = *(a1 + 32);
  v7 = *(a1 + 40);
  v4 = [v2 initWithTeamID:@"com.apple.coreos.nand" targetQueue:v3 configProcessingBlock:v6];
  v5 = qword_1000D82B0;
  qword_1000D82B0 = v4;

  [qword_1000D82B0 startMonitoring];
}

void sub_100010060(uint64_t a1, void *a2, void *a3)
{
  v5 = a2;
  v6 = a3;
  v7 = [*(a1 + 32) stringByAppendingPathComponent:@"dp_tasking_payload.plist"];
  ...
  v6 = [v5 payloadDictionaryRepresentation];
  ...
  if (os_log_type_enabled(oslog, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 136315138;
    v32 = [v7 UTF8String];
    _os_log_impl(&_mh_execute_header, v14, OS_LOG_TYPE_DEFAULT, "Got DP tasking payload. Dumping it to file %s", buf, 0xCu);
  }
  ...
  if ([v9 fileExistsAtPath:v7])
  {
    ...
    {
      *buf = 0;
      _os_log_impl(&_mh_execute_header, v15, OS_LOG_TYPE_DEFAULT, "Previous payload exists. Deleting...", buf, 2u);
    }

    [v9 removeItemAtPath:v7 error:0];
  }

  if ([v9 fileExistsAtPath:*(a1 + 32)])
  {
    v6 = 0;
LABEL_19:
    v29[0] = @"payload";
    v18 = [v5 payloadDictionaryRepresentation];
    v29[1] = @"expire_time";
    v30[0] = v18;
    v19 = [NSDate dateWithTimeIntervalSinceNow:432000.0];
    v30[1] = v19;
...
LABEL_20:
    ...
    {
      *buf = 0;
      _os_log_impl(&_mh_execute_header, v21, OS_LOG_TYPE_DEFAULT, "Marking DP tasking payload complete.", buf, 2u);
    }
...
LABEL_27:
  ...
  v16 = *(a1 + 32);
  v28 = 0;
  v17 = [v9 createDirectoryAtPath:v16 withIntermediateDirectories:0 attributes:0 error:&v28];
  v6 = v28;
  if (v17)
  {
    goto LABEL_19;
...
void sub_1000109D8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, __int128 a9)
{
  if (a2)
  {
    if (a2 == 2)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(&a9 + 4) = v12;
        _os_log_error_impl(&_mh_execute_header, v10, OS_LOG_TYPE_ERROR, "ERROR: get tasking duration error %s", &a9, 0xCu);
      }
    }
...
void sub_100010B34(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, __int128 a9)
{
  if (a2)
  {
    if (a2 == 2)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(a9) = 136315138;
        *(&a9 + 4) = v12;
        _os_log_error_impl(&_mh_execute_header, v10, OS_LOG_TYPE_ERROR, "ERROR: get tasking size limit error %s", &a9, 0xCu);
      }
    }
...
uint64_t sub_100011D7C(uint64_t a1, void *a2)
{
  v3 = a2;
  v13 = 0u;
  v14 = 0u;
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if (![*(a1 + 40) _elementPassesWhiteListCheck:v7 whiteListRef:*(a1 + 48) forCriteriaDict:{v3, v13}])
        {
          v11 = 0;
          goto LABEL_12;
        }
...
uint64_t sub_100012164(uint64_t a1, void *a2)
{
  v3 = a2;
  v13 = 0u;
  v14 = 0u;
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if (![*(a1 + 40) _elementExistsInStats:v7 statsProvider:*(a1 + 48) forCriteriaDict:{v3, v13}])
        {
          v11 = 0;
          goto LABEL_12;
        }
...
{
  v3 = a2;
  [*(a1 + 32) getCriteriaValueUsingStatsProvider:*(a1 + 40) forCriteriaDict:v3];
  v5 = v4;
  v6 = [v3 objectForKeyedSubscript:@"START_RANGE"];

  if (v6)
  {
    [*(a1 + 32) _getElementValue:*(a1 + 40) forElementName:@"START_RANGE" criteriaDict:v3];
    v8 = v5 >= v7;
  }
  ...
  v9 = [v3 objectForKeyedSubscript:@"END_RANGE"];

  if (v9)
  {
    [*(a1 + 32) _getElementValue:*(a1 + 40) forElementName:@"END_RANGE" criteriaDict:v3];
    if (v5 <= v10)
    {
      v8 = v8;
    }
  ...
  {
    v12 = v11;
    v13 = [v3 descriptionInStringsFileFormat];
    v15 = 136315394;
    v16 = [v13 UTF8String];
    v17 = 2048;
    v18 = v5;
    _os_log_impl(&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "criteriaDict %s value %.2f", &v15, 0x16u);
  }
...
const char *sub_100012818()
{
  if (qword_1000D82E8)
  {
    return qword_1000D82E8;
  }
...
LABEL_51:
                                                    sub_100019074(v16, v17, v15, v18, v19);
                                                    goto LABEL_79;
                                                  }
...
uint64_t sub_100019074(uint64_t result, int a2, const char *a3, uint64_t *a4, unsigned int a5)
{
  v7 = result;
  v8 = *a4;
  if (a2 > 44)
...
LABEL_59:
  if (a5 == 1)
  {
    ...
    return sub_10002E450(result, "", a3, v8);
  }
  ...
  else
  {
    ...
    do
    {
      ...
      __str[100] = 0;
      result = sub_10002E450(v7, a3, __str, a4[v13++]);
    }
...
double sub_100019338(uint64_t a1)
{
  v2 = *a1;
  if (v2)
  {
...
LABEL_2:
  ...
  {
    case 1:
      if (sub_10002E2CC(a1, "", "version", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 2:
      if (sub_10002E2CC(a1, "", "hostWriteXacts", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 3:
      if (sub_10002E2CC(a1, "", "hostReadXacts", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 4:
      if (sub_10002E2CC(a1, "", "hostWrites", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 5:
      if (sub_10002E2CC(a1, "", "hostWritesDyn", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 6:
      if (sub_10002E2CC(a1, "", "hostWritesStatic", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 7:
      if (sub_10002E2CC(a1, "", "hostReads", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 8:
      if (sub_10002E2CC(a1, "", "validLbas", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 9:
      if (sub_10002E2CC(a1, "", "shutdowns", *v8))
      {
        goto LABEL_162;
      }
    ...
    case 10:
      ...
      goto LABEL_161;
    case 11:
      if (sub_10002E2CC(a1, "", "uncleanBoots", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 12:
      if (sub_10002E2CC(a1, "", "IND_pool_free", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 13:
      if (sub_10002E2CC(a1, "", "IND_pool_count", *v8))
      {
        goto LABEL_162;
      }
    ...
    case 14:
      if (v14 != 10)
      {
        sub_100012748("ASPFTLParseBufferToCxt: hostWriteLogHisto(14): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
      }
      ...
      if (sub_100026C38(a1, "hostWriteLogHisto_", v8, 8u, v18))
      {
        goto LABEL_110;
      }
    ...
    case 15:
      if (v14 != 10)
      {
        sub_100012748("ASPFTLParseBufferToCxt: hostReadLogHisto(15): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
      }
      ...
      if (sub_100026C38(a1, "hostReadLogHisto_", v8, 8u, v18))
      {
        goto LABEL_110;
      }
      ...
      goto LABEL_2993;
    case 16:
      if (sub_10002E2CC(a1, "", "gcWrites", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 17:
      if (sub_10002E2CC(a1, "", "wearLevMoves", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 18:
      if (sub_10002E2CC(a1, "", "nandWrites", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 19:
      if (sub_10002E2CC(a1, "", "nandReads", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 20:
      if (sub_10002E2CC(a1, "", "bandErases", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 22:
      if (sub_10002E2CC(a1, "", "numPfail", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 23:
      if (sub_10002E2CC(a1, "", "numEfail", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 24:
      if (sub_10002E2CC(a1, "", "numPerformanceRefreshes", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 27:
      if (sub_10002E2CC(a1, "", "hostWritesMeta", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 28:
      if (sub_10002E2CC(a1, "", "numSleepOps", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 30:
      if (sub_10002E2CC(a1, "", "cntTimeWentBackWardOnBoot", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 31:
      if (sub_10002E2CC(a1, "", "cntTimeWentBackWard", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 34:
      if (sub_10002E2CC(a1, "", "powerOnHours", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 36:
      if (sub_10002E2CC(a1, "", "smartCritWarnings", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 37:
      if (sub_10002E2CC(a1, "", "numFlushes", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 38:
      if (sub_10002E2CC(a1, "", "numUnmap", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 39:
      if (sub_10002E2CC(a1, "", "numUnmapSec", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 41:
      if (sub_10002E2CC(a1, "", "clogProgram", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 42:
      if (sub_10002E2CC(a1, "", "clogPFail", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 43:
      if (sub_10002E2CC(a1, "", "clogRead", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 44:
      if (sub_10002E2CC(a1, "", "clogRFail", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 45:
      if (sub_10002E2CC(a1, "", "maxHighEnduranceBlockErases", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 46:
      if (sub_10002E2CC(a1, "", "numFactoryBad", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 47:
      if (sub_10002E2CC(a1, "", "numGrownBad", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 48:
      if (sub_10002E2CC(a1, "", "numFreeVirtualBlocks", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 49:
      if (sub_10002E2CC(a1, "", "bytesPerPage", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 50:
      if (sub_10002E2CC(a1, "", "pagesPerVirtualBlock", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 51:
      if (sub_10002E2CC(a1, "", "blocksPerVirtualBlock", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 52:
      if (sub_10002E2CC(a1, "", "numVirtualBlocks", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 53:
      if (sub_10002E2CC(a1, "", "exportVersion", *v8))
      {
        goto LABEL_162;
      }
    ...
    case 54:
      if (v14 != 100)
      {
        sub_100012748("ASPFTLParseBufferToCxt: ECBins(54): (#100) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
      }
      ...
      if (sub_100026C38(a1, "ECBins_", v8, 8u, v18))
      {
        goto LABEL_110;
      }
    ...
    case 55:
      if (v14 != 100)
      {
        sub_100012748("ASPFTLParseBufferToCxt: RCBins(55): (#100) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
      }
      ...
      if (sub_100026C38(a1, "RCBins_", v8, 8u, v18))
      {
        goto LABEL_110;
      }
      ...
      goto LABEL_2993;
    case 56:
      if (sub_10002E2CC(a1, "", "utilFormatTime", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 57:
      if (sub_10002E2CC(a1, "", "calendarTime", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 58:
      if (sub_10002E2CC(a1, "", "wallTime", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 59:
      if (sub_10002E2CC(a1, "", "cmdq_flush_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 60:
      if (sub_10002E2CC(a1, "", "cmdq_unmap_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 61:
      if (sub_10002E2CC(a1, "", "cmdq_pri0_r_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 62:
      if (sub_10002E2CC(a1, "", "cmdq_pri0_w_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 63:
      if (sub_10002E2CC(a1, "", "cmdq_pri1_r_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 64:
      if (sub_10002E2CC(a1, "", "cmdq_pri1_w_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 65:
      if (sub_10002E2CC(a1, "", "cmdq_pri2_r_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 66:
      if (sub_10002E2CC(a1, "", "cmdq_pri2_w_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 67:
      if (sub_10002E2CC(a1, "", "cmdq_pri3_r_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 68:
      if (sub_10002E2CC(a1, "", "cmdq_pri3_w_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 69:
      if (sub_10002E2CC(a1, "", "host_idle_ms", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 70:
      if (sub_10002E2CC(a1, "", "cmd_hysteresis_window_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 71:
      if (sub_10002E2CC(a1, "", "cmd_lowPriHoldoffDelay_us", *v8))
      {
        goto LABEL_162;
      }
      ...
      goto LABEL_161;
    case 72:
      if (sub_10002E2CC(a1, "", "cmd_lowPriHoldoffEnabled", *v8))
      {
        goto LABEL_162;
      }
    ...
    default:
      ...
      {
        case 73:
          if (sub_10002E2CC(a1, "", "cmd_expedite_num_success", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 75:
          if (sub_10002E2CC(a1, "", "cmd_expedite_num_failures", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 76:
          if (sub_10002E2CC(a1, "", "num_trimerase", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 77:
          if (sub_10002E2CC(a1, "", "staticSizeInMB", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 80:
          if (sub_10002E2CC(a1, "", "slcInvalidations", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 81:
          if (sub_10002E2CC(a1, "", "slcGCInvalidations", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 82:
          if (sub_10002E2CC(a1, "", "hostSectorsDuringGCon", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 83:
          if (sub_10002E2CC(a1, "", "highWaterMarkSLCUsed", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 84:
          if (sub_10002E2CC(a1, "", "intermediateBandErases", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 85:
          if (sub_10002E2CC(a1, "", "intermediatePartitionStart", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 86:
          if (sub_10002E2CC(a1, "", "userPartitionStart", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 87:
          if (sub_10002E2CC(a1, "", "iolog_lbas", *v8))
          {
            goto LABEL_162;
          }
        ...
        case 88:
          if (v14 != 10)
          {
            sub_100012748("ASPFTLParseBufferToCxt: bandsAgeBins(88): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "bandsAgeBins_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 89:
          if (v14 != 10)
          {
            sub_100012748("ASPFTLParseBufferToCxt: intermediateBandsAgeBins(89): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "intermediateBandsAgeBins_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 90:
          if (v14 != 160)
          {
            sub_100012748("ASPFTLParseBufferToCxt: qosPerCmdQ(90): (#160) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "qosPerCmdQ_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 91:
          if (v14 != 10)
          {
            sub_100012748("ASPFTLParseBufferToCxt: maxQosPerCmdQ(91): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "maxQosPerCmdQ_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
          ...
          goto LABEL_2993;
        case 92:
          if (sub_10002E2CC(a1, "", "shutdownDuringGC", *v8))
          {
            goto LABEL_162;
          }
        ...
        case 93:
          if (v14 != 3)
          {
            sub_100012748("ASPFTLParseBufferToCxt: numBandsRefreshedForAgePerTier(93): (#3) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "numBandsRefreshedForAgePerTier_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 94:
          if (v14 != 20)
          {
            sub_100012748("ASPFTLParseBufferToCxt: bdrDeltaHot(94): (#20) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "bdrDeltaHot_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
          ...
          goto LABEL_2993;
        case 95:
          if (sub_10002E2CC(a1, "", "numRefreshOnClockLoss", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 96:
          if (sub_10002E2CC(a1, "", "numRefreshOnErrNandRefreshRel", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 97:
          if (sub_10002E2CC(a1, "", "numBGRefreshMoves", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 98:
          if (sub_10002E2CC(a1, "", "numBGPaddingMoves", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 99:
          if (sub_10002E2CC(a1, "", "hostWritesPhoto", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 100:
          if (sub_10002E2CC(a1, "", "INDPooldFree", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 101:
          if (sub_10002E2CC(a1, "", "INDContigCount", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 102:
          if (sub_10002E2CC(a1, "", "INDValidContigCount", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 103:
          if (sub_10002E2CC(a1, "", "INDMinContigSize", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 104:
          if (sub_10002E2CC(a1, "", "INDMaxContigSize", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 105:
          if (sub_10002E2CC(a1, "", "INDAveContigSize", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 106:
          if (sub_10002E2CC(a1, "", "INDpoolSize", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 107:
          if (sub_10002E2CC(a1, "", "pushSyncWrites", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 109:
          if (sub_10002E2CC(a1, "", "cmd_rw_hysteresis_us", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 110:
          if (sub_10002E2CC(a1, "", "photoFlowMode", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 112:
          if (sub_10002E2CC(a1, "", "numBandsPaddedForAge", *v8))
          {
            goto LABEL_162;
          }
        ...
        case 113:
          if (v14 != 4)
          {
            sub_100012748("ASPFTLParseBufferToCxt: bandsPerHostFlow(113): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "bandsPerHostFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 114:
          if (v14 != 5)
          {
            sub_100012748("ASPFTLParseBufferToCxt: bandsPerSpecialFlow(114): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "bandsPerSpecialFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 115:
          if (v14 != 4)
          {
            sub_100012748("ASPFTLParseBufferToCxt: secsPerHostFlow(115): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "secsPerHostFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 116:
          if (v14 != 5)
          {
            sub_100012748("ASPFTLParseBufferToCxt: secsPerSpecialFlow(116): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "secsPerSpecialFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 118:
          if (v14 != 4)
          {
            sub_100012748("ASPFTLParseBufferToCxt: overWritesPerHostFlow(118): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "overWritesPerHostFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 119:
          if (v14 != 5)
          {
            sub_100012748("ASPFTLParseBufferToCxt: overWritesPerSpecialFlow(119): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "overWritesPerSpecialFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 120:
          if (v14 != 10)
          {
            sub_100012748("ASPFTLParseBufferToCxt: padSectorsPerFlow(120): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "padSectorsPerFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 121:
          if (v14 != 4)
          {
            sub_100012748("ASPFTLParseBufferToCxt: padSizes(121): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "padSizes_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 122:
          if (v14 != 4)
          {
            sub_100012748("ASPFTLParseBufferToCxt: unmapsPerHostFlow(122): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "unmapsPerHostFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 123:
          if (v14 != 5)
          {
            sub_100012748("ASPFTLParseBufferToCxt: unmapsPerSpecialFlow(123): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "unmapsPerSpecialFlow_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 124:
          if (v14 != 2)
          {
            sub_100012748("ASPFTLParseBufferToCxt: coldestCycle(124): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "coldestCycle_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
        ...
        case 125:
          if (v14 != 2)
          {
            sub_100012748("ASPFTLParseBufferToCxt: hottestCycle(125): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "hottestCycle_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
          ...
          goto LABEL_2993;
        case 126:
          if (sub_10002E2CC(a1, "", "gcLonlyWrites", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 127:
          if (sub_10002E2CC(a1, "", "gcPLWrites", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 129:
          if (sub_10002E2CC(a1, "", "pagesPerVirtualBlockSlc", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 130:
          if (sub_10002E2CC(a1, "", "bdrPadding", *v8))
          {
            goto LABEL_162;
          }
        ...
        case 131:
          if (v14 != 8)
          {
            sub_100012748("ASPFTLParseBufferToCxt: errInjCounters(131): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
          }
          ...
          if (sub_100026C38(a1, "errInjCounters_", v8, 8u, v18))
          {
            goto LABEL_110;
          }
          ...
          goto LABEL_2993;
        case 132:
          if (sub_10002E2CC(a1, "", "raidSuccessfulReconstructionInternal", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 133:
          if (sub_10002E2CC(a1, "", "raidSuccessfulReconstructionHost", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 134:
          if (sub_10002E2CC(a1, "", "raidFailedReconstructionInternal", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 135:
          if (sub_10002E2CC(a1, "", "raidFailedReconstructionHost", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 136:
          if (sub_10002E2CC(a1, "", "raidBandsPerHostFlow", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 137:
          if (sub_10002E2CC(a1, "", "raidSecsPerHostFlow", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 138:
          if (sub_10002E2CC(a1, "", "gcFreeL", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 139:
          if (sub_10002E2CC(a1, "", "gcDestinations", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 140:
          if (sub_10002E2CC(a1, "", "gcFragments", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 141:
          if (sub_10002E2CC(a1, "", "numMemChoke", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 142:
          if (sub_10002E2CC(a1, "", "maxMemChokeDuration", *v8))
          {
            goto LABEL_162;
          }
          ...
          goto LABEL_161;
        case 143:
          if (sub_10002E2CC(a1, "", "memChokeDuration", *v8))
          {
            goto LABEL_162;
          }
        ...
        default:
          ...
          {
            case 144:
              if (sub_10002E2CC(a1, "", "numMemExtreme", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 145:
              if (sub_10002E2CC(a1, "", "maxMemExtremeDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 146:
              if (sub_10002E2CC(a1, "", "memExtremeDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 147:
              if (sub_10002E2CC(a1, "", "bandGetsExtreme", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 148:
              if (sub_10002E2CC(a1, "", "bandGetsLow", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 149:
              if (sub_10002E2CC(a1, "", "numHostChoke", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 152:
              if (sub_10002E2CC(a1, "", "AbortSkip_ProgramError", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 153:
              if (sub_10002E2CC(a1, "", "AbortSkip_ReadErrorOpenBand", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 154:
              if (sub_10002E2CC(a1, "", "AbortSkip_FailedRebuildingParity", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 155:
              if (sub_10002E2CC(a1, "", "AbortPad_OpenRefreshBand", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 156:
              if (sub_10002E2CC(a1, "", "AbortPad_CloseBands", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 157:
              if (sub_10002E2CC(a1, "", "AbortPad_SetPhoto", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 158:
              if (sub_10002E2CC(a1, "", "AbortPad_GcNoSource", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 159:
              if (sub_10002E2CC(a1, "", "AbortPad_Format", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 160:
              if (sub_10002E2CC(a1, "", "nandDiscoveryDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 161:
              if (sub_10002E2CC(a1, "", "coreCCEnableDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 163:
              if (sub_10002E2CC(a1, "", "coreOpenDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 164:
              if (sub_10002E2CC(a1, "", "coreWritableDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 165:
              if (sub_10002E2CC(a1, "", "coreClogLoadDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 167:
              if (sub_10002E2CC(a1, "", "bulkPFail", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 169:
              if (sub_10002E2CC(a1, "", "bulkRFail", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 172:
              if (sub_10002E2CC(a1, "", "raidSmartErrors", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 182:
              if (sub_10002E2CC(a1, "", "internalUeccs", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 183:
              if (sub_10002E2CC(a1, "", "e2eFail", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 184:
              if (sub_10002E2CC(a1, "", "TempSensorMax", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 185:
              if (sub_10002E2CC(a1, "", "TempSensorMin", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 186:
              if (sub_10002E2CC(a1, "", "powerUpFromDDR", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 187:
              if (sub_10002E2CC(a1, "", "numMemLow", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 188:
              if (sub_10002E2CC(a1, "", "maxMemLowDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 189:
              if (sub_10002E2CC(a1, "", "memLowDuration", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 190:
              if (sub_10002E2CC(a1, "", "numFences", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 191:
              if (sub_10002E2CC(a1, "", "hostPassiveIO", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 192:
              if (sub_10002E2CC(a1, "", "odtsMax", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 193:
              if (sub_10002E2CC(a1, "", "defragMFromOrphans", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 194:
              if (sub_10002E2CC(a1, "", "defragMFromFragments", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 195:
              if (sub_10002E2CC(a1, "", "defragMTime", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 196:
              if (sub_10002E2CC(a1, "", "defragMMaxTime", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 197:
              if (sub_10002E2CC(a1, "", "raidFailedLbaMismatch", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 198:
              if (sub_10002E2CC(a1, "", "numSyscfgWrites", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 199:
              if (sub_10002E2CC(a1, "", "indmbUnitsXfer", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 200:
              if (sub_10002E2CC(a1, "", "indmbUnitsCache", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 201:
              if (sub_10002E2CC(a1, "", "indmbUnitsInd", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 202:
              if (sub_10002E2CC(a1, "", "wcacheFS_Mbytes", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 203:
              if (sub_10002E2CC(a1, "", "wcacheDS_Mbytes", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 204:
              if (sub_10002E2CC(a1, "", "powerOnSeconds", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 205:
              if (sub_10002E2CC(a1, "", "numUnknownTokenHostRead", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 206:
              if (sub_10002E2CC(a1, "", "numUnmmapedTokenHostRead", *v8))
              {
                goto LABEL_162;
              }
            ...
            case 207:
              if (v14 != 25)
              {
                sub_100012748("ASPFTLParseBufferToCxt: numOfThrottlingEntriesPerLevel(207): (#25) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
              }
              ...
              if (sub_100026C38(a1, "numOfThrottlingEntriesPerLevel_", v8, 8u, v18))
              {
                goto LABEL_110;
              }
              ...
              goto LABEL_2993;
            case 208:
              if (sub_10002E2CC(a1, "", "wcacheFS_MbytesMin", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 209:
              if (sub_10002E2CC(a1, "", "wcacheFS_MbytesMax", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 210:
              if (sub_10002E2CC(a1, "", "prepareForShutdownFailCounter", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 211:
              if (sub_10002E2CC(a1, "", "lpsrEntry", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 212:
              if (sub_10002E2CC(a1, "", "lpsrExit", *v8))
              {
                goto LABEL_162;
              }
            ...
            case 213:
              if (v14 != 8)
              {
                sub_100012748("ASPFTLParseBufferToCxt: crcInternalReadFail(213): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
              }
              ...
              if (sub_100026C38(a1, "crcInternalReadFail_", v8, 8u, v18))
              {
                goto LABEL_110;
              }
              ...
              goto LABEL_2993;
            case 214:
              if (sub_10002E2CC(a1, "", "wcacheFSEvictCnt", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 215:
              if (sub_10002E2CC(a1, "", "wcacheFSEvictSize", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 216:
              if (sub_10002E2CC(a1, "", "wcacheFSWr", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 217:
              if (sub_10002E2CC(a1, "", "wcacheDSWr", *v8))
              {
                goto LABEL_162;
              }
            ...
            case 218:
              if (v14 != 10)
              {
                sub_100012748("ASPFTLParseBufferToCxt: wcacheFSEvictSizeLogDist(218): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
              }
              ...
              if (sub_100026C38(a1, "wcacheFSEvictSizeLogDist_", v8, 8u, v18))
              {
                goto LABEL_110;
              }
              ...
              goto LABEL_2993;
            case 219:
              if (sub_10002E2CC(a1, "", "prepareForShutdownTimeoutCounter", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 220:
              if (sub_10002E2CC(a1, "", "prepareForShutdownCancelCounter", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 221:
              if (sub_10002E2CC(a1, "", "RD_openBandCount", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 222:
              if (sub_10002E2CC(a1, "", "RD_openBandNops", *v8))
              {
                goto LABEL_162;
              }
              ...
              goto LABEL_161;
            case 223:
              if (sub_10002E2CC(a1, "", "RD_closedBandEvictCount", *v8))
              {
                goto LABEL_162;
              }
            ...
            default:
              ...
              {
                case 224:
                  if (sub_10002E2CC(a1, "", "RD_closedBandEvictSectors", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 225:
                  if (sub_10002E2CC(a1, "", "RD_closedBandFragmentCount", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 226:
                  if (sub_10002E2CC(a1, "", "RD_closedBandFragmentSectors", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 227:
                  if (v14 != 10)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: wcacheFSOverWrLogSizeCnts(227): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "wcacheFSOverWrLogSizeCnts_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 228:
                  if (v14 != 4)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: wcacheFSOverWrSizeByFlow(228): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "wcacheFSOverWrSizeByFlow_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 229:
                  if (v14 != 2)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: indmbXferCountTo(229): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "indmbXferCountTo_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 230:
                  if (v14 != 2)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: indmbAccumulatedTimeBetweenXfers(230): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "indmbAccumulatedTimeBetweenXfers_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 231:
                  if (sub_10002E2CC(a1, "", "maxGracefulBootTimeMs", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 232:
                  if (sub_10002E2CC(a1, "", "maxUngracefulBootTimeMs", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 233:
                  if (sub_10002E2CC(a1, "", "averageGracefulBootTimeMs", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 234:
                  if (sub_10002E2CC(a1, "", "averageUngracefulBootTimeMs", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 235:
                  if (v14 != 8)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: gracefulBootTimeLogMs(235): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "gracefulBootTimeLogMs_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 236:
                  if (v14 != 8)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: ungracefulBootTimeLogMs(236): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "ungracefulBootTimeLogMs_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 237:
                  if (v14 != 4)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: CalibrationCount(237): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "CalibrationCount_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 238:
                  if (sub_10002E2CC(a1, "", "CalibrationLastTmp", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 239:
                  if (sub_10002E2CC(a1, "", "CalibrationMaxTmp", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 240:
                  if (sub_10002E2CC(a1, "", "CalibrationMinTmp", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 241:
                  if (sub_10002E2CC(a1, "", "ungracefulBootWorstIndicator", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 242:
                  if (sub_10002E2CC(a1, "", "metaMismatchReread", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 243:
                  if (sub_10002E2CC(a1, "", "numS3SleepOps", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 244:
                  if (sub_10002E2CC(a1, "", "odtsCurrent", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 245:
                  if (sub_10002E2CC(a1, "", "prefetchReads", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 246:
                  if (sub_10002E2CC(a1, "", "prefetchHits", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 247:
                  if (sub_10002E2CC(a1, "", "prefetchWritesInvalidation", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 248:
                  if (sub_10002E2CC(a1, "", "indmbUnitsTotal", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 249:
                  if (sub_10002E2CC(a1, "", "selfThrottlingEngage", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 250:
                  if (sub_10002E2CC(a1, "", "selfThrottlingDisengage", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 252:
                  if (sub_10002E2CC(a1, "", "AbortSkip_WlpMode", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 253:
                  if (sub_10002E2CC(a1, "", "hostWritesWlpMode", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 254:
                  if (sub_10002E2CC(a1, "", "numClogDoubleUnc", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 256:
                  if (sub_10002E2CC(a1, "", "AbortPad_WlpMode", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 257:
                  if (sub_10002E2CC(a1, "", "bonfireIntermediateBandErases", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 258:
                  if (sub_10002E2CC(a1, "", "bonfireUserBandErases", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 259:
                  if (sub_10002E2CC(a1, "", "bonfireIntermediateBandProgs", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 260:
                  if (sub_10002E2CC(a1, "", "bonfireUserBandProgs", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 261:
                  if (sub_10002E2CC(a1, "", "bonfireIntermediatePageReads", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 262:
                  if (sub_10002E2CC(a1, "", "bonfireUserPageReads", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 263:
                  if (sub_10002E2CC(a1, "", "refreshUtil00", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 264:
                  if (sub_10002E2CC(a1, "", "failToReadUtil00", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 265:
                  if (v14 != 5)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: readCountHisto(265): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "readCountHisto_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 266:
                  if (v14 != 16)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: readAmpHisto(266): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "readAmpHisto_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 267:
                  if (sub_10002E2CC(a1, "", "totalReadAmp", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 268:
                  if (v14 != 4)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: nvmeModeSelect(268): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "nvmeModeSelect_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 269:
                  if (v14 != 8)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: numBootBlockRefreshSuccess(269): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "numBootBlockRefreshSuccess_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 270:
                  if (v14 != 8)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: numBootBlockRefreshFail(270): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "numBootBlockRefreshFail_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 271:
                  if (sub_10002E2CC(a1, "", "numUnsupportedAsi", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 272:
                  if (sub_10002E2CC(a1, "", "NumTerminatedProgramSegs", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 273:
                  if (sub_10002E2CC(a1, "", "indParityPagesDrops", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 274:
                  if (sub_10002E2CC(a1, "", "indFlowPrograms", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 277:
                  if (v14 != 4)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: powerBudgetSelect(277): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "powerBudgetSelect_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 279:
                  if (sub_10002E2CC(a1, "", "RxBurnNandWrites", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 280:
                  if (v14 != 12)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: E2EDPErrorCounters(280): (#12) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "E2EDPErrorCounters_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 281:
                  if (sub_10002E2CC(a1, "", "wcacheSectorsMax", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 282:
                  if (sub_10002E2CC(a1, "", "wcacheSectorsMin", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 283:
                  if (sub_10002E2CC(a1, "", "wcacheSectorsCur", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 284:
                  if (sub_10002E2CC(a1, "", "wcacheDS_SectorsMax", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 285:
                  if (sub_10002E2CC(a1, "", "wcacheDS_SectorsMin", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 286:
                  if (sub_10002E2CC(a1, "", "wcacheDS_SectorsCur", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 287:
                  if (sub_10002E2CC(a1, "", "wcacheFS_Reads", *v8))
                  {
                    goto LABEL_162;
                  }
                  ...
                  goto LABEL_161;
                case 288:
                  if (sub_10002E2CC(a1, "", "wcacheDS_Reads", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                case 289:
                  if (v14 != 32)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: mspBootBlockReadFail(289): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "mspBootBlockReadFail_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 290:
                  if (v14 != 32)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: mspBootBlockProgFail(290): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "mspBootBlockProgFail_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                ...
                case 291:
                  if (v14 != 32)
                  {
                    sub_100012748("ASPFTLParseBufferToCxt: mspBootBlockEraseFail(291): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                  }
                  ...
                  if (sub_100026C38(a1, "mspBootBlockEraseFail_", v8, 8u, v18))
                  {
                    goto LABEL_110;
                  }
                  ...
                  goto LABEL_2993;
                case 292:
                  if (sub_10002E2CC(a1, "", "bandsRefreshedOnError", *v8))
                  {
                    goto LABEL_162;
                  }
                ...
                default:
                  switch(v12)
                  {
                    case 298:
                      if (v14 != 2)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: perHostReads(298): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "perHostReads_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 299:
                      if (v14 != 2)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: perHostReadXacts(299): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "perHostReadXacts_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 300:
                      if (v14 != 2)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: perHostWrites(300): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "perHostWrites_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 301:
                      if (v14 != 2)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: perHostWriteXacts(301): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "perHostWriteXacts_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 302:
                      if (v14 != 2)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: perHostNumFlushes(302): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "perHostNumFlushes_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 303:
                      if (v14 != 2)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: perHostNumFences(303): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "perHostNumFences_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 304:
                      if (v14 != 10)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: commitPadSectorsPerFlow(304): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "commitPadSectorsPerFlow_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 305:
                      if (v14 != 10)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: wcacheDSOverWrLogSizeCnts(305): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "wcacheDSOverWrLogSizeCnts_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 306:
                      if (v14 != 4)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: wcacheDSOverWrSizeByFlow(306): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "wcacheDSOverWrSizeByFlow_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 307:
                      if (v14 != 10)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: CmdRaisePrioiryEvents(307): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "CmdRaisePrioiryEvents_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                      ...
                      goto LABEL_2993;
                    case 308:
                      if (sub_10002E2CC(a1, "", "utilNumVerification", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 309:
                      if (sub_10002E2CC(a1, "", "utilRefreshes", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 310:
                      if (sub_10002E2CC(a1, "", "utilBDRErrors", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 311:
                      if (sub_10002E2CC(a1, "", "indBandsPerFlow", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 312:
                      if (sub_10002E2CC(a1, "", "secsPerIndFlow", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 313:
                      if (sub_10002E2CC(a1, "", "indDecodedECC", *v8))
                      {
                        goto LABEL_162;
                      }
                    ...
                    case 314:
                      if (v14 != 8)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: numBootBlockValidateSuccess(314): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "numBootBlockValidateSuccess_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 315:
                      if (v14 != 8)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: numBootBlockValidateFail(315): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "numBootBlockValidateFail_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 316:
                      if (v14 != 4)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: clogPagesFillingPercentage(316): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "clogPagesFillingPercentage_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                      ...
                      goto LABEL_2993;
                    case 317:
                      if (sub_10002E2CC(a1, "", "bdrCalTimeAccFactor", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 318:
                      if (sub_10002E2CC(a1, "", "bootChainRdError", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 319:
                      if (sub_10002E2CC(a1, "", "bootChainBlankError", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 320:
                      if (sub_10002E2CC(a1, "", "bootChainRefreshError", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 321:
                      if (sub_10002E2CC(a1, "", "bootChainVersionError", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 322:
                      if (sub_10002E2CC(a1, "", "mspBootBlockMismatch", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 323:
                      if (sub_10002E2CC(a1, "", "mspBootBlockMismatchErr", *v8))
                      {
                        goto LABEL_162;
                      }
                    ...
                    case 324:
                      if (v14 != 5)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bitflipAddr(324): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bitflipAddr_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 325:
                      if (v14 != 5)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bitflipCount(325): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bitflipCount_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 326:
                      if (v14 != 5)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bitflipDupes(326): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bitflipDupes_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 327:
                      if (v14 != 30)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bandsMaxTempHisto(327): (#30) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bandsMaxTempHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 328:
                      if (v14 != 30)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bandsMinTempHisto(328): (#30) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bandsMinTempHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 329:
                      if (v14 != 30)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bandsLifeTimeTempHisto(329): (#30) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bandsLifeTimeTempHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 330:
                      if (v14 != 22)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bandsDeltaTempHisto(330): (#22) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bandsDeltaTempHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 331:
                      if (v14 != 45)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: bandsCrossTempHisto(331): (#45) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "bandsCrossTempHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 332:
                      if (v14 != 10)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: wcacheWaitLogMs(332): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "wcacheWaitLogMs_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 333:
                      if (v14 != 10)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: wcacheDS_segsSortedLogSize(333): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "wcacheDS_segsSortedLogSize_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                      ...
                      goto LABEL_2993;
                    case 334:
                      if (sub_10002E2CC(a1, "", "numFirmwareWrites", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 335:
                      if (sub_10002E2CC(a1, "", "numBisWrites", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 336:
                      if (sub_10002E2CC(a1, "", "numBootChainUpdates", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 337:
                      if (sub_10002E2CC(a1, "", "cntCalTimeWentBackWard", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 338:
                      if (sub_10002E2CC(a1, "", "indBoRecoveries", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 340:
                      if (sub_10002E2CC(a1, "", "numCrossTempUecc", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 341:
                      if (sub_10002E2CC(a1, "", "latencyMonitorError", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 343:
                      if (sub_10002E2CC(a1, "", "utilUeccReads", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 344:
                      if (sub_10002E2CC(a1, "", "numOfAvoidedGCDueToTemp", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 345:
                      if (sub_10002E2CC(a1, "", "forceShutdowns", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 346:
                      if (sub_10002E2CC(a1, "", "gcSlcDestinations", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 347:
                      if (sub_10002E2CC(a1, "", "indReplayExtUsed", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 348:
                      if (sub_10002E2CC(a1, "", "defectsPerPackageOverflow", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 349:
                      if (sub_10002E2CC(a1, "", "RxBurnIntBandsProgrammed", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 350:
                      if (sub_10002E2CC(a1, "", "RxBurnUsrBandsProgrammed", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 351:
                      if (sub_10002E2CC(a1, "", "RxBurnIntNandWrites", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 352:
                      if (sub_10002E2CC(a1, "", "RxBurnUsrNandWrites", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 353:
                      if (sub_10002E2CC(a1, "", "clogLastStripeUeccs", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 354:
                      if (sub_10002E2CC(a1, "", "GC_MidDestSrcSwitchSLC2TLC", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 355:
                      if (sub_10002E2CC(a1, "", "GC_MidDestSrcSwitchTLC2SLC", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 356:
                      if (sub_10002E2CC(a1, "", "nvme_stats_shutdown_count_host0_normal", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 357:
                      if (sub_10002E2CC(a1, "", "nvme_stats_shutdown_count_host1_normal", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 358:
                      if (sub_10002E2CC(a1, "", "nvme_stats_shutdown_count_host0_s2r", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 359:
                      if (sub_10002E2CC(a1, "", "nvme_stats_shutdown_count_host1_s2r", *v8))
                      {
                        goto LABEL_162;
                      }
                    ...
                    case 360:
                      if (v14 != 16)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: gcPDusterIntrSrcValidityHisto(360): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "gcPDusterIntrSrcValidityHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                    ...
                    case 361:
                      if (v14 != 16)
                      {
                        sub_100012748("ASPFTLParseBufferToCxt: gcPDusterUserSrcValidityHisto(361): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                      }
                      ...
                      if (sub_100026C38(a1, "gcPDusterUserSrcValidityHisto_", v8, 8u, v18))
                      {
                        goto LABEL_110;
                      }
                      ...
                      goto LABEL_2993;
                    case 362:
                      if (sub_10002E2CC(a1, "", "raidFailedReadParity", *v8))
                      {
                        goto LABEL_162;
                      }
                      ...
                      goto LABEL_161;
                    case 364:
                      if (sub_10002E2CC(a1, "", "lhotNumSkipes", *v8))
                      {
                        goto LABEL_162;
                      }
                    ...
                    default:
                      ...
                      {
                        case 365:
                          if (sub_10002E2CC(a1, "", "lhotNumIsHotCalls", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 366:
                          if (sub_10002E2CC(a1, "", "lhotFullLap", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 367:
                          if (sub_10002E2CC(a1, "", "lhotSkipPrecent", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 368:
                          if (sub_10002E2CC(a1, "", "eraseSuspendEvents", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 369:
                          if (sub_10002E2CC(a1, "", "eraseSuspendedStatuses", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 370:
                          if (sub_10002E2CC(a1, "", "eraseSuspendedBands", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 371:
                          if (sub_10002E2CC(a1, "", "eraseSuspendSituationsBelowThreshold", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 372:
                          if (sub_10002E2CC(a1, "", "eraseSuspendSituationsAboveThreshold", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 373:
                          if (sub_10002E2CC(a1, "", "eraseSuspendReadChainsProcessed", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 374:
                          if (sub_10002E2CC(a1, "", "bdrLastDoneHr", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 375:
                          if (sub_10002E2CC(a1, "", "bdrBackupThreshHrs", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 376:
                          if (sub_10002E2CC(a1, "", "clogPortableProgBufs", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 377:
                          if (sub_10002E2CC(a1, "", "clogPortableDropBufs", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 378:
                          if (sub_10002E2CC(a1, "", "clogPortablePadSectors", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 379:
                          if (sub_10002E2CC(a1, "", "numRetiredBlocks", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 381:
                          if (sub_10002E2CC(a1, "", "numRefreshOnErrNandRefreshPerf", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 382:
                          if (sub_10002E2CC(a1, "", "raidReconstructReads", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 383:
                          if (sub_10002E2CC(a1, "", "gcReadsNoBlog", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 384:
                          if (sub_10002E2CC(a1, "", "AbortSkip_MPBXReadVerifyClosedBand", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 385:
                          if (sub_10002E2CC(a1, "", "openBandReadFail", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 386:
                          if (sub_10002E2CC(a1, "", "AbortSkip_MPBXReadVerifyOpenBand", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 387:
                          if (sub_10002E2CC(a1, "", "AbortSkip_MBPXFailedRebuildingParity", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 388:
                          if (sub_10002E2CC(a1, "", "raidSuccessfulPMXReconstructionInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 389:
                          if (sub_10002E2CC(a1, "", "raidSuccessfulPMXReconstructionHost", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 390:
                          if (sub_10002E2CC(a1, "", "raidFailedPMXReconstructionInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 391:
                          if (sub_10002E2CC(a1, "", "raidFailedPMXReconstructionHost", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 392:
                          if (sub_10002E2CC(a1, "", "raidSuccessfulRMXReconstructionInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 393:
                          if (sub_10002E2CC(a1, "", "raidSuccessfulRMXReconstructionHost", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 394:
                          if (sub_10002E2CC(a1, "", "raidFailedRMXReconstructionInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 395:
                          if (sub_10002E2CC(a1, "", "raidFailedRMXReconstructionHost", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 396:
                          if (sub_10002E2CC(a1, "", "raidFailedReadParityInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 397:
                          if (sub_10002E2CC(a1, "", "raidFailedReadQParityInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 398:
                          if (sub_10002E2CC(a1, "", "raidFailedReadQParity", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 399:
                          if (sub_10002E2CC(a1, "", "raidFailedReadQCopy", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 400:
                          if (sub_10002E2CC(a1, "", "raidFailedReconstructionQParity", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 401:
                          if (sub_10002E2CC(a1, "", "offlineBlocksCnt", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 402:
                          if (sub_10002E2CC(a1, "", "bork0Revectors", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 403:
                          if (sub_10002E2CC(a1, "", "raidFailedReadBlog", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 404:
                          if (sub_10002E2CC(a1, "", "numReliabilityRefreshes", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 405:
                          if (sub_10002E2CC(a1, "", "raidFailedReadQCopyInternal", *v8))
                          {
                            goto LABEL_162;
                          }
                        ...
                        case 406:
                          if (v14 != 5)
                          {
                            sub_100012748("ASPFTLParseBufferToCxt: raidReconstructSuccessFlow(406): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                          }
                          ...
                          if (sub_100026C38(a1, "raidReconstructSuccessFlow_", v8, 8u, v18))
                          {
                            goto LABEL_110;
                          }
                        ...
                        case 407:
                          if (v14 != 5)
                          {
                            sub_100012748("ASPFTLParseBufferToCxt: raidReconstructFailFlow(407): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                          }
                          ...
                          if (sub_100026C38(a1, "raidReconstructFailFlow_", v8, 8u, v18))
                          {
                            goto LABEL_110;
                          }
                          ...
                          goto LABEL_2993;
                        case 408:
                          if (sub_10002E2CC(a1, "", "raidReconstructFailP", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 409:
                          if (sub_10002E2CC(a1, "", "raidReconstructFailQ", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 410:
                          if (sub_10002E2CC(a1, "", "raidReconstructFailUECC", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 411:
                          if (sub_10002E2CC(a1, "", "raidReconstructFailUnsupp", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 412:
                          if (sub_10002E2CC(a1, "", "raidUECCOpenBand", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 414:
                          if (sub_10002E2CC(a1, "", "ueccReads", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 416:
                          if (sub_10002E2CC(a1, "", "raidSuccessfulVerify", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 417:
                          if (sub_10002E2CC(a1, "", "raidFailedVerify", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 418:
                          if (sub_10002E2CC(a1, "", "numBandsVerified", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 419:
                          if (sub_10002E2CC(a1, "", "cache_heads", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 420:
                          if (sub_10002E2CC(a1, "", "AbortSkip_RMXtoMPBX", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 421:
                          if (sub_10002E2CC(a1, "", "s3eFwVer", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 422:
                          if (sub_10002E2CC(a1, "", "readVerifyNative", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 423:
                          if (sub_10002E2CC(a1, "", "reducedReadVerifyNative", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 424:
                          if (sub_10002E2CC(a1, "", "readVerifySlc", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 425:
                          if (sub_10002E2CC(a1, "", "reducedReadVerifySlc", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 426:
                          if (sub_10002E2CC(a1, "", "RxBurnEvictions", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 427:
                          if (sub_10002E2CC(a1, "", "directToTLCBands", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 428:
                          if (sub_10002E2CC(a1, "", "nandDesc", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 429:
                          if (sub_10002E2CC(a1, "", "fwUpdatesPercentUsed", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 430:
                          if (sub_10002E2CC(a1, "", "slcPercentUsed", *v8))
                          {
                            goto LABEL_162;
                          }
                          ...
                          goto LABEL_161;
                        case 431:
                          if (sub_10002E2CC(a1, "", "percentUsed", *v8))
                          {
                            goto LABEL_162;
                          }
                        ...
                        default:
                          ...
                          {
                            case 432:
                              if (sub_10002E2CC(a1, "", "hostAutoWrites", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 433:
                              if (sub_10002E2CC(a1, "", "hostAutoWriteXacts", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 434:
                              if (sub_10002E2CC(a1, "", "gcDestDynamic", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 435:
                              if (sub_10002E2CC(a1, "", "gcDestStatic", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 436:
                              if (sub_10002E2CC(a1, "", "gcDestWearlevel", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 437:
                              if (sub_10002E2CC(a1, "", "gcDestParity", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 438:
                              if (sub_10002E2CC(a1, "", "AbortSkip_Format", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 440:
                              if (sub_10002E2CC(a1, "", "raidSLCPadding", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 441:
                              if (sub_10002E2CC(a1, "", "raidGCBands", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 442:
                              if (sub_10002E2CC(a1, "", "raidGCSectors", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 443:
                              if (sub_10002E2CC(a1, "", "raidGCPadding", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 444:
                              if (sub_10002E2CC(a1, "", "raidSLCBandsPerHostFlow", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 445:
                              if (sub_10002E2CC(a1, "", "raidSLCSecsPerHostFlow", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 446:
                              if (sub_10002E2CC(a1, "", "rxBurnMinCycleRuns", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 447:
                              if (sub_10002E2CC(a1, "", "clogNumFastCxt", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 448:
                              if (sub_10002E2CC(a1, "", "clogNumRapidReboots", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 449:
                              if (sub_10002E2CC(a1, "", "clogFastCxtAbvThr", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 450:
                              if (sub_10002E2CC(a1, "", "rxBurnDiffModeRuns", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 452:
                              if (sub_10002E2CC(a1, "", "indReadVerifyFail", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 453:
                              if (v14 != 25)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: numOfThrottlingEntriesPerReadLevel(453): (#25) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "numOfThrottlingEntriesPerReadLevel_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 454:
                              if (v14 != 25)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: numOfThrottlingEntriesPerWriteLevel(454): (#25) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "numOfThrottlingEntriesPerWriteLevel_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 456:
                              if (v14 != 10)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: slcFifoDepth(456): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "slcFifoDepth_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 457:
                              if (sub_10002E2CC(a1, "", "wcacheSectorsDirtyIdle", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 458:
                              if (sub_10002E2CC(a1, "", "wcacheDS_SectorsDirtyIdle", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 459:
                              if (sub_10002E2CC(a1, "", "wcacheFS_MbytesDirtyIdle", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 460:
                              if (v14 != 256)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: CacheDepthVsThroughput(460): (#256) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "CacheDepthVsThroughput_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 461:
                              if (sub_10002E2CC(a1, "", "directToTLCSectors", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 462:
                              if (sub_10002E2CC(a1, "", "fallbackToWaterfall", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 463:
                              if (v14 != 11)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: balanceProportionBucketsHistogram(463): (#11) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "balanceProportionBucketsHistogram_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 464:
                              if (sub_10002E2CC(a1, "", "lockToTlc", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 465:
                              if (v14 != 10)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: burstSizeHistogram(465): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "burstSizeHistogram_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 466:
                              if (v14 != 64)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: qosDirectToTLC(466): (#64) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "qosDirectToTLC_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 467:
                              if (v14 != 4)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: maxQosDirectToTLC(467): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "maxQosDirectToTLC_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 468:
                              if (v14 != 16)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: wcacheDirtyAtFlush(468): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "wcacheDirtyAtFlush_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 469:
                              if (v14 != 2)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: raidReconstructSuccessPartition(469): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "raidReconstructSuccessPartition_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 470:
                              if (v14 != 2)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: raidReconstructFailPartition(470): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "raidReconstructFailPartition_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 471:
                              if (sub_10002E2CC(a1, "", "raidUncleanBootBandFail", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 472:
                              if (sub_10002E2CC(a1, "", "raidReconstructFailBandFlowHost", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 473:
                              if (sub_10002E2CC(a1, "", "raidReconstructFailBandFlowGC", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 476:
                              if (v14 != 2)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: raidSuccessfulRecoLbaRange(476): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "raidSuccessfulRecoLbaRange_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 477:
                              if (v14 != 2)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: raidFailedRecoLbaRange(477): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "raidFailedRecoLbaRange_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 481:
                              if (v14 != 32)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: skinnyBandErases_481(481): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "skinnyBandErases_481_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 483:
                              if (sub_10002E2CC(a1, "", "tlcOverHeatWaterfall", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 484:
                              if (sub_10002E2CC(a1, "", "skinnyCyclesConvert", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 485:
                              if (sub_10002E2CC(a1, "", "non_proportional_directToTLCSectors", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 486:
                              if (sub_10002E2CC(a1, "", "maxFailedFastCxtSync", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 487:
                              if (sub_10002E2CC(a1, "", "numFormatUserArea", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 488:
                              if (sub_10002E2CC(a1, "", "clogFastCxtSyncAborted", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 489:
                              if (v14 != 5)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: clogOccupationSectors(489): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "clogOccupationSectors_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                            ...
                            case 490:
                              if (v14 != 64)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: bdrTmpHist(490): (#64) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "bdrTmpHist_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 491:
                              if (sub_10002E2CC(a1, "", "numFWUpdates", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 492:
                              if (sub_10002E2CC(a1, "", "numClogLoadFails", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 493:
                              if (sub_10002E2CC(a1, "", "rxBurnNumForcedDiffMode", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 494:
                              if (sub_10002E2CC(a1, "", "RD_numSaves", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 495:
                              if (sub_10002E2CC(a1, "", "eanCompressWrites", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 496:
                              if (sub_10002E2CC(a1, "", "eanHostWrites", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 497:
                              if (sub_10002E2CC(a1, "", "bandPreErases", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 498:
                              if (sub_10002E2CC(a1, "", "eanHostUnmaps", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 499:
                              if (sub_10002E2CC(a1, "", "eanHostFlushes", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 500:
                              if (sub_10002E2CC(a1, "", "eanFastWrites", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 501:
                              if (sub_10002E2CC(a1, "", "autowriteDS2FSCollisions", *v8))
                              {
                                goto LABEL_162;
                              }
                              ...
                              goto LABEL_161;
                            case 502:
                              if (sub_10002E2CC(a1, "", "autowriteWaitTransferTaskBlocks", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            case 503:
                              if (v14 != 2)
                              {
                                sub_100012748("ASPFTLParseBufferToCxt: avgCycle(503): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                              }
                              ...
                              if (sub_100026C38(a1, "avgCycle_", v8, 8u, v18))
                              {
                                goto LABEL_110;
                              }
                              ...
                              goto LABEL_2993;
                            case 504:
                              if (sub_10002E2CC(a1, "", "RD_DeferredClearsOverflowCnt", *v8))
                              {
                                goto LABEL_162;
                              }
                            ...
                            default:
                              ...
                              {
                                case 505:
                                  if (sub_10002E2CC(a1, "", "maxVerticsInBand", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 506:
                                  if (sub_10002E2CC(a1, "", "numVertics", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 507:
                                  if (sub_10002E2CC(a1, "", "exceededCVertics", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 510:
                                  if (sub_10002E2CC(a1, "", "raidReconstructFailMismatch", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                ...
                                case 511:
                                  if (v14 != 32)
                                  {
                                    sub_100012748("ASPFTLParseBufferToCxt: mspbootBlockRefreshCnt(511): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                  }
                                  ...
                                  if (sub_100026C38(a1, "mspbootBlockRefreshCnt_", v8, 8u, v18))
                                  {
                                    goto LABEL_110;
                                  }
                                ...
                                case 516:
                                  if (v14 != 32)
                                  {
                                    sub_100012748("ASPFTLParseBufferToCxt: mspBootBlockRefreshTime(516): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                  }
                                  ...
                                  if (sub_100026C38(a1, "mspBootBlockRefreshTime_", v8, 8u, v18))
                                  {
                                    goto LABEL_110;
                                  }
                                  ...
                                  goto LABEL_2993;
                                case 517:
                                  if (sub_10002E2CC(a1, "", "mspBootBlockCountPerMsp", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 518:
                                  if (sub_10002E2CC(a1, "", "skinnyRevectorSLC", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 519:
                                  if (sub_10002E2CC(a1, "", "skinnyRevectorTLC", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 520:
                                  if (sub_10002E2CC(a1, "", "perfSetupAttempts", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 521:
                                  if (sub_10002E2CC(a1, "", "perfSetupSuccesses", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 522:
                                  if (sub_10002E2CC(a1, "", "perfWriteAttempts", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 523:
                                  if (sub_10002E2CC(a1, "", "perfWriteSuccesses", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 524:
                                  if (sub_10002E2CC(a1, "", "perfReadAttempts", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 525:
                                  if (sub_10002E2CC(a1, "", "perfReadSuccesses", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 526:
                                  if (sub_10002E2CC(a1, "", "perfCleanupAttempts", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 527:
                                  if (sub_10002E2CC(a1, "", "perfCleanupSuccesses", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 530:
                                  if (sub_10002E2CC(a1, "", "firstFailedDieId", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 531:
                                  if (sub_10002E2CC(a1, "", "numDieFailures", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 532:
                                  if (sub_10002E2CC(a1, "", "spareAvailablePercent", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 533:
                                  if (sub_10002E2CC(a1, "", "dataFabricErr", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 534:
                                  if (sub_10002E2CC(a1, "", "downlinkFabricErr", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 535:
                                  if (sub_10002E2CC(a1, "", "prpAccTimeoutErr", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 537:
                                  if (sub_10002E2CC(a1, "", "uplinkFabricErr", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 538:
                                  if (sub_10002E2CC(a1, "", "skinnyBandsGBB", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 539:
                                  if (sub_10002E2CC(a1, "", "AbortPad_GcMustPadBand", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 540:
                                  if (sub_10002E2CC(a1, "", "AbortPad_GcMustPadSkinny", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 541:
                                  if (sub_10002E2CC(a1, "", "bdrHostPingInitial", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 542:
                                  if (sub_10002E2CC(a1, "", "bdrHostPingMoreNeeded", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 543:
                                  if (sub_10002E2CC(a1, "", "bandParityAllocationFailed", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 544:
                                  if (sub_10002E2CC(a1, "", "fastHwBurstToSlc", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 545:
                                  if (sub_10002E2CC(a1, "", "slowHwToTlc", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                ...
                                case 546:
                                  if (v14 != 10)
                                  {
                                    sub_100012748("ASPFTLParseBufferToCxt: slcDemandBurstSizeDetected(546): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                  }
                                  ...
                                  if (sub_100026C38(a1, "slcDemandBurstSizeDetected_", v8, 8u, v18))
                                  {
                                    goto LABEL_110;
                                  }
                                ...
                                case 547:
                                  if (v14 != 10)
                                  {
                                    sub_100012748("ASPFTLParseBufferToCxt: slcDemandBurstDur(547): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                  }
                                  ...
                                  if (sub_100026C38(a1, "slcDemandBurstDur_", v8, 8u, v18))
                                  {
                                    goto LABEL_110;
                                  }
                                  ...
                                  goto LABEL_2993;
                                case 548:
                                  if (sub_10002E2CC(a1, "", "fastHwToTlcBurst", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                ...
                                case 549:
                                  if (v14 != 10)
                                  {
                                    sub_100012748("ASPFTLParseBufferToCxt: slcDemandBurstSizeSlc(549): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                  }
                                  ...
                                  if (sub_100026C38(a1, "slcDemandBurstSizeSlc_", v8, 8u, v18))
                                  {
                                    goto LABEL_110;
                                  }
                                ...
                                case 551:
                                  if (v14 != 11)
                                  {
                                    sub_100012748("ASPFTLParseBufferToCxt: balanceProportionBucketsHistogramTlc(551): (#11) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                  }
                                  ...
                                  if (sub_100026C38(a1, "balanceProportionBucketsHistogramTlc_", v8, 8u, v18))
                                  {
                                    goto LABEL_110;
                                  }
                                  ...
                                  goto LABEL_2993;
                                case 553:
                                  if (sub_10002E2CC(a1, "", "slowHwFlushToSlc", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 557:
                                  if (sub_10002E2CC(a1, "", "slowHwToSlc", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 558:
                                  if (sub_10002E2CC(a1, "", "flushNwToSlc", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 559:
                                  if (sub_10002E2CC(a1, "", "flushNwToTlc", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                ...
                                case 560:
                                  ...
                                  goto LABEL_161;
                                case 561:
                                  if (sub_10002E2CC(a1, "", "oslcTransitions", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 563:
                                  if (sub_10002E2CC(a1, "", "slcDemandFlushCount", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 564:
                                  if (sub_10002E2CC(a1, "", "slcDemandBurstCount", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 565:
                                  if (sub_10002E2CC(a1, "", "oslcBaseAvgPE", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 566:
                                  if (sub_10002E2CC(a1, "", "raidReconstructFailNoSPBX", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 567:
                                  if (sub_10002E2CC(a1, "", "raidReconstructFailDouble", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 568:
                                  if (sub_10002E2CC(a1, "", "oslcFastWAmpUOnOff", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 569:
                                  if (sub_10002E2CC(a1, "", "oslcSlowWAmpUOnOff", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 570:
                                  if (sub_10002E2CC(a1, "", "raidReconstructFailInvalid", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 572:
                                  if (sub_10002E2CC(a1, "", "oslcLastWAmpUx10", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 573:
                                  if (sub_10002E2CC(a1, "", "raidFailedReadNoBlog", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 574:
                                  if (sub_10002E2CC(a1, "", "raidReconstructFailBlank", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 575:
                                  if (sub_10002E2CC(a1, "", "oslcHotTLCOnOff", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 576:
                                  if (sub_10002E2CC(a1, "", "gcVPackDestinations", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 581:
                                  if (sub_10002E2CC(a1, "", "averageTLCPECycles", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 582:
                                  if (sub_10002E2CC(a1, "", "averageSLCPECycles", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 583:
                                  if (sub_10002E2CC(a1, "", "numAtomicBoots", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 584:
                                  if (sub_10002E2CC(a1, "", "clogMinorMismatch", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 586:
                                  if (sub_10002E2CC(a1, "", "raidExpectedFailRMXReconstructionInternal", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 587:
                                  if (sub_10002E2CC(a1, "", "raidExpectedFailRMXReconstructionHost", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 588:
                                  if (sub_10002E2CC(a1, "", "oslcGCinvalidations", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                  ...
                                  goto LABEL_161;
                                case 589:
                                  if (sub_10002E2CC(a1, "", "oslcGCActivateReason", *v8))
                                  {
                                    goto LABEL_162;
                                  }
                                ...
                                default:
                                  ...
                                  {
                                    case 590:
                                      if (sub_10002E2CC(a1, "", "oslcLowCleanBandsUOnOff", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 591:
                                      if (sub_10002E2CC(a1, "", "oslcTooManyGCMustOnOff", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 592:
                                      if (sub_10002E2CC(a1, "", "oslcBaseHostWrites", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 593:
                                      if (sub_10002E2CC(a1, "", "oslcBaseBandErases", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 594:
                                      if (sub_10002E2CC(a1, "", "oslcBdrBands", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 595:
                                      if (sub_10002E2CC(a1, "", "oslcBdrValid", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 596:
                                      if (sub_10002E2CC(a1, "", "unexpectedBlanksInternal", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 597:
                                      if (sub_10002E2CC(a1, "", "unexpectedBlanksOnRV", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 601:
                                      if (sub_10002E2CC(a1, "", "waterfallLockSectors", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 602:
                                      if (sub_10002E2CC(a1, "", "oslcGCActiveWrites", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 603:
                                      if (sub_10002E2CC(a1, "", "chipIdTemperatureSample", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 604:
                                      if (sub_10002E2CC(a1, "", "gcVPackWrites", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 605:
                                      if (v14 != 10)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: gcActiveReasons(605): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "gcActiveReasons_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 606:
                                      if (sub_10002E2CC(a1, "", "eanMaxInitTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 607:
                                      if (sub_10002E2CC(a1, "", "eanMinToFirstReadTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 608:
                                      if (sub_10002E2CC(a1, "", "skinnyAPGMRetire", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 609:
                                      if (sub_10002E2CC(a1, "", "unexpectedBlanksHost", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 610:
                                      if (v14 != 64)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: pcieAerCounters(610): (#64) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "pcieAerCounters_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 611:
                                      if (sub_10002E2CC(a1, "", "fastHwToTlcBalance", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 612:
                                      if (sub_10002E2CC(a1, "", "perfOSLCRuns", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 613:
                                      if (sub_10002E2CC(a1, "", "slcDemandBurstWritesInGC", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 614:
                                      if (sub_10002E2CC(a1, "", "slcDemandBurstWritesInTT", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 615:
                                      if (sub_10002E2CC(a1, "", "slcDemandBurstWritesInNRP", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 616:
                                      if (sub_10002E2CC(a1, "", "perfTotalDmaMb", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 617:
                                      if (sub_10002E2CC(a1, "", "eanAvgInitTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 618:
                                      if (sub_10002E2CC(a1, "", "eanAvgToFirstReadTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 619:
                                      if (sub_10002E2CC(a1, "", "eanMaxBootReadTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 620:
                                      if (sub_10002E2CC(a1, "", "eanAvgBootReadTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 621:
                                      if (v14 != 10)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: eanBootReadsHist(621): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "eanBootReadsHist_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 622:
                                      if (sub_10002E2CC(a1, "", "maxBgInitTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 623:
                                      if (sub_10002E2CC(a1, "", "avgBgInitTimeMs", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 624:
                                      if (v14 != 16)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: clogFailReason(624): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "clogFailReason_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 625:
                                      if (sub_10002E2CC(a1, "", "eanMinBootReadMBPerSec", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 626:
                                      if (sub_10002E2CC(a1, "", "eanAvgBootReadMBPerSec", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 627:
                                      if (sub_10002E2CC(a1, "", "minSkinnyPECycles", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 628:
                                      if (sub_10002E2CC(a1, "", "maxSkinnyPECycles", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 629:
                                      if (sub_10002E2CC(a1, "", "averageSkinnyPECycles", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 630:
                                      if (v14 != 6)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: raidSuccessfulRecoEAN(630): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "raidSuccessfulRecoEAN_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                    ...
                                    case 631:
                                      if (v14 != 6)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: raidFailedRecoEAN(631): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "raidFailedRecoEAN_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                    ...
                                    case 632:
                                      if (v14 != 6)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: eanFirstReadMode(632): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "eanFirstReadMode_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 635:
                                      if (sub_10002E2CC(a1, "", "oslcHwGC", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 636:
                                      if (sub_10002E2CC(a1, "", "oslcHwTT", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 637:
                                      if (sub_10002E2CC(a1, "", "oslcHwNRP", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 638:
                                      if (v14 != 10)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: oslcDemandBurstSize(638): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "oslcDemandBurstSize_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 639:
                                      if (sub_10002E2CC(a1, "", "raidReconstructSuccessBandFlowOslc", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 640:
                                      if (sub_10002E2CC(a1, "", "raidReconstructFailBandFlowOslc", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 641:
                                      if (sub_10002E2CC(a1, "", "raidFailSectors", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 642:
                                      if (sub_10002E2CC(a1, "", "eanFailSectors", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 643:
                                      if (sub_10002E2CC(a1, "", "bdrTimeMode", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 644:
                                      if (sub_10002E2CC(a1, "", "raidParityNotSavedP", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 645:
                                      if (sub_10002E2CC(a1, "", "raidParityNotSavedQ", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 646:
                                      if (sub_10002E2CC(a1, "", "raidParityInvalid", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 647:
                                      if (sub_10002E2CC(a1, "", "raidParityUnknown", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 648:
                                      if (sub_10002E2CC(a1, "", "raidParityUnmapped", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 649:
                                      if (sub_10002E2CC(a1, "", "raidParityGCUnc", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 657:
                                      if (sub_10002E2CC(a1, "", "AbortSkip_MPBXProbational", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 659:
                                      if (sub_10002E2CC(a1, "", "raidVerificationReads", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 666:
                                      if (sub_10002E2CC(a1, "", "nofDies", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 671:
                                      if (sub_10002E2CC(a1, "", "skinnyBandsNum", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 672:
                                      if (sub_10002E2CC(a1, "", "skinnyBandsNumDips", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    case 674:
                                      if (v14 != 8)
                                      {
                                        sub_100012748("ASPFTLParseBufferToCxt: oslcNoVotesHw(674): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                      }
                                      ...
                                      if (sub_100026C38(a1, "oslcNoVotesHw_", v8, 8u, v18))
                                      {
                                        goto LABEL_110;
                                      }
                                      ...
                                      goto LABEL_2993;
                                    case 675:
                                      if (sub_10002E2CC(a1, "", "totalLbas", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 676:
                                      if (sub_10002E2CC(a1, "", "bdrHostPingExtra", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                      ...
                                      goto LABEL_161;
                                    case 677:
                                      if (sub_10002E2CC(a1, "", "magazineInstanceMeta", *v8))
                                      {
                                        goto LABEL_162;
                                      }
                                    ...
                                    default:
                                      switch(v12)
                                      {
                                        case 680:
                                          if (v14 != 3)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: magazineFWVersion(680): (#3) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "magazineFWVersion_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 681:
                                          if (sub_10002E2CC(a1, "", "raidReconstructFailPMXUnsup", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 682:
                                          if (sub_10002E2CC(a1, "", "raidReconstructFailBMXUnsup", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 683:
                                          if (sub_10002E2CC(a1, "", "iBootNANDResets", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 684:
                                          if (sub_10002E2CC(a1, "", "pcieClkreqHighTimeout", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 687:
                                          if (v14 != 3)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrInitSent(687): (#3) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrInitSent_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 688:
                                          if (sub_10002E2CC(a1, "", "cbdrPauseSent", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 689:
                                          if (sub_10002E2CC(a1, "", "cbdrResumeSent", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 690:
                                          if (sub_10002E2CC(a1, "", "cbdrGetResultSent", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 691:
                                          if (sub_10002E2CC(a1, "", "cbdrEarlyExits", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 694:
                                          if (v14 != 10)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrRefreshGrades(694): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrRefreshGrades_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 695:
                                          if (sub_10002E2CC(a1, "", "cbdrNotEnoughReads", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 696:
                                          if (sub_10002E2CC(a1, "", "cbdrAborts", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 697:
                                          if (sub_10002E2CC(a1, "", "TurboRaidHostClassifications", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 698:
                                          if (sub_10002E2CC(a1, "", "TurboRaidInternalClassifications", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 699:
                                          if (sub_10002E2CC(a1, "", "cbdrFullyDone", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 702:
                                          if (v14 != 32)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: vcurve(702): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "vcurve_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                        ...
                                        case 703:
                                          if (v14 != 12)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: injDepth(703): (#12) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "injDepth_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 704:
                                          if (sub_10002E2CC(a1, "", "logical_disk_occupied_promiles", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 711:
                                          if (sub_10002E2CC(a1, "", "raidPrevFailedReconstructSkip", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 712:
                                          if (sub_10002E2CC(a1, "", "TurboRaidSuccessfulHostAuxReads", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 713:
                                          if (sub_10002E2CC(a1, "", "TurboRaidSuccessfulInternalAuxReads", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 714:
                                          if (sub_10002E2CC(a1, "", "turboRaidClassificationReliabilityHost", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 715:
                                          if (sub_10002E2CC(a1, "", "turboRaidClassificationReliabilityInternal", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 716:
                                          if (sub_10002E2CC(a1, "", "turboRaidClassificationQualityHost", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 717:
                                          if (sub_10002E2CC(a1, "", "turboRaidClassificationQualityInternal", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 719:
                                          if (sub_10002E2CC(a1, "", "skinnyBandErases", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 721:
                                          if (sub_10002E2CC(a1, "", "gcPDusterDestinations", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 722:
                                          if (sub_10002E2CC(a1, "", "gcPDusterWrites", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 730:
                                          if (sub_10002E2CC(a1, "", "rvFails", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 737:
                                          if (sub_10002E2CC(a1, "", "TurboRaidFailedHostAuxReads", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 738:
                                          if (sub_10002E2CC(a1, "", "TurboRaidFailedInternalAuxReads", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 741:
                                          if (sub_10002E2CC(a1, "", "autoSkipTriggers", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 742:
                                          if (sub_10002E2CC(a1, "", "autoSkipPlanes", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 744:
                                          if (v14 != 8)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: raidReconstructDurationHisto(744): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "raidReconstructDurationHisto_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                        ...
                                        case 745:
                                          if (v14 != 8)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: failsOnReconstructHisto(745): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "failsOnReconstructHisto_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 746:
                                          if (sub_10002E2CC(a1, "", "bandKill_userFlattenExcessive", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 747:
                                          if (sub_10002E2CC(a1, "", "bandKill_IntFlattenExcessive", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 748:
                                          if (sub_10002E2CC(a1, "", "bandKill_userFlattenBalance", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 749:
                                          if (sub_10002E2CC(a1, "", "bandKill_intFlattenBalance", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 750:
                                          if (sub_10002E2CC(a1, "", "bandKill_formatVertExcessive", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 751:
                                          if (sub_10002E2CC(a1, "", "bandKill_formatVertBalance", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 753:
                                          if (sub_10002E2CC(a1, "", "cbdrNumSlowRefreshes", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 754:
                                          if (sub_10002E2CC(a1, "", "cbdrNumFastRefreshes", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 755:
                                          if (sub_10002E2CC(a1, "", "cbdrTotalRefreshValidity", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 756:
                                          if (v14 != 9)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrRefreshedAges(756): (#9) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrRefreshedAges_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 758:
                                          if (sub_10002E2CC(a1, "", "cbdrSkippedBlocks", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 759:
                                          if (v14 != 5)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrScanPct(759): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrScanPct_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 760:
                                          if (sub_10002E2CC(a1, "", "raidSuccessfulBMXReconstructionInternal", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 761:
                                          if (sub_10002E2CC(a1, "", "raidSuccessfulBMXReconstructionHost", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 762:
                                          if (sub_10002E2CC(a1, "", "raidFailedBMXReconstructionInternal", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 763:
                                          if (sub_10002E2CC(a1, "", "raidFailedBMXReconstructionHost", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 764:
                                          if (sub_10002E2CC(a1, "", "ricSPRVFail", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 765:
                                          if (sub_10002E2CC(a1, "", "ricMPRVFail", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 767:
                                          if (v14 != 10)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrRefreshGradesSLC(767): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrRefreshGradesSLC_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                        ...
                                        case 768:
                                          if (v14 != 9)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrRefreshedAgesSLC(768): (#9) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrRefreshedAgesSLC_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                        ...
                                        case 769:
                                          if (v14 != 5)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cbdrScanPctSLC(769): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cbdrScanPctSLC_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                        ...
                                        case 770:
                                          if (v14 != 8)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: cpuBurstLength(770): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "cpuBurstLength_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 771:
                                          if (sub_10002E2CC(a1, "", "autoSkipRaidRecoFail", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        case 772:
                                          if (v14 != 32)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: dmReasonsSlc(772): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "dmReasonsSlc_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                        ...
                                        case 773:
                                          if (v14 != 32)
                                          {
                                            sub_100012748("ASPFTLParseBufferToCxt: dmReasonsTlc(773): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                          }
                                          ...
                                          if (sub_100026C38(a1, "dmReasonsTlc_", v8, 8u, v18))
                                          {
                                            goto LABEL_110;
                                          }
                                          ...
                                          goto LABEL_2993;
                                        case 774:
                                          if (sub_10002E2CC(a1, "", "raidReconstructFailBMXAbort", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 775:
                                          if (sub_10002E2CC(a1, "", "bandKill_fatBindingNoBlocks", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                          ...
                                          goto LABEL_161;
                                        case 776:
                                          if (sub_10002E2CC(a1, "", "bandKill_fatBindingFewBlocks", *v8))
                                          {
                                            goto LABEL_162;
                                          }
                                        ...
                                        default:
                                          ...
                                          {
                                            case 777:
                                              if (sub_10002E2CC(a1, "", "numBadBootBlocks", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 778:
                                              if (sub_10002E2CC(a1, "", "snapshotCPUHigh", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 779:
                                              if (sub_10002E2CC(a1, "", "snapshotCPULow", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 780:
                                              if (sub_10002E2CC(a1, "", "gcWithoutBMs", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 781:
                                              if (v14 != 10)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: gcSearchTimeHistory(781): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "gcSearchTimeHistory_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 785:
                                              if (v14 != 16)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: gcSearchPortion(785): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "gcSearchPortion_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 786:
                                              if (sub_10002E2CC(a1, "", "raidReconstructFailBmxMp", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 787:
                                              if (sub_10002E2CC(a1, "", "raidReconstructFailBmx", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 788:
                                              if (sub_10002E2CC(a1, "", "raidReconstructFailBMXUECC", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 789:
                                              if (sub_10002E2CC(a1, "", "raidReconstructFailBMXBlank", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 790:
                                              if (sub_10002E2CC(a1, "", "raidPrevFailedReconstructBmxMpSkip", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 792:
                                              if (sub_10002E2CC(a1, "", "numTLCFatBands", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 793:
                                              if (sub_10002E2CC(a1, "", "fatValidity", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 794:
                                              if (sub_10002E2CC(a1, "", "fatTotal", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 798:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailP(798): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailP_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 799:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailUECC(799): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailUECC_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 804:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailNoSPBX(804): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailNoSPBX_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 806:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailBlank(806): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailBlank_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 809:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailUnsup(809): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailUnsup_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 811:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailMpSkip(811): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailMpSkip_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 812:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailAbort(812): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailAbort_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 813:
                                              if (sub_10002E2CC(a1, "", "TurboRaidIsEnabled", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 814:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXFailOther(814): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXFailOther_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 815:
                                              if (v14 != 4)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: raidBMXSuccess(815): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "raidBMXSuccess_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 816:
                                              if (sub_10002E2CC(a1, "", "skinnyBandsExtraDip", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 821:
                                              if (sub_10002E2CC(a1, "", "writeAmp", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 822:
                                              if (sub_10002E2CC(a1, "", "ricMaxClogOnlyPages", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 823:
                                              if (v14 != 3)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: readClassifyStatusesHisto(823): (#3) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "readClassifyStatusesHisto_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 824:
                                              if (v14 != 10)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: readWithAuxStatusesHisto(824): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "readWithAuxStatusesHisto_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 825:
                                              if (v14 != 10)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: readReconstructStatusesHisto(825): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "readReconstructStatusesHisto_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 826:
                                              if (sub_10002E2CC(a1, "", "bdrBackupChecks", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 827:
                                              if (sub_10002E2CC(a1, "", "ricExceedClogOnlyPagesTH", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 828:
                                              if (sub_10002E2CC(a1, "", "numDipFailures", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 831:
                                              if (sub_10002E2CC(a1, "", "prefetchNextRange", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 862:
                                              if (sub_10002E2CC(a1, "", "raidSuccessfulSkip", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 863:
                                              if (sub_10002E2CC(a1, "", "raidFailedSkip", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 864:
                                              if (sub_10002E2CC(a1, "", "raidSkipAttempts", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 865:
                                              if (v14 != 25)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: timeOfThrottlingPerLevel(865): (#25) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "timeOfThrottlingPerLevel_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 866:
                                              if (v14 != 25)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: timeOfThrottlingPerReadLevel(866): (#25) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "timeOfThrottlingPerReadLevel_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 867:
                                              if (v14 != 25)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: timeOfThrottlingPerWriteLevel(867): (#25) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "timeOfThrottlingPerWriteLevel_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 868:
                                              if (v14 != 32)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: dmReasonsSlc_1bc(868): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "dmReasonsSlc_1bc_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 869:
                                              if (v14 != 32)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: dmReasonsTlc_1bc(869): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "dmReasonsTlc_1bc_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 870:
                                              if (v14 != 32)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: dmReasonsSlc_1bc_he(870): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "dmReasonsSlc_1bc_he_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 871:
                                              if (v14 != 32)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: dmReasonsTlc_1bc_he(871): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "dmReasonsTlc_1bc_he_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 876:
                                              if (v14 != 32)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: dmReasonsSlc_mbc(876): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "dmReasonsSlc_mbc_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 877:
                                              if (v14 != 32)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: dmReasonsTlc_mbc(877): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "dmReasonsTlc_mbc_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 883:
                                              if (sub_10002E2CC(a1, "", "clogEmptyProgramms", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 884:
                                              if (sub_10002E2CC(a1, "", "oslcHwCloseBand", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 891:
                                              if (v14 != 2)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: turboRaidSuccessAuxPartition(891): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "turboRaidSuccessAuxPartition_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 892:
                                              if (v14 != 2)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: turboRaidFailAuxPartition(892): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "turboRaidFailAuxPartition_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 893:
                                              if (v14 != 2)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: turboRaidClassifyQualPartition(893): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "turboRaidClassifyQualPartition_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 894:
                                              if (v14 != 2)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: turboRaidClassifyRelPartition(894): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "turboRaidClassifyRelPartition_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 895:
                                              if (sub_10002E2CC(a1, "", "IND_pool_freeMinSilo", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 896:
                                              if (sub_10002E2CC(a1, "", "autoSweepBlocks", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 897:
                                              if (v14 != 16)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: wcWrFragSizes(897): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "wcWrFragSizes_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 898:
                                              if (v14 != 16)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: indStateAcrossGcDidNoL(898): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "indStateAcrossGcDidNoL_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 899:
                                              if (v14 != 16)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: indStateAcrossGcDidL(899): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "indStateAcrossGcDidL_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              goto LABEL_2993;
                                            case 900:
                                              if (sub_10002E2CC(a1, "", "turboRaidNoClassifyDueToWasRetire", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 901:
                                              if (sub_10002E2CC(a1, "", "turboRaidNoClassifyDueToOpenBand", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 902:
                                              if (sub_10002E2CC(a1, "", "turboRaidNoClassifyDueToQualityBlock", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 903:
                                              if (sub_10002E2CC(a1, "", "turboRaidGbbOpenBand", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                              ...
                                              goto LABEL_161;
                                            case 904:
                                              if (sub_10002E2CC(a1, "", "turboRaidGbbShouldRetireOnRefresh", *v8))
                                              {
                                                goto LABEL_162;
                                              }
                                            ...
                                            case 905:
                                              if (v14 != 16)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: turboRaidRelPerBlock(905): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "turboRaidRelPerBlock_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                            ...
                                            case 906:
                                              if (v14 != 16)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: turboRaidRelBetweenRefreshesPerBlock(906): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "turboRaidRelBetweenRefreshesPerBlock_", v8, 8u, v18))
                                              {
                                                goto LABEL_110;
                                              }
                                              ...
                                              if (v12 <= 997)
                                              {
                                                switch(v12)
                                                {
                                                  case 907:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidMaxRelBetweenRefreshesPerBlock(907): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidMaxRelBetweenRefreshesPerBlock_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 908:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidMinRelBetweenRefreshesPerBlock(908): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidMinRelBetweenRefreshesPerBlock_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 918:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidMaxCyclesBetweenRel(918): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidMaxCyclesBetweenRel_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 919:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidMinCyclesBetweenRel(919): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidMinCyclesBetweenRel_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 920:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidAuxPerBlock(920): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidAuxPerBlock_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 921:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidAuxBetweenRefreshesPerBlock(921): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidAuxBetweenRefreshesPerBlock_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 922:
                                                    if (sub_10002E2CC(a1, "", "turboRaidRelLockMark", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 923:
                                                    if (sub_10002E2CC(a1, "", "turboRaidAuxLockMark", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 930:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidMaxCyclesBetweenAux(930): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidMaxCyclesBetweenAux_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 931:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidMinCyclesBetweenAux(931): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidMinCyclesBetweenAux_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 932:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidLastRelPECycles(932): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidLastRelPECycles_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 933:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidRelQualPECycles(933): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidRelQualPECycles_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 934:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidLastAuxPECycles(934): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidLastAuxPECycles_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 935:
                                                    if (v14 != 16)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: turboRaidAuxQualPECycles(935): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "turboRaidAuxQualPECycles_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 937:
                                                    if (sub_10002E2CC(a1, "", "turboRaidPEFailAfterRel", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 938:
                                                    if (sub_10002E2CC(a1, "", "turboRaidPEFailAfterAux", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 939:
                                                    if (sub_10002E2CC(a1, "", "dvfmVotesCPU", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 940:
                                                    if (sub_10002E2CC(a1, "", "dvfmVotesBandwidth", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 942:
                                                    if (sub_10002E2CC(a1, "", "maxSLCEndurance", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 943:
                                                    if (sub_10002E2CC(a1, "", "maxMixedEndurance", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 944:
                                                    if (sub_10002E2CC(a1, "", "maxNativeEndurance", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 948:
                                                    if (v14 != 40)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: assertHistory(948): (#40) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "assertHistory_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 951:
                                                    if (sub_10002E2CC(a1, "", "asp3Support", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 953:
                                                    if (sub_10002E2CC(a1, "", "numCrossTempRaidUecc", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 961:
                                                    if (sub_10002E2CC(a1, "", "osBuildStr", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 962:
                                                    if (sub_10002E2CC(a1, "", "raidConfig", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 964:
                                                    if (sub_10002E2CC(a1, "", "raidBlkParityBands", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 965:
                                                    if (sub_10002E2CC(a1, "", "raidBlkParitySecs", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 967:
                                                    if (v14 != 12)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: indTrimFrags(967): (#12) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "indTrimFrags_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 971:
                                                    if (v14 != 12)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: indUsedFrags(971): (#12) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "indUsedFrags_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  default:
                                                    if (v12 != 996)
                                                    {
                                                      ...
                                                      if ((sub_10002E2CC(a1, "", "clogFindBlank", *v8) & 1) == 0)
                                                      {
                                                    ...
                                                    if (sub_10002E2CC(a1, "", "clogFindFail", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                              ...
                                              if (v12 <= 1137)
                                              {
                                                  ...
                                                  if (v12 > 1104)
                                                  {
                                                    if (v12 > 1115)
                                                    {
                                                      if (v12 == 1116)
                                                      {
                                                        if (v14 != 32)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: gcwamp(1116): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if ((sub_100026C38(a1, "gcwamp_", v8, 8u, v18) & 1) == 0)
                                                        {
                                                      ...
                                                      if (v12 == 1137)
                                                      {
                                                        if (sub_10002E2CC(a1, "", "numOfToUnhappySwitches", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                    ...
                                                    else
                                                    {
                                                      if (v12 == 1105)
                                                      {
                                                        if (v14 != 14)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: hostReadSequential(1105): (#14) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if ((sub_100026C38(a1, "hostReadSequential_", v8, 8u, v18) & 1) == 0)
                                                        {
                                                      ...
                                                      if (v12 == 1106)
                                                      {
                                                        if (v14 != 14)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: GCReadSequential(1106): (#14) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if ((sub_100026C38(a1, "GCReadSequential_", v8, 8u, v18) & 1) == 0)
                                                        {
                                                  ...
                                                  else
                                                  {
                                                    if (v12 <= 1041)
                                                    {
                                                      ...
                                                      if (v12 == 1040)
                                                      {
                                                        if (v14 != 31)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bandsAgeBinsV2(1040): (#31) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if ((sub_100026C38(a1, "bandsAgeBinsV2_", v8, 8u, v18) & 1) == 0)
                                                        {
                                                      ...
                                                      else
                                                      {
                                                        if (v14 != 31)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bandsAgeBinsSnapshot(1041): (#31) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if ((sub_100026C38(a1, "bandsAgeBinsSnapshot_", v8, 8u, v18) & 1) == 0)
                                                        {
                                                    ...
                                                    if (v12 == 1042)
                                                    {
                                                      if (v14 != 15)
                                                      {
                                                        sub_100012748("ASPFTLParseBufferToCxt: bandsAgeBinsReadSectors(1042): (#15) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                      }
                                                      ...
                                                      if ((sub_100026C38(a1, "bandsAgeBinsReadSectors_", v8, 8u, v18) & 1) == 0)
                                                      {
                                                    ...
                                                    if (v12 == 1080)
                                                    {
                                                      if (sub_10002E2CC(a1, "", "raidForceClogLoad", *v8))
                                                      {
                                                        goto LABEL_162;
                                                      }
                                                ...
                                                if (v12 > 1002)
                                                {
                                                  if (v12 > 1015)
                                                  {
                                                    if (v12 == 1016)
                                                    {
                                                      if (sub_10002E2CC(a1, "", "eanEarlyBootNumUeccPages", *v8))
                                                      {
                                                        goto LABEL_162;
                                                      }
                                                    ...
                                                    if (v12 == 1017)
                                                    {
                                                      if (sub_10002E2CC(a1, "", "eanEarlyBootUeccMultiplane", *v8))
                                                      {
                                                        goto LABEL_162;
                                                      }
                                                  ...
                                                  else
                                                  {
                                                    if (v12 == 1003)
                                                    {
                                                      if (sub_10002E2CC(a1, "", "clogReplaySpfError", *v8))
                                                      {
                                                        goto LABEL_162;
                                                      }
                                                    ...
                                                    if (v12 == 1015)
                                                    {
                                                      if (v14 != 4)
                                                      {
                                                        sub_100012748("ASPFTLParseBufferToCxt: eanEarlyBootUeccPage(1015): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                      }
                                                      ...
                                                      if ((sub_100026C38(a1, "eanEarlyBootUeccPage_", v8, 8u, v18) & 1) == 0)
                                                      {
                                                ...
                                                if (v12 <= 1000)
                                                {
                                                  if (v12 == 998)
                                                  {
                                                    if (sub_10002E2CC(a1, "", "clogFindUnc", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  if (v12 == 999)
                                                  {
                                                    if (sub_10002E2CC(a1, "", "clogFindUnexpected", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                ...
                                                if (v12 == 1001)
                                                {
                                                  if (v14 != 8)
                                                  {
                                                    sub_100012748("ASPFTLParseBufferToCxt: clogReplayFailReason(1001): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                  }
                                                  ...
                                                  if ((sub_100026C38(a1, "clogReplayFailReason_", v8, 8u, v18) & 1) == 0)
                                                  {
                                                ...
                                                if ((sub_10002E2CC(a1, "", "clogReplayTransientError", *v8) & 1) == 0)
                                                {
...
LABEL_163:
                                                ...
                                                if (v12 > 1180)
                                                {
                                                  if (v12 <= 1182)
                                                  {
                                                    if (v12 == 1181)
                                                    {
                                                      if (v14 != 4)
                                                      {
                                                        sub_100012748("ASPFTLParseBufferToCxt: gc_cur_dw_gc3(1181): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                      }
                                                      ...
                                                      if ((sub_100026C38(a1, "gc_cur_dw_gc3_", v8, 8u, v18) & 1) == 0)
                                                      {
                                                    ...
                                                    else
                                                    {
                                                      if (v14 != 4)
                                                      {
                                                        sub_100012748("ASPFTLParseBufferToCxt: gc_tot_dw_gc1(1182): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                      }
                                                      ...
                                                      if ((sub_100026C38(a1, "gc_tot_dw_gc1_", v8, 8u, v18) & 1) == 0)
                                                      {
                                                  ...
                                                  if (v12 == 1183)
                                                  {
                                                    if (v14 != 4)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: gc_tot_dw_gc2(1183): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if ((sub_100026C38(a1, "gc_tot_dw_gc2_", v8, 8u, v18) & 1) == 0)
                                                    {
                                                  ...
                                                  if (v12 == 1184)
                                                  {
                                                    if (sub_10002E2CC(a1, "", "unhappy_state", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                ...
                                                else
                                                {
                                                  if (v12 > 1178)
                                                  {
                                                    if (v12 == 1179)
                                                    {
                                                      if (v14 != 4)
                                                      {
                                                        sub_100012748("ASPFTLParseBufferToCxt: gc_cur_dw_gc1(1179): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                      }
                                                      ...
                                                      if ((sub_100026C38(a1, "gc_cur_dw_gc1_", v8, 8u, v18) & 1) == 0)
                                                      {
                                                    ...
                                                    else
                                                    {
                                                      if (v14 != 4)
                                                      {
                                                        sub_100012748("ASPFTLParseBufferToCxt: gc_cur_dw_gc2(1180): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                      }
                                                      ...
                                                      if ((sub_100026C38(a1, "gc_cur_dw_gc2_", v8, 8u, v18) & 1) == 0)
                                                      {
                                                  ...
                                                  if (v12 == 1171)
                                                  {
                                                    if (v14 != 10)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectEmptySpotRemovalAge(1171): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if ((sub_100026C38(a1, "poDetectEmptySpotRemovalAge_", v8, 8u, v18) & 1) == 0)
                                                    {
                                                  ...
                                                  if (v12 == 1172)
                                                  {
                                                    if (v14 != 3)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectGBBedMostSevereCost(1172): (#3) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if ((sub_100026C38(a1, "poDetectGBBedMostSevereCost_", v8, 8u, v18) & 1) == 0)
                                                    {
                                              ...
                                              if (v12 > 1156)
                                              {
                                                if (v12 > 1167)
                                                {
                                                  if (v12 == 1168)
                                                  {
                                                    if (v14 != 2)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectPERemovalTotalCost(1168): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if ((sub_100026C38(a1, "poDetectPERemovalTotalCost_", v8, 8u, v18) & 1) == 0)
                                                    {
                                                  ...
                                                  if (v12 == 1169)
                                                  {
                                                    if (v14 != 2)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectEmptySpotRemovalTotalCost(1169): (#2) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if ((sub_100026C38(a1, "poDetectEmptySpotRemovalTotalCost_", v8, 8u, v18) & 1) == 0)
                                                    {
                                                ...
                                                else
                                                {
                                                  if (v12 == 1157)
                                                  {
                                                    if (sub_10002E2CC(a1, "", "eanMaxForceROTimeMs", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  if (v12 == 1158)
                                                  {
                                                    if (sub_10002E2CC(a1, "", "eanMaxForceRORecoTimeMs", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                              ...
                                              if (v12 <= 1147)
                                              {
                                                if (v12 == 1138)
                                                {
                                                  if (sub_10002E2CC(a1, "", "numOfToHappySwitches", *v8))
                                                  {
                                                    goto LABEL_162;
                                                  }
                                                ...
                                                if (v12 == 1147)
                                                {
                                                  if (v14 != 24)
                                                  {
                                                    sub_100012748("ASPFTLParseBufferToCxt: gc_concurrent_dw_gc12(1147): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                  }
                                                  ...
                                                  if ((sub_100026C38(a1, "gc_concurrent_dw_gc12_", v8, 8u, v18) & 1) == 0)
                                                  {
...
LABEL_2529:
                                                ...
                                                {
                                                  case 1185:
                                                    if (sub_10002E2CC(a1, "", "unhappy_level", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
...
LABEL_2686:
                                                    if (v12 <= 1447)
                                                    {
                                                      ...
                                                      {
                                                        case 1354:
                                                          if (sub_10002E2CC(a1, "", "numOfThrottlingLevels", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1355:
                                                          if (sub_10002E2CC(a1, "", "crossTempColdEvict", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1356:
                                                          if (sub_10002E2CC(a1, "", "crossTempHotEvict", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1357:
                                                          if (sub_10002E2CC(a1, "", "crossTempColdHotEvict", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                        ...
                                                        case 1358:
                                                          if (v14 != 13)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: tempChangedHisto(1358): (#13) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if (sub_100026C38(a1, "tempChangedHisto_", v8, 8u, v18))
                                                          {
                                                            goto LABEL_110;
                                                          }
                                                        ...
                                                        case 1359:
                                                          if (v14 != 13)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: tempChangedEnterETHisto(1359): (#13) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if (sub_100026C38(a1, "tempChangedEnterETHisto_", v8, 8u, v18))
                                                          {
                                                            goto LABEL_110;
                                                          }
                                                        ...
                                                        case 1362:
                                                          if (v14 != 20)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: gcMustReasons(1362): (#20) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if (sub_100026C38(a1, "gcMustReasons_", v8, 8u, v18))
                                                          {
                                                            goto LABEL_110;
                                                          }
                                                        ...
                                                        case 1367:
                                                          if (v14 != 32)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: asyncMessageHisto(1367): (#32) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if (sub_100026C38(a1, "asyncMessageHisto_", v8, 8u, v18))
                                                          {
                                                            goto LABEL_110;
                                                          }
                                                          ...
                                                          goto LABEL_2993;
                                                        case 1368:
                                                          if (sub_10002E2CC(a1, "", "massScanIgnoredTooFrequent", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                        ...
                                                        case 1369:
                                                          if (v14 != 8)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: realGBBPerDipOfFailingDie(1369): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if (sub_100026C38(a1, "realGBBPerDipOfFailingDie_", v8, 8u, v18))
                                                          {
                                                            goto LABEL_110;
                                                          }
                                                          ...
                                                          goto LABEL_2993;
                                                        case 1379:
                                                          if (sub_10002E2CC(a1, "", "boffOrderedReadBlank", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1380:
                                                          if (sub_10002E2CC(a1, "", "boffOrderedRaidSuccessValidLba", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1381:
                                                          if (sub_10002E2CC(a1, "", "unexpectedRaidFailures", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1382:
                                                          if (sub_10002E2CC(a1, "", "boffOrderedUnexpectedBlankValid", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1383:
                                                          if (sub_10002E2CC(a1, "", "raidExpectedFailPMXReconstructionInternal", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1384:
                                                          if (sub_10002E2CC(a1, "", "raidExpectedFailPMXReconstructionHost", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1385:
                                                          if (sub_10002E2CC(a1, "", "raidExpectedFailBMXReconstructionInternal", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1386:
                                                          if (sub_10002E2CC(a1, "", "raidExpectedFailBMXReconstructionHost", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1392:
                                                          if (sub_10002E2CC(a1, "", "cbdrHPScanHP", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1393:
                                                          if (sub_10002E2CC(a1, "", "cbdrMPScanMP", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1394:
                                                          if (sub_10002E2CC(a1, "", "cbdrMPScanHP", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1401:
                                                          if (sub_10002E2CC(a1, "", "ldefragFailedMemBalancer", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1409:
                                                          if (sub_10002E2CC(a1, "", "BP_readThrottleEngagedCnt", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                          ...
                                                          goto LABEL_161;
                                                        case 1410:
                                                          if (sub_10002E2CC(a1, "", "BP_readThrottleActualSize", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                    ...
                                                    if (v12 > 1535)
                                                    {
                                                      if (v12 > 1542)
                                                      {
                                                        if (v12 <= 1544)
                                                        {
                                                          if (v12 == 1543)
                                                          {
                                                            if (v14 != 10)
                                                            {
                                                              sub_100012748("ASPFTLParseBufferToCxt: istkLowNoDIPingIntervals(1543): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                            }
                                                            ...
                                                            if ((sub_100026C38(a1, "istkLowNoDIPingIntervals_", v8, 8u, v18) & 1) == 0)
                                                            {
                                                          ...
                                                          else
                                                          {
                                                            if (v14 != 10)
                                                            {
                                                              sub_100012748("ASPFTLParseBufferToCxt: istkLowNoSUIPingIntervals(1544): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                            }
                                                            ...
                                                            if ((sub_100026C38(a1, "istkLowNoSUIPingIntervals_", v8, 8u, v18) & 1) == 0)
                                                            {
                                                        ...
                                                        if (v12 == 1545)
                                                        {
                                                          if (v14 != 6)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: istkLowAfterMedIntervals(1545): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if ((sub_100026C38(a1, "istkLowAfterMedIntervals_", v8, 8u, v18) & 1) == 0)
                                                          {
                                                        ...
                                                        if (v12 == 1547)
                                                        {
                                                          if (v14 != 5)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: istkHWBetweenMed(1547): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if ((sub_100026C38(a1, "istkHWBetweenMed_", v8, 8u, v18) & 1) == 0)
                                                          {
                                                        ...
                                                        if (sub_10002E2CC(a1, "", "uptimeSeconds", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                      ...
                                                      else if (v12 <= 1537)
                                                      {
                                                        if (v12 == 1536)
                                                        {
                                                          if (sub_10002E2CC(a1, "", "istkLowPings", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                        ...
                                                        {
                                                          if (sub_10002E2CC(a1, "", "istkLowNoDIPings", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                      ...
                                                      else
                                                      {
                                                        ...
                                                        {
                                                          case 0x602:
                                                            if (sub_10002E2CC(a1, "", "istkLowNoSUIPings", *v8))
                                                            {
                                                              goto LABEL_162;
                                                            }
                                                            ...
                                                            break;
                                                          case 0x603:
                                                            if (sub_10002E2CC(a1, "", "istkMedPings", *v8))
                                                            {
                                                              goto LABEL_162;
                                                            }
                                                            ...
                                                            break;
                                                          case 0x604:
                                                            if (sub_10002E2CC(a1, "", "istkHighPings", *v8))
                                                            {
                                                              goto LABEL_162;
                                                            }
                                                    ...
                                                    else
                                                    {
                                                      if (v12 > 1462)
                                                      {
                                                        if (v12 > 1532)
                                                        {
                                                          if (v12 == 1533)
                                                          {
                                                            if (v14 != 12)
                                                            {
                                                              sub_100012748("ASPFTLParseBufferToCxt: istkLowPingIntervals(1533): (#12) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                            }
                                                            ...
                                                            if ((sub_100026C38(a1, "istkLowPingIntervals_", v8, 8u, v18) & 1) == 0)
                                                            {
                                                          ...
                                                          else if (v12 == 1534)
                                                          {
                                                            if (v14 != 10)
                                                            {
                                                              sub_100012748("ASPFTLParseBufferToCxt: istkMedPingIntervals(1534): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                            }
                                                            ...
                                                            if ((sub_100026C38(a1, "istkMedPingIntervals_", v8, 8u, v18) & 1) == 0)
                                                            {
                                                          ...
                                                          else
                                                          {
                                                            if (v14 != 10)
                                                            {
                                                              sub_100012748("ASPFTLParseBufferToCxt: istkHighPingIntervals(1535): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                            }
                                                            ...
                                                            if ((sub_100026C38(a1, "istkHighPingIntervals_", v8, 8u, v18) & 1) == 0)
                                                            {
                                                        ...
                                                        if (v12 == 1463)
                                                        {
                                                          if (v14 != 6)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: nandReadsByMode(1463): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if ((sub_100026C38(a1, "nandReadsByMode_", v8, 8u, v18) & 1) == 0)
                                                          {
                                                        ...
                                                        if (v12 == 1494)
                                                        {
                                                          if (v14 != 20)
                                                          {
                                                            sub_100012748("ASPFTLParseBufferToCxt: throttlingSecPerTTPerMW(1494): (#20) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                          }
                                                          ...
                                                          if ((sub_100026C38(a1, "throttlingSecPerTTPerMW_", v8, 8u, v18) & 1) == 0)
                                                          {
                                                      ...
                                                      if (v12 <= 1449)
                                                      {
                                                        if (v12 == 1448)
                                                        {
                                                          if (sub_10002E2CC(a1, "", "deviceTempMaxValue", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                        ...
                                                        {
                                                          if (sub_10002E2CC(a1, "", "deviceTempHighValue", *v8))
                                                          {
                                                            goto LABEL_162;
                                                          }
                                                      ...
                                                      else
                                                      {
                                                        ...
                                                        {
                                                          case 0x5AA:
                                                            if (sub_10002E2CC(a1, "", "deviceTempLowValue", *v8))
                                                            {
                                                              goto LABEL_162;
                                                            }
                                                            ...
                                                            break;
                                                          case 0x5AC:
                                                            if (sub_10002E2CC(a1, "", "selfPanicEnabled", *v8))
                                                            {
                                                              goto LABEL_162;
                                                            }
                                                          ...
                                                          case 0x5B6:
                                                            if (v14 != 6)
                                                            {
                                                              sub_100012748("ASPFTLParseBufferToCxt: nandWritesByMode(1462): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                            }
                                                            ...
                                                            if ((sub_100026C38(a1, "nandWritesByMode_", v8, 8u, v18) & 1) == 0)
                                                            {
...
LABEL_2987:
                                                    ...
                                                    break;
                                                  case 1189:
                                                    if (sub_10002E2CC(a1, "", "lastLbaFormatTime", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 1190:
                                                    if (v14 != 11)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: powerDownTime(1190): (#11) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "powerDownTime_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1196:
                                                    if (v14 != 5)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectGBBedTotalCost(1196): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "poDetectGBBedTotalCost_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1197:
                                                    if (v14 != 10)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectGBBedAge(1197): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "poDetectGBBedAge_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1198:
                                                    if (v14 != 3)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: poDetectPERemovalMostSevereCost(1198): (#3) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "poDetectPERemovalMostSevereCost_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 1199:
                                                    if (sub_10002E2CC(a1, "", "poDetectCurrentSize", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 1201:
                                                    if (v14 != 4)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: gcVerticalSuccssfulAlignments(1201): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "gcVerticalSuccssfulAlignments_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1202:
                                                    if (v14 != 4)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: gcVerticalNoAlignmentDueToMissingSegs(1202): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "gcVerticalNoAlignmentDueToMissingSegs_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1211:
                                                    if (v14 != 24)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: forcedAllocationSmallEraseQ(1211): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "forcedAllocationSmallEraseQ_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1215:
                                                    if (v14 != 5)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: hostWritesPerThrottleZone(1215): (#5) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "hostWritesPerThrottleZone_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1216:
                                                    if (v14 != 24)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: tlcWLPerDipAvgPEC(1216): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "tlcWLPerDipAvgPEC_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1217:
                                                    if (v14 != 24)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: tlcWLPerDipMaxPEC(1217): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "tlcWLPerDipMaxPEC_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1218:
                                                    if (v14 != 24)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: tlcWLPerDipMinPEC(1218): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "tlcWLPerDipMinPEC_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 1221:
                                                    if (sub_10002E2CC(a1, "", "RD_openBandEvictBlocks", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1222:
                                                    if (sub_10002E2CC(a1, "", "RD_closedBandEvictBlocks", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 1223:
                                                    if (v14 != 10)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: RD_closedBlocksTHHist(1223): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "RD_closedBlocksTHHist_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1224:
                                                    if (v14 != 20)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: apfsValidLbaOvershoot(1224): (#20) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "apfsValidLbaOvershoot_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 1225:
                                                    if (sub_10002E2CC(a1, "", "HUPolicySwitchPeMinSlc", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1226:
                                                    if (sub_10002E2CC(a1, "", "HUPolicySwitchPeInt", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1227:
                                                    if (sub_10002E2CC(a1, "", "HUPolicySwitchPeGap", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 1228:
                                                    if (v14 != 6)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: HUPolicyWidthDown(1228): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "HUPolicyWidthDown_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                  ...
                                                  case 1229:
                                                    if (v14 != 6)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: HUPolicyWidthUp(1229): (#6) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "HUPolicyWidthUp_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 1230:
                                                    if (sub_10002E2CC(a1, "", "HUPolicyPrevPeSlc", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1231:
                                                    if (sub_10002E2CC(a1, "", "HUPolicyPrevPeTlc", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1232:
                                                    if (sub_10002E2CC(a1, "", "eanFastSize", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1233:
                                                    if (sub_10002E2CC(a1, "", "eanNumSlcEvictions", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                    ...
                                                    goto LABEL_161;
                                                  case 1234:
                                                    if (sub_10002E2CC(a1, "", "eanNumForcedCompress", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 1241:
                                                    if (v14 != 10)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: s2rTimeHisto(1241): (#10) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "s2rTimeHisto_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 1244:
                                                    if (sub_10002E2CC(a1, "", "calendarTimeWentBackward", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  case 1246:
                                                    if (v14 != 8)
                                                    {
                                                      sub_100012748("ASPFTLParseBufferToCxt: bandsUeccCrossTempHisto(1246): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                    }
                                                    ...
                                                    if (sub_100026C38(a1, "bandsUeccCrossTempHisto_", v8, 8u, v18))
                                                    {
                                                      goto LABEL_110;
                                                    }
                                                    ...
                                                    goto LABEL_2993;
                                                  case 1264:
                                                    if (sub_10002E2CC(a1, "", "numRefreshOnErrNandRefreshPerfOpt", *v8))
                                                    {
                                                      goto LABEL_162;
                                                    }
                                                  ...
                                                  default:
                                                    ...
                                                    {
                                                      case 1271:
                                                        if (sub_10002E2CC(a1, "", "deviceTempMax", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1272:
                                                        if (sub_10002E2CC(a1, "", "deviceTempHigh", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1273:
                                                        if (sub_10002E2CC(a1, "", "deviceTempLow", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1282:
                                                        if (sub_10002E2CC(a1, "", "cbdrScanHP", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1283:
                                                        if (sub_10002E2CC(a1, "", "cbdrScanMP", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1285:
                                                        if (sub_10002E2CC(a1, "", "bitsPerCell", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1289:
                                                        if (sub_10002E2CC(a1, "", "numRefreshOnErrNandRefreshPerfOptOpen", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                      ...
                                                      case 1293:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2EntryTime(1293): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2EntryTime_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1294:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2ExitTime(1294): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2ExitTime_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1295:
                                                        if (v14 != 8)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpHostChokeTime(1295): (#8) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpHostChokeTime_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1296:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2EntryHW(1296): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2EntryHW_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1298:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2ExitHW(1298): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2ExitHW_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1302:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2EntryHostTP(1302): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2EntryHostTP_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1303:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2EntryGCTP(1303): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2EntryGCTP_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1304:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2ExitHostTP(1304): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2ExitHostTP_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1305:
                                                        if (v14 != 16)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: bpZone2ExitGCTP(1305): (#16) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "bpZone2ExitGCTP_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                        ...
                                                        goto LABEL_2993;
                                                      case 1323:
                                                        if (sub_10002E2CC(a1, "", "prefetchNofHits", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1326:
                                                        if (sub_10002E2CC(a1, "", "massScanFullRounds", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1327:
                                                        if (sub_10002E2CC(a1, "", "massScanEarlyExits", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1328:
                                                        if (sub_10002E2CC(a1, "", "massScanMspFullScanRequests", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1329:
                                                        if (sub_10002E2CC(a1, "", "massScanMspEarlyExitRequests", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1333:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedRecoverableErrorGbbs", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1334:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedUnrecoverableErrorGbbs", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1335:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedBandOrphansNumBands", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1336:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedBandOrphansNumSectors", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1337:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedDefragEvents", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1338:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedDefragIterations", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1339:
                                                        if (sub_10002E2CC(a1, "", "gcBoffOrderedDefragSectors", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                      ...
                                                      case 1344:
                                                        if (v14 != 4)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: unhappyWideGC1(1344): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "unhappyWideGC1_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                      ...
                                                      case 1345:
                                                        if (v14 != 4)
                                                        {
                                                          sub_100012748("ASPFTLParseBufferToCxt: unhappyVertGC(1345): (#4) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                        }
                                                        ...
                                                        if (sub_100026C38(a1, "unhappyVertGC_", v8, 8u, v18))
                                                        {
                                                          goto LABEL_110;
                                                        }
                                                        ...
                                                        goto LABEL_2993;
                                                      case 1348:
                                                        if (sub_10002E2CC(a1, "", "thermalSelfThrottlingSupported", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                                        ...
                                                        goto LABEL_161;
                                                      case 1349:
                                                        if (sub_10002E2CC(a1, "", "thermalSelfThrottlingEnabled", *v8))
                                                        {
                                                          goto LABEL_162;
                                                        }
                                              ...
                                              if (v12 != 1148)
                                              {
                                                if (v12 == 1149)
                                                {
                                                  if (v14 != 24)
                                                  {
                                                    sub_100012748("ASPFTLParseBufferToCxt: gc_concurrent_dw_gc2(1149): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                                  }
                                                  ...
                                                  if ((sub_100026C38(a1, "gc_concurrent_dw_gc2_", v8, 8u, v18) & 1) == 0)
                                                  {
                                              ...
                                              if (v14 != 24)
                                              {
                                                sub_100012748("ASPFTLParseBufferToCxt: gc_concurrent_dw_gc1(1148): (#24) cfg elements != (%d) buffer elements", a2, a3, a4, a5, a6, a7, a8, v14);
                                              }
                                              ...
                                              if (sub_100026C38(a1, "gc_concurrent_dw_gc1_", v8, 8u, v18))
                                              {
LABEL_110:
                                                v10 = v18 + v10;
                                                goto LABEL_163;
...
LABEL_2993:
                                              sub_100012748(v19, a2, a3, a4, a5, a6, a7, a8, v21);
                                              return v10;
                                          }
                                      }
                                  }
