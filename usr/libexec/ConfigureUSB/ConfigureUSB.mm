uint64_t start()
{
  ...
  {
    *buf = 0;
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_DEFAULT, "Configuring USB", buf, 2u);
  }

  *buf = 0;
  for (i = IOUSBDeviceControllerCreate(); i; i = IOUSBDeviceControllerCreate())
  {
    warnx("unable to get USB device controller: 0x%x", i);
    sleep(3u);
  }

  v1 = *buf;
  v2 = malloc_type_calloc(0xFFuLL, 2uLL, 0x100004077774924uLL);
  if (!v2)
  {
    sub_10000849C();
    v20 = 71;
  ...
  if (!os_parse_boot_arg_string())
  {
    ...
    {
      v5 = v4;
      length = CFStringFind(v4, @"KeyMaker", 0).length;
      v7 = length | CFStringFind(v5, @"Horizon", 0).length;
      v8 = v7 != 0;
      if (v7)
      {
        printf("Use default USB configuration for keymaker/horizon ramdisk %s\n", "muxNcmAux");
        __strlcpy_chk();
      }
    ...
    if (!v8)
    {
      ...
      v10 = IORegistryEntrySearchCFProperty(Service, "IOService", @"darwin-configuration-string", kCFAllocatorDefault, 3u);
      if (v10)
      {
        v11 = v10;
        if (CFDataGetLength(v10) <= 255)
        {
          v33.length = CFDataGetLength(v11);
          v33.location = 0;
          CFDataGetBytes(v11, v33, v3);
          printf("Use USB configuration %s from device tree\n", v3);
          CFRelease(v11);
          goto LABEL_22;
        }

        printf("darwin-configuration-string length too long");
        CFRelease(v11);
LABEL_21:
        printf("Use default USB configuration %s\n", "muxNcmAux");
        __strlcpy_chk();
        goto LABEL_22;
      }
    }
...
LABEL_18:
  ...
  printf("Use USB configuration %s from boot-args\n", v3);
LABEL_22:
  v12 = CFStringCreateWithCString(kCFAllocatorDefault, v3, 0x600u);
  if (v12)
  {
    v13 = v12;
    printf("Starting USB config: %s\n", v3);
    v14 = IOUSBDeviceDescriptionCreateFromControllerWithType();
    if (v14)
    {
      v15 = v14;
      v16 = qword_10001C008;
      ...
      CFRetain(v16);
      v17 = qword_10001C008;
      CStringPtr = CFStringGetCStringPtr(qword_10001C008, 0);
      printf("Setting serial string as %s.\n", CStringPtr);
      IOUSBDeviceDescriptionSetSerialString();
      CFRelease(v17);
      v19 = IOUSBDeviceControllerSetDescription();
      v20 = 0;
      if (v19)
      {
        warnx("unable to set USB description: 0x%x", v19);
        v20 = 71;
      }
    ...
    {
      warnx("IOUSBDeviceDescriptionCreateFromControllerWithType failed");
      v20 = 71;
    }
  ...
  {
    warnx("CFStringCreateWithCString failed");
    v20 = 12;
  }
...
LABEL_31:
  ...
  if (v20)
  {
    v21 = "USB configuration fail!";
  }

  else
  {
    v21 = "USB configuration complete!";
  }

  puts(v21);
  *buf = 0;
  if (os_parse_boot_arg_int() && *buf)
  {
    if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      *v31 = 0;
      _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_DEFAULT, "Not disabling display due to boot-arg no_darwinos_disable_display=1", v31, 2u);
    }
  }

  else if ((os_variant_is_recovery() & 1) == 0)
  {
    sleep(0xB4u);
    if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      *buf = 0;
      _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_DEFAULT, "Disabling Display", buf, 2u);
    }
    ...
    if (DisplayList)
    {
      v23 = DisplayList;
      *v31 = 0;
      if (CFArrayGetCount(DisplayList) >= 1)
      {
        for (j = 0; j < CFArrayGetCount(v23); ++j)
        {
          ValueAtIndex = CFArrayGetValueAtIndex(v23, j);
          if (!*(ValueAtIndex + 2))
          {
            if (!CFStringGetCString(*ValueAtIndex, buf, 64, 0x8000100u))
            {
              __strlcpy_chk();
            }

            printf("found display: %s\n", buf);
            v26 = IOMobileFramebufferOpenByName();
            if (!v26)
            {
              break;
            }

            warn("unable to open framebuffer: 0x%x\n", v26);
          }
        }
      }

      warn("unable to get embedded display");
    }

    else
    {
      warn("unable to get display list");
    }

    puts("Display Off!");
  }

  if ((os_variant_allows_internal_security_policies() & 1) != 0 || !access("/var/db/darwinos-enable-usb", 0))
  {
    puts("Disabling Transport Restricted Mode");
    if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      *buf = 0;
      _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_DEFAULT, "Disabling Transport Restricted Mode", buf, 2u);
    }
    ...
    while (v27 == -14)
    {
      ...
      {
        *buf = 0;
        _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "Calling ACMTRMEnableRestrictedModeFromClient", buf, 2u);
      }

      *buf = 2;
      buf[4] = 0;
      v27 = ACMKernelControl(6);
      sleep(3u);
      --v28;
    }
    ...
    if (v27 == -6)
    {
      ...
      *buf = 0;
      v29 = "ACM not implemented on this platform";
      goto LABEL_70;
    }
    ...
    if (!v27)
    {
      ...
      *buf = 0;
      v29 = "Successfully disabled ACM";
LABEL_70:
      _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_DEFAULT, v29, buf, 2u);
      return v20;
    }
...
const char *acm_mem_alloc_info(const char *result, const void *a2, uint64_t a3, const char *a4, int a5, const char *a6)
{
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_alloc_info", v7, a2, a3, qword_10001C010, 0, qword_10001C018, qword_10001C020, v8, a5, v6);
  }
...
const char *acm_mem_free_info(const char *result, const void *a2, unint64_t a3, const char *a4, int a5, const char *a6)
{
  if (a2)
  {
    v6 = qword_10001C010 - a3;
    if (qword_10001C010 < a3)
    {
      v6 = 0;
    }
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_free_info", v8, a2, a3, qword_10001C010, 0, qword_10001C018, qword_10001C020, v9, a5, v7);
  }

  return result;
}

uint64_t sub_10000120C(void *a1, rsize_t __n)
{
...
LABEL_19:
            if (v22 != v16)
            {
              ...
              if (v16 - (v22 + 1) >= 4)
              {
                ...
                v29 = *(a2 + v22 + 1);
                v37 = v22 + 5;
                v12 = sub_100001EA0(a2, v16, &v37, &v36, &v35);
                if (!v12)
                {
                  *v33 = v21;
                  *a7 = v28;
...
LABEL_20:
                            ...
                            else
                            {
                              ...
                              v30 = *(a1 + v21);
                              v40 = v21 + 4;
                              v10 = sub_100001EA0(a1, v17, &v40, &v39, &v38);
                              if (!v10)
                              {
                                *v11 = v28;
                                *v36 = v34;
...
uint64_t sub_10000187C(unsigned int a1, _DWORD *a2)
{
  if (!a2)
  {
    sub_100002208();
  ...
  return qword_100012D20[v2];
}

uint64_t sub_100001A94@<X0>(uint64_t a1@<X8>, uint64_t a2)
{
  a2 = a1;

  return sub_100001D64(v4, v3, v2, &a2);
}
...
uint64_t sub_100001AD4(uint64_t a1, uint64_t a2, uint64_t a3, void *a4)
{
  result = 0;
  *a4 = 24;
  return result;
...
uint64_t sub_100001AE4(uint64_t a1, void *a2)
{
  result = 0;
  *a2 = 16;
  return result;
...
uint64_t sub_100001AF4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  a9 = *v9 - v12;
  v16 = *(v14 + 8 * v13);
...
uint64_t sub_100001B20(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11)
{

  return sub_100001C74(a2, a3, &a11);
}

uint64_t sub_100001B90(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22)
{
  a10 = 0;
  a11 = 0;
...
__n128 sub_100001BE4(__n128 *a1, uint64_t a2, __n128 *a3, _DWORD *a4)
{
  result = *a1;
  *a3 = *a1;
  *a4 = a1[1].n128_u32[0];
...
__n128 sub_100001C28@<Q0>(unsigned __int32 a1@<W1>, unsigned __int32 a2@<W2>, __n128 *a3@<X3>, void *a4@<X4>, __n128 *a5@<X8>)
{
  result = *a5;
  *a3 = *a5;
  a3[1].n128_u32[0] = a1;
...
uint64_t sub_100001D64(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  LODWORD(v6) = a2;
...
uint64_t sub_100001EA0(uint64_t a1, unint64_t a2, unint64_t *a3, void *size, _DWORD *a5)
{
  v10 = &gACMLoggingLevel;
  if (gACMLoggingLevel <= 0xAu)
  {
...
uint64_t sub_100002144(_DWORD *a1)
{
  if (!a1)
  {
    return 4294967293;
...
uint64_t sub_100002278(int a1, const char *a2)
{
  if (a1)
  {
...
void sub_10000233C(uint64_t a1, size_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{

  bzero(&a9 - a2, a2);
}

uint64_t sub_10000235C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, const char *a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, __int128 a13, __int128 a14)
{
  a13 = 0u;
  a14 = 0u;
...
uint64_t sub_100002450(uint64_t a1, uint64_t a2)
{
  ...
  {
    qword_10001C028 = ccrng();
    v3 = sub_100002278(-1, "ccrng");
    if (v3)
    {
      v6 = 0;
      v7 = 70;
...
void sub_10000259C()
{
  ...
  sub_10000233C(v6, v7, v8, v9, v10, v11, v12, v13, v20);
  if (v4)
  {
    if (v2)
    {
      if (v1)
      {
        if (v3)
        {
          if (v0)
          {
            ...
            if (v1 != -32)
            {
              if (v14 > *v0 || (sub_100002330(), v15 = ccgcm_init(), !sub_100002278(v15, "ccgcm_init")) && !sub_100002450(v3, 16) && (sub_100002308(), v16 = ccgcm_set_iv(), !sub_100002278(v16, "ccgcm_set_iv")) && (sub_100002330(), v17 = ccgcm_update(), !sub_100002278(v17, "ccgcm_update")) && (sub_100002308(), v18 = ccgcm_finalize(), !sub_100002278(v18, "ccgcm_finalize")))
              {
                *v0 = v14;
              }
            }
...
void sub_10000275C()
{
  ...
  sub_1000023A8();
  v6 = __chkstk_darwin(v5);
  sub_10000233C(v6, v7, v8, v9, v10, v11, v12, v13, v24);
  if (v4)
  {
    if (v2)
    {
      if (v1)
      {
        if (v3)
        {
          if (v0)
          {
            ...
            if (v1 != -33)
            {
              if (v14 > *v0 || (sub_100002330(), v15 = ccgcm_init(), !sub_100002278(v15, "ccgcm_init")) && (*v3 = 2, v16 = (v3 + 1), sub_100002414(), !v17) && !sub_100002450(v16, 16) && (sub_100002308(), v18 = ccgcm_set_iv(), !sub_100002278(v18, "ccgcm_set_iv")) && (v19 = v16 + 16, sub_100002414(), !v20) && (sub_100002330(), v21 = ccgcm_update(), !sub_100002278(v21, "ccgcm_update")) && !__CFADD__(v19, v1) && (sub_100002308(), v22 = ccgcm_finalize(), !sub_100002278(v22, "ccgcm_finalize")))
              {
                *v0 = v14;
              }
            }
...
void sub_10000294C()
{
  ...
  sub_10000233C(v11, v12, v13, v14, v15, v16, v17, v18, v25);
  if (v9)
  {
    if (v7)
    {
      if (v5)
      {
        if (v3)
        {
          if (v1)
          {
            ...
            if (v19)
            {
              if (*v1 < v20 || (sub_100002330(), v21 = ccgcm_init(), !sub_100002278(v21, "ccgcm_init")) && (sub_100002308(), v22 = ccgcm_set_iv(), !sub_100002278(v22, "ccgcm_set_iv")) && (sub_100002330(), v23 = ccgcm_update(), !sub_100002278(v23, "ccgcm_update")) && (sub_100002308(), ccgcm_finalize(), v24 = cc_cmp_safe(), !sub_100002278(v24, "cc_cmp_safe")))
              {
                *v1 = v20;
              }
            }
...
void sub_100002B28()
{
  ...
  sub_1000023A8();
  v11 = __chkstk_darwin(v10);
  sub_10000233C(v11, v12, v13, v14, v15, v16, v17, v18, v27);
  if (v9)
  {
    if (v7)
    {
      if (v5)
      {
        if (v3)
        {
          if (v1)
          {
            ...
            {
              v19 = v5 - 33;
              if (*v1 < v19 || (sub_100002414(), !v20) && *v7 == 2 && (sub_100002330(), v21 = ccgcm_init(), !sub_100002278(v21, "ccgcm_init")) && (sub_100002308(), v22 = ccgcm_set_iv(), !sub_100002278(v22, "ccgcm_set_iv")) && (sub_100002414(), !v23) && (sub_100002330(), v24 = ccgcm_update(), !sub_100002278(v24, "ccgcm_update")) && !__CFADD__(v7 + 17, v19) && (sub_100002308(), ccgcm_finalize(), v25 = cc_cmp_safe(), !sub_100002278(v25, "cc_cmp_safe")))
              {
                *v1 = v19;
              }
            }
...
uint64_t sub_10000335C(uint64_t result, int a2, unsigned __int8 a3, uint64_t a4, uint64_t a5, uint64_t a6, const void *a7, uint64_t a8, char a9, uint64_t a10, int a11, int a12, uint64_t a13)
{
  v20 = result;
  if (gACMLoggingLevel <= 0xAu)
  {
...
{
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v10 = "ACMLib";
    v11 = 2080;
  ...
  v8 = 0;
  v4 = LibCall_ACMContextCreate(sub_100006E98, &v8, a1, a2, &byte_10001C001, 1);
  if (v4)
  {
    sub_100006ABC();
    v5 = 70;
  ...
  if (v5 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v10 = "ACMLib";
    v11 = 2080;
...
uint64_t ACMContextCreateWithExternalForm(uint64_t a1, uint64_t a2)
{
  ...
  v8 = 0;
  v4 = LibCall_ACMContextCreateWithExternalForm(sub_100006E98, &v8, a1, a2, &byte_10001C001, 1);
  if (v4)
  {
    if (byte_10001C001 <= 0x28u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
    {
      v5 = *(v4 + 16);
      *buf = 136315650;
      v10 = "ACMLib";
  ...
  if (v6 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v10 = "ACMLib";
    v11 = 2080;
...
uint64_t ACMContextDelete(_DWORD *a1, uint64_t a2)
{
  ...
  v10 = a1;
  v7 = LibCall_ACMContextDelete(sub_100006E98, &v10, a1, v2);
  if (v7)
  {
    v8 = 70;
  }
  ...
  if (v8 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v12 = "ACMLib";
    v13 = 2080;
...
void ACMContextGetExternalForm(const void *a1, uint64_t a2)
{
  ...
  if (a1 && a2)
  {
    if (!sub_10000705C() && !sub_100007210(a1, 19, 0, a1, 0x10uLL, 0, 0))
    {
      (*(a2 + 16))(a2, a1, 16);
      goto LABEL_9;
    }
...
uint64_t ACMContextVerifyPolicy(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  v9 = a1;
  v6 = LibCall_ACMContextVerifyPolicy_Block(sub_100006E98, &v9, a1, a2, a3);
  if (v6)
  {
    v7 = 70;
  }
  ...
  if (v7 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v11 = "ACMLib";
    v12 = 2080;
...
uint64_t ACMContextVerifyPolicyWithPreflight(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  v11 = a1;
  v8 = LibCall_ACMContextVerifyPolicyWithPreflight_Block(sub_100006E98, &v11, a1, a2, a3, a4);
  if (v8)
  {
    v9 = 70;
  }
  ...
  if (v9 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v13 = "ACMLib";
    v14 = 2080;
...
void ACMContextVerifyPolicyEx(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  ...
  v14 = a1;
  LibCall_ACMContextVerifyPolicyEx_Block(sub_100006E98, &v14, a1, a2, a3, a4, a5, a6, a7);
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v16 = "ACMLib";
...
uint64_t ACMParseAclAndCopyConstraintCharacteristics(const void *a1, uint64_t a2, uint64_t a3)
{
  ...
  SerializedProcessAclSize = sub_10000705C();
...
LABEL_31:
  ...
  v13 = sub_100007210(0, 20, 0, v9, size, v12, &__n);
  v11 = __n;
  if (v13)
  {
    v6 = v13;
...
LABEL_19:
  ...
  if (v17 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v22 = "ACMLib";
    v23 = 2080;
...
void ACMGetAclAuthMethod(__n128 *a1, uint64_t a2)
{
  ...
  v4 = a1;
  LibCall_ACMGetAclAuthMethod_Block(sub_100006E98, &v4, a1, a2);
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v6 = "ACMLib";
...
uint64_t ACMGetEnvironmentVariable(uint64_t a1, uint64_t a2)
{
  ...
  v7 = 0;
  v4 = LibCall_ACMGetEnvironmentVariable_Block(sub_100006E98, &v7, a1, a2);
  if (v4)
  {
    v5 = 70;
  }
...
uint64_t ACMKernelControl(int a1)
{
  ...
  v2 = LibCall_ACMKernelControl_Block(sub_100006E98);
  if (v2)
  {
    v3 = 70;
  }
  ...
  if (v3 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315906;
    v6 = "ACMLib";
    v7 = 2080;
...
void ACMGlobalContextCredentialGetProperty(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  v6 = 0;
  LibCall_ACMGlobalContextCredentialGetProperty_Block(sub_100006E98, &v6, v5, v4, a3);
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  {
    v9 = a1;
    v8 = LibCall_ACMContextCredentialGetProperty(sub_100006E98, &v9, a1, v6, v5, buf, &v10);
    (*(a4 + 16))(a4, v8, buf, v10);
  }
...
uint64_t ACMContextSetDataEx(uint64_t a1, int a2, int a3, int a4, int a5, int a6)
{
  ...
  v12 = LibCall_ACMContextSetData(sub_100006E98, &v16, a1, a2, a3, a4, a5, a6, v15, a1, *buf, *&buf[8], *&buf[16], v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28);
  if (v12)
  {
    v13 = 70;
  }
  ...
  if (v13 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    *&buf[4] = "ACMLib";
    *&buf[12] = 2080;
...
uint64_t ACMContextCopyData(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  ...
  v13 = 0;
  v10 = LibCall_ACMContextCopyData(sub_100006E98, &v13, a1, a2, a3, a4);
  if (v10)
  {
    v11 = 70;
  }
  ...
  if (v11 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v15 = "ACMLib";
    v16 = 2080;
...
uint64_t ACMContextGetInfo(__int128 *a1, uint64_t a2, void *a3)
{
  ...
  v9 = a1;
  v6 = LibCall_ACMContextGetInfo(sub_100006E98, &v9, a1, v4, a3);
  if (v6)
  {
    v7 = 70;
  }
...
void sub_100006ABC()
{
  ...
  output = 0;
  outputCnt = 1;
  if (IOConnectCallScalarMethod(dword_10001C034, 2u, 0, 0, &output, &outputCnt))
  {
    goto LABEL_12;
  }

  v0 = output;
  byte_10001C001 = output;
...
uint64_t sub_100006D80(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, size_t a5)
{

  return sub_100007210(a1, a2, 0, v5, a5, 0, 0);
}

uint64_t sub_100006E98(uint64_t *a1, uint64_t a2, uint64_t a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100006D74();
  ...
  if (a1)
  {
    ...
    {
      v21 = sub_100007210(*a1, a2, a3, a4, a5, a6, a7);
      if (v21)
      {
        v20 = 70;
      }
  ...
  if (v20 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100006E64();
    sub_100006DAC();
    sub_100006D00();
...
uint64_t sub_10000705C()
{
  ...
  else
  {
    ...
    v8 = MatchingService;
    v5 = IOServiceOpen(MatchingService, mach_task_self_, 0, &dword_10001C034);
    if (v5)
    {
      v9 = 70;
      goto LABEL_10;
...
uint64_t sub_100007210(uint64_t a1, uint64_t a2, uint64_t a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  v11 = a3;
  v12 = a2;
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  ...
  if (v18)
  {
    ...
    else
    {
      ...
      v41 = v20;
      v21 = IOConnectCallStructMethod(dword_10001C034, 0, v18, inputStructCnt, a6, &v41);
      if (v21)
      {
        if (byte_10001C001 <= 0x46u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
        {
          sub_100006CE8();
          sub_100006E1C();
          v46 = v22;
  ...
  if (v34 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    v43 = 136315650;
    v44 = "ACMLib";
    sub_100006D5C();
...
void sub_100007BD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{

  LibCall_ACMSetEnvironmentVariable();
}

uint64_t sub_100007BF8(uint64_t (*a1)(uint64_t, void, void, const void *, size_t, _DWORD *, unint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, const void *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
...
void sub_1000084C8(int a1)
{
  warnx("unable to disable TRM, ACM returned error: %d", a1);
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_FAULT))
  {
    *buf = 67109120;
    v3 = a1;
    _os_log_fault_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_FAULT, "Unable to disable TRM: ACMStatus=%d", buf, 8u);
  }
}
...
void acm_mem_free_data(void *a1, rsize_t a2)
{
  if (a1)
  {
    sub_10000120C(a1, a2);
    free(v3);
    v4 = qword_10001C018 - v2;
    if (qword_10001C018 < v2)
    {
      v4 = 0;
    }
...
void acm_mem_free(void *a1, rsize_t a2)
{
  if (a1)
  {
    sub_10000120C(a1, a2);
    free(v3);
    v4 = qword_10001C020 - v2;
    if (qword_10001C020 < v2)
    {
      v4 = 0;
    }
  ...
  if (v5)
  {
    if (v1)
    {
      ...
      if (v4)
      {
        ...
        {
          v10 = v9;
          result = sub_100001C74(v8, v7, &v11);
          if (!result)
          {
            *v6 = v10 + v11 + 26;
          }
                ...
                if (v9)
                {
                  ...
                  *v4 = *a1;
                  ...
                  else
                  {
                    ...
                    v21 = *(a1 + v18 + 18);
                    v26 = v18 + 22;
                    result = sub_100001EA0(a1, v16, &v26, &v25, &v24);
                    if (!result)
                    {
                      *v11 = v19;
                      *v12 = v20;
  ...
  if (v15)
  {
    if (a11)
    {
      if (a10 <= 0xA && (a9 != 0) == (a10 != 0))
      {
        v16 = v14;
        v17 = v13;
        result = sub_100001C74(a9, a10, &v21);
        if (!result)
        {
          v18 = 29;
          if (a1 == 32)
...
uint64_t SerializeVerifyAclConstraint(int a1, _OWORD *a2, const void *a3, unsigned int a4, const void *a5, unsigned int a6, char a7, int a8, uint64_t a9, unsigned int a10, uint64_t a11, uint64_t *a12)
{
  ...
  if (a12)
  {
    ...
    {
      v30 = 0;
      result = sub_100001C74(a9, a10, &v30);
      if (!result)
      {
        v20 = 29;
        if (a1 == 32)
        ...
        else
        {
          ...
          *(v26 + 1) = v23;
          v29 = v24 + 5;
          result = sub_100001D64(a9, a10, a11, &v29);
          if (!result)
          {
            *a12 = v29;
          }
...
uint64_t GetSerializedProcessAclSize(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void *a9)
{
  ...
  if (v14)
  {
    ...
    if (v10)
    {
      ...
      {
        v16 = v11;
        result = sub_100001C74(v12, v13, &v17);
        if (!result)
        {
          *a9 = v15 + v16 + v17 + 36;
        }
          ...
          if (a8 <= 0xA && (a7 != 0) == (a8 != 0))
          {
            ...
            if (!result)
            {
              ...
              else
              {
                ...
                *(a9 + v19) = v15;
                v20 = v19 + 4;
                result = sub_100001D64(a7, v13, a9, &v20);
                if (!result)
                {
                  *a10 = v20;
                }
      ...
      if ((v7 & 0x30) != 0)
      {
        *a3 = 20;
        while (*(a2 + 16))
        {
          ...
          sub_100001B78(v9, v10, v11, v12, v13, v14, v15, v16, v25, v26);
        }
      }
      ...
      else if (v6 == 7)
      {
        *a3 = 24;
        while (*(a2 + 20))
        {
          ...
          sub_100001B78(v17, v18, v19, v20, v21, v22, v23, v24, v25, v26);
        }
      }
    }
          ...
          if (v7 == __s2[7])
          {
            switch(*__s1)
            {
              ...
              case 0x17:
                ...
                goto LABEL_8;
              case 7:
                if (sub_100001AB8() || memcmp(__s1 + 32, v5 + 8, 0x20uLL))
                {
                  break;
                }
              ...
              case 9:
                ...
                goto LABEL_33;
              case 0xA:
                if (sub_100001AB8() || memcmp(__s1 + 36, v5 + 9, 0x10uLL))
                {
                  break;
                }
...
double LibSer_GetSerializedContainsCredential_Serialize(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, __n128 *a4, void *a5)
{
  ...
  {
    *&result = sub_100001C28(a2, a3, a4, a5, a1).n128_u64[0];
  }
...
uint64_t LibSer_ContextCredentialGetProperty_GetSize(uint64_t a1, uint64_t a2, uint64_t a3, void *a4)
{
  if (a4)
  {
    return sub_100001AD4(a1, a2, a3, a4);
  }
...
uint64_t LibSer_StorageSetData_GetSize(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  result = sub_100001B20(a1, a2, a3, a4, a5, a6, a7, a8, v11, v12, 0);
  if (!result)
  {
    *v8 = v9 + v13 + 28;
  }
...
uint64_t LibSer_StorageSetData_Deserialize(__n128 *a1, unint64_t a2, __n128 *a3, _DWORD *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  if (a1 && a2 >= 0x18 && a3 && a4 && a5 && a6 && a7 && a8)
  {
    ...
    *v17 = v16;
    ...
    return sub_100001EA0(v11, v12, v20, v14, v15);
  }
...
uint64_t LibSer_StorageGetData_Deserialize(__n128 *a1, unint64_t a2, __n128 *a3, _DWORD *a4, uint64_t a5)
{
  ...
  if (a1 && a2 >= 0x15 && a3 && a4 && a5)
  {
    ...
    *v9 = *(v8 + 20) != 0;
    v14[0] = 21;
    return sub_100001EA0(v8, v10, v14, v11, v12);
  }
...
void LibSer_GetUnlockSecret_Serialize(_OWORD *a1, uint64_t a2, uint64_t a3, _OWORD *a4, uint64_t a5)
{
  if (a1)
  {
    if (a4)
    {
      ...
      {
        sub_100001C04();
        if (!sub_100001C74(v8, a3, v9))
        {
          sub_100001BF8();
          if (v10)
          {
            *a4 = *a1;
            v11 = sub_100001A94(16, v19);
            if (!v11)
            {
              sub_100001C1C(v11, v12, v13, v14, v15, v16, v17, v18, v20);
            }
          }
        }
      }
...
uint64_t LibSer_GetUnlockSecret_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5)
{
  ...
  if (a2 >= 0x10 && a3 && a4)
  {
    if (a5)
    {
      ...
      *a3 = *a1;
      v9[0] = 16;
      return sub_100001EA0(a1, a2, v9, a4, a5);
    }
  }
    ...
    if (v26)
    {
      ...
      if (!sub_100001C74(v36, v34, v37))
      {
        ...
        if (v38)
        {
          ...
          a9 = 16;
          if (!sub_100001D64(v35, v34, v31, &a9))
          {
            v39 = a9;
            *(v31 + a9) = v32;
            v40 = v39 + 4;
...
uint64_t LibSer_SEPControl_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5, unint64_t *a6, void *a7)
{
  ...
  if (a2 >= 0x18 && a3 && a4 && a5 && a6 && a7)
  {
    *a3 = *a1;
    v12 = 16;
    result = sub_100001EA0(a1, a2, &v12, a4, a5);
    if (!result)
    {
      v11 = a1 + v12 + 4;
      *a7 = *(a1 + v12);
...
uint64_t LibSer_ACMDeserializeSEPControlCode()
{
  ...
  if (v1 && v2)
  {
    ...
    {
      v11 = 16;
      v6 = sub_100001EA0(v1, v2, &v11, &v10, &v9);
      if (v6)
      {
        v5 = v6;
      }
...
uint64_t crypto_deriveKeyAndEncryptData(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t *a10)
{
  ...
  else
  {
    ...
    if (a9)
    {
      v30 = sub_10000235C(v11, v12, v13, v14, v15, v16, v17, v18, v31, v32, v33, v34, v35[0], v35[1]);
      if (v30)
      {
        v10 = v30;
      }
...
LABEL_25:
  ...
  v28 = sub_10000235C(v11, v12, v13, v14, v15, v16, v17, v18, v29, v30, v31, v32, v33[0], v33[1]);
  if (v28)
  {
    v10 = v28;
  }
...
void ACMContextAddCredentialWithScope(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, size_t size, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  ...
  if (v27 && (v34 & 1) == 0)
  {
    if (sub_10000705C() || (v35 = sub_100006CB4(), GetSerializedAddCredentialSize(v35, v36, v37, v38)))
    {
      sub_100006DF8();
    }
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_100006D80(v26, 5, v44, v45, size);
        }
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        *(v12 + 5) = a3;
        sub_100006DC8();
        v3 = sub_100007210(v18, v19, v20, v21, v22, 0, 0);
        sub_100006DA0();
...
void ACMContextRemoveCredentialsByValueAndScope(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, size_t size, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  ...
  if (v27 && (v34 & 1) == 0)
  {
    if (sub_10000705C() || (v35 = sub_100006CB4(), GetSerializedRemoveCredentialSize(v35, v36, v37, v38)))
    {
      sub_100006DF8();
    }
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_100006D80(v26, 6, v44, v45, size);
        }
...
void ACMContextReplacePassphraseCredentialsWithScope(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, size_t size, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  ...
  if (v27 && (v34 & 1) == 0)
  {
    if (sub_10000705C() || (v35 = sub_100006CB4(), GetSerializedReplacePassphraseCredentialSize(v35, v36, v37, v38)))
    {
      sub_100006DF8();
    }
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_100006D80(v26, 15, v44, v45, size);
        }
...
uint64_t ACMContextContainsPassphraseCredentialWithPurpose(_OWORD *a1, int a2, int a3)
{
    ...
    else
    {
      ...
      if (v14)
      {
        *v14 = *a1;
        ...
        v14[5] = a3;
        sub_100006DC8();
        v27 = sub_100007210(v20, v21, v22, v23, v24, v25, v26);
        if (v27)
        {
          v28 = v27;
        }
  ...
  if (*(v3 + 1) <= 0x46u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100006C68();
    sub_100006CC4();
...
LABEL_13:
  ...
  if (v10 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100006DAC();
    sub_100006D00();
    sub_100006D10();
...
LABEL_11:
  v18 = 70;
LABEL_15:
  if (v18 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *size_4 = 136315650;
    *&size_4[4] = "ACMLib";
    *&size_4[12] = 2080;
  ...
  if (!a4)
  {
    switch(a2)
    {
      ...
      case 304:
        ...
        if (v25)
        {
          *(a1 + 185) = sub_100007AE0(v21, v22, v23);
        }
...
LABEL_155:
    ...
    case 0x1F5:
      ...
      {
LABEL_50:
        *(a1 + 9) = sub_100007AE0(v10, v11, v12);
      }
    ...
    case 0x1F6:
      ...
      {
LABEL_140:
        *(a1 + 13) = sub_100007AE0(v61, v62, v63);
      }
    ...
    case 0x1F7:
      ...
      if (v45)
      {
        *(a1 + 17) = sub_100007AE0(v41, v42, v43);
      }
...
LABEL_143:
  ...
  if (a2 != 701)
  {
    if (a2 == 801)
    {
      ...
      if (v37)
      {
        *(a1 + 2) = sub_100007AE0(v33, v34, v35);
      }
...
uint64_t LibCall_ACMSecSetBuiltinBiometry(uint64_t a1, uint64_t a2)
{
  ...
  v3 = sub_100007AF8();
  sub_100007BD8(v3, v4, 30, v5, v6, v7, v8);
  sub_1000023FC();
  if (v9)
  {
    v10 = 10;
