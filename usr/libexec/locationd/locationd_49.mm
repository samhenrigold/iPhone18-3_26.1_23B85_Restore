_DWORD *sub_1003237B8(_DWORD *a1, _DWORD *a2)
{
  if (a1 == a2)
  {
    sub_101A26924();
...
uint64_t sub_100323A14@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, _DWORD *a3@<X8>)
{
  if ((a1 & 0x80000000) != 0)
  {
    sub_101A261B4();
  ...
  if (v6)
  {
    if (v9 != v8)
    {
      ...
      while (1)
      {
        ...
        {
          v22 = *(a1 + 104);
          if (fabsf(v13) > v22 || fabsf(v15) > v22)
          {
            *(a1 + 96) = v11;
          }
        }
        ...
        if (v11 - *(a1 + 96) <= *(a1 + 88) || (sub_1001E9DA0(*(a1 + 64), v7) & 1) != 0)
        {
          if (*(a1 + 108) == 1)
          {
            ...
            if (os_log_type_enabled(qword_1025D4608, OS_LOG_TYPE_INFO))
            {
              ...
              *&buf[15] = 2050;
              *&buf[17] = v29;
              _os_log_impl(dword_100000000, v27, OS_LOG_TYPE_INFO, "#pbio, ending forced static period, input static flag, %{public}d, time since last non-negligible delta position, %{public}.3f, threshold, %{public}.3f", buf, 0x19u);
            }
            ...
            if (sub_10000A100(121, 2))
            {
              ...
              *&v80[13] = v52;
              LODWORD(v61) = 25;
              _os_log_send_and_compose_impl(2, 0, buf, 1628, dword_100000000, qword_1025D4608, 1, "#pbio, ending forced static period, input static flag, %{public}d, time since last non-negligible delta position, %{public}.3f, threshold, %{public}.3f", &v79, v61);
              v54 = v53;
...
LABEL_10:
        ...
        if (os_log_type_enabled(qword_1025D4608, OS_LOG_TYPE_INFO))
        {
          ...
          *&buf[15] = 2050;
          *&buf[17] = v25;
          _os_log_impl(dword_100000000, v23, OS_LOG_TYPE_INFO, "#pbio, starting forced static period, input static flag, %{public}d, time since last non-negligible delta position, %{public}.3f, threshold, %{public}.3f", buf, 0x19u);
        }
        ...
        if (sub_10000A100(121, 2))
        {
          ...
          *&v80[13] = v48;
          LODWORD(v61) = 25;
          _os_log_send_and_compose_impl(2, 0, buf, 1628, dword_100000000, qword_1025D4608, 1, "#pbio, starting forced static period, input static flag, %{public}d, time since last non-negligible delta position, %{public}.3f, threshold, %{public}.3f", &v79, v61);
          v50 = v49;
          sub_100152C7C("Generic", 1, 0, 2, "void CLProactiveInertialOdometryManager::exportBackgroundInertialOdometrySamplesToRoutine(const std::vector<CLPIOSample> &)", "%s\n", v49);
          if (v50 != buf)
          {
...
LABEL_26:
      *(a1 + 108) = v26;
      if (*(a1 + 50) == 1)
      {
        ...
        v30 = qword_1025D4608;
        v31 = os_log_type_enabled(qword_1025D4608, OS_LOG_TYPE_DEBUG);
        if (v31)
        {
          v33 = sub_10000B1F8(v31, v32);
          *buf = 0;
          v65 = sub_10001A6B0(v33, buf);
        ...
        if (sub_10000A100(121, 2))
        {
          ...
          v41 = qword_1025D4608;
          v64 = sub_1000281DC(v39, v40);
          v44 = sub_1000281DC(v42, v43);
          v79 = 134355457;
          *v80 = v10;
          *&v80[8] = 2050;
          *&v80[10] = v11;
          ...
          *&v80[20] = v12;
          ...
          v126 = v44 - v10;
          LODWORD(v61) = 204;
          _os_log_send_and_compose_impl(2, 0, buf, 1628, dword_100000000, v41, 2, "#pbio Routine, userCfAbsoluteTimestamp_s, %{public}.3f, machContinuousTimestamp_s, %{public}.3f, sampleInterval_s, %{public}.3f, dPosX_m, %{private}+.3f, dPosY_m, %{private}+.3f, dPosZ_m, %{private}+.3f, dVelX_mps, %{private}+.3f, dVelY_mps, %{private}+.3f, dVelZ_mps, %{private}+.3f, qX, %{private}+.3f, qY, %{private}+.3f, qZ, %{private}+.3f, qW, %{private}+.3f, rotationToTrueNorthFromMagnetometer_rad, %{private}+.3f, referenceFrameContinuity, %{public}d, referenceFrame, %{public}d, staticFlag, %{public}d, isDeltaPositionValid, %{private}d, isRotationToTrueNorthFromMagnetometerValid, %{private}d, isDeltaVelocityValid, %d, isAttitudeValid, %{private}d, zuptIndicator, %{private}d, dotChangeIndicator, %{private}d, mountState, %{private}d,now, %{public}.3f, diffNowMinusSample, %{public}.3f", &v79, v61);
          v46 = v45;
          sub_100152C7C("Generic", 1, 0, 2, "void CLProactiveInertialOdometryManager::exportBackgroundInertialOdometrySamplesToRoutine(const std::vector<CLPIOSample> &)", "%s\n", v45);
          if (v46 != buf)
          {
      ...
      v38 = [CLBackgroundInertialOdometrySample alloc];
      *buf = v10;
      *&buf[8] = v11;
      *&buf[16] = v66;
      *&buf[24] = v12;
      ...
      *&v129[24] = v77;
      ...
      v129[46] = v21;
      v129[47] = v67;
      [v4 addObject:{objc_msgSend(v38, "initWithCLPIOSample:", buf)}];
      goto LABEL_33;
    }
  }
  ...
  else
  {
    for (; v9 != v8; v9 += 7)
    {
      v55 = [CLBackgroundInertialOdometrySample alloc];
      v56 = *v9;
      v57 = v9[2];
      *&buf[16] = v9[1];
      *v128 = v57;
      ...
      *&v128[16] = v58;
      *v129 = v59;
      [v4 addObject:{objc_msgSend(v55, "initWithCLPIOSample:", buf)}];
    }
  }
...
void sub_100326B7C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_100B314E8(va);
  _Unwind_Resume(a1);
...
uint64_t sub_100327AF4(float *a1, void *a2)
{
  v4 = sub_100007070(a1, a2 + 2);
  a2[1] = v4;
  v5 = *(a1 + 1);
  if (v5)
  {
...
void sub_100327DAC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_100328364(va);
  _Unwind_Resume(a1);
...
void sub_100327DC4(uint64_t a1, uint64_t a2, double a3)
{
  v5 = sub_10001A3E8(a1, a2);
  if (sub_100328630(v5, v6))
  {
    v7 = [NSString stringWithFormat:@"%@/mapmatcher_%@.clmm", @"/var/mobile/Library/Logs/locationd/mapmatcher", sub_100328668([NSDate dateWithTimeIntervalSinceReferenceDate:a3])];
    v8 = [(NSString *)v7 UTF8String];
    v9 = strlen(v8);
    ...
    *(&__dst + v10) = 0;
    ...
    v13 = [NSFileHandle fileHandleForWritingAtPath:v7];
    if (!v13)
    {
      goto LABEL_29;
    }
    ...
    v25 = 0;
    v14 = [NSKeyedArchiver archivedDataWithRootObject:a1 requiringSecureCoding:1 error:&v25];
    if ([(NSData *)v14 length])
    {
      [(NSFileHandle *)v13 seekToEndOfFile];
      [(NSFileHandle *)v13 writeData:[[NSString dataUsingEncoding:@"clmm stringWithFormat:%d, AA", a3, [(NSData *)v14 length]], "dataUsingEncoding:", 4]];
      [(NSFileHandle *)v13 writeData:v14];
      ...
      {
        v16 = [(NSData *)v14 length];
        *buf = 67240192;
        *&buf[4] = v16;
        _os_log_impl(dword_100000000, v15, OS_LOG_TYPE_INFO, "CLMM,Recorder,writeToFile,success,length,%{public}d", buf, 8u);
      }
      ...
      sub_101A2EBF0(buf);
      v17 = qword_1025D46B8;
      v18 = [(NSData *)v14 length];
      v28[0] = 67240192;
      v28[1] = v18;
      LODWORD(v24) = 8;
      _os_log_send_and_compose_impl(2, 0, buf, 1628, dword_100000000, v17, 1, "CLMM,Recorder,writeToFile,success,length,%{public}d", v28, v24);
      v20 = v19;
    ...
    else
    {
      ...
      {
        *buf = 0;
        _os_log_impl(dword_100000000, v21, OS_LOG_TYPE_INFO, "CLMM,Recorder,writeToFile,failed as date length is 0", buf, 2u);
      }
      ...
      LOWORD(v28[0]) = 0;
      LODWORD(v23) = 2;
      _os_log_send_and_compose_impl(2, 0, buf, 1628, dword_100000000, qword_1025D46B8, 1, "CLMM,Recorder,writeToFile,failed as date length is 0", v28, v23);
      v20 = v22;
      sub_100152C7C("Generic", 1, 0, 2, "void logRecorder::writeToFile(id, CFAbsoluteTime)", "%s\n", v22);
      if (v20 == buf)
      {
...
uint64_t sub_1003283C0(_DWORD *a1, wireless_diagnostics::google::protobuf::io::CodedInputStream *this, unsigned int a3)
{
  do
  {
    while (1)
...
LABEL_9:
    ...
    result = sub_100AB9384(this, a1 + 2);
    if (!result)
    {
      return result;
    }
...
void sub_100328618(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
...
uint64_t sub_100328630(uint64_t a1, uint64_t a2)
{
...
uint64_t sub_100328880(mach_port_t a1, int a2, int *a3, uint64_t a4, int a5, _OWORD *a6, uint64_t *a7, int *a8, _DWORD *a9, _DWORD *a10, _DWORD *a11, _DWORD *a12)
{
  v31 = 1;
  v32 = a4;
  v33 = 16777472;
...
uint64_t sub_100328C74(mach_port_t a1, int a2, int a3, int a4, _OWORD *a5, uint64_t a6, int a7, _OWORD *a8, uint64_t *a9, int *a10)
{
  v19 = 1;
  v20 = a6;
  v21 = 16777472;
...
uint64_t sub_100329FC4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, unsigned int a10, uint64_t a11, uint64_t *a12, unsigned int a13, unsigned int a14)
{
  v18 = v14 - 131;
  v19 = (v14 + 979) | 0x141;
  v20 = v14 + 689;
...
uint64_t sub_10032A32C@<X0>(int a1@<W8>, uint64_t a2, unsigned int a3, uint64_t a4, uint64_t *a5, unsigned int a6, unsigned int a7)
{
...
uint64_t sub_10032A89C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, int a11, int a12, char a13, char *a14, unsigned int a15, unsigned int a16, char *a17, uint64_t a18)
{
...
uint64_t sub_10032B344(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, int a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, uint64_t a16, int a17, unsigned int a18, unsigned int a19, char *a20, unsigned int a21)
{
...
uint64_t sub_10032C01C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  *(v67 + 264) = a66;
  ...
  return sub_10034012C(a1, a65, a3, a4, a5, a6, a7, a8);
}
...
uint64_t sub_10032C18C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, uint64_t a16, uint64_t a17, unsigned int a18, unsigned int a19)
{
...
void sub_10032D2DC(uint64_t a1)
{
  __chkstk_darwin(a1);
  if (*(v1 + 24))
  {
...
uint64_t sub_10032FAA0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, int a14, unsigned int a15, unsigned int a16, char *a17, unsigned int a18)
{
...
uint64_t sub_10033040C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15, uint64_t a16, uint64_t a17, int a18, unsigned int a19, unsigned int a20, char *a21, unsigned int a22)
{
...
uint64_t sub_100330644(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int32x4_t a20, int32x4_t a21, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, int32x4_t a22, int32x4_t a23)
{
  a22 = vdupq_n_s32(0xF9467F82);
  a23 = a22;
...
uint64_t sub_1003317C0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, int a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, unsigned int a20, unsigned int a21)
{
  v28 = &a17;
...
void sub_100331D90(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, _DWORD *a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, _DWORD **a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, ...)
{
  ...
  else
  {
    ...
    *v67 = v65;
    **(&off_10244F320 + (v61 ^ 0xEA02B466)) = 255;
...
uint64_t sub_100332A10(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, int a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, unsigned int a21, unsigned int a22)
{
  v27 = &a18 | 0xF62481BB;
  a18 = a13;
...
uint64_t sub_10033928C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, int a18, unsigned int a19, unsigned int a20, char *a21, unsigned int a22)
{
...
uint64_t sub_10033949C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
  *(va + a5) = HIDWORD(a2) + v11 - ((v12 + 15 + a1) & (2 * HIDWORD(a2)));
  return sub_10036F2E4(a1, va, v12 + 15);
}
...
void sub_10033AEEC(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X8>, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8, unsigned int a9)
{
  *(*(a1 + 96) + 528) = 64;
  *(*(a1 + 96) + 532) = 763308221;
  *(*(a1 + 96) + 536) = *(a1 + 96) + 544;
...
uint64_t sub_10033C754(uint64_t a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8, uint64_t a9, uint64_t a10)
{
  ...
  return sub_10033C830(a4, (a8 - 1796304963) | 0x103u);
}
...
uint64_t sub_10033CBBC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, unsigned int a9, unsigned int a10, uint64_t a11, unsigned int a12)
{
...
uint64_t sub_10033D6E8(uint64_t a1, uint64_t a2, uint64_t a3, int a4, uint64_t a5, uint64_t a6, int a7, uint64_t a8, int32x4_t a26, int32x4_t a27, int32x4_t a28, int32x4_t a29, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, int a16, int a17, uint64_t (*a18)(__n128, __n128, __n128, __n128), int a19, unsigned int a20, uint64_t a21, uint64_t a22, int a23, int a24, uint64_t a25, int32x4_t a30, int32x4_t a31, int32x4_t a32, int32x4_t a33)
{
  ...
  else if (v50 == 1)
  {
    ...
    v75 = *(&off_10244F320 + v51 - 1541);
    v76 = (v48 & 0x8D9BD615 ^ 0x8008D005 ^ (v47 ^ 0x2FD70678) & (v48 ^ v34) | v47 & 0xD073C016 ^ 0x50330012 ^ (v47 ^ ((v51 ^ 0xBB) + 1572022463)) & (v49 ^ 0x723F107B)) + (v46 ^ v34) + *(*(&off_10244F320 + (v51 ^ 0x6F5)) + a21 + v37) + (a30.i32[(*(*(&off_10244F320 + v51 - 1530) + a21 + v37 - 4) - 50)] ^ v38);
    v77 = *(v75 + a21 + v37);
...
uint64_t sub_10034017C@<X0>(int a3@<W2>, int w8_0@<W8>, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63, uint64_t _1B0, void _1B8, void _1C0, void _1C8, void _1D0, char arg1D8, void arg1D8_8)
{
  ...
  STACK[0x268] = v66 + 16;
  return sub_100347FBC(160, w8_0 + 16, a9, a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, a24, a25, a26, a27, a28, a29, a30, a31, a32, a33, a34, a35, a36, a37, a38, a39, a40, a41, a42, a43, a44, a45, a46, a47, a48, a49, a51, a52, a53, a54, a55, a56, a57, a58, a59, a60, a61, a62, a63, _1B0);
}

void sub_1003402A8(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X8>, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8, unsigned int a9)
{
  *(*(a1 + 96) + 800) = 64;
  *(*(a1 + 96) + 804) = 763308221;
  *(*(a1 + 96) + 808) = *(a1 + 96) + 816;
...
uint64_t sub_100340AA8(__n128 a1, __n128 a2, __n128 a3, int8x16_t a4, int8x16_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, int a13)
{
  v18 = (v17 + v13);
...
void sub_100340C9C(char a1@<W8>, uint64_t a2, uint64_t a3, unsigned __int8 *a4)
{
  v7 = a4[3] ^ 0x33;
...
uint64_t sub_100340D5C@<X0>(uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t a5@<X4>, uint64_t a6@<X5>, uint64_t a7@<X6>, uint64_t a8@<X7>, int w8_0@<W8>, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, unsigned int a46, unsigned int a47, int a48, char a49)
{
  ...
  {
    return sub_10034F3DC(a3, a4, a5, a6, a7, a8, v57, a9, a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, a24, a25, a26, a27, v57, a29, a31, a32, a33, a34, a35, a36, a37, a38, a39, a40, a41, a42, a43, a44, SHIDWORD(a44), a45, HIDWORD(a45), a46);
  }
}
...
uint64_t sub_1003416FC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, __int16 a12, char a13, char *a14, unsigned int a15, unsigned int a16, char *a17, uint64_t a18)
{
...
uint64_t sub_10034208C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, int a17, unsigned int a18, char *a19, unsigned int a20)
{
...
uint64_t sub_10034441C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, int a14, unsigned int a15, unsigned int a16, char *a17, unsigned int a18)
{
...
void sub_100346194(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  **(a1 + 16) = v3;
  *(a2 + 16) = v2;
  nullsub_2638();
...
void sub_100346A18(uint64_t a1@<X8>, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5)
{
...
uint64_t sub_100347B48@<X0>(unint64_t a1@<X2>, uint64_t a2@<X8>, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57)
{
  ...
  *(v62 + 1) = v64;
  ...
  v93 = *(v60 + 424);
  STACK[0x268] = v92 + 7;
  return sub_100347FBC(160, -1065, a3, a4, a5, a6, a7, a8, a9, a10, a11, v92, v93, a14, v74, v72, a17, a18, a19, a20, a21, a22, a23, a24, a25, a26, a27, a28, a29, a30, a31, a32, a33, v69, a35, a36, a37, a38, a39, a40, v67, a42, a43, a44, a45, a46, a47, a48, a49, a50, a51, a52, a53, a54, a55, a56, a57);
}
...
uint64_t sub_10034A290@<X0>(unsigned int a1@<W8>)
{
  v7 = (v2 + v1);
  *v7 = 0u;
  v7[1] = 0u;
...
uint64_t sub_10034A3B0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, unsigned int a15, unsigned int a16)
{
...
uint64_t sub_10034B3AC@<X0>(int a2@<W2>, int a3@<W8>)
{
...
uint64_t sub_10034DAD0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, int a54, int a55, int a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, int a62, int a63)
{
  ...
  if (v72)
  {
    ...
    *(v71 - 184) = v72 - v74 - ((2 * v72) & 0xD141E1F0) + (a55 & 0x50D10DFF ^ 0xE8A0F003);
    ...
    return sub_10034012C(v76, v68, v77, v78, 392145697, v79, v80, -392105736);
  }
...
void sub_10034EA64(uint64_t a1@<X8>, uint64_t a2, unsigned int a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
...
uint64_t sub_100354158(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15, char a16, uint64_t a17, uint64_t a18, uint64_t a19, char *a20, char *a21)
{
  a19 = a13;
  a21 = &a16;
  ...
  return sub_100358954(v24, v25, v26, v27, v28, v29, v30, v31, a9, a10, a11, a12, a13, a14, SBYTE4(a14), SHIWORD(a14), a15, a17, a18, a19, a20, a21);
}
...
void sub_100355FE0(uint64_t a1@<X8>, uint64_t a2, unsigned int a3, unsigned int a4, uint64_t a5)
{
...
void sub_100356F98(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  *(v14 - 120) = v12;
...
uint64_t sub_100357640(uint64_t a1, uint64_t a2, int a3, uint64_t a4, int a5)
{
  v6.i64[0] = 0x6666666666666666;
  v6.i64[1] = 0x6666666666666666;
  v7.i64[0] = 0x3333333333333333;
  v7.i64[1] = 0x3333333333333333;
  return sub_100357654(a3, a5, v5 & 0x60, v6, v7);
}
