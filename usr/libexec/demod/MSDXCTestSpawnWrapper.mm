...
- (id)listAllTestScripts
{
  ...
  v28 = +[NSPipe pipe];
  v29 = sub_100063A54([v26 setStandardOutput:v28]);
...
- (BOOL)executeTestScriptOfIdentifier:(id)identifier
{
  ...
  v13 = sub_100063A54(identifierCopy);
  ...
  v16 = sub_100063A54([v14 setCurrentDirectoryPath:@"/var/tmp"]);
  ...
  if (terminationStatus)
  {
    v21 = sub_100063A54(terminationStatus);
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      sub_1000E52C8(v20, v21);
    }
  }
