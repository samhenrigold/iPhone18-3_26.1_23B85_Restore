...
LABEL_97:
  ...
  while (2)
  {
    ...
    do
    {
      ...
      if (!v22)
      {
        v64 = sub_100063A54(isKindOfClass);
        v103 = 0;
...
LABEL_96:
            ...
            v102 = v53;
            v56 = sub_1000559DC(kCFAllocatorDefault, v45, v53);
...
LABEL_50:
  ...
  v47 = v37;
  v61 = sub_100063A54(has_internal_content);
...
LABEL_58:
  v63 = sub_100063A54(has_internal_content);
  v10 = v91;
...
- (__SecKey)createPublicKeyForStrongSigning:(id)signing
{
  ...
  v6 = sub_100063A54(MobileStoreSigner);
  v7 = v6;
...
- (BOOL)verifySignature:(id)signature forData:(id)data withKey:(__SecKey *)key
{
  dataCopy = data;
  signatureCopy = signature;
  v9 = sub_100063A54(signatureCopy);
...
- (BOOL)runSecurityCheck:(id)check
{
  ...
  getBackupSectionName = [(MSDDemoManifestCheck *)self getBackupSectionName];
  v8 = sub_100063A54(getBackupSectionName);
...
LABEL_64:
  ...
  v81 = [NSSet setWithArray:&off_10017BE68];
  getBackupSectionName = [(MSDDemoManifestCheck *)self getBackupSectionName];
...
- (BOOL)runAppLayoutSecurityCheck:(id)check
{
  ...
  if (macOS)
  {
    ...
    [v6 addObject:@"staff"];
    v74 = [NSSet setWithArray:&off_10017BE80];
    goto LABEL_11;
  }
...
LABEL_105:
        ...
        {
          objc_opt_class();
          if ((objc_opt_isKindOfClass() & 1) == 0 || ([v25 isEqualToString:&stru_10016D9D8] & 1) == 0)
          {
            sub_1000E292C(v23, v25, v24);
            goto LABEL_105;
          }
        }
                              ...
                              if (v42 && (objc_opt_class(), v43 = objc_opt_isKindOfClass(), (v43 & 1) != 0))
                              {
                                ...
                                if (v44)
                                {
                                  ...
                                  if (v45 && (objc_opt_class(), v45 = objc_opt_isKindOfClass(), (v45 & 1) != 0))
                                  {
                                    ...
                                    v60 = sub_100063A54(integerValue2);
...
LABEL_73:
                    ...
                    v42 = sub_100063A54(integerValue);
                    if (!os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
                    {
LABEL_71:
                      v30 = 6;
...
LABEL_38:
  ...
  if (v9 != 2)
  {
    v39 = sub_100063A54(v9);
    if (sub_100018978(v39))
    {
      *buf = 0;
LABEL_37:
      sub_100093CA4();
...
LABEL_23:
  ...
  if (!v14)
  {
    v40 = sub_100063A54(v15);
    if (!sub_100018978(v40))
    {
      goto LABEL_23;
    }
  ...
  if ((v17 & 1) == 0)
  {
    v41 = sub_100063A54(v18);
    if (sub_100018978(v41))
    {
      *buf = 138543362;
      v58 = v16;
      sub_10005F09C();
...
LABEL_21:
  ...
  if (!v3)
  {
    v48 = sub_100063A54(v24);
    if (sub_100018978(v48))
    {
      *buf = 0;
      sub_100093CA4();
      goto LABEL_28;
...
LABEL_34:
  ...
  v27 = CFDataCreate(kCFAllocatorDefault, byte_1001A4CB8, dword_1001A5040);
  if (!v27)
  {
    v49 = sub_100063A54(0);
    if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
