...
LABEL_6:
  ...
  {
    v9 = sub_100001684(isKindOfClass);
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
    {
      sub_10003D1DC(v4);
    }
...
{
  v90 = 0;
  v6 = sub_10000A740("hangreporter", &v90);
  v7 = v90;
  v8 = v7;
  if (v6 >= 1)
  {
...
LABEL_4:
  ...
  if (v18 != -1)
  {
    if (v15 < v18)
    {
      v9 = sub_100001684(v19);
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        sub_10003D494(v18, v15, v9);
      }
