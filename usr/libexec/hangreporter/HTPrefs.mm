  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = i + 1)
      {
        ...
        v14 = *(*(&v30 + 1) + 8 * i);
        v15 = [(__CFString *)v14 isEqualToString:&stru_100085FF8];
        if (v15)
        {
          namedCopy = namedCopy;
        }
...
- (unsigned)unsignedIntProperty:(HTPrefInit *)property contextPrefixOut:(id *)out
{
  ...
  {
    v10 = sub_100001684(unsignedIntValue);
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      var0 = property->var0;
      var4 = property->var4;
...
LABEL_9:
  ...
  {
    v13 = sub_100001684(tailspinSaveFormat);
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      sub_10003FF6C();
    }
  ...
  {
    v14 = sub_100001684(tailspinSaveFormat);
...
- (void)initPropertyReportPeriod:(HTPrefInit *)period
{
  ...
  v10 = v7 * 1000.0 / sub_10000B4C0(v6, v8);
  if (v10 != reportPeriodMATU)
  {
    v11 = sub_100001684(v9);
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *&result[12].var2.var0 = xmmword_100045340;
...
- (void)refreshHTPrefs
{
  ...
  {
    v8 = sub_100001684([(HTPrefs *)self setShouldPostHTPrefsChangedNotification:0]);
...
LABEL_11:
    ...
    CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_10008AA80, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
  }
...
- (void)setupPrefsWithQueue:(id)queue profilePath:(id)path taskingDomainName:(__CFString *)name hangtracerDomain:(__CFString *)domain setupInternalPrefs:(BOOL)prefs
{
  ...
  *buf = 0;
  ...
  notify_register_dispatch(off_10008FD68[0], v30 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10008FD50[0], v42 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10008FD58[0], v38 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10008FD60[0], v34 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10008FD70, v24 + 6, self->__prefsQueue, v19);
  [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
