...
- (void)notifyUrskCreated:(unsigned int)created
{
  ...
  else
  {
    ...
    [v7 handleFailureInMethod:a2 object:self file:@"NISession.mm" lineNumber:2685 description:@"Parent session is nil"];
  }
}
...
- (void)notifyLockStatusChanged:(unsigned __int16)changed
{
  ...
  {
    v7 = +[NSAssertionHandler currentHandler];
    [v7 handleFailureInMethod:a2 object:self file:@"NISession.mm" lineNumber:2695 description:@"Parent session is nil"];
  }
}
