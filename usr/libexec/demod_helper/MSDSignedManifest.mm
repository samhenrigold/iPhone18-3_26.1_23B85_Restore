...
- (MSDSignedManifest)initWithManifestData:(id)data
{
  ...
  if (v6)
  {
    ...
    if (+[MSDPlatform iOSHub])
    {
      ...
      v11 = v10;
      if (!v10 || (v12 = objc_opt_class(), v10 = sub_10000C340(v12), (v10 & 1) == 0))
      {
        v53 = sub_100021268(v10);
    ...
    if (manifestVerifier)
    {
      ...
      {
        v28 = objc_opt_class();
        if ((sub_10000C340(v28) & 1) == 0)
        {
          v29 = objc_opt_class();
          v30 = sub_10000C340(v29);
          if ((v30 & 1) == 0)
          {
            v60 = sub_100021268(v30);
...
LABEL_50:
      ...
      {
        v60 = sub_100021268(validateInstallationOrder);
        if (!os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
        {
LABEL_76:
