...
LABEL_18:
    ...
    v20 = sub_100021268(v27);
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      sub_100031CCC(toCopy, v26);
    }
  ...
  if (v20)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v25 = 0u;
        v26 = 0u;
        v8 = [&off_100056640 countByEnumeratingWithState:&v23 objects:v33 count:16];
        if (v8)
        {
          v9 = v8;
          v10 = *v24;
          do
          {
            ...
            while (v9 != v11);
            v9 = [&off_100056640 countByEnumeratingWithState:&v23 objects:v33 count:16];
          }
