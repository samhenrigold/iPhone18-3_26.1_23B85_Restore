...
- (BOOL)enumerateAndCollectMetaData:(id)data relativeTo:(id)to skip:(id)skip superSet:(id)set handler:(id)handler
{
  ...
  v23 = [v20 enumeratorAtURL:v21 includingPropertiesForKeys:v22 options:0 errorHandler:&stru_100050EE8];
...
LABEL_38:
    ...
    if (v48)
    {
      ...
      v50 = [v52 stringByReplacingOccurrencesOfString:*p_rootPath withString:&stru_1000519D0];
    ...
    {
      path7 = [v18 path];
      v50 = [path7 stringByReplacingOccurrencesOfString:*p_rootPath withString:&stru_1000519D0];
    }
...
LABEL_28:
    ...
    if (!v54)
    {
      v58 = sub_100021268(v55);
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        sub_10002DF38(v84, v18, &v85, v58);
      }
...
LABEL_34:
  ...
  v64 = sub_100021268(v57);
  if (os_log_type_enabled(v64, OS_LOG_TYPE_ERROR))
  {
    sub_10002DEA0(v18, v64);
  }
