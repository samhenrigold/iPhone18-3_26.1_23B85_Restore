...
LABEL_17:
      ...
      sub_100028C04(pathCopy);
    }

    else
    {
      sub_100028C98(pathCopy);
    }
  ...
  if (v6 >= 1)
  {
    ...
    if (v8)
    {
      ...
      else
      {
        ...
        v15 = sub_100021268(v13);
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          sub_100028D2C(v12, attributesCopy, v15);
        }
      }
...
LABEL_51:
  ...
  while (2)
  {
    ...
    do
    {
      ...
      {
        v52 = sub_100021268(isKindOfClass);
        if (sub_10000AD20(v52))
        {
          *buf = 0;
          sub_10000ACE4();
      ...
      if ((v42 & 1) == 0)
      {
        v58 = sub_100021268(v42);
        if (!sub_10000AD20(v58))
        {
LABEL_32:
          v38 = v34;
LABEL_33:
...
LABEL_42:
      ...
      if (v43)
      {
        v65 = sub_100021268(v43);
        if (!sub_10000AD20(v65))
        {
          goto LABEL_32;
        }
...
LABEL_21:
  ...
  if ((v45 & 1) == 0)
  {
    ...
    if (v48)
    {
      ...
      if (!self)
      {
        v51 = sub_100021268(v50);
        if (sub_10000AD20(v51))
        {
          goto LABEL_65;
        }
    ...
    else
    {
      ...
      {
        v80 = sub_100021268(0);
        if (sub_10000AD20(v80))
        {
LABEL_65:
          v91 = __error();
          v92 = strerror(*v91);
          sub_10000ACBC(v92, 5.8382e-34);
          sub_10000ACE4();
