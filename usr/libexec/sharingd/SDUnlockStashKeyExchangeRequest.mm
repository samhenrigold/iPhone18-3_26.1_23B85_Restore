...
{
  v7.receiver = self;
  v7.super_class = SDUnlockStashKeyExchangeRequest;
  v3 = [(SDUnlockStashKeyExchangeRequest *)&v7 description];
  dictionaryRepresentation = [(SDUnlockStashKeyExchangeRequest *)self dictionaryRepresentation];
...
LABEL_5:
    v7 = 0;
    return v7 ^ v6 ^ [(NSData *)self->_key hash:v3];
  }
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(SDUnlockStashKeyExchangeRequest *)self setKey:?];
    fromCopy = v6;
  }
}
