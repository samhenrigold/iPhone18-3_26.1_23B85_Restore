...
{
  v7.receiver = self;
  v7.super_class = SDAutoUnlockDecryptionFailed;
  v3 = [(SDAutoUnlockDecryptionFailed *)&v7 description];
  dictionaryRepresentation = [(SDAutoUnlockDecryptionFailed *)self dictionaryRepresentation];
...
LABEL_11:
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 16) & 1) == 0 || self->_errorCode != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
