...
- (BOOL)addSymmetricKeyEntryWithError:(id *)error
{
  ...
  if (v18)
  {
    ...
    LODWORD(v22) = 8;
    sub_100179F08(&v26, mutableSymmetricKey, v6, &v22, v17);
...
LABEL_27:
      ...
      {
        LODWORD(v29) = 8;
        sub_100178F44(v13, v12, &v29, v24, &v33);
        if (v35)
        {
