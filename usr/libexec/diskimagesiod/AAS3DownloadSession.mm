...
- (AAS3DownloadSession)initWithURL:(id)l streamBase:(id *)base maxAttempts:(unsigned int)attempts pauseInterval:(float)interval maxRequestsInFlight:(unsigned int)flight
{
  ...
  if (v14)
  {
    ...
    for (i = *(var2 + 349); i; i = *(i + 8))
    {
      ...
      if (*i)
      {
        ...
        if (v20 + 1 < 0x2000000001)
        {
          ...
          if (v22)
          {
            ...
            {
              sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 252, 121, 0, "invalid header: %s", v23);
            }
      ...
      v27 = __error();
      sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 250, 121, *v27, "malloc");
    }

    if (*(var2 + 350))
    {
      sub_100023A04("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 259, 121, "Non supported options in AAS3DownloadSession (ignored): proxy_headers %s", *(var2 + 350));
    }

    if (*(var2 + 346))
    {
      sub_100023A04("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 260, 121, "Non supported options in AAS3DownloadSession (ignored): pinned_public_key %s", *(var2 + 346));
    }
...
- (int)addRequest:(id)request
{
  ...
  if (v7)
  {
    sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession addRequest:]", 292, 121, 0, "euqueueRequest timed out");
    v8 = -1;
  }
...
- (id)enqueueRequestWithSize:(unint64_t)size atOffset:(int64_t)offset destinationBuffer:(char *)buffer destinationStream:(AAAsyncByteStream_impl *)stream completionSemaphore:(id)semaphore
{
  ...
  if (v13)
  {
    ...
    {
      sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession enqueueRequestWithSize:atOffset:destinationBuffer:destinationStream:completionSemaphore:]", 335, 121, 0, "addRequest");
    }
    ...
    else
    {
      ...
      sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession enqueueRequestWithSize:atOffset:destinationBuffer:destinationStream:completionSemaphore:]", 338, 121, 0, "createTask");
    }
  }

  else
  {
    sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession enqueueRequestWithSize:atOffset:destinationBuffer:destinationStream:completionSemaphore:]", 332, 121, 0, "Request creation");
  }
...
- (int64_t)readToBuffer:(void *)buffer size:(unint64_t)size atOffset:(int64_t)offset
{
  ...
  else
  {
    ...
    if (v19)
    {
      ...
      {
        sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession readToBuffer:size:atOffset:]", 384, 121, 0, "Request timed out");
      }
      ...
      else
      {
        ...
        sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession readToBuffer:size:atOffset:]", 386, 121, 0, "Request failed");
      }
    }

    else
    {
      sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession readToBuffer:size:atOffset:]", 380, 121, 0, "enqueueRequest");
    }
...
- (int)syncRequests
{
  if ([(AAS3DownloadSession *)self maxRequests])
  {
    ...
    sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession syncRequests]", 401, 121, 0, "Request timed out");
    return -1;
  }
...
LABEL_7:
    ...
    sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "[AAS3DownloadSession readToAsyncByteStream:size:atOffset:]", 451, 121, 0, "enqueueRequest");
    v17 = 0;
    v14 = -1;
  }
...
LABEL_2:
  ...
  {
    v32 = v31;
    sub_100023A04("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "+[AAS3DownloadSession completeRequest:data:response:error:]", 546, 121, "Request failed: %03ld %s", statusCode, [v31 UTF8String]);
  }

  else
  {
    sub_100023A04("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "+[AAS3DownloadSession completeRequest:data:response:error:]", 547, 121, "Request failed: %03ld (error not set)", statusCode);
  }

  if ([requestCopy remainingAttempts])
  {
    [requestCopy pauseInterval];
    sub_100023A04("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "+[AAS3DownloadSession completeRequest:data:response:error:]", 554, 121, "Retrying request after %.0f seconds %zu bytes at offset %llu", v33, [requestCopy nbyte], objc_msgSend(requestCopy, "offset"));
    [requestCopy pauseInterval];
    ...
    *&v36 = v35 + v35;
    ...
    sub_1000238F8("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "+[AAS3DownloadSession completeRequest:data:response:error:]", 561, 121, 0, "createTask");
  }
