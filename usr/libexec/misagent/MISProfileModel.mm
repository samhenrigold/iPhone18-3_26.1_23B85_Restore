...
- (BOOL)queryCMSBlobForProfile:(id)profile forcingXML:(BOOL)l handler:(id)handler
{
  ...
  if (profileCopy)
  {
    if (!lCopy || (v22 = 0, v23 = &v22, v24 = 0x2020000000, v25 = 0, v20[0] = _NSConcreteStackBlock, v20[1] = 3221225472, v20[2] = sub_10000D318, v20[3] = &unk_100028C48, v21 = profileCopy, v17[0] = _NSConcreteStackBlock, v17[1] = 3221225472, v17[2] = sub_10000D388, v17[3] = &unk_1000290D0, v19 = &v22, v18 = handlerCopy, v11 = [WeakRetained executeQuery:@"SELECT cms_blob FROM xml_profiles_cache WHERE uuid = @uuid" withBind:v20 withResults:v17], v12 = *(v23 + 24), v13 = v11 == 0, v18, v21, _Block_object_dispose(&v22, 8), (v12 & 1) == 0))
    {
