...
+ (id)descriptor
{
  result = qword_10015D018;
  if (!qword_10015D018)
  {
    qword_10015D020 = [[TransparencyGPBFileDescriptor alloc] initWithPackage:@"internal" syntax:2];
    LODWORD(v3) = 0;
    result = [TransparencyGPBDescriptor allocDescriptorForClass:objc_opt_class() rootClass:0 file:qword_10015D020 fields:0 fieldCount:0 storageSize:0 flags:v3];
    qword_10015D018 = result;
  }
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((*(v16 + 28) & 0xF02) != 0)
        {
          v17 = sub_1000EE6CC(selfCopy, *(*(&v43 + 1) + 8 * v14));
          if (!v17)
          {
            goto LABEL_37;
          }
...
LABEL_36:
              v12 = v37;
              v33 = v18;
              sub_1000EED50(intoCopy, v15, v22);
              goto LABEL_37;
            }
...
LABEL_33:
        ...
        if ((v28 - 15) <= 1)
        {
          if (!sub_1000EEBFC(selfCopy, *(v16 + 20), *(v16 + 16)))
          {
...
LABEL_27:
          v29 = sub_1000EE6CC(selfCopy, v15);
          v30 = [v29 copyWithZone:zone];
          v31 = v29;
          sub_1000EED50(intoCopy, v15, v30);
          goto LABEL_37;
        }

        if ((v28 - 13) <= 3 && sub_1000EEBFC(selfCopy, *(v16 + 20), *(v16 + 16)))
        {
          goto LABEL_27;
        }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6[2] = sub_1000E37EC(self->extensionMap_, zone);
  return v6;
}
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = i + 1)
      {
        ...
        if ((*(v10 + 28) & 0xF02) != 0)
        {
          v11 = sub_1000EE6CC(self, *(*(&v29 + 1) + 8 * i));
          if (!v11)
          {
            continue;
          }
...
LABEL_24:
        ...
        if ((v14 - 15) <= 1)
        {
          sub_1000EEC64(self, *(*(&v29 + 1) + 8 * i));
          v15 = sub_1000EE6CC(self, v9);
LABEL_14:

          continue;
        }

        if ((v14 - 13) <= 3 && sub_1000EEBFC(self, *(v10 + 20), *(v10 + 16)))
        {
          v15 = sub_1000E3DE8(self, v9);
          goto LABEL_14;
        }
      }
...
LABEL_3:
    ...
    while (1)
    {
      ...
      v7 = *(*(&v28 + 1) + 8 * v6);
      if ([v7 isRequired] && !sub_1000EEBFC(self, *(v7[1] + 20), *(v7[1] + 16)))
      {
        goto LABEL_34;
      }
...
LABEL_34:
      ...
      if (fieldType)
      {
        ...
        if (v14)
        {
          v15 = sub_1000C42E0(v14);
          goto LABEL_27;
        }
      }

      else if ([v7 isRequired] || sub_1000EEBFC(self, *(v7[1] + 20), *(v7[1] + 16)))
      {
        v15 = [sub_1000EF8C8(self v7)];
LABEL_27:
        if ((v15 & 1) == 0)
        {
          goto LABEL_34;
...
- (id)delimitedData
{
  ...
  v4 = [NSMutableData dataWithLength:sub_1000BF820(serializedSize) + serializedSize];
...
- (void)writeField:(id)field toCodedOutputStream:(id)stream
{
  ...
  if (fieldType || sub_1000EEBFC(self, *(*(field + 1) + 20), *(*(field + 1) + 16)))
  {
    v8 = *(field + 1);
    v9 = *(v8 + 16);
    switch(*(v8 + 30))
...
LABEL_120:
          ...
          sub_1000C41B4(stream, v12, field);
        }
    ...
    do
    {
      for (i = 0; i != v10; i = i + 1)
      {
        ...
        if (fieldNumber >= range.var0)
        {
          ...
          sub_1000E1570(v13, [(NSMutableDictionary *)self->extensionMap_ objectForKey:v13], stream);
        }
      }
...
- (void)mergeDelimitedFromCodedInputStream:(id)stream extensionRegistry:(id)registry
{
  if (!sub_1000BD0A8(stream + 1))
  {
    v7 = sub_1000BD334(stream + 1);
    if (v7)
    {
      v8 = v7;
...
- (void)parseMessageSet:(id)set extensionRegistry:(id)registry
{
  v7 = sub_1000BD014(set + 8);
  if (v7)
  {
    v8 = v7;
    v9 = sub_1000F1CD4(2, 0);
    v10 = 0;
    v11 = 0;
    v12 = 0;
    do
    {
      ...
      else if (v8 == sub_1000F1CD4(3, 2))
      {
        v11 = sub_1000BD334(set + 1);
      }
  ...
  [set checkLastTagWas:{sub_1000F1CD4(1, 4)}];
  if (v11 && v10)
  {
    if (v12)
    {
      v15 = [[TransparencyGPBCodedInputStream alloc] initWithData:v11];
      sub_1000E5ED0(v12, [v12 isPackable], v15, registry, self);
    }

    else
    {
      v13 = sub_1000E6094(self);
...
{
  v5 = *&tag;
  v9 = sub_1000F1CDC(tag);
  v10 = sub_1000F1CE4(v5);
  descriptor = [(TransparencyGPBMessage *)self descriptor];
...
LABEL_4:
      sub_1000E5ED0(v13, isPackable, field, registry, self);
LABEL_8:
      LOBYTE(v15) = 1;
      return v15;
    }
  ...
  else if ([descriptor isWireFormat] && sub_1000F1CD4(1, 3) == v5)
  {
...
LABEL_23:
        ...
        else
        {
          if (fieldType)
          {
            [stream readMapEntry:sub_1000E6DD0(self extensionRegistry:v12) field:registry parentMessage:{v12, self}];
            goto LABEL_28;
          }
          ...
          {
            case 0:
              v16 = sub_1000BCFF4(stream + 1);
              sub_1000EF2D0(self, v12, v16);
              break;
            case 1:
              v18 = sub_1000BCF70(stream + 1);
              goto LABEL_46;
            case 2:
              v20 = sub_1000BCF70(stream + 1);
              goto LABEL_43;
            case 3:
              v21 = sub_1000BCE54(stream + 1);
              sub_1000EF630(self, v12, v21);
              break;
            case 4:
              v19 = sub_1000BCF34(stream + 1);
              goto LABEL_36;
            case 5:
              v19 = sub_1000BCF34(stream + 1);
              goto LABEL_36;
            case 6:
              v29 = sub_1000BCE18(stream + 1);
              sub_1000EF7CC(self, v12, v29);
              break;
            case 7:
              v20 = sub_1000BCF1C(stream + 1);
              goto LABEL_43;
            case 8:
              v19 = sub_1000BCE90();
              goto LABEL_36;
            case 9:
              v20 = sub_1000BCFAC(stream + 1);
LABEL_43:
              v22 = v20;
              selfCopy4 = self;
              v24 = v12;
              goto LABEL_44;
            case 0xA:
              v19 = sub_1000BCFD0(stream + 1);
              goto LABEL_36;
            case 0xB:
              v18 = sub_1000BCF1C(stream + 1);
LABEL_46:
              sub_1000EF114(self, v12, v18);
              break;
            case 0xC:
              v19 = sub_1000BCE90();
LABEL_36:
              sub_1000EF498(self, v12, v19);
              break;
            case 0xD:
              v17 = sub_1000BD2C8(stream + 1);
              goto LABEL_52;
            case 0xE:
              v17 = sub_1000BD1C4(stream + 1);
LABEL_52:
              v26 = v17;
              selfCopy3 = self;
              v28 = v12;
              goto LABEL_60;
            case 0xF:
              if (sub_1000EEBFC(self, *(v15 + 20), *(v15 + 16)))
              {
                [stream readMessage:sub_1000EE6CC(self extensionRegistry:{v12), registry}];
                break;
              }
            ...
            case 0x10:
              if (sub_1000EEBFC(self, *(v15 + 20), *(v15 + 16)))
              {
                [stream readGroup:*(v12[1] + 16) message:sub_1000EE6CC(self extensionRegistry:{v12), registry}];
              }
...
LABEL_59:
                ...
                v26 = v30;
LABEL_60:
                sub_1000EED50(selfCopy3, v28, v26);
              }

              break;
            case 0x11:
              v25 = sub_1000BCF1C(stream + 1);
              if ((*(v12[1] + 28) & 0x1000) != 0 && ![v12 isValidEnumValue:v25])
              {
                [sub_1000E6094(self) mergeVarintField:*(v12[1] + 16) value:v25];
              }
              ...
              else
              {
                ...
                v22 = v25;
LABEL_44:
                sub_1000EF114(selfCopy4, v24, v22);
              }
    ...
    while (1)
    {
      ...
      v12 = [v6 objectAtIndexedSubscript:v10];
      if ([v12 fieldType] == 1 && *(v12[1] + 30) - 13 >= 4 && sub_1000C3044(v12) == v9)
      {
        break;
      }
...
LABEL_27:
    sub_1000E6A44(self, v12, stream, registry);
LABEL_28:
    v9 = sub_1000BD014(stream + 8);
  }
...
- (void)mergeFrom:(id)from
{
    ...
    do
    {
      for (i = 0; i != v9; i = i + 1)
      {
        ...
        else
        {
          ...
          v16 = *(v14 + 16);
          v15 = *(v14 + 20);
          if (sub_1000EEBFC(from, v15, v16))
          {
            switch(*(v12[1] + 30))
            {
              case 0:
                v30 = sub_1000EF214(from, v12);
                sub_1000EF2D0(self, v12, v30);
                break;
              case 1:
              case 2:
              case 7:
              ...
              case 0xB:
              case 0x11:
                v17 = sub_1000EEFD8(from, v12);
                sub_1000EF114(self, v12, v17);
                break;
              case 3:
                v31 = sub_1000EF590(from, v12);
                sub_1000EF630(self, v12, v31);
                break;
              case 4:
              case 5:
              case 8:
              case 0xA:
              case 0xC:
                v28 = sub_1000EF414(from, v12);
                sub_1000EF498(self, v12, v28);
                break;
              case 6:
                v32 = sub_1000EF72C(from, v12);
                sub_1000EF7CC(self, v12, v32);
                break;
              case 0xD:
              case 0xE:
                v29 = sub_1000EE6CC(from, v12);
                sub_1000EED0C(self, v12, v29);
                break;
              case 0xF:
              case 0x10:
                obj = sub_1000EE6CC(from, v12);
                if (sub_1000EEBFC(self, v15, v16))
                {
                  [sub_1000EE6CC(self v12)];
                }

                else
                {
                  sub_1000EED50(self, v12, [obj copy]);
                }
  ...
  if ([*(from + 2) count])
  {
    if (!self->extensionMap_)
    {
      ...
      self->extensionMap_ = sub_1000E37EC(v50, v51);
      return;
    }
...
LABEL_4:
  ...
  do
  {
    ...
    do
    {
      ...
      if ((*(v12 + 28) & 0xF02) != 0)
      {
        v13 = sub_1000EE6CC(self, *(*(&v33 + 1) + 8 * v10));
        v14 = sub_1000EE6CC(equal, v11);
      ...
      v18 = *(v12 + 16);
      v17 = *(v12 + 20);
      v19 = sub_1000EEBFC(self, v17, v18);
      v20 = sub_1000EEBFC(equal, v17, v18);
      if (v19)
      {
        v21 = v20 == 0;
      }
...
LABEL_14:
      ...
      if (!v23)
      {
        v26 = sub_1000EEBFC(self, v24, 0);
        if (v26 != sub_1000EEBFC(equal, v24, 0))
        {
          goto LABEL_4;
        }
      }
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = i + 1)
      {
        ...
        if ((*(v10 + 28) & 0xF02) != 0)
        {
          v11 = [sub_1000EE6CC(self *(*(&v19 + 1) + 8 * i))];
          if (v11)
          {
        ...
        {
          if (!sub_1000EEBFC(self, *(v10 + 20), *(v10 + 16)))
          {
            continue;
          }
...
LABEL_30:
          ...
          else if (*(v12 + 30) <= 3u)
          {
            ...
            if (!*(v12 + 30))
            {
              descriptor = 19 * descriptor + sub_1000EEBFC(self, v14, 0);
            }
          }
    ...
    do
    {
      ...
      if (fieldType == 1)
      {
        ...
        if (v15)
        {
          ...
          if (isPackable)
          {
            v4 = v37 + v36 + sub_1000BF5CC(v97[3]);
          }
      ...
      else if (fieldType)
      {
        ...
        {
          v16 = sub_1000EE6CC(self, v8);
          if (!v16)
          {
            goto LABEL_69;
          }

          v13 = sub_1000C4088(v16, v8);
        }

        else
        {
          v13 = [sub_1000EE6CC(self v8)];
        }
...
LABEL_19:
      ...
      else if (sub_1000EEBFC(self, *(v10 + 20), *(v10 + 16)))
      {
        v12 = *(v8[1] + 16);
        switch(v11)
        {
          case 0:
            sub_1000EF214(self, v8);
            v13 = sub_1000C14A8(v12);
            goto LABEL_19;
          case 1:
          case 2:
            sub_1000EEFD8(self, v8);
            v13 = sub_1000C1350(v12);
            goto LABEL_19;
          case 3:
            sub_1000EF590(self, v8);
            v13 = sub_1000C1350(v12);
            goto LABEL_19;
          case 4:
          case 5:
            sub_1000EF414(self, v8);
            v13 = sub_1000C12B0(v12);
            goto LABEL_19;
          case 6:
            sub_1000EF72C(self, v8);
            v13 = sub_1000C12B0(v12);
            goto LABEL_19;
          case 7:
          case 17:
            v44 = sub_1000EEFD8(self, v8);
            v13 = sub_1000C1408(v12, v44);
            goto LABEL_19;
          case 8:
          case 12:
            v41 = sub_1000EF414(self, v8);
            v13 = sub_1000C13A0(v12, v41);
            goto LABEL_19;
          case 9:
            v42 = sub_1000EEFD8(self, v8);
            v13 = sub_1000C17DC(v12, v42);
            goto LABEL_19;
          case 10:
            v46 = sub_1000EF414(self, v8);
            v13 = sub_1000C1878(v12, v46);
            goto LABEL_19;
          case 11:
            v40 = sub_1000EEFD8(self, v8);
            v13 = sub_1000C1748(v12, v40);
            goto LABEL_19;
          case 13:
            v45 = sub_1000EE6CC(self, v8);
            v13 = sub_1000C16A8(v12, v45);
            goto LABEL_19;
          case 14:
            v39 = sub_1000EE6CC(self, v8);
            v13 = sub_1000C14F8(v12, v39);
            goto LABEL_19;
          case 15:
            v43 = sub_1000EE6CC(self, v8);
            v13 = sub_1000C1608(v12, v43);
            goto LABEL_19;
          case 16:
            v38 = sub_1000EE6CC(self, v8);
            v13 = sub_1000C159C(v12, v38);
            goto LABEL_19;
          default:
            break;
        }
  ...
  if (v53)
  {
    ...
    do
    {
      for (n = 0; n != v53; n = n + 1)
      {
        ...
        v54 += sub_1000E1E40(*(*(&v62 + 1) + 8 * n), [(NSMutableDictionary *)self->extensionMap_ objectForKey:*(*(&v62 + 1) + 8 * n)]);
      }
...
LABEL_4:
  ...
  while (1)
  {
    ...
    if (*(v11 + 32) == method)
    {
      ...
      block[1] = 3221225472;
      block[2] = sub_1000EA14C;
      block[3] = &unk_100137950;
      block[4] = v11;
...
LABEL_36:
  ...
  return sub_1000F0CA4(messageClass, method);
}
