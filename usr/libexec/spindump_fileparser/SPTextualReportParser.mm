...
- (BOOL)parseSpindumpFile:(const char *)file andReportToStream:(__sFILE *)stream
{
  ...
  v1093[1] = 3221225472;
  v1093[2] = sub_1000A0AF0;
  v1093[3] = &unk_100115410;
  v1093[4] = &v1094;
  v1093[5] = &v1098;
...
LABEL_19:
    ...
    v29 = byte_100127EC9 == 1 && dword_100127558 <= 3;
    if (v29)
    {
      v41 = *__error();
...
LABEL_69:
  ...
  if (!v1069)
  {
    ...
    sub_10003DF54("CallTreeFrameLineRegex", "SPTextualReportParser.m", 1816, "%s: Unable to compile regex %s: %s", v721, v722, v723, v724, "regex", uTF8String6, uTF8String7);
  ...
  if (!v1068)
  {
    if (byte_100127EC8 == 1)
    {
      v725 = __error();
      v726 = *v725;
      v728 = sub_10003E080(v725, v727);
      if (os_log_type_enabled(v728, OS_LOG_TYPE_ERROR))
      {
        sub_1000C6480([(__CFString *)v76 UTF8String], buf);
      }
    ...
    if (byte_100127EC9 == 1 && dword_100127558 <= 3)
    {
      ...
      {
        v733 = sub_10003E080(0, v731);
        if (os_log_type_enabled(v733, OS_LOG_TYPE_FAULT))
        {
          sub_1000C64CC([(__CFString *)v76 UTF8String], v1119);
        }

        if (qword_100127ED0)
        {
          v734 = qword_100127ED0;
        }
    ...
    sub_10003DF54("CallTreeNonFrameLineRegex", "SPTextualReportParser.m", 1879, "%s: Unable to compile regex %s", v896, v897, v898, v899, "regex", uTF8String8);
    goto LABEL_1248;
  }
  ...
  if (!v1067)
  {
    if (byte_100127EC8 == 1)
    {
      v735 = __error();
      v736 = *v735;
      v738 = sub_10003E080(v735, v737);
      if (os_log_type_enabled(v738, OS_LOG_TYPE_ERROR))
      {
        sub_1000C6480([(__CFString *)v79 UTF8String], buf);
      }
    ...
    if (byte_100127EC9 == 1 && dword_100127558 <= 3)
    {
      ...
      {
        v743 = sub_10003E080(0, v741);
        if (os_log_type_enabled(v743, OS_LOG_TYPE_FAULT))
        {
          sub_1000C64CC([(__CFString *)v79 UTF8String], v1119);
        }

        if (qword_100127ED0)
        {
          v744 = qword_100127ED0;
        }
    ...
    sub_10003DF54("LoadInfoLineRegex", "SPTextualReportParser.m", 1958, "%s: Unable to compile regex %s", v902, v903, v904, v905, "regex", uTF8String9);
    goto LABEL_1248;
  }
  ...
  if (!v1064)
  {
    ...
    if (byte_100127EC9 == 1 && dword_100127558 <= 3)
    {
      ...
      {
        v753 = sub_10003E080(0, v751);
        if (os_log_type_enabled(v753, OS_LOG_TYPE_FAULT))
        {
          sub_1000C64CC([@"^UUID:(?<whitespace>\\s*)(?:<?(?<binaryUuid>[\\dabcdef\\-]{32 36})>?|(?<binaryIndex>\\d+))$"], v1119);
        }

        if (qword_100127ED0)
        {
          v754 = qword_100127ED0;
        }
    ...
    sub_10003DF54("UUIDLineRegex", "SPTextualReportParser.m", 1984, "%s: Unable to compile regex %s", v908, v909, v910, v911, "regex", v907);
    goto LABEL_1248;
  }
...
LABEL_248:
  if (self->_symbolicate)
  {
    ...
    sub_1000A0B94(v5, v1069, v1067, v1058, self->_useDsymForUUIDForEverything, self->_findDsymsForIDs);
  }

  v1070 = sub_1000A0E84(v5, 0, v1067, v1058);
  streamCopy6 = stream;
  if (!v1070)
  {
    if (byte_100127EC8 == 1)
...
LABEL_932:
  ...
  if (fgets(v1099[3], *(v1095 + 6), v5))
  {
    ...
    while (1)
    {
      ...
      {
        v1089 = 0;
        v1054 = sub_1000A0FE4(v181, v182, v1058, v1090, v1091);
        v1023 = [v182 rangeWithName:@"kernelDot"];
        v1102 = -1;
        v183 = sub_1000A10B4(v181, v1028, v182, v1070, v1058, &v1102);
        v184 = v183;
        if (v1052 != -1)
        {
        ...
        *&buf[48] = v207;
        ...
        if (v219 == 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          sub_10003DF54("ParseFrameLine", "SPTextualReportParser.m", 1511, "%s: frame match with no count (%d: %s)", v918, v919, v920, v921, "range.location != NSNotFound", v1028, uTF8String10);
          goto LABEL_1248;
        }

        v220 = [v215 substringWithRange:{v219, v218}];
        v1033 = sub_1000A2DC0(v220);
        ...
        if (v222 == 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          sub_10003DF54("ParseFrameLine", "SPTextualReportParser.m", 1515, "%s: frame match with no count and whitespace (%d: %s)", v925, v926, v927, v928, "range.location != NSNotFound", v1028, uTF8String11);
          goto LABEL_1248;
        }
...
LABEL_567:
              ...
              {
                v428 = [NSArray alloc];
                v277 = sub_1000A51AC(0, -1, 0, 0, 0, 0, -1);
              ...
              if ([v277 numSymbols] > 1 || !v1000 && ((v472 = objc_msgSend(v277, "hasSourceInfo"), !v239) ? (v473 = 1) : (v473 = v472), (v473 & 1) != 0))
              {
                ...
                v1119[1] = 3221225472;
                v1119[2] = sub_1000A533C;
                v1119[3] = &unk_100116018;
                v1124 = v214;
                v1120 = v277;
                v1121 = name2;
                v1123 = v1008;
                ...
                else
                {
                  ...
                  v469 = [NSArray alloc];
                  v470 = sub_1000A51AC(0, -1, 0, 0, 0, v466, v1008);
...
LABEL_358:
        ...
        if (v281)
        {
          ...
          sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 469, "%s: No frame bodies in %s (%d: %s)", v657, v658, v659, v660, "frameBodies.firstObject.length > 0", uTF8String17, v1028, uTF8String18);
...
LABEL_538:
              ...
              while (v392 < [v1047 count])
              {
                ...
                v399 = v1039;
                sub_1000A2E60(stream, v396 + v395 * (v393 + v392), v1023 != 0x7FFFFFFFFFFFFFFFLL, v1033, v1018, uTF8String19, v1015, [v1039 UTF8String], v1009, v309);
          ...
          else
          {
            if (v284)
            {
              if (!v1065)
              {
                ...
                sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 561, "%s: no previousNode for indent of %d (%d: %s)", v830, v831, v832, v833, "previousNode", v1054, v1028, uTF8String22);
                goto LABEL_1248;
              }
              ...
              if (v1050 >= v284)
              {
                ...
                sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 566, "%s: no previousNode for indent %d, previousIndentLevel %d (%d: %s)", v679, v680, v681, v682, "previousNode", v1054, v1050, v1028, uTF8String25);
                goto LABEL_1248;
              }
...
LABEL_513:
              ...
              v323 = sub_100098474(SPTreeNode, 0, v1023 != 0x7FFFFFFFFFFFFFFFLL, v1047, v1015, v1039, 0);
              [obj addObject:v323];
            }
            ...
            if ([v1022 containsString:@"Binary Images:"])
            {
              ...
              if (v568)
              {
                ...
                do
                {
                  ...
                  do
                  {
                    ...
                    v571 = *(*(&v1077 + 1) + 8 * v570);
                    v572 = sub_1000C5624(v571);
                    v573 = [v572 length];
                    v574 = v573;
                    if (!v573)
                    {
                      v575 = sub_1000C5684(v571);
                      v576 = [v575 length];
                      if (v576)
                      {
                        v574 = v576;
              ...
              if (v1032)
              {
                ...
                while (1)
                {
                  ...
                  v1012 = v585;
                  v1066 = sub_1000C5624(v584);
                  v586 = v1066;
                  uTF8String26 = [v1066 UTF8String];
                  v1057 = sub_1000C5684(v584);
                  v587 = v1057;
                  uTF8String27 = [v1057 UTF8String];
                  v1051 = sub_1000C56E4(v584);
                  v588 = v1051;
                ...
                sub_10003DF54("PrintLoadInfoLine", "SPTextualReportParser.m", 2394, "%s: Printed %d characters when max is %d: %s, %s, %s", v606, v607, v608, v609, "numChars < nameAndVersionWidth + 1", v610, v566, uTF8String26, uTF8String27, uTF8String28);
                goto LABEL_1248;
              }
...
LABEL_876:
              ...
              if ((v1058 & 1) == 0)
              {
                sub_1000A0E84(v5, v1028, v1067, 0);
                v1018 = 0;
                v998 = 0;
                v1065 = 0;
                v1054 = 0xFFFFFFFFLL;
...
LABEL_724:
                  ...
                  v541 = v540;
                  v542 = v541;
                  sub_1000A2F80(stream, v530, v534 & 1, v535, v1041 + 2, uTF8String32, [v541 UTF8String], 0, 0);
...
LABEL_730:
                ...
                if (byte_100127EC9 == 1 && dword_100127558 <= 3)
                {
                  ...
                  {
                    v977 = sub_10003E080(v975, v976);
                    if (os_log_type_enabled(v977, OS_LOG_TYPE_FAULT))
                    {
                      v978 = [v1056 debugDescription];
                      v979 = v978;
                      sub_1000C63BC([v978 UTF8String], v1119, v977, v978);
                    }

                    if (qword_100127ED0)
                    {
                      v980 = qword_100127ED0;
                    }
                ...
                sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 820, "%s: No angle bracket contents nor state info for non-frame (%s)", v994, v995, v996, v997, "heaviestNode.angleBracketContents || heaviestNode.stateInfo", uTF8String33);
...
LABEL_1248:
              ...
              while (1)
              {
                ...
                v515 = v513;
                v516 = v515;
                sub_1000A2E60(stream, v509 + v508 * (v1035 + v498), v506 & 1, v507, v1041 + 2, uTF8String34, v514, [v515 UTF8String], 0, 0);
...
LABEL_731:
              if (v1056)
              {
                ...
                if (v543 && [v543 count])
                {
                  [v544 sortUsingComparator:&stru_100115F08];
...
LABEL_503:
      ...
      else
      {
        ...
        if (v1058)
        {
          ...
          [v228 appendFormat:@", Effective %s", sub_1000A57B8((v249 >> 8) & 7)];
          [v228 appendFormat:@", Requested %s", sub_1000A57B8((v249 >> 11) & 7)];
          [v228 appendFormat:@", Override %s", sub_1000A57B8((v249 >> 14) & 7)];
        }
      ...
      else
      {
        ...
        if ((v1058 & 1) == 0 && [v1044 rangeWithName:@"countAndWhitespace"] == 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          sub_10003DF54("ParseCallTreeNonFrameLine", "SPTextualReportParser.m", 2186, "%s: frame match with no count and whitespace (%d: %s)", v943, v944, v945, v946, "range.location != NSNotFound", v1028, uTF8String35);
          goto LABEL_1248;
        }

        v326 = sub_1000A0FE4(v1055, v1044, v1058, v187, v188);
      }
      ...
      if (v334 == 0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        sub_10003DF54("ParseCallTreeNonFrameLine", "SPTextualReportParser.m", 2219, "%s: frame match with no count and whitespace (%d: %s)", v950, v951, v952, v953, "range.location != NSNotFound", v1028, uTF8String36);
        goto LABEL_1248;
      }
...
LABEL_469:
      if ((v326 & 0x80000000) != 0)
      {
        ...
        sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 640, "%s: Non-frame line has count but no indent level (%d: %s)", v936, v937, v938, v939, "rawIndentLevel >= 0", v1028, uTF8String37);
        goto LABEL_1248;
      }
...
LABEL_527:
        ...
        v388 = v1034;
        sub_1000A2F80(stream, v385 + (v368 + v326) * v384, v1030 != 0x7FFFFFFFFFFFFFFFLL, v1025, v369, uTF8String38, [v1034 UTF8String], v338, v339);
        goto LABEL_672;
      }
...
LABEL_668:
              v449 = sub_100098474(SPTreeNode, 0, v1030 != 0x7FFFFFFFFFFFFFFFLL, 0, 0xFFFFFFFFFFFFFFFFLL, v1034, v1040);
              [obj addObject:v449];
              goto LABEL_669;
            }
          }
...
LABEL_610:
      ...
      if (!v1065)
      {
        ...
        sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 697, "%s: no previousNode for indent of %d (%d: %s)", v878, v879, v880, v881, "previousNode", v326, v1028, uTF8String41);
        goto LABEL_1248;
      }
      ...
      do
      {
        ...
        if (!v448)
        {
          ...
          sub_10003DF54("[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 702, "%s: no previousNode for indent %d, previousIndentLevel %d (%d: %s)", v786, v787, v788, v789, "previousNode", v326, v1050, v1028, uTF8String44);
          goto LABEL_1248;
        }
