...
- (void)logInternal:(id)internal arguments:(char *)arguments
{
  ...
  if (WeakRetained)
  {
    ...
    if (delegateQueue)
    {
      ...
      v12[1] = 3254779904;
      v12[2] = __51__UARPSuperBinaryBackDeploy_logInternal_arguments___block_invoke;
...
void __51__UARPSuperBinaryBackDeploy_logInternal_arguments___block_invoke(uint64_t a1)
{
