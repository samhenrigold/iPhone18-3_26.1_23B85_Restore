...
- (GPBUInt32UInt64Dictionary)initWithDictionary:(id)dictionary;
- (GPBUInt32UInt64Dictionary)initWithUInt64s:(const unint64_t *)int64s forKeys:(const unsigned int *)keys count:(unint64_t)count;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt32UInt64Dictionary allocWithZone:zone];
