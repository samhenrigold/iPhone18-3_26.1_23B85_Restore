uint64_t CMMsl::KappaActivityWatch::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v7 & 0x100) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 100), 3u);
    v7 = *(v3 + 104);
    if ((v7 & 0x40) == 0)
    {
LABEL_8:
...
LABEL_24:
    this = PB::Writer::writeVarInt(a2, *(v3 + 64), 7u);
    if ((*(v3 + 104) & 4) == 0)
    {
      goto LABEL_13;
    }
...
uint64_t CMMsl::KappaAirbagResult::formatText(CMMsl::KappaAirbagResult *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((v5 & 0x10) != 0)
  {
    PB::TextFormatter::format(a2, "diffPeakTimestampTrigger", *(this + 10));
    v5 = *(this + 34);
    if ((v5 & 1) == 0)
    {
LABEL_3:
...
LABEL_20:
  PB::TextFormatter::format(a2, "pass", *(this + 64));
  v5 = *(this + 34);
  if ((v5 & 0x40) == 0)
  {
LABEL_7:
...
LABEL_23:
  PB::TextFormatter::format(a2, "pressureODR", *(this + 13));
  v5 = *(this + 34);
  if ((v5 & 0x100) == 0)
  {
LABEL_10:
...
LABEL_19:
  this = PB::Writer::writeVarInt(a2, *(v3 + 40), 7u);
  v4 = *(v3 + 68);
  if ((v4 & 1) == 0)
  {
LABEL_9:
...
LABEL_3:
  ...
  PB::TextFormatter::format(a2, "configFeatureSamples", *(this + 3));
  v5 = *(this + 27);
  if ((v5 & 4) == 0)
  {
LABEL_4:
...
LABEL_40:
  PB::TextFormatter::format(a2, "configPostTriggerLimitTime", *(this + 9));
  v5 = *(this + 27);
  if ((v5 & 0x100) == 0)
  {
LABEL_10:
...
LABEL_41:
  PB::TextFormatter::format(a2, "configPreTriggerLimitTime", *(this + 10));
  v5 = *(this + 27);
  if ((v5 & 0x200) == 0)
  {
LABEL_11:
...
LABEL_46:
  PB::TextFormatter::format(a2, "isAudioTPQ", *(this + 100));
  v5 = *(this + 27);
  if ((v5 & 0x1000000) == 0)
  {
LABEL_16:
...
LABEL_47:
  PB::TextFormatter::format(a2, "isFpThresholdsMet", *(this + 101));
  v5 = *(this + 27);
  if ((v5 & 0x2000000) == 0)
  {
LABEL_17:
...
LABEL_48:
  PB::TextFormatter::format(a2, "isNonPlanarTp", *(this + 102));
  v5 = *(this + 27);
  if ((v5 & 0x4000000) == 0)
  {
LABEL_18:
...
LABEL_49:
  PB::TextFormatter::format(a2, "isPlanarTp", *(this + 103));
  v5 = *(this + 27);
  if ((v5 & 0x8000000) == 0)
  {
LABEL_19:
...
LABEL_50:
  PB::TextFormatter::format(a2, "isTauBarWithinRange", *(this + 104));
  v5 = *(this + 27);
  if ((v5 & 0x2000) == 0)
  {
LABEL_20:
...
LABEL_57:
  PB::TextFormatter::format(a2, "sampleCount", *(this + 21));
  v5 = *(this + 27);
  if ((v5 & 0x100000) == 0)
  {
LABEL_27:
...
uint64_t CMMsl::KappaAudioResult::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x800000) != 0)
  {
    this = PB::Writer::write(a2, *(this + 100), 1u);
    v4 = *(v3 + 108);
    if ((v4 & 0x80000) == 0)
    {
LABEL_3:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 84), 2u);
  v4 = *(v3 + 108);
  if ((v4 & 0x20000) == 0)
  {
LABEL_4:
...
LABEL_32:
  this = PB::Writer::write(a2, *(v3 + 76), 3u);
  v4 = *(v3 + 108);
  if ((v4 & 0x10000) == 0)
  {
LABEL_5:
...
LABEL_34:
  this = PB::Writer::write(a2, *(v3 + 68), 5u);
  v4 = *(v3 + 108);
  if ((v4 & 0x200000) == 0)
  {
LABEL_7:
...
LABEL_42:
  this = PB::Writer::write(a2, *(v3 + 103), 0xDu);
  v4 = *(v3 + 108);
  if ((v4 & 0x2000000) == 0)
  {
LABEL_15:
...
LABEL_43:
  this = PB::Writer::write(a2, *(v3 + 102), 0xEu);
  v4 = *(v3 + 108);
  if ((v4 & 0x1000000) == 0)
  {
LABEL_16:
...
LABEL_44:
  this = PB::Writer::write(a2, *(v3 + 101), 0xFu);
  v4 = *(v3 + 108);
  if ((v4 & 0x8000000) == 0)
  {
LABEL_17:
...
LABEL_45:
  this = PB::Writer::write(a2, *(v3 + 104), 0x10u);
  v4 = *(v3 + 108);
  if ((v4 & 2) == 0)
  {
LABEL_18:
...
LABEL_46:
  this = PB::Writer::writeVarInt(a2, *(v3 + 12), 0x11u);
  v4 = *(v3 + 108);
  if ((v4 & 0x800) == 0)
  {
LABEL_19:
...
LABEL_47:
  this = PB::Writer::write(a2, *(v3 + 52), 0x12u);
  v4 = *(v3 + 108);
  if ((v4 & 0x100) == 0)
  {
LABEL_20:
...
LABEL_48:
  this = PB::Writer::writeVarInt(a2, *(v3 + 40), 0x13u);
  v4 = *(v3 + 108);
  if ((v4 & 0x80) == 0)
  {
LABEL_21:
...
LABEL_49:
  this = PB::Writer::writeVarInt(a2, *(v3 + 36), 0x14u);
  v4 = *(v3 + 108);
  if ((v4 & 0x40) == 0)
  {
LABEL_22:
...
LABEL_51:
  this = PB::Writer::write(a2, *(v3 + 28), 0x16u);
  v4 = *(v3 + 108);
  if ((v4 & 8) == 0)
  {
LABEL_24:
...
LABEL_52:
  this = PB::Writer::write(a2, *(v3 + 20), 0x17u);
  v4 = *(v3 + 108);
  if ((v4 & 4) == 0)
  {
LABEL_25:
...
LABEL_53:
  this = PB::Writer::write(a2, *(v3 + 16), 0x18u);
  v4 = *(v3 + 108);
  if ((v4 & 1) == 0)
  {
LABEL_26:
...
LABEL_54:
  this = PB::Writer::write(a2, *(v3 + 8), 0x19u);
  v4 = *(v3 + 108);
  if ((v4 & 0x10) == 0)
  {
LABEL_27:
...
LABEL_56:
    this = PB::Writer::write(a2, *(v3 + 48), 0x1Bu);
    if ((*(v3 + 108) & 0x200) == 0)
    {
      return this;
    }
...
LABEL_55:
  this = PB::Writer::write(a2, *(v3 + 24), 0x1Au);
  v4 = *(v3 + 108);
  if ((v4 & 0x400) != 0)
  {
    goto LABEL_56;
...
uint64_t CMMsl::KappaBaroResult::formatText(CMMsl::KappaBaroResult *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((v5 & 0x20000000) != 0)
  {
    PB::TextFormatter::format(a2, "airbagDetected", *(this + 148));
    v5 = *(this + 38);
    if ((v5 & 0x40) == 0)
    {
LABEL_3:
...
LABEL_44:
  PB::TextFormatter::format(a2, "diffPeakTimeTrigger", *(this + 22));
  v5 = *(this + 38);
  if ((v5 & 0x8000) == 0)
  {
LABEL_12:
...
LABEL_45:
  PB::TextFormatter::format(a2, "diffTimeTrigger", *(this + 23));
  v5 = *(this + 38);
  if ((v5 & 1) == 0)
  {
LABEL_13:
...
LABEL_48:
  PB::TextFormatter::format(a2, "eventStartTime", *(this + 3));
  v5 = *(this + 38);
  if ((v5 & 0x10000) == 0)
  {
LABEL_16:
...
LABEL_51:
  PB::TextFormatter::format(a2, "maxAccelNormOverEpochTimestamp", *(this + 4));
  v5 = *(this + 38);
  if ((v5 & 0x40000) == 0)
  {
LABEL_19:
...
LABEL_52:
  PB::TextFormatter::format(a2, "numAirbags", *(this + 26));
  v5 = *(this + 38);
  if ((v5 & 0x80000) == 0)
  {
LABEL_20:
...
LABEL_53:
  PB::TextFormatter::format(a2, "numBarosInEpoch", *(this + 27));
  v5 = *(this + 38);
  if ((v5 & 0x100000) == 0)
  {
LABEL_21:
...
LABEL_54:
  PB::TextFormatter::format(a2, "odr", *(this + 28));
  v5 = *(this + 38);
  if ((v5 & 0x200000) == 0)
  {
LABEL_22:
...
LABEL_56:
  PB::TextFormatter::format(a2, "peakTimestamp", *(this + 5));
  v5 = *(this + 38);
  if ((v5 & 0x400000) == 0)
  {
LABEL_24:
...
uint64_t CMMsl::KappaBaroResult::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x20000000) != 0)
  {
    this = PB::Writer::write(a2, *(this + 148), 1u);
    v4 = *(v3 + 152);
    if ((v4 & 0x200000) == 0)
    {
LABEL_3:
  ...
  this = PB::Writer::write(a2, *(v3 + 116), 2u);
  v4 = *(v3 + 152);
  if ((v4 & 4) == 0)
  {
LABEL_4:
...
LABEL_35:
  this = PB::Writer::write(a2, *(v3 + 144), 4u);
  v4 = *(v3 + 152);
  if ((v4 & 0x4000000) == 0)
  {
LABEL_6:
...
LABEL_36:
  this = PB::Writer::write(a2, *(v3 + 136), 5u);
  v4 = *(v3 + 152);
  if ((v4 & 0x100000) == 0)
  {
LABEL_7:
...
LABEL_38:
  this = PB::Writer::writeVarInt(a2, *(v3 + 104), 7u);
  v4 = *(v3 + 152);
  if ((v4 & 0x10) == 0)
  {
LABEL_9:
...
LABEL_40:
  this = PB::Writer::write(a2, *(v3 + 140), 9u);
  v4 = *(v3 + 152);
  if ((v4 & 0x8000) == 0)
  {
LABEL_11:
...
LABEL_41:
  this = PB::Writer::writeVarInt(a2, *(v3 + 92), 0xAu);
  v4 = *(v3 + 152);
  if ((v4 & 0x4000) == 0)
  {
LABEL_12:
...
LABEL_45:
  this = PB::Writer::write(a2, *(v3 + 128), 0xEu);
  v4 = *(v3 + 152);
  if ((v4 & 0x2000) == 0)
  {
LABEL_16:
...
LABEL_46:
  this = PB::Writer::write(a2, *(v3 + 84), 0xFu);
  v4 = *(v3 + 152);
  if ((v4 & 0x1000) == 0)
  {
LABEL_17:
...
LABEL_50:
  this = PB::Writer::write(a2, *(v3 + 68), 0x13u);
  v4 = *(v3 + 152);
  if ((v4 & 1) == 0)
  {
LABEL_21:
...
LABEL_51:
  this = PB::Writer::writeVarInt(a2, *(v3 + 8), 0x14u);
  v4 = *(v3 + 152);
  if ((v4 & 2) == 0)
  {
LABEL_22:
...
LABEL_53:
  this = PB::Writer::write(a2, *(v3 + 96), 0x16u);
  v4 = *(v3 + 152);
  if ((v4 & 0x20) == 0)
  {
LABEL_24:
...
LABEL_54:
  this = PB::Writer::writeVarInt(a2, *(v3 + 48), 0x17u);
  v4 = *(v3 + 152);
  if ((v4 & 0x2000000) == 0)
  {
LABEL_25:
...
LABEL_55:
  this = PB::Writer::write(a2, *(v3 + 132), 0x18u);
  v4 = *(v3 + 152);
  if ((v4 & 0x20000) == 0)
  {
LABEL_26:
...
LABEL_56:
  this = PB::Writer::write(a2, *(v3 + 100), 0x19u);
  v4 = *(v3 + 152);
  if ((v4 & 0x100) == 0)
  {
LABEL_27:
...
LABEL_58:
  this = PB::Writer::writeVarInt(a2, *(v3 + 108), 0x1Bu);
  v4 = *(v3 + 152);
  if ((v4 & 0x40) == 0)
  {
LABEL_29:
...
LABEL_60:
    this = PB::Writer::writeVarInt(a2, *(v3 + 32), 0x1Du);
    if ((*(v3 + 152) & 0x80) == 0)
    {
      return this;
    }
...
LABEL_59:
  this = PB::Writer::write(a2, *(v3 + 56), 0x1Cu);
  v4 = *(v3 + 152);
  if ((v4 & 8) != 0)
  {
    goto LABEL_60;
...
LABEL_17:
  if ((*(this + 150) & 8) != 0)
  {
    PB::TextFormatter::format(a2, "crashDetectorDecision", *(this + 280));
  }
...
LABEL_109:
  PB::TextFormatter::format(a2, "detectorRegime", *(this + 24));
  v7 = *v5;
  if ((*v5 & 0x400000) == 0)
  {
LABEL_26:
...
LABEL_44:
  ...
  if ((v8 & 0x10) != 0)
  {
    PB::TextFormatter::format(a2, "hasAudioInEpoch", *(this + 281));
    v8 = *(this + 150);
    if ((v8 & 0x20) == 0)
    {
LABEL_46:
  ...
  PB::TextFormatter::format(a2, "isAudio", *(this + 282));
  v8 = *(this + 150);
  if ((v8 & 0x40) == 0)
  {
LABEL_47:
...
LABEL_130:
  PB::TextFormatter::format(a2, "isAudioDv", *(this + 283));
  v8 = *(this + 150);
  if ((v8 & 0x80) == 0)
  {
LABEL_48:
...
LABEL_131:
  PB::TextFormatter::format(a2, "isAudioSupported", *(this + 284));
  v8 = *(this + 150);
  if ((v8 & 0x100) == 0)
  {
LABEL_49:
...
LABEL_132:
  PB::TextFormatter::format(a2, "isBaro", *(this + 285));
  v8 = *(this + 150);
  if ((v8 & 0x200) == 0)
  {
LABEL_50:
...
LABEL_133:
  PB::TextFormatter::format(a2, "isCompanionConnected", *(this + 286));
  v8 = *(this + 150);
  if ((v8 & 0x400) == 0)
  {
LABEL_51:
...
LABEL_134:
  PB::TextFormatter::format(a2, "isFreeFall", *(this + 287));
  v8 = *(this + 150);
  if ((v8 & 0x800) == 0)
  {
LABEL_52:
...
LABEL_135:
  PB::TextFormatter::format(a2, "isPulse", *(this + 288));
  if ((*(this + 150) & 0x1000) != 0)
  {
LABEL_53:
    PB::TextFormatter::format(a2, "lowSenseCrashDetectorDecision", *(this + 289));
  }
...
LABEL_159:
    PB::TextFormatter::format(a2, "numShortAudio", *(this + 65));
...
LABEL_80:
  ...
  PB::TextFormatter::format(a2, "shortAudioMet", *(this + 290));
  v10 = *(this + 150);
  if ((v10 & 2) == 0)
  {
LABEL_81:
...
LABEL_164:
  ...
  {
LABEL_83:
    PB::TextFormatter::format(a2, "strongerAudio", *(this + 291));
  }
