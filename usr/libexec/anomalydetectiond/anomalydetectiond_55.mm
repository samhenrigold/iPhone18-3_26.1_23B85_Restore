...
LABEL_63:
  this = PB::Writer::write(a2, *(v3 + 116), 0xCu);
  v4 = *(v3 + 188);
  if ((v4 & 0x8000000) == 0)
  {
LABEL_14:
...
LABEL_71:
  this = PB::Writer::write(a2, *(v3 + 100), 0x14u);
  v4 = *(v3 + 188);
  if ((v4 & 4) == 0)
  {
LABEL_22:
...
LABEL_72:
  this = PB::Writer::write(a2, *(v3 + 20), 0x15u);
  v4 = *(v3 + 188);
  if ((v4 & 0x400000000) == 0)
  {
LABEL_23:
...
LABEL_73:
  this = PB::Writer::write(a2, *(v3 + 148), 0x16u);
  v4 = *(v3 + 188);
  if ((v4 & 0x4000) == 0)
  {
LABEL_24:
...
LABEL_74:
  this = PB::Writer::write(a2, *(v3 + 68), 0x17u);
  v4 = *(v3 + 188);
  if ((v4 & 0x2000000000) == 0)
  {
LABEL_25:
...
LABEL_76:
  this = PB::Writer::write(a2, *(v3 + 80), 0x19u);
  v4 = *(v3 + 188);
  if ((v4 & 0x800000000) == 0)
  {
LABEL_27:
...
LABEL_77:
  this = PB::Writer::write(a2, *(v3 + 152), 0x1Au);
  v4 = *(v3 + 188);
  if ((v4 & 0x8000) == 0)
  {
LABEL_28:
...
LABEL_78:
  this = PB::Writer::write(a2, *(v3 + 72), 0x1Bu);
  v4 = *(v3 + 188);
  if ((v4 & 0x4000000000) == 0)
  {
LABEL_29:
...
LABEL_79:
  this = PB::Writer::write(a2, *(v3 + 164), 0x1Cu);
  v4 = *(v3 + 188);
  if ((v4 & 0x40000) == 0)
  {
LABEL_30:
...
LABEL_80:
  this = PB::Writer::write(a2, *(v3 + 84), 0x1Du);
  v4 = *(v3 + 188);
  if ((v4 & 0x1000000000) == 0)
  {
LABEL_31:
...
LABEL_81:
  this = PB::Writer::write(a2, *(v3 + 156), 0x1Eu);
  v4 = *(v3 + 188);
  if ((v4 & 0x10000) == 0)
  {
LABEL_32:
...
LABEL_82:
  this = PB::Writer::write(a2, *(v3 + 76), 0x1Fu);
  v4 = *(v3 + 188);
  if ((v4 & 0x8000000000) == 0)
  {
LABEL_33:
...
LABEL_84:
  this = PB::Writer::write(a2, *(v3 + 88), 0x21u);
  v4 = *(v3 + 188);
  if ((v4 & 0x200000000000) == 0)
  {
LABEL_35:
...
LABEL_85:
  this = PB::Writer::write(a2, *(v3 + 183), 0x22u);
  v4 = *(v3 + 188);
  if ((v4 & 0x800) == 0)
  {
LABEL_36:
...
LABEL_86:
  this = PB::Writer::write(a2, *(v3 + 56), 0x23u);
  v4 = *(v3 + 188);
  if ((v4 & 0x1000) == 0)
  {
LABEL_37:
...
LABEL_87:
  this = PB::Writer::write(a2, *(v3 + 60), 0x24u);
  v4 = *(v3 + 188);
  if ((v4 & 0x100000000000) == 0)
  {
LABEL_38:
...
LABEL_88:
  this = PB::Writer::write(a2, *(v3 + 182), 0x25u);
  v4 = *(v3 + 188);
  if ((v4 & 0x400000000000) == 0)
  {
LABEL_39:
...
LABEL_89:
  this = PB::Writer::write(a2, *(v3 + 184), 0x26u);
  v4 = *(v3 + 188);
  if ((v4 & 0x2000) == 0)
  {
LABEL_40:
...
LABEL_90:
  this = PB::Writer::writeVarInt(a2, *(v3 + 64), 0x27u);
  v4 = *(v3 + 188);
  if ((v4 & 0x100000000) == 0)
  {
LABEL_41:
...
LABEL_91:
  this = PB::Writer::write(a2, *(v3 + 140), 0x28u);
  v4 = *(v3 + 188);
  if ((v4 & 0x200000000) == 0)
  {
LABEL_42:
...
LABEL_92:
  this = PB::Writer::write(a2, *(v3 + 144), 0x29u);
  v4 = *(v3 + 188);
  if ((v4 & 0x1000000000000) == 0)
  {
LABEL_43:
...
LABEL_93:
  this = PB::Writer::write(a2, *(v3 + 186), 0x2Au);
  v4 = *(v3 + 188);
  if ((v4 & 0x80000000000) == 0)
  {
LABEL_44:
...
LABEL_94:
  this = PB::Writer::write(a2, *(v3 + 181), 0x2Bu);
  v4 = *(v3 + 188);
  if ((v4 & 0x40000000000) == 0)
  {
LABEL_45:
...
LABEL_95:
  this = PB::Writer::write(a2, *(v3 + 180), 0x2Cu);
  v4 = *(v3 + 188);
  if ((v4 & 0x20000000) == 0)
  {
LABEL_46:
...
LABEL_96:
  this = PB::Writer::write(a2, *(v3 + 128), 0x2Du);
  v4 = *(v3 + 188);
  if ((v4 & 0x20000000000) == 0)
  {
LABEL_47:
...
LABEL_98:
  this = PB::Writer::write(a2, *(v3 + 172), 0x2Fu);
  v4 = *(v3 + 188);
  if ((v4 & 0x100000) == 0)
  {
LABEL_49:
...
LABEL_100:
    this = PB::Writer::write(a2, *(v3 + 185), 0x31u);
...
LABEL_99:
  this = PB::Writer::writeVarInt(a2, *(v3 + 92), 0x30u);
  v4 = *(v3 + 188);
  if ((v4 & 0x800000000000) != 0)
  {
    goto LABEL_100;
...
LABEL_45:
  PB::TextFormatter::format(a2, "hasUnCorrelatedSrcMotion", *(this + 120));
  v5 = *(this + 32);
  if ((v5 & 0x4000000) == 0)
  {
LABEL_11:
...
LABEL_46:
  PB::TextFormatter::format(a2, "inHeadTurnState", *(this + 121));
  v5 = *(this + 32);
  if ((v5 & 0x8000000) == 0)
  {
LABEL_12:
...
LABEL_47:
  PB::TextFormatter::format(a2, "inLikelySlowBodyTurnPed", *(this + 122));
  v5 = *(this + 32);
  if ((v5 & 0x10000000) == 0)
  {
LABEL_13:
...
LABEL_48:
  PB::TextFormatter::format(a2, "isInCorrelatedActivity", *(this + 123));
  v5 = *(this + 32);
  if ((v5 & 0x20000000) == 0)
  {
LABEL_14:
...
LABEL_49:
  PB::TextFormatter::format(a2, "isInCorrelatedMotion", *(this + 124));
  v5 = *(this + 32);
  if ((v5 & 1) == 0)
  {
LABEL_15:
...
LABEL_53:
  PB::TextFormatter::format(a2, "likelyOnGymMachine", *(this + 125));
  v5 = *(this + 32);
  if ((v5 & 0x1000) == 0)
  {
LABEL_19:
...
LABEL_67:
  PB::TextFormatter::format(a2, "steadyStatePedestrian", *(this + 126));
  if ((*(this + 32) & 4) != 0)
  {
LABEL_33:
...
LABEL_3:
  ...
  this = PB::Writer::write(a2, *(v3 + 100), 2u);
  v4 = *(v3 + 128);
  if ((v4 & 0x80) == 0)
  {
LABEL_4:
...
LABEL_43:
  this = PB::Writer::write(a2, *(v3 + 124), 0xAu);
  v4 = *(v3 + 128);
  if ((v4 & 0x2000000) == 0)
  {
LABEL_12:
...
LABEL_44:
  this = PB::Writer::write(a2, *(v3 + 120), 0xBu);
  v4 = *(v3 + 128);
  if ((v4 & 0x400) == 0)
  {
LABEL_13:
...
LABEL_46:
  this = PB::Writer::write(a2, *(v3 + 123), 0xDu);
  v4 = *(v3 + 128);
  if ((v4 & 0x40000000) == 0)
  {
LABEL_15:
...
LABEL_47:
  this = PB::Writer::write(a2, *(v3 + 125), 0xEu);
  v4 = *(v3 + 128);
  if ((v4 & 0x40000) == 0)
  {
LABEL_16:
...
LABEL_48:
  this = PB::Writer::write(a2, *(v3 + 92), 0xFu);
  v4 = *(v3 + 128);
  if ((v4 & 0x20) == 0)
  {
LABEL_17:
...
LABEL_50:
  this = PB::Writer::write(a2, *(v3 + 88), 0x11u);
  v4 = *(v3 + 128);
  if ((v4 & 0x10) == 0)
  {
LABEL_19:
...
LABEL_51:
  this = PB::Writer::write(a2, *(v3 + 36), 0x12u);
  v4 = *(v3 + 128);
  if ((v4 & 0x100) == 0)
  {
LABEL_20:
...
LABEL_54:
  this = PB::Writer::write(a2, *(v3 + 126), 0x15u);
  v4 = *(v3 + 128);
  if ((v4 & 0x10000) == 0)
  {
LABEL_23:
...
LABEL_56:
  this = PB::Writer::write(a2, *(v3 + 32), 0x17u);
  v4 = *(v3 + 128);
  if ((v4 & 0x200) == 0)
  {
LABEL_25:
...
LABEL_57:
  this = PB::Writer::write(a2, *(v3 + 56), 0x18u);
  v4 = *(v3 + 128);
  if ((v4 & 0x200000) == 0)
  {
LABEL_26:
...
LABEL_58:
  this = PB::Writer::write(a2, *(v3 + 104), 0x19u);
  v4 = *(v3 + 128);
  if ((v4 & 0x4000000) == 0)
  {
LABEL_27:
...
LABEL_59:
  this = PB::Writer::write(a2, *(v3 + 121), 0x1Au);
  v4 = *(v3 + 128);
  if ((v4 & 0x800) == 0)
  {
LABEL_28:
...
LABEL_61:
  this = PB::Writer::write(a2, *(v3 + 8), 0x1Cu);
  v4 = *(v3 + 128);
  if ((v4 & 2) == 0)
  {
LABEL_30:
...
LABEL_64:
    this = PB::Writer::write(a2, *(v3 + 80), 0x1Fu);
...
LABEL_63:
  this = PB::Writer::write(a2, *(v3 + 116), 0x1Eu);
  v4 = *(v3 + 128);
  if ((v4 & 0x8000) != 0)
  {
    goto LABEL_64;
...
uint64_t CMMsl::RelativeDeviceMotionInternal::formatText(CMMsl::RelativeDeviceMotionInternal *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((v5 & 0x400000) != 0)
  {
    PB::TextFormatter::format(a2, "btz", *(this + 152));
    v5 = *(this + 41);
    if ((v5 & 4) == 0)
    {
LABEL_3:
...
LABEL_45:
  PB::TextFormatter::format(a2, "btzIsCurrentlyQuiescent", *(this + 153));
  v5 = *(this + 41);
  if ((v5 & 8) == 0)
  {
LABEL_5:
...
LABEL_49:
  PB::TextFormatter::format(a2, "centeredBoresight", *(this + 154));
  v5 = *(this + 41);
  if ((v5 & 0x2000000) == 0)
  {
LABEL_9:
...
LABEL_50:
  PB::TextFormatter::format(a2, "centeredBoresightInHighDynamics", *(this + 155));
  v5 = *(this + 41);
  if ((v5 & 0x40) == 0)
  {
LABEL_10:
...
LABEL_51:
  PB::TextFormatter::format(a2, "clientMode", *(this + 22));
  if ((*(this + 41) & 0x4000000) != 0)
  {
LABEL_11:
    PB::TextFormatter::format(a2, "inComplexTransitionState", *(this + 156));
  }
...
LABEL_12:
  ...
  if ((v9 & 0x8000000) != 0)
  {
    PB::TextFormatter::format(a2, "pinnedBoresight", *(this + 157));
    v9 = *(this + 41);
    if ((v9 & 0x80) == 0)
    {
LABEL_16:
...
LABEL_64:
  PB::TextFormatter::format(a2, "requestingCamera", *(this + 158));
  if (*(this + 41))
  {
LABEL_27:
...
LABEL_32:
  ...
  PB::TextFormatter::format(a2, "tracking1IMU", *(this + 159));
  v13 = *(this + 41);
  if ((v13 & 0x20000) == 0)
  {
LABEL_33:
...
LABEL_68:
  PB::TextFormatter::format(a2, "trackingBehavior", *(this + 33));
  v13 = *(this + 41);
  if ((v13 & 0x40000000) == 0)
  {
LABEL_34:
...
LABEL_69:
  PB::TextFormatter::format(a2, "trackingDisabled", *(this + 160));
  v13 = *(this + 41);
  if ((v13 & 0x40000) == 0)
  {
LABEL_35:
...
LABEL_70:
  PB::TextFormatter::format(a2, "trackingScheme", *(this + 34));
  v13 = *(this + 41);
  if ((v13 & 0x80000000) == 0)
  {
LABEL_36:
...
LABEL_71:
  PB::TextFormatter::format(a2, "useRelaxedQuiescenceBounds", *(this + 161));
  v13 = *(this + 41);
  if ((v13 & 0x80000) == 0)
  {
LABEL_37:
...
LABEL_48:
  this = PB::Writer::write(a2, *(v3 + 140), 8u);
  v4 = *(v3 + 164);
  if ((v4 & 0x100000) == 0)
  {
LABEL_10:
...
LABEL_49:
  this = PB::Writer::write(a2, *(v3 + 144), 9u);
  v4 = *(v3 + 164);
  if ((v4 & 0x200000) == 0)
  {
LABEL_11:
...
LABEL_50:
  this = PB::Writer::write(a2, *(v3 + 148), 0xAu);
  v4 = *(v3 + 164);
  if ((v4 & 0x100) == 0)
  {
LABEL_12:
...
LABEL_52:
  this = PB::Writer::write(a2, *(v3 + 100), 0xCu);
  v4 = *(v3 + 164);
  if ((v4 & 0x400) != 0)
  {
    goto LABEL_53;
...
LABEL_14:
  ...
  {
LABEL_15:
    this = PB::Writer::write(a2, *(v3 + 92), 0xEu);
  }
...
LABEL_16:
  ...
  if ((v11 & 0x8000000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 157), 0x11u);
    v11 = *(v3 + 164);
    if ((v11 & 0x400000) == 0)
    {
LABEL_24:
...
LABEL_57:
  this = PB::Writer::write(a2, *(v3 + 154), 0x13u);
  v11 = *(v3 + 164);
  if ((v11 & 0x10) == 0)
  {
LABEL_26:
...
LABEL_61:
  this = PB::Writer::write(a2, *(v3 + 159), 0x17u);
  v11 = *(v3 + 164);
  if ((v11 & 0x80000000) == 0)
  {
LABEL_30:
...
LABEL_62:
  this = PB::Writer::write(a2, *(v3 + 161), 0x18u);
  v11 = *(v3 + 164);
  if ((v11 & 0x800000) == 0)
  {
LABEL_31:
...
LABEL_64:
  this = PB::Writer::write(a2, *(v3 + 84), 0x1Au);
  v11 = *(v3 + 164);
  if ((v11 & 0x40000) == 0)
  {
LABEL_33:
...
LABEL_65:
  this = PB::Writer::writeVarInt(a2, *(v3 + 136), 0x1Bu);
  v11 = *(v3 + 164);
  if ((v11 & 0x10000000) == 0)
  {
LABEL_34:
...
LABEL_66:
  this = PB::Writer::write(a2, *(v3 + 158), 0x1Cu);
  v11 = *(v3 + 164);
  if ((v11 & 0x4000000) == 0)
  {
LABEL_35:
...
LABEL_67:
  this = PB::Writer::write(a2, *(v3 + 156), 0x1Du);
  v11 = *(v3 + 164);
  if ((v11 & 0x40000000) == 0)
  {
LABEL_36:
...
LABEL_69:
  this = PB::Writer::write(a2, *(v3 + 56), 0x1Fu);
  v11 = *(v3 + 164);
  if ((v11 & 0x40) == 0)
  {
LABEL_38:
...
LABEL_71:
    this = PB::Writer::write(a2, *(v3 + 155), 0x21u);
    if ((*(v3 + 164) & 0x20000) == 0)
    {
      return this;
    }
...
LABEL_70:
  this = PB::Writer::writeVarInt(a2, *(v3 + 88), 0x20u);
  v11 = *(v3 + 164);
  if ((v11 & 0x2000000) != 0)
  {
    goto LABEL_71;
...
LABEL_19:
  PB::TextFormatter::format(a2, "isAvgGrav", *(this + 44));
  v5 = *(this + 24);
  if ((v5 & 0x40) == 0)
  {
LABEL_8:
...
uint64_t CMMsl::RhythmicGnssOperatorStatus::formatText(CMMsl::RhythmicGnssOperatorStatus *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((v5 & 8) != 0)
  {
    PB::TextFormatter::format(a2, "activeGnssSession", *(this + 20));
    v5 = *(this + 24);
    if ((v5 & 1) == 0)
    {
LABEL_3:
  ...
  PB::TextFormatter::format(a2, "currentModesOfOperation", *(this + 2));
  v5 = *(this + 24);
  if ((v5 & 2) == 0)
  {
LABEL_4:
...
LABEL_12:
  PB::TextFormatter::format(a2, "gnssModeOfOperation", *(this + 3));
  v5 = *(this + 24);
  if ((v5 & 0x10) == 0)
  {
LABEL_5:
...
LABEL_13:
  PB::TextFormatter::format(a2, "hasSubscribedRhythmicClient", *(this + 21));
  if ((*(this + 24) & 4) != 0)
  {
LABEL_6:
    PB::TextFormatter::format(a2, "rhythmicMode", *(this + 4));
  }
...
LABEL_10:
    this = PB::Writer::writeVarInt(a2, *(v3 + 8), 4u);
    if ((*(v3 + 24) & 0x10) == 0)
    {
      return this;
    }
