...
- (GPBInt32UInt32Dictionary)initWithDictionary:(id)dictionary;
- (GPBInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)int32s forKeys:(const int *)keys count:(unint64_t)count;
...
{
  v14.receiver = self;
  v14.super_class = GPBInt32UInt32Dictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBInt32UInt32Dictionary;
  [(GPBInt32UInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBInt32UInt32Dictionary allocWithZone:zone];
