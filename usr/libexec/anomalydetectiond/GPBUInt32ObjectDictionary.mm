...
- (BOOL)isInitialized;
- (GPBUInt32ObjectDictionary)initWithDictionary:(id)dictionary;
- (GPBUInt32ObjectDictionary)initWithObjects:(const void *)objects forKeys:(const unsigned int *)keys count:(unint64_t)count;
...
{
  v12.receiver = self;
  v12.super_class = GPBUInt32ObjectDictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBUInt32ObjectDictionary;
  [(GPBUInt32ObjectDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt32ObjectDictionary allocWithZone:zone];
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      v16 = sub_10031D598(unsignedIntValue, 1, mapKeyDataType);
