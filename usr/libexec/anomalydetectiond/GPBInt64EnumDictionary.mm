...
- (void)setEnum:(int)enum forKey:(int64_t)key
{
  ...
  {
    [NSException raise:NSInvalidArgumentException format:@"GPBInt64EnumDictionary: Attempt to set an unknown enum value (%d)", v5];
  }
