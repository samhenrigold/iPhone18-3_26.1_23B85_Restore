...
{
  v14.receiver = self;
  v14.super_class = GPBInt32Int32Dictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBInt32Int32Dictionary;
  [(GPBInt32Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBInt32Int32Dictionary allocWithZone:zone];
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      [stream writeInt32NoTag:{sub_10031DFD8(intValue2, 2, v7) + v17}];
      sub_10031E218(stream, intValue, 1, mapKeyDataType);
      sub_10031E218(stream, intValue2, 2, v7);
      nextObject2 = [keyEnumerator nextObject];
    }
