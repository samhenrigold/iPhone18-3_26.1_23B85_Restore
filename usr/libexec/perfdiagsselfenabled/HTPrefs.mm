  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = i + 1)
      {
        ...
        v14 = *(*(&v30 + 1) + 8 * i);
        v15 = [(__CFString *)v14 isEqualToString:&stru_100018A40];
        if (v15)
        {
          namedCopy = namedCopy;
        }
...
- (unsigned)unsignedIntProperty:(HTPrefInit *)property contextPrefixOut:(id *)out
{
  ...
  {
    v10 = sub_10000B598(unsignedIntValue);
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      var0 = property->var0;
      var4 = property->var4;
...
LABEL_9:
  ...
  {
    v13 = sub_10000B598(tailspinSaveFormat);
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      sub_10000CDA0();
    }
  ...
  {
    v14 = sub_10000B598(tailspinSaveFormat);
...
- (void)initPropertyReportPeriod:(HTPrefInit *)period
{
  ...
  v10 = v7 * 1000.0 / sub_10000BAE0(v6, v8);
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *&result[12].var2.var0 = xmmword_10000F560;
...
- (void)refreshHTPrefs
{
  ...
  {
    v8 = sub_10000B598([(HTPrefs *)self setShouldPostHTPrefsChangedNotification:0]);
...
LABEL_11:
    ...
    CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_100019FF0, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
  }
...
- (void)setupPrefsWithQueue:(id)queue profilePath:(id)path taskingDomainName:(__CFString *)name hangtracerDomain:(__CFString *)domain setupInternalPrefs:(BOOL)prefs
{
  ...
  *buf = 0;
  ...
  notify_register_dispatch(off_10001E748, v30 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10001E730, v42 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10001E738, v38 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10001E740, v34 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(off_10001E750, v24 + 6, self->__prefsQueue, v19);
  [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
