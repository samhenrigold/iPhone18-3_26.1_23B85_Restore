...
LABEL_86:
    ...
    *(&v58.st_ino + 6) = v43;
    _os_log_error_impl(&dword_296E3E000, v39, OS_LOG_TYPE_ERROR, "Failed to open base directory %s (%s)", &v58, 0x16u);
    goto LABEL_86;
  }
...
void sub_296E431AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
...
void sub_296E47894(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
