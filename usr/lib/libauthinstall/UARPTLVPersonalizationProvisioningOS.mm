...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationProvisioningOS;
...
- (void)setProvisioning:(unsigned __int8)provisioning
{
  ...
  *(&selfCopy->super.super._tlvLength + 4) = provisioning;
  objc_sync_exit(selfCopy);
}

- (id)description
{
  v3 = +[UARPTLVPersonalizationProvisioningOS metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationProvisioningOS tlvType];
  v4 = *(&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationProvisioningOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationProvisioningOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = [MEMORY[0x29EDBA070] numberWithUnsignedInt:{+[UARPTLVPersonalizationProvisioningOS tlvType](UARPTLVPersonalizationProvisioningOS, "tlvType")}];
  v6[1] = v2;
