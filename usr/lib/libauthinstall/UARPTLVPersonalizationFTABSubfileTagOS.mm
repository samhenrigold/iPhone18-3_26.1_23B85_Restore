...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationFTABSubfileTagOS;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationFTABSubfileTagOS metaDataTableEntry];
...
- (id)generateTLV
{
  ...
  v8 = uarpHtonl(+[UARPTLVPersonalizationFTABSubfileTagOS tlvType]);
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = [MEMORY[0x29EDBA070] numberWithUnsignedInt:{+[UARPTLVPersonalizationFTABSubfileTagOS tlvType](UARPTLVPersonalizationFTABSubfileTagOS, "tlvType")}];
  v6[1] = v2;
