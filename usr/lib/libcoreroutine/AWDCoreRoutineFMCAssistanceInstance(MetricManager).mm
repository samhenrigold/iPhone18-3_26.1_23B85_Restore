...
- (char)_init
{
  ...
  if (v1)
  {
    v3 = *MEMORY[0x277D81958];
    v4 = *&v1[v3];
    *&v1[v3] = 0;

    *&v2[*MEMORY[0x277D81948]] = 0;
    *&v2[*MEMORY[0x277D81950]] = 0;
    *&v2[*MEMORY[0x277D81960]] = 0;
  }
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"%@, assistanceType %d, assistanceValue %d, uiPlacement %d", v5, objc_msgSend(self, "assistanceType"), objc_msgSend(self, "assistanceValue"), objc_msgSend(self, "uiPlacement")];
