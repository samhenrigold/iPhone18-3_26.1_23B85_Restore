...
LABEL_44:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(v38, 797, 0, v13 + 4709, v18, v19, v20, v21, *v13, a2, a3, a4);
    v22 = byte_21B175;
    if (byte_21B175)
    {
      breakpoint_break(v38, (&stru_2E8.align + 1), 1, *(v13 + 851), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v23 = mach_absolute_time();
      (*(v13[4] + 7944))(a1, a2, a3, a4);
...
LABEL_17:
  ...
  v16 = *(v12 + 40);
  v17 = atomic_fetch_add(v16 + 1160, 1u) + 1;
  ...
  else
  {
    ...
    {
LABEL_52:
      atomic_fetch_add(v16 + 1160, 0xFFFFFFFF);
  ...
  *(v16 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    GPUTools::FB::Encode(v39, 814, 0, v10, v19, v20, v21, v22, *v16, a2, a3, a4);
    v23 = byte_21B186;
    if (byte_21B186)
    {
      breakpoint_break(v39, (&stru_2E8.reserved1 + 2), 1, v16[851], v16);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v23 & 4))
    {
      v24 = mach_absolute_time();
      (*(*(v16 + 4) + 8016))(a1, a2, a3, a4);
...
LABEL_31:
    ...
    if ([objc_msgSend(DYGetGLGuestAppClient() "activeCaptureDescriptor")])
    {
      encode_driver_events(v16, v39);
    }

    GPUTools::FB::EncodeThreadQueueInfo(v16 + 435, v16 + 440, v39);
    v27 = v16[851];
...
LABEL_40:
        ...
        v30 = atomic_fetch_add(v16 + 1160, 0xFFFFFFFF) - 1;
    ...
    breakpoint_break(v39, v36, v35, v27, v16);
    goto LABEL_40;
  }

  atomic_fetch_add(v16 + 1160, 0xFFFFFFFF);
  [DYGetGLGuestAppClient() triggerArmedCapture];
  (*(*(v16 + 3) + 8016))(a1, a2, a3, a4);
LABEL_48:
  if (v39[0])
  {
    free(v39[0]);
...
LABEL_46:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(v39, 815, 0, v13 + 4709, v18, v19, v20, v21, *v13, a2, a3, a4);
    v22 = byte_21B187;
    if (byte_21B187)
    {
      breakpoint_break(v39, (&stru_2E8.reserved1 + 3), 1, *(v13 + 851), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v23 = mach_absolute_time();
      (*(v13[4] + 8024))(a1, a2, a3, a4);
      v24 = mach_absolute_time() - v23;
      if (g_DYTimebaseInfo == *(&g_DYTimebaseInfo + 1))
      {
        v25 = v39[0];
...
LABEL_46:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(v39, 816, 0, v13 + 4709, v18, v19, v20, v21, *v13, a2, a3, a4);
    v22 = byte_21B188;
    if (byte_21B188)
    {
      breakpoint_break(v39, &stru_2E8.reserved2, 1, *(v13 + 851), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v23 = mach_absolute_time();
      (*(v13[4] + 8032))(a1, a2, a3, a4);
      v24 = mach_absolute_time() - v23;
      if (g_DYTimebaseInfo == *(&g_DYTimebaseInfo + 1))
      {
        v25 = v39[0];
...
LABEL_46:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    snprintf(v13 + 4709, 0x40uLL, "Cee@%u%c", *&v38[1], v17);
    GPUTools::FB::Encode(v39, 817, 0, v13 + 4709, v18, v19, v20, v21, *v13, a2, a3, a4);
    v22 = byte_21B189;
    if (byte_21B189)
    {
      breakpoint_break(v39, (&stru_2E8.reserved2 + 1), 1, *(v13 + 851), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v23 = mach_absolute_time();
      (*(v13[4] + 8040))(a1, a2, a3, a4);
      v24 = mach_absolute_time() - v23;
      if (g_DYTimebaseInfo == *(&g_DYTimebaseInfo + 1))
      {
        v25 = v39[0];
