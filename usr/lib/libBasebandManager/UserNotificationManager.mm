...
LABEL_237:
    ...
    *(&buf + 4) = v10;
    _os_log_error_impl(&dword_296FF7000, v116, OS_LOG_TYPE_ERROR, "Unsupported header: %s", &buf, 0xCu);
    v107 = 0;
    goto LABEL_214;
  }
...
LABEL_101:
              ...
              *v58 = 136315138;
              v59 = v42;
              _os_log_impl(&dword_296FF7000, v41, OS_LOG_TYPE_INFO, "Removed callback for id: %s", v58, 0xCu);
            }
          }
