...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallInvitationSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallInvitationSent;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDFaceTimeCallInvitationSent description](&v3, sel_description), -[AWDFaceTimeCallInvitationSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
