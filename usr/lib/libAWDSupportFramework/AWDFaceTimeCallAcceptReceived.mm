...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallAcceptReceived;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallAcceptReceived;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDFaceTimeCallAcceptReceived description](&v3, sel_description), -[AWDFaceTimeCallAcceptReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)mergeFrom:(id)from
{
  if (*(from + 2))
  {
    [(AWDFaceTimeCallAcceptReceived *)self setGuid:?];
  }
