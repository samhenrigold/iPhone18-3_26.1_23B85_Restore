...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_loads count])
  {
    ...
    v14 = 0u;
    loads = self->_loads;
    v6 = [(NSMutableArray *)loads countByEnumeratingWithState:&v11 objects:v15 count:16];
    if (v6)
    {
      v7 = v6;
      v8 = *v12;
      do
      {
        ...
        while (v7 != v9);
        v7 = [(NSMutableArray *)loads countByEnumeratingWithState:&v11 objects:v15 count:16];
      }
...
- (void)writeTo:(id)to
{
  ...
  v10 = 0u;
  loads = self->_loads;
  v5 = [(NSMutableArray *)loads countByEnumeratingWithState:&v9 objects:v13 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v10;
    do
    {
      ...
      while (v6 != v8);
      v6 = [(NSMutableArray *)loads countByEnumeratingWithState:&v9 objects:v13 count:16];
    }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v15 = 0u;
  loads = self->_loads;
  v8 = [(NSMutableArray *)loads countByEnumeratingWithState:&v14 objects:v18 count:16];
  if (v8)
  {
    v9 = v8;
    v10 = *v15;
    do
    {
      ...
      while (v9 != v11);
      v9 = [(NSMutableArray *)loads countByEnumeratingWithState:&v14 objects:v18 count:16];
    }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDPowerPerProcessCPULoadMetrics *)self addLoad:*(*(&v9 + 1) + 8 * v8++)];
      }
