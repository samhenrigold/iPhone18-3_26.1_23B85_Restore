...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_instances count])
  {
    ...
    v24 = 0u;
    instances = self->_instances;
    v6 = [(NSMutableArray *)instances countByEnumeratingWithState:&v21 objects:v26 count:16];
    if (v6)
    {
      v7 = v6;
      v8 = *v22;
      do
      {
        ...
        v7 = [(NSMutableArray *)instances countByEnumeratingWithState:&v21 objects:v26 count:16];
      }
  ...
  if ([(NSMutableArray *)self->_secondaryInstances count])
  {
    ...
    v20 = 0u;
    secondaryInstances = self->_secondaryInstances;
    v12 = [(NSMutableArray *)secondaryInstances countByEnumeratingWithState:&v17 objects:v25 count:16];
    if (v12)
    {
      v13 = v12;
      v14 = *v18;
      do
      {
        ...
        v13 = [(NSMutableArray *)secondaryInstances countByEnumeratingWithState:&v17 objects:v25 count:16];
      }
...
- (void)writeTo:(id)to
{
  ...
  v19 = 0u;
  instances = self->_instances;
  v5 = [(NSMutableArray *)instances countByEnumeratingWithState:&v18 objects:v23 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v19;
    do
    {
      ...
      v6 = [(NSMutableArray *)instances countByEnumeratingWithState:&v18 objects:v23 count:16];
    }
  ...
  v15 = 0u;
  secondaryInstances = self->_secondaryInstances;
  v10 = [(NSMutableArray *)secondaryInstances countByEnumeratingWithState:&v14 objects:v22 count:16];
  if (v10)
  {
    v11 = v10;
    v12 = *v15;
    do
    {
      ...
      v11 = [(NSMutableArray *)secondaryInstances countByEnumeratingWithState:&v14 objects:v22 count:16];
    }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v25 = 0u;
  instances = self->_instances;
  v8 = [(NSMutableArray *)instances countByEnumeratingWithState:&v24 objects:v29 count:16];
  if (v8)
  {
    v9 = v8;
    v10 = *v25;
    do
    {
      ...
      v9 = [(NSMutableArray *)instances countByEnumeratingWithState:&v24 objects:v29 count:16];
    }
  ...
  v21 = 0u;
  secondaryInstances = self->_secondaryInstances;
  v14 = [(NSMutableArray *)secondaryInstances countByEnumeratingWithState:&v20 objects:v28 count:16];
  if (v14)
  {
    v15 = v14;
    v16 = *v21;
    do
    {
      ...
      v15 = [(NSMutableArray *)secondaryInstances countByEnumeratingWithState:&v20 objects:v28 count:16];
    }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(AWDCoreRoutineLMPScoreBoard *)self addInstances:*(*(&v19 + 1) + 8 * i)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        ...
        [(AWDCoreRoutineLMPScoreBoard *)self addSecondaryInstances:*(*(&v15 + 1) + 8 * j)];
      }
