...
{
  v3.receiver = self;
  v3.super_class = AWDSafariContactAutoFillDidFillCustomContactSetEvent;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDSafariContactAutoFillDidFillCustomContactSetEvent description](&v3, sel_description), -[AWDSafariContactAutoFillDidFillCustomContactSetEvent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
