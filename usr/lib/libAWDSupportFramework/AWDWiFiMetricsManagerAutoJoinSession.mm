...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDWiFiMetricsManagerAutoJoinSession;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDWiFiMetricsManagerAutoJoinSession;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDWiFiMetricsManagerAutoJoinSession description](&v3, sel_description), -[AWDWiFiMetricsManagerAutoJoinSession dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearRecords];
    recordsCount = [(AWDWiFiMetricsManagerAutoJoinSession *)self recordsCount];
    if (recordsCount)
    {
      v6 = recordsCount;
      for (i = 0; i != v6; ++i)
      {
        [to addRecords:{-[AWDWiFiMetricsManagerAutoJoinSession recordsAtIndex:](self, "recordsAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDWiFiMetricsManagerAutoJoinSession *)self addRecords:*(*(&v9 + 1) + 8 * v8++)];
      }
