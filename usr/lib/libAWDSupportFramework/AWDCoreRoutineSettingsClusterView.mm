...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineSettingsClusterView;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineSettingsClusterView;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDCoreRoutineSettingsClusterView description](&v3, sel_description), -[AWDCoreRoutineSettingsClusterView dictionaryRepresentation](self, "dictionaryRepresentation")];
}
