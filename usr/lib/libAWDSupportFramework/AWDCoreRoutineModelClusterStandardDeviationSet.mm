...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelClusterStandardDeviationSet;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelClusterStandardDeviationSet;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelClusterStandardDeviationSet description](&v3, sel_description), -[AWDCoreRoutineModelClusterStandardDeviationSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearInstances];
    instancesCount = [(AWDCoreRoutineModelClusterStandardDeviationSet *)self instancesCount];
    if (instancesCount)
    {
      v6 = instancesCount;
      for (i = 0; i != v6; ++i)
      {
        [to addInstance:{-[AWDCoreRoutineModelClusterStandardDeviationSet instanceAtIndex:](self, "instanceAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineModelClusterStandardDeviationSet *)self addInstance:*(*(&v9 + 1) + 8 * v8++)];
      }
