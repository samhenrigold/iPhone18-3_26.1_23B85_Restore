...
void *nlp::sharedBuffer(nlp *this)
{
  {
    v3 = 0;
    pthread_key_create(&v3, MEMORY[0x29EDCA938]);
...
_DWORD *nlp::BurstTrieCursorCreateCopy(_DWORD *result)
{
  if (result)
  {
    v1 = result;
...
{
  callBacks.retain = nlp::TrieCursorRetain;
  callBacks.release = nlp::TrieCursorRelease;
  callBacks.compare = nlp::TrieCursorCompare;
  return CFBinaryHeapCreate(*MEMORY[0x29EDB8ED8], 0, &callBacks, 0);
}
...
{
  callBacks.retain = nlp::trieCompletionRetain;
  callBacks.release = nlp::trieCompletionRelease;
  callBacks.compare = nlp::trieCompletionCompareScore;
  return CFBinaryHeapCreate(*MEMORY[0x29EDB8ED8], 0, &callBacks, 0);
}
...
void nlp::BurstTrieRankedSearchWithSelection(unint64_t a1, void *a2, unsigned __int8 *a3, uint64_t a4, uint64_t a5, __CFBinaryHeap *a6, __CFBinaryHeap *a7)
{
  if (*(a1 + 2064))
  {
    callBacks.retain = nlp::trieCompletionRetain;
    callBacks.release = nlp::trieCompletionRelease;
    callBacks.compare = nlp::trieCompletionInternalCompareScore;
    v14 = CFBinaryHeapCreate(*MEMORY[0x29EDB8ED8], 0, &callBacks, 0);
    if (v14)
    {
      v15 = v14;
      v16 = *(a1 + 2080);
      if (v16)
      {
        ...
        nlp::rankSearchDiskLevel(a1, v16 + (v16[1] & 0xFFFFFFFC), a3, a4, 0, a6, v14, a5, a2);
      }

      else
      {
        nlp::rankSearchLevel(a1, a1, a3, a4, 0, a6, v14, a5, a2);
      }
...
LABEL_5:
    ...
    if ((a4 + 1) <= 1023)
    {
      ...
      do
      {
        v21 = *(a2 + 4 * v20);
        v19[a4] = v20;
        nlp::rankSearchGetCursor(a1, v21, v19, a4 + 1, a6);
        ++v20;
      }
    ...
    v23 = *(a2 + 1032);
    v24 = malloc_type_malloc(a4 + 21, 0x1000040A86A77D5uLL);
    v24[4] = a4;
    *(v24 + a4 + 20) = 0;
    memcpy(v24 + 5, a3, a4);
    *v24 = v23;
    v24[2] = v22;
    v24[3] = 1;
    updated = nlp::updateCompletions(v24, a9, a6, a7, a8);
    v26 = updated;
    v27 = v24[3] - 1;
    v24[3] = v27;
    if (v27)
...
LABEL_11:
  ...
  if ((v16 & 3) == 2)
  {
    v28 = ((v16 & 0xFFFFFFFC) + *(a1 + 260));

    return nlp::rankSearchDiskPage(a1, v28, a3, a4, v15 + 1, a6, a7, a8, a9);
  }

  else
  {
    v30 = ((v16 & 0xFFFFFFFC) + *(a1 + 260));

    return nlp::rankSearchCompactDiskLevel(a1, v30, a3, a4, v15 + 1, a6, a7, a8, a9);
  }
}
...
LABEL_10:
  ...
  return nlp::rankSearchList((v16 & 0xFFFFFFFFFFFFFFFCLL), a3, a4, v15 + 1, a6, a7, a8, a9);
}
...
void nlp::BurstTrieContinueRankedSearch(nlp *a1, uint64_t a2, __CFBinaryHeap *a3, __CFBinaryHeap *a4)
{
  if (*(a1 + 2064))
  {
    ...
    callBacks.release = nlp::trieCompletionRelease;
    callBacks.compare = nlp::trieCompletionInternalCompareScore;
    v8 = CFBinaryHeapCreate(*MEMORY[0x29EDB8ED8], 0, &callBacks, 0);
    if (v8)
    {
      v9 = v8;
...
BOOL nlp::rankSearchCursors(nlp *a1, CFBinaryHeapRef heap, __CFBinaryHeap *a3, uint64_t a4, void *a5)
{
  while (1)
  {
    ...
    if ((v13 & 3) == 0)
    {
      ...
      v20 = v12[6];
      v21 = v12[4];
      v22 = malloc_type_malloc(v20 + 21, 0x1000040A86A77D5uLL);
      v22[4] = v20;
      *(v22 + v20 + 20) = 0;
      memcpy(v22 + 5, v12 + 7, v20);
      *v22 = v21;
      v22[2] = v19;
      v22[3] = 1;
      updated = nlp::updateCompletions(v22, a5, heap, a3, a4);
      v24 = v22[3] - 1;
      v22[3] = v24;
      if (!v24)
      {
    ...
    if (v15)
    {
      ...
      if (v14 == 3)
      {
        v18 = nlp::rankSearchCompactDiskLevel(a1, (v16 + v15), v12 + 28, v17, v17, heap, a3, a4, a5);
      }
      ...
      {
        v18 = nlp::rankSearchDiskPage(a1, (v16 + v15), v12 + 28, v17, v17, heap, a3, a4, a5);
      }
    }

    else if (v14 == 2)
    {
      v18 = nlp::rankSearchList((v13 & 0xFFFFFFFFFFFFFFFCLL), v12 + 28, v12[6], v12[6], heap, a3, a4, a5);
    }
    ...
    else
    {
      ...
      v18 = nlp::rankSearchLevel(a1, v13 & 0xFFFFFFFFFFFFFFFCLL, v12 + 28, v12[6], v12[6], heap, a3, a4, a5);
    }
...
LABEL_9:
    ...
    if ((a4 + 1) <= 1023)
    {
      ...
      do
      {
        ...
        if (((1 << v25) & *&v27) != 0)
        {
          ...
          v32 = vcnt_s8((((1 << v25) - 1) & *&v27));
          v32.i16[0] = vaddlv_u8(v32);
          v33 = a2[5].u32[v28 + v32.i32[0] + 1];
          v24[a4] = v25;
          nlp::rankSearchGetCursor(v12, v33, v24, a4 + 1, a6);
        }
    ...
    v35 = a2[4].i32[1];
    v36 = malloc_type_malloc(a4 + 21, 0x1000040A86A77D5uLL);
    v36[4] = a4;
    *(v36 + a4 + 20) = 0;
    memcpy(v36 + 5, a3, a4);
    *v36 = v35;
      ...
      if (v15)
      {
        ...
        while (1)
        {
          ...
          if (v32)
          {
            ...
            if (v33 > v34)
            {
              memcpy(__s1 + v34, v32 + 11, v33 - v34);
            }
          }
          ...
          if (!memcmp(v29 + 11, &__s2a[v33], v37))
          {
LABEL_30:
            v38 = v10;
            v39 = v33 + v9;
            ...
            {
              v42 = v41 - (v40 & ~(v40 >> 31));
              memcpy(&v17[v39], &v29[v35 - v42 + 11], v42);
              v39 += v42;
            }
  ...
  *v18 = 0;
  ...
  do
  {
    ...
    if (v14 <= *(v22 + 4) && !memcmp(v22 + 10, &__s2[v54], v14))
    {
      v24 = *(v22 + 1);
      v25 = *v22;
      v26 = malloc_type_malloc(v23 + 21, 0x1000040A86A77D5uLL);
      v26[4] = v23;
      *(v26 + v23 + 20) = 0;
      memcpy(v26 + 5, v17, v23);
      *v26 = v25;
      v26[2] = v24;
      v26[3] = 1;
...
LABEL_27:
    ...
    else
    {
      ...
      if (v19 < v18)
      {
        ...
        v21 = *(v16 + 4);
        v22 = *v16;
        v23 = malloc_type_malloc(v21 + 4125, 0x1000040CE2BBAF2uLL);
        *(v23 + 1) = v20;
        v23[4] = v22;
        *(v23 + 5) = 1;
        *(v23 + 6) = v21;
        *(v23 + v21 + 28) = 0;
        memcpy(v23 + 7, v17 + 5, v21);
...
void nlp::rankSearchGetCursor(uint64_t a1, uint64_t a2, const void *a3, unsigned int a4, __CFBinaryHeap *a5)
{
  ...
  if (v9)
  {
    ...
    {
      v12 = v10 == 2;
      v13 = (a2 & 0xFFFFFFFFFFFFFFFCLL) + v9;
      v14 = (v13 + 4);
      v11 = (v13 + 32);
      if (v12)
      {
  ...
  v15 = *v11;
  v16 = malloc_type_malloc(a4 + 4125, 0x1000040CE2BBAF2uLL);
  v16[1] = a2;
  *(v16 + 4) = v15;
  *(v16 + 5) = 1;
  *(v16 + 6) = a4;
...
BOOL nlp::rankSearchList(nlp *a1, char *a2, int a3, unsigned int a4, __CFBinaryHeap *a5, __CFBinaryHeap *a6, unsigned int a7, void *a8)
{
  if (a4 <= 0x3FF)
  {
    ...
    if (v12)
    {
      ...
      do
      {
        memcpy(&v13[a4], v12 + 22, *(v12 + 10));
        v17 = *(v12 + 10) + a4;
        v13[v17] = 0;
        if (v15 <= *(v12 + 10) && !memcmp(v12 + 22, &a2[v14], v16))
        {
          v18 = v16;
          v19 = v14;
          v20 = *(v12 + 4);
          v21 = *(v12 + 3);
          v22 = malloc_type_malloc(v17 + 21, 0x1000040A86A77D5uLL);
          v22[4] = v17;
          *(v22 + v17 + 20) = 0;
          memcpy(v22 + 5, v13, v17);
          *v22 = v21;
          v22[2] = v20;
          v22[3] = 1;
          updated = nlp::updateCompletions(v22, a8, a5, a6, a7);
          v23 = v22[3] - 1;
          v22[3] = v23;
          if (!v23)
          {
...
void nlp::serializeListsRanked(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  do
  {
    ...
    if ((v9 & 3) == 2)
    {
      ...
      v14 = v10[2];
      v15 = malloc_type_malloc(1035 * v13 + 8, 0x100004077774924uLL);
      ...
      while (v18);
      qsort(v16, v17, 8uLL, nlp::nodeScoreCompare);
      v20 = 0;
      if (v17)
      {
        v21 = v16;
      ...
      *v15 = v20;
      v15[1] = v14;
      v4 = __fd;
      write(__fd, v15, (v20 + 11) & 0x1FFFFFFFCLL);
      free(v16);
      free(v15);
      do
      {
    ...
    {
      nlp::serializeListsRanked(v6, v9 & 0xFFFFFFFFFFFFFFFCLL, v5, v4);
    }
...
void nlp::serializeLists(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  do
  {
    ...
    if ((v9 & 3) == 2)
    {
      ...
      {
        v25 = v15;
        qsort(v14, v15, 8uLL, nlp::nodeStringCompare);
        if (v15)
        {
          v26 = 0;
          v20 = 0;
      ...
      else
      {
        ...
        if (v17)
        {
          v19 = nlp::nodeScoreCompare;
        }

        else
        {
          v19 = nlp::nodeStringCompare;
        }
    ...
    {
      nlp::serializeLists(v6, v9 & 0xFFFFFFFFFFFFFFFCLL, v5, v4);
    }
...
uint64_t *std::vector<nlp::_RankedTrieLevel *>::__init_with_size[abi:ne200100]<nlp::_RankedTrieLevel * const*,nlp::_RankedTrieLevel * const*>(uint64_t *result, uint64_t *a2, uint64_t *a3, unint64_t a4)
{
  if (a4)
  {
    std::vector<nlp::_RankedTrieLevel *>::__vallocate[abi:ne200100](result, a4);
  }

  return result;
}

void sub_29772E644(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void std::vector<nlp::_RankedTrieLevel *>::__vallocate[abi:ne200100](uint64_t *a1, unint64_t a2)
{
  if (!(a2 >> 61))
  {
    std::__allocate_at_least[abi:ne200100]<std::allocator<nlp::_RankedTrieLevel *>>(a1, a2);
  }

  std::vector<double>::__throw_length_error[abi:ne200100]();
}

void std::__allocate_at_least[abi:ne200100]<std::allocator<nlp::_RankedTrieLevel *>>(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 61))
  {
    operator new();
...
void std::__function::__func<void nlp::reverseBurst<nlp::_RankedTrieLevel *,nlp::_RankedListNode *>(nlp::_BurstTrie *,std::vector<nlp::_RankedTrieLevel *> const&,unsigned char const*,unsigned int)::{lambda(void *,unsigned char const*,unsigned int,unsigned int,float,BOOL *)#2},std::allocator<void nlp::reverseBurst<nlp::_RankedTrieLevel *,nlp::_RankedListNode *>(nlp::_BurstTrie *,std::vector<nlp::_RankedTrieLevel *> const&,unsigned char const*,unsigned int)::{lambda(void *,unsigned char const*,unsigned int,unsigned int,float,BOOL *)#2}>,void ()(void *,unsigned char const*,unsigned int,unsigned int,float,BOOL *)>::operator()(uint64_t a1, uint64_t a2, void **a3, unsigned int *a4, int *a5, int *a6)
{
  ...
  if (v9 >= v10)
  {
    ...
    if (v15)
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<std::pair<std::string,double>>>(v8, v15);
    }
    ...
    *(v8 + 16) = 0;
    v26[3] = v22;
    std::__split_buffer<std::pair<std::string,double>>::~__split_buffer(v26);
    v23 = SHIBYTE(v25);
    *(v8 + 8) = v18;
    if (v23 < 0)
    {
...
void sub_29772EB10(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_29772EC80(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_29772F024(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
