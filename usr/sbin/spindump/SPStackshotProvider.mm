...
- (void)startSamplingThread
{
  ...
  else
  {
    ...
    v33 = pthread_create(&selfCopy->_samplingThread, 0, sub_100089AD0, selfCopy);
    if (v33)
    {
      *__errnum = v33;
      if (byte_100117E80 == 1)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          sub_1000BAD18(v38, buf, __errnum[0]);
        }
      ...
      if (byte_100117E81 == 1 && dword_100117510 <= 3)
      {
        ...
        {
          v44 = sub_100035B80(0, v42);
          if (os_log_type_enabled(v44, OS_LOG_TYPE_FAULT))
          {
            v45 = strerror(__errnum[0]);
            sub_1000BAD6C(v45, v56, __errnum[0]);
          }
      ...
      sub_100035A54("[SPStackshotProvider startSamplingThread]", "SPSampleProvider.m", 490, "%s: Unable to create sampling thread: %d (%s)", v51, v52, v53, v54, "ret == 0", *__errnum, v50);
      abort();
    }
  }
  ...
  else
  {
    ...
    if (byte_100117E80 == 1)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        sub_1000BB58C(v27, threadsCopy, buf, v26);
      }
    ...
    if (byte_100117E81 == 1 && dword_100117510 <= 3)
    {
      ...
      {
        v46 = sub_100035B80(v32, v33);
        if (os_log_type_enabled(v46, OS_LOG_TYPE_FAULT))
        {
          v47 = [processesCopy description];
          sub_1000BB5F8(v47, v73, threadsCopy, v46);
        }
