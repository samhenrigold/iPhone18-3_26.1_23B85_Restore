...
- (void)setSamplingIntervalUs:(unsigned int)us
{
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    if (byte_100117E80)
    {
      ...
      {
        v30 = sub_100035B20(self->super.super._targetProcessId);
    ...
    v10 = *__error();
    v11 = sub_100035B20(self->super.super._targetProcessId);
    ...
    if (!v12)
    {
      ...
      {
        v15 = sub_100035B20(self->super.super._targetProcessId);
  ...
  if (self->super.super._timeoutTime <= time)
  {
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v72 = sub_100035B20(*p_targetProcessId);
      ...
      v29 = *__error();
      v30 = sub_100035B20(*p_targetProcessId);
...
- (void)setSamplingCompletionHandlerQueue:(id)queue andBlock:(id)block
{
  ...
  if (!queueCopy || !blockCopy)
  {
    ...
    else
    {
      ...
      {
        v22 = *__error();
        v23 = sub_100035B20(*p_targetProcessId);
      ...
      v47 = sub_100035B20(*p_targetProcessId);
      sub_100035A54("[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1065, "%s [%d]: %s: Must provide both queue and block", v48, v49, v50, v51, v47, *p_targetProcessId, "queue && block");
    }
...
- (void)stopSamplingWithReason:(unsigned __int8)reason
{
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    if (byte_100117E80)
    {
      ...
      {
        sub_1000B8D20(p_targetProcessId);
      }
...
LABEL_53:
    ...
    {
      sub_1000B8DC8(p_targetProcessId);
    }
...
LABEL_91:
        ...
        v165[1] = 3221225472;
        v165[2] = sub_100083DD4;
        v165[3] = &unk_100109C00;
        v165[4] = self;
        v167 = reasonCopy;
        v166 = snapshotCopy;
...
LABEL_216:
    ...
    else
    {
      ...
      v28 = *__error();
      v29 = sub_100035B20(*p_targetProcessId);
...
LABEL_185:
        ...
        v170[1] = 3221225472;
        v170[2] = sub_100083A4C;
        v170[3] = &unk_100109AE8;
        v170[4] = self;
        sub_10007C31C(v170);
LABEL_212:
        LOBYTE(reasonCopy) = 8;
...
- (void)_saveReportToStream:(__sFILE *)stream
{
  if (!stream || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_100035A54("[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1338, "%s: save report fail %d %d %d", v3, v4, v5, v6, "stream && !_isSampling && _hasSampled", v58, self->super.super._isSampling, self->super.super._hasSampled);
    }
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v47 = sub_100035B20(self->super.super._targetProcessId);
          targetProcessId = self->super.super._targetProcessId;
      ...
      if (byte_100117E81 == 1 && dword_100117510 < 4)
      {
        v52 = stream != 0;
        v59 = *__error();
        v60 = sub_100035B20(self->super.super._targetProcessId);
        ...
        {
          v63 = sub_100035B80(0, v62);
          if (os_log_type_enabled(v63, OS_LOG_TYPE_FAULT))
          {
            v64 = sub_100035B20(self->super.super._targetProcessId);
      ...
      v85 = sub_100035B20(self->super.super._targetProcessId);
      sub_100035A54("[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1338, "%s [%d]: %s: save report fail %d %d %d", v86, v87, v88, v89, v85, self->super.super._targetProcessId, "stream && !_isSampling && _hasSampled", v52, self->super.super._isSampling, self->super.super._hasSampled);
    }
...
- (void)_performSamplePrinterWork:(id)work
{
  ...
  if (!workCopy || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_100035A54("[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1354, "%s: save report fail %d %d %d", v4, v5, v6, v7, "callback && !_isSampling && _hasSampled", v59, self->super.super._isSampling, self->super.super._hasSampled);
    }
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v48 = sub_100035B20(self->super.super._targetProcessId);
          targetProcessId = self->super.super._targetProcessId;
      ...
      if (byte_100117E81 == 1 && dword_100117510 < 4)
      {
        v53 = workCopy != 0;
        v60 = *__error();
        v61 = sub_100035B20(self->super.super._targetProcessId);
        ...
        else
        {
          ...
          {
            v65 = sub_100035B20(self->super.super._targetProcessId);
      ...
      v86 = sub_100035B20(self->super.super._targetProcessId);
      sub_100035A54("[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1354, "%s [%d]: %s: save report fail %d %d %d", v87, v88, v89, v90, v86, self->super.super._targetProcessId, "callback && !_isSampling && _hasSampled", v53, self->super.super._isSampling, self->super.super._hasSampled);
    }
