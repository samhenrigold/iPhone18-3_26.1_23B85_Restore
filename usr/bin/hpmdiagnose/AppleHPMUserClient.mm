...
- (int)forceModeForDevice:(unint64_t)device enable:(unsigned __int8)enable withDataStatus:(unsigned int)status andStatus:(unsigned int)andStatus;
- (int)forceUSBDeviceMode:(unsigned int)mode withDevice:(unint64_t)device;
- (int)forceUpdateModeForDevice:(unint64_t)device enable:(unsigned __int8)enable;
...
- (int)forceModeForDevice:(unint64_t)device enable:(unsigned __int8)enable withDataStatus:(unsigned int)status andStatus:(unsigned int)andStatus
{
  if (self->_userClientActive)
  {
    return (*(*self->_deviceInterface + 11))(self->_deviceInterface, device, enable, *&status, *&andStatus);
  }
...
- (int)forceUpdateModeForDevice:(unint64_t)device enable:(unsigned __int8)enable
{
  if (self->_userClientActive)
  {
    return (*(*self->_deviceInterface + 12))(self->_deviceInterface, device, enable);
  }
...
- (int)forceUSBDeviceMode:(unsigned int)mode withDevice:(unint64_t)device
{
  if (self->_userClientActive)
  {
    return (*(*self->_deviceInterface + 17))(self->_deviceInterface, *&mode, device);
  }
