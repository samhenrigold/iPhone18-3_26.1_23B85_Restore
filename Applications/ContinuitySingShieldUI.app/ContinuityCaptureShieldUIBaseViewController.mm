...
- (void)tearDownShield
{
  ...
  else
  {
    ...
    v15 = [[UIDestroySceneAction alloc] initWithPersistedIdentifiers:0 preferredAnimationType:1 forDestroyingSession:1 userOriginatedRequest:0 callbackQueue:&_dispatch_main_q completion:&stru_100018818];
    ...
    {
      v20 = sub_100005368(isOnLockScreen);
