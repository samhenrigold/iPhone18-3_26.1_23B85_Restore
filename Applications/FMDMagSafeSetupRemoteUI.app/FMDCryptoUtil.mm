...
+ (void)testCrypto
{
  ...
  {
    v8 = sub_100002400(IsAlgorithmSupported);
...
+ (void)testCrypto2:(id)crypto2 privateKey:(id)key
{
  ...
  {
    v15 = sub_100002400(IsAlgorithmSupported);
