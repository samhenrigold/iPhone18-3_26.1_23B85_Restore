...
- (NSAttributedString)localizedAttributedFollowUpSuggestionsText
{
  v3 = [[NSMutableAttributedString alloc] initWithString:&stru_10008C168];
  ...
  v10 = [v9 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FOLLOW_UP_SUGGESTIONS" value:&stru_10008C168 table:@"VoicemailUI"];
...
LABEL_3:
    v9 = +[NSBundle mainBundle];
    v10 = [v9 localizedStringForKey:v8 value:&stru_10008C168 table:@"VoicemailUI"];
...
- (id)localizedAttributedFeedbackTextForConfidence:(unint64_t)confidence locale:(id)locale
{
  ...
  if (confidence - 2 < 2)
  {
    ...
    [v14 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_OPTION_NEGATIVE" value:&stru_10008C168 table:@"VoicemailUI"];
    v15 = v42 = v9;

    v16 = +[NSBundle mainBundle];
    v17 = [v16 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_OPTION_POSITIVE" value:&stru_10008C168 table:@"VoicemailUI"];

    +[NSBundle mainBundle];
    v18 = v41 = v10;
    v19 = [v18 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_WITH_OPTIONS_%_OR_%" value:&stru_10008C168 table:@"VoicemailUI"];
...
LABEL_11:
  ...
  if (confidence == 1)
  {
    ...
    v20 = [v34 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_CONFIDENCE_NONE" value:&stru_10008C168 table:@"VoicemailUI"];

    v26 = [[NSMutableAttributedString alloc] initWithString:&stru_10008C168 attributes:v9];
...
LABEL_5:
    ...
    v12 = [v11 localizedStringForKey:v9 value:&stru_10008C168 table:@"VoicemailUI"];
