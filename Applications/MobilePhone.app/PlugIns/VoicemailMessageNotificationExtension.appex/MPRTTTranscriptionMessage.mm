      ...
      do
      {
        for (i = 0; i != v6; i = i + 1)
        {
          ...
          if (([v9 isMe] & 1) == 0)
          {
            ...
            {
              v11 = ttyLocString();
              v12 = [NSString stringWithFormat:v11, &stru_10008C168];

              v13 = [text stringByReplacingOccurrencesOfString:v12 withString:&stru_10008C168];
...
- (NSString)text
{
  ...
  {
    sub_10006081C();
    makeTranscriptMessage = sub_1000607EC();
  }
