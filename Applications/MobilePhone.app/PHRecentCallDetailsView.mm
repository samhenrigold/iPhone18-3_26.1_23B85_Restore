...
- (id)emergencyItemLabelText:(id)text
{
  ...
  if (!v8)
  {
    ...
    v10 = [v9 localizedStringForKey:@"Shared %lu videos" value:&stru_10028F310 table:0];
LABEL_10:
...
LABEL_11:
  ...
  {
    v9 = +[NSBundle mainBundle];
    v10 = [v9 localizedStringForKey:@"Shared %lu photos" value:&stru_10028F310 table:0];
  ...
  {
    v9 = +[NSBundle mainBundle];
    v10 = [v9 localizedStringForKey:@"Shared %lu videos and %lu photos" value:&stru_10028F310 table:0];
    v15 = v8;
    goto LABEL_10;
  }

LABEL_15:
  v12 = PHDefaultLog(isKindOfClass);
