...
- (void)prepareNewIteration
{
  sub_100007090(__p, "prepareNewIteration");
  [(ViewController *)self log:__p];
  if (v4 < 0)
  {
    operator delete(__p[0]);
...
- (void)startUI
{
  ...
  sub_100007090(&v30, "_sessionMaxTimeOut ");
  ...
  *&v31.__r_.__value_.__l.__data_ = v6;
  ...
  sub_100007090(v27, " _consecutiveSceneErrorLimit ");
  if ((v28 & 0x80u) == 0)
  {
    v7 = v27;
  }
...
- (int)getJasperSensorId:(void *)id
{
  ...
  if (DeviceCMInterface::getJasperModuleInfo(self->_diagnosticCMInterface, &theDict))
  {
    ...
    [(ViewController *)self error:@"unable to get JasperModuleInfo" details:&stru_10002D398];
  }
...
- (int)startStreaming
{
  sub_100007090(__p, "startStreaming started");
  [(ViewController *)self log:__p];
  if (v6 < 0)
  {
    operator delete(__p[0]);
...
- (int)initStreaming
{
  ...
  sub_100007090(__p, "initStreaming");
  [(ViewController *)self log:__p];
  if (v6 < 0)
  {
    operator delete(__p[0]);
  ...
  *&v7.var0 = 65537;
  ...
  self->_diagnosticFinalResult = 2;
  [(ViewController *)self error:@"no JasperDevice" details:&stru_10002D398];
...
- (void)initFlow
{
  ...
  *&self->_avgRotAngles[8] = 0;
  sub_100007090(__p, "init flow started");
  [(ViewController *)self log:__p];
  if (v11 < 0)
  {
    operator delete(__p[0]);
  ...
  if (self->_iterationsLimit >= 1)
  {
    ...
    {
      __p[0] = &v9;
      v6 = sub_10001CE9C(&self->_rgbjCalibrationResults, &v9, &unk_100023727, __p);
      v6[6] = v6[5];
      ++v9;
    }
...
- (void)showPausedDialog
{
  ...
  v6 = [v3 localizedStringForKey:@"Device_Is_Motionless" value:&stru_10002D398 table:0];

  v4 = +[NSBundle mainBundle];
  v5 = [v4 localizedStringForKey:@"Device_Is_Motionless_Subtitle" value:&stru_10002D398 table:0];
...
- (int)initDiagnosticRgbjFlow
{
  sub_100007090(__p, "set rgbj configuration to frameSelect(1)  featureVector(5)  dilutionRate(500)");
  [(ViewController *)self log:__p];
  if (v7 < 0)
  {
    operator delete(__p[0]);
  ...
  else
  {
    ...
    sub_100007090(__p, "set wide jasper extrinsics to 0");
    [(ViewController *)self log:__p];
    if (v7 < 0)
    {
      operator delete(__p[0]);
  ...
  v4 = 2;
  self->_diagnosticFinalResult = 2;
  [(ViewController *)self error:v3 details:&stru_10002D398];
  return v4;
}
...
- (int)getCalibResults:(ViewController *)self focalPoint:(SEL)point
{
  v4 = v3;
  v5 = v2;
  sub_100007090(&__p, "getCalibResults");
  [(ViewController *)self log:&__p];
  if (SHIBYTE(v21) < 0)
  {
    operator delete(__p);
  ...
  if (DeviceCMInterface::getJasperCalib(self->_diagnosticCMInterface, &v27))
  {
    v7 = 2;
    self->_diagnosticFinalResult = 2;
    [(ViewController *)self error:@"unable to get JasperCalib" details:&stru_10002D398];
  }
...
- (void)loadNormalAppWindow
{
  ...
  sub_100007090(__p, "loadNormalAppWindow");
  [(ViewController *)self log:__p];
  if (v152 < 0)
  {
    operator delete(__p[0]);
...
- (void)dogWatch:(id)watch
{
  ...
  if (v316[1] == 1)
  {
    sub_100007090(__p, "Driver reported disk is full with RgbjReport_FailedToSave");
    [(ViewController *)self log:__p];
  ...
  *__p = &self->_iterationNumber;
  v8 = sub_10001CE9C(&self->_rgbjCalibrationResults, &self->_iterationNumber, &unk_100023727, __p);
  v9 = v8;
  v11 = v8[6];
  v10 = v8[7];
  if (v11 >= v10)
  ...
  v9[6] = v13;
  *__p = &self->_iterationNumber;
  v25 = sub_10001CE9C(&self->_rgbjCalibrationResults, &self->_iterationNumber, &unk_100023727, __p);
  if (v25[6] - v25[5] == 24)
  {
    [(ViewController *)self hideInProgressView];
    [(ViewController *)self hideWarningWindow];
    v26 = +[NSBundle mainBundle];
    v27 = [v26 localizedStringForKey:@"Pan_Slowly" value:&stru_10002D398 table:0];
  ...
  *__p = &self->_iterationNumber;
  v70 = sub_10001CE9C(&self->_rgbjCalibrationResults, &self->_iterationNumber, &unk_100023727, __p);
  *__p = &self->_iterationNumber;
  v71 = sub_10001CE9C(&self->_rgbjCalibrationResults, &self->_iterationNumber, &unk_100023727, __p);
  v73 = v71[5];
  v72 = v71[6];
  v74 = v70[5];
  ...
  *__p = v107;
  ...
  v111 = [v110 localizedStringForKey:@"Pan_Slowly" value:&stru_10002D398 table:0];
  ...
  if (v316[0] > *(v75 - 32))
  {
    ...
    v123 = [v122 localizedStringForKey:@"Bad_Scene" value:&stru_10002D398 table:0];
    v124 = +[NSBundle mainBundle];
    v125 = [v124 localizedStringForKey:@"Bad_Scene_Subtitle" value:&stru_10002D398 table:0];
    [(ViewController *)self showWarningWindow:v123 subMessage:v125];

    v126 = +[NSBundle mainBundle];
    v127 = [v126 localizedStringForKey:@"Pan_Slowly" value:&stru_10002D398 table:0];
  ...
  if (SDWORD1(__val) <= *(v75 - 44))
  {
    ...
    v126 = +[NSBundle mainBundle];
    v127 = [v126 localizedStringForKey:@"No_Objects_Found" value:&stru_10002D398 table:0];
    v129 = +[NSBundle mainBundle];
    v130 = [v129 localizedStringForKey:@"No_Objects_Found_Subtitle" value:&stru_10002D398 table:0];
...
LABEL_195:
  if (SHIDWORD(__val) < self->_calibUpdateEachIsfEntiresLimit)
  {
    ...
    if (sessionSecondsCount >= self->_sessionMaxTimeOut || self->_consecutiveSceneError > self->_consecutiveSceneErrorLimit)
    {
      ...
      *__p = v151;
      ...
      v280[1] = 3221225472;
      v280[2] = sub_100018D88;
      v280[3] = &unk_10002CEC0;
      v280[4] = self;
  ...
  sub_100007090(__p, "dogWatch finishing sub iteration");
  [(ViewController *)self log:__p];
  if ((__p[23] & 0x80000000) != 0)
  {
    operator delete(*__p);
  ...
  v294[1] = 3221225472;
  v294[2] = sub_100018B8C;
  v294[3] = &unk_10002CEC0;
  v294[4] = self;
  dispatch_async(&_dispatch_main_q, v294);

  if (DeviceCMInterface::forceSaveWideJasperCalib(self->_diagnosticCMInterface))
  {
    [(ViewController *)self error:@"failed to forceSaveWideJasperCalib" details:&stru_10002D398];
    goto LABEL_164;
  }
  ...
  *&v293 = 0;
  ...
  if (![(ViewController *)self getCalibResults:&v293 focalPoint:&v291])
  {
    ...
    sub_100015C3C("iteration ", &v312.__r_.__value_.__l.__data_, &v297);
    ...
    *(&v312.__r_.__value_.__s + 23) = v211;
    ...
    {
      sub_100007090(__p, "dogWatch finishing iteration");
      [(ViewController *)self log:__p];
      if ((__p[23] & 0x80000000) != 0)
      {
        operator delete(*__p);
      ...
      sub_10001D24C(self->_anon_b8, &v293);
      ...
      *&v311.__r_.__value_.__l.__data_ = v234;
      ...
      if (self->_diagnosticFinalResult == -3)
      {
        ...
        v283[1] = 3221225472;
        v283[2] = sub_100018BEC;
        v283[3] = &unk_10002CEC0;
        v283[4] = self;
        ...
        *__p = 2;
        if (![(ViewController *)self getRotAnglesToPrcl:__p focalPoint:*self->_avgRotAngles prcl:*self->_focalPoint])
        {
          ...
          *&self->_prclResult.swideFocalPoint[2] = v276;
          sub_100007090(&v310, "dogWatch finishing all iterations");
          ...
          v282[1] = 3221225472;
          v282[2] = sub_100018C44;
          v282[3] = &unk_10002CEC0;
          v282[4] = self;
    ...
    v281[1] = 3221225472;
    v281[2] = sub_100018C4C;
    v281[3] = &unk_10002CEC0;
    v281[4] = self;
...
- (void)handleResume
{
  ...
  {
    self->_inResume = 1;
    sub_100007090(__p, "handleResume");
    [(ViewController *)self log:__p];
    if (v7 < 0)
    {
      operator delete(__p[0]);
...
- (void)endTest
{
  ...
  *__p = v5;
  ...
  {
    sub_100007090(__p, "_skipSummaryScreen is true");
    [(ViewController *)self log:__p];
    if (SHIBYTE(v9) < 0)
    {
      operator delete(__p[0]);
  ...
  sub_100007090(__p, "_skipSummaryScreen is false");
  [(ViewController *)self log:__p];
  if (SHIBYTE(v9) < 0)
  {
    operator delete(__p[0]);
...
- (void)quitButtonTapped
{
  sub_100007090(__p, "Quit button tapped!");
  [(ViewController *)self log:__p];
  if (v4 < 0)
  {
    operator delete(__p[0]);
