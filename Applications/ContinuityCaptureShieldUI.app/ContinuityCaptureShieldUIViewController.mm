  ...
  if (activeConfiguration)
  {
    ...
    if (uiState == 5)
    {
      if (clientDeviceModel == 2)
      {
        ...
        v15 = [v12 localizedStringForKey:v14 value:&stru_100018968 table:0];
        ...
        if (clientName)
        {
          ...
          v20 = [v17 localizedStringForKey:v19 value:&stru_100018968 table:0];
        ...
        else
        {
          ...
          v20 = [v17 localizedStringForKey:v21 value:&stru_100018968 table:0];
...
- (void)_pullConversation:(id)conversation deviceHandle:(id)handle completion:(id)completion
{
  ...
  if (isOnLockScreen)
  {
    v16 = sub_100006DC0(isOnLockScreen);
  ...
  {
    v18 = sub_100006DC0(isOnLockScreen);
