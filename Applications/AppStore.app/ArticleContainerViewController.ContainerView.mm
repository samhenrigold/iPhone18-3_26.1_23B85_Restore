...
- (void)setFrame:(CGRect)frame
{
  ...
  if (!CGRectEqualToRect(v27, v28))
  {
    ...
    if (v22)
    {
      v23 = *&selfCopy->frameUpdatedCallback[OBJC_IVAR____TtCC8AppStore30ArticleContainerViewControllerP33_3306EAC28C78331905A290D09A08BB9913ContainerView_frameUpdatedCallback];
