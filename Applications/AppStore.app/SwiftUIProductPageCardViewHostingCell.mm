...
- (_TtC8AppStore37SwiftUIProductPageCardViewHostingCell)initWithCoder:(id)coder;
- (_TtC8AppStore37SwiftUIProductPageCardViewHostingCell)initWithFrame:(CGRect)frame;
@end
