...
- (_TtC8AppStore20PlayerViewController)initWithCoder:(id)coder;
- (_TtC8AppStore20PlayerViewController)initWithNibName:(id)name bundle:(id)bundle;
- (_TtC8AppStore20PlayerViewController)initWithPlayerLayerView:(id)view;
- (void)dealloc;
