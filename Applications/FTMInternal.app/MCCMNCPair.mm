...
- (id)description
{
  ...
  dictionaryRepresentation = [(MCCMNCPair *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 16) & 1) == 0 || self->_mCC != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 16) & 2) == 0 || self->_mNC != *(equalCopy + 3))
    {
      goto LABEL_11;
    }
