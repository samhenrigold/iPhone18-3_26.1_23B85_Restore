...
- (int)StringAsReleaseCause:(id)cause
{
  ...
  else if ([causeCopy isEqualToString:@"KRRC_REL_SIM_RADIO_CONFLICT"])
  {
    v4 = 18;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_CONN_RELEASE"])
  {
    v4 = 19;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_UNSPECIFIED"])
  {
    v4 = 20;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_PRE_EMPTIVE_RELEASE"])
  {
    v4 = 21;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_CONGESTION"])
  {
    v4 = 22;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_RE_ESTABLISHMENT_REJECT"])
  {
    v4 = 23;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_DIRECTED_SIGCONN_RE_ESTABLISHMENT"])
  {
    v4 = 24;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_USER_INACTIVITY"])
  {
    v4 = 25;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_RL_FAILURE"])
  {
    v4 = 26;
  }

  else if ([causeCopy isEqualToString:@"KRRC_REL_RLC_LINK_ERROR"])
  {
    v4 = 27;
  }
