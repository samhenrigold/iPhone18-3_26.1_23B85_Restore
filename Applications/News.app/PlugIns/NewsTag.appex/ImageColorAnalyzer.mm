...
- (NSArray)dominantColors
{
  ...
  v10 = 0;
  v11 = 0;
  sub_100016FD8(&__p, self->_analyzedColors.completeColorList.__begin_, self->_analyzedColors.completeColorList.__end_, self->_analyzedColors.completeColorList.__end_ - self->_analyzedColors.completeColorList.__begin_);
  v4 = __p;
  if (v10 != __p)
  {
    v5 = 0;
