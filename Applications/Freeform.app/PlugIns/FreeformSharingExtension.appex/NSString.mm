...
- (id)crl_escapeForIcuRegex
{
  ...
  *&v13 = [(NSString *)selfCopy rangeOfCharacterFromSet:qword_1000B4AF0];
    ...
    if (v4 != v13)
    {
      do
      {
        ...
        *(&v13 + 1) = &v4[-v13];
        ...
        if (v4 != v13)
        {
          *&v12 = [(NSString *)selfCopy rangeOfCharacterFromSet:qword_1000B4AF0 options:0 range:v13];
          *(&v12 + 1) = v9;
          v13 = v12;
...
{
  extensionCopy = extension;
  if (-[NSString isEqualToString:](self, "isEqualToString:", &stru_1000A9FE0) || [extensionCopy isEqualToString:&stru_1000A9FE0])
  {
    selfCopy = self;
LABEL_4:
    v6 = selfCopy;
...
- (id)crl_stringByApplyingSubstitutions:(id)substitutions
{
  ...
  allKeys = [v6 allKeys];
  v8 = [allKeys sortedArrayUsingComparator:&stru_1000A60F8];
...
+ (id)crl_stringWithItemProviderData:(id)data typeIdentifier:(id)identifier error:(id *)error
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
    {
      sub_10007BF6C(identifierCopy, v9);
    }
