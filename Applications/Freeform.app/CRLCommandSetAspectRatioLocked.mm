...
- (_TtC8Freeform30CRLCommandSetAspectRatioLocked)initWithBoardItem:(id)item aspectRatioLocked:(BOOL)locked;
- (_TtC8Freeform30CRLCommandSetAspectRatioLocked)initWithId:(id)id aspectRatioLocked:(BOOL)locked;
@end
...
- (_TtC8Freeform30CRLCommandSetAspectRatioLocked)initWithBoardItem:(id)item aspectRatioLocked:(BOOL)locked
{
  ...
  (*(v8 + 8))(v11, v7);
  v14 = [(CRLCommandSetAspectRatioLocked *)self initWithId:isa aspectRatioLocked:lockedCopy];
