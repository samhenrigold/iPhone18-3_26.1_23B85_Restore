...
- (BOOL)authPassed
{
  ...
  v4 = [authStatus isEqualToNumber:&off_100028C30];
...
- (void)updateWithProperties:(id)properties
{
  ...
  v5 = sub_100004FC8(propertiesCopy);
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    v51 = 138412290;
    v52 = propertiesCopy;
...
- (void)getPairingStatus
{
  ...
  if ([(FMDMagSafeRawInfo *)self enableCAAPI:@"enableGetPairingStatus"]&& [(FMDMagSafeRawInfo *)self authPassed])
  {
    ...
    *buf = 0;
    ...
    {
      v14 = *(&off_100025920 + v13);
    }

    v15 = sub_100004FC8(v11);
...
- (void)getPairingDataWithCompletion:(id)completion
{
  ...
  else
  {
    ...
    selfCopy = self;
    v15 = completionCopy;
    [connectionInfo getPublicNVMKeyValues:&off_100028D50 forEndpoint:endPointUUID2 withReply:v12];
  }
}
...
{
  completionCopy = completion;
  v5 = sub_100004FC8(completionCopy);
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    LOWORD(buf[0]) = 0;
