...
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSection:(id)section;
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSection:(id)section configuration:(id)configuration;
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSection:(id)section sectionProvider:(id)provider configuration:(id)configuration;
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSectionProvider:(id)provider;
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSectionProvider:(id)provider configuration:(id)configuration;
...
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSectionProvider:(id)provider configuration:(id)configuration
{
  ...
  *(v6 + 16) = v5;
  return sub_3AE8C0(sub_3B08A8, v6, configuration);
}
