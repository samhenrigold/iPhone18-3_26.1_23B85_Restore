...
- (void)buttonTapped
{
  ...
  if (v2)
  {
    v3 = *&self->titleLabel[OBJC_IVAR____TtC18ASMessagesProvider30AccountActionSectionFooterView_buttonAction];
    selfCopy = self;
    v5 = sub_F714(v2, v3);
    v2(v5);
...
{
  width = fits.width;
  v5 = *(&self->super.super.super.super.isa + OBJC_IVAR____TtC18ASMessagesProvider30AccountActionSectionFooterView_text);
  v6 = *&self->titleLabel[OBJC_IVAR____TtC18ASMessagesProvider30AccountActionSectionFooterView_text];

  selfCopy = self;
  [(AccountActionSectionFooterView *)selfCopy layoutMargins];
  sub_129114(v5, v6, selfCopy, width, v8, v9, v10, v11);
  v13 = v12;
  v15 = v14;
