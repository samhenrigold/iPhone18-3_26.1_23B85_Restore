...
- (_TtC18ASMessagesProvider11OfferButton)initWithFrame:(CGRect)frame;
- (void)dealloc;
...
- (void)tintColorDidChange
{
  ...
  sub_134D8(v2 + v3, v5);
  sub_B170(v5, v5[3]);
  sub_1DF6D4(&qword_949A60, v4, type metadata accessor for OfferButton, &unk_78AA88);
  sub_760E20();
