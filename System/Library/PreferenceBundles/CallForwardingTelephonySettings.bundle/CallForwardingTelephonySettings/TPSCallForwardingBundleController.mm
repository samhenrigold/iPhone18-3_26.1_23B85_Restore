...
{
  v9.receiver = self;
  v9.super_class = TPSCallForwardingBundleController;
  isHidden = [(TPSCallForwardingBundleController *)&v9 isHidden];
  if ((isHidden & 1) == 0)
  {
  ...
  v6 = TPSCallForwardingLog(isHidden, v3);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *v8 = 0;
    _os_log_impl(&dword_0, v6, OS_LOG_TYPE_DEFAULT, "Hiding TPSCallForwarding settings row from view", v8, 2u);
  }
