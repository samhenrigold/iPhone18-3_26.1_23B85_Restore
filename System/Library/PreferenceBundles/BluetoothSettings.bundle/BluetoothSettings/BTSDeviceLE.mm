  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        name2 = [v10 localizedStringForKey:@"ACCESSORY" value:&stru_284EE3458 table:@"Devices"];
      }
    }
  }
...
- (void)sendNextChannelSoundingMessage
{
  ...
  _os_log_error_impl(&dword_23C0F7000, a2, OS_LOG_TYPE_ERROR, "Error sending channel sounding data: %@", &v7, 0xCu);
}
    ...
    if (event != 4)
    {
      ...
      if (event == 16)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
        {
          v15 = 67109120;
          v16 = 128;
          _os_log_impl(&dword_23C0F7000, v10, OS_LOG_TYPE_DEFAULT, "NSStreamEventEndEncountered for %d", &v15, 8u);
        }
...
LABEL_20:
    _os_log_impl(&dword_23C0F7000, v11, OS_LOG_TYPE_DEFAULT, v12, &v15, 8u);
    goto LABEL_21;
  }
...
LABEL_15:
        _os_log_impl(&dword_23C0F7000, v8, OS_LOG_TYPE_DEFAULT, v9, &v15, 8u);
        goto LABEL_25;
      }
...
- (void)stream:(void *)a1 handleEvent:(NSObject *)a2 .cold.1(void *a1, NSObject *a2)
{
  ...
  v6 = 2112;
  v7 = v4;
  _os_log_error_impl(&dword_23C0F7000, a2, OS_LOG_TYPE_ERROR, "NSStreamEventErrorOccurred for %d. Error: %@", v5, 0x12u);
}
