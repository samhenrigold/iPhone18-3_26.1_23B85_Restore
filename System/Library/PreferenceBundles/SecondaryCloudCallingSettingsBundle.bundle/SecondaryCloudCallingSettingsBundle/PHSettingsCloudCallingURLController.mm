...
- (id)genericErrorAlertController
{
  ...
  v4 = [v2 localizedStringForKey:v3 value:&stru_C760 table:@"CloudCallingURLController"];

  v5 = [NSBundle bundleForClass:objc_opt_class()];
  v6 = TUStringKeyForNetwork();
  v7 = [v5 localizedStringForKey:v6 value:&stru_C760 table:@"CloudCallingURLController"];

  v8 = [UIAlertController alertControllerWithTitle:v4 message:v7 preferredStyle:1];
  v9 = [NSBundle bundleForClass:objc_opt_class()];
  v10 = [v9 localizedStringForKey:@"OK" value:&stru_C760 table:@"CloudCallingURLController"];
