@interface URLFilterSetupListController
...
@implementation URLFilterSetupListController
...
- (void)appWillEnterForeground:(id)foreground
{
  ...
  v8 = [v6 connectionWithServiceID:v7 withGrade:{-[URLFilterSetupListController vpnGrade](self, "vpnGrade")}];
...
- (void)dealloc
{
  ...
  v6.receiver = self;
  v6.super_class = URLFilterSetupListController;
  [(URLFilterSetupListController *)&v6 dealloc];
}

- (URLFilterSetupListController)init
{
  v7.receiver = self;
  v7.super_class = URLFilterSetupListController;
  v2 = [(URLFilterSetupListController *)&v7 init];
  if (v2)
  {
    v3 = +[NSNotificationCenter defaultCenter];
...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v10.receiver = self;
  v10.super_class = URLFilterSetupListController;
  [(URLFilterSetupListController *)&v10 viewWillAppear:appearCopy];
  objc_destroyWeak(&location);
}
...
{
  v3.receiver = self;
  v3.super_class = URLFilterSetupListController;
  [(URLFilterSetupListController *)&v3 viewDidAppear:appear];
}
...
- (void)setStateForServiceID:(id)d
{
  dCopy = d;
  v5 = [dCopy copy];
  [(URLFilterSetupListController *)self setServiceID:v5];

  v6 = OBJC_IVAR___PSViewController__specifier;
  userInfo = [*&self->PSListController_opaque[OBJC_IVAR___PSViewController__specifier] userInfo];
  v8 = [userInfo objectForKey:@"service-grade"];
  -[URLFilterSetupListController setVpnGrade:](self, "setVpnGrade:", [v8 unsignedIntegerValue]);

  v9 = +[VPNConnectionStore sharedInstance];
  v15 = [v9 optionsForServiceID:dCopy withGrade:{-[URLFilterSetupListController vpnGrade](self, "vpnGrade")}];

  if (v15)
  {
    v10 = [v15 objectForKey:@"dispName"];
    [(URLFilterSetupListController *)self setDisplayName:v10];

    v11 = [v15 objectForKey:@"VPNApplicationName"];
    [(URLFilterSetupListController *)self setAppName:v11];

    v12 = [v15 objectForKey:@"VPNIncludedBundleIDs"];
    [(URLFilterSetupListController *)self setIncludedBundleIDs:v12];

    userInfo2 = [*&self->PSListController_opaque[v6] userInfo];
    v14 = [userInfo2 objectForKey:@"vpn-organization"];
    [(URLFilterSetupListController *)self setOrganization:v14];
  }
}
...
{
  v5.receiver = self;
  v5.super_class = URLFilterSetupListController;
  [(URLFilterSetupListController *)&v5 loadView];
  userInfo = [*&self->PSListController_opaque[OBJC_IVAR___PSViewController__specifier] userInfo];
  v4 = [userInfo objectForKey:@"vpn-service-id"];

  [(URLFilterSetupListController *)self setStateForServiceID:v4];
}

- (id)connection
{
  v3 = +[VPNConnectionStore sharedInstance];
  serviceID = [(URLFilterSetupListController *)self serviceID];
  v5 = [v3 connectionWithServiceID:serviceID withGrade:{-[URLFilterSetupListController vpnGrade](self, "vpnGrade")}];
...
- (id)statusForConnection:(id)connection
{
  connection = [(URLFilterSetupListController *)self connection];
  v4 = connection;
  if (connection)
  {
...
- (id)specifiers
{
  ...
  {
    displayName = [(URLFilterSetupListController *)self displayName];
    [(URLFilterSetupListController *)selfCopy setTitle:displayName];
    ...
    v54 = v4;
    [v4 addObject:v11];
    includedBundleIDs = [(URLFilterSetupListController *)selfCopy includedBundleIDs];
    if (includedBundleIDs)
    {
      v14 = includedBundleIDs;
      includedBundleIDs2 = [(URLFilterSetupListController *)selfCopy includedBundleIDs];
      ...
      if (v16)
      {
        ...
        v57 = 0u;
        v58 = 0u;
        obj = [(URLFilterSetupListController *)selfCopy includedBundleIDs];
          ...
          do
          {
            for (i = 0; i != v22; i = i + 1)
            {
              ...
              if (v31)
              {
                ...
                includedBundleIDs3 = [(URLFilterSetupListController *)v21 includedBundleIDs];
  ...
  {
    [(URLFilterSetupListController *)self settingsNavigationProxyPopWithAnimated:1];
    v44 = 0;
  }
