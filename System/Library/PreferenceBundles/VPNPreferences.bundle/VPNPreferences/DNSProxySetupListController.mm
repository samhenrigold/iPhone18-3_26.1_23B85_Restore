...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v10.receiver = self;
  v10.super_class = DNSProxySetupListController;
  [(DNSProxySetupListController *)&v10 viewWillAppear:appearCopy];
  objc_destroyWeak(&location);
}
...
{
  v3.receiver = self;
  v3.super_class = DNSProxySetupListController;
  [(DNSProxySetupListController *)&v3 viewDidAppear:appear];
}
