...
+ (id)_rpLocalizedAppNameFromBundleID:(id)d
{
  ...
  if (v5)
  {
    ...
    v8 = localizedName;
    if (localizedName && ([localizedName isEqualToString:&stru_82A8] & 1) == 0 && !objc_msgSend(v8, "isEqualToString:", @"$(PRODUCT_BUNDLE_IDENTIFIER)"))
    {
      goto LABEL_8;
    }
  }
...
LABEL_8:
  if (([v8 isEqualToString:&stru_82A8] & 1) != 0 || objc_msgSend(v8, "isEqualToString:", @"$(PRODUCT_BUNDLE_IDENTIFIER)"))
  {
    goto LABEL_10;
  }
