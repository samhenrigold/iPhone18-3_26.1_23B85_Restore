...
{
  v1 = OSObject_typed_operator_new(&AppleH15PlatformErrorHandler_ktv, "IRQ_EN_FLD");
...
LABEL_23:
      ...
      v25 = v24;
      v26 = AppleH15PlatformErrorHandler::_readRegister32(v24, v7, v10, (v15[2] + 12));
      v27 = v25 & 0xFFFFF;
      v40 = (v23 >> 22) & 7;
      v37 = (v23 >> 17) & 0x1F;
      v28 = (v23 >> 11) & 0x3F;
      ...
      v30 = v21 & 0xF;
      v31 = (v21 >> 4) & 7;
      v32 = AppleH15PlatformErrorHandler::_readRegister32(v26, v7, v10, (v16[2] + 16));
      v33 = AppleH15PlatformErrorHandler::_readRegister32(v32, v7, v10, (v16[2] + 20));
      v34 = v33 & 0x3FF;
      v35 = AppleH15PlatformErrorHandler::_readRegister32(v33, v7, v10, (v16[2] + 28));
      v36 = AppleH15PlatformErrorHandler::_fabricCommands[v28];
      if (!v36)
      {
        v36 = "???";
      }

      snprintf(AppleH15PlatformErrorHandler::_afxNiDecodeInterrupts(int,void *)::msg, 0x100uLL, "%s NI%d %s %d %s error (0x%08x) cmd/st:0x%x(%s)/0x%x src/dst/tid:%x/%x/%x vc/sc/tz/crh:0x%x/0x%x/0x%x/0x%x user:0x%x addrl:0x%x addrh:0x%x errorvec 0x%x", *(v16 + 2), v41, *(v16 + 3), v10, v43, v42, v28, v36, v40, 0, v38, v39, v30, v31, v37, v29, v27, v32, v34, v35);
...
uint64_t AppleH15PlatformErrorHandler::_afxNsDecodeInterrupts(AppleH15PlatformErrorHandler *this, int a2, _DWORD *a3)
{
  ...
  if (8 * v3 != 8 * v3)
  {
    v4 = ((&unk_65F0 + 8 * v3) & 0xFFFFFFFFFFFFLL | 0x2BAD000000000000);
  }
  ...
  if (v14 != v14)
  {
    v15 = ((&unk_6620 + v14) & 0xFFFFFFFFFFFFLL | 0x2BAD000000000000);
  }
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeTagPipeParity(uint64_t a1, unsigned int a2, int a3, int a4, _DWORD *a5, uint64_t a6)
{
  ...
  Register32 = AppleH15PlatformErrorHandler::_readRegister32(a1, v11, a2, ((a3 << 18) | 0x744u));
  v13 = AppleH15PlatformErrorHandler::_readRegister32(Register32, v11, a2, ((a3 << 18) | 0x748u));
  v14 = AppleH15PlatformErrorHandler::_readRegister32(v13, v11, a2, ((a3 << 18) | 0x74Cu));
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeDataPipeSBE(uint64_t a1, unsigned int a2, int a3, int a4, _DWORD *a5, uint64_t a6)
{
  ...
  v16 = vandq_s8(vshlq_u32(vdupq_n_s32(v14), xmmword_65A0), xmmword_65B0);
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeDirectoryParity(uint64_t a1, unsigned int a2, int a3, int a4, _DWORD *a5, uint64_t a6)
{
  ...
  panic("AMCC%u PLANE%u %s error: INTSTS%u 0x%08x FLAG/STATE %#x/%#x INFO %#x/%#x/%#x ADDR %#llx CMD/AID/TID %#x(%s)/%#x/%#x WAY/TAG/PARITY %#x/%#x/%#x @%s:%d", a2, a3, *(a6 + 8), a4, *a5, Register32, (v12 >> 5), v12, v13, v14, v16, v14 & 0x3F, v17, v14 & 0xFFFFF, (v14 >> 6) & 0x7FF, v12 & 0x1F, v13 & 0x3FFFF, v13 >> 31, "AppleH15PlatformErrorHandler.cpp", 2355);
}
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeDirectoryMultiHit(uint64_t a1, unsigned int a2, int a3, int a4, _DWORD *a5, uint64_t a6)
{
  ...
  panic("AMCC%u PLANE%u %s error: INTSTS%u 0x%08x FLAG/STATE %#x/%#x INFO %#x/%#x/%#x ADDR %#llx CMD/AID/TID %#x(%s)/%#x/%#x WAYS %#x @%s:%d", a2, a3, *(a6 + 8), a4, *a5, Register32, v12, v12, v13, v14, v17 & 0x3FF | v16, v14 & 0x3F, v18, v14 & 0xFFFFF, (v14 >> 6) & 0x7FF, v13 & 0xFFFFFF, "AppleH15PlatformErrorHandler.cpp", 2323);
}
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeTagPipeAFError(uint64_t a1, unsigned int a2, int a3, unsigned int a4, _DWORD *a5, uint64_t a6)
{
  ...
  Register32 = AppleH15PlatformErrorHandler::_readRegister32(a1, v10, a2, ((a3 << 18) | 0x750u));
  v12 = AppleH15PlatformErrorHandler::_readRegister32(Register32, v10, a2, ((a3 << 18) | 0x754u));
  v13 = AppleH15PlatformErrorHandler::_readRegister32(v12, v10, a2, ((a3 << 18) | 0x758u));
  v22 = AppleH15PlatformErrorHandler::_readRegister32(v13, v10, a2, ((a3 << 18) | 0x75Cu));
  v14 = AppleH15PlatformErrorHandler::_readRegister32(v22, v10, a2, ((a3 << 18) | 0x760u));
  v15 = AppleH15PlatformErrorHandler::_readRegister32(v14, v10, a2, ((a3 << 18) | 0x764u));
  v16 = AppleH15PlatformErrorHandler::_readRegister32(v15, v10, a2, ((a3 << 18) | 0x778u));
...
uint64_t AppleH15PlatformErrorHandler::_amccPlaneDsidAgeOut(uint64_t a1, unsigned int a2, int a3, int a4)
{
  ...
  while (1)
  {
    ...
    if (!--v9)
    {
      Register32 = AppleH15PlatformErrorHandler::_readRegister32(a1, v8, a2, (v6 | 0x750u));
      v24 = AppleH15PlatformErrorHandler::_readRegister32(Register32, v8, a2, (v6 | 0x754u));
      v23 = AppleH15PlatformErrorHandler::_readRegister32(v24, v8, a2, (v6 | 0x758u));
      v22 = AppleH15PlatformErrorHandler::_readRegister32(v23, v8, a2, (v6 | 0x75Cu));
      v21 = AppleH15PlatformErrorHandler::_readRegister32(v22, v8, a2, (v6 | 0x760u));
      v20 = AppleH15PlatformErrorHandler::_readRegister32(v21, v8, a2, (v6 | 0x764u));
      v19 = AppleH15PlatformErrorHandler::_readRegister32(v20, v8, a2, (v6 | 0x778u));
...
void AppleH15PlatformErrorHandler::_amccDumpRegs(uint64_t this, unsigned int a2)
{
  ...
  AppleH15PlatformErrorHandler::_amccDumpRegsForInputTable(this, dword_181C0, a2, v5, &v19);
...
void AppleH15PlatformErrorHandler::_amccDecodeInterrupts(uint64_t this, int a2, void *a3)
{
  ...
  do
  {
    ...
    do
    {
      Register32 = AppleH15PlatformErrorHandler::_readRegister32(Register32, v9, v3, (v27 + 8 * v11 + 135172), v27);
      v28 = Register32;
...
uint64_t AppleH15PlatformErrorHandler::_dcsDecodeInterrupts(uint64_t this, int a2, void *a3)
{
  ...
  do
  {
    v14 = &AppleH15PlatformErrorHandler::_dcsDecoders[6 * v9];
    if (v14[2])
    {
      this = AppleH15PlatformErrorHandler::_readRegister32(this, v13, v8, (*(*(v14 + 2) + 8) + v12 + *(*(v14 + 2) + 16)));
      *v33 = this;
      v15 = *v14 & this;
      if (v15)
      {
  ...
  if ((v10 & 1) == 0)
  {
    ...
    while (1)
    {
      if (*(v30 - 2))
      {
        Register32 = AppleH15PlatformErrorHandler::_readRegister32(v26, v13, v8, (*(*v30 + 2) + v12 + *(*v30 + 4)));
        v26 = snprintf(&v33[v28], 2000 - v28, "%d:%08x/%08x ", v27, Register32, *(v34 + v27));
        v29 += v26;
      }
      ...
      panic("Unhandled DCS interrupt: AMCC%u DCS Group %u Channel %u: %s @%s:%d", v8, v11, 0, v33, "AppleH15PlatformErrorHandler.cpp", 3277);
    }
  }
...
void AppleH15PlatformErrorHandler::_ioaPanic(uint64_t a1, unsigned int a2, _DWORD *a3, uint64_t a4)
{
  ...
  *__str = 0uLL;
  ...
  v23 = *a4 & *a3;
  if ((!v23 || (v10 & 0x7FFFC00) != 0x24C6000) && (!v23 || (v19 & 0x3FFFFFFC000) != 0x27F000000 || (*a4 & 0x2000) == 0))
  {
...
void AppleH15PlatformErrorHandler::_sepDecodeMonInterrupts(uint64_t this, int a2, void *a3)
{
  ...
  v13 = AppleH15PlatformErrorHandler::_readRegister32(v10, v12, 0, 0x5C000);
  v14 = AppleH15PlatformErrorHandler::_readRegister32(v13, v12, 1u, &stru_20.vmaddr);
  if (!Register32)
  {
    v15 = &unk_404D;
    if (!v6)
...
{
  Reg32 = AppleH15MemCacheController::_mccReadReg32(this, this + 1016, 0, 0x100024u);
...
uint64_t AppleH15MemCacheController::setWayMask(AppleH15MemCacheController *this)
{
  ...
  if (*(this + 517))
  {
    ...
    do
    {
      AppleH15MemCacheController::_mccProtectedWriteReg32(this, this + 1016, v17++, 0x1C072Cu, 0);
      v18 = *(this + 517);
    }
    ...
    if (v18)
    {
      ...
      if (v20)
      {
        for (j = 0; j < v14; ++j)
        {
          AppleH15MemCacheController::_mccProtectedWriteReg32(this, this + 1016, j, 0x1C072Cu, 1u);
          v14 = *(this + 517);
        }
...
_DWORD *AppleH15MemCacheController::_setCntrCtrlParmeters(_DWORD *result, uint64_t a2, unsigned int a3)
{
  v3 = 160 * a3;
  v4 = a2 + v3;
  if (v3 != v3)
  {
    v4 = (a2 + v3) & 0xFFFFFFFFFFFFLL | 0x2BAD000000000000;
  }

  *(v4 + 120) = ++AppleH15MemCacheController::_setCntrCtrlParmeters(AppleH15MemCacheController::AMCCCounterConfig *,unsigned int)::channelId;
  v5 = *(v4 + 4);
  if (v5 > 8)
  {
    if (v5 > 12)
    {
      if ((v5 - 13) < 6)
      {
        ...
        *(v4 + 28) = 34816;
        ...
        if (v7 >= 3)
        {
          AppleH15MemCacheController::_setCntrCtrlParmeters((v4 + 8));
        }

        v8 = (v7 << 48) + 0x1000000000000;
        v9 = v8 | 0x10000000000000;
        if ((v5 - 17) >= 2)
        {
          v9 = v8 | 0x50000000000000;
        }

        v10 = v8 | 0x30000000000000;
        if (v5 != 14)
        {
          v10 = v8 | 0x40000000000000;
        }
        ...
        *(v4 + 72) |= *(v4 + 56) & 0xFFFFFLL | ((*(v4 + 60) & 0xFFFFF) << 20);
        *(v4 + 80) = v11 | 0xFF000000000;
        v12 = 16 * v6 + 34904;
LABEL_17:
        *(v4 + 44) = v12;
        return result;
      ...
      if (v5 == 19)
      {
        ...
        *(v4 + 72) = (*(v4 + 56) & 0xFFFFFLL | ((*(v4 + 60) & 0xFFFFF) << 20) | (v29 << 56)) + 0x100000000000000;
        *(v4 + 80) = 0xFF000000000;
        v12 = 16 * v28 + 34904;
        goto LABEL_17;
      }
...
LABEL_46:
  ...
  if ((v5 - 1) >= 6)
  {
    if (!v5)
    {
      ...
      *(v4 + 52) = result[514] * v23;
      *(v4 + 64) = 2;
      v25 = *&v24 & 0xFFFFFLL | ((*(v4 + 60) & 0xFFFFF) << 20);
      *(v4 + 72) = v25 | 0x10000000000000;
      *(v4 + 80) = 0xFF000000000;
      v26 = *(v4 + 8);
      if (v26 >= 3)
      {
        panic("Counter type %d is not supported on counter index %d\\n @%s:%d", *(v4 + 8), a3, "AppleH15MemCacheController.cpp", 1689);
      }

      *(v4 + 72) = (v25 | (v26 << 56)) + 0x110000000000000;
      v27 = *(v4 + 24);
      *(v4 + 32) = 1 << v27;
      *(v4 + 28) = 0x8000;
      *(v4 + 44) = vadd_s32(vshl_u32(vdup_n_s32(v27), 0x300000004), 0x900000008010);
    }
  }
  ...
  else
  {
    ...
    *(v4 + 52) = result[517] * v13;
    *(v4 + 64) = 2;
    v15 = *(v4 + 24);
    *(v4 + 32) = 1 << v15;
    v16 = *(v4 + 8);
    *(v4 + 72) = *&v14 & 0xFFFFFLL | ((*(v4 + 60) & 0xFFFFF) << 20) | ((*(v4 + 12) & 0x7FFFF) << 40) | 0x1000000000000000;
    *(v4 + 80) = 0xFF000000000;
    if (v16 >= 3)
    {
      panic("Unsupported counter config type %d on counter index %d\\n @%s:%d", *(v4 + 8), a3, "AppleH15MemCacheController.cpp", 1636);
    }

    v17 = (v16 << 48) + 0x10FF000000000;
    *(v4 + 80) = v17;
    *(v4 + 44) = vadd_s32(vshl_u32(vdup_n_s32(v15), 0x300000004), 0x900000008008);
    if (v5 > 3)
    {
      if ((v5 - 5) >= 2)
      {
        v18 = v17 | 0x50000000000000;
      }

      else
      {
        v18 = v17 | 0x10000000000000;
      }
    }
    ...
    else
    {
      ...
      if (v5 == 2)
      {
        v18 = v17 | 0x30000000000000;
      }

      else
      {
        v18 = v17 | 0x40000000000000;
      }
    }
...
{
  OSMetaClass::OSMetaClass(&AppleH15MemCacheController::gMetaClass, "AppleH15MemCacheController", &AppleMemCacheController::gMetaClass, 0x8B0u)->__vftable = off_23FB8;
  OSMetaClass::OSMetaClass(&AppleMemCacheModeFunction::gMetaClass, "AppleMemCacheModeFunction", &AppleARMFunction::gMetaClass, 0x30u)->__vftable = off_24110;
  OSMetaClass::OSMetaClass(&AppleMemCachePanicFunction::gMetaClass, "AppleMemCachePanicFunction", &AppleARMFunction::gMetaClass, 0x30u)->__vftable = off_24248;
