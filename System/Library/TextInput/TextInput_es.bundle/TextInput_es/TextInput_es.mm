...
unsigned int *WTF::RefCounted<TI::Favonius::KeyboardLayout>::deref(unsigned int *result)
{
  ...
  if (v2 == 1)
  {
    ...
    return MEMORY[0x29EDA2EE0](v1, 0x10B0C409EA53459);
  }
...
uint64_t WTF::RefCounted<TI::Favonius::Key>::deref(uint64_t result)
{
  ...
  if (v2 == 1)
  {
    if (*(result + 40) >= 0xFu)
    {
      ...
      if (v3)
      {
        MEMORY[0x29EDA2EC0](v3, 0x1000C8077774924);
      }
    }
...
void _GLOBAL__sub_I_TIKeyboardFeatureSpecialization_es_mm()
{
  ...
  __cxa_atexit(KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_29EA19000);
...
{
  {
    __cxa_atexit(WTF::RefPtr<KB::InputSegmentFilter>::~RefPtr, &KB::InputManagerSpecialization::create_input_segment_filter(WTF::PassRefPtr<TI::Favonius::KeyboardLayout>)const::filter, &dword_29EA19000);
  }
