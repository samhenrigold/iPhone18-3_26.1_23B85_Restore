...
uint64_t ACMContextCopyData(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  ...
  if (v11 >= _logLevel && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v15 = "ACMLib";
    v16 = 2080;
...
uint64_t performCommand(uint64_t a1, uint64_t a2, uint64_t a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  ...
  if (v18)
  {
    ...
    else
    {
      ...
      v41 = v20;
      v21 = IOConnectCallStructMethod(dword_63C14, 0, v18, inputStructCnt, a6, &v41);
      if (v21)
      {
...
void logObjectForModule_cold_1()
{
  v5 = 134218240;
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&def_3A0E8, &_os_log_default, v0, "Make sure you have called init_logging()!\ngLogObjects: %p, gNumLogObjects: %d", v1, v2, v3, v4, v5);
}
...
void EnableAccessoryPower_cold_3()
{
  v6 = 136315394;
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&def_3A0E8, v0, v1, "%s could not find IOAccessoryManager services: %#x\n", v2, v3, v4, v5, v6);
}
...
void IOAccessoryManagerEventCallback_cold_24()
{
  v6 = 136315394;
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_1_0(&def_3A0E8, v0, v1, "%s ioService:%02X is NULL!\n", v2, v3, v4, v5, v6);
}
