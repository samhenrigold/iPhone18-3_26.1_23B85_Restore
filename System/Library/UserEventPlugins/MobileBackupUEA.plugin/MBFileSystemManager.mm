  ...
  if ((v17 & 0x80000000) != 0)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      *buf = 138543618;
      ...
      v30 = 1024;
      LODWORD(v31) = v25;
      _os_log_impl(&dword_0, v26, OS_LOG_TYPE_ERROR, "Failed to open %{public}@: %{errno}d", buf, 0x12u);
        ...
        if (dateCopy && [dateCopy compare:v7] == -1)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138412546;
            ...
            v25 = 2048;
            v26 = v19;
            _os_log_impl(&dword_0, v17, OS_LOG_TYPE_INFO, "Ignoring %@ since it was created at %.3f", buf, 0x16u);
            [v7 timeIntervalSince1970];
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *buf = 138412546;
              ...
              v25 = 2048;
              v26 = v18;
              _os_log_impl(&dword_0, v17, OS_LOG_TYPE_DEFAULT, "Removed %@ in %.3fs", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
            {
              *buf = 138412546;
              ...
              v25 = 2112;
              v26 = v14;
              _os_log_impl(&dword_0, v17, OS_LOG_TYPE_ERROR, "Failed to remove %@: %@", buf, 0x16u);
