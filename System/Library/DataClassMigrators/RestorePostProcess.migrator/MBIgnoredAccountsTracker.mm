...
LABEL_19:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
      {
        *buf = 138412290;
        v13 = v4;
        _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEBUG, "Found nil personaIdentifier for %@", buf, 0xCu);
...
LABEL_20:
  ...
  if (os_log_type_enabled(personaIdentifier, OS_LOG_TYPE_DEFAULT))
  {
    *buf = 138412290;
    v13 = v4;
    _os_log_impl(&dword_0, personaIdentifier, OS_LOG_TYPE_DEFAULT, "Account is marked as managed %@", buf, 0xCu);
...
- (BOOL)addAccountWithDSID:(id)d
{
  dCopy = d;
  v5 = dCopy;
  if (dCopy && ([dCopy isEqualToNumber:&off_25F88] & 1) == 0)
  {
    selfCopy = self;
