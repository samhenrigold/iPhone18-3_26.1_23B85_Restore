...
- (BOOL)addNode:(id)node
{
  nodeCopy = node;
  v20 = [nodeCopy hex];
  if (sub_40D8(&self->_nodes.__table_.__bucket_list_.__ptr_, &v20))
  {
...
- (void)incrementNeighborCountsForHex:(Hex)hex
{
  hexCopy = hex;
  v11 = 0;
  v8 = sub_106DC(&hexCopy);
  for (i = v4; (v8 & 1) != 0; i = v6)
  {
    v5 = sub_40D8(&self->_neighborCounts.__table_.__bucket_list_.__ptr_, &v8 + 1);
    if (v5)
    {
      ++*(v5 + 6);
    }
    ...
    {
      v7 = 1;
      sub_18574(&self->_neighborCounts.__table_.__bucket_list_.__ptr_, &v8 + 1, (&v8 + 4), &v7);
    }
...
- (void)setNodeObject:(id)object forKey:(Hex)key
{
  ...
  objectCopy = object;
  v7 = &keyCopy;
  sub_187C0(&self->_nodes.__table_.__bucket_list_.__ptr_, &keyCopy, &unk_2BE28, &v7)[3] = objectCopy;
  *&self->_neighborCountValid = 256;
}
...
- (id)_emplaceNodeAtHex:(Hex)hex withBundleIdentifier:(id)identifier
{
  ...
  sub_18A34(&self->_nodes.__table_.__bucket_list_.__ptr_, &hexCopy, &hexCopy, &v9);
  v7 = v9;
