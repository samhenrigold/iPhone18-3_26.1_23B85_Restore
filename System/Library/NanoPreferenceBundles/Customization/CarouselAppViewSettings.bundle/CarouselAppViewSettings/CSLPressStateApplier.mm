...
- (void)cleanupAfterLayout
{
  if (self->_pressStates.__size_)
  {
    ...
    do
    {
      ...
      v4 = sub_40D8(&self->_pressedHexes.__table_.__bucket_list_.__ptr_, v3 + 2);
      sub_4194(&self->_pressedHexes.__table_.__bucket_list_.__ptr_, v4);
      v10 = *(v3 + 1);
      v11 = xmmword_2BCE0;
      v12 = v10;
      v13 = 0;
      ...
      *v9 = sub_2B2C(&v10);
      ...
      {
        v6 = sub_40D8(&self->_pressedHexes.__table_.__bucket_list_.__ptr_, &v9[4]);
        sub_4194(&self->_pressedHexes.__table_.__bucket_list_.__ptr_, v6);
        *v9 = sub_2B2C(&v10);
      }

      *&self->_pressStates.__start_ = vaddq_s64(*&self->_pressStates.__start_, xmmword_2BCF0);
      sub_4314(&self->_pressStates, 1);
    }
