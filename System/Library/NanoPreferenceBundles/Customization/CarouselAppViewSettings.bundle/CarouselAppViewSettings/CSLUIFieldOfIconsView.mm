...
- (void)setLayout:(id)layout percentComplete:(double)complete animated:(BOOL)animated options:(unint64_t)options
{
  ...
  else
  {
    ...
    [(CSLHexLayout *)self->_layout setTargetHex:sub_1F330(self, [(CSLUIFieldOfIconsView *)self targetHex])];
    v28 = self->_layout;
    [(CSLUIFieldOfIconsView *)self bounds];
...
LABEL_6:
  ...
  *&v18[0] = v11;
  ...
  v13 = vcgt_f32(vabs_f32(*v17.i8), vadd_f32(vdup_laneq_s32(v17, 2), qword_465D0));
...
- (void)handlePanGesture:(id)gesture
{
  ...
  {
    sub_1FE58(&self->super.super.super.isa, gestureCopy);
  }
}
...
LABEL_39:
  ...
  if (state == (&dword_0 + 1))
  {
    ...
    self->_touchedHex = sub_1DA9C(self, v20, v21);
    *buf = 0u;
    v35 = 0u;
    objc_msgSend_originalLayoutAttributesForHex_(self);
    if (0.0 >= 0.2)
    {
      v25 = vcgt_f32(vabs_f32(*buf), vadd_f32(vdup_laneq_s32(*buf, 2), qword_465D0));
