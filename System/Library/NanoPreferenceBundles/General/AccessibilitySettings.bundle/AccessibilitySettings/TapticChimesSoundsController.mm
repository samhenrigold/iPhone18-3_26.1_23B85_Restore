...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v21.receiver = self;
  v21.super_class = TapticChimesSoundsController;
  ...
  if (bundleURL)
  {
    ...
    v8 = [v5 initWithKey:@"TAPTIC_CHIMES_SOUNDS_TITLE" table:@"Localizable" locale:currentLocale bundleURL:bundleURL2];
    ...
    v20 = [MEMORY[0x277CBEBC0] URLWithString:@"bridge:root=ACCESSIBILITY_ID&path=TapticChimesCell/CHIMES_SOUNDS_ID"];
