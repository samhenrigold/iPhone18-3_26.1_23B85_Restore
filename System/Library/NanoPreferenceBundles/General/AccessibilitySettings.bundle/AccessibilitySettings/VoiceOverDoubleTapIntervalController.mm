...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v19.receiver = self;
  v19.super_class = VoiceOverDoubleTapIntervalController;
  [(AccessibilityBridgeBaseController *)&v19 viewWillAppear:appear];
  v3 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v4 = objc_alloc(MEMORY[0x277CCAEB8]);
  currentLocale = [MEMORY[0x277CBEAF8] currentLocale];
  bundleURL = [v3 bundleURL];
  v7 = [v4 initWithKey:@"DOUBLE_TAP_INTERVAL_TITLE" table:@"VoiceOverSettings" locale:currentLocale bundleURL:bundleURL];
  ...
  v18 = [MEMORY[0x277CBEBC0] URLWithString:@"bridge:root=ACCESSIBILITY_ID&path=VOICEOVER_ID/VoiceOverDoubleTapInterval"];
