...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v23.receiver = self;
  v23.super_class = VoiceOverHandGesturesActivationController;
  ...
  v11 = [v8 initWithKey:@"HAND_GESTURES" table:@"VoiceOverSettings" locale:currentLocale2 bundleURL:bundleURL2];
  ...
  v22 = [MEMORY[0x277CBEBC0] URLWithString:@"bridge:root=ACCESSIBILITY_ID&path=VOICEOVER_ID/HandGestures/ACTIVATION_GESTURE_ID"];
