...
- (CHASActivitySetupMetricsCollectionViewController)initWithPresentationContext:(int64_t)context
{
  ...
  result = [(CHASActivitySetupMetricsCollectionViewController *)&v5 initWithTitle:&stru_35FD0 detailText:0 icon:0 adoptTableViewScrollView:1];
  if (result)
  {
...
- (CHASActivitySetupMetricsCollectionViewController)initWithPresentationContext:(int64_t)context pregnancyStateProvider:(id)provider
{
  ...
  v8 = [(CHASActivitySetupMetricsCollectionViewController *)&v11 initWithTitle:&stru_35FD0 detailText:0 icon:0 adoptTableViewScrollView:1];
  v9 = v8;
  if (v8)
  {
...
- (void)viewDidLoad
{
  ...
  if ((v9 & 1) != 0 || [v7 wheelchairUse] != &dword_0 + 2)
  {
  ...
  v19 = [v18 localizedStringForKey:@"SET_UP_ACTIVITY" value:&stru_35FD0 table:@"ActivitySetup"];
  [headerView setTitle:v19];

  headerView2 = [(CHASActivitySetupMetricsCollectionViewController *)self headerView];
  v21 = [NSBundle bundleForClass:objc_opt_class()];
  v22 = [v21 localizedStringForKey:@"SET_UP_ACTIVITY_DETAIL" value:&stru_35FD0 table:@"ActivitySetup"];
...
- (id)_titleForConfirmButton
{
  ...
  {
    v4 = off_35670[presentationContext];
    v5 = [NSBundle bundleForClass:objc_opt_class()];
    v2 = [v5 localizedStringForKey:v4 value:&stru_35FD0 table:@"ActivitySetup"];
  }
...
- (void)tappedConfirm:(id)confirm
{
  ...
  if (presentationContext <= 2)
  {
    if (!presentationContext)
    {
      ...
      {
        sub_210A0(&self->_presentationContext, v10);
      }
    ...
    if (presentationContext != 1)
    {
      ...
      if (os_log_type_enabled(HKLogActivity, OS_LOG_TYPE_FAULT))
      {
        sub_210A0(&self->_presentationContext, v9);
      }
    }
...
- (id)_footerString
{
  ...
  v10 = [v6 localizedStringForKey:v9 value:&stru_35FD0 table:@"ActivitySetup"];
...
- (void)_startEdit
{
  ...
  v5 = FIUIBundle();
  v6 = [v5 localizedStringForKey:@"DONE_BUTTON" value:&stru_35FD0 table:@"Localizable"];
  ...
  v9 = FIUIBundle();
  v10 = [v9 localizedStringForKey:@"CANCEL_BUTTON" value:&stru_35FD0 table:@"Localizable"];
...
- (void)_requestWheelchairDiagnosticsSubmissionIfNecessary
{
  ...
  if (isDiagnosticSubmissionAllowed)
  {
    ...
    if ((hasWheelchairDataSubmissionAllowedBeenSet & 1) == 0)
    {
      ...
      v8 = [v7 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_TITLE" value:&stru_35FD0 table:@"ActivitySetup"];
      v9 = [NSBundle bundleForClass:objc_opt_class()];
      v10 = [v9 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_DESCRIPTION" value:&stru_35FD0 table:@"ActivitySetup"];
      v11 = [UIAlertController alertControllerWithTitle:v8 message:v10 preferredStyle:1];

      v12 = [NSBundle bundleForClass:objc_opt_class()];
      v13 = [v12 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_ALLOW" value:&stru_35FD0 table:@"ActivitySetup"];
      v14 = [UIAlertAction actionWithTitle:v13 style:0 handler:&stru_355A0];
      [v11 addAction:v14];

      v15 = [NSBundle bundleForClass:objc_opt_class()];
      v16 = [v15 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_MORE_INFO" value:&stru_35FD0 table:@"ActivitySetup"];
      ...
      v18 = [NSBundle bundleForClass:objc_opt_class()];
      v19 = [v18 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_DENY" value:&stru_35FD0 table:@"ActivitySetup"];
      v20 = [UIAlertAction actionWithTitle:v19 style:0 handler:&stru_35610];
      [v11 addAction:v20];
...
- (void)didTapEditPregnancy
{
  ...
  [v3 openURL:v2 options:&__NSDictionary0__struct completionHandler:&stru_35650];
}
