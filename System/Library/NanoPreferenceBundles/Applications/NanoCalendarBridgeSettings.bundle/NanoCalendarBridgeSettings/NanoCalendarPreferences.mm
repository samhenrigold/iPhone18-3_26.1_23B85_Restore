...
- (BOOL)overlayCalendarIsEnabled
{
  ...
  v3 = [overlayCalendarID isEqualToString:&stru_10A88] ^ 1;
...
- (void)_reportOverlayCalendarID:(id)d mirroringCompanion:(BOOL)companion
{
  ...
  v11 = v10;
  if ([(__CFString *)overlayCalendarID isEqualToString:&stru_10A88])
  {
    v12 = @"off";
  }
  ...
  if ([(__CFString *)v11 isEqualToString:&stru_10A88])
  {
    v14 = @"off";
  }
