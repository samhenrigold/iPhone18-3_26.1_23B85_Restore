...
- (ProcExitHUDLine)initWithProcExitRecord:(id)record theme:(id)theme lineDelegate:(id)delegate
{
  ...
  if (v11)
  {
    [(HUDLine *)v11 setSpacing:sub_1000172DC(v11, v12)];
    ...
    v17 = [(CATextLayer *)v13->_exitedProcNameLayer setFont:qword_10003E768];
    sub_100016E74(v17, v18);
    ...
    v21 = [v20 setFont:qword_10003E788];
    sub_100016E74(v21, v22);
    [v20 setFontSize:?];
    [(HUDLine *)v13 contentScaleForTexts];
    [v20 setContentsScale:?];
    [v20 setAlignmentMode:kCAAlignmentRight];
    v23 = objc_alloc_init(NSString);
    v24 = [NSSet setWithObject:&off_100035CF0];
    ...
    if ((v26 & 1) == 0)
    {
      v27 = sub_10000D8F0([recordCopy exitReasonNamespace]);
    ...
    v29 = [v28 setFont:qword_10003E778];
    sub_100016E74(v29, v30);
    [v28 setFontSize:?];
    [(HUDLine *)v13 contentScaleForTexts];
    [v28 setContentsScale:?];
    [v28 setAlignmentMode:kCAAlignmentRight];
    v31 = sub_10000F008([recordCopy exitReasonNamespace], objc_msgSend(recordCopy, "exitReasonCode"));
    [v28 setString:v31];
