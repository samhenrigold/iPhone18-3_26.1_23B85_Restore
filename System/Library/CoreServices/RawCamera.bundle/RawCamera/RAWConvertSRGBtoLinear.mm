...
- (id)outputImage
{
  if (self->inputImage)
  {
    ...
    {
      *buf = 0;
      _os_signpost_emit_with_name_impl(&dword_23371F000, v4, OS_SIGNPOST_INTERVAL_BEGIN, self, "RAWConvertSRGBtoLinear", &unk_233945DBE, buf, 2u);
    }
    ...
    v6 = self->inputImage;
    v7 = [RAWKernels kernelWithName:@"raw_srgb_to_linear"];
