...
- (void)setFrame:(CGRect)frame
{
  ...
  if (!CGRectEqualToRect(v27, v28))
  {
    ...
    if (v22)
    {
      v23 = *&selfCopy->frameUpdatedCallback[OBJC_IVAR____TtCC22SubscribePageExtension30ArticleContainerViewControllerP33_BACDBA853B9C19619833ED681F77E93313ContainerView_frameUpdatedCallback];
