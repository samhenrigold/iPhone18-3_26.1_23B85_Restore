...
- (id)animationControllerForPresentedController:(id)controller presentingController:(id)presentingController sourceController:(id)sourceController
{
  ...
  selfCopy = self;
  v12 = sub_100653F6C(presentingControllerCopy);
...
- (id)animationControllerForDismissedController:(id)controller
{
  controllerCopy = controller;
  selfCopy = self;
  v6 = sub_100653690(controllerCopy);
...
- (_TtC22SubscribePageExtension34ComponentViewOverflowTransitioning)init
{
  ...
  swift_unknownObjectWeakInit();
  *(&self->super.isa + OBJC_IVAR____TtC22SubscribePageExtension34ComponentViewOverflowTransitioning_isTransitioningFromContainer) = 0;
  v3 = OBJC_IVAR____TtC22SubscribePageExtension34ComponentViewOverflowTransitioning_selectedIndexPath;
  v4 = sub_1007417F4();
