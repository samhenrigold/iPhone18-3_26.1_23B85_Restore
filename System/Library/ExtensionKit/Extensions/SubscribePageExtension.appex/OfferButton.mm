...
- (_TtC22SubscribePageExtension11OfferButton)initWithFrame:(CGRect)frame;
- (void)dealloc;
...
- (void)tintColorDidChange
{
  ...
  sub_100156B68(&qword_100929E60, v4, type metadata accessor for OfferButton, &unk_1007ADF58);
  sub_10074AE94();
