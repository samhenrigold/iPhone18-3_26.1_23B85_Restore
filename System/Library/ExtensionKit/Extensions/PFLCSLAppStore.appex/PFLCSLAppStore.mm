...
uint64_t sub_100021030(uint64_t a1)
{
  if (*(a1 + 16))
  {
    sub_100022C78(&qword_1000324C8, &unk_100027290);
    v2 = sub_100024428();
  }
...
void *sub_100021F18(uint64_t a1, uint64_t a2)
{
  ...
  sub_100022C78(&qword_1000324B0, &qword_100027270);
...
uint64_t sub_100022A64()
{
  ...
  v1 = sub_100022080(0xD000000000000010, 0x8000000100029EA0);
  if ((v2 & 1) == 0)
  {
  }
  ...
  sub_100022C78(&qword_1000324A0, &qword_100027268);
  ...
  v4 = sub_100022080(0xD000000000000015, 0x8000000100029EC0);
  if ((v5 & 1) == 0)
  {
  }
...
unint64_t sub_100022E18(uint64_t a1)
{
  ...
  if (v1)
  {
    sub_100022C78(&qword_1000324B8, &qword_100027280);
    v3 = sub_100024428();
    v4 = a1 + 32;
...
{
  v4 = sub_100022C78(&qword_1000324C0, &qword_100027288);
  (*(*(v4 - 8) + 16))(a2, a1, v4);
  return a2;
}
...
uint64_t sub_100023AB4()
{
  ...
  if (v2)
  {
    ...
    sub_100022C78(&qword_1000324E0, &qword_100027360);
    sub_100024368();
    sub_100022C78(&qword_1000324E8, &qword_100027368);
    v8 = swift_allocObject();
    *(v8 + 16) = xmmword_1000272A0;
    ...
    sub_100022C78(&qword_1000324F8, &qword_100027370);
    sub_100023FF4();
    sub_1000243C8();
    ...
    *(v10 + 24) = v7;
    v0[5] = v9;
    v11 = sub_1000240A0(&qword_100032508, type metadata accessor for PFLAMDODMLTaskRunner, &unk_1000271F0);
    v0[2] = v10;
    v0[6] = v11;
...
unint64_t sub_100023FF4()
{
  ...
  if (!qword_100032500)
  {
    sub_100024058(&qword_1000324F8, &qword_100027370);
    result = swift_getWitnessTable();
