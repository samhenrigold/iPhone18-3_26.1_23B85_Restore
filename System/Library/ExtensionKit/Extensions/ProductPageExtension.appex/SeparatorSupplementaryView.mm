...
- (void)layoutSubviews
{
  ...
  v9 = *(&selfCopy->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension26SeparatorSupplementaryView_lineView);
  v10 = OBJC_IVAR____TtC20ProductPageExtension26SeparatorSupplementaryView_separator;
  swift_beginAccess();
