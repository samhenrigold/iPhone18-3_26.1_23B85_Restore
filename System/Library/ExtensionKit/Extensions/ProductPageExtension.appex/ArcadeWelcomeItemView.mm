...
- (_TtC20ProductPageExtension21ArcadeWelcomeItemView)initWithCoder:(id)coder;
- (void)layoutSubviews;
...
- (void)setFrame:(CGRect)frame
{
  ...
  *(&selfCopy->super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension21ArcadeWelcomeItemView_shouldUpdateArtwork) = v18;
}
...
- (JUMeasurements)measurementsWithFitting:(CGSize)fitting in:(id)in
{
  ...
  selfCopy = self;
  v9.n128_f64[0] = width;
  v10 = sub_1002EE688(in, v9, height);
  v12 = v11;
  v14 = v13;
  v16 = v15;
