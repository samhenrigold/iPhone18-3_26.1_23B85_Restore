...
- (void)setFrame:(CGRect)frame
{
  ...
  if (!CGRectEqualToRect(v27, v28))
  {
    ...
    if (v22)
    {
      v23 = *&selfCopy->frameUpdatedCallback[OBJC_IVAR____TtCC20ProductPageExtension30ArticleContainerViewControllerP33_DBD3BDFA863817F76B447E10483B1F7213ContainerView_frameUpdatedCallback];
