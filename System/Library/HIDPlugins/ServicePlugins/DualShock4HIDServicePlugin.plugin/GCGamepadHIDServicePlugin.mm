...
- (GCGamepadHIDServicePlugin)initWithService:(unsigned int)service
{
  ...
  if (v4)
  {
    ...
    *&v23->var0 = 25700;
    ...
    v34 = sub_10F8(defaultRightAxisSnapRadius);
...
LABEL_5:
  ...
  if (v19)
  {
    ...
    {
      v20 = [NSPredicate predicateWithBlock:&stru_14660];
...
- (BOOL)setProperty:(id)property forKey:(id)key client:(id)client
{
  ...
  keyCopy = key;
  if (sub_E38(keyCopy, v9))
  {
    sub_A1C8(self, propertyCopy, keyCopy);
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  ...
  {
    v4 = sub_10F8(shouldCreateBatteryDevice);
    ...
    [v6 setObject:&off_15488 forKeyedSubscript:@"GameControllerType"];
...
- (void)sendBatteryReport
{
  ...
  {
    v4 = sub_10F8(updateClientBattery);
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      regID = self->_regID;
      var0 = self->_batteryReport->var0;
...
- (void)updateIdleState
{
  if ([(GCGamepadHIDServicePlugin *)self isIdle])
  {
    ...
    {
      v4 = sub_10F8(shouldDisconnectWhenIdle);
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        regID = self->_regID;
        v6 = 134217984;
...
- (BOOL)isIdle
{
  ...
  v6 = (v5 * dword_1AFF0 / *algn_1AFF4) / 1000000000.0;
