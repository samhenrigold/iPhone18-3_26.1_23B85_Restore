...
- (GCGamepadHIDServicePlugin)initWithService:(unsigned int)service
{
  ...
  if (v4)
  {
    ...
    *&v23->var0 = 25700;
    ...
    v34 = sub_1080(defaultRightAxisSnapRadius);
...
- (void)createVirtualHIDDeviceForBattery
{
  ...
  {
    v4 = sub_1080(shouldCreateBatteryDevice);
    ...
    [v6 setObject:&off_11010 forKeyedSubscript:@"GameControllerType"];
...
- (void)sendBatteryReport
{
  ...
  {
    v4 = sub_1080(updateClientBattery);
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      regID = self->_regID;
      var0 = self->_batteryReport->var0;
...
- (void)updateIdleState
{
  if ([(GCGamepadHIDServicePlugin *)self isIdle])
  {
    ...
    {
      v4 = sub_1080(shouldDisconnectWhenIdle);
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        regID = self->_regID;
        v6 = 134217984;
...
- (BOOL)isIdle
{
  ...
  v6 = (v5 * dword_16B00 / *algn_16B04) / 1000000000.0;
