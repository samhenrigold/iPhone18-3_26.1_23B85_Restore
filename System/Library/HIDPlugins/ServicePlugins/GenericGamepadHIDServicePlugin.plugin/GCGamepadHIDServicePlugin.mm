...
- (GCGamepadHIDServicePlugin)initWithService:(unsigned int)service
{
  ...
  if (v4)
  {
    ...
    *&v23->var0 = 25700;
    ...
    v34 = sub_1148(defaultRightAxisSnapRadius);
...
- (BOOL)setProperty:(id)property forKey:(id)key client:(id)client
{
  ...
  keyCopy = key;
  if (sub_E88(keyCopy, v9))
  {
    sub_CFAC(self, propertyCopy, keyCopy);
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  ...
  {
    v4 = sub_1148(shouldCreateBatteryDevice);
    ...
    [v6 setObject:&off_19AC0 forKeyedSubscript:@"GameControllerType"];
...
- (void)sendBatteryReport
{
  ...
  {
    v4 = sub_1148(updateClientBattery);
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      regID = self->_regID;
      var0 = self->_batteryReport->var0;
...
- (void)updateIdleState
{
  if ([(GCGamepadHIDServicePlugin *)self isIdle])
  {
    ...
    {
      v4 = sub_1148(shouldDisconnectWhenIdle);
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        regID = self->_regID;
        v6 = 134217984;
...
- (BOOL)isIdle
{
  ...
  v6 = (v5 * dword_1F018 / *algn_1F01C) / 1000000000.0;
