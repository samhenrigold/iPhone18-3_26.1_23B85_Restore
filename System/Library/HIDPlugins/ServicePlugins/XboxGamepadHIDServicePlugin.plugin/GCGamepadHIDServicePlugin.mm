...
- (BOOL)setProperty:(id)property forKey:(id)key client:(id)client
{
  ...
  {
    sub_87A8(self, propertyCopy, keyCopy);
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  ...
  if (shouldCreateBatteryDevice)
  {
    ...
    [v6 setObject:&off_11040 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  v6 = (v5 * dword_17A88 / *algn_17A8C) / 1000000000.0;
