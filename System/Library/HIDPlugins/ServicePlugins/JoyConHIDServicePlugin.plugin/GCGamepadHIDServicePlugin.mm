...
LABEL_5:
  ...
  if (v19)
  {
    ...
    {
      v20 = [NSPredicate predicateWithBlock:&stru_245F0];
...
- (void)createVirtualHIDDeviceForBattery
{
  ...
  if (shouldCreateBatteryDevice)
  {
    ...
    [v6 setObject:&off_25EF8 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  v6 = (v5 * dword_2B068 / *algn_2B06C) / 1000000000.0;
