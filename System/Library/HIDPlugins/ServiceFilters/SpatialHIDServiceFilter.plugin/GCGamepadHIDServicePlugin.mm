...
- (GCGamepadHIDServicePlugin)initWithService:(unsigned int)service
{
  ...
  if (v4)
  {
    ...
    *&v23->var0 = 25700;
    ...
    v34 = sub_1120(defaultRightAxisSnapRadius);
...
LABEL_5:
  ...
  if (v19)
  {
    ...
    {
      v20 = [NSPredicate predicateWithBlock:&stru_14578];
...
- (BOOL)setProperty:(id)property forKey:(id)key client:(id)client
{
  ...
  {
    sub_8344(self, propertyCopy, keyCopy);
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  ...
  {
    v4 = sub_1120(shouldCreateBatteryDevice);
    ...
    [v6 setObject:&off_14FB0 forKeyedSubscript:@"GameControllerType"];
...
- (void)sendBatteryReport
{
  ...
  {
    v4 = sub_1120(updateClientBattery);
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      regID = self->_regID;
      var0 = self->_batteryReport->var0;
...
- (void)updateIdleState
{
  if ([(GCGamepadHIDServicePlugin *)self isIdle])
  {
    ...
    {
      v4 = sub_1120(shouldDisconnectWhenIdle);
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        regID = self->_regID;
        v6 = 134217984;
...
- (BOOL)isIdle
{
  ...
  v6 = (v5 * dword_1AE80 / *algn_1AE84) / 1000000000.0;
  ...
  *&v20 = self->_rightThumbstickNoiseBuffer;
  ...
  if (state->var0)
  {
    ...
    *&state->var1[15] = vand_s8(vneg_f32(v27), vcltz_f32(v27));
    ...
    IOHIDEventSetIntegerValue(VendorDefinedEvent, 0x10000, "=%f)\n}", *&v49);
    IOHIDEventSetIntegerValue(VendorDefinedEvent, 65537, &stru_20.vmsize + 3);
    IOHIDEventAppendEvent();
