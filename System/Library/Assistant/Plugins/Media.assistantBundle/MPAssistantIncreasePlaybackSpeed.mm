...
- (void)performWithCompletion:(id)completion
{
  ...
  if (!objc_msgSend_length(self->_requestAceHash, v10, v11, v12, v13))
  {
    ...
    v19 = sub_233505670(@"Increase Playback Speed", v18);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543618;
    ...
    _os_log_impl(&dword_2334D9000, v21, OS_LOG_TYPE_DEFAULT, "Increase Playback Speed (invoke) <%{public}@>: %lu UIDs", buf, 0x16u);
  }

  v32 = self->_requestAceHash;
  v37 = objc_msgSend_hashedRouteUIDs(self, v33, v34, v35, v36);
  sub_2335057BC(@"Increase Playback Speed", v32, v37);
  ...
  v50 = v41;
  v51 = v46;
  sub_2334ED7CC(v55, 0, v52, v53, v54);
}
