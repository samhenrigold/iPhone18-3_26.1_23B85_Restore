...
- (void)performWithCompletion:(id)completion
{
  ...
  if (!objc_msgSend_length(self->_requestAceHash, v5, v6, v7, v8))
  {
    ...
    v14 = sub_233505670(@"Remove Output Devices From Group", v13);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543362;
    v75 = v17;
    _os_log_impl(&dword_2334D9000, v16, OS_LOG_TYPE_DEFAULT, "Remove Output Devices From Group (invoke) <%{public}@>: invoked", buf, 0xCu);
  }

  v18 = self->_requestAceHash;
  v23 = objc_msgSend_hashedRouteUIDs(self, v19, v20, v21, v22);
  sub_2335057BC(@"Remove Output Devices From Group", v18, v23);
