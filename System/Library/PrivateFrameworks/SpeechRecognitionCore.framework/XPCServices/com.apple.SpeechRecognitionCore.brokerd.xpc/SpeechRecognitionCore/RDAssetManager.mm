          ...
          else
          {
            ...
            if (_es_status != 3)
            {
              if (_es_status == 4)
              {
                ...
                if ([v18 _es_isCompatibleWithThisDevice] && sub_100003CCC(_es_quasarModelPath))
                {
      ...
      while (2)
      {
        for (i = 0; i != v17; i = i + 1)
        {
          ...
          if (v23)
          {
            ...
            if ([v20 _es_isCompatibleWithThisDevice] && (sub_100003CCC(_es_quasarModelPath) & 1) != 0)
            {
...
LABEL_25:
  ...
  if (state == 1)
  {
    ...
    else
    {
      ...
      v15 = [NSError errorWithDomain:@"kRXAssetDownloadErrorDomain" code:101 userInfo:&off_10001E1E0];
