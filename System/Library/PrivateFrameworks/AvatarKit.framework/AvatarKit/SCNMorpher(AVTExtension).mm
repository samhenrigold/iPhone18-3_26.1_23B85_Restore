...
LABEL_63:
    ...
    if (v74 < v75)
    {
      ...
      {
        [(SCNMorpher(AVTExtension) *)v76 avt_buildInternalSupportForCorrectivesWithBlock:v77, v78, v79, v80, v81, v82, v83];
      }
    }
    ...
    if (v84 < v85)
    {
      ...
      {
        [(SCNMorpher(AVTExtension) *)v86 avt_buildInternalSupportForCorrectivesWithBlock:v87, v88, v89, v90, v91, v92, v93];
      }
    }
...
{
  LODWORD(v8) = 136315138;
  *(&v8 + 4) = "newTargetsAndInBetweens.count + newCorrectivesAndInBetweens.count == oldTargetsAndInBetweens.count - numberOfOldTargetsAndInBetweensSkippedForInvalidCorrective";
  OUTLINED_FUNCTION_0(&dword_1BB472000, a1, a3, "Error: Condition '%s' failed. Failed to correctly separate correctives", a5, a6, a7, a8, v8, DWORD2(v8));
}
...
{
  LODWORD(v8) = 136315138;
  *(&v8 + 4) = "newInBetweenCounts.count + newCorrectiveInBetweenCounts.count == oldInBetweenCounts.count";
  OUTLINED_FUNCTION_0(&dword_1BB472000, a1, a3, "Error: Condition '%s' failed. Failed to correctly separate correctives", a5, a6, a7, a8, v8, DWORD2(v8));
}
...
{
  LODWORD(v8) = 136315138;
  *(&v8 + 4) = "newInBetweenWeights.count + newCorrectiveInBetweenWeights.count == oldInBetweenWeights.count";
  OUTLINED_FUNCTION_0(&dword_1BB472000, a1, a3, "Error: Condition '%s' failed. Failed to correctly separate correctives", a5, a6, a7, a8, v8, DWORD2(v8));
}
...
{
  LODWORD(v8) = 136315138;
  *(&v8 + 4) = "newCorrectiveInBetweenCounts.count == newCorrectiveDriverCounts.count";
  OUTLINED_FUNCTION_0(&dword_1BB472000, a1, a3, "Error: Condition '%s' failed. Failed to correctly separate correctives", a5, a6, a7, a8, v8, DWORD2(v8));
}
