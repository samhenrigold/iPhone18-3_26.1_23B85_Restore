...
- (void)avt_setInitialValuesExportedAsAnimationsWithWithOptions:()AVTExtension handler:
{
  ...
  v11 = a3;
  v8 = v6;
  [rootNode enumerateHierarchyUsingBlock:{v9, 3221225472, __90__SCNScene_AVTExtension__avt_setInitialValuesExportedAsAnimationsWithWithOptions_handler___block_invoke, &unk_1E7F499A0}];
...
LABEL_22:
      ...
      if (v27)
      {
        simdTransform = [v17 simdTransform];
        ...
        {
          v33 = avt_default_log(simdTransform);
          if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
          {
            [(SCNScene(AVTExtension) *)v48 avt_removeDuplicateSkeletonRootWithHandler:v33];
          }
        }
