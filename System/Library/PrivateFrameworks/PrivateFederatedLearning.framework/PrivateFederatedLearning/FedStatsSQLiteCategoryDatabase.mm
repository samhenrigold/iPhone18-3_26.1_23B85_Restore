...
+ (id)databaseWithFileURL:(id)l error:(id *)error
{
  ...
  v75[1] = &unk_282B4B988;
  v10 = [MEMORY[0x277CBEA60] arrayWithObjects:v75 count:2];
  v76[0] = v10;
  ...
  v73[1] = &unk_282B4B9B8;
  v12 = [MEMORY[0x277CBEA60] arrayWithObjects:v73 count:2];
  v76[2] = v12;
  ...
  v72[1] = &unk_282B4B988;
  v13 = [MEMORY[0x277CBEA60] arrayWithObjects:v72 count:2];
  v76[3] = v13;
  ...
  v76[5] = v15;
  v16 = [MEMORY[0x277CBEA60] arrayWithObjects:v76 count:6];
...
LABEL_42:
      ...
      if (!v30 || (v31 = v29, objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0) || ([v30 isEqualToNumber:v29] & 1) == 0)
      {
        if (errorCopy)
        {
          v43 = [MEMORY[0x277CCACA8] stringWithFormat:@"Cannot complete check statement for %@", v60];
...
+ (id)categoryDatabaseAt:(id)at withCategories:(id)categories error:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      v32 = 0;
      v14 = [FedStatsSQLiteDatabase databaseWithURL:atCopy mode:119 error:&v32];
      v15 = v32;
      v16 = v15;
      if (v14)
      {
        v31 = v15;
        v17 = [v14 execute:@"CREATE TABLE categories (idx INTEGER UNIQUE error:{category TEXT UNIQUE, PRIMARY KEY(idx, category)) WITHOUT ROWID, STRICT", &v31}];
        v18 = v31;
        ...
        if (v17)
        {
          ...
          do
          {
            ...
            v22 = [v9 objectAtIndex:v20 - 1];
            v23 = [v21 stringWithFormat:@"INSERT INTO categories VALUES (%lu, '%@')", v20, v22];
