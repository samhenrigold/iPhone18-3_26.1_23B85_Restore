...
- (BOOL)_loadRemoteItemsForWishlist:(id)wishlist didChange:(BOOL *)change error:(id *)error
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    {
      LOWORD(v32) = 0;
      v25 = _os_log_send_and_compose_impl(v24, 0, 0, 0, &dword_259CB8000, v23, 0, "[Wishlist]: No bag key for viewWishlist", &v32, 2);
...
LABEL_14:
  ...
  v31[1] = 3221225472;
  v31[2] = __73__SUUISyncWishlistOperation__loadRemoteItemsForWishlist_didChange_error___block_invoke;
  v31[3] = &unk_2798F9580;
  v31[4] = &v42;
  v31[5] = &v32;
  v31[6] = &v38;
  ...
  if (*(v39 + 24) == 1)
  {
    ...
    v17 = (v43 + 5);
    obj = v43[5];
    v18 = [(SUUISyncWishlistOperation *)self _mergeItems:v16 wishlist:wishlistCopy didChange:v48 error:&obj];
...
- (void)_sendLocalChangesForWishlist:(id)wishlist
{
  ...
  v22[1] = 3221225472;
  v22[2] = __58__SUUISyncWishlistOperation__sendLocalChangesForWishlist___block_invoke;
  v22[3] = &unk_2798F8300;
  v5 = v4;
  v23 = v5;
  ...
  v25 = 134217984;
  v26 = v10;
  v11 = _os_log_send_and_compose_impl(v8, 0, 0, 0, &dword_259CB8000, oSLogObject, 2, "[Wishlist]: Syncing %ld local changes", &v25);
