...
id *__74__SUProductPageViewController_clientInterface_showPreviewOverlayAnimated___block_invoke(id *result, int a2)
{
  if (a2)
  {
...
- (void)purchaseManager:(id)manager didFinishPurchaseRequest:(id)request withError:(id)error
{
  ...
  if (!errorCopy)
  {
    ...
    if (v13)
    {
      ...
      v24 = objc_opt_class();
      v21 = v24;
      v22 = _os_log_send_and_compose_impl(v13, 0, 0, 0, &dword_259CB8000, v15, 2, "%@: Did finish purchase batch", &v23, 12);
...
LABEL_21:
  ...
  if (v13)
  {
    ...
    v26 = errorCopy;
    v16 = v24;
    v17 = _os_log_send_and_compose_impl(v13, 0, 0, 0, &dword_259CB8000, v15, 0, "%@: Did fail purchase batch with error: %@", &v23, 22);
...
- (void)purchaseManager:(id)manager willAddPurchases:(id)purchases
{
  ...
  if (v20)
  {
    ...
    v22 = v21;
    LODWORD(v27) = 22;
    v23 = _os_log_send_and_compose_impl(v20, 0, 0, 0, &dword_259CB8000, oSLogObject, 2, "%@: Will make purchases: %@", &v33, v27);
...
LABEL_3:
    ...
    if (v15)
    {
      ...
      v37 = error2;
      v18 = v17;
      v19 = _os_log_send_and_compose_impl(v15, 0, 0, 0, &dword_259CB8000, oSLogObject, 0, "%@: Did fail purchase batch with error: %@", &v34, 22, v30);
...
LABEL_23:
  ...
  v35 = v27;
  v28 = v27;
  v29 = _os_log_send_and_compose_impl(v25, 0, 0, 0, &dword_259CB8000, oSLogObject2, 2, "%@: Did finish purchase batch", &v34, 12, v30);
...
- (void)_purchaseFailedNotification:(id)notification
{
  ...
  if (v10)
  {
    ...
    v22 = v7;
    v12 = v18;
    v13 = _os_log_send_and_compose_impl(v10, 0, 0, 0, &dword_259CB8000, oSLogObject, 0, "%@: Did fail purchase: %@ with error: %@", &v17, 32);
...
- (void)_purchaseFinishedNotification:(id)notification
{
  ...
  if (v7)
  {
    ...
    v17 = object;
    v9 = v15;
    v10 = _os_log_send_and_compose_impl(v7, 0, 0, 0, &dword_259CB8000, oSLogObject, 2, "%@: Did finish purchase: %@", &v14, 22);
...
- (void)_loadClientContextWithCompletionBlock:(id)block
{
  ...
  if (!self->_clientContext)
  {
    ...
    if (!self->_clientContext)
    {
      ...
      v20[1] = 3221225472;
      v20[2] = __69__SUProductPageViewController__loadClientContextWithCompletionBlock___block_invoke;
      v20[3] = &unk_2798F7C50;
      objc_copyWeak(&v24, &location);
      v21 = clientIdentifier;
      selfCopy = self;
      v23 = blockCopy;
      [(SUUIReloadConfigurationOperation *)v10 setOutputBlock:v20];
      mEMORY[0x277D69B38] = [MEMORY[0x277D69B38] sharedConfig];
      ...
      if (v12)
      {
        ...
        v27 = v16;
        v17 = v16;
        v18 = _os_log_send_and_compose_impl(v12, 0, 0, 0, &dword_259CB8000, v15, 2, "%@: Loading missing client context", &v26, 12);
...
void __55__SUProductPageViewController__loadProductWithRequest___block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if (a2)
  {
    ...
    if (v12)
    {
      ...
      v27 = 2112;
      v28 = v17;
      v18 = _os_log_send_and_compose_impl(v12, 0, 0, 0, &dword_259CB8000, v11, 2, "%@: Loading request: %@", &v25, 22);
...
- (void)_loadRequestForProductParameters
{
  ...
  if ([(NSDictionary *)self->_productParameters count])
  {
    if (self->_bannerViewController)
    {
      ...
      v32[1] = 3221225472;
      v32[2] = __63__SUProductPageViewController__loadRequestForProductParameters__block_invoke;
      v32[3] = &unk_2798F6170;
      objc_copyWeak(&v33, location);
      v32[4] = self;
      [(SUProductPageViewController *)self _loadClientContextWithCompletionBlock:v32];
    ...
    else
    {
      ...
      if (v5)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0 && (-[SUProductPageViewController productPageStyle](self, "productPageStyle") == 1 && ([v6 objectForKey:@"banner-lookup-url"], (v7 = objc_claimAutoreleasedReturnValue()) != 0) || (objc_msgSend(v6, "objectForKey:", @"lookup-url"), (v7 = objc_claimAutoreleasedReturnValue()) != 0)) && (v8 = objc_msgSend(objc_alloc(MEMORY[0x277CBEBC0]), "initWithString:", v7), v7, v8))
        {
          ...
          if (v11)
          {
            ...
            *&location[4] = objc_opt_class();
            ...
            v36 = v8;
            v13 = *&location[4];
            v14 = _os_log_send_and_compose_impl(v11, 0, 0, 0, &dword_259CB8000, oSLogObject, 2, "%@: Loading using lookup URL: %@", location, 22);
        ...
        else
        {
          ...
          if (v18)
          {
            ...
            *&location[4] = objc_opt_class();
            v20 = *&location[4];
            v21 = _os_log_send_and_compose_impl(v18, 0, 0, 0, &dword_259CB8000, oSLogObject2, 0, "%@: Could not find lookup URL", location, 12);
      ...
      else
      {
        ...
        v28[1] = 3221225472;
        v28[2] = __63__SUProductPageViewController__loadRequestForProductParameters__block_invoke_111;
        v28[3] = &unk_2798F7CC8;
...
void __63__SUProductPageViewController__loadRequestForProductParameters__block_invoke_2(uint64_t a1)
{
  ...
  if (![*(a1 + 32) success])
  {
    ...
    if (v4)
    {
      ...
      v24 = 2112;
      v25 = v10;
      v11 = _os_log_send_and_compose_impl(v4, 0, 0, 0, &dword_259CB8000, v5, 0, "%@: Couldn't load URL bag to perform lookup: %@", &v22, 22);
...
LABEL_15:
        ...
        v16 = [v15 localizedStringForKey:@"DEFAULT_ERROR_TITLE" value:&stru_286AECDE0 table:0];
        v21 = v16;
