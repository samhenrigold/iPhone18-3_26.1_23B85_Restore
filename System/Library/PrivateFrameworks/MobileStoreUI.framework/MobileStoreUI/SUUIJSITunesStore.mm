...
- (SUUIJSITunesStore)initWithAppContext:(id)context clientContext:(id)clientContext
{
  ...
  v16.receiver = self;
  v16.super_class = SUUIJSITunesStore;
  v8 = [(IKJSITunesStore *)&v16 initWithAppContext:context];
  v9 = v8;
  if (v8)
  {
    ...
    v14 = SUUIMediaPlayerFramework(v12, v13);
    [SUUIWeakLinkedClassForString(&cfstr_Mpmediaquery.isa v14)];
  }
...
- (void)attemptLocalAskToBuyApproval:(id)approval
{
  ...
  v5 = SUUIAskPermissionFramework(approvalCopy, v4);
  v6 = SUUIWeakLinkedClassForString(&cfstr_Prrequestqueue.isa, v5);
  v8 = SUUIAskPermissionFramework(v6, v7);
  v10 = [v6 _requestQueueForIdentifier:{*SUUIWeakLinkedSymbolForString("kPRRequestQueueiTunesStoreIdentifier", v8)}];
...
void __25__SUUIJSITunesStore_buy___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    {
      v6 = v5;
      v7 = [[SUUITonePurchaseController alloc] initWithItem:*(a1 + 32)];
      [(SUUITonePurchaseController *)v7 setClientContext:*(*(a1 + 40) + 96)];
...
- (void)approveInPerson:(id)person :(id)a4
{
  ...
  v14 = SUUIAskPermissionFramework(v12, v13);
  v15 = SUUIWeakLinkedClassForString(&cfstr_Prrequestqueue.isa, v14);
  v17 = SUUIAskPermissionFramework(v15, v16);
  v18 = *SUUIWeakLinkedSymbolForString("kPRRequestQueueiTunesStoreIdentifier", v17);
  v19 = [v15 _requestQueueForIdentifier:v18];
  longLongValue = [personCopy longLongValue];
  v25[0] = MEMORY[0x277D85DD0];
  v25[1] = 3221225472;
  v25[2] = __38__SUUIJSITunesStore_approveInPerson::__block_invoke;
  v25[3] = &unk_2798FB830;
  v26 = appContext;
  v27 = v9;
  v28 = personCopy;
...
void __38__SUUIJSITunesStore_approveInPerson::__block_invoke(uint64_t a1, uint64_t a2, char a3)
{
  ...
  v11[1] = 3221225472;
  v11[2] = __38__SUUIJSITunesStore_approveInPerson::__block_invoke_2;
  v11[3] = &unk_2798FB808;
  v5 = (a1 + 64);
  v6 = *(a1 + 32);
  v7 = *(a1 + 40);
...
- (void)clearToggleStateItems
{
  v2 = +[SUUIToggleStateCenter defaultCenter];
  [v2 clearAll];
}
...
void __40__SUUIJSITunesStore_downloadExistsFor::__block_invoke(uint64_t a1, void *a2)
{
  ...
  v16[0] = MEMORY[0x277D85DD0];
  v16[1] = 3221225472;
  v16[2] = __40__SUUIJSITunesStore_downloadExistsFor::__block_invoke_2;
  v16[3] = &unk_2798FB858;
  v5 = *(a1 + 64);
  v16[4] = &v17;
  v16[5] = v5;
...
void __32__SUUIJSITunesStore_findApps_::__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        {
          v14 = [[SUUILibraryItemState alloc] initWithApplication:v11];
          v15 = [(SUUILibraryItemState *)v14 newJavaScriptRepresentation];
          ...
          if (v16)
          {
            ...
            v18 = v8;
            v20 = v19 = v5;
            [v15 setObject:v20 forKey:0x286AF1240];
  ...
  v30[1] = 3221225472;
  v30[2] = __32__SUUIJSITunesStore_findApps_::__block_invoke_2;
  v30[3] = &unk_2798FA7E8;
  v21 = *(v25 + 32);
  v31 = *(v25 + 40);
  v32 = v29;
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v17 = v16;
        v18 = -[SUUIStoreIdentifier initWithLongLong:]([SUUIStoreIdentifier alloc], "initWithLongLong:", [v16 longLongValue]);
        if (v18)
        {
...
void __37__SUUIJSITunesStore_getAdminStatus::__block_invoke(uint64_t a1, unsigned __int8 a2, void *a3)
{
  if (a3)
  {
    v5 = [a3 userInfo];
    ...
    {
      v7 = +[SUUIMediaSocialAdminPermissionsCoordinator sharedCoordinator];
...
void __44__SUUIJSITunesStore_getProfilePermissions::__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    {
      v10 = +[SUUIMediaSocialAdminPermissionsCoordinator sharedCoordinator];
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v18 = [[SUUIJSMediaSocialAuthor alloc] initWithSUUIMediaSocialAuthor:*(*(&v28 + 1) + 8 * v17)];
        [v12 addObject:v18];
...
void __41__SUUIJSITunesStore_isRemovedSystemApp::__block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      v27 = v5;
      v12 = v10;
      v13 = _os_log_send_and_compose_impl(v8, 0, 0, 0, &dword_259CB8000, v9, 0, "[%@] Error check for removed system app %@ %@", &v22, 32);
...
LABEL_13:
  v17[0] = MEMORY[0x277D85DD0];
  v17[1] = 3221225472;
  v17[2] = __41__SUUIJSITunesStore_isRemovedSystemApp::__block_invoke_211;
  v17[3] = &unk_2798F8678;
  v14 = *(a1 + 48);
  v18 = *(a1 + 56);
  v21 = a2;
...
void __41__SUUIJSITunesStore_isRemovedSystemApp::__block_invoke_211(uint64_t a1)
{
  v6[1] = *MEMORY[0x277D85DE8];
  v2 = [*(a1 + 32) value];
  v3 = [MEMORY[0x277CCABB0] numberWithBool:*(a1 + 56)];
...
void __47__SUUIJSITunesStore_launchICloudFamilySettings__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    {
      v5 = v3;
      v6 = SUUIFamilyCircleFramework(v3, v4);
      v7 = objc_alloc_init(SUUIWeakLinkedClassForString(&cfstr_Fafamilysettin.isa, v6));
      if (objc_opt_respondsToSelector())
      {
...
- (SUUIJSAppleAccount)primaryAppleAccount
{
  v2 = SUUIAccountsFramework(self, a2);
...
LABEL_13:
  v17[0] = MEMORY[0x277D85DD0];
  v17[1] = 3221225472;
  v17[2] = __46__SUUIJSITunesStore_restoreRemovedSystemApp::__block_invoke_232;
  v17[3] = &unk_2798F8678;
  v14 = *(a1 + 48);
  v18 = *(a1 + 56);
  v21 = a2;
...
void __46__SUUIJSITunesStore_restoreRemovedSystemApp::__block_invoke_232(uint64_t a1)
{
  v6[1] = *MEMORY[0x277D85DE8];
  v2 = [*(a1 + 32) value];
  v3 = [MEMORY[0x277CCABB0] numberWithBool:*(a1 + 56)];
...
void __33__SUUIJSITunesStore_loadRentals___block_invoke(id *a1, uint64_t a2)
{
  v3 = SUUIMediaPlayerFramework(a1, a2);
  v4 = [SUUIWeakLinkedClassForString(&cfstr_Mpmediaquery.isa v3)];
  v6 = SUUIMediaPlayerFramework(v4, v5);
  v7 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalExpirationDate", v6);
  v9 = SUUIMediaPlayerFramework(v7, v8);
  v10 = SUUIWeakLinkedClassForString(&cfstr_Mpmediapropert.isa, v9);
  ...
  v18[0] = MEMORY[0x277D85DD0];
  v18[1] = 3221225472;
  v18[2] = __33__SUUIJSITunesStore_loadRentals___block_invoke_2;
  v18[3] = &unk_2798FB968;
...
void __33__SUUIJSITunesStore_loadRental::__block_invoke(uint64_t a1, uint64_t a2)
{
  v24[1] = *MEMORY[0x277D85DE8];
  v3 = SUUIMediaPlayerFramework(a1, a2);
  v4 = [SUUIWeakLinkedClassForString(&cfstr_Mpmediaquery.isa v3)];
  v6 = SUUIMediaPlayerFramework(v4, v5);
  v7 = SUUIWeakLinkedClassForString(&cfstr_Mpmediapropert.isa, v6);
  v9 = SUUIMediaPlayerFramework(v7, v8);
  v10 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyStoreID", v9);
  ...
  v20[1] = 3221225472;
  v20[2] = __33__SUUIJSITunesStore_loadRental::__block_invoke_2;
  v20[3] = &unk_2798FB968;
    ...
    do
    {
      ...
      do
      {
        ...
        if ([v8 isRental])
        {
          ...
          v12 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalStartDate", v11);
          v14 = SUUIMediaPlayerFramework(v12, v13);
          v15 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalPeriod", v14);
          v17 = SUUIMediaPlayerFramework(v15, v16);
          v18 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalPlaybackStartDate", v17);
          v20 = SUUIMediaPlayerFramework(v18, v19);
          v97 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalPlaybackPeriod", v20);
          v22 = SUUIMediaPlayerFramework(v97, v21);
          v92 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyStoreID", v22);
          ...
          v27 = SUUIMediaPlayerFramework(v25, v26);
          v90 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyFilePath", v27);
          v28 = [v8 valueForProperty:?];
          v30 = SUUIMediaPlayerFramework(v28, v29);
          v31 = [SUUIWeakLinkedClassForString(&cfstr_Mpstoredownloa.isa v30)];
          ...
          if (v33)
          {
            v35 = SUUICelestialFramework(v33, v34);
            v36 = [SUUIWeakLinkedClassForString(&cfstr_Avfileprocesso_3.isa v35)];
          ...
          else
          {
            ...
            v40 = SUUIMediaPlayerFramework(dictionary, v39);
            v41 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalPlaybackStartTime", v40);
            v43 = SUUIMediaPlayerFramework(v41, v42);
            v44 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalPlaybackDuration", v43);
            v46 = SUUIMediaPlayerFramework(v44, v45);
            v47 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalStartTime", v46);
            v49 = SUUIMediaPlayerFramework(v47, v48);
            v50 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalDuration", v49);
            v86 = v41;
            v51 = [v8 valueForProperty:v41];
            if (([v51 isEqualToNumber:&unk_286BBE2F8] & 1) == 0)
            {
            ...
            if (([v56 isEqualToNumber:&unk_286BBE2F8] & 1) == 0)
            {
    ...
    if (v10)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          if (!v14)
          {
            v25 = [v7 callWithArguments:&unk_286BBE0E8];
            goto LABEL_12;
          }
...
LABEL_12:
  ...
  {
    v26 = [v7 callWithArguments:&unk_286BBE0D0];
  }
}
...
- (void)fetchMSOProviderStatus:(id)status
{
  ...
  v11 = SUUIVideoSubscriberAccountFramework(v9, v10);
  v12 = [SUUIWeakLinkedClassForString(&cfstr_Vsaccountchann.isa v11)];
  v16[0] = MEMORY[0x277D85DD0];
  v16[1] = 3221225472;
  v16[2] = __44__SUUIJSITunesStore_fetchMSOProviderStatus___block_invoke;
  v16[3] = &unk_2798FBA30;
  v17 = appContext;
  v18 = v6;
  v19 = virtualMachine;
...
void __56__SUUIJSITunesStore__displayWifiConnectionRequiredAlert__block_invoke()
{
  ...
  if (v0)
  {
    v3 = @"PENDING_RENTAL_NETWORK_ERROR_MESSAGE_WLAN_ONLY";
  }

  else
  {
    v3 = @"PENDING_RENTAL_NETWORK_ERROR_MESSAGE_WIFI_ONLY";
  }

  if (v0)
  {
    v4 = @"PENDING_RENTAL_NETWORK_ERROR_TITLE_WLAN_ONLY";
  }

  else
  {
    v4 = @"PENDING_RENTAL_NETWORK_ERROR_TITLE_WIFI_ONLY";
  }

  v5 = [v1 localizedStringForKey:v3 value:&stru_286AECDE0 table:0];
  [v10 setMessage:v5];

  v6 = SUUIBundle();
  v7 = [v6 localizedStringForKey:v4 value:&stru_286AECDE0 table:0];
  [v10 setTitle:v7];

  v8 = SUUIBundle();
  v9 = [v8 localizedStringForKey:@"OK" value:&stru_286AECDE0 table:0];
  [v10 addButtonWithTitle:v9];
