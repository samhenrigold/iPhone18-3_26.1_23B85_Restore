...
- (void)willAppearInContext:(id)context
{
    ...
    if (v21)
    {
      ...
      do
      {
        for (i = 0; i != v22; ++i)
        {
          ...
          [(objc_class *)[(SUUICarouselPageSection *)self _cellClassForViewElement:*(*(&v61 + 1) + 8 * i)] preferredSizeForViewElement:*(*(&v61 + 1) + 8 * i) context:self->_cellLayoutContext];
          v26.f64[1] = v25;
    ...
    if (v28)
    {
      ...
      do
      {
        for (j = 0; j != v29; ++j)
        {
          ...
          [(objc_class *)[(SUUICarouselPageSection *)self _cellClassForViewElement:*(*(&v57 + 1) + 8 * j)] requestLayoutForViewElement:*(*(&v57 + 1) + 8 * j) width:self->_cellLayoutContext context:self->_itemSize.width];
        }
  ...
  if (v39)
  {
    ...
    if (v47)
    {
      ...
      {
        [(SUUICarouselPageSection *)self _scrollToItemAtIndexPath:v47 animated:0];
      }
    }
  }
  ...
  v56.receiver = self;
  v56.super_class = SUUICarouselPageSection;
  [(SUUIStorePageSection *)&v56 willAppearInContext:contextCopy];
}
...
- (id)_carouselCollectionView
{
  ...
  if (!carouselCollectionView)
  {
    ...
    v12 = [(SUUICarouselPageSection *)self backgroundColorForIndexPath:v10];
