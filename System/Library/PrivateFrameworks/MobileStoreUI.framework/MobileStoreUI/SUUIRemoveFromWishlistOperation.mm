...
- (SUUIRemoveFromWishlistOperation)initWithItemIdentifier:(int64_t)identifier entityIdentifier:(int64_t)entityIdentifier reason:(int64_t)reason;
- (void)main;
@end
...
{
  v9.receiver = self;
  v9.super_class = SUUIRemoveFromWishlistOperation;
...
- (void)main
{
  ...
  if (v11)
  {
    ...
    *(&v44 + 4) = itemID;
    v13 = _os_log_send_and_compose_impl(v11, 0, 0, 0, &dword_259CB8000, oSLogObject, 2, "[Wishlist]: Removing wishlist ID: %lld", &v44);
  ...
  *(&v44 + 1) = &v44;
  ...
  v37[1] = 3221225472;
  v37[2] = __39__SUUIRemoveFromWishlistOperation_main__block_invoke;
  v37[3] = &unk_2798F82D8;
  v39 = &v44;
  v16 = v15;
  v38 = v16;
  [(SUUIURLConnectionRequest *)v6 startWithConnectionResponseBlock:v37];
...
LABEL_26:
    ...
    if (v25)
    {
      ...
      v42 = 2048;
      v43 = v26;
      v28 = _os_log_send_and_compose_impl(v25, 0, 0, 0, &dword_259CB8000, v23, 2, "[Wishlist]: Received status: %ld when removing wishlist ID: %lld", &v40, 22);
...
LABEL_24:
    if (v27 <= 1)
    {
      ...
      v36[1] = 3221225472;
      v36[2] = __39__SUUIRemoveFromWishlistOperation_main__block_invoke_30;
      v36[3] = &unk_2798F8300;
      v36[4] = self;
