...
- (void)dealloc
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SUUIStorePageSectionsViewController *)self _unregisterForNotificationsForEntityProvider:*(*(&v12 + 1) + 8 * v9++)];
      }
  ...
  {
    [(SUUIStorePageSectionsViewController *)self unregisterPreviewing:?];
  ...
  if (self->_ignoreSectionsChangeCount < 1)
  {
    if (self->_splitsDescription != descriptionCopy)
    {
      ...
      *(&self->super.super.super.super.isa + v31) = v18;
      ...
      v20 = [(SUUIStorePageSplitsDescription *)v6 copy];
      ...
      {
        [(SUUILayoutCache *)self->_textLayoutCache setDelegate:0, v31];
        textLayoutCache = self->_textLayoutCache;
        self->_textLayoutCache = 0;
      }
...
- (void)showOverlayWithProductPage:(id)page metricsPageEvent:(id)event
{
  ...
  v7 = [[SUUIProductPageOverlayController alloc] initWithParentViewController:self];
  overlayController = self->_overlayController;
...
- (void)loadView
{
  ...
  if (self->_stackedBar)
  {
    ...
    [(SUUIStackedBar *)self->_stackedBar setFrame:v8, v11, v10, 0.0];
...
- (void)viewDidAppear:(BOOL)appear
{
  ...
  if (initialOverlayURLs)
  {
    if (!self->_overlayController)
    {
      v6 = [[SUUIProductPageOverlayController alloc] initWithParentViewController:self];
      overlayController = self->_overlayController;
...
LABEL_10:
  ...
  v11 = [(SUUICollectionView *)self->_collectionView cellForItemAtIndexPath:indexPathOfEditedCell];
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v12; ++i)
        {
          ...
          v17 = [(SUUIStorePageSectionsViewController *)self defaultSectionForComponent:*(*(&v22 + 1) + 8 * i)];
          v18 = v17;
          if (v17)
          {
...
- (void)_handleTap:(id)tap
{
  if (self->_indexPathOfEditedCell)
  {
    v3 = [(SUUICollectionView *)self->_collectionView cellForItemAtIndexPath:?];
...
void __80__SUUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke(uint64_t a1)
{
  ...
  if ([v3 count])
  {
    ...
    v10 = 3221225472;
    v11 = __80__SUUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke_2;
    v12 = &unk_2798F70E0;
    v13 = v3;
    v14 = v2;
    v15 = v5;
...
- (void)_invalidateIfLastKnownWidthChanged
{
  if (self->_lastKnownWidth)
  {
    ...
    if (floor(v5) != v9)
    {
      [(SUUIStorePageSectionsViewController *)self _invalidateLayoutWithNewSize:0 transitionCoordinator:v5, v7];
    }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = [(SUUIStorePageSectionsViewController *)self _newSectionsWithPageComponent:*(*(&v13 + 1) + 8 * v10), v13];
...
- (void)_updateCollectionViewWithUpdates:(id)updates
{
  ...
  if ([(SUUIStorePageSectionsViewController *)self isViewLoaded:v15])
  {
    overlayController = self->_overlayController;
