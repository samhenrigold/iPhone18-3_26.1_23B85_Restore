...
- (AAAccountUserNotificationDaemonConnection)initWithListenerEndpoint:(id)endpoint;
- (id)_connection;
...
- (AAAccountUserNotificationDaemonConnection)initWithListenerEndpoint:(id)endpoint
{
  ...
  v9.receiver = self;
  v9.super_class = AAAccountUserNotificationDaemonConnection;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = AAAccountUserNotificationDaemonConnection;
  [(AAAccountUserNotificationDaemonConnection *)&v5 dealloc];
}
...
- (id)remoteObjectProxyWithErrorHandler:(id)handler
{
  ...
  if (!handlerCopy)
  {
    [(AAAccountUserNotificationDaemonConnection *)a2 remoteObjectProxyWithErrorHandler:?];
  }

  _connection = [(AAAccountUserNotificationDaemonConnection *)self _connection];
...
- (id)synchronousRemoteObjectProxyWithErrorHandler:(id)handler
{
  ...
  if (!handlerCopy)
  {
    [(AAAccountUserNotificationDaemonConnection *)a2 synchronousRemoteObjectProxyWithErrorHandler:?];
  }
...
- (id)_connection
{
  ...
  v3 = __56__AAAccountUserNotificationDaemonConnection__connection__block_invoke(v5);
...
id __56__AAAccountUserNotificationDaemonConnection__connection__block_invoke(uint64_t a1)
{
  ...
  if (!v3)
  {
    ...
    {
      v6 = [v5 initWithMachServiceName:@"com.apple.aa.usernotifications.xpc" options:0];
    }
...
- (void)_connectionInterruptionHandler
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    [(AAAccountUserNotificationDaemonConnection *)v3 _connectionInterruptionHandler:v4];
  }

  v11[0] = MEMORY[0x1E69E9820];
  v11[1] = 3221225472;
  v11[2] = __75__AAAccountUserNotificationDaemonConnection__connectionInterruptionHandler__block_invoke;
  v11[3] = &unk_1E7C9A868;
  v11[4] = self;
  os_unfair_lock_lock(&self->_unfairLock);
  __75__AAAccountUserNotificationDaemonConnection__connectionInterruptionHandler__block_invoke(v11);
  os_unfair_lock_unlock(&self->_unfairLock);
}
...
- (void)_connectionInvalidationHandler
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    [(AAAccountUserNotificationDaemonConnection *)v3 _connectionInvalidationHandler:v4];
  }

  v11[0] = MEMORY[0x1E69E9820];
  v11[1] = 3221225472;
  v11[2] = __75__AAAccountUserNotificationDaemonConnection__connectionInvalidationHandler__block_invoke;
  v11[3] = &unk_1E7C9A868;
  v11[4] = self;
  os_unfair_lock_lock(&self->_unfairLock);
  __75__AAAccountUserNotificationDaemonConnection__connectionInvalidationHandler__block_invoke(v11);
  os_unfair_lock_unlock(&self->_unfairLock);
}
...
- (void)remoteObjectProxyWithErrorHandler:(uint64_t)a1 .cold.1(uint64_t a1, uint64_t a2)
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"AAAccountUserNotificationDaemonConnection.m" lineNumber:52 description:{@"Invalid parameter not satisfying: %@", @"handler"}];
}

- (void)synchronousRemoteObjectProxyWithErrorHandler:(uint64_t)a1 .cold.1(uint64_t a1, uint64_t a2)
{
  v4 = [MEMORY[0x1E696AAA8] currentHandler];
  [v4 handleFailureInMethod:a1 object:a2 file:@"AAAccountUserNotificationDaemonConnection.m" lineNumber:57 description:{@"Invalid parameter not satisfying: %@", @"handler"}];
}
