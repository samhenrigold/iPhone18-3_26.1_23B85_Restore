...
- (id)rem_store
{
  ...
  rem_storeProvider = [v1 rem_storeProvider];
  ...
  if (!rem_storeForDataAccess)
  {
    ...
    if (os_log_type_enabled(v4, v5))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_2424DF000, v4, v5, "Couldn't get an REMStore from %{public}@.", &v9, 0xCu);
    }
  }
...
- (id)rem_saveRequest
{
  ...
  if (!rem_saveRequestForDataAccess)
  {
    ...
    if (os_log_type_enabled(v4, v5))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_2424DF000, v4, v5, "Couldn't get an REMSaveRequest from %{public}@.", &v9, 0xCu);
    }
  }
