...
LABEL_15:
      ...
      v24 = *(v21 + 8);
      v25 = *v21;
      result = MEMORY[0x26D69DB90](*(v7 + 40), v22, 4);
      v26 = -1 << *(v7 + 32);
      v27 = result & ~v26;
      v28 = v27 >> 6;
...
LABEL_15:
      ...
      v20 = *(*(v5 + 48) + 8 * v19);
      v21 = *(*(v5 + 56) + 4 * v19);
      result = MEMORY[0x26D69DBA0](*(v7 + 40), v20);
      v22 = -1 << *(v7 + 32);
      v23 = result & ~v22;
      v24 = v23 >> 6;
...
LABEL_15:
      ...
      v27 = *(*(v9 + 56) + 4 * v24);
      _s8Dispatch0A13WorkItemFlagsVACs10SetAlgebraAAWlTm_1(&lazy protocol witness table cache variable for type SHA256Digest and conformance SHA256Digest, MEMORY[0x277CC5290], MEMORY[0x277CC5298]);
...
LABEL_15:
      ...
      v24 = *(v21 + 8);
      v25 = *v21;
      result = MEMORY[0x26D69DBA0](*(v7 + 40), v22);
      v26 = -1 << *(v7 + 32);
      v27 = result & ~v26;
      v28 = v27 >> 6;
      if (((-1 << v27) & ~*(v14 + 8 * (v27 >> 6))) == 0)
...
LABEL_15:
      ...
      v26 = *v23;
      v27 = *(v23 + 8);
      result = MEMORY[0x26D69DBA0](*(v9 + 40), v24);
      v28 = -1 << *(v9 + 32);
      v29 = result & ~v28;
      v30 = v29 >> 6;
...
LABEL_15:
      ...
      v22 = *(*(v7 + 48) + 8 * v21);
      v23 = *(*(v7 + 56) + 4 * v21);
      result = MEMORY[0x26D69DBA0](*(v9 + 40), v22);
      v24 = -1 << *(v9 + 32);
      v25 = result & ~v24;
      v26 = v25 >> 6;
...
uint64_t specialized _NativeDictionary.setValue(_:forKey:isUnique:)(char a1, unint64_t a2, char a3)
{
  v4 = v3;
  v8 = *v3;
...
{
  return specialized _NativeDictionary.setValue(_:forKey:isUnique:)(a1, a2, a3, specialized __RawDictionaryStorage.find<A>(_:), &_ss18_DictionaryStorageCy21SwiftUITracingSupport13TransactionIDVSayAC8EventRefVGGMd, &_ss18_DictionaryStorageCy21SwiftUITracingSupport13TransactionIDVSayAC8EventRefVGGMR, &type metadata for TransactionID);
}
...
unint64_t specialized _NativeDictionary.setValue(_:forKey:isUnique:)(int a1, int a2, char a3)
{
  v4 = v3;
  v8 = *v3;
...
{
  return specialized _NativeDictionary.setValue(_:forKey:isUnique:)(a1, a2, a3, specialized __RawDictionaryStorage.find<A>(_:), &_ss18_DictionaryStorageCy21SwiftUITracingSupport8ActionIDVSayAC8EventRefVGGMd, &_ss18_DictionaryStorageCy21SwiftUITracingSupport8ActionIDVSayAC8EventRefVGGMR, &type metadata for ActionID);
}
...
unint64_t specialized _NativeDictionary.setValue(_:forKey:isUnique:)(int a1, uint64_t a2, uint64_t a3, char a4, uint64_t (*a5)(uint64_t, uint64_t), uint64_t *a6, uint64_t *a7, uint64_t a8)
{
  v12 = v8;
  v17 = *v8;
  result = a5(a2, a3);
...
LABEL_8:
  ...
  else
  {
    ...
    return specialized _NativeDictionary._insert(at:key:value:)(result, v13 | (v12 << 32), a1, a2, v8, v24);
  }
...
unint64_t specialized _NativeDictionary.setValue(_:forKey:isUnique:)(uint64_t a1, int a2, char a3)
{
  v4 = v3;
  v8 = *v3;
  result = specialized __RawDictionaryStorage.find<A>(_:)();
...
LABEL_11:
  (*(v9 + 16))(v11, a2, v8);
  return specialized _NativeDictionary._insert(at:key:value:)(v14, v11, v7, v20);
}
...
LABEL_8:
  ...
  else
  {
    ...
    return specialized _NativeDictionary._insert(at:key:value:)(result, a3, a1, a2 & 0x1FFFFFFFFLL, v21);
  }
...
{
  v1 = v0;
  v31 = type metadata accessor for SHA256Digest();
  v33 = *(v31 - 8);
...
uint64_t specialized Set._Variant.insert(_:)(void *a1, void *a2)
{
  ...
  if ((*v2 & 0xC000000000000001) != 0)
  {
    ...
    else
    {
      ...
      {
        v19 = _ss10_NativeSetV_8capacityAByxGs07__CocoaB0Vn_SitcfCSo13AGSubgraphRefa_Tt1g5(v7, result + 1);
        v20 = *(v19 + 16);
        if (*(v19 + 24) <= v20)
        {
...
LABEL_15:
      v17 = *(*(v3 + 48) + 8 * (v14 | (v6 << 6)));
      result = MEMORY[0x26D69DBA0](*(v5 + 40), v17);
      v18 = -1 << *(v5 + 32);
      v19 = result & ~v18;
      v20 = v19 >> 6;
      if (((-1 << v19) & ~*(v12 + 8 * (v19 >> 6))) == 0)
...
LABEL_15:
      v17 = *(*(v3 + 48) + 4 * (v14 | (v6 << 6)));
      result = MEMORY[0x26D69DB90](*(v5 + 40), v17, 4);
      v18 = -1 << *(v5 + 32);
      v19 = result & ~v18;
      v20 = v19 >> 6;
      if (((-1 << v19) & ~*(v12 + 8 * (v19 >> 6))) == 0)
