...
- (void)_evaluateSystemEvents
{
  if (self->_isCurrentState)
  {
    ...
    if (isUIBlocked)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because UI blocked ", v17, 2u);
      }
...
LABEL_14:
    ...
    if ((isUILocked & 1) == 0)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because UI unlocked", v17, 2u);
      }
    ...
    if (isInCall)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because in call", v17, 2u);
      }
    ...
    if (isSOSActive)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because SOS active", v17, 2u);
      }
    ...
    if (isLockScreenSearchPresented)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because lock screen search presented", v17, 2u);
      }
    ...
    if (isUsingSecureApp)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because using secure app", v17, 2u);
      }
    ...
    if (isAirplayMirroring)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because airplay mirroring", v17, 2u);
      }
    ...
    if (isUserInitiatedRemoteTransientOverlayPresented)
    {
      ...
      {
        *v17 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because user-initiated remote transient overlay is presented", v17, 2u);
      }
...
- (void)_reevaluateStateForReason:(id)reason
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      v14 = 138543362;
      v15 = v5;
      _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] Re-evaluating state for reason: %{public}@", &v14, 0xCu);
    }
    ...
    {
      [v7 addObject:@"checkpoint.waiting-for-configured-HIDServices"];
    }
    ...
    if (v9)
    {
      if (v11)
      {
        ...
        v14 = 138543362;
        v15 = bs_array;
        _os_log_impl(&dword_21ED4E000, v10, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] still blocked by %{public}@", &v14, 0xCu);
      }
    ...
    else
    {
      ...
      {
        LOWORD(v14) = 0;
        _os_log_impl(&dword_21ED4E000, v10, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .Activating", &v14, 2u);
      }
