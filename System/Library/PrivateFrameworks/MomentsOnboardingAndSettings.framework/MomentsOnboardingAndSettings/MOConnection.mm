...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_1(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  v8 = 2048;
  v9 = [a2 count];
  _os_log_fault_impl(&dword_25A200000, a3, OS_LOG_TYPE_FAULT, "[%s] The connection has been interrupted with %lu pending tasks", &v6, 0x16u);
}
...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  v4 = 136315138;
  v5 = v3;
  _os_log_error_impl(&dword_25A200000, a2, OS_LOG_TYPE_ERROR, "[%s] The connection has been interrupted with zero pending tasks", &v4, 0xCu);
}
