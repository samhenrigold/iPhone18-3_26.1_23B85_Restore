...
void __43__MOConnectionManager__getActiveConnection__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v6 = 138412290;
      v7 = v5;
      _os_log_impl(&dword_25A200000, v4, OS_LOG_TYPE_INFO, "Connection '%@' Invalidated", &v6, 0xCu);
    }
  }
}
...
- (void)_getActiveConnection
{
  ...
  _os_log_error_impl(&dword_25A200000, v0, OS_LOG_TYPE_ERROR, "Can't activate connection '%@': nil delegate", v1, 0xCu);
}
...
- (void)withProxyProvider:proxyHandler:onError:.cold.1()
{
  ...
  v2 = 1024;
  v3 = 210;
  _os_log_error_impl(&dword_25A200000, v0, OS_LOG_TYPE_ERROR, "Should use valid sync proxy block handler (in %s:%d)", v1, 0x12u);
}
...
void __62__MOConnectionManager_withProxyProvider_proxyHandler_onError___block_invoke_cold_1(uint64_t a1, void *a2)
{
  ...
  OUTLINED_FUNCTION_3_0(&dword_25A200000, v6, v7, "%@: proxy error, %@, %@, retrying...", v8, v9, v10, v11);
}
...
void __62__MOConnectionManager_withProxyProvider_proxyHandler_onError___block_invoke_27_cold_1(uint64_t a1, void *a2)
{
  ...
  v5 = [a2 localizedFailureReason];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_3_0(&dword_25A200000, v6, v7, "%@: proxy error, %@, %@.", v8, v9, v10, v11);
}
