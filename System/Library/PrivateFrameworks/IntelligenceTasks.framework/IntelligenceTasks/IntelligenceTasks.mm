uint64_t sub_255426A18()
{
  v0 = sub_255426D18();
  __swift_allocate_value_buffer(v0, qword_27F7B6540);
  __swift_project_value_buffer(v0, qword_27F7B6540);
  return sub_255426D08();
}
...
uint64_t static Logging.Engine.getter@<X0>(uint64_t a1@<X8>)
{
  ...
  v2 = sub_255426D18();
  v3 = __swift_project_value_buffer(v2, qword_27F7B6540);
  v4 = *(*(v2 - 8) + 16);
