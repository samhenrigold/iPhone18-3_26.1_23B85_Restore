...
- (_BKSHIDCGSWindowIDEventDeferringToken)initWithCoder:(id)coder;
- (id)_initWithCGSWindowID:(unsigned int)d;
...
- (void)appendDescriptionToFormatter:(id)formatter
{
  ...
  [(_BKSHIDCGSWindowIDEventDeferringToken *)self _identifierOfCGSWindow];
  v4 = [formatterCopy appendUInt64:? withName:?];
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = objc_opt_class();
    v6 = v5 == objc_opt_class() && self->_CGSWindowID == equalCopy->_CGSWindowID;
  }
...
- (_BKSHIDCGSWindowIDEventDeferringToken)initWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  v15.receiver = self;
  v15.super_class = _BKSHIDCGSWindowIDEventDeferringToken;
...
- (id)initForProtobufDecoding
{
  ...
  v10.receiver = self;
  v10.super_class = _BKSHIDCGSWindowIDEventDeferringToken;
