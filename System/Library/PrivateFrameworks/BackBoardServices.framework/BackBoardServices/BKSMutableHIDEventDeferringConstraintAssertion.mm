  ...
  if (!basisCopy)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544642;
      ...
      selfCopy2 = self;
      v30 = 2114;
      v31 = @"BKSHIDEventDeferringConstraintAssertion.m";
      v32 = 1024;
      v33 = 235;
      v34 = 2114;
      v35 = v11;
...
- (void)setConstraint:(id)constraint
{
  ...
  if (!constraintCopy)
  {
    ...
    v9 = objc_opt_class();
    v10 = NSStringFromClass(v9);
    v11 = [v8 stringWithFormat:@"constraint", v10];
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    v18 = objc_opt_class();
    v19 = NSStringFromClass(v18);
    v20 = [v15 stringWithFormat:@"constraint", v17, v19];
  ...
  else
  {
    ...
    if (v6 != identifierCopy)
    {
      ...
      if (os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
      {
        ...
        selfCopy = self;
        v18 = 2114;
        v19 = @"BKSHIDEventDeferringConstraintAssertion.m";
        v20 = 1024;
        v21 = 217;
        v22 = 2114;
        v23 = v8;
