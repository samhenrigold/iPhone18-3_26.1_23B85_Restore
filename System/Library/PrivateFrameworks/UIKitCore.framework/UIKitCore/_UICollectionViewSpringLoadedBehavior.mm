...
- (BOOL)shouldAllowInteraction:(id)interaction withContext:(id)context
{
  ...
  v8 = [view _indexPathForItemAtPoint:?];
  v9 = [view _cellForItemAtIndexPath:v8];
  v10 = v9;
...
LABEL_5:
  ...
  if (![view _shouldSpringLoadItemAtIndexPath:v8 withContext:contextCopy])
  {
    goto LABEL_13;
  }
  ...
  if ((v16 & 1) == 0 || ([view _delegateProxy], v17 = objc_claimAutoreleasedReturnValue(), v18 = objc_msgSend(v17, "collectionView:shouldHighlightItemAtIndexPath:", view, v8), v17, v18))
  {
