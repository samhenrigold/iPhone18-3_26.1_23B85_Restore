  ...
  if (WeakRetained)
  {
    ...
    if (v3)
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 2112;
        v18 = v3;
        _os_log_impl(&dword_22D12F000, v8, OS_LOG_TYPE_ERROR, "%{public}@Removing faceprints:%@ failed with error:%@", &v13, 0x20u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v12 = [v6 faceprintUUIDs];
        v13 = 138543618;
        v14 = v11;
        v15 = 2112;
        v16 = v12;
        _os_log_impl(&dword_22D12F000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing faceprints:%@ completed successfully", &v13, 0x16u);
      }
