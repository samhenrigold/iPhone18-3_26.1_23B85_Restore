...
- (void)mergeFrom:(id)from
{
  ...
  {
    [(SIRINLUINTERNALMENTION_DETECTORMentionDetectorResponse *)self setRequestId:?];
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(SIRINLUINTERNALMENTION_DETECTORMentionDetectorResponse *)self addMentions:*(*(&v12 + 1) + 8 * i), v12];
      }
