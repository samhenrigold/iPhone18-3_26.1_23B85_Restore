void sub_10000C7B8(char **result, uint64_t a2, char *a3, uint64_t *a4, char a5)
{
  v10 = a4[6];
  v11 = a4[1] - *a4;
...
void sub_10000D1CC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, ...)
{
  va_start(va, a16);
  sub_100005568(va);
  sub_10000E398((v16 - 144));
  _Unwind_Resume(a1);
}
...
uint64_t sub_10000EA90(uint64_t a1, unsigned __int8 **a2, int a3)
{
...
LABEL_34:
  ...
  *v270 = v25;
  *&v270[16] = v25;
  sub_100002670(v270, "(\\d{4})-(\\d{2})-(\\d{2})-(\\d{2})-(\\d{2})-(\\d{2})-(\\d{3})", 0);
  v26 = a5 == 0;
  v27 = strlen(this);
...
LABEL_42:
  ...
  *(v28 + v29) = 0;
  ...
  v267 = *(&v273 + 1);
  v31 = sub_1000018B8(__p, &v262, &v275, 0);
  v32 = v266;
...
LABEL_52:
  ...
  sub_1000158E4(v275, v276, __dst, v35, 1);
  v260[0] = 0;
  v260[1] = 0;
  v261 = 0;
  v36 = v275;
...
LABEL_187:
    ...
    *(&__dst[0].st_rdev + 1) = 0uLL;
    v49 = sub_10000C4AC(v270, v47, &v48[v47], __dst, 0);
    v50 = HIBYTE(v259[2]);
    if (SHIBYTE(v259[2]) >= 0)
    {
      v51 = v259;
    ...
    sub_10000C7B8(v299, v51, &v50[v51], &__dst[0].st_dev, 0);
    v33 = a6;
    if (*&__dst[0].st_dev)
    {
...
LABEL_197:
    sub_1000020AC(v290, v257[0], v257[1]);
LABEL_198:
    ...
    v289 = *(&v293 + 1);
    v102 = sub_1000018B8(v290, &v284, &v294, 0);
    v103 = v288;
...
LABEL_204:
    ...
    if (SHIBYTE(v258) < 0)
    {
      sub_1000020AC(v281, v257[0], v257[1]);
    }
    ...
    *&__dst[0].st_uid = v298;
    do
    {
      ...
      sub_1000020AC(v109, *v106, v106[1]);
      v111 = v298[0];
      v106 += 3;
      v109 = v298[0] + 24;
      v298[0] = v298[0] + 24;
...
LABEL_217:
    ...
    while (1)
    {
      ...
      if (v112[47] < 0)
      {
        sub_1000020AC(buf, *(v112 + 3), *(v112 + 4));
      }
...
LABEL_459:
    ...
    *&__dst[0].st_birthtimespec.tv_nsec = v191;
    ...
    __dst[0].st_blocks = 0;
    memset(__dst, 0, 41);
    v194 = sub_10000C4AC(&v247, v192, &v193[v192], __dst, 0x1040u);
    sub_10000C7B8(v299, v192, &v193[v192], &__dst[0].st_dev, 0);
    if (*&__dst[0].st_dev)
    {
      __dst[0].st_ino = *&__dst[0].st_dev;
      operator delete(*&__dst[0].st_dev);
...
LABEL_487:
    ...
    sub_100012E6C(v292, &__dst[0].st_gid);
...
LABEL_521:
        ...
        v213[v212] = 0;
LABEL_533:
        sub_100012E6C(v292, &__dst[0].st_uid);
        if ((v292[23] & 0x80000000) != 0)
        {
          operator delete(*v292);
          --__dst[0].st_uid;
...
LABEL_549:
              ...
              v223[v222] = 0;
LABEL_561:
              sub_100012E6C(v292, &__dst[0].st_ino);
              if ((v292[23] & 0x80000000) != 0)
              {
                operator delete(*v292);
                if (v198[136] == 1)
...
LABEL_563:
                ...
                v228[v227] = 0;
LABEL_575:
                sub_100012E6C(v292, &__dst[0].st_mode);
                if ((v292[23] & 0x80000000) != 0)
                {
                  operator delete(*v292);
                  if (v198[160] == 1)
...
__n128 sub_1000158E4(char *a1, const void **a2, uint64_t a3, uint64_t a4, char a5)
{
LABEL_1:
  v9 = a1;
LABEL_2:
...
LABEL_10:
    ...
    else
    {
      ...
      sub_100015D88((a1 + 48), &a1[v16 + 24], a2 - 9);
      sub_100015D88(v17, v15, &a1[v16 + 24]);
      v18 = *a1;
      v19 = *(a1 + 8);
      v20 = *v15;
      *(a1 + 2) = *(v15 + 16);
...
LABEL_35:
    ...
    {
LABEL_38:
      result.n128_u64[0] = sub_1000158E4(a1, v29, a3, -v11, a5 & 1).n128_u64[0];
      v9 = (v29 + 3);
LABEL_40:
      a5 = 0;
      a4 = -v11;
