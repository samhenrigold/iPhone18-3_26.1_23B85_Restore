...
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)data root:(const RepeatedItnAlignment *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (NSArray)itn_alignment
{
  array = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"itn_alignment"];
  if (!array)
  {
    ...
    [(NSMutableDictionary *)self->_storage setObject:array forKeyedSubscript:@"itn_alignment"];
  }
