...
- (QSSTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)data root:(const TextToSpeechSpeechFeatureInputWord *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (QSSTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)data root:(const TextToSpeechSpeechFeatureInputWord *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v29.receiver = self;
  v29.super_class = QSSTextToSpeechSpeechFeatureInputWord;
  v10 = [(QSSTextToSpeechSpeechFeatureInputWord *)&v29 init];
  v11 = v10;
  if (v10)
  {
