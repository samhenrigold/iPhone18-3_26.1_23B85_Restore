...
char *pg_query_raw_parse(uint64_t a1, uint64_t a2)
{
  ...
  *v3 = 0;
  ...
  if (sigsetjmp(v17, 0))
  {
    ...
    *v6 = v7;
    v14 = CopyErrorData();
    v15 = malloc_type_malloc(0x28uLL, 0x1010040E871EB1AuLL);
    *v15 = strdup(*(v14 + 64));
    v15[2] = strdup(*(v14 + 16));
    v15[1] = strdup(*(v14 + 32));
    v15[4] = 0;
...
uint64_t pg_query_parse@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  ...
  *(a2 + 8) = v8;
  nodes_to_json = pg_query_nodes_to_json(v7, *&v8);
...
uint64_t pg_query_parse_protobuf@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  ...
  pg_query_raw_parse(a1, v4);
  *(a2 + 16) = v9;
  *a2 = pg_query_nodes_to_protobuf(v8, v5);
  *(a2 + 8) = v6;
