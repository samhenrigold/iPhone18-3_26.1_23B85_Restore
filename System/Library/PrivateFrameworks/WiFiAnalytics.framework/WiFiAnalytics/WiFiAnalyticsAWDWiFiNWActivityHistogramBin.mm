...
- (id)description
{
  ...
  dictionaryRepresentation = [(WiFiAnalyticsAWDWiFiNWActivityHistogramBin *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSString *)self->_bin copyWithZone:zone];
  v7 = *(v5 + 16);
  *(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) != 0 && self->_hits == *(equalCopy + 1))
    {
      v6 = 1;
      goto LABEL_9;
    }
