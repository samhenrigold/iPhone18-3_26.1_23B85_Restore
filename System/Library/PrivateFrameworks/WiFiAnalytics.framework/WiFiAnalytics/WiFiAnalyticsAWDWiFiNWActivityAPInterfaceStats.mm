  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addPackets:*(*(&v74 + 1) + 8 * i)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addBytes:*(*(&v70 + 1) + 8 * j)];
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (k = 0; k != v17; ++k)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addNpeers:*(*(&v66 + 1) + 8 * k)];
      }
  ...
  if (v22)
  {
    ...
    do
    {
      for (m = 0; m != v23; ++m)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addEnableState:*(*(&v62 + 1) + 8 * m)];
      }
  ...
  if (v27)
  {
    ...
    do
    {
      for (n = 0; n != v28; ++n)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addTxLatencyBK:*(*(&v58 + 1) + 8 * n)];
      }
  ...
  if (v32)
  {
    ...
    do
    {
      for (ii = 0; ii != v33; ++ii)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addTxLatencyBE:*(*(&v54 + 1) + 8 * ii)];
      }
  ...
  if (v37)
  {
    ...
    do
    {
      for (jj = 0; jj != v38; ++jj)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addTxLatencyVO:*(*(&v50 + 1) + 8 * jj)];
      }
  ...
  if (v42)
  {
    ...
    do
    {
      for (kk = 0; kk != v43; ++kk)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityAPInterfaceStats *)self addTxLatencyVI:*(*(&v46 + 1) + 8 * kk), v46];
      }
