...
BOOL mlir::function_interface_impl::verifyTrait<mlir::mpsx::CPUOp>(uint64_t *a1)
{
...
BOOL mlir::OpTrait::HasParent<mlir::mpsx::FusionOp>::Impl<mlir::mpsx::FusionReturnOp>::verifyTrait(uint64_t a1)
{
...
uint64_t mlir::InFlightDiagnostic::operator<<<llvm::ArrayRef<llvm::StringLiteral>>(uint64_t a1, const char ***a2)
{
  if (*a1)
  {
    v3 = a2[1];
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::mpsx::ListPopBackOp>::refineReturnTypes(uint64_t a1, uint64_t a2, char a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  ...
  v20[1] = *(v20[0] + 8);
  LODWORD(v19) = 2;
  mlir::ValueRange::ValueRange(v17, v20, 2uLL);
  mlir::ValueRange::ValueRange(v16, *a11, *(a11 + 8));
  v21 = &unk_1F1A17650;
  v23 = &v21;
  if (v23 == &v21)
...
uint64_t mlir::Op<mlir::mpsx::MemrefBackedOp,mlir::OpTrait::OneRegion,mlir::OpTrait::ZeroResults,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::VariadicOperands,mlir::OpTrait::OpInvariants,mlir::OpTrait::RegionOp>::verifyInvariants(uint64_t *a1, mlir::Operation *a2)
{
