...
uint64_t foldLoopBounds(mlir::affine::AffineForOp)::$_0::operator()(uint64_t **a1, int a2)
{
  ...
  do
  {
    ...
    if (DefiningOp)
    {
      mlir::detail::constant_op_binder<mlir::Attribute>::match(&v38, DefiningOp);
    }
...
LABEL_17:
  ...
  {
    v47 = *v41;
    mlir::IntegerAttr::getValue(&v47, &v38);
    if (v42 >= 2)
    {
      v17 = 8 * v42;
      v18 = 8;
      if ((v2 & 1) == 0)
      {
        while (1)
        {
          ...
          v22 = llvm::APInt::compareSigned(&v38, &v47);
          if (v22 >= 0)
          {
            v23 = &v47;
          }
          ...
          {
LABEL_47:
            llvm::APInt::assignSlowCase(&v38, v23);
            if (v48 >= 0x41)
            {
LABEL_48:
              if (v47)
      ...
      do
      {
        v37 = *(v41 + v18);
        mlir::IntegerAttr::getValue(&v37, &v47);
        v19 = llvm::APInt::compareSigned(&v38, &v47);
        if (v19 <= 0)
        {
          v20 = &v47;
        }
        ...
        {
LABEL_34:
          llvm::APInt::assignSlowCase(&v38, v20);
          if (v48 >= 0x41)
          {
LABEL_35:
            if (v47)
  ...
  if (a3)
  {
    ...
    if (v24)
    {
      ...
      for (i = 8 * v24; i; i -= 8)
      {
        ...
        {
          ZinMirValidateMirInfo::ZinMirValidateMirInfo(&v94, v29);
          if (!v94)
          {
            goto LABEL_26;
          }
        ...
        {
          ZinMirValidateMirInfo::ZinMirValidateMirInfo(&v94, 0);
          if (!v94)
          {
LABEL_26:
        ...
        do
        {
          ...
          if (*(v100 + 16 * v53 + 8) == 1)
          {
            ...
            if (*(v56 + 8) == 1)
            {
              ...
              if (v57 == *v56)
              {
                Context = mlir::AffineExpr::getContext(&v93);
                AffineConstantExpr = mlir::getAffineConstantExpr(v57, Context, v59);
        ...
        do
        {
          ...
          if (*(v100 + 16 * v70 + 8) == 1)
          {
            ...
            if (*(v73 + 8) == 1)
            {
              ...
              if (v74 == *v73)
              {
                v75 = mlir::AffineExpr::getContext(&v93);
...
uint64_t mlir::affine::AffineDmaStartOp::getAffineMapAttrForMemRef(uint64_t *a1, uint64_t a2)
{
  ...
  {
    v11[0] = mlir::Operation::getInherentAttr(v3, "src_map", 7);
    v11[0] = mlir::AffineMapAttr::getValue(v11);
    v5 = *(*(*a1 + 72) + 32 * (mlir::AffineMap::getNumInputs(v11) + 1) + 24);
  ...
  InherentAttr = mlir::Operation::getInherentAttr(*a1, v7, 7);
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::affine::AffineApplyOp>::refineReturnTypes(mlir::IndexType *a1, mlir::MLIRContext *a2, char a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  ...
  v14 = v26;
  *v26 = IndexType;
  mlir::ValueRange::ValueRange(&v24, v14, v27);
  mlir::ValueRange::ValueRange(v23, *a11, *(a11 + 8));
  v15 = v25;
  if (v25 == v23[1])
  {
    if (!v25)
...
uint64_t mlir::detail::LoopLikeOpInterfaceInterfaceTraits::Model<mlir::affine::AffineForOp>::getInitsMutable(uint64_t a1, uint64_t a2)
{
  ...
  ZinMirCacheTensors::ZinMirCacheTensors(&v13, v8, v10);
  v14 = 2;
  v15 = v13;
...
void mlir::detail::InterfaceMap::insertModel<mlir::detail::RegionBranchOpInterfaceInterfaceTraits::Model<mlir::affine::AffineForOp>>(uint64_t a1)
{
  ...
  *v2 = mlir::detail::RegionBranchOpInterfaceInterfaceTraits::Model<mlir::affine::AffineForOp>::getEntrySuccessorOperands;
  ...
  {
    v5 = v2;
    mlir::detail::InterfaceMap::insertModel<mlir::detail::RegionBranchOpInterfaceInterfaceTraits::Model<mlir::affine::AffineForOp>>();
    v3 = v5;
  }
...
uint64_t mlir::affine::detail::AffineMapAccessInterfaceInterfaceTraits::Model<mlir::affine::AffinePrefetchOp>::getAffineMapAttrForMemRef(uint64_t a1, uint64_t a2)
{
  ...
  v6[1] = 3;
  v4 = mlir::StringAttr::get(Context, v6);
  ZinMirCacheTensors::ZinMirCacheTensors(&v8, v4, *(a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 88));
  return v8;
}
