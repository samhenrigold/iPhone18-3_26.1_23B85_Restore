uint64_t mlir::pdl_interp::SwitchAttributeOp::setPropertiesFromAttr(uint64_t *a1, uint64_t a2, void (*a3)(void *__return_ptr, uint64_t), uint64_t a4)
{
  ...
  v8 = mlir::DictionaryAttr::get(&v40, "caseValues", 0xAuLL);
  if (!v8)
  {
    return 1;
  }
...
uint64_t mlir::pdl_interp::SwitchAttributeOp::parse(uint64_t a1, void *a2)
{
  ...
  if ((*(*a1 + 296))(a1))
  {
    ...
    if ((*(*a1 + 488))(a1, a2 + 14))
    {
      ...
      v24 = &v15;
      v25 = a2;
      if (mlir::pdl_interp::SwitchAttributeOp::verifyInherentAttrs(v9, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::pdl_interp::SwitchAttributeOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v23) && ((*(*a1 + 56))(a1) & 1) != 0 && ((*(*a1 + 800))(a1, &v16) & 1) != 0)
      {
...
BOOL mlir::pdl_interp::__mlir_ods_local_attr_constraint_PDLInterpOps14(uint64_t a1, const char *a2, const char *a3, void (*a4)(uint64_t *__return_ptr, uint64_t), uint64_t a5)
{
...
uint64_t mlir::pdl_interp::SwitchOperandCountOp::parse(uint64_t a1, void *a2)
{
  ...
  v23 = 257;
  if (((*(*a1 + 400))(a1, "to", 2, &v20) & 1) == 0 || !mlir::AsmParser::parseAttribute<mlir::DenseIntElementsAttr>(a1, &v14, 0))
  {
    goto LABEL_24;
  }
  ...
  if ((v5 & 0x100) != 0)
  {
    ...
    llvm::SmallVectorImpl<mlir::Block *>::emplace_back<mlir::Block *&>(&v17, &v20);
    while (((*(*a1 + 128))(a1) & 1) != 0)
    {
      ...
      if (v18 >= HIDWORD(v18))
      {
        llvm::SmallVectorTemplateBase<long long,true>::growAndEmplaceBack<long long>(&v17, &v20);
      }
  ...
  if ((*(*a1 + 296))(a1))
  {
    ...
    if ((*(*a1 + 488))(a1, a2 + 14))
    {
      ...
      v21 = &v12;
      v22 = a2;
      if (mlir::pdl_interp::SwitchOperandCountOp::verifyInherentAttrs(v6, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::pdl_interp::SwitchOperandCountOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v20) && ((*(*a1 + 56))(a1) & 1) != 0 && ((*(*a1 + 800))(a1, &v13) & 1) != 0)
      {
        mlir::OperationState::addSuccessors(a2, v13);
        mlir::BlockRange::BlockRange(&v20, v17, v18);
        mlir::OperationState::addSuccessors(a2, v20, v21);
        v7 = (*(*a1 + 32))(a1);
        v8 = mlir::Builder::getType<mlir::pdl::OperationType>(v7);
        v9 = (*(*a1 + 728))(a1, v15, v8, a2 + 2) & 1;
        goto LABEL_25;
      }
    }
  }
...
uint64_t mlir::pdl_interp::SwitchOperationNameOp::parse(uint64_t a1, void *a2)
{
  ...
  if ((*(*a1 + 296))(a1))
  {
    ...
    if ((*(*a1 + 488))(a1, a2 + 14))
    {
      ...
      v24 = &v15;
      v25 = a2;
      if (mlir::pdl_interp::SwitchOperationNameOp::verifyInherentAttrs(v9, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::pdl_interp::SwitchOperationNameOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v23) && ((*(*a1 + 56))(a1) & 1) != 0 && ((*(*a1 + 800))(a1, &v16) & 1) != 0)
      {
        mlir::OperationState::addSuccessors(a2, v16);
        mlir::BlockRange::BlockRange(&v23, v20, v21);
        mlir::OperationState::addSuccessors(a2, v23, v24);
...
uint64_t mlir::pdl_interp::SwitchResultCountOp::parse(uint64_t a1, void *a2)
{
  ...
  if ((*(*a1 + 296))(a1))
  {
    ...
    if ((*(*a1 + 488))(a1, a2 + 14))
    {
      ...
      v21 = &v12;
      v22 = a2;
      if (mlir::pdl_interp::SwitchOperandCountOp::verifyInherentAttrs(v6, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::pdl_interp::SwitchResultCountOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v20) && ((*(*a1 + 56))(a1) & 1) != 0 && ((*(*a1 + 800))(a1, &v13) & 1) != 0)
      {
        mlir::OperationState::addSuccessors(a2, v13);
        mlir::BlockRange::BlockRange(&v20, v17, v18);
        mlir::OperationState::addSuccessors(a2, v20, v21);
...
uint64_t mlir::pdl_interp::SwitchTypeOp::parse(uint64_t a1, void *a2)
{
  ...
  if ((*(*a1 + 296))(a1))
  {
    ...
    if ((*(*a1 + 488))(a1, a2 + 14))
    {
      ...
      v24 = &v15;
      v25 = a2;
      if (mlir::pdl_interp::SwitchTypeOp::verifyInherentAttrs(v9, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::pdl_interp::SwitchTypeOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v23) && ((*(*a1 + 56))(a1) & 1) != 0 && ((*(*a1 + 800))(a1, &v16) & 1) != 0)
      {
        mlir::OperationState::addSuccessors(a2, v16);
        mlir::BlockRange::BlockRange(&v23, v20, v21);
        mlir::OperationState::addSuccessors(a2, v23, v24);
...
BOOL mlir::pdl_interp::__mlir_ods_local_attr_constraint_PDLInterpOps15(uint64_t a1, const char *a2, const char *a3, void (*a4)(uint64_t *__return_ptr, uint64_t), uint64_t a5)
{
...
uint64_t mlir::pdl_interp::SwitchTypesOp::parse(uint64_t a1, void *a2)
{
  ...
  if ((*(*a1 + 296))(a1))
  {
    ...
    if ((*(*a1 + 488))(a1, a2 + 14))
    {
      ...
      v25 = &v16;
      v26 = a2;
      if (mlir::pdl_interp::SwitchTypesOp::verifyInherentAttrs(v9, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::pdl_interp::SwitchTypesOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v24) && ((*(*a1 + 56))(a1) & 1) != 0 && ((*(*a1 + 800))(a1, &v17) & 1) != 0)
      {
...
BOOL mlir::OpTrait::HasParent<mlir::pdl_interp::ForEachOp>::Impl<mlir::pdl_interp::ContinueOp>::verifyTrait(uint64_t a1)
{
  v48 = *MEMORY[0x1E69E9840];
  if (*(a1 + 16))
  {
