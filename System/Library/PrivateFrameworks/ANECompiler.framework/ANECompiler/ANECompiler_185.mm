...
BOOL mlir::tensor::InsertOp::verifyInvariantsImpl(uint64_t **this)
{
...
BOOL mlir::tensor::InsertSliceOp::readProperties(uint64_t a1, void *a2)
{
  ...
  if ((*(*a1 + 40))(a1) <= 5)
  {
    ...
    if (mlir::AffineBinaryOpExpr::getLHS(&v17) >= 6)
    {
...
void mlir::tensor::InsertSliceOp::build(mlir::MLIRContext **a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, unint64_t a7, uint64_t a8, uint64_t a9, unint64_t a10, uint64_t a11, unint64_t a12, llvm::hashing::detail *a13, uint64_t a14, llvm::hashing::detail *a15, uint64_t a16, llvm::hashing::detail *a17, uint64_t a18)
{
  ...
  *(v26 + 8) = v25;
  v27 = mlir::Builder::getDenseI64ArrayAttr(a1, a17, a18);
  v28 = *(a2 + 256);
  if (!v28)
  {
    operator new();
...
BOOL mlir::tensor::InsertSliceOp::verifyInvariantsImpl(uint64_t **this)
{
...
BOOL mlir::tensor::InsertSliceOp::parse(void *a1, unsigned int *a2)
{
  ...
  (*(*a1 + 40))(a1);
  v49 = 0;
  if (!mlir::parseDynamicIndexList(a1, &v59, &v42, &v49, 0))
  {
    goto LABEL_36;
  }
  ...
  *v6 = v42;
  (*(*a1 + 40))(a1);
  v49 = 0;
  if (!mlir::parseDynamicIndexList(a1, &v56, &v41, &v49, 0))
  {
    goto LABEL_36;
  }
  ...
  *(v7 + 8) = v41;
  (*(*a1 + 40))(a1);
  v49 = 0;
  if (!mlir::parseDynamicIndexList(a1, &v53, &v40, &v49, 0))
  {
    goto LABEL_36;
  }
  ...
  *(v8 + 16) = v40;
  ...
  v50 = v32;
  v51 = a2;
  if (!mlir::memref::ReinterpretCastOp::verifyInherentAttrs(v9, (a2 + 28), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::tensor::InsertSliceOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v49))
  {
    goto LABEL_36;
  }
...
LABEL_21:
    ...
    mlir::OperationState::addTypes(a2, v31, 1);
    if (mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v46, v38, v4, (a2 + 4)) && mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v43, &v35, v5, (a2 + 4)))
    {
      if (v60)
      {
        v19 = v59;
...
LABEL_36:
  ...
  while (1)
  {
    ...
    v49 = llvm::cast<mlir::ShapedType,mlir::Type>(&v34);
    v50 = v16;
  ...
  v27 = (*(*a1 + 16))(a1);
  v33 = 257;
  (*(*a1 + 24))(&v49, a1, v27, v32);
  mlir::InFlightDiagnostic::operator<<<char const(&)[44]>(&v49, "'dest' must be ranked tensor of any type values, but got ");
  mlir::InFlightDiagnostic::operator<<<mlir::Type &>(v28, &v34);
  v25 = mlir::InFlightDiagnostic::operator llvm::LogicalResult(v29);
...
LABEL_76:
  ...
  v8 = mlir::DictionaryAttr::get(&v71, "inner_dims_pos", 0xEuLL);
  if (!v8)
  {
    goto LABEL_8;
  }
  ...
  *a1 = v9;
LABEL_8:
  v10 = mlir::DictionaryAttr::get(&v71, "outer_dims_perm", 0xFuLL);
  if (!v10)
  {
    goto LABEL_11;
  }
  ...
  a1[1] = v11;
LABEL_11:
  v12 = mlir::DictionaryAttr::get(&v71, "static_inner_tiles", 0x12uLL);
  if (v12)
  {
    v13 = v12;
    if (!mlir::detail::DenseArrayAttrImpl<long long>::classof(v12))
...
BOOL mlir::tensor::PackOp::verifyInvariantsImpl(uint64_t **this)
{
...
LABEL_78:
  ...
  v8 = mlir::DictionaryAttr::get(&v71, "nofold", 6uLL);
  if (v8)
  {
  ...
  v36 = mlir::DictionaryAttr::get(&v71, "static_high", 0xBuLL);
  if (v36)
  {
    v37 = v36;
...
LABEL_49:
  v38 = mlir::DictionaryAttr::get(&v71, "static_low", 0xAuLL);
  if (v38)
  {
    v39 = v38;
  ...
  v40 = mlir::DictionaryAttr::get(&v71, "operandSegmentSizes", 0x13uLL);
  if (!v40)
  {
    v40 = mlir::DictionaryAttr::get(&v71, "operand_segment_sizes", 0x15uLL);
    if (!v40)
    {
      return 1;
    }
...
uint64_t mlir::tensor::PadOp::verifyInvariantsImpl(uint64_t **this)
{
  v37 = *MEMORY[0x1E69E9840];
...
uint64_t mlir::tensor::ParallelInsertSliceOp::parse(uint64_t a1, void *a2)
{
  ...
  (*(*a1 + 40))(a1);
  v40[0] = 0;
  if (!mlir::parseDynamicIndexList(a1, &v48, &v33, v40, 0))
  {
    goto LABEL_32;
  }
  ...
  *v6 = v33;
  (*(*a1 + 40))(a1);
  v40[0] = 0;
  if (!mlir::parseDynamicIndexList(a1, &v45, &v32, v40, 0))
  {
    goto LABEL_32;
  }
  ...
  *(v7 + 8) = v32;
  (*(*a1 + 40))(a1);
  v40[0] = 0;
  if (!mlir::parseDynamicIndexList(a1, &v42, &v31, v40, 0))
  {
    goto LABEL_32;
  }
  ...
  *(v8 + 16) = v31;
  ...
  v40[1] = &v26;
  v40[2] = a2;
  if (!mlir::memref::ReinterpretCastOp::verifyInherentAttrs(v9, (a2 + 14), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::tensor::ParallelInsertSliceOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, v40))
  {
    goto LABEL_32;
  }
  ...
  *(v13 + 40) = v12;
  ...
  if (!mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v37, v29, v4, (a2 + 2)) || !mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v34, v27, v5, (a2 + 2)))
  {
    goto LABEL_32;
  }
...
uint64_t mlir::tensor::ScatterOp::setPropertiesFromAttr(uint64_t *a1, uint64_t a2, void (*a3)(void *__return_ptr, uint64_t), uint64_t a4)
{
  ...
  v8 = mlir::DictionaryAttr::get(&v58, "scatter_dims", 0xCuLL);
  if (v8)
  {
    v9 = v8;
    if (!mlir::detail::DenseArrayAttrImpl<long long>::classof(v8))
...
BOOL mlir::tensor::SplatOp::verifyInvariantsImpl(uint64_t **this)
{
...
LABEL_62:
  ...
  if (mlir::TensorType::getElementType(v79) == (*(*((*this)[9] + 24) + 8) & 0xFFFFFFFFFFFFFFF8))
  {
    return 1;
  }
...
uint64_t mlir::tensor::UnPackOp::setPropertiesFromAttr(uint64_t *a1, uint64_t a2, void (*a3)(uint64_t *__return_ptr, uint64_t), uint64_t a4)
{
  ...
  v8 = mlir::DictionaryAttr::get(&v70, "inner_dims_pos", 0xEuLL);
  if (v8)
  {
    v9 = v8;
    if (!mlir::detail::DenseArrayAttrImpl<long long>::classof(v8))
  ...
  v10 = mlir::DictionaryAttr::get(&v70, "outer_dims_perm", 0xFuLL);
  if (v10)
  {
    v11 = v10;
    if (mlir::detail::DenseArrayAttrImpl<long long>::classof(v10))
...
LABEL_11:
  v12 = mlir::DictionaryAttr::get(&v70, "static_inner_tiles", 0x12uLL);
  if (!v12)
  {
    return 1;
  }
...
BOOL mlir::tensor::UnPackOp::readProperties(uint64_t a1, void *a2)
{
  ...
  return mlir::DialectBytecodeReader::readAttribute<mlir::detail::DenseArrayAttrImpl<long long>>(a1, a2[32]) && mlir::DialectBytecodeReader::readOptionalAttribute<mlir::detail::DenseArrayAttrImpl<long long>>(a1, (v3 + 8)) && mlir::DialectBytecodeReader::readAttribute<mlir::detail::DenseArrayAttrImpl<long long>>(a1, (v3 + 16));
}
...
BOOL mlir::tensor::UnPackOp::verifyInvariantsImpl(uint64_t **this)
{
...
LABEL_40:
  ...
  v8 = v4[1];
  v47[0] = v2;
  if (!mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps6(v8, "outer_dims_perm", 0xF, llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::tensor::__mlir_ods_local_attr_constraint_TensorOps3(mlir::Operation *,mlir::Attribute,llvm::StringRef)::$_0>, v47))
  {
    return 0;
  }

  v47[0] = *this;
  if (!mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps6(v5, "inner_dims_pos", 0xE, llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::tensor::__mlir_ods_local_attr_constraint_TensorOps3(mlir::Operation *,mlir::Attribute,llvm::StringRef)::$_0>, v47))
  {
    return 0;
  }

  v47[0] = *this;
  if (!mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps6(v7, "static_inner_tiles", 0x12, llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::tensor::__mlir_ods_local_attr_constraint_TensorOps3(mlir::Operation *,mlir::Attribute,llvm::StringRef)::$_0>, v47) || !mlir::tensor::__mlir_ods_local_type_constraint_TensorOps3(*this, (*(*((*this)[9] + 24) + 8) & 0xFFFFFFFFFFFFFFF8), "operand", 7, 0))
  {
    return 0;
  }
...
BOOL mlir::tensor::UnPackOp::parse(void *a1, unsigned int *a2)
{
  ...
  if (((*(*a1 + 136))(a1) & 1) == 0 || !mlir::AsmParser::parseCustomAttributeWithFallback<mlir::detail::DenseArrayAttrImpl<long long>>(a1, &v37, 0))
  {
LABEL_36:
    v19 = 0;
    goto LABEL_37;
...
LABEL_9:
  v44 = 257;
  if (((*(*a1 + 400))(a1, "inner_dims_pos", 14, &v41) & 1) == 0 || ((*(*a1 + 136))(a1) & 1) == 0 || !mlir::AsmParser::parseCustomAttributeWithFallback<mlir::detail::DenseArrayAttrImpl<long long>>(a1, &v36, 0))
  {
    goto LABEL_36;
  }
  ...
  v44 = 257;
  if (((*(*a1 + 400))(a1, "inner_tiles", 11, &v41) & 1) == 0)
  {
    goto LABEL_36;
  }
  ...
  (*(*a1 + 40))(a1);
  v41 = 0;
  if (!mlir::parseDynamicIndexList(a1, &v45, &v35, &v41, 0))
  {
    goto LABEL_36;
  }
  ...
  *(v7 + 16) = v35;
  ...
  v42 = v24;
  v43 = a2;
  if (!mlir::tensor::PackOp::verifyInherentAttrs(v9, (a2 + 28), llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::tensor::UnPackOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v41))
  {
    goto LABEL_36;
  }
  ...
  v41 = 0;
  if (!mlir::AsmParser::parseType<mlir::RankedTensorType>(a1, &v41))
  {
    goto LABEL_36;
  }
...
LABEL_29:
    ...
    if (mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v38, v30, v4, (a2 + 4)) && mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v32, &v27, v8, (a2 + 4)))
    {
      if (!v46)
      {
        v19 = 1;
...
LABEL_40:
  ...
  {
    v26 = *v12;
    if (*(*v26 + 136) != &mlir::detail::TypeIDResolver<mlir::RankedTensorType,void>::id)
    {
      break;
    }

    v41 = llvm::cast<mlir::ShapedType,mlir::Type>(&v26);
    v42 = v13;
  ...
  v21 = (*(*a1 + 16))(a1);
  v25 = 257;
  (*(*a1 + 24))(&v41, a1, v21, v24);
  mlir::InFlightDiagnostic::operator<<<char const(&)[44]>(&v41, "'dest' must be ranked tensor of any type values, but got ");
  mlir::InFlightDiagnostic::operator<<<mlir::Type &>(v22, &v26);
  v19 = mlir::InFlightDiagnostic::operator llvm::LogicalResult(v23);
