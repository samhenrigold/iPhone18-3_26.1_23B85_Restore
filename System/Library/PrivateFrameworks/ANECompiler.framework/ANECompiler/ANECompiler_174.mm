...
LABEL_70:
  ...
  while (2)
  {
    ...
    if (*(v17 + 200))
    {
      llvm::SmallVectorImpl<llvm::SMRange>::operator=(v53, (v17 + 192));
    }
    ...
    if (*(v17 + 216))
    {
      llvm::SmallVectorImpl<llvm::SMRange>::operator=(v54, (v17 + 208));
    }
    ...
    if (a3 == 2)
    {
      ...
      if (*(a1 + 112) < *(a2 - 4))
      {
        *a4 = *(a2 - 15);
        ...
        if (*(v5 - 10))
        {
          llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 9), v5 - 6);
        }
        ...
        if (*(v5 - 6))
        {
          llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 11), v5 - 4);
        }
        ...
        *(v4 + 56) = *(v5 - 4);
        ...
        if (*(v6 + 80))
        {
          llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 24), (v6 + 72));
        }
...
LABEL_9:
        llvm::SmallVectorImpl<llvm::SMRange>::operator=(v7, (v6 + 88));
LABEL_10:
        v9 = *(v6 + 104);
        *(v8 + 4) = *(v6 + 112);
        *v8 = v9;
      ...
      *a4 = *a1;
      ...
      if (*(v6 + 80))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 9), (v6 + 72));
      }
      ...
      if (*(v6 + 96))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 11), (v6 + 88));
      }
      ...
      *(v4 + 56) = *(v6 + 112);
      ...
      if (*(v5 - 10))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 24), v5 - 6);
      }
      ...
      if (*(v5 - 6))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 26), v5 - 4);
      }
...
LABEL_122:
              if (v50 != v5)
              {
                ...
                do
                {
                  ...
                  *v64 = *(v50 + v61 * 8);
                  ...
                  if (*(v63 + 80))
                  {
                    llvm::SmallVectorImpl<llvm::SMRange>::operator=((v64 + 9), (v50 + v61 * 8 + 72));
                  }
                  ...
                  if (*(v63 + 96))
                  {
                    llvm::SmallVectorImpl<llvm::SMRange>::operator=((v64 + 11), (v50 + v61 * 8 + 88));
                  }
          ...
          else
          {
            *v4 = *v50;
            ...
            if (*(v50 + 80))
            {
              llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 9), (v50 + 72));
            }
            ...
            if (*(v50 + 96))
            {
              llvm::SmallVectorImpl<llvm::SMRange>::operator=((v4 + 11), (v50 + 88));
            }
        ...
        if (v6 != v48)
        {
          ...
          do
          {
            ...
            *v57 = *(v6 + v54 * 8);
            ...
            if (*(v56 + 80))
            {
              llvm::SmallVectorImpl<llvm::SMRange>::operator=(v59, (v6 + v54 * 8 + 72));
            }
            ...
            *v58 = v60;
            ...
            if (*(v56 + 96))
            {
              llvm::SmallVectorImpl<llvm::SMRange>::operator=(v58, (v6 + v54 * 8 + 88));
            }
        ...
        if ((v6 + 120) != v5)
        {
          ...
          do
          {
            ...
            if (*(v16 + 56) >= *(v6 + 232))
            {
              ...
              if (*(v6 + 200))
              {
                llvm::SmallVectorImpl<llvm::SMRange>::operator=((v16 + 24), (v6 + 192));
              }
              ...
              if (*(v6 + 216))
              {
                llvm::SmallVectorImpl<llvm::SMRange>::operator=((v16 + 26), (v6 + 208));
              }
            ...
            else
            {
              ...
              if (*(v16 + 20))
              {
                llvm::SmallVectorImpl<llvm::SMRange>::operator=((v16 + 24), v16 + 9);
              }
              ...
              if (*(v16 + 24))
              {
                llvm::SmallVectorImpl<llvm::SMRange>::operator=((v16 + 26), v16 + 11);
              }
  ...
  if (a4 <= a5)
  {
    ...
    do
    {
      ...
      *(a6 + v51 + 8) = a6 + v51 + 24;
      ...
      if (*(v53 + 80))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=(v56, (a1 + v51 + 72));
      }
      ...
      *(a6 + v51 + 96) = 0;
      if (*(v53 + 96))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=(v55, (a1 + v51 + 88));
      }
  ...
  else
  {
    ...
    do
    {
      ...
      *(a6 + v40 + 8) = a6 + v40 + 24;
      ...
      if (*(v46 + 80))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=(v48, (a2 + v40 + 72));
      }
      ...
      *(a6 + v40 + 96) = 0;
      if (*(v46 + 96))
      {
        llvm::SmallVectorImpl<llvm::SMRange>::operator=(v47, (a2 + v40 + 88));
      }
...
void std::swap[abi:nn200100]<mlir::detail::PDLByteCode::MatchResult>(const void **a1, uint64_t a2)
{
  ...
  if (*(a1 + 20))
  {
    llvm::SmallVectorImpl<llvm::SMRange>::operator=(v7, a1 + 9);
  }
  ...
  if (*(a1 + 24))
  {
    llvm::SmallVectorImpl<llvm::SMRange>::operator=(v8, a1 + 11);
  }
...
void OUTLINED_FUNCTION_2_17(uint64_t a1, uint64_t a2, unint64_t a3)
{
...
LABEL_8:
          ...
          v17 = v10 & (*(*(a4 + 48) + 16) != &mlir::detail::TypeIDResolver<mlir::placement::HostTypeCast,void>::id) & ~(*(**(a4 + 48) + 32))(*(a4 + 48), mlir::detail::TypeIDResolver<mlir::OpTrait::RegionOp<mlir::TypeID mlir::TypeID::get<mlir::OpTrait::RegionOp>(void)::Empty>,void>::resolveTypeID(void)::id);
          if (a1 == a4)
          {
            v18 = 0;
          }
          ...
          v19 = (*(**(a4 + 48) + 32))(*(a4 + 48), mlir::detail::TypeIDResolver<mlir::OpTrait::ConstantLike<mlir::TypeID mlir::TypeID::get<mlir::OpTrait::ConstantLike>(void)::Empty>,void>::resolveTypeID(void)::id);
          {
          }

          return (v18 & ((v19 | (*(**(a4 + 48) + 32))(*(a4 + 48), mlir::detail::TypeIDResolver<mlir::OpTrait::IsTerminator<mlir::TypeID mlir::TypeID::get<mlir::OpTrait::IsTerminator>(void)::Empty>,void>::resolveTypeID(void)::id)) ^ 1));
        }
...
void mlir::collectRegions(ZinIrHalH13g *a1, ZinIrHalH13g *a2, void *a3)
{
  ...
  *v26 = 0u;
  ...
  {
    v5 = *(v44[0] + 2);
    ZinIrHalH13g::~ZinIrHalH13g(v44[0]);
    *(v13 + 16) = v5;
    *(v13 + 24) = v6;
    v7 = (v23[1] + 8 * (v25 >> 9));
    if (v24 == v23[1])
...
LABEL_82:
          v44 = __p[1];
          v72 = vaddq_s64(v194, xmmword_1A75A6420);
          v194 = v72;
          v42 = v72.i64[0];
...
LABEL_10:
  ...
  if (v24)
  {
    ...
    if (LODWORD(v72[1]))
    {
      llvm::SmallVectorImpl<mlir::Value>::operator=(&v77, v72);
    }
  }
...
void mlir::OpBuilder::create<mlir::placement::ReplacedOps,std::string &,mlir::Operation *&,llvm::SmallVector<mlir::Operation *,6u> &,llvm::SmallVector<mlir::Value,6u> &,llvm::SmallVector<mlir::Value,6u> &>(mlir::StringAttr **a1, uint64_t a2, uint64_t ***a3, mlir::SymbolRefAttr **a4, mlir::Operation ***a5, uint64_t a6, uint64_t a7)
{
  ...
  if (*(this + 6))
  {
    ...
    if (v5 != v6)
    {
      do
      {
        ...
        {
          v32 = v7;
          llvm::SmallVectorImpl<mlir::Operation *>::insert_one_impl<mlir::Operation *>(&v33, v33, &v32);
        }
  ...
  if (v22 || *(this + 7))
  {
    ...
    if (v23 <= 4 * v22 || v23 < 0x41)
    {
      if (v23)
      {
        ...
        v27 = v25 + 1;
        v26 = (v24 + 8 * (v27 & 0x3FFFFFFFFFFFFFFCLL));
        v28 = v24 + 1;
...
uint64_t llvm::SmallVectorImpl<mlir::Value>::operator=(uint64_t result, const void **a2)
{
  if (result != a2)
  {
    v3 = a2 + 2;
...
BOOL mlir::emitOptionalWarning<char const(&)[37],llvm::StringRef &>(uint64_t a1, char a2, char *a3, const char **a4)
{
...
void mlir::ConversionTarget::~ConversionTarget(mlir::ConversionTarget *this)
{
  *this = &unk_1F1A05CE0;
  ...
  if (v9)
  {
    ...
    do
    {
      if ((*(v10 - 4) | 0x1000) != 0xFFFFFFFFFFFFF000)
      {
        v13 = *v10;
        if (v10 - 3 == *v10)
        {
...
void mlir::OpBuilder::create<mlir::ModuleOp>(mlir::StringAttr **a1, uint64_t a2)
{
  ...
  mlir::OpBuilder::create<mlir::ModuleOp,llvm::StringRef>(v10, v9, v8);
}
...
LABEL_6:
    ...
    if (v10 == v12)
    {
      std::deque<mlir::Operation *>::__add_back_capacity(v7);
      v11 = *(v7 + 40);
      v9 = *(v7 + 8);
      v12 = *(v7 + 32) + v11;
    }
...
LABEL_80:
      v36 = __p[1];
      v76 = vaddq_s64(v100, xmmword_1A75A6420);
      v100 = v76;
      v34 = v76.i64[0];
...
void std::deque<mlir::Operation *>::__add_front_capacity(const void **a1)
{
  v1 = a1[1];
  v2 = a1[2];
  v3 = v2 - v1;
  ...
  v10 = *(v2 - 8);
  a1[2] = (v2 - 8);
  std::__split_buffer<mlir::Operation **>::emplace_front<mlir::Operation **>(a1, &v10);
}
...
{
  if (this && *(*(this + 6) + 16) == &mlir::detail::TypeIDResolver<mlir::placement::HostTypeCast,void>::id)
  {
    v3 = *a1;
    v4 = **a1;
    v5 = (v4 + 16);
    ...
    *(v4 + 24) = v7;
    ...
    {
      v17 = *v14;
      v18 = 0x9DDFEA08EB382D69 * ((8 * *(*(this + 9) + 24) - 0xAE502812AA7333) ^ HIDWORD(*(*(this + 9) + 24)));
