...
LABEL_33:
  ...
  {
    RawStringData = *(*((*this)[9] + 56) + 8) & 0xFFFFFFFFFFFFFFF8;
...
BOOL mlir::memref::SubViewOp::verify(uint64_t **this)
{
...
LABEL_52:
  ...
  v16 = mlir::BaseMemRefType::operator mlir::ShapedType(&v74);
  v18 = v17;
  v19 = mlir::BaseMemRefType::operator mlir::ShapedType(&v75);
...
LABEL_67:
  ...
  if ((v94 & 1) == 0 && v94)
  {
    ...
    MEMORY[0x1AC55A070](v68, 0x1080C40EF38A13ELL);
  }

  return v36;
}

BOOL produceSubViewErrorMsg(int a1, uint64_t *a2, void *a3)
{
...
LABEL_74:
    if (a1 == 1)
    {
      ...
      v16 = mlir::InFlightDiagnostic::operator llvm::LogicalResult(v93);
      if (v93[0])
      {
    ...
    else
    {
      ...
      {
        v64 = &v90;
        mlir::DiagnosticArgument::DiagnosticArgument(&v90, v63);
        v65 = v94;
        if (v95 >= v96)
        {
          if (v94 <= &v90 && v94 + 24 * v95 > &v90)
        ...
        *v66 = v67;
        ...
        if (v93[0])
        {
          ...
          if (v68 >= v96)
          {
            if (v94 <= &v90 && v94 + 24 * v68 > &v90)
            {
              v85 = &v90 - v94;
              llvm::SmallVectorBase<unsigned int>::grow_pod(&v94, v97, v68 + 1, 24);
              v70 = v94;
              v69 = (v94 + v85);
            }
...
LABEL_115:
  ...
  else
  {
    ...
    {
      v37 = &v90;
      mlir::DiagnosticArgument::DiagnosticArgument(&v90, v36);
      v38 = v94;
      if (v95 >= v96)
      {
        if (v94 <= &v90 && v94 + 24 * v95 > &v90)
...
uint64_t mlir::memref::TransposeOp::verify(uint64_t **this)
{
  ...
  if (mlir::AffineMap::isPermutation(v52))
  {
    ...
    v47[0] = (*(*((*this)[9] + 24) + 8) & 0xFFFFFFFFFFFFFFF8);
...
uint64_t mlir::memref::AssumeAlignmentOp::setPropertiesFromAttr(uint64_t *a1, uint64_t a2, void (*a3)(void *__return_ptr, uint64_t), uint64_t a4)
{
  ...
  v8 = mlir::DictionaryAttr::get(&v40, "alignment", 9uLL);
  if (!v8)
  {
    return 1;
  }
...
BOOL mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps1(uint64_t a1, const char *a2, const char *a3, void (*a4)(void *__return_ptr, void), uint64_t a5)
{
  ...
  v35 = a1;
  mlir::IntegerAttr::getValue(&v35, &v41);
  v11 = v42[0];
  v12 = v42[0] - 1;
  if (v42[0] < 0x41)
  {
  ...
  v13 = v41;
  if (((*(v41 + 8 * (v12 >> 6)) >> v12) & 1) == 0)
  {
    v14 = llvm::APInt::countLeadingZerosSlowCase(&v41);
...
LABEL_12:
  ...
  v23 = mlir::InFlightDiagnostic::operator llvm::LogicalResult(&v41);
  if (v41)
  {
...
BOOL mlir::memref::__mlir_ods_local_type_constraint_MemRefOps1(uint64_t *a1, uint64_t *a2, const char *a3, const char *a4, unsigned int a5)
{
...
BOOL mlir::memref::AssumeAlignmentOp::parse(uint64_t a1, void *a2)
{
  ...
  if (v9)
  {
    if (!mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps1(v9, "alignment", 9, llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::memref::AssumeAlignmentOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, v11))
    {
      return 0;
    }
  }
  ...
  v14 = v11[0];
  return mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v16, v13, v4, (a2 + 2));
}
...
uint64_t mlir::memref::AtomicRMWOp::setPropertiesFromAttr(uint64_t *a1, uint64_t a2, void (*a3)(void *__return_ptr, uint64_t), uint64_t a4)
{
  ...
  v8 = mlir::DictionaryAttr::get(&v40, "kind", 4uLL);
  if (!v8)
  {
    return 1;
  }
...
BOOL mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps2(uint64_t a1, const char *a2, const char *a3, void (*a4)(uint64_t *__return_ptr, uint64_t), uint64_t a5)
{
...
LABEL_7:
    ...
    if (mlir::memref::__mlir_ods_local_type_constraint_MemRefOps2(*this, *(NextResultAtOffset + 8) & 0xFFFFFFFFFFFFFFF8, "result", 6, 0))
    {
      ...
      if ((*(mlir::detail::OpResultImpl::getNextResultAtOffset(v10, 0) + 8) ^ v9) <= 7 && (*(*this + 9) ? (v11 = *this - 2) : (v11 = 0), v12 = mlir::detail::OpResultImpl::getNextResultAtOffset(v11, 0), v13 = (*this)[9], (*(*(v13 + 24) + 8) ^ *(v12 + 8)) < 8))
      {
        ...
        if (mlir::AffineBinaryOpExpr::getRHS(&v26) == (*(*((*this)[9] + 24) + 8) & 0xFFFFFFFFFFFFFFF8))
        {
          return 1;
        }
...
BOOL mlir::memref::__mlir_ods_local_type_constraint_MemRefOps2(uint64_t *a1, uint64_t a2, const char *a3, const char *a4, unsigned int a5)
{
...
BOOL mlir::memref::__mlir_ods_local_type_constraint_MemRefOps3(uint64_t *a1, uint64_t *a2, const char *a3, const char *a4, unsigned int a5)
{
...
BOOL mlir::memref::__mlir_ods_local_type_constraint_MemRefOps4(uint64_t *a1, uint64_t a2, const char *a3, const char *a4, unsigned int a5)
{
  v55 = *MEMORY[0x1E69E9840];
...
BOOL mlir::memref::AtomicRMWOp::parse(uint64_t a1, uint64_t a2)
{
  ...
  v74[8] = 4;
  v4 = (*(*a1 + 40))(a1);
  v72[0] = xmmword_1E77C4E68;
  v72[1] = *&off_1E77C4E78;
  v72[2] = xmmword_1E77C4E88;
  v68 = xmmword_1E77C4E28;
  v69 = *&off_1E77C4E38;
  __p = xmmword_1E77C4E48;
  v71 = *&off_1E77C4E58;
  v67[2] = xmmword_1E77C4DE8;
  v67[3] = *&off_1E77C4DF8;
  v67[4] = xmmword_1E77C4E08;
  v67[5] = *&off_1E77C4E18;
  v65 = xmmword_1E77C4DA8;
  v66 = *&off_1E77C4DB8;
  v67[0] = xmmword_1E77C4DC8;
  v67[1] = *&off_1E77C4DD8;
...
LABEL_7:
    ...
    *(&v65 + 1) = v73;
    *&v66 = a2;
    if (!mlir::memref::AtomicRMWOp::verifyInherentAttrs(v14, a2 + 112, llvm::function_ref<mlir::InFlightDiagnostic ()(void)>::callback_fn<mlir::memref::AtomicRMWOp::parse(mlir::OpAsmParser &,mlir::OperationState &)::$_0>, &v65))
    {
      goto LABEL_49;
    }
    ...
    *&v65 = 0;
    ...
    mlir::OperationState::addTypes(a2, &v50, 1);
    if (!mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v58, v53, v12, a2 + 16) || !mlir::OpAsmParser::resolveOperands<llvm::ArrayRef<mlir::OpAsmParser::UnresolvedOperand> &,llvm::ArrayRef<mlir::Type> &>(a1, v55, v51, v13, a2 + 16))
    {
      goto LABEL_49;
    }
...
LABEL_83:
  ...
  v46[0] = 0;
  v21 = (*(*a1 + 32))(a1);
  NoneType = mlir::Builder::getNoneType(v21, v22);
  v24 = (*(*a1 + 472))(a1, v46, NoneType);
  if ((v24 & 0x100) == 0)
  {
    ...
    v64 = 259;
    (*(*a1 + 24))(&v65, a1, v4, &v61);
    v20 = mlir::InFlightDiagnostic::operator llvm::LogicalResult(&v65);
    if (v65)
    {
  ...
  mlir::NamedAttrList::append(v73, "kind", 4uLL, v46[0]);
...
LABEL_3:
  ...
  {
    LODWORD(v61) = 3;
    v62 = "kind attribute specification: ";
    v63 = 31;
    v34 = &v61;
    v35 = *(&v66 + 1);
...
BOOL mlir::memref::__mlir_ods_local_type_constraint_MemRefOps6(uint64_t *a1, uint64_t *a2, const char *a3, const char *a4, unsigned int a5)
{
...
BOOL mlir::memref::GenericAtomicRMWOp::verifyInvariantsImpl(uint64_t **this)
{
...
uint64_t mlir::memref::LoadOp::setPropertiesFromAttr(uint64_t *a1, uint64_t a2, void (*a3)(void *__return_ptr, uint64_t), uint64_t a4)
{
  ...
  v8 = mlir::DictionaryAttr::get(&v40, "nontemporal", 0xBuLL);
  if (!v8)
  {
    return 1;
  }
...
BOOL mlir::memref::__mlir_ods_local_attr_constraint_MemRefOps3(void *a1, const char *a2, const char *a3, void (*a4)(uint64_t *__return_ptr, uint64_t), uint64_t a5)
{
  v45 = *MEMORY[0x1E69E9840];
...
BOOL mlir::memref::LoadOp::verifyInvariantsImpl(uint64_t **this)
{
  v36 = *MEMORY[0x1E69E9840];
  v2 = *this;
  v3 = (*this)[2 * ((*(*this + 11) >> 23) & 1) + 8];
...
LABEL_50:
  ...
  v8 = mlir::DictionaryAttr::get(&v41, "alignment", 9uLL);
  if (v8)
  {
    if (*(*v8 + 136) != &mlir::detail::TypeIDResolver<mlir::IntegerAttr,void>::id)
    {
