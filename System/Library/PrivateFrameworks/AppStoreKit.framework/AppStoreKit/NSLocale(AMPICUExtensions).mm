...
- (id)threeCharacterLanguageCode
{
  ...
  v2 = [MEMORY[0x1E695DF58] threeCharacterLanguageCodeFromTwoCharacterCode:languageCode];
  if (!v2)
  {
    v2 = languageCode;
  }
...
- (id)threeCharacterRegionCode
{
  ...
  v2 = [MEMORY[0x1E695DF58] threeCharacterRegionCodeFromTwoCharacterCode:countryCode];
  if (!v2)
  {
    v2 = countryCode;
  }
