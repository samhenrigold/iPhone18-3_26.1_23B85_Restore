...
- (BOOL)start
{
  ...
  if (v10 < 1)
  {
    v28 = sub_100001F6C(v10);
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      directoryURL3 = [(FMDFSWatcher *)self directoryURL];
      sub_100004430(directoryURL3, buf, v28);
    }

    v31 = sub_100001F6C(v30);
...
- (void)directoryChanged
{
  ...
  if (targetFilename)
  {
    ...
    if (v7)
    {
      ...
      {
        sub_100004488(self, v7, v9);
      }

      v11 = sub_100001F6C(v10);
