    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        if (v17)
        {
          ...
          objc_msgSend_addServiceEntry_(v26, v24, v18);
        }
      }
...
- (id)convertToPList
{
  ...
  v9 = objc_msgSend_countByEnumeratingWithState_objects_count_(v7, v8, &v29, v35, 16);
  if (v9)
  {
    v12 = v9;
    v13 = *v30;
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (objc_msgSend_length(v16, v17, v18))
        {
          ...
          v34 = v16;
          v23 = objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x277CBEAC0], v22, &v34, &v33, 1);
          v26 = objc_msgSend_pcsService(v15, v24, v25);
          objc_msgSend_setObject_forKeyedSubscript_(v4, v27, v23, v26);
        }
      }

      v12 = objc_msgSend_countByEnumeratingWithState_objects_count_(v7, v10, &v29, v35, 16);
    }
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addServiceEntry_(self, v7, *(*(&v11 + 1) + 8 * v10++), v11);
      }
