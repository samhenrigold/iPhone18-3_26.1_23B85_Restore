...
- (void)mismatchError:(id)error
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    v5 = 138412290;
    errorCopy = error;
    _os_log_impl(&dword_1B0389000, v4, OS_LOG_TYPE_INFO, "Ignoring unmatched </%@> command", &v5, 0xCu);
  }
}
...
- (void)nowWouldBeAGoodTimeToAppendToTheAttributedString
{
  if (*(self + 212))
  {
    ...
    [(NSMutableString *)outputBuffer setString:&stru_1F273A5E0];
    return;
  }
...
LABEL_86:
  ...
  CFStringReplaceAll(self->_prependHTML, &stru_1F273A5E0);
  CFStringReplaceAll(self->_postpendHTML, &stru_1F273A5E0);
  CFStringReplaceAll(self->_outputBuffer, &stru_1F273A5E0);
}
  ...
  if (v4)
  {
    ...
    if (((*v4)[1] & 0x18) != 0 && !v4[1])
    {
      ...
      if (v6)
      {
        ...
        v13 = -1431655766;
        v14 = -1431655766;
        v7 = [MEMORY[0x1E696AE88] scannerWithString:string];
        ...
        {
          string = [MEMORY[0x1E696AEC0] stringWithFormat:@"rgba(%d, %d, %d, 1)", (vcvtd_n_f64_u32(v15, 0x10uLL) * 255.0), (vcvtd_n_f64_u32(v14, 0x10uLL) * 255.0), (vcvtd_n_f64_u32(v13, 0x10uLL) * 255.0)];
        }
...
LABEL_12:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 134218496;
    ...
    v19 = 2048;
    v20 = v13;
    _os_log_impl(&dword_1B0389000, v10, OS_LOG_TYPE_INFO, "elapsed time %gs (input length=%ld, output length=%lu)", buf, 0x20u);
  }
}
