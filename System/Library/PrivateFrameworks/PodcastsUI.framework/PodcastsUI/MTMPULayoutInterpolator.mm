...
- (id)description
{
  ...
  if (v10 != v11)
  {
    ...
    do
    {
      ...
      MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(&v19, v10);
      v14 = v19;
      v15 = v20;
      if (v19 != v20)
      {
...
- (void)addValue:(double)value forReferenceMetric:(double)metric secondaryReferenceMetric:(double)referenceMetric
{
  ...
  if (end == begin)
  {
    ...
    MTMPU::LayoutInterpolator::EntriesContainer::insertEntry(&v22, v28, v29);
    v19 = v22;
    v25 = v22;
    __p = v23;
    v27 = v24;
  ...
  else
  {
    ...
    if (v16)
    {
      MTMPU::LayoutInterpolator::EntriesContainer::insertEntry(&v22, begin, *&referenceMetricCopy);
      v19 = v22;
      v25 = v22;
      __p = v23;
      v27 = v24;
    ...
    {
      MTMPU::LayoutInterpolator::EntriesContainer::insertEntry(&v22, v28, *&referenceMetricCopy);
      v19 = v22;
      v25 = v22;
      __p = v23;
      v27 = v24;
...
- (double)_interpolatedValueForPrimaryReferenceMetric:(double)metric secondaryReferenceMetric:(double)referenceMetric betweenFirstEntriesContainer:(void *)container andSecondEntriesContainer:(void *)entriesContainer
{
  ...
  if (v11 == 1 && v12 == 1)
  {
    MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(&v62, container);
    v13 = *(v62.n128_u64[0] + 8);
    v14 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(container);
    MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(&__p, entriesContainer);
    v15 = *(__p + 1);
...
- (vector<MTMPU::Point3D,)_sortedPointsFor3DInterpolationFromEntriesContainer:(MTMPULayoutInterpolator *)self usingQueriedPoint:(SEL)point fallbackSecondaryReferenceMetric:(void *)metric
{
  ...
  retstr->var1 = 0;
  retstr->var2 = 0;
  MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(&__p, metric);
  v13 = __p;
  v14 = v22;
  while (v13 != v14)
  {
          ...
          if (v12 > 2)
          {
            switch(v12)
            {
              case 3:
                ...
                std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v10, (v10 + 24), a2 - 3, interpolation);
                return;
              case 4:
                std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v10, (v10 + 24), (v10 + 48), interpolation);
                v65 = *(a2 - 3);
                v66 = *(a2 - 2);
                v64 = a2 - 24;
                v67 = interpolation[1];
              ...
              case 5:
                ...
                std::__sort5[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v10, v10 + 24, v10 + 48, v10 + 72, a2 - 24, interpolation);
                return;
            }
          }
...
LABEL_79:
          ...
          if (v11 < 0xC01)
          {
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>((result + 24 * v13), result, a2 - 3, interpolation);
          }

          else
          {
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(result, (result + 24 * v13), a2 - 3, interpolation);
            v15 = 3 * v13;
            v16 = (result + 24 * v13 - 24);
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>((result + 24), v16, a2 - 6, interpolation);
            v17 = (result + 24 + 8 * v15);
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>((result + 48), v17, a2 - 9, interpolation);
...
LABEL_36:
        std::__introsort<std::_ClassicAlgPolicy,[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,false>(result, v10 - 24, interpolation, point, a5 & 1);
        a5 = 0;
      }

      v42 = std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *>(result, v10 - 24, interpolation);
      if (std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *>(v10, a2, interpolation))
      {
        break;
      }
