...
- (id)nextBatchWithSize:(unint64_t)size
{
  ...
  v15 = objc_msgSend_predicateWithFormat_(v8, v13, @"%K > %lld", v14, @"rowID", RowID);
  ...
  v33 = objc_msgSend_synchronousDatabase(IMDDatabase, v30, v31, v32);
  v60 = v7;
  ...
  v53[3] = &unk_1E7CB6860;
  v53[4] = &v54;
  objc_msgSend_fetchAttachmentRecordsFilteredUsingPredicate_sortedUsingDescriptors_limit_completionHandler_(v33, v36, v29, v35, size, v53);
