...
- (id)trifbCreateMobileAssetReferenceUsingBlock:()TRIFBMobileAssetReference
{
  ...
  if (!v5)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:2374 description:{@"Invalid parameter not satisfying: %@", @"block"}];
  }
  ...
  {
    v30.receiver = v7;
    v30.super_class = TRIFBMobileAssetReferenceBuilder;
    ...
    if (v13)
    {
      ...
      if (v18 >= 5 && v17[2])
      {
        if (v18 >= 7 && v17[3])
        {
          ...
          [currentHandler2 handleFailureInMethod:sel__finish object:v7 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:2281 description:{@"%@", @"Failed to set required field version on a table of type: TRIFBMobileAssetReferenceBuilder"}];
        ...
        else
        {
          ...
          [currentHandler3 handleFailureInMethod:sel__finish object:v7 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:2270 description:{@"%@", @"Failed to set required field specifier on a table of type: TRIFBMobileAssetReferenceBuilder"}];
      ...
      else
      {
        ...
        [currentHandler4 handleFailureInMethod:sel__finish object:v7 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:2259 description:{@"%@", @"Failed to set required field type on a table of type: TRIFBMobileAssetReferenceBuilder"}];
...
- (id)trifbFinishedBufferWithRootMobileAssetReferenceOfs:()TRIFBMobileAssetReference error:
{
  ...
  {
    currentHandler = [MEMORY[0x277CCA890] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:2396 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
  ...
  else
  {
    ...
    v22 = 0;
    v12 = [self trifbFinishBufferWithRootMobileAssetReferenceOfs:v7 error:&v22];
    v13 = v22;
    if (v12)
    {
      v21 = v13;
...
- (uint64_t)trifbFinishBufferWithRootMobileAssetReferenceOfs:()TRIFBMobileAssetReference error:
{
  ...
  {
    currentHandler = [MEMORY[0x277CCA890] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:2430 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
