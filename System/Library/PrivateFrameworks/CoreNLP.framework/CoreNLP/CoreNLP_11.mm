...
void *std::__tree<std::__value_type<std::string,BloomFilter>,std::__map_value_compare<std::string,std::__value_type<std::string,BloomFilter>,std::less<std::string>,true>,std::allocator<std::__value_type<std::string,BloomFilter>>>::__emplace_unique_key_args<std::string,std::pair<std::string,BloomFilter>>(uint64_t **a1, const void **a2, uint64_t a3)
{
  result = *std::__tree<std::string>::__find_equal<std::string>(a1, &v4, a2);
  if (!result)
  {
    std::__tree<std::__value_type<std::string,BloomFilter>,std::__map_value_compare<std::string,std::__value_type<std::string,BloomFilter>,std::less<std::string>,true>,std::allocator<std::__value_type<std::string,BloomFilter>>>::__construct_node<std::pair<std::string,BloomFilter>>();
  }
...
void sub_19D23250C(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
...
void NLModelTrainerTrainAndCopyContainer(CoreNLP *a1, void *a2, std::string *a3, std::string *a4, uint64_t a5)
{
  v10 = CoreNLP::unwrapGazetteer(a1, a2);
  v11 = NLModelTrainerTrainAndCopyModelDict(a1, a2, a3, a4, a5);
  if (v11)
  {
    v12 = v11;
    ...
    {
      values = CFDictionaryGetValue(v12, kNLModelTrainerModelDataKey);
      Copy = CFArrayCreate(0, &values, 1, MEMORY[0x1E695E9C0]);
    }
    ...
    else
    {
      ...
      {
        NLModelContainerCreate(*(v10 + 168), 0, 0, Value, 0);
      }

      v16 = CFDictionaryGetValue(v12, kNLModelTrainerModelDataArrayKey);
      Copy = CFArrayCreateCopy(0, v16);
    }

    NLModelContainerCreate(*(v10 + 168), 0, 0, Value, Copy);
  }

  v15 = *(v10 + 168);

  NLModelContainerCreate(v15, 0, 0, 0, 0);
}

const __CFDictionary *NLModelTrainerTrainAndCopyModelDict(CoreNLP *a1, const __CFDictionary *(*a2)(void *, BOOL *), std::string *a3, std::string *a4, uint64_t a5)
{
  if (!a2 || !a1 || !a3)
  {
    return 0;
  ...
  CoreNLP::NLModelTrainer::setLogBlock(v8, a5);

  return CoreNLP::NLModelTrainer::copyTrainedModelDict(v8);
}

void NLModelTrainerTrainAndCopyContainerAndPredictedLabels(CoreNLP *a1, void *a2, std::string *a3, std::string *a4, __CFDictionary **a5, uint64_t a6)
{
  v12 = CoreNLP::unwrapGazetteer(a1, a2);
  v13 = NLModelTrainerTrainAndCopyModelDict(a1, a2, a3, a4, a6);
  if (!v13)
  {
    v17 = *(v12 + 168);

    NLModelContainerCreate(v17, 0, 0, 0, 0);
  }
  ...
  {
    values = CFDictionaryGetValue(v14, kNLModelTrainerModelDataKey);
    Copy = CFArrayCreate(0, &values, 1, MEMORY[0x1E695E9C0]);
  }
  ...
  else
  {
    ...
    v18 = CFDictionaryGetValue(v14, kNLModelTrainerModelDataArrayKey);
...
LABEL_10:
  ...
  *a5 = Mutable;
LABEL_35:
  NLModelContainerCreate(*(v12 + 168), 0, 0, Value, v19);
}

__CFData *NLModelTrainerTrainAndCopyModelData(CoreNLP *a1, const __CFDictionary *(*a2)(void *, BOOL *), std::string *a3, std::string *a4, uint64_t a5)
{
  if (!a2 || !a1 || !a3)
  {
    return 0;
...
void NLModelReadSamplesIntoTrainer(CoreNLP *a1, const __CFDictionary *(*a2)(void *, BOOL *), std::string *a3, std::string *a4)
{
  v44 = CoreNLP::unwrapGazetteer(a1, a2);
  __p = 0;
  v60 = 0;
  v61 = 0;
  v56 = 0;
  ...
  std::vector<std::pair<void *,CoreNLP::NLTrainerDataType>>::push_back[abi:ne200100](&v53, &v62);
  if (a4)
  {
    v62.__first_ = a4;
    LODWORD(v62.__begin_) = 1;
    std::vector<std::pair<void *,CoreNLP::NLTrainerDataType>>::push_back[abi:ne200100](&v53, &v62);
  }
...
LABEL_47:
  ...
  else
  {
    ...
    do
    {
      ...
      {
        v60 = __p;
        p_data = &v56->__r_.__value_.__l.__data_;
        v7 = v57;
        while (v7 != p_data)
        {
          v8 = *(v7 - 1);
        ...
        Value = CFDictionaryGetValue(v9, kNLModelSampleDataTextKey);
        v11 = CFDictionaryGetValue(v10, kNLModelSampleDataLabelArrayKey);
        v12 = CFDictionaryGetValue(v10, kNLModelSampleDataRangeLocationArrayKey);
        v13 = CFDictionaryGetValue(v10, kNLModelSampleDataRangeLengthArrayKey);
        Count = CFArrayGetCount(v11);
        v15 = CFArrayGetCount(v12);
        v16 = CFArrayGetCount(v13);
        if (Count == v15 && Count == v16)
        {
          if (Count >= 1)
          {
            for (i = 0; i != Count; ++i)
            {
              ...
              v19 = CFArrayGetValueAtIndex(v13, i);
              CFNumberGetValue(v19, kCFNumberCFIndexType, &valuePtr + 8);
              v20 = v60;
              if (v60 >= v61)
              {
                v22 = (v60 - __p) >> 4;
                ...
                if (v25)
                {
                  std::__allocate_at_least[abi:ne200100]<std::allocator<CFRange>>(&__p, v25);
                }
                ...
                *v26 = valuePtr;
                v21 = 16 * v22 + 16;
                v27 = (16 * v22 - (v60 - __p));
                memcpy(v26 - (v60 - __p), __p, v60 - __p);
                v28 = __p;
                __p = v27;
                v60 = v21;
                v61 = 0;
              ...
              v60 = v21;
              v29 = CFArrayGetValueAtIndex(v11, i);
              CoreNLP::getUTF8StringFromCFString(v49, v29);
              v30 = v57;
              if (v57 >= v58)
              {
                v32 = 0xAAAAAAAAAAAAAAABLL * ((v57 - v56) >> 3);
                v33 = v32 + 1;
                ...
                if (0x5555555555555556 * ((v58 - v56) >> 3) > v33)
                {
                  v33 = 0x5555555555555556 * ((v58 - v56) >> 3);
                }
                ...
                v62.__end_cap_.__value_ = &v56;
                if (v34)
                {
                  std::__allocate_at_least[abi:ne200100]<std::allocator<std::string>>(&v56, v34);
                }
                ...
                *v35 = v36;
                ...
                v37 = 24 * v32 + 24;
                v38 = (24 * v32 - (v57 - v56));
                memcpy((v35 - (v57 - v56)), v56, v57 - v56);
                v39 = v56;
                v40 = v58;
                v56 = v38;
                v57 = v37;
          ...
          {
            v41 = __ROR8__(0xCCCCCCCCCCCCCCCDLL * v46 + 0x1999999999999998, 1) < 0x1999999999999999uLL;
          }

          CoreNLP::NLModelTrainer::readSample(v44, Value, &__p, &v56, v41);
          CFRelease(v10);
          ++v46;
        }
      }
...
void sub_19D23303C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, void *a16, uint64_t a17, int a18, __int16 a19, char a20, char a21, uint64_t a22, uint64_t a23, uint64_t a24, char *__p, char *a26, uint64_t a27, char a28, uint64_t a29, uint64_t a30, void *a31, uint64_t a32)
{
  if (__p)
  {
    a26 = __p;
...
uint64_t NLModelCreateWithContainer(CoreNLP *a1, void *a2)
{
  ...
  {
    v19 = NLModelContainerCopyModelDataAtIndex(a1, 0);
    NLModelCreate(v19);
  }

  if (NLModelContainerGetType(a1, v3) == 9)
  {
    ModelDataCount = NLModelContainerGetModelDataCount(a1, v4);
    Mutable = CFArrayCreateMutable(0, ModelDataCount, MEMORY[0x1E695E9C0]);
    v19 = Mutable;
    if (ModelDataCount >= 1)
    {
      for (i = 0; i != ModelDataCount; ++i)
      {
        v9 = NLModelContainerCopyModelDataAtIndex(a1, i);
        theDict = v9;
    ...
    v17 = @"en";
    theDict = NLModelContainerCopyInfoDictionary(a1, v6);
    if (CFDictionaryContainsKey(theDict, kNLModelTrainerLanguageKey))
    {
      Value = CFDictionaryGetValue(theDict, kNLModelTrainerLanguageKey);
      CFRelease(@"en");
      v17 = Value;
    }
    ...
    else
    {
      ...
      v16 = MutableCopy;
      CFDictionaryAddValue(MutableCopy, kNLModelTrainerLanguageKey, @"en");
      nlp::CFScopedPtr<__CFDictionary const*>::acquire(&theDict, MutableCopy);
      if (MutableCopy)
      {
    ...
    v16 = v12;
    CFDictionaryAddValue(v12, kNLModelTrainerModelDataArrayKey, Mutable);
    CFDictionaryAddValue(v12, kNLModelTrainerModelMetadataKey, theDict);
    CFDictionaryAddValue(v12, kNLModelTrainerLanguageKey, Value);
    valuePtr = 9;
    v14 = CFNumberCreate(0, kCFNumberIntType, &valuePtr);
    CFDictionaryAddValue(v12, kNLModelTrainerModelMethodTypeKey, v14);
    NLModelTrainerCreate(v12);
  }

  return 0;
}

void sub_19D23332C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va3, a5);
  va_start(va2, a5);
  va_start(va1, a5);
  ...
  nlp::CFScopedPtr<__CFDictionary const*>::reset(va2, 0);
  nlp::CFScopedPtr<__CFArray *>::reset(va3, 0);
  _Unwind_Resume(a1);
}

void sub_19D23345C(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    std::__shared_weak_count::__release_shared[abi:ne200100](a10);
...
uint64_t NLModelCopyContainer(CoreNLP *a1, void *a2)
{
  if (a1)
  {
    ...
    v3 = CoreNLP::NLModelTrainer::copyModelDict(v2);
    Value = CFDictionaryGetValue(v3, kNLModelTrainerModelMetadataKey);
    values[0] = 0;
    values[1] = 0;
    CFDictionaryRef = applesauce::CF::details::make_CFDictionaryRef(values);
    cf = CFDictionaryRef;
    if (!Value)
    {
    ...
    {
      values[0] = CFDictionaryGetValue(v3, kNLModelTrainerModelDataKey);
      v6 = CFArrayCreate(0, values, 1, MEMORY[0x1E695E9C0]);
    }
    ...
    {
      v7 = CFDictionaryGetValue(v3, kNLModelTrainerModelDataArrayKey);
      v6 = CFRetain(v7);
    }

    if (v6)
    {
      NLModelContainerCreate(v2[42], 0, 0, Value, v6);
    }
...
void sub_19D2336F8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
...
CoreNLP *NLModelCopyModelData(CoreNLP *result, void *a2)
{
  if (result)
  {
    ...
    return CoreNLP::NLModelTrainer::copyModelData(v2);
  }

  return result;
}

void std::vector<std::pair<void *,CoreNLP::NLTrainerDataType>>::push_back[abi:ne200100](uint64_t a1, _OWORD *a2)
{
  v5 = *(a1 + 8);
  v4 = *(a1 + 16);
  if (v5 >= v4)
  {
    ...
    if (v10)
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<std::pair<void *,CoreNLP::NLTrainerDataType>>>(a1, v10);
    }
...
void std::shared_ptr<CoreNLP::NLModelTrainer>::shared_ptr[abi:ne200100]<CoreNLP::NLModelTrainer,0>(void *a1, uint64_t a2)
{
  *a1 = a2;
  v2 = a2;
  operator new();
...
void sub_19D233898(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  std::unique_ptr<CoreNLP::NLModelTrainer>::~unique_ptr[abi:ne200100](va);
  _Unwind_Resume(a1);
}

CoreNLP::NLModelTrainer **std::unique_ptr<CoreNLP::NLModelTrainer>::~unique_ptr[abi:ne200100](CoreNLP::NLModelTrainer **a1)
{
  v2 = *a1;
  *a1 = 0;
  if (v2)
  {
    CoreNLP::NLModelTrainer::~NLModelTrainer(v2);
    MEMORY[0x19EAF8CA0]();
  }
...
void std::__allocate_at_least[abi:ne200100]<std::allocator<std::pair<void *,CoreNLP::NLTrainerDataType>>>(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 60))
  {
    operator new();
...
void *Darts::DoubleArrayImpl<void,void,int,void>::~DoubleArrayImpl(void *a1)
{
  ...
  *a1 = &unk_1F10B0398;
  ...
  if (v2)
  {
    MEMORY[0x19EAF8C70](v2, 0x1000C8052888210);
    a1[3] = 0;
  }
...
void sub_19D233B44(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
...
void sub_19D2341FC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
...
void sub_19D234738(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sentencepiece::ModelInterface::~ModelInterface(sentencepiece::ModelInterface *this)
{
  ...
  *(this + 3) = &unk_1F10B0398;
  ...
  if (v3)
  {
    MEMORY[0x19EAF8C70](v3, 0x1000C8052888210);
    *(this + 6) = 0;
  }
...
void sub_19D234FA8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19D23504C(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_19D23529C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19D235530(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, void *a16, uint64_t a17)
{
  *(v17 + 8) = v18;
  if (a15 < 0)
  {
...
void sub_19D2356CC(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_19D235A90(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *a10, uint64_t a11, int a12, __int16 a13, char a14, char a15, void *__p, uint64_t a17)
{
  if (__p)
  {
    operator delete(__p);
...
LABEL_69:
  ...
  std::__tree<std::__value_type<NLLanguageID,__CFString const*>,std::__map_value_compare<NLLanguageID,std::__value_type<NLLanguageID,__CFString const*>,std::less<NLLanguageID>,true>,std::allocator<std::__value_type<NLLanguageID,__CFString const*>>>::destroy(&v44, v45[0]);
  std::__tree<std::__value_type<NLLanguageID,__CFString const*>,std::__map_value_compare<NLLanguageID,std::__value_type<NLLanguageID,__CFString const*>,std::less<NLLanguageID>,true>,std::allocator<std::__value_type<NLLanguageID,__CFString const*>>>::destroy(&v46, v47);
  std::__tree<std::__value_type<NLLanguageID,__CFString const*>,std::__map_value_compare<NLLanguageID,std::__value_type<NLLanguageID,__CFString const*>,std::less<NLLanguageID>,true>,std::allocator<std::__value_type<NLLanguageID,__CFString const*>>>::destroy(&v49, v50);
}

void sub_19D236114(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, void *a16, uint64_t a17, uint64_t a18, uint64_t a19, void *a20, uint64_t a21, uint64_t a22, void *a23, uint64_t a24, uint64_t a25, void *a26)
{
  ...
  std::__tree<std::__value_type<NLLanguageID,__CFString const*>,std::__map_value_compare<NLLanguageID,std::__value_type<NLLanguageID,__CFString const*>,std::less<NLLanguageID>,true>,std::allocator<std::__value_type<NLLanguageID,__CFString const*>>>::destroy(&a19, a20);
  ...
  std::__tree<std::__value_type<NLLanguageID,__CFString const*>,std::__map_value_compare<NLLanguageID,std::__value_type<NLLanguageID,__CFString const*>,std::less<NLLanguageID>,true>,std::allocator<std::__value_type<NLLanguageID,__CFString const*>>>::destroy(&a25, a26);
  _Unwind_Resume(a1);
}
...
void sub_19D2367F0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, uint64_t a14, void *a15, uint64_t a16, uint64_t a17, void *a18, uint64_t a19)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19D236B80(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *__p, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a20 < 0)
  {
    operator delete(__p);
...
void sub_19D23701C(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_19D2370E4(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void sub_19D2371CC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_19D237608(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19D237CAC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
...
void std::deque<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State,std::allocator<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State>>::__add_back_capacity(unint64_t *a1)
{
  ...
  if (!v2)
  {
    ...
    v10 = a1;
    std::__allocate_at_least[abi:ne200100]<std::allocator<CoreNLP::SubWordTagger *>>(a1, v8);
  }
...
void sub_19D237F2C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13)
{
  operator delete(v13);
  if (__p)
  {
...
void std::__split_buffer<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *,std::allocator<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *>>::emplace_back<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *&>(unint64_t *a1, void *a2)
{
  ...
  if (v4 == a1[3])
  {
    ...
    if (v5 <= *a1)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<CoreNLP::SubWordTagger *>>(a1, v11);
    }
...
void std::__split_buffer<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *,std::allocator<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *>>::emplace_front<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *>(const void **a1, void *a2)
{
  ...
  if (v4 == *a1)
  {
    ...
    if (v6 >= v7)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<CoreNLP::SubWordTagger *>>(a1, v9);
    }
...
void std::__split_buffer<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *,std::allocator<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *> &>::emplace_back<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *>(unint64_t *a1, void *a2)
{
  ...
  if (v4 == a1[3])
  {
    ...
    if (v5 <= *a1)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<CoreNLP::SubWordTagger *>>(a1[4], v11);
    }
...
void std::__split_buffer<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *,std::allocator<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *> &>::emplace_front<unsigned long Darts::DoubleArrayImpl<void,void,int,void>::predictiveSearch<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>(char const*,Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type *,unsigned long,unsigned long,int)::State *&>(const void **a1, void *a2)
{
  ...
  if (v4 == *a1)
  {
    ...
    if (v6 >= v7)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<CoreNLP::SubWordTagger *>>(a1[4], v9);
    }
...
void std::vector<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type,std::allocator<Darts::DoubleArrayImpl<void,void,int,void>::result_pair_type>>::__append(uint64_t a1, unint64_t a2)
{
  ...
  else
  {
    ...
    if (v9)
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<std::pair<float,unsigned long>>>(a1, v9);
    }
...
void sub_19D238620(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
...
void sub_19D238928(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 + 8) = v10;
...
void sub_19D238AF8(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_19D238E48(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
uint64_t *Darts::Details::AutoPool<unsigned char>::~AutoPool(uint64_t *a1)
{
  ...
  if (*a1)
  {
    MEMORY[0x19EAF8C70](*a1, 0x1000C8077774924);
    *a1 = 0;
  }
...
uint64_t Darts::Details::AutoPool<unsigned char>::clear(uint64_t *a1)
{
  ...
  if (*a1)
  {
    result = MEMORY[0x19EAF8C70](result, 0x1000C8077774924);
    *a1 = 0;
  }
...
uint64_t Darts::Details::BitVector::clear(Darts::Details::BitVector *this)
{
  ...
  if (result)
  {
    result = MEMORY[0x19EAF8C70](result, 0x1000C8052888210);
    *(this + 3) = 0;
  }
...
uint64_t *Darts::Details::AutoPool<unsigned int>::resize(uint64_t *result, unint64_t a2, int *a3)
{
  ...
  if (a2 > v3)
  {
    ...
    {
      v9 = vdupq_n_s64(v5);
      v10 = vmovn_s64(vcgeq_u64(v7, vorrq_s8(v9, xmmword_19D27D560)));
      ...
      if (vuzp1_s16(*&v7, vmovn_s64(vcgeq_u64(v7, vorrq_s8(v9, xmmword_19D27D820)))).i32[1])
      {
        *v8 = v6;
        v8[1] = v6;
      }
...
void Darts::Details::DoubleArrayBuilder::~DoubleArrayBuilder(Darts::Details::DoubleArrayBuilder *this)
{
  ...
  if (v2)
  {
    MEMORY[0x19EAF8C70](v2, 0x1000C80CBA68D63);
    *(this + 4) = 0;
  }
  ...
  *(this + 18) = 0;
  ...
  if (v4)
  {
    MEMORY[0x19EAF8C70](v4, 0x1000C80CBA68D63);
    *(this + 4) = 0;
  }
...
void sub_19D23C340(_Unwind_Exception *a1)
{
...
void sub_19D23C4E8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sentencepiece::util::Status::~Status(va);
  _Unwind_Resume(a1);
...
void sub_19D23C58C(_Unwind_Exception *a1)
{
  sentencepiece::util::Status::~Status((v1 + 56));
  v4 = *v2;
  *v2 = 0;
...
void sub_19D23C6E0(_Unwind_Exception *a1)
{
  sentencepiece::util::Status::~Status((v1 + 56));
  v4 = *v2;
  *v2 = 0;
...
LABEL_72:
  ...
  *(&v42 + *(v42 - 24)) = *(MEMORY[0x1E69E54E8] + 24);
  ...
  std::ostream::~ostream();
  return MEMORY[0x19EAF8C10](&v46);
}

void sub_19D23D048(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sentencepiece::util::StatusBuilder::~StatusBuilder(va);
  _Unwind_Resume(a1);
...
void sub_19D23D3F4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11)
{
...
void sub_19D23D6F8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_19D23D998(_Unwind_Exception *exception_object, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, __int16 a10, char a11, char a12, void *__p, uint64_t a14)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19D23DB84(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  *v1 = 0;
  if (v3)
...
void sub_19D23DF08(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
...
void sub_19D23E248(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sentencepiece::error::Die::~Die(va);
  _Unwind_Resume(a1);
...
void sub_19D23EA48(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
void sub_19D23EE6C(_Unwind_Exception *exception_object)
{
  if (*(v1 - 41) < 0)
  {
...
void sub_19D23F03C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_19D23F108(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, sentencepiece::ModelProto *a9, sentencepiece::ModelProto *a10)
{
  std::unique_ptr<sentencepiece::ModelProto>::~unique_ptr[abi:ne200100](&a9);
...
void sub_19D23FF80(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *a15, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sentencepiece::SentencePieceProcessor::ParseExtraOptions(sentencepiece::ModelInterface **a1@<X0>, uint64_t a2@<X1>, unint64_t a3@<X2>, void *a4@<X3>, sentencepiece::util::Status *a5@<X8>)
{
  ...
  if (a3)
  {
    ...
    if (!*a5)
    {
      ...
      {
        v39[3] = xmmword_1E7625CF8;
        *__p = unk_1E7625D08;
        v41 = xmmword_1E7625D18;
        v42 = 3;
        v38 = xmmword_1E7625CB8;
        v39[0] = unk_1E7625CC8;
        v39[1] = xmmword_1E7625CD8;
        v39[2] = *&off_1E7625CE8;
        ...
        __cxa_atexit(std::map<std::string_view,sentencepiece::SentencePieceProcessor::ExtraOption>::~map[abi:ne200100], &sentencepiece::SentencePieceProcessor::ParseExtraOptions(std::string_view,std::vector<sentencepiece::SentencePieceProcessor::ExtraOption> *)const::extra_option_map, &dword_19D184000);
      }
  ...
  if (*(v8 + 16) >= 1)
  {
    ...
    do
    {
      ...
      if ((*(v11 + 60) - 2) >= 3)
      {
        ...
        v21[0] = v13;
        v21[1] = v14;
        if (&v23 == std::__tree<std::string_view>::find<std::string_view>(&v22, v21) && ((v15 = *(v12 + 48) & 0xFFFFFFFFFFFFFFFELL, v16 = *(v15 + 23), v16 < 0) ? (v17 = *v15, v16 = *(v15 + 8)) : (v17 = (*(v12 + 48) & 0xFFFFFFFFFFFFFFFELL)), v16 != asc_19D294130[*v17 >> 4]))
        {
...
LABEL_31:
  ...
  sentencepiece::util::Status::Status(a3);
  std::__tree<std::__value_type<NLLanguageID,__CFString const*>,std::__map_value_compare<NLLanguageID,std::__value_type<NLLanguageID,__CFString const*>,std::less<NLLanguageID>,true>,std::allocator<std::__value_type<NLLanguageID,__CFString const*>>>::destroy(&v22, v23);
}
...
void sub_19D2419AC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10)
{
  __p = (v10 - 176);
  std::vector<std::string>::__destroy_vector::operator()[abi:ne200100](&__p);
  __p = (v10 - 152);
...
BOOL absl::SimpleAtoi<int>(const char *a1, uint64_t a2, uint64_t a3)
{
  ...
  *(v11 + *(v11[0] - 24)) = *(MEMORY[0x1E69E54D8] + 64);
  ...
  MEMORY[0x19EAF8C10](&v16);
  return v7;
}

void sub_19D241C94(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>>::~basic_stringstream(va, MEMORY[0x1E69E54D8]);
  MEMORY[0x19EAF8C10](v3 + 128);
  _Unwind_Resume(a1);
}
  ...
  if (!*a5)
  {
    ...
    else
    {
      ...
      *(&v24 + *(v24 - 24)) = *(MEMORY[0x1E69E54E8] + 24);
      ...
      std::ostream::~ostream();
      MEMORY[0x19EAF8C10](&v31);
    }
  }
}

void sub_19D242400(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sentencepiece::util::StatusBuilder::~StatusBuilder(va);
  _Unwind_Resume(a1);
...
void sub_19D2424B8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19D242E54(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sentencepiece::util::StatusBuilder::~StatusBuilder(va);
  _Unwind_Resume(a1);
...
void sub_19D2439D8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sentencepiece::util::StatusBuilder::~StatusBuilder(va);
  _Unwind_Resume(a1);
...
void sub_19D243E48(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  sentencepiece::util::StatusBuilder::~StatusBuilder(va);
  _Unwind_Resume(a1);
...
LABEL_130:
  ...
  *(&__p[1] + *(__p[1] - 3)) = *(MEMORY[0x1E69E54E8] + 24);
  ...
  std::ostream::~ostream();
  return MEMORY[0x19EAF8C10](&v100);
}