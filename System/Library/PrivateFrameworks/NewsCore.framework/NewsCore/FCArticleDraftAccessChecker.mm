...
- (FCArticleDraftAccessChecker)initWithPrivateChannelMembershipController:(id)controller
{
  ...
  v10.receiver = self;
  v10.super_class = FCArticleDraftAccessChecker;
...
LABEL_6:
  ...
  {
    v17.receiver = self;
    v17.super_class = FCArticleDraftAccessChecker;
  ...
  else
  {
    ...
    v15 = itemCopy;
    v16 = completionCopy;
    [privateChannelMembershipController isAllowedToSeeArticleID:identifier completionBlock:v14];
  }
}
