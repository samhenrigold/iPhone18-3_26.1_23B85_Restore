...
- (FCNewsTabiNotificationScoringEndpoint)initWithDictionary:(id)dictionary;
- (id)description;
@end
...
- (FCNewsTabiNotificationScoringEndpoint)initWithDictionary:(id)dictionary
{
  ...
  {
    v7 = v5;
    v8 = [[FCNewsTabiNotificationScoringConfiguration alloc] initWithDictionary:dictionaryCopy];
    v9 = v8;
    if (v8)
    {
      v10 = v8;
    ...
    else
    {
      ...
      v19[3] = &unk_1E7C36F98;
      v20 = dictionaryCopy;
      selfCopy = __60__FCNewsTabiNotificationScoringEndpoint_initWithDictionary___block_invoke_5(v19);
      v10 = v20;
    }
  }
  ...
  else
  {
    ...
    v21[3] = &unk_1E7C36F98;
    v22 = dictionaryCopy;
    selfCopy = __60__FCNewsTabiNotificationScoringEndpoint_initWithDictionary___block_invoke(v21);
    v7 = v22;
  }
...
uint64_t __60__FCNewsTabiNotificationScoringEndpoint_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1B63EF000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiNotificationScoringEndpoint due to failure to decode packageAssetID from configuration %{public}@", &v7, 0xCu);
  }
...
uint64_t __60__FCNewsTabiNotificationScoringEndpoint_initWithDictionary___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1B63EF000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiNotificationScoringEndpoint due to failure to decode configuration from configuration %{public}@", &v7, 0xCu);
  }
...
- (id)description
{
  ...
  packageAssetID = [(FCNewsTabiNotificationScoringEndpoint *)self packageAssetID];
  [v3 appendFormat:@"\n\tpackageAssetID: %@;", packageAssetID];

  configuration = [(FCNewsTabiNotificationScoringEndpoint *)self configuration];
  indentedDescription = [configuration indentedDescription];
  [v3 appendFormat:@"\n\tconfiguration: %@;", indentedDescription];

  eventAggregationOutputs = [(FCNewsTabiNotificationScoringEndpoint *)self eventAggregationOutputs];
