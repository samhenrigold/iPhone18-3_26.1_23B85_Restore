...
uint64_t __56__FCNewsTabiRecommendedTagsEndpoint_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1B63EF000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiRecommendedTagsEndpoint due to failure to decode packageAssetID from configuration %{public}@", &v7, 0xCu);
  }
...
uint64_t __56__FCNewsTabiRecommendedTagsEndpoint_initWithDictionary___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1B63EF000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiRecommendedTagsEndpoint due to failure to decode configuration from configuration %{public}@", &v7, 0xCu);
  }
