      ...
      if (munmap(mappedAddress, pageAlignedSize))
      {
        ...
        if (os_log_type_enabled(SRLogMemoryMapping, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 134349568;
          ...
          v14 = 1026;
          v15 = v7;
          _os_log_impl(&dword_26561F000, v6, OS_LOG_TYPE_INFO, "Unable to unmap %{public}p size %zu because %{public, darwin.errno}d", buf, 0x1Cu);
          v6 = SRLogMemoryMapping;
        }
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_FAULT))
        {
          ...
          *buf = 134349568;
          ...
          v14 = 1026;
          v15 = v8;
          _os_log_fault_impl(&dword_26561F000, v6, OS_LOG_TYPE_FAULT, "Unable to unmap %{public}p size %zu because %{public, darwin.errno}d", buf, 0x1Cu);
        }
  ...
  if (result)
  {
    ...
    if (v8 == -1)
    {
      ...
      if (result)
      {
        ...
        v17 = 1026;
        v18 = v13;
        _os_log_fault_impl(&dword_26561F000, v12, OS_LOG_TYPE_FAULT, "Unable to mmap storage file %{public}@ because %{public, darwin.errno}d", &v15, 0x12u);
        return 0;
      }
    }
      ...
      *(v3 + 24) = v9;
      if (madvise(v8, v7, v10) < 0)
      {
        ...
        if (os_log_type_enabled(SRLogMemoryMapping, OS_LOG_TYPE_FAULT))
        {
          ...
          v15 = 67240192;
          LODWORD(v16) = v14;
          _os_log_fault_impl(&dword_26561F000, v11, OS_LOG_TYPE_FAULT, "Failed to madvise() because %{public, darwin.errno}d", &v15, 8u);
        }
      }
      ...
      if (v4 != v3)
      {
        if (msync(v2, v4 - v3, 16))
        {
          ...
          if (os_log_type_enabled(SRLogMemoryMapping, OS_LOG_TYPE_ERROR))
          {
            ...
            v8[0] = 67240192;
            v8[1] = v7;
            _os_log_error_impl(&dword_26561F000, v6, OS_LOG_TYPE_ERROR, "Failed to msync because %{public, darwin.errno}d", v8, 8u);
          }
        }
      }
    }
      ...
      if ((*(v4 + 8) & 2) != 0)
      {
        ...
        if (__CFADD__(v7, address))
        {
          ...
          if (result)
          {
            v14 = 134349056;
            addressCopy = address;
            _os_log_error_impl(&dword_26561F000, v8, OS_LOG_TYPE_ERROR, "%{public}zu is too large to write", &v14, 0xCu);
            return 0;
          }
        }
        ...
        else
        {
          ...
          else
          {
            ...
            if (result)
            {
              ...
              v18 = 2050;
              v19 = v10;
              _os_log_fault_impl(&dword_26561F000, v11, OS_LOG_TYPE_FAULT, "writing to %{public}p with length %{public}lu would go past end of file (%{public}p)", &v14, 0x20u);
              return 0;
            }
          }
        }
    ...
    if ([(SRMemoryMapping *)self isValidWriteToDestinationAddress:v6 withLength:bytes bytes:a2])
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(SRLogMemoryMapping, OS_LOG_TYPE_INFO))
        {
          ...
          v11 = 2050;
          v12 = v7;
          _os_log_impl(&dword_26561F000, v8, OS_LOG_TYPE_INFO, "More bytes requested %{public}zu than the capacity %{public}zu. Client should call -freeSpace: to avoid this", &v9, 0x16u);
        }
      }
    }
  }
