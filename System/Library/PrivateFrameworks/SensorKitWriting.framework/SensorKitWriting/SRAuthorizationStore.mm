...
- (SRAuthorizationStore)initWithSensors:(id)sensors withAuthorizationTimes:(BOOL)times
{
  ...
  if (self)
  {
    ...
    if (v8)
    {
      ...
      v33 = [objc_alloc(MEMORY[0x277CBEB38]) initWithCapacity:{-[NSSet count](v9->_sensors, "count")}];
      v35 = 0u;
      v36 = 0u;
      v37 = 0u;
      v38 = 0u;
...
LABEL_36:
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(SRLogAuthorizationStore, OS_LOG_TYPE_FAULT))
      {
        *v38 = 67240192;
        v39 = v11;
        _os_log_fault_impl(&dword_26561F000, v12, OS_LOG_TYPE_FAULT, "Failed to register for TCC notifications.  Got status %{public}d", v38, 8u);
      }
...
- (void)updateAuthorizations
{
      ...
      do
      {
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            *v158 = 138543362;
            v159 = v10;
            _os_log_impl(&dword_26561F000, v13, OS_LOG_TYPE_INFO, "Could not retrieve authorization information for TCC service %{public}@", v158, 0xCu);
          }
        }
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          *v158 = 138543874;
          ...
          v162 = 2114;
          v163 = v109;
          _os_log_impl(&dword_26561F000, v15, OS_LOG_TYPE_DEFAULT, "Authorized Bundle Ids for %{public}@, overridden %{public, BOOL}d, %{public}@", v158, 0x1Cu);
          v15 = *(v6 + 2824);
        }
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          *v158 = 138543874;
          ...
          v162 = 2114;
          v163 = v106;
          _os_log_impl(&dword_26561F000, v15, OS_LOG_TYPE_DEFAULT, "Deauthorized Bundle Ids for %{public}@, overridden %{public, BOOL}d, %{public}@", v158, 0x1Cu);
        }
  ...
  v100 = [MEMORY[0x277CBEAC0] dictionaryWithDictionary:{objc_msgSend(self, "readerAuthorizationValues")}];
          ...
          for (ii = 0; ii != v114; ii = ii + 1)
          {
            ...
            if (!v53)
            {
              ...
              *&v164[4] = v52;
              ...
              v65 = 12;
LABEL_108:
              _os_log_error_impl(&dword_26561F000, v63, OS_LOG_TYPE_ERROR, v64, v164, v65);
              goto LABEL_105;
            }
    ...
    do
    {
      ...
      do
      {
        ...
        if (v82 && os_log_type_enabled(*(v70 + 2824), OS_LOG_TYPE_INFO))
        {
          *v155 = 138543362;
          *&v155[4] = v77;
          _os_log_impl(&dword_26561F000, v81, OS_LOG_TYPE_INFO, "Could not retrieve authorization information for TCC service %{public}@", v155, 0xCu);
          v81 = *(v70 + 2824);
        }
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *&v155[12] = 2114;
          *&v155[14] = v78;
          _os_log_impl(&dword_26561F000, v81, OS_LOG_TYPE_DEFAULT, "Authorized Bundle Ids for %{public}@, %{public}@", v155, 0x16u);
          v81 = *(v70 + 2824);
        }
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *&v155[12] = 2114;
          *&v155[14] = v80;
          _os_log_impl(&dword_26561F000, v81, OS_LOG_TYPE_DEFAULT, "Deauthorized Bundle Ids for %{public}@, %{public}@", v155, 0x16u);
        }
...
- (void)resetAllAuthorizations
{
  ...
  v17 = &unk_279B99E08;
  v18 = v3;
  __46__SRAuthorizationStore_resetAllAuthorizations__block_invoke(v15, [(SRAuthorizationStore *)self readerAuthorizationBundleIdValues], &__block_literal_global_3);
...
- (void)resetAuthorizationForService:(id)service bundleId:(id)id
{
  ...
  if (os_log_type_enabled(SRLogAuthorizationStore, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 2114;
    idCopy = id;
    _os_log_impl(&dword_26561F000, v7, OS_LOG_TYPE_DEFAULT, "Reset authorization for service %@ and bundle id: %{public}@", &v8, 0x16u);
  }
    ...
    if (v11)
    {
      if ([id isEqualToString:@"com.apple.private.SensorKit._compositeBundle"])
      {
        ...
        if (v11)
        {
          ...
          _os_log_fault_impl(&dword_26561F000, v12, OS_LOG_TYPE_FAULT, "Setting authorization for %{public}@ is not allowed", &v15, 0xCu);
          LOBYTE(v11) = 0;
        }
      }
...
- (id)readerAuthorizationBundleIdValues
{
  ...
  return [MEMORY[0x277CBEAC0] dictionaryWithDictionary:v3];
}
