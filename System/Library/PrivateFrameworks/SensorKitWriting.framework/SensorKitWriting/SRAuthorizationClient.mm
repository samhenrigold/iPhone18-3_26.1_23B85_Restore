...
id __34__SRAuthorizationClient_syncProxy__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(SRLogAuthorizationClient, OS_LOG_TYPE_ERROR))
  {
    v6 = 138543362;
    v7 = a2;
    _os_log_error_impl(&dword_26561F000, v4, OS_LOG_TYPE_ERROR, "Failed to get sync proxy to daemon, error %{public}@", &v6, 0xCu);
  }
...
void __34__SRAuthorizationClient_syncProxy__block_invoke_36(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(SRLogAuthorizationClient, OS_LOG_TYPE_ERROR))
  {
    v4 = 138543362;
    v5 = a2;
    _os_log_error_impl(&dword_26561F000, v3, OS_LOG_TYPE_ERROR, "Failed to get sync proxy to daemon, error %{public}@", &v4, 0xCu);
  }
}
