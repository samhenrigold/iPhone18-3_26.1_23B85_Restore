...
+ (id)authorizationIdentifiersForSummaryID:(int64_t)d databaseTransaction:(id)transaction error:(id *)error;
+ (id)foreignKeys;
...
+ (id)authorizationIdentifiersForSummaryID:(int64_t)d databaseTransaction:(id)transaction error:(id *)error
{
  ...
  v16[3] = &unk_278614098;
  v12 = v10;
  LODWORD(error) = [v11 executeCachedStatementForKey:&authorizationIdentifiersForSummaryID_databaseTransaction_error__key error:error SQLGenerator:v19 bindingHandler:v18 enumerationHandler:v16];
