  ...
  if (selfCopy->_ctx)
  {
    ...
    if (selfCopy->_plan)
    {
      ...
      else
      {
        ...
        v25 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v38 count:16];
        if (v25)
        {
          v21 = *__b[2];
          v22 = 0;
          ...
          while (1)
          {
            ...
            {
              v22 = 0;
              v23 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v38 count:16];
              if (!v23)
              {
                goto LABEL_15;
              }
...
- (int64_t)_bindBuffers:(id *)buffers errorDomain:(id)domain
{
  ...
  v61 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v83 count:16];
  if (v61)
  {
    v57 = *__b[2];
    v58 = 0;
    ...
    while (1)
    {
      ...
      {
        v58 = 0;
        v59 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v83 count:16];
        if (!v59)
        {
          goto LABEL_11;
        }
...
LABEL_11:
  ...
  if (!v71)
  {
    ...
    v51 = selfCopy->_outputNameBufferMap;
    v52 = [(NSDictionary *)v51 countByEnumeratingWithState:v69 objects:v82 count:16];
    if (v52)
    {
      v48 = *v69[2];
      v49 = 0;
      ...
      while (1)
      {
        ...
        {
          v49 = 0;
          v50 = [(NSDictionary *)v51 countByEnumeratingWithState:v69 objects:v82 count:16];
          if (!v50)
          {
            goto LABEL_23;
          }
...
LABEL_23:
    ...
    if (!v71)
    {
      ...
      *selfCopy->_bufLR.data = v20;
      ...
      v40 = selfCopy->_weightNameBufferMap;
      v41 = [(NSDictionary *)v40 countByEnumeratingWithState:v63 objects:v81 count:16];
      if (v41)
      {
        v37 = *v63[2];
        v38 = 0;
...
LABEL_40:
          ...
          {
            v38 = 0;
            v39 = [(NSDictionary *)v40 countByEnumeratingWithState:v63 objects:v81 count:16];
            if (!v39)
            {
              break;
            }
...
- (id)trainOnData:(id)data numLocalIterations:(int64_t)iterations error:(id *)error errorDomain:(id)domain
{
  ...
  else
  {
    ...
    v72 = [[NSMutableArray alloc] initWithCapacity:?];
    v71 = [[NSMutableDictionary alloc] initWithCapacity:0];
      ...
      if (v69)
      {
        ...
        else
        {
          ...
          *&v13 = v66;
          ...
          NSLog(@"Loss: %.4f", v66);
          memset(__b, 0, sizeof(__b));
          v39 = selfCopy->_metricNames;
          v40 = [(NSArray *)v39 countByEnumeratingWithState:__b objects:v91 count:16];
          if (v40)
          {
            v32 = *__b[2];
            v33 = 0;
            ...
            while (1)
            {
              ...
              v27 = v61;
              LODWORD(v15) = v62;
              v28 = [NSNumber numberWithFloat:v15];
              [v27 addObject:?];
              ...
              {
                v33 = 0;
                v34 = [(NSArray *)v39 countByEnumeratingWithState:__b objects:v91 count:16];
                if (!v34)
                {
                  break;
                }
    ...
    v25 = selfCopy->_weightNames;
    v26 = [(NSArray *)v25 countByEnumeratingWithState:v58 objects:v90 count:16];
    if (v26)
    {
      v22 = *v58[2];
      v23 = 0;
      ...
      while (1)
      {
        ...
        {
          v23 = 0;
          v24 = [(NSArray *)v25 countByEnumeratingWithState:v58 objects:v90 count:16];
          if (!v24)
          {
            break;
          }
    ...
    {
      v48[0] = +[NSMutableDictionary dictionary];
...
- (id)finishInitializeManually:(id *)manually errorDomain:(id)domain
{
  ...
  v24 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v35 count:16];
  if (v24)
  {
    v20 = *__b[2];
    v21 = 0;
    ...
    while (1)
    {
      ...
      {
        v21 = 0;
        v22 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v35 count:16];
        if (!v22)
        {
          goto LABEL_13;
        }
