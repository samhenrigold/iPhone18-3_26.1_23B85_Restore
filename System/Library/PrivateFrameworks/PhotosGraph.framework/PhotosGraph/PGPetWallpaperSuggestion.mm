...
- (PGPetWallpaperSuggestion)initWithPetLocalIdentifier:(id)identifier type:(unsigned __int16)type subtype:(unsigned __int16)subtype asset:(id)asset;
@end
...
- (PGPetWallpaperSuggestion)initWithPetLocalIdentifier:(id)identifier type:(unsigned __int16)type subtype:(unsigned __int16)subtype asset:(id)asset
{
  ...
  v15.receiver = self;
  v15.super_class = PGPetWallpaperSuggestion;
