...
- (PGInvariantMotherMemoryNodeFeatureExtractor)initWithError:(id *)error
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantMotherMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"MOTHER" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_45384];
