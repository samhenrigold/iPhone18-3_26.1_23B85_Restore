...
- (PGBabyFeatureExtractor)initWithError:(id *)error
{
  ...
  v13.receiver = self;
  v13.super_class = PGBabyFeatureExtractor;
  v11 = [(PGGraphFeatureExtractor *)&v13 initWithName:@"Baby" featureNames:v4 relation:v10 labelForTargetBlock:&__block_literal_global_2506];
