...
- (PGGraphAnniversaryEventEdge)initWithLabel:(id)label sourceNode:(id)node targetNode:(id)targetNode domain:(unsigned __int16)domain properties:(id)properties;
- (PGGraphAnniversaryEventEdge)initWithLabel:(id)label sourceNode:(id)node targetNode:(id)targetNode domain:(unsigned __int16)domain weight:(float)weight properties:(id)properties;
- (id)edgeDescription;
...
- (id)edgeDescription
{
  ...
  v7.receiver = self;
  v7.super_class = PGGraphAnniversaryEventEdge;
...
- (PGGraphAnniversaryEventEdge)initWithLabel:(id)label sourceNode:(id)node targetNode:(id)targetNode domain:(unsigned __int16)domain weight:(float)weight properties:(id)properties
{
  ...
  v22 = [(PGGraphAnniversaryEventEdge *)self initWithLabel:labelCopy sourceNode:nodeCopy targetNode:targetNodeCopy domain:domainCopy properties:propertiesCopy];
...
- (PGGraphAnniversaryEventEdge)initWithLabel:(id)label sourceNode:(id)node targetNode:(id)targetNode domain:(unsigned __int16)domain properties:(id)properties
{
  ...
  v15 = [(PGGraphAnniversaryEventEdge *)self initFromMomentNode:nodeCopy toPersonNode:targetNodeCopy confidence:v14];
  return v15;
}
...
+ (id)filter
{
  v2 = [objc_alloc(MEMORY[0x277D22C20]) initWithLabel:@"ANNIVERSARY" domain:301];
