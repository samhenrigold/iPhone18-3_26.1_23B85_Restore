...
- (PGInvariantFamilyFeatureExtractor)initWithError:(id *)error
{
  ...
  v15.receiver = self;
  v15.super_class = PGInvariantFamilyFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:v4 featureNames:v5 relation:v12 labelForTargetBlock:&__block_literal_global_22067];
