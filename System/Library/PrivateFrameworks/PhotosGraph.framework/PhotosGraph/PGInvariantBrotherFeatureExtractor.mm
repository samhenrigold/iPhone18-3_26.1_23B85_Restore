...
- (PGInvariantBrotherFeatureExtractor)initWithError:(id *)error
{
  ...
  v15.receiver = self;
  v15.super_class = PGInvariantBrotherFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:@"BROTHER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_38138];
