...
- (PGInvariantFatherMemoryNodeFeatureExtractor)initWithError:(id *)error
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantFatherMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"FATHER" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_69202];
