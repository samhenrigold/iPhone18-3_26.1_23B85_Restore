...
- (PGInvariantPartnerBiologicalSexFemaleMemoryNodeFeatureExtractor)initWithError:(id *)error;
@end
...
- (PGInvariantPartnerBiologicalSexFemaleMemoryNodeFeatureExtractor)initWithError:(id *)error
{
  ...
  v19.receiver = self;
  v19.super_class = PGInvariantPartnerBiologicalSexFemaleMemoryNodeFeatureExtractor;
