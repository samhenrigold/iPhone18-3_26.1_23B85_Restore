...
- (PGInvariantMotherFeatureExtractor)initWithError:(id *)error;
@end
...
- (PGInvariantMotherFeatureExtractor)initWithError:(id *)error
{
  ...
  v15.receiver = self;
  v15.super_class = PGInvariantMotherFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:@"MOTHER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_45376];
