...
- (PGInvariantSonMemoryNodeFeatureExtractor)initWithError:(id *)error
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantSonMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"SON" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_42873];
