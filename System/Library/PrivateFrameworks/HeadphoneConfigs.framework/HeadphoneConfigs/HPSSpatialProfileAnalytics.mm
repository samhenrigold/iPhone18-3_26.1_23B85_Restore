  ...
  if (v2)
  {
    ...
    *&v2->_leftEarOcclusionDetectCount = 0;
    ...
    if (+[HPSSpatialProfileAnalytics isRBSProcessHandleAvailable])
    {
      ...
      {
        v15 = 0;
        v7 = [MEMORY[0x277D46F40] handleForIdentifier:v5 error:&v15];
        v8 = v15;
        if (v7)
        {
          bundle = [v7 bundle];
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138412290;
        v18 = v13;
        _os_log_impl(&dword_251143000, v12, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Initialized Analytics From Client %@", buf, 0xCu);
      }
    }
  }
...
- (void)updateFaceEnrollStart
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Face Enroll Start Time", v4, 2u);
  }
}
...
- (void)updateSoundProfileCreationDurationStart
{
  if (self->_soundProfileCreationStartTime == 0.0)
  {
    ...
    {
      *v6 = 0;
      _os_log_impl(&dword_251143000, v5, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Profile Creation Time", v6, 2u);
    }
  }
}
...
- (void)updateSoundProfileCreationDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Face Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateRightEarEnrollStart
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Right Enroll Time", v4, 2u);
  }
}
...
- (void)updateRightEarFrontAnglelDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Right Front Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateRightEarMidAnglelDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Right Mid Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateRightEarBackAnglelDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Right Back Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateLeftEarFrontAnglelDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Left Front Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateLeftEarMidAnglelDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Left Mid Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateLeftEarBackAnglelDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Left Back Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateRightEarEnrollDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Right Enroll Time: %f", &v5, 0xCu);
  }
}
...
- (void)updateLeftEarEnrollStart
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Left Enroll Time", v4, 2u);
  }
}
...
- (void)updateLeftEarEnrollDuration
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_251143000, v3, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Left Enroll Time: %f ", &v5, 0xCu);
  }
}
...
- (void)updateStatus:(BOOL)status EnrollmentResult:(id)result
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    resultCopy2 = result;
    _os_log_impl(&dword_251143000, v9, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Analytics Update Status : %d Result %@", v12, 0x12u);
  }
}
  ...
  else
  {
    ...
    if (v4 > 2.0)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v11 = 2048;
        v12 = v4;
        _os_log_impl(&dword_251143000, v5, OS_LOG_TYPE_DEFAULT, "Spatial Profile: Frame Rate : Frame Per sec %f   [ Num : %llu Time :%f]", &v7, 0x20u);
      }
...
- (void)submitHPSSpatialProfileEnrollAnalytics
{
  ...
  if (!self->_submitted)
  {
    ...
    {
      self = [(HPSSpatialProfileAnalytics *)self updateFaceEnrollDuration];
    }

    if (selfCopy->_rightEarEnrollmentTime == 0.0)
    {
      self = [(HPSSpatialProfileAnalytics *)selfCopy updateRightEarEnrollDuration];
    }

    if (selfCopy->_leftEarEnrollmentTime == 0.0)
    {
      self = [(HPSSpatialProfileAnalytics *)selfCopy updateLeftEarEnrollDuration];
    }
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v4 = [MEMORY[0x277CCABB0] numberWithBool:selfCopy->_status];
      ...
      v22 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_faceEnrollmentTime + selfCopy->_rightEarEnrollmentTime + selfCopy->_leftEarEnrollmentTime];
      v26[3] = v22;
      v25[4] = @"FaceEnrollmentDuration";
      v21 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_faceEnrollmentTime];
      v26[4] = v21;
      v25[5] = @"RightEarEnrollmentDuration";
      v20 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_rightEarEnrollmentTime];
      v26[5] = v20;
      v25[6] = @"LeftEarEnrollmentDuration";
      v19 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_leftEarEnrollmentTime];
      v26[6] = v19;
      v25[7] = @"LeftEarOcclusionCount";
      v18 = [MEMORY[0x277CCABB0] numberWithUnsignedChar:selfCopy->_leftEarOcclusionDetectCount];
      v26[7] = v18;
      v25[8] = @"RightEarOcclusionCount";
      v17 = [MEMORY[0x277CCABB0] numberWithUnsignedChar:selfCopy->_rightEarOcclusionDetectCount];
      v26[8] = v17;
      v25[9] = @"SoundProfileCreationDuration";
      v8 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_soundProfileCreationTime];
      v26[9] = v8;
      v25[10] = @"RightEarFrontAngleDuration";
      v9 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_rightEarFrontAngleTime];
      v26[10] = v9;
      v25[11] = @"RightEarMidAngleDuration";
      v10 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_rightEarMidAngleTime];
      v26[11] = v10;
      v25[12] = @"RightEarBackAngleDuration";
      v11 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_rightEarBackAngleTime];
      v26[12] = v11;
      v25[13] = @"LeftEarFrontAngleDuration";
      v12 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_leftEarFrontAngleTime];
      v26[13] = v12;
      v25[14] = @"LeftEarMidAngleDuration";
      v13 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_leftEarMidAngleTime];
      v26[14] = v13;
      v25[15] = @"LeftEarBackAngleDuration";
      v14 = [MEMORY[0x277CCABB0] numberWithDouble:selfCopy->_leftEarBackAngleTime];
      v26[15] = v14;
      v15 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v26 forKeys:v25 count:16];
      *buf = 138412290;
      v28 = v15;
...
id __68__HPSSpatialProfileAnalytics_submitHPSSpatialProfileEnrollAnalytics__block_invoke(uint64_t a1)
{
  ...
  v21 = [MEMORY[0x277CCABB0] numberWithDouble:*(*(a1 + 32) + 16) + *(*(a1 + 32) + 40) + *(*(a1 + 32) + 80)];
  v25[4] = v21;
  v24[5] = @"FaceEnrollmentDuration";
  v20 = [MEMORY[0x277CCABB0] numberWithDouble:*(*(a1 + 32) + 16)];
  v25[5] = v20;
  v24[6] = @"RightEarEnrollmentDuration";
  v19 = [MEMORY[0x277CCABB0] numberWithDouble:*(*(a1 + 32) + 40)];
  v25[6] = v19;
  v24[7] = @"LeftEarEnrollmentDuration";
  v18 = [MEMORY[0x277CCABB0] numberWithDouble:*(*(a1 + 32) + 80)];
  v25[7] = v18;
  ...
  v25[16] = v15;
  v16 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v25 forKeys:v24 count:17];
