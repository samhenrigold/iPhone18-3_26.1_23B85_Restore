  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v15 = objc_msgSend_topicResultForObjCTopicResult_(DUObjCCompatibilityUtils, v9, *(*(&v22 + 1) + 8 * v14), v10, v11, v22);
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v14; ++i)
      {
        ...
        v17 = objc_msgSend_objCTopicResultForTopicResult_(DUObjCCompatibilityUtils, v11, *(*(&v22 + 1) + 8 * i), v12, v13);
