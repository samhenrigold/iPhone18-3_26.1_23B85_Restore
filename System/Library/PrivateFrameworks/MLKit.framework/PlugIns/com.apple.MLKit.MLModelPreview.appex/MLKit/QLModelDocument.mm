...
- (void)handleError:(id)error userInteractionPermitted:(BOOL)permitted
{
  ...
  *(&self->super.super.isa + OBJC_IVAR____TtC30com_apple_MLKit_MLModelPreview15QLModelDocument_error) = error;
  errorCopy = error;
  selfCopy = self;
...
- (_TtC30com_apple_MLKit_MLModelPreview15QLModelDocument)initWithFileURL:(id)l
{
  ...
  sub_100019938();
  v8 = OBJC_IVAR____TtC30com_apple_MLKit_MLModelPreview15QLModelDocument_error;
