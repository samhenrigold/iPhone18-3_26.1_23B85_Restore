...
- (void)prepareForReuse
{
  ...
  v5 = &v10 - v4;
  v6 = type metadata accessor for ContentUnavailableCell(0);
  v11.receiver = self;
  v11.super_class = v6;
  selfCopy = self;
  ...
  swift_endAccess();
  [*(&selfCopy->super.super.super.super.super.isa + OBJC_IVAR____TtC9SeymourUI22ContentUnavailableCell_contentUnavailableView) smu:0 updateWithType:0 text:0 secondaryText:0 image:0 buttonTitle:0 buttonPrimaryAction:?];
}
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)size withHorizontalFittingPriority:(float)priority verticalFittingPriority:(float)fittingPriority
{
  ...
  width = size.width;
  selfCopy = self;
  contentView = [(ContentUnavailableCell *)selfCopy contentView];
  *&v11 = priority;
  *&v12 = fittingPriority;
