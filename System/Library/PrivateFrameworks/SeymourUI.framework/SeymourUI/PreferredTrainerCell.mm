...
- (void)prepareForReuse
{
  ...
  v5 = &v10 - v4;
  v6 = type metadata accessor for PreferredTrainerCell(0);
  v11.receiver = self;
  v11.super_class = v6;
  selfCopy = self;
  ...
  (*(*(v8 - 8) + 56))(v5, 1, 1, v8);
  v9 = OBJC_IVAR____TtC9SeymourUI20PreferredTrainerCell_itemInfo;
  swift_beginAccess();
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)size withHorizontalFittingPriority:(float)priority verticalFittingPriority:(float)fittingPriority
{
  ...
  width = size.width;
  selfCopy = self;
  contentView = [(PreferredTrainerCell *)selfCopy contentView];
  *&v11 = priority;
  *&v12 = fittingPriority;
