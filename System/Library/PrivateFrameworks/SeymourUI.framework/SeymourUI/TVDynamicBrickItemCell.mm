...
- (void)prepareForReuse
{
  ...
  v5 = &v10 - v4;
  v6 = type metadata accessor for TVDynamicBrickItemCell(0);
  v11.receiver = self;
  v11.super_class = v6;
  selfCopy = self;
  ...
  swift_endAccess();
  [*(&selfCopy->super.super.super.super.super.super.isa + OBJC_IVAR____TtC9SeymourUI22TVDynamicBrickItemCell_titleLabel) setAttributedText_];
  [*(&selfCopy->super.super.super.super.super.super.isa + OBJC_IVAR____TtC9SeymourUI22TVDynamicBrickItemCell_subtitleLabel) setAttributedText_];
}
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)size withHorizontalFittingPriority:(float)priority verticalFittingPriority:(float)fittingPriority
{
  ...
  width = size.width;
  selfCopy = self;
  contentView = [(TVDynamicBrickItemCell *)selfCopy contentView];
  *&v11 = priority;
  *&v12 = fittingPriority;
