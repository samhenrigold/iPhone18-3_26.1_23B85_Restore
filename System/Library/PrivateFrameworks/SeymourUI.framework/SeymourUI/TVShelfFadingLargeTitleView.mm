...
- (void)applyLayoutAttributes:(id)attributes
{
  ...
  v7 = &v14 - v6;
  v8 = type metadata accessor for TVShelfFadingLargeTitleView(0);
  v15.receiver = self;
  v15.super_class = v8;
  attributesCopy = attributes;
  selfCopy = self;
  [(TVShelfFadingLargeTitleView *)&v15 applyLayoutAttributes:attributesCopy];
...
{
  v4.receiver = self;
  v4.super_class = type metadata accessor for TVShelfFadingLargeTitleView(0);
  v2 = v4.receiver;
