  ...
  if (verboseLoggingEnabled)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138412802;
      ...
      _os_log_impl(&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "\\BCCollectionMember configured: %@ %@ from collectionMember:%@\", buf, 0x20u);
    }
  }
}
...
- (void)resolveConflictsFromRecord:(id)record withResolvers:(id)resolvers
{
  ...
  if (recordCopy)
  {
      ...
      if (v18 > v21)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138412802;
          ...
          v50 = 2114;
          v51 = v31;
          _os_log_impl(&_mh_execute_header, v23, OS_LOG_TYPE_INFO, "BCCollectionMember %@ Resolving conflicts from record %{public}@, keeping my properties as my modification date is %{public}@.", buf, 0x20u);
        }
    ...
    [(BCCollectionMember *)self setDifferentNumber:v33 forKey:@"sortOrder"];
    ...
    v36 = +[BULogUtilities shared];
    verboseLoggingEnabled = [v36 verboseLoggingEnabled];

    if (hasChanges)
    {
      if (verboseLoggingEnabled)
      {
        v39 = sub_10000DB80(v38);
...
LABEL_24:
          _os_log_impl(&_mh_execute_header, v39, OS_LOG_TYPE_DEFAULT, v44, buf, 0x20u);
