...
- (id)insertRecord:(id)record inManagedObjectContext:(id)context
{
  ...
  [(_DPOBHRecordMOConverter *)self copyRecord:recordCopy intoManagedObject:v10];
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        {
          v15 = [(_DPOBHRecordMOConverter *)self insertRecord:v14 inManagedObjectContext:contextCopy, v17];
          [v8 addObject:v15];
        }
      }
