...
- (GDRoadTypeValue)initWithType:(int64_t)type typeValue:(double)value;
...
- (id)description
{
  ...
  {
    v3 = off_1E79620C8[type];
  }

  v4 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"GDRoadTypeValue<type: %@, typeValue: %lf>", v3, *&self->_typeValue];
...
{
  v7.receiver = self;
  v7.super_class = GDRoadTypeValue;
