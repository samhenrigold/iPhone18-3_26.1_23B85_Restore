...
- (void)addPublisher:(id)publisher
{
  ...
  if (WFCurrentLogLevel(v6, v8) >= 3 && v5)
  {
    ...
    if (os_log_type_enabled(v9, v7))
    {
      ...
      *buf = 134217984;
      v15 = v10;
      _os_log_impl(&dword_273FB9000, v9, v7, "Added new publisher, new count is %lu", buf, 0xCu);
    }
  }
...
- (void)addSubscriber:(id)subscriber
{
  ...
  if (WFCurrentLogLevel(v6, v8) >= 3 && v5)
  {
    ...
    if (os_log_type_enabled(v9, v7))
    {
      ...
      *buf = 134217984;
      v15 = v10;
      _os_log_impl(&dword_273FB9000, v9, v7, "Added new subcriber, new count is %lu", buf, 0xCu);
    }
  }
  ...
  if (WFCurrentLogLevel(v14, v16) >= 3 && v13)
  {
    ...
    if (os_log_type_enabled(v17, v15))
    {
      ...
      *buf = 138412546;
      ...
      v27 = 2048;
      v28 = [array count];
      _os_log_impl(&dword_273FB9000, v17, v15, "Added new discovery result for subscriber %@, new count is %lu", buf, 0x16u);
    }
  }
  ...
  if (WFCurrentLogLevel(v14, v16) >= 3 && v13)
  {
    ...
    if (os_log_type_enabled(v17, v15))
    {
      ...
      *buf = 138412546;
      ...
      v27 = 2048;
      v28 = [array count];
      _os_log_impl(&dword_273FB9000, v17, v15, "Added new data session for publisher %@, new count is %lu", buf, 0x16u);
    }
  }
  ...
  if (WFCurrentLogLevel(v14, v16) >= 3 && v13)
  {
    ...
    if (os_log_type_enabled(v17, v15))
    {
      ...
      *buf = 138412546;
      ...
      v27 = 2048;
      v28 = [array count];
      _os_log_impl(&dword_273FB9000, v17, v15, "Added new data session for subscriber %@, new count is %lu", buf, 0x16u);
    }
  }
  ...
  if (WFCurrentLogLevel(v7, v9) >= 3 && v6)
  {
    ...
    if (os_log_type_enabled(v10, v8))
    {
      ...
      *buf = 134218240;
      ...
      v17 = 2048;
      v18 = v11;
      _os_log_impl(&dword_273FB9000, v10, v8, "Removed publisher at index %ld, new count is %lu", buf, 0x16u);
    }
  }
    ...
    if (WFCurrentLogLevel(v11, v13) >= 3 && v10)
    {
      ...
      if (os_log_type_enabled(v14, v12))
      {
        ...
        *buf = 134218240;
        ...
        v20 = 2048;
        v21 = v15;
        _os_log_impl(&dword_273FB9000, v14, v12, "Removed publisher at index %ld, new count is %lu", buf, 0x16u);
      }
    }
...
LABEL_5:
    ...
    if (WFCurrentLogLevel(v7, v9) && v6 && os_log_type_enabled(v6, v8))
    {
      *buf = 138412290;
      v19 = publisherCopy;
      _os_log_impl(&dword_273FB9000, v6, v8, "Publisher %@ does not exist", buf, 0xCu);
    }
  }
}
  ...
  if (WFCurrentLogLevel(v7, v9) >= 3 && v6)
  {
    ...
    if (os_log_type_enabled(v10, v8))
    {
      ...
      *buf = 134218240;
      ...
      v17 = 2048;
      v18 = v11;
      _os_log_impl(&dword_273FB9000, v10, v8, "Removed subscriber at index %ld, new count is %lu", buf, 0x16u);
    }
  }
    ...
    if (WFCurrentLogLevel(v11, v13) >= 3 && v10)
    {
      ...
      if (os_log_type_enabled(v14, v12))
      {
        ...
        *buf = 134218240;
        ...
        v20 = 2048;
        v21 = v15;
        _os_log_impl(&dword_273FB9000, v14, v12, "Removed subscriber at index %ld, new count is %lu", buf, 0x16u);
      }
    }
...
LABEL_5:
    ...
    if (WFCurrentLogLevel(v7, v9) && v6 && os_log_type_enabled(v6, v8))
    {
      *buf = 138412290;
      v19 = subscriberCopy;
      _os_log_impl(&dword_273FB9000, v6, v8, "Subscriber %@ does not exist", buf, 0xCu);
    }
  }
}
  ...
  if ([v12 count])
  {
    ...
    if (WFCurrentLogLevel(v28, v30) >= 3 && v27)
    {
      ...
      if (os_log_type_enabled(v31, v29))
      {
        ...
        *&v38[8] = 2048;
        *&v38[10] = [v12 count];
        _os_log_impl(&dword_273FB9000, v31, v29, "Removed discovery result for subcriber %@, new count is %lu", buf, 0x16u);
      }
    }
...
LABEL_6:
  ...
  if (WFCurrentLogLevel(v18, v20) && v17)
  {
    ...
    if (os_log_type_enabled(v21, v19))
    {
      ...
      *&v38[14] = 2112;
      *&v38[16] = serviceName2;
      _os_log_impl(&dword_273FB9000, v21, v19, "Discovery result with publish ID %hhu and address %@ does not exist for subscriber %@", buf, 0x1Cu);
    }
    ...
    if (WFCurrentLogLevel(v22, v24) >= 3 && v21)
    {
      ...
      if (os_log_type_enabled(v25, v23))
      {
        ...
        *buf = 138412546;
        ...
        v33 = 2048;
        v34 = [v10 count];
        _os_log_impl(&dword_273FB9000, v25, v23, "Removed data session for publisher %@, new count is %lu", buf, 0x16u);
      }
    }
  ...
  if (WFCurrentLogLevel(v13, v15) && v12)
  {
    ...
    if (os_log_type_enabled(v16, v14))
    {
      ...
      *buf = 138412546;
      ...
      v33 = 2112;
      v34 = serviceName2;
      _os_log_impl(&dword_273FB9000, v16, v14, "Data session %@ does not exist for publisher %@", buf, 0x16u);
    }
    ...
    if (WFCurrentLogLevel(v22, v24) >= 3 && v21)
    {
      ...
      if (os_log_type_enabled(v25, v23))
      {
        ...
        *buf = 138412546;
        ...
        v33 = 2048;
        v34 = [v10 count];
        _os_log_impl(&dword_273FB9000, v25, v23, "Removed data session for subscriber %@, new count is %lu", buf, 0x16u);
      }
    }
  ...
  if (WFCurrentLogLevel(v13, v15) && v12)
  {
    ...
    if (os_log_type_enabled(v16, v14))
    {
      ...
      *buf = 138412546;
      ...
      v33 = 2112;
      v34 = serviceName2;
      _os_log_impl(&dword_273FB9000, v16, v14, "Data session %@ does not exist for subscriber %@", buf, 0x16u);
    }
...
- (void)publisherStarted:(id)started
{
  ...
  if (WFCurrentLogLevel(v5, v7) >= 3 && v4)
  {
    ...
    if (os_log_type_enabled(v8, v6))
    {
      ...
      v11 = 138412290;
      v12 = serviceName;
      _os_log_impl(&dword_273FB9000, v8, v6, "NAN publish %@ started", &v11, 0xCu);
    }
  }
}
...
- (void)publisher:(id)publisher failedToStartWithError:(int64_t)error
{
  ...
  if (WFCurrentLogLevel(v8, v10) >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v11, v9))
    {
      ...
      v16 = 2048;
      errorCopy = error;
      _os_log_impl(&dword_273FB9000, v11, v9, "NAN publish %@ failed to start with error %ld", &v14, 0x16u);
    }
  }
...
- (void)publisher:(id)publisher terminatedWithReason:(int64_t)reason
{
  ...
  if (WFCurrentLogLevel(v8, v10) >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v11, v9))
    {
      ...
      v16 = 2048;
      reasonCopy = reason;
      _os_log_impl(&dword_273FB9000, v11, v9, "NAN publish %@ terminated with reason %ld", &v14, 0x16u);
    }
  }
...
- (void)publisher:(id)publisher dataConfirmedForHandle:(id)handle localInterfaceIndex:(unsigned int)index serviceSpecificInfo:(id)info
{
  ...
  if (WFCurrentLogLevel(v11, v13) >= 3 && v10)
  {
    ...
    if (os_log_type_enabled(v14, v12))
    {
      ...
      _os_log_impl(&dword_273FB9000, v14, v12, "Data confirmed for session with peer %@", &v16, 0xCu);
    }
  }
...
- (void)publisher:(id)publisher dataTerminatedForHandle:(id)handle reason:(int64_t)reason
{
  ...
  if (WFCurrentLogLevel(v10, v12) >= 3 && v9)
  {
    ...
    if (os_log_type_enabled(v13, v11))
    {
      ...
      _os_log_impl(&dword_273FB9000, v13, v11, "Data terminated for session with peer %@", &v15, 0xCu);
    }
  }
...
- (void)subscriberStarted:(id)started
{
  ...
  if (WFCurrentLogLevel(v5, v7) >= 3 && v4)
  {
    ...
    if (os_log_type_enabled(v8, v6))
    {
      ...
      v11 = 138412290;
      v12 = serviceName;
      _os_log_impl(&dword_273FB9000, v8, v6, "NAN subscribe %@ started", &v11, 0xCu);
    }
  }
}
...
- (void)subscriber:(id)subscriber failedToStartWithError:(int64_t)error
{
  ...
  if (WFCurrentLogLevel(v8, v10) >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v11, v9))
    {
      ...
      v16 = 2048;
      errorCopy = error;
      _os_log_impl(&dword_273FB9000, v11, v9, "NAN subscribe %@ failed to start with error %ld", &v14, 0x16u);
    }
  }
...
- (void)subscriber:(id)subscriber terminatedWithReason:(int64_t)reason
{
  ...
  if (WFCurrentLogLevel(v8, v10) >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v11, v9))
    {
      ...
      v16 = 2048;
      reasonCopy = reason;
      _os_log_impl(&dword_273FB9000, v11, v9, "NAN subscribe %@ terminated with reason %ld", &v14, 0x16u);
    }
  }
...
- (void)subscriber:(id)subscriber receivedDiscoveyResult:(id)result
{
  ...
  if (WFCurrentLogLevel(v9, v11) >= 3 && v8)
  {
    ...
    if (os_log_type_enabled(v12, v10))
    {
      ...
      v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_273FB9000, v12, v10, "NAN subscribe %@ received discovery result %@", &v17, 0x16u);
    }
  }
...
- (void)subscriber:(id)subscriber lostDiscoveryResultForPublishID:(unsigned __int8)d address:(id)address
{
  ...
  if (WFCurrentLogLevel(v11, v13) >= 3 && v10)
  {
    ...
    if (os_log_type_enabled(v14, v12))
    {
      ...
      v22 = 2112;
      v23 = v17;
      _os_log_impl(&dword_273FB9000, v14, v12, "NAN subscribe %@ lost discovery result with publish ID %hhu and address %@", &v18, 0x1Cu);
    }
  }
