  ...
  if (WFCurrentLogLevel(v10, v12) >= 3 && v9)
  {
    ...
    if (os_log_type_enabled(v13, v11))
    {
      ...
      *&v25[14] = networkQualityDate3;
      ...
      _os_log_impl(&dword_273FB9000, v13, v11, "NetQuality: %s: Date is %@, responsiveness %.3f, existing view? %s existing date? %@", v25, 0x34u);
    }
  }
...
- (void)_openNetworkQualityDetails:(id)details
{
  ...
  v31 = [v4 initWithTitle:v6 detailText:0 symbolName:0 contentLayout:2];

  v8 = WFCurrentDeviceCapability(v7);
  LODWORD(v5) = WFCapabilityIsChinaDevice(v8);
  v9 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v10 = [v9 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection1Title" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  v11 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v12 = v11;
  if (v5)
  {
    v13 = @"kWFLocNetworkQualityLearnMoreSection1TextCH";
  }

  else
  {
    v13 = @"kWFLocNetworkQualityLearnMoreSection1Text";
  }

  v14 = [v11 localizedStringForKey:v13 value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  [v31 addSectionWithHeader:v10 content:v14];

  v15 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v16 = [v15 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection2Title" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  v17 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v18 = [v17 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection2Text" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  [v31 addSectionWithHeader:v16 content:v18];

  v19 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v20 = [v19 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection3Title" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  v21 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v22 = [v21 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection3Text" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  [v31 addSectionWithHeader:v20 content:v22];

  accessoryButton = [MEMORY[0x277D37680] accessoryButton];
  v24 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
  v25 = [v24 localizedStringForKey:@"kWFLocNetworkQualityKBURL" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  ...
  v27 = [v26 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection4Text" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
  [v31 addSectionWithHeader:0 content:v27 accessoryButton:accessoryButton];

  v28 = [objc_alloc(MEMORY[0x277D751E0]) initWithBarButtonSystemItem:0 target:self action:sel_donePressed];
  navigationItem = [v31 navigationItem];
  [navigationItem setRightBarButtonItem:v28];

  v30 = [objc_alloc(MEMORY[0x277D757A0]) initWithRootViewController:v31];
  [(WFDiagnosticsTableViewController *)self presentViewController:v30 animated:1 completion:0];
}
  ...
  if (![(WFDiagnosticsTableViewController *)self networkQualitySpinning])
  {
    ...
    if (WFCurrentLogLevel(v4, v6) >= 3 && v3 && os_log_type_enabled(v3, v5))
    {
      *buf = 136315138;
      ...
      _os_log_impl(&dword_273FB9000, v3, v5, "NetQuality: %s: User scheduled a run", buf, 0xCu);
    }

    v7 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
    v8 = [v7 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertTitle" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];

    v9 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
    v10 = [v9 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertText" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];

    v11 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
    v12 = [v11 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertContinue" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];

    v13 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
    v14 = [v13 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertCancel" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];

    v15 = [MEMORY[0x277D75110] alertControllerWithTitle:v8 message:v10 preferredStyle:1];
    v16 = [MEMORY[0x277D750F8] actionWithTitle:v14 style:1 handler:&__block_literal_global_2];
    [v15 addAction:v16];
    ...
    if (unsignedIntegerValue != 1)
    {
      ...
      if ([pathCopy row])
      {
        ...
        if ([pathCopy row] == 2)
        {
          ...
          v80 = [v79 localizedStringForKey:@"kWFLocDiagnosticsDeployment" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
        ...
        else
        {
          ...
          v102 = [v101 localizedStringForKey:@"kWFLocDiagnosticsMotion" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
...
LABEL_61:
    ...
    v86 = [v85 localizedStringForKey:@"kWFLocDiagnosticsSignalStrength" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
    ...
    if (unsignedIntegerValue == 4)
    {
      if ([pathCopy row])
      {
        ...
        else
        {
          ...
          v95 = [v94 localizedStringForKey:@"kWFLocDiagnosticsReceivedFrames" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
    ...
    else
    {
      ...
      if ([pathCopy row])
      {
        ...
        else
        {
          ...
          v83 = [v82 localizedStringForKey:@"kWFLocDiagnosticsScan" value:&stru_288308678 table:@"WiFiKitUILocalizableStrings"];
    ...
    if (WFCurrentLogLevel(v70, v72) >= 3 && v69)
    {
      ...
      if (os_log_type_enabled(v73, v71))
      {
        ...
        *&v111[14] = v76;
        v112 = 2080;
        v113 = v78;
        _os_log_impl(&dword_273FB9000, v73, v71, "NetQuality: %s: Responsiveness is %.1f, execution running? %s", v111, 0x20u);
      }
    }
