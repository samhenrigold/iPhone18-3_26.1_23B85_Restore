...
{
  classCopy = class;
  if (MBProtectionClassSupportedValue(class, 1, 0) == 255)
  {
    v7 = +[NSAssertionHandler currentHandler];
    [v7 handleFailureInMethod:a2 object:self file:@"MBProtectionClassFileHandleFactory.m" lineNumber:22 description:{@"Invalid protection class: %d", classCopy}];
  }

  v8.receiver = self;
  v8.super_class = MBProtectionClassFileHandleFactory;
  result = [(MBProtectionClassFileHandleFactory *)&v8 init];
  if (result)
  {
