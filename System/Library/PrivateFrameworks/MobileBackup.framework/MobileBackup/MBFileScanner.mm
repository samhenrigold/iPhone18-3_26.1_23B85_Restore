...
- (id)scanDomain:(id)domain snapshotMountPoint:(id)point
{
  ...
  if ((atomic_exchange(&self->_started, 1u) & 1) == 0)
  {
    ...
    *&self->_totalStats.minFileSize = xmmword_1002BA000;
      ...
      if (v8 >= 0x6FC23AC00)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 134218498;
          ...
          name4 = [domain4 name];
          _MBLog(@"Df", "=scanning= Found large file (%lld) at %{public}@ (%{public}@)", v8, absolutePath2, name4);
        }
      }
...
- (BOOL)_shouldNotBackupFile:(id)file domain:(id)domain
{
  ...
  if (!self->_delegateRespondsToFileScannerShouldExcludeFile || ([WeakRetained fileScanner:self shouldExcludeFile:fileCopy] & 1) == 0)
  {
    ...
    if ((policy & 0x21) == 0x20)
    {
      __assert_rtn("[MBFileScanner _shouldNotBackupFile:domain:]", "MBFileScanner.m", 295, "!isMegaBackupPolicy || _isCloudKitEngine(_policy)");
    }
            ...
            if (strlen([absolutePath fileSystemRepresentation]) >= 0x3E6)
            {
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *v117 = absolutePath;
                ...
                _MBLog(@"Df", "=scanning= WARNING: File name too long - excluding file and continuing with backup. Please contact the developer and include this log message. Path: %@", absolutePath);
              }
...
LABEL_132:
              if ([fileCopy isRegularFile])
              {
                if ((policy & 8) != 0)
                {
                  ...
                  {
                    v106 = 0;
                    v69 = [MBProtectionClassUtils getWithPath:absolutePath error:&v106];
                    v32 = v106;
                  }
                ...
                v71 = [absolutePath length];
                if (v71 - [@".plist.1234567" length] >= 1)
                {
                  v72 = [absolutePath substringFromIndex:?];
                  ...
                  if (v73)
                  {
                    ...
                    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
                    {
                      ...
                      _MBLog(@"I ", "=scanning= Not backing up failed plist safe save: %@", absolutePath);
                    }
                ...
                {
                  v75 = [absolutePath containsString:@"binarycookies_tmp"];
                  ...
                  if (v75)
                  {
                    ...
                    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
                    {
                      ...
                      _MBLog(@"I ", "=scanning= Not backing up temporary cookie: %@", absolutePath);
                    }
                ...
                if (v77)
                {
                  ...
                  if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    _MBLog(@"Db", "=scanning= Not backing up .dat.nosync file: %@", absolutePath);
                  }
...
LABEL_64:
            ...
            v48 = [NSURL fileURLWithPath:absolutePath isDirectory:isDirectory];
            v111 = 0;
            v110 = 0;
    ...
    if ([MBError isError:v28 withCode:4])
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138412290;
        ...
        _MBLog(@"Db", "=scanning= Doesn't exist: %@", absolutePath3);
LABEL_18:
      }
    }
    ...
    else
    {
      if (![MBError isError:v28 withCode:241])
      {
        ...
        *buf = 138412546;
        ...
        absolutePath3 = [v25 absolutePath];
        _MBLog(@"Df", "=scanning= Skipping due to unsupported mbNode type: %@ %@", absolutePath3, v28);
        goto LABEL_18;
      }
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138412546;
        ...
        absolutePath3 = [v25 absolutePath];
        _MBLog(@"Df", "=scanning= Skipping due to unsupported protection class: %@ %@", absolutePath3, v28);
        goto LABEL_18;
      }
    }
      ...
      if ([v25 isDirectory])
      {
        ...
        if (v52)
        {
          ...
          while (2)
          {
            ...
            v52 = [obj countByEnumeratingWithState:&v58 objects:v65 count:16];
            if (v52)
            {
              continue;
            }
...
LABEL_37:
  ...
  if (([relativePathCopy isEqualToString:@"Library/Application Support/CloudDocs/backup"]& 1) == 0 && ([relativePathCopy hasPrefix:@"Library/Application Support/CloudDocs/backup/"]& 1) == 0 && ([relativePathCopy isEqualToString:@"Library/Application Support/FileProvider/backup"]& 1) == 0 && ([relativePathCopy hasPrefix:@"Library/Application Support/FileProvider/backup/"]& 1) == 0)
  {
    if (([relativePathCopy isEqualToString:@"Library/Application Support/CloudDocs"]& 1) != 0 || [relativePathCopy isEqualToString:@"Library/Application Support/FileProvider"])
    {
      ...
      absolutePath = [v66 absolutePath];
      v77[0] = 0;
      v31 = +[NSFileManager defaultManager];
      v32 = [v31 fileExistsAtPath:absolutePath isDirectory:v77];
      v64 = v77[0];
      v65 = v32;
      ...
      if (v65 && (v64 & 1) != 0)
      {
        if (v34)
        {
          ...
          *&buf[4] = absolutePath;
          ...
          _MBLog(@"Df", "=scanning= Scanning the live path at %@", absolutePath);
        }
...
LABEL_38:
    ...
    v75 = v22;
    v71 = v38;
    v40 = MBNodeForRelativePathAt(v38, relativePathCopy, buf, &v75);
    v41 = v75;
...
LABEL_61:
    ...
    if (v42 == 2)
    {
      ...
      if (v9)
      {
        ...
        {
          absolutePath2 = [v73 absolutePath];
          *v77 = 138412290;
          v78 = absolutePath2;
          _os_log_impl(&_mh_execute_header, v44, OS_LOG_TYPE_DEFAULT, "=scanning= Deleted while scanning: %@", v77, 0xCu);

          absolutePath3 = [v73 absolutePath];
          _MBLog(@"Df", "=scanning= Deleted while scanning: %@", absolutePath3);
      ...
      {
        absolutePath4 = [v73 absolutePath];
        *v77 = 138412290;
        v78 = absolutePath4;
        _os_log_impl(&_mh_execute_header, v44, OS_LOG_TYPE_DEBUG, "=scanning= Doesn't exist: %@", v77, 0xCu);

        absolutePath5 = [v73 absolutePath];
        _MBLog(@"Db", "=scanning= Doesn't exist: %@", absolutePath5);
        goto LABEL_57;
      }
    }
    ...
    else
    {
      ...
      if (![MBError isError:v41 withCode:241])
      {
        ...
        if (![MBError isError:v41 withCode:242])
        {
          ...
          {
            absolutePath6 = [v73 absolutePath];
            domain = [v73 domain];
            ...
            if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
            {
              *v77 = 138412802;
              ...
              _MBLog(@"I ", "=scanning= Skipping file with MBNodeForRelativePathAt() failure %@ (%@): %{errno}d", absolutePath6, relativePathCopy, v42);
            }

            MBDiagnoseUnavailableFile(absolutePath6, pathCopy, volumeMountPoint, v42, "MBNodeForRelativePathAt");
            v19 = 0;
            v21 = v74;
          }
          ...
          {
            absolutePath7 = [v73 absolutePath];
            domain2 = [v73 domain];
            ...
            if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
            {
              *v77 = 138412802;
              ...
              _MBLog(@"E ", "=scanning= MBNodeForRelativePathAt() failed at %@ (%@): %{errno}d", absolutePath7, relativePathCopy, v42);
            }

            MBDiagnoseUnavailableFile(absolutePath7, pathCopy, volumeMountPoint2, v42, "MBNodeForRelativePathAt");
            v19 = [MBError errorWithErrno:v42 code:101 path:absolutePath7 format:@"MBNodeForRelativePathAt() error"];
        ...
        absolutePath8 = [v73 absolutePath];
        *v77 = 138412546;
        v78 = absolutePath8;
        v79 = 2112;
        v80 = v41;
        ...
        absolutePath5 = [v73 absolutePath];
        _MBLog(@"Db", "=scanning= Skipping unsupported mbNode type: %@ %@", absolutePath5, v41);
        goto LABEL_57;
      }
      ...
      {
        absolutePath9 = [v73 absolutePath];
        *v77 = 138412546;
        v78 = absolutePath9;
        v79 = 2112;
        v80 = v41;
        ...
        absolutePath5 = [v73 absolutePath];
        _MBLog(@"Df", "=scanning= Skipping due to unsupported protection class: %@ %@", absolutePath5, v41);
LABEL_57:
    ...
    if (v26 == 2)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(&v132.d_ino + 4) = absolutePath;
        ...
        _MBLog(@"Df", "=scanning= Modification error when opening directory %@ while scanning", absolutePath2);
      }
    ...
    else
    {
      if ((objc_opt_respondsToSelector() & 1) == 0 || ![delegate fileScanner:self failedToOpenFile:directoryCopy withErrno:v26])
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *&v132.d_name[3] = v26;
          ...
          _MBLog(@"E ", "=scanning= openat failed at %@ (%s): %{errno}d", absolutePath4, fileSystemRepresentation, v26);
        }

        absolutePath5 = [directoryCopy absolutePath];
        v31 = [MBError errorWithErrno:v26 code:101 path:absolutePath5 format:@"open error"];
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *&v132.d_name[3] = v26;
        ...
        _MBLog(@"I ", "=scanning= Skipping file with openat failure %@ (%s): %{errno}d", absolutePath8, fileSystemRepresentation, v26);
      }
    }
      ...
      if (d_seekoff != [directoryCopy inodeNumber])
      {
        ...
        if (os_log_type_enabled(v96, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *v134 = absolutePath9;
          ...
          _MBLog(@"Df", "=scanning= Modification error when opening directory %@ while scanning", absolutePath10);
        }
    ...
    if (v32 == 2)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *v134 = absolutePath11;
        ...
        _MBLog(@"Df", "=scanning= Modification error when stating directory %@ while scanning", absolutePath12);
      }
    ...
    else
    {
      if ((objc_opt_respondsToSelector() & 1) == 0 || ![delegate2 fileScanner:self failedToStatFile:directoryCopy withErrno:v32])
      {
        ...
        if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
        {
          ...
          *&v134[20] = v32;
          ...
          _MBLog(@"E ", "=scanning= fstat failed at %@ (%s): %{errno}d", absolutePath14, fileSystemRepresentation, v32);
        }

        absolutePath15 = [directoryCopy absolutePath];
        v37 = [MBError errorWithErrno:v32 code:101 path:absolutePath15 format:@"stat error"];
      ...
      if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
      {
        ...
        *&v134[20] = v32;
        ...
        _MBLog(@"I ", "=scanning= Skipping file with fstat failure %@ (%s): %{errno}d", absolutePath17, fileSystemRepresentation, v32);
      }
    }
    ...
    if (v41 == 2)
    {
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(&v132.d_ino + 4) = absolutePath18;
        ...
        _MBLog(@"Df", "=scanning= Modification error when opening directory %@ while scanning", absolutePath19);
      }
    ...
    else
    {
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *&v132.d_name[3] = v41;
        ...
        _MBLog(@"E ", "=scanning= fdopendir failed at %@ (%s): %{errno}d", absolutePath21, fileSystemRepresentation, v41);
      }

      absolutePath22 = [directoryCopy absolutePath];
      v46 = [MBError errorWithErrno:v41 code:101 path:absolutePath22 format:@"fdopendir error"];
    }
...
LABEL_56:
      ...
      else
      {
        ...
        {
          if (dword_100421998 || atomic_fetch_add_explicit(&dword_100421998, 1u, memory_order_relaxed))
          {
            goto LABEL_56;
          }
...
LABEL_77:
  ...
  {
    absolutePath23 = [v121 absolutePath];
    *buf = 138412546;
    *v134 = absolutePath23;
    *&v134[8] = 1024;
    *&v134[10] = v25;
    ...
    absolutePath24 = [v121 absolutePath];
    _MBLog(@"E ", "=scanning= readdir_r failed at %@: %d", absolutePath24, v25);
  }

  v80 = *__error();
  absolutePath25 = [v121 absolutePath];
  v46 = [MBError errorWithErrno:v80 code:101 path:absolutePath25 format:@"readdir error"];
...
LABEL_111:
      ...
      {
        absolutePath26 = [v121 absolutePath];
        *buf = 138412290;
        *v134 = absolutePath26;
        _os_log_impl(&_mh_execute_header, v102, OS_LOG_TYPE_DEFAULT, "=scanning= Deleted/modified while scanning: %@", buf, 0xCu);

        absolutePath27 = [v121 absolutePath];
        _MBLog(@"Df", "=scanning= Deleted/modified while scanning: %@", absolutePath27);
      }
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0 && [delegate fileScanner:self failedToStatFile:v121 withErrno:v99])
    {
      ...
      {
        absolutePath28 = [v121 absolutePath];
        *buf = 138412802;
        *v134 = absolutePath28;
        *&v134[8] = 2080;
        *&v134[10] = v117;
        ...
        *&v134[20] = v99;
        ...
        absolutePath29 = [v121 absolutePath];
        _MBLog(@"I ", "=scanning= Skipping file with fstat failure %@ (%s): %{errno}d", absolutePath29, v117, v99);
      }
    ...
    else
    {
      ...
      {
        absolutePath30 = [v121 absolutePath];
        *buf = 138412802;
        *v134 = absolutePath30;
        *&v134[8] = 2080;
        *&v134[10] = v117;
        ...
        *&v134[20] = v99;
        ...
        absolutePath31 = [v121 absolutePath];
        _MBLog(@"E ", "=scanning= fstatat failed at %@ (%s): %{errno}d", absolutePath31, v117, v99);
      }

      absolutePath32 = [v121 absolutePath];
      v31 = [MBError errorWithErrno:v99 code:101 path:absolutePath32 format:@"stat error"];
    }
...
- (id)_scanFilesUsingGetattrlistbulkForDomain:(id)domain fds:(id)fds snapshotPath:(id)path relativePath:(id)relativePath stats:(_MBFileScannerDomainStats *)stats
{
  ...
  memset(buf, 0, sizeof(buf));
  v84 = v19;
  v21 = MBNodeForRelativePathAt(v18, relativePathCopy, buf, &v84);
  v22 = v84;
...
LABEL_6:
  ...
  while (1)
  {
    ...
    {
      absolutePath6 = MBGetDefaultLog();
      if (os_log_type_enabled(absolutePath6, OS_LOG_TYPE_INFO))
      {
        absolutePath = [v53 absolutePath];
        *v86 = 138412802;
        *v87 = absolutePath;
        *&v87[8] = 2112;
        *&v87[10] = v82;
        *&v87[18] = 1024;
        *&v87[20] = v76;
        _os_log_impl(&_mh_execute_header, absolutePath6, OS_LOG_TYPE_INFO, "=scanning= Skipping file with openat failure %@ (%@): %{errno}d", v86, 0x1Cu);

        absolutePath2 = [v53 absolutePath];
        _MBLog(@"I ", "=scanning= Skipping file with openat failure %@ (%@): %{errno}d", absolutePath2, v82, v76);
      }
    ...
    else
    {
      ...
      {
        absolutePath3 = [v53 absolutePath];
        *v86 = 138412802;
        *v87 = absolutePath3;
        *&v87[8] = 2112;
        *&v87[10] = v82;
        ...
        *&v87[20] = v76;
        ...
        absolutePath4 = [v53 absolutePath];
        _MBLog(@"E ", "=scanning= openat failed at %@ (%@): %{errno}d", absolutePath4, v82, v76);
      }

      absolutePath5 = [v53 absolutePath];
      v70 = [MBError errorWithErrno:v76 code:101 path:absolutePath5 format:@"open error"];

      absolutePath6 = [v53 absolutePath];
      MBDiagnoseFile(absolutePath6, v76, "openat");
      v57 = 1;
      v81 = v70;
    }
...
- (id)_performSinglePassEnumerationForDomain:(id)domain snapshotPath:(id)path relativePath:(id)relativePath buffer:(id)buffer dirFd:(int)fd direntCount:(unsigned int)count directoryPathStack:(id)stack directoryCountStack:(id)self0 stats:(_MBFileScannerDomainStats *)self1
{
  ...
  v23 = v19;
  v59 = v23;
  MBEnumerateDirectoryNodes(fd, bufferCopy, v53);
  if (v71[3] >> 4 >= 0x271)
  {
    v24 = MBGetDefaultLog();
...
LABEL_22:
                  ...
                  if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *&buf[4] = absolutePath;
                    ...
                    absolutePath2 = [fileCopy absolutePath];
                    _MBLog(@"I ", "=scanning= Not backing up SQLite file: %@", absolutePath2);
                  }
                ...
                memset(buf, 0, sizeof(buf));
                v105 = v36;
                v55 = MBNodeForPath(v30, buf, &v105);
                v21 = v105;
                    ...
                    if (v56)
                    {
                      ...
                      if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *v114 = absolutePath3;
                        ...
                        _MBLog(@"I ", "=scanning= Backing up SQLite file: %@", absolutePath4);
                      }
...
LABEL_97:
                ...
                else
                {
                  ...
                  {
                    absolutePath5 = [v97 absolutePath];
                    ...
                    *&v114[10] = relativePath5;
                    ...
                    absolutePath6 = [v97 absolutePath];
                    relativePath6 = [v97 relativePath];
                    _MBLog(@"I ", "=scanning= Skipping SQLite file with lstat failure %@ (%@): %{errno}d", absolutePath6, relativePath6, v83);
                  }
                }
...
LABEL_58:
          ...
          *&buf[4] = absolutePath7;
          ...
          _MBLog(@"I ", "=scanning= Backing up protected SQLite journal: %@", absolutePath8);
          v47 = v99;
        }
  ...
  if ([fileCopy size] > v68)
  {
    ...
    if (os_log_type_enabled(v69, OS_LOG_TYPE_FAULT))
    {
      ...
      *&buf[24] = v71;
      ...
      _MBLog(@"F ", "=scanning= Found a file with unexpected size (%llu/%llu) at %{public}@", v72, v68, absolutePath9);
    ...
    if ([MBError isError:v21 withCode:4])
    {
      ...
      if (os_log_type_enabled(v77, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[4] = absolutePath11;
        ...
        _MBLog(@"Df", "=scanning= Deleted while scanning: %@", absolutePath12);
      }
