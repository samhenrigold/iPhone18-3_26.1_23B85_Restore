...
+ (void)_persistDisabledDomainNames:(id)names forPersona:(id)persona
{
  ...
  if (!namesCopy)
  {
    __assert_rtn("+[MBAppManager _persistDisabledDomainNames:forPersona:]", "MBAppManager.m", 104, "names");
  }
...
+ (id)_volumesToBackUpForPersona:(id)persona
{
  ...
  v5 = [allObjects sortedArrayUsingComparator:&stru_1003C0228];
        ...
        if (v25)
        {
          ...
          do
          {
            for (j = 0; j != v25; j = j + 1)
            {
              ...
              v33 = MBStringForContainerType(containerType);
              v34 = MBGetDefaultLog();
    ...
    do
    {
      ...
      do
      {
        ...
        if (v14)
        {
          ...
          if (!v15)
          {
            __assert_rtn("[MBAppManager _copyAppsWithPlists:volumeMountPoints:safeHarbor:error:]", "MBAppManager.m", 395, "app");
          }
...
- (id)_copySystemPluginsWithPlists:(id)plists volumeMountPoints:(id)points error:(id *)error
{
  ...
  if (v10)
  {
    v11 = v10;
    v12 = *v32;
    v13 = &OBJC_METACLASS___MBBackupAttemptSummary;
    while (2)
    {
      v14 = 0;
      v30 = v11;
      do
      {
        ...
        v15 = *(*(&v31 + 1) + 8 * v14);
        v16 = sub_100179FF8(v15, pointsCopy);
        if (v16)
        {
          v17 = v16;
          v18 = [objc_alloc(&v13[51]) initWithPropertyList:v15 volumeMountPoint:v16];
          if (!v18)
          {
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = i + 1)
      {
        ...
        v14 = *(*(&v25 + 1) + 8 * i);
        v15 = sub_100179FF8(v14, pointsCopy);
        if (v15)
        {
          v16 = v15;
...
- (id)containerWithIdentifier:(id)identifier containerType:(int)type
{
  ...
  {
    v7 = [*(&self->super.isa + qword_1002B9F50[type - 1]) objectForKeyedSubscript:identifierCopy];
  }
        ...
        if (v18)
        {
          ...
          do
          {
            for (i = 0; i != v19; i = i + 1)
            {
              ...
              v27 = MBStringForContainerType(containerType);
              v28 = MBGetDefaultLog();
...
- (id)createSafeHarborForContainer:(id)container withPersona:(id)persona usingIntermediateRestoreDir:(BOOL)dir error:(id *)error
{
  containerCopy = container;
  personaCopy = persona;
  if (qword_1004218D0 != -1)
  {
    dispatch_once(&qword_1004218D0, &stru_1003C0248);
  }
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10017C85C;
  block[3] = &unk_1003C0270;
  v13 = personaCopy;
  v41 = v13;
  selfCopy = self;
  dirCopy = dir;
