...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [[NSMutableArray alloc] initWithCapacity:{-[NSMutableArray count](self->_keysAndValues, "count")}];
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; i = i + 1)
      {
        ...
        [(BackupStatusMessage *)self addKeysAndValues:*(*(&v10 + 1) + 8 * i), v10];
      }
