      ...
      for (i = 0; i != v11; i = i + 1)
      {
        ...
        if ([pathCopy hasPrefix:v14])
        {
          ...
          if (!v15)
          {
            ...
            [v22 handleFailureInMethod:a2 object:self file:@"MBDomainManager.m" lineNumber:276 description:{@"Domain not found for redirect: %@", v17}];
          }
