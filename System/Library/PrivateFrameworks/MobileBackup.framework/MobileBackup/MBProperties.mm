    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          [v23 handleFailureInMethod:a2 object:selfCopy file:@"MBProperties.m" lineNumber:377 description:{@"Account item %@ not a string", v13}];
        }

        v14 = [appleIDs objectForKeyedSubscript:v13];
        objc_opt_class();
