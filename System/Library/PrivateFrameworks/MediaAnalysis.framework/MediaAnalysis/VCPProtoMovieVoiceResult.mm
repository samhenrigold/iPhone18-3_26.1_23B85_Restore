    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          [(VCPProtoMovieVoiceResult *)v6 setTimeRange:v8];

          [v5 floatValue];
          [(VCPProtoMovieVoiceResult *)v6 setConfidence:?];
        }
      }
    }
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = VCPProtoMovieVoiceResult;
  v4 = [(VCPProtoMovieVoiceResult *)&v8 description];
  dictionaryRepresentation = [(VCPProtoMovieVoiceResult *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(VCPProtoMovieVoiceResult *)self setTimeRange:?];
  }
