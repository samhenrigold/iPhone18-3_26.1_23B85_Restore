...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = VCPProtoMoviePetsFaceResult;
  v4 = [(VCPProtoMoviePetsFaceResult *)&v8 description];
  dictionaryRepresentation = [(VCPProtoMoviePetsFaceResult *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(VCPProtoMoviePetsFaceResult *)self setTimeRange:?];
  }
...
LABEL_7:
  ...
  else
  {
    ...
    [(VCPProtoMoviePetsFaceResult *)self setBounds:?];
  }
  ...
  if (v14.start.flags)
  {
    ...
    if ((v14.duration.flags & 1) != 0 && !v14.duration.epoch)
    {
      ...
      if ((v14.duration.value & 0x8000000000000000) == 0 && v5 && v6 != 0)
      {
        ...
        [(VCPProtoMoviePetsFaceResult *)v8 setTimeRange:v11];

        v16 = NSRectFromString(v5);
        v12 = [VCPProtoBounds boundsWithCGRect:v16.origin.x, v16.origin.y, v16.size.width, v16.size.height];
        [(VCPProtoMoviePetsFaceResult *)v8 setBounds:v12];

        [v7 floatValue];
        [(VCPProtoMoviePetsFaceResult *)v8 setConfidence:?];
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  ...
  v15[0] = @"petsBounds";
  bounds = [(VCPProtoMoviePetsFaceResult *)self bounds];
  [bounds rectValue];
