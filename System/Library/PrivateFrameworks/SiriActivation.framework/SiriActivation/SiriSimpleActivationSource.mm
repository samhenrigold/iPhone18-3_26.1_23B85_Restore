...
{
  v5.receiver = self;
  v5.super_class = SiriSimpleActivationSource;
...
void __49__SiriSimpleActivationSource_configureConnection__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v14[1] = 3221225472;
    v14[2] = __49__SiriSimpleActivationSource_configureConnection__block_invoke_2;
    v14[3] = &unk_1E82F35E8;
    v9 = v6;
    v15 = v9;
    ...
    v11[1] = 3221225472;
    v11[2] = __49__SiriSimpleActivationSource_configureConnection__block_invoke_26;
    v11[3] = &unk_1E82F3630;
...
void __49__SiriSimpleActivationSource_configureConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v5 = [v3 remoteTarget];
  [v5 unregisterNonButtonSourceWithType:&unk_1F47D1800 withUUID:*(a1 + 32)];
}
...
void __49__SiriSimpleActivationSource_configureConnection__block_invoke_24(uint64_t a1, void *a2)
{
  ...
  {
    __49__SiriSimpleActivationSource_configureConnection__block_invoke_24_cold_1(v2, v3);
  }
}
...
void __49__SiriSimpleActivationSource_configureConnection__block_invoke_26(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v7 = [v3 remoteTarget];
    [v7 registerNonButtonSourceWithType:&unk_1F47D1800 withUUID:*(a1 + 32)];
