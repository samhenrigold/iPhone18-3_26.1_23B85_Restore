uint64_t DeepThoughtPlugin.perform(_:)(void *a1)
{
  ...
  v10 = SiriPenetrationRateMetrics.init(bookmarkLocation:)();
  if (!v2)
  {
    v14[1] = v10;
    __swift_instantiateConcreteTypeFromMangledNameV2(&_s18lighthouse_runtime26LighthouseRuntimeProcessorCy11DeepThought26SiriPenetrationRateMetricsCGMd, &_s18lighthouse_runtime26LighthouseRuntimeProcessorCy11DeepThought26SiriPenetrationRateMetricsCGMR);
    swift_allocObject();
    v11 = a1;
    v12 = LighthouseRuntimeProcessor.init(task:plugin:enforceDiagnosticCheck:)();
    if (v12)
    {
      *(v3 + OBJC_IVAR___DeepThoughtPlugin_processor) = v12;
...
id DeepThoughtPlugin.init()()
{
  ...
  *&v0[OBJC_IVAR___DeepThoughtPlugin_processor] = 0;
  v2.receiver = v0;
  v2.super_class = type metadata accessor for DeepThoughtPlugin(0);
...
uint64_t type metadata accessor for DeepThoughtPlugin(uint64_t a1)
{
...
uint64_t type metadata completion function for DeepThoughtPlugin(uint64_t a1, uint64_t a2)
{
