...
- (id)description
{
  ...
  dictionaryRepresentation = [(NNMKProtoMessageDeletion *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) != 0 && self->_deletionState == *(equalCopy + 2))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[6])
  {
    self->_deletionState = fromCopy[2];
    *&self->_has |= 1u;
  }
}
