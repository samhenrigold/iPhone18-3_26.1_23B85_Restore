...
__n128 sub_1000BF720(unint64_t *a1, uint64_t *a2, __int128 *a3)
{
  v12 = *a2;
  v13 = *a3;
  v14 = *(a3 + 2);
...
void sub_1000BFA78(uint64_t a1, char *a2, size_t a3, uint64_t (*a4)(int, llvm::raw_ostream *this), void ***p_p_p)
{
  v10 = *(a1 + 8);
  (**a1)(*(*a1 + 8));
  __p = 0;
...
void sub_1000C0440(uint64_t a1, char *a2, size_t a3, uint64_t (*a4)(int, llvm::raw_ostream *this), void ***p_p_p)
{
  v10 = *(a1 + 8);
  (**a1)(*(*a1 + 8));
  __p = 0;
...
void sub_1000C0A6C(uint64_t a1, char *a2, size_t a3, uint64_t (*a4)(int, llvm::raw_ostream *this), void ***p_p_p)
{
  v10 = *(a1 + 8);
  (**a1)(*(*a1 + 8));
  __p = 0;
...
__n128 sub_1000C1778(unint64_t a1, __n128 *a2, uint64_t a3, char a4, __n128 result)
{
LABEL_1:
  v9 = &a2[-2].n128_u32[2];
  v10 = a2 - 3;
...
LABEL_62:
      ...
      *(v12 - 20) = v152;
      ...
      {
LABEL_81:
        result = sub_1000C1778(a1, (v12 - 24), a3, a4 & 1, result);
        a4 = 0;
      }
    }
  }
...
BOOL sub_1000C2A00(uint64_t a1, int *a2, __n128 a3)
{
...
LABEL_47:
    ...
    if (v3 != 4)
    {
      ...
      sub_1000C27B8(a1, (a1 + 24), (a1 + 48), (a1 + 72), (a2 - 6), a3);
      return 1;
    }
...
llvm *sub_1000C3F54(uint64_t a1, __int16 a2, uint64_t a3, uint64_t a4, _BYTE *a5, uint64_t a6)
{
  v11 = 0;
...
char *sub_1000C4CD4(uint64_t *a1, uint64_t a2, __int128 *a3)
{
  v31 = 0;
  v6 = a1 + 2;
...
char *sub_1000C50F0(uint64_t *a1, uint64_t a2, _BYTE *a3)
{
  v30 = 0;
  v6 = a1 + 2;
...
char *sub_1000C53D8(uint64_t *a1, uint64_t a2, __int128 *a3)
{
  v30 = 0;
  v6 = a1 + 2;
  v7 = llvm::SmallVectorBase<unsigned int>::mallocForGrow(a1, a1 + 2, 0, 96, &v30);
...
uint64_t sub_1000C56D0(uint64_t a1, unsigned int *a2, _OWORD *a3, uint64_t a4)
{
  ...
  *(a1 + 544) = v9;
  ...
  v240 = &v241 + 8;
  v242 = 1;
  v241 = xmmword_10028FC90;
  v11 = sub_10003A984(&v235, 24, 24, 3);
  v12 = a2;
  v13 = *(a1 + 424);
  *v11 = a1 + 400;
  v11[1] = v13;
...
LABEL_104:
      *(&v241 + 1) += 24;
      ...
      {
        v77 = sub_10003A984(&v235, 24, 24, 3);
        v28 = *(v211 + 240);
      }
      ...
      *(v209 + 424) = v77;
      ...
      if ((*(v209 + 584) & 4) == 0)
      {
        ...
        if (v78)
        {
          if (sub_1000BA82C(*(v210 + 2)))
          {
            v79 = sub_1000BA82C(v78);
            v79[1](v79, v78, v210, sub_1000C8438, &v221);
          }
        }
      }
              ...
              *&v243 = &off_1002B45C0;
              ...
              if (v94)
              {
                *(a1 + 512) += v94;
                ...
                {
                  v128 = v93;
                  v129 = sub_10003A984(v211 + 248, v94, v94, 0);
                  v93 = v128;
                  a1 = v209;
                  v95 = v129;
                }
...
LABEL_147:
              ...
              *(&v243 + 1) = v98;
              ...
              while (v100 != v99)
              {
                ...
                sub_1000C7150(v218, v107, Value, v112);
LABEL_153:
                ++v100;
              }
...
LABEL_240:
            *&v243 = v145;
            ...
            sub_1000C7E30(v150, v165);
            sub_100095A6C(v150, v149 + 16, &v243);
            v145 = v243;
            ++*(v150 + 8);
            if (*v145 != -1)
            {
...
{
  if ((atomic_load_explicit(byte_1002C04D8, memory_order_acquire) & 1) == 0)
  {
    v7 = a1;
    v5 = a2;
    sub_1002791C4();
    ...
    a1 = v7;
    v2 = qword_1002C04D0;
    if (atomic_load_explicit(byte_1002C04F0, memory_order_acquire))
    {
      goto LABEL_3;
    }
...
void sub_1000C8A68(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = *(a1 + 8);
  if (!v3)
  {
      ...
      while (1)
      {
        ...
        if (a2[3] - v12 > 1uLL)
        {
          *v12 = 8236;
          ...
          {
LABEL_19:
            if ((sub_1000AEDE4((*(a3 + 8) + 144), v13, *a3) & 1) == 0)
            {
...
LABEL_8:
  ...
  if (sub_1000AEDE4((*(a3 + 8) + 144), v7, *a3))
  {
    goto LABEL_8;
  }
...
void sub_1000C9214(llvm::detail::IEEEFloat *__return_ptr a1@<X8>, llvm::APInt *a2@<X1>, llvm::APFloatBase *a3@<X0>)
{
  v6 = *(a3 + 4);
  v15 = *(a2 + 2);
  if (v15 > 0x40)
