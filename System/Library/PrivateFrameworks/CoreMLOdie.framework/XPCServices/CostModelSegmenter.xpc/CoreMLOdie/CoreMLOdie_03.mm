...
uint64_t llvm::detail::IEEEFloat::roundSignificandWithExponent(uint64_t a1)
{
  ...
  if (v11 >= 8)
  {
    if ((v11 & 8) != 0)
    {
      v14 = &v79;
      v13 = v78;
      llvm::APInt::tcFullMultiply(&v79, v78, &v83, 1, 1);
      if (v80)
      {
        v12 = 2;
      }
...
LABEL_33:
    if (v19 != v78)
    {
      llvm::APInt::tcAssign(v78, v19, v12);
    }
  }
  ...
  do
  {
    LODWORD(v75) = (v10 << 6) - 1;
    v22 = *(*v7 + 8);
    llvm::detail::IEEEFloat::IEEEFloat(&v79, &v74, v2, v3);
    v23 = v82 & 0xF0;
    v82 = v82 & 0xF0 | *(v7 + 20) & 8 | 3;
    if (*(v79 + 5) == 2)
    {
      v82 = v23 | 3;
    }
    ...
    llvm::detail::IEEEFloat::IEEEFloat(&v72[1], &v74, v29, v30);
    v31 = llvm::detail::IEEEFloat::convertFromUnsignedParts(&v79, v71, v72[0], 1);
    v34 = llvm::detail::IEEEFloat::convertFromUnsignedParts(&v72[1], v78, v12, 1);
    v81 += v5;
    if (v5 < 0)
    {
      v40 = llvm::detail::IEEEFloat::divideSignificand(&v79, &v72[1], v32);
      v37 = v40;
      v41 = *(*v7 + 4);
      v39 = (v10 << 6) - 1 - v22;
      v42 = v41 - v81;
    ...
    {
      llvm::detail::IEEEFloat::IEEEFloat(&v83, v79, v32, v33);
      v37 = llvm::detail::IEEEFloat::multiplySignificand(&v79, &v72[1], &v83, (v79[3] & 1) == 0, v35, v36);
      if ((*(v83 + 8) - 64) <= 0xFFFFFF7F && v84)
      {
        operator delete[]();
      }
    ...
    v47 = (v24 - 1) >> 6;
    v48 = v2[v47] & (0xFFFFFFFFFFFFFFFFLL >> ((v24 - 1) & 0x3F ^ 0x3F));
    v49 = 1 << (v24 - 1);
    if (!v70)
    {
      v49 = 0;
...
LABEL_83:
          ...
          llvm::APInt::tcExtract(v57, v59, v2, (v75 - v24), v24);
          *(v7 + 4) = v81 + v24 + *(*v7 + 8) - v75;
          v60 = *(v79 + 2);
          ...
          else if (v39 <= v63 << 6 && llvm::APInt::tcExtractBit(v61, (v39 - 1)))
          {
            v65 = 3;
          }
          ...
          v67 = llvm::detail::IEEEFloat::normalize(v7, v68, v65);
          goto LABEL_103;
        }
...
llvm::detail::IEEEFloat *llvm::detail::IEEEFloat::convertPPCDoubleDoubleLegacyAPFloatToAPInt@<X0>(llvm::detail::IEEEFloat **this@<X0>, uint64_t a3@<X8>)
{
  ...
  *&v65[4] = -1022;
  ...
  llvm::detail::IEEEFloat::convert(&v57, &unk_10028EE24, 1, &v66);
  if (v57 == &unk_10028EF74)
  {
    v27 = 1022;
  }
...
LABEL_103:
  llvm::detail::IEEEFloat::convert(&v53, &unk_10028EE24, 1, &v66);
  if (v53 == &unk_10028EF74)
  {
    LODWORD(v49) = 1022;
  }
...
uint64_t llvm::detail::IEEEFloat::initFromPPCDoubleDoubleLegacyAPInt(llvm::detail::IEEEFloat *this, const llvm::APInt ***a2, uint64_t a3, unsigned int a4)
{
  ...
  result = llvm::detail::IEEEFloat::convert(this, &unk_10028EE78, 1, &v22);
  if ((*(this + 20) & 6) != 0 && (*(this + 20) & 7) != 3)
  {
    v18 = 64;
    v17 = v7;
    llvm::detail::IEEEFloat::initFromDoubleAPInt(&v19, &v17, v9, v10);
    llvm::detail::IEEEFloat::convert(&v19, &unk_10028EE78, 1, &v22);
...
LABEL_3:
  ...
  v10 = *(a1 + 1);
  v11 = *v9;
  if (*v10 != &unk_10028EE5C)
  {
    if (v11 != &unk_10028EE5C)
    {
...
LABEL_22:
  ...
  v17 = (v16 + 24);
  v18 = *(v16 + 24);
  v19 = v15 == &unk_10028EE5C;
  v6 = v18 == &unk_10028EE5C;
  if (v18 != &unk_10028EE5C)
  {
    v7 = a1;
...
LABEL_30:
  ...
  while (1)
  {
    ...
    v21 = *(v17 + 1);
    v22 = *v20;
    if (*v21 == &unk_10028EE5C)
    {
      if (v22 != &unk_10028EE5C)
      {
        if (v21 == v20)
        {
          goto LABEL_46;
...
{
  llvm::detail::IEEEFloat::IEEEFloat(&v11, &unk_10028EE78, a3, a4);
  if (v11 == &unk_10028EE5C)
  {
...
uint64_t llvm::APFloat::Storage::Storage(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (a3 == &unk_10028EE5C)
  {
    ...
    *a2 = &unk_10028F000;
    ...
    llvm::detail::IEEEFloat::IEEEFloat(&v12, &unk_10028EE24, v9, v10);
    *v3 = &unk_10028EE5C;
    operator new[]();
  }
...
LABEL_14:
  ...
  sub_10002B260(&v10, this, a3, a4);
  llvm::APFloat::convert(&v10, &unk_10028EE24, 1, &v7);
  if (*&v10 == &unk_10028EE5C)
  {
    v4 = v11;
  }
...
LABEL_14:
  ...
  sub_10002B260(&v10, this, a3, a4);
  llvm::APFloat::convert(&v10, &unk_10028EE08, 1, &v7);
  if (v10 == &unk_10028EE5C)
  {
    v4 = v11;
  }
...
__int128 *sub_10002B0F0(__int128 *result, __int128 *a2)
{
  v3 = *result;
  v4 = *a2;
  if (*result != &unk_10028EE5C)
...
llvm::detail::IEEEFloat *sub_10002B260(llvm::detail::IEEEFloat *result, const llvm::detail::IEEEFloat *a2, uint64_t a3, unsigned int a4)
{
  if (*a2 != &unk_10028EE5C)
  {
...
char *sub_10002B9D4(void *a1, char *a2, uint64_t *a3)
{
  v4 = a2;
  v6 = a1[1];
  v7 = a1[2];
...
void sub_10002BC18(unint64_t *a1, uint64_t *a2)
{
  v4 = a1[2];
  if (v4 == a1[3])
  {
...
unint64_t sub_10002C12C(unint64_t __src, uint64_t a2, char *a3, char *a4)
{
  if (a2)
  {
    if (__src == a3 || a3 == a4)
...
LABEL_43:
  ...
  *(a4 + 2) = v9;
  ...
  if (v19 == 1)
  {
    ...
    v39 = **a2;
    v40 = *v37 / v39;
    sub_10002F308(a3, v40);

    sub_10002F308(a4, v38 - v40 * v39);
  }
