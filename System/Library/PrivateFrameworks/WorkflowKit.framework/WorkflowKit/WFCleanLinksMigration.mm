...
+ (BOOL)workflowNeedsMigration:(id)migration fromClientVersion:(id)version
{
  ...
  {
    HasActionsWithIdentifier = WFWorkflowHasActionsWithIdentifier(@"com.smallpotatoes.evanston.cleanlinks", migrationCopy);
  }
    ...
    do
    {
      ...
      do
      {
        ...
        if (objc_msgSend_isEqualToString_(v10))
        {
          ...
          [v8 setObject:@"is.workflow.actions.url.expand" forKeyedSubscript:actionIdentifierKey2];
        }
