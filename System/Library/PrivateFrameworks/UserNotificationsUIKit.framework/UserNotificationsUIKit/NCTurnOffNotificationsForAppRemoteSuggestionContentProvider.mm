...
- (NCTurnOffNotificationsForAppRemoteSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate uuid:(id)uuid;
...
- (NCTurnOffNotificationsForAppRemoteSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate uuid:(id)uuid
{
  nameCopy = name;
  v20.receiver = self;
  v20.super_class = NCTurnOffNotificationsForAppRemoteSuggestionContentProvider;
  ...
  if (v13)
  {
    ...
    v17 = [v16 localizedStringForKey:@"NOTIFICATION_MANAGEMENT_SUGGESTION_EXPLANATION" value:&stru_282FE84F8 table:0];
...
- (id)auxiliaryOptionActions
{
  ...
  v19[1] = 3221225472;
  v19[2] = __85__NCTurnOffNotificationsForAppRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v19[3] = &unk_27836F428;
  objc_copyWeak(&v20, &location);
  v6 = [v3 actionWithTitle:v5 image:0 identifier:@"notification-management-turn-off-notifications-suggestion-keep" handler:v19];

  v7 = MEMORY[0x277D750C8];
  v9 = NCUserNotificationsUIKitFrameworkBundle(v8);
  v10 = [v9 localizedStringForKey:@"NOTIFICATION_MANAGEMENT_SUGGESTION_OFF" value:&stru_282FE84F8 table:0];
  v14 = MEMORY[0x277D85DD0];
  v15 = 3221225472;
  v16 = __85__NCTurnOffNotificationsForAppRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v17 = &unk_27836F428;
  objc_copyWeak(&v18, &location);
  v11 = [v7 actionWithTitle:v10 image:0 identifier:@"notification-management-turn-off-notifications-suggestion-off" handler:&v14];
...
- (void)handleKeepAction:(id)action
{
  ...
  [mEMORY[0x277CEB1B8] logSuggestionEvent:1 suggestionType:9 suggestionIdentifier:uuid timestamp:v6];
...
- (void)logSuggestionEvent:(int64_t)event
{
  ...
  uuid = [(NCRemoteSuggestionContentProvider *)self uuid];
  v6 = [MEMORY[0x277CBEAA8] now];
  [mEMORY[0x277CEB1B8] logSuggestionEvent:event suggestionType:9 suggestionIdentifier:uuid timestamp:v6];
}
