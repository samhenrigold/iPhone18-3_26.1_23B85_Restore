...
- (NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate;
...
- (NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate
{
  nameCopy = name;
  v18.receiver = self;
  v18.super_class = NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider;
  ...
  if (v11)
  {
    ...
    v15 = [v14 localizedStringForKey:@"NOTIFICATION_MANAGEMENT_TIME_SENSITIVE_IN_DIGEST_SUGGESTION" value:&stru_282FE84F8 table:0];
...
- (id)auxiliaryOptionActions
{
  ...
  v19[1] = 3221225472;
  v19[2] = __96__NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v19[3] = &unk_27836F428;
  objc_copyWeak(&v20, &location);
  v6 = [v3 actionWithTitle:v5 image:0 identifier:@"notification-management-suggestion-time-sensitive-in-digest-turn-off" handler:v19];
  ...
  v15 = 3221225472;
  v16 = __96__NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v17 = &unk_27836F428;
  objc_copyWeak(&v18, &location);
  v11 = [v7 actionWithTitle:v10 image:0 identifier:@"notification-management-suggestion-time-sensitive-in-digest-leave-on" handler:&v14];
