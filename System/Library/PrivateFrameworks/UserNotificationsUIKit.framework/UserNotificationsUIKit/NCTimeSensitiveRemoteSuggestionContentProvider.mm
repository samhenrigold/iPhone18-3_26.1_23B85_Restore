...
- (NCTimeSensitiveRemoteSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate uuid:(id)uuid
{
  nameCopy = name;
  v20.receiver = self;
  v20.super_class = NCTimeSensitiveRemoteSuggestionContentProvider;
  ...
  if (v13)
  {
    ...
    v17 = [v16 localizedStringForKey:@"NOTIFICATION_REMOTE_MANAGEMENT_TIME_SENSITIVE_SUGGESTION" value:&stru_282FE84F8 table:0];
...
- (id)auxiliaryOptionActions
{
  ...
  v19[1] = 3221225472;
  v19[2] = __72__NCTimeSensitiveRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v19[3] = &unk_27836F428;
  objc_copyWeak(&v20, &location);
  v6 = [v3 actionWithTitle:v5 image:0 identifier:@"notification-management-remote-suggestion-time-sensitive-turn-off" handler:v19];
  ...
  v15 = 3221225472;
  v16 = __72__NCTimeSensitiveRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v17 = &unk_27836F428;
  objc_copyWeak(&v18, &location);
  v11 = [v7 actionWithTitle:v10 image:0 identifier:@"notification-management-remote-suggestion-time-sensitive-leave-on" handler:&v14];
