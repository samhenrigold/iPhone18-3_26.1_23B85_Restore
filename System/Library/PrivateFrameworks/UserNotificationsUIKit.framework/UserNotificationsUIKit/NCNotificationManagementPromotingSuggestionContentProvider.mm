...
- (NCNotificationManagementPromotingSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate
{
  nameCopy = name;
  v18.receiver = self;
  v18.super_class = NCNotificationManagementPromotingSuggestionContentProvider;
...
- (id)auxiliaryOptionActions
{
  ...
  v5 = [v4 localizedStringForKey:@"NOTIFICATION_MANAGEMENT_SUGGESTION_KEEP_MENU" value:&stru_282FE84F8 table:0];
  v19[0] = MEMORY[0x277D85DD0];
  v19[1] = 3221225472;
  v19[2] = __84__NCNotificationManagementPromotingSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v19[3] = &unk_27836F428;
  objc_copyWeak(&v20, &location);
  v6 = [v3 actionWithTitle:v5 image:0 identifier:@"notification-management-promotion-suggestion-keep" handler:v19];
  ...
  v15 = 3221225472;
  v16 = __84__NCNotificationManagementPromotingSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v17 = &unk_27836F428;
  objc_copyWeak(&v18, &location);
  v11 = [v7 actionWithTitle:v10 image:0 identifier:@"notification-management-promotion-suggestion-off" handler:&v14];
