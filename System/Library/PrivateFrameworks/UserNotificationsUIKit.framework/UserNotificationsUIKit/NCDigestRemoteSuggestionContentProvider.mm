...
- (NCDigestRemoteSuggestionContentProvider)initWithNotificationRequest:(id)request bundleDisplayName:(id)name managementDelegate:(id)delegate suggestionDelegate:(id)suggestionDelegate uuid:(id)uuid
{
  nameCopy = name;
  v20.receiver = self;
  v20.super_class = NCDigestRemoteSuggestionContentProvider;
  ...
  if (v13)
  {
    ...
    v17 = [v16 localizedStringForKey:@"NOTIFICATION_REMOTE_MANAGEMENT_SUMMARY_SUGGESTION" value:&stru_282FE84F8 table:0];
...
- (id)auxiliaryOptionActions
{
  ...
  v5 = [v4 localizedStringForKey:@"NOTIFICATION_REMOTE_MANAGEMENT_SUGGESTION_NOT_NOW" value:&stru_282FE84F8 table:0];
  v19[0] = MEMORY[0x277D85DD0];
  v19[1] = 3221225472;
  v19[2] = __65__NCDigestRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v19[3] = &unk_27836F428;
  objc_copyWeak(&v20, &location);
  v6 = [v3 actionWithTitle:v5 image:0 identifier:@"notification-management-remote-suggestion-reject" handler:v19];

  v7 = MEMORY[0x277D750C8];
  v9 = NCUserNotificationsUIKitFrameworkBundle(v8);
  v10 = [v9 localizedStringForKey:@"NOTIFICATION_REMOTE_MANAGEMENT_SUMMARY_SUGGESTION_ADD_TO_SUMMARY" value:&stru_282FE84F8 table:0];
  v14 = MEMORY[0x277D85DD0];
  v15 = 3221225472;
  v16 = __65__NCDigestRemoteSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v17 = &unk_27836F428;
  objc_copyWeak(&v18, &location);
  v11 = [v7 actionWithTitle:v10 image:0 identifier:@"notification-management-remote-suggestion-accept" handler:&v14];
