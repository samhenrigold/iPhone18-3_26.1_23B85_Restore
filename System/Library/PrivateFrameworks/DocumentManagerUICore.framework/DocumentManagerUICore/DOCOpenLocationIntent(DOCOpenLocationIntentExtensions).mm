...
+ (void)intentFromActivity:()DOCOpenLocationIntentExtensions .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_249CE0000, a2, OS_LOG_TYPE_ERROR, "Unable to get DOCOpenLocationIntent from activity: %@", &v2, 0xCu);
}
...
+ (void)intentFromGenericIntent:()DOCOpenLocationIntentExtensions .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_249CE0000, a2, OS_LOG_TYPE_ERROR, "Unable create typed intent from intent: %@", &v2, 0xCu);
}
