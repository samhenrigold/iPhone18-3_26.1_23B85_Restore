...
- (MTLTexture)texture0;
- (MTLTexture)texture1;
- (NUNCalliopeOffscreen)initWithDevice:(id)device width:(int)width height:(int)height pixelFormat0:(unint64_t)format0 pixelFormat1:(unint64_t)format1 mipmaps:(int)mipmaps loadAction:(unint64_t)action clearColor0:(id)self0 clearColor1:(id)self1;
...
- (NUNCalliopeOffscreen)initWithDevice:(id)device width:(int)width height:(int)height pixelFormat0:(unint64_t)format0 pixelFormat1:(unint64_t)format1 mipmaps:(int)mipmaps loadAction:(unint64_t)action clearColor0:(id)self0 clearColor1:(id)self1
{
  ...
  v23 = color0.var0;
  deviceCopy = device;
  v26 = _NUNCalliopeCreateTexture(deviceCopy, v15, v14, mipmaps, format0, 0);
  v27 = _NUNCalliopeCreateTexture(deviceCopy, v15, v14, mipmaps, format1, 0);
  var3 = [(NUNCalliopeOffscreen *)self initWithDevice:deviceCopy width:v15 height:v14 texture0:v26 texture1:v27 loadAction:action clearColor0:v23 clearColor1:v22, v21, v20, var0, var1, var2, var3];
