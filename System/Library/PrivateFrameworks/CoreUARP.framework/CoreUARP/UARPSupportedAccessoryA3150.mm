...
- (UARPSupportedAccessoryA3150)init
{
  ...
  v16.receiver = self;
  v16.super_class = UARPSupportedAccessoryA3150;
  ...
  if (v2)
  {
    ...
    v9 = [[UARPAccessoryHardwareBluetooth alloc] initWithVendorIDSource:1 vendorID:+[UARPSupportedAccessoryBeatsBluetooth vendorID](UARPSupportedAccessoryBeatsBluetooth productID:"vendorID") productVersion:+[UARPSupportedAccessoryA3150 productID], 1];
    hwID = v2->hwID;
    v2->hwID = v9;
