...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationFTABSubfileTag;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationFTABSubfileTag metaDataTableEntry];
...
- (id)generateTLV
{
  ...
  v8 = uarpHtonl(+[UARPTLVPersonalizationFTABSubfileTag tlvType]);
  [v3 appendBytes:&v8 length:4];
  v7 = uarpHtonl(4u);
  [v3 appendBytes:&v7 length:4];
  tlvValue = [(UARPTLVPersonalizationFTABSubfileTag *)self tlvValue];
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:{+[UARPTLVPersonalizationFTABSubfileTag tlvType](UARPTLVPersonalizationFTABSubfileTag, "tlvType")}];
  v6[1] = v2;
