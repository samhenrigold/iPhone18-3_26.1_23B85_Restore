...
- (UARPSupportedAccessoryA2617)init
{
  ...
  v17.receiver = self;
  v17.super_class = UARPSupportedAccessoryA2617;
  ...
  if (v2)
  {
    ...
    v10 = [[UARPAccessoryHardwareBluetooth alloc] initWithVendorIDSource:1 vendorID:+[UARPSupportedAccessoryAirPodsCase vendorID](UARPSupportedAccessoryAirPodsCase productID:"vendorID") productVersion:+[UARPSupportedAccessoryA2617 productID], 1];
    hwID = v2->hwID;
    v2->hwID = v10;
