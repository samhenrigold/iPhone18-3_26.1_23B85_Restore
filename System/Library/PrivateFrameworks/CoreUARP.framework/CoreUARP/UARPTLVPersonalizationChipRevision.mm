...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationChipRevision;
...
- (void)setChipRevision:(unsigned int)revision
{
  obj = self;
  objc_sync_enter(obj);
  *(&obj->super.super._tlvLength + 1) = revision;
  objc_sync_exit(obj);
}

- (id)description
{
  v3 = +[UARPTLVPersonalizationChipRevision metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationChipRevision tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationChipRevision;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationChipRevision;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:{+[UARPTLVPersonalizationChipRevision tlvType](UARPTLVPersonalizationChipRevision, "tlvType")}];
  v6[1] = v2;
