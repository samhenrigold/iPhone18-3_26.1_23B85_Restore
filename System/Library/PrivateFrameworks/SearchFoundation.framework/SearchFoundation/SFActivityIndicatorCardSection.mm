...
- (SFActivityIndicatorCardSection)initWithCoder:(id)coder;
- (SFActivityIndicatorCardSection)initWithProtobuf:(id)protobuf;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFActivityIndicatorCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            type = [(SFActivityIndicatorCardSection *)self type];
            type2 = [(SFActivityIndicatorCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v53 = type2;
              ...
              if (v52)
              {
                type3 = [(SFActivityIndicatorCardSection *)self type];
                type4 = [(SFActivityIndicatorCardSection *)v6 type];
                v50 = type3;
                if (![type3 isEqual:?])
                {
                  v11 = 0;
              ...
              if (separatorStyle == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((backgroundColor != 0) != (backgroundColor2 == 0))
                {
                  ...
                  {
                    text = [(SFActivityIndicatorCardSection *)self text];
                    text2 = [(SFActivityIndicatorCardSection *)v6 text];
                    v40 = text2;
                    if ((text != 0) == (text2 == 0))
                    {
...
LABEL_66:
                    ...
                    {
                      text3 = [(SFActivityIndicatorCardSection *)self text];
                      if (text3)
                      {
                        v42 = text3;
                        text4 = [(SFActivityIndicatorCardSection *)self text];
                        text5 = [(SFActivityIndicatorCardSection *)v6 text];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBActivityIndicatorCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBActivityIndicatorCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBActivityIndicatorCardSection *)v2 dictionaryRepresentation];
...
- (SFActivityIndicatorCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFActivityIndicatorCardSection *)v5 setType:type];
    ...
    [(SFActivityIndicatorCardSection *)v5 setText:text];
...
- (SFActivityIndicatorCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v32.receiver = self;
  v32.super_class = SFActivityIndicatorCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFActivityIndicatorCardSection *)v5 setType:type2];
    }
    ...
    if (text)
    {
      ...
      [(SFActivityIndicatorCardSection *)v5 setText:text2];
    }
