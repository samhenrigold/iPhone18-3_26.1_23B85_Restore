...
- (_SFPBAppLinkCardSection)initWithFacade:(id)facade
{
  ...
  if (v5)
  {
    ...
    v31 = [appLinks2 countByEnumeratingWithState:&v38 objects:v46 count:16];
    if (v31)
    {
      v32 = v31;
      v33 = *v39;
      do
      {
        for (j = 0; j != v32; ++j)
        {
          ...
          v35 = [[_SFPBAppLink alloc] initWithFacade:*(*(&v38 + 1) + 8 * j)];
          if (v35)
          {
            [v29 addObject:v35];
          }
        ...
        v32 = [appLinks2 countByEnumeratingWithState:&v38 objects:v46 count:16];
      }
...
- (_SFPBAppLinkCardSection)initWithDictionary:(id)dictionary
{
  ...
  v62.receiver = self;
  v62.super_class = _SFPBAppLinkCardSection;
...
- (void)writeTo:(id)to
{
  ...
  v23 = 0u;
  v24 = 0u;
  v17 = [appLinks countByEnumeratingWithState:&v21 objects:v29 count:16];
  if (v17)
  {
    v18 = v17;
    v19 = *v22;
    do
    {
      ...
      while (v18 != v20);
      v18 = [appLinks countByEnumeratingWithState:&v21 objects:v29 count:16];
    }
