...
- (SFMiniCardSection)initWithCoder:(id)coder;
- (SFMiniCardSection)initWithProtobuf:(id)protobuf;
...
- (SFMiniCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v42.receiver = self;
  v42.super_class = SFMiniCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFMiniCardSection *)v5 setType:type2];
    }
...
- (unint64_t)hash
{
  ...
  type = [(SFMiniCardSection *)self type];
  v14 = hasBottomPadding ^ [type hash];
  v15 = v14 ^ [(SFCardSection *)self separatorStyle];
  backgroundColor = [(SFCardSection *)self backgroundColor];
  v17 = v15 ^ [backgroundColor hash];
  title = [(SFMiniCardSection *)self title];
  v19 = v11 ^ v17 ^ [title hash];
  subtitle = [(SFMiniCardSection *)self subtitle];
  v21 = [subtitle hash];
  image = [(SFMiniCardSection *)self image];
  v23 = v21 ^ [image hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFMiniCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v67.receiver = self;
...
LABEL_40:
        ...
        if (canBeHidden == [(SFCardSection *)v5 canBeHidden])
        {
          ...
          if (hasTopPadding == [(SFCardSection *)v5 hasTopPadding])
          {
            ...
            {
              type = [(SFMiniCardSection *)self type];
              type2 = [(SFMiniCardSection *)v5 type];
              if ((type != 0) != (type2 == 0))
              {
                v55 = type2;
                v56 = type;
                ...
                if (v57)
                {
                  type3 = [(SFMiniCardSection *)self type];
                  type4 = [(SFMiniCardSection *)v5 type];
                  if (![type3 isEqual:?])
                  {
                    goto LABEL_50;
                  }
                ...
                if (separatorStyle == [(SFCardSection *)v5 separatorStyle])
                {
                  ...
                  if ((backgroundColor != 0) != (backgroundColor2 == 0))
                  {
                    ...
                    title = [(SFMiniCardSection *)self title];
                    title2 = [(SFMiniCardSection *)v5 title];
                    if ((title != 0) == (title2 == 0))
                    {
...
LABEL_57:
                    ...
                    title3 = [(SFMiniCardSection *)self title];
                    if (title3)
                    {
                      title4 = [(SFMiniCardSection *)self title];
                      title5 = [(SFMiniCardSection *)v5 title];
                      v42 = title4;
                      if (![title4 isEqual:?])
                      {
                        v11 = 0;
...
LABEL_24:
                    ...
                    subtitle = [(SFMiniCardSection *)self subtitle];
                    subtitle2 = [(SFMiniCardSection *)v5 subtitle];
                    ...
                    subtitle3 = [(SFMiniCardSection *)self subtitle];
                    if (!subtitle3 || (-[SFMiniCardSection subtitle](self, "subtitle"), v32 = objc_claimAutoreleasedReturnValue(), -[SFMiniCardSection subtitle](v5, "subtitle"), v36 = objc_claimAutoreleasedReturnValue(), v37 = v32, [v32 isEqual:?]))
                    {
                      image = [(SFMiniCardSection *)self image];
                      image2 = [(SFMiniCardSection *)v5 image];
                      if ((image != 0) == (image2 == 0))
                      {
                      ...
                      {
                        image3 = [(SFMiniCardSection *)self image];
                        if (image3)
                        {
                          image4 = [(SFMiniCardSection *)self image];
                          image5 = [(SFMiniCardSection *)v5 image];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBMiniCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMiniCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBMiniCardSection *)v2 dictionaryRepresentation];
...
- (SFMiniCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFMiniCardSection *)v5 setType:type];
    ...
    [(SFMiniCardSection *)v5 setTitle:title];

    subtitle = [(SFCardSection *)v8 subtitle];
    [(SFMiniCardSection *)v5 setSubtitle:subtitle];

    image = [(SFCardSection *)v8 image];
    [(SFMiniCardSection *)v5 setImage:image];
