...
- (_SFPBTrackListCardSection)initWithFacade:(id)facade
{
  ...
  if (v5)
  {
    ...
    v31 = [tracks2 countByEnumeratingWithState:&v38 objects:v46 count:16];
    if (v31)
    {
      v32 = v31;
      v33 = *v39;
      do
      {
        for (j = 0; j != v32; ++j)
        {
          ...
          v35 = [[_SFPBTrack alloc] initWithFacade:*(*(&v38 + 1) + 8 * j)];
          if (v35)
          {
            [v29 addObject:v35];
          }
        ...
        v32 = [tracks2 countByEnumeratingWithState:&v38 objects:v46 count:16];
      }
...
- (_SFPBTrackListCardSection)initWithDictionary:(id)dictionary
{
  ...
  v62.receiver = self;
  v62.super_class = _SFPBTrackListCardSection;
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSArray *)self->_tracks count])
  {
    ...
    v42 = 0u;
    v29 = self->_tracks;
    v30 = [(NSArray *)v29 countByEnumeratingWithState:&v39 objects:v47 count:16];
    if (v30)
    {
      v31 = v30;
      v32 = *v40;
      do
      {
        ...
        v31 = [(NSArray *)v29 countByEnumeratingWithState:&v39 objects:v47 count:16];
      }
...
- (void)writeTo:(id)to
{
  ...
  v23 = 0u;
  v24 = 0u;
  v17 = [tracks countByEnumeratingWithState:&v21 objects:v29 count:16];
  if (v17)
  {
    v18 = v17;
    v19 = *v22;
    do
    {
      ...
      while (v18 != v20);
      v18 = [tracks countByEnumeratingWithState:&v21 objects:v29 count:16];
    }
