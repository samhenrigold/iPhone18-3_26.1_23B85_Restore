...
- (_SFPBTextColumn)initWithFacade:(id)facade
{
  ...
  if (v5)
  {
    ...
    v9 = [sections2 countByEnumeratingWithState:&v16 objects:v20 count:16];
    if (v9)
    {
      v10 = v9;
      v11 = *v17;
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = [[_SFPBTextColumnSection alloc] initWithFacade:*(*(&v16 + 1) + 8 * i)];
          if (v13)
          {
            [v7 addObject:v13];
          }
        ...
        v10 = [sections2 countByEnumeratingWithState:&v16 objects:v20 count:16];
      }
...
- (_SFPBTextColumn)initWithDictionary:(id)dictionary
{
  ...
  v21.receiver = self;
  v21.super_class = _SFPBTextColumn;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = [(_SFPBTextColumnSection *)v13 initWithDictionary:v12, v17];
...
- (void)writeTo:(id)to
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      while (v7 != v9);
      v7 = [sections countByEnumeratingWithState:&v10 objects:v14 count:16];
    }
