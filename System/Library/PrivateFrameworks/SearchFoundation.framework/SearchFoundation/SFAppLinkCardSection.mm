...
- (SFAppLinkCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v46.receiver = self;
  v46.super_class = SFAppLinkCardSection;
  ...
  if (v5)
  {
    ...
    v31 = [appLinks2 countByEnumeratingWithState:&v38 objects:v47 count:16];
    if (v31)
    {
      v32 = v31;
      v33 = *v39;
      do
      {
        for (j = 0; j != v32; ++j)
        {
          ...
          v35 = [[SFAppLink alloc] initWithProtobuf:*(*(&v38 + 1) + 8 * j)];
          if (v35)
          {
            [v29 addObject:v35];
          }
        ...
        v32 = [appLinks2 countByEnumeratingWithState:&v38 objects:v47 count:16];
      }
