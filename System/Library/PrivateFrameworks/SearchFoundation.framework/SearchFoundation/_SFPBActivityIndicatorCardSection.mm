...
- (NSData)jsonData;
- (_SFPBActivityIndicatorCardSection)initWithDictionary:(id)dictionary;
- (_SFPBActivityIndicatorCardSection)initWithFacade:(id)facade;
- (_SFPBActivityIndicatorCardSection)initWithJSON:(id)n;
...
- (_SFPBActivityIndicatorCardSection)initWithFacade:(id)facade
{
  ...
  if (v5)
  {
    ...
    if (punchoutPickerTitle)
    {
      ...
      [(_SFPBActivityIndicatorCardSection *)v5 setPunchoutPickerTitle:punchoutPickerTitle2];
    }
    ...
    if (punchoutPickerDismissText)
    {
      ...
      [(_SFPBActivityIndicatorCardSection *)v5 setPunchoutPickerDismissText:punchoutPickerDismissText2];
    }

    if ([facadeCopy hasCanBeHidden])
    {
      -[_SFPBActivityIndicatorCardSection setCanBeHidden:](v5, "setCanBeHidden:", [facadeCopy canBeHidden]);
    }

    if ([facadeCopy hasHasTopPadding])
    {
      -[_SFPBActivityIndicatorCardSection setHasTopPadding:](v5, "setHasTopPadding:", [facadeCopy hasTopPadding]);
    }

    if ([facadeCopy hasHasBottomPadding])
    {
      -[_SFPBActivityIndicatorCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", [facadeCopy hasBottomPadding]);
    }
    ...
    if (type)
    {
      ...
      [(_SFPBActivityIndicatorCardSection *)v5 setType:type2];
    }

    if ([facadeCopy hasSeparatorStyle])
    {
      -[_SFPBActivityIndicatorCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", [facadeCopy separatorStyle]);
    }
    ...
    if (text)
    {
      ...
      [(_SFPBActivityIndicatorCardSection *)v5 setText:text2];
    }
...
- (_SFPBActivityIndicatorCardSection)initWithDictionary:(id)dictionary
{
  ...
  v38.receiver = self;
  v38.super_class = _SFPBActivityIndicatorCardSection;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(_SFPBActivityIndicatorCardSection *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    backgroundColor = [(_SFPBActivityIndicatorCardSection *)self backgroundColor];
  ...
  if ([(NSArray *)self->_punchoutOptions count])
  {
    ...
    v12 = [(NSArray *)v11 countByEnumeratingWithState:&v29 objects:v33 count:16];
    if (v12)
    {
      v13 = v12;
      v14 = *v30;
      do
      {
        ...
        v13 = [(NSArray *)v11 countByEnumeratingWithState:&v29 objects:v33 count:16];
      }
  ...
  {
    punchoutPickerDismissText = [(_SFPBActivityIndicatorCardSection *)self punchoutPickerDismissText];
  ...
  {
    punchoutPickerTitle = [(_SFPBActivityIndicatorCardSection *)self punchoutPickerTitle];
  ...
  {
    separatorStyle = [(_SFPBActivityIndicatorCardSection *)self separatorStyle];
    if (separatorStyle >= 6)
    {
  ...
  if (self->_text)
  {
    text = [(_SFPBActivityIndicatorCardSection *)self text];
    v25 = [text copy];
    [dictionary setObject:v25 forKeyedSubscript:@"text"];
  }

  if (self->_type)
  {
    type = [(_SFPBActivityIndicatorCardSection *)self type];
    v27 = [type copy];
...
- (BOOL)isEqual:(id)equal
{
  ...
  punchoutOptions = [(_SFPBActivityIndicatorCardSection *)self punchoutOptions];
  ...
  punchoutOptions3 = [(_SFPBActivityIndicatorCardSection *)self punchoutOptions];
  if (punchoutOptions3)
  {
    v8 = punchoutOptions3;
    punchoutOptions4 = [(_SFPBActivityIndicatorCardSection *)self punchoutOptions];
  ...
  punchoutOptions = [(_SFPBActivityIndicatorCardSection *)self punchoutPickerTitle];
  ...
  if (punchoutPickerTitle)
  {
    ...
    punchoutPickerTitle2 = [(_SFPBActivityIndicatorCardSection *)self punchoutPickerTitle];
  ...
  punchoutOptions = [(_SFPBActivityIndicatorCardSection *)self punchoutPickerDismissText];
  ...
  if (punchoutPickerDismissText)
  {
    ...
    punchoutPickerDismissText2 = [(_SFPBActivityIndicatorCardSection *)self punchoutPickerDismissText];
  ...
  punchoutOptions = [(_SFPBActivityIndicatorCardSection *)self type];
  ...
  {
    v26 = type;
    type2 = [(_SFPBActivityIndicatorCardSection *)self type];
  ...
  punchoutOptions = [(_SFPBActivityIndicatorCardSection *)self backgroundColor];
  ...
  {
    v32 = backgroundColor;
    backgroundColor2 = [(_SFPBActivityIndicatorCardSection *)self backgroundColor];
  ...
  punchoutOptions = [(_SFPBActivityIndicatorCardSection *)self text];
...
LABEL_39:
  ...
  v37 = text;
  text2 = [(_SFPBActivityIndicatorCardSection *)self text];
