...
- (SFNowPlayingCardSection)initWithCoder:(id)coder;
- (SFNowPlayingCardSection)initWithProtobuf:(id)protobuf;
...
{
  v25.receiver = self;
  v25.super_class = SFNowPlayingCardSection;
  ...
  v21 = [subtitle hash];
  movies = [(SFNowPlayingCardSection *)self movies];
  v23 = v21 ^ [movies hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFNowPlayingCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v67.receiver = self;
      v67.super_class = SFNowPlayingCardSection;
...
LABEL_24:
                    ...
                    {
                      movies = [(SFNowPlayingCardSection *)self movies];
                      movies2 = [(SFNowPlayingCardSection *)v5 movies];
                      if ((movies != 0) == (movies2 == 0))
                      {
                      ...
                      {
                        movies3 = [(SFNowPlayingCardSection *)self movies];
                        if (movies3)
                        {
                          movies4 = [(SFNowPlayingCardSection *)self movies];
                          movies5 = [(SFNowPlayingCardSection *)v5 movies];
                          v11 = [movies4 isEqual:movies5];
                        }
...
{
  v22.receiver = self;
  v22.super_class = SFNowPlayingCardSection;
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBNowPlayingCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBNowPlayingCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBNowPlayingCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFNowPlayingCardSection;
...
- (SFNowPlayingCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    movies = [(SFCardSection *)v8 movies];
    [(SFNowPlayingCardSection *)v5 setMovies:movies];
...
- (SFNowPlayingCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v46.receiver = self;
  v46.super_class = SFNowPlayingCardSection;
  ...
  if (v5)
  {
    ...
    v38 = 0u;
    v39 = 0u;
    movies2 = [protobufCopy movies];
    v31 = [movies2 countByEnumeratingWithState:&v38 objects:v47 count:16];
    if (v31)
    {
      v32 = v31;
      v33 = *v39;
      do
      {
        for (j = 0; j != v32; ++j)
        {
          ...
          v35 = [[SFMediaItem alloc] initWithProtobuf:*(*(&v38 + 1) + 8 * j)];
          if (v35)
          {
            [v29 addObject:v35];
          }
        ...
        v32 = [movies2 countByEnumeratingWithState:&v38 objects:v47 count:16];
      }
