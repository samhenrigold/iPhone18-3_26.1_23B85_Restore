...
- (SFWebCardSection)initWithCoder:(id)coder;
- (SFWebCardSection)initWithProtobuf:(id)protobuf;
...
- (SFWebCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v32.receiver = self;
  v32.super_class = SFWebCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFWebCardSection *)v5 setType:type2];
    }
    ...
    htmlString = [protobufCopy htmlString];

    if (htmlString)
    {
      htmlString2 = [protobufCopy htmlString];
      [(SFWebCardSection *)v5 setHtmlString:htmlString2];
    }
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFWebCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
...
LABEL_47:
            ...
            type = [(SFWebCardSection *)self type];
            type2 = [(SFWebCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v53 = type2;
              ...
              if (v52)
              {
                type3 = [(SFWebCardSection *)self type];
                type4 = [(SFWebCardSection *)v6 type];
                v50 = type3;
                if (![type3 isEqual:?])
                {
                  v11 = 0;
              ...
              if (separatorStyle == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((backgroundColor != 0) != (backgroundColor2 == 0))
                {
                  ...
                  {
                    htmlString = [(SFWebCardSection *)self htmlString];
                    htmlString2 = [(SFWebCardSection *)v6 htmlString];
                    v40 = htmlString2;
                    if ((htmlString != 0) == (htmlString2 == 0))
                    {
...
LABEL_66:
                    ...
                    {
                      htmlString3 = [(SFWebCardSection *)self htmlString];
                      if (htmlString3)
                      {
                        v42 = htmlString3;
                        htmlString4 = [(SFWebCardSection *)self htmlString];
                        htmlString5 = [(SFWebCardSection *)v6 htmlString];
                        v11 = [htmlString4 isEqual:htmlString5];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBWebCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWebCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBWebCardSection *)v2 dictionaryRepresentation];
...
- (SFWebCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFWebCardSection *)v5 setType:type];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    backgroundColor = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:backgroundColor];

    htmlString = [(SFCardSection *)v8 htmlString];
    [(SFWebCardSection *)v5 setHtmlString:htmlString];
