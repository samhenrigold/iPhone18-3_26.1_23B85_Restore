...
- (SFProductCardSection)initWithCoder:(id)coder;
- (SFProductCardSection)initWithProtobuf:(id)protobuf;
...
- (SFProductCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v32.receiver = self;
  v32.super_class = SFProductCardSection;
  ...
  if (v5)
  {
    ...
    v9 = [punchoutOptions2 countByEnumeratingWithState:&v28 objects:v33 count:16];
    if (v9)
    {
      v10 = v9;
      v11 = *v29;
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = [[SFPunchout alloc] initWithProtobuf:*(*(&v28 + 1) + 8 * i)];
          if (v13)
          {
            [v7 addObject:v13];
          }
        ...
        v10 = [punchoutOptions2 countByEnumeratingWithState:&v28 objects:v33 count:16];
      }
    ...
    if (type)
    {
      ...
      [(SFProductCardSection *)v5 setType:type2];
    }
    ...
    productJSON = [protobufCopy productJSON];

    if (productJSON)
    {
      productJSON2 = [protobufCopy productJSON];
      [(SFProductCardSection *)v5 setProductJSON:productJSON2];
    }
...
{
  v21.receiver = self;
  v21.super_class = SFProductCardSection;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFProductCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = SFProductCardSection;
...
LABEL_47:
            ...
            type = [(SFProductCardSection *)self type];
            type2 = [(SFProductCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v53 = type2;
              [(SFProductCardSection *)self type];
              v52 = v51 = type;
              if (v52)
              {
                type3 = [(SFProductCardSection *)self type];
                type4 = [(SFProductCardSection *)v6 type];
                v50 = type3;
                if (![type3 isEqual:?])
                {
                  v11 = 0;
              ...
              if (separatorStyle == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((backgroundColor != 0) != (backgroundColor2 == 0))
                {
                  ...
                  {
                    productJSON = [(SFProductCardSection *)self productJSON];
                    productJSON2 = [(SFProductCardSection *)v6 productJSON];
                    v40 = productJSON2;
                    if ((productJSON != 0) == (productJSON2 == 0))
                    {
...
LABEL_66:
                    ...
                    {
                      productJSON3 = [(SFProductCardSection *)self productJSON];
                      if (productJSON3)
                      {
                        v42 = productJSON3;
                        productJSON4 = [(SFProductCardSection *)self productJSON];
                        productJSON5 = [(SFProductCardSection *)v6 productJSON];
                        v11 = [productJSON4 isEqual:productJSON5];
...
{
  v18.receiver = self;
  v18.super_class = SFProductCardSection;
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBProductCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBProductCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBProductCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFProductCardSection;
...
- (SFProductCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFProductCardSection *)v5 setType:type];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    backgroundColor = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:backgroundColor];

    productJSON = [(SFCardSection *)v8 productJSON];
    [(SFProductCardSection *)v5 setProductJSON:productJSON];
