...
- (SFWatchListCardSection)initWithCoder:(id)coder;
- (SFWatchListCardSection)initWithProtobuf:(id)protobuf;
...
{
  v21.receiver = self;
  v21.super_class = SFWatchListCardSection;
  ...
  type = [(SFWatchListCardSection *)self type];
  v14 = hasBottomPadding ^ [type hash];
  v15 = v14 ^ [(SFCardSection *)self separatorStyle];
  backgroundColor = [(SFCardSection *)self backgroundColor];
  v17 = v15 ^ [backgroundColor hash];
  watchListItem = [(SFWatchListCardSection *)self watchListItem];
  v19 = v17 ^ [watchListItem hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFWatchListCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = SFWatchListCardSection;
...
LABEL_47:
            ...
            type = [(SFWatchListCardSection *)self type];
            type2 = [(SFWatchListCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v53 = type2;
              [(SFWatchListCardSection *)self type];
              v52 = v51 = type;
              if (v52)
              {
                type3 = [(SFWatchListCardSection *)self type];
                type4 = [(SFWatchListCardSection *)v6 type];
                v50 = type3;
                if (![type3 isEqual:?])
                {
                  v11 = 0;
              ...
              if (separatorStyle == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((backgroundColor != 0) != (backgroundColor2 == 0))
                {
                  ...
                  {
                    watchListItem = [(SFWatchListCardSection *)self watchListItem];
                    watchListItem2 = [(SFWatchListCardSection *)v6 watchListItem];
                    v40 = watchListItem2;
...
LABEL_66:
                    ...
                    {
                      watchListItem3 = [(SFWatchListCardSection *)self watchListItem];
                      if (watchListItem3)
                      {
                        v42 = watchListItem3;
                        watchListItem4 = [(SFWatchListCardSection *)self watchListItem];
                        watchListItem5 = [(SFWatchListCardSection *)v6 watchListItem];
...
{
  v18.receiver = self;
  v18.super_class = SFWatchListCardSection;
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBWatchListCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWatchListCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBWatchListCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFWatchListCardSection;
...
- (SFWatchListCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFWatchListCardSection *)v5 setType:type];
    ...
    [(SFWatchListCardSection *)v5 setWatchListItem:watchListItem];
...
- (SFWatchListCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v34.receiver = self;
  v34.super_class = SFWatchListCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFWatchListCardSection *)v5 setType:type2];
    }
    ...
    if (watchListItem)
    {
      ...
      v27 = [(SFWatchListItem *)v25 initWithProtobuf:watchListItem2];
