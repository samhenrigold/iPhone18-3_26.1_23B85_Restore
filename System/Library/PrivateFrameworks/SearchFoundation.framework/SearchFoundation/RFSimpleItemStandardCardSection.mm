...
- (RFSimpleItemStandardCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v48.receiver = self;
  v48.super_class = RFSimpleItemStandardCardSection;
  ...
  if (v5)
  {
    ...
    v17 = [text_3s2 countByEnumeratingWithState:&v44 objects:v50 count:16];
    if (v17)
    {
      v18 = v17;
      v19 = *v45;
      do
      {
        ...
        v18 = [text_3s2 countByEnumeratingWithState:&v44 objects:v50 count:16];
      }
    ...
    v25 = [text_4s2 countByEnumeratingWithState:&v40 objects:v49 count:16];
    if (v25)
    {
      v26 = v25;
      v27 = *v41;
      do
      {
        ...
        v26 = [text_4s2 countByEnumeratingWithState:&v40 objects:v49 count:16];
      }
