...
- (SFAppIconCardSection)initWithCoder:(id)coder;
- (SFAppIconCardSection)initWithProtobuf:(id)protobuf;
...
- (unint64_t)hash
{
  ...
  type = [(SFAppIconCardSection *)self type];
  v14 = hasBottomPadding ^ [type hash];
  v15 = v14 ^ [(SFCardSection *)self separatorStyle];
  backgroundColor = [(SFCardSection *)self backgroundColor];
  v17 = v15 ^ [backgroundColor hash];
  title = [(SFAppIconCardSection *)self title];
  v19 = v11 ^ v17 ^ [title hash];
  applicationBundleIdentifier = [(SFCardSection *)self applicationBundleIdentifier];
  v21 = [applicationBundleIdentifier hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFAppIconCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            type = [(SFAppIconCardSection *)self type];
            type2 = [(SFAppIconCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v63 = type2;
              v76 = type;
              type3 = [(SFAppIconCardSection *)self type];
              if (type3)
              {
                type4 = [(SFAppIconCardSection *)self type];
                type5 = [(SFAppIconCardSection *)v6 type];
                if (![type4 isEqual:?])
                {
                  v11 = 0;
                  goto LABEL_68;
              ...
              if ((backgroundColor != 0) != (backgroundColor2 == 0))
              {
                ...
                title = [(SFAppIconCardSection *)self title];
                title2 = [(SFAppIconCardSection *)v6 title];
                v43 = title2;
                if ((title != 0) == (title2 == 0))
                {
...
LABEL_65:
                ...
                title3 = [(SFAppIconCardSection *)self title];
                if (!title3 || (-[SFAppIconCardSection title](self, "title"), v44 = objc_claimAutoreleasedReturnValue(), -[SFAppIconCardSection title](v6, "title"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  applicationBundleIdentifier = [(SFCardSection *)self applicationBundleIdentifier];
                  applicationBundleIdentifier2 = [(SFCardSection *)v6 applicationBundleIdentifier];
                  v46 = applicationBundleIdentifier2;
                  ...
                  {
                    applicationBundleIdentifier3 = [(SFCardSection *)self applicationBundleIdentifier];
                    if (applicationBundleIdentifier3)
                    {
                      applicationBundleIdentifier4 = [(SFCardSection *)self applicationBundleIdentifier];
                      applicationBundleIdentifier5 = [(SFCardSection *)v6 applicationBundleIdentifier];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  applicationBundleIdentifier = [(SFCardSection *)self applicationBundleIdentifier];
  v18 = [applicationBundleIdentifier copy];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBAppIconCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBAppIconCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBAppIconCardSection *)v2 dictionaryRepresentation];
...
- (SFAppIconCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFAppIconCardSection *)v5 setType:type];
    ...
    [(SFAppIconCardSection *)v5 setTitle:title];
    ...
    applicationBundleIdentifier2 = [(SFCardSection *)v8 applicationBundleIdentifier];
    [(SFCardSection *)v5 setApplicationBundleIdentifier:applicationBundleIdentifier2];
  }
...
- (SFAppIconCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v34.receiver = self;
  v34.super_class = SFAppIconCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFAppIconCardSection *)v5 setType:type2];
    }
    ...
    if (title)
    {
      ...
      [(SFAppIconCardSection *)v5 setTitle:title2];
    }
