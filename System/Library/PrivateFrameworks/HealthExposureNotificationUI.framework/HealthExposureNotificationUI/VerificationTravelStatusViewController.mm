...
- (BOOL)tableView:(id)view shouldHighlightRowAtIndexPath:(id)path
{
  ...
  v10 = *(&self->super.super.super.super.super.super.isa + OBJC_IVAR____TtC28HealthExposureNotificationUI38VerificationTravelStatusViewController_dataSource);
  if (v10)
  {
    selfCopy = self;
    v12 = v10;
...
- (void)tableView:(id)view didSelectRowAtIndexPath:(id)path
{
  ...
  viewCopy = view;
  selfCopy = self;
  VerificationTravelStatusViewController.tableView(_:didSelectRowAt:)(viewCopy, v9);
...
- (double)tableView:(id)view heightForRowAtIndexPath:(id)path
{
  ...
  viewCopy = view;
  selfCopy = self;
  VerificationTravelStatusViewController.tableView(_:heightForRowAt:)(viewCopy, v9);
  v13 = v12;
...
- (void)didTapSecondaryButton
{
  v3 = *(&self->super.super.super.super.super._responderFlags + OBJC_IVAR____TtC28HealthExposureNotificationUI38VerificationTravelStatusViewController_flow);
  swift_getObjectType();
  v4 = *(v3 + 120);
  selfCopy = self;
  v4();
