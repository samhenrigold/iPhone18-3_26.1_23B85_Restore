...
- (id)description
{
  ...
  dictionaryRepresentation = [(VMTranscriptMessage *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [dictionary setObject:transcriptionData forKey:@"transcriptionData"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if (*&self->_has)
  {
    toCopy[2] = self->_protocolVersion;
    *(toCopy + 24) |= 1u;
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v7 = [(NSData *)self->_transcriptionData copyWithZone:zone];
  v8 = v6[2];
  v6[2] = v7;
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[6])
  {
    self->_protocolVersion = fromCopy[2];
    *&self->_has |= 1u;
  }
