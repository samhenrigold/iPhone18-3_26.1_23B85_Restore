...
- (void)stateManager:(id)manager didReceiveLocalUpdate:(id)update
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v18 = 2112;
    v19 = updateCopy;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Received local analysis state update: %@", buf, 0x16u);
  }
...
- (void)_handleRemoteAnalysisStateUpdate:(id)update
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling remote state update: %@", &v17, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = identifier;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Received nil analysis state update from message with identifier: %@", &v17, 0x16u);
    }
...
- (void)_publishAnalysisStateUpdate
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v28 = 2112;
        v29 = v6;
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize %@: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v25 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invoking _publishAnalysisStateUpdate with nil stateUpdate!", buf, 0xCu);
    }
...
void __62__HMDCameraAnalysisStatePublisher__publishAnalysisStateUpdate__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (([v4 isCurrentDevice] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v9;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending state update to %@", &v17, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_47446 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t6_47446, &__block_literal_global_47447);
  }

  v3 = logCategory__hmf_once_v7_47448;
...
void __46__HMDCameraAnalysisStatePublisher_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v7_47448;
  logCategory__hmf_once_v7_47448 = v0;
}
