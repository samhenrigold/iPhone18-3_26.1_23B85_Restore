...
- (void)routeAccessorySettingsUpdateRequestMessage:(id)message
{
  ...
  v13 = v9;
  v11 = v9;
  [messageRouter routeMessage:v11 localHandler:v12];
}
...
- (void)routeAccessorySettingsFetchRequestMessage:(id)message
{
  ...
  v24 = v20;
  v22 = v20;
  [messageRouter routeMessage:v22 localHandler:v23];
}
...
void __123__HMDAccessorySettingsMessenger_sendUpdateAccessorySettingRequestWithAccessoryUUID_keyPath_settingValue_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Send update request responded with error: %@", &v13, 0x16u);
    }
  }
  ...
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Send update request responded", &v13, 0xCu);
  }
...
LABEL_4:
  ...
  if (!payloadCopy)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v51 = 2112;
      v52 = 0;
      _os_log_impl(&dword_229538000, v33, OS_LOG_TYPE_ERROR, "%{public}@Send fetch request responded with error: %@", buf, 0x16u);
    }
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v51 = 2112;
    v52 = payloadCopy;
    _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode fetch request response payload: %@", buf, 0x16u);
  }
...
- (id)fetchLogEventFromMessage:(id)message
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v20;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode fetch request payload for metric generation", &v22, 0xCu);
    }
...
void __111__HMDAccessorySettingsMessenger_sendFetchAccessorySettingsRequestWithAccessoryUUID_keyPaths_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v12;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Send fetch request responded", &v22, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 2112;
        v25 = v6;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode fetch request response payload: %@", &v22, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = v5;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Send fetch request responded with error: %@", &v22, 0x16u);
    }
...
void __44__HMDAccessorySettingsMessenger_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v12_252821;
  logCategory__hmf_once_v12_252821 = v0;
}
