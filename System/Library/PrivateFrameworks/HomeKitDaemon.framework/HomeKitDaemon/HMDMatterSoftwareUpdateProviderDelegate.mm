...
- (void)resetOTAProviderStateForHMDHAPAccessory:(id)accessory
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = accessoryCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ Resetting OTA provider state for %@", &v23, 0x20u);
  }
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", &v23, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", &v23, 0x16u);
    }
...
- (BOOL)canEstablishConnectionForHMDHAPAccessory:(id)accessory
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ canEstablishConnectionForHMDHAPAccessory", &v25, 0x16u);
  }
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", &v25, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", &v25, 0x16u);
    }
...
- (void)notifyUpdateRequestedForHMDHAPAccessory:(id)accessory isUserTriggered:(BOOL)triggered isRetry:(BOOL)retry
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v39 = 2112;
    v40 = v15;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@%@ notifyUpdateRequestedForHMDHAPAccessory, isUserTriggered: %@, isRetry: %@", &v33, 0x2Au);
  }
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", &v33, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", &v33, 0x16u);
    }
...
LABEL_46:
              ...
              if ((v108 & 1) == 0)
              {
                ...
                if ((v75 & 1) == 0)
                {
                  if (*(a1 + 64) == 1)
                  {
                    ...
                    if (os_log_type_enabled(v99, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *buf = 138543618;
                      ...
                      v116 = 2112;
                      v117 = v101;
                      _os_log_impl(&dword_229538000, v99, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented to firmware update and requestor cannot consent.", buf, 0x16u);
                    }
                  ...
                  {
                    v102 = *(a1 + 56);
                    v103 = [*(a1 + 32) _queryImageResponseWithStatus:&unk_283E74D80 delayedActionTime:0];
                    (*(v102 + 16))(v102, v103, 0);
                  }
              ...
              v87 = [v104 initWithStatus:&unk_283E74D80 delayedActionTime:&unk_283E75FA8 imageURI:v82 softwareVersion:v83 softwareVersionString:v84 updateToken:v85 userConsentNeeded:v86 metadataForRequestor:0];
              (*(v81 + 16))(v81, v87, 0);
...
- (void)resetImageResponseCounters:(id)counters
{
  ...
  if (countersCopy)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ Sending Available status response, reset all other responses counters", &v10, 0x16u);
    }
...
- (void)manageBusyImageResponses:(id)responses completionHandler:(id)handler
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2048;
    v22 = v9;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@%@ Sending BUSY status response with %.0f seconds delay", &v17, 0x20u);
  }
...
- (void)manageNonBusyAvailableImageResponses:(id)responses normalStatus:(id)status error:(id)error completionHandler:(id)handler
{
  ...
  if (!responsesCopy)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 138543362;
      v27 = v24;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_INFO, "%{public}@AccessoryServer is nil, responding with original status without rate-limiting", &v26, 0xCu);
    }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Sending BUSY status response with %0.f delay due to request rate exceeding threshold", &v26, 0x20u);
  }
...
void __111__HMDMatterSoftwareUpdateProviderDelegate_notifyCheckFirmwareUpdateSessionWithPairing_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v11;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", &v19, 0x16u);
    }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    v19 = 138543362;
    v20 = v16;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", &v19, 0xCu);
  }
...
void __98__HMDMatterSoftwareUpdateProviderDelegate_notifyUpdateWithPairing_params_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v17;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", &v36, 0x16u);
    }
  ...
  if (([v2 supportsCHIP] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v25;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory has updated software image, but Accessory does not support Matter", &v36, 0x16u);
    }
...
LABEL_13:
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v11;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory update timed out", &v36, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 2112;
      v41 = v28;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ Accessory has updated software image. New version: %@", &v36, 0x20u);
    }
...
void __104__HMDMatterSoftwareUpdateProviderDelegate_applyUpdateWithPairing_requestParams_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@%@ Inform accessory to proceed with applying the software image", &v15, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Accessory should not proceed with applying the software image. Accessory not found for pairing : %@", &v15, 0x16u);
    }
...
- (void)configureWithSoftwareUpdateProvider:(id)provider
{
  ...
  if (isMatterAccessorySoftwareUpdateEnabled)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring with matter software update provider", &v13, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", &v13, 0x16u);
    }
...
void __54__HMDMatterSoftwareUpdateProviderDelegate_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v37_244313;
  logCategory__hmf_once_v37_244313 = v0;
}
