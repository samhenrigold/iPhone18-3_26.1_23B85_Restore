    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v14 = v11;
          _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to unregister for ProxSetup notifications", buf, 0xCu);
        }
    ...
    if (v13->_proxSetupNotificationToken == -1)
    {
      ...
      if (uTF8String)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v29 = v22;
          _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to register for ProxSetup notifications", buf, 0xCu);
        }
...
+ (id)sharedManager
{
  if (sharedManager_onceToken_233890 != -1)
  {
    dispatch_once(&sharedManager_onceToken_233890, &__block_literal_global_233891);
  }

  v3 = sharedManager_sharedManager_233892;
...
void __38__HMDDeviceSetupManager_sharedManager__block_invoke()
{
  ...
  v4 = sharedManager_sharedManager_233892;
  sharedManager_sharedManager_233892 = v3;
}
