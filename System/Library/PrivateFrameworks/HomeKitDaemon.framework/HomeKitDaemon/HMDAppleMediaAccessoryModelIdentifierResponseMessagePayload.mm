...
- (HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload)initWithPayload:(id)payload
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = payloadCopy;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive message due to no model identifier in payload: %@", &v12, 0x16u);
    }
...
void __74__HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_83786;
  logCategory__hmf_once_v2_83786 = v0;
}
