...
- (void)handleTimerFiredNotification:(id)notification
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = timerID2;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Timer Trigger fired : %@", &v14, 0x16u);
    }
...
- (void)_transactionObjectUpdated:(id)updated newValues:(id)values message:(id)message
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Received unknown model object", &v18, 0xCu);
    }
          ...
          *after = v29;
          ...
          if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v92 = 2112;
            v93 = date4;
            _os_log_impl(&dword_229538000, v86, OS_LOG_TYPE_INFO, "%{public}@(f) Timer fires next at %@; current time (GMT): %@", buf, 0x20u);
            ...
            *after = _NCSchedulerDateWithMultiple(v30, getCalendar, intervalCopy, v41 + 1);
            ...
            if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543874;
              ...
              v92 = 2112;
              v93 = date6;
              _os_log_impl(&dword_229538000, v86, OS_LOG_TYPE_INFO, "%{public}@(c) Timer fires next at %@; current time (GMT): %@", buf, 0x20u);
  ...
  if (WeakRetained)
  {
    if (v3)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 138543362;
        v23 = v9;
        _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Activate on super class failed, bailing out", &v22, 0xCu);
      }
...
LABEL_19:
    ...
    else
    {
      ...
      else if ([v5 active])
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          v22 = 138543362;
          v23 = v20;
          _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Looks like the timer is already running. Stopping it.", &v22, 0xCu);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@TimerTrigger instance is gone. Doing Nothing.", &v22, 0xCu);
    }
...
- (BOOL)_reactivateSignificantEventTrigger
{
  ...
  if (_nextSignificantEventFireDate)
  {
    if (v7)
    {
      ...
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting timer based on significant event with %@", &v12, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@No valid next significant fire date, disabling the timer", &v12, 0xCu);
    }
...
- (BOOL)_reactivateFireDateTrigger
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@No valid next fire date, disabling the timer", &v9, 0xCu);
    }
...
- (void)_startTimerWithFireDate:(id)date
{
  ...
  if (v5 <= 0.0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Revised Next Fire Date %@", &v19, 0x16u);
    }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Next fire date %@", &v19, 0x16u);
  }
          ...
          if (![v19 weekday])
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543618;
              ...
              v46 = 2112;
              v47 = v19;
              _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@Invalid values for week day: %@", buf, 0x16u);
            }
          ...
          if (([v19 isEqual:v20] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543618;
              ...
              v46 = 2112;
              v47 = v19;
              _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_ERROR, "%{public}@Miscellaneous fields have been set recurrence instances: %@", buf, 0x16u);
            }
...
void __30__HMDTimerTrigger_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_42024;
  logCategory__hmf_once_v1_42024 = v0;
}
