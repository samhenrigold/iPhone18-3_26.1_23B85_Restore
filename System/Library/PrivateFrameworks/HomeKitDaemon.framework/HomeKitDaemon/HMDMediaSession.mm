...
void __46__HMDMediaSession_writeProperties_completion___block_invoke_2(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2048;
      v15 = v4;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@responding to set playback with state %ld", &v12, 0x16u);
    }
...
void __45__HMDMediaSession_readProperties_completion___block_invoke(id *a1)
{
  ...
  group = dispatch_group_create();
  v54 = [MEMORY[0x277CBEB18] arrayWithCapacity:{objc_msgSend(a1[4], "count")}];
  ...
  v67 = 0u;
  obj = a1[4];
  v2 = [obj countByEnumeratingWithState:&v66 objects:v71 count:16];
  if (v2)
  {
    v3 = *v67;
    v4 = *MEMORY[0x277CD0938];
    v52 = *MEMORY[0x277CD0990];
    v50 = *MEMORY[0x277CD09B0];
    v51 = *MEMORY[0x277CD0960];
    v49 = *MEMORY[0x277CD0920];
    v48 = *MEMORY[0x277CD09A0];
    do
    {
      v5 = 0;
      do
      {
        ...
        else
        {
          ...
          if (v13)
          {
            ...
            v17 = [HMDMediaPropertyResponse responseWithRequest:v6 value:v16 updatedTime:v55];
          ...
          else
          {
            ...
            if (v19)
            {
              ...
              v23 = [HMDMediaPropertyResponse responseWithRequest:v6 value:v22 updatedTime:v55];
            ...
            else
            {
              ...
              if (v25)
              {
                ...
                if (v27)
                {
                  v28 = [a1[5] state];
                  v29 = [v28 volume];
                  v30 = [HMDMediaPropertyResponse responseWithRequest:v6 value:v29 updatedTime:v55];
              ...
              else
              {
                ...
                if (v32)
                {
                  ...
                  if (v34)
                  {
                    ...
                    v37 = [HMDMediaPropertyResponse responseWithRequest:v6 value:v36 updatedTime:v55];
                ...
                else
                {
                  ...
                  if (v39)
                  {
                    ...
                    v43 = [HMDMediaPropertyResponse responseWithRequest:v6 value:v42 updatedTime:v55];
      ...
      while (v2 != v5);
      v44 = [obj countByEnumeratingWithState:&v66 objects:v71 count:16];
      v2 = v44;
    }
...
- (void)updateEndpoint:(id)endpoint
{
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = endpointCopy;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@MediaSession endpoint %@ changed to %@", &v13, 0x20u);
    }
...
- (void)_notifyClientsOfUpdatedVolume:(id)volume muted:(id)muted inResponseToMessage:(id)message
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v15;
    _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification %@ with payload %@", &v22, 0x20u);
  }
    ...
    if ([(HMDMediaSession *)self isCurrentAccessorySession])
    {
      ...
      if (v10)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138543362;
          v40 = v26;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up local origin for currentAccessory to set playback state", buf, 0xCu);
        }
...
void __65__HMDMediaSession_updateWithResponses_requestMessageInformation___block_invoke(uint64_t a1)
{
  ...
  v77 = 0u;
  v7 = *(a1 + 40);
  v75 = [v7 countByEnumeratingWithState:&v76 objects:v80 count:16];
  if (v75)
  {
    v8 = 0;
    v74 = *v77;
    v73 = *MEMORY[0x277CD0938];
    v72 = *MEMORY[0x277CD0990];
    v71 = *MEMORY[0x277CD0960];
    v70 = *MEMORY[0x277CD09B0];
    v69 = *MEMORY[0x277CD0920];
    obj = v7;
    v68 = *MEMORY[0x277CD09A0];
    do
    {
      for (i = 0; i != v75; ++i)
      {
        ...
        if ([v12 isEqual:v68])
        {
          ...
          {
            v60 = [*(a1 + 32) state];
            v61 = [v60 sleepWakeState];

            v62 = [v59 unsignedIntegerValue];
            v63 = [*(a1 + 32) state];
...
- (void)_postNotificationOfMediaStateUpdateWithPayload:(id)payload
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v11;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification %@ with payload %@", &v17, 0x20u);
  }
  ...
  if ([(HMDMediaSession *)self isCurrentAccessorySession])
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543362;
        v30 = v15;
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up local origin for currentAccessory to get playback state", buf, 0xCu);
      }
...
void __51__HMDMediaSession__getPlaybackStateWithCompletion___block_invoke(uint64_t a1, void *a2, unsigned int a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2048;
      v18 = v8;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Locally read the playback state as: %tu", &v15, 0x16u);
    }
...
{
  keyCopy = key;
  if (([keyCopy isEqualToString:*MEMORY[0x277CD0938]] & 1) != 0 || (objc_msgSend(keyCopy, "isEqualToString:", *MEMORY[0x277CD0990]) & 1) != 0 || (objc_msgSend(keyCopy, "isEqualToString:", *MEMORY[0x277CD0960]) & 1) != 0 || (objc_msgSend(keyCopy, "isEqualToString:", *MEMORY[0x277CD09B0]) & 1) != 0 || (objc_msgSend(keyCopy, "isEqualToString:", *MEMORY[0x277CD09A0]) & 1) != 0 || objc_msgSend(keyCopy, "isEqualToString:", *MEMORY[0x277CD0920]))
  {
    v4 = objc_opt_class();
  }
...
void __30__HMDMediaSession_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_134332;
  logCategory__hmf_once_v2_134332 = v0;
}
