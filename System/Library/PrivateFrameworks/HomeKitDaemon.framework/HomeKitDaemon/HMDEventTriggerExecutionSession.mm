...
void __63__HMDEventTriggerExecutionSession_didOccurEvent_causingDevice___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@End Event has occurred, declaring execution complete, %@", &v22, 0x16u);
    }
...
LABEL_7:
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2114;
      v25 = v14;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Monitored Event %{public}@ has occurred", &v22, 0x16u);
    }
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v21;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received a delegate callback on event occurrence from %@", &v22, 0x16u);
  }
...
LABEL_4:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = mediaProfiles;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Not ending the trigger execution session because there are write requests left %@ or media profiles %@", &v17, 0x20u);
    }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 138543362;
    v18 = v16;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@No more write requests in restore list, declaring execution complete", &v17, 0xCu);
  }
...
uint64_t __51__HMDEventTriggerExecutionSession__activateEvents___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating event failed with error %@, %@", &v9, 0x20u);
  }
...
- (void)_handleActionSetExecutionResponse:(id)response actionSetError:(id)error completion:(id)completion
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *&v50[14] = errorCopy;
    v51 = 2112;
    v52 = responseCopy;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Action set execution responded with error %@ and response %@", v50, 0x20u);
  }
    ...
    if ([domain isEqualToString:*MEMORY[0x277CCFD28]])
    {
      ...
      if (code == 64)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *v50 = 138543362;
          *&v50[4] = v23;
          _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Action set has resulted in partial success, proceeding with successful ones", v50, 0xCu);
        }
...
LABEL_20:
    _os_log_impl(&dword_229538000, v37, OS_LOG_TYPE_INFO, v39, v50, 0xCu);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *&v50[14] = monitorEvents;
    _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@Created monitoring events %@", v50, 0x16u);
  }
...
LABEL_24:
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
  {
    ...
    *v50 = 138543362;
    *&v50[4] = v45;
    _os_log_impl(&dword_229538000, v44, OS_LOG_TYPE_INFO, "%{public}@There are end events with the execution session, activating them", v50, 0xCu);
  }
...
- (void)_addEvent:(id)event causingDevice:(id)device
{
  ...
  if ([(HMDEventTriggerExecutionSession *)self executionState]> 2)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 2112;
      v35 = v20;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Current state has moved beyond waiting for user response: %@", &v32, 0x16u);
    }
  ...
  if (v9)
  {
    if (v13)
    {
      ...
      v34 = 2112;
      v35 = deviceCopy;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Device is already in the causing devices list, %@", &v32, 0x16u);
    }
...
LABEL_9:
  ...
  if (v13)
  {
    ...
    v34 = 2112;
    v35 = deviceCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding device to ask for confirmation, %@", &v32, 0x16u);
  }
  ...
  if ((v24 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 2112;
      v35 = eventCopy;
      _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_INFO, "%{public}@Adding event as an additional event, %@", &v32, 0x16u);
    }
...
- (void)_userResponse:(unint64_t)response device:(id)device completionHandler:(id)handler
{
  ...
  if (!secureTriggerConfirmationTimer)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v48 = 138543362;
      v49 = v23;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@There is no confirmation timer running, not processing the confirmation", &v48, 0xCu);
    }
  ...
  if (actionSetExecutionInProgress)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v48 = 138543362;
      v49 = v16;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Action set execution is already in progress", &v48, 0xCu);
    }
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v52 = 2112;
    v53 = v26;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Received response from %@ with %@", &v48, 0x20u);
  }
  ...
  if (response > 2)
  {
    if (response == 3)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        v48 = 138543362;
        v49 = v44;
        _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_INFO, "%{public}@User confirms not to execute trigger", &v48, 0xCu);
      }
...
LABEL_24:
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      v48 = 138543362;
      v49 = v37;
      _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_INFO, "%{public}@None of the devices have answered the dialog, ending the session", &v48, 0xCu);
    }
...
LABEL_35:
  ...
  if (response == 2)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      v48 = 138543362;
      v49 = v30;
      _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@User confirms to execute trigger", &v48, 0xCu);
    }
...
void *__70__HMDEventTriggerExecutionSession_postponeRestoreIfWaitingForEndEvent__block_invoke(uint64_t a1)
{
  ...
  if (result == 4)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Waiting for end event, received request to postpone the end event", &v7, 0xCu);
    }
...
void __72__HMDEventTriggerExecutionSession_cancelSessionIfWaitingForUserResponse__block_invoke(uint64_t a1)
{
  ...
  if ([*(a1 + 32) executionState] == 2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138543362;
      v9 = v5;
      _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Waiting for user response, received request to cancel the session", &v8, 0xCu);
    }
...
- (void)setExecutionState:(unint64_t)state
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2114;
    v16 = v10;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting the execution from %{public}@ to %{public}@", &v11, 0x20u);
  }
...
- (BOOL)needsUserConfirmationForDevice:(id)device
{
  ...
  if (causingDevices2)
  {
    ...
    if (account)
    {
      ...
      v14[3] = &unk_278687A10;
      v15 = device;
      v9 = [causingDevices2 na_firstObjectPassingTest:v14];
...
void __46__HMDEventTriggerExecutionSession_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_265248;
  logCategory__hmf_once_v1_265248 = v0;
}
