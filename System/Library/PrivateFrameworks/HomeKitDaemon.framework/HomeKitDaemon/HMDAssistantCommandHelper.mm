...
- (void)addMediaWriteRequests:(id)requests withRequestProperty:(id)property completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(&v56 + 4) = v32;
      _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_INFO, "%{public}@Received write request with no apple media accessory, reporting invalid parameters error", &v56, 0xCu);
    }
...
LABEL_38:
                        ...
                        v41 = [HMDCharacteristicWriteRequest writeRequestWithCharacteristic:v84 value:&unk_283E72248 authorizationData:0 type:0];
...
uint64_t __52__HMDAssistantCommandHelper_timeoutAndReportResults__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Timeout current requests execution - reporting results", &v10, 0xCu);
  }
...
void __40__HMDAssistantCommandHelper_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_55048;
  logCategory__hmf_once_v1_55048 = v0;
}
