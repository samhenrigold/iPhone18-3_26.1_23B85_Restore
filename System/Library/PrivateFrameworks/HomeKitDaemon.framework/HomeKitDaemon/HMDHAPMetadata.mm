  ...
  if (v6)
  {
    ...
    if (!characteristicConfigurations)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 138543362;
        v28 = v25;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristics", &v27, 0xCu);
      }
...
LABEL_16:
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, v21, &v27, 0xCu);
  }
  ...
  if (!v14)
  {
    ...
    if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v89 = 2112;
      v90 = v13;
      _os_log_impl(&dword_229538000, v52, OS_LOG_TYPE_ERROR, "%{public}@Service type not found for service:%@.", buf, 0x16u);
    }
    ...
    if (![v17 count])
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v91 = 2112;
        v92 = v15;
        _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_ERROR, "%{public}@Service configuration failed for category %@ in service:%@.", buf, 0x20u);
      }
...
LABEL_34:
  ...
  if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v89 = 2112;
    v90 = v15;
    _os_log_impl(&dword_229538000, v56, OS_LOG_TYPE_ERROR, "%{public}@Failed while parsing policy configuration for service:%@.", buf, 0x16u);
  }
...
- (void)parseAndSetHMAccessoryFirmwareUpdatePolicies:(id)policies
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Accessory firmware update policies not defined!", &v14, 0xCu);
    }
...
- (id)parseMetadataTupleSetFromPlist:(id)plist
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = plistCopy;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristic/service tuples: %@", &v12, 0x16u);
    }
...
- (id)parseAndSetRawPlist:(id)plist
{
  ...
  if (plistCopy)
  {
    ...
    if ([(HMDHAPMetadata *)self parseAndSetHMMetadataWithHMPlist:v6])
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          v21 = 2112;
          v22 = v7;
          _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse assistant metadata from plist %@", &v19, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 2112;
        v22 = v6;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HM metadata from plist %@", &v19, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set HMDMetadata because rawPlist is nil.", &v19, 0xCu);
    }
...
{
  hmAccessoryCategories = [(HMDHAPMetadata *)self hmAccessoryCategories];
  v3 = [hmAccessoryCategories objectForKeyedSubscript:&unk_283E71C30];
...
- (BOOL)shouldAutoEnableNotificationForCharacteristic:(id)characteristic ofService:(id)service
{
  ...
  if (isCharacteristicHeartBeat(serviceCopy, characteristicCopy) && (isiOSDevice() || isWatch() || isMac() || ([MEMORY[0x277D0F8E8] productInfo], v8 = objc_claimAutoreleasedReturnValue(), v9 = objc_msgSend(v8, "productPlatform"), v8, v9 == 5)))
  {
    v10 = objc_autoreleasePoolPush();
    selfCopy = self;
    v12 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 138543362;
      v19 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Forcing shouldAutoEnableNotification to NO for Heart Beat characteristic", &v18, 0xCu);
    }
  ...
  else
  {
    ...
    {
      v16 = [shouldAutoEnableNotificationForCharacteristic_ofService__autoEnableNotifications hmf_arrayForKey:serviceCopy];
      v14 = [v16 containsObject:characteristicCopy];
    }
  }
...
LABEL_10:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 32;
LABEL_12:
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, v18, &v37, v21);
...
LABEL_33:
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      v41 = 2112;
      v42 = typeCopy;
      _os_log_impl(&dword_229538000, v33, OS_LOG_TYPE_ERROR, "%{public}@Service %@ or service being associated %@ are not compatible", &v37, 0x20u);
    }
...
+ (void)_logCurrentMetadata
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = schemaVersion;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Switching to HMDHAPMetadata version %@ schemaVersion %@", &v8, 0x20u);
  }
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 2112;
        v21 = v10;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find metadata for key: %@", &v18, 0x16u);
      }
