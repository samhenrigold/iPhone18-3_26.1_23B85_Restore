...
- (BOOL)componentsSupportsHomeLevelLocationServiceSetting
{
  ...
  v4 = [accessories na_map:&__block_literal_global_105];
  v5 = [v4 count];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = accessories;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine supports home level location services setting for all components: %@", &v12, 0x16u);
    }
...
- (void)removeManagedConfigurationProfileWithProfileData:(id)data completion:(id)completion
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Remove managed configuration profile not supported", &v13, 0xCu);
  }
...
- (void)mergeMediaSystemData:(id)data
{
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = dataCopy;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Merging media system data: %@", &v11, 0x16u);
    }
...
- (void)_appDataRemoved:(id)removed message:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling removal of app data", &v13, 0xCu);
  }
...
void __51__HMDMediaSystem_transactionObjectRemoved_message___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error removing root group.", &v8, 0xCu);
    }
...
void __40__HMDMediaSystem_reevaluateSettingOwner__block_invoke(uint64_t a1)
{
  ...
  if (v3 != v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v14 = 2112;
      v15 = v2;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Target accessory sorting order has changed updating setting owner to %@", &v12, 0x16u);
    }
...
void __61__HMDMediaSystem_transactionObjectUpdated_newValues_message___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error adding root group.", &v8, 0xCu);
    }
...
- (NSArray)components
{
  ...
  {
    legacyComponents = [(HMDMediaSystem *)self legacyComponents];
  }

  else
  {
    legacyComponents = [(HMDMediaSystem *)self generateComponents];
  }
...
- (NSString)configuredName
{
  if (isFeatureHomeTheaterQFAEnabledForTests && ([isFeatureHomeTheaterQFAEnabledForTests BOOLValue] & 1) == 0)
  {
    legacyConfiguredName = [(HMDMediaSystem *)self legacyConfiguredName];
  }
  ...
  else
  {
    ...
    if (isDefaultName)
    {
      legacyConfiguredName = 0;
    }

    else
    {
      data2 = [(HMDMediaSystem *)self data];
      legacyConfiguredName = [data2 name];
    }
  }

  return legacyConfiguredName;
}
...
- (NSString)name
{
  if (isFeatureHomeTheaterQFAEnabledForTests && ([isFeatureHomeTheaterQFAEnabledForTests BOOLValue] & 1) == 0)
  {
    legacyName = [(HMDMediaSystem *)self legacyName];
  }
...
- (void)relayMessage:(id)message
{
  ...
  if ([messageCopy isRemote])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = messageCopy;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay remote message: %@", &v33, 0x16u);
    }
  ...
  else
  {
    ...
    if (msgDispatcher)
    {
      ...
      if (device)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            v35 = 2112;
            v36 = messageCopy;
            _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message destination to relay message: %@", &v33, 0x16u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          v35 = 2112;
          v36 = messageCopy;
          _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get target device to relay message: %@", &v33, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = messageCopy;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message dispatcher to relay message: %@", &v33, 0x16u);
      }
...
- (void)_handleAppData:(id)data
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = dataCopy;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to pre process update media system app data message: %@", &v12, 0x16u);
    }
...
- (void)_registerForNotifications
{
  ...
  [notificationCenter addObserver:self selector:sel_handleRemovedAccessory_ name:@"HMDHomeAccessoryRemovedNotification" object:0];

  notificationCenter2 = [(HMDMediaSystem *)self notificationCenter];
  [notificationCenter2 addObserver:self selector:sel_handleAccessorySoftwareUpdated_ name:@"HMDAppleMediaAccessorySoftwareVersionUpdatedNotification" object:0];
}
...
- (void)_registerForMessages
{
  ...
  if ((isMessageBindingsEnabled & 1) == 0)
  {
    ...
    [msgDispatcher registerForMessage:*MEMORY[0x277CD2778] receiver:self policies:v12 selector:sel__routeUpdateMediaSystem_];
    ...
    [msgDispatcher registerForMessage:*MEMORY[0x277CD2468] receiver:self policies:v16 selector:sel__handleAppData_];
  }
}
...
void __38__HMDMediaSystem_auditMediaComponents__block_invoke(uint64_t a1)
{
  ...
  if (([*(a1 + 32) isValid] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v5;
      _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Media system isn't valid anymore, removing it", &v16, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v15;
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Did not obtain media system model, not deleting.", &v16, 0xCu);
      }
...
- (HMDMediaSystemModel)_modelForMediaSystem
{
  ...
  if (self)
  {
    ...
    home = [(HMDMediaSystemModel *)selfCopy home];
    uuid2 = [home uuid];
    selfCopy = [(HMDBackingStoreModelObject *)v2 initWithUUID:uuid parentUUID:uuid2];
  }
...
- (void)mediaDestinationsManager:(id)manager didUpdateDestination:(id)destination
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = destinationCopy;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home and siri sync data due to updated destination: %@", &v16, 0x16u);
  }
...
- (id)mediaGroupsAggregatorMessengerForMediaDestinationsManager:(id)manager
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get messenger from dependencies home: %@ aggregator: %@", &v15, 0x20u);
    }
...
{
  components = [(HMDMediaSystem *)self components];
  v3 = [components na_any:&__block_literal_global_64_147311];
...
void __49__HMDMediaSystem_repairAnyPreExistingAudioGroups__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Repair existing audio group request completed with error: %@", &v12, 0x16u);
    }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Repair existing audio group request completed", &v12, 0xCu);
  }
...
- (id)createNewAudioDestination
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating new audio destination", &v12, 0xCu);
  }
...
id __52__HMDMediaSystem_associatedAudioDestinationManagers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@No audio destination manager found for component: %@ accessory: %@ apple media accessory: %@", &v14, 0x2Au);
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get audio destination data due to no data source set", &v13, 0xCu);
      }
...
{
  accessories = [(HMDMediaSystem *)self accessories];
  v4 = [accessories na_any:&__block_literal_global_58_147323];
...
- (BOOL)isValid
{
  ...
  if (v4 <= 1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = &unk_283E73160;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@There are fewer than %@ components, not valid", &v10, 0x16u);
    }
...
- (id)attributeDescriptions
{
  ...
  v18 = [v4 na_map:&__block_literal_global_26_147333];
...
uint64_t __38__HMDMediaSystem_sortMediaComponents___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 2112;
      v34 = v12;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unexpected media accessory not found for components %@, acc1: %@, acc2: %@", &v27, 0x2Au);
    }
...
void __29__HMDMediaSystem_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_147381;
  logCategory__hmf_once_v3_147381 = v0;
}
...
- (id)assistantObject
{
  ...
  if (name && home)
  {
    ...
    if (name2)
    {
      ...
      v17 = [accessories na_map:&__block_literal_global_38_175493];
