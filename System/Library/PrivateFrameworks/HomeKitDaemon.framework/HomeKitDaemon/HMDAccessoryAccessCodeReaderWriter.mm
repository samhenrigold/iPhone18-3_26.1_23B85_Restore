...
- (id)_readAccessCodesFromAccessoriesWithUUIDs_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow;
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow;
...
- (id)performAccessCodeModificationRequests_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow;
...
- (id)removeAllAccessCodesWithValue_Matter:(id)matter withUserUUID:(id)d guestName:(id)name flow:(id)flow;
        ...
        if (!v14)
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = v33;
            ...
            v48 = 2112;
            v49 = v11;
            _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Could not create read write requests because failed to find hap accessory with UUID: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = v33;
            ...
            v48 = 2112;
            v49 = v14;
            _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Could not create read write requests because failed to find access code control point characteristic on accessory: %@", buf, 0x20u);
...
- (id)_characteristicsOfType:(id)type fromAccessoriesWithUUIDs:(id)ds flow:(id)flow
{
  ...
  if (v15 == [v13 count])
  {
    ...
    v32[1] = 3221225472;
    v32[2] = __91__HMDAccessoryAccessCodeReaderWriter__characteristicsOfType_fromAccessoriesWithUUIDs_flow___block_invoke_123;
    v32[3] = &unk_27866E7A0;
    v16 = typeCopy;
    v33 = v16;
    v17 = [v14 na_map:v32];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544386;
        ...
        v44 = 2112;
        v45 = v17;
        _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Could not find access code control point characteristics of type: %@ for all accessories: %@. Found characteristics: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v42 = 2112;
      v43 = v14;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Could not find all accessories with UUIDs: %@. Only found the subset of accessories: %@", buf, 0x2Au);
    }
...
- (id)_createConstraintsReadRequestsForAccessoriesWithUUIDs:(id)ds flow:(id)flow
{
  ...
  if (v4)
  {
    v6 = [v4 na_map:&__block_literal_global_120];
  }
...
id __101__HMDAccessoryAccessCodeReaderWriter__fetchResponseFromCredentialUserTuples_accessory_doorLock_flow___block_invoke(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v57 = 2112;
    v58 = v10;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Creating fetch response from credential: %@, user: %@", buf, 0x2Au);
  }
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544642;
      ...
      v61 = 2112;
      v62 = v36;
      _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Dropping userUniqueId because the user's creatorFabricIndex does not match the currentFabricIndex. credential: %@, creatorFabricIndex: %@, currentFabricIndex: %@, accessory: %@", buf, 0x3Eu);
...
LABEL_11:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v57 = 2112;
    v58 = v26;
    _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Dropping credential because it is the COTA home user: %@, accessory: %@", buf, 0x2Au);
  }
...
- (id)_readAccessCodesFromAccessory_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v39 = 2112;
    v40 = matterCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[ChildFlow: %@ Parent: %@] Reading access codes from Matter accessory: %@", buf, 0x2Au);
  }
...
id __92__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessory_Matter_withRetries_flow___block_invoke_3(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to read access codes from Matter accessory: %@, with error: %@", &v16, 0x2Au);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v27 = 2112;
      v28 = matterCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading access codes from Matter accessories with UUIDs: %@", buf, 0x20u);
    }

    objc_autoreleasePoolPop(v11);
    v20[0] = MEMORY[0x277D85DD0];
    v20[1] = 3221225472;
    v20[2] = __103__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_Matter_withRetries_flow___block_invoke;
    v20[3] = &unk_27866E688;
    v20[4] = selfCopy;
    retriesCopy = retries;
    v21 = flowCopy;
    v16 = [matterCopy na_map:v20];
    v17 = MEMORY[0x277D2C900];
    immediateScheduler = [MEMORY[0x277D2C938] immediateScheduler];
    v10 = [v17 combineAllFutures:v16 scheduler:immediateScheduler];
  }

  return v10;
}

id __103__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_Matter_withRetries_flow___block_invoke(uint64_t a1, void *a2)
{
  v3 = *(a1 + 32);
  v4 = a2;
  v5 = [v3 context];
  v6 = [v5 hapAccessoryWithUUID:v4];

  v7 = [*(a1 + 32) _readAccessCodesFromAccessory_Matter:v6 withRetries:*(a1 + 48) flow:*(a1 + 40)];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v37 = 2112;
      v38 = pCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading access codes from HAP accessories with UUIDs: %@", buf, 0x20u);
    }
    ...
    if (v16)
    {
      ...
      v28[1] = 3221225472;
      v28[2] = __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_104;
      v28[3] = &unk_27867B1D8;
      v28[4] = selfCopy;
      v20 = v18;
      v29 = v20;
...
id __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Got list responses", &v12, 0x16u);
  }
...
id __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_104(uint64_t a1, uint64_t a2)
{
...
id __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v24 = 2112;
    v25 = v4;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Access code fetch responses from read: %@", buf, 0x20u);
  }
  ...
  v18[0] = MEMORY[0x277D85DD0];
  v18[1] = 3221225472;
  v18[2] = __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_105;
  v18[3] = &unk_27868A1B0;
  v19 = v4;
  v11 = v4;
  v12 = [v10 na_filter:v18];
  v13 = [v12 na_map:&__block_literal_global_110];
...
BOOL __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_105(uint64_t a1, void *a2)
{
  v3 = a2;
  v4 = *(a1 + 32);
  v9[0] = MEMORY[0x277D85DD0];
  v9[1] = 3221225472;
  v9[2] = __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_2_106;
  v9[3] = &unk_27866E6D8;
  v10 = v3;
  v5 = v3;
...
id __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_3_108(uint64_t a1, void *a2)
{
...
uint64_t __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_2_106(uint64_t a1, void *a2)
{
  v2 = [a2 accessoryUUID];
  v3 = HMFEqualObjects();
...
- (id)_readAccessCodesFromAccessoriesWithUUIDs:(id)ds withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v35 = 2112;
    v36 = dsCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading access codes from accessories with UUIDs: %@", buf, 0x20u);
  }
  ...
  if ([dsCopy hmf_isEmpty])
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v33 = 2112;
      v34 = uUID2;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Caller submitted empty array of accessory UUIDs", buf, 0x16u);
    }
...
- (id)_readConstraintsFromAccessory_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v36 = 2112;
    v37 = matterCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading constraints from accessory: %@", buf, 0x20u);
  }
...
id __92__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries_flow___block_invoke_4(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v9;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] All retries failed to read constraint from accessory: %@", &v16, 0x20u);
  }
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v32 = 2112;
    v33 = matterCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading constraints from Matter accessories with UUIDs: %@", buf, 0x20u);
  }
  ...
  else
  {
    ...
    v25[1] = 3221225472;
    v25[2] = __103__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessoriesWithUUIDs_Matter_withRetries_flow___block_invoke;
    v25[3] = &unk_27866E688;
    v25[4] = selfCopy;
    retriesCopy = retries;
    v26 = flowCopy;
    v21 = [matterCopy na_map:v25];
    v22 = MEMORY[0x277D2C900];
    immediateScheduler = [MEMORY[0x277D2C938] immediateScheduler];
    v20 = [v22 combineAllFutures:v21 scheduler:immediateScheduler];
  }

  return v20;
}

id __103__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessoriesWithUUIDs_Matter_withRetries_flow___block_invoke(uint64_t a1, void *a2)
{
  v3 = *(a1 + 32);
  v4 = a2;
  v5 = [v3 context];
  ...
  v7 = [*(a1 + 32) _readConstraintsFromAccessory_Matter:v6 withRetries:*(a1 + 48) flow:*(a1 + 40)];
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_HAP:(id)p withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v32 = 2112;
    v33 = pCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading constraints from HAP accessories with UUIDs: %@", buf, 0x20u);
  }
...
- (id)_readConstraintsFromAccessoriesWithUUIDs:(id)ds withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v35 = 2112;
    v36 = dsCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading constraints from accessories with UUIDs: %@", buf, 0x20u);
  }
...
- (id)performModificationRequest_Matter:(id)matter flow:(id)flow
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v95 = 2112;
    v96 = matterCopy;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[ChildFlow: %@ Parent: %@] Performing access code modification request Matter: %@", buf, 0x2Au);
  }
...
LABEL_16:
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v91 = 2112;
    v92 = uUID3;
    _os_log_impl(&dword_229538000, v53, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Found HMAccessCodeModificationRequestValue of unknown type", buf, 0x16u);
  }
...
LABEL_23:
  ...
  v75 = v36[441];
  v58 = v75;
  v76 = __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_88;
  v77 = &unk_27866E638;
  v78 = v31;
  v79 = stringValue;
  v59 = v25;
  ...
  v72[1] = v58;
  v72[2] = __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_3_92;
  v72[3] = &unk_27866E660;
  v72[4] = selfCopy;
  v73 = v59;
  v63 = v59;
...
id __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_88(uint64_t a1)
{
  v7[0] = MEMORY[0x277D85DD0];
  v7[1] = 3221225472;
  v7[2] = __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_2_89;
  v7[3] = &unk_27866E610;
  v2 = *(a1 + 32);
  v8 = *(a1 + 40);
  v3 = *(a1 + 48);
...
id __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_3_92(uint64_t a1, void *a2)
{
  v3 = MEMORY[0x277D2C900];
  v4 = a2;
...
id __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_2_89(uint64_t a1, void *a2)
{
...
- (id)performAccessCodeModificationRequests_Matter:(id)matter withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v31 = 2112;
    v32 = matterCopy;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Performing access code modification requests Matter: %@", buf, 0x20u);
  }

  objc_autoreleasePoolPop(v11);
  if ([matterCopy hmf_isEmpty])
  {
    v16 = [MEMORY[0x277D2C900] futureWithResult:MEMORY[0x277CBEBF8]];
  }
  ...
  else
  {
    ...
    v22 = 3221225472;
    v23 = __100__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_Matter_withRetries_flow___block_invoke;
    v24 = &unk_27866E5E8;
    v25 = selfCopy;
    v26 = flowCopy;
    v17 = [matterCopy na_map:&v21];
    v18 = MEMORY[0x277D2C900];
    immediateScheduler = [MEMORY[0x277D2C938] immediateScheduler];
    v16 = [v18 combineAllFutures:v17 scheduler:immediateScheduler];
  }
...
- (id)performAccessCodeModificationRequests_HAP:(id)p withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v39 = 2112;
    v40 = pCopy;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@[ChildFlow: %@ Parent: %@] Performing access code modification requests HAP: %@", buf, 0x2Au);
  }
  ...
  else
  {
    ...
    v21 = [v20 na_map:&__block_literal_global_83_4757];
    if ([v21 hmf_isEmpty])
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v35 = 2112;
        v36 = uUID3;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Did not find any valid write requests to perform", buf, 0x16u);
      }
    ...
    else
    {
      ...
      v30[0] = MEMORY[0x277D85DD0];
      v30[1] = 3221225472;
      v30[2] = __97__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries_flow___block_invoke_84;
      v30[3] = &unk_27866E5C0;
      v30[4] = selfCopy;
      v31 = v20;
...
id __97__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries_flow___block_invoke_84(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Received modification responses: %@", &v12, 0x20u);
  }
...
- (id)performAccessCodeModificationRequests:(id)requests withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v37 = 2112;
    v38 = requestsCopy;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Performing access code modification requests: %@", buf, 0x20u);
  }
  ...
  if ([requestsCopy hmf_isEmpty])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v35 = 2112;
      v36 = uUID2;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Caller submitted empty modification requests", buf, 0x16u);
    }
...
- (void)_readConstraintsAndAccessCodesFromAccessoriesWithUUIDs:(id)ds flow:(id)flow completion:(id)completion
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v31 = 2112;
    v32 = dsCopy;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading constraints and access codes from accessories with UUIDs: %@", buf, 0x20u);
  }
  ...
  if ([dsCopy hmf_isEmpty])
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v29 = 2112;
      v30 = uUID2;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Caller submitted empty array of accessory UUIDs", buf, 0x16u);
    }
...
void __109__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_flow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v34 = 2112;
      v35 = v6;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to read constraints from accessories with uuids: %@, error: %@", buf, 0x2Au);
    }
  ...
  v23[0] = MEMORY[0x277D85DD0];
  v23[1] = 3221225472;
  v23[2] = __109__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_flow_completion___block_invoke_78;
  v23[3] = &unk_27866E550;
  v19 = a1[5];
  v23[4] = a1[4];
  v24 = v19;
...
void __109__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_flow_completion___block_invoke_78(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to read access codes from accessories with uuids: %@, error: %@", &v13, 0x2Au);
    }
...
- (id)_readAccessCodeWithIdentifier:(id)identifier accessoryUUID:(id)d flow:(id)flow
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v39 = 2112;
    v40 = dCopy;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reading access code for identifier: %@ from accessoryUUID: %@", buf, 0x2Au);
  }
...
- (id)removeAccessCodeWithValue_Matter:(id)matter fromAccessory:(id)accessory withUserUUID:(id)d guestName:(id)name flow:(id)flow
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v60 = 2112;
    v61 = uuid;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@[ChildFlow: %@ Parent: %@] removeAllAccessCodesWithValue_Matter fromAccessory: %@", buf, 0x2Au);
...
- (id)removeAllAccessCodesWithValue_Matter:(id)matter withUserUUID:(id)d guestName:(id)name flow:(id)flow
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v37 = 2112;
    v38 = uUID;
    _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] removeAllAccessCodesWithValue_Matter", buf, 0x16u);
  }

  objc_autoreleasePoolPop(v16);
  context2 = [(HMDAccessoryAccessCodeReaderWriter *)selfCopy context];
  uUIDsOfMatterAccessoriesSupportingAccessCodes = [context2 UUIDsOfMatterAccessoriesSupportingAccessCodes];
  v30[0] = MEMORY[0x277D85DD0];
  v30[1] = 3221225472;
  v30[2] = __103__HMDAccessoryAccessCodeReaderWriter_removeAllAccessCodesWithValue_Matter_withUserUUID_guestName_flow___block_invoke;
  v30[3] = &unk_27866E4D8;
  v30[4] = selfCopy;
  v31 = matterCopy;
  v32 = dCopy;
  ...
  v25 = dCopy;
  v26 = matterCopy;
  v27 = [uUIDsOfMatterAccessoriesSupportingAccessCodes na_map:v30];

  v28 = [MEMORY[0x277D2C900] combineAllFuturesIgnoringEmptyResults:v27];

  return v28;
}

id __103__HMDAccessoryAccessCodeReaderWriter_removeAllAccessCodesWithValue_Matter_withUserUUID_guestName_flow___block_invoke(uint64_t a1, void *a2)
{
  v3 = *(a1 + 32);
  v4 = a2;
  v5 = [v3 context];
  ...
  v7 = [*(a1 + 32) removeAccessCodeWithValue_Matter:*(a1 + 40) fromAccessory:v6 withUserUUID:*(a1 + 48) guestName:*(a1 + 56) flow:*(a1 + 64)];
...
- (id)removeAllHAPAccessCodesWithValue:(id)value forSpecificAccessory:(id)accessory flow:(id)flow
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v37 = 2112;
    v38 = uUID;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] removeAllHAPAccessCodesWithValue", buf, 0x16u);
  }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543874;
    ...
    v39 = 2112;
    v40 = accessoryCopy;
    _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] removeAccessCodeWithValue for HAP was passed a non HAP accessory or does not support access codes: %@", buf, 0x20u);
  }
...
id __97__HMDAccessoryAccessCodeReaderWriter_removeAllHAPAccessCodesWithValue_forSpecificAccessory_flow___block_invoke(uint64_t a1, void *a2)
{
  ...
  v7 = [v6 na_map:&__block_literal_global_4781];
...
- (id)removeAllAccessCodesWithValue:(id)value withUserUUID:(id)d guestName:(id)name flow:(id)flow
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v36 = 2112;
    v37 = uUID2;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@[ChildFlow: %@ Parent: %@] removeAllAccessCodesWithValue", buf, 0x20u);
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t75, &__block_literal_global_177);
  }
...
+ (id)createWriteRequestForRemoveRequests:(id)requests characteristic:(id)characteristic flow:(id)flow
{
  ...
  else
  {
    ...
    v13 = [requestsCopy na_map:&__block_literal_global_174];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544386;
        ...
        v34 = 2112;
        v35 = v16;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to serialize access code control write request: %@, for update requests: %@, with error: %@", buf, 0x34u);
...
+ (id)createWriteRequestForUpdateRequests:(id)requests characteristic:(id)characteristic flow:(id)flow
{
  ...
  else
  {
    ...
    v13 = [requestsCopy na_map:&__block_literal_global_171];
    v14 = [objc_alloc(MEMORY[0x277CFE9C8]) initWithOperationType:v12 accessCodeControlRequest:v13 accessCodeControlResponse:0];
    v25 = 0;
    v15 = [v14 serializeWithError:&v25];
    v16 = v25;
...
+ (id)createWriteRequestForAddRequests:(id)requests characteristic:(id)characteristic flow:(id)flow
{
  ...
  else
  {
    ...
    v13 = [requestsCopy na_map:&__block_literal_global_168];
    v14 = [objc_alloc(MEMORY[0x277CFE9C8]) initWithOperationType:v12 accessCodeControlRequest:v13 accessCodeControlResponse:0];
    v25 = 0;
    v15 = [v14 serializeWithError:&v25];
    v16 = v25;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544386;
        ...
        v34 = 2112;
        v35 = v16;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to serialize access code control write request: %@, for add requests: %@, with error: %@", buf, 0x34u);
        ...
        if (!v24)
        {
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = v51;
            ...
            v74 = 2112;
            v75 = v23;
            _os_log_impl(&dword_229538000, v47, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not submitting modification requests because did not find an accessory with UUID: %@", buf, 0x20u);
...
LABEL_35:
        ...
        if (v26)
        {
          ...
          v28 = [v27 na_map:&__block_literal_global_158];
          ...
          v32 = [v31 na_map:&__block_literal_global_162];
          ...
          v36 = [v35 na_map:&__block_literal_global_165];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = v51;
            ...
            v74 = 2112;
            v75 = v25;
            _os_log_impl(&dword_229538000, v41, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not submitting modification requests because did not find an access code control point on accessory: %@", buf, 0x20u);
...
void *__101__HMDAccessoryAccessCodeReaderWriter_createWriteRequestsForModificationRequests_hapAccessories_flow___block_invoke_155(uint64_t a1, void *a2)
{
  v2 = a2;
  objc_opt_class();
  if (objc_opt_isKindOfClass())
...
+ (int64_t)hmPrivateErrorCodeForHAPAccessCodeError:(int64_t)error
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v10;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Encountered an error type that likely indicates a bug: %@", &v11, 0x16u);
  }
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = v38;
            ...
            v58 = 2112;
            v59 = writeRequest;
            _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x2Au);
          }

          objc_autoreleasePoolPop(v27);
          modificationRequests = [v11 modificationRequests];
          v25 = modificationRequests;
          v26 = &__block_literal_global_147;
          goto LABEL_15;
        }
        ...
        if (!accessCodeControlResponse || (v16 = accessCodeControlResponse, [v14 accessCodeControlResponse], v17 = objc_claimAutoreleasedReturnValue(), v18 = objc_msgSend(v17, "hmf_isEmpty"), v17, v16, v18))
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v54 = 2112;
            v55 = uUID2;
            _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Received HAPAccessCodeControl object that does not contain any HAPAccessCodeControlResponses", buf, 0x16u);
          }

          objc_autoreleasePoolPop(v19);
          modificationRequests = [v11 modificationRequests];
          v25 = modificationRequests;
          v26 = &__block_literal_global_150;
LABEL_15:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543874;
          ...
          v49 = 2112;
          v50 = v14;
          _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v49 = 2112;
        v50 = v14;
        _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Characteristic response value: %@ is not of expected type NSData", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544386;
      ...
      v53 = 2112;
      v54 = v13;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to parse characteristic response for characteristic: %@, in payload: %@, with error: %@", buf, 0x34u);
...
+ (id)createConstraintsFromReadResponses:(id)responses readRequests:(id)requests flow:(id)flow
{
  responsesCopy = responses;
  flowCopy = flow;
  v10 = [requests na_map:&__block_literal_global_142];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543874;
          ...
          v62 = 2112;
          v63 = v10;
          _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v62 = 2112;
        v63 = v10;
        _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Characteristic response value: %@ is not of expected type NSData", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544386;
      ...
      v66 = 2112;
      v67 = v9;
      _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to parse characteristic response for characteristic: %@, in payload: %@, with error: %@", buf, 0x34u);
    ...
    *&v10 = 138544130;
    ...
    do
    {
      for (i = 0; i != v34; ++i)
      {
        ...
        v14 = *(*(&v35 + 1) + 8 * i);
        v15 = [p_info + 51 _accessCodeControlFromWriteResponses:responsesCopy forWriteRequest:v14 flow:{flowCopy, v29}];
        v16 = v15;
        if (v15)
        {
          accessCodeControlResponse = [v15 accessCodeControlResponse];
          v18 = [accessCodeControlResponse na_map:&__block_literal_global_139];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = v29;
            ...
            v45 = 2112;
            v46 = v14;
            _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x2Au);
          }

          objc_autoreleasePoolPop(v22);
          v11 = v30;
          p_info = (HMDAggregationAnalysisLogEvent + 32);
        }
      }
      ...
      do
      {
        ...
        if (uuid)
        {
          ...
          if (v18)
          {
            ...
            v24 = [accessCodeControlResponse2 na_firstObjectPassingTest:&__block_literal_global_135];
          ...
          else
          {
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = v42;
              ...
              v64 = 2112;
              v65 = v13;
              _os_log_impl(&dword_229538000, v37, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x2Au);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543874;
            ...
            v62 = 2112;
            v63 = v13;
            _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to find accessory UUID for write request: %@", buf, 0x20u);
          }
...
LABEL_10:
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, v22, &v25, 0x2Au);
    }
...
BOOL __105__HMDAccessoryAccessCodeReaderWriter_accessCodeFetchResponsesForReadWriteResponses_ofWriteRequests_flow___block_invoke_132(uint64_t a1, void *a2)
{
  v2 = [a2 statusCode];
  v3 = [v2 value] != 0;
  ...
  if (v31)
  {
    ...
    while (2)
    {
      for (i = 0; i != v31; ++i)
      {
        ...
        v10 = [v9 na_map:&__block_literal_global_129];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138544642;
            ...
            v47 = 2112;
            v48 = v13;
            _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to serialize access code control write request: %@, to read access codes with identifiers: %@, from characteristic: %@, with error: %@", buf, 0x3Eu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v22 = 2112;
      v23 = v7;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to serialize access code control list request: %@, with error: %@", buf, 0x2Au);
    }
