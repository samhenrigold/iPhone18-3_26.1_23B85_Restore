...
void __76__HMDAccessoryNetworkProtectionGroupRegistry_handleAccessoryTransportAdded___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling accessory transport added for accessory: %@", &v13, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Not creating protection group for accessory, supportsNetworkProtection: %@", &v13, 0x16u);
    }
...
- (BOOL)updateTargetProtectionModeForGroupWithUUID:(id)d protectionMode:(int64_t)mode error:(id *)error requestMessage:(id)message
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 2112;
      v41 = dCopy;
      _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Updating target protection mode to: %ld, on group with UUID:%@", &v36, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      modeCopy = uUIDString;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cannot find network protection group with UUID %@", &v36, 0x16u);
    }
...
void __69__HMDAccessoryNetworkProtectionGroupRegistry_handleRemovedAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v26 = 2112;
    v27 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Handling removed accessory: %@", &v24, 0x16u);
  }
...
LABEL_17:
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = v23;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@No network protection group UUID for removed accessory %@", &v24, 0x16u);
      }
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 22;
LABEL_14:
        _os_log_impl(&dword_229538000, v19, v20, v18, &v24, v21);
...
void __67__HMDAccessoryNetworkProtectionGroupRegistry_handleAddedAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Handling added accessory: %@", &v21, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          ...
          v21 = 138543362;
          v22 = v20;
          _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Accessory does not support network protection", &v21, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        v21 = 138543362;
        v22 = v15;
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEBUG, "%{public}@There are no transportInformationInstances", &v21, 0xCu);
      }
...
- (void)handleRemoveAccessoryNetworkProtectionGroupModel:(id)model message:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = uUIDString;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling remove of accessory network group model %@", &v25, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = uUIDString2;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Accessory network protection group %@ doesn't exist to remove", &v25, 0x16u);
    }
  ...
  if (v7)
  {
    ...
    if (isActive != activeCopy)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v37 = 2112;
        v38 = v16;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Active status for group %@ changes from %@ to %@", &v31, 0x2Au);
      }
...
LABEL_16:
          _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, v21, &v31, 0x16u);
        }
      }
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = dCopy;
      _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_INFO, "%{public}@No change in active status for group %@", &v31, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = dCopy;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_INFO, "%{public}@No change to active status of group %@ that doesn't exist", &v31, 0x16u);
    }
...
- (void)_setupProtectionGroupForAccessory:(id)accessory shouldNotifyChange:(BOOL)change
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Setting up protection group for accessory %@ with initialManufacturer: %@ initialCategoryIdentifier: %@", &v25, 0x2Au);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory %@/%@ is assigned to non-default group %@", &v25, 0x2Au);
    }
...
- (id)markGroupWithUUID:(id)d active:(BOOL)active
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = dCopy;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Marking group as active: %@, group: %@", &v16, 0x20u);
  }
...
- (id)removeGroupWithUUID:(id)d
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = dCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing group with UUID: %@", &v11, 0x16u);
  }
...
- (BOOL)addActiveSurrogateGroup:(id)group
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = groupCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Adding active surrogate group: %@", &v20, 0x16u);
  }
...
void __57__HMDAccessoryNetworkProtectionGroupRegistry_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v11_92272;
  logCategory__hmf_once_v11_92272 = v0;
}
