...
- (void)sessionEnded:(id)ended withReason:(unsigned int)reason error:(id)error
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2114;
    v23 = errorCopy;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Session %{public}@ has ended with reason: %{public}u and error: %{public}@", &v16, 0x26u);
  }
...
- (void)_handleDataFromSocket:(id)socket
{
  ...
  if (!socketSource)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 138543362;
      v41 = v16;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Socket source is already nil, rejecting the data from socket", &v40, 0xCu);
LABEL_20:
    }
  ...
  if (![(HMDCameraSnapshotIDSRelayReceiver *)self expectedByteCount])
  {
    ...
    if (v18 > 7)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting expected byte count to %llu", &v40, 0x16u);
      }
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Only received %lu bytes that represent the expected byte count so far; will wait for more", &v40, 0x16u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    v44 = 2112;
    v45 = v31;
    _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Updating received byte count from %@ to %@", &v40, 0x20u);
  }
  ...
  if (receivedByteCount == [(HMDCameraSnapshotIDSRelayReceiver *)selfCopy4 expectedByteCount])
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 138543362;
      v41 = v36;
      _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@All the bytes have been received, file transfer is complete", &v40, 0xCu);
    }
...
void __48__HMDCameraSnapshotIDSRelayReceiver_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_257522;
  logCategory__hmf_once_v1_257522 = v0;
}
