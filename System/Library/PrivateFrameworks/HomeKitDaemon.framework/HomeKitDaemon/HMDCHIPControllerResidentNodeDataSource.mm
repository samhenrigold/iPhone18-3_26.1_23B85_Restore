...
- (BOOL)removeValueForKey:(id)key completion:(id)completion
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Controller Resident Node Data Source not implemented yet", &v13, 0xCu);
  }
...
- (BOOL)setValue:(id)value forKey:(id)key completion:(id)completion
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 138543362;
    v17 = v14;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Controller Resident Node Data Source not implemented yet", &v16, 0xCu);
  }
...
- (id)valueForKey:(id)key
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@Controller Resident Node Data Source not implemented yet", &v10, 0xCu);
  }
...
- (id)keyValueStore
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_ERROR, "%{public}@Controller Resident Node Data Source not implemented yet", &v8, 0xCu);
  }
...
void __54__HMDCHIPControllerResidentNodeDataSource_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_279925;
  logCategory__hmf_once_v5_279925 = v0;
}
