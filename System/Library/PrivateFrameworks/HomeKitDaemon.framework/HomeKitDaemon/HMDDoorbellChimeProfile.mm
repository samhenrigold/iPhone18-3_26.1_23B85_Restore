  ...
  if (v7)
  {
    if ([v7 isCurrentAccessory])
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v38 = 2112;
        v39 = uuid;
        _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying framework to chime on current accessory - %@", &v36, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        v36 = 138543362;
        v37 = v35;
        _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_ERROR, "%{public}@Asked to chime on non-current accessory", &v36, 0xCu);
      }
