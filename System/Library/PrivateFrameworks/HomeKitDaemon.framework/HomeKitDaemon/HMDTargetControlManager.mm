...
- (void)_handleTargetControlServiceDeselection:(id)deselection
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = instanceID;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification that control service %@/%@  is not actively controlling this target accessory", &v16, 0x20u);
  }
...
- (void)_handleTargetControlServiceSelection:(id)selection
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = name2;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Tracking controller %@ service %@ for active selection", &v13, 0x20u);
  }
...
- (void)_targetAccessoryConfiguredWithController:(id)controller
{
  ...
  if (v6)
  {
    if (v10)
    {
      ...
      v22 = 2112;
      v23 = name2;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Controller %@ already configured for controlling target accessory %@", &v18, 0x20u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      v20 = 2112;
      v21 = name3;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding controller %@ to the list of configuredControllers and registering for notifications ", &v18, 0x16u);
    }
...
LABEL_48:
        ...
        if (([v29 dispatchButtonEvent:v46] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v108 = 2048;
            v109 = type;
            _os_log_impl(&dword_229538000, v72, OS_LOG_TYPE_INFO, "%{public}@Received an event for button with ID %lu/type %lu - consuming in HomeKit layer", buf, 0x20u);
          }
    ...
    if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544130;
      ...
      v110 = 2048;
      v111 = v22;
      _os_log_impl(&dword_229538000, v78, OS_LOG_TYPE_INFO, "%{public}@Received an event from control service %@/%@ for a button id %lu that is not mapped into the receiver's selected buttons", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v108 = 2048;
      v109 = v37;
      _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_INFO, "%{public}@Event targetID %lu does not match our target identifier %lu - treating as deselection to avoid receiving additional events", buf, 0x20u);
    }
...
void __44__HMDTargetControlManager___accessoryAdded___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v13;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Received notification that an accessory %@/%@ (supportsTargetController %@) has been added to the home", &v14, 0x2Au);
  }
...
void __51__HMDTargetControlManager___accessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v11;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Disconnected from accessory %@/%@", &v24, 0x20u);
  }
  ...
  if (v14)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = v23;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Disconnected from controller %@ for target accessory %@", &v24, 0x20u);
      }
...
void __48__HMDTargetControlManager___accessoryConnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v11;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Connected to accessory %@/%@", &v25, 0x20u);
  }
  ...
  if (v14)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 2112;
        v30 = v23;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Connected to controller %@ for target accessory %@", &v25, 0x20u);
      }
...
void __50__HMDTargetControlManager___accessoryNameUpdated___block_invoke(uint64_t a1)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 2112;
      v34 = v23;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process name update for a controller %@/%@ that is not configured with a home", &v29, 0x20u);
    }
  ...
  if ((v7 & 1) == 0)
  {
    if (v11)
    {
      ...
      v35 = 2112;
      v36 = v28;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Controller %@/%@ that has updated its name not one of the configured controllers %@", &v29, 0x2Au);
    }
...
LABEL_17:
  ...
  if (v11)
  {
    ...
    v33 = 2112;
    v34 = v15;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of a controller %@/%@ has been updated", &v29, 0x20u);
  }
...
void __62__HMDTargetControlManager___controllerRefreshedConfiguration___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v12;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that a controller %@/%@ has refreshed its configuration - userInfo %@", &v25, 0x2Au);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 2112;
        v32 = v24;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Controller %@/%@ that has refreshed its configuration not one of the configured controllers %@", &v25, 0x2Au);
      }
...
void __67__HMDTargetControlManager___targetAccessoryUnconfiguredForControl___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v11;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessories %@ have been unconfigured for control by controller %@", &v18, 0x20u);
  }
...
void __65__HMDTargetControlManager___targetAccessoryConfiguredForControl___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2112;
    v31 = v13;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessories %@ have been configured for control by controller %@/%@", &v24, 0x2Au);
  }
  ...
  if (v4)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = v23;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received notification that this target has been configured for control by controller %@/%@", &v24, 0x20u);
      }
...
void __38__HMDTargetControlManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_136859;
  logCategory__hmf_once_v5_136859 = v0;
}
