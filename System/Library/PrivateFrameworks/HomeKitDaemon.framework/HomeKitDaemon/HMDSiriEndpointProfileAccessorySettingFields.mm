  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v28 = 2112;
      v29 = pathCopy;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to store language value: %@ for keypath: %@", buf, 0x20u);
    }
...
- (void)setNumberValue:(id)value forKeyPath:(id)path
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = pathCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to store integer value: %@ for keypath: %@", &v15, 0x20u);
    }
...
- (void)setBoolValue:(BOOL)value forKeyPath:(id)path
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = pathCopy;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to store BOOLean value: %@ for keypath: %@", &v17, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_90540 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t7_90540, &__block_literal_global_90541);
  }

  v3 = logCategory__hmf_once_v8_90542;
...
void __59__HMDSiriEndpointProfileAccessorySettingFields_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v8_90542;
  logCategory__hmf_once_v8_90542 = v0;
}
