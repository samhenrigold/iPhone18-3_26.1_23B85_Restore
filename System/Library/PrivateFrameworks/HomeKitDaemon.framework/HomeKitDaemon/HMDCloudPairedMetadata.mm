    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v30 = 2112;
        v31 = v18;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
      }
...
+ (id)__decodeVersionConfigurationWithVersionString:(id)string versionConfigurationValue:(id)value baseAccessoryIdentifier:(id)identifier
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Version configuration for version '%@' is not a dictionary: %@", &v29, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = stringCopy;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Version configuration contains an invalid version string: %@", &v29, 0x16u);
    }
...
void __37__HMDCloudPairedMetadata_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_190983;
  logCategory__hmf_once_v1_190983 = v0;
}
