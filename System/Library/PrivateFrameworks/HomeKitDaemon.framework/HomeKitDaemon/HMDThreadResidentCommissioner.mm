...
- (void)_stopThreadAccessoryFirmwareUpdateWithCompletion:(id)completion
{
  ...
  v18 = &v17;
  v19 = 0x3032000000;
  v20 = __Block_byref_object_copy__121125;
  v21 = __Block_byref_object_dispose__121126;
...
void __82__HMDThreadResidentCommissioner__stopThreadAccessoryFirmwareUpdateWithCompletion___block_invoke_30(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 32;
LABEL_6:
      _os_log_impl(&dword_229538000, v11, v12, v10, &v19, v13);
    }
  }
...
- (void)_startThreadAccessoryFirmwareUpdateWithExtendedMACAddress:(id)address isWedDevice:(BOOL)device completion:(id)completion
{
  ...
  v27 = &v26;
  v28 = 0x3032000000;
  v29 = __Block_byref_object_copy__121125;
  v30 = __Block_byref_object_dispose__121126;
  _getThreadOperationSequenceNumber = [(HMDThreadResidentCommissioner *)self _getThreadOperationSequenceNumber];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v36 = 2112;
      v37 = v5;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@[%@] start firmware update - operational error %@", buf, 0x20u);
    }
...
void __114__HMDThreadResidentCommissioner__startThreadAccessoryFirmwareUpdateWithExtendedMACAddress_isWedDevice_completion___block_invoke_29(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 42;
LABEL_6:
      _os_log_impl(&dword_229538000, v12, v13, v11, &v24, v14);
    }
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v36 = 2112;
      v37 = v5;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@[%@] start pairing - operational error %@", buf, 0x20u);
    }
...
- (void)_connectToThreadAccessoryWithExtendedMACAddress:(id)address completion:(id)completion
{
  ...
  v30 = &v29;
  v31 = 0x3032000000;
  v32 = __Block_byref_object_copy__121125;
  v33 = __Block_byref_object_dispose__121126;
  _getThreadOperationSequenceNumber = [(HMDThreadResidentCommissioner *)self _getThreadOperationSequenceNumber];
  v23 = 0;
  v24 = &v23;
  v25 = 0x3032000000;
  v26 = __Block_byref_object_copy__121125;
  v27 = __Block_byref_object_dispose__121126;
  v28 = 0;
...
void __92__HMDThreadResidentCommissioner__connectToThreadAccessoryWithExtendedMACAddress_completion___block_invoke_26(uint64_t a1, void *a2)
{
  ...
  _os_log_impl(&dword_229538000, v12, v13, v11, &v26, v14);
...
- (void)_stopThreadNetworkWithCompletion:(id)completion
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping thread network", &v9, 0xCu);
  }
...
- (void)_startThreadNetworkWithOperationalDataset:(id)dataset threadNetworkID:(id)d isOwnerUser:(BOOL)user completion:(id)completion
{
  ...
  v35 = &v34;
  v36 = 0x3032000000;
  v37 = __Block_byref_object_copy__121125;
  v38 = __Block_byref_object_dispose__121126;
  _getThreadOperationSequenceNumber = [(HMDThreadResidentCommissioner *)self _getThreadOperationSequenceNumber];
...
void __114__HMDThreadResidentCommissioner__startThreadNetworkWithOperationalDataset_threadNetworkID_isOwnerUser_completion___block_invoke_14(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v3;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to start thread network %@: %@", &v14, 0x2Au);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Started thread network", &v14, 0x16u);
    }
...
- (void)_setThreadOperationInProgress:(BOOL)progress
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@TEST ONLY - overriding _setThreadOperationInProgress to %@", &v10, 0x16u);
  }
...
void __70__HMDThreadResidentCommissioner__startThreadNetworkWithID_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v5;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Started thread network: %@", &v15, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread network %@: %@", &v15, 0x20u);
    }
...
- (void)setGeoAvailable:(BOOL)available
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v12 = 1024;
    v13 = availableCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting isGeoAvailable: %d", &v10, 0x12u);
  }
...
+ (HMDThreadResidentCommissioner)sharedCommissioner
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v11 = 138543362;
      v12 = v7;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reusing existing commissioner", &v11, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Creating new commissioner", &v11, 0xCu);
    }
...
void __44__HMDThreadResidentCommissioner_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_121224;
  logCategory__hmf_once_v1_121224 = v0;
}
