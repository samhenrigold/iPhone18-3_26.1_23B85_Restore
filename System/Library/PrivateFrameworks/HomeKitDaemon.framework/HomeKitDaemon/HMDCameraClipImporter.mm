      ...
      do
      {
        ...
        if (isHeader)
        {
          ...
          if (firstObject2)
          {
            ...
            v107[1] = 3221225472;
            v107[2] = __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_46;
            v107[3] = &unk_2786824E0;
            v108 = firstObject2;
            v109 = v16;
            v110 = v30;
          ...
          if (lastObject)
          {
            ...
            v103[1] = 3221225472;
            v103[2] = __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_2;
            v103[3] = &unk_2786824E0;
            v104 = lastObject;
            v105 = v16;
            v106 = v30;
              ...
              for (i = 0; i != v41; ++i)
              {
                ...
                if (v48)
                {
                  ...
                  if (isHeader2)
                  {
                    ...
                    v95[1] = 3221225472;
                    v95[2] = __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_54;
                    v95[3] = &unk_278682508;
                    v96 = v85;
                    v97 = v48;
                  ...
                  else
                  {
                    ...
                    v90[1] = 3221225472;
                    v90[2] = __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_2_55;
                    v90[3] = &unk_278682530;
                    v91 = v85;
                    v59 = v48;
                    v94 = v43;
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_46(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543874;
      ...
      v30 = 2112;
      v31 = v13;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Loaded %lu bytes of hero frame data from %@", buf, 0x20u);
    }
    ...
    [v17 addSignificantEvent:v16 completionHandler:v18];

    v19 = [v3 future];
    v24[0] = MEMORY[0x277D85DD0];
    v24[1] = 3221225472;
    v24[2] = __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_50;
    v24[3] = &unk_27868A228;
    v24[4] = *(a1 + 40);
    v25 = v16;
    v20 = v16;
    v21 = [v19 addSuccessBlock:v24];
  }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = [*(a1 + 32) resourcePath];
      *buf = 138543618;
      v27 = v22;
      v28 = 2112;
      v29 = v23;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not load data from %@", buf, 0x16u);
    }

    objc_autoreleasePoolPop(v7);
    v20 = [MEMORY[0x277CCA9B8] hmfErrorWithCode:3];
    [v3 finishWithError:v20];
  }
}

void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_2(uint64_t a1, void *a2)
{
  v32 = *MEMORY[0x277D85DE8];
  v3 = a2;
  v4 = MEMORY[0x277CBEA90];
  ...
  if (v6)
  {
    ...
    v24[0] = MEMORY[0x277D85DD0];
    v24[1] = 3221225472;
    v24[2] = __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_53;
    v24[3] = &unk_27868A228;
    v24[4] = *(a1 + 40);
    v25 = v16;
    v20 = v16;
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_54(uint64_t a1, void *a2)
{
  v2 = *(a1 + 32);
  v3 = *(a1 + 40);
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_2_55(double *a1, void *a2)
{
  v2 = *(a1 + 4);
  v3 = *(a1 + 5);
  v4 = a1[7];
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_53(uint64_t a1)
{
  v4 = [*(a1 + 32) bulletinNotificationManager];
  v2 = *(a1 + 40);
  v3 = [*(a1 + 32) cameraProfileUUID];
  [v4 handleSignificantEvent:v2 cameraProfileUUID:v3];
}

void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_50(uint64_t a1)
{
  v4 = [*(a1 + 32) bulletinNotificationManager];
  v2 = *(a1 + 40);
  v3 = [*(a1 + 32) cameraProfileUUID];
...
LABEL_9:
    ...
    return +[(HMDCameraClipImporter *)v23];
  }

  v25.receiver = self;
  v25.super_class = HMDCameraClipImporter;
  v13 = [(HMDCameraClipImporter *)&v25 init];
  v14 = v13;
  if (v13)
  {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_230051 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t7_230051, &__block_literal_global_58_230052);
  }

  v3 = logCategory__hmf_once_v8_230053;
...
void __36__HMDCameraClipImporter_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v8_230053;
  logCategory__hmf_once_v8_230053 = v0;
}
