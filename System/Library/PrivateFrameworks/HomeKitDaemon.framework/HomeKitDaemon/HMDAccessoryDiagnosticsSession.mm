...
- (void)_callCompletionHandlerWithError:(id)error
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = errorCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Calling completion handler with error:%@", &v11, 0x16u);
  }
...
- (BOOL)_validDataSequenceNumber:(id)number
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid data sequence number received:%lld expected:%lld", &v18, 0x20u);
    }
...
- (void)dataStreamAdapterDidFailDataRead:(id)read
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = accessory;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to read data for accessory:%@", &v13, 0x16u);
  }
...
- (void)dataStreamAdapterDidCompleteDataRead:(id)read
{
  ...
  if (pendingCompletionHandler)
  {
    ...
    if (fileHandle)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2112;
        v26 = accessory;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Data read completed for accessory:%@", &v23, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = accessory2;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Data read completed for accessory:%@ but file path not present", &v23, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 138543362;
      v24 = v20;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Data read completed but no completion handler", &v23, 0xCu);
    }
...
- (BOOL)dataStreamAdapter:(id)adapter didReceiveData:(id)data
{
  ...
  if (v11)
  {
    ...
    if (v14)
    {
      ...
      if (!fileHandle)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          v39 = 2112;
          v40 = urlParameters;
          _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@URL parameters: %@ received in packet metadata", &v37, 0x16u);
        }
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      v37 = 138543362;
      v38 = v30;
      _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@Data frame received", &v37, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v35;
      _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_ERROR, "%{public}@No data present in frame", &v37, 0xCu);
    }
...
LABEL_8:
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, v12, &v13, 0xCu);
    }
...
void __63__HMDAccessoryDiagnosticsSession__setUpWithOptions_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v6)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v24 = 2112;
        v25 = v6;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to setup data stream with error: %@", &v22, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v20;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Diagnostics data stream was setup successfully", &v22, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v18;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Setting up data stream failed, diagnostics session is nil", &v22, 0xCu);
    }
...
void __62__HMDAccessoryDiagnosticsSession_setUpWithOptions_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start HAP session with accessory: %@", &v9, 0x16u);
    }
