...
- (void)_transactionObjectRemoved:(id)removed message:(id)message
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to cast the given model object to EventModel", &v15, 0xCu);
    }
...
- (void)processEventRecords:(id)records message:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Saving to push the event records to cloud", &v14, 0xCu);
  }
...
- (void)_transactionObjectUpdated:(id)updated newValues:(id)values message:(id)message
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 138543362;
      v32 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Handling event trigger update", &v31, 0xCu);
    }
  ...
  else
  {
    ...
    if (v20)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 138543362;
          v32 = v30;
          _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@Handling event add", &v31, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 138543362;
        v32 = v26;
        _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_INFO, "%{public}@Unknown model object", &v31, 0xCu);
      }
      ...
      if (!v20 || ([(HMDEventTriggerDevice *)v20 isOwner]& 1) == 0)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v52 = 2112;
          v53 = v16;
          _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_ERROR, "%{public}@Only owner may perform a user permission dialog: %@", buf, 0x16u);
...
LABEL_5:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 138543362;
    v19 = v15;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@There is no confirmation timer running, ignoring the response", &v18, 0xCu);
  }
...
- (void)_resetExecutionState
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting execution sessions %@, confirmation session %@", &v9, 0x20u);
  }
...
uint64_t __43__HMDEventTrigger_executionComplete_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Action set execution session %@ is complete with error %@", &v13, 0x20u);
  }
  ...
  if (!*(a1 + 48) && [*(a1 + 32) executeOnce])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Trigger is marked to be executed once, deactivating", &v13, 0xCu);
    }
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run locally. [%s]", buf, 0x16u);
            }
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run on the resident. [%s]", buf, 0x16u);
            }
...
- (void)_updateEventTriggerExecuteOnce:(id)once
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Execute once requires shared-trigger-activation capable homehub", &v19, 0xCu);
    }
...
- (void)_handleUpdateEventTriggerCondition:(id)condition
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 2112;
      v32 = v7;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating evaluation condition for trigger %@", &v29, 0x16u);
    }
    ...
    if (v13 && ![(HMDEventTrigger *)selfCopy checkSharedEventTriggerActivationResidentRequirement:v6])
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v28;
        _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_INFO, "%{public}@Presence Event Condition requires shared-trigger-activation capable homehub", &v29, 0xCu);
      }
...
LABEL_9:
  ...
  if ([nameCopy length] > v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", &v26, 0xCu);
    }
...
{
  classCopy = class;
  if (([classCopy isEqualToString:*MEMORY[0x277CD22D8]] & 1) != 0 || (objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD22F8]) & 1) != 0 || (objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD22D0]) & 1) != 0 || (objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD2310]) & 1) != 0 || (objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD22E0]) & 1) != 0 || (objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD2300]) & 1) != 0 || (objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD2308]) & 1) != 0 || objc_msgSend(classCopy, "isEqualToString:", *MEMORY[0x277CD22E8]))
  {
    v4 = objc_opt_class();
  }
      ...
      if ([(HMDEventTrigger *)selfCopy _populateTriggerModel:v20 fromBuilderMessage:v52 transaction:v49 responsePayload:v32])
      {
        ...
        if (v36)
        {
          ...
          if (v41)
          {
            ...
            v54[1] = 3221225472;
            v54[2] = __45__HMDEventTrigger__handleUpdateEventTrigger___block_invoke_127;
            v54[3] = &unk_278675A28;
            v55 = v52;
            v56 = v46;
            v57 = v20;
...
void __45__HMDEventTrigger__handleUpdateEventTrigger___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v5;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding to the client about update event trigger status : Payload : [%@], error : [%@]", &v12, 0x20u);
  }
...
- (void)_addEventModelFromDictionary:(uint64_t)dictionary endEvent:(void *)event transaction:(void *)transaction message:(void *)message error:
{
  ...
  transactionCopy = transaction;
  v97 = 0;
  v14 = [self createEventModel:v11 endEvent:dictionary message:transactionCopy checkForSupport:1 transaction:eventCopy error:&v97];
  v96 = v97;
  if (v14)
  {
    v94 = transactionCopy;
  ...
  else
  {
    ...
    if (message)
    {
      ...
      {
        v93 = [MEMORY[0x277CCA9B8] hmErrorWithCode:20];
        *message = v93;
      }
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v102 = 2112;
      v103 = obj;
      _os_log_impl(&dword_229538000, v65, OS_LOG_TYPE_INFO, "%{public}@Client does not have authorization for location, cannot remove event. [%@]", buf, 0x16u);
    }
...
- (void)_removeEventsFromEventTrigger:(id)trigger
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 138543362;
      v32 = v27;
      _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot remove event", &v31, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = name2;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Couldn't find event with UUID %@ in trigger %@", &v31, 0x20u);
    }
...
LABEL_83:
  ...
  v90 = createPayload;
  v84 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:&v90 forKeys:&v89 count:1];
...
- (id)eventModelWithDictionary:(id)dictionary transaction:(id)transaction home:(id)home message:(id)message error:(id *)error
{
  ...
  v73 = [dictionaryCopy hmf_numberForKey:*MEMORY[0x277CCF2D8]];
  v74 = [dictionaryCopy hmf_UUIDForKey:*MEMORY[0x277CCF0B0]];
  ...
  if (v18)
  {
    ...
    if (isKindOfClass & 1) != 0 || (v22)
    {
      ...
      v39 = [MEMORY[0x277CD51C0] attributePathWithEndpointID:v71 clusterID:v17 attributeID:v73];
      v66 = matterAdapter;
      ...
      if (v39)
      {
        v65 = [HMDMatterPath PathWithAttributeID:v73 endpointID:v71 clusterID:v17 accessory:v21];
        if (v65)
        {
          uuid = [(HMDTrigger *)self uuid];
          ...
          if (v29)
          {
            attributePaths = [v66 attributePaths];
            v43 = [attributePaths containsObject:v65];

            if (v43)
            {
              attributePaths2 = [v66 attributePaths];
              v75[0] = MEMORY[0x277D85DD0];
              v75[1] = 3221225472;
              v75[2] = __75__HMDEventTrigger_eventModelWithDictionary_transaction_home_message_error___block_invoke;
              v75[3] = &unk_2786733A0;
              v45 = v65;
              v76 = v65;
              v77 = v29;
              [attributePaths2 hmf_enumerateWithAutoreleasePoolUsingBlock:v75];
            }
            ...
            else
            {
              uuid2 = [v65 uuid];
              uuid3 = [v21 uuid];
              v61 = [v65 modelObjectWithChangeType:1 uuid:uuid2 parentUUID:uuid3];

              [v65 populateModelObject:v61];
              [v72 add:v61];
              v45 = v65;
              uuid4 = [v65 uuid];
...
LABEL_27:
  ...
  {
    uuid = [(HMDTrigger *)self uuid];
    v21 = [HMDCharacteristicEventModel eventModelWithDictionary:modelCopy home:home eventTriggerUUID:uuid message:messageCopy checkForSupport:supportCopy error:error];
    goto LABEL_7;
  }
  ...
  if (![v17 isEqualToString:*MEMORY[0x277CD22F8]])
  {
    ...
    {
      uuid = [(HMDTrigger *)self uuid];
      v21 = [HMDCharacteristicThresholdRangeEventModel eventModelWithDictionary:modelCopy home:home eventTriggerUUID:uuid message:messageCopy checkForSupport:supportCopy];
      goto LABEL_7;
    }

    if ([v17 isEqualToString:*MEMORY[0x277CD2300]])
    {
      v22 = [(HMDEventTrigger *)self eventModelWithDictionary:modelCopy transaction:transactionCopy home:home message:messageCopy error:error];
      goto LABEL_28;
    }
  ...
  if (messageCopy && ([messageCopy isAuthorizedForLocationAccess] & 1) == 0)
  {
    v27 = objc_autoreleasePoolPush();
    selfCopy = self;
    v29 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 138543362;
      v33 = v30;
      _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot add event", &v32, 0xCu);
    }
  ...
  uuid2 = [(HMDTrigger *)self uuid];
  v22 = [HMDLocationEventModel eventModelWithDictionary:modelCopy home:home eventTriggerUUID:uuid2 message:messageCopy];
...
- (id)_modelWithRewrittenCondition:(id)condition
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = conditionCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating evaluation condition for trigger %@", &v17, 0x16u);
  }
...
- (void)handleRemovalOfUser:(id)user transaction:(id)transaction
{
  ...
  if (v14)
  {
    ...
    v17 = [predicateUtilities2 updatePredicate:evaluationCondition2 removedUser:userCopy conditionModified:&v23];
  ...
  if (WeakRetained)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v16 = 138543362;
        v17 = v14;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@There are no triggering events anymore, removing the trigger", &v16, 0xCu);
      }
...
- (void)auditForStaleEventsWithAccessory:(id)accessory transaction:(id)transaction
{
  ...
  if (v11)
  {
    ...
    predicateUtilities = [(HMDEventTrigger *)self predicateUtilities];
    evaluationCondition = [(HMDEventTrigger *)self evaluationCondition];
    v41 = [predicateUtilities predicateWithoutStaleCharacteristicsFromPredicate:evaluationCondition accessory:v11 conditionModified:&v48];
    ...
    if (v48 == 1)
    {
      ...
      objc_autoreleasePoolPop(v14);
      v20 = [(HMDEventTrigger *)selfCopy _modelWithRewrittenCondition:v41];
      if (v20)
      {
    ...
    if (v22)
    {
      ...
      do
      {
        ...
        v23 = [obj countByEnumeratingWithState:&v44 objects:v49 count:16];
      }
    ...
    transactionCopy = v40;
    [(HMDEventTrigger *)self _handleRemovalOfEvents:array transaction:v40];
...
- (void)_registerForMessages
{
  ...
  {
    v35.receiver = self;
    v35.super_class = HMDEventTrigger;
    [(HMDTrigger *)&v35 _registerForMessages];
    home = [(HMDTrigger *)self home];
    v34 = +[(HMDRemoteMessagePolicy *)HMDMutableRemoteMessagePolicy];
    [v34 setRoles:{objc_msgSend(v34, "roles") | 4}];
    v4 = objc_msgSend_copy(v34);
    ...
    v43[3] = v8;
    v9 = [MEMORY[0x277CBEA60] arrayWithObjects:v43 count:4];
    ...
    v42[3] = v11;
    v12 = [MEMORY[0x277CBEA60] arrayWithObjects:v42 count:4];
    ...
    v40[3] = v18;
    v19 = [MEMORY[0x277CBEA60] arrayWithObjects:v40 count:4];
...
- (void)timerDidFire:(id)fire
{
  ...
  if (debounceTriggerActivationTimer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Debounce Timer expired: Going to activate the trigger", &v11, 0xCu);
    }
...
- (void)_configureDebounceTriggerActivationTimer
{
  ...
  if (!dependencyFactory)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Missing dependency factory, reinitializing %@", &v15, 0x16u);
    }
    ...
    else
    {
      ...
      if (!debounceTriggerActivationTimer || ([debounceTriggerActivationTimer timeInterval], v9 != 7.0))
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
        {
          ...
          _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Reinitialized debounce timer from %@ to %@", &v16, 0x20u);
        }
...
void __35__HMDEventTrigger__activateEvents___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Completed activation with errors: %@", &v12, 0x16u);
  }
...
LABEL_43:
  ...
  if ([(HMDEventTrigger *)v43 activationState]!= v36)
  {
    ...
    v77 = *MEMORY[0x277CD2288];
    v61 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:v36];
    v78 = v61;
    v62 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:&v78 forKeys:&v77 count:1];
...
void __30__HMDEventTrigger_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_46869;
  logCategory__hmf_once_v2_46869 = v0;
}
