...
- (void)handleMediaGroupsAggregateConsumerUpdatedAggregateDataNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media groups aggregate consumer updated aggregate data notification", &v15, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media groups aggregate consumer updated aggregate data notification due to no delegate", &v15, 0xCu);
    }
...
- (void)handleMediaDestinationControllerUpdatedDestinationNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination controller updated destination notification: %@", &v38, 0x16u);
  }
  ...
  if (userInfo)
  {
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v40 = 2112;
        v41 = v10;
        _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media destination controller identifier from media destination controller updated destination notification user info: %@", &v38, 0x16u);
      }
    ...
    if (v12)
    {
      ...
      if (!v15)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
          {
            ...
            v38 = 138543362;
            v39 = v37;
            _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media destination controller updated destination notification due to no delegate", &v38, 0xCu);
          }
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 12;
LABEL_17:
        _os_log_impl(&dword_229538000, v21, v22, v20, &v38, v23);
      }
    }
...
LABEL_26:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    v40 = 2112;
    v41 = notificationCopy;
    _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get user info in media destination controller updated destination notification: %@", &v38, 0x16u);
  }
...
- (void)handleNotificationAccessoryChangedRoom:(id)room
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2112;
      v31 = roomCopy;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling accessory changed room notification: %@", &v28, 0x16u);
    }
    ...
    if (audioDestination || ([audioDestinationController identifier], v15 = objc_claimAutoreleasedReturnValue(), -[HMDMessageHandler messageTargetUUID](selfCopy, "messageTargetUUID"), v16 = objc_claimAutoreleasedReturnValue(), v17 = objc_msgSend(v15, "hmf_isEqualToUUID:", v16), v16, v15, (v17 & 1) != 0))
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          v28 = 138543362;
          v29 = v23;
          _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of accessory changed rooms notification due to no delegate", &v28, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v27;
        _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_INFO, "%{public}@Skipping accessory changed room notification due to no destination and no related destination controller", &v28, 0xCu);
      }
...
- (void)handleMediaSystemRemovedNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media system removed notification: %@", &v15, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media system removed notification due to no delegate", &v15, 0xCu);
    }
...
- (void)handleMediaSystemAddedNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = notificationCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media system added notification: %@", &v15, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media system added notification due to no delegate", &v15, 0xCu);
    }
...
- (void)handleHomeAccessoryRemovedNotification:(id)notification
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling home accessory removed notification: %@", &v23, 0x16u);
    }
    ...
    if (audioDestination)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          v23 = 138543362;
          v24 = v22;
          _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of accessory removed notification due to no delegate", &v23, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v18;
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping home accessory removed notification due to no destination", &v23, 0xCu);
      }
...
- (void)handleMediaDestinationUpdatedNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = notificationCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination updated notification: %@", &v15, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media destination updated notification due to no delegate", &v15, 0xCu);
    }
...
LABEL_18:
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v16;
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform update due to unknown update options: %@", &v27, 0x16u);
      }
...
LABEL_16:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = messageCopy;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to get update options from message: %@", &v27, 0x16u);
      }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2112;
    v30 = messageCopy;
    _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", &v27, 0x16u);
  }
  ...
  if (messagePayload)
  {
      ...
      if (([v9 isEqualToString:*MEMORY[0x277CD0860]] & 1) == 0)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            v31 = 2112;
            v32 = messageCopy;
            _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse destination identifier: %@ message: %@", &v27, 0x20u);
          }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = messageCopy;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination identifier from message: %@", &v27, 0x16u);
      }
...
LABEL_21:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2112;
    v30 = messageCopy;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", &v27, 0x16u);
  }
...
void __107__HMDMediaDestinationControllerMessageHandler_sendRequestToUpdateDestinationIdentifier_options_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Update destination identifier request message responded with error: %@", &v12, 0x16u);
    }
...
void __58__HMDMediaDestinationControllerMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v37_237974;
  logCategory__hmf_once_v37_237974 = v0;
}
