...
- (HMDAppleMediaAccessoryModelIdentifierRequestMessagePayload)initWithPayload:(id)payload
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = payloadCopy;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive message due to no accessory identifier in payload: %@", &v12, 0x16u);
    }
...
void __73__HMDAppleMediaAccessoryModelIdentifierRequestMessagePayload_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_114660;
  logCategory__hmf_once_v2_114660 = v0;
}
