...
- (void)notify:(BOOL)notify
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending notification with policy status %@", buf, 0x16u);
  }
...
- (BOOL)evaluate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", &v8, 0xCu);
  }
...
void __47__HMDAccessoryFirmwareUpdatePolicy_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_155566;
  logCategory__hmf_once_v1_155566 = v0;
}
