  ...
  *buffer = 0u;
  ...
  if (proc_pid_rusage(v5, 6, buffer))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v9;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve memory foot-print", &v18, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Current process memory utilization: %lld, Interval peak memory utilization (Since last timer-based sample): %lld", &v18, 0x20u);
    }
...
void __42__HMDMemoryUtilizationTracker_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_267607;
  logCategory__hmf_once_v3_267607 = v0;
}
