...
+ (id)deviceHandleForDestination:(id)destination
{
  ...
  if (!destinationCopy)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 12;
LABEL_11:
      _os_log_impl(&dword_229538000, v15, v16, v14, &v19, v17);
    }
...
LABEL_12:
  ...
  v6 = &off_2786663C0;
  if ([_HMDLocalDeviceHandle isValidDestination:destinationCopy]|| (v6 = off_2786663B8, [_HMDGlobalDeviceHandle isValidDestination:destinationCopy]))
  {
