...
void __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_183(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v10;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Fetch collection response completed with %@%@", &v11, 0x20u);
  }
...
- (void)configureWithHome:(id)home isPrimaryResident:(BOOL)resident isResidentEventProviding:(BOOL)providing additionalPolicies:(id)policies
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v16;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEFAULT, "Configuring on device isPrimaryResident. %@ isResidentEventProviding: %@", &v17, 0x16u);
  }
...
- (void)server:(id)server connectionDidFail:(id)fail
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    v8 = 138412290;
    v9 = failCopy;
    _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Removing connection on error %@", &v8, 0xCu);
  }
...
- (void)server:(id)server connectionDidExpire:(id)expire
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    v8 = 138412290;
    v9 = expireCopy;
    _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Removing connection on expiry %@", &v8, 0xCu);
  }
...
- (BOOL)server:(id)server shouldProcessEventsForConnection:(id)connection shouldLogState:(BOOL)state
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v36 = 2112;
    v37 = WeakRetained;
    _os_log_impl(&dword_229538000, logger, OS_LOG_TYPE_DEFAULT, "Checking if server should process events for connection: %@, dataSource: %@", &v34, 0x16u);
  }
    ...
    if (v20)
    {
      ...
      if (![(HMDRemoteEventRouterServer *)self isPrimaryResident]|| !v23)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v40 = 2112;
          v41 = v20;
          _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for resident connection mode. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", &v34, 0x2Au);
...
LABEL_30:
      ...
      if (stateCopy)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v38 = 2112;
          v39 = v20;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_DEFAULT, "Not allowing connection while both devices are known as primary, this should resolve shortly. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", &v34, 0x20u);
...
LABEL_23:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 138412290;
        v35 = v26;
        _os_log_error_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "Unexpectedly did not find device for resident. %@", &v34, 0xCu);
        goto LABEL_23;
      }
    }
...
LABEL_14:
  ...
  if (stateCopy)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v34 = 138543362;
      v35 = v21;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for primary connection mode.", &v34, 0xCu);
LABEL_29:
...
uint64_t __81__HMDRemoteEventRouterServer_responseHandlerForSendMessageIdentifier_completion___block_invoke_2(void *a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v2;
      _os_log_error_impl(&dword_229538000, v4, OS_LOG_TYPE_ERROR, "Failed to send message: %@ error: %@", &v14, 0x16u);
    }
  }

  else
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT) && (v6 = a1[6], v14 = 138412290, v15 = v6, _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEFAULT, "Successfully sent message: %@", &v14, 0xCu), (v3 = a1[5]) == 0))
    {
      WeakRetained = 0;
    }
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138412546;
          ...
          v29 = 2112;
          v30 = v13;
          _os_log_error_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "No connection was found for keep alive request in current connections: %@ device identifier: %@", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138412546;
          ...
          v40 = 2112;
          v41 = v13;
          _os_log_error_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "No connection was found during change registrations request in current connections: %@ device identifier: %@", buf, 0x16u);
        }
...
LABEL_12:
    ...
    v66[1] = 3221225472;
    v66[2] = __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke;
    v66[3] = &unk_278678358;
    v55 = v59;
    v67 = v55;
    v23 = [currentConnections na_firstObjectPassingTest:v66];

    v56 = currentAccessorySetupMetricDispatcher;
    if (v23)
    {
      v57 = v23;
...
LABEL_37:
        if ([requestCopy hasConnectEvent])
        {
          ...
          v54 = [v37 fromProtobuff:connectEvent];
        }
        ...
        v49 = v48;
        v50 = objc_msgSend_copy(array);
        v60[0] = MEMORY[0x277D85DD0];
        v60[1] = 3221225472;
        v60[2] = __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke_2;
        v60[3] = &unk_2786783C8;
        v65 = modeCopy;
        v60[4] = self;
        v61 = messageCopy;
        v62 = remoteSourceDevice;
        v63 = v55;
        v64 = v57;
        v51 = v57;
        [v49 connectWithConnection:v51 connectEvent:v54 unregisterEvent:v41 topicFilterAdditions:v50 completion:v60];

        v31 = v67;
        currentAccessorySetupMetricDispatcher = v56;
        currentAccessoryHomeUUID = v52;
LABEL_48:
...
LABEL_49:
    ...
    v57 = -[HMDRemoteEventRouterServerConnection initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:]([HMDRemoteEventRouterServerConnection alloc], "initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:", remoteSourceDevice, modeCopy, [messageCopy BOOLForKey:@"isFragmented"]);
    if (modeCopy == 1)
    {
      v27 = self->_logger;
      v26 = v53;
...
LABEL_33:
        ...
        [currentConnections3 addObject:v57];
...
void *__85__HMDRemoteEventRouterServer_handlePrimaryResidentIsCurrentDeviceChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (v4 != result)
  {
    v6 = *(a1 + 32);
    v7 = *(v6 + 8);
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT) && (v8 = MEMORY[0x277CCABB0], v9 = v7, [v8 numberWithBool:v4], v10 = objc_claimAutoreleasedReturnValue(), v15 = 138412290, v16 = v10, _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", &v15, 0xCu), v10, v9, (v6 = *(a1 + 32)) == 0))
    {
      v11 = 0;
    }
...
- (void)_registerForAccessoryMessages:(id)messages
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *&v38[14] = v7 != 0;
    v39 = 2112;
    v40 = v14;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "Registering for accessory messages %@, user privilege: (exists: %d) %@", v38, 0x1Cu);
  }
...
- (void)_registerForMessages:(id)messages withHome:(id)home
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v29 = 2112;
    v30 = v22;
    _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_DEFAULT, "Registering for messages with user privilege: (exists: %d) %@", v28, 0x12u);
  }
...
void __41__HMDRemoteEventRouterServer_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_109816;
  logCategory__hmf_once_v5_109816 = v0;
}
