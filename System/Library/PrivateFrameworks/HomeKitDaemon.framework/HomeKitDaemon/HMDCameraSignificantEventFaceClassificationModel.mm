...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_151573 != -1)
  {
    dispatch_once(&hmbProperties_onceToken_151573, &__block_literal_global_151574);
  }

  v3 = hmbProperties__properties_151575;
...
void __65__HMDCameraSignificantEventFaceClassificationModel_hmbProperties__block_invoke()
{
  ...
  v7 = hmbProperties__properties_151575;
  hmbProperties__properties_151575 = v6;
}
...
- (id)createFaceClassification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot create face classification from model: %@", &v17, 0x16u);
    }
