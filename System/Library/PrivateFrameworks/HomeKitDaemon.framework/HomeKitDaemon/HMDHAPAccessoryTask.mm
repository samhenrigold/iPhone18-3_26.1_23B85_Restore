...
- (void)sendCharacteristicNotificationsForCompletedTask:(id)task completion:(id)completion
{
  ...
  v18 = [requests na_map:&__block_literal_global_153_276853];
...
- (void)_sendCharacteristicNotificationsForTaskInProgress:(id)progress completion:(id)completion
{
  ...
  if ([v9 count])
  {
    ...
    {
      v15 = [v9 na_map:&__block_literal_global_146_276865];
    ...
    else
    {
      ...
      [v9 na_each:&__block_literal_global_141_276864];
...
void __84__HMDHAPAccessoryTask__sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_139(uint64_t a1, void *a2)
{
  v2 = [a2 request];
  [v2 setCompleted:1];
}
...
{
  requests = [(HMDHAPAccessoryTask *)self requests];
  v3 = [requests na_filter:&__block_literal_global_276902];
  v4 = [v3 count];
