...
void __61__HMDXPCEventRouterServer_handleConnectionActiveStateChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@[HMDXPCEventRouterSever] Received notification that connection active state changed: %@", &v13, 0x16u);
  }
...
LABEL_24:
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v52 = v48;
          _os_log_impl(&dword_229538000, v47, OS_LOG_TYPE_ERROR, "%{public}@No message payload present.", buf, 0xCu);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v52 = v42;
      _os_log_impl(&dword_229538000, v41, OS_LOG_TYPE_ERROR, "%{public}@Transport is not XPC connection.", buf, 0xCu);
    }
...
void __38__HMDXPCEventRouterServer_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_11124;
  logCategory__hmf_once_v1_11124 = v0;
}
