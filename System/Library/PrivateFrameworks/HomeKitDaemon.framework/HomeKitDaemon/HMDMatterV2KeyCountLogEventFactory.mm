  ...
  else
  {
    if ([eventsCopy count])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@We are trying to serialize %lu HMDMatterV2KeyCountLogEvent objects, which is impossible", &v14, 0x16u);
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_34898 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t5_34898, &__block_literal_global_34899);
  }

  v3 = logCategory__hmf_once_v6_34900;

  return v3;
}

void __49__HMDMatterV2KeyCountLogEventFactory_logCategory__block_invoke()
{
  v0 = HMFCreateOSLogHandle();
  v1 = logCategory__hmf_once_v6_34900;
  logCategory__hmf_once_v6_34900 = v0;
}
