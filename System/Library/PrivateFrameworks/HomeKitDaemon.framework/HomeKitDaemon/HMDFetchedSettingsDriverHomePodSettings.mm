...
void __83__HMDFetchedSettingsDriverHomePodSettings_serviceDidInitializeForCurrentAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@homepod settings did initialize", &v7, 0xCu);
  }
...
void __55__HMDFetchedSettingsDriverHomePodSettings_didReconnect__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@homepod settings did reconnect", &v7, 0xCu);
  }
...
void __76__HMDFetchedSettingsDriverHomePodSettings__writeSetting_keyPath_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Update %{public}@ completion error: %@", &v12, 0x20u);
  }
...
- (id)_transformPreferredMediaUserEvent:(id)event
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Transform hpSetting to primaryUserInfo: %@", &v12, 0x16u);
  }
...
LABEL_9:
  ...
  if ([HMDHPSAPIConformanceProviding objectRespondsToHPSConstrainedNumberSettingProtocolMethods:settingCopy])
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      v55 = 2048;
      v56 = integerValue4;
      _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Transform constrained number setting (after scaling up) with value: %ld, max: %ld, min: %ld, step: %ld", &v47, 0x34u);
    }
  ...
  if ([HMDHPSAPIConformanceProviding objectRespondsToHPSSiriLanguageSettingProtocolMethods:settingCopy])
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
      {
        ...
        v47 = 138543362;
        v48 = v45;
        _os_log_impl(&dword_229538000, v44, OS_LOG_TYPE_ERROR, "%{public}@Nil Language Value", &v47, 0xCu);
      }
...
- (void)updateSettingWithKeyPath:(id)path primaryUserInfo:(id)info completion:(id)completion
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v28 = 2112;
    v29 = infoCopy;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating Primary User setting %{public}@ to %@", &v24, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = infoCopy;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", &v24, 0x16u);
    }
...
- (void)updateSettingWithKeyPath:(id)path integerSettingValue:(id)value completion:(id)completion
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 2112;
    v34 = v19;
    _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@ (integer value: %@)", &v27, 0x2Au);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = valueCopy;
      _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", &v27, 0x16u);
    }
...
- (void)updateSettingWithKeyPath:(id)path BOOLSettingValue:(id)value completion:(id)completion
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v27 = 2112;
    v28 = valueCopy;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", &v23, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = valueCopy;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", &v23, 0x16u);
    }
...
- (void)fetchSettingsForKeyPaths:(id)paths completion:(id)completion
{
  ...
  v26[1] = v26;
  v26[2] = 0x3032000000;
  v26[3] = __Block_byref_object_copy__247791;
  v26[4] = __Block_byref_object_dispose__247792;
  v27 = MEMORY[0x277CBEBF8];
  v24[0] = 0;
  v24[1] = v24;
  v24[2] = 0x3032000000;
  v24[3] = __Block_byref_object_copy__247791;
  v24[4] = __Block_byref_object_dispose__247792;
  v25 = 0;
...
void __54__HMDFetchedSettingsDriverHomePodSettings_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_247803;
  logCategory__hmf_once_v1_247803 = v0;
}
