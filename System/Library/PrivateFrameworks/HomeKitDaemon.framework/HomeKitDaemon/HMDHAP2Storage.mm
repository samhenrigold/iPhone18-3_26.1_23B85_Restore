...
void __54__HMDHAP2Storage_removeCacheForIdentifier_completion___block_invoke(void *a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(*MEMORY[0x277CFECF0], OS_LOG_TYPE_ERROR))
    {
      ...
      v9 = 138412290;
      v10 = v8;
      _os_log_error_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "Storage: Unable to remove cache for %@", &v9, 0xCu);
    }
...
void __57__HMDHAP2Storage_saveCacheForIdentifier_data_completion___block_invoke(void *a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(*MEMORY[0x277CFECF0], OS_LOG_TYPE_ERROR))
    {
      ...
      v9 = 138412290;
      v10 = v8;
      _os_log_error_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "Storage: Unable to save cache for %@", &v9, 0xCu);
    }
...
void __58__HMDHAP2Storage_deregisterPairedAccessoryWithIdentifier___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(*MEMORY[0x277CFECF8], OS_LOG_TYPE_DEBUG))
    {
      ...
      v9 = 138412290;
      v10 = v8;
      _os_log_debug_impl(&dword_229538000, v7, OS_LOG_TYPE_DEBUG, "Ignoring invalid deregistered device ID: %@", &v9, 0xCu);
    }
  }
}
...
void __58__HMDHAP2Storage_deregisterPairedAccessoryWithIdentifier___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(*MEMORY[0x277CFECF8], OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 2112;
    v10 = v5;
    _os_log_debug_impl(&dword_229538000, v6, OS_LOG_TYPE_DEBUG, "remove key id=%@ error=%@", &v7, 0x16u);
  }
}
...
void __56__HMDHAP2Storage_registerPairedAccessoryWithIdentifier___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(*MEMORY[0x277CFECF8], OS_LOG_TYPE_DEBUG))
    {
      ...
      v8 = 138412290;
      v9 = v7;
      _os_log_debug_impl(&dword_229538000, v6, OS_LOG_TYPE_DEBUG, "Ignoring invalid registered device ID: %@", &v8, 0xCu);
    }
  }
}
