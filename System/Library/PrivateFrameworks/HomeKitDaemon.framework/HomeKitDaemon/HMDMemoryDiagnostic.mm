  ...
  if (v6)
  {
    ...
    if (v7 && [buildCopy isEqualToString:v7])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v8;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Previous diagnostic memory limit for build %@ is set to %@MB", &v14, 0x20u);
      }
...
+ (void)configureMemoryDiagnostic
{
  ...
  if (numberValue && [numberValue intValue] >= 1)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v34 = 2112;
      v35 = v7;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set diagnostic memory limit from preference: %@", &v32, 0x16u);
    }
  ...
  if (buildVersion)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      v36 = 2112;
      v37 = v18;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Setting diagnostic memory limit for build %@ to %@MB", &v32, 0x20u);
    }
    ...
    if (v23)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 2112;
        v35 = v23;
        _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to set diagnostic memory limit: %@", &v32, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 138543362;
      v33 = v31;
      _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current build version, return", &v32, 0xCu);
    }
