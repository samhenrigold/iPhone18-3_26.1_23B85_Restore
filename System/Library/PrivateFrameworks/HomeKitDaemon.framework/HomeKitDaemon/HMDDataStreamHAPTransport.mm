...
LABEL_7:
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling characteristics value updated notification: %@", &v18, 0x16u);
    }
...
- (void)_handleReceivedData:(id)data
{
  ...
  if (hasFailed)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@DataStream has encountered irrecoverable framing issue. Closing stream.", &v21, 0xCu);
    }
      ...
      if (v37 || !v36)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v58 = 2112;
          v59 = v37;
          _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply could not be parsed (error=%@)", buf, 0x16u);
        }
...
- (void)_writeCharacteristicRequests:(id)requests completion:(id)completion
{
  ...
  v17[1] = 3221225472;
  v17[2] = __69__HMDDataStreamHAPTransport__writeCharacteristicRequests_completion___block_invoke;
  v17[3] = &unk_2786862C0;
  v18 = requestsCopy;
  v19 = completionCopy;
  v17[4] = selfCopy;
  v15 = requestsCopy;
  v16 = completionCopy;
  [home writeCharacteristicValues:v15 source:1090 biomeSource:0 identifier:uUID transport:0 qualityOfService:-1 withCompletionHandler:v17];
}
...
LABEL_5:
    ...
    if (v16)
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 138543362;
        v31 = v21;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Error: failed to serialize Controller Payload; should not happen!", &v30, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Writing: %u bytes (rts=%d)", &v30, 0x18u);
      }
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
  {
    ...
    v30 = 138543362;
    v31 = v29;
    _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Writing: nothing to write", &v30, 0xCu);
  }
...
- (void)close
{
  ...
  if (_isRunning)
  {
    if (v7)
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@DataStream transport closing.", &v10, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket invoked closed but nothing to clean up.", &v10, 0xCu);
    }
...
- (void)connect
{
  ...
  if ([(HMDDataStreamHAPTransport *)self _isRunning])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v6;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-running transport", &v26, 0xCu);
    }
  ...
  else
  {
    ...
    if (accessory)
    {
      ...
      if (v9)
      {
        ...
        if (v10)
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            v26 = 138543362;
            v27 = v15;
            _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@[Connect] All good; connected!", &v26, 0xCu);
          }
        ...
        else
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
          {
            ...
            v26 = 138543362;
            v27 = v24;
            _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Connect] Missing characteristics to create transport for HDS over HAP (Interrupt Characteristic does not exist)", &v26, 0xCu);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          v26 = 138543362;
          v27 = v23;
          _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Connect] Missing characteristics to create transport for HDS over HAP (Transport Characteristic does not exist)", &v26, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 138543362;
        v27 = v19;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Connect called but accessory is no longer valid", &v26, 0xCu);
      }
