...
- (void)executeMediaActionWithSessionData:(id)data completion:(id)completion
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Running media action locally", &v13, 0xCu);
  }
...
- (id)targetResidentDeviceForExecutingMediaActionWithProfiles:(id)profiles targetSystemMediaApplication:(BOOL)application
{
    ...
    if (targetResidentDeviceOverride)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543618;
        ...
        v163 = 2112;
        v164 = identifier;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@[Target Device] Picking resident device override: %@", buf, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138543618;
        ...
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Available residents: %@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v165 = 2048;
        v166 = v32;
        _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Number of reachable residents: %lu, number of residents in action: %lu", buf, 0x20u);
      }

      objc_autoreleasePoolPop(v25);
      v33 = [v147 na_any:&__block_literal_global_35_135240];
      v34 = v33;
      if (v33)
      {
        v35 = [v23 na_any:&__block_literal_global_37_135241];
      }
      ...
      v36 = [v148 na_firstObjectPassingTest:&__block_literal_global_39_135242];
      if (v36)
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v163 = 2112;
          v164 = v42;
          _os_log_impl(&dword_229538000, v39, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a resident and part of action: %@", buf, 0x16u);
        ...
        if (firstObject)
        {
          ...
          if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v163 = 2112;
            v164 = v48;
            _os_log_impl(&dword_229538000, v45, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking non-odeon HomePod in action: %@", buf, 0x16u);
          ...
          if (firstObject2)
          {
            ...
            if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              v163 = 2112;
              v164 = v56;
              _os_log_impl(&dword_229538000, v53, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking non-odeon resident device in action: %@", buf, 0x16u);
            ...
            if (contexta)
            {
              ...
              if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543618;
                ...
                v163 = 2112;
                v164 = v63;
                _os_log_impl(&dword_229538000, v60, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking HomePod in action: %@", buf, 0x16u);
              ...
              if (firstObject3)
              {
                ...
                if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
                {
                  ...
                  *buf = 138543618;
                  ...
                  v163 = 2112;
                  v164 = v71;
                  _os_log_impl(&dword_229538000, v68, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking resident device in action: %@", buf, 0x16u);
                ...
                if (v74)
                {
                  ...
                  if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *buf = 138543618;
                    ...
                    v163 = 2112;
                    v164 = v81;
                    _os_log_impl(&dword_229538000, v78, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a HomePod and not part of action and is non-odeon: %@", buf, 0x16u);
                  ...
                  if (firstObject4)
                  {
                    ...
                    if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *buf = 138543618;
                      ...
                      v163 = 2112;
                      v164 = v89;
                      _os_log_impl(&dword_229538000, v86, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any non-odeon HomePod: %@", buf, 0x16u);
                    ...
                    if (v122)
                    {
                      ...
                      if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *buf = 138543618;
                        ...
                        v163 = 2112;
                        v164 = v97;
                        _os_log_impl(&dword_229538000, v94, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a resident and not part of action and is non-odeon: %@", buf, 0x16u);
                      ...
                      if (firstObject5)
                      {
                        ...
                        if (os_log_type_enabled(v103, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *buf = 138543618;
                          ...
                          v163 = 2112;
                          v164 = identifier2;
                          _os_log_impl(&dword_229538000, v103, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any HomePod resident: %@", buf, 0x16u);
                        }
                        ...
                        if (firstObject6)
                        {
                          ...
                          if (os_log_type_enabled(v108, OS_LOG_TYPE_INFO))
                          {
                            ...
                            *buf = 138543618;
                            ...
                            v163 = 2112;
                            v164 = identifier3;
                            _os_log_impl(&dword_229538000, v108, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any non-odeon resident: %@", buf, 0x16u);
                          }
                          ...
                          if (firstObject7)
                          {
                            if (v113)
                            {
                              ...
                              *buf = 138543618;
                              ...
                              v163 = 2112;
                              v164 = identifier4;
                              _os_log_impl(&dword_229538000, v112, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any resident: %@", buf, 0x16u);
                            }
                          ...
                          else
                          {
                            if (v113)
                            {
                              ...
                              *buf = 138543618;
                              ...
                              v163 = 2048;
                              v164 = v118;
                              _os_log_impl(&dword_229538000, v112, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Couldn't find media action resident to route to, out of %lu candidates", buf, 0x16u);
                            }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v162 = v19;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid data source", buf, 0xCu);
    }
...
- (void)sendMediaActionMessageToDevice:(id)device sessionData:(id)data encodePlaybackArchive:(BOOL)archive canForwardMessage:(BOOL)message completion:(id)completion
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v45 = 2112;
    v46 = v22;
    _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending media action to < %@ : %@ > canForward: %@", buf, 0x2Au);
...
- (void)sendMediaActionMessageToCompanionWithSessionData:(id)data encodePlaybackArchive:(BOOL)archive completion:(id)completion
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v20 = v13;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Running media action on companion", buf, 0xCu);
  }
...
void __106__HMDMediaActionRouter_sendMediaActionMessageToCompanionWithSessionData_encodePlaybackArchive_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unable to execute media action on companion: %@", &v8, 0x16u);
    }
...
void __102__HMDMediaActionRouter_sendMediaActionMessageToResident_sessionData_encodePlaybackArchive_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 && ([*(a1 + 32) dataSource], v4 = objc_claimAutoreleasedReturnValue(), v5 = objc_msgSend(v4, "isResidentReachable:", *(a1 + 40)), v4, (v5 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Device < %@ : %@ > unreachable, rerouting", &v13, 0x20u);
    }
...
- (void)routeSessionDataForExecution:(id)execution encodePlaybackArchive:(BOOL)archive completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to package media action for execution, invalid message payload", &v18, 0xCu);
    }
