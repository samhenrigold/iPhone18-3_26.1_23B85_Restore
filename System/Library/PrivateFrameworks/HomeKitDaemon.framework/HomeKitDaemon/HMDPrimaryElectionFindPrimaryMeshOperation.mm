...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_56(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained && v5)
  {
    v7 = [v3 na_map:&__block_literal_global_60_171093];
    v8 = WeakRetained[39];
    WeakRetained[39] = v7;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_171166 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t14_171166, &__block_literal_global_64_171167);
  }

  v3 = logCategory__hmf_once_v15_171168;
