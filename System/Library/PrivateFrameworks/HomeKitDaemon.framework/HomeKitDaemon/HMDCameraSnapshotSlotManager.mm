...
- (id)createSlot
{
  ...
  v9 = &v8;
  v10 = 0x3032000000;
  v11 = __Block_byref_object_copy__65886;
  v12 = __Block_byref_object_dispose__65887;
  v13 = 0;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_65908 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t13_65908, &__block_literal_global_23_65909);
  }

  v3 = logCategory__hmf_once_v14_65910;
...
+ (HMDCameraSnapshotSlotManager)sharedManager
{
  ...
  {
    dispatch_once(&sharedManager_onceToken, &__block_literal_global_65915);
  }
...
void __45__HMDCameraSnapshotSlotManager_sharedManager__block_invoke()
{
