...
void __44__HMDTimeEvent__reactivateTriggerAfterDelay__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Reactivated trigger after timer fired", &v9, 0xCu);
  }
...
- (void)handleTimerFiredNotification:(id)notification
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v13;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Timer has fired %@, current activation state: %@", &v24, 0x20u);
    }
      ...
      if ([(HMDTimeEvent *)selfCopy repetitive])
      {
        ...
        if (executeOnce)
        {
          if (v21)
          {
            ...
            v24 = 138543362;
            v25 = v22;
            _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Not-Reactivating the event as it does not have recurrences", &v24, 0xCu);
          }
        ...
        else
        {
          if (v21)
          {
            ...
            v24 = 138543362;
            v25 = v23;
            _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Reactivating the event as it does have some recurrences", &v24, 0xCu);
          }
...
void __27__HMDTimeEvent_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v15_191596;
  logCategory__hmf_once_v15_191596 = v0;
}
  ...
  if (componentsCopy)
  {
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 2112;
        v15 = componentsCopy;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Given date component contains non supported fields set: %@", &v12, 0x16u);
      }
