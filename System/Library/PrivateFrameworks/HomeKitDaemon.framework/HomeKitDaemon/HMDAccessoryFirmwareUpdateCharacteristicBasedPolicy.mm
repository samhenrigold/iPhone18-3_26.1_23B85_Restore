...
- (BOOL)evaluate
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", &v11, 0x16u);
  }
...
void __66__HMDAccessoryFirmwareUpdateCharacteristicBasedPolicy_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_133616;
  logCategory__hmf_once_v1_133616 = v0;
}
