...
- (void)setSelectedEndPointSetupParameters:(id)parameters videoNetworkConfig:(id)config audioNetworkConfig:(id)networkConfig
{
  ...
  if (createSRTPParamters)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 138543362;
        v36 = v34;
        _os_log_impl(&dword_229538000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio SRTP parameters", &v35, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 138543362;
      v36 = v30;
      _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video SRTP parameters", &v35, 0xCu);
    }
...
- (BOOL)findBestMatchWithProtocolParameters:(id)parameters streamingCapabilities:(id)capabilities videoTierParameters:(id)tierParameters
{
  ...
  if ([(HMDCameraVideoParameterSelection *)v15 selectVideoParameters])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 138543362;
        v32 = v29;
        _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to select audio config", &v31, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 138543362;
      v32 = v25;
      _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to select video config", &v31, 0xCu);
    }
