...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_183605 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_183605, &__block_literal_global_183606);
  }

  v3 = logCategory__hmf_once_v1_183607;
...
void __51__HMDAccessoryFirmwareUpdateTimeWindow_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_183607;
  logCategory__hmf_once_v1_183607 = v0;
}
