...
- (id)fetchWalletKeyColorForAccessories_HAP:(id)p home:(id)home flow:(id)flow
{
  ...
  if (v18)
  {
    ...
    v27[1] = 3221225472;
    v27[2] = __84__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_HAP_home_flow___block_invoke_530;
    v27[3] = &unk_2786839D0;
...
id __84__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_HAP_home_flow___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color options: %@, accessory information service: %@ doesn't support hardware finish characteristic: %@", &v22, 0x34u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2112;
      v29 = v4;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color options: %@, accessory information service not supported %@", &v22, 0x2Au);
    }
...
id __87__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_Matter_home_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v11;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to find wallet key color for Matter accessories", &v15, 0x16u);
    }
...
- (void)fetchWalletKeyColorForAccessories:(id)accessories flow:(id)flow withCompletion:(id)completion
{
  ...
  else
  {
    ...
    if (home)
    {
      ...
      v36 = [accessoriesCopy na_filter:&__block_literal_global_519];
...
void __90__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_flow_withCompletion___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v13;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched wallet key color: %@", &v20, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 138543362;
      v21 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to find color for Matter or HAP accessories", &v20, 0xCu);
    }
...
void __74__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorWithAccessory_flow___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v12;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color when accessory connected %@:%@", &v13, 0x2Au);
    }
...
LABEL_14:
    ...
    v66[1] = 3221225472;
    v66[2] = __105__HMDHomeWalletKeyAccessoryManager_configureMatterAccessory_withDeviceCredentialKey_ofType_forUser_flow___block_invoke;
    v66[3] = &unk_2786838C0;
    v67 = accessoryCopy;
    v68 = flowCopy;
    v37 = v37;
...
LABEL_11:
  ...
  v62 = keyCopy;
  v37 = keyCopy;
  v43 = objc_alloc_init(MEMORY[0x277CFEB40]);
  v44 = [objc_alloc(MEMORY[0x277CFEBE8]) initWithValue:2];
  [v43 setType:v44];

  [v43 setKey:v37];
  v45 = [objc_alloc(MEMORY[0x277CFEBE0]) initWithValue:1];
  [v43 setState:v45];

  v46 = v43;
  v47 = objc_alloc_init(MEMORY[0x277CFEB90]);
  [v47 setDeviceCredentialKey:v46];
  v73 = 0;
  v61 = v47;
  v48 = [v47 serializeWithError:&v73];
  v64 = v73;
  if (v48)
  {
    v36 = selfCopy;
  ...
  else
  {
    ...
    selfCopy = [v56 futureWithError:v49];
    v46 = v60;
  }
...
uint64_t __105__HMDHomeWalletKeyAccessoryManager_configureMatterAccessory_withDeviceCredentialKey_ofType_forUser_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (v4 && (v5 = v4, [v3 status], v6 = objc_claimAutoreleasedReturnValue(), v7 = objc_msgSend(v6, "isEqualToNumber:", &unk_283E74810), v6, v5, v7))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 2112;
      v34 = v14;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured accessory with device credential key %@, accessory: %@", &v27, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 2112;
      v34 = v22;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@ with status code: %@", &v27, 0x2Au);
    }
  ...
  if (!home)
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v94 = 2112;
      v95 = uUID;
      _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key, home is nil", buf, 0x16u);
  ...
  if (![h2Copy count])
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v94 = 2112;
      v95 = uUID2;
      _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessories with device credential key, accessories count is 0", buf, 0x16u);
...
LABEL_13:
  ...
  v87[1] = 3221225472;
  v87[2] = __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_506;
  v87[3] = &unk_2786837D0;
  v87[4] = selfCopy3;
  v88 = keyCopy;
  typeCopy = type;
    ...
    if (v51 != [v21 count])
    {
      ...
      if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544130;
        ...
        v98 = 2048;
        v99 = v57;
        _os_log_impl(&dword_229538000, v71, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create a write request for a subset of the HAP accessories (%lu of the %lu HAP accessories)", buf, 0x2Au);
      }

      objc_autoreleasePoolPop(v52);
      v85[0] = MEMORY[0x277D85DD0];
      v85[1] = 3221225472;
      v85[2] = __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_508;
      v85[3] = &unk_2786837F8;
      v86 = v48;
      v58 = [v50 flatMap:v85];
    }
  ...
  v83[1] = 3221225472;
  v83[2] = __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_2_510;
  v83[3] = &unk_278683820;
  v65 = completionCopy;
  v84 = v65;
...
- (void)configureAccessories:(id)accessories withDeviceCredentialKey:(id)key ofType:(int64_t)type forDeviceWithUUID:(id)d user:(id)user flow:(id)flow completion:(id)completion
{
  ...
  else
  {
    ...
    v30 = flowCopy;
    v46 = v30;
    v31 = [accessoriesCopy na_filter:v44];
...
- (void)unregisterForNotificationsWithReason:(id)reason
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = reasonCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Unregistering for notifications with reason: %@", &v17, 0x16u);
  }
...
void __71__HMDHomeWalletKeyAccessoryManager_registerForNotificationsWithReason___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully fetched wallet key color when registered for notifications %@", &v15, 0x20u);
...
LABEL_6:
  ...
  else if (v10)
  {
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Could not fetch wallet key color when registered for notifications %@", &v15, 0x20u);
...
id __76__HMDHomeWalletKeyAccessoryManager_configureReaderKey_onACWGAccessory_flow___block_invoke(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = [a1[5] UUID];
    v23 = [a1[6] readerPublicKeyExternalRepresentation];
    v9 = [v23 hmf_hexadecimalRepresentation];
  ...
  v27[0] = MEMORY[0x277D85DD0];
  v27[1] = 3221225472;
  v27[2] = __76__HMDHomeWalletKeyAccessoryManager_configureReaderKey_onACWGAccessory_flow___block_invoke_480;
  v27[3] = &unk_278683748;
  v16 = a1[6];
  v26 = *(a1 + 2);
  v17 = v26.i64[1];
...
LABEL_8:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    v19 = HMFGetLogIdentifier();
    v20 = [a1[6] UUID];
    v36 = [v3 readerPublicKeyExternalRepresentation];
    v21 = [v36 hmf_hexadecimalRepresentation];
    v35 = [v3 readerGroupIdentifier];
    v22 = [v35 hmf_hexadecimalRepresentation];
  ...
  v38[1] = 3221225472;
  v38[2] = __76__HMDHomeWalletKeyAccessoryManager_configureReaderKey_onACWGAccessory_flow___block_invoke_482;
  v38[3] = &unk_278683598;
  v28 = a1[8];
  v29 = a1[5];
  v30 = a1[6];
...
LABEL_12:
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    else
    {
      ...
      v107 = objc_alloc_init(MEMORY[0x277CFEB90]);
      [v107 setReaderKey:v64];
      ...
      v130 = 0;
      contexta = [v107 serializeWithError:&v130];
      v102 = v130;
      if (contexta)
      {
        ...
        v127[1] = 3221225472;
        v127[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke;
        v127[3] = &unk_27868A6D8;
        v128 = contexta;
        v71 = flowCopy;
        v129 = v71;
        v72 = [v70 then:v127];
        ...
        v122[1] = 3221225472;
        v122[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_2;
        v122[3] = &unk_2786836F8;
        v122[4] = v60;
        v123 = v71;
        v124 = keyCopy;
        v125 = accessoryCopy;
        ...
        v119[1] = 3221225472;
        v119[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_477;
        v119[3] = &unk_278683720;
        v119[4] = v60;
        v120 = v123;
        v121 = v126;
        v73 = [v72 then:v122 orRecover:v119];
  ...
  else
  {
    ...
    if (v43)
    {
      ...
      if (v44)
      {
        ...
        v101 = [objc_alloc(MEMORY[0x277CFEBD0]) initWithOperationType:context issuerKeyRequest:0 issuerKeyResponse:0 deviceCredentialKeyRequest:0 deviceCredentialKeyResponse:0 readerKeyRequest:v45 readerKeyResponse:0];
        v118 = 0;
        v100 = [v101 serializeWithError:&v118];
        v99 = v118;
        if (v100)
        {
          v49 = [HMDCharacteristicWriteRequest writeRequestWithCharacteristic:v44 value:v100 authorizationData:0 identifier:0 type:0 includeResponseValue:1];
          v131 = v49;
          ...
          [dataSource2 accessoryWriteRetryInterval];
          v97 = [(__CFString *)home performWriteRequests:v50 withRetries:accessoryWriteMaxRetryCount timeInterval:v39 loggingObject:flowCopy flow:?];
          ...
          v57 = [v97 reschedule:v56];
          v111[0] = MEMORY[0x277D85DD0];
          v111[1] = 3221225472;
          v111[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_478;
          v111[3] = &unk_2786836D0;
          objc_copyWeak(&v115, buf);
          objc_copyWeak(&v116, &location);
          v112 = flowCopy;
          v114 = completionCopy;
          v113 = v44;
          v58 = [v57 addCompletionBlock:v111];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v82, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138544386;
          ...
          v135 = uUID9;
          v136 = 2112;
          v137 = shortDescription5;
          v138 = 2112;
          v139 = v106;
          v140 = 2112;
          v141 = @"00000264-0000-1000-8000-0026BB765291";
    ...
    else
    {
      ...
      if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544130;
        ...
        v135 = uUID10;
        v136 = 2112;
        v137 = shortDescription6;
        v138 = 2112;
        v139 = @"00000266-0000-1000-8000-0026BB765291";
...
uint64_t __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v4 && (v5 = v4, [v3 status], v6 = objc_claimAutoreleasedReturnValue(), v7 = objc_msgSend(v6, "isEqualToNumber:", &unk_283E74810), v6, v5, v7))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = v14;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured accessory with NFC reader key: %@, accessory: %@", &v26, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = v23;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@ with status code: %@", &v26, 0x2Au);
    }
...
LABEL_7:
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v3;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to configure NFC reader key with error: %@", &v15, 0x20u);
    }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v11;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Ignoring duplicate error while adding Reader key", &v15, 0x16u);
  }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138544386;
              ...
              v78 = 2112;
              v79 = v17;
              _os_log_impl(&dword_229538000, v58, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, failed to parse response value %@:%@", buf, 0x34u);
...
void __80__HMDHomeWalletKeyAccessoryManager_configureNFCReaderKeyOnMatterAccessory_flow___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch or nfc reader key for matter accessory: %@", &v17, 0x20u);
    }
...
- (void)fetchOrConfigureNFCReaderKeyForAccessory:(id)accessory flow:(id)flow completion:(id)completion
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterTTU", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [accessoryCopy supportsCHIP] && !-[HMDHomeWalletKeyAccessoryManager isPrimaryResidentOrSoleOwnerController](selfCopy, "isPrimaryResidentOrSoleOwnerController"))
  {
    ...
    v41[0] = @"HMDHomeConfigureMatterAccessoryWithReaderKeyMessageKeyAccessoryUUID";
    uuid2 = [accessoryCopy uuid];
    v30 = encodeRootObjectForIncomingXPCMessage(uuid2, 0);
    v42[0] = v30;
    v41[1] = *MEMORY[0x277D0F1C8];
    v31 = HMFEncodedRootObject();
    v42[1] = v31;
    v32 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v42 forKeys:v41 count:2];
  ...
  else
  {
    ...
    v37[1] = 3221225472;
    v37[2] = __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke;
    v37[3] = &unk_278683658;
    v37[4] = selfCopy;
    v38 = flowCopy;
    v40 = completionCopy;
    v39 = accessoryCopy;
    [nfcReaderKeyManager fetchOrCreateReaderKeyWithRequiresPrivateKey:1 flow:v38 completion:v37];
  }
}
...
void __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      v17[1] = 3221225472;
      v17[2] = __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke_464;
      v17[3] = &unk_278683630;
      v17[4] = v11;
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      if (v7)
      {
        ...
        v31[1] = 3221225472;
        v31[2] = __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke_465;
        v31[3] = &unk_2786862E8;
        v31[4] = v28;
        v35 = a1[7];
        v32 = a1[6];
...
void __75__HMDHomeWalletKeyAccessoryManager_configureNFCReaderKeyForAccessory_flow___block_invoke(id *a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v3;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure accessory with nfc reader key %@:%@", &v21, 0x2Au);
    }
    ...
    if ([a1[5] shouldRetryReaderKeyConfigureOnFailure])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2112;
        v26 = v17;
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Retrying configuring accessory with nfc reader key: %@", &v21, 0x20u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v20;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured accessory with nfc reader key: %@", &v21, 0x20u);
    }
...
- (void)requestPrimaryResident:(id)resident toConfigureAccessories:(id)accessories withDeviceCredentialKey:(id)key ofType:(int64_t)type flow:(id)flow completion:(id)completion
{
  ...
  else
  {
    ...
    v45[1] = 3221225472;
    v45[2] = __129__HMDHomeWalletKeyAccessoryManager_requestPrimaryResident_toConfigureAccessories_withDeviceCredentialKey_ofType_flow_completion___block_invoke_462;
    v45[3] = &unk_278685AF8;
    v45[4] = self;
    v46 = completionCopy;
  ...
  if ([*(a1 + 32) isPrimaryResidentOrSoleOwnerController])
  {
    ...
    if (v6)
    {
      if (v10)
      {
        ...
        v23 = 2112;
        v24 = v12;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification of restricted guest %@ being added to home but we already scheduled work to configure issuerKeys in invite acceptance, so nothing to be done here", &v21, 0x16u);
      }
    ...
    else
    {
      if (v10)
      {
        ...
        v23 = 2112;
        v24 = v5;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling added user: %@", &v21, 0x16u);
      }
      ...
      if ((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterTTU", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v25 = 2112;
          v26 = v5;
          _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Adding Issuer Key to accessories for newly added user: %@", &v21, 0x20u);
        }
...
void __68__HMDHomeWalletKeyAccessoryManager_handleWalletKeySupportDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v8;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Configuring NFC Reader Key because wallet key support did change on accessory: %@", &v17, 0x20u);
  }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterTTU", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [*(a1 + 40) supportsCHIP] && objc_msgSend(*(a1 + 40), "supportsWalletKey") && objc_msgSend(*(a1 + 32), "isPrimaryResidentOrSoleOwnerController"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Adding Issuer Key to accessory because wallet key support did change on accessory: %@", &v17, 0x20u);
    }
...
void __62__HMDHomeWalletKeyAccessoryManager_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Configuring NFC Reader Key because accessory was configured", &v15, 0x16u);
  }
  ...
  if (v8 && [*(a1 + 40) supportsHAP])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Fetching wallet key color because accessory was configured", &v15, 0x16u);
    }
...
void __75__HMDHomeWalletKeyAccessoryManager_handleHomeAccessoryRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Last accessory supporting wallet key was removed.", &v8, 0x16u);
  }
...
void __73__HMDHomeWalletKeyAccessoryManager_handleHomeAddedAccessoryNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2112;
    v26 = v8;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Configuring NFC Reader Key because new accessory was added: %@", &v21, 0x20u);
  }
        ...
        if ([*(a1 + 32) isPrimaryResidentOrSoleOwnerController])
        {
          ...
          if (([*(a1 + 40) supportsACWGProvisioning] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              v25 = 2112;
              v26 = v19;
              _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Home Key}] Adding Issuer Key to accessory because new accessory was added: %@", &v21, 0x20u);
            }
...
void __76__HMDHomeWalletKeyAccessoryManager_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (v12)
  {
    ...
    v24[0] = MEMORY[0x277D85DD0];
    v24[1] = 3221225472;
    v24[2] = __76__HMDHomeWalletKeyAccessoryManager_handlePrimaryResidentUpdateNotification___block_invoke_439;
    v24[3] = &unk_2786830C8;
    v14 = v12;
    v25 = v14;
    ...
    if (v10)
    {
      ...
      if (v17)
      {
        ...
        if (v19)
        {
          ...
          v26[0] = MEMORY[0x277D85DD0];
          v26[1] = 3221225472;
          v26[2] = __86__HMDHomeWalletKeyAccessoryManager_handleAccessoryCharacteristicsChangedNotification___block_invoke_438;
          v26[3] = &unk_27868A750;
          v26[4] = selfCopy;
          v27 = v19;
...
- (void)handleHMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessage:(id)message
{
  ...
  v32 = [messageCopy uuidForKey:@"HMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessageAccessoryUUID"];
  v33 = home;
  ...
  v31 = [messageCopy numberForKey:@"HMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessageControllerType"];
  ...
  v24 = -[HMDHomeWalletKeyAccessoryManager addOrUpdateIssuerKey:forUser:toMatterAccessory:withControllerType:unifiedAccess:flow:](v19, "addOrUpdateIssuerKey:forUser:toMatterAccessory:withControllerType:unifiedAccess:flow:", v17, v13, v16, v31, [supportsMatterWalletKey BOOLValue], flow);
  v37[0] = MEMORY[0x277D85DD0];
  v37[1] = 3221225472;
  v37[2] = __102__HMDHomeWalletKeyAccessoryManager_handleHMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessage___block_invoke;
  v37[3] = &unk_2786835C0;
  v37[4] = v19;
  v25 = flow;
  v38 = v25;
  v26 = messageCopy;
  v39 = v26;
  v27 = [v24 addSuccessBlock:v37];
  v34[0] = MEMORY[0x277D85DD0];
  v34[1] = 3221225472;
  v34[2] = __102__HMDHomeWalletKeyAccessoryManager_handleHMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessage___block_invoke_433;
  v34[3] = &unk_278688D58;
  v34[4] = v19;
  v35 = v25;
  v36 = v26;
...
void __102__HMDHomeWalletKeyAccessoryManager_handleHMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessage___block_invoke(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addOrUpdateIssuerKey successful.", &v9, 0x16u);
  }
...
void __102__HMDHomeWalletKeyAccessoryManager_handleHMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessage___block_invoke_433(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] addOrUpdateIssuerKey failed with error: %@", &v9, 0x20u);
  }
...
- (void)auditKeysLocallyOrRedispatchWithAccessoryUUID:(id)d issuerKey:(id)key withFlow:(id)flow
{
  ...
  if (home)
  {
    v84 = [(HMDHomeWalletKeyAccessoryManager *)selfCopy reachablePrimaryResidentDeviceForHome:home];
    ...
    else
    {
      ...
      if (v84)
      {
        ...
        objc_autoreleasePoolPop(v39);
        [(HMDHomeWalletKeyAccessoryManager *)v40 sendIssuerKeyUpdateMessageToPrimaryResidentforAccessoryWithUUID:v83 issuerKey:keyCopy flow:flowCopy];
        v21 = v82;
        goto LABEL_34;
      }
      ...
      if (currentUser3)
      {
        ...
        if (isOwner)
        {
          ...
          if (isWatch && companionDevice)
          {
            ...
            dCopy = v83;
            keyCopy = v80;
            [(HMDHomeWalletKeyAccessoryManager *)v64 sendIssuerKeyUpdateMessageToPhone:companionDevice forAccessoryWithUUID:v83 issuerKey:v80 flow:flowCopy];
          }
          ...
          else
          {
            ...
            keyCopy = v80;
            v77 = [(HMDHomeWalletKeyAccessoryManager *)v64 addOrUpdateIssuerKey:v80 forUser:currentUser5 toMatterAccessory:v21 withControllerType:&unk_283E747F8 unifiedAccess:bOOLValue flow:flowCopy];
...
- (void)sendIssuerKeyUpdateMessageToPrimaryResidentforAccessoryWithUUID:(id)d issuerKey:(id)key flow:(id)flow
{
  ...
  v34 = keyCopy;
  v42[0] = keyCopy;
  v41[0] = @"HMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessageIssuerKey";
  v41[1] = @"HMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessageControllerType";
  v16 = MEMORY[0x277CCABB0];
  productInfo = [MEMORY[0x277D0F8E8] productInfo];
  v18 = [v16 numberWithInteger:{objc_msgSend(productInfo, "productClass")}];
  v42[1] = v18;
  v41[2] = *MEMORY[0x277D0F1C8];
  v19 = HMFEncodedRootObject();
  v42[2] = v19;
  v20 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v42 forKeys:v41 count:3];
  ...
  v35[1] = 3221225472;
  v35[2] = __115__HMDHomeWalletKeyAccessoryManager_sendIssuerKeyUpdateMessageToPrimaryResidentforAccessoryWithUUID_issuerKey_flow___block_invoke;
  v35[3] = &unk_278688370;
  v35[4] = self;
  v24 = flowCopy;
  v36 = v24;
  [(HMDRemoteMessage *)v23 setResponseHandler:v35];
  v25 = objc_autoreleasePoolPush();
  selfCopy = self;
  v27 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
...
void __115__HMDHomeWalletKeyAccessoryManager_sendIssuerKeyUpdateMessageToPrimaryResidentforAccessoryWithUUID_issuerKey_flow___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to send message to primary resident receiver with error: %@", &v12, 0x20u);
    }
...
- (void)sendIssuerKeyUpdateMessageToPhone:(id)phone forAccessoryWithUUID:(id)d issuerKey:(id)key flow:(id)flow
{
  ...
  v30[0] = keyCopy;
  v29[0] = @"HMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessageIssuerKey";
  v29[1] = @"HMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessageControllerType";
  v18 = MEMORY[0x277CCABB0];
  productInfo = [MEMORY[0x277D0F8E8] productInfo];
  v20 = [v18 numberWithInteger:{objc_msgSend(productInfo, "productClass")}];
  v30[1] = v20;
  v29[2] = *MEMORY[0x277D0F1C8];
  ...
  v27[0] = MEMORY[0x277D85DD0];
  v27[1] = 3221225472;
  v27[2] = __106__HMDHomeWalletKeyAccessoryManager_sendIssuerKeyUpdateMessageToPhone_forAccessoryWithUUID_issuerKey_flow___block_invoke;
  v27[3] = &unk_278688370;
  v27[4] = self;
  v28 = flowCopy;
  v25 = flowCopy;
  [(HMDRemoteMessage *)v24 setResponseHandler:v27];
  msgDispatcher = [home msgDispatcher];
...
void __106__HMDHomeWalletKeyAccessoryManager_sendIssuerKeyUpdateMessageToPhone_forAccessoryWithUUID_issuerKey_flow___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to send message to phone receiver with error: %@", &v12, 0x20u);
    }
  ...
  if (accessoryCopy)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = uuid;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not adding issuer key because we don't have one for user: %@", &v25, 0x20u);
      }
...
void __121__HMDHomeWalletKeyAccessoryManager_addOrUpdateIssuerKey_forUser_toMatterAccessory_withControllerType_unifiedAccess_flow___block_invoke_2(id *a1, void *a2)
{
  ...
  if (a1[4] && [v3 BOOLValue])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Healing Mechanism successfully added new issuer key", &v13, 0x16u);
    }
...
void __121__HMDHomeWalletKeyAccessoryManager_addOrUpdateIssuerKey_forUser_toMatterAccessory_withControllerType_unifiedAccess_flow___block_invoke_417(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Healing Mechanism triggered but failed with error %@", &v9, 0x20u);
  }
...
LABEL_3:
  ...
  if (v27)
  {
    ...
    if (!accessCopy)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138544642;
        ...
        v66 = uuid;
        v67 = 2112;
        v68 = acwgIssuerPublicKeyExternalRepresentation;
        v69 = 2112;
        v70 = v52;
        v71 = 2112;
        v72 = v40;
    ...
    v54[1] = 3221225472;
    v54[2] = __103__HMDHomeWalletKeyAccessoryManager__addOrUpdateIssuerKey_forUser_toMatterAccessory_unifiedAccess_flow___block_invoke;
    v54[3] = &unk_2786834A8;
    keyCopy = v52;
    v55 = v52;
    v56 = userCopy;
...
LABEL_6:
  ...
  v20[1] = 3221225472;
  v20[2] = __103__HMDHomeWalletKeyAccessoryManager__addOrUpdateIssuerKey_forUser_toMatterAccessory_unifiedAccess_flow___block_invoke_3;
  v20[3] = &unk_278683430;
  v21 = *(a1 + 64);
  v22 = *(a1 + 72);
  v24 = *(a1 + 80);
...
LABEL_10:
  ...
  v18 = _HMFPreconditionFailure();
  return __103__HMDHomeWalletKeyAccessoryManager__addOrUpdateIssuerKey_forUser_toMatterAccessory_unifiedAccess_flow___block_invoke_4(v18, v19);
}
...
LABEL_8:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v12;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Ignoring duplicate error while updating Issuer key", &v18, 0x16u);
  }
...
id __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke(id *a1, void *a2)
{
  ...
  if ([a1[4] supportsACWGProvisioning])
  {
    if ([a1[5] isCurrentUser])
    {
      ...
      v25[0] = MEMORY[0x277D85DD0];
      v25[1] = 3221225472;
      v25[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_2;
      v25[3] = &unk_2786833E0;
      v8 = a1[7];
      v25[4] = a1[6];
      v26 = v8;
      ...
      v29 = v3;
      v30 = a1[4];
      [v5 getIssuerKeyPairExternalRepresentationFromKeychainForHomeUUID:v7 completionHandler:v25];
    ...
    else
    {
      v13 = a1[6];
      v14 = a1[4];
      v15 = [a1[5] acwgIssuerPublicKeyExternalRepresentation];
      v11 = [v13 _addIssuerKeyForUserIndex:v3 toMatterAccessory:v14 isUnifiedAccess:0 issuerKeyData:v15 withFlow:a1[7]];
    }
  }

  else
  {
    v12 = [objc_opt_class() createMatterIssuerKeyDataForUser:a1[5] withUserIndex:v3 flow:a1[7]];
    if (v12)
    {
      v11 = [a1[6] _addIssuerKeyForUserIndex:v3 toMatterAccessory:a1[4] isUnifiedAccess:1 issuerKeyData:v12 withFlow:a1[7]];
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v35 = 2112;
        v36 = v21;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not adding issuer key because we don't have one for user: %@", buf, 0x20u);
      }

      objc_autoreleasePoolPop(v16);
      v22 = MEMORY[0x277D2C900];
      v23 = [MEMORY[0x277CCA9B8] hmErrorWithCode:52];
      v11 = [v22 futureWithError:v23];
    }
  }
...
void __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_3(uint64_t a1)
{
  ...
  if (*(a1 + 32))
  {
    ...
    if (v2)
    {
      ...
      v19[0] = MEMORY[0x277D85DD0];
      v19[1] = 3221225472;
      v19[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_405;
      v19[3] = &unk_2786833B8;
      v20 = *(a1 + 64);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v13;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Ignoring duplicate error while adding Issuer key", &v17, 0x16u);
  }
...
void __119__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUserIndex_toMatterAccessory_isUnifiedAccess_issuerKeyData_withFlow___block_invoke_398(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v19 = 2112;
    v20 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to add issuer key for user index: %@, to accessory: %@, with error: %@", &v11, 0x34u);
  }
...
void __119__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUserIndex_toMatterAccessory_isUnifiedAccess_issuerKeyData_withFlow___block_invoke_399(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured issuer key for user index: %@ on accessory: %@", &v13, 0x2Au);
  }
...
- (void)addIssuerKeysToMatterV1AccessoriesWithFlow:(id)flow
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = uUID;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addIssuerKeysToMatterAccessories", &v20, 0x16u);
  }
  ...
  if (hmf_isEmpty)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = uUID2;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] No Matter accessories supporting wallet key excluding aliro, so nothing to add Issuer key to.", &v20, 0x16u);
    }
...
void __85__HMDHomeWalletKeyAccessoryManager__handleAddIssuerKeysToMatterV1AccessoriesMessage___block_invoke(id *a1)
{
  ...
  v16[0] = MEMORY[0x277D85DD0];
  v16[1] = 3221225472;
  v16[2] = __85__HMDHomeWalletKeyAccessoryManager__handleAddIssuerKeysToMatterV1AccessoriesMessage___block_invoke_387;
  v16[3] = &unk_278682F48;
  v17 = a1[6];
      ...
      if (v18)
      {
        ...
        if (v19)
        {
          ...
          if (v20)
          {
            ...
            v65[1] = 3221225472;
            v65[2] = __93__HMDHomeWalletKeyAccessoryManager_handleConfigureAccessoriesWithDeviceCredentialKeyMessage___block_invoke_378;
            v65[3] = &unk_278688D58;
            v65[4] = selfCopy;
            v66 = v22;
            v67 = messageCopy;
            v26 = selfCopy;
            v27 = v57;
            [(HMDHomeWalletKeyAccessoryManager *)v26 configureAccessories:v23 withDeviceCredentialKey:v59 ofType:integerValue forDeviceWithUUID:identifier user:v14 flow:v66 completion:v65];
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 2112;
        v32 = v6;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessory with device credential key, accessory with uuid: %@ not found", &v27, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        v33 = 2112;
        v34 = objc_opt_class();
        _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessory with device credential key, failed to convert accessory uuid: %@ to: %@", &v27, 0x2Au);
      }
...
LABEL_20:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    v33 = 2112;
    v34 = objc_opt_class();
    _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessory with device credential key, unknown type for uuid: %@ expected: %@", &v27, 0x2Au);
  }
...
LABEL_4:
    ...
    v35[0] = MEMORY[0x277D85DD0];
    v35[1] = 3221225472;
    v35[2] = __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_2_366;
    v35[3] = &unk_278683250;
    v36 = uniqueIDCopy;
    selfCopy = self;
    v38 = flowCopy;
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v48 = 2112;
    v49 = uuid;
    _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reader key is missing on accessory: %@", buf, 0x20u);
  ...
  v42[0] = MEMORY[0x277D85DD0];
  v42[1] = 3221225472;
  v42[2] = __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_364;
  v42[3] = &unk_278683208;
  v43 = uuid;
  v25 = uuid;
  v33 = [allValues2 na_map:v42];
  v24 = [v32 setWithArray:v33];
...
- (id)fetchMissingWalletKeysForUserUUID:(id)d flow:(id)flow
{
  ...
  v47[1] = 3221225472;
  v47[2] = __75__HMDHomeWalletKeyAccessoryManager_fetchMissingWalletKeysForUserUUID_flow___block_invoke;
  v47[3] = &unk_2786830C8;
  v16 = v14;
  v48 = v16;
  v17 = [accessoriesWithWalletKeySupport na_filter:v47];
  ...
  else
  {
    v44[0] = MEMORY[0x277D85DD0];
    v44[1] = 3221225472;
    v44[2] = __75__HMDHomeWalletKeyAccessoryManager_fetchMissingWalletKeysForUserUUID_flow___block_invoke_341;
    v44[3] = &unk_2786830F0;
    v44[4] = selfCopy;
    v45 = v16;
    v40 = home;
    ...
    v41[1] = 3221225472;
    v41[2] = __75__HMDHomeWalletKeyAccessoryManager_fetchMissingWalletKeysForUserUUID_flow___block_invoke_4;
    v41[3] = &unk_278689A18;
    v41[4] = selfCopy;
    v37 = v29;
    dCopy = v28;
    ...
    v42 = v37;
    v43 = dCopy;
    v26 = [v36 addCompletionBlock:v41];
...
- (id)restoreMissingWalletKeys:(id)keys onAccessory:(id)accessory flow:(id)flow
{
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    v42[0] = MEMORY[0x277D85DD0];
    v42[1] = 3221225472;
    v42[2] = __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke;
    v42[3] = &unk_27868A1D8;
    v29 = v17;
    v43 = v29;
    v30 = keysCopy;
    v44 = v30;
    v31 = [v27 addFailureBlock:v42];
    v36[0] = MEMORY[0x277D85DD0];
    v36[1] = 3221225472;
...
id __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to find HMDUser with UUID: %@", &v14, 0x20u);
    }
...
void __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if ([v3 count])
  {
    ...
    v12[1] = 3221225472;
    v12[2] = __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_2_337;
    v12[3] = &unk_278683028;
    v13 = *(a1 + 64);
    v5 = [v4 na_map:v12];
    v6 = [v5 asSet];
...
- (void)handleRestoreMissingWalletKeysMessage:(id)message
{
  ...
  if (v18)
  {
    v32[0] = MEMORY[0x277D85DD0];
    v32[1] = 3221225472;
    v32[2] = __74__HMDHomeWalletKeyAccessoryManager_handleRestoreMissingWalletKeysMessage___block_invoke_319;
    v32[3] = &unk_278682F20;
    v32[4] = selfCopy;
    ...
    v30[3] = &unk_278682F48;
    v31 = messageCopy;
    v21 = [combineAllFutures addSuccessBlock:v30];
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = v29 = internalOnlyInitializer;
...
- (void)handleWalletKeyRemoved
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling wallet key removed", &v10, 0xCu);
  }
...
- (void)fetchWalletKeyColorWithFlow:(id)flow completion:(id)completion
{
  ...
  else
  {
    ...
    else
    {
      ...
      v50[0] = MEMORY[0x277D85DD0];
      v50[1] = 3221225472;
      v50[2] = __75__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorWithFlow_completion___block_invoke_306;
      v50[3] = &unk_278685AF8;
      v50[4] = v34;
      v51 = completionCopy;
...
- (void)configureWithHome:(id)home
{
  ...
  if (isResidentCapable)
  {
    ...
    v48[1] = v14;
    v48[2] = v13;
    v15 = [MEMORY[0x277CBEA60] arrayWithObjects:v48 count:3];
    ...
    v46[0] = v12;
    v46[1] = v13;
    v20 = [MEMORY[0x277CBEA60] arrayWithObjects:v46 count:2];
...
void __47__HMDHomeWalletKeyAccessoryManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v266;
  logCategory__hmf_once_v266 = v0;
}
