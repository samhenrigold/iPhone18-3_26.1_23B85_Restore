...
- (NSString)description
{
  ...
  v11 = v7;
  NSAppendPrintF(&v11, " flags: %#{flags}\n", [(CUWiFiDevice *)self->_cuWiFiDevice deviceIEFlags], &unk_22A5879E0);
  v8 = v11;
  v9 = v11;
...
- (void)startConfigurationWithCompletionHandler:(id)handler
{
  ...
  else
  {
    ...
    *(&buf + 1) = &buf;
    v21 = 0x3032000000;
    v22 = __Block_byref_object_copy__139507;
    v23 = __Block_byref_object_dispose__139508;
    v24 = 0;
    objc_initWeak(&location, self);
...
void __37__HMDCUWiFiDeviceWrapper_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v19_139544;
  logCategory__hmf_once_v19_139544 = v0;
}
