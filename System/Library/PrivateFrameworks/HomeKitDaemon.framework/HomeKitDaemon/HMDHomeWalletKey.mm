...
- (id)xpcWalletKeyWithExpressEnabled:(BOOL)enabled uwbEnabled:(BOOL)uwbEnabled clientWalletKeyUUID:(id)d;
- (unint64_t)hash;
@end
  ...
  if (customURL)
  {
    ...
    if (dCopy)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        uuid2 = [(HMDHomeWalletKey *)selfCopy uuid];
        v22 = 138543874;
        v23 = v16;
        v24 = 2112;
        v25 = v12;
        v26 = 2112;
        v27 = uuid2;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Client Wallet Key UUID set in local store, using it: %@ instead of %@", &v22, 0x20u);
      }
    ...
    v19 = objc_alloc(MEMORY[0x277CD1AB8]);
    customURL2 = [(HMDHomeWalletKey *)self customURL];
    v18 = [v19 initWithUUID:v12 customURL:customURL2 expressEnabled:enabledCopy uwbUnlockEnabled:uwbEnabledCopy color:{-[HMDHomeWalletKey color](self, "color")}];
  }
