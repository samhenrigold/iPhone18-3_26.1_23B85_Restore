...
- (id)attributeDescriptions
{
  ...
  if (v5)
  {
    ...
    keyValueStore2 = [(HMDCHIPControllerFabricStorage *)self keyValueStore];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [[HMDCHIPControllerFabricStorage allocWithZone:?]];
  keyValueStore = [(HMDCHIPControllerFabricStorage *)self keyValueStore];
  [(HMDCHIPControllerFabricStorage *)v4 setKeyValueStore:keyValueStore];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_280037 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t3_280037, &__block_literal_global_280038);
  }

  v3 = logCategory__hmf_once_v4_280039;
