...
- (id)rcacFromFabricData:(id)data
{
  ...
  if (rootCert2)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Corrupt fabricData rootCert %@", &v24, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = dataCopy;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@fabricData didn't contain rootCert to extract RCAC from: %@", &v24, 0x16u);
    }
...
- (NSArray)fabricDataItems
{
  ...
  v18 = 0;
  v5 = [systemKeychainStore allKeychainItemsForType:&unk_283E72470 identifier:0 syncable:v4 error:&v18];
  v6 = v18;
...
void __44__HMDCHIPHomeKeychainFabricData_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v20_75714;
  logCategory__hmf_once_v20_75714 = v0;
}
