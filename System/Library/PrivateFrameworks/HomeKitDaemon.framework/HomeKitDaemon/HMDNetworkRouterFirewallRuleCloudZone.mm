...
LABEL_32:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
        {
          ...
          *v86 = 138543618;
          ...
          v88 = 2048;
          v89 = 32;
          _os_log_impl(&dword_229538000, v69, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", v86, 0x16u);
        }
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *v86 = 138543874;
      ...
      v90 = 2112;
      v91 = v66;
      _os_log_impl(&dword_229538000, v63, OS_LOG_TYPE_ERROR, "%{public}@Error reading data from record %@: %@", v86, 0x20u);
...
LABEL_45:
  ...
  if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
  {
    ...
    *v86 = 138543874;
    ...
    v90 = 2112;
    v91 = hmbDescription2;
    _os_log_impl(&dword_229538000, v55, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on record %@", v86, 0x20u);
...
- (BOOL)__canRecoverFromError:(id)error fetchInfo:(id)info
{
  ...
  if ([errorCopy hmbIsCKPartialFailureError])
  {
    ...
    *&buf[8] = buf;
    *&buf[16] = 0x3032000000;
    v34 = __Block_byref_object_copy__213133;
    v35 = __Block_byref_object_dispose__213134;
    v36 = 0;
  ...
  switch(code)
  {
    case 21:
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = errorCopy;
        _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Change token has expired: %@", buf, 0x16u);
      }
    ...
    case 28:
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = errorCopy;
        _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Zone was deleted: %@", buf, 0x16u);
      }
    ...
    case 26:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = errorCopy;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Zone does not exist: %@", buf, 0x16u);
      }
...
LABEL_25:
  ...
  if ([infoCopy shouldRetry])
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *&buf[12] = 2112;
      *&buf[14] = errorCopy;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Ignoring non-fatal error: %@", buf, 0x16u);
    }
  ...
  if (!errorCopy)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543874;
      ...
      v33 = 2112;
      v34 = v28;
      _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Zone fetch completed successfully, token: %@, moreComing: %@", buf, 0x20u);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138544130;
    ...
    v35 = 2112;
    v36 = v22;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Zone fetch completed unsuccessfully, token: %@, error: %@, moreComing: %@", buf, 0x2Au);
  }
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543618;
        ...
        v18 = 2112;
        v19 = v11;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneFetchCompletionBlock called with unknown zone: %@", buf, 0x16u);
      }
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543618;
        ...
        v18 = 2112;
        v19 = v11;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneChangeTokensUpdatedBlock called with unknown zone: %@", buf, 0x16u);
      }
...
- (HMDNetworkRouterFirewallRuleCloudZone)initWithCloudDatabase:(id)database state:(id)state useAnonymousRequests:(BOOL)requests watchedRecordIDs:(id)ds signatureVerificationPublicKeys:(id)keys
{
  ...
  if (![keysCopy count])
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v28 = v24;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have verification keys", buf, 0xCu);
    }
