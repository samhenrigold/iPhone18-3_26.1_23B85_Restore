...
- (unint64_t)supportedOptionsInMessage:(id)message error:(id *)error
{
  ...
  if (messagePayload)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v23 = 2112;
        v24 = v8;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to get supported options from message payload: %@", &v21, 0x16u);
      }
  ...
  else if (error)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = messageCopy;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", &v21, 0x16u);
    }
...
LABEL_16:
    ...
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, v16, &v22, 0x16u);
  ...
  if (error)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = messageCopy;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", &v22, 0x16u);
    }
...
- (void)handleUpdatedDestination:(id)destination
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = destinationCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling updated destination: %@", &v10, 0x16u);
  }
...
void __82__HMDMediaDestinationMessageHandler_sendRequestToUpdateSupportOptions_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Update destination supported options request message responded with error: %@", &v12, 0x16u);
    }
...
void __88__HMDMediaDestinationMessageHandler_sendRequestToUpdateAudioGroupIdentifier_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Update audio group identifier request message responded with error: %@", &v12, 0x16u);
    }
...
void __48__HMDMediaDestinationMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v21_189803;
  logCategory__hmf_once_v21_189803 = v0;
}
