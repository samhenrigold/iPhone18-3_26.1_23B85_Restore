...
+ (id)properties
{
  if (properties_onceToken_65533 != -1)
  {
    dispatch_once(&properties_onceToken_65533, &__block_literal_global_65534);
  }

  v3 = properties__properties_65535;
...
void __48__HMDAccessorySettingConstraintModel_properties__block_invoke()
{
  ...
  v3 = properties__properties_65535;
  properties__properties_65535 = v2;
}
