...
void __60__HMDCameraSnapshotFileManager_backboardServicesRelaunched___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Recreating slot for most recent snapshot file after backboard services relaunch", &v12, 0xCu);
  }
...
- (id)encodedMostRecentSnapshotForMessage:(id)message
{
  ...
  if (!slotIdentifier)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 2112;
      v35 = v9;
      _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_INFO, "%{public}@Not encoding invalid most recent snapshot for message %@: %@", &v30, 0x20u);
    }
...
LABEL_14:
  ...
  if (processInfo)
  {
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 2112;
      v35 = v9;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Associating process info %@ with most recent snapshot file: %@", &v30, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v32 = 2112;
      v33 = messageCopy;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot encode most recent snapshot for message without process info: %@", &v30, 0x16u);
    }
    ...
    if (v16)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          if (self)
          {
            v22 = *(&selfCopy->super.super.isa + v13[244]);
          }
...
LABEL_22:
          ...
          if (([v44 isEqualToString:hmd_snapshotFileName] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
            {
              ...
              *v88 = 138543618;
              ...
              v90 = 2112;
              v91 = v46;
              _os_log_impl(&dword_229538000, v49, OS_LOG_TYPE_INFO, "%{public}@Removing obsolete snapshot at path: %@", v88, 0x16u);
    ...
    if (v56)
    {
      if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
      {
        ...
        *v88 = 138543618;
        ...
        v90 = 2112;
        v91 = v56;
        _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_INFO, "%{public}@Found and created the most recent snapshot file: %@", v88, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
      {
        ...
        *v88 = 138543874;
        ...
        v92 = 2112;
        v93 = v57;
        _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_ERROR, "%{public}@Failed to create most recent snapshot file with path %@: %@", v88, 0x20u);
      }
  ...
  if (v56)
  {
    ...
    if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
    {
      ...
      *v98 = 138543618;
      ...
      v100 = 2112;
      v101 = v71;
      _os_log_impl(&dword_229538000, v68, OS_LOG_TYPE_INFO, "%{public}@Created the most recent snapshot %@", v98, 0x16u);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
    {
      ...
      *v98 = 138543362;
      v99 = v73;
      _os_log_impl(&dword_229538000, v68, OS_LOG_TYPE_INFO, "%{public}@No recent snapshot found", v98, 0xCu);
    }
  }
...
void __43__HMDCameraSnapshotFileManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v31_246122;
  logCategory__hmf_once_v31_246122 = v0;
}
