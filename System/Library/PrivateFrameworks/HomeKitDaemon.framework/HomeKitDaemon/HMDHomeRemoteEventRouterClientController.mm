...
- (void)delegatingRouter:(id)router fetchCachedEventsForTopics:(id)topics forRouter:(id)forRouter cachedEventCollection:(id)collection
{
  ...
  if ([(HMDHomeRemoteEventRouterClientController *)self isCurrentDevicePrimaryResident])
  {
    ...
    if (v14)
    {
      ...
      {
        v29 = [topicsCopy na_filter:&__block_literal_global_87_112208];
...
void __120__HMDHomeRemoteEventRouterClientController_delegatingRouter_fetchCachedEventsForTopics_forRouter_cachedEventCollection___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v14;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch events from router: %@", &v17, 0x16u);
    }
...
LABEL_19:
  ...
  {
    v16 = v26;
    v23 = [HMDAccessoryEventsGenerated topicsRemovingAccessoryTopics:topicsCopy accessoryUUID:objc_getProperty(self, v27, 104, 1)];
LABEL_24:
  }
...
LABEL_5:
  ...
  v5 = objc_getProperty(self, v4, 88, 1) == clientCopy;
  v6 = clientCopy;
  if (v5)
  {
    WeakRetained = objc_loadWeakRetained(&self->_dataSource);
...
- (id)routerClientMessageDestination:(id)destination serverIdentifier:(id *)identifier
{
  ...
  if (self)
  {
    ...
    if (objc_getProperty(self, v11, 88, 1) != destinationCopy)
    {
...
void __72__HMDHomeRemoteEventRouterClientController_fetchWithFilters_completion___block_invoke(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    if ([v1 isCurrentDevicePrimaryResident])
    {
      ...
      v36[1] = v36;
      v36[2] = 0x3032000000;
      v36[3] = __Block_byref_object_copy__112221;
      v36[4] = __Block_byref_object_dispose__112222;
      v37 = 0;
      v32 = 0u;
      v33 = 0u;
      v34 = 0u;
...
void __73__HMDHomeRemoteEventRouterClientController__fetchWithFilters_completion___block_invoke_3(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v18;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch events from router: %@", &v19, 0x16u);
    }
...
unsigned __int8 *__73__HMDHomeRemoteEventRouterClientController_networkAvailabilityDidChange___block_invoke(unsigned __int8 *result, const char *a2)
{
  ...
  {
    v3 = result[40];
    Property = objc_getProperty(*(result + 4), a2, 24, 1);
    dispatch_assert_queue_V2(Property);
    v14 = 0u;
    v15 = 0u;
    v12 = 0u;
      ...
      if ([WeakRetained isMessagedHomepodSettingsEnabledForClientController:v1] && objc_msgSend(v6, "isCurrentDeviceResidentCapableForRemoteEventRouterClientController:", v1))
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *v33 = 138543874;
          ...
          v37 = 2112;
          v38 = v3;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_INFO, "%{public}@Removing %@ client resident event router(s) for accessory: %@", v33, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v41 = 2112;
        v42 = v3;
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident router for accessory: %@ due to nil datasource", buf, 0x16u);
      }
  ...
  if (v1)
  {
    ...
    if (WeakRetained)
    {
      if ([WeakRetained isMessagedHomepodSettingsEnabledForClientController:v1] && objc_msgSend(v6, "isCurrentDeviceResidentCapableForRemoteEventRouterClientController:", v1))
      {
        ...
        v51 = v15;
        v28 = [v18 residentClientWithAccessoryUUID:v3 homeUUID:v20 queue:v22 dataSource:v1 messageDispatcher:v53 notificationCenter:v52 requestMessageName:v24 updateMessageName:v26 multiHopFetchResponseMessageName:objc_getProperty(v1 storeReadHandle:v27 storeWriteHandle:{56, 1), v15, v16}];

        v29 = [v1 isCurrentDevicePrimaryResident];
        v30 = [v1 isNetworkAvailable];
        v64 = objc_getProperty(v1, v31, 72, 1);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *v65 = 138543618;
        ...
        v67 = 2112;
        v68 = v3;
        _os_log_impl(&dword_229538000, v45, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident router for accessory: %@ due to nil datasource", v65, 0x16u);
      }
  ...
  if (!v6)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v20 = 2112;
        v21 = v15;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Mark network as available on transport start %@", &v18, 0x16u);
      }
...
- (HMDHomeRemoteEventRouterClientController)initWithMessageTargetUUID:(id)d workQueue:(id)queue dataSource:(id)source routerClientFactory:(id)factory requestMessageName:(id)name updateMessageName:(id)messageName multiHopFetchResponseMessageName:(id)responseMessageName clientUserMessagePolicy:(id)self0 currentAccessoryUUID:(id)self1 assertionController:(id)self2 remoteTransportStartFuture:(id)self3 delegatingRouterFactory:(id)self4
{
  ...
  if (v23)
  {
    ...
    v63[0] = objc_getProperty(v24, v36, 72, 1);
    v37 = sourceCopy;
