...
- (void)_postWACMatchingAccessoryFound:(id)found
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v22 = 2112;
    v23 = foundCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Post-WAC matching accessory found: %@", &v20, 0x16u);
  }
  ...
  if (state == 4)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      v20 = 138543362;
      v21 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Post-WAC accessory found, but WAC hasn't completed.  Holding on to accessory until completion", &v20, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2048;
      v23 = v19;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid state (%ld) for postWACMatchingAccessoryFound call", &v20, 0x16u);
    }
...
- (void)_postWACMatchTimeout
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_ERROR, "%{public}@Timeout waiting to find device post-WAC", &v10, 0xCu);
  }
...
- (void)_waitForPostWACMatch
{
  ...
  if (self->_postWACAccessory)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v6;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Post WAC accessory already located, handoff", &v18, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting Post-WAC match timeout for %@ seconds", &v18, 0x16u);
    }
...
- (void)_configureDeviceCompleted:(id)completed
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = completedCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@WAC completed with %@", &v19, 0x16u);
  }
  ...
  if (delegate)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = completedCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@WAC Failed with %@, device should still be WAC-able", &v19, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@No delegate assigned, cannot continue WAC association", &v19, 0xCu);
    }
...
- (void)_userPermissionResponse:(BOOL)response
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Permission to share network: %@", &v16, 0x16u);
  }
  ...
  if (responseCopy)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@User permission denied, return to ready state", &v16, 0xCu);
    }
...
void __71__HMDUnassociatedWACAccessory_startConfigurationWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      v15 = 138543362;
      v16 = v7;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@WAC association already in progress", &v15, 0xCu);
    }
  ...
  else
  {
    if (v6)
    {
      ...
      v17 = 2112;
      v18 = v11;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Kicking off WAC association for %@", &v15, 0x16u);
    }
