...
- (void)createMissingResidentDevicesFromMeshNodes:(void *)nodes;
...
- (id)dumpState
{
  ...
  v7 = &v6;
  v8 = 0x3032000000;
  v9 = __Block_byref_object_copy__261344;
  v10 = __Block_byref_object_dispose__261345;
  v11 = 0;
  queue = self->_queue;
...
- (void)timerDidFire:(id)fire
{
  ...
  if (debounceTimer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *&buf[12] = 2114;
      *&buf[14] = v34;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Debounce expired, current state = %{public}@", buf, 0x16u);
    }
...
LABEL_83:
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *&buf[12] = 2114;
        *&buf[14] = v80;
        _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_INFO, "%{public}@Primary resident election or mesh change cannot be kicked off while in the state %{public}@", buf, 0x16u);
...
LABEL_52:
        _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_INFO, v40, buf, 0xCu);
LABEL_73:
      }
    }
...
LABEL_74:
  ...
  if (pingTimer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *&buf[12] = 2114;
      *&buf[14] = v49;
      _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_INFO, "%{public}@Ping timer fired, current state = %{public}@", buf, 0x16u);
    }
    ...
    if ([(HMDPrimaryElectionCoordinationAddOn *)selfCopy2 state]== 2 || [(HMDPrimaryElectionCoordinationAddOn *)selfCopy2 state]== 4)
    {
      if (![(HMDLocalElectionMeshController *)selfCopy2->_meshController isLeader])
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          *&buf[4] = v63;
          _os_log_impl(&dword_229538000, v62, OS_LOG_TYPE_INFO, "%{public}@Ping timer expired and we haven't heard from the leader. Sending a ping command to the leader", buf, 0xCu);
        }
...
LABEL_104:
      ...
      if (primaryResidentDevice2)
      {
        ...
        if (!v93)
        {
          ...
          if (v100)
          {
            if (os_log_type_enabled(v103, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543362;
              *&buf[4] = v105;
              _os_log_impl(&dword_229538000, v104, OS_LOG_TYPE_INFO, "%{public}@We are the leader. Sending periodic ping request to the primary resident", buf, 0xCu);
            }
          ...
          else
          {
            if (os_log_type_enabled(v103, OS_LOG_TYPE_ERROR))
            {
              ...
              *&buf[14] = shortDescription2;
              _os_log_impl(&dword_229538000, v104, OS_LOG_TYPE_ERROR, "%{public}@Not sending the ping request. Unable to find the mesh node for primary resident %{public}@", buf, 0x16u);
            }
        ...
        if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          *&buf[4] = v97;
          _os_log_impl(&dword_229538000, v96, OS_LOG_TYPE_INFO, "%{public}@Not sending the ping request. We are the primary resident.", buf, 0xCu);
        }
      ...
      else
      {
        if (v56)
        {
          ...
          *buf = 138543362;
          *&buf[4] = v78;
          _os_log_impl(&dword_229538000, v55, OS_LOG_TYPE_INFO, "%{public}@Not sending the periodic ping request to the primary and notification to the followers. Primary resident is nil.", buf, 0xCu);
        }
...
LABEL_103:
  ...
  if (secondaryMeshTimer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *&buf[12] = 2114;
      *&buf[14] = v68;
      _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_INFO, "%{public}@Secondary mesh timer fired, current state = %{public}@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (meshLeaderToPrimaryResidentPingResponseTimer5 == fireCopy)
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *&buf[12] = 2114;
        *&buf[14] = v77;
        _os_log_impl(&dword_229538000, v45, OS_LOG_TYPE_ERROR, "%{public}@Timer fired and the primary resident did not respond to ping request from the leader, current state = %{public}@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (activeNodesUpdateDebounceTimer == fireCopy)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *&buf[12] = 2114;
          *&buf[14] = v81;
          _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Active nodes update timer fired, current state = %{public}@", buf, 0x16u);
        }
        ...
        [(HMDPrimaryElectionCoordinationAddOn *)selfCopy5 createMissingResidentDevicesFromMeshNodes:?];
        ...
        if (os_log_type_enabled(v85, OS_LOG_TYPE_DEBUG))
        {
          ...
          *&buf[14] = firstPrimaryResidentDiscoveryAttemptCompletionFuture;
          _os_log_impl(&dword_229538000, v85, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate of active mesh nodes: %{public}@", buf, 0x16u);
        }
...
- (void)createMissingResidentDevicesFromMeshNodes:(void *)nodes
{
  if (nodes)
  {
    ...
    if (dataSource)
    {
      idsAccountDevices = [dataSource idsAccountDevices];
    }
    ...
    v16 = v11;
    v25 = v16;
    [meshNodes hmf_enumerateWithAutoreleasePoolUsingBlock:v20];

    delegate = [nodes delegate];
    if (objc_opt_respondsToSelector())
    {
      ...
      v18[4] = nodes;
      v19 = delegate;
      [v16 hmf_enumerateWithAutoreleasePoolUsingBlock:v18];
    }
  }
}
...
void __81__HMDPrimaryElectionCoordinationAddOn_createMissingResidentDevicesFromMeshNodes___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v4)
  {
    ...
    if (v7)
    {
      ...
      v9 = [*(a1 + 56) home];
      v4 = [(HMDResidentDevice *)v8 initWithDevice:v7 home:v9];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v30 = 18;
LABEL_24:
          _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, v28, buf, v30);
        }
      }

      objc_autoreleasePoolPop(v17);
      [v18 setState:4];
      [(HMDPrimaryElectionCoordinationAddOn *)v18 _startSecondaryMeshTimer];
      goto LABEL_26;
    }
    ...
    objc_autoreleasePoolPop(v22);
    [v23 setState:2];
    [(HMDPrimaryElectionCoordinationAddOn *)v23 _doMetaMeshElection];
  }
...
LABEL_33:
        ...
        v23 = [v3 na_any:&__block_literal_global_261433];
          ...
          if (v24)
          {
            if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              v33 = 18;
LABEL_30:
              _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_INFO, v31, buf, v33);
            }
...
LABEL_31:
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *buf = 138543618;
            ...
            v40 = 18;
LABEL_37:
            _os_log_impl(&dword_229538000, v39, OS_LOG_TYPE_DEFAULT, v38, buf, v40);
...
- (__HMDPrimaryElectionCandidate)candidateRepresentation
{
  if (self)
  {
    ...
    else
    {
      ...
      connectionType = MEMORY[0x22AAD4080](v14, 3);
    }
...
{
  v2 = [*(a1 + 32) na_filter:&__block_literal_global_96_261468];
  (*(*(a1 + 40) + 16))();
}
...
- (id)_consensusPrimaryFromResidentCandidates:(uint64_t)candidates
{
  if (candidates)
  {
    ...
    v3 = [a2 na_map:&__block_literal_global_84_261615];
...
- (void)meshControllerDidUpdatesNodes:(id)nodes
{
  ...
  objc_autoreleasePoolPop(v5);
  [(HMDPrimaryElectionCoordinationAddOn *)selfCopy createMissingResidentDevicesFromMeshNodes:?];
...
- (void)meshController:(id)controller didReceivePingFromLeaderWithPrimaryResidentUUID:(id)d
{
  ...
  if (dCopy)
  {
    ...
    objc_autoreleasePoolPop(v9);
    delegate = [(HMDPrimaryElectionCoordinationAddOn *)selfCopy delegate];
    [delegate primaryElectionAddOn:selfCopy didReceivePrimaryResidentUUIDFromLeader:dCopy];
  }
...
- (id)residentsInMesh
{
  [(HMDPrimaryElectionCoordinationAddOn *)self createMissingResidentDevicesFromMeshNodes:?];

  return [(HMDPrimaryElectionCoordinationAddOn *)self _meshNodesToResidentDevices];
}
...
- (BOOL)allowExternalUpdateOfPrimaryResidentTo:(id)to
{
  ...
  context = [(HMDPrimaryElectionCoordinationAddOn *)self context];
  primaryResidentDevice = [context primaryResidentDevice];
  v7 = [toCopy isEqual:primaryResidentDevice];
  ...
  {
    v9 = [(HMDPrimaryElectionCoordinationAddOn *)self residentIsPartOfTheCurrentMesh:toCopy];
    v8 = 1;
...
- (void)start
{
  ...
  home = [context home];
  uuid = [home uuid];
  v7 = [v3 stringWithFormat:@"%@.%@", @"com.apple.HomeKit.HH2", uuid];
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t125, &__block_literal_global_105_261701);
  }

  v3 = logCategory__hmf_once_v126;
