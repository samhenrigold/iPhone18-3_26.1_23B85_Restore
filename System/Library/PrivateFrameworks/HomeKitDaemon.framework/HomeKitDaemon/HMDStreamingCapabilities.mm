...
void __53__HMDStreamingCapabilities_initWithStreamPreference___block_invoke()
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v0;
    _os_log_impl(&dword_229538000, v2, OS_LOG_TYPE_INFO, "%{public}@Audio streaming capabilities as reported by AVCAudioStream: %@", &v9, 0x16u);
  }
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Video streaming capabilities as reported by AVCVideoStream: %@", &v9, 0x16u);
  }
...
+ (unint64_t)aspectRatioOfResolution:(id)resolution
{
  ...
  if ((resolutionType - 1) >= 0x1D)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Resolution: %@ is not handled, returning default aspect ratio: %@", &v12, 0x20u);
    }
