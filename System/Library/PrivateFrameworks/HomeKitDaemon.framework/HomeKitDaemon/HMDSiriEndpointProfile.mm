...
LABEL_5:
    ...
    if (clientSettingsIdentifier && [_allSettingsCharacteristicsToMonitor count])
    {
      ...
      if (v12)
      {
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@[Profile Notifications] %@ notifications for characteristics for %@: %@", &v29, 0x2Au);
        }
      ...
      else
      {
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          v29 = 138543362;
          v30 = v28;
          _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] accessory not part of profile", &v29, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v9;
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] nothing to %@ because characteristic.count (%ld) or client identifier %@", &v29, 0x2Au);
      }
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    v31 = 2048;
    optionsCopy = options;
    _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] options is not valid: %ld", &v29, 0x16u);
  }
...
void __51__HMDSiriEndpointProfile_setNotifications_options___block_invoke(uint64_t a1)
{
  ...
  else if ((v2 & 2) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2048;
      v13 = v7;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_ERROR, "%{public}@[Notifications] options is not valid: %ld", &v10, 0x16u);
    }
...
- (void)_handleRefreshProfileState:(id)state
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handle refresh profile state", &v9, 0xCu);
  }
...
void __69__HMDSiriEndpointProfile_notifyClientsDidUpdateStagedNeedsOnboarding__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated needsOnboarding: %@", &v14, 0x16u);
  }
...
- (void)stagedValue:(id)value didExpireValue:(id)expireValue
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = expireValueCopy;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unknown stage value: %@ did expire value: %@", &v14, 0x20u);
    }
...
- (void)handleEnableNotifications:(id)notifications
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] parameters not specific", &v13, 0xCu);
    }
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          v28 = 2112;
          v29 = userInfo2;
          _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling %@/%@", &v24, 0x20u);
        }
...
void __58__HMDSiriEndpointProfile_handleDeviceCapabilitiesUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 2112;
    v32 = v14;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling updated resident capabilities: %@ notification: %@", &v27, 0x20u);
  }
    ...
    if (v21 == v4 && ([v9 containsObject:@"supportsSiriEndpointSetup"] & 1) != 0)
    {
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 2112;
          v30 = v20;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_INFO, "%{public}@Current device was updated to support Siri Endpoint Settings (%@)", &v27, 0x16u);
        }
...
uint64_t __52__HMDSiriEndpointProfile_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@", &v11, 0x16u);
  }
...
- (void)stageNeedsOnboarding:(int64_t)onboarding withTimeout:(double)timeout
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2048;
    onboardingCopy = onboarding;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Staging needsOnboarding: %ld", &v13, 0x16u);
  }
...
- (void)registerForMessages
{
  ...
  home = [accessory home];
  v13.receiver = self;
  v13.super_class = HMDSiriEndpointProfile;
  ...
  v12[1] = 3221225472;
  v12[2] = __45__HMDSiriEndpointProfile_registerForMessages__block_invoke;
  v12[3] = &unk_27868A728;
  v12[4] = self;
...
void __45__HMDSiriEndpointProfile_registerForMessages__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for characteristic notifications since current device supports home hub", &v9, 0xCu);
    }
