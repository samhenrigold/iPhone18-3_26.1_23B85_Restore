      ...
      if (v17)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *&v38[3] = identifierCopy;
          _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid uploadType: %u received in JSON for accessory: %@", buf, 0x1Cu);
        }
...
LABEL_17:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v37 = 2112;
    *v38 = identifierCopy;
    _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Version configuration must contain firmware version: %@", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_184081 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_184081, &__block_literal_global_184082);
  }

  v3 = logCategory__hmf_once_v1_184083;
...
void __48__HMDCloudPairedMetadataDiagnostics_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_184083;
  logCategory__hmf_once_v1_184083 = v0;
}
