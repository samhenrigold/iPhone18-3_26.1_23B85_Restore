...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_134588 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t18_134588, &__block_literal_global_18);
  }

  v3 = logCategory__hmf_once_v19_134589;
...
+ (HMDBackgroundTaskManager)sharedManager
{
  ...
  {
    dispatch_once(&sharedManager__hmf_once_t0, &__block_literal_global_134593);
  }
