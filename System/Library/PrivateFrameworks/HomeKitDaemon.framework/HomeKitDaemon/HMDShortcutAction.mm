    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v23 = 2112;
        v24 = v14;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to process model update with error: %@", buf, 0x16u);
      }
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v26 = 2112;
      v27 = v18;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] %@ requires device to be unlock", buf, 0x20u);
    }
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Does this shortcut action contain any unsecuring actions: [%@]", buf, 0x16u);
    }
...
- (uint64_t)doesAnyCharacteristicWriteTuplePassTest:(void *)test orDoesAnyActionSetPassTest:
{
  ...
  if (self && WorkflowKitLibraryCore(0))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v30 = v10;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Shortcuts framework is available on this OS", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v26 = 32;
LABEL_13:
        _os_log_impl(&dword_229538000, v24, v25, v23, buf, v26);
      }
    }
  ...
  if (self)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v31 = 2112;
      v32 = v15;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Found actionSets from shortcut dictionary : %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v31 = 2112;
      v32 = v16;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Found characteristics from shortcut dictionary : %@", buf, 0x16u);
    }
      ...
      if (v14)
      {
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v157, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            *&buf[4] = v158;
            _os_log_impl(&dword_229538000, v157, OS_LOG_TYPE_ERROR, "%{public}@Did not find any serialized homekit data in this shortcut dictionary", buf, 0xCu);
          }
        ...
        if (!v16)
        {
          ...
          if (os_log_type_enabled(v161, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            *&buf[4] = v162;
            _os_log_impl(&dword_229538000, v161, OS_LOG_TYPE_ERROR, "%{public}@Could not initialize PB actionSet data", buf, 0xCu);
          }
                      ...
                      if ([characteristicReference hasServiceReference])
                      {
                        ...
                        if (!v36)
                        {
                          ...
                          if (os_log_type_enabled(v75, OS_LOG_TYPE_ERROR))
                          {
                            ...
                            *buf = 138543362;
                            *&buf[4] = v76;
                            _os_log_impl(&dword_229538000, v75, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode characteristic uniqueIdentifier", buf, 0xCu);
                          }
                                        ...
                                        if (v54)
                                        {
                                          ...
                                          if (!v57)
                                          {
                                            ...
                                            if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
                                            {
                                              ...
                                              *buf = 138543362;
                                              *&buf[4] = v61;
                                              _os_log_impl(&dword_229538000, v60, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode service uniqueIdentifier", buf, 0xCu);
                                            }
...
LABEL_95:
                                            ...
                                            if (os_log_type_enabled(v124, OS_LOG_TYPE_INFO))
                                            {
                                              ...
                                              *v224 = 138543618;
                                              ...
                                              v226 = 2112;
                                              v227 = v36;
                                              _os_log_impl(&dword_229538000, v124, OS_LOG_TYPE_INFO, "%{public}@Unable to find the characteristic with uniqueIdentifier: %@", v224, 0x16u);
...
LABEL_96:
                                            ...
                                            if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
                                            {
                                              ...
                                              *v228 = 138543618;
                                              ...
                                              v230 = 2112;
                                              v231 = context;
                                              _os_log_impl(&dword_229538000, v120, OS_LOG_TYPE_INFO, "%{public}@Unable to find the service with uniqueIdentifier : %@", v228, 0x16u);
                                        ...
                                        else
                                        {
                                          ...
                                          if (os_log_type_enabled(v107, OS_LOG_TYPE_ERROR))
                                          {
                                            ...
                                            *&buf[12] = 2112;
                                            *&buf[14] = v196;
                                            _os_log_impl(&dword_229538000, v107, OS_LOG_TYPE_ERROR, "%{public}@Can't find accessory %@", buf, 0x16u);
                                          }
                                    ...
                                    else
                                    {
                                      ...
                                      if (os_log_type_enabled(v103, OS_LOG_TYPE_ERROR))
                                      {
                                        ...
                                        *buf = 138543362;
                                        *&buf[4] = v104;
                                        _os_log_impl(&dword_229538000, v103, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode Home uniqueIdentifier", buf, 0xCu);
                                      }
                                  ...
                                  else
                                  {
                                    ...
                                    if (os_log_type_enabled(v99, OS_LOG_TYPE_ERROR))
                                    {
                                      ...
                                      *buf = 138543362;
                                      *&buf[4] = v100;
                                      _os_log_impl(&dword_229538000, v99, OS_LOG_TYPE_ERROR, "%{public}@Characteristic write action's HomeReference does not have uniqueIdentifier set", buf, 0xCu);
                                    }
                                ...
                                else
                                {
                                  ...
                                  if (os_log_type_enabled(v95, OS_LOG_TYPE_ERROR))
                                  {
                                    ...
                                    *buf = 138543362;
                                    *&buf[4] = v96;
                                    _os_log_impl(&dword_229538000, v95, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode accessory uniqueIdentifier", buf, 0xCu);
                                  }
...
LABEL_53:
                        _os_log_impl(&dword_229538000, v71, OS_LOG_TYPE_ERROR, v72, buf, 0xCu);
                      }
                    }
                    ...
                    if (v66)
                    {
                      ...
                      else
                      {
                        ...
                        if (os_log_type_enabled(v145, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *buf = 138543362;
                          *&buf[4] = v146;
                          _os_log_impl(&dword_229538000, v145, OS_LOG_TYPE_INFO, "%{public}@Did not find the target value belonging to the write action", buf, 0xCu);
                        }
...
LABEL_123:
                    ...
                    if (os_log_type_enabled(v141, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *buf = 138543362;
                      *&buf[4] = v142;
                      _os_log_impl(&dword_229538000, v141, OS_LOG_TYPE_INFO, "%{public}@Did not find the accessory/characteristic belonging to the write action", buf, 0xCu);
                    }
...
LABEL_155:
            ...
            else
            {
              ...
              if (os_log_type_enabled(v171, OS_LOG_TYPE_ERROR))
              {
                ...
                *buf = 138543362;
                *&buf[4] = v172;
                _os_log_impl(&dword_229538000, v171, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode Home UUID", buf, 0xCu);
              }
...
LABEL_147:
            _os_log_impl(&dword_229538000, v165, OS_LOG_TYPE_ERROR, v167, buf, 0xCu);
          }
        }
...
uint64_t __58__HMDShortcutAction_doesActionSetContainUnsecuringAction___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@ActionSet %@ unsecure the home : %@", &v11, 0x20u);
  }
  ...
  if (![v4 isEqual:v3])
  {
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v30 = v19;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Could not find actionSet based on actionSet.uuid. Now searching using spiClientIdentifier", buf, 0xCu);
      }
      ...
      if (!v15)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v31 = 2112;
          v32 = v21;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find actionSet [%@]", buf, 0x16u);
        }
...
LABEL_4:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v35 = 2112;
    v36 = v12;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Skipping actionSet to avoid cycle. [Checking ActionSet : %@] against [ActionSetUUID: %@] [ActionSet SPI Identifier: %@]", buf, 0x2Au);
  }
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Does this shortcut action contain any secure class accessories: [%@]", buf, 0x16u);
    }
...
uint64_t __62__HMDShortcutAction_doesActionSetContainSecureCharacteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@ActionSet %@ contain secure class accessory : %@", &v11, 0x20u);
  }
...
- (void)executeWithSource:(unint64_t)source clientName:(id)name completionHandler:(id)handler
{
  ...
  if (WorkflowKitLibraryCore(0) && self->_controller)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543618;
      ...
      v25 = 2114;
      v26 = shortcut;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Executing shortcut action : %{public}@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v24 = v18;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@The shortcut action is unavailable to execute", buf, 0xCu);
    }
...
void __68__HMDShortcutAction_executeWithSource_clientName_completionHandler___block_invoke(uint64_t a1, void *a2, int a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2114;
      v26 = v5;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to execute shortcut action %{public}@ with error: %{public}@", &v21, 0x20u);
    }
...
LABEL_9:
  ...
  if (a3)
  {
    if (v14)
    {
      ...
      v23 = 2112;
      v24 = v16;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@shortcut action execution was cancelled : %@", &v21, 0x16u);
    }
  ...
  if (v14)
  {
    ...
    v23 = 2112;
    v24 = v20;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Shortcut action successfully executed : %@", &v21, 0x16u);
  }
...
+ (id)actionWithDictionaryRepresentation:(id)representation home:(id)home actionSet:(id)set
{
  ...
  if ([v11 unsignedIntegerValue] == 2)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized shortcut: %@", &v25, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v11;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", &v25, 0x16u);
    }
