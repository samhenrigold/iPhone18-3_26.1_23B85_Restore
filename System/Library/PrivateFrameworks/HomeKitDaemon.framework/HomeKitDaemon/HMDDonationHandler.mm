...
void __50__HMDDonationHandler__donateIntent_withActionSet___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v3;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to donate home intent of Action Set %@ in Home %@ with error - %@", &v17, 0x2Au);
    }
  }
  ...
  else if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v16;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Successfully donate home intent(s) of Action Set %@ in Home %@ to Siri Actions - intent: %@", &v17, 0x2Au);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
    {
      ...
      *&buf[4] = v52;
      ...
      v63 = 2112;
      v64 = name5;
      _os_log_impl(&dword_229538000, v51, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the intent of Action Set %@ in Home %@", buf, 0x20u);
    }
...
void __33__HMDDonationHandler_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v10_221220;
  logCategory__hmf_once_v10_221220 = v0;
}
