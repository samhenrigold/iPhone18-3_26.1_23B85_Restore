...
void __34__HMDNFCEventListener_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v8_175534;
  logCategory__hmf_once_v8_175534 = v0;
}
...
- (id)_createNFCEventStreamWithName:(id)name workQueue:(id)queue
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = nameCopy;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Initializing NFC event stream with name: %@", &v14, 0x16u);
  }
...
void __28__HMDNFCEventListener_start__block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 1024;
    v16 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Initializing NFC streams with isBackgroundTagReadingAvailable: %{BOOL}d", &v13, 0x12u);
  }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Finished initializing NFC streams", &v13, 0xCu);
  }
