...
LABEL_16:
  ...
  if ([(HMDAccessoryPairingEvent *)self _isMatterAccessory])
  {
    ...
    if ([matterVendorID isEqual:&unk_283E72AA0])
    {
    ...
    if ([matterProductID isEqual:&unk_283E72AA0])
    {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_110846 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t15_110846, &__block_literal_global_110847);
  }

  v3 = logCategory__hmf_once_v16_110848;
