...
+ (id)unassociatedFaceCropsBetweenDatesQueryWithIsAscending:(BOOL)ascending
{
  ...
  {
    dispatch_once(&unassociatedFaceCropsBetweenDatesQueryWithIsAscending__onceToken, &__block_literal_global_26_62267);
  }
...
void __86__HMDUnassociatedFaceCropModel_unassociatedFaceCropsBetweenDatesQueryWithIsAscending___block_invoke()
{
  ...
  v4 = [v0 queryWithSQLPredicate:@"dateCreated >= :dateAfter AND dateCreated < :dateBefore ORDER BY dateCreated ASC" sequenceArgumentName:@"dateAfter" indexedProperties:&unk_283E756E0 arguments:v3];
  ...
  v10 = [v6 queryWithSQLPredicate:@"dateCreated > :dateAfter AND dateCreated <= :dateBefore ORDER BY dateCreated DESC" sequenceArgumentName:@"dateBefore" indexedProperties:&unk_283E756F8 arguments:v9];
...
+ (NSUUID)sentinelParentUUID
{
  if (sentinelParentUUID_onceToken_62290 != -1)
  {
    dispatch_once(&sentinelParentUUID_onceToken_62290, &__block_literal_global_21_62291);
  }

  v3 = sentinelParentUUID_sentinelParentUUID_62292;
...
void __50__HMDUnassociatedFaceCropModel_sentinelParentUUID__block_invoke()
{
  ...
  v1 = sentinelParentUUID_sentinelParentUUID_62292;
  sentinelParentUUID_sentinelParentUUID_62292 = v0;
}
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_62302 != -1)
  {
    dispatch_once(&hmbProperties_onceToken_62302, &__block_literal_global_62303);
  }

  v3 = hmbProperties_properties_62304;
...
void __45__HMDUnassociatedFaceCropModel_hmbProperties__block_invoke()
{
  ...
  v9 = hmbProperties_properties_62304;
  hmbProperties_properties_62304 = v8;
}
...
- (id)createAssociatedUnassociatedFaceCrop
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = selfCopy;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot create face crop from model: %@", &v15, 0x16u);
    }
