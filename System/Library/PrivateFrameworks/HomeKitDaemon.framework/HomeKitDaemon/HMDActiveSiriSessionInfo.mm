  ...
  if ([*(a1 + 32) _maybeHandleFrame:v5 error:v6])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 138543362;
        v14 = v12;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Audio receive channel is complete", &v13, 0xCu);
      }
...
- (BOOL)_maybeHandleFrame:(id)frame error:(id)error
{
  ...
  if (errorCopy)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = errorCopy;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Audio receive channel has error; closing. (%@)", &v14, 0x16u);
    }
...
- (void)invalidate
{
  ...
  if ([(HMDActiveSiriSessionInfo *)self isBulkSendActive])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 2112;
      v11 = selfCopy;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Plugin removed before all audio was received; cancelling (%@)", &v8, 0x16u);
    }
...
- (void)setActiveBulkSendSession:(id)session
{
  ...
  if (bulkSendSession)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Siri active session got two send sessions? Canceling the latter one.", &v10, 0xCu);
    }
  ...
  if (bulkSendSession)
  {
    ...
    if (didBulkSendSessionComplete)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 2112;
        v14 = selfCopy;
        _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Plugin stopped and all audio was received; closing as complete (%@)", &v11, 0x16u);
      }
