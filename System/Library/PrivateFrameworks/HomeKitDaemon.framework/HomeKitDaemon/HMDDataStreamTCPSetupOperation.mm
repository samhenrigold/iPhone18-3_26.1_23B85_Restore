...
- (void)_finishStreamTransport
{
  ...
  if (_isComplete)
  {
    if (v7)
    {
      ...
      v15 = 138543362;
      v16 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] DataStream configuration valid; starting stream", &v15, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] Setup still in progress (hasPort=%d, hasHostname=%d, hasEnc=%d)", &v15, 0x1Eu);
    }
...
- (id)_createTCPTransport
{
  ...
  if (siriEndpointProfile)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v8;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] Accessory is a Siri endpoint, creating transport with elevated scheduling mode", &v19, 0xCu);
    }
  ...
  if (WeakRetained)
  {
    ...
    if (!v5 || v6)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 2112;
        v17 = v6;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create secure session for the accessory (%@)", &v14, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        v16 = 2112;
        v17 = v5;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] Key creation succeeded; will use session encryption %@", &v14, 0x16u);
      }
...
LABEL_10:
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, v20, &v22, 0xCu);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] The setup transfer succeeded; will use port %@", &v22, 0x16u);
  }
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v10;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; invalid IP address", &v13, 0xCu);
      }
