  ...
  if (operationCopy)
  {
    ...
    if ([(HMDSyncOperationQueue *)self hasExponentialBackoff])
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2048;
        delayCopy = delay;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Current delay is %g", &v23, 0x16u);
      }
...
void __36__HMDSyncOperationQueue_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v29_145771;
  logCategory__hmf_once_v29_145771 = v0;
}
