...
- (id)_keyOfLargestCountInHistogram:(id)histogram
{
  ...
  v8 = &v7;
  v9 = 0x3032000000;
  v10 = __Block_byref_object_copy__81952;
  v11 = __Block_byref_object_dispose__81953;
  v12 = 0;
...
+ (id)supportedEventClasses
{
  if (supportedEventClasses_onceToken_81972 != -1)
  {
    dispatch_once(&supportedEventClasses_onceToken_81972, &__block_literal_global_81973);
  }

  v3 = supportedEventClasses_supportedEventClasses_81974;
