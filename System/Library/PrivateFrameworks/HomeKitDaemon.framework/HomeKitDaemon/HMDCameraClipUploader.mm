...
- (void)_startNextOperation
{
  ...
  if (firstObject)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = firstObject;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting next operation: %@", &v9, 0x16u);
    }
...
- (void)_operationCompleted:(id)completed isFinalOperation:(BOOL)operation future:(id)future
{
  ...
  if (error && !operation && ![(HMDCameraClipUploader *)self _isCancelledError:error])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2114;
      v25 = error;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Handling fatal error for operation %{public}@: %{public}@", &v20, 0x20u);
    }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = completedCopy;
    _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Operation completed: %@", &v20, 0x16u);
  }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v31 = v27;
    _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Asked to add video segment before clip has been created", buf, 0xCu);
  }
...
void __63__HMDCameraClipUploader_addSignificantEvent_completionHandler___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting significant event operation: %@", &v10, 0x16u);
  }
...
void __36__HMDCameraClipUploader_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v16_241505;
  logCategory__hmf_once_v16_241505 = v0;
}
