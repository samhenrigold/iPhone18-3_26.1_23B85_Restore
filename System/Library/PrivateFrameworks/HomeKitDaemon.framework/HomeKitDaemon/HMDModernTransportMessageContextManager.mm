  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138544130;
      ...
      v41 = 2112;
      v42 = errorCopy;
      _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Completed context %@ for message %@ with error: %@", buf, 0x2Au);
    }
...
void __54__HMDModernTransportMessageContextManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_89791;
  logCategory__hmf_once_v3_89791 = v0;
}
