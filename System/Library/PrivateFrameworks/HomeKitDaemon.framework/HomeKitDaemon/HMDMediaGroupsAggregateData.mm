...
- (id)sentinelGroup
{
  ...
  v4 = [v3 initWithIdentifier:sentinelIdentifier parentIdentifier:sentinelIdentifier name:&stru_283CF9D50 defaultName:0 destinationIdentifiers:MEMORY[0x277CBEBF8] associatedGroupIdentifier:0];
...
- (id)encodedDestinationControllerEvents
{
  ...
  if (v4)
  {
    ...
    v6 = [destinationControllersData2 na_map:&__block_literal_global_20_84039];
  }
...
- (id)encodedDestinationEvents
{
  ...
  if (v4)
  {
    ...
    v6 = [destinations2 na_map:&__block_literal_global_16];
  }
...
- (id)decodeMediaGroupsWithEncodedMediaGroups:(id)groups
{
  v4 = [groups na_map:&__block_literal_global_10_84045];
