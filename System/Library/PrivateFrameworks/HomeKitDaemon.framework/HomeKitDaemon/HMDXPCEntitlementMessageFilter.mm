...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_185329 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t2_185329, &__block_literal_global_185330);
  }

  v3 = logCategory__hmf_once_v3_185331;
...
void __45__HMDXPCEntitlementMessageFilter_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_185331;
  logCategory__hmf_once_v3_185331 = v0;
}
    ...
    if (proxyConnection)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          v32 = 2112;
          v33 = v21;
          _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Rejecting message, %@, client is missing the following entitlements: %@", &v28, 0x20u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v28 = 138543362;
          v29 = v26;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@Missing XPC policy", &v28, 0xCu);
        }
