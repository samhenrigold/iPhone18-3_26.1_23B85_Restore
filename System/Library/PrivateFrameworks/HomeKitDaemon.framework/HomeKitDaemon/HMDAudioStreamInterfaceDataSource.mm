...
- (void)createPHASEEngineAndControllerForStreamToken:(int64_t)token completion:(id)completion
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Cannot create PHASE engine and controller on unsupported platform", &v11, 0xCu);
  }
...
- (void)setAudioSessionPropertiesWithShouldAllowSystemSounds:(BOOL)sounds hostProcessBundleIdentifier:(id)identifier
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v25 = 2112;
    v26 = v17;
    _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Setting audio session properties: %@", buf, 0x16u);
  }
  ...
  if (_os_feature_enabled_impl() && _os_feature_enabled_impl())
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v28 = 2112;
      v29 = v9;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting AVAudioClient audio muted to %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v28 = 2112;
      v29 = v14;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Setting AVSystemController audio muted to %@", buf, 0x16u);
    }
    ...
    if ((v18 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v30 = 2112;
        v31 = v19;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to set AVSystemController audio muted to %@: %@", buf, 0x20u);
      }
