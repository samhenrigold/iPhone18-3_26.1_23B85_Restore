  ...
  while ([v43 count] && v48)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v45[1] = 3221225472;
        v45[2] = __87__HMDHAPAccessoryLocalNotifyUpdate__performLocalNotifyUpdateForCharacteristics_enable___block_invoke_15;
        v45[3] = &unk_278672728;
...
void __87__HMDHAPAccessoryLocalNotifyUpdate__performLocalNotifyUpdateForCharacteristics_enable___block_invoke(uint64_t a1, void *a2, void *a3)
{
              ...
              if (v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *&buf[4] = v28;
                  v58 = 2112;
                  v59 = v14;
                  _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@No clients registered. Going to deregister with the accessory server for notifications for HAPCharacteristic: %@", buf, 0x16u);
                }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            *&buf[4] = v18;
            ...
            v62 = 2112;
            v63 = v22;
            _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot map HMDCharacteristic %@/%@ to a HAPCharacteristic for server %@ to enable notifications", buf, 0x2Au);
          }
  ...
  if (v41 && v29 && ([v47 isReachable] & 1) != 0)
  {
    ...
    v48[1] = 3221225472;
    v48[2] = __87__HMDHAPAccessoryLocalNotifyUpdate__performLocalNotifyUpdateForCharacteristics_enable___block_invoke_11;
    v48[3] = &unk_2786726D8;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *&buf[4] = v36;
      ...
      v62 = 2112;
      v63 = v38;
      _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@Not enabling events on HAP accessory server because hapCharacteristics.count=%lu accessoryServer=%@ hapAccessory.isReachable=%@", buf, 0x2Au);
    }
...
void __87__HMDHAPAccessoryLocalNotifyUpdate__performLocalNotifyUpdateForCharacteristics_enable___block_invoke_15(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (!v3 && v8 && ([v7 isReachable]& 1) != 0)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v28 = 2112;
        v29 = v14;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Retrieved HAP accessory: %@ for linkType: %@.", &v24, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 2112;
        v27 = v3;
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve the HAP accessory: %@", &v24, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v24 = 138543362;
      v25 = v21;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Self became nil after we retrieved the HAP accessory from home.", &v24, 0xCu);
    }
  ...
  if (WeakRetained)
  {
    ...
    if (v3)
    {
      if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        ...
        v15 = 2112;
        v16 = v9;
        _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@Done performing update. Enable notify update failed with error: %@.", &v13, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v13 = 138543362;
        v14 = v12;
        _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Done performing update. All characteristics finished updating successfully.", &v13, 0xCu);
      }
...
- (void)_copyRelevantFieldsFrom:(id)from forEnableValue:(BOOL)value
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543874;
    ...
    v24 = 2112;
    v25 = v13;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Copying characteristics: %@ with enable: %@", buf, 0x20u);
  }
...
- (void)setEnable:(BOOL)enable forCharacteristics:(id)characteristics
{
  ...
  if (inProcessing)
  {
    if (v11)
    {
      ...
      v21 = 2112;
      v22 = v13;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating characteristics: %@ to: %@ since we are already in processing.", &v17, 0x20u);
    }
  ...
  else
  {
    if (v11)
    {
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updating characteristics: %@ to: %@", &v17, 0x20u);
    }
...
void __47__HMDHAPAccessoryLocalNotifyUpdate_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v23_36386;
  logCategory__hmf_once_v23_36386 = v0;
}
