...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_62196 != -1)
  {
    dispatch_once(&hmbProperties_onceToken_62196, &__block_literal_global_62197);
  }

  v3 = hmbProperties_properties_62198;
...
void __45__HMDUserActionPredictionModel_hmbProperties__block_invoke()
{
  ...
  v24 = hmbProperties_properties_62198;
  hmbProperties_properties_62198 = v23;
}
...
- (HMDUserActionPredictionModel)initWithUserActionPrediction:(id)prediction
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v45 = 2112;
      v46 = v30;
      _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_ERROR, "%{public}@User Action Prediction: %@, resulted in nil hmbModelID for prediction model: %@", &v41, 0x20u);
    }
    ...
    if (!hmbModelID2)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
      {
        ...
        v41 = 138543362;
        v42 = v38;
        _os_log_impl(&dword_229538000, v37, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: User Action Prediction ModelID should not be nil", &v41, 0xCu);
      }
