...
- (BOOL)cancelAssetStagingForAccessory:(id)accessory asset:(id)asset
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v13, 0x16u);
  }
...
- (BOOL)resumeAssetTransfersForAccessory:(id)accessory
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v10, 0x16u);
  }
...
- (BOOL)rescindStagedAssetsForAccessory:(id)accessory error:(id *)error
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v11, 0x16u);
  }
...
- (BOOL)offerAssetToAccessory:(id)accessory asset:(id)asset error:(id *)error
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v14, 0x16u);
  }
...
- (BOOL)accessoryUnreachable:(id)unreachable error:(id *)error
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = unreachableCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: accessory %@ is now unreachable.", &v11, 0x20u);
  }
...
- (BOOL)accessoryReachable:(id)reachable error:(id *)error
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = reachableCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: accessory %@ is now reachable.", &v11, 0x20u);
  }
