...
- (BOOL)_activate:(unint64_t)_activate completionHandler:(id)handler
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v12;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating the activation type from %@ to %@", &v17, 0x20u);
  }
...
void __23__HMDEvent_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_167982;
  logCategory__hmf_once_v1_167982 = v0;
}
