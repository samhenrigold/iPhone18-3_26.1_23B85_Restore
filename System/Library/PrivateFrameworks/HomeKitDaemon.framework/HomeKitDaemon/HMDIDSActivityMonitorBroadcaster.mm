  ...
  if (dataSource)
  {
    ...
    if (queue)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Data source updated, resuming debounce timer", &v12, 0xCu);
      }
...
- (void)timerDidFire:(id)fire
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Debounce timer fired, rebuilding observer list", &v10, 0xCu);
  }
...
LABEL_9:
  ...
  if (queue)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Queue and data source set, starting debounce timer", &v12, 0xCu);
    }
...
void __47__HMDIDSActivityMonitorBroadcaster_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v10_206227;
  logCategory__hmf_once_v10_206227 = v0;
}
