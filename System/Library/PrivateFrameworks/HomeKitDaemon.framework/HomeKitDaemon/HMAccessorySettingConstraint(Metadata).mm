...
+ (id)valueWithType:()Metadata representation:
{
  ...
  if ((a3 - 1) < 3)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid constraint value: %@", &v19, 0x16u);
    }
...
LABEL_14:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid constraint value: %@", &v19, 0x16u);
    }
