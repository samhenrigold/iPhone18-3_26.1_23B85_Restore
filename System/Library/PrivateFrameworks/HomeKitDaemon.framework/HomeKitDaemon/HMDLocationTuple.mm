...
- (HMDLocationTuple)initWithLocation:(id)location reachableIPAccessoryCount:(unint64_t)count reachableBTLEAccessoryCount:(unint64_t)accessoryCount reachableMediaAccessoryCount:(unint64_t)mediaAccessoryCount
{
  ...
  if (locationCopy)
  {
    v12 = locationCopy;
    v21.receiver = self;
    v21.super_class = HMDLocationTuple;
    v13 = [(HMDLocationTuple *)&v21 init];
    v14 = v13;
    if (v13)
    {
  ...
  else
  {
    ...
    return [(NSManagedObject(HomeKitDaemon) *)v16 mkf_findRelationOnProperty:v17 modelProtocol:v18 keyValue:v19, v20];
  }
}
