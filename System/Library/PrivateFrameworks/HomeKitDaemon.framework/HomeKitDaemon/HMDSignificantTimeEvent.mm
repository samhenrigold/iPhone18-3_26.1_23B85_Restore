...
- (void)_transactionObjectUpdated:(id)updated newValues:(id)values message:(id)message
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 138543362;
    v31 = v14;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", &v30, 0xCu);
  }
...
+ (id)nextTimerDateFromHomeLocation:(id)location signifiantEvent:(id)event offset:(id)offset loggingObject:(id)object
{
  ...
  if (!locationCopy)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v77 = v23;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get next significant event fire date because home location is nil", buf, 0xCu);
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v78 = 2112;
    v79 = v25;
    _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@nextSunEventDates %@", buf, 0x16u);
  }
  ...
  if (v25)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = [v25 describeElements:&__block_literal_global_19_102975];
      *buf = 138543618;
      v77 = v34;
      v78 = 2112;
      v79 = v35;
      _os_log_impl(&dword_229538000, v33, OS_LOG_TYPE_INFO, "%{public}@Set of events to pick from %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v78 = 2112;
      v79 = v55;
      _os_log_impl(&dword_229538000, v53, OS_LOG_TYPE_INFO, "%{public}@Set of events to pick after offset & current time addition from %@", buf, 0x16u);
    ...
    if ([v50 count])
    {
      ...
      if (v56 == v58)
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v77 = v62;
          _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine next timer event for Significant Event", buf, 0xCu);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v78 = 2112;
          v79 = v24;
          _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_INFO, "%{public}@Event next fire date : %@", buf, 0x16u);
        }
      }
...
LABEL_49:
  ...
  else
  {
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v77 = v49;
      _os_log_impl(&dword_229538000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to get the sun event dates based on home location", buf, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_102990 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_102990, &__block_literal_global_102991);
  }

  v3 = logCategory__hmf_once_v1_102992;
...
void __38__HMDSignificantTimeEvent_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_102992;
  logCategory__hmf_once_v1_102992 = v0;
}
