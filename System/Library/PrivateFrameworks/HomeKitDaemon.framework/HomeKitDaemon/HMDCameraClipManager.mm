  ...
  if (v13)
  {
    ...
    if (reason == 1)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v20;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received all storage disabled notification", &v22, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v24 = 2112;
        v25 = v9;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received unknown notification: %@", &v22, 0x16u);
      }
...
- (void)zoneManagerDidStop:(id)stop
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Camera clips zone manager stopped", &v11, 0xCu);
  }
...
void __44__HMDCameraClipManager_zoneManagerDidStart___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Camera clips cloud zone finished starting up", &v10, 0xCu);
  }
  ...
  if (v4)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Home person manager face classification is disabled; removing all face classification models", &v12, 0xCu);
      }
...
void __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke_221(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch is cloud storage enabled: %@", &v8, 0x16u);
  }
...
- (void)handleImportClipsMessage:(id)message
{
  ...
  if (localZone)
  {
    ...
    if (v12)
    {
      ...
      v15 = [MEMORY[0x277CBEA60] arrayWithObjects:v43 count:4];
      v16 = [v14 setWithArray:v15];
      v42 = 0;
      v17 = [v13 unarchivedObjectOfClasses:v16 fromData:v12 error:&v42];
      v18 = v42;
      ...
      if (v17)
      {
        ...
        v40[1] = 3221225472;
        v40[2] = __49__HMDCameraClipManager_handleImportClipsMessage___block_invoke;
        v40[3] = &unk_278687CC0;
        v41 = messageCopy;
        v26 = [v25 addCompletionBlock:v40];
      }
      ...
      if (v15)
      {
        ...
        if (v16 && v23 && v24 && v25)
        {
          ...
          if (bOOLValue)
          {
            ...
            v49[1] = 3221225472;
            v49[2] = __60__HMDCameraClipManager_handleFetchSignificantEventsMessage___block_invoke_215;
            v49[3] = &unk_27868A728;
            v50 = messageCopy;
...
- (void)handleFetchVideoSegmentsAssetContextMessage:(id)message
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch video segments asset context message", &v15, 0xCu);
  }
    ...
    if (v13)
    {
      ...
      if (v14 && v15 && v16 && v17 && v18)
      {
        ...
        if (bOOLValue)
        {
          ...
          v50[1] = 3221225472;
          v50[2] = __48__HMDCameraClipManager_handleFetchClipsMessage___block_invoke_206;
          v50[3] = &unk_27868A728;
          v51 = messageCopy;
...
- (void)handleSubscribeMessage:(id)message
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling subscribe message", &v27, 0xCu);
  }
  ...
  if (v12)
  {
    ...
    if (!cloudZone)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v27 = 138543362;
        v28 = v18;
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Asked to subscribe to changes when no cloud zone exists; Restarting zone manager", &v27, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = transport2;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Subscribing transport was not of expected class %@: %@", &v27, 0x20u);
    }
...
- (id)_disableCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 138543362;
    v26 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Disabling cloud storage", &v25, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v25 = 138543362;
      v26 = v22;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot disable cloud storage", &v25, 0xCu);
    }
...
id __120__HMDCameraClipManager__updateModelsForMisclassificationForSignificantEvent_unassociatedFaceCropUUID_personManagerUUID___block_invoke(id *a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    v24[1] = 3221225472;
    v24[2] = __120__HMDCameraClipManager__updateModelsForMisclassificationForSignificantEvent_unassociatedFaceCropUUID_personManagerUUID___block_invoke_187;
    v24[3] = &unk_278681068;
    v24[4] = a1[4];
    v25 = a1[6];
    v26 = a1[5];
    ...
    v22[1] = 3221225472;
    v22[2] = __120__HMDCameraClipManager__updateModelsForMisclassificationForSignificantEvent_unassociatedFaceCropUUID_personManagerUUID___block_invoke_192;
    v22[3] = &unk_278686CE8;
    v23 = v5;
    v18 = [v17 flatMap:v22];
  }
...
id __120__HMDCameraClipManager__updateModelsForMisclassificationForSignificantEvent_unassociatedFaceCropUUID_personManagerUUID___block_invoke_187(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating face classification to use unassociated face crop with UUID: %@", &v21, 0x16u);
  }
...
id __141__HMDCameraClipManager__handleFaceMisclassificationForSignificantEvent_personUUID_faceClassificationPersonManagerUUID_homePersonManagerUUID___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Adding unassociated face crop to home person dataset for misclassified face classification", &v12, 0xCu);
  }
...
void __82__HMDCameraClipManager__notifyForChangedSignificantEventModel_mirrorOutputFuture___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = v21;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create significant event from model: %@", &v24, 0x16u);
LABEL_12:
    }
...
LABEL_13:
  ...
  if (v13 == -1)
  {
    if (v17)
    {
      ...
      v28 = 2112;
      v29 = v23;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring significant event with date of occurrence %@ because it is before %@", &v24, 0x20u);
  ...
  if (v17)
  {
    ...
    v26 = 2112;
    v27 = v7;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate about updated significant event: %@", &v24, 0x16u);
  }
...
- (void)_handleChangedFaceClassificationModel:(id)model
{
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 2112;
        v23 = modelCopy;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Ignoring changed face classification model because it could not be converted into a HMCameraClipSignificantEvent: %@", &v20, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v22 = 2112;
      v23 = modelCopy;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changed face classification model because its associated significant event does not exist: %@", &v20, 0x16u);
    }
...
- (void)_handleChangedSignificantEventNotificationModel:(id)model mirrorOutputFuture:(id)future
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      v19 = 2112;
      v20 = modelCopy;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changed significant event notification model because its associated clip model does not exist: %@", &v17, 0x16u);
    }
...
void __44__HMDCameraClipManager__cleanUpExpiredClips__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2112;
    v21 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Removing expired clip: %@", &v18, 0x16u);
  }
  ...
  if (v11 >= [*(a1 + 32) fetchBatchLimit])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 2048;
      v21 = v16;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Removing %lu expired clips", &v18, 0x16u);
    }
...
void __65__HMDCameraClipManager__cleanUpIncompleteClipsForInitialStartup___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v49 = 2112;
    v50 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cleaning up incomplete clip: %@", &v47, 0x16u);
  }
  ...
  if (v27 >= [*(a1 + 32) fetchBatchLimit])
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v49 = 2112;
      v50 = v32;
      _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Completing batch of incomplete clips: %@", &v47, 0x16u);
    }
  ...
  if (v37 >= [*(a1 + 32) fetchBatchLimit])
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v49 = 2112;
      v50 = v42;
      _os_log_impl(&dword_229538000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Removing batch of incomplete 0-duration clip UUIDs: %@", &v47, 0x16u);
    }
...
void __41__HMDCameraClipManager__performCloudPull__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform cloud pull due to cloud zone fetch timer firing: %@", &v8, 0x16u);
  }
...
id __66__HMDCameraClipManager__fetchFaceCropURLForSignificantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched face crop URL: %@", &v17, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find face crop file URL on fetched asset: %@", &v17, 0x16u);
    }
...
void __66__HMDCameraClipManager__fetchFaceCropURLForSignificantEventModel___block_invoke_155(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch complete significant event notification model: %@", &v8, 0x16u);
  }
...
id __67__HMDCameraClipManager__fetchHeroFrameURLForSignificantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched hero frame URL: %@", &v17, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find hero frame file URL on fetched asset: %@", &v17, 0x16u);
    }
...
void __86__HMDCameraClipManager__fetchClipsWithDateInterval_quality_isAscending_error_handler___block_invoke(uint64_t a1, void *a2, _BYTE *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant events for clip model %@", &v14, 0x16u);
    }
...
- (BOOL)_fetchSignificantEventsWithDateInterval:(id)interval isAscending:(BOOL)ascending error:(id *)error handler:(id)handler
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v36 = 2112;
    v37 = intervalCopy;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Fetching significant events with date interval: %@", buf, 0x16u);
  }
...
- (id)remove
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Asked to remove clip manager zones", &v11, 0xCu);
  }
...
- (void)configure
{
  ...
  if (home)
  {
    ...
    v50[1] = v9;
    v50[2] = v11;
    v12 = [MEMORY[0x277CBEA60] arrayWithObjects:v50 count:3];
    ...
    v42 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
    v43 = v9;
    v49[0] = v9;
    v49[1] = v11;
    v49[2] = v42;
    v41 = [MEMORY[0x277CBEA60] arrayWithObjects:v49 count:3];
...
- (void)setHasWriteAccess:(BOOL)access
{
  ...
  if (self->_hasWriteAccess != accessCopy)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v11;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating has write access from %@ to %@", &v13, 0x20u);
    }
