  ...
  if (verificationTimer == fireCopy)
  {
    ...
    if (![(HMDPowerManager *)self isPowerAsserted])
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        v11 = 138543362;
        v12 = v9;
        _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@HomeKit remote access power assertion unexpectedly released", &v11, 0xCu);
      }
...
- (void)_ensureNetworkInterfaceMonitorStopped
{
  ...
  if (scStore)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopped network interface monitor", &v9, 0xCu);
    }
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v31 = 2080;
        v32 = strerror(v6);
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Create HomeKit remote access power assertion failed: %s", buf, 0x16u);
      }
...
LABEL_39:
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v30 = v19;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Created HomeKit remote access power assertion", buf, 0xCu);
    }
    ...
    if (!isPowerAsserted)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v30 = v27;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Create HomeKit remote access power assertion failed to become active", buf, 0xCu);
      }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v30 = v23;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@HomeKit remote access power assertion is active", buf, 0xCu);
    }
...
void __30__HMDPowerManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_84915;
  logCategory__hmf_once_v1_84915 = v0;
}
