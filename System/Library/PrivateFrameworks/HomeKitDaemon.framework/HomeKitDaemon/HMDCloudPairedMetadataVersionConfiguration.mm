...
- (HMDCloudPairedMetadataVersionConfiguration)initWithAccessoryIdentifier:(id)identifier jsonDictionary:(id)dictionary
{
  ...
  if (firmwareVersion)
  {
    ...
    if (v9)
    {
      ...
      if (v12)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            v35 = 2112;
            v36 = dictionaryCopy;
            _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", &v31, 0x20u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v35 = 2112;
          v36 = dictionaryCopy;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", &v31, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = dictionaryCopy;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON contains no '%@' value: %@", &v31, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 2112;
      v34 = identifierCopy;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Version configuration must contain firmware version: %@", &v31, 0x16u);
    }
...
void __57__HMDCloudPairedMetadataVersionConfiguration_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_204614;
  logCategory__hmf_once_v1_204614 = v0;
}
