...
- (id)createFaceprint
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v14;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot create faceprint from model: %@", &v16, 0x16u);
    }
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_210124 != -1)
  {
    dispatch_once(&hmbProperties_onceToken_210124, &__block_literal_global_210125);
  }

  v3 = hmbProperties_properties_210126;
...
void __34__HMDFaceprintModel_hmbProperties__block_invoke()
{
  ...
  v4 = hmbProperties_properties_210126;
  hmbProperties_properties_210126 = v3;
}
