...
- (void)handleFetchMultiuserSettingsRequest:(id)request
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling fetch Multiuser Settings Request, %@", &v14, 0x16u);
  }
...
void __44__HMDMultiuserSettingsMessenger_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_196209;
  logCategory__hmf_once_v3_196209 = v0;
}
