    ...
    if (v34 || !v33)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v63 = 2112;
        v64 = v34;
        _os_log_impl(&dword_229538000, v41, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply could not be parsed (error=%@)", buf, 0x16u);
      }
...
LABEL_42:
      _os_log_impl(&dword_229538000, v46, OS_LOG_TYPE_ERROR, v48, buf, 0xCu);
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v63 = 2112;
        v64 = v53;
        _os_log_impl(&dword_229538000, v50, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write failed with status %@", buf, 0x16u);
      }
