...
+ (id)createWithExternalRepresentation:(id)representation
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nfc reader key external representation length %lu", &v12, 0x16u);
    }
...
- (id)createKeychainItemForHome:(id)home
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = selfCopy;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keychain item for home: %@ from: %@, external representation is nil", &v19, 0x20u);
    }
...
LABEL_8:
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, v15, &v17, 0x20u);
    }
  }
