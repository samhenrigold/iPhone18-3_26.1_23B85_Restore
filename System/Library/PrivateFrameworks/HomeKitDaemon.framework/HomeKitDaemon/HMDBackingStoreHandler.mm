...
- (void)transactionObjectRemoved:(id)removed message:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = removedCopy;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to process removed object: %@", &v13, 0x16u);
  }
...
- (void)transactionObjectUpdated:(id)updated newValues:(id)values message:(id)message
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    v18 = 2112;
    v19 = valuesCopy;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to process udated changes for object: %@", &v16, 0x16u);
  }
...
- (id)backingStoreObjectsForVersion:(int64_t)version
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive backinstore objects for shared user", &v9, 0xCu);
  }
...
void __77__HMDBackingStoreHandler_runTransactionWithModels_options_reason_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Transaction completed with error: %@", &v12, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Transaction completed", &v12, 0xCu);
    }
...
void __37__HMDBackingStoreHandler_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v8_91757;
  logCategory__hmf_once_v8_91757 = v0;
}
