...
id __51__HMDAccessorySettingsController_languageValueList__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v7;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get expected language code count from legacy language setting encoding: %@", &v23, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v3;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get legacy langage setting encoding from language constaint: %@", &v23, 0x16u);
    }
...
- (void)legacySettingsAdaptor:(id)adaptor didUpdateSettingKeyPath:(id)path selectedLanguageValue:(id)value availableLanguageList:(id)list
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = listCopy;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Did update setting from keyPath:%@ value = %@, availableLanguageList = %@", &v18, 0x2Au);
  }
...
void __92__HMDAccessorySettingsController_legacySettingsAdaptor_didUpdateSettingKeyPath_numberValue___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@ with error %@", &v13, 0x20u);
  }
...
void __92__HMDAccessorySettingsController_legacySettingsAdaptor_didUpdateSettingKeyPath_numberValue___block_invoke_196(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2114;
    v16 = v12;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@", &v13, 0x16u);
  }
    ...
    if ((v13 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543874;
        ...
        v29 = 2114;
        v30 = v11;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting keyPath: %{public}@ on notification from adaptor to %{public}@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v27 = 2114;
      v28 = pathCopy;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Did not find setting with keyPath: %{public}@ on update from fetched settings adaptor", buf, 0x16u);
    }
    ...
    if (!v2)
    {
      ...
      if (v3)
      {
        if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
        {
          ...
          v10 = 138543362;
          v11 = v8;
          _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Already initiated settings creation for older software counterpart. Will not attempt again", &v10, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v10 = 138543362;
          v11 = v9;
          _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Detected no settings with older software counterpart. Will create settings.", &v10, 0xCu);
        }
...
void *__53__HMDAccessorySettingsController_updateSettingOwner___block_invoke(uint64_t a1)
{
  ...
  if (*(a1 + 40) != result)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 2112;
      v11 = v7;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting owner to %@", &v8, 0x16u);
    }
...
- (void)configureIsSettingOwner:(BOOL)owner migrationOwner:(BOOL)migrationOwner home:(id)home legacySettingsAdaptor:(id)adaptor
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v42 = 2112;
    v43 = v19;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Configuring settingOwner: %@, migrationOwner: %@, rootGroup: %@", buf, 0x2Au);
...
- (NSString)siriLanguage
{
  ...
  if (v3)
  {
    ...
    if ([v9 hmf_isEmpty])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v13;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse siri language componenets", &v20, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch siri language because the HMDAccessorySetting was nil", &v20, 0xCu);
    }
...
- (void)decodeWithCoder:(id)coder
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Assigning root group on decode. %@", &v14, 0x16u);
  }
...
- (void)handleLanguageChangeTimerFired
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Accessory settings language change timer did fire, notifying delegate", &v8, 0xCu);
  }
...
- (void)handleRemovedSettingConstraintModel:(id)model completion:(id)completion
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      if (v16)
      {
        ...
        v30 = 2112;
        v31 = v14;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Removed constraint: %@ from setting: %@", &v26, 0x20u);
      }
    ...
    else
    {
      if (v16)
      {
        ...
        v30 = 2112;
        v31 = v14;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Constraint already removed: %@ from setting: %@", &v26, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = 2112;
      v31 = modelCopy;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "%{public}@Setting %@ to remove constraint %@ not found", &v26, 0x20u);
    }
...
- (void)handleRemovedSettingModel:(id)model completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = uuid2;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Setting with id %@ not found", &v22, 0x16u);
    }
...
LABEL_10:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v24 = 2112;
    v25 = v8;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Parent group %@ to add setting %@ not found", &v20, 0x20u);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v37 = 2112;
        v38 = value4;
        _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive accessory setting supported value from model's value: %@", buf, 0x16u);
      }
  ...
  if (v10)
  {
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v30 = 2112;
        v31 = rootGroup2;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Root group model %@ was removed %@", &v26, 0x20u);
      }
...
- (void)handleUpdatedGroupModel:(id)model completion:(id)completion
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v46 = 2112;
      v47 = modelCopy;
      _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode group from model %@", &v44, 0x16u);
    }
  ...
  if (!v11)
  {
    ...
    if (v32)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        v48 = 2112;
        v49 = v32;
        _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@Added group %@ to %@", &v44, 0x20u);
      }
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      v48 = 2112;
      v49 = v8;
      _os_log_impl(&dword_229538000, v41, OS_LOG_TYPE_ERROR, "%{public}@Parent group %@ to add group %@ not found", &v44, 0x20u);
    }
...
LABEL_23:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v48 = 2112;
    v49 = uuid;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Assigning root group from transaction model: %@ id: %@.", &v44, 0x20u);
  }
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v48 = 2112;
      v49 = v8;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@RootGroup changing unexpectedly %@ / %@.", &v44, 0x20u);
    }
...
- (void)_removeManagedConfigurationProfile:(id)profile completion:(id)completion
{
  ...
  if (profileCopy)
  {
    ...
    if (dataSource)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v13;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Remove managed configuration profile", &v22, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 138543362;
        v23 = v19;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Nil datasource.", &v22, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 138543362;
      v23 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@Managed configuration profile data is nil", &v22, 0xCu);
    }
...
- (BOOL)canUser:(id)user editConstraintsForSetting:(id)setting
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = settingCopy;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@User %@ cannot edit accessory setting with UUID %@ because it does not exist.", &v17, 0x20u);
    }
...
- (BOOL)canUser:(id)user editConstraintsForSettingWithKeyPath:(id)path
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = pathCopy;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@User %@ cannot edit accessory setting at key path %@ because it does not exist.", &v17, 0x20u);
    }
  ...
  if (v16)
  {
    ...
    if (v27 == [v18 count])
    {
      if ([(HMDAccessorySettingsController *)self isProxy])
      {
        if (classCopy != 6)
        {
          v48 = [v17 na_map:&__block_literal_global_179];
          messageHandler = [(HMDAccessorySettingsController *)self messageHandler];
      ...
      if ([v19 count] == 1)
      {
        ...
        if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v98 = 2112;
          v99 = firstObject;
          _os_log_impl(&dword_229538000, v69, OS_LOG_TYPE_INFO, "%{public}@Remove managed configuration profile for constraint: %@", buf, 0x16u);
        }
...
void __144__HMDAccessorySettingsController_onMessageReplaceConstraintsWithAdditions_constraintIdsToRemove_keyPath_senderProductClass_isRemote_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Got response from owner failing current %@.", &v11, 0x16u);
  }
...
- (void)_cacheConstraintAdditions:(id)additions removals:(id)removals setting:(id)setting
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v21 = 2112;
    v22 = removalsCopy;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@%@ caching additions %@, removals %@", &v15, 0x2Au);
  }
...
- (void)onMessageRemoveConstraint:(id)constraint keyPath:(id)path completion:(id)completion
{
  ...
  *&buf[8] = buf;
  *&buf[16] = 0x3032000000;
  v33 = __Block_byref_object_copy__229298;
  v34 = __Block_byref_object_dispose__229299;
  ...
  else
  {
    if ([*(a1 + 32) configurationVersion] >= a3)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 2048;
        v31 = v22;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Not changing locally as the new config version isnt higher %tu (current %tu)", &v26, 0x20u);
      }
    ...
    else
    {
      ...
      if (v11)
      {
        if (v15)
        {
          ...
          v28 = 2112;
          v29 = v17;
          _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Not updating the value from %@ as the new value is same", &v26, 0x16u);
        }
      ...
      else
      {
        if (v15)
        {
          ...
          v30 = 2112;
          v31 = v7;
          _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Updating the value locally from %@ to %@", &v26, 0x20u);
        }
...
void __102__HMDAccessorySettingsController__updateValue_forSetting_senderVersion_senderProductClass_completion___block_invoke_122(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Adaptor update result keyPath:%{public}@ error: %@", &v11, 0x20u);
  }
...
- (void)_onMessageUpdateValue:(id)value settingKeyPath:(id)path senderVersion:(id)version senderProductClass:(int64_t)class completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = pathCopy;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for keyPath %@", &v23, 0x16u);
    }
...
- (void)onMessageUpdateValue:(id)value settingKeyPath:(id)path senderVersion:(id)version senderProductClass:(int64_t)class completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = pathCopy;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", &v23, 0x16u);
    }
...
- (void)onMessageUpdateValue:(id)value settingIdentifier:(id)identifier senderVersion:(id)version senderProductClass:(int64_t)class completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 2112;
      v27 = identifierCopy;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for identifier %@", &v24, 0x16u);
    }
...
void __56__HMDAccessorySettingsController_scheduleDependantFixup__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v19 = 2112;
    v20 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received request to fix settings for dependents: %@", &v17, 0x16u);
  }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@There is already an fix setting request in queue, kicking it again", &v17, 0xCu);
    }
...
void __65__HMDAccessorySettingsController__migrateSettingsWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Finished migrating settings.", &v9, 0xCu);
  }
...
void __49__HMDAccessorySettingsController__createSettings__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 138543362;
    v34 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Finished creating settings.", &v33, 0xCu);
  }
  ...
  {
    LOWORD(v33) = 0;
    _os_signpost_emit_with_name_impl(&dword_229538000, v16, OS_SIGNPOST_INTERVAL_END, v17, "SettingsCreate", "", &v33, 2u);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2048;
    v36 = v22;
    _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Setup start timestamp %f", &v33, 0x16u);
  }
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2048;
    v36 = v30;
    _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Settings creation latency %f", &v33, 0x16u);
  }
...
void __47__HMDAccessorySettingsController_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Fix settings timer has fired, issuing fix settings", &v14, 0xCu);
    }
  ...
  else
  {
    ...
    if (v4 == v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v9;
        _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Audit settings timer has fired, issuing audit for settings", &v14, 0xCu);
      }
...
uint64_t __63__HMDAccessorySettingsController_scheduleAuditWithReason_from___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received audit with reason %@ from %@", &v9, 0x20u);
  }
...
- (void)_scheduleAuditWithReason:(unint64_t)reason
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v25 = 2112;
    v26 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Received audit with reason %@", &v23, 0x16u);
  }
  ...
  if ([(HMDAccessorySettingsController *)selfCopy hasCreatedUnprocessedRootGroup])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 138543362;
      v24 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Not scheduling audit as the root group has been created but not processed yet", &v23, 0xCu);
    }
  ...
  else
  {
    ...
    if (auditSettingsTimer)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v18;
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@There is already an fix setting request in queue, kicking it again", &v23, 0xCu);
      }
...
LABEL_11:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 2112;
      v28 = v19;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Filtering out keyPath = %@, filtered? = %@", &v23, 0x20u);
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v25 = 2112;
    v26 = dataSource;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode xpc settings for controller due to no home for data source: %@", &v23, 0x16u);
  }
...
void __45__HMDAccessorySettingsController_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v4_229435;
  logCategory__hmf_once_v4_229435 = v0;
}
