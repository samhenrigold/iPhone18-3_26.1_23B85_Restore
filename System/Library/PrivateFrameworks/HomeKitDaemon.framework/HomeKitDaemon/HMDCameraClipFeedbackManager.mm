...
- (void)_handleFindAndUploadSubmittedClipsMessage:(id)message
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling find and upload submitted clips message: %@", &v11, 0x16u);
  }
...
void __72__HMDCameraClipFeedbackManager_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@The current device is the confirmed primary resident", &v9, 0xCu);
    }
  ...
  else
  {
    if (v6)
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@The current device is not the confirmed primary resident", &v9, 0xCu);
    }
  ...
  else
  {
    ...
    if (primaryResident)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2112;
        v26 = primaryResident;
        _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ that clips were submitted to %@", &v21, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 138543362;
        v22 = v20;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find primary resident to send notifications to", &v21, 0xCu);
      }
...
void __43__HMDCameraClipFeedbackManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v24_258925;
  logCategory__hmf_once_v24_258925 = v0;
}
