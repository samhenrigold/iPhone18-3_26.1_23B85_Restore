...
- (void)timerDidFire:(id)fire
{
  ...
  if (activeGroupIdentifier)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v6;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Timer fired, submitting log event with duration: %llu error: %@", &v21, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Timer fired but no active metric type being tracked.", &v21, 0xCu);
    }
...
- (void)_submitLogEvent:(id)event error:(id)error
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %@", &v14, 0x16u);
  }
  ...
  if (type)
  {
    ...
    if (activeGroupIdentifier)
    {
      if (([(NSUUID *)activeGroupIdentifier hmf_isEqualToUUID:identifierCopy]& 1) != 0)
      {
        ...
        if (metricType == type)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            v48 = 2112;
            v49 = v18;
            _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Request committed for group identifier %@ metric type: %@", &v44, 0x20u);
          }
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v48 = 2112;
          v49 = v43;
          _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher is tracking metric type %@ but ask to mark metric type %@", &v44, 0x20u);
        }
      }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v48 = 2112;
          v49 = v31;
          _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Tracking different group identifier: %@ active group identifier: %@", &v44, 0x20u);
        }
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v46 = 2112;
        v47 = v28;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@No active setup tracking for metric type: %@", &v44, 0x16u);
      }
    }
...
LABEL_38:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    v44 = 138543362;
    v45 = v22;
    _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for committed request", &v44, 0xCu);
  }
        ...
        if (submissionTimer)
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v49 = v38;
            v43 = v38;
            _os_log_impl(&dword_229538000, v37, OS_LOG_TYPE_INFO, "%{public}@Resetting the submission timer", buf, 0xCu);
          }
...
- (void)_resetActiveTracking
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Reset active tracking for group identifier: %@", &v11, 0x16u);
  }
...
void __49__HMDMediaGroupSetupMetricDispatcher_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v20_98639;
  logCategory__hmf_once_v20_98639 = v0;
}
