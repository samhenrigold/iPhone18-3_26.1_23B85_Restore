...
- (BOOL)canPairGivenCapabilities:(unint64_t)capabilities
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@No required capabilities found.", &v14, 0xCu);
    }
...
void __49__HMDUnassociatedAppleMediaAccessory_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_51696;
  logCategory__hmf_once_v9_51696 = v0;
}
