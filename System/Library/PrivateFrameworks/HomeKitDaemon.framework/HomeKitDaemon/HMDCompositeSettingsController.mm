...
- (void)database:(id)database didConfigureWithError:(id)error
{
  ...
  if (errorCopy)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *&v32[12] = 2112;
      *&v32[14] = errorCopy;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Error configuring database adapter: %@", v32, 0x16u);
    }
  ...
  if (self)
  {
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        v22 = 2112;
        v23 = modelCopy;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Processing  model deletion, model:%@", &v20, 0x16u);
      }
    ...
    else
    {
      if (v11)
      {
        ...
        v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_handleModelDeletion)", &v20, 0xCu);
      }
...
LABEL_50:
  ...
  if (!v53)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *v73 = 138543362;
      v74 = v35;
      _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@Nil database (_updateSettingsForKeyPaths)", v73, 0xCu);
    }
...
void __90__HMDCompositeSettingsController__updateSettingForKeyPath_value_callerVersion_completion___block_invoke_82(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v9;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@updating setting:%@, error:%@", &v11, 0x20u);
  }
...
- (void)_createSettingsFromModel:(id)model
{
  ...
  if (rawDatabase)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *&v58[12] = 2112;
      *&v58[14] = v21;
      _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_INFO, "%{public}@Updated Settings %@", v58, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *v58 = 138543362;
      *&v58[4] = v45;
      _os_log_impl(&dword_229538000, v44, OS_LOG_TYPE_INFO, "%{public}@Nil database (_createSettingsFromModel)", v58, 0xCu);
    }
...
void __62__HMDCompositeSettingsController_filteredSettingsForSettings___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Filtering setting with blocked key path: %@", &v9, 0x16u);
    }
...
void __45__HMDCompositeSettingsController_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v14_124980;
  logCategory__hmf_once_v14_124980 = v0;
}
