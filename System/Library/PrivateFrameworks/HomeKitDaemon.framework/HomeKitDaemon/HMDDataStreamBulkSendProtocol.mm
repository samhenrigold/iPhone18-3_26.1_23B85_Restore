...
- (void)_sendAckMessageWithIdentifier:(id)identifier
{
  ...
  if (dataStream)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = identifierCopy;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending 'ack' for sid=%@", &v11, 0x16u);
    }

    objc_autoreleasePoolPop(v7);
    [dataStream sendEventForProtocol:@"dataSend" topic:@"ack" payload:v6 completion:&__block_literal_global_46];
  }
}
...
- (void)_sendCloseMessageWithIdentifier:(id)identifier reason:(unsigned __int16)reason
{
  ...
  if (dataStream)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 1024;
      v19 = reasonCopy;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending 'close' for sid=%@ with reason %d", &v14, 0x1Cu);
    }

    objc_autoreleasePoolPop(v10);
    [dataStream sendEventForProtocol:@"dataSend" topic:@"close" payload:v9 completion:&__block_literal_global_44_186885];
  }
}
...
LABEL_15:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 138543362;
    v22 = v20;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received message with no packets", &v21, 0xCu);
  }
...
- (void)_handleDataMessage:(id)message
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        v19 = 2112;
        v20 = v7;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Data packet for streamIdentifier=%@ dropped because no session is active", &v17, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Data packet dropped because no session identifier was present", &v17, 0xCu);
    }
...
- (void)_handleCloseMessage:(id)message
{
  ...
  if (v7)
  {
    ...
    if (v15)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v28 = 2112;
        v29 = v7;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received close packet for stream identifier: %@", &v26, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        v28 = 2112;
        v29 = v7;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Close packet for streamIdentifier=%@ dropped because no session is active", &v26, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v24;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@Close dropped because streamIdentifier was not included", &v26, 0xCu);
    }
...
- (void)_handleOpenWithRequestHeader:(id)header payload:(id)payload
{
  ...
  if (v10 && v13)
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        v33 = 2112;
        v34 = v10;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Received 'open' with type=%@; passing to listener", &v31, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v33 = 2112;
        v34 = v10;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Received 'open' for type=%@ but no active listener accepted it", &v31, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v13;
      _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Dropping 'open' because it is missing required keys (type=%@, target=%@)", &v31, 0x20u);
    }
  ...
  if (dataStream)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v21 = 2048;
      v22 = statusCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending open response with status %@ (%ld)", buf, 0x20u);
    }
...
- (id)_createSessionFromCandidate:(id)candidate queue:(id)queue
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive session with streamIdentifier=%@", &v19, 0x16u);
  }
...
- (id)_createSessionCandidateWithRequestHeader:(id)header metadata:(id)metadata
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 2112;
    v17 = headerCopy;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive candidate session (header %@)", &v14, 0x16u);
  }
  ...
  if ([(HMDDataStreamBulkSendProtocol *)self isConnected])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = requestCopy;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@DataSend received unexpected request '%@'", &v18, 0x16u);
      }
...
- (void)dataStreamDidClose:(id)close
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream closed; cleaning up", &v9, 0xCu);
  }
...
- (void)dataStreamInitiatedClose:(id)close
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream initiated closing...", &v9, 0xCu);
  }
...
- (void)dataStream:(id)stream didFailWithError:(id)error
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = errorCopy;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@DataStream failed with error; cleaning up. (%@)", &v12, 0x16u);
  }
...
- (void)_notifyActiveStatusChangedFromPreviousValue:(BOOL)value
{
  ...
  if ([(HMDDataStreamBulkSendProtocol *)self isActive]!= value)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@BulkSend protocol changes active to %@", &v10, 0x16u);
    }
...
- (void)addListener:(id)listener fileType:(id)type
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = typeCopy;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Rejecting BulkSend registration for file type %@; handler already exists", &v17, 0x16u);
    }
