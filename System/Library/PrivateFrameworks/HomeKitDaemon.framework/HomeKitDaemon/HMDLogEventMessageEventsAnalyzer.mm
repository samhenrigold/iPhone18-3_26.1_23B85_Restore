...
- (void)handlePrimaryResidentChangedNotification:(id)notification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received update primary resident notification but the primary resident is nil", &v15, 0xCu);
    }
...
LABEL_6:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v23 = 2112;
    v24 = eventCopy;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Unknown XPC message counter type - dropping the LogEvent %@", buf, 0x16u);
  }
...
LABEL_17:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
          {
            ...
            v28 = 2112;
            v29 = identifierCopy;
            _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Unable to retrieve eventName for remoteMessage - dropping remote message log event with identifier %@", &v26, 0x16u);
          }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    ...
    v28 = 2112;
    v29 = identifierCopy;
    _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Invalid transport type - dropping remote message log event with identifier %@", &v26, 0x16u);
  }
