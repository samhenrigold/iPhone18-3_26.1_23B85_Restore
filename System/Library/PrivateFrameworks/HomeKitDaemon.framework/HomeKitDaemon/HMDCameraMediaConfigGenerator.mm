...
void __44__HMDCameraMediaConfigGenerator_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_73450;
  logCategory__hmf_once_v9_73450 = v0;
}
...
- (BOOL)extractReselectedConfigFromVideoTier:(id)tier videoStreamConfig:(id *)config
{
  ...
  if (v10 == -1)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v24;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to translate image resolution", &v26, 0xCu);
    }
...
LABEL_4:
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, v18, &v100, 0x16u);
...
LABEL_5:
  ...
  else
  {
    ...
    {
      v36 = (&unk_22A5877F8 + 8 * resolutionType - 8);
    }
    ...
    if (v37 == -1)
    {
      ...
      v100 = 138543362;
      v101 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to translate image resolution", &v100, 0xCu);
      goto LABEL_5;
    }
...
- (BOOL)extractSelectedConfigFromProtocolParameters:(id)parameters videoStreamConfig:(id *)config audioStreamConfig:(id *)streamConfig
{
  ...
  if ([(HMDCameraMediaConfigGenerator *)self _loadAVCVideoStreamConfig:v9 protocolParameters:parametersCopy])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 138543362;
        v22 = v19;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to load audio config from the protocol parameters", &v21, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to load video config from the protocol parameters", &v21, 0xCu);
    }
