...
LABEL_12:
  ...
  if ((v8 & 0x40000) != 0 && [*(a1 + 32) reconfigurationCookie] == v8 && objc_msgSend(*(a1 + 32), "reconfigurationCookie") == v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration successful", &v26, 0xCu);
    }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    v32 = 1024;
    v33 = v23;
    _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit fail-safe Wi-Fi reconfiguration (cookie: %04x, status: %08x, expected cookie: %04x)", &v26, 0x1Eu);
  }
...
LABEL_6:
  ...
  if (reconfigurationState == 2)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration failed - timed out waiting for accessory reconnection", &v12, 0xCu);
    }
...
void __60__HMDWiFiManagementController__accessoryDidBecomeReachable___block_invoke_3(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v6;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration connection verification failed", &v9, 0xCu);
    }
  ...
  if ((v8 & 0x10000) != 0 && [*(a1 + 32) reconfigurationCookie] == v8)
  {
    ...
    if ((v8 & 0x20000) != 0)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 2048;
        *v31 = v23;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration initiated, awaiting accessory disconnect/reconnect with timeout of %ld seconds", &v28, 0x16u);
      }
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 138543362;
      v29 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Wi-Fi reconfiguration without session restart is not supported", &v28, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *v31 = v8;
      v31[2] = 1024;
      *&v31[3] = v20;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate fail-safe Wi-Fi reconfiguration (status: %08x, expected cookie: %04x)", &v28, 0x18u);
    }
...
LABEL_9:
  ...
  v15 = [objc_alloc(MEMORY[0x277CFEC98]) initWithValue:&unk_283E72668];
  [v14 setCookie:v15];
...
LABEL_5:
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Simple Wi-Fi reconfiguration successful", &v17, 0xCu);
    }
...
void __42__HMDWiFiManagementController_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v24_82442;
  logCategory__hmf_once_v24_82442 = v0;
}
