...
- (void)_configureTargetAccessories:(id)accessories reason:(id)reason targetAccessories:(id)targetAccessories responseHandler:(id)handler
{
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v26 = v19;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Configure target accessories", buf, 0xCu);
    }
...
LABEL_29:
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v99 = 2112;
        v100 = uUIDString;
        _os_log_impl(&dword_229538000, v47, OS_LOG_TYPE_ERROR, "%{public}@Attempting to configure targets for a controller %@/%@ that is not configured with a home", buf, 0x20u);
      ...
      if (!home)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138544130;
          ...
          v102 = v101 = 2112;
          v59 = v102;
          _os_log_impl(&dword_229538000, v56, OS_LOG_TYPE_ERROR, "%{public}@Attempting to remove target %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544386;
      ...
      v33 = v32 = 2112;
      v19 = v33;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempting to lookup target %@/%@ for a controller %@/%@ that is not configured with a home", buf, 0x34u);
...
void __44__HMDTargetControllerManager_updateTargets___block_invoke(uint64_t a1)
{
  ...
  v74 = [*(a1 + 32) controller];
  v2 = [v74 home];
  v3 = [*(v1 + 32) targetUUIDs];
  v4 = [MEMORY[0x277CBEB58] setWithArray:*(v1 + 40)];
  v69 = v3;
  ...
  v73 = v6;
  v76 = v1;
  v79 = [v6 countByEnumeratingWithState:&v85 objects:v98 count:16];
  if (v79)
  {
    obj = *v86;
    do
        ...
        if (v9)
        {
          ...
          if (v10)
          {
            if ([v10 isCurrentAccessory])
            {
              ...
              if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543618;
                ...
                v94 = 2112;
                v95 = v16;
                _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@(Update) Adding current target accessory %@", buf, 0x16u);
            ...
            else
            {
              ...
              v26 = [*(v1 + 32) buttonConfiguration];
              v27 = [(HMDTargetConfiguration *)v25 initWithAccessory:v11 buttonConfiguration:v26];
              ...
              if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543874;
                ...
                v96 = 2112;
                v97 = v34;
                _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_INFO, "%{public}@(Update) Adding target accessory %@/%@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              v94 = 2112;
              v95 = v8;
              _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_INFO, "%{public}@Cannot look up target accessory from UUID %@ to add", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v94 = 2112;
            v95 = v8;
            _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Incorrectly formatted target UUID %@ to add", buf, 0x16u);
          }
  ...
  v37 = [MEMORY[0x277CBEB58] setWithArray:v69];
  v38 = [MEMORY[0x277CBEB98] setWithArray:*(v1 + 40)];
  [v37 minusSet:v38];
  ...
  v82 = 0u;
  obja = v37;
  v80 = [obja countByEnumeratingWithState:&v81 objects:v90 count:16];
  if (v80)
  {
    v39 = *v82;
    v75 = *v82;
    while (2)
    {
      for (j = 0; j != v80; ++j)
      {
        ...
        {
          v43 = v42;
          v44 = [v2 accessoryWithUUID:v42];
          if (v44)
          {
            v45 = v44;
            v46 = [*(v1 + 32) targetConfigurationMatchingAccessory:v44];
            ...
            if (!v46)
            {
              if (v50)
              {
                ...
                *buf = 138543874;
                ...
                v96 = 2112;
                v97 = v68;
                _os_log_impl(&dword_229538000, v49, OS_LOG_TYPE_INFO, "%{public}@Attempt to remove a target %@/%@ that cannot be looked up in target controller manager", buf, 0x20u);
            ...
            if (v50)
            {
              ...
              *buf = 138543874;
              ...
              v96 = 2112;
              v97 = v54;
              _os_log_impl(&dword_229538000, v49, OS_LOG_TYPE_INFO, "%{public}@(Update) Removing target accessory %@/%@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              v94 = 2112;
              v95 = v41;
              _os_log_impl(&dword_229538000, v63, OS_LOG_TYPE_INFO, "%{public}@Cannot look up target accessory from UUID %@ to remove", buf, 0x16u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v94 = 2112;
            v95 = v41;
            _os_log_impl(&dword_229538000, v59, OS_LOG_TYPE_INFO, "%{public}@Incorrectly formatted target UUID %@ to remove", buf, 0x16u);
          }
...
void __50__HMDTargetControllerManager_autoConfigureTargets__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v28 = v8;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Preference set to auto-configure existing targets when new target controller is added - configuring them...", buf, 0xCu);
    }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v29 = 2112;
      v30 = v10;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Saving targetUUIDs after auto-configuration of targets - %@", buf, 0x16u);
    }
  ...
  if ([v15 count])
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v46 = 2112;
      v47 = v15;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Registering for notification on active selection characteristics: %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v45 = v29;
      _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Refreshing the active selections on the controller", buf, 0xCu);
    }
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138544130;
          ...
          v32 = v31 = 2112;
          v15 = v32;
          _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Unable to look up target for identifier %@ while reading activeIdentifier characteristic %@/%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received a non-number (%@) for activeIdentifier characteristic %@", buf, 0x20u);
    }
  ...
  if ([v14 count])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544130;
      ...
      v48 = 2112;
      v49 = v24;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@%@ for notifications from event characteristics on controller service %@/%@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543874;
          ...
          v46 = 2112;
          v47 = v35;
          _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_INFO, "%{public}@Unable to look up active characteirstic in controller %@ service %@ for active selection acknowledgement", buf, 0x20u);
        }
...
- (void)_resetTargets
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      if (v10)
      {
        ...
        *buf = 138543618;
        ...
        v22 = 2112;
        v23 = v6;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for resetting targets - error %@", buf, 0x16u);
      }
    ...
    else
    {
      if (v10)
      {
        ...
        *buf = 138543362;
        v21 = v16;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Reset targets for controller", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v21 = v15;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for resetting targets", buf, 0xCu);
    }
...
LABEL_6:
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, v9, &v10, 0xCu);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v13 = 2048;
      v14 = 4;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Encoding for reset target - operation %lu", buf, 0x16u);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v20 = 2112;
        v21 = uUIDString;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Attempt to remove a target %@/%@ that cannot be looked up in target controller manager", buf, 0x20u);
      }
    ...
    if (v6)
    {
      ...
      if (v41)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543874;
          ...
          v58 = 2112;
          v59 = v41;
          _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for removing targets %@ - error %@", buf, 0x20u);
        }
      ...
      else
      {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
                {
                  ...
                  *buf = 138543618;
                  ...
                  v56 = 2112;
                  v57 = v23;
                  _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Target being removed %@ does not have a UUID", buf, 0x16u);
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v55 = v35;
          _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@Remove controller accessory targets", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v56 = 2112;
        v57 = targetsCopy;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for removing targets %@", buf, 0x16u);
      }
...
void __45__HMDTargetControllerManager__removeTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for removing targets %@", &v18, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v12;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully removed targets %@ - response %@", &v18, 0x20u);
    }
        ...
        for (i = 0; i != v10; ++i)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v35 = 2048;
            v36 = v25;
            _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Encoding for remove target - operation %lu  identifier %lu", buf, 0x20u);
          }
...
void __69__HMDTargetControllerManager_addTargetAccessory_buttonConfiguration___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544386;
    ...
    v29 = 2112;
    v30 = v15;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding target accessory %@/%@ with button configuration %@ - target configuration %@", buf, 0x34u);
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v69 = 2112;
          v70 = targetsCopy;
          _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for adding targets %@", buf, 0x16u);
        }
              ...
              else
              {
                ...
                if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138543618;
                  ...
                  v69 = 2112;
                  v70 = v29;
                  _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_ERROR, "%{public}@Target being added %@ does not have a UUID", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v69 = 2112;
        v70 = targetsCopy;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for adding targets %@", buf, 0x16u);
      }
...
void __42__HMDTargetControllerManager__addTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for adding targets %@ - error %@", &v19, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v12;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully added targets %@ configuredTargets %@ - response %@", &v19, 0x2Au);
    }
...
LABEL_22:
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138544386;
            ...
            v76 = 2112;
            v77 = v27;
            _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Adding TLVs for add target operation - identifier %lu  name %s  category %lu  buttonConfiguration: %@", buf, 0x34u);
...
- (void)_updateName:(id)name buttonConfiguration:(id)configuration target:(id)target
{
    ...
    if (nameCopy || [configurationCopy count])
    {
      ...
      if (v12)
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *&buf[42] = 2112;
            *&buf[44] = v20;
            _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for updating %@/%@ with name %@  buttonConfiguration %@", buf, 0x34u);
        ...
        else if ([v13 length])
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
            {
              ...
              *v55 = 138543362;
              v56 = v37;
              _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_INFO, "%{public}@Update target name or button configuration", v55, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *&buf[42] = 2112;
          *&buf[44] = v32;
          _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for updating %@/%@ with name %@  buttonConfiguration %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *&buf[22] = 2112;
      *&buf[24] = v25;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_INFO, "%{public}@Request to update name %@  buttonConfiguration %@ for a nil target", buf, 0x20u);
    }
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544386;
      ...
      v35 = 2112;
      v36 = v11;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for updating %@/%@ with name %@  buttonConfiguration %@", buf, 0x34u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544642;
      ...
      v37 = 2112;
      v38 = v15;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Successfully updated %@/%@ with name %@  buttonConfiguration %@ - response %@", buf, 0x3Eu);
    }
              ...
              else
              {
                ...
                if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
                {
                  ...
                  *buf = 138544130;
                  ...
                  v48 = 2112;
                  v49 = v33;
                  _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_INFO, "%{public}@Encoding for update target - identifier %lu  updatedName %@  buttonConfiguration: %@", buf, 0x2Au);
                }
        ...
        if (v10)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v22 = 2112;
            v23 = v7;
            _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Updated the button configuration for target %@", buf, 0x16u);
          }
...
- (void)_auditTargets:(id)targets
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v69 = 2112;
    v70 = v6;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Read targets %@, Configured targets %@", buf, 0x20u);
  }
      ...
      for (j = 0; j != v24; ++j)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v67 = 2112;
          v68 = v27;
          _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_INFO, "%{public}@Target %@ not present in controller's target list - adding...", buf, 0x16u);
        }
      ...
      for (k = 0; k != v36; ++k)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v67 = 2112;
          v68 = v39;
          _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_INFO, "%{public}@Target %@ present in controller's target list - removing...", buf, 0x16u);
        }
...
- (void)_listTargetsWithCompletionHandler:(id)handler
{
    ...
    if (v8)
    {
      if (v12)
      {
        ...
        *buf = 138543618;
        ...
        v28 = 2112;
        v29 = v8;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Unable to generate serialized data for listing targets - error %@", buf, 0x16u);
      }
    ...
    else
    {
      if (v12)
      {
        ...
        *buf = 138543618;
        ...
        v28 = 2112;
        v29 = v19;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@write target list characteristic %@", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v27 = v17;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@No Target List characteristic to audit configured target accessories - skipping", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v13 = 2048;
      v14 = 1;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Encoding for list target - operation %lu", buf, 0x16u);
    }
...
- (void)_refreshConfigurationWithCompletion:(id)completion
{
  ...
  v26[1] = v26;
  v26[2] = 0x3032000000;
  v26[3] = __Block_byref_object_copy__85560;
  v26[4] = __Block_byref_object_dispose__85561;
  v27 = 0;
  ...
  v21[1] = v21;
  v21[2] = 0x3032000000;
  v21[3] = __Block_byref_object_copy__85560;
  v21[4] = __Block_byref_object_dispose__85561;
  v22 = 0;
  v19[0] = 0;
  v19[1] = v19;
  v19[2] = 0x3032000000;
  v19[3] = __Block_byref_object_copy__85560;
  v19[4] = __Block_byref_object_dispose__85561;
  v20 = 0;
...
uint64_t __66__HMDTargetControllerManager__refreshConfigurationWithCompletion___block_invoke_3(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v9;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Notifying supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", &v12, 0x2Au);
  }
...
- (void)_readSupportedConfigurationWithCompletion:(id)completion
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v24 = 2048;
      v25 = [v8 count];
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Read supported configuration. size: %lu", buf, 0x16u);
    }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v23 = v17;
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@No Supported target Configuration characteristic to refresh the configuration for the controller", buf, 0xCu);
  }
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543874;
          ...
          v57 = 2112;
          v58 = v7;
          _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Error %@ response for reading characteristic %@", buf, 0x20u);
        }
          ...
          if (v31)
          {
            if (v31 == -6727)
            {
              if (v35)
              {
                ...
                *buf = 138543362;
                v54 = v36;
                _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@No data to parse for supported configuration", buf, 0xCu);
              }
            ...
            else
            {
              if (v35)
              {
                ...
                *buf = 138543618;
                ...
                v55 = 2048;
                v56 = v31;
                _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@Parsing supported configuration data failed with error %lu", buf, 0x16u);
          ...
          else
          {
            if (v35)
            {
              ...
              *buf = 138544130;
              ...
              v60 = v59 = 2112;
              v45 = v60;
              _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@Refreshed supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", buf, 0x2Au);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v57 = 2112;
            v58 = v7;
            _os_log_impl(&dword_229538000, v41, OS_LOG_TYPE_INFO, "%{public}@Got unexpected response - attempting to read %@, got %@", buf, 0x20u);
          }
...
LABEL_40:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v54 = v25;
      _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@No responses refreshing controller configuration", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v54 = v18;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for reading supported target configuration characteristic", buf, 0xCu);
    }
...
void __49__HMDTargetControllerManager___accessoryRemoved___block_invoke(uint64_t a1)
{
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v71 = v20;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller has been removed from the home - invalidating...", buf, 0xCu);
    }
            ...
            if (v32)
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543874;
                ...
                v74 = 2112;
                v75 = v46;
                _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessory %@/%@ has been removed", buf, 0x20u);
              }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544386;
        ...
        v79 = v56;
        v57 = v56;
        _os_log_impl(&dword_229538000, v51, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process accessory %@/%@ removal for a controller %@/%@ that is not configured with a home", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v74 = 2112;
      v75 = v39;
      _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@Removed accessory %@/%@ does not support target control - ignoring", buf, 0x20u);
    }
...
void __53__HMDTargetControllerManager___accessoryNameUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v71 = 2112;
    v72 = v11;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of an accessory %@/%@ has been updated", buf, 0x20u);
  }
          ...
          if (v25)
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543874;
              ...
              v71 = 2112;
              v72 = v34;
              _os_log_impl(&dword_229538000, v29, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of target accessory %@ has been updated to %@", buf, 0x20u);
            ...
            if ((v37 & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138544130;
                ...
                v73 = 2112;
                v74 = v43;
                _os_log_impl(&dword_229538000, v40, OS_LOG_TYPE_INFO, "%{public}@Updating the name of target accessory %@/%@ to %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v71 = 2112;
      v72 = v56;
      _os_log_impl(&dword_229538000, v50, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process accessory name update with a controller %@/%@ that is not configured with a home", buf, 0x20u);
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v30 = 2112;
    v31 = v11;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Connected to accessory %@/%@", buf, 0x20u);
  }
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v27 = v22;
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Connected to controller - refreshing the supported target configuration and auditing the list of targets", buf, 0xCu);
      }
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke_59(uint64_t a1, void *a2)
{
  ...
  if (v3 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to refresh the supported target configuration - error %@", &v10, 0x16u);
    }
...
void __54__HMDTargetControllerManager___accessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v11;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Disconnected from accessory %@/%@", &v23, 0x20u);
  }
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v22;
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Disconnected from controller - marking configuation as stale", &v23, 0xCu);
      }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = v21;
            ...
            v32 = 2112;
            v33 = identifier;
            _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Target %@/%@ does not have a UUID", buf, 0x20u);
          }
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating target controller manager", &v8, 0xCu);
  }
...
LABEL_14:
      ...
      if (home)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543874;
          ...
          v84 = 2048;
          v85 = v29;
          _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_INFO, "%{public}@Unable to look up the target with UUID %@ - adding with identifier %lu", buf, 0x20u);
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544130;
        ...
        v86 = 2112;
        v87 = v43;
        _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_ERROR, "%{public}@Attempting to initialize target with UUID %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
...
LABEL_22:
  ...
  if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v82 = 2112;
    v83 = v57;
    _os_log_impl(&dword_229538000, v55, OS_LOG_TYPE_INFO, "%{public}@Initializing target controller manager with targets %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_85611 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t6_85611, &__block_literal_global_85612);
  }

  v3 = logCategory__hmf_once_v7_85613;
...
void __41__HMDTargetControllerManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v7_85613;
  logCategory__hmf_once_v7_85613 = v0;
}
