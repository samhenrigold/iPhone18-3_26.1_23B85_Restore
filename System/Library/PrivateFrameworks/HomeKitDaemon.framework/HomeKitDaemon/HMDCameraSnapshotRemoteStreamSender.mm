...
- (void)snapshotLocal:(id)local didSaveSnapshotFile:(id)file error:(id)error sessionID:(id)d
{
  ...
  if (errorCopy)
  {
    if (v18)
    {
      ...
      v24 = 2112;
      v25 = errorCopy;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Snapshot local capture has ended in %@", &v22, 0x16u);
    }
  ...
  else
  {
    if (v18)
    {
      ...
      v24 = 2112;
      v25 = fileCopy;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Scheduling the transfer of file %@ through IDS", &v22, 0x16u);
    }
...
- (void)sendSnapshotAtPath:(id)path
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = pathCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending the snapshot %@", &v11, 0x16u);
  }
...
void __50__HMDCameraSnapshotRemoteStreamSender_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_15739;
  logCategory__hmf_once_v2_15739 = v0;
}
