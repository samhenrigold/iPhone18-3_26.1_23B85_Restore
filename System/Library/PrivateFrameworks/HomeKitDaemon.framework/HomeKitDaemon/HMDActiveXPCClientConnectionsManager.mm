...
void __76__HMDActiveXPCClientConnectionsManager_handleClientConnectionDidDeactivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling client connection did deactivate: %@", &v8, 0x16u);
  }
...
void __74__HMDActiveXPCClientConnectionsManager_handleClientConnectionDidActivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling client connection did activate: %@", &v8, 0x16u);
  }
...
- (void)removeClientConnection:(id)connection
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = connectionCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing client connection: %@", &v12, 0x16u);
  }
...
- (void)addClientConnection:(id)connection
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = connectionCopy;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Adding client connection: %@", &v12, 0x16u);
  }
...
void __51__HMDActiveXPCClientConnectionsManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v10_263117;
  logCategory__hmf_once_v10_263117 = v0;
}
