...
- (void)markAddUserToHomeEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v24 = 138543362;
    v25 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAddUserToHomeEnd", &v24, 0xCu);
  }
...
- (void)markAddUserToHomeBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAddUserToHomeBegin", &v10, 0xCu);
  }
...
- (void)markJoiningReverseShareEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 138543362;
    v18 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markJoiningReverseShareEnd", &v17, 0xCu);
  }
...
- (void)markJoiningReverseShareBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markJoiningReverseShareBegin", &v10, 0xCu);
  }
...
- (void)markAuthenticateUserEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 138543362;
    v18 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAuthenticateUserEnd", &v17, 0xCu);
  }
...
- (void)markAuthenticateUserBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAuthenticateUserBegin", &v10, 0xCu);
  }
...
void __62__HMDSharedUserInviteOwnerResponseLogEventBuilder_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v14_170071;
  logCategory__hmf_once_v14_170071 = v0;
}
