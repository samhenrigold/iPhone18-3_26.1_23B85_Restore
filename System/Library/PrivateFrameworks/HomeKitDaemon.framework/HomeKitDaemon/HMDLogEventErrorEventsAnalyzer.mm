...
- (HMDLogEventErrorEventsAnalyzer)initWithDataSource:(id)source
{
  ...
  if (v5)
  {
    ...
    v13 = [MEMORY[0x277CBEA60] arrayWithObjects:v16 count:17];
    ...
    [sourceCopy addThresholdTrigger:@"cloudKitImportErrorCount" forEventName:@"Any Error" requestGroup:@"CoreDataCloudKitImportEvent" atThreshold:1];
    [sourceCopy addThresholdTrigger:@"cloudKitExportErrorCount" forEventName:@"Any Error" requestGroup:@"CoreDataCloudKitExportEvent" atThreshold:1];
  }
