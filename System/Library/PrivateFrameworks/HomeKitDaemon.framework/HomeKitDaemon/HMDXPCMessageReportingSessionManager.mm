...
- (void)addResponseMessagePayload:(id)payload toSessionWithUUID:(id)d
{
  ...
  if (responseMessagePayloads)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = dCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Adding response message payload to session with UUID: %@", &v15, 0x16u);
    }
...
- (void)startSessionWithUUID:(id)d reportContext:(id)context xpcClientConnection:(id)connection
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v33 = 2048;
    v34 = v12;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Starting reporting session with UUID: %@, reportDomain: %@, requestInfo: %@, timeout: %fs", &v25, 0x34u);
  }
...
void __51__HMDXPCMessageReportingSessionManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v17_200640;
  logCategory__hmf_once_v17_200640 = v0;
}
