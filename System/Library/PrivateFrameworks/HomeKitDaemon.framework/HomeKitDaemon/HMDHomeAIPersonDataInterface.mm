...
- (void)handleUpdatedIsDataSyncInProgress:(BOOL)progress
{
  ...
  if (isPersonDataAvailableViaHomeKit == progressCopy)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = personManager3;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating personDataAvailableViaHomeKit from %d -> %d on %@", &v17, 0x22u);
    }
...
- (void)handleUpdatedIsCurrentDeviceAvailableResident:(BOOL)resident
{
  ...
  if (supportsFaceClassification != residentCopy)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = personManager3;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating supportsFaceClassification from %d -> %d on %@", &v16, 0x22u);
    }
...
- (void)configureWithDataSource:(id)source home:(id)home
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v12;
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Configuring HomeAI person data interface", &v14, 0xCu);
  }
...
void __65__HMDHomeAIPersonDataInterface_fetchPersonsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v8;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch persons with UUIDs because data is not available", &v11, 0xCu);
    }
