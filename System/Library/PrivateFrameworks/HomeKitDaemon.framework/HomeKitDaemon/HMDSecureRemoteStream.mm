  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification device was removed from account", &v13, 0xCu);
      }
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v12;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification account was removed from registry", &v14, 0xCu);
      }
      ...
      if (v11)
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            v20 = 138543362;
            v21 = v18;
            _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Received notification peer identity was removed", &v20, 0xCu);
          }
...
void __70__HMDSecureRemoteStream_handleSecureMessage_fromDevice_fromTransport___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543618;
    ...
    v30 = 2112;
    v31 = v8;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Received encrypted secure message: %@", buf, 0x16u);
  }
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v30 = 2112;
      v31 = v20;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Unable to map productClass for device %@", buf, 0x16u);
    }
...
void __96__HMDSecureRemoteStream_handleCompletedMessage_options_responsePayload_error_completionHandler___block_invoke(uint64_t a1)
{
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v36 = 2112;
        v37 = v6;
        _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize error with error: %@", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544898;
    ...
    v46 = 2114;
    v47 = v20;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Received response %{public}@ to secure message: %{public}@ and identifier %{public}@, with transport error: %{public}@, error: %{public}@, options: %{public}@", buf, 0x48u);
  }
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v35 = v32;
    _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_INFO, "%{public}@The session is now idle", buf, 0xCu);
  }
...
void __55__HMDSecureRemoteStream_sendMessage_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543618;
    ...
    v42 = 2112;
    v43 = v14;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Sending message: %@", buf, 0x16u);
  }
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543618;
      ...
      v42 = 2112;
      v43 = v17;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Message serialization failed: %@", buf, 0x16u);
    }
  ...
  v28 = MEMORY[0x22AAD2510](*(a1 + 40), *(a1 + 56));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *&location[4] = v27;
      v49 = 2112;
      v50 = v10;
      _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot open stream, failed to get local pairing identity with error: %@", location, 0x16u);
    }
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that remote session has stopped due to error: %@", &v9, 0x16u);
    }
      ...
      if ((v8 & 1) == 0)
      {
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            v25 = 138543362;
            v26 = v16;
            _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Swapping out the local pairing identifier for legacy remote sessions", &v25, 0xCu);
          }
      ...
      if (v13 && v11 != v13)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543874;
          ...
          v78 = 2112;
          v79 = v13;
          _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Peer device resolved from the registry -- tracked: %@, resolved: %@", buf, 0x20u);
...
LABEL_10:
        ...
        if (v32)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v75 = v36;
            _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@Successfully authenticated peer identity", buf, 0xCu);
          }
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v76 = 2112;
          v77 = v50;
          _os_log_impl(&dword_229538000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to authenticate peer identity for device: %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138544130;
          ...
          v80 = 2112;
          v81 = v69;
          _os_log_impl(&dword_229538000, v53, OS_LOG_TYPE_INFO, "%{public}@The provided pairing identity, %@, for peer, %@, is not registered to account: %@", buf, 0x2Au);
...
LABEL_16:
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138543362;
          v75 = v29;
          _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping account authentication check as the peer account is not authenticated", buf, 0xCu);
        }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *buf = 138543618;
            ...
            v76 = 2112;
            v77 = v63;
            _os_log_impl(&dword_229538000, v60, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDSecureSession] Unable to get the 'userID' from destination '%@'", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543874;
        ...
        v78 = 2112;
        v79 = v44;
        _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find identity, %@, for peer: %@", buf, 0x20u);
      }
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v72 = 2112;
        v73 = v23;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Received request to setup reverse secure connection: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v74 = 2112;
        v75 = v49;
        _os_log_impl(&dword_229538000, v44, OS_LOG_TYPE_INFO, "%{public}@Received decrypted secure message, %@, with payload: %@", buf, 0x20u);
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_3_366(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending encrypted secure message %@ to %@ with options:\n%@", &v37, 0x2Au);
    }
    ...
    v31 = v30;
    v32 = [[HMDRemoteMessage alloc] initWithName:v31 destination:v22 payload:v8 type:3 timeout:0 secure:17 restriction:v26];
    v33 = [v6 hmf_stringForKey:@"kRemoteMessageAttributedMessageNameKey"];

    [(HMDRemoteMessage *)v32 setAttributedMessageName:v33];
    v34 = [v14 delegate];
    if ([v34 conformsToProtocol:&unk_283EFF620])
    {
      v35 = v34;
    }
    ...
    if (v36)
    {
      [v36 secureRemoteStream:v14 receivedRequestToSendMessage:v32];
    }
  }
}
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_361(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v34 = 2114;
    v35 = v5;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to decrypted secure message: %{public}@, payload %@ with error: %{public}@", buf, 0x2Au);
  }
...
uint64_t __65__HMDSecureRemoteStream_startAndInvokeOnQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting secure session in %@ mode", &v9, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t98_270774 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t98_270774, &__block_literal_global_397_270775);
  }

  v3 = logCategory__hmf_once_v99_270776;
...
void __36__HMDSecureRemoteStream_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v99_270776;
  logCategory__hmf_once_v99_270776 = v0;
}
