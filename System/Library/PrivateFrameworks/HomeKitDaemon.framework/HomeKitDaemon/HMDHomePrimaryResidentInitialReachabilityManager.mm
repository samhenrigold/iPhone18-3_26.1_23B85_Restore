...
- (void)handlePrimaryResidentUpdated:(id)updated reason:(id)reason
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = persistedState;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping primary resident update for reason: %@, because resident device identifier found in peristed state: %@", &v28, 0x20u);
    }
  ...
  else if (updatedCopy)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = v19;
      _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Persisting primary resident reachability state for reason %@:%@", &v28, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2112;
      v31 = reasonCopy;
      _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted reachability state for reason: %@ because primary resident is nil", &v28, 0x16u);
    }
...
uint64_t __82__HMDHomePrimaryResidentInitialReachabilityManager_handleHomeRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted reachability state because home was removed", &v7, 0xCu);
  }
...
uint64_t __103__HMDHomePrimaryResidentInitialReachabilityManager_handleResidentDeviceEnabledStateChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted reachability state because current device became resident", &v7, 0xCu);
  }
...
- (void)handleResidentDeviceManagerUpdateResidentNotification:(id)notification
{
  ...
  if ([v8 isCurrentDeviceAvailableResident])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 138543362;
      v36 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Not handling resident update notification because current device is a resident", &v35, 0xCu);
    }
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      if (v23)
      {
        if (v27)
        {
          ...
          v39 = 2112;
          v40 = v21;
          _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_INFO, "%{public}@Not handling resident update notification because peristed state: %@ is equal to state: %@", &v35, 0x20u);
        }
      ...
      else
      {
        if (v27)
        {
          ...
          v37 = 2112;
          v38 = v21;
          _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_INFO, "%{public}@Persisting primary resident reachability state: %@", &v35, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        v37 = 2112;
        v38 = v16;
        _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_INFO, "%{public}@Not handling resident update notification because it is for non-primary resident device: %@", &v35, 0x16u);
      }
...
- (void)handlePrimaryResidentUpdateNotification:(id)notification
{
  ...
  if ([v8 isCurrentDeviceAvailableResident])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Not handling primary resident updated notification because current device is a resident", &v17, 0xCu);
    }
  ...
  if ([residentDeviceManager3 isCurrentDeviceAvailableResident])
  {
    ...
    if (persistedState)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 138543362;
        v21 = v18;
        _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted state since current device this device is enabled as a resident", &v20, 0xCu);
      }
...
- (NSNumber)initialReachability
{
  ...
  if (persistedState)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        v24 = persistedState;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Returning reachability as nil, primary resident UUID: %@ not found in persisted state: %@", &v19, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Returning reachability as nil, no persisted state", &v19, 0xCu);
    }
...
void __63__HMDHomePrimaryResidentInitialReachabilityManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_257130;
  logCategory__hmf_once_v5_257130 = v0;
}
