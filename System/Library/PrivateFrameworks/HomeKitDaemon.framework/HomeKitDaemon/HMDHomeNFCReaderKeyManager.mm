...
void __96__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      v34[1] = 3221225472;
      v34[2] = __96__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow_completion___block_invoke_250;
      v34[3] = &unk_27868A7A0;
      v26 = a1[6];
      v35 = v24;
      v36 = v26;
  ...
  else
  {
    ...
    v38[1] = 3221225472;
    v38[2] = __96__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow_completion___block_invoke_248;
    v38[3] = &unk_278688B80;
    v39 = a1[6];
...
uint64_t __96__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully fetched nfc reader key: %@", &v9, 0x20u);
  }
...
void __96__HMDHomeNFCReaderKeyManager_requestDevice_toCreateKeychainItemForReaderKeyWithFlow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      v33[1] = 3221225472;
      v33[2] = __96__HMDHomeNFCReaderKeyManager_requestDevice_toCreateKeychainItemForReaderKeyWithFlow_completion___block_invoke_247;
      v33[3] = &unk_27868A7A0;
      v27 = a1[6];
      v34 = v25;
      v35 = v27;
  ...
  else
  {
    ...
    v36[1] = 3221225472;
    v36[2] = __96__HMDHomeNFCReaderKeyManager_requestDevice_toCreateKeychainItemForReaderKeyWithFlow_completion___block_invoke_246;
    v36[3] = &unk_278688B80;
    v37 = a1[6];
...
uint64_t __96__HMDHomeNFCReaderKeyManager_requestDevice_toCreateKeychainItemForReaderKeyWithFlow_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Resident successfully created keychain item for nfc reader key: %@", &v9, 0x20u);
  }
...
- (void)removeKeychainItemForReaderKey:(id)key home:(id)home flow:(id)flow
{
  ...
  v48 = 0;
  v14 = [keychainStore allKeychainItemsForType:&unk_283E73B20 identifier:v12 syncable:MEMORY[0x277CBEC38] error:&v48];
  v15 = v48;
...
- (void)createReaderKeyInKeychainForHome:(id)home isForceUpdate:(BOOL)update flow:(id)flow
{
  ...
  if (v16)
  {
    ...
    if (createKeychainItemFuture3)
    {
      ...
      v63 = 0;
      v20 = [keychainStore updateKeychainItem:createKeychainItemFuture3 createIfNeeded:1 error:&v63];
      createKeychainItemFuture2 = v63;
      ...
      if (v20)
      {
        ...
        v59[1] = 3221225472;
        v59[2] = __82__HMDHomeNFCReaderKeyManager_createReaderKeyInKeychainForHome_isForceUpdate_flow___block_invoke;
        v59[3] = &unk_27867E7E8;
        v59[4] = v23;
        v50 = v54;
        v60 = v50;
        ...
        v33 = v53;
        v62 = v33;
        [createKeychainItemFuture setResponseHandler:v59];
        if (v51)
        {
        ...
        v49 = [backingStore transaction:@"Creating NFC Reader Key" options:v52];

        [v49 add:v47 withMessage:createKeychainItemFuture];
        v55[0] = MEMORY[0x277D85DD0];
        v55[1] = 3221225472;
        v55[2] = __82__HMDHomeNFCReaderKeyManager_createReaderKeyInKeychainForHome_isForceUpdate_flow___block_invoke_2;
        v55[3] = &unk_278683340;
        v55[4] = v23;
        v56 = v50;
        v57 = v32;
...
LABEL_7:
  ...
  v64[1] = 3221225472;
  v64[2] = __93__HMDHomeNFCReaderKeyManager_createReaderKeyInKeychainForHome_isForceUpdate_flow_completion___block_invoke;
  v64[3] = &unk_27867E798;
  v64[4] = self;
  v24 = createKeychainItemFuture3;
  v65 = v24;
  v66 = completionCopy;
  v34 = [v33 addCompletionBlock:v64];
  ...
  if (!createKeychainItemFuture)
  {
    ...
    if (identifier)
    {
      ...
      v63 = 0;
      v43 = [(HMDHomeNFCReaderKeyManager *)selfCopy3 readerKeyWithKeychainItemIdentifier:v37 error:&v63 flow:flowCopy];
      v56 = v63;
      v44 = objc_autoreleasePoolPush();
      v45 = selfCopy3;
      ...
      else
      {
        ...
        v58[1] = 3221225472;
        v58[2] = __93__HMDHomeNFCReaderKeyManager_createReaderKeyInKeychainForHome_isForceUpdate_flow_completion___block_invoke_237;
        v58[3] = &unk_27867E7C0;
        v58[4] = v45;
        v59 = v37;
        v60 = flowCopy;
        v61 = homeCopy;
        v62 = v57;
        [(HMDHomeNFCReaderKeyManager *)v45 pullFromKeychainWithFlow:v60 completionHandler:v58];
      }
    ...
    {
      [(HMDHomeNFCReaderKeyManager *)self createReaderKeyInKeychainForHome:homeCopy isForceUpdate:v57 flow:flowCopy];
    }
  }
...
void __93__HMDHomeNFCReaderKeyManager_createReaderKeyInKeychainForHome_isForceUpdate_flow_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (v3)
  {
    v12 = [v2 createKeychainItemFuture];
    [v12 finishWithError:*(a1 + 32)];
  }

  else
  {
    v13 = 0;
    v4 = [v2 readerKeyWithKeychainItemIdentifier:*(a1 + 48) error:&v13 flow:*(a1 + 56)];
    v5 = v13;
    if (v4)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v18 = 2112;
        v19 = v4;
        _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Found reader key after keychain pull, returning that: %@", buf, 0x20u);
      }

      objc_autoreleasePoolPop(v6);
      v11 = [*(a1 + 40) createKeychainItemFuture];
      [v11 finishWithResult:v4];
    }
...
- (id)readerKeyWithKeychainItemIdentifier:(id)identifier error:(id *)error flow:(id)flow
{
  ...
  if ([v12 count])
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = identifierCopy;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Found keychain items: %@ for nfc reader key with keychain item identifier: %@", &v21, 0x2Au);
    }
...
LABEL_11:
  ...
  if ([v6 isCurrentDeviceConfirmedPrimaryResident])
  {
    ...
    v39[1] = 3221225472;
    v39[2] = __85__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow___block_invoke;
    v39[3] = &unk_27867E748;
    v13 = v7;
    v40 = v13;
    [(HMDHomeNFCReaderKeyManager *)selfCopy2 createReaderKeyInKeychainForHome:v6 isForceUpdate:0 flow:flowCopy completion:v39];
    v14 = v13;
    primaryResidentDevice = v40;
  }
  ...
  else
  {
    ...
    if (device)
    {
      ...
      v37[1] = 3221225472;
      v37[2] = __85__HMDHomeNFCReaderKeyManager_requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow___block_invoke_227;
      v37[3] = &unk_27867E748;
      v27 = v7;
      v38 = v27;
      [(HMDHomeNFCReaderKeyManager *)self requestDevice:device toCreateKeychainItemForReaderKeyWithFlow:flowCopy completion:v37];
      v14 = v27;
      v28 = v38;
    }
...
void __74__HMDHomeNFCReaderKeyManager_handleHomeDidUpdateNFCReaderKeyNotification___block_invoke_226(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Removing key identifier from keyIdentifiersAlreadyUpdated: %@", &v9, 0x20u);
  }
...
void __67__HMDHomeNFCReaderKeyManager_rollReaderKeyWithFlow_withCompletion___block_invoke(id *a1)
{
  ...
  if (isInternalBuild())
  {
    ...
    if (v7 && v8)
    {
      ...
      v34[0] = MEMORY[0x277D85DD0];
      v34[1] = 3221225472;
      v34[2] = __67__HMDHomeNFCReaderKeyManager_rollReaderKeyWithFlow_withCompletion___block_invoke_222;
      v34[3] = &unk_27868A528;
      v19 = a1[6];
      v20 = a1[4];
      v37 = v19;
...
- (id)fetchOrCreateReaderKeyForPairingWithFlow:(id)flow
{
  ...
  if (isOwner)
  {
    ...
    v32[0] = MEMORY[0x277D85DD0];
    v32[1] = 3221225472;
    v32[2] = __71__HMDHomeNFCReaderKeyManager_fetchOrCreateReaderKeyForPairingWithFlow___block_invoke;
    v32[3] = &unk_278683318;
    v32[4] = v16;
    v33 = flowCopy;
    v34 = home;
...
LABEL_8:
  ...
  v19[1] = 3221225472;
  v19[2] = __71__HMDHomeNFCReaderKeyManager_fetchOrCreateReaderKeyForPairingWithFlow___block_invoke_220;
  v19[3] = &unk_27867E748;
  v17 = v13;
  v20 = v17;
  [v16 createReaderKeyInKeychainForHome:v14 isForceUpdate:0 flow:v15 completion:v19];
...
- (void)fetchOrCreateReaderKeyWithRequiresPrivateKey:(BOOL)key flow:(id)flow completion:(id)completion
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v57 = 2112;
    v58 = v16;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetch or create reader key with requiresPrivateKey: %@", &v53, 0x20u);
  }
  ...
  if (home)
  {
    ...
    if (((isWatch & 1) != 0 || !key) && nfcReaderKey)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        v57 = 2112;
        v58 = v22;
        _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current device is watch or caller does not requires private key, fetched nfc reader key from home graph: %@", &v53, 0x20u);
      }
    ...
    else
    {
      if ([currentUser isAdministrator])
      {
        if ([currentUser privilege] == 4)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            v55 = 2112;
            v56 = uUID3;
            _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is shared admin, sending request to resident to create nfc reader key", &v53, 0x16u);
          }
        ...
        {
          primaryResidentDevice = [(HMDHomeNFCReaderKeyManager *)selfCopy primaryResidentDevice];
          v52 = primaryResidentDevice;
          if (primaryResidentDevice && ([primaryResidentDevice isCurrentDevice] & 1) == 0)
          {
            [(HMDHomeNFCReaderKeyManager *)selfCopy requestDevice:v52 toCreateKeychainItemForReaderKeyWithFlow:flowCopy completion:completionCopy];
          }
        ...
        if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
        {
          ...
          v55 = 2112;
          v56 = uUID4;
          _os_log_impl(&dword_229538000, v48, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is owner. Fetch or create reader key from keychain is not supported on watch", &v53, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          v55 = 2112;
          v56 = uUID5;
          _os_log_impl(&dword_229538000, v40, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Current user is not admin and home key doesn't exist in home graph, returning nil", &v53, 0x16u);
        }
...
LABEL_22:
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
  {
    ...
    v55 = 2112;
    v56 = uUID6;
    _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create reader key, home is nil", &v53, 0x16u);
  }
...
- (void)handleCreateKeychainItemForReaderKeyMessage:(id)message
{
  ...
  if (home)
  {
    v19[0] = MEMORY[0x277D85DD0];
    v19[1] = 3221225472;
    v19[2] = __74__HMDHomeNFCReaderKeyManager_handleCreateKeychainItemForReaderKeyMessage___block_invoke;
    v19[3] = &unk_27867E748;
    v20 = messageCopy;
    [(HMDHomeNFCReaderKeyManager *)selfCopy createReaderKeyInKeychainForHome:home isForceUpdate:0 flow:flow completion:v19];
    v13 = v20;
  }
...
void __41__HMDHomeNFCReaderKeyManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v78_193809;
  logCategory__hmf_once_v78_193809 = v0;
}
