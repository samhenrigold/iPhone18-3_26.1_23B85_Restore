...
- (void)updateWithProgressState:(id)state date:(id)date
{
  ...
  if (stateCopy)
  {
    ...
    [progressStateMap setObject:&unk_283E75068 forKey:stateCopy];
...
LABEL_9:
    ...
    v23 = [(NSMutableDictionary *)self->_progressStateMap keysSortedByValueUsingComparator:&__block_literal_global_269012];
    v24 = [v23 count];
    if (v24)
    {
