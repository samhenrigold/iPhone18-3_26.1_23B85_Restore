...
fst::internal::SymbolTableImpl *fst::internal::SymbolTableImpl::Read(void *a1)
{
  v6 = 0;
  std::istream::read();
  if ((*(a1 + *(*a1 - 24) + 32) & 5) == 0)
...
uint64_t fst::SymbolTable::Write(uint64_t a1, uint64_t a2)
{
  ...
  *&v14[*(v13 - 24) - 8] = *(MEMORY[0x277D82810] + 24);
  MEMORY[0x26D67A340](v14);
  std::ostream::~ostream();
  MEMORY[0x26D67A4B0](v15);
  return v8;
}
...
uint64_t fst::SymbolTable::WriteText(uint64_t a1, uint64_t a2)
{
  ...
  *&v16[*(v15 - 24) - 8] = *(MEMORY[0x277D82810] + 24);
  MEMORY[0x26D67A340](v16);
  std::ostream::~ostream();
  MEMORY[0x26D67A4B0](v17);
  return v8;
}
...
void *std::map<long long,long long>::insert[abi:ne200100]<std::__map_const_iterator<std::__tree_const_iterator<std::__value_type<long long,long long>,std::__tree_node<std::__value_type<long long,long long>,void *> *,long>>>(void *result, void *a2, void *a3)
{
  if (a2 != a3)
  {
    v4 = a2;
    ...
    do
    {
      result = std::__tree<std::__value_type<long long,long long>,std::__map_value_compare<long long,std::__value_type<long long,long long>,std::less<long long>,true>,std::allocator<std::__value_type<long long,long long>>>::__emplace_hint_unique_key_args<long long,std::pair<long long const,long long> const&>(v5, v5 + 1, v4 + 4, v4 + 2);
      v6 = v4[1];
      if (v6)
      {
        do
...
uint64_t std::__tree<std::__value_type<long long,long long>,std::__map_value_compare<long long,std::__value_type<long long,long long>,std::less<long long>,true>,std::allocator<std::__value_type<long long,long long>>>::__emplace_hint_unique_key_args<long long,std::pair<long long const,long long> const&>(void *a1, void *a2, uint64_t *a3, _OWORD *a4)
{
