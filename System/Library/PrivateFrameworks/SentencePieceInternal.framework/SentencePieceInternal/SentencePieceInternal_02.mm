...
void sub_265660208(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, void *__p, uint64_t a17)
{
  if (__p)
  {
    operator delete(__p);
      ...
      *v140 = 0;
      ...
      if (!(((v156[1] + v156[2] * v157) < 0x3B9ACA00) | v131 & 1))
      {
        ...
        if (MinLogLevel <= 1)
        {
          ...
          v80 = MEMORY[0x26675B160](v79, 1000000000);
  ...
  *a1 = &unk_287703CE0;
  ...
  if (v2 != v3)
  {
    do
    {
      if (*v2)
      {
        MEMORY[0x26675B2D0](*v2, 0x1020C8062D53EE8);
      }
...
void sub_265661874(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *a11, uint64_t a12, uint64_t a13, uint64_t a14, void *a15, uint64_t a16, uint64_t a17, uint64_t a18, void *__p, uint64_t a20)
{
  if (__p)
  {
    operator delete(__p);
...
void sentencepiece::unigram::Model::PopulateNodes(sentencepiece::unigram::Model *this, sentencepiece::unigram::Lattice *a2)
{
  ...
  do
  {
    ...
    if (v16 >= v12)
    {
      ...
      v28 = MEMORY[0x26675B160](v27, 572);
...
void sub_265661CAC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, int a13, __int16 a14, char a15, char a16, void *__p, uint64_t a18)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_265661EEC(_Unwind_Exception *a1)
{
...
LABEL_3:
  ...
  else
  {
    ...
    {
      v11 = *(12 * v8 + 4);
      if (a3 - v8 >= asc_2656C45A0[*(a2 + v8) >> 4])
      {
        v12 = asc_2656C45A0[*(a2 + v8) >> 4];
      }
...
void sub_265662AEC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, void *__p)
{
  v17 = *a13;
  if (*a13)
  {
...
LABEL_31:
  ...
  if (sentencepiece::logging::GetMinLogLevel(v16) <= 2)
  {
    ...
    v33 = MEMORY[0x26675B160](v32, 717);
...
LABEL_25:
  ...
  if (v27 > 0.0000001 && sentencepiece::logging::GetMinLogLevel(v26) <= 1)
  {
    ...
    v30 = MEMORY[0x26675B160](v29, 840);
...
void sub_265664420(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_2656645BC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *__p, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a20 < 0)
  {
    operator delete(__p);
...
void sub_265664694(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_26566474C(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
  ...
  *a1 = &unk_287703CB0;
  ...
  if (v2 != v3)
  {
    do
    {
      if (*v2)
      {
        MEMORY[0x26675B2D0](*v2, 0x1070C8005A2B047);
      }
...
void sub_265664B60(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
...
void sub_26566586C(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_265665B2C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_265666F08(_Unwind_Exception *a1)
{
...
void sub_26566703C(_Unwind_Exception *a1)
{
...
void sub_265669A70(_Unwind_Exception *a1)
{
...
void sub_265669DB8(_Unwind_Exception *a1)
{
...
LABEL_4:
  ...
  if (*(this + 21) != &google::protobuf::internal::fixed_address_empty_string)
  {
    ...
    MEMORY[0x26675B300](v9, 0x1012C40EC159624);
  }
  ...
  if (*(this + 22))
  {
    ...
    MEMORY[0x26675B300](v11, 0x1012C40EC159624);
  }
  ...
  if (*(this + 23))
  {
    ...
    MEMORY[0x26675B300](v13, 0x1012C40EC159624);
  }
  ...
  if (*(this + 24))
  {
    ...
    MEMORY[0x26675B300](v15, 0x1012C40EC159624);
  }
  ...
  if (*(this + 25))
  {
    ...
    MEMORY[0x26675B300](v17, 0x1012C40EC159624);
  }
  ...
  if (*(this + 26))
  {
    ...
    result = MEMORY[0x26675B300](v20, 0x1012C40EC159624);
  }
  ...
  if (v22 != &google::protobuf::internal::fixed_address_empty_string)
  {
    ...
    return MEMORY[0x26675B300](v24, 0x1012C40EC159624);
  }
