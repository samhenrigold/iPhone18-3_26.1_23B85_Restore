...
- (GEOAPSequenceActionTargetState)initWithName:(id)name admissionUserAction:(int)action target:(int)target;
...
LABEL_1997:
  ...
  if ([(GEOAPSequenceActionTargetState *)self didTimeoutAt:time])
  {
    v16 = GEOGetGEOAPSequenceStateAnalyticsLog();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      v17 = objc_opt_class();
      v18 = self->super._name;
      *buf = 138412546;
      v31 = v17;
      v32 = 2112;
      v33 = v18;
      v19 = "(%@) state '%@' timed out";
LABEL_2004:
      _os_log_impl(&dword_1AB634000, v16, OS_LOG_TYPE_DEBUG, v19, buf, 0x16u);
      goto LABEL_2005;
    }
  ...
  if ([(NSMutableArray *)self->super._rejectionPairs containsObject:v15])
  {
    v16 = GEOGetGEOAPSequenceStateAnalyticsLog();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      v20 = objc_opt_class();
      v21 = self->super._name;
      *buf = 138412546;
      v31 = v20;
      v32 = 2112;
      v33 = v21;
      v19 = "(%@) state '%@' aborts on input pair";
      goto LABEL_2004;
    }
...
LABEL_2005:
  ...
  if (![(NSMutableArray *)self->_admissionPairs containsObject:v15])
  {
    v22 = 1;
    goto LABEL_2007;
  }

  v24 = GEOGetGEOAPSequenceStateAnalyticsLog();
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
  {
    v25 = objc_opt_class();
    v26 = self->super._name;
    *buf = 138412546;
    v31 = v25;
    v32 = 2112;
    v33 = v26;
    _os_log_impl(&dword_1AB634000, v24, OS_LOG_TYPE_DEBUG, "(%@) state '%@' fulfilled on input pair", buf, 0x16u);
  }

  if (self->super._fulfillmentBlock)
  {
    v27 = GEOGetGEOAPSequenceStateAnalyticsLog();
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138412546;
      ...
      v32 = 2112;
      v33 = v29;
      _os_log_impl(&dword_1AB634000, v27, OS_LOG_TYPE_DEBUG, "(%@) state '%@' will excute fulfillment block", buf, 0x16u);
    }
...
- (void)addAdmissionUserAction:(int)action target:(int)target
{
  v5 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:target | (*&action << 32)];
  [(NSMutableArray *)self->_admissionPairs addObject:v5];
}
...
- (GEOAPSequenceActionTargetState)initWithName:(id)name admissionUserAction:(int)action target:(int)target
{
  ...
  v6 = *&action;
  v12.receiver = self;
  v12.super_class = GEOAPSequenceActionTargetState;
  v7 = [(GEOAPSequenceState *)&v12 initWithName:name];
  v8 = v7;
  if (v7)
  {
    v7->_timeout = 0.0;
    v9 = objc_alloc_init(MEMORY[0x1E695DF70]);
    admissionPairs = v8->_admissionPairs;
    v8->_admissionPairs = v9;

    [(GEOAPSequenceActionTargetState *)v8 addAdmissionUserAction:v6 target:v5];
  }
