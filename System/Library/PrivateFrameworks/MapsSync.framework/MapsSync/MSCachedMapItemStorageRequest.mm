@interface MSCachedMapItemStorageRequest
- (MSCachedMapItemStorageRequest)init;
- (MSCachedMapItemStorageRequest)initWithStore:(id)store;
...
@implementation MSCachedMapItemStorageRequest
...
- (MSCachedMapItemStorageRequest)init
{
  ...
  return [(MSCachedMapItemStorageRequest *)self initWithStore:v3];
}

- (MSCachedMapItemStorageRequest)initWithStore:(id)store
{
  v5 = type metadata accessor for CachedMapItemStorage(0);
