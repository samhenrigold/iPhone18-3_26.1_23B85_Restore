...
uint64_t pg_query_scan(uint64_t a1)
{
  ...
  *v2 = 0u;
  ...
  v48 = 0;
  v47 = 0;
  v44 = xmmword_2797B7790;
  v45 = unk_2797B77A0;
  v46 = xmmword_2797B77B0;
  ...
  else
  {
    ...
    v43 = v3;
    *v9 = v51;
    v14 = scanner_init(v1, v49, &ScanKeywords, &ScanKeywordTokens);
    v16 = -1;
    v17 = -8;
    do
    {
      v18 = v16;
      v19 = v17;
      v20 = core_yylex(&v48, &v47, v14, v15);
      v21 = v18 + 1;
      v22 = v19 + 8;
      v17 = v22;
      v16 = v18 + 1;
    ...
    while (v20);
    scanner_finish(v14);
    v23 = malloc_type_malloc(v22, 0x2004093837F09uLL);
    v24 = scanner_init(v1, v49, &ScanKeywords, &ScanKeywordTokens);
    v26 = core_yylex(&v48, &v47, v24, v25);
    if (v26)
    {
      v27 = v26;
      v28 = v23;
      do
      {
        v31 = malloc_type_malloc(0x28uLL, 0x10600401BE82CDFuLL);
        *v28 = v31;
        scan_token__init = pg_query__scan_token__init(v31);
        v33 = v47;
        *(*v28 + 6) = v47;
        if ((v27 - 258) <= 0x12 && ((1 << (v27 - 2)) & 0x40069) != 0)
        {
          v34 = HIDWORD(v50);
        }
        ...
        *(*v28 + 8) = v27;
        ...
        v30 = *v28++;
        *(v30 + 36) = v29;
        v27 = core_yylex(&v48, &v47, v24, scan_token__init);
      }
    ...
    *&v46 = v21;
    *(&v46 + 1) = v23;
    packed_size = pg_query__scan_result__get_packed_size(&v44, v35);
    *v43 = packed_size;
    v37 = malloc_type_malloc(packed_size, 0x3121CBB5uLL);
    *(v43 + 1) = v37;
    pg_query__scan_result__pack(&v44, v37);
    if (v21)
    {
      v38 = 0;
      do
...
uint64_t pg_query_split_with_scanner(uint64_t a1)
{
  ...
  *v2 = 0u;
  ...
  else
  {
    ...
    v13 = v7;
    *v7 = v41;
    v14 = scanner_init(v1, v39, &ScanKeywords, &ScanKeywordTokens);
    v16 = 0;
    v17 = 0;
    v18 = 0;
    do
    {
      v19 = v17;
      v20 = core_yylex(&v38, &v37, v14, v15);
      if ((v20 - 277) < 0x1C2)
      {
        v16 = 1;
      }
    ...
    *v3 = v21;
    v22 = scanner_init(v1, v39, &ScanKeywords, &ScanKeywordTokens);
    v24 = 0;
    v25 = 0;
    v26 = 0;
    v27 = 0;
    do
    {
      v28 = core_yylex(&v38, &v37, v22, v23);
      v29 = v28;
      if ((v28 - 277) < 0x1C2)
      {
        v27 = 1;
      ...
      else if ((v27 & (v25 == 0)) == 1 && (v28 == 59 || !v28))
      {
