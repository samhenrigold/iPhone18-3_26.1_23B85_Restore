...
- (id)description
{
  ...
  dictionaryRepresentation = [(SharedChannelPublishOffGridPayloadRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (encryptionKey)
  {
    [dictionary setObject:encryptionKey forKey:@"encryption_key"];
  }
