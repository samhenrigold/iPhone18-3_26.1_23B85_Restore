...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDFlagstoneCTCSStabilityMetrics *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (sCntrsStability)
  {
    dictionaryRepresentation2 = [(AWDCtcsReadWriteStabilityS *)sCntrsStability dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v9 = [(AWDCtcsReadWriteStabilityS *)self->_sCntrsStability copyWithZone:zone];
  v10 = v6[3];
  v6[3] = v9;
...
LABEL_11:
  ...
  {
    v7 = [(AWDCtcsReadWriteStabilityS *)sCntrsStability isEqual:?];
  }
