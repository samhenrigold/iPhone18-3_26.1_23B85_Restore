...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = ASCodableCloudKitSample;
  v4 = [(ASCodableCloudKitSample *)&v8 description];
  dictionaryRepresentation = [(ASCodableCloudKitSample *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(ASCodableCloudKitSample *)self setUuid:?];
    fromCopy = v6;
  }
