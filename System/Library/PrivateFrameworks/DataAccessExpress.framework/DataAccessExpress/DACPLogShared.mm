...
- (id)_getUUIDForFolder:(id)folder baseName:(id)name
{
  ...
  *buf = 0;
  ...
  if (v40)
  {
    ...
    v50 = 0;
    v9 = [(DACPLogShared *)self _array:pathComponents beginsWithArray:&unk_2837D0078 outRemainingArray:&v50];
    v10 = v50;
    v11 = v10;
    if (!v9)
    {
      v49 = v10;
      v12 = [(DACPLogShared *)self _array:pathComponents beginsWithArray:&unk_2837D0090 outRemainingArray:&v49];
      v13 = v49;
      ...
      {
        v48 = v13;
        v15 = [(DACPLogShared *)self _array:pathComponents beginsWithArray:&unk_2837D00A8 outRemainingArray:&v48];
        v37 = v48;

        if (!v15)
        {
          v16 = [MEMORY[0x277CBEB18] arrayWithCapacity:{objc_msgSend(pathComponents, "count")}];
          for (i = 1; i - 1 < [pathComponents count]; ++i)
          {
            v18 = [pathComponents objectAtIndexedSubscript:i - 1];
            [v16 addObject:v18];
            ...
            if (v21)
            {
              ...
              pathComponents2 = [v22 pathComponents];
              v24 = [pathComponents2 isEqualToArray:v40];
              ...
              if (v24)
              {
                ...
                {
                  v11 = [pathComponents subarrayWithRange:{i, objc_msgSend(pathComponents, "count") - i}];
                }
...
LABEL_31:
    ...
    if (v30)
    {
      v30 = [v28 characterAtIndex:{objc_msgSend(v28, "length") - 1}];
      if (v30 == 47)
      {
        v31 = [v28 substringToIndex:{objc_msgSend(v28, "length") - 1}];

        v28 = v31;
      }
    }

    v32 = _fileOpsQueue(v30);
    block[0] = MEMORY[0x277D85DD0];
    block[1] = 3221225472;
  ...
  if (*(v52 + 24) == 1)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      *v61 = 138412546;
      ...
      v63 = 2112;
      v64 = nameCopy;
      _os_log_impl(&dword_2243BD000, v34, OS_LOG_TYPE_ERROR, "Get UUID for for folder resulted in an error. Folder: %@. Basename: %@.", v61, 0x16u);
    }
  }
  ...
  *buf = 0;
  ...
  if (*(v53 + 24) == 1)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      *v56 = 138412290;
      v57 = v19;
      _os_log_impl(&dword_2243BD000, v21, OS_LOG_TYPE_ERROR, "Log data resulted in an error. UUID: %@.", v56, 0xCu);
    }
  }
  ...
  *buf = 0;
  ...
  if (*(v64 + 24) == 1)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      *v67 = 138412290;
      v68 = v27;
      _os_log_impl(&dword_2243BD000, v30, OS_LOG_TYPE_ERROR, "Slurp to file UUID resulted in an error. UUID: %@.", v67, 0xCu);
    }
  }
...
void *__160__DACPLogShared__slurpToFileUUID_slurpeeFileDescriptor_prefix_suffix_startNewFile_sizeCheck_wantsCompressed_maxLogFileCount_outDidCreateNewFile_outNewFilePath___block_invoke_118(uint64_t a1)
{
  if (*(a1 + 56) != -1)
  {
