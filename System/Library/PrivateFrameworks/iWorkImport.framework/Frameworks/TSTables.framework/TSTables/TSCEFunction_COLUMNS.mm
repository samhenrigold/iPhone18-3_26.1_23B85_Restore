@interface TSCEFunction_COLUMNS
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments;
@end

@implementation TSCEFunction_COLUMNS
  ...
  if (v20 == 6)
  {
    ...
    if (IsWithinTable)
    {
      ...
      if (v16)
      {
        ...
        objc_msgSend_columnWidthInBodyOfTable_(v59, v60, v58, v61);
      }

      else
      {
        if (!objc_msgSend_spansAllColumns(v54, v55, v56, v57))
        {
          objc_msgSend_numColumns(v58, v70, v71, v72);
LABEL_40:
...
LABEL_23:
      ...
      if (v95)
      {
        if (v16)
        {
          ...
          objc_msgSend_columnWidthInBodyOfTable_(v110, v111, v106, v112);
        }
