...
LABEL_25:
    ...
    v89.i64[0] = objc_msgSend_range(v24, v29, v30, v31);
    v89.i64[1] = v39;
    v42 = objc_msgSend_calcEngine(context, v39, v40, v41);
    v86._tskFormat = objc_msgSend_tableUID(v24, v43, v44, v45);
    *&v86._formatType = v46;
    v32 = objc_msgSend_tableResolverForTableUID_(v42, v46, &v86, v47);
    ...
    if (v32)
    {
      ...
      v57 = vmovn_s64(vmvnq_s8(vceqq_s64(vandq_s8(v89, v56), vdupq_n_s64(0x7FFF00000000uLL))));
      v58 = vuzp1_s16(v57, v57);
      v58.i32[1] = vuzp1_s16(v58, vmovn_s64(vceqq_s64(vandq_s8(v89, v55), vdupq_n_s64(0x7FFFFFFFuLL)))).i32[1];
      if (vminv_u16(v58))
      {
    ...
    v69 = v89.i32[0];
    if ((v89.i32[2] - v89.i32[0] + 1) >= 2)
    {
      v35 = objc_opt_new();
      for (i = 0; v69 <= v89.i32[2]; ++v69)
      {
        TSUDecimal::operator=();
        TSCEFormat::TSCEFormat(&v86, v11, 0);
        v71 = objc_msgSend_numberWithDecimal_format_(TSCENumberValue, v70, v87, &v86);
        objc_msgSend_setValue_atCoord_(v35, v72, v71, &i);
        ++HIDWORD(i);
      }
