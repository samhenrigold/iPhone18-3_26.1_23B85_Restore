@interface TSCEFunction_BIN2HEX
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments;
@end

@implementation TSCEFunction_BIN2HEX
...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  else
  {
    ...
    v14 = objc_msgSend_initWithBase_basePlaces_baseUseMinusSign_(v32, v33, 16, v21, 0);
    v15 = sub_2211F78B4(context, spec, v10, 2, 1, v14);
  }
