...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  else
  {
    if ((objc_msgSend_isDuration(v9, v10, v11, v12) & 1) == 0)
    {
      ...
      v19 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v15, "+[TSCEFunction_DUR2WEEKS evaluateForArgsWithContext:functionSpec:arguments:]", v17);
      ...
      objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v18, v23, v19, v22, 601, 0, "Shouldn't get a non-duration in DUR2WEEKS");
