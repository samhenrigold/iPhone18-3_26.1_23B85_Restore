@interface TSCEFunction_COUPDAYS
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments;
@end

@implementation TSCEFunction_COUPDAYS
...
LABEL_42:
    ...
    if (v53 <= 4 && ((1 << v53) & 0x16) != 0)
    {
      ...
      if (objc_msgSend_compare_(v22, v54, v101, v56) != 1 && objc_msgSend_compare_(v22, v84, v101, v86))
      {
        ...
        specCopy = spec;
        v39 = v101;
        objc_msgSend_getCouponDaysWithSettlementDate_settlement_maturity_numCoupons_dayBasisMode_outError_(TSCEFinancialFunctions, v84, specCopy, v22, v101, v64, &v104, v57);
        v88 = v104;
        if (v88)
        {
          v17 = v88;
