...
+ (id)JSONStringFromNSDictionary:()NSString error:
{
  ...
  if ([MEMORY[0x277CCAAA0] isValidJSONObject:v5])
  {
    ...
    if (v7)
    {
      ...
      v9 = [mainBundle localizedStringForKey:@"NSJSONSerialization failed" value:&stru_287709218 table:0];
  ...
  else
  {
    ...
    v13 = [mainBundle2 localizedStringForKey:@"Invalid dictionary for JSON serialization" value:&stru_287709218 table:0];
    v21[0] = v13;
    v20[1] = *MEMORY[0x277CCA498];
    mainBundle3 = [MEMORY[0x277CCA8D8] mainBundle];
    v15 = [mainBundle3 localizedStringForKey:@"Refer to NSJSONSerialization spec for valid dictionaries" value:&stru_287709218 table:0];
    v21[1] = v15;
