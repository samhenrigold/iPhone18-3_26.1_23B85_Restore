id updatePointsOfInterestHandler.getter()
{
  ...
  v1 = updatePointsOfInterestHandler;

  return v1;
}

uint64_t one-time initialization function for updatePointsOfInterestHandler()
{
...
uint64_t type metadata accessor for NSMutableAttributedString(uint64_t a1, unint64_t *a2, void *a3)
{
  result = *a2;
  if (!*a2)
  {
...
uint64_t @objc DOCConfiguration.canHaveFloatingTabSwitcher.getter(void *a1)
{
  v2 = objc_opt_self();
  v3 = a1;
  if ([v2 enclosingTabSwitcherCanBeFloating])
  {
    v4 = [v3 isPickerUI];
...
BOOL @objc static UITraitCollection.enclosingTabSwitcherCanBeFloating.getter()
{
...
uint64_t static Logger.DocumentManager.getter@<X0>(void *a1@<X0>, uint64_t a2@<X1>, uint64_t a4@<X8>)
{
  if (*a1 != -1)
  {
    swift_once();
...
uint64_t one-time initialization function for DocumentManager(uint64_t a1, uint64_t *a2, uint64_t a3, uint64_t a4)
{
...
uint64_t specialized NSNotification.SubscriptionsController.init(observee:)(uint64_t a1)
{
...
uint64_t NSNotification.SubscriptionsController.startObserving(_:object:queue:handler:)(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  ...
  v14 = v13;
  specialized NSNotification.SubscriptionsController.removeRegistration(_:endObserving:)(v12, v13);
  v15 = [objc_opt_self() defaultCenter];
  outlined init with copy of Any?(a2, aBlock);
  v16 = v40;
  if (v40)
  {
    v17 = __swift_project_boxed_opaque_existential_1(aBlock, v40);
    v35 = v15;
    v36 = a5;
    v34[1] = v34;
    v18 = a1;
    ...
    v20 = a3;
    v21 = *(v16 - 1);
    v22 = MEMORY[0x28223BE20](v17, v17);
    v24 = a4;
    v25 = v34 - ((v23 + 15) & 0xFFFFFFFFFFFFFFF0);
    (*(v21 + 16))(v25, v22);
  ...
  v29[4] = a4;
  v29[5] = a5;
  v41 = partial apply for closure #1 in NSNotification.SubscriptionsController.startObserving(_:object:queue:handler:);
  v42 = v29;
  ...
  v31 = [v15 addObserverForName:a1 object:v26 queue:a3 usingBlock:v30];
  _Block_release(v30);
  ...
  specialized _NativeDictionary.setValue(_:forKey:isUnique:)(v31, v12, v14, isUniquelyReferenced_nonNull_native);
...
uint64_t sub_2493B00D4()
{

  return MEMORY[0x2821FE8E8](v0, 48, 7);
}

uint64_t specialized NSNotification.SubscriptionsController.removeRegistration(_:endObserving:)(uint64_t a1, uint64_t a2)
{
  swift_beginAccess();
  v5 = *(v2 + 24);
  if (*(v5 + 16))
...
uint64_t specialized Dictionary._Variant.removeValue(forKey:)(uint64_t a1, uint64_t a2)
{
  ...
  {
    specialized _NativeDictionary.copy()(&_ss18_DictionaryStorageCySSSo8NSObject_pGMd, &_ss18_DictionaryStorageCySSSo8NSObject_pGMR);
    v8 = v11;
  }
...
{
  return specialized __RawDictionaryStorage.find<A>(_:)(a1, a2, DOCItemFileTypeGroupCategory.hash(into:), specialized __RawDictionaryStorage.find<A>(_:hashValue:));
}
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySSSo8NSObject_pGMd, &_ss18_DictionaryStorageCySSSo8NSObject_pGMR);
}
...
LABEL_10:
        ...
        do
        {
          ...
          if (v8 >= v13)
          {
            if (v4)
            {
              ...
              if (v66 >= 64)
              {
                bzero((v5 + 64), ((v66 + 63) >> 3) & 0x1FFFFFFFFFFFFFF8);
              }
      ...
      v82 = v57;
      v83 = v56;
      outlined init with copy of DOCGridLayout.LayoutCalculator.CalculationVariables(&v69, &v94);
      outlined init with copy of DOCGridLayout(&v80, &v94);
      v104 = v90;
      v105 = v91;
      v106 = v92;
      v107 = v93;
...
LABEL_17:
      ...
      v82 = v110;
      v83 = v111;
      DOCGridLayout.Spec.hash(into:)(&v69);
      CGSize.hash(into:)(*&v68, *(&v68 + 1));
      UIEdgeInsets.hash(into:)(*&v67, *(&v67 + 1), v32, v33);
      if (v34 == 0.0)
      {
        v58 = 0.0;
      }
      ...
      MEMORY[0x24C1FCC00](*&v58);
      result = Hasher._finalize()();
      v59 = -1 << *(v7 + 32);
      v60 = result & ~v59;
      v61 = v60 >> 6;
      if (((-1 << v60) & ~*(v14 + 8 * (v60 >> 6))) == 0)
      {
        v62 = 0;
        v63 = (63 - v59) >> 6;
        v17 = v67;
...
LABEL_38:
      ...
      v15 = __clz(__rbit64((-1 << v60) & ~*(v14 + 8 * (v60 >> 6)))) | v60 & 0x7FFFFFFFFFFFFFC0;
      v17 = v67;
      v16 = v68;
LABEL_7:
...
LABEL_15:
      ...
      if ((v31 & 1) == 0)
      {
        outlined copy of ColumnType(v32, v21);
      }
...
LABEL_15:
      ...
      if ((v40 & 1) == 0)
      {
        outlined copy of DOCSidebarItem(v23, v24, v25, v26, v27, v28);
      }
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables20DOCOperationProgressCyypGGMd, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables20DOCOperationProgressCyypGGMR);
}
...
LABEL_15:
      ...
      if ((v33 & 1) == 0)
      {
        ...
        outlined copy of DOCItemFileTypeGroupCategory(v34, *(&v34 + 1));
      }
...

{
  ...
  v4 = a2;
  v5 = *v2;
  __swift_instantiateConcreteTypeFromMangledNameV2(&_ss18_DictionaryStorageCy26DocumentManagerExecutables28DOCItemFileTypeGroupCategoryOAC20DOCCollectionSectionVGMd, &_ss18_DictionaryStorageCy26DocumentManagerExecutables28DOCItemFileTypeGroupCategoryOAC20DOCCollectionSectionVGMR);
  v36 = v4;
  result = static _DictionaryStorage.resize(original:capacity:move:)();
  v7 = result;
  if (*(v5 + 16))
...
LABEL_15:
      ...
      if ((v36 & 1) == 0)
      {
        outlined copy of DOCItemFileTypeGroupCategory(v21, *(&v21 + 1));
      }
...
LABEL_15:
      ...
      if ((v43 & 1) == 0)
      {
        outlined copy of DOCItemDateGroupCategory(v25, v24, v26);
      }
...
LABEL_15:
      ...
      if (v23)
      {
        ...
        {
          MEMORY[0x24C1FCBD0](1);
          MEMORY[0x24C1FCC00](v25);
          MEMORY[0x24C1FCC00](v24);
        }
...
LABEL_15:
      ...
      if ((v31 & 1) == 0)
      {
        outlined copy of DOCItemSharedByGroupCategory(v32, v21);
        swift_unknownObjectRetain();
      }
...

{
  ...
  v4 = a2;
  v5 = *v2;
  __swift_instantiateConcreteTypeFromMangledNameV2(&_ss18_DictionaryStorageCy26DocumentManagerExecutables28DOCItemSharedByGroupCategoryOAC20DOCCollectionSectionVGMd, &_ss18_DictionaryStorageCy26DocumentManagerExecutables28DOCItemSharedByGroupCategoryOAC20DOCCollectionSectionVGMR);
  v38 = v4;
  result = static _DictionaryStorage.resize(original:capacity:move:)();
  v7 = result;
  if (*(v5 + 16))
...
LABEL_15:
      ...
      if ((v38 & 1) == 0)
      {
        outlined copy of DOCItemSharedByGroupCategory(v21, *(&v21 + 1));
      }
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySo13DOCSourceTypeVSaySo17DOCDocumentSourceCGGMd, &_ss18_DictionaryStorageCySo13DOCSourceTypeVSaySo17DOCDocumentSourceCGGMR);
}
...
LABEL_15:
      ...
      {
        outlined init with copy of AnyHashable(v24, &v43);
        v31 = *(v5 + 56) + 24 * v23;
        v28 = *v31;
        v29 = *(v31 + 8);
        v30 = *(v31 + 16);
        outlined copy of DOCItemCollectionCellContentPool.CellContentPromise(*v31, v29, v30);
      }
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySo8UIButtonCSo23UIDocumentBrowserActionCGMd, &_ss18_DictionaryStorageCySo8UIButtonCSo23UIDocumentBrowserActionCGMR);
}

{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables24DOCFileOperationProgressCGMd, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables24DOCFileOperationProgressCGMR);
}
...
LABEL_15:
      ...
      *&v71[24] = v64;
      *&v71[40] = v33;
      DOCItemCollectionLayoutTraits.ListItemTraits.hash(into:)(v67);
      result = Hasher._finalize()();
      v43 = -1 << *(v7 + 32);
      v44 = result & ~v43;
      v45 = v44 >> 6;
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySo24UIUserInterfaceSizeClassVSaySo18NSLayoutConstraintCGGMd, &_ss18_DictionaryStorageCySo24UIUserInterfaceSizeClassVSaySo18NSLayoutConstraintCGGMR);
}
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySSSo23UIDocumentBrowserActionCGMd, &_ss18_DictionaryStorageCySSSo23UIDocumentBrowserActionCGMR);
}

{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySo8FPItemIDCSo0C0CGMd, &_ss18_DictionaryStorageCySo8FPItemIDCSo0C0CGMR);
}
...
LABEL_15:
      ...
      if (v4)
      {
        outlined init with take of DOCGoToFolderCandidate(v21, v32);
      }

      else
      {
        outlined init with copy of DOCSidebarItemIconProvider(v21, v32);
        v22 = v20;
      }
...
LABEL_7:
      *(v14 + ((v15 >> 3) & 0x1FFFFFFFFFFFFFF8)) |= 1 << v15;
      *(*(v7 + 48) + 8 * v15) = v20;
      result = outlined init with take of DOCGoToFolderCandidate(v32, *(v7 + 56) + 40 * v15);
      ++*(v7 + 16);
    }
...
LABEL_15:
      ...
      {
        outlined init with copy of DOCIdentityHashableLocation(v29, &v52);
        outlined init with copy of DOCIdentityHashableLocation(*(v5 + 56) + 56 * v28, &v48);
      }

      Hasher.init(_seed:)();
      __swift_project_boxed_opaque_existential_1(&v52 + 1, v54);
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables20DOCOperationProgressCyAE16DOCFileOperationVGGMd, _ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables20DOCOperationProgressCyAE16DOCFileOperationVGGMR);
}
...
{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCy26DocumentManagerExecutables15DOCItemSortModeOAC0F27CollectionViewSectionHeaderC0g15ButtonContainerJ033_01DF393BC1153E369869A3FC5380444BLLCGMd, &_ss18_DictionaryStorageCy26DocumentManagerExecutables15DOCItemSortModeOAC0F27CollectionViewSectionHeaderC0g15ButtonContainerJ033_01DF393BC1153E369869A3FC5380444BLLCGMR);
}

{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCy26DocumentManagerExecutables15DOCItemSortModeOSo18NSLayoutConstraintCGMd, &_ss18_DictionaryStorageCy26DocumentManagerExecutables15DOCItemSortModeOSo18NSLayoutConstraintCGMR);
}

{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCySSSo7DOCNode_pGMd, &_ss18_DictionaryStorageCySSSo7DOCNode_pGMR);
}

{
  return specialized _NativeDictionary._copyOrMoveAndResize(capacity:moveElements:)(a1, a2, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables22DOCRelatedNodeObserver33_4D9ABB82B8ED4BF825755B13B5FAF488LLCGMd, &_ss18_DictionaryStorageCys11AnyHashableV26DocumentManagerExecutables22DOCRelatedNodeObserver33_4D9ABB82B8ED4BF825755B13B5FAF488LLCGMR);
}

uint64_t type metadata completion function for DOCThreadSafeState(uint64_t a1)
{
...
uint64_t NSNotification.SubscriptionsController.init(observee:)(uint64_t a1)
{
  v1 = specialized NSNotification.SubscriptionsController.init(observee:)(a1);
  swift_unknownObjectRelease();
  return v1;
}
...
id one-time initialization function for UI()
{
  result = DOCUILogHandle();
  static DOCLog.UI = result;
  return result;
}

_BYTE *destructiveInjectEnumTag for DOCItemGroupingBehavior(_BYTE *result, int a2)
{
  if (a2)
  {
    *result = a2 + 9;
...
void static DOCUserInterfaceStateStore.retrieveDefaultGroupingBehavior(configuration:sourceIdentifier:fallback:)(uint64_t a1@<X0>, void *a2@<X1>, char *a3@<X2>, char *a4@<X8>)
{
  v6 = *a3;
  v55 = 11;
  ...
  v11 = v10;
  v50 = v9;
  groupingBehavior #1 (from:for:) in static DOCUserInterfaceStateStore.retrieveDefaultGroupingBehavior(configuration:sourceIdentifier:fallback:)(v8, v9, v10, v54);
  v12 = v54[0];
  v55 = v54[0];
  v52 = v8;
  if (v54[0] == 11)
  {
    ...
    __swift_project_value_buffer(v13, static Logger.StateStore);
    ...
    if (os_log_type_enabled(v14, v15))
    {
      ...
      *v54 = v17;
      *v16 = 136315394;
      *(v16 + 4) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(0xD000000000000049, 0x8000000249C01890, v54);
      *(v16 + 12) = 2080;
      LOBYTE(v53) = 11;
      __swift_instantiateConcreteTypeFromMangledNameV2(&_s26DocumentManagerExecutables23DOCItemGroupingBehaviorOSgMd, &_s26DocumentManagerExecutables23DOCItemGroupingBehaviorOSgMR);
      v18 = String.init<A>(describing:)();
      v20 = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(v18, v19, v54);

      *(v16 + 14) = v20;
      _os_log_impl(&dword_2493AC000, v14, v15, "%s fetched value: %s could not be converted to DOCItemGroupingBehavior", v16, 0x16u);
      swift_arrayDestroy();
...
LABEL_10:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, v24))
    {
      ...
      *v54 = v26;
      *v25 = 136315650;
      *(v25 + 4) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(0xD000000000000049, 0x8000000249C01890, v54);
      *(v25 + 12) = 2080;
      v53 = v8;
      v27 = v23;
      __swift_instantiateConcreteTypeFromMangledNameV2(&_sSo21DOCUserInterfaceStateCSgMd, &_sSo21DOCUserInterfaceStateCSgMR);
      ...
      *(v25 + 24) = v33;
      _os_log_impl(&dword_2493AC000, v14, v24, "%s couldn't fetch state: %s and grouping value: %s", v25, 0x20u);
      swift_arrayDestroy();
  ...
  __swift_project_value_buffer(v35, static Logger.StateStore);
  v36 = a2;
  ...
  if (os_log_type_enabled(v37, v38))
  {
    ...
    v53 = v40;
    *v39 = 136315906;
    *(v39 + 4) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(0xD000000000000049, 0x8000000249C01890, &v53);
    *(v39 + 12) = 2080;
    ...
    *(v39 + 14) = v43;
    *(v39 + 22) = 2080;
    v44 = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(v50, v11, &v53);
    ...
    *(v39 + 34) = v48;
    _os_log_impl(&dword_2493AC000, v37, v38, "%s fetched: %s for state identifier: %s derived from sourceIdentifier: %s", v39, 0x2Au);
    swift_arrayDestroy();
...
void groupingBehavior #1 (from:for:) in static DOCUserInterfaceStateStore.retrieveDefaultGroupingBehavior(configuration:sourceIdentifier:fallback:)(void *a1@<X0>, uint64_t a2@<X1>, unint64_t a3@<X2>, char *a4@<X8>)
{
  if (!a1)
  {
    if (one-time initialization token for StateStore != -1)
    ...
    if (os_log_type_enabled(v11, v12))
    {
      ...
      *&v52[0] = v14;
      *v13 = 136315138;
      *(v13 + 4) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(0xD00000000000001BLL, 0x8000000249C01920, v52);
      _os_log_impl(&dword_2493AC000, v11, v12, "%s state store was nil", v13, 0xCu);
  ...
  if (!*(&v51 + 1))
  {
    outlined destroy of CharacterSet?(v52, &_sypSgMd, &_sypSgMR);
    goto LABEL_22;
  }
...
LABEL_22:
    ...
    __swift_project_value_buffer(v26, static Logger.StateStore);
    ...
    if (os_log_type_enabled(v27, v28))
    {
      ...
      *&v52[0] = v30;
      *v29 = 136315138;
      *(v29 + 4) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(0xD00000000000001BLL, 0x8000000249C01920, v52);
      _os_log_impl(&dword_2493AC000, v27, v28, "%s groupingBehaviors in state store was nil or couldn't be converted to NSNumber", v29, 0xCu);
...
LABEL_21:
  ...
  outlined init with copy of Any(*(v49 + 56) + 32 * v17, v52);
  if ((swift_dynamicCast() & 1) == 0)
  {
    goto LABEL_21;
  }
...
LABEL_30:
  ...
  outlined init with copy of Any(*(v49 + 56) + 32 * v22, v52);
...
LABEL_31:
  ...
  DOCItemSortMode.init(rawValue:)(v50);
  v25 = LOBYTE(v52[0]);
LABEL_32:
  if (LOBYTE(v50._countAndFlagsBits))
  {
    v32 = v25;
  }
  ...
  __swift_project_value_buffer(v33, static Logger.StateStore);
  v34 = v7;
  ...
  if (os_log_type_enabled(v35, v36))
  {
    ...
    *&v52[0] = v48;
    *v37 = 136315906;
    *(v37 + 4) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(0xD00000000000001BLL, 0x8000000249C01920, v52);
    *(v37 + 12) = 2080;
    __swift_instantiateConcreteTypeFromMangledNameV2(&_s26DocumentManagerExecutables23DOCItemGroupingBehaviorOSgMd, &_s26DocumentManagerExecutables23DOCItemGroupingBehaviorOSgMR);
    v38 = String.init<A>(describing:)();
    v40 = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(v38, v39, v52);

    *(v37 + 14) = v40;
    *(v37 + 22) = 2080;
    *(v37 + 24) = getNullTerminatedUTF8PointerImpl(_:storingStringOwnersIn:)(a2, a3, v52);
    *(v37 + 32) = 2080;
    v41 = v34;
    v42 = [v41 description];
    ...
    *(v37 + 34) = v46;
    _os_log_impl(&dword_2493AC000, v35, v47, "%s fetched value: %s for identifier: %s from state store: %s", v37, 0x2Au);
    swift_arrayDestroy();
...
uint64_t outlined destroy of CharacterSet?(uint64_t a1, uint64_t *a2, uint64_t *a3)
{
...
uint64_t sub_2493B26B4()
{

  return MEMORY[0x2821FE8E8](v0, 40, 7);
}

unint64_t lazy protocol witness table accessor for type DOCUIPDocumentLandingModeTrait and conformance DOCUIPDocumentLandingModeTrait()
{
  result = lazy protocol witness table cache variable for type DOCUIPDocumentLandingModeTrait and conformance DOCUIPDocumentLandingModeTrait;
  if (!lazy protocol witness table cache variable for type DOCUIPDocumentLandingModeTrait and conformance DOCUIPDocumentLandingModeTrait)
  {
    result = swift_getWitnessTable();
    atomic_store(result, &lazy protocol witness table cache variable for type DOCUIPDocumentLandingModeTrait and conformance DOCUIPDocumentLandingModeTrait);
  }

  return result;
}

uint64_t UIView.doc_registerForTraitChanges<A>(_:options:handler:)(uint64_t a1, _BYTE *a2, void (*a3)(uint64_t, void), uint64_t a4, uint64_t a5, unint64_t *a6, void *a7, uint64_t (*a8)(void, void, void, void))
{
  if (a2[8] & 1) == 0 && (*a2)
  {
    v12 = a1;
    v13 = a8;
    type metadata accessor for NSMutableAttributedString(0, a6, a7);
    v14 = v8;
    swift_dynamicCast();
    a3(v16, 0);
    swift_unknownObjectRelease();
  ...
  return (a8)(a1, a3, a4, a5, a5, a6, a7);
}

uint64_t protocol witness for static UITraitDefinition.name.getter in conformance DOCTabSwitcherStyleTrait(uint64_t a1, uint64_t a2, uint64_t *a3, void *a4)
{
  swift_beginAccess();
  v5 = *a3;
...
id static FPItem.modificationDateFormatter.getter(void *a1, void **a2, uint64_t a3)
{
  if (*a1 == -1)
  {
    v4 = *a2;
...
id DOCUILogHandle()
{
  v0 = MEMORY[0x277D06310];
  v1 = *MEMORY[0x277D06310];
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCySo8PropertyVGMd, &_ss23_ContiguousArrayStorageCySo8PropertyVGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables14DOCDisplayModeOGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables14DOCDisplayModeOGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables30DOCActionToolbarItemDescriptorOGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables30DOCActionToolbarItemDescriptorOGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables23DOCItemGroupingBehaviorOGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables23DOCItemGroupingBehaviorOGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    *(v10 + 2) = v8;
    *(v10 + 3) = 2 * v11 - 64;
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables14DOCMetadataKeyOGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables14DOCMetadataKeyOGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables28DOCImageContainerFittingViewC0J4Pair33_21B246C888A0EA67723399696C2617DBLLVGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables28DOCImageContainerFittingViewC0J4Pair33_21B246C888A0EA67723399696C2617DBLLVGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables32DOCGoToSuggestionsViewControllerC7Section33_03A6F4A3946F5CAF17EC184247B3DEF3LLVGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables32DOCGoToSuggestionsViewControllerC7Section33_03A6F4A3946F5CAF17EC184247B3DEF3LLVGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
...

{
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables14AnimationImageVGMd, &_ss23_ContiguousArrayStorageCy26DocumentManagerExecutables14AnimationImageVGMR);
    v10 = swift_allocObject();
    v11 = _swift_stdlib_malloc_size(v10);
    v12 = v11 - 32;
    if (v11 < 32)
