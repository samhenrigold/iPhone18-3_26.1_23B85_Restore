...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = PBBProtoInitialSyncStateUpdate;
  v4 = [(PBBProtoInitialSyncStateUpdate *)&v8 description];
  dictionaryRepresentation = [(PBBProtoInitialSyncStateUpdate *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [MEMORY[0x277CCABB0] numberWithDouble:self->_progress];
    [dictionary setObject:v5 forKey:@"progress"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 20) & 1) == 0 || self->_progress != *(equalCopy + 1))
    {
      goto LABEL_11;
    }
  }
...
- (unint64_t)hash
{
  if (*&self->_has)
  {
    ...
    *v2.i64 = floor(progress + 0.5);
    v6 = (progress - *v2.i64) * 1.84467441e19;
