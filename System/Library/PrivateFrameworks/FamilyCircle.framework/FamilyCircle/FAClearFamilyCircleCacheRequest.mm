...
void __69__FAClearFamilyCircleCacheRequest_startRequestWithCompletionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v5 = 138412290;
    v6 = v3;
    _os_log_impl(&dword_1B70B0000, v4, OS_LOG_TYPE_DEFAULT, "FAClearFamilyCircleCacheRequest: Error from service - %@", &v5, 0xCu);
  }
...
void __69__FAClearFamilyCircleCacheRequest_startRequestWithCompletionHandler___block_invoke_17(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v6 = 138412290;
    v7 = v3;
    _os_log_impl(&dword_1B70B0000, v4, OS_LOG_TYPE_DEFAULT, "Cleared cache with error: %@", &v6, 0xCu);
  }
