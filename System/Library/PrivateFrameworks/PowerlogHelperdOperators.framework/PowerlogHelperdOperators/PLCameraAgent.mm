...
- (void)initOperatorDependancies
{
  ...
  v38 = v12;
  v26 = v12;
  v27 = [v25 initWithOperator:self withRegistration:&unk_287147C58 withBlock:v37];
...
- (void)handleCameraEvent:(id)event withEntryKey:(id)key
{
  ...
  v9 = [v8 countByEnumeratingWithState:&v119 objects:v132 count:16];
  if (!v9)
  {
    goto LABEL_62;
  }
  ...
  do
  {
    ...
    do
    {
      ...
      if (v13)
      {
        v9 = [v13 objectForKeyedSubscript:@"Timestamp"];
        if (v9)
        {
          v15 = v9;
          v16 = [v13 objectForKeyedSubscript:@"Streaming"];
          if (!v16)
          {
            goto LABEL_56;
          }
          ...
          v20 = [v13 objectForKeyedSubscript:@"CameraType"];
          v21 = +[PLCameraAgent checkCameraType:](PLCameraAgent, "checkCameraType:", [v20 intValue]);
          ...
          if (v21 == -1)
          {
            ...
            {
              [(PLCameraAgent *)v128 handleCameraEvent:v13 withEntryKey:&v129, v15];
            }
          ...
          if ((v28 & 1) == 0)
          {
            ...
            v31 = bOOLValue;
            v109 = v21;
            v32 = [MEMORY[0x277CCABB0] numberWithInt:v21];
            ...
            if (v33 && bOOLValue == [v33 BOOLValue])
            {
              if (bOOLValue)
              {
                ...
                v36 = [MEMORY[0x277CCABB0] numberWithInt:v109];
...
LABEL_28:
            ...
            v40 = v109;
            v41 = [MEMORY[0x277CCABB0] numberWithInt:v109];
            ...
            convertFromSystemToMonotonic = [v107 convertFromSystemToMonotonic];
            ...
            else
            {
              ...
              {
                [(PLCameraAgent *)&v117 handleCameraEvent:v118 withEntryKey:v44];
              }
            ...
            v49 = [MEMORY[0x277CCABB0] numberWithInt:v109];
            ...
            if (bOOLValue)
            {
              ...
              v71 = [MEMORY[0x277CCABB0] numberWithBool:v105];
              [v37 setObject:v71 forKeyedSubscript:@"BackgroundBlurEnabled"];

              v72 = [MEMORY[0x277CCABB0] numberWithBool:v105];
              backgroundBlurState2 = [(PLCameraAgent *)selfCopy2 backgroundBlurState];
              v74 = [MEMORY[0x277CCABB0] numberWithInt:v109];
            ...
            if (v85)
            {
              ...
              v87 = [v86 countByEnumeratingWithState:&v113 objects:v127 count:16];
              if (v87)
              {
                v88 = v87;
                v89 = *v114;
                do
                {
                  ...
                  v88 = [v86 countByEnumeratingWithState:&v113 objects:v127 count:16];
                }
...
LABEL_48:
            ...
            v97 = [v13 objectForKeyedSubscript:@"ContinuityCameraType"];
            v98 = [v96 numberWithInteger:{objc_msgSend(v97, "integerValue")}];
            [v37 setObject:v98 forKeyedSubscript:@"ContinuityCameraType"];
...
LABEL_62:
  ...
  if ([array count])
  {
    v123 = keyCopy;
    v124 = array;
    v99 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:&v124 forKeys:&v123 count:1];
...
{
  v3 = *&power;
  v4 = [PLUtilities powerModelForOperatorName:@"camera"];
  ...
  if (v9)
  {
    v11 = [v4 objectForKeyedSubscript:stringValue];
...
- (void)modelFrontCameraPowerWithEntry:(id)entry
{
  ...
  if ([(PLCameraAgent *)self frontCameraIsOn])
  {
    v6 = [(PLCameraAgent *)self getCameraPower:2];
    v5 = v7;
    v8 = PLLogCamera(v6);
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      [(PLCameraAgent *)v8 modelFrontCameraPowerWithEntry:v9, v10, v11, v12, v13, v14, v15, v5];
    }
  }
  ...
  if ([(PLCameraAgent *)self frontCameraIsOn])
  {
    v18 = [entryCopy objectForKeyedSubscript:@"BundleId"];
    v19 = v18;
    v20 = @"com.apple.deadcanary";
    if (v18)
    {
      v20 = v18;
    }

    mEMORY[0x277D3F0C0]5 = v20;
    ...
    [mEMORY[0x277D3F0C0]2 createDistributionEventForwardWithDistributionID:13 withChildNodeNameToWeight:v22 withStartDate:entryDate2];

    mEMORY[0x277D3F0C0]3 = [MEMORY[0x277D3F0C0] sharedInstance];
    entryDate3 = [entryCopy entryDate];
    [mEMORY[0x277D3F0C0]3 createDistributionEventForwardWithDistributionID:43 withChildNodeNameToWeight:v22 withStartDate:entryDate3];
  }
  ...
  else
  {
    ...
    [(__CFString *)mEMORY[0x277D3F0C0]5 createDistributionEventForwardWithDistributionID:43 withChildNodeNameToWeight:v22 withStartDate:mEMORY[0x277D3F0C0]3];
  }
...
- (void)modelBackCameraPowerWithEntry:(id)entry
{
  ...
  if ([(PLCameraAgent *)self backCameraIsOn])
  {
    v6 = [(PLCameraAgent *)self getCameraPower:0];
    v5 = v7;
    v8 = PLLogCamera(v6);
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      [(PLCameraAgent *)v8 modelBackCameraPowerWithEntry:v9, v10, v11, v12, v13, v14, v15, v5];
    }
  }
...
- (void)getCameraPower:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_25EE51000, v0, OS_LOG_TYPE_ERROR, "No camera power model exists for camera class: %@", v1, 0xCu);
}

- (void)modelFrontCameraPowerWithEntry:(uint64_t)a3 .cold.1(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, double a9)
{
  LODWORD(v9) = 134217984;
  *(&v9 + 4) = a9;
  OUTLINED_FUNCTION_0(&dword_25EE51000, a1, a3, "Power value for front camera: %f", a5, a6, a7, a8, v9, DWORD2(v9));
}

- (void)modelBackCameraPowerWithEntry:(uint64_t)a3 .cold.1(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, double a9)
{
  LODWORD(v9) = 134217984;
  *(&v9 + 4) = a9;
  OUTLINED_FUNCTION_0(&dword_25EE51000, a1, a3, "Power value for rear camera: %f", a5, a6, a7, a8, v9, DWORD2(v9));
}
...
+ (void)checkCameraType:(int)a1 .cold.1(int a1, NSObject *a2)
{
  ...
  v2[0] = 67109120;
  v2[1] = a1;
  _os_log_error_impl(&dword_25EE51000, a2, OS_LOG_TYPE_ERROR, "PLCameraAgent checkCameraType undefined camera type: %d", v2, 8u);
}
