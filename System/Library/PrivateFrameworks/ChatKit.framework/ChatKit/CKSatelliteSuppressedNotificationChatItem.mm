...
- (id)loadTranscriptText
{
  ...
  v13 = [v12 localizedStringForKey:@"MESSAGE_STATUS_CHECK_VIA_SATELLITE" value:&stru_1F04268F8 table:@"ChatKit-CarrierPigeon"];
  ...
  [v20 setImage:satelliteSuppressedNotificationIndicatorIcon];
  v21 = [MEMORY[0x1E696AAB0] attributedStringWithAttachment:v20];
  [(NSAttributedString *)v19 insertAttributedString:v21 atIndex:0];

  [(NSAttributedString *)v19 addAttributes:transcriptSatelliteSuppressedNotificationFontAttributes range:0, [(NSAttributedString *)v19 length]];
  satelliteNoNotificationTitleLabelAttributedText = self->_satelliteNoNotificationTitleLabelAttributedText;
  self->_satelliteNoNotificationTitleLabelAttributedText = v19;
  v23 = v19;
