@interface MTLSArc
- (MTLSArc)initWithStrokeWeight:(MTLSArc *)self radius:(SEL)radius scale:(float)scale rotation:(float)rotation translation:(AxisAngle)translation;
- (id).cxx_construct;
@end
