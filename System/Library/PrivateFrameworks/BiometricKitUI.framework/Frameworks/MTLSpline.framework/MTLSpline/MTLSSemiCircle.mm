...
- (MTLSSemiCircle)initWithStrokeWeight:(MTLSSemiCircle *)self radius:(SEL)radius scale:(float)scale rotation:(float)rotation translation:(AxisAngle)translation;
- (id).cxx_construct;
@end
...
- (MTLSSemiCircle)initWithStrokeWeight:(MTLSSemiCircle *)self radius:(SEL)radius scale:(float)scale rotation:(float)rotation translation:(AxisAngle)translation
{
  ...
  *&v10->super._strokeWeight = 0;
  ...
  v20[1] = v14;
  v19.receiver = self;
  v19.super_class = MTLSSemiCircle;
