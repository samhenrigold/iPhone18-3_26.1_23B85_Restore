...
- (_TtC8NewsFeed33DebugFormatCompilerViewController)initWithNibName:(id)name bundle:(id)bundle;
...
- (id)tableView:(id)view cellForRowAtIndexPath:(id)path
{
  ...
  viewCopy = view;
  selfCopy = self;
  v13 = sub_1D720E8A4(viewCopy, v10);
...
- (id)tableView:(id)view titleForHeaderInSection:(int64_t)section
{
  ...
  if (*(*(self + OBJC_IVAR____TtC8NewsFeed33DebugFormatCompilerViewController_sections) + 16) <= section)
  {
LABEL_7:
    __break(1u);
    return self;
