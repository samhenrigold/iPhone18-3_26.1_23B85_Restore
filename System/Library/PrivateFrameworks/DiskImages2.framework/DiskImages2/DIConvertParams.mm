...
- (BOOL)prepareParamsForSquashWithError:(id *)error
{
  ...
  if (v6)
  {
    ...
    *buf = 68157954;
    ...
    LODWORD(v43) = 18;
    v10 = _os_log_send_and_compose_impl(v9, &v44, 0, 0, &dword_248DE0000, v8, 0, "%.*s: Performing in-place squash optimization", buf, v43);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      *buf = 68157954;
      ...
      v47 = 2080;
      v48 = "[DIConvertParams prepareParamsForSquashWithError:]";
      _os_log_impl(&dword_248DE0000, v11, OS_LOG_TYPE_DEFAULT, "%.*s: Performing in-place squash optimization", buf, 0x12u);
    }
  }
  ...
  *__error() = v5;
  ...
  if (![DICreateParams eraseIfExistingWithURL:v12 error:error])
  {
    ...
    if (!v31)
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        *buf = 68157954;
        ...
        v47 = 2080;
        v48 = "[DIConvertParams prepareParamsForSquashWithError:]";
        _os_log_impl(&dword_248DE0000, v36, OS_LOG_TYPE_ERROR, "%.*s: Failed to erase output URL", buf, 0x12u);
      }
    ...
    *buf = 68157954;
    ...
    v48 = "[DIConvertParams prepareParamsForSquashWithError:]";
    LODWORD(v43) = 18;
    v35 = _os_log_send_and_compose_impl(v34, &v44, 0, 0, &dword_248DE0000, v33, 16, "%.*s: Failed to erase output URL", buf, v43);
...
LABEL_38:
  ...
  v15 = [defaultManager copyItemAtURL:inputURL toURL:v12 error:error];
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (!v37)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        *buf = 68157954;
        ...
        v47 = 2080;
        v48 = "[DIConvertParams prepareParamsForSquashWithError:]";
        _os_log_impl(&dword_248DE0000, v41, OS_LOG_TYPE_ERROR, "%.*s: Failed to copy source disk image to temporary URL", buf, 0x12u);
      }
    ...
    *buf = 68157954;
    ...
    v48 = "[DIConvertParams prepareParamsForSquashWithError:]";
    LODWORD(v43) = 18;
    v35 = _os_log_send_and_compose_impl(v40, &v44, 0, 0, &dword_248DE0000, v39, 16, "%.*s: Failed to copy source disk image to temporary URL", buf, v43);
...
LABEL_18:
  ...
  v23 = MEMORY[0x277CCACE0];
  inputURL3 = [(DIBaseParams *)self inputURL];
  v25 = [v23 componentsWithURL:inputURL3 resolvingAgainstBaseURL:1];
  LODWORD(v23) = v25 == 0;
...
LABEL_41:
  ...
  v26 = [MEMORY[0x277CBEB18] arrayWithArray:self->_shadowURLs];
...
- (id)copyUpdatedOutputURLWithError:(id *)error
{
  ...
  if ([inputURL isFileURL])
  {
    ...
    if (!v6)
    {
      ...
      FileLocal::FileLocal(&v11, v9, 0, 0);
    }
  }
    ...
    if (outputParams)
    {
      ...
      if (v9)
      {
        ...
        *buf = 68157954;
        ...
        LODWORD(v55) = 18;
        v13 = _os_log_send_and_compose_impl(v12, &v57, 0, 0, &dword_248DE0000, v11, 16, "%.*s: Due to the conversion error, erasing the output file", buf, v55);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          *buf = 68157954;
          ...
          v60 = 2080;
          v61 = "[DIConvertParams onConvertCompletionWithInError:outError:]";
          _os_log_impl(&dword_248DE0000, v20, OS_LOG_TYPE_ERROR, "%.*s: Due to the conversion error, erasing the output file", buf, 0x12u);
        }
      }
...
LABEL_21:
  ...
  if (v31)
  {
    ...
    *buf = 68158467;
    ...
    v64 = 2113;
    v65 = path2;
    v40 = _os_log_send_and_compose_impl(v34, &v57, 0, 0, &dword_248DE0000, v33, 0, "%.*s: Moving %{private}@ to %{private}@", buf, 38);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 68158467;
      ...
      v64 = 2113;
      v65 = path4;
      _os_log_impl(&dword_248DE0000, v41, OS_LOG_TYPE_DEFAULT, "%.*s: Moving %{private}@ to %{private}@", buf, 0x26u);
    }
  }
...
LABEL_5:
  ...
  if (v11)
  {
    ...
    *buf = 68158210;
    ...
    v33 = 2114;
    selfCopy2 = self;
    v15 = _os_log_send_and_compose_impl(v14, &v28, 0, 0, &dword_248DE0000, v13, 0, "%.*s: entry: %{public}@", buf, 28);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      *buf = 68158210;
      ...
      v33 = 2114;
      selfCopy2 = self;
      _os_log_impl(&dword_248DE0000, v16, OS_LOG_TYPE_DEFAULT, "%.*s: entry: %{public}@", buf, 0x1Cu);
    }
  }
  ...
  *__error() = v10;
  ...
  if (![(DIConvertParams *)self conversionMethod])
  {
    ...
    if (v17)
    {
      ...
      if (!temporaryPassphrase || (-[DIConvertParams temporaryPassphrase](self, "temporaryPassphrase"), v25 = objc_claimAutoreleasedReturnValue(), v26 = -[DICreateParams setPassphrase:encryptionMethod:error:](v18, "setPassphrase:encryptionMethod:error:", [v25 buf], -[DIConvertParams encryptionMethod](self, "encryptionMethod"), error), v25, temporaryPassphrase, v26))
      {
...
void __46__DIConvertParams_convertWithCompletionBlock___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    v11 = 3221225472;
    v12 = __46__DIConvertParams_convertWithCompletionBlock___block_invoke_58;
    v13 = &unk_278F80B88;
    v6 = v3;
    v7 = *(a1 + 32);
    v8 = *(a1 + 40);
