...
- (BOOL)updateStatFSWithError:(id *)error
{
  ...
  {
    objc_msgSend_backend(self);
    sub_10019A824(&v17, &v19);
    v7 = sub_10015F9B4(&v19);
    if (v20)
    {
      sub_10000367C(v20);
    }
...
- (BOOL)isDeviceWithProperty:(const char *)property registryEntryID:(unint64_t)d predicate:(function<BOOL)(iokit_utils::di_io_obj_t
{
  ...
  if (d)
  {
    sub_100049E20(&dCopy, v25);
    sub_100049E98(v25, "device not found in registry", &v23);
    sub_10015607C(v22, 3, &v23);
    sub_100156088(v22, &v20);
    sub_100156240(v22, &v19);
    sub_10004A3EC(v30, a5);
    sub_100049F1C(&v20, &v19, v30, &v21);
    sub_10004A484(v30);
    IOObjectRelease(HIDWORD(v19));
    IOObjectRelease(v19);
    IOObjectRelease(HIDWORD(v20));
    IOObjectRelease(v20);
    sub_100156240(v22, &v18);
    v8 = sub_100156020(&v21, &v18);
