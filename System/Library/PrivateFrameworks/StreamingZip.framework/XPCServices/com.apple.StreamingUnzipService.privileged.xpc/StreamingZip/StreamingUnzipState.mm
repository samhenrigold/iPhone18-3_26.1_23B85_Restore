...
- (id)finishStream
{
  ...
  if (self->_streamState - 5 >= 3)
  {
    ...
    v3 = sub_1000015F4("[StreamingUnzipState finishStream]", 537, @"SZExtractorErrorDomain", 3, 0, 0, @"Finishing an incomplete stream! This stream will not be resumable.", v5, *v8);
    goto LABEL_7;
  }

  if (self->_bytesHashedInChunk)
  {
    v3 = sub_100011D38(self, self->_currentOffset);
LABEL_7:
    v6 = v3;
    goto LABEL_8;
  }
  ...
  if (hashes)
  {
    ...
    if (hashes)
    {
      ...
      else
      {
        ...
        hashes = sub_1000015F4("[StreamingUnzipState updateHashFromOffset:withBytes:length:onlyFinishCurrentChunk:]", 477, @"SZExtractorErrorDomain", 4, 0, 0, @"Ambiguous or missing hash chunk size: chunk size is %llu but have %lu hashes", v14, v13);
      }
    }
  }
...
- (id)checkLastChunkPartialHash
{
  v3 = qword_10001A758[self->_hashContext.hashType];
  ...
  v20[1] = v9;
  sub_10000183C(v20 - ((v3 + 15) & 0xFFFFFFFFFFFFFFF0), v20);
  v10 = sub_10000A428(v20 - ((v3 + 15) & 0xFFFFFFFFFFFFFFF0), v3);
  ...
  if (v11)
  {
    ...
    v17 = sub_1000015F4("[StreamingUnzipState checkLastChunkPartialHash]", 460, @"SZExtractorErrorDomain", 2, 0, v15, @"Hash mismatch for last partial chunk: expected %@, got %@", v16, self->_lastChunkPartialHash);
  }
...
LABEL_7:
    if (self->_streamState == 5)
    {
      ...
      if (hashes && [(NSArray *)hashes count])
      {
        ...
        [v8 encodeBytes:&self->_hashContext.context length:qword_10001A718[self->_hashContext.hashType] forKey:@"HashContext"];
        if (v5)
        {
...
LABEL_59:
    ...
    v2 = sub_1000015F4("[StreamingUnzipState serializeState]", v49, @"SZExtractorErrorDomain", 1, v23, v47, v48, v46, v60);
