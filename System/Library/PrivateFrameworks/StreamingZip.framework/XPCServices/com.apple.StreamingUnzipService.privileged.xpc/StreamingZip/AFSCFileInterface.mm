...
- (BOOL)openOutputFDWithFlags:(int)flags mode:(unsigned __int16)mode quarantineInfo:(void *)info performCachedWrites:(BOOL)writes error:(id *)error
{
  ...
  if (([(AFSCFileInterface *)self outputFD]& 0x80000000) == 0)
  {
    ...
    v17 = sub_1000015F4("[AFSCFileInterface openOutputFDWithFlags:mode:quarantineInfo:performCachedWrites:error:]", 165, @"SZExtractorErrorDomain", 1, 0, 0, @"Output FD is already open refusing to open again for path %@.", v16, v12);;
    goto LABEL_5;
  }

  v52 = 0;
  v20 = sub_10000D8E8([(MemoryBufferStream *)v12 fileSystemRepresentation], flagsCopy, modeCopy, writes, fileSize, &v52);
  if ((v20 & 0x80000000) != 0)
  {
    v17 = v52;
    goto LABEL_5;
  ...
  if (resumptionState)
  {
    ...
    if (v22)
    {
      ...
      *__error() = 0;
      ...
      v39 = sub_1000015F4("_StreamOpenWithState", 59, @"SZAppleArchiveError", v33, v34, 0, @"AAAFSCStreamOpenWithState failed", v38, v50);
      v40 = v39;
      ...
      v17 = sub_1000015F4("[AFSCFileInterface openOutputFDWithFlags:mode:quarantineInfo:performCachedWrites:error:]", 188, @"SZExtractorErrorDomain", 1, v41, 0, @"Failed to resume AAAFSC stream for%@.", v43, v12);
    ...
    sub_1000015F4("[AFSCFileInterface openOutputFDWithFlags:mode:quarantineInfo:performCachedWrites:error:]", 181, @"SZExtractorErrorDomain", 1, v23, 0, @"Failed to create buffer stream for resumption state for %@.", v32, v12);
  }
...
LABEL_18:
    ...
    v46 = sub_1000015F4("_StreamOpen", 45, @"SZAppleArchiveError", v35, v36, 0, @"AAAFSCStreamOpen failed", v45, v50);
    v47 = v46;
    ...
    sub_1000015F4("[AFSCFileInterface openOutputFDWithFlags:mode:quarantineInfo:performCachedWrites:error:]", 197, @"SZExtractorErrorDomain", 1, v23, 0, @"Failed to open AAAFSC stream for %@.", v49, v12);
  }
  v17 = ;
LABEL_40:
