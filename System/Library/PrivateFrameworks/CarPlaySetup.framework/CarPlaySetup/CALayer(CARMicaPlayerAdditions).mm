...
- (void)car_deepCopyLayer
{
  ...
  if (v2)
  {
    ...
    v16 = [car_propertiesToCopy countByEnumeratingWithState:&v37 objects:v46 count:16];
    if (v16)
    {
      v17 = v16;
      v18 = *v38;
      do
      {
        ...
        v17 = [car_propertiesToCopy countByEnumeratingWithState:&v37 objects:v46 count:16];
      }
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [*(*(&v14 + 1) + 8 * v13++) car_addLayerAndSublayersToArray:v6 allowHiddenLayers:a4];
        }
