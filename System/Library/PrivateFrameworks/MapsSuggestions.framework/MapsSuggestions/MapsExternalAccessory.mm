...
- (void)_handleFake:(id)fake
{
  ...
  if ([fakeCopy hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.type"])
  {
    ...
    v9 = [NSNumber numberWithUnsignedInt:sub_10002AAAC(lastObject) | longLongValue];
  ...
  else
  {
    if ([fakeCopy hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.low"])
    {
      v10 = qword_100085630;
      v11 = qword_1000855E8;
      v12 = [NSNumber numberWithUnsignedInt:sub_10002AAAC(lastObject)];
      v13 = [v11 objectForKeyedSubscript:v12];
      [v10 setObject:&__kCFBooleanTrue forKeyedSubscript:v13];

      v14 = qword_100085630;
      v15 = qword_1000855E0;
      v9 = [NSNumber numberWithUnsignedInt:sub_10002AAAC(lastObject)];
    ...
    else
    {
      ...
      v18 = qword_100085630;
      v19 = qword_1000855E8;
      v20 = [NSNumber numberWithUnsignedInt:sub_10002AAAC(lastObject)];
...
- (void)_postNotificationIfNeeded
{
  ...
  v6 = sub_10002BB88(_isCurrentStateEqualLastPostedState);
  currentState3 = v6;
  if (!v5)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
