  ...
  if (WeakRetained)
  {
    ...
    if ((v7 & 0x100) != 0)
    {
      if (v10)
      {
        ...
        *buf = 138543362;
        v20 = v12;
        _os_log_impl(&dword_26CF7F000, v9, OS_LOG_TYPE_DEFAULT, "RPMediaControlFlagsVolume available for <%{public}@>", buf, 0xCu);
      }
    ...
    else
    {
      if (v10)
      {
        ...
        *buf = 138543362;
        v20 = v11;
        _os_log_impl(&dword_26CF7F000, v9, OS_LOG_TYPE_DEFAULT, "RPMediaControlFlagsVolume not available for companionLinkClient <%{public}@>", buf, 0xCu);
      }
...
- (void)invalidate
{
  ...
  v4 = _TVRCRapportLog([(TVRCRapportMediaEventsManager *)self setMediaSession:0]);
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    *v5 = 0;
...
- (void)sendMediaEvent:(id)event
{
  ...
  if ((buttonType - 16) > 2)
  {
    ...
    if (v9 == 7)
    {
      ...
      v23[1] = 3221225472;
      v23[2] = __48__TVRCRapportMediaEventsManager_sendMediaEvent___block_invoke_6;
    ...
    else
    {
      ...
      v21[1] = 3221225472;
      v21[2] = __48__TVRCRapportMediaEventsManager_sendMediaEvent___block_invoke_7;
...
void __48__TVRCRapportMediaEventsManager_sendMediaEvent___block_invoke_6(uint64_t a1, void *a2)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      __48__TVRCRapportMediaEventsManager_sendMediaEvent___block_invoke_6_cold_1();
    }
  }
}
...
{
  v10 = *MEMORY[0x277D85DE8];
  supportsDirectCaptionQueries = [(TVRCRapportMediaEventsManager *)self supportsDirectCaptionQueries];
...
void __48__TVRCRapportMediaEventsManager_sendMediaEvent___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138543362;
  v3 = a1;
  _os_log_error_impl(&dword_26CF7F000, a2, OS_LOG_TYPE_ERROR, "Could not set media caption setting for companionLinkClient, error - %{public}@", &v2, 0xCu);
}
...
void __53__TVRCRapportMediaEventsManager__refreshCaptionState__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138543362;
  v3 = a1;
  _os_log_error_impl(&dword_26CF7F000, a2, OS_LOG_TYPE_ERROR, "Could not get current caption settings error= %{public}@", &v2, 0xCu);
}
