...
uint64_t __49__SFDeviceSetupTVColorCalibratorService_activate__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v3 = a1;
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
  {
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (a1 = _LogCategory_Initialize(), a1))
    {
      __49__SFDeviceSetupTVColorCalibratorService_activate__block_invoke_cold_1(a1, a2, a3);
    }
  }
...
void *__51__SFDeviceSetupTVColorCalibratorService_invalidate__block_invoke(void *result, uint64_t a2, uint64_t a3)
{
  if ((*(result[4] + 10) & 1) == 0)
  {
    v4 = result;
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
    {
      if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (result = _LogCategory_Initialize(), result))
      {
        __51__SFDeviceSetupTVColorCalibratorService_invalidate__block_invoke_cold_1(result, a2, a3);
      }
    }
...
- (void)_invalidate
{
  if (!self->_invalidateDone)
  {
    ...
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
    {
      if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (v5 = _LogCategory_Initialize(), v5))
      {
        [(SFDeviceSetupTVColorCalibratorService *)v5 _invalidate];
      }
    }
  }
}
...
LABEL_215:
    LogPrintF(&gLogCategory_SFDeviceSetupTVColorCalibratorService, "[SFDeviceSetupTVColorCalibratorService _reportProgress:info:]", 30, "Progress: %s, %##@\n", v7, v6);
  }
...
- (void)sendSetupAction:(unsigned int)action info:(id)info responseHandler:(id)handler
{
  ...
  if (self->_sfSession)
  {
    ...
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30 && (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || _LogCategory_Initialize()))
    {
      [SFDeviceSetupTVColorCalibratorService sendSetupAction:v6 info:v13 responseHandler:?];
    }
...
- (void)_sfServiceStart
{
  ...
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
  {
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (self = _LogCategory_Initialize(), self))
    {
      [(SFDeviceSetupTVColorCalibratorService *)self _sfServiceStart];
    }
  }
  ...
  [(SFService *)selfCopy->_sfService setDeviceActionType:30];
  ...
  [(SFService *)selfCopy->_sfService setLabel:@"TVColorCalibration"];
  ...
  [(SFService *)selfCopy->_sfService setSessionStartedHandler:v11];
...
void __56__SFDeviceSetupTVColorCalibratorService__sfServiceStart__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    {
      __56__SFDeviceSetupTVColorCalibratorService__sfServiceStart__block_invoke_3_cold_1(v3);
    }
...
- (void)_handleSessionEnded:(id)ended
{
  ...
  if (endedCopy && gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
  {
    ...
    LogPrintF(&gLogCategory_SFDeviceSetupTVColorCalibratorService, "[SFDeviceSetupTVColorCalibratorService _handleSessionEnded:]", 30, "Ending session with %@\n", peer);
  }

LABEL_7:
  [(SFDeviceSetupTVColorCalibratorService *)self _reportProgress:32 info:0];
  ...
  if (self->_invalidateCalled && !self->_invalidateDone)
  {
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
    {
      if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (v9 = _LogCategory_Initialize(), v9))
      {
        [(SFDeviceSetupTVColorCalibratorService *)v9 _handleSessionEnded:endedCopy, v10];
      }
    }
...
- (void)_handleTVLatencyRequest:(id)request responseHandler:(id)handler
{
  ...
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30 && (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || _LogCategory_Initialize()))
  {
    [SFDeviceSetupTVColorCalibratorService _handleTVLatencyRequest:requestCopy responseHandler:?];
  }
  ...
  if (messageSessionTemplate)
  {
    ...
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
    {
      if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (messageSessionTemplate = _LogCategory_Initialize(), messageSessionTemplate))
      {
        [(SFDeviceSetupTVColorCalibratorService *)messageSessionTemplate _handleTVLatencyRequest:v9 responseHandler:v10];
      }
    }

    v12 = [objc_alloc(getTVLDisplayColorCalibratorClass_0()) initWithMessageSession:v11];
    tvColorCalibrator = self->_tvColorCalibrator;
    self->_tvColorCalibrator = v12;

    v16 = MEMORY[0x1E69E9820];
    v17 = 3221225472;
    v18 = __81__SFDeviceSetupTVColorCalibratorService__handleTVLatencyRequest_responseHandler___block_invoke;
    v19 = &unk_1E788B598;
    selfCopy = self;
    v21 = v12;
    v14 = v12;
    [(TVLDisplayColorCalibrator *)v14 setProgressEventHandler:&v16];
    [(TVLDisplayColorCalibrator *)v14 activate:v16];
...
LABEL_10:
  ...
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 90 && (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || _LogCategory_Initialize()))
  {
    [SFDeviceSetupTVColorCalibratorService _handleTVLatencyRequest:v15 responseHandler:?];
  }
...
id *__81__SFDeviceSetupTVColorCalibratorService__handleTVLatencyRequest_responseHandler___block_invoke_2(id *result)
{
  if (result[4] == *(result[5] + 4))
  {
    return [result[5] _handleTVColorCalibratorProgressEvent:result[7] info:result[6]];
  }
...
- (void)_handleTVColorCalibratorProgressEvent:(unint64_t)event info:(id)info
{
  ...
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
  {
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (infoCopy = _LogCategory_Initialize(), v7 = v10, infoCopy))
    {
      infoCopy = LogPrintF(&gLogCategory_SFDeviceSetupTVColorCalibratorService, "[SFDeviceSetupTVColorCalibratorService _handleTVColorCalibratorProgressEvent:info:]", 30, "TVLatency progress: %d, %##.32@\n", event, v7);
    }
  }
  ...
  if (event == 2)
  {
    ...
    v9 = 280;
LABEL_17:
    infoCopy = [(SFDeviceSetupTVColorCalibratorService *)selfCopy4 _reportProgress:v9 info:v10];
    goto LABEL_18;
  }
  ...
  {
    infoCopy = [(SFDeviceSetupTVColorCalibratorService *)self _reportProgress:282 info:v10];
...
- (void)_handleFinishRequest:(id)request responseHandler:(id)handler
{
  ...
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
  {
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (handlerCopy = _LogCategory_Initialize(), handlerCopy))
    {
      handlerCopy = [SFDeviceSetupTVColorCalibratorService _handleFinishRequest:requestCopy responseHandler:?];
    }
  }

  if (!self->_eventFinalDelivered)
  {
    handlerCopy = [(SFDeviceSetupTVColorCalibratorService *)self _reportProgress:282 info:MEMORY[0x1E695E0F8]];
    self->_eventFinalDelivered = 1;
  }
  ...
  if (gLogCategory_SFDeviceSetupTVColorCalibratorService <= 30)
  {
    if (gLogCategory_SFDeviceSetupTVColorCalibratorService != -1 || (handlerCopy = _LogCategory_Initialize(), handlerCopy))
    {
      [(SFDeviceSetupTVColorCalibratorService *)handlerCopy _handleFinishRequest:v7 responseHandler:v8];
    }
  }
...
- (uint64_t)sendSetupAction:(unsigned int)a1 info:(uint64_t)a2 responseHandler:.cold.1(unsigned int a1, uint64_t a2)
{
  ...
  return LogPrintF(&gLogCategory_SFDeviceSetupTVColorCalibratorService, "[SFDeviceSetupTVColorCalibratorService sendSetupAction:info:responseHandler:]", 30, "SetupActionRequest: %s, %##.32@\n", v4, a2, v2, v3);
}
...
- (void)_handleSessionStarted:(void *)a3 .cold.1(int a1, void **a2, void *a3, void *a4)
{
  if (a1 <= 60)
  {
    ...
    v7 = [a3 peer];
    v5 = [a4 peer];
    LogPrintF(&gLogCategory_SFDeviceSetupTVColorCalibratorService, "[SFDeviceSetupTVColorCalibratorService _handleSessionStarted:]", 60, "### Ignoring session when already active: existing peer %@, new peer %@\n", v7, v5);
  }
}
...
{
  v1 = [a1 peer];
  LogPrintF(&gLogCategory_SFDeviceSetupTVColorCalibratorService, "[SFDeviceSetupTVColorCalibratorService _handleSessionStarted:]", 30, "Starting session with %@\n", v1);
}
