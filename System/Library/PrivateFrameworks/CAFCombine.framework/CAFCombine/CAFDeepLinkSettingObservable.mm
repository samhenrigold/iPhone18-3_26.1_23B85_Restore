...
- (void)automakerSettingService:(id)service didUpdateSortOrder:(unsigned __int8)order
{
  serviceCopy = service;
  selfCopy = self;
  CAFDeepLinkSettingObservable.automakerSettingService(_:didUpdateSortOrder:)(selfCopy, order);
}
...
- (void)automakerSettingService:(id)service didUpdateCategory:(unsigned __int8)category
{
  serviceCopy = service;
  selfCopy = self;
  CAFDeepLinkSettingObservable.automakerSettingService(_:didUpdateCategory:)(selfCopy, category);
}
...
- (void)automakerSettingService:(id)service didUpdateDisabled:(BOOL)disabled
{
  ...
  serviceCopy = service;
  selfCopy = self;
  CAFDeepLinkSettingObservable.automakerSettingService(_:didUpdateDisabled:)(selfCopy, disabledCopy);
}
...
- (void)automakerSettingService:(id)service didUpdateLimitableUIElement:(BOOL)element
{
  ...
  serviceCopy = service;
  selfCopy = self;
  CAFDeepLinkSettingObservable.automakerSettingService(_:didUpdateLimitableUIElement:)(selfCopy, elementCopy);
}
...
- (void)automakerSettingService:(id)service didUpdateHidden:(BOOL)hidden
{
  ...
  serviceCopy = service;
  selfCopy = self;
  CAFDeepLinkSettingObservable.automakerSettingService(_:didUpdateHidden:)(selfCopy, hiddenCopy);
}
...
- (void)automakerSettingService:(id)service didUpdateShowAudioBrandLogo:(BOOL)logo
{
  ...
  serviceCopy = service;
  selfCopy = self;
  CAFDeepLinkSettingObservable.automakerSettingService(_:didUpdateShowAudioBrandLogo:)(selfCopy, logoCopy);
}
