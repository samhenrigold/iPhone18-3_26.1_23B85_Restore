...
- (void)settingsSectionService:(id)service didUpdateSortOrder:(unsigned __int8)order;
@end
...
- (void)serviceDidUpdate:(id)update characteristic:(id)characteristic fromGroupUpdate:(BOOL)groupUpdate
{
  ...
  selfCopy = self;
  CAFSettingsSectionObservable.serviceDidUpdate(_:characteristic:fromGroupUpdate:)(selfCopy, v10, groupUpdate);
}
...
- (void)serviceDidUpdate:(id)update receivedAllValues:(BOOL)values
{
  updateCopy = update;
  selfCopy = self;
  CAFSettingsSectionObservable.serviceDidUpdate(_:receivedAllValues:)(selfCopy, values);
}
