...
- (BOOL)isEqualToAssets:(id)assets
{
  assetsCopy = assets;
  v5 = assetsCopy;
  if (!assetsCopy || (v6 = self->_cloudKit == 0, [assetsCopy cloudKit], v7 = objc_claimAutoreleasedReturnValue(), v8 = v7 != 0, v7, v6 == v8) || (cloudKit = self->_cloudKit) != 0 && (objc_msgSend(v5, "cloudKit"), v10 = objc_claimAutoreleasedReturnValue(), v11 = -[NSDictionary isEqual:](cloudKit, "isEqual:", v10), v10, !v11) || (v12 = self->_mobileAsset == 0, objc_msgSend(v5, "mobileAsset"), v13 = objc_claimAutoreleasedReturnValue(), v14 = v13 != 0, v13, v12 == v14))
  {
    v17 = 0;
  }
  ...
  else
  {
    ...
    if (mobileAsset)
    {
      ...
      v17 = [(NSDictionary *)mobileAsset isEqual:mobileAsset];
    }
