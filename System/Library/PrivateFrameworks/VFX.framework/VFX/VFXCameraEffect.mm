...
{
  v10.receiver = self;
  v10.super_class = VFXCameraEffect;
  v2 = [(VFXCameraEffect *)&v10 init];
  v5 = v2;
  if (v2)
  {
    v2->_enabled = 1;
    v2->_animationsLock._os_unfair_lock_opaque = 0;
    CFXObject = objc_msgSend_createCFXObject(v2, v3, v4);
    v5->_cameraEffect = CFXObject;
    if (CFXObject)
    {
      sub_1AF16CDFC(CFXObject, v5);
    }

    objc_msgSend__updateModelFromPresentation(v5, v7, v8);
  }
...
- (void)dealloc
{
  ...
  if (cameraEffect)
  {
    ...
    objc_msgSend_postReleaseCommandWithCFXObject_(VFXTransaction, a2, cameraEffect);
  }

  v4.receiver = self;
  v4.super_class = VFXCameraEffect;
...
+ (id)presentationCameraEffectWithCameraEffectRef:(__CFXCameraEffect *)ref
{
  ...
  inited = objc_msgSend_initPresentationCameraEffectWithCameraEffectRef_(v4, v5, ref);
...
- (id)presentationObject
{
  ...
  if ((*(self + 28) & 1) == 0)
  {
    ...
    inited = objc_msgSend_initPresentationCameraEffectWithCameraEffectRef_(v3, v4, selfCopy[1]);
...
- (void)removeAllAnimations
{
  ...
  if (v16 <= 0.0)
  {
    objc_msgSend_postCommandWithObject_applyBlock_(VFXTransaction, v14, self, v20, MEMORY[0x1E69E9820], 3221225472, sub_1AF2AAC9C, &unk_1E7A7E1D0, self, v21[0], v21[1], v21[2], v21[3], v21[4], v21[5], v21[6]);
  }
  ...
  else
  {
    ...
    objc_msgSend_postCommandWithObject_applyBlock_(VFXTransaction, v19, self, v21, v20[0], v20[1], v20[2], v20[3], v20[4], MEMORY[0x1E69E9820], 3221225472, sub_1AF2AAC8C, &unk_1E7A7E2E8, self, v18, *&v17);
  }
}
...
- (id)_valueForSimdVectorKeyPath:(id)path
{
  v26 = 0;
  v25 = 0;
  sub_1AF3716AC(path, &v26, &v25);
  if (qword_1ED73B310 != -1)
  {
    sub_1AFDF4F74();
  }

  if (!v25 || !objc_msgSend_containsObject_(qword_1ED73B308, v4, v25))
  {
    return 0;
  }
  ...
  v22 = 0.0;
  v23 = 0;
  if (objc_msgSend_rawFloat3ForKey_value_(self, v5, v26, &v23))
  {
    if (objc_msgSend_isEqualToString_(v25, v6, @"x"))
    {
      LODWORD(v9) = v23;
      return objc_msgSend_numberWithFloat_(MEMORY[0x1E696AD98], v7, v8, v9);
    }

    if (objc_msgSend_isEqualToString_(v25, v7, @"y"))
    {
      LODWORD(v13) = HIDWORD(v23);
      return objc_msgSend_numberWithFloat_(MEMORY[0x1E696AD98], v11, v12, v13);
    }

    if (objc_msgSend_isEqualToString_(v25, v11, @"z"))
    {
      LODWORD(v15) = v24;
  ...
  if (!objc_msgSend_rawFloat2ForKey_value_(self, v6, v26, &v22))
  {
    return 0;
  }

  if (objc_msgSend_isEqualToString_(v25, v16, @"x"))
  {
    return objc_msgSend_numberWithFloat_(MEMORY[0x1E696AD98], v17, v18, v22);
  }

  if (!objc_msgSend_isEqualToString_(v25, v17, @"y"))
  {
    return 0;
  }

  LODWORD(v21) = HIDWORD(v22);
  return objc_msgSend_numberWithFloat_(MEMORY[0x1E696AD98], v19, v20, v21);
}
...
- (id)valueForKeyPath:(id)path
{
  ...
  {
    v6.receiver = self;
    v6.super_class = VFXCameraEffect;
    return [(VFXCameraEffect *)&v6 valueForKeyPath:path];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  objc_msgSend_setEnabled_(v4, v5, self->_enabled);
  return v4;
}
...
{
  v19.receiver = self;
  v19.super_class = VFXCameraEffect;
  v6 = [(VFXCameraEffect *)&v19 init];
  if (v6)
  {
    v7 = objc_msgSend_immediateMode(VFXTransaction, v4, v5);
    objc_msgSend_setImmediateMode_(VFXTransaction, v8, 1);
    CFXObject = objc_msgSend_createCFXObject(v6, v9, v10);
    ...
    v15 = objc_msgSend_decodeBoolForKey_(coder, v14, @"enabled");
    objc_msgSend_setEnabled_(v6, v16, v15);
    v6->_animationsLock._os_unfair_lock_opaque = 0;
    sub_1AF37249C(coder, v6);
    sub_1AF372B94(coder, v6);
    objc_msgSend_setImmediateMode_(VFXTransaction, v17, v7);
  }
