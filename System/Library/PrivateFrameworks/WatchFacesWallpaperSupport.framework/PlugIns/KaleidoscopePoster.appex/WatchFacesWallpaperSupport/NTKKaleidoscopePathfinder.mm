    ...
    if (v9.f64[0] < 2.0 || v9.f64[1] < 2.0)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        *buf = 138412802;
        ...
        v49 = 1024;
        v50 = v10;
        _os_log_error_impl(&_mh_execute_header, v12, OS_LOG_TYPE_ERROR, "[kaleidoscope pathfinder cache] nil pathfinder for image %@ (%d x %d), returning early", buf, 0x18u);
      }
      ...
      if (v9.f64[0] < 188 || v15 <= 187)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
        {
          *buf = 138412802;
          ...
          v49 = 1024;
          v50 = v15;
          _os_log_impl(&_mh_execute_header, v25, OS_LOG_TYPE_DEFAULT, "[kaleidoscope pathfinder cache] poor quality pathfinder for image %@ (%d x %d)", buf, 0x18u);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138412546;
      ...
      v17 = 2112;
      v18 = v13;
      _os_log_impl(&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "[kaleidoscope pathfinder cache] path %@ has the wrong protection class (%@)", buf, 0x16u);
    }
  ...
  if (v4)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *buf = 138412290;
        v13 = fileCopy;
        _os_log_impl(&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "[kaleidoscope pathfinder cache] using %@", buf, 0xCu);
      }
    }
