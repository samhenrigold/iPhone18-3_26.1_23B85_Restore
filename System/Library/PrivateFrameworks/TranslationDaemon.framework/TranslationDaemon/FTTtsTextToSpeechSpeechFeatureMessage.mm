...
- (FTTtsTextToSpeechSpeechFeatureMessage)initWithFlatbuffData:(id)data root:(const TtsTextToSpeechSpeechFeatureMessage *)root verify:(BOOL)verify
{
  ...
  if (v10)
  {
    ...
    if (verifyCopy)
    {
      ...
      if (v16 || (v17 = [(NSData *)v10->_data bytes], v18 = [(NSData *)v10->_data length], v24 = v17, v25 = v18, v26 = xmmword_233005E20, v27 = 0, LOBYTE(v28) = 1, (v19 = v10->_root) != 0) && !siri::speech::qss_fb::TtsTextToSpeechSpeechFeatureMessage::Verify(v19, &v24))
      {
LABEL_15:
        v22 = 0;
        goto LABEL_16;
