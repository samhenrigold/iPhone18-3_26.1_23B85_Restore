...
- (FTTTSWordPhonemes)initWithFlatbuffData:(id)data root:(const TTSWordPhonemes *)root verify:(BOOL)verify;
- (NSArray)phonemes;
...
- (FTTTSWordPhonemes)initWithFlatbuffData:(id)data root:(const TTSWordPhonemes *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTTTSWordPhonemes;
  v10 = [(FTTTSWordPhonemes *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
...
- (Offset<siri::speech::schema_fb::TTSWordPhonemes>)addObjectToBuffer:(void *)buffer
{
  ...
  phonemes = [(FTTTSWordPhonemes *)self phonemes];
  ...
  v20 = 0u;
  v21 = 0u;
  phonemes2 = [(FTTTSWordPhonemes *)self phonemes];
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTTTSWordPhonemes *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
