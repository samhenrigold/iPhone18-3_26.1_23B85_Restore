...
- (FTRecoverPronsRequest)initWithFlatbuffData:(id)data root:(const RecoverPronsRequest *)root verify:(BOOL)verify;
- (NSArray)apg_ids;
- (NSString)language;
- (NSString)session_id;
- (NSString)speech_id;
- (Offset<siri::speech::schema_fb::RecoverPronsRequest>)addObjectToBuffer:(void *)buffer;
- (id)apg_ids_objectAtIndex:(unint64_t)index;
- (id)flatbuffData;
- (unint64_t)apg_ids_count;
- (void)apg_ids_enumerateObjectsUsingBlock:(id)block;
@end
...
- (FTRecoverPronsRequest)initWithFlatbuffData:(id)data root:(const RecoverPronsRequest *)root verify:(BOOL)verify
{
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::RecoverPronsRequest::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::RecoverPronsRequest>)addObjectToBuffer:(void *)buffer
{
  ...
  speech_id = [(FTRecoverPronsRequest *)self speech_id];
  v6 = speech_id;
  if (!speech_id)
  {
  ...
  session_id = [(FTRecoverPronsRequest *)self session_id];
  v11 = session_id;
  if (!session_id)
  {
  ...
  language = [(FTRecoverPronsRequest *)self language];
  v16 = language;
  if (!language)
  {
  ...
  apg_ids = [(FTRecoverPronsRequest *)self apg_ids];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v39, [apg_ids count]);

  v37 = 0u;
  v38 = 0u;
  v35 = 0u;
  v36 = 0u;
  apg_ids2 = [(FTRecoverPronsRequest *)self apg_ids];
  v22 = [apg_ids2 countByEnumeratingWithState:&v35 objects:v40 count:16];
  if (v22)
  {
    v23 = *v36;
    do
    {
      for (i = 0; i != v22; ++i)
      {
        ...
        uTF8String4 = [*(*(&v35 + 1) + 8 * i) UTF8String];
        v26 = strlen(uTF8String4);
        v34 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString(buffer, uTF8String4, v26);
  ...
  v28 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>(buffer, begin, v39.__end_ - v39.__begin_);
  *(buffer + 70) = 1;
  v29 = *(buffer + 8);
  v30 = *(buffer + 12);
  v31 = *(buffer + 10);
