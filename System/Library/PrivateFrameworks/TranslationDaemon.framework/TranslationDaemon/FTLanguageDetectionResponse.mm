...
- (FTLanguageDetectionResponse)initWithFlatbuffData:(id)data root:(const LanguageDetectionResponse *)root verify:(BOOL)verify;
- (NSArray)predictions;
...
- (FTLanguageDetectionResponse)initWithFlatbuffData:(id)data root:(const LanguageDetectionResponse *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTLanguageDetectionResponse;
  v10 = [(FTLanguageDetectionResponse *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::LanguageDetectionResponse::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::LanguageDetectionResponse>)addObjectToBuffer:(void *)buffer
{
  ...
  speech_id = [(FTLanguageDetectionResponse *)self speech_id];
  v6 = speech_id;
  if (!speech_id)
  {
  ...
  session_id = [(FTLanguageDetectionResponse *)self session_id];
  v11 = session_id;
  if (!session_id)
  {
  ...
  return_code = [(FTLanguageDetectionResponse *)self return_code];
  return_string = [(FTLanguageDetectionResponse *)self return_string];
  v17 = return_string;
  if (!return_string)
  {
  ...
  detected_locale = [(FTLanguageDetectionResponse *)self detected_locale];
  v22 = detected_locale;
  if (!detected_locale)
  {
  ...
  predictions = [(FTLanguageDetectionResponse *)self predictions];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v43, [predictions count]);

  v41 = 0u;
  v42 = 0u;
  v39 = 0u;
  v40 = 0u;
  predictions2 = [(FTLanguageDetectionResponse *)self predictions];
  v28 = [predictions2 countByEnumeratingWithState:&v39 objects:v44 count:16];
  if (v28)
  {
    v29 = *v40;
    do
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTLanguageDetectionResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
