...
- (FTTextToSpeechRequestContext_ContextInfoEntry)initWithFlatbuffData:(id)data root:(const ContextInfoEntry *)root verify:(BOOL)verify;
- (NSString)key;
- (NSString)value;
- (Offset<siri::speech::schema_fb::TextToSpeechRequestContext_::ContextInfoEntry>)addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestContext_::ContextInfoEntry>)addObjectToBuffer:(void *)buffer
{
  ...
  value = [(FTTextToSpeechRequestContext_ContextInfoEntry *)self value];
  v11 = value;
  if (!value)
  {
