...
- (FTTextToSpeechRequestExperiment)initWithFlatbuffData:(id)data root:(const TextToSpeechRequestExperiment *)root verify:(BOOL)verify;
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestExperiment>)addObjectToBuffer:(void *)buffer
{
  experiment_identifier = [(FTTextToSpeechRequestExperiment *)self experiment_identifier];
  v5 = experiment_identifier;
  if (!experiment_identifier)
  {
    experiment_identifier = &stru_284834138;
  }
