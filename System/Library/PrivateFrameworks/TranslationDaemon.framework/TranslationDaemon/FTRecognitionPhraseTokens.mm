...
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)data root:(const RecognitionPhraseTokens *)root verify:(BOOL)verify;
- (NSArray)tokens;
...
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)data root:(const RecognitionPhraseTokens *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTRecognitionPhraseTokens;
  v10 = [(FTRecognitionPhraseTokens *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::RecognitionPhraseTokens::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::RecognitionPhraseTokens>)addObjectToBuffer:(void *)buffer
{
  ...
  tokens = [(FTRecognitionPhraseTokens *)self tokens];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v22, [tokens count]);

  v20 = 0u;
  v21 = 0u;
  v18 = 0u;
  v19 = 0u;
  tokens2 = [(FTRecognitionPhraseTokens *)self tokens];
  v7 = [tokens2 countByEnumeratingWithState:&v18 objects:v23 count:16];
  if (v7)
  {
    v8 = *v19;
    do
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTRecognitionPhraseTokens *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
