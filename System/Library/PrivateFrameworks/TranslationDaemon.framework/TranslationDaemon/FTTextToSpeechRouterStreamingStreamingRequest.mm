...
- (FTTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)data root:(const TextToSpeechRouterStreamingStreamingRequest *)root verify:(BOOL)verify;
...
- (FLTBFBufferAccessor)content
{
  if ([(FTTextToSpeechRouterStreamingStreamingRequest *)self content_type]== 1)
  {
    contentAsFTStartTextToSpeechStreamingRequest = [(FTTextToSpeechRouterStreamingStreamingRequest *)self contentAsFTStartTextToSpeechStreamingRequest];
  }
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingRequest>)addObjectToBuffer:(void *)buffer
{
  content_type = [(FTTextToSpeechRouterStreamingStreamingRequest *)self content_type];
  if ([(FTTextToSpeechRouterStreamingStreamingRequest *)self content_type]== 1)
  {
    contentAsFTStartTextToSpeechStreamingRequest = [(FTTextToSpeechRouterStreamingStreamingRequest *)self contentAsFTStartTextToSpeechStreamingRequest];
