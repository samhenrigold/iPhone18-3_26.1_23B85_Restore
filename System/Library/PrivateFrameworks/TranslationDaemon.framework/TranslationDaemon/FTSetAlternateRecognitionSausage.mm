...
- (FTSetAlternateRecognitionSausage)initWithFlatbuffData:(id)data root:(const SetAlternateRecognitionSausage *)root verify:(BOOL)verify;
...
- (FTSetAlternateRecognitionSausage)initWithFlatbuffData:(id)data root:(const SetAlternateRecognitionSausage *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTSetAlternateRecognitionSausage;
  v10 = [(FTSetAlternateRecognitionSausage *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
...
- (Offset<siri::speech::schema_fb::SetAlternateRecognitionSausage>)addObjectToBuffer:(void *)buffer
{
  ...
  positional_tok_phrase_alt = [(FTSetAlternateRecognitionSausage *)self positional_tok_phrase_alt];
  ...
  v18 = 0u;
  v19 = 0u;
  positional_tok_phrase_alt2 = [(FTSetAlternateRecognitionSausage *)self positional_tok_phrase_alt];
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTSetAlternateRecognitionSausage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
