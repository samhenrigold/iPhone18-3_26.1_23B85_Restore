...
- (void)setSession_messageAsFTTextToSpeechSpeechFeatureRequest:(id)request;
- (void)setSession_messageAsFTTextToSpeechSpeechFeatureResponse:(id)response;
...
{
  v6.receiver = self;
  v6.super_class = FTMutableTtsTextToSpeechSpeechFeatureMessage;
...
- (void)setSession_message:(id)session_message
{
  ...
  -[FTMutableTtsTextToSpeechSpeechFeatureMessage setSession_message_type:](self, "setSession_message_type:", [objc_opt_class() session_message_typeForObject:session_messageCopy]);
