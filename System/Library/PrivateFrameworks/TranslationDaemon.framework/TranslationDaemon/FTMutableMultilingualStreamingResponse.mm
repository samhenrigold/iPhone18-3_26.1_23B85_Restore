...
{
  v6.receiver = self;
  v6.super_class = FTMutableMultilingualStreamingResponse;
...
{
  contentCopy = content;
  -[FTMutableMultilingualStreamingResponse setContent_type:](self, "setContent_type:", [objc_opt_class() content_typeForObject:contentCopy]);
  v4 = [contentCopy copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"content"];
}
