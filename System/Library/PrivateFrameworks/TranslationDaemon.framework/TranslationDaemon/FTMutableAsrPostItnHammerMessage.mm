...
- (void)setSession_messageAsFTPostItnHammerRequest:(id)request;
- (void)setSession_messageAsFTPostItnHammerResponse:(id)response;
...
{
  v6.receiver = self;
  v6.super_class = FTMutableAsrPostItnHammerMessage;
...
- (void)setSession_message:(id)session_message
{
  ...
  -[FTMutableAsrPostItnHammerMessage setSession_message_type:](self, "setSession_message_type:", [objc_opt_class() session_message_typeForObject:session_messageCopy]);
