...
- (FTSetSpeechProfile)initWithFlatbuffData:(id)data root:(const SetSpeechProfile *)root verify:(BOOL)verify;
- (FTUserAcousticProfile)user_acoustic_profile;
- (FTUserLanguageProfile)user_language_profile;
- (NSString)language;
- (NSString)session_id;
- (NSString)speech_id;
- (Offset<siri::speech::schema_fb::SetSpeechProfile>)addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
@end
...
- (FTSetSpeechProfile)initWithFlatbuffData:(id)data root:(const SetSpeechProfile *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTSetSpeechProfile;
  v10 = [(FTSetSpeechProfile *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::SetSpeechProfile::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::SetSpeechProfile>)addObjectToBuffer:(void *)buffer
{
  speech_id = [(FTSetSpeechProfile *)self speech_id];
  v6 = speech_id;
  if (!speech_id)
  {
  ...
  session_id = [(FTSetSpeechProfile *)self session_id];
  v11 = session_id;
  if (!session_id)
  {
  ...
  user_language_profile = [(FTSetSpeechProfile *)self user_language_profile];
  v16 = [user_language_profile addObjectToBuffer:buffer];

  user_acoustic_profile = [(FTSetSpeechProfile *)self user_acoustic_profile];
  v18 = [user_acoustic_profile addObjectToBuffer:buffer];

  language = [(FTSetSpeechProfile *)self language];
  v20 = language;
  if (!language)
  {
  ...
  *(buffer + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>(buffer, 10, v18);
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTSetSpeechProfile *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
