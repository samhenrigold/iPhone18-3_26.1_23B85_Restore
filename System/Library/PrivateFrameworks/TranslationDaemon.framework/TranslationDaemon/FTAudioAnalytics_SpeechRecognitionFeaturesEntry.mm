...
- (FTAudioAnalytics_SpeechRecognitionFeaturesEntry)initWithFlatbuffData:(id)data root:(const SpeechRecognitionFeaturesEntry *)root verify:(BOOL)verify;
- (NSString)key;
- (Offset<siri::speech::schema_fb::AudioAnalytics_::SpeechRecognitionFeaturesEntry>)addObjectToBuffer:(void *)buffer;
- (float)value;
- (id)flatbuffData;
@end
...
- (FTAudioAnalytics_SpeechRecognitionFeaturesEntry)initWithFlatbuffData:(id)data root:(const SpeechRecognitionFeaturesEntry *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTAudioAnalytics_SpeechRecognitionFeaturesEntry;
  v10 = [(FTAudioAnalytics_SpeechRecognitionFeaturesEntry *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
...
- (Offset<siri::speech::schema_fb::AudioAnalytics_::SpeechRecognitionFeaturesEntry>)addObjectToBuffer:(void *)buffer
{
  v5 = [(FTAudioAnalytics_SpeechRecognitionFeaturesEntry *)self key];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTAudioAnalytics_SpeechRecognitionFeaturesEntry *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
