...
- (FTSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)data root:(const SpeechTranslationServerEndpointFeatures *)root verify:(BOOL)verify;
...
- (FTSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)data root:(const SpeechTranslationServerEndpointFeatures *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTSpeechTranslationServerEndpointFeatures;
  v10 = [(FTSpeechTranslationServerEndpointFeatures *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::SpeechTranslationServerEndpointFeatures::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::SpeechTranslationServerEndpointFeatures>)addObjectToBuffer:(void *)buffer
{
  conversation_id = [(FTSpeechTranslationServerEndpointFeatures *)self conversation_id];
  v6 = conversation_id;
  if (!conversation_id)
  {
  ...
  request_id = [(FTSpeechTranslationServerEndpointFeatures *)self request_id];
  v11 = request_id;
  if (!request_id)
  {
  ...
  source_locale = [(FTSpeechTranslationServerEndpointFeatures *)self source_locale];
  v16 = source_locale;
  if (!source_locale)
  {
  ...
  server_endpoint_features = [(FTSpeechTranslationServerEndpointFeatures *)self server_endpoint_features];
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTSpeechTranslationServerEndpointFeatures *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
