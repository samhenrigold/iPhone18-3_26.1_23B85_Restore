...
- (Offset<siri::speech::schema_fb::ShortcutFuzzyMatchRequest_::StringTokenPair>)addObjectToBuffer:(void *)buffer
{
  ...
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v29, [tokens count]);
  ...
  v12 = [tokens2 countByEnumeratingWithState:&v25 objects:v30 count:16];
  if (v12)
  {
    v13 = *v26;
    do
