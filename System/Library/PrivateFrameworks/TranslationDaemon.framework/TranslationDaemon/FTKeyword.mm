@interface FTKeyword
- (FTKeyword)initWithFlatbuffData:(id)data root:(const Keyword *)root verify:(BOOL)verify;
...
- (Offset<siri::speech::schema_fb::Keyword>)addObjectToBuffer:(void *)buffer
{
  keyword_orthography = [(FTKeyword *)self keyword_orthography];
  v6 = keyword_orthography;
  if (!keyword_orthography)
  {
    keyword_orthography = &stru_284834138;
  }
