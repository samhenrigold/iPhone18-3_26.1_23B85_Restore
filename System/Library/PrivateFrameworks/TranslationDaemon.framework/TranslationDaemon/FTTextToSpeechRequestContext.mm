...
- (FTTextToSpeechRequestContext)initWithFlatbuffData:(id)data root:(const TextToSpeechRequestContext *)root verify:(BOOL)verify;
...
- (FTTextToSpeechRequestContext)initWithFlatbuffData:(id)data root:(const TextToSpeechRequestContext *)root verify:(BOOL)verify
{
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::TextToSpeechRequestContext::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestContext>)addObjectToBuffer:(void *)buffer
{
  ...
  context_info = [(FTTextToSpeechRequestContext *)self context_info];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v36, [context_info count]);

  v34 = 0u;
  v35 = 0u;
  v32 = 0u;
  v33 = 0u;
  context_info2 = [(FTTextToSpeechRequestContext *)self context_info];
  selfCopy = self;
  v7 = [context_info2 countByEnumeratingWithState:&v32 objects:v37 count:16];
  if (v7)
  {
    v8 = *v33;
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v10 = [*(*(&v32 + 1) + 8 * i) addObjectToBuffer:buffer];
        end = v36.__end_;
        if (v36.__end_ >= v36.__end_cap_.__value_)
        {
          begin = v36.__begin_;
          v14 = v36.__end_ - v36.__begin_;
          v15 = v36.__end_ - v36.__begin_;
          v16 = v15 + 1;
          if ((v15 + 1) >> 62)
          {
          ...
          v17 = v36.__end_cap_.__value_ - v36.__begin_;
          if ((v36.__end_cap_.__value_ - v36.__begin_) >> 1 > v16)
          {
            v16 = v17 >> 1;
          }
          ...
          if (v18)
          {
            std::__allocate_at_least[abi:ne200100]<std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>(&v36, v18);
          }
  ...
  v21 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>(buffer, v20, v36.__end_ - v36.__begin_);
  dialog_identifier = [(FTTextToSpeechRequestContext *)selfCopy dialog_identifier];
  v23 = dialog_identifier;
  if (!dialog_identifier)
  {
    dialog_identifier = &stru_284834138;
  }

  uTF8String = [(__CFString *)dialog_identifier UTF8String];
  v25 = strlen(uTF8String);
  LODWORD(uTF8String) = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString(buffer, uTF8String, v25);
