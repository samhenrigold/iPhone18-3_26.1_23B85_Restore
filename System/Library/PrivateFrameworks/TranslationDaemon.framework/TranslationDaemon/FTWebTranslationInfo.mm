...
- (FTWebTranslationInfo)initWithFlatbuffData:(id)data root:(const WebTranslationInfo *)root verify:(BOOL)verify;
- (NSArray)spans;
- (NSString)text;
...
- (FTWebTranslationInfo)initWithFlatbuffData:(id)data root:(const WebTranslationInfo *)root verify:(BOOL)verify
{
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::WebTranslationInfo::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::WebTranslationInfo>)addObjectToBuffer:(void *)buffer
{
  ...
  text = [(FTWebTranslationInfo *)self text];
  v6 = text;
  if (!text)
  {
    text = &stru_284834138;
  ...
  spans = [(FTWebTranslationInfo *)self spans];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v27, [spans count]);

  v25 = 0u;
  v26 = 0u;
  v23 = 0u;
  v24 = 0u;
  spans2 = [(FTWebTranslationInfo *)self spans];
  v12 = [spans2 countByEnumeratingWithState:&v23 objects:v28 count:16];
  if (v12)
  {
    v13 = *v24;
    do
