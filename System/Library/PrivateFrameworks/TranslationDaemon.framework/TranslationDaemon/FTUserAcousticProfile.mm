...
- (FTUserAcousticProfile)initWithFlatbuffData:(id)data root:(const UserAcousticProfile *)root verify:(BOOL)verify
{
  ...
  v10->_root = root;
  if (verifyCopy && ((v12 = [(NSData *)v10->_data bytes], v13 = [(NSData *)v10->_data length], root = v10->_root, root >= v12) ? (v15 = root > v12 + v13) : (v15 = 1), v15 || (v16 = [(NSData *)v10->_data bytes], v17 = [(NSData *)v10->_data length], v21[0] = v16, v21[1] = v17, v22 = xmmword_233005E20, v23 = 0, v24 = 1, (v18 = v10->_root) != 0) && !siri::speech::schema_fb::UserAcousticProfile::Verify(v18, v21)))
  {
LABEL_14:
    v19 = 0;
  }
