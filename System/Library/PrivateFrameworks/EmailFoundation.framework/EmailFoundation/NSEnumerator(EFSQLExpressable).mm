    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_respondsToSelector() & 1) == 0)
        {
          ...
          [currentHandler handleFailureInFunction:v19 file:@"EFSQLExpressable.m" lineNumber:104 description:{@"Objects in the %@ must conform to protocol EFSQLValueExpressable", @"enumerator"}];
        }
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_respondsToSelector() & 1) == 0)
        {
          ...
          [currentHandler handleFailureInFunction:v15 file:@"EFSQLExpressable.m" lineNumber:104 description:{@"Objects in the %@ must conform to protocol EFSQLValueExpressable", @"enumerator"}];
        }
