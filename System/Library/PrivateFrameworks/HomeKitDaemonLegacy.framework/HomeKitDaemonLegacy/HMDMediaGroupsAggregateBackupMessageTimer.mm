  ...
  if (timer == fireCopy)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of triggered timer due to no delegate", &v12, 0xCu);
      }
...
- (void)startRetryTimer
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting timer with attempts: %@", &v20, 0x16u);
  }
  ...
  if ([(HMDMediaGroupsAggregateBackupMessageTimer *)selfCopy attemptCount]< 0x24)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to start new timer due to no timer provider", &v20, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = &unk_286628CA8;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create retry timer due to reaching the max attempt count: %@", &v20, 0x16u);
    }
...
uint64_t __56__HMDMediaGroupsAggregateBackupMessageTimer_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_108966;
  logCategory__hmf_once_v5_108966 = v0;
