  ...
  if (enable < 2)
  {
    ...
    if (v10)
    {
      ...
      if (_smartSpeakerAirPlayEnableCharacteristic && ([MEMORY[0x277CCABB0] numberWithInteger:enable == 1], v12 = objc_claimAutoreleasedReturnValue(), objc_msgSend(_smartSpeakerAirPlayEnableCharacteristic, "authorizationData"), v13 = objc_claimAutoreleasedReturnValue(), +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:value:authorizationData:type:](HMDCharacteristicWriteRequest, "writeRequestWithCharacteristic:value:authorizationData:type:", _smartSpeakerAirPlayEnableCharacteristic, v12, v13, 0), v14 = objc_claimAutoreleasedReturnValue(), v13, v12, v14))
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v37 = 2048;
          enableCopy = enable;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Set airplay enable %zd", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v36 = v25;
          _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set AirPlay Enable] failed to create AirPlay enable write request", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v36 = v29;
        _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@[Set AirPlay Enable] accessory not part of profile", buf, 0xCu);
      }
  ...
  if (stateCopy || percentageCopy || mutedCopy || enableCopy)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544130;
      ...
      v48 = 2112;
      v49 = mutedCopy;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated current media state %@, volume %@, muted %@", buf, 0x2Au);
    }
...
- (BOOL)_updateAudioControl:(id)control
{
  ...
  if (![(HMDMediaProfile *)&v36 _updateAudioControl:controlCopy])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v38 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@No local media session for hapMediaProfile", buf, 0xCu);
    }
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v39 = 2112;
          v40 = v18;
          _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] accessory not part of profile (%@)", buf, 0x16u);
        }
      ...
      if (v10)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v38 = v23;
            _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] smart speaker volume is not available", buf, 0xCu);
          }
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v38 = v27;
            _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] smart speaker muted is not available", buf, 0xCu);
          }
          ...
          if (v11)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543874;
              ...
              v42 = 2112;
              v43 = v20;
              _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_ERROR, "%{public}@Write value %@ failed with error %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v40 = 2112;
      v41 = v26;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid response with write values %@", buf, 0x16u);
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              v31 = 2112;
              v32 = v20;
              _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Current device is primary:%@ and does not support home hub", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (v5 && [v5 isCurrentDevice])
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v13;
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Current device was added as a resident device (%@ / %@) notification.", &v14, 0x20u);
      }
...
- (void)_disableCharacteristicNotifications
{
  ...
  if ([_allCharacteristicsToMonitor count])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Disabling notifications for characteristics :%@", &v12, 0x16u);
    }
  ...
  if (currentDeviceSupportsSidekickSettings)
  {
    ...
    if ([_allCharacteristicsToMonitor count])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@%@ notifications for characteristics: %@", &v18, 0x20u);
      }
    ...
    do
    {
      ...
      do
      {
        ...
        if (v15)
        {
          ...
          {
            v20 = qword_253D4C1F0[integerValue - 1];
          }
...
{
  stateCopy = state;
  v6 = [services na_filter:&__block_literal_global_167926];
  if ([v6 count])
  {
...
- (id)_mediaSessionStateFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session state from profile due to no accessory", &v13, 0xCu);
    }
...
- (id)mediaSessionFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session from profile due to no media session state from profile", buf, 0xCu);
    }
...
- (BOOL)_updateRefreshPlayback:(id)playback
{
  ...
  if (![(HMDMediaProfile *)&v50 _updateRefreshPlayback:?])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v53 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@No local media session for hapMediaProfile", buf, 0xCu);
    }
    ...
    if (v36)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v53 = v17;
          _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker airplay enable state is not available", buf, 0xCu);
        }
            ...
            if ([v23 isEqual:v20])
            {
              ...
              if (!_smartSpeakerCurrentMediaStateReadRequest)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138543362;
                  v53 = v28;
                  _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker current media state is not available", buf, 0xCu);
                }
            ...
            else if ([v23 isEqual:v21])
            {
              ...
              if (!_smartSpeakerCurrentMediaStateReadRequest)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138543362;
                  v53 = v29;
                  _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker volume is not available", buf, 0xCu);
                }
            ...
            else
            {
              ...
              if (!_smartSpeakerCurrentMediaStateReadRequest)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138543362;
                  v53 = v30;
                  _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker muted is not available", buf, 0xCu);
                }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v54 = 2112;
        v55 = v11;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] accessory not part of profile (%@)", buf, 0x16u);
      }
...
LABEL_44:
  ...
  if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v67 = 2112;
    v68 = v45;
    _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
  }
    ...
    if (v10)
    {
      ...
      if (v13)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v33 = v24;
            _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Update Playback] failed to create target media state write request", buf, 0xCu);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v33 = v20;
          _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Update Playback] accessory not part of profile", buf, 0xCu);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v37 = 2112;
      v38 = v25;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
    }
...
- (id)_smartSpeakerTargetMediaStateWriteRequestWithPlaybackState:(id)state
{
  ...
  if (_smartSpeakerTargetMediaStateCharacteristic)
  {
    ...
    {
      v8 = qword_253D4C1B8[integerValue];
    }
...
- (void)registerForNotifications
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_ERROR, "%{public}@Not registering for notifications as accessory is nil", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v20 = 2112;
      v21 = firstObject;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot create media profile, cannot determine accessory from services %@", buf, 0x16u);
    }
