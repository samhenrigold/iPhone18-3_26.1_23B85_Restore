...
- (void)_startReevaluateTimer:(double)timer
{
  ...
  if (timer < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v14 = 138543362;
      v15 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Invalid time interval", &v14, 0xCu);
    }
            ...
            if (v24)
            {
              ...
              if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543618;
                ...
                v72 = 2112;
                v73 = v51;
                _os_log_impl(&dword_2531F8000, v48, OS_LOG_TYPE_INFO, "%{public}@Update could be interrupted by trigger:%@", buf, 0x16u);
  ...
  if (!bridge)
  {
    ...
    if (_getMaxUpdateApplyEndTime)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v17;
        _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to NO", &v23, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v22;
        _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Invalid max update apply end time, policy status evaluated to NO", &v23, 0xCu);
      }
...
LABEL_2:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 138543362;
    v24 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", &v23, 0xCu);
  }
...
uint64_t __62__HMDAccessoryFirmwareUpdateTimedAutomationPolicy_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_133165;
  logCategory__hmf_once_v1_133165 = v0;
