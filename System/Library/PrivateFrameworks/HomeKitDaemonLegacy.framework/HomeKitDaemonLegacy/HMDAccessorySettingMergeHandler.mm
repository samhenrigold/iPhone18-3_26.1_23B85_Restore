...
+ (id)_mergeValidValueConstraintsFirst:(id)first second:(id)second shouldAddMissing:(BOOL)missing
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2048;
    v36 = [v16 count];
    _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Valid value constraints: this: %lu, second: %lu", &v31, 0x20u);
  }
  ...
  _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, v26, &v31, 0x16u);
...
LABEL_58:
        _os_log_impl(&dword_2531F8000, v69, OS_LOG_TYPE_ERROR, v71, buf, 0x16u);
      }
    }
    ...
    else
    {
      ...
      v54 = compareCharacteristicValue(v75, v53, 1, &unk_28662BF68);
...
+ (BOOL)_isNumber:(id)number betweenStart:(id)start andEnd:(id)end first:(id)first
{
  ...
  if (!numberCopy)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Given value is nil, cannot determine whether within the range", &v19, 0xCu);
    }
  ...
  if (type != [secondCopy type])
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v202 = 2112;
      v203 = v32;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Value types are not matching: self %@, second %@", buf, 0x20u);
  ...
  if ((v18 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v202 = 2112;
      v203 = v38;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting names are not matching: self %@, second %@", buf, 0x20u);
    ...
    if (type3 != 1)
    {
      ...
      if (!v42)
      {
        ...
        if (os_log_type_enabled(v121, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v199 = v122;
          _os_log_impl(&dword_2531F8000, v121, OS_LOG_TYPE_ERROR, "%{public}@Merged constraints is invalid, cannot merge this setting", buf, 0xCu);
        }
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v202 = 2112;
        v203 = v49;
        _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Comparing the values: self %@, second %@", buf, 0x20u);
      }
      ...
      if ((HMFEqualObjects() & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v199 = v57;
          _os_log_impl(&dword_2531F8000, v56, OS_LOG_TYPE_INFO, "%{public}@Values are not matching, going to compute the value", buf, 0xCu);
        }
        ...
        if (!v58)
        {
          ...
          if (os_log_type_enabled(v162, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v199 = v163;
            _os_log_impl(&dword_2531F8000, v162, OS_LOG_TYPE_ERROR, "%{public}@Cannot come up with the merged value", buf, 0xCu);
          }
        ...
        if ((v61 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v202 = 2112;
            v203 = v59;
            _os_log_impl(&dword_2531F8000, v64, OS_LOG_TYPE_INFO, "%{public}@Updating the value from %@ to %@", buf, 0x20u);
...
LABEL_111:
      ...
      if (os_log_type_enabled(v129, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138544130;
        ...
        v204 = 2112;
        v205 = v135;
        _os_log_impl(&dword_2531F8000, v129, OS_LOG_TYPE_INFO, "%{public}@Numerical Constraints are not matching (merged: %@) (first: %@), (second: %@) updating the constraints", buf, 0x2Au);
...
LABEL_47:
    ...
    if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v200 = 2112;
      v201 = v83;
      _os_log_impl(&dword_2531F8000, v81, OS_LOG_TYPE_INFO, "%{public}@Setting type is %@, keeping the values", buf, 0x16u);
    }
    ...
    if ([firstCopy isConstraintMergeStrategyReflection] && objc_msgSend(secondCopy, "isConstraintMergeStrategyReflection"))
    {
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138544386;
        ...
        v206 = 2112;
        v207 = constraints4;
        _os_log_impl(&dword_2531F8000, v74, OS_LOG_TYPE_DEBUG, "%{public}@merge constraints first: %@, %@, second: %@, %@", buf, 0x34u);
...
LABEL_69:
      ...
      if (os_log_type_enabled(v104, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v200 = 2112;
        v201 = constraints8;
        _os_log_impl(&dword_2531F8000, v104, OS_LOG_TYPE_INFO, "%{public}@Updating constraints to %@", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v200 = 2112;
    v201 = v84;
    _os_log_impl(&dword_2531F8000, v87, OS_LOG_TYPE_INFO, "%{public}@Setting type is selection, merged constraints: %@", buf, 0x16u);
  }
...
LABEL_63:
    ...
    if (os_log_type_enabled(v110, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v199 = v111;
      _os_log_impl(&dword_2531F8000, v110, OS_LOG_TYPE_INFO, "%{public}@Did not find first's selection in merged list", buf, 0xCu);
    }
...
LABEL_93:
      ...
      if (os_log_type_enabled(v138, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v199 = v139;
        _os_log_impl(&dword_2531F8000, v138, OS_LOG_TYPE_INFO, "%{public}@Did not find second's selection in merged list, updating the selected value to nil", buf, 0xCu);
      }
...
LABEL_96:
    ...
    if ((v141 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v144, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v202 = 2112;
        v203 = v189;
        _os_log_impl(&dword_2531F8000, v144, OS_LOG_TYPE_INFO, "%{public}@Updating the value from %@ to %@", buf, 0x20u);
    ...
    if ((v152 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v155, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v202 = 2112;
        v203 = v159;
        _os_log_impl(&dword_2531F8000, v155, OS_LOG_TYPE_INFO, "%{public}@Selection Constraints are not matching (merged: %@) (first: %@), updating the constraints", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v125, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v199 = v126;
      _os_log_impl(&dword_2531F8000, v125, OS_LOG_TYPE_ERROR, "%{public}@There are no elements in the intersection of selection list", buf, 0xCu);
    }
