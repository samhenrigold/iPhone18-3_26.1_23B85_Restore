...
- (void)__startupWithLocalZone:(id)zone activity:(id)activity
{
  ...
  if ([(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)self isShuttingDown])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Already shutting down", &v20, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Starting up", &v20, 0xCu);
    }
...
void __138__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchVerificationCertificates____retryFetchVerificationCertificatesWithFetchInfo___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Retrying fetch for verification certificates", &v9, 0xCu);
    }
  ...
  if (recordCopy)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v28 = 2112;
        v29 = hmbDescription;
        _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get any usable public keys from record: %@", &v26, 0x16u);
      }
...
LABEL_14:
  ...
  if (![completedCopy shouldRetry])
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2112;
      v29 = hmbDescription2;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Fetch returned no verification certificates record: %@", &v26, 0x16u);
    }
...
- (BOOL)__addOverrides:(id)overrides replace:(BOOL)replace options:(id)options activity:(id)activity error:(id *)error
{
  ...
  if (v17)
  {
    ...
    v46 = &v45;
    v47 = 0x3032000000;
    v48 = __Block_byref_object_copy__95496;
    v49 = __Block_byref_object_dispose__95497;
    v50 = 0;
...
LABEL_12:
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543362;
    v62 = v45;
    _os_log_impl(&dword_2531F8000, v44, OS_LOG_TYPE_DEBUG, "%{public}@No local zones exist", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (!databaseChangeToken4)
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543362;
        v58 = v53;
        _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Should never have a nil change token here", buf, 0xCu);
      }
...
- (void)__saveInternalStateWithActivity:(id)activity
{
  ...
  if (!internalState)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v30 = v26;
      _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have internal state", buf, 0xCu);
    }
...
- (id)fetchOverridesForRecordIDs:(id)ds options:(id)options error:(id *)error
{
  ...
  v39 = &v38;
  v40 = 0x3032000000;
  v41 = __Block_byref_object_copy__134914;
  v42 = __Block_byref_object_dispose__134915;
  v43 = 0;
  v32 = 0;
  v33 = &v32;
  v34 = 0x3032000000;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Cloud fetch completed unsuccessfully: %@", buf, 0x16u);
    }
  }
...
LABEL_15:
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v49 = v44;
      _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_INFO, "%{public}@Set of interested accessories has not grown, skipping fetch", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Cloud sync completed unsuccessfully: %@", buf, 0x16u);
    }
  }
...
void __62__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_flush__block_invoke_168(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 138543362;
    v12 = v10;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Flushed", &v11, 0xCu);
  }
...
void __102__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror___asyncFutureWithActivity_ignoreErrors_block___block_invoke_2_151(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 2112;
    v10 = v6;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring error from promise: %@", &v7, 0x16u);
  }
  ...
  if (WeakRetained)
  {
    if ([WeakRetained isShuttingDown])
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v16 = 138543362;
        v17 = v7;
        _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Not running block because we're already shutting down", &v16, 0xCu);
      }
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v11;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Not running block because we're already shutting down", &v16, 0xCu);
      }
...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel)internalState
{
  ...
  if (![(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)self isRunning])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Should only get internal state while running", &v12, 0xCu);
    }
...
uint64_t __68__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_135045;
  logCategory__hmf_once_v5_135045 = v0;
  ...
  if ([errorCopy code] == 21)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v23 = 2112;
      v24 = errorCopy;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Change token has expired: %@", buf, 0x16u);
    }
...
LABEL_3:
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v23 = 2112;
      v24 = errorCopy;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Ignoring non-fatal error: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v28 = 2112;
      v29 = v25;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changes from zone: %@", buf, 0x16u);
    }
...
- (BOOL)__createCloudZonesForFetchInfo:(id)info error:(id *)error
{
  ...
  if (v9)
  {
    ...
    *(&buf + 1) = &buf;
    v29 = 0x3032000000;
    v30 = __Block_byref_object_copy__182682;
    v31 = __Block_byref_object_dispose__182683;
    v32 = 0;
    cloudDatabase = [(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)selfCopy cloudDatabase];
