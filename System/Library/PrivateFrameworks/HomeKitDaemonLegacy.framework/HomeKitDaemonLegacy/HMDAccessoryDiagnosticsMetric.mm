...
- (void)submitMetric:(id)metric
{
  ...
  if (metricCopy)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting AccessoryDiagnosticMetric for accessory: %{public}@/%{public}@ - %{public}@", &v16, 0x2Au);
    }
...
uint64_t __44__HMDAccessoryDiagnosticsMetric_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_64894;
  logCategory__hmf_once_v9_64894 = v0;
