...
- (void)_authenticateAccount:(id)account alreadyExists:(BOOL)exists withCompanionDevice:(id)device
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2112;
    v31 = deviceCopy;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Authenticating the account %@, service type %@, with companion device: %@", &v24, 0x2Au);
  }
...
void __62__HMDRemoteLoginReceiverCompanionAuthentication__authenticate__block_invoke(uint64_t a1, char a2, uint64_t a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Save-remote-verified-account failed with error %@", &v16, 0x16u);
    }
...
uint64_t __60__HMDRemoteLoginReceiverCompanionAuthentication_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_52739;
  logCategory__hmf_once_v2_52739 = v0;
