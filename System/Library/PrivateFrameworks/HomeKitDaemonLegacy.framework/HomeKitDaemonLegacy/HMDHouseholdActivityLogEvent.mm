...
- (HMDHouseholdActivityLogEvent)initWithDictionary:(id)dictionary contributors:(id)contributors
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v30 = v22;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Household activity is missing home UUID. Assuming from original SkyG seed and ignoring.", buf, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_57487 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t5_57487, &__block_literal_global_57488);
  }

  v3 = logCategory__hmf_once_v6_57489;
...
uint64_t __43__HMDHouseholdActivityLogEvent_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v6_57489;
  logCategory__hmf_once_v6_57489 = v0;
