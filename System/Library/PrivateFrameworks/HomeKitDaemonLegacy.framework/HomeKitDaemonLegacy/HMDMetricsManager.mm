...
- (void)logEventAggregationAnalysisLogEvents
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2114;
    v20 = v10;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated event counts since last metric submission (reset every 24 hrs): %{public}@", &v17, 0x16u);
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2114;
    v20 = v16;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated error counts since last metric submission (reset every 24 hrs): %{public}@", &v17, 0x16u);
  }
...
- (void)start
{
  ...
  if ([(HMDMetricsManager *)self hasStarted])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v6;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_ERROR, "%{public}@Metrics collection already started", &v19, 0xCu);
    }
...
- (void)_configureManagers
{
  ...
  v16[0] = self->_userActivityEventsAnalyzer;
...
uint64_t __32__HMDMetricsManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v21_80607;
  logCategory__hmf_once_v21_80607 = v0;
