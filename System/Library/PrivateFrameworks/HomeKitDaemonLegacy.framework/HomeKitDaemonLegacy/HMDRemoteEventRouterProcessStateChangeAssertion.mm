...
- (void)_backgroundTimerDidExpire:(id)expire
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2112;
    v36 = v7;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@bundleIdentifier: %@ backgroundTimer: %@ expired.", &v31, 0x20u);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", &v31, 0x20u);
  }
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2112;
    v36 = v28;
    _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground %@", &v31, 0x20u);
  }
...
- (void)_removeBackgroundTimer:(id)timer
{
  ...
  if (timerCopy)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = timerCopy;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Remove backgroundTimer: %@", &v10, 0x16u);
    }
...
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)identifier
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v30 = 2112;
    v31 = v18;
    _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting backgroundTimer: %@ interval: %@", buf, 0x20u);
  }
...
void __101__HMDRemoteEventRouterProcessStateChangeAssertion_handleProcessWithBundleIdentifier_updatedIsActive___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 1024;
    LODWORD(v41) = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Application %@ isActive state changed to %{BOOL}d", &v36, 0x1Cu);
  }
  ...
  if (v8 == 1)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v38 = 2112;
      v39 = v20;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground YES", &v36, 0x16u);
    }
...
LABEL_13:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 138543362;
      v37 = v35;
      _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to enable background timer.", &v36, 0xCu);
    }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2112;
    v41 = v31;
    _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", &v36, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_126267 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t10_126267, &__block_literal_global_126268);
  }

  v3 = logCategory__hmf_once_v11_126269;
...
uint64_t __62__HMDRemoteEventRouterProcessStateChangeAssertion_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v11_126269;
  logCategory__hmf_once_v11_126269 = v0;
