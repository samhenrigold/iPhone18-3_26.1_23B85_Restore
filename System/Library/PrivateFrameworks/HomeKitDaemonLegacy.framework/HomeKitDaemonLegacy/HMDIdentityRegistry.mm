...
uint64_t __43__HMDIdentityRegistry_registeredIdentities__block_invoke(uint64_t a1, const char *a2)
{
...
uint64_t __34__HMDIdentityRegistry_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v28_11271;
  logCategory__hmf_once_v28_11271 = v0;
...
void __37__HMDIdentityRegistry_sharedRegistry__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating HMDIdentity Registry", &v8, 0xCu);
  }
