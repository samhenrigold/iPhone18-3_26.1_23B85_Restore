...
uint64_t __33__HMDStreamInterface_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v12_55025;
  logCategory__hmf_once_v12_55025 = v0;
  ...
  if (((extractor)(v5, v34, &v20) & 0x80000000) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v25 = 1024;
      v26 = v15;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get the peer name: %s (%d)", buf, 0x1Cu);
    }
