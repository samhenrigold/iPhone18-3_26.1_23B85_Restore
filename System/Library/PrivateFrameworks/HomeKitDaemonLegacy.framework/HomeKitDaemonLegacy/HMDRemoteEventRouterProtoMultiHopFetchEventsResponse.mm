  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self addChangedEvents:*(*(&v9 + 1) + 8 * v8++), v9];
      }
...
- (void)copyTo:(id)to
{
  ...
  if ([(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self changedEventsCount])
  {
    ...
    changedEventsCount = [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self changedEventsCount];
...
- (id)description
{
  ...
  dictionaryRepresentation = [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self dictionaryRepresentation];
