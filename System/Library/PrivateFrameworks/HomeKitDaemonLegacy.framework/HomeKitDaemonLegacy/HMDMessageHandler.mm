...
- (void)didTriggerQueuedOutgoingMessage:(id)message
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to send queued outgoing message: %@ error: %@", &v13, 0x20u);
    }
...
- (void)didTriggerQueuedIncomingMessage:(id)message
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to send queued incoming message: %@ error: %@", &v13, 0x20u);
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 2112;
        v16 = messageCopy;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Dropping unknown triggered queued message: %@", &v13, 0x16u);
      }
...
- (void)handleAccountAddedDeviceNotification:(id)notification
{
      ...
      if ([identifier hmf_isEqualToUUID:identifier2])
      {
        ...
        if (hasQueuedOutgoingMessages)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            v23 = 138543362;
            v24 = v18;
            _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending queued outgoing messages due to new account device added", &v23, 0xCu);
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get new device from notification: %@", &v23, 0x16u);
    }
...
- (BOOL)isReadyForOutgoingMessaging
{
  ...
  if (!device)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Not ready for outgoing messaging due to no device for account manager: %@", &v10, 0x16u);
    }
...
- (id)deviceForMessage:(id)message
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remote device message destination due to no data source", &v13, 0xCu);
    }
...
- (BOOL)shouldRelayIncomingMessage:(id)message error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = dataSource;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get relay preference from data source: %@", &v16, 0x16u);
    }
...
- (BOOL)isReadyForIncomingMessage:(id)message error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get is ready for message value due to no data source", &v14, 0xCu);
    }
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v44 = 2112;
        v45 = v25;
        _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to relay preference error: %@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v44 = 2112;
        v45 = v22;
        _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to no handler available for message: %@", buf, 0x16u);
      }
...
LABEL_27:
  ...
  if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v43 = v33;
    _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_INFO, "%{public}@Skipping routing message since message was already dequeued on another thread", buf, 0xCu);
  }
...
- (void)associateDevice:(id)device withOutgoingMessage:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = messageCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Associating device: %@ with outgoing message: %@", &v15, 0x20u);
  }
...
- (void)queueOutgoingMessage:(id)message
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = messageCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Queueing outgoing message: %@", &v22, 0x16u);
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = message;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Canceling queued outgoing message due to duplicate message name for message: %@", &v22, 0x16u);
    }
...
- (id)dequeueQueuedIncomingMessages
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Dequeueing incoming messages: %@", &v11, 0x16u);
  }
...
- (void)queueIncomingMessage:(id)message
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = messageCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Queueing incoming message: %@", &v22, 0x16u);
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = message;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Canceling queued incoming message due to duplicate message name for message: %@", &v22, 0x16u);
    }
...
- (void)registerForMessagesWithHome:(id)home
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Registering for messages owner: %@, admin: %@, internal: %@", &v12, 0x2Au);
  }
...
- (void)configureWithHome:(id)home
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuring", &v10, 0xCu);
  }
...
uint64_t __32__HMDMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v61_178012;
  logCategory__hmf_once_v61_178012 = v0;
