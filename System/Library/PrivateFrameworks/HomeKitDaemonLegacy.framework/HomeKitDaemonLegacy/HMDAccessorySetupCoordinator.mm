...
- (void)_handleStagedPairingReadyToCancel:(id)cancel forRequest:(id)request
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = uUID;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Handling ready to cancel for request UUID: %@", &v25, 0x16u);
  }
  ...
  if (pendingCancelMessage)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 138543362;
      v26 = v18;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to a pending Cancel message", &v25, 0xCu);
    }
...
LABEL_6:
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@", buf, 0x20u);
  }
...
- (id)_createCHIPSetupAccessoryPayloadWithSetupPayloadDecimalStringRepresentation:(id)representation error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from decimal string representation: %@", &v17, 0x16u);
    }
...
void __78__HMDAccessorySetupCoordinator_handleCancelStagedCHIPAccessoryPairingMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to discard staged accessory server: %@", &v10, 0x16u);
    }
...
- (void)handleCancelStagingMessage:(id)message
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 2112;
      v40 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling cancel staging message with staging request UUID: %@", &v37, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (error)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v39 = 2112;
          v40 = error2;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to cancel staging message with success in presence of queued pairing error: %@", &v37, 0x16u);
        }
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            v39 = 2112;
            v40 = v6;
            _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_INFO, "%{public}@Staging request UUID: %@ is not ready to cancel yet", &v37, 0x16u);
          }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        v39 = 2112;
        v40 = v6;
        _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for cancel staging message with staging request UUID: %@", &v37, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v39 = 2112;
      v40 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in cancel staging message payload: %@", &v37, 0x16u);
    }
...
- (void)handleRejectDeviceCredentialMessage:(id)message
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 2112;
      v46 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling reject device credential message with staging request UUID: %@", &v43, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (error)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v45 = 2112;
          v46 = error2;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to reject device credential message with queued pairing error: %@", &v43, 0x16u);
        }
...
LABEL_21:
          _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, v35, &v43, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v45 = 2112;
        v46 = v6;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for reject device credential message with staging request UUID: %@", &v43, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v45 = 2112;
      v46 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in reject device credential message payload: %@", &v43, 0x16u);
    }
...
- (void)handleConfirmDeviceCredentialMessage:(id)message
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v42 = 2112;
      v43 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling confirm device credential message with staging request UUID: %@", &v40, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (error)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v42 = 2112;
          v43 = error2;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to confirm device credential message with queued pairing error: %@", &v40, 0x16u);
        }
...
LABEL_9:
      ...
      if (!confirmDeviceCredentialCompletionHandler)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          v42 = 2112;
          v43 = v6;
          _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@No pending confirm device credential completion handler exists for staging request UUID: %@", &v40, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v42 = 2112;
        v43 = v6;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for confirm device credential message with staging request UUID: %@", &v40, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v42 = 2112;
      v43 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in confirm device credential message payload: %@", &v40, 0x16u);
    }
  ...
  if (v9)
  {
    ...
    if (v24)
    {
      ...
      *buf = 138546434;
      ...
      v147 = 2112;
      v148 = v33;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x84u);
    ...
    if (chipAccessorySetupPayload)
    {
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138545410;
        ...
        v139 = 2112;
        v140 = v54;
        _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x5Cu);
      ...
      if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v127 = 2112;
        v128 = uUID2;
        _os_log_impl(&dword_2531F8000, v75, OS_LOG_TYPE_INFO, "%{public}@Handling stage CHIP accessory pairing in steps message with setup payload: %@, request UUID: %@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v125 = 2112;
        v126 = v104;
        _os_log_impl(&dword_2531F8000, v59, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory setup payload on setup accessory payload: %@", buf, 0x16u);
...
- (void)stopMetricsForThirdPartyPairingWithError:(id)error
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = errorCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Stop metrics for 3rd party pairing, error:%@", &v22, 0x16u);
  }
  ...
  if (isValid)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = @"Stop";
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@", &v22, 0x20u);
      }
...
- (void)startMetricsForThirdPartyPairing
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 138543362;
    v24 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Start metrics for 3rd party pairing", &v23, 0xCu);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = @"Start";
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@", &v23, 0x20u);
  }
...
- (id)createSetupAccessoryPayloadWithCHIPSetupPayload:(id)payload error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload %@", &v17, 0x16u);
    }
...
- (id)createCHIPSetupAccessoryPayloadWithSetupPayloadURL:(id)l error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload URL string: %@", &v19, 0x16u);
    }
