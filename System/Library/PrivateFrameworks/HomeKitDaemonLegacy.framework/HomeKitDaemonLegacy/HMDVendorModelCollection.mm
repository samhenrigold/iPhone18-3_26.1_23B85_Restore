...
- (id)lookupProductData:(id)data
{
  ...
  v14 = &v13;
  v15 = 0x3032000000;
  v16 = __Block_byref_object_copy__108667;
  v17 = __Block_byref_object_dispose__108668;
  v18 = 0;
  if (self)
  {
    entries = self->_entries;
...
- (id)lookupModel:(id)model
{
  ...
  v22 = 0;
  if (modelCopy && (!self ? (entries = 0) : (entries = self->_entries), v6 = entries, v11 = MEMORY[0x277D85DD0], v12 = 3221225472, v13 = __40__HMDVendorModelCollection_lookupModel___block_invoke, v14 = &unk_27972B0B0, v15 = modelCopy, v16 = &v17, [(NSMutableSet *)v6 hmf_enumerateWithAutoreleasePoolUsingBlock:&v11], v6, v15, (v7 = v18[5]) != 0))
  {
    v8 = v7;
  }
