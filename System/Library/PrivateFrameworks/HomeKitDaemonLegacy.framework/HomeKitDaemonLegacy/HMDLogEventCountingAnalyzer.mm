...
- (void)incrementPeriodicCountersForEventName:(id)name
{
  ...
  {
    [(NSMutableDictionary *)self->_currentPeriodCounters setObject:&unk_286627D90 forKeyedSubscript:nameCopy];
  }
...
- (HMDLogEventCountingAnalyzer)initWithEventCountersManager:(id)manager dailyScheduler:(id)scheduler dateProvider:(id)provider systemInfo:(id)info queue:(id)queue
{
  ...
  v14[3] = &unk_279725348;
  selfCopy = self;
  v12 = [(HMDLogEventCountingAnalyzer *)selfCopy initWithEventCountersManager:manager dailyScheduler:scheduler dateProvider:provider systemInfo:info queue:queue loggingPeriodicitySeconds:900 tickSecondsProviderBlock:&__block_literal_global_37603 periodicCountersLoggingBlock:v14];
...
void __105__HMDLogEventCountingAnalyzer_initWithEventCountersManager_dailyScheduler_dateProvider_systemInfo_queue___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v5;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@[Logging Period = %d Minutes] Metric event counts on current device: %@ %@", &v11, 0x26u);
  }
