...
uint64_t __34__HMDAssistantCommand_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_12907;
  logCategory__hmf_once_v3_12907 = v0;
...
void __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      v17[1] = 3221225472;
      v17[2] = __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke_134;
      v17[3] = &unk_279735738;
      v19 = *(a1 + 32);
      v18 = v3;
...
- (void)handleGetColor:(id)color forObjects:(id)objects serviceType:(id)type completionHandler:(id)handler
{
  ...
  if ([array count])
  {
    ...
    *(&buf + 1) = &buf;
    v112 = 0x3032000000;
    v113 = __Block_byref_object_copy__13089;
    v114 = __Block_byref_object_dispose__13090;
...
void __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Received error %@ for read request with response tuples: %@", &v17, 0x20u);
    }
...
uint64_t __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke_128(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for set-action-types, calling result handler", &v7, 0xCu);
  }
...
- (void)handleSetColor:(id)color forObjects:(id)objects service:(id)service completionHandler:(id)handler
{
  ...
  if ([v62 count])
  {
    ...
    v100 = &v99;
    v101 = 0x3032000000;
    v102 = __Block_byref_object_copy__13089;
    v103 = __Block_byref_object_dispose__13090;
    array = [MEMORY[0x277CBEB18] array];
...
void __75__HMDAssistantCommand_handleSetColor_forObjects_service_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v5;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response %@ for write request with %@", &v17, 0x20u);
    }
...
LABEL_22:
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
  {
    ...
    v38 = 2112;
    v39 = actionType12;
    _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri sent an unsupported action type: %@", &v34, 0x20u);
  }
...
LABEL_7:
      ...
      v27 = 2112;
      v28 = actionType3;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri sent an unsupported action type: %@", &v23, 0x20u);
    }
...
LABEL_30:
          ...
          *&buf[8] = buf;
          *&buf[16] = 0x3032000000;
          v150 = __Block_byref_object_copy__13089;
          *&v151 = __Block_byref_object_dispose__13090;
...
LABEL_69:
  ...
  else
  {
    if ([v93 count])
    {
      ...
      v103[1] = 3221225472;
      v103[2] = __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_110;
      v103[3] = &unk_279723128;
...
uint64_t __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_111(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for update-action-types, calling result handler", &v7, 0xCu);
  }
...
LABEL_6:
  ...
  *&buf[8] = buf;
  *&buf[16] = 0x3032000000;
  v157 = __Block_byref_object_copy__13089;
  v158 = __Block_byref_object_dispose__13090;
  array = [MEMORY[0x277CBEB18] array];
  includeCompleteInformation = [typesCopy includeCompleteInformation];
  v148 = 0u;
  v149 = 0u;
...
- (void)handleSetNaturalLightingAction:(id)action serviceType:(id)type forObjects:(id)objects completionHandler:(id)handler
{
  ...
  if (v59)
  {
    ...
    v75 = 0u;
    obj = objectsCopy;
    v21 = [obj countByEnumeratingWithState:&v74 objects:v84 count:16];
    if (v21)
    {
      v63 = 0;
      v22 = *v75;
        ...
        for (i = 0; i != v21; ++i)
        {
          ...
          if (v25)
          {
            ...
            if (!v31)
            {
              ...
              v72[3] = &unk_2797285D0;
              v73 = v26;
              v34 = [lightProfiles na_firstObjectPassingTest:v72];
    ...
    else
    {
      ...
      naturalLightingCurveWriter = [v63 naturalLightingCurveWriter];
      value2 = [v59 value];
      v64[0] = MEMORY[0x277D85DD0];
      v64[1] = 3221225472;
      v64[2] = __95__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_completionHandler___block_invoke_102;
      v64[3] = &unk_279723100;
      ...
      v69 = obj;
      v70 = handlerCopy;
      [naturalLightingCurveWriter setNaturalLightingEnabled:value2 forLightProfiles:v66 completion:v64];
        ...
        if ([v27 count])
        {
          ...
          if (v66)
          {
            ...
            if ([obj count])
            {
              ...
              *&buf[8] = buf;
              *&buf[16] = 0x3032000000;
              v100 = __Block_byref_object_copy__13089;
              v101 = __Block_byref_object_dispose__13090;
              array2 = [MEMORY[0x277CBEB18] array];
              objc_initWeak(&location, self);
              v91 = 0u;
              v92 = 0u;
...
uint64_t __85__HMDAssistantCommand_handleGetActionTypes_serviceType_forObjects_completionHandler___block_invoke_100(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for get-action-types, calling result handler", &v7, 0xCu);
  }
...
- (void)handleMediaAccessorySetActionType:(id)type forObjects:(id)objects withServiceType:(id)serviceType completionHandler:(id)handler
{
  ...
  if (attribute)
  {
    ...
    if (v17)
    {
      ...
      *(&buf + 1) = &buf;
      v79 = 0x3032000000;
      v80 = __Block_byref_object_copy__13089;
      v81 = __Block_byref_object_dispose__13090;
      array2 = [MEMORY[0x277CBEB18] array];
      v69 = 0u;
      v70 = 0u;
      v71 = 0u;
...
uint64_t __102__HMDAssistantCommand_handleMediaAccessorySetActionType_forObjects_withServiceType_completionHandler___block_invoke_97(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for Apple Media Accessory get-action-types, calling result handler", &v7, 0xCu);
  }
        ...
        if (accessoryName)
        {
          ...
          if (![v37 count])
          {
            ...
            if (os_log_type_enabled(v92, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543362;
              v129 = v94;
              _os_log_impl(&dword_2531F8000, v92, OS_LOG_TYPE_INFO, "%{public}@After filtering for accessoryName, no objects to apply the command to", buf, 0xCu);
          ...
          if (v95)
          {
            ...
            if (![v37 count])
            {
              ...
              if (os_log_type_enabled(v101, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543362;
                v129 = v103;
                _os_log_impl(&dword_2531F8000, v101, OS_LOG_TYPE_INFO, "%{public}@After filtering for actionSetType, no objects to apply the command to", buf, 0xCu);
  ...
  if (homeIdentifier)
  {
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v49 = 2112;
        v50 = homeIdentifier3;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Matched home %@ with the homeIdentifier %@ from SCF", &v45, 0x20u);
      }
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
    {
      ...
      v47 = 2112;
      v48 = homeIdentifier4;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_FAULT, "%{public}@No home found with identifier %@", &v45, 0x16u);
    }
  ...
  if (homeName)
  {
    ...
    if ([v20 count] >= 2)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        ...
        v47 = 2112;
        v48 = homeName3;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_FAULT, "%{public}@Multiple homes found with name %@, homeIdentifier should be used instead", &v45, 0x16u);
      }
    ...
    if (firstObject)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        v49 = 2112;
        v50 = homeName5;
        _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_INFO, "%{public}@Matched home %@ with the homeName %@ from SCF after a homeIdentifier mismatch", &v45, 0x20u);
      }
...
LABEL_24:
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 138543362;
      v46 = v39;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_INFO, "%{public}@No matches for the home name/identifier specified in Siri command - bailing out....", &v45, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      v45 = 138543362;
      v46 = v43;
      _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_INFO, "%{public}@Cannot evaluate the home to apply the Siri command to - bailing out....", &v45, 0xCu);
    }
  ...
  if (!home || nameCopy && ([home name], v8 = objc_claimAutoreleasedReturnValue(), v9 = objc_msgSend(nameCopy, "isEqual:", v8), v8, !v9))
  {
    ...
    if (v17 && (!nameCopy || ([v17 name], v18 = objc_claimAutoreleasedReturnValue(), v19 = objc_msgSend(nameCopy, "isEqual:", v18), v18, v19)))
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v17;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Defaulting to current home %@ of the device", &v30, 0x16u);
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = v14;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Defaulting to primary home %@ of the device", &v30, 0x16u);
      }
...
LABEL_20:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = home;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Defaulting to home %@ that this device belongs to", &v30, 0x16u);
  }
      ...
      if (temperatureConversionIsNeeded(unitsCopy))
      {
        ...
        *&v19 = (v18 * 1.8) + 32.0;
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 2112;
          v32 = v16;
          _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@adjustGet: Attribute %@ value %@  adjusted to Fahrenheit %@", &v25, 0x2Au);
        }
      ...
      if (temperatureConversionIsNeeded(unitsCopy))
      {
        ...
        *&v19 = ((v18 + -32.0) * 5.0) / 9.0;
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 2112;
          v32 = v16;
          _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@adjustSet: Attribute %@ value %@  converted to Celsius as %@", &v25, 0x2Au);
        }
