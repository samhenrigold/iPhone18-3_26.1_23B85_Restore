  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to remove migration record from disk %@ (%@)", buf, 0x20u);
    }
...
LABEL_8:
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, v11, &v18, 0xCu);
  ...
  if ([(HMDHH2MigratorRecord *)self migrateFromTestDirectory])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v6;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Not enforcing the migration attempt as we are doing migration from test directory", &v18, 0xCu);
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Increased migration attempt to %u", &v18, 0x12u);
  }
...
- (BOOL)writeToDisk
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v19 = v15;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot prepare HH2 migrator record dictionary", buf, 0xCu);
    }
...
- (BOOL)writeMigratorRecord:(id)record
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = recordCopy;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to create an archive of the HH2 migrator record : %@", &v19, 0x16u);
LABEL_9:
    }
...
LABEL_10:
  ...
  if ((v7 & 1) == 0)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to write the HH2 migrator record to %@", &v19, 0x16u);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully written HH2 migrator record to disk: %@ : %@", &v19, 0x20u);
  }
...
LABEL_10:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v17 = v13;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot prepare HH2 migrator record", buf, 0xCu);
      }
...
- (void)unarchiveRecordFromData:(id)data
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Successfully got the HH2 Migrator record : %@", &v13, 0x16u);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the valid HH2 Migrator record from stored archive.", &v13, 0xCu);
    }
  }
...
- (void)readMigratorRecord
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Going to read migrator record from : %@", buf, 0x16u);
  }
  ...
  if (v10 || !v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543618;
      ...
      v18 = 2112;
      v19 = v10;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Current device is not the migrator: %@", buf, 0x16u);
    }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v56 = 2112;
      v57 = v2;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Found migration failure record on disk at %@. Going to read it.", buf, 0x16u);
    }
        ...
        if (v21)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, "%{public}@Successfully read the migration failure record %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v56 = 2112;
            v57 = v20;
            _os_log_impl(&dword_2531F8000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to open the migration failure record from archive data: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v56 = 2112;
          v57 = v19;
          _os_log_impl(&dword_2531F8000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive migration failure record from archive data: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v56 = 2112;
        v57 = v10;
        _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_ERROR, "%{public}@Unable to read the migration failure record due to an error: [%@]", buf, 0x16u);
      }
...
+ (BOOL)recordMigrationFailureWithError:(id)error
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Going to write migration failure record : [%@] -> [%@]", &v27, 0x20u);
  }
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 22;
LABEL_13:
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, v23, &v27, v25);
    }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v31 = 2112;
    v32 = v7;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully written migration failure record on disk : %@, %@", &v27, 0x20u);
  }
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive HMDHH2MigratorRecord from archive data: %@", buf, 0x16u);
    }
...
+ (id)archiveMigratorDict:(id)dict
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = dictCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Going to archive : %@", &v11, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_84175 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t4_84175, &__block_literal_global_22_84176);
  }

  v3 = logCategory__hmf_once_v5_84177;
...
uint64_t __35__HMDHH2MigratorRecord_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_84177;
  logCategory__hmf_once_v5_84177 = v0;
...
+ (id)singleRecord
{
  ...
  {
    dispatch_once(&singleRecord_onceToken, &__block_literal_global_84182);
  }
