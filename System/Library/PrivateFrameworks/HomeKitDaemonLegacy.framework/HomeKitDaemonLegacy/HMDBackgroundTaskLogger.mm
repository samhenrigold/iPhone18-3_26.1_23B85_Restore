...
- (void)submitNotFiredLogEventForTask:(id)task
{
  ...
  if (v8 != 1)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v22 = 2112;
      v23 = identifier;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Submitting never fired log %@ with identifier %@", &v18, 0x20u);
    }
...
- (void)submitLogEventForTask:(id)task
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 2112;
    v20 = identifier;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Submitting log %@ with identifier %@", &v15, 0x20u);
  }
...
uint64_t __38__HMDBackgroundTaskLogger_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v3_157235;
  logCategory__hmf_once_v3_157235 = v0;
