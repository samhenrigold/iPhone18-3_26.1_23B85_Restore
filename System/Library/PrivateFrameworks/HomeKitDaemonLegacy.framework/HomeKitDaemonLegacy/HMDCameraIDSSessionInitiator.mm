...
- (void)_callSessionStarted
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling didSetUp delegate", &v9, 0xCu);
  }
...
- (void)sessionEnded:(id)ended withReason:(unsigned int)reason error:(id)error
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2114;
    v23 = errorCopy;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@IDSSession %{public}@ has ended with reason: %{public}u and error %{public}@", &v16, 0x26u);
  }
...
- (void)sessionStarted:(id)started
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2114;
    v14 = startedCopy;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@IDSSession %{public}@ has started", &v11, 0x16u);
  }
...
- (void)session:(id)session receivedInvitationCancelFromID:(id)d
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = dCopy;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ was canceled by: %@", &v13, 0x20u);
  }
...
- (void)session:(id)session receivedInvitationDeclineFromID:(id)d
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = dCopy;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ has been declined by: %@", &v13, 0x20u);
  }
...
- (void)session:(id)session receivedInvitationAcceptFromID:(id)d
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = dCopy;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %{public}@ has been accepted by: %@, waiting for session to get started", &v13, 0x20u);
  }
...
void __58__HMDCameraIDSSessionInitiator_packetRelay_didStop_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay did stop: %@ error: %@", &v8, 0x20u);
  }
...
void __59__HMDCameraIDSSessionInitiator_packetRelay_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2114;
    v13 = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay did start: %{public}@ error: %{public}@", &v8, 0x20u);
  }
...
- (void)_startPacketRelayWithVideoSocket:(int)socket videoNetworkConfig:(id)config cameraVideoSSRC:(unsigned int)c audioSocket:(int)audioSocket audioNetworkConfig:(id)networkConfig cameraAudioSSRC:(unsigned int)rC
{
  ...
  if (idsSession)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *&v73[4] = 2112;
      *&v73[6] = configCopy;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Created video relay connection with SSRC %08x and config: %@", buf, 0x1Cu);
    }
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *&v73[6] = networkConfigCopy;
      _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_INFO, "%{public}@Created audio relay connection with SSRC %08x and config: %@", buf, 0x1Cu);
    }
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v72 = 2112;
      *v73 = destination2;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_INFO, "%{public}@Created IDS relay connection with destination: %@", buf, 0x16u);
    ...
    if (v66 && v28 && v35)
    {
      ...
      if (packetRelay)
      {
        if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v71 = v50;
          _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay", buf, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v72 = 2112;
          *v73 = v44;
          _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
      {
        ...
        *&v73[10] = v65;
        v74 = 2112;
        v75 = v35;
        _os_log_impl(&dword_2531F8000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to start packet relay with relayConnectionCameraVideo: %@, relayConnectionCameraAudio: %@, relayConnectionIDS: %@", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v71 = v56;
      _os_log_impl(&dword_2531F8000, v55, OS_LOG_TYPE_ERROR, "%{public}@Cannot start packet relay because no IDS session exists", buf, 0xCu);
    }
