...
- (void)timerDidFire:(id)fire
{
  ...
  if (requestInviteTimer == fireCopy)
  {
    if (v10)
    {
      ...
      v21 = 138543362;
      v22 = v12;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Request invite timer fired", &v21, 0xCu);
    }
...
LABEL_12:
      ...
      v23 = 2112;
      v24 = v17;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Canceling request invite timer due to trust manager configure state: %@", &v21, 0x16u);
    }
    ...
    else
    {
      ...
      v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Canceling request invite timer due to reaching max interval time", &v21, 0xCu);
    }
  ...
  if (v10)
  {
    ...
    v23 = 2112;
    v24 = fireCopy;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Received timer did fire call from unknown timer: %@", &v21, 0x16u);
  }
...
- (void)_startRequestInviteTimer
{
  ...
  if (requestInviteTimer)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Request invite timer already started", &v19, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Starting request invite timer", &v19, 0xCu);
    }
...
- (void)_didRemoveZone
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Trust zone has been removed", &v10, 0xCu);
  }
...
- (void)_didCreateZone
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Trust zone has been created", &v13, 0xCu);
  }
  ...
  if ([(HMDCloudShareTrustManager *)selfCopy configureState]== 3)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Forcing trust from removed to unconfigured state due to a zone creation notification", &v13, 0xCu);
    }
...
void __75__HMDCloudShareTrustManager_messenger_didReceiveInvitationData_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Trust zone invitation was not accepted: %@", &v9, 0x16u);
  }
...
void __75__HMDCloudShareTrustManager_messenger_didReceiveInvitationData_completion___block_invoke_40(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Trust zone invitation was accepted", &v8, 0xCu);
  }
...
- (void)localZone:(id)zone didProcessModelUpdate:(id)update
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = updateCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trust zone updated unknown model: %@", &v13, 0x16u);
  }
...
- (void)localZone:(id)zone didProcessModelDeletion:(id)deletion
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = deletionCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trust zone deleted unknown model: %@", &v13, 0x16u);
  }
...
- (void)localZone:(id)zone didProcessModelCreation:(id)creation
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 2112;
    v16 = creationCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trust zone created unknown model: %@", &v13, 0x16u);
  }
...
- (void)cloudZone:(id)zone didRemoveParticipantWithClientIdentifier:(id)identifier
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = identifierCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Trust zone removed participant with client identifier: %@", &v13, 0x16u);
  }
...
- (void)setConfigureState:(int64_t)state
{
  ...
  if (self->_configureState == 3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot change from removed state to: %@", &v11, 0x16u);
    }
...
- (void)_homeDidBecomeTrustZoneCapable:(id)capable
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Owner is now capable of establishing trust zones", &v15, 0xCu);
  }
  ...
  if (requestInviteTimer)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Skipping reconfigure since a request invite timer exists", &v15, 0xCu);
    }
...
void __63__HMDCloudShareTrustManager_sendShareInvitation_toUser_device___block_invoke_29(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Cloud pull fail with error:%@", &v9, 0x16u);
  }
...
void __63__HMDCloudShareTrustManager_sendShareInvitation_toUser_device___block_invoke_30(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Cloud pull was successful", &v8, 0xCu);
  }
...
void __55__HMDCloudShareTrustManager_updateCloudShareIDForUser___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch cloud share ID for %@: %@", &v10, 0x20u);
  }
...
void __55__HMDCloudShareTrustManager_updateCloudShareIDForUser___block_invoke_22(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Received cloud share ID for %@: %@", &v9, 0x20u);
  }
...
void __58__HMDCloudShareTrustManager_updateCurrentUserCloudShareID__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch cloud share id for current user, error: %@", &v9, 0x16u);
  }
...
void __58__HMDCloudShareTrustManager_updateCurrentUserCloudShareID__block_invoke_21(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Received current user cloud share id: %@", &v11, 0x16u);
  }
...
void __40__HMDCloudShareTrustManager_removeTrust__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed cloud share trust removal, error: %@", &v9, 0x16u);
  }
...
void __40__HMDCloudShareTrustManager_removeTrust__block_invoke_19(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Cloud share trust has been removed", &v9, 0xCu);
  }
...
- (void)_finishConfigure
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Trust manager finished configuring", &v9, 0xCu);
  }
...
void __70__HMDCloudShareTrustManager__configureOwnerCloudShareIDWithCloudZone___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Could not read owner cloud share id in trust zone, error: %@", &v9, 0x16u);
  }
...
void __70__HMDCloudShareTrustManager__configureOwnerCloudShareIDWithCloudZone___block_invoke_17(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Read trust zone owner cloud share ID: %@", &v9, 0x16u);
  }
...
- (void)_configureWithFetchZoneResult:(id)result error:(id)error
{
  ...
  if (resultCopy)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *v38 = 138543362;
      *&v38[4] = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Did fetch trust cloud zone", v38, 0xCu);
    }
    ...
    if ([(HMDCloudShareTrustManager *)selfCopy isOwnedTrust])
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *v38 = 138543362;
        *&v38[4] = v22;
        _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting participant manager to share trust zone", v38, 0xCu);
      }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *&v38[14] = v36;
      v39 = 2112;
      v40 = errorCopy;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to open trust zone: %@, error: %@", v38, 0x20u);
    }
...
- (void)_requestShareInvitationForSharedZone
{
  ...
  if ([dataSource isOwnerCapableForTrustManager:self])
  {
    ...
    if (ownerCloudShareID)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 138543362;
        v22 = v9;
        _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@We have a cloud share ID for the owner, but we aren't invited to the share", &v21, 0xCu);
      }
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = uuid;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Requesting trust zone share invitation from trust owner with id: %@", &v21, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v20;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping request for trust invitation due to owner being incapable of setting up trust", &v21, 0xCu);
    }
...
- (void)_configure
{
  ...
  if ([(HMDCloudShareTrustManager *)self configureState])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Skipping cloud share trust configure. Trust already in configure state: %@", &v17, 0x16u);
    }
  ...
  else
  {
    ...
    if (isOwnedTrust)
    {
      if (v14)
      {
        ...
        v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring cloud share trust with owned trust", &v17, 0xCu);
      }
    ...
    else
    {
      if (v14)
      {
        ...
        v17 = 138543362;
        v18 = v16;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring cloud share trust with shared trust", &v17, 0xCu);
      }
