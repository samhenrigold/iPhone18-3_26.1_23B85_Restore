...
uint64_t __38__HMDMediaSystemComponent_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_106568;
  logCategory__hmf_once_v5_106568 = v0;
...
+ (id)mediaSystemComponentWithDictionary:(id)dictionary home:(id)home
{
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          v24 = 2112;
          v25 = dictionaryCopy;
          _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@Role entry is nil - cannot create mediaSystemComponent with %@", &v22, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 2112;
        v27 = homeCopy;
        _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@accessory cannot be looked up - cannot create mediaSystemComponent with %@in home %@", &v22, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = dictionaryCopy;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@mediaComponentUUID is nil - cannot create mediaSystemComponent with %@", &v22, 0x16u);
    }
...
+ (id)accessoryForMediaSystemComponentWithDictionary:(id)dictionary home:(id)home
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = homeCopy;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@accessoryUUID is nil transaction dictionary - cannot find accessory with %@in home %@", &v14, 0x20u);
    }
