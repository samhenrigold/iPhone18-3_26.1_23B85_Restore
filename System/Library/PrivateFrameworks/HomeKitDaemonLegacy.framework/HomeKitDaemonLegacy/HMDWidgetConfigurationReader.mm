...
- (id)fetchedHomeWidgets
{
  if (self)
  {
    ...
    v13 = &v12;
    v14 = 0x3032000000;
    v15 = __Block_byref_object_copy__186702;
    v16 = __Block_byref_object_dispose__186703;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_186712 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t18_186712, &__block_literal_global_186713);
  }

  v3 = logCategory__hmf_once_v19_186714;
