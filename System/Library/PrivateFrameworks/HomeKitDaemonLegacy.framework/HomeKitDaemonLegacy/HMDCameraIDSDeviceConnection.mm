...
- (void)_createStreamSocketWithDevice:(id)device
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *&buf[12] = 2112;
    *&buf[14] = deviceCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating stream sockets with device: %@", buf, 0x16u);
  }
...
LABEL_35:
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_ERROR))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = v34;
        _os_log_impl(&dword_2531F8000, v86, OS_LOG_TYPE_ERROR, "%{public}@Failed to create IDS connections: %@", buf, 0x16u);
      }
...
LABEL_7:
  ...
  if (v13)
  {
    ...
    v14->_idsDeviceConnectionFactory = &__block_literal_global_44235;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t26_44252 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t26_44252, &__block_literal_global_51_44253);
  }

  v3 = logCategory__hmf_once_v27_44254;
