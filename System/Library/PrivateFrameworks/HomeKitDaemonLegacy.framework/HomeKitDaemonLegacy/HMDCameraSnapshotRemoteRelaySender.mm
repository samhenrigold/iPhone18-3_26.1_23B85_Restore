...
- (void)snapshotLocal:(id)local didSaveSnapshotFile:(id)file error:(id)error sessionID:(id)d
{
  ...
  if (errorCopy)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = errorCopy;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Snapshot local capture has ended in %@", &v29, 0x16u);
    }
  ...
  else
  {
    ...
    if (idsData)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 2112;
        v32 = fileCopy;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Scheduling the transfer of file %@ through IDS", &v29, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 138543362;
        v30 = v28;
        _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode snapshot file to send over IDS", &v29, 0xCu);
      }
...
- (void)_callDidSaveSnapshotFileDelegate:(id)delegate
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that snapshot file has been saved", &v13, 0xCu);
  }
...
uint64_t __49__HMDCameraSnapshotRemoteRelaySender_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_155244;
  logCategory__hmf_once_v2_155244 = v0;
