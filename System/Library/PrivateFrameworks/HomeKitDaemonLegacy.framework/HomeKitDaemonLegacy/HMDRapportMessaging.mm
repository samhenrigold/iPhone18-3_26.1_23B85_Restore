...
- (void)_invalidateDestinationDeviceWithIDSIdentifier:(id)identifier
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2114;
      v18 = identifierCopy;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Invalidating Rapport client for device: %{public}@", &v15, 0x16u);
    }
...
- (id)_createRapportClientForDevice:(id)device
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543618;
    ...
    v30 = 2112;
    v31 = deviceCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Creating Rapport client for device: %@", buf, 0x16u);
  }
  ...
  v21[1] = 3221225472;
  v21[2] = __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke_121;
  v21[3] = &unk_279732E78;
...
void __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2114;
    v12 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Rapport client disconnected for device: %{public}@", &v9, 0x16u);
  }
...
void __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke_121(uint64_t a1)
{
...
void __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2114;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Rapport client invalidated for device: %{public}@", &v8, 0x16u);
  }
...
void __58__HMDRapportMessaging__clientForIDSIdentifier_withDevice___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to activate Rapport client for device: %@, error: %@", &v9, 0x20u);
    }
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543618;
      ...
      v22 = 2112;
      v23 = v17;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@ Request handler is nil", buf, 0x16u);
    }
...
- (void)_configureDiscoveryClientWithCompletion:(id)completion forRequestIDs:(id)ds
{
  ...
  v71[1] = 3221225472;
  v71[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_97;
  v71[3] = &unk_279732FD8;
  ...
  v69[1] = 3221225472;
  v69[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_98;
  v69[3] = &unk_27972FEB8;
  ...
  v67[1] = 3221225472;
  v67[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_100;
  v67[3] = &unk_27972FEB8;
  ...
  v65[1] = 3221225472;
  v65[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_101;
  v65[3] = &unk_27972FEE0;
  ...
  v63[1] = 3221225472;
  v63[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_103;
  v63[3] = &unk_279732FD8;
  ...
  if (v39)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        aBlock[1] = 3221225472;
        aBlock[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_104;
        aBlock[3] = &unk_27972FF08;
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Discovery client interrupted", &v6, 0xCu);
  }

  objc_autoreleasePoolPop(v2);
}

void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_97(uint64_t a1)
{
  v8 = *MEMORY[0x277D85DE8];
  WeakRetained = objc_loadWeakRetained((a1 + 32));
  v2 = objc_autoreleasePoolPush();
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Discovery client invalidated", &v6, 0xCu);
  }

  objc_autoreleasePoolPop(v2);
}

void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_98(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Discovery client lost device: %@", &v10, 0x16u);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_100(uint64_t a1, void *a2)
{
  v13 = *MEMORY[0x277D85DE8];
  v3 = a2;
  WeakRetained = objc_loadWeakRetained((a1 + 32));
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Discovery client found device: %@", &v9, 0x16u);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_101(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Discovery client device changed: %@", &v9, 0x16u);
  }

  objc_autoreleasePoolPop(v5);
}

void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_103(uint64_t a1)
{
  v13 = *MEMORY[0x277D85DE8];
  WeakRetained = objc_loadWeakRetained((a1 + 32));
  v2 = objc_autoreleasePoolPush();
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = NSPrintF("%#ll{flags}", [Property errorFlags], &unk_253D4C08C);
    *buf = 138543618;
    v10 = v6;
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Discovery client error flag changed: %@", buf, 0x16u);
  }

  objc_autoreleasePoolPop(v2);
}

void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_104(uint64_t a1, void *a2, void *a3, void *a4)
{
  v12 = a2;
  v7 = a3;
  v8 = a4;
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Activated Rapport client with error: %@", &v10, 0x16u);
  }
...
- (BOOL)isRapportDeviceDiscoveredWithIdentifier:(id)identifier
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v19 = v14;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Discovery client is not configured", buf, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_157060 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t16_157060, &__block_literal_global_125_157061);
  }

  v3 = logCategory__hmf_once_v17_157062;
...
uint64_t __34__HMDRapportMessaging_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v17_157062;
  logCategory__hmf_once_v17_157062 = v0;
...
+ (HMDRapportMessaging)sharedInstance
{
  if (sharedInstance_onceToken_157067 != -1)
  {
    dispatch_once(&sharedInstance_onceToken_157067, &__block_literal_global_157068);
  }

  v3 = sharedInstance_sharedInstance_157069;
...
void __37__HMDRapportMessaging_sharedInstance__block_invoke()
{
  ...
  v2 = sharedInstance_sharedInstance_157069;
  sharedInstance_sharedInstance_157069 = v1;
}
