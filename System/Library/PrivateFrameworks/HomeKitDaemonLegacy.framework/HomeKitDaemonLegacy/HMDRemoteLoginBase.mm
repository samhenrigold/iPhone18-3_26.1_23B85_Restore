...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_107566 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_107566, &__block_literal_global_107567);
  }

  v3 = logCategory__hmf_once_v1_107568;
...
uint64_t __33__HMDRemoteLoginBase_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_107568;
  logCategory__hmf_once_v1_107568 = v0;
