...
- (void)setSetting:(id)setting forKeyPath:(id)path withError:(id *)error
{
  settingCopy = setting;
  pathCopy = path;
  if ([pathCopy isEqualToString:&stru_286509E58])
  {
    if (!error)
    {
      goto LABEL_141;
...
LABEL_81:
    ...
    v148 = [(HMDCompositeNumberSetting *)v145 initWithValue:&unk_286628528 readVersion:root_general_accessibility_vision_doubleTapSettings_timeoutSettings_timeoutInterval_value2 writeVersion:v147];
...
LABEL_105:
    ...
    v187 = [(HMDCompositeNumberSetting *)v184 initWithValue:&unk_286628540 readVersion:root_general_accessibility_vision_speakingRateSection_speakingRate_value2 writeVersion:v186];
...
LABEL_121:
    ...
    v213 = [(HMDCompositeNumberSetting *)v210 initWithValue:&unk_286628558 readVersion:root_general_accessibility_interaction_holdDuration_seconds_value2 writeVersion:v212];
...
LABEL_145:
    ...
    v252 = [(HMDCompositeNumberSetting *)v249 initWithValue:&unk_286628558 readVersion:root_general_accessibility_interaction_ignoreRepeat_seconds_value2 writeVersion:v251];
