...
- (void)database:(id)database didReceiveMessageWithUserInfo:(id)info
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = infoCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@did receive message with  user info %@", &v12, 0x16u);
  }
...
uint64_t __76__HMDCompositeSettingsZoneManager_database_didRemoveZoneWithName_isPrivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Zone removed", &v7, 0xCu);
  }
...
- (id)database:(id)database willRemoveZoneWithName:(id)name isPrivate:(BOOL)private
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v12;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@will remove zone", &v15, 0xCu);
  }
...
- (void)database:(id)database didCreateZoneWithName:(id)name isPrivate:(BOOL)private
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@did create zone", &v13, 0xCu);
  }
...
void __45__HMDCompositeSettingsZoneManager__configure__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@CloudZone Error: %@", &v8, 0x16u);
  }
...
void __45__HMDCompositeSettingsZoneManager__configure__block_invoke_13(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@CloudZone startup success", &v8, 0xCu);
  }
...
uint64_t __46__HMDCompositeSettingsZoneManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v6_166232;
  logCategory__hmf_once_v6_166232 = v0;
