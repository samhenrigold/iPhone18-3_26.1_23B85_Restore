...
- (void)_runLoggingForDate:(id)date isDailySummary:(BOOL)summary
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Submitting HMDThreadNetworkStabilityLogEvent: %@", &v16, 0x16u);
    }
...
- (void)stop
{
  ...
  if (self->_started)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping", &v7, 0xCu);
    }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 138543362;
    v12 = v10;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@This device does not support Thread network stability reporting", &v11, 0xCu);
  }
