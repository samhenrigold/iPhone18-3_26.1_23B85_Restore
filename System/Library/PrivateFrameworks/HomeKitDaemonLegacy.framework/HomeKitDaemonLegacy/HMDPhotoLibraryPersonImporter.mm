...
LABEL_10:
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, v9, &v10, 0xCu);
    }
...
- (void)_handleFMFDeviceChanged
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@FMF device changed, isThisDesignatedFMFDevice: %@", &v9, 0x16u);
  }
...
- (void)_handleUpdatedCloudPhotosSetting
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Cloud photos enabled changed to %@", &v10, 0x16u);
  }
...
- (void)_unconfigure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Unconfiguring photo library person importer", &v9, 0xCu);
  }
...
- (void)_configure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring photo library person importer", &v12, 0xCu);
  }
  ...
  if (v7)
  {
    ...
    if (v10 == 1)
    {
      if (v14)
      {
        ...
        v25 = 2112;
        v26 = v3;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring person with duplicate external person UUID: %@", &v23, 0x16u);
      }
...
id __40__HMDPhotoLibraryPersonImporter__import__block_invoke_9(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v8;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Committing batch change: %@", &v15, 0x16u);
  }
...
void __40__HMDPhotoLibraryPersonImporter__import__block_invoke_11(uint64_t a1, void *a2, void *a3)
{
  ...
  if ([*(a1 + 32) hasQueuedImport])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting queued import after finishing import", &v11, 0xCu);
    }
...
uint64_t __44__HMDPhotoLibraryPersonImporter_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v31_95974;
  logCategory__hmf_once_v31_95974 = v0;
