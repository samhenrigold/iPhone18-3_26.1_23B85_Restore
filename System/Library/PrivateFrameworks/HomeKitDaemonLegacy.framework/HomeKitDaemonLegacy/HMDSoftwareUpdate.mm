...
- (void)_handleNeedsAttentionReasonsRequest:(id)request
{
  ...
  if (responseHandler)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending %@ reply with payload %@", &v15, 0x20u);
    }
...
- (void)setNeedsAttentionReasons:(unint64_t)reasons
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v9;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@NeedsAttentionReasons updated to %@", &v22, 0x16u);
    }
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v14;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ to %@", &v22, 0x20u);
    }
...
void __46__HMDSoftwareUpdate_setDocumentationMetadata___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Updated documentation metadata: %@", &v8, 0x16u);
  }
...
LABEL_15:
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v25 = 2048;
        v26 = integerValue;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid state: %ld", &v23, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = messagePayload;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing state from message payload: %@", &v23, 0x16u);
      }
...
- (void)_updateState:(int64_t)state message:(id)message options:(id)options
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v32 = 2112;
    v33 = v15;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Updating state: %@ from current state: %@", &v28, 0x20u);
  }
...
LABEL_15:
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_ERROR, v22, &v32, 0xCu);
    }
...
uint64_t __32__HMDSoftwareUpdate_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v47_85370;
  logCategory__hmf_once_v47_85370 = v0;
