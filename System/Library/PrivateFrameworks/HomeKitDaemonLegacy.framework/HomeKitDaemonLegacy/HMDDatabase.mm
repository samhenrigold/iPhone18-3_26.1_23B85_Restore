...
- (void)localDatabase:(id)database willRemoveZoneWithID:(id)d
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 2112;
    v17 = dCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Local database %@ will remove zone with ID: %@", &v12, 0x20u);
  }
...
- (id)acceptInvitation:(id)invitation
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = invitationCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Accepting sharing invitation %@", &v12, 0x16u);
  }
...
- (id)removeSharedZonesWithName:(id)name
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = nameCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing shared zones with name %@", &v18, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = nameCopy;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Attempted to remove a non-existing shared zone with name: %@", &v18, 0x16u);
    }
...
- (id)removePrivateZonesWithName:(id)name
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = nameCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing private zones with name %@", &v13, 0x16u);
  }
...
- (id)synchronizeSharedZones
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Synchronizing shared zones", &v10, 0xCu);
  }
...
- (id)sharedZonesWithID:(id)d configuration:(id)configuration delegate:(id)delegate error:(id *)error
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = dCopy;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching shared zones with zone ID %@", &v20, 0x16u);
  }
...
- (id)privateZonesWithName:(id)name configuration:(id)configuration delegate:(id)delegate error:(id *)error
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = nameCopy;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching private zones with name %@", &v21, 0x16u);
  }
...
- (id)existingPrivateZonesWithName:(id)name configuration:(id)configuration delegate:(id)delegate error:(id *)error
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = nameCopy;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching existing private zones with name %@", &v21, 0x16u);
  }
...
- (id)unregisterSharedSubscriptionForExternalRecordType:(id)type
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = typeCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering shared subscription for external record type %@", &v12, 0x16u);
  }
...
- (id)registerSharedSubscriptionForExternalRecordType:(id)type
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = typeCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering shared subscription for external record type %@", &v12, 0x16u);
  }
...
- (void)start
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v12 = v6;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting database", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (stringValue)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v22 = 2112;
        v23 = stringValue2;
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding camera clips container identifier to %@", &v20, 0x16u);
      }
...
void __30__HMDDatabase_defaultDatabase__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding default container identifier to %@", &v17, 0x16u);
    }
