      ...
      if (!v23)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v53 = 2112;
          v54 = v22;
          _os_log_impl(&dword_2531F8000, v37, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid IP address value: %@", buf, 0x16u);
        }
    ...
    if (v47)
    {
      ...
      if (HIWORD(v48) > v48)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v52 = v28;
          _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Must have portStart less than or equal to portEnd", buf, 0xCu);
        }
