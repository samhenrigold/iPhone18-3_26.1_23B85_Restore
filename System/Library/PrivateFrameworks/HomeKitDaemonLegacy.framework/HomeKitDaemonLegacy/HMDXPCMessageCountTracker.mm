...
- (void)submitCounters
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v43 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Submitting counters", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_69959 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t4_69959, &__block_literal_global_29_69960);
  }

  v3 = logCategory__hmf_once_v5_69961;
...
uint64_t __40__HMDXPCMessageCountTracker_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_69961;
  logCategory__hmf_once_v5_69961 = v0;
...
+ (HMDXPCMessageCountTracker)sharedTracker
{
  ...
  {
    dispatch_once(&sharedTracker_onceToken, &__block_literal_global_69966);
  }
