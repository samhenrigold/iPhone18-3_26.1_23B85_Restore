...
void __59__HMDRemoteEventRouterClient_networkAvailabilityDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 138412290;
    v11 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "Network availability changed to %@", &v10, 0xCu);
...
- (void)configureIsPrimaryResident:(BOOL)resident networkAvailable:(BOOL)available additionalPolicies:(id)policies
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2112;
    v16 = v12;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEFAULT, "Configuring isPrimaryResident: %@, networkAvailable: %@", &v13, 0x16u);
  }
...
- (void)clientDidDisconnect:(id)disconnect
{
  ...
  {
    *v11 = 0;
    _os_log_impl(&dword_2531F8000, logger, OS_LOG_TYPE_DEFAULT, "Client disconnected from server", v11, 2u);
  }
...
- (void)client:(id)client fetchWithFilters:(id)filters isMultiHop:(BOOL)hop completion:(id)completion
{
  ...
  v19 = [filtersCopy na_map:&__block_literal_global_208];
...
void __76__HMDRemoteEventRouterClient_client_fetchWithFilters_isMultiHop_completion___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v8 && !v9)
  {
    ...
    v37[1] = 3221225472;
    v37[2] = __76__HMDRemoteEventRouterClient_client_fetchWithFilters_isMultiHop_completion___block_invoke_211;
    v37[3] = &unk_279723828;
    v33 = v32;
    v38 = v33;
...
void __76__HMDRemoteEventRouterClient_client_sendConnectWithAddedFilters_completion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v8 && !v9)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v22) = 0;
        _os_log_error_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "Did not find connect response", &v22, 2u);
      }
    ...
    if ([(HMDRemoteEventRouterProtoConnectResponse *)v12 cachedEventsCount])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v24 = 2112;
        v25 = v18;
        _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEFAULT, "Received %@ events in connect response of size %@", &v22, 0x16u);
      }
    ...
    if (v7)
    {
      if (!v10)
      {
        ...
        if (os_signpost_enabled(v21))
        {
          v22 = 138412290;
          v23 = v7;
          _os_signpost_emit_with_name_impl(&dword_2531F8000, v21, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientConnected", "serverIdentifier=%{signpost.description:attribute}@ ", &v22, 0xCu);
        }
      }
    }
  }
...
void __110__HMDRemoteEventRouterClient_sendChangeRegistrationsMessageWithAddedFilters_removedFilters_client_completion___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (v6 && !v7)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v19) = 0;
        _os_log_error_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "Did not find change registrations response", &v19, 2u);
      }
    ...
    if ([(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)v10 cachedEventsCount])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v21 = 2112;
        v22 = v16;
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEFAULT, "Received %@ events in change registrations response of size %@", &v19, 0x16u);
      }
...
- (void)_handleUpdatedEventsRequest:(id)request originalMessage:(id)message
{
  ...
  v37[1] = v37;
  v37[2] = 0x3032000000;
  v37[3] = __Block_byref_object_copy__17408;
  v37[4] = __Block_byref_object_dispose__17409;
  v38 = 0;
  v11 = dispatch_group_create();
  if ([requestCopy eventsCount])
  {
    events = [requestCopy events];
    v13 = [events na_map:&__block_literal_global_179];
    ...
    if (v13 && [v13 count])
    {
      ...
      v34[1] = 3221225472;
      v34[2] = __74__HMDRemoteEventRouterClient__handleUpdatedEventsRequest_originalMessage___block_invoke_181;
      v34[3] = &unk_279731688;
      v34[4] = self;
      v36 = v37;
      v35 = v11;
  ...
  if ([requestCopy cachedEventsCount])
  {
    ...
    v20 = [cachedEvents na_map:&__block_literal_global_184];
    ...
    if (v20 && [v20 count])
    {
      ...
      v31[1] = 3221225472;
      v31[2] = __74__HMDRemoteEventRouterClient__handleUpdatedEventsRequest_originalMessage___block_invoke_185;
      v31[3] = &unk_279731688;
      v31[4] = self;
      v33 = v37;
      v32 = v11;
  ...
  v28[1] = 3221225472;
  v28[2] = __74__HMDRemoteEventRouterClient__handleUpdatedEventsRequest_originalMessage___block_invoke_2_186;
  v28[3] = &unk_279734898;
  v29 = messageCopy;
  v30 = v37;
  v27 = messageCopy;
...
LABEL_19:
      ...
      _os_log_error_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, v24, buf, 2u);
      goto LABEL_18;
    }
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "Unable to decode payload from fragment message.", buf, 2u);
      if (!v14)
      {
        goto LABEL_24;
      }
...
- (void)handlePrimaryResidentConfirmedDeviceIdentifierChangeNotification:(id)notification
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_2531F8000, logger, OS_LOG_TYPE_DEFAULT, "Received primary resident change notification %@", &v13, 0xCu);
  }
  ...
  if (isCurrentDevicePrimaryResident != [(HMDRemoteEventRouterClient *)self isPrimaryResident])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v13 = 138412290;
      v14 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", &v13, 0xCu);
    }
...
- (void)_registerForMessages:(id)messages
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    v16 = 138412290;
    v17 = v13;
    _os_log_impl(&dword_2531F8000, logger, OS_LOG_TYPE_DEFAULT, "Registering for primary resident change notification %@", &v16, 0xCu);
  }
...
- (HMDRemoteEventRouterClient)initWithMessageTargetUUID:(id)d queue:(id)queue dataSource:(id)source messageDispatcher:(id)dispatcher notificationCenter:(id)center requestMessageName:(id)name updateMessageName:(id)messageName multiHopFetchResponseMessageName:(id)self0 logCategory:(const char *)self1 logEventSubmitter:(id)self2 eventRouterClientFactory:(id)self3
{
  ...
  if (v22)
  {
    ...
    v25 = [[_TtC19HomeKitDaemonLegacy28HMDRemoteConnectivityMonitor alloc] initWithFailedMessagesThreshold:3 connectivityLostTimerInterval:v22 delegate:queueCopy workQueue:60.0];
...
uint64_t __41__HMDRemoteEventRouterClient_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_17446;
  logCategory__hmf_once_v1_17446 = v0;
