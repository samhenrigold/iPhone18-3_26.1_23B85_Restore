...
void __46__HMDCameraSettingProactiveReader_readSetting__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Received response for proactive read of stream status", &v8, 0xCu);
  }
...
- (void)handleMessage:(id)message
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling message: %@", &v27, 0x16u);
  }
...
LABEL_7:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = sessionID;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to pending negotiate message for session with identifier: %@", &v27, 0x16u);
    }
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    v27 = 138543362;
    v28 = v25;
    _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@Responding to message with error because it cannot be handled", &v27, 0xCu);
  }
...
uint64_t __46__HMDCameraSettingProactiveReader_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v17_89704;
  logCategory__hmf_once_v17_89704 = v0;
