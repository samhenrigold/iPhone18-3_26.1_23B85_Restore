...
- (void)didReceiveCachedEvent:(id)event topic:(id)topic source:(id)source
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = topicCopy;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Process cached event: %@ topic: %@", &v15, 0x20u);
  }
...
uint64_t __57__HMDStereoPairSettingsController_didReceiveEvent_topic___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Process event: %@ topic: %@", &v9, 0x20u);
  }
  ...
  if ([_homeUUID isEqual:homeCopy])
  {
    if (state != 3 || updatedState == 3)
    {
      if (state != 3 && updatedState == 3)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          v18 = 138543362;
          v19 = v17;
          _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEBUG, "%{public}@State change from primary to non-primary: subscribe to the group owner", &v18, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        v18 = 138543362;
        v19 = v13;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEBUG, "%{public}@State change from primary to non-primary: unsubscribe to the group owner", &v18, 0xCu);
      }
...
LABEL_4:
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, v11, &v12, 0x16u);
...
LABEL_15:
    ...
    v37 = v44;
    [eventForwarder forwardEvent:v44 topic:v21 completion:&__block_literal_global_15];
...
void __64__HMDStereoPairSettingsController__subscribeToAddedMediaSystem___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Process cached event: %@ topic: %@", &v14, 0x20u);
  }
...
uint64_t __46__HMDStereoPairSettingsController_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v27_22513;
  logCategory__hmf_once_v27_22513 = v0;
