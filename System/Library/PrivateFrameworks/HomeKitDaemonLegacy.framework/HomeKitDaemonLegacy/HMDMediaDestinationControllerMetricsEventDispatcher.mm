...
- (id)dataSourceIsTriggeredOnControllerDevice
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get is triggered on controller device due to no data source", &v11, 0xCu);
    }
  ...
  if (identifierCopy)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination type due to no data source", &v13, 0xCu);
      }
...
- (id)dataSourceCurrentDestinationType
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current destination type due to no data source", &v13, 0xCu);
    }
...
- (id)dataSourceCurrentUser
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = dataSource;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current user from data source: %@", &v10, 0x16u);
    }
...
- (void)submitDailySetDestinationEvent
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 138543362;
    v21 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Submitting daily set destination event", &v20, 0xCu);
  }
  ...
  if (!dataSource)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 12;
LABEL_10:
      _os_log_impl(&dword_2531F8000, v17, v18, v16, &v20, v19);
    }
...
- (void)submitStagedDestinationIdentifierCommittedEventWithCommittedDestinationIdentifier:(id)identifier
{
  ...
  if (v5 && ([(HMDMediaDestinationControllerStagedDestinationIdentifierCommittedEvent *)v5 stagedDestinationIdentifier], v7 = objc_claimAutoreleasedReturnValue(), v8 = HMFEqualObjects(), v7, (v8 & 1) != 0))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = identifierCopy;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@submitting staged destination identifier committed event with committed destination identifier: %@", &v19, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping staged destination identifier committed event due to out-dated information", &v19, 0xCu);
    }
...
- (void)startStagedDestinationIdentifierCommittedEventWithStagedDestinationIdentifier:(id)identifier
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = identifierCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Tracking staged destination identifier: %@", &v13, 0x16u);
  }
