...
- (id)mediaDestinationManagerWithParticipantAccessoryUUID:(id)d
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = dCopy;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media destination manager with participant accessory uuid: %@ due to no data source", &v13, 0x16u);
    }
...
- (void)queueOnboardingParticipantWithAccessoryUUID:(id)d withAssociatedGroupIdentifier:(id)identifier
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = identifierCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Queueing onboarding for participant accessory uuid: %@ associated group identifier: %@", &v12, 0x20u);
  }
...
uint64_t __69__HMDMediaGroupsUnconfiguredParticipantOnboardingManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v10_105266;
  logCategory__hmf_once_v10_105266 = v0;
