            ...
            else
            {
              ...
              if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
              {
                ...
                *v85 = 138543874;
                ...
                v89 = 2112;
                v90 = v30;
                _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_INFO, "%{public}@Unable to load document, %@, with error: %@", v85, 0x20u);
...
LABEL_40:
      ...
      if (os_log_type_enabled(v64, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543362;
        v92 = v65;
        _os_log_impl(&dword_2531F8000, v64, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Missing SLA version", buf, 0xCu);
      }
...
LABEL_51:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543362;
        v92 = v55;
        _os_log_impl(&dword_2531F8000, v54, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Missing asset properties", buf, 0xCu);
      }
    ...
    _os_log_impl(&dword_2531F8000, v59, OS_LOG_TYPE_ERROR, v61, buf, 0x16u);
