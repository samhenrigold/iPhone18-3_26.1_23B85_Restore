  ...
  if ([messageCopy isRemote])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get caller version from remote source device: %@", &v14, 0x16u);
      }
...
LABEL_7:
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, v14, &v16, 0xCu);
    }
  }
...
- (void)handleAccessorySettingsUpdateRequestMessage:(id)message
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v39 = 2112;
    v40 = messageCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory settings update request message: %@", buf, 0x16u);
  }
    ...
    if (v10)
    {
      ...
      if (v11)
      {
        ...
        if (settingValue)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543362;
              v38 = v36;
              _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due to no delegate", buf, 0xCu);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v38 = v32;
            _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting as unable to determine setting value from payload", buf, 0xCu);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v38 = v28;
          _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due no caller version", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v39 = 2112;
        v40 = messagePayload;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create update request payload with message payload: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v38 = v20;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to update settings due to no payload found on message", buf, 0xCu);
    }
...
- (void)handleAccessorySettingsFetchRequestMessage:(id)message
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v52 = 2112;
    v53 = messageCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory settings fetch request message: %@", buf, 0x16u);
  }
  ...
  if (messagePayload)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v52 = 2112;
        v53 = messagePayload;
        _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch request payload with message payload: %@", buf, 0x16u);
      }
    ...
    if (v11)
    {
      ...
      if (!v13)
      {
          ...
          if ([v32 containsObject:@"root.siri.availableLanguages"])
          {
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543362;
              ...
              v47 = v33;
              v37 = v36;
              _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_INFO, "%{public}@Fetching siri available language setting", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v51 = v42;
            _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due to no delegate", buf, 0xCu);
          }
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v52 = 2112;
        v53 = v14;
        _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due caller privilege data sourcing error: %@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v51 = v30;
        _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due no caller version", buf, 0xCu);
      }
...
LABEL_32:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v51 = v22;
    _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload on fetch request message", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_89350 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t16_89350, &__block_literal_global_89351);
  }

  v3 = logCategory__hmf_once_v17_89352;
...
uint64_t __54__HMDAccessorySettingsLocalMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v17_89352;
  logCategory__hmf_once_v17_89352 = v0;
