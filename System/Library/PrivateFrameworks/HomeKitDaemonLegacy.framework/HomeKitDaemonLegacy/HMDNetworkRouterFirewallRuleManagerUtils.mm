...
+ (id)dumpTLVsFromJSONData:(id)data error:(id *)error
{
  ...
  if (v44)
  {
    ...
    v54 = &v53;
    v55 = 0x3032000000;
    v56 = __Block_byref_object_copy__110988;
    v57 = __Block_byref_object_dispose__110989;
    v58 = 0;
      ...
      if (![v41 hmf_isEmpty])
      {
        if ([v41 count] >= 2)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v68 = 2048;
            v69 = v14;
            _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Multiple declarations (%lu) found, choosing the first", buf, 0x16u);
          }
        ...
        if ([ruleConfigurations hmf_isEmpty])
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v67 = v17;
            _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@No rule configurations were found", buf, 0xCu);
          }
...
LABEL_37:
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v67 = v10;
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@No network declarations were found", buf, 0xCu);
      }
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v14;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid declarations found", &v18, 0xCu);
      }
