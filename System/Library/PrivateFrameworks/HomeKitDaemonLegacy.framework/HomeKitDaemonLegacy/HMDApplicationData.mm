...
- (void)updateWithModel:(id)model
{
  ...
  if (appDataDictionary)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v21 = 2112;
      v22 = parentUUID;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Updating the application data from transaction: %@ / %@", &v17, 0x20u);
...
LABEL_6:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = parentUUID2;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing entire app data for container: %@", &v17, 0x16u);
...
uint64_t __33__HMDApplicationData_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_11561;
  logCategory__hmf_once_v5_11561 = v0;
