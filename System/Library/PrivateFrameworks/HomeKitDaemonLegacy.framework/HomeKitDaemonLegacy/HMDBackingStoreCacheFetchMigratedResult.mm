...
- (id)mainReturningError
{
  ...
  v40 = &v39;
  v41 = 0x3032000000;
  v42 = __Block_byref_object_copy__16828;
  v43 = __Block_byref_object_dispose__16829;
  v44 = 0;
        ...
        if (!v8 || ([v8 isEqual:v21] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *buf = 138543618;
            ...
            v30 = 2048;
            v31 = v26;
            _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@detected migrations is need for %lu", buf, 0x16u);
