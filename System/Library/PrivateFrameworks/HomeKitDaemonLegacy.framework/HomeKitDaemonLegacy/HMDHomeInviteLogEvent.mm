...
LABEL_18:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v21 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Creating", buf, 0xCu);
    }
...
LABEL_12:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v21 = v12;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@No home invitation event to log. Invitation was cancelled or is pending.", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_85036 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t2_85036, &__block_literal_global_85037);
  }

  v3 = logCategory__hmf_once_v3_85038;

  return v3;
}

uint64_t __36__HMDHomeInviteLogEvent_logCategory__block_invoke()
{
  v0 = HMFCreateOSLogHandle();
  v1 = logCategory__hmf_once_v3_85038;
  logCategory__hmf_once_v3_85038 = v0;
