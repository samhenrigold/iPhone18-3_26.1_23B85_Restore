...
- (id)removeName:(id)name namespace:(id)namespace
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2112;
      v17 = nameCopy;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to remove %@", &v14, 0x16u);
    }
...
- (id)removeNamespace:(id)namespace
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to remove namespace", &v10, 0xCu);
    }
...
- (id)addNamespace:(id)namespace
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to add namespace", &v10, 0xCu);
    }
...
- (id)_removeName:(id)name namespace:(id)namespace
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 2112;
      v21 = nameCopy;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@ to remove name %@", &v16, 0x20u);
    }
  ...
  if (!v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v23 = 2112;
        v24 = nameCopy;
        _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@ to remove name %@", &v19, 0x20u);
      }
...
- (id)_checkForConflict:(id)conflict namespace:(id)namespace
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 2112;
      v20 = namespaceCopy;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@", &v17, 0x16u);
    }
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v47 = 2112;
        v48 = nameCopy;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Name is invalid: starts with disallowed character '%@' (0x%@): '%@'", &v41, 0x2Au);
      }
...
LABEL_15:
    ...
    if (v22 != [nameCopy length] - 1)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v47 = 2112;
        v48 = nameCopy;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Name is invalid: ends with allowed character '%@' (0x%@): '%@'", &v41, 0x2Au);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        v47 = 2112;
        v48 = nameCopy;
        _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_ERROR, "%{public}@Name is invalid: contains disallowed character '%@' (0x%@): '%@'", &v41, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v43 = 2112;
      v44 = nameCopy;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ is empty", &v41, 0x16u);
    }
