    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v37 = 2112;
        v38 = v18;
        _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
      }
...
+ (id)__decodeRuleConfigurationWithVersionString:(id)string ruleConfigurationValue:(id)value baseAccessoryIdentifier:(id)identifier
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Rule configuration for version '%@' is not a dictionary: %@", &v29, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = stringCopy;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Rule configuration contains an invalid version string: %@", &v29, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_164853 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_164853, &__block_literal_global_164854);
  }

  v3 = logCategory__hmf_once_v1_164855;
...
uint64_t __67__HMDNetworkRouterFirewallRuleCloudNetworkDeclarations_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_164855;
  logCategory__hmf_once_v1_164855 = v0;
