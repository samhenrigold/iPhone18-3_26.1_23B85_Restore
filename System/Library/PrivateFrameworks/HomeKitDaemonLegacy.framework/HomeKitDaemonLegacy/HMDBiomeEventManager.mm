...
uint64_t __45__HMDBiomeEventManager_submitAccessoryEvent___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Submitting accessory event for %@ with source %@: %@ ", &v11, 0x2Au);
  }
    ...
    if (v11)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [HMDBiomeEventManager _deleteEventFromStartDate:v4 toEndDate:*(*(&v16 + 1) + 8 * v14++) stream:&__block_literal_global_31_79831 passingDeleteEventTest:?];
        }
