  ...
  *(v22 + 8) = setCopy;
  ...
  if (v37)
  {
    if (([(objc_class *)class isSubclassOfClass:objc_opt_class()]& 1) != 0)
    {
      ...
      if ([v37 count])
      {
        [v37 hmf_enumerateWithAutoreleasePoolUsingBlock:&__block_literal_global_15566];
...
void __131__HMDBackingStoreModelObjectStorageInfo_initWithClass_logging_readOnly_unavailable_defaultSet_defaultValue_additonalDecodeClasses___block_invoke(uint64_t a1, objc_class *a2, _BYTE *a3)
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v10;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@Encoding top level type of %@ will fail in the future.", &v11, 0x16u);
    }
