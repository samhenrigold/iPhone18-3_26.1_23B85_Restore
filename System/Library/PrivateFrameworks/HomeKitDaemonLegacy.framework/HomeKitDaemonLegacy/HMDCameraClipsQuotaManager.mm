...
- (id)database:(id)database willRemoveZoneWithName:(id)name isPrivate:(BOOL)private
{
  ...
  if ([nameCopy hasPrefix:*MEMORY[0x277CCF500]] && private)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = nameCopy;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Disabling cloud storage before removing zone with name %@", &v17, 0x16u);
    }
...
id __65__HMDCameraClipsQuotaManager_disableCloudStorageForZoneWithName___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully disabled camera with response: %@", &v10, 0x16u);
  }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Assuming success for disable camera request because zone does not exist", &v13, 0xCu);
  }
...
id __64__HMDCameraClipsQuotaManager_enableCloudStorageForZoneWithName___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully enabled camera with response: %@", &v10, 0x16u);
  }
...
id __71__HMDCameraClipsQuotaManager_fetchNamesForZonesWithEnabledCloudStorage__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v9;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully got active cameras with zone names: %@", &v23, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v3;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@Received get active cameras response of unexpected type %@: %@", &v23, 0x20u);
    }
...
void __41__HMDCameraClipsQuotaManager_synchronize__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    v11 = 138543362;
    v12 = v10;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Finished initial cloud sync for camera clips quota manager cloud database", &v11, 0xCu);
  }
...
+ (id)_quotaErrorFromServerError:(id)error
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Determining quota error based on underlying quota server error: %@", &v14, 0x16u);
    }
