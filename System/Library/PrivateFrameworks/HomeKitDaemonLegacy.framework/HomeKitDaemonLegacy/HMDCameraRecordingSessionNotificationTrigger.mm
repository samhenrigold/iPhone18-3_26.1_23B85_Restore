...
- (void)listener:(id)listener didUpdateAvailableCharacteristics:(id)characteristics
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Enabling notification for characteristics: %@", &v17, 0x16u);
  }
...
uint64_t __59__HMDCameraRecordingSessionNotificationTrigger_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v12_168792;
  logCategory__hmf_once_v12_168792 = v0;
