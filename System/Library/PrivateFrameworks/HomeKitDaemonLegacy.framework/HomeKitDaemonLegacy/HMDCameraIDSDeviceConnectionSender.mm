...
void __64__HMDCameraIDSDeviceConnectionSender_packetRelay_didStop_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay %@ did stop: %{BOOL}d error: %@", &v9, 0x26u);
  }
...
void __65__HMDCameraIDSDeviceConnectionSender_packetRelay_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2114;
    v16 = v8;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay %@ did start: %{BOOL}d error: %{public}@", &v9, 0x26u);
  }
...
- (void)startPacketRelayWithIDSDestination:(id)destination cameraVideoSSRC:(unsigned int)c cameraAudioSSRC:(unsigned int)rC
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v53 = v13;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@IDS Session is present", buf, 0xCu);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v54 = 1024;
    LODWORD(v55) = v6;
    _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Creating video relay connection with SSRC %08x", buf, 0x12u);
  }
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v54 = 1024;
    LODWORD(v55) = v5;
    _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, "%{public}@Creating audio relay connection with SSRC %08x", buf, 0x12u);
  }
  ...
  if (v17 && v25 && v31)
  {
    ...
    if (videoPacketRelay)
    {
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v53 = v42;
        _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay", buf, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v54 = 2114;
        v55 = v36;
        _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay with error %{public}@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v53 = v48;
      _os_log_impl(&dword_2531F8000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to create relay objects", buf, 0xCu);
    }
...
uint64_t __49__HMDCameraIDSDeviceConnectionSender_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v18_107968;
  logCategory__hmf_once_v18_107968 = v0;
