  ...
  if (WeakRetained)
  {
    ...
    if (v9 == -1)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        v28 = 2048;
        v29 = v5;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to send the data of size %tu", &v26, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2048;
        v29 = v9;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Sent %lu bytes", &v26, 0x16u);
      }
      ...
      if (!v17)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          v26 = 138543362;
          v27 = v21;
          _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@File transfer is complete with total transferred bytes", &v26, 0xCu);
        }
...
- (void)sendData:(id)data
{
  ...
  if (data)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *v14 = 138543362;
      *&v14[4] = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Data send already in progress", v14, 0xCu);
    }
...
uint64_t __49__HMDCameraSnapshotIDSRelayInitiator_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_169929;
  logCategory__hmf_once_v1_169929 = v0;
