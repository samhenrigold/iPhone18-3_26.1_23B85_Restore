...
- (HMDRemoteLoginAuthenticationResponse)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  loggedInAccount = [(HMDRemoteLoginAuthenticationResponse *)self loggedInAccount];
  v7 = [mEMORY[0x277CF0130] transportableAuthKitAccount:loggedInAccount];
...
- (NSDictionary)messagePayload
{
  ...
  v3 = encodeRootObject();
  messageName = [(HMDRemoteLoginAuthenticationResponse *)self messageName];
  v7 = messageName;
  v8[0] = v3;
...
+ (id)objWithMessage:(id)message
{
  ...
  v6 = [messagePayload hmf_dataForKey:@"kHMDRemoteLoginAuthenticationResponse"];
...
+ (id)objWithDict:(id)dict
{
  ...
  dictCopy = dict;
  v5 = [dictCopy hmf_dataForKey:@"kHMDRemoteLoginAuthenticationResponse"];
  v13 = 0;
