...
- (void)extractionEnteredPassThroughMode
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Unarchive in pass through mode", &v7, 0xCu);
  }
...
- (void)extractionCompleteAtArchivePath:(id)path
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = pathCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Completed unarchiving to path: %@", &v9, 0x16u);
  }
...
- (void)setExtractionProgress:(double)progress
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2048;
    v12 = progress * 100.0;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Unarchive progress: %.1f%%", &v9, 0x16u);
  }
...
- (void)URLSession:(id)session downloadTask:(id)task didWriteData:(int64_t)data totalBytesWritten:(int64_t)written totalBytesExpectedToWrite:(int64_t)write
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2048;
    v21 = (v16 * 100.0);
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Download progress: %.1f%%", &v18, 0x16u);
  }
...
- (void)URLSession:(id)session task:(id)task didCompleteWithError:(id)error
{
  ...
  if (errorCopy)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = errorCopy;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset with error: %@", &v15, 0x16u);
    }
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_finishDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Finished download", &v8, 0xCu);
  }
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_cancelDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling download", &v8, 0xCu);
  }
...
LABEL_16:
      _os_log_impl(&dword_2531F8000, v7, v8, v6, &v33, 0xCu);
...
LABEL_18:
  ...
  if ((v9 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v33 = 138543362;
      v34 = v28;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Not attempting to download documentation now as we are in a backoff", &v33, 0xCu);
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v33 = 138543362;
    v34 = v13;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Starting download", &v33, 0xCu);
  }
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = 2112;
      v36 = v23;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Resuming task: %@", &v33, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v33 = 138543362;
      v34 = v32;
      _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot download software update from nil url", &v33, 0xCu);
    }
...
- (BOOL)purgeWithError:(id *)error
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 138543362;
    v14 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Purging", &v13, 0xCu);
  }
...
- (void)resetDownloadRetryCount
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Resetting download retry count", &v8, 0xCu);
  }
...
- (void)increaseDownloadRetryCount
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Increased download retry count to: %lu next retry is at: %@", &v14, 0x20u);
  }
...
- (HMSoftwareUpdateDocumentation)documentation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v22 = 138543362;
    v23 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing documentation", &v22, 0xCu);
  }
  ...
  if (state == 4)
  {
    ...
    if (!v11 || (v12 = objc_alloc(MEMORY[0x277CD1E58]), -[HMDSoftwareUpdateDocumentationAsset fileManager](selfCopy, "fileManager"), v13 = objc_claimAutoreleasedReturnValue(), v14 = [v12 initWithBundle:v11 fileManager:v13], v13, !v14))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 138543362;
        v23 = v18;
        _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Failed to find documentation bundle", &v22, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v20;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Documentation not cached", &v22, 0xCu);
    }
...
uint64_t __50__HMDSoftwareUpdateDocumentationAsset_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v75_120744;
  logCategory__hmf_once_v75_120744 = v0;
