...
LABEL_11:
          _os_log_impl(&dword_2531F8000, v14, v15, v13, &v32, 0x16u);
...
LABEL_18:
        _os_log_impl(&dword_2531F8000, v30, v31, v29, &v32, 0x16u);
      }
    }
...
- (void)_resetSessionMetric
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Resetting session metric - accessory: %{public}@", &v13, 0x16u);
  }
...
- (void)_submitMetric
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Submitting SessionMetric for accessory: %@/%{public}@ - %{public}@", &v36, 0x2Au);
  }
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2114;
    v41 = identifier2;
    _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, "%{public}@Skipped Submitting SessionMetric for %@/%{public}@", &v36, 0x20u);
  }
...
- (void)_updateSessionState:(BOOL)state linkLayerType:(int64_t)type sessionInfo:(id)info bookkeeping:(id)bookkeeping withError:(id)error
{
    ...
    if (sessionStartTime)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138543874;
        ...
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Session was already started on %@ for: %@", buf, 0x20u);
  ...
  if (stateCopy)
  {
    if (v39)
    {
      ...
      *buf = 138544130;
      ...
      v123 = 2112;
      v124 = v43;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_INFO, "%{public}@Session started on %{public}@ for accessory: %{public}@ discovered by %@", buf, 0x2Au);
  ...
  if (v39)
  {
    ...
    *buf = 138544130;
    ...
    _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_INFO, "%{public}@Session ended on %{public}@ with error: %{public}@ for accessory: %@", buf, 0x2Au);
  }
      ...
      if (v78)
      {
        ...
        if (isRunning)
        {
          if (v84)
          {
            ...
            *buf = 138543362;
            v118 = v85;
            _os_log_impl(&dword_2531F8000, v83, OS_LOG_TYPE_INFO, "%{public}@Not starting timer to initiate radar for accessory because one is already running", buf, 0xCu);
          }
        ...
        else
        {
          if (v84)
          {
            ...
            *buf = 138543362;
            v118 = v86;
            _os_log_impl(&dword_2531F8000, v83, OS_LOG_TYPE_INFO, "%{public}@Starting timer to initiate radar for accessory", buf, 0xCu);
          }
...
uint64_t __40__HMDAccessorySessionMetric_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v21_195222;
  logCategory__hmf_once_v21_195222 = v0;
