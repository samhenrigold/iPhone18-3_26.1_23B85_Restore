    ...
    if (value2 <= 2)
    {
      if (!value2)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v82 = v64;
            _os_log_impl(&dword_2531F8000, v63, OS_LOG_TYPE_ERROR, "%{public}@hapAccessory home field is not available", buf, 0xCu);
      ...
      if (value2 == 1)
      {
        ...
        if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v82 = v68;
          _os_log_impl(&dword_2531F8000, v67, OS_LOG_TYPE_INFO, "%{public}@Prevent moving to REQUESTED state because the latest firmware is already installed on the accessory", buf, 0xCu);
...
- (void)__handleMatterFirmwareRevisionNumberUpdate:(id)update
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = updateCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update for %@", &v12, 0x16u);
  }
...
LABEL_8:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v71 = 2112;
      v72 = v26;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update state previous value : %@", buf, 0x16u);
    }
    ...
    if (!accessory)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v70 = v44;
        _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil. Cannot process initial state from accessory", buf, 0xCu);
      }
    ...
    if ([home isCurrentDevicePrimaryResident] && objc_msgSend(home, "isAutomaticThirdPartyAccessorySoftwareUpdateEnabled"))
    {
      ...
      if (!v32)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v70 = v36;
          _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_INFO, "%{public}@No active firmware update session, attempting to create one", buf, 0xCu);
        ...
        if (!v32)
        {
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v70 = v61;
            _os_log_impl(&dword_2531F8000, v60, OS_LOG_TYPE_ERROR, "%{public}@Failed to register and create a firmware update session", buf, 0xCu);
      ...
      if ([v32 isMatterFirmwareUpdateRetryAllowed])
      {
        ...
        if (!matterSoftwareUpdateProviderDelegate)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v70 = v57;
            _os_log_impl(&dword_2531F8000, v56, OS_LOG_TYPE_ERROR, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v70 = v53;
          _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Maximum matter firmware update retries reached", buf, 0xCu);
...
LABEL_42:
        _os_log_impl(&dword_2531F8000, v46, OS_LOG_TYPE_INFO, v48, buf, 0xCu);
      }
    }
...
void __88__HMDAccessoryMatterFirmwareUpdateProfile_readAndProcessCharacteristics_withCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v5)
    {
      ...
      *&v49[8] = v49;
      *&v49[16] = 0x3032000000;
      v50 = __Block_byref_object_copy__138204;
      v51 = __Block_byref_object_dispose__138205;
      v32 = a1;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *&v49[22] = 2112;
        v50 = v33;
        _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@Read of characteristics %@ failed with error %@", v49, 0x20u);
      }
...
uint64_t __88__HMDAccessoryMatterFirmwareUpdateProfile_readAndProcessCharacteristics_withCompletion___block_invoke_41(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v6;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Read succeeded for %@", &v10, 0x16u);
  }
...
uint64_t __95__HMDAccessoryMatterFirmwareUpdateProfile_handleDisplayableFirmwareVersionUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Matter firmware version string updated", &v7, 0xCu);
  }
...
uint64_t __75__HMDAccessoryMatterFirmwareUpdateProfile_handleVIDPIDUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@VID/PID updated", &v7, 0xCu);
  }
...
void __70__HMDAccessoryMatterFirmwareUpdateProfile_handleAccessoryIsReachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 138543362;
    v17 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is now reachable", &v16, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil", &v16, 0xCu);
    }
...
LABEL_6:
      _os_log_impl(&dword_2531F8000, v13, v14, v12, &v16, 0xCu);
    }
  }
...
- (void)setMatterFirmwareRevisionNumber:(id)number
{
  ...
  if (numberCopy)
  {
    if (!self->_matterFirmwareRevisionNumber || ([numberCopy isEqualToNumber:?] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v6;
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating Matter firmware revision number from %@ to %@", &v18, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Not setting matter firmware revision number to nil", &v18, 0xCu);
    }
...
uint64_t __54__HMDAccessoryMatterFirmwareUpdateProfile_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_138243;
  logCategory__hmf_once_v1_138243 = v0;
