...
- (void)beginTrackingStreamStartMetricWithActivationType:(unint64_t)type
{
  ...
  if (v7 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v8))
  {
    ...
    v21 = 2112;
    v22 = identifier;
    _os_signpost_emit_with_name_impl(&dword_2531F8000, v9, OS_SIGNPOST_INTERVAL_BEGIN, v7, "SiriSession", "ActivationType=%@ AccessoryID=%@", &v19, 0x16u);
  }
  ...
  if (streamStartMetric)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Resetting start stream metric", &v19, 0xCu);
    }
...
- (void)stopStream
{
  ...
  if (activeSessionInfo)
  {
    if (v7)
    {
      ...
      v26 = 2112;
      v27 = identifier;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Session %@ stopped the audio", &v24, 0x16u);
    }
    ...
    if (v13 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v10))
    {
      ...
      v24 = 138412290;
      v25 = identifier2;
      _os_signpost_emit_with_name_impl(&dword_2531F8000, v10, OS_SIGNPOST_INTERVAL_END, v13, "SiriSession", "AccessoryID=%@", &v24, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v26 = 2112;
      v27 = identifier3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Session %@ did stop but was not active (stale notification?)", &v24, 0x16u);
    }
  ...
  if (boostMessage)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 138543362;
      v25 = v23;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Releasing boost message", &v24, 0xCu);
    }
...
- (void)activeSiriSessionDidStop:(id)stop
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = identifier;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@[session %@] Deactivating Siri Session", &v10, 0x16u);
  }
...
- (void)handleResetStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = identifier;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Resetting stream", &v8, 0x16u);
  }
...
- (void)handleStopStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = identifier;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Stopping stream", &v8, 0x16u);
  }
...
- (void)handleStartStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = identifier;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Starting stream", &v15, 0x16u);
  }
  ...
  if (v11 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v8))
  {
    ...
    v15 = 138412290;
    v16 = identifier2;
    _os_signpost_emit_with_name_impl(&dword_2531F8000, v8, OS_SIGNPOST_EVENT, v11, "SiriRecording", "AccessoryID=%@", &v15, 0xCu);
  }
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = identifier;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Invalidate", &v8, 0x16u);
  }
...
LABEL_6:
  ...
  if (isActivationPending)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = identifier;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Siri session is inactive and activation is pending, reading first frame (%@)", &v13, 0x16u);
    }
...
- (BOOL)activateAfterHubInitiation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = identifier;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_ERROR, "%{public}@Hub initiated Siri input not supported for this Siri session (%@)", &v9, 0x16u);
  }
