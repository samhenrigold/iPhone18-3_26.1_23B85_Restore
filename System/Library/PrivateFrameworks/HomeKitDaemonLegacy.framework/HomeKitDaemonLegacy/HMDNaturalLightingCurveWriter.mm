...
- (void)synchronizeCurveWithActiveTransitionContext:(id)context
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Synchronizing curve...", &v27, 0xCu);
  }
...
LABEL_14:
      _os_log_impl(&dword_2531F8000, v24, v25, v23, &v27, 0xCu);
...
LABEL_13:
  ...
  if (v21)
  {
    ...
    v27 = 138543362;
    v28 = v26;
    _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Start sychronizing curve", &v27, 0xCu);
  }
...
- (void)writeWithNaturalLightingEnabled:(BOOL)enabled reason:(id)reason completion:(id)completion
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = reasonCopy;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping curve write with reason because current device is not a primary resident: %@", &v19, 0x16u);
    }
...
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)reason
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = reasonCopy;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling current device primary resident changed: %@ with reason: %@", &v12, 0x20u);
  }
...
void __73__HMDNaturalLightingCurveWriter_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (v5 != [*(a1 + 32) isCurrentDevicePrimaryResident])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v11;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Current device primary changed from: (%@->%@)", &v14, 0x20u);
    }
    ...
    if (updatedCopy)
    {
      ...
      if (v12 >= 0.0)
      {
        ...
        if (v28 - v12 <= 0.0)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            v55 = 2048;
            v56 = v28;
            _os_log_impl(&dword_2531F8000, v46, OS_LOG_TYPE_INFO, "%{public}@Updating curve since time elapsed since transition start is greater than curve update interval %f:%f", &v51, 0x20u);
          }
        ...
        else
        {
          ...
          if (v31 < v34)
          {
            if (v37)
            {
              ...
              v53 = 2048;
              v54 = v29;
              _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_INFO, "%{public}@Starting timer for natural lighting curve update: %fs", &v51, 0x16u);
            }
          ...
          if (v37)
          {
            ...
            v59 = 2048;
            v60 = v50;
            _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating curve because accessory time (%fs) and controller time (%fs) difference (%fs) is greater than threshold (%fs)", &v51, 0x34u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          v55 = 2112;
          v56 = *&startDate;
          _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating curve because transition start date is ahead of the current date %@:%@", &v51, 0x20u);
        }
...
LABEL_25:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      v53 = 2112;
      v54 = 0.0;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@Stopping characteristic write timer because active transition context is not set: %@", &v51, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v51 = 138543362;
      v52 = v21;
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Skipping active transition context update because current device is not primary resident", &v51, 0xCu);
    }
...
uint64_t __44__HMDNaturalLightingCurveWriter_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v20_191361;
  logCategory__hmf_once_v20_191361 = v0;
