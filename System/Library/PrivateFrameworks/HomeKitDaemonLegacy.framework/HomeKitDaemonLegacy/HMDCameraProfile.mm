...
- (void)timerDidFire:(id)fire
{
  ...
  if (recordingEventsCleanupTimer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Performing recording events cleanup due to timer firing", &v13, 0xCu);
    }
...
- (void)_postNotificationForUpdatedSignificantEvent:(id)event allClipSignificantEvents:(id)events homePresence:(id)presence
{
  ...
  if (v12)
  {
    ...
    if (!v14 || ([objc_opt_class() bulletinBoard], v15 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v15, "updateDoorbellPressNotificationsWithSignificantEventBulletin:", v12), v15, objc_msgSend(v12, "significantEvents"), v16 = objc_claimAutoreleasedReturnValue(), v17 = objc_msgSend(v16, "na_any:", &__block_literal_global_110_156650), v16, v17))
    {
...
- (void)_postNotificationForUpdatedSignificantEvent:(id)event homePresence:(id)presence
{
  ...
  if (![v10 count])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = clipUUID2;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Could not find any significant events for clip with UUID %@", &v17, 0x16u);
    }
...
LABEL_9:
  ...
  if (smartBulletinBoardNotificationCondition)
  {
    ...
    v60 = v21;
    v42 = [v22 rewritePredicate:v21 currentCharacteristicInPredicate:0 characteristicsToRead:0 homePresence:v64];
    [v42 allowEvaluation];
    v71 = @"THIS_OBJECT";
    v72[0] = v22;
    v43 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v72 forKeys:&v71 count:1];
    v63 = [v42 evaluateWithObject:v22 substitutionVariables:v43];
    ...
    {
      HMFGetLogIdentifier();
      v46 = v59 = smartBulletinBoardNotificationCondition;
      HMFBooleanToString();
      v47 = eventCopy;
      ...
      *buf = 138543874;
      ...
      smartBulletinBoardNotificationCondition = v59;
    }

    objc_autoreleasePoolPop(v44);
    v28 = ![(HMDCameraProfile *)self _areFaceClassificationNotificationsSuppressedForSignificantEvent:v20]& v63;
...
- (BOOL)_areFaceClassificationNotificationsSuppressedForSignificantEvent:(id)event
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = person;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Classification notifications enabled is %@ for person: %@", &v20, 0x20u);
  }
...
- (void)registerForMessages
{
  ...
  if (hapAccessory)
  {
    ...
    v71[0] = v30;
    v71[1] = v31;
    v33 = [MEMORY[0x277CBEA60] arrayWithObjects:v71 count:2];
...
void __35__HMDCameraProfile_removeCloudData__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing all cloud data", &v9, 0xCu);
  }
...
- (void)_createCameraRecordingManager
{
  ...
  if (recordingManagementService)
  {
    ...
    if (isCurrentDeviceAvailableResident && (isOwnerUser & 1) != 0)
    {
      if (!cameraRecordingManager)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 138543362;
          v30 = v15;
          _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Creating camera recording manager", &v29, 0xCu);
        }
    ...
    else if (cameraRecordingManager)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v27;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Destroying camera recording manager", &v29, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v23;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Not configuring for recording because there is no recording service", &v29, 0xCu);
    }
...
- (void)tearDownWithReplacementCameraProfile:(id)profile
{
  ...
  if (-[HMDCameraProfile isCameraRecordingFeatureSupported](self, "isCameraRecordingFeatureSupported") && ([profileCopy isCameraRecordingFeatureSupported] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing clip data because we have a recording management service %@ and we are transitioning to a replacement camera profile that does not", &v13, 0x16u);
    }
...
- (void)setUp
{
  ...
  if (accessory)
  {
    ...
    if (home)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v36 = 2112;
        v37 = zoneName;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Using zone %@ for camera settings", &v34, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 138543362;
        v35 = v33;
        _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Skipping camera profile setup because home reference is nil", &v34, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      v34 = 138543362;
      v35 = v29;
      _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@Skipping camera profile setup because accessory reference is nil", &v34, 0xCu);
    }
...
uint64_t __31__HMDCameraProfile_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_156777;
  logCategory__hmf_once_v9_156777 = v0;
