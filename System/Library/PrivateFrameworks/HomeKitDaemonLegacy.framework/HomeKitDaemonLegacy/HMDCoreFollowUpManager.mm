...
void __70__HMDCoreFollowUpManager_startAdvertisingHH2UpgradeRecommendationCFU___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v24;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unable to get followup controller from datasource: %@", &v25, 0x16u);
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_ERROR, "%{public}@Unexpected setup mode to start advertising: %ld", buf, 0x16u);
  }
...
uint64_t __37__HMDCoreFollowUpManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v10_53122;
  logCategory__hmf_once_v10_53122 = v0;
