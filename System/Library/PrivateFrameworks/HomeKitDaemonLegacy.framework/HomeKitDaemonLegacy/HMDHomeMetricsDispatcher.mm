...
- (void)submitMigrationEventMetricsForModel:(id)model reason:(id)reason
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = reasonCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting migration event metric for model: %@ reason: %@", &v14, 0x20u);
  }
...
uint64_t __39__HMDHomeMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_7395;
  logCategory__hmf_once_v2_7395 = v0;
