    ...
    if (v19)
    {
      ...
      if (errorCopy)
      {
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          v30 = 2112;
          v31 = errorCopy;
          _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@Received confirmation from IDS that the file send failed for identifier %@: %@", &v26, 0x20u);
        }
      ...
      else
      {
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          v28 = 2112;
          v29 = identifierCopy;
          _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Received confirmation from IDS that the file send succeeded for identifier: %@", &v26, 0x16u);
        }
...
uint64_t __50__HMDCameraSnapshotIDSStreamInitiator_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_192941;
  logCategory__hmf_once_v5_192941 = v0;
