...
- (NSSet)allNodeIDs
{
  ...
  if (!home)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", &v15, 0xCu);
    }
...
- (void)updateKeyValueStoreWithBlock:(id)block completion:(id)completion
{
  ...
  if (home)
  {
    ...
    v17[3] = &unk_27972B918;
    v18 = blockCopy;
    [(HMDCHIPHomeDataSource *)selfCopy _updateHomeModelWithLabel:@"Update CHIP key-value store" completion:completionCopy block:v17];
    v14 = v18;
  }
...
uint64_t __36__HMDCHIPHomeDataSource_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v13_115924;
  logCategory__hmf_once_v13_115924 = v0;
