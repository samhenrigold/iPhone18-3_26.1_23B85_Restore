...
BOOL __113__HMDCameraRecordingSessionSignificantEventManager__isAnyEventInAnalyzerEvents_includedInRecordingEventTriggers___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v3;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Recording fragment due to recording trigger event: %@", &v16, 0x16u);
    }
...
- (void)resetState
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Resetting state", &v9, 0xCu);
  }
...
uint64_t __63__HMDCameraRecordingSessionSignificantEventManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v14_54254;
  logCategory__hmf_once_v14_54254 = v0;
