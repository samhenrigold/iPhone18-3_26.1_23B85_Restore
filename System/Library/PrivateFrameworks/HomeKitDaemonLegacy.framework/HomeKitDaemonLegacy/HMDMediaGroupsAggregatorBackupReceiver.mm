...
- (void)handleGroupsBackupDataMessage:(id)message
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = messageCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling backup group data message: %@", &v27, 0x16u);
  }
  ...
  if (messagePayload)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v29 = 2112;
          v30 = v22;
          _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify delegate of received backup due to unconfigured delegate error: %@", &v27, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v31 = 2112;
        v32 = v13;
        _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Failed to decode group backup data payload: %@ error: %@", &v27, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = v11;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from group backup data message: %@ error: %@", &v27, 0x20u);
    }
...
uint64_t __53__HMDMediaGroupsAggregatorBackupReceiver_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_160632;
  logCategory__hmf_once_v5_160632 = v0;
