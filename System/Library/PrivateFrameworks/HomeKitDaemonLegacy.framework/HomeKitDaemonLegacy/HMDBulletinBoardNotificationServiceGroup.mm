...
- (void)_updateAssociatedServices:(id)services associatedCameras:(id)cameras
{
  ...
  v25 = [allValues countByEnumeratingWithState:&v48 objects:v52 count:16];
  if (v25)
  {
    v26 = v25;
    v27 = *v49;
    do
    {
      ...
      do
      {
        ...
        cameraProfile = [*(*(&v48 + 1) + 8 * v28) cameraProfile];
      ...
      while (v26 != v28);
      v26 = [allValues countByEnumeratingWithState:&v48 objects:v52 count:16];
    }
...
- (void)configureBulletinNotification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@configureBulletinNotification called before configure", &v9, 0xCu);
    }
...
- (void)_handleBulletinBoardNotificationServiceGroupRequest:(id)request
{
  ...
  if (responseHandler)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to a request for notification service group with payload %@", &v12, 0x16u);
    }
