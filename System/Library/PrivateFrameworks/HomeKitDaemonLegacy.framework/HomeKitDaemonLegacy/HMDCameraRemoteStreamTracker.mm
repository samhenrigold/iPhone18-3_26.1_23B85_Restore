...
void __64__HMDCameraRemoteStreamTracker_stopTrackingStreamWithSessionID___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@No longer tracking stream with session ID: %@", &v13, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Cannot find stream to stop tracking: %@", &v13, 0x16u);
    }
...
void __59__HMDCameraRemoteStreamTracker_startTrackingStreamSession___block_invoke(uint64_t a1)
{
  ...
  if (v3 >= v4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v22;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Cannot start tracking stream session: %@. Already tracking maximum number of stream sessions: %@", &v23, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2048;
      v28 = [v16 count];
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Started tracking stream session: %@. Total count is now %lu", &v23, 0x20u);
    }
...
uint64_t __43__HMDCameraRemoteStreamTracker_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v5_102398;
  logCategory__hmf_once_v5_102398 = v0;
