...
- (void)removeFabricData
{
  ...
  keychainItemIdentifier = [(HMDCHIPSharedHomeKeychainFabricDataStore *)self keychainItemIdentifier];
  v24 = 0;
  v5 = [systemKeychainStore allKeychainItemsForType:&unk_286628318 identifier:keychainItemIdentifier syncable:MEMORY[0x277CBEC28] error:&v24];
  v6 = v24;
...
- (HMMTROperationalFabricData)fabricData
{
  ...
  keychainItemIdentifier = [(HMDCHIPSharedHomeKeychainFabricDataStore *)self keychainItemIdentifier];
  v53 = 0;
  v5 = [systemKeychainStore allKeychainItemsForType:&unk_286628318 identifier:keychainItemIdentifier syncable:MEMORY[0x277CBEC28] error:&v53];
  v6 = v53;
  if (v6)
  {
...
uint64_t __55__HMDCHIPSharedHomeKeychainFabricDataStore_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v16_62268;
  logCategory__hmf_once_v16_62268 = v0;
