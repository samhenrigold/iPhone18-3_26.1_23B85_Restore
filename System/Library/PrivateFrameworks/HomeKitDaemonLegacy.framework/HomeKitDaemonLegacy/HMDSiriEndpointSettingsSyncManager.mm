...
LABEL_52:
  ...
  if ([pathCopy isEqualToString:@"root.siri.tapToAccess"])
  {
    ...
    if (v21)
    {
      ...
      v79[1] = 3221225472;
      v79[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_61;
      v79[3] = &unk_279735BE8;
      v79[4] = selfCopy;
      v80 = accessoryCopy;
      v81 = v21;
...
LABEL_53:
  ...
  if ([pathCopy isEqualToString:@"root.siri.lightWhenUsingSiri"])
  {
    ...
    if (v21)
    {
      ...
      v75[1] = 3221225472;
      v75[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_62;
      v75[3] = &unk_279735BE8;
      v75[4] = selfCopy;
      v76 = accessoryCopy;
      v77 = v21;
  ...
  if ([pathCopy isEqualToString:@"root.siri.soundAlert"])
  {
    ...
    if (v21)
    {
      ...
      v71[1] = 3221225472;
      v71[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_63;
      v71[3] = &unk_279735BE8;
      v71[4] = selfCopy;
      v72 = accessoryCopy;
      v73 = v21;
  ...
  if ([pathCopy isEqualToString:@"root.airPlay.airPlayEnabled"])
  {
    ...
    if (v21)
    {
      ...
      if (v46)
      {
        ...
        v67[1] = 3221225472;
        v67[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_65;
        v67[3] = &unk_279735BE8;
        v67[4] = selfCopy;
        v68 = accessoryCopy;
        v69 = v21;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138544130;
          ...
          v93 = 2112;
          v94 = accessoryCopy;
          _os_log_impl(&dword_2531F8000, v60, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize airplayEnabledSettingValue (%@) for keypath %@, accessory: %@, as accessory does not have a hapMediaProfile", buf, 0x2Au);
    ...
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v93 = 2112;
      v94 = accessoryCopy;
      _os_log_impl(&dword_2531F8000, v55, OS_LOG_TYPE_ERROR, "%{public}@airplayEnabledSettingValue (%@) for keypath %@, accessory: %@, is not of BOOL setting type", buf, 0x2Au);
    }
  }
  ...
  else
  {
    if ([pathCopy isEqualToString:@"root.siri.siriEnabled"])
    {
      ...
      if (v21)
      {
        ...
        v63[1] = 3221225472;
        v63[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_66;
        v63[3] = &unk_279735BE8;
        v63[4] = selfCopy;
        v64 = accessoryCopy;
        v65 = v21;
    ...
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v93 = 2112;
      v94 = accessoryCopy;
      _os_log_impl(&dword_2531F8000, v55, OS_LOG_TYPE_ERROR, "%{public}@Unknown keypath (%@) for homekit backed siri endpoint setting value (%@) accessory: %@", buf, 0x2Au);
    }
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized hey siri enabled on %@ to %@ with success: %@ (%@)", &v12, 0x34u);
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_61(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized tap to access on %@ to %@ with success: %@ (%@)", &v12, 0x34u);
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_62(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized light on use on %@ to %@ with success: %@ (%@)", &v12, 0x34u);
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_63(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized sound on use on %@ to %@ with success: %@ (%@)", &v12, 0x34u);
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_65(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized airplayEnabled on %@ to %@ with success: %@ (%@)", &v12, 0x34u);
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_66(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized siriEnabled on %@ to %@ with success: %@ (%@)", &v12, 0x34u);
  }
...
- (void)_writeSetting:(id)setting toAccessory:(id)accessory forKeyPath:(id)path
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unexpected setting type received.", &v19, 0xCu);
    }
...
void __69__HMDSiriEndpointSettingsSyncManager__stopManagingAccessory_forHome___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Unsubscribed endpoint setting sync manager with result: %@", &v8, 0x16u);
  }
...
void __70__HMDSiriEndpointSettingsSyncManager__beginManagingAccessory_forHome___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v6;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Subscribed endpoint setting sync manager for changed topics (%@) with result: %@ (%@)", &v16, 0x2Au);
  }
...
uint64_t __49__HMDSiriEndpointSettingsSyncManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_110791;
  logCategory__hmf_once_v1_110791 = v0;
