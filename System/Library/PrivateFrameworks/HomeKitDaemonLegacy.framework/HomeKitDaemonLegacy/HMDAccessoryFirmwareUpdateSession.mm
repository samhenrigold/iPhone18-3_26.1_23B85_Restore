  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v21 = 2112;
      v22 = hapAccessory;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@No staged firmware in accessory %@", buf, 0x16u);
    }
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to rescind staged firmware for UARP accessory %@", &v12, 0x16u);
    }
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke_174(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v10 = 2112;
    v11 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening socket for UARP communication: %@", &v8, 0x16u);
  }
...
- (void)_logDebugStates:(const char *)states
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    {
      v17 = off_27972C5D8[internalState - 1];
    }
    ...
    {
      v18 = off_27972C5D8[nextStateToSchedule - 1];
    }
    ...
    *buf = 138546434;
    ...
    v59 = 2114;
    v60 = v24;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@%@ States <Session internal %@, next %@, accessory %@, SU %@> Versions <available %@, staged %@ (last %@), accessory %@, asset %{public}@> Not Ready Reasons <Stage (%{public}@) Apply (%{public}@)>", buf, 0x84u);
...
uint64_t __51__HMDAccessoryFirmwareUpdateSession_logDebugStates__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, asset: %@, auto update: %@", &v11, 0x2Au);
  }
...
- (void)socket:(id)socket didFailWithError:(id)error
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v22 = 2112;
    v23 = errorCopy;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@HDS socket %@ closed: %@ failed for accessory %@ with error %@", &v14, 0x34u);
  }
  ...
  if ((_os_feature_enabled_impl() & 1) == 0 && !CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0) || (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v6 = objc_claimAutoreleasedReturnValue(), v7 = [v6 supportsCHIP], v6, !v7))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *&v42[14] = v17;
      ...
      v45 = 2112;
      v46 = hapAccessory2;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@HDS socket closed in state %@ for %@accessory %@", v42, 0x2Au);
    }
    ...
    _os_log_impl(&dword_2531F8000, v33, v34, v32, v42, 0xCu);
...
LABEL_21:
    ...
    else if ([(HMDAccessoryFirmwareUpdateSession *)v28 internalState]== 5 && [(HMDAccessoryFirmwareUpdateSession *)v28 isFirmwareVersionUpToDate])
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *v42 = 138543362;
        *&v42[4] = v41;
        _os_log_impl(&dword_2531F8000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Registration complete", v42, 0xCu);
      }
...
LABEL_24:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *&v42[14] = "[HMDAccessoryFirmwareUpdateSession socketDidClose:]";
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", v42, 0x16u);
  }
...
- (void)_handleApplyTimerFired
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543874;
    ...
    v25 = 2112;
    v26 = v11;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Apply timer fired for %@ %@ install", buf, 0x20u);
  }
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)selfCopy isFirmwareVersionUpToDate])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v22 = v15;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware is up to date", buf, 0xCu);
    }
...
LABEL_18:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543618;
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Firmware is still not applied after apply timer fired: retries count=%@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v18 = v13;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Out of retries for automatic apply", buf, 0xCu);
  }
...
LABEL_4:
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, v8, buf, 0xCu);
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 138543362;
    v28 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Asking UARP for Apply Results", &v27, 0xCu);
  }
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 138543362;
      v28 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Start the timer for querying result", &v27, 0xCu);
    }
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke_133(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening HDS socket: %@", &v8, 0x16u);
    }
        ...
        else
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
            {
              ...
              v20 = 138543362;
              v21 = v19;
              _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unknown timer", &v20, 0xCu);
            }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v7 = objc_claimAutoreleasedReturnValue(), v8 = [v7 supportsCHIP], v7, v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for staging firmware. No action taken.", buf, 0x16u);
    }
...
void __78__HMDAccessoryFirmwareUpdateSession_stagedFirmwareRescindComplete_withStatus___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 2112;
    v15 = v8;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Staged firmware rescinded with status: %@ for accessory %@", &v10, 0x20u);
  }
...
void __85__HMDAccessoryFirmwareUpdateSession_firmwareUpdateResult_vendorSpecificStatus_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v16 = 2112;
    v17 = v8;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Results from apply accessory %@ status %@", &v12, 0x20u);
  }
...
- (void)firmwareStagingComplete:(id)complete assetID:(id)d withStatus:(unint64_t)status
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543618;
    ...
    v24 = 2112;
    v25 = v14;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingComplete called with status %@", buf, 0x16u);
  }
  ...
  if (v4 > 2)
  {
    if ((v4 - 4) < 2)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543362;
        v49 = v28;
        _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Update canceled", buf, 0xCu);
      }
...
LABEL_15:
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v52 = 2112;
        v53 = v24;
        _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Staging completion status %@ not handled for accessory %@", buf, 0x20u);
      }
...
LABEL_37:
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v49 = v34;
      _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Asset staging complete", buf, 0xCu);
    }
...
LABEL_34:
      _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_DEFAULT, v43, buf, 0xCu);
...
LABEL_5:
  ...
  if (v8)
  {
    if (v12)
    {
      ...
      *buf = 138543874;
      ...
      v52 = 2112;
      v53 = v16;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Staging %@ for asset %@", buf, 0x20u);
    }
  ...
  if (v12)
  {
    ...
    *buf = 138544130;
    ...
    v54 = 2112;
    v55 = v47;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring Staging %@ for asset %@ with current asset %@", buf, 0x2Au);
  }
...
- (void)firmwareStagingProgress:(id)progress assetID:(id)d bytesSent:(unint64_t)sent bytesTotal:(unint64_t)total
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v24 = 2112;
    v25 = v17;
    _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingProgress called for accessory %@ %@/%@ bytes sent", &v18, 0x2Au);
  }
...
void __80__HMDAccessoryFirmwareUpdateSession_assetAvailablityUpdateForAccessory_assetID___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544898;
    ...
    v145 = 2112;
    v146 = v12;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@assetAvailabilityUpdate called with firmware %{public}@,  status: <%{public}@, %{public}s> releaseNotes status: <%{public}@, %{public}s> for asset %@", buf, 0x48u);
  }
...
LABEL_15:
    ...
    if ([a1[4] downloadStatus] == 2)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v134 = v37;
        _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Firmware failed to download", buf, 0xCu);
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v135 = 2112;
      v136 = v46;
      _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_DEBUG, "%{public}@userInitiatedFirmwareStaging: %@", buf, 0x16u);
...
LABEL_48:
              _os_log_impl(&dword_2531F8000, v71, OS_LOG_TYPE_ERROR, v74, buf, 0x16u);
        ...
        if (v48 == 1)
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *buf = 138543874;
            ...
            v137 = 2112;
            v138 = v80;
            _os_log_impl(&dword_2531F8000, v77, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to download asset for accessory:%@ assetID:%@", buf, 0x20u);
          }
...
LABEL_53:
              _os_log_impl(&dword_2531F8000, v89, v90, v88, buf, 0xCu);
...
LABEL_73:
                  _os_log_impl(&dword_2531F8000, v99, OS_LOG_TYPE_ERROR, v102, buf, 0x16u);
...
LABEL_76:
              ...
              if (v91 == 1)
              {
                ...
                if (os_log_type_enabled(v105, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *buf = 138543874;
                  ...
                  v137 = 2112;
                  v138 = v108;
                  _os_log_impl(&dword_2531F8000, v105, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to download release notes for accessory:%@ assetID:%@", buf, 0x20u);
                ...
                if (os_log_type_enabled(v111, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138543874;
                  ...
                  v137 = 2112;
                  v138 = v114;
                  _os_log_impl(&dword_2531F8000, v111, OS_LOG_TYPE_ERROR, "%{public}@Download of release notes failed for accessory:%@ assetID:%@", buf, 0x20u);
              ...
              if (v91 == 3)
              {
                ...
                if (os_log_type_enabled(v94, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *buf = 138543618;
                  ...
                  v135 = 2114;
                  v136 = v96;
                  _os_log_impl(&dword_2531F8000, v94, OS_LOG_TYPE_DEFAULT, "%{public}@Release notes downloaded to %{public}@", buf, 0x16u);
          ...
          if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543874;
            ...
            v137 = 2112;
            v138 = v83;
            _os_log_impl(&dword_2531F8000, v71, OS_LOG_TYPE_ERROR, "%{public}@downloadAvailableFirmwareUpdate failed for accessory:%@ assetID:%@", buf, 0x20u);
          ...
          if (v48 == 3)
          {
            ...
            if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *buf = 138543618;
              ...
              v135 = 2114;
              v136 = v53;
              _os_log_impl(&dword_2531F8000, v51, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloaded to %{public}@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v120, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138543362;
          v134 = v121;
          _os_log_impl(&dword_2531F8000, v120, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloading", buf, 0xCu);
...
LABEL_37:
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v134 = v68;
      _os_log_impl(&dword_2531F8000, v67, OS_LOG_TYPE_DEFAULT, "%{public}@No asset download needed", buf, 0xCu);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138544386;
    ...
    v141 = 2112;
    v142 = v16;
    _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring assetAvailability with asset version %@: current asset %@, accessory %@, staged %@", buf, 0x34u);
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@%s: called on accessory that supports Matter", buf, 0x16u);
    }
...
void __46__HMDAccessoryFirmwareUpdateSession__register__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543874;
    ...
    v42 = 2112;
    v43 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Register accessory failed for %@ - couldn't open socket error:%@", buf, 0x20u);
  }
  ...
  if ([*(a1 + 32) currentRegisterFailureCount] < 0xA)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v40 = 2112;
      v41 = &unk_286628F18;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Rescheduling register in %@ seconds", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138543362;
        v39 = v14;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Register retry timer is active", buf, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543618;
        ...
        v40 = 2112;
        v41 = v29;
        _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ hours to retry registering accessory", buf, 0x16u);
      }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v5 = objc_claimAutoreleasedReturnValue(), v6 = [v5 supportsCHIP], v5, v6))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", buf, 0x16u);
    }
  ...
  if (v5)
  {
    ...
    *&v6 = 138543874;
    ...
    while (1)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138543618;
        ...
        v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEBUG, "%{public}@HDS socket received %@ bytes", buf, 0x16u);
      }
      ...
      if ((v14 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = v28;
          ...
          v35 = 2112;
          v36 = v15;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Couldn't send data from accessory %@ to controller: %@", buf, 0x20u);
        }
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v32 = v27;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Socket closed", buf, 0xCu);
    }
...
- (BOOL)sendMessageToAccessory:(id)accessory uarpMsg:(id)msg error:(id *)error
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543618;
    ...
    v34 = 2112;
    v35 = v14;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEBUG, "%{public}@sendMessageToAccessory called with %@ bytes", buf, 0x16u);
  }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](selfCopy, "hapAccessory"), v15 = objc_claimAutoreleasedReturnValue(), v16 = [v15 supportsCHIP], v15, v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", buf, 0x16u);
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v33 = v27;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: Socket not open", buf, 0xCu);
      }
...
- (HMSoftwareUpdateDocumentationMetadata)newDocumentationMetadata
{
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self documentationAvailable])
  {
    ...
    {
      dispatch_once(&documentationMaxSize_onceToken, &__block_literal_global_595);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544130;
        ...
        v33 = 2112;
        v34 = v18;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@Couldn't create digest for URLs local %@ remote: %@ error: %@", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v29 = 2112;
      v30 = uarpAccessory;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEBUG, "%{public}@No documentation available for %@", buf, 0x16u);
    }
...
- (id)newSoftwareUpdateWithState:(int64_t)state
{
  ...
  if (!assetReleaseDate)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543618;
      ...
      v51 = 2112;
      v52 = assetID2;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@No release date set for asset, using current date - assetID %@", buf, 0x16u);
    }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138545154;
    ...
    v63 = 2112;
    v64 = v31;
    _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Creating SoftwareUpdate with version %@, state %@, downloadSize %@(uarpAccessory downloadSize %@), documentation %@, release date %@, duration %@", buf, 0x52u);
...
- (void)_updateAvailableSoftwareUpdateDocumentation
{
  ...
  if (softwareUpdate)
  {
    ...
    if (!documentationMetadata)
    {
      ...
      [hapAccessory updateSoftwareUpdate:documentationMetadata completionHandler:&__block_literal_global_111_125732];
    }
  }
...
- (void)_updateAvailableSoftwareUpdateState:(int64_t)state
{
  ...
  if (!availableSoftwareVersion)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = v36;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Not updating state from %@ to %@ because update firmware version is not set by UARP", &v39, 0x20u);
    }
  ...
  if (state == 2 && [(HMDAccessoryFirmwareUpdateSession *)self isFirmwareVersionUpToDate])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      {
        v13 = off_27972C5D8[internalState - 1];
      }
      ...
      v41 = 2112;
      v42 = v13;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not updating state from %@ to downloaded because firmware version is up to date", &v39, 0x16u);
    }
...
LABEL_24:
  ...
  if (softwareUpdate && ([softwareUpdate version], v16 = objc_claimAutoreleasedReturnValue(), v17 = objc_msgSend(availableSoftwareVersion, "isEqualToVersion:", v16), v16, v17))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v43 = 2112;
      v44 = v38;
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating available software update state from %@ to %@", &v39, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v41 = 2112;
      v42 = v34;
      _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_INFO, "%{public}@New available software update with state %@", &v39, 0x16u);
    }
    ...
    [hapAccessory updateSoftwareUpdate:v35 completionHandler:&__block_literal_global_109_125738];
  }
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAvailableSoftwareUpdateState___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2112;
      v17 = v11;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating available software update state from %@ to %@ because apply timer is active", &v12, 0x20u);
    }
...
- (void)_resetAvailableSoftwareUpdate
{
  ...
  if (softwareUpdate)
  {
    [hapAccessory updateSoftwareUpdate:0 completionHandler:&__block_literal_global_107_125741];
  }
}
    ...
    if (([accessoryVersion isGreaterThanVersion:availableSoftwareVersion] & 1) != 0 || objc_msgSend(stagedFirmwareVersion, "isGreaterThanVersion:", availableSoftwareVersion))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138544130;
        ...
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version (%@) is older than either current accessory version (%@) or the staged version (%@)", buf, 0x2Au);
    ...
    else
    {
      if ([availableSoftwareVersion isEqualToVersion:accessoryVersion])
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v48 = v30;
          _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is the same as the current accessory version. Software Update has been installed.", buf, 0xCu);
        }
...
LABEL_22:
      ...
      if ([availableSoftwareVersion isEqualToVersion:stagedFirmwareVersion])
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v48 = v36;
          _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is staged on accessory. Software Update has been downloaded.", buf, 0xCu);
        }
    ...
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, v38, buf, 0xCu);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543362;
    v48 = v19;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEBUG, "%{public}@firmware version not available in UARP accessory", buf, 0xCu);
  }
...
- (void)incrementMatterFirmwareUpdateRetryCount
{
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self isMatterFirmwareUpdateRetryAllowed])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 2048;
      v12 = 5;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update retry attempt %lu of %lu", &v7, 0x20u);
    }
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAccessoryVendorIDAndProductID__block_invoke(uint64_t a1)
{
  ...
  if ((v8 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v24;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory vendor ID property", &v26, 0xCu);
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v14;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Accessory vendor ID updated to %@", &v26, 0x16u);
  }
  ...
  if ((v18 & 1) == 0)
  {
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v25;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory product ID property", &v26, 0xCu);
    }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = v23;
    _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory product ID updated to %@", &v26, 0x16u);
  }
...
- (void)_updateSoftwareUpdateNotReadyReasons
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543618;
    ...
    v55 = 2112;
    v56 = v20;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown stagingNotReadyReasons %@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543618;
    ...
    v55 = 2112;
    v56 = v35;
    _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown applyNotReadyReasons %@", buf, 0x16u);
  }
  ...
  if (softwareUpdate2)
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138545410;
      ...
      v69 = 2114;
      v70 = v43;
      _os_log_impl(&dword_2531F8000, v39, OS_LOG_TYPE_INFO, "%{public}@SoftwareUpdate needsAttentionReasons changed - old %{public}@ (%{public}@) new %{public}@ (%{public}@) staging reasons %{public}@ (%{public}@) apply reasons %{public}@ (%{public}@)", buf, 0x5Cu);
...
void __82__HMDAccessoryFirmwareUpdateSession_handleFirmwareUpdateStateChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v9;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory state changed to %@", &v18, 0x16u);
  }
  ...
  if ([v6 internalState] == 2 && (!objc_msgSend(v4, "longValue") || objc_msgSend(v4, "longValue") == 2))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138543362;
      v19 = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Restarting staging", &v18, 0xCu);
    }
  ...
  else if ([v6 internalState] == 3 && objc_msgSend(v4, "longValue") == 4)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Detected remote apply in progress", &v18, 0xCu);
    }
...
void __73__HMDAccessoryFirmwareUpdateSession_updateAccessoryStagedFirmwareVersion__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v41 = 2112;
    v42 = v4;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version changed from %@ to %@", &v37, 0x20u);
  }
  ...
  if (!v13)
  {
    ...
    if (v26)
    {
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        v37 = 138543362;
        v38 = v31;
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated UARP staged firmware version property", &v37, 0xCu);
      }
...
LABEL_19:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v41 = 2112;
        v42 = v36;
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_ERROR, "%{public}@checkForUpdate failed for accessory %@ %@", &v37, 0x20u);
    ...
    else if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v32;
      _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP staged firmware version property", &v37, 0xCu);
LABEL_17:
    }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v39 = 2112;
    v40 = v18;
    _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version newer than available version (%@)", &v37, 0x16u);
  }
  ...
  if (([v11 checkForUpdateForAccessory:v2] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v22;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Error request UARP to check for available updates", &v37, 0xCu);
    }
...
LABEL_4:
    ...
    if (v23)
    {
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138544130;
        ...
        v46 = 2112;
        v47 = v29;
        _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_INFO, "%{public}@Accessory %@: UARP accessory firmware version property updated to %@ (accessoryVersion is %@)", buf, 0x2Au);
      }
    ...
    else
    {
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v41 = v30;
        _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory firmware version property", buf, 0xCu);
      }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v41 = v34;
    _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_INFO, "%{public}@Waiting for version number and version string to be in sync before proceeding", buf, 0xCu);
  }
  ...
  if (stringValue)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v43 = 2112;
      v44 = v23;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@isAccessoryVersionInSyncWithAssetVersion: VersionNumberInSync : %@, VersionStringInSync: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544386;
      ...
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@isAccessoryVersionInSyncWithAssetVersion: AssetVersionNumber: %@, MatterFirmwareRevisionNumber: %@, AssetVersionString %@, FirmwareVersionString: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v41 = 2112;
      v42 = 0;
      _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, "%{public}@Matter firmware version is invalid: %@", buf, 0x16u);
    }
...
LABEL_19:
    _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, v30, &v32, 0xCu);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2112;
    v37 = v13;
    _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Version mismatch detected. Comparing Matter firmware = %@ and UARP version = %@", &v32, 0x20u);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Matter firmware version = %llu is larger than UARP version = %@ with valid asset version number = %llu", &v32, 0x2Au);
  }
...
- (void)handleAccessoryFirmwareVersionChangedNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware updated notification", &v9, 0xCu);
  }
...
- (void)handleAccessoryVIDPIDChangedNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received matter VID PID updated notification", &v9, 0xCu);
  }
...
- (void)handleAccessoryFirmwareVersionNumberChangedNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version number updated notification", &v9, 0xCu);
  }
...
- (void)_updateSoftwareUpdateStateForMatterAccessoryWithState:(unint64_t)state
{
  ...
  if (state == 1)
  {
    ...
    if ([availableSoftwareVersion isEqualToVersion:accessoryVersion])
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v33 = 2112;
        v34 = softwareUpdate;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Update is already installed for acc:%@ uarpAcc:%@ softwareUpdate:%@", &v27, 0x2Au);
      }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v26;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@Marking Update as %@, matter accessory will trigger staging by itself.", &v27, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v30 = v20;
      v21 = v20;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unsupported state %@ for Matter Accessory, ignoring.", &v27, 0x16u);
    }
...
- (void)_cancelApplyTimer
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply timer cancelled", &v12, 0xCu);
  }
...
- (void)_endSession
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [hapAccessory supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v11;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", &v23, 0xCu);
      }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v25 = 2112;
    v26 = v16;
    _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Session ended (already ended: %@)", &v23, 0x16u);
  }
...
LABEL_21:
      _os_log_impl(&dword_2531F8000, v20, v21, v19, &v23, 0xCu);
    }
...
LABEL_22:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      {
        v14 = off_27972C5D8[internalState2 - 1];
      }
      ...
      v25 = 2112;
      v26 = v14;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Scheduling next operation, state %@", &v23, 0x16u);
    }
...
- (void)_applyFailed
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", &v14, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Apply did not complete or failed in the accessory", &v14, 0xCu);
    }
...
- (void)_stagingFailed
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [hapAccessory supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", &v20, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Staging failed", &v20, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@No more staging retries for this accessory's firmware update session", &v20, 0xCu);
      }
...
void __74__HMDAccessoryFirmwareUpdateSession__handleAutomaticUpdateEnabledChanged___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@Notification missing required key", buf, 0xCu);
    }
...
- (double)_expectedApplyDuration
{
  ...
  if (!updateDuration)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Expected duration is not set - default to minimum apply duration", &v12, 0xCu);
    }
...
- (void)startApplyDurationTimers
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v24 = 2112;
    v25 = v19;
    _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ seconds for accessory to apply update", &v22, 0x16u);
  }
...
- (void)_applyFirmware
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [hapAccessory supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v31 = v14;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to apply asset", buf, 0xCu);
    }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v32 = 2112;
          v33 = hapAccessory;
          _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@No firmwareUpdateProfile for accessory: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v32 = 2112;
        v33 = uarpAccessory2;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@applyFirmwareUpdateOnAccessoryList failed for %@", buf, 0x16u);
      }
        ...
        if (v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged version %@ is different then available version %@", buf, 0x20u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v29 = 2112;
          v30 = v24;
          _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Not auto applying firmware update because isAutomaticThirdPartyAccessorySoftwareUpdateEnabled = %@", buf, 0x16u);
        }
...
- (void)stagingComplete
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [hapAccessory supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", &v14, 0x16u);
    }
  ...
  else
  {
    ...
    if (([hapAccessory isAutomaticThirdPartyAccessorySoftwareUpdateEnabled] & 1) != 0 || -[HMDAccessoryFirmwareUpdateSession isUserInitiatedInstall](self, "isUserInitiatedInstall"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v14 = 138543362;
        v15 = v12;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Staging complete", &v14, 0xCu);
      }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [hapAccessory supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: firmware has been downloaded for Matter Accessory. Matter Accessory responsible for staging firmware. No action taken.", buf, 0x16u);
    }
...
void __50__HMDAccessoryFirmwareUpdateSession_stageFirmware__block_invoke(uint64_t a1)
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@UARP initiated asset staging", &v14, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate asset staging in UARP controller", &v14, 0xCu);
    }
  ...
  if (![stagedFirmwareVersion isAtLeastVersion:availableSoftwareVersion] || !objc_msgSend(stagedFirmwareVersion, "isGreaterThanVersion:", accessoryVersion))
  {
    if (![availableSoftwareVersion isGreaterThanVersion:stagedFirmwareVersion])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unhandled version combination in nextStateToSchedule", &v17, 0xCu);
      }
...
- (BOOL)isReadyToApplyUpdate
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138544642;
    ...
    v30 = 2112;
    v31 = v14;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Not ready for applying update - Not ready reason: %@ (%{public}@), updateState %@ (%@), isFirmwareVersionUpToDate %@", buf, 0x3Eu);
  }
...
- (BOOL)isCurrentUpdateLatest
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@No available version from UARP", &v14, 0xCu);
    }
...
- (BOOL)isReadyForStaging
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138544642;
    ...
    v30 = 2112;
    v31 = v14;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Not ready for staging - Not ready reasons: %@ (%{public}@), updateState %@ (%{public}@), isStagedFirmwareVersionUpToDate %@", buf, 0x3Eu);
  }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [hapAccessory supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", buf, 0x16u);
    }
...
LABEL_10:
    if ([(HMDAccessoryFirmwareUpdateSession *)self applyHDSRetryCount]< 0xA)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v31 = 2112;
        v32 = v17;
        _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Rescheduling apply task after HDS failure in %@ sec for retry: %@", buf, 0x20u);
      }
    ...
    else
    {
      if ([(HMDAccessoryFirmwareUpdateSession *)self internalState]== 3)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v28 = v12;
          _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Out of HDS retries for apply. Moving update back to downloaded.", buf, 0xCu);
        }
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v29 = 2112;
    v30 = name;
    _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not performing HDS retries because firmware apply has not started and accessory %@ is unreachable", buf, 0x16u);
  }
...
void __70__HMDAccessoryFirmwareUpdateSession__evaluateHDSRetryForApplyFirmware__block_invoke(uint64_t a1)
{
  ...
  if ([*(a1 + 32) sessionEnded])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      v7 = 138543362;
      v8 = v5;
      _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Session has been ended, stop performing retries", &v7, 0xCu);
    }
...
- (void)_syncStateWithAccessoryOnResume
{
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self internalState])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      {
        v9 = off_27972C5D8[internalState - 1];
      }
      ...
      v12 = 2112;
      v13 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Synced state is: %@", &v10, 0x16u);
    }
...
- (void)_withOpenSocketDoBlock:(id)block error:(id)error
{
    ...
    else
    {
      ...
      if (dataStreamSocketController)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v31 = v23;
          _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Opening HDS connection to accessory", buf, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v31 = v24;
          _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@No dataStreamSocketController", buf, 0xCu);
        }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", buf, 0x16u);
  }
  ...
  if (WeakRetained)
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v8;
        _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Opened HDS connection to accessory", &v28, 0xCu);
      }
      ...
      if (v14)
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v28 = 138543362;
          v29 = v19;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Notified UARP accessory is reachable", &v28, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v28 = 138543362;
          v29 = v25;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify about reachable accessory to UARP", &v28, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 2112;
        v31 = v24;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Couldn't open HDS connection to accessory error %@", &v28, 0x16u);
      }
...
- (void)_handleRegisterFailureRetryTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Register failure retry timeout", &v8, 0xCu);
  }
...
- (void)_cancelRegisterFailureRetryTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel register failure retry timer", &v9, 0xCu);
  }
...
- (void)_handleQueryFirmwareUpdateResultTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Query firmware update result duration timeout", &v8, 0xCu);
  }
...
- (void)_cancelQueryFirmwareUpdateResultTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel query firmware update result duration timer", &v9, 0xCu);
  }
...
- (void)_handleSocketTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 138543362;
    v15 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Socket idle timeout", &v14, 0xCu);
  }
  ...
  if ((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))
  {
    ...
    if ([hapAccessory supportsCHIP])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", &v14, 0x16u);
      }
...
- (void)_cancelSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 138543362;
    v16 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel socket idle timer", &v15, 0xCu);
  }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](selfCopy, "hapAccessory"), v8 = objc_claimAutoreleasedReturnValue(), v9 = [v8 supportsCHIP], v8, v9))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", &v15, 0x16u);
    }
...
- (void)_resetSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 138543362;
    v16 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reset socket idle timer", &v15, 0xCu);
  }
...
- (void)_startSocketIdleTimer
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", &v25, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      v27 = 2112;
      v28 = v19;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Start socket idle timer for %@ seconds", &v25, 0x16u);
    }
...
- (void)resumeWithState:(unint64_t)state
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v40 = 2112;
    v41 = v16;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Resume called with sessionState: %@ accessoryState %@ resumeState %@", buf, 0x2Au);
  }
  ...
  if (v5 > 2)
  {
    if (v5 == 3)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
      {
        ...
        v29 = 138543362;
        v30 = v23;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Next action: applyFirmware", &v29, 0xCu);
      }
    ...
    if (v5 != 4)
    {
      if (v5 == 5)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          ...
          v29 = 138543362;
          v30 = v15;
          _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Next action: register", &v29, 0xCu);
        }
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 2112;
      v32 = v28;
      _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_ERROR, "%{public}@Ignoring resume in state %@", &v29, 0x16u);
    }
...
LABEL_39:
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      v29 = 138543362;
      v30 = v19;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Next action: -", &v29, 0xCu);
    }
...
LABEL_31:
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEBUG, v10, &v29, 0xCu);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543874;
    ...
    v24 = 2112;
    v25 = v3;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@HAP Communication Error occurrence: %@ error: %@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v21 = v14;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Out of retries for socket open", buf, 0xCu);
  }
...
void __53__HMDAccessoryFirmwareUpdateSession_resumeWithState___block_invoke_90(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@rescheduling task after socket open failed", &v6, 0xCu);
  }
    ...
    if (supportsCHIP)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called by the controller's scheduler. Only a Matter Accessory can pause a firmware staging/application. No action taken.", buf, 0x16u);
      }
...
LABEL_11:
  ...
  if (isClosing)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Pause ignored with socket in closing state", buf, 0xCu);
    }
...
LABEL_7:
    ...
    if ((v24 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544130;
        ...
        _os_log_impl(&dword_2531F8000, v40, OS_LOG_TYPE_ERROR, "%{public}@Requested install version %@ is different than available version %@ / %@", buf, 0x2Au);
    ...
    if (updateNotReadyReasons)
    {
      ...
      *buf = 138543618;
      ...
      v37 = 22;
LABEL_24:
      _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_ERROR, v35, buf, v37);
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      ...
      _os_log_impl(&dword_2531F8000, v53, OS_LOG_TYPE_DEFAULT, "%{public}@Starting user-initiated update", buf, 0xCu);
    }
...
LABEL_27:
          ...
          *buf = 138543362;
          v65 = v32;
          _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot update while registration is in progress", buf, 0xCu);
LABEL_25:
...
LABEL_45:
          _os_log_impl(&dword_2531F8000, v60, v61, v59, buf, 0xCu);
...
LABEL_49:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138544386;
    ...
    _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Already has the latest version: %@. Ignoring the downloaded version: %@ / %@", buf, 0x34u);
...
- (unint64_t)sessionState
{
  ...
  {
    return qword_253D4BF48[nextStateToSchedule - 1];
  }
}
...
- (void)setInternalState:(unint64_t)state
{
  ...
  if (internalState != state)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v14 = 2112;
      v15 = v11;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@State changed to %@", &v12, 0x16u);
    }
...
- (HMDAccessoryFirmwareUpdateSession)initWithHAPAccessory:(id)accessory uarpAccessory:(id)uarpAccessory accessoryFirmwareUpdateManager:(id)manager logEventManager:(id)eventManager wingman:(id)wingman
{
  ...
  if (v17)
  {
    ...
    v17->_registerFailureRetryTimerFactory = &__block_literal_global_125906;
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t203, &__block_literal_global_158_125916);
  }
...
+ (id)__calculateDigestDataFromFile:(id)file maxDataSize:(unint64_t)size error:(id *)error
{
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v50 = 2112;
      v51 = v12;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Couldn't open input stream for %@", &data, 0x16u);
    }
  ...
  if (v14 >= 1)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v46 = 2112;
      v47 = v12;
      _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on file %@", buf, 0x20u);
    }
  ...
  if (v14 < 0)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v46 = 2112;
      v47 = streamError;
      _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, "%{public}@Error reading documentation from %@: %@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v44 = 2048;
      v45 = 20;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", buf, 0x16u);
    }
