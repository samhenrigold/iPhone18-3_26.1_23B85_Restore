...
void __48__HMDAudioStreamInterface_streamDidRTCPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream RTCP has timed out", &v6, 0xCu);
  }
...
void __47__HMDAudioStreamInterface_streamDidRTPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream RTP has timed out", &v6, 0xCu);
  }
...
void __46__HMDAudioStreamInterface_streamDidServerDie___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream server died", &v8, 0xCu);
  }
...
uint64_t __50__HMDAudioStreamInterface_stream_didResume_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream resumed with didResume: %@ error: %@", &v9, 0x20u);
  }
...
uint64_t __49__HMDAudioStreamInterface_stream_didPause_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream paused with didPause: %@ error: %@", &v9, 0x20u);
  }
...
uint64_t __41__HMDAudioStreamInterface_streamDidStop___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream stopped", &v7, 0xCu);
  }
...
uint64_t __49__HMDAudioStreamInterface_stream_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream started with didStart: %@ error: %@", &v9, 0x20u);
  }
...
- (void)_callStopped:(id)stopped
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 138543362;
    v17 = v13;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didStop", &v16, 0xCu);
  }
...
- (void)_callResumed:(id)resumed
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didResume", &v11, 0xCu);
  }
...
- (void)_callPaused:(id)paused
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didPause", &v11, 0xCu);
  }
...
- (void)_callStarted:(id)started
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didStart", &v11, 0xCu);
  }
...
- (void)setMuted:(BOOL)muted
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Setting audio muted to %@", &v16, 0x16u);
  }
...
- (void)addMutedStream:(id)stream
{
  ...
  if (!anyObject)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Adding first muted stream, so set should restore unmuting to %{BOOL}d", &v13, 0x12u);
    }
...
- (void)startSynchronizationWithVideoStreamToken:(int64_t)token
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2048;
    tokenCopy = token;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Starting synchronization with video stream token: %ld", &v11, 0x16u);
  }
...
- (void)_resumeStream
{
  ...
  if (sessionID)
  {
    if (v11)
    {
      ...
      v15 = 138543362;
      v16 = v12;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Resuming audio stream", &v15, 0xCu);
    }
  ...
  else
  {
    if (v11)
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Starting audio stream", &v15, 0xCu);
    }
...
- (void)_pauseStream
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Pausing audio stream", &v9, 0xCu);
  }
...
- (void)_stopStreamWithCompletion:(id)completion
{
  ...
  if ([(HMDStreamInterface *)self state]== 3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Not stopping stream because it has already stopped", &v15, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Stopping audio stream", &v15, 0xCu);
    }
...
- (void)updateAudioVolume:(id)volume callback:(id)callback
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2048;
    v30 = v16;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Setting audio stream volume from %f to %f", &v25, 0x20u);
  }
...
- (void)updateAudioSetting:(unint64_t)setting
{
  ...
  if (setting - 1 >= 3)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2048;
      settingCopy = setting;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Invalid audio stream setting %tu", &v23, 0x16u);
    }
  ...
  if (audioStreamSetting == setting)
  {
    if (v10)
    {
      ...
      v25 = 2112;
      settingCopy = v12;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Audio stream setting is already set to %@", &v23, 0x16u);
    }
...
LABEL_9:
  ...
  if (v10)
  {
    ...
    v27 = 2112;
    v28 = v20;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Changing the audio stream setting from %@ to %@", &v23, 0x20u);
  }
...
+ (int)_createLocalRTPSocketWithRemoteSender:(id)sender localNetworkConfig:(id)config
{
  ...
  if (v8 == -1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 1024;
      v22 = v15;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Could not create rtp socket with port %@ %d", &v17, 0x1Cu);
    }
...
+ (id)_createAudioStreamWithSessionHandler:(id)handler localNetworkConfig:(id)config localRTPSocket:(int *)socket sessionID:(id)d
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 138543362;
    v31 = v16;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Creating the audio stream", &v30, 0xCu);
  }
