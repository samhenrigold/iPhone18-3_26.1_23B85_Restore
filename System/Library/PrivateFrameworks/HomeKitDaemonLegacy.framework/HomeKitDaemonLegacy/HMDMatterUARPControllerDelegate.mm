...
- (id)newUploader
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", &v8, 0x16u);
    }
...
- (BOOL)sendMessageToAccessory:(id)accessory uarpMsg:(id)msg error:(id *)error
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v14 = 138543362;
    v15 = v12;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: failed. This function should not be called for Matter accessories", &v14, 0xCu);
  }
...
- (void)assetAvailablityUpdateForAccessory:(id)accessory assetID:(id)d
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *&buf[24] = updated;
    ...
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update Available for accessory:%@, status:%s, release notes status:%s", buf, 0x2Au);
  }
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *&buf[24] = firmwareVersion2;
          _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_INFO, "%{public}@Available version %@ is equal or older than current accessory version %@", buf, 0x20u);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543362;
    *&buf[4] = v18;
    _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not supported on this device; ignoring", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_111164 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_111164, &__block_literal_global_111165);
  }

  v3 = logCategory__hmf_once_v1_111166;
...
uint64_t __46__HMDMatterUARPControllerDelegate_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_111166;
  logCategory__hmf_once_v1_111166 = v0;
