...
LABEL_41:
  ...
  if (transportProtocol >= 2)
  {
    if (transportProtocol == 2)
    {
      ...
      v20 = [icmpTypes na_map:&__block_literal_global_216_144118];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v37 = 2112;
        v38 = v28;
        _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Invalid address value: %@", buf, 0x16u);
...
LABEL_10:
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        v20 = 138543362;
        v21 = v18;
        _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@IP address range must have matching address family", &v20, 0xCu);
      }
...
LABEL_10:
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, v15, &v27, 0x20u);
...
LABEL_20:
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, v23, &v27, 0x20u);
    }
  }
...
+ (BOOL)__decodeAddresses:(id)addresses subject:(id *)subject
{
  ...
  if (![addressesCopy count])
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v60 = v34;
      _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an empty address array", buf, 0xCu);
    }
      ...
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v61 = 2112;
          v62 = v11;
          _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a non-string address: %@", buf, 0x16u);
        }
      ...
      if (!v15)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v61 = 2112;
          v62 = v13;
          _os_log_impl(&dword_2531F8000, v44, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid address: %@", buf, 0x16u);
        }
      ...
      if ([v9 containsObject:ipAddressAny])
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v61 = 2112;
          v62 = ipAddressAny;
          _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a duplicate address: %@", buf, 0x16u);
  ...
  if (v53 & v49 & 1) != 0 || (v51 & HIDWORD(v49))
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v61 = 2112;
      v62 = v7;
      _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a mix of wildcard and non-wildcard addresses: %@", buf, 0x16u);
    }
...
+ (BOOL)__decodeHostnames:(id)hostnames subject:(id *)subject
{
  ...
  if (![v9 count])
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v112 = v42;
      _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an empty hostname array", buf, 0xCu);
    }
  ...
  if (!v20)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v113 = 2112;
      v114 = v65;
      _os_log_impl(&dword_2531F8000, v63, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a non-string hostname: %@", buf, 0x16u);
    }
  ...
  if (![v21 length] || objc_msgSend(v21, "length") >= 0xFE)
  {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *v103 = 138543874;
      ...
      v107 = 2048;
      v108 = v60;
      _os_log_impl(&dword_2531F8000, v58, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its length is out of bounds: %lu", v103, 0x20u);
      ...
      if ([validateHostNameForWANFirewallRule_componentRegex numberOfMatchesInString:v27 options:0 range:{0, v28}] != 1)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *v103 = 138543874;
          ...
          v50 = 32;
LABEL_49:
          _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_INFO, v48, v103, v50);
        }
        ...
        if (v30)
        {
          ...
          if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
          {
            ...
            *v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2531F8000, v73, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its second-to-last component contains a wildcard", v103, 0x16u);
          }
        ...
        if ([lastObject isEqualToString:@"local"])
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
          {
            ...
            *v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2531F8000, v77, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component is 'local'", v103, 0x16u);
          }
        ...
        if ([lastObject containsString:@"*"])
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
          {
            ...
            *v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2531F8000, v77, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component contains a wildcard", v103, 0x16u);
        ...
        if ([lastObject rangeOfCharacterFromSet:v32] == 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
          {
            ...
            *v103 = 138543618;
            ...
            v105 = 2112;
            v106 = v21;
            _os_log_impl(&dword_2531F8000, v82, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component does not contain letters", v103, 0x16u);
        ...
        if ([v89 containsObject:v21])
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v113 = 2112;
            v114 = v21;
            _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a duplicate hostname: %@", buf, 0x16u);
...
LABEL_50:
  ...
  if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
  {
    ...
    *v103 = 138543874;
    ...
    v107 = 2048;
    v108 = 2;
    _os_log_impl(&dword_2531F8000, v69, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because it does not contain at least %lu components", v103, 0x20u);
  }
...
LABEL_52:
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v113 = 2112;
    v114 = v21;
    _os_log_impl(&dword_2531F8000, v53, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid hostname: %@", buf, 0x16u);
  }
