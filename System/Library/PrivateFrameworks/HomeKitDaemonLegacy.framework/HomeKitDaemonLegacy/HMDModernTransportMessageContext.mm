...
- (void)completeSendingOverTransport:(id)transport withError:(id)error
{
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v74 = v61;
      _os_log_impl(&dword_2531F8000, v60, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid transport", buf, 0xCu);
    }
  ...
  if ((v11 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v66, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v74 = v67;
      _os_log_impl(&dword_2531F8000, v66, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transport has not started", buf, 0xCu);
    }
...
- (void)startSendingOverTransport:(id)transport
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      v32 = v31 = 138543362;
      v21 = v32;
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid transport", &v31, 0xCu);
    }
  ...
  if (![transportCopy maximumNumberOfRetries] && (-[NSMutableSet containsObject:](self->_remainingTransports, "containsObject:", transportCopy) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_FAULT))
    {
      ...
      v32 = v27;
      v28 = v27;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transport already started", &v31, 0xCu);
    }
...
uint64_t __47__HMDModernTransportMessageContext_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v14_88731;
  logCategory__hmf_once_v14_88731 = v0;
