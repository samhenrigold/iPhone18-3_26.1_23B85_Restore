...
LABEL_13:
        _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, v10, &v19, 0xCu);
...
LABEL_18:
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, v15, &v19, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v36 = 2112;
            v37 = v10;
            _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid value type: %@", buf, 0x16u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v36 = 2112;
    v37 = v28;
    _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", buf, 0x16u);
  }
...
uint64_t __63__HMDAccessoryFirmwareUpdateCameraPolicy_handleSettingsChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Settings changed, updating policy status", &v7, 0xCu);
  }
...
uint64_t __82__HMDAccessoryFirmwareUpdateCameraPolicy_handleAccessoryUnconfiguredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is unconfigured, disabling stream status monitoring...", &v10, 0xCu);
  }
...
uint64_t __80__HMDAccessoryFirmwareUpdateCameraPolicy_handleAccessoryConfiguredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is configured, enabling stream status monitoring...", &v10, 0xCu);
  }
...
uint64_t __53__HMDAccessoryFirmwareUpdateCameraPolicy_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_19698;
  logCategory__hmf_once_v1_19698 = v0;
