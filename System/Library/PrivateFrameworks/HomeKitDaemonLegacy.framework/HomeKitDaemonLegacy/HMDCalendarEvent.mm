...
- (id)_nextTimerDateAfterDate:(id)date timeZone:(id)zone
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = recurrences;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Determining next fire date after date %@ using components: %@ recurrence: %@", &v21, 0x2Au);
  }
...
- (void)_transactionObjectUpdated:(id)updated newValues:(id)values message:(id)message
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 138543362;
    v26 = v14;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", &v25, 0xCu);
  }
...
LABEL_28:
          _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_INFO, v40, buf, 0x16u);
        }
      }
...
LABEL_14:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v48 = 2112;
      v49 = v16;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Determined next fire date by assigning fire date components to current date: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v48 = 2112;
    v49 = v27;
    _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, "%{public}@Determined next fire date by assigning fire recurrent date components to current date: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_9895 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_9895, &__block_literal_global_9896);
  }

  v3 = logCategory__hmf_once_v1_9897;
...
uint64_t __31__HMDCalendarEvent_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_9897;
  logCategory__hmf_once_v1_9897 = v0;
