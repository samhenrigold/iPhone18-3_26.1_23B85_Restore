...
void __90__HMDRemoteEventRouterAssertionController_handleConnectionActiveStateUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 1024;
    v18 = v5;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Received notification that connection active state is now %{BOOL}d", &v15, 0x12u);
  }
...
uint64_t __54__HMDRemoteEventRouterAssertionController_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_174733;
  logCategory__hmf_once_v9_174733 = v0;
