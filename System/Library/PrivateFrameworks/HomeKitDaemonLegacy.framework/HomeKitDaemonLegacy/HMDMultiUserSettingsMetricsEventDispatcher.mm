...
- (void)submitMultiUserSettingsDailyEvent
{
  ...
  if (dataSource)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitting multi user settings daily event", &v21, 0xCu);
    }
...
LABEL_14:
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = numSharedUsers3;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@numSharedUsers is %@. Don't submit logs", &v21, 0x16u);
    }
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v21 = 138543362;
    v22 = v15;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@No DataSource is set for submitMultiUserSettingsDailyEvent", &v21, 0xCu);
  }
...
uint64_t __57__HMDMultiUserSettingsMetricsEventDispatcher_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v4_25151;
  logCategory__hmf_once_v4_25151 = v0;
