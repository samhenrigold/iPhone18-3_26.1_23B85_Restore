  ...
  if (v8 && [*(a1 + 32) hasCurrentUserAccessCodeChangedWithChangedAccessCodes:*(a1 + 48) home:v8])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = v17;
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not creating access code removed bulletin because it was removed by current user: %@", &v22, 0x20u);
      }
  ...
  if (v8 && [*(a1 + 32) hasCurrentUserAccessCodeChangedWithChangedAccessCodes:*(a1 + 48) home:v8])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = v17;
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not creating access code changed bulletin because it was changed by current user: %@", &v22, 0x20u);
      }
  ...
  if (v8 && [*(a1 + 32) hasCurrentUserAccessCodeChangedWithChangedAccessCodes:*(a1 + 48) home:v8])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = v17;
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not creating access code added bulletin because it was added by current user: %@", &v22, 0x20u);
      }
...
id __80__HMDAccessCodeManager__waitUntilDataHasSyncedToResidentForAccessoryUUIDs_flow___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v29 = 2112;
    v30 = v17;
    _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Pinging resident to confirm data has synced for accessories: %@", buf, 0x20u);
  }
...
void __80__HMDAccessCodeManager__waitUntilDataHasSyncedToResidentForAccessoryUUIDs_flow___block_invoke_2(id *a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      v19 = 2112;
      v20 = v5;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to confirm resident has data with error: %@", &v15, 0x20u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Resident confirmed that data has synced", &v15, 0x16u);
    }
...
- (id)_addNewAccessCode:(id)code forUserWithUUID:(id)d toAccessoriesWithUUIDs:(id)ds withRetries:(BOOL)retries flow:(id)flow
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v37 = 2112;
    v38 = dsCopy;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Adding new access code to accessories with UUIDs: %@", buf, 0x20u);
  }
...
void __67__HMDAccessCodeManager__removeAccessCode_forUserBeingRemoved_flow___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v5 || [objc_msgSend(*(a1 + 32) "utilities")])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v11;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] At least one modification response failed, so saving removedUserAccessCode", &v20, 0x16u);
    }
...
void __102__HMDAccessCodeManager__removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure_forUserUUID_flow___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      v27[1] = 3221225472;
      v27[2] = __102__HMDAccessCodeManager__removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure_forUserUUID_flow___block_invoke_369;
      v27[3] = &unk_279735918;
      v28 = *(a1 + 48);
      v29 = v5;
...
LABEL_16:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    v30 = 2112;
    v31 = v26;
    _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Received modification request of unknown type", &v28, 0x16u);
  }
...
- (void)_submitAccessCodeModificationRequestsForMessage:(id)message
{
  ...
  v17 = [MEMORY[0x277CBEA60] arrayWithObjects:v52 count:4];
  v18 = [v15 unarchivedObjectForKey:v16 ofClasses:v17];
  ...
  if (v18 && ![v18 hmf_isEmpty])
  {
    ...
    if ([v25 isAdministrator] & 1) != 0 || (-[objc_class allModificationRequests:areAddingAccessCode:](-[HMDAccessCodeManager utilities](selfCopy, "utilities"), "allModificationRequests:areAddingAccessCode:", v18, v30))
    {
      ...
      v43[1] = 3221225472;
      v43[2] = __72__HMDAccessCodeManager__submitAccessCodeModificationRequestsForMessage___block_invoke;
      v43[3] = &unk_279733F88;
      v43[4] = selfCopy;
      v44 = flow;
      v45 = v15;
      v34 = [v33 addCompletionBlock:v43];
    }
    ...
    if ([context2 primaryResidentSupportsAccessCodes])
    {
      ...
      if (residentCommunicationHandlerPreferredDevice)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          v35 = 2112;
          v36 = uUID;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Redispatching message to resident.", &v33, 0x16u);
        }
...
LABEL_16:
    ...
    if ((isCurrentDeviceOwnerUser & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        v35 = 2112;
        v36 = uUID2;
        _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] There is no resident available, so nothing can be done.", &v33, 0x16u);
      }
...
- (void)_updateCacheWithModificationResponses:(id)responses flow:(id)flow
{
  ...
  if (responsesCopy)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = uUID2;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@[ChildFlow: %@ Parent: %@] Updating cache with modification responses", &v21, 0x20u);
    }
...
void __71__HMDAccessCodeManager_handleHomeDidDisableCharacteristicNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Pin Codes}] Handling home did disable characteristic notification", &v8, 0x16u);
  }
...
void __70__HMDAccessCodeManager_handleHomeDidEnableCharacteristicNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@ {Feature:Pin Codes}] Handling home did enable characteristic notification", &v8, 0x16u);
  }
...
- (void)handleUserAccessCodeDidChangeMessage:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling UserAccessCodeDidChangeMessage with changeType: %lu", &v17, 0x20u);
  }
...
void __64__HMDAccessCodeManager_handleFetchAccessCodeConstraintsMessage___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v9;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Data never synced to the resident for accessories: %@", &v12, 0x20u);
  }
...
void __58__HMDAccessCodeManager_handleRemoveHomeAccessCodeMessage___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove home access code with error: %@", &v12, 0x20u);
    }
...
void __56__HMDAccessCodeManager_handleSetUserInformationMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to set userInfo: %@, with error: %@", &v13, 0x2Au);
    }
...
- (void)handleUnsubscribeMessage:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = uUID;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling client unsubscribe message", &v30, 0x16u);
  }
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = uUID2;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Responding with no payload after removing client from subscribed clients", &v30, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 2112;
      v37 = transport2;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Subscribing transport was not of expected class %@: %@", &v30, 0x2Au);
    }
...
- (void)handleSubscribeMessage:(id)message
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = uUID;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling client subscribe message", &v30, 0x16u);
  }
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 2112;
      v33 = uUID2;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Responding with no payload after adding client to subscribed clients", &v30, 0x16u);
    }
...
void __83__HMDAccessCodeManager_fetchAccessCodeForIdentifier_accessoryUUID_flow_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetched access code for access code identifier: %@", &v19, 0x20u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      v25 = 2112;
      v26 = v6;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to fetch access code for access code identifier: %@ with error: %@", &v19, 0x2Au);
    }
