...
- (id)dataSourceDataProviders
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get host accessories due to no data source", &v11, 0xCu);
    }
...
uint64_t __61__HMDUnifiedLanguageValueListSettingDataProvider_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v2_35590;
  logCategory__hmf_once_v2_35590 = v0;
