  ...
  if ([(HMFOperation *)self isExecuting]&& [(NSString *)self->_messageIdentifier isEqualToString:identifierCopy])
  {
    ...
    if (successCopy)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v23;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Successfully sent message", &v28, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v30 = 2112;
        v31 = errorCopy;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send message with error: %@", &v28, 0x16u);
      }
...
- (void)main
{
  ...
  v51 = 0;
  v12 = [HMDRemoteMessageSerialization dictionaryForMessage:v11 error:&v51];
  v13 = v51;
  v14 = v13;
  if (v12)
  {
...
uint64_t __41__HMDIDSSendMessageOperation_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_44011;
  logCategory__hmf_once_v9_44011 = v0;
