...
- (void)triggerThrottledMicroLocationLocalizationScanWithMetadata:(id)metadata triggerType:(unint64_t)type
{
  ...
  if (type >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v12;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Localization Scan", &v33, 0x16u);
    }
  ...
  else
  {
    ...
    if (v20 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = off_279735028[type];
        v33 = 138543618;
        v34 = v24;
        v35 = 2112;
        v36 = v25;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation localization scan for event: %@, throttling in effect", &v33, 0x16u);
      }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = off_279735028[type];
    v33 = 138543618;
    v34 = v30;
    v35 = 2112;
    v36 = v31;
    _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation localization scan for event: %@", &v33, 0x16u);
  }
...
- (void)triggerThrottledMicroLocationRecordingScanWithMetadata:(id)metadata triggerType:(unint64_t)type
{
  ...
  if (type >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 2112;
      v36 = v12;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Recording Scan", &v33, 0x16u);
    }
  ...
  else
  {
    ...
    if (v20 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v35 = 2112;
        v36 = v25;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation recording scan for event type: %@, throttling in effect", &v33, 0x16u);
      }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    v35 = 2112;
    v36 = v31;
    _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation recording scan for event: %@", &v33, 0x16u);
  }
...
- (HMDMicroLocationManager)initWithLocationManager:(id)manager dateFactory:(id)factory
{
  ...
  if (v9)
  {
    ...
    v11 = [MEMORY[0x277CBEB18] na_arrayByRepeatingWithCount:3 generatorBlock:&__block_literal_global_188863];
    lastRecordingScanTimes = v10->_lastRecordingScanTimes;
    v10->_lastRecordingScanTimes = v11;

    v13 = [MEMORY[0x277CBEB18] na_arrayByRepeatingWithCount:3 generatorBlock:&__block_literal_global_4_188864];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_188876 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t8_188876, &__block_literal_global_22_188877);
  }

  v3 = logCategory__hmf_once_v9_188878;
...
uint64_t __38__HMDMicroLocationManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_188878;
  logCategory__hmf_once_v9_188878 = v0;
