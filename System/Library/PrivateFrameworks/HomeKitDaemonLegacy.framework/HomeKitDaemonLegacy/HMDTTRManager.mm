...
+ (HMMRadarRequestFilter)defaultFilter
{
  ...
  swift_allocObject();
  v3 = sub_253CD06E8();
  v4 = sub_25320727C(sharedPreferences, v3, sub_253207278, 0);
...
void __125__HMDTTRManager_initiateRadarWithTitle_componentName_componentVersion_componentID_displayReason_attachments_isUserInitiated___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error trying to create radar draft: %@", &v8, 0x16u);
    }
...
LABEL_11:
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEFAULT, v11, &v15, 0xCu);
...
void __30__HMDTTRManager_sharedManager__block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (isInternalBuild())
  {
    ...
    {
      v3 = [HMDTTRManager alloc];
      v4 = +[HMDUIDialogPresenter sharedUIDialogPresenter];
      v5 = [*(a1 + 32) defaultFilter];
      v6 = [(HMDTTRManager *)v3 initWithDialog:v4 requestFilter:v5];
      v7 = sharedManager_defaultManager;
      sharedManager_defaultManager = v6;

      v8 = +[HMDMessageDispatcher defaultDispatcher];
      v9 = sharedManager_defaultManager;
      v10 = [HMDXPCMessagePolicy policyWithEntitlements:5];
      v16[0] = v10;
      v11 = [MEMORY[0x277CBEA60] arrayWithObjects:v16 count:1];
      [v8 registerForMessage:@"presentTTRDialog" receiver:v9 policies:v11 selector:sel_handlePresentTTRDialog_];

      v12 = sharedManager_defaultManager;
      v13 = [HMDXPCMessagePolicy policyWithEntitlements:5];
      v15 = v13;
      v14 = [MEMORY[0x277CBEA60] arrayWithObjects:&v15 count:1];
      [v8 registerForMessage:@"resetLastTTRTime" receiver:v12 policies:v14 selector:sel_handleResetLastTTRTime_];
    }
  }
}
