...
void __70__HMDHH2FrameworkSwitchDefaultDataSource_initiateDaemonRelaunchToHH2___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (v7)
    {
      ...
      v11 = 138543362;
      v12 = v8;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@We are in the right world, do not relaunch.", &v11, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@See you on the other side - restarting...", &v11, 0xCu);
    }
...
- (id)controller:(id)controller cloudDatabaseWithContainerID:(id)d
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get default local database", &v17, 0xCu);
    }
