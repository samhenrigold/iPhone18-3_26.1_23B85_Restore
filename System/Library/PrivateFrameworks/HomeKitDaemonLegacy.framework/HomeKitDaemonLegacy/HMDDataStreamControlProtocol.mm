...
void __64__HMDDataStreamControlProtocol__sendVersionRequestOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send version control message (%@)", &v8, 0x16u);
    }
...
void __62__HMDDataStreamControlProtocol__sendHelloMessageOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v10 = 2112;
      v11 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send hello control message (%@)", &v8, 0x16u);
    }
...
- (void)dataStream:(id)stream didReceiveResponse:(id)response header:(id)header payload:(id)payload
{
  ...
  if ([(HMDDataStreamControlProtocol *)self isExpectedHelloControlMessage:responseCopy header:headerCopy])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message reply received", &v29, 0xCu);
    }
  ...
  else
  {
    ...
    if (v19)
    {
      if (v23)
      {
        ...
        v31 = 2112;
        v32 = payloadCopy;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Received Peer Request Version Response %@", &v29, 0x16u);
      }
    ...
    else
    {
      if (v23)
      {
        ...
        v29 = 138543362;
        v30 = v28;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Expected hello reply or Version but got something else", &v29, 0xCu);
      }
...
- (void)dataStream:(id)stream didReceiveRequest:(id)request header:(id)header payload:(id)payload
{
  ...
  if ([requestCopy isEqual:@"hello"])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message received", &v29, 0xCu);
    }

    objc_autoreleasePoolPop(v14);
    [streamCopy sendResponseForRequestHeader:headerCopy payload:MEMORY[0x277CBEC10] status:0 completion:&__block_literal_global_191028];
  }
  ...
  else
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v23;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Version control message received", &v29, 0xCu);
      }
      ...
      [streamCopy sendResponseForRequestHeader:headerCopy payload:v27 status:0 completion:&__block_literal_global_3_191030];
    }
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 2112;
        v32 = requestCopy;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Control Protocol received unexpected request '%@'", &v29, 0x16u);
      }
...
- (void)dataStreamDidOpen:(id)open
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending hello control message", &v9, 0xCu);
  }
...
- (HMDDataStreamControlProtocol)initWithLogIdentifier:(id)identifier
{
  ...
  if (v5)
  {
    ...
    *&v6->_helloMessageResponseReceived = 0;
    ...
    v6->_peerDataStreamProtocolVersion = &unk_28662BF58;
  }
