...
void __69__HMDUnassociatedAirPlayAccessory_associateToHome_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with configuration: %@", &v11, 0x16u);
  }
      ...
      if (v35 < 2)
      {
        ...
        if (v55)
        {
          ...
          if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v69 = v59;
            _os_log_impl(&dword_2531F8000, v58, OS_LOG_TYPE_INFO, "%{public}@Successfully associated", buf, 0xCu);
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138543362;
          v69 = v63;
          _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to set media password", buf, 0xCu);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138543618;
          ...
          v70 = 2112;
          v71 = v40;
          _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_DEFAULT, "%{public}@Unexpected peers found: %@", buf, 0x16u);
...
LABEL_42:
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v69 = v52;
      _os_log_impl(&dword_2531F8000, v51, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to add ourselves as a peer", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v69 = v46;
      _os_log_impl(&dword_2531F8000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid or missing pairing identity", buf, 0xCu);
...
uint64_t __46__HMDUnassociatedAirPlayAccessory_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v21_36720;
  logCategory__hmf_once_v21_36720 = v0;
