...
- (void)_handleSiriIntentRequest:(id)request
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v36 = 2112;
        v37 = v7;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive control home intent from the message payload data: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v35 = v23;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Error - Did not get the intent", buf, 0xCu);
    }
...
- (void)_handleSiriCommand:(id)command
{
  ...
  v11 = [MEMORY[0x277CCAAC8] deserializeObjectWithData:v48 allowedClass:objc_opt_class() frameworkClasses:&unk_286627190];
...
uint64_t __34__HMDClientConnection_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v13_124151;
  logCategory__hmf_once_v13_124151 = v0;
