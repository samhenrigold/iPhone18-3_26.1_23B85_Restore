  ...
  if ([*(a1 + 32) shouldSubmitEvent:*(a1 + 40)])
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v36 = 2112;
      v37 = v19;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Submitting event: %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v36 = 2112;
      v37 = v8;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Submitting signature: %@", buf, 0x16u);
    }
    ...
    v31[1] = 3221225472;
    v31[2] = __49__HMDDiagnosticReporterLogObserver_observeEvent___block_invoke_76;
    v31[3] = &unk_2797357F8;
    ...
    if ((v25 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543618;
        ...
        v36 = 2112;
        v37 = v30;
        _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to submit event: %@", buf, 0x16u);
      }
...
void __49__HMDDiagnosticReporterLogObserver_observeEvent___block_invoke_76(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitted event with response: %@", &v9, 0x16u);
  }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", &v9, 0xCu);
  }
...
uint64_t __47__HMDDiagnosticReporterLogObserver_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v9_192472;
  logCategory__hmf_once_v9_192472 = v0;
