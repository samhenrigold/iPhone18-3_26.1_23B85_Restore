...
- (void)downloadLogWithController:(id)controller nodeId:(id)id type:(int64_t)type timeout:(double)timeout completion:(id)completion
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v47 = 2112;
    v48 = v21;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Download log via controller %@, nodeId %@, logType %@, timeout %@", &v39, 0x34u);
  }
  ...
  if (v24)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v41 = 2112;
        v42 = v25;
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using invalid home UUID: %@", &v39, 0x16u);
      }
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
  {
    ...
    v44 = v37;
    v38 = v37;
    _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_ERROR, "%{public}@Download log called with controller of unexpected class: %@ (%@)", &v39, 0x20u);
  }
...
- (void)readAttributeCacheWithController:(id)controller nodeId:(unint64_t)id endpointId:(id)endpointId clusterId:(id)clusterId attributeId:(id)attributeId completion:(id)completion
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2048;
    idCopy = id;
    _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not reading attribute cache with controller: %@, nodeID: 0x%llx: Unsupported", &v25, 0x20u);
  }
...
- (void)subscribeWithController:(id)controller nodeId:(unint64_t)id minInterval:(id)interval maxInterval:(id)maxInterval params:(id)params shouldCache:(BOOL)cache completion:(id)completion
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2048;
    idCopy = id;
    _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not subscribing with controller: %@, nodeID: 0x%llx: Unsupported", &v25, 0x20u);
  }
...
- (void)stopReportsWithController:(id)controller nodeId:(unint64_t)id completion:(id)completion
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 2048;
    idCopy = id;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Stop reports with controller %@, nodeId 0x%llx", &v15, 0x20u);
  }
...
- (void)subscribeAttributeWithController:(id)controller nodeId:(unint64_t)id endpointId:(id)endpointId clusterId:(id)clusterId attributeId:(id)attributeId minInterval:(id)interval maxInterval:(id)maxInterval params:(id)self0 establishedHandler:(id)self1
{
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138545410;
    ...
    v52 = 2112;
    v53 = paramsCopy;
    _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Subscribing attribute via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, attributeId %@ minInterval %@, maxInterval %@, params %@", buf, 0x5Cu);
  }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v37 = v30;
    _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@Subscribing attribute is not supported yet", buf, 0xCu);
  }
...
- (void)invokeCommandWithController:(id)controller nodeId:(unint64_t)id endpointId:(id)endpointId clusterId:(id)clusterId commandId:(id)commandId fields:(id)fields timedInvokeTimeout:(id)timeout completion:(id)self0
{
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138545154;
    ...
    v80 = 2112;
    v81 = timeoutCopy;
    _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Invoking command via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, commandId %@, fields %@, timedInvokeTimeout %@", buf, 0x52u);
  }
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        idCopy = v44;
        v45 = v44;
        _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_ERROR, "%{public}@CHIP invoke command called with controller of unexpected class: %@ (%@)", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v68 = 2112;
            v69 = v31;
            _os_log_impl(&dword_2531F8000, v55, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using unknown home UUID: %@", buf, 0x16u);
          }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v52 = 22;
LABEL_26:
        _os_log_impl(&dword_2531F8000, v51, OS_LOG_TYPE_ERROR, v50, buf, v52);
...
LABEL_38:
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v67 = v39;
    _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Invoke-command operation by backgrounded client not allowed", buf, 0xCu);
  }
...
- (void)writeAttributeWithController:(id)controller nodeId:(unint64_t)id endpointId:(id)endpointId clusterId:(id)clusterId attributeId:(id)attributeId value:(id)value timedWriteTimeout:(id)timeout completion:(id)self0
{
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138545154;
    ...
    v75 = 2112;
    v76 = timeoutCopy;
    _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Writing attribute via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, attributeId %@, value %@, timedWriteTimeout %@", buf, 0x52u);
  }
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        idCopy = v42;
        v43 = v42;
        _os_log_impl(&dword_2531F8000, v40, OS_LOG_TYPE_ERROR, "%{public}@CHIP write attribute called with controller of unexpected class: %@ (%@)", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v63 = 2112;
            v64 = v31;
            _os_log_impl(&dword_2531F8000, v53, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using unknown home UUID: %@", buf, 0x16u);
          }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v50 = 22;
LABEL_25:
        _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_ERROR, v48, buf, v50);
...
LABEL_28:
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v62 = v37;
    _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_ERROR, "%{public}@Write operation by backgrounded client not allowed", buf, 0xCu);
  }
...
- (void)readAttributeWithController:(id)controller nodeId:(unint64_t)id endpointId:(id)endpointId clusterId:(id)clusterId attributeId:(id)attributeId params:(id)params completion:(id)completion
{
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138544898;
    ...
    v73 = 2112;
    v74 = paramsCopy;
    _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Reading attribute via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, attributeId %@, params %@", buf, 0x48u);
  }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v63 = 2112;
          v64 = v31;
          _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_ERROR, "%{public}@CHIP Read attribute called with invalid home UUID string: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        idCopy = v45;
        v46 = v45;
        _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_ERROR, "%{public}@CHIP Read attribute called with controller of unexpected class: %@ (%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v62 = v40;
      _os_log_impl(&dword_2531F8000, v39, OS_LOG_TYPE_ERROR, "%{public}@Read operation by backgrounded client not allowed", buf, 0xCu);
    }
...
- (void)getAnyDeviceControllerWithCompletion:(id)completion
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v52 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Retrieving any shared remote controller", buf, 0xCu);
  }
...
LABEL_18:
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v53 = 2112;
        v54 = v15;
        _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, "%{public}@Retrieved shared remote controller: %@", buf, 0x16u);
      }
    ...
    if (uuid)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v53 = 2112;
        v54 = uuid;
        _os_log_impl(&dword_2531F8000, v37, OS_LOG_TYPE_INFO, "%{public}@Retrieved shared remote controller with no paired CHIP accessory: %@", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v52 = v34;
    _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve any remote controller", buf, 0xCu);
  }
...
- (BOOL)allowsOperation
{
  ...
  if (isForegrounded)
  {
    if (v8)
    {
      ...
      v13 = 138543362;
      v14 = v9;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Client foregrounded", &v13, 0xCu);
    }
  ...
  else
  {
    if (v8)
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Client is not foregrounded: entitlement %@", &v13, 0x16u);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v42 = 2048;
    idCopy2 = id;
    _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve remote controller with fabric Id %llu", buf, 0x16u);
  }
        ...
        for (i = 0; i != v11; ++i)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
          {
            ...
            *buf = 138543618;
            ...
            v49 = 2112;
            v50 = v24;
            _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Fetched CHIP pairing with fabric Id: %@", buf, 0x16u);
          ...
          if (v28)
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543874;
              ...
              v51 = 2112;
              v52 = v34;
              _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_INFO, "%{public}@Retrieved shared remote controller with fabric Id %llu: %@", buf, 0x20u);
            }
    ...
    if ((v9 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v24 = 2112;
        v25 = dCopy;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Registering report handler with home with UUID: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v24 = 2112;
      v25 = dCopy;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not register report handler using unknown home UUID: %@", buf, 0x16u);
    }
...
void __69__HMDCHIPXPCClientConnection__registerReportHandlerWithHomeWithUUID___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v5;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Dispatching report to client using nodeId %tu, reports %@", &v13, 0x20u);
  }
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Deregistering report handlers from home: %@", buf, 0x16u);
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t44, &__block_literal_global_56632);
  }
