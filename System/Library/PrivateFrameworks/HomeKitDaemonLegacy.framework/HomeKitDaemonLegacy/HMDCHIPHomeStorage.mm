...
LABEL_7:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v70 = 2112;
    v71 = chipFabricID2;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating storage fabric ID from %@ to %@", &v66, 0x20u);
  }
...
LABEL_8:
  ...
  if ([setProperties2 containsObject:@"chipLastNodeID"])
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v70 = 2112;
      v71 = chipLastNodeID2;
      _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating storage last node ID from %@ to %@", &v66, 0x20u);
    }
...
LABEL_14:
  ...
  if ([setProperties3 containsObject:@"chipRootCertificate"])
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating storage root certificate from %@ to %@", &v66, 0x20u);
    }
...
LABEL_20:
  ...
  if ([setProperties4 containsObject:@"chipOperationalCertificate"])
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating storage operational certificate from %@ to %@", &v66, 0x20u);
    }
...
LABEL_26:
  ...
  if ([setProperties5 containsObject:@"chipIntermediateCertificate"])
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v53, OS_LOG_TYPE_INFO, "%{public}@Updating storage intermediate certificate from %@ to %@", &v66, 0x20u);
    }
...
LABEL_37:
  ...
  if ((v60 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
    {
      ...
      v66 = 138543362;
      v67 = v64;
      _os_log_impl(&dword_2531F8000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating storage key-value store", &v66, 0xCu);
    }
...
uint64_t __33__HMDCHIPHomeStorage_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v8_10128;
  logCategory__hmf_once_v8_10128 = v0;
