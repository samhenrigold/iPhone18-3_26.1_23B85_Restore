...
- (id)getLastProgressStateForAccessory:(id)accessory
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Final pairing progress state map before metric submission for identifier %{public}@ - %{public}@", &v14, 0x20u);
    }
...
LABEL_16:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Updated Pairing UI state: %lu, recoveryType: %lu on progress: %@", &v13, 0x2Au);
  }
...
- (void)updatePairingProgressState:(id)state
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempting to update an uninitialized progress state map for %@", &v16, 0x16u);
    }
...
- (void)_handlePairingStateProgressNotification:(id)notification
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 2112;
    v14 = name;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Received accessory pairing progress notification %@", &v11, 0x16u);
  }
...
- (void)incrementRetryCount:(id)count
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = countCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Incrementing retry count for identifier %@", &v13, 0x16u);
  }
...
LABEL_6:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Updated previous recoveryType to: %lu", &v11, 0x16u);
  }
...
- (void)fillUnknownErrorIfMissingErrorForPairingEvent:(id)event
{
  ...
  if (matterAccessoryPairingStep != 27 && !error)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Filling unknown error before submission because pairing event is missing error", &v12, 0xCu);
    }
  ...
  if (error || matterAccessoryPairingStep == 27)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = error2;
      _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@Received update to pairing event when metric is completed already %@ %@", buf, 0x20u);
    }
  ...
  if (v137)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2048;
      v153 = v137;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_INFO, "%{public}@Updating mtr metrics %p -> %p", buf, 0x20u);
    }
  ...
  if (!v130)
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v54;
      _os_log_impl(&dword_2531F8000, v51, OS_LOG_TYPE_INFO, "%{public}@Updating step %@ -> %@", buf, 0x20u);
    }
  ...
  if (!v129)
  {
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v59;
      _os_log_impl(&dword_2531F8000, v56, OS_LOG_TYPE_INFO, "%{public}@Updating matter accessory discovered %@ -> %@", buf, 0x20u);
    }
  ...
  if (v136)
  {
    ...
    if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v136;
      _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_INFO, "%{public}@Updating Matter vendorID %@ -> %@", buf, 0x20u);
    }
  ...
  if (v135)
  {
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v135;
      _os_log_impl(&dword_2531F8000, v67, OS_LOG_TYPE_INFO, "%{public}@Updating Matter productID %@ -> %@", buf, 0x20u);
    }
  ...
  if (v134)
  {
    ...
    if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v134;
      _os_log_impl(&dword_2531F8000, v72, OS_LOG_TYPE_INFO, "%{public}@Updating Matter device type %@ -> %@", buf, 0x20u);
    }
  ...
  if (contexta)
  {
    ...
    if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = contexta;
      _os_log_impl(&dword_2531F8000, v77, OS_LOG_TYPE_INFO, "%{public}@Updating supported link layer types %@ -> %@", buf, 0x20u);
    }
    ...
    if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v84;
      _os_log_impl(&dword_2531F8000, v81, OS_LOG_TYPE_INFO, "%{public}@Updating isThreadAccessory %@ -> %@", buf, 0x20u);
    }
  ...
  if (v133)
  {
    ...
    if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v133;
      _os_log_impl(&dword_2531F8000, v87, OS_LOG_TYPE_INFO, "%{public}@Updating Matter Thread capabilities %@ -> %@", buf, 0x20u);
    }
  ...
  if (v132)
  {
    ...
    if (os_log_type_enabled(v91, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v152 = 2112;
      v153 = v94;
      _os_log_impl(&dword_2531F8000, v91, OS_LOG_TYPE_INFO, "%{public}@Updating isWEDAccessory %@ -> %@", buf, 0x20u);
      if (wedAccessory)
      {
      }
    }
  ...
  if (v131)
  {
    ...
    if (v95)
    {
      ...
      if (os_log_type_enabled(v98, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v149 = v99;
        _os_log_impl(&dword_2531F8000, v98, OS_LOG_TYPE_INFO, "%{public}@Updating unauthenticated Matter accessory prompt start time", buf, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v100, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v149 = v101;
        _os_log_impl(&dword_2531F8000, v100, OS_LOG_TYPE_INFO, "%{public}@Updating unauthenticated Matter accessory prompt duration", buf, 0xCu);
      }
  ...
  if (v143)
  {
    ...
    if (!v128)
    {
      ...
      if (os_log_type_enabled(v106, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v149 = v107;
        _os_log_impl(&dword_2531F8000, v106, OS_LOG_TYPE_ERROR, "%{public}@Received pairing error without source error domain", buf, 0xCu);
      }
    ...
    if (os_log_type_enabled(v111, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544386;
      ...
      v156 = 2112;
      v157 = v128;
      _os_log_impl(&dword_2531F8000, v111, OS_LOG_TYPE_INFO, "%{public}@Updating error %@ -> %@, sourceErrorDomain %@ -> %@", buf, 0x34u);
    }
  ...
  if (v116)
  {
    ...
    if (os_log_type_enabled(v119, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v150 = 2112;
      v151 = eventCopy;
      _os_log_impl(&dword_2531F8000, v119, OS_LOG_TYPE_INFO, "%{public}@Submitting Event %@", buf, 0x16u);
    }
...
- (void)configureWithPairingEvent:(id)event workQueue:(id)queue logEventSubmitter:(id)submitter
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring with workQueue %@ logEventSubmitter %@, from workQueue %@ logEventSubmitter %@", &v17, 0x34u);
  }
