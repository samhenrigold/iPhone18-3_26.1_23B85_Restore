                        ...
                        if (v85)
                        {
                          ...
                          if (integerValue >= 3)
                          {
                            ...
                            if (os_log_type_enabled(v89, OS_LOG_TYPE_DEFAULT))
                            {
                              ...
                              *buf = 138543362;
                              v229 = v90;
                              _os_log_impl(&dword_2531F8000, v89, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to log event metadata to biome, unknown playback state not eligible for donation", buf, 0xCu);
                            }
                          ...
                          v208 = v51;
                          v211 = type;
                          v150 = [MEMORY[0x277CCABB0] numberWithInteger:qword_253D4C198[integerValue]];
...
LABEL_103:
                          _os_log_impl(&dword_2531F8000, v148, OS_LOG_TYPE_DEFAULT, v149, buf, 0xCu);
...
LABEL_104:
                      ...
                      if (os_log_type_enabled(v164, OS_LOG_TYPE_DEFAULT))
                      {
                        ...
                        *buf = 138543362;
                        v229 = v166;
                        _os_log_impl(&dword_2531F8000, v164, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to log event metadata to biome, unknown mute state not eligible for donation", buf, 0xCu);
...
LABEL_105:
                    ...
                    else
                    {
                      ...
                      if (os_log_type_enabled(v128, OS_LOG_TYPE_DEFAULT))
                      {
                        ...
                        *buf = 138543362;
                        v229 = v131;
                        _os_log_impl(&dword_2531F8000, v128, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to log event metadata to biome, smart speaker event is missing media profile", buf, 0xCu);
                      ...
                      if (!v105)
                      {
                        ...
                        if (os_log_type_enabled(v158, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *buf = 138544386;
                          ...
                          v237 = v103;
                          v161 = v160;
                          _os_log_impl(&dword_2531F8000, v158, OS_LOG_TYPE_INFO, "%{public}@Unable to log event metadata to biome, unknown write value type (%@) for characteristic: %@, Service: %@, written value: %@", buf, 0x34u);
                        }
...
LABEL_108:
            ...
            if (os_log_type_enabled(v73, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543362;
              v229 = v75;
              _os_log_impl(&dword_2531F8000, v73, OS_LOG_TYPE_ERROR, "%{public}@HAP event ineligible for donation because data source is nil", buf, 0xCu);
...
LABEL_59:
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_DEBUG))
          {
            ...
            *buf = 138543874;
            ...
            v232 = 2112;
            v233 = v93;
            _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_DEBUG, "%{public}@Unable to log event metadata to biome, not eligible for donation. Characteristic: %@, Service: %@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543874;
          ...
          v232 = 2112;
          v233 = v69;
          _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no characteristic type for characteristic (%@) at index: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543874;
          ...
          v232 = 2112;
          v233 = v65;
          _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no service type for characteristic (%@) at index: %@", buf, 0x20u);
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v125 = objc_msgSend_copy(dictionary);
...
- (void)_setBtLoad
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEBUG, "%{public}@RW BT Load: %d AudioTsk: %d NonAudioTsk: %d", &v12, 0x1Eu);
  }
    ...
    if ([(HMDCharacteristicReadWriteLogEvent *)self isLocal]|| ([(HMMLogEvent *)self error], v4 = objc_claimAutoreleasedReturnValue(), v4, v4))
    {
      if ([(HMDCharacteristicReadWriteLogEvent *)self cellularDataConnectionState]== 1 && [(HMDCharacteristicReadWriteLogEvent *)self ethernetConnectionState]== 1 && ([(HMDCharacteristicReadWriteLogEvent *)self wifiConnectionState]== 1 || [(HMDCharacteristicReadWriteLogEvent *)self wifiConnectionState]== 2 || [(HMDCharacteristicReadWriteLogEvent *)self wifiConnectionState]== 5))
      {
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
        {
          ...
          v21 = 138543362;
          v22 = v8;
          _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@HomeHub-ResidentFirstError: Current device has no cellular or wifi data connectivity", &v21, 0xCu);
        }
      ...
      else if ([(HMDCharacteristicReadWriteLogEvent *)self isNetworkAvailable])
      {
        if ([(HMDCharacteristicReadWriteLogEvent *)self isRemoteAccessAllowed])
        {
          if ([(HMDCharacteristicReadWriteLogEvent *)self isResidentAvailable])
          {
            if ([(HMDCharacteristicReadWriteLogEvent *)self isPrimaryResidentAvailable])
            {
              ...
              if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
              {
                ...
                v21 = 138543362;
                v22 = v11;
                _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@HomeHub-ResidentFirstError: Primary resident is unreachable", &v21, 0xCu);
              }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
              {
                ...
                v21 = 138543362;
                v22 = v19;
                _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@HomeHub-ResidentFirstError: No primary resident in home", &v21, 0xCu);
              }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
            {
              ...
              v21 = 138543362;
              v22 = v17;
              _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@HomeHub-ResidentFirstError: No resident in this home", &v21, 0xCu);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
          {
            ...
            v21 = 138543362;
            v22 = v15;
            _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@HomeHub-ResidentFirstError: Current user is not allowed remote access", &v21, 0xCu);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
        {
          ...
          v21 = 138543362;
          v22 = v13;
          _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@HomeHub-ResidentFirstError: Current device has no network connectivity", &v21, 0xCu);
        }
...
- (void)_populateTHSensorMetricsForAccessory:(id)accessory accessoryServer:(id)server characteristicsInRequest:(id)request home:(id)home
{
  ...
  if (v11)
  {
    ...
    v14 = [residentDevices countByEnumeratingWithState:&v24 objects:v28 count:16];
    if (v14)
    {
      v15 = v14;
      v16 = *v25;
      do
      {
        ...
        while (v15 != v17);
        v15 = [residentDevices countByEnumeratingWithState:&v24 objects:v28 count:16];
      }
...
- (HMDCharacteristicReadWriteLogEvent)initWithStartTime:(double)time characteristics:(id)characteristics hmdAccessory:(id)accessory hapAccessory:(id)hapAccessory source:(unint64_t)source biomeSource:(unint64_t)biomeSource isWriteOperation:(BOOL)operation isTimedWrite:(BOOL)self0 isLocal:(BOOL)self1 transactionId:(id)self2 isCached:(BOOL)self3 bundleId:(id)self4 userUUID:(id)self5 writtenValues:(id)self6 readWriteLogEventManager:(id)self7
{
  ...
  uuid = [home uuid];
  v243.receiver = self;
  v243.super_class = HMDCharacteristicReadWriteLogEvent;
  v27 = home;
  v28 = [(HMMDatedHomeLogEvent *)&v243 initWithStartTime:uuid homeUUID:time];
  ...
  v27 = v217;
  threadNetworkID = [v217 threadNetworkID];
  ...
  spiClientIdentifier3 = [v217 spiClientIdentifier];
  ...
  currentUser = [v217 currentUser];
  v28->_isRemoteAccessAllowed = [currentUser isRemoteAccessAllowed];

  v28->_isRemotelyReachable = [v225 isRemotelyReachable];
  enabledResidents = [v217 enabledResidents];
  v28->_hasEnabledResidents = [enabledResidents count] != 0;

  v28->_isResidentFirstEnabled = [v217 isResidentFirstAccessoryCommunicationEnabled];
  v28->_isDeviceAtHome = [v217 homeLocation] == 1;
  ...
  if (v217)
  {
    ...
    v102 = [v101 countByEnumeratingWithState:&v246 objects:buf count:16];
    if (v102)
    {
      v103 = v102;
      v104 = *v247;
      do
      {
        for (i = 0; i != v103; ++i)
        {
          ...
          if (service)
          {
            ...
            if (!v109)
            {
              ...
              v244[1] = 3221225472;
              v244[2] = __90__HMDCharacteristicReadWriteLogEvent_serviceUUIDToServiceGroupsForCharacteristics_inHome___block_invoke;
              v244[3] = &unk_27972E300;
              v111 = v107;
              v245 = v111;
              v112 = [serviceGroups na_firstObjectPassingTest:v244];
        ...
        v103 = [v101 countByEnumeratingWithState:&v246 objects:buf count:16];
      }

      while (v103);
    }

    v114 = objc_msgSend_copy(dictionary);
    v27 = v217;
    valuesCopy = v218;
  }
  ...
  v212 = [v114 na_dictionaryByMappingValues:&__block_literal_global_480];
  v116 = objc_msgSend_copy(v212);
  serviceUUIDToServiceGroupName = v28->_serviceUUIDToServiceGroupName;
  v28->_serviceUUIDToServiceGroupName = v116;

  v118 = objc_msgSend_copy(v115);
  ...
  accessoryProfiles = [v225 accessoryProfiles];
  ...
  v134 = objc_msgSend_copy(valuesCopy);
  writtenValues = v28->_writtenValues;
  v28->_writtenValues = v134;

  v136 = [v220 findServiceWithServiceType:@"00000701-0000-1000-8000-0026BB765291"];
  ...
  v137 = [v220 findCharacteristicType:@"00000702-0000-1000-8000-0026BB765291" forServiceType:@"00000701-0000-1000-8000-0026BB765291"];
  value = [v137 value];
  objc_opt_class();
  isKindOfClass = objc_opt_isKindOfClass();
  if (isKindOfClass)
  ...
  if (v168)
  {
    ...
    v175 = [residentDevices3 countByEnumeratingWithState:&v239 objects:v251 count:16];
    if (v175)
    {
      v176 = v175;
      v177 = v114;
      ...
      do
      {
        ...
        v176 = [residentDevices3 countByEnumeratingWithState:&v239 objects:v251 count:16];
      }
  ...
  v237[1] = 3221225472;
  v237[2] = __235__HMDCharacteristicReadWriteLogEvent_initWithStartTime_characteristics_hmdAccessory_hapAccessory_source_biomeSource_isWriteOperation_isTimedWrite_isLocal_transactionId_isCached_bundleId_userUUID_writtenValues_readWriteLogEventManager___block_invoke_7;
  v237[3] = &unk_279734F10;
  v186 = primaryResidentDevice2;
  v238 = v186;
  v203 = appleMediaAccessories;
  v187 = [appleMediaAccessories na_firstObjectPassingTest:v237];
  if (!v187)
  {
    goto LABEL_86;
  }
  ...
  v201 = v186;
  v202 = v115;
  v227 = [v27 mediaSystemForAppleMediaAccessory:v187];
  v233 = 0u;
  v234 = 0u;
  v235 = 0u;
  v236 = 0u;
  objb = [v27 appleMediaAccessories];
  v188 = [objb countByEnumeratingWithState:&v233 objects:v250 count:16];
  if (!v188)
  {
    goto LABEL_83;
  }
  ...
  do
  {
    for (k = 0; k != v189; ++k)
    {
      ...
      audioDestinationControllerData = [*(*(&v233 + 1) + 8 * k) audioDestinationControllerData];
      ...
      {
        audioDestination2 = [v227 audioDestination];
...
LABEL_81:
    ...
    v189 = [objb countByEnumeratingWithState:&v233 objects:v250 count:16];
  }
...
LABEL_86:
  ...
  v114 = v204;
LABEL_87:
  if (v28->_isCurrentDevicePrimaryResident && [(HMDCharacteristicReadWriteLogEvent *)v28 _isRequestForTHSensorOnAppleMediaAccessory:v225 characteristicsInRequest:characteristicsCopy])
  {
    [(HMDCharacteristicReadWriteLogEvent *)v28 _populateTHSensorMetricsForAccessory:v225 accessoryServer:v207 characteristicsInRequest:characteristicsCopy home:v27];
