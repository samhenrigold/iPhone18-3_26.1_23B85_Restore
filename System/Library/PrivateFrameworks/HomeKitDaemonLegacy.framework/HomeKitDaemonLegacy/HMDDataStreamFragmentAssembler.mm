...
- (BOOL)addFragmentChunk:(id)chunk error:(id *)error
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    v43 = 2112;
    v44 = chunkCopy;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Adding chunk: %@", &v41, 0x16u);
  }
  ...
  if (assembledFragment)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = chunkCopy;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Asked to add fragment chunk %@ but the last data chunk has already been received", &v41, 0x16u);
    }
...
LABEL_18:
  ...
  if (unsignedLongLongValue2 != unsignedLongLongValue + 1)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, "%{public}@Asked to add fragment chunk %@ with non-sequential sequence number compared to current stream data chunk sequence number %@", &v41, 0x20u);
    }
...
LABEL_23:
  ...
  if (unsignedLongLongValue2 == -1 && ([chunkCopy isLast] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = chunkCopy;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Asked to add non-last fragment chunk with maximum allowed sequence number: %@", &v41, 0x16u);
    }
