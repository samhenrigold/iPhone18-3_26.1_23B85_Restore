...
- (NSDictionary)prettyJSONDictionary
{
  ...
  v23[1] = @"lanRules";
  lanRules = [(HMDNetworkRouterFirewallRuleConfiguration *)self lanRules];
  v19 = [lanRules na_map:&__block_literal_global_51_184296];
...
LABEL_11:
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, v18, &v21, 0x20u);
    }
...
uint64_t __56__HMDNetworkRouterFirewallRuleConfiguration_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v1_184384;
  logCategory__hmf_once_v1_184384 = v0;
