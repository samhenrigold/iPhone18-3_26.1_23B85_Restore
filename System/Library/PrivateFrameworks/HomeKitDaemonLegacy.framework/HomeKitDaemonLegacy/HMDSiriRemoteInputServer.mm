...
- (void)handleCheckInMsg:(id)msg
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Siri checked in", &v9, 0xCu);
  }
...
- (void)sendMsg:(id)msg args:(id)args
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2112;
    v21 = v8;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Sending Siri XPC message to %p: %@", &v16, 0x20u);
  }
...
- (void)sendMsgIfCheckedIn:(id)in args:(id)args
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Cannot send; no XPC client is checked in yet", &v13, 0xCu);
    }
...
- (void)handleMsg:(id)msg
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = msgCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received Siri XPC message to %p: %@", &v19, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2080;
      v22 = string;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unexpected message: '%s'", &v19, 0x16u);
    }
...
LABEL_10:
    ...
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, v10, &v11, 0x16u);
...
- (void)handleServerEvent:(id)event
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = eventCopy;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@Unexpected Siri XPC server event: %@", &v9, 0x16u);
    }
...
- (void)deregisterSiriSession:(id)session
{
  ...
  if (v6)
  {
    if (v10)
    {
      ...
      v17 = 2112;
      v18 = sessionCopy;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Deregistering session %@", &v15, 0x16u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      v17 = 2112;
      v18 = identifier2;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Session deregistration with identifier %@ but was not registered!", &v15, 0x16u);
    }
...
- (BOOL)registerSiriSession:(id)session
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = identifier2;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Session with identifier %@ already exists!", &v16, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = sessionCopy;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Registering session %@", &v16, 0x16u);
    }
