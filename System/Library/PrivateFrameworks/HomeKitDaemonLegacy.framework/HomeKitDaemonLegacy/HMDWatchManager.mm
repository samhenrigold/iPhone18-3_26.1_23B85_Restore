...
- (void)service:(id)service connectedDevicesChanged:(id)changed
{
  ...
  if (service == serviceCopy)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 2112;
      v16 = changedCopy;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Connected devices changed: %@", &v13, 0x16u);
    }
...
uint64_t __30__HMDWatchManager_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v8_153287;
  logCategory__hmf_once_v8_153287 = v0;
