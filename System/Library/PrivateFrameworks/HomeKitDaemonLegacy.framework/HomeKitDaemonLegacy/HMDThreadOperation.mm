...
{
  v2 = [*(a1 + 32) operation];
  v2[2](v2, *(a1 + 40), &__block_literal_global_89510);
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_89521 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t2_89521, &__block_literal_global_4_89522);
  }

  v3 = logCategory__hmf_once_v3_89523;
