...
- (id)processRecipe:(id *)recipe errorDomain:(id)domain
{
  ...
  v16 = [MEMORY[0x277CCABB0] numberWithLong:1];
LABEL_9:
  objc_storeStrong(&location, 0);
  v4 = v16;
  ...
  if (!v90 || ((v88 = -[NSMutableDictionary objectForKey:](selfCopy->_coreDictionary, "objectForKey:", v90), v87 = [location[0] objectForKey:StartingLikeOtherArrayMultiplier], v86 = objc_msgSend(location[0], "objectForKey:", StartingLikeOtherArrayOffset), v88) && v87 && v86 ? (v7 = objc_msgSend(MEMORY[0x277CCABB0], "numberWithLong:", objc_msgSend(v88, "count") * objc_msgSend(v87, "longValue") + objc_msgSend(v86, "longValue")), v8 = v92, v92 = v7, MEMORY[0x277D82BD8](v8), v85 = 0) : (v5 = objc_alloc(MEMORY[0x277CCA9B8]), v50 = objc_msgSend(v5, "initWithDomain:code:userInfo:", v93, 47, 0), v6 = v50, *errorCopy = v50, v97 = 0, v85 = 1), objc_storeStrong(&v86, 0), objc_storeStrong(&v87, 0), objc_storeStrong(&v88, 0), !v85))
  {
    if (!v89 || ((v84 = -[NSMutableDictionary objectForKey:](selfCopy->_coreDictionary, "objectForKey:", v89), v83 = [location[0] objectForKey:EndingLikeOtherArrayMultiplier], v82 = objc_msgSend(location[0], "objectForKey:", EndingLikeOtherArrayOffset), v84) && v83 && v82 ? (v11 = objc_msgSend(MEMORY[0x277CCABB0], "numberWithLong:", objc_msgSend(v84, "count") * objc_msgSend(v83, "longValue") + objc_msgSend(v82, "longValue")), v12 = v91, v91 = v11, MEMORY[0x277D82BD8](v12), v85 = 0) : (v9 = objc_alloc(MEMORY[0x277CCA9B8]), v49 = objc_msgSend(v9, "initWithDomain:code:userInfo:", v93, 146, 0), v10 = v49, *errorCopy = v49, v97 = 0, v85 = 1), objc_storeStrong(&v82, 0), objc_storeStrong(&v83, 0), objc_storeStrong(&v84, 0), !v85))
    {
      ...
      for (i = [v92 intValue]; ; ++i)
      {
        ...
        v79 = [MEMORY[0x277CCABB0] numberWithLong:i];
        for (j = 0; ; ++j)
        {
          v47 = j;
          if (v47 >= [v81 count])
          ...
          if (v46)
          {
            ...
            while (1)
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                v68 = MEMORY[0x277D82BE0](v71);
                memset(v66, 0, sizeof(v66));
                v39 = MEMORY[0x277D82BE0](v75);
                ...
                if (v40)
                {
                  ...
                  while (1)
                  {
                    ...
                    if ([v67 isEqual:v73])
                    {
                      ...
                      [v63 doubleValue];
                      v62 = v19 + v34 * v33;
                      v20 = [MEMORY[0x277CCABB0] numberWithDouble:v62];
                      v21 = v68;
                      v68 = v20;
              ...
              if (objc_opt_isKindOfClass())
              {
                v61 = MEMORY[0x277D82BE0](v71);
                v60 = objc_alloc_init(MEMORY[0x277CBEB38]);
                memset(v58, 0, sizeof(v58));
                v31 = MEMORY[0x277D82BE0](v61);
...
LABEL_66:
      ...
      v97 = [MEMORY[0x277CCABB0] numberWithLong:1];
      v85 = 1;
LABEL_69:
...
- (id)aggregateArray:(id)array error:(id *)error errorDomain:(id)domain
{
  ...
  if (v31 && v30 && v29)
  {
    ...
    if (v27)
    {
      ...
      if ([v29 isEqual:AggregateSum])
      {
        v25 = 0.0;
        for (i = 0; i < [v27 count]; ++i)
        {
          v16 = [v27 objectAtIndex:i];
          [v16 doubleValue];
          v25 = v25 + v9;
          MEMORY[0x277D82BD8](v16);
        }

        v15 = [MEMORY[0x277CCABB0] numberWithDouble:v25];
        [v26 addObject:?];
        MEMORY[0x277D82BD8](v15);
      }

      else if ([v29 isEqual:AggregateAverage])
      {
        v22 = 0.0;
        for (j = 0; j < [v27 count]; ++j)
        {
          v14 = [v27 objectAtIndex:j];
          [v14 doubleValue];
          v22 = v22 + v10;
          MEMORY[0x277D82BD8](v14);
        }
        ...
        v23 = v22 / [v27 count];
        v13 = [MEMORY[0x277CCABB0] numberWithDouble:v23];
        [v26 addObject:?];
...
- (id)checkIfArrayEmptyAndThrowError:(id)error error:(id *)a4 errorDomain:(id)domain
{
  ...
  if (v20)
  {
    ...
    if (v18)
    {
      if ([v18 count])
      {
        v25 = [MEMORY[0x277CCABB0] numberWithLong:1];
      }
...
- (id)downSampleData:(id)data error:(id *)error errorDomain:(id)domain
{
  ...
  *&v109 = [location[0] objectForKey:OtherAffectedVectors];
  if (v109 == 0)
  {
    *(&v109 + 1) = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
    *&v109 = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
LABEL_32:
...
- (id)constantValueMathFunction:(id)function error:(id *)error errorDomain:(id)domain
{
  ...
  v53 = [location[0] objectForKey:Operation];
  if (!v56 || !v55 || !v54 || !v53)
  {
    v5 = objc_alloc(MEMORY[0x277CCA9B8]);
  ...
  [v54 doubleValue];
  if (v7 == 0.0 && (([v53 isEqual:Modulo] & 1) != 0 || (objc_msgSend(v53, "isEqual:", Division) & 1) != 0))
  {
  ...
  for (i = 0; ; ++i)
  {
    ...
    else if ([v53 isEqual:Division])
    {
      [v48 doubleValue];
      v38 = v14;
      [v54 doubleValue];
      v16 = [MEMORY[0x277CCABB0] numberWithDouble:v38 / v15];
      v17 = v47;
      v47 = v16;
      MEMORY[0x277D82BD8](v17);
    }

    else if ([v53 isEqual:Multiplication])
    {
      [v48 doubleValue];
      v37 = v18;
      [v54 doubleValue];
      v20 = [MEMORY[0x277CCABB0] numberWithDouble:v37 * v19];
      v21 = v47;
      v47 = v20;
      MEMORY[0x277D82BD8](v21);
    }

    else if ([v53 isEqual:Addition])
    {
      [v48 doubleValue];
      v36 = v22;
      [v54 doubleValue];
      v24 = [MEMORY[0x277CCABB0] numberWithDouble:v36 + v23];
      v25 = v47;
      v47 = v24;
    ...
    {
      if (([v53 isEqual:Subtraction] & 1) == 0)
      {
      ...
      v35 = v26;
      [v54 doubleValue];
      v28 = [MEMORY[0x277CCABB0] numberWithDouble:v35 - v27];
      v29 = v47;
      v47 = v28;
...
- (id)filterArrayOnNumber:(id)number error:(id *)error errorDomain:(id)domain
{
  ...
  *&v122 = [location[0] objectForKey:OtherAffectedVectors];
  if (v122 == 0)
  {
    *(&v122 + 1) = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
    *&v122 = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
  }
...
- (id)ifStatement:(id)statement error:(id *)error errorDomain:(id)domain
{
  ...
  if (!v108)
  {
    v108 = [MEMORY[0x277CCABB0] numberWithLong:10000];
    MEMORY[0x277D82BD8](0);
  }
...
LABEL_30:
      ...
      if (([v87 isEqual:NAKey] & 1) == 0)
      {
        ...
        {
          [v105 addObject:&unk_285210FC8];
        }

        else if ([v87 isEqual:orKey])
        {
          [v105 addObject:&unk_285210FE0];
        }

        [v106 addObject:v87];
        [v107 addObject:&unk_285210FE0];
        goto LABEL_67;
      }
      ...
      if ([v83 isEqual:HasLengthEqualTo])
      {
        ...
        if (v49 == [v82 intValue])
        {
          objc_storeStrong(&v81, &unk_285210FC8);
        }

        else
        {
          objc_storeStrong(&v81, &unk_285210FE0);
        }
...
LABEL_98:
      ...
      v115 = [MEMORY[0x277CCABB0] numberWithLong:1];
      v104 = 1;
    }
  }
    ...
    else
    {
      ...
      if (v11)
      {
        ...
        while (1)
        {
          ...
          __b[8] = *(__b[1] + 8 * v19);
          v15 = v30;
          v16 = [MEMORY[0x277CCABB0] numberWithLong:v31];
...
- (id)randomizeArray:(id)array error:(id *)error errorDomain:(id)domain
{
  ...
  *&v112 = [location[0] objectForKey:OtherAffectedVectors];
  if (v112 == 0)
  {
    *(&v112 + 1) = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
    *&v112 = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
LABEL_32:
    if (v114 && v113)
    {
      ...
      if (v105)
      {
        ...
        {
          v47 = [MEMORY[0x277CCABB0] numberWithLong:i];
          [v100 addObject:?];
          MEMORY[0x277D82BD8](v47);
        }
...
- (id)requestData:(id)data withUseStubs:(int64_t)stubs error:(id *)error errorDomain:(id)domain
{
  ...
  v8 = objc_alloc(MEMORY[0x277CEE0B0]);
  ...
  if (v126)
  {
    ...
    else
    {
      for (i = 0; i < 3; ++i)
      {
        ...
        if (v125)
        {
          v123 = [v125 objectForKey:*MEMORY[0x277CEE098]];
          v122 = 1;
          v86 = [v123 isEqual:*MEMORY[0x277CEE0A0]];
        }
...
LABEL_119:
    ...
    v121 = [v125 objectForKey:*MEMORY[0x277CEE098]];
    if (([v121 isEqual:*MEMORY[0x277CEE0A0]] & 1) == 0)
    {
      v17 = objc_alloc(MEMORY[0x277CCA9B8]);
...
LABEL_118:
    ...
    v120 = [v125 objectForKey:*MEMORY[0x277CEE090]];
    if (!v120)
    {
      v19 = objc_alloc(MEMORY[0x277CCA9B8]);
...
LABEL_117:
    ...
    v118 = MEMORY[0x277D82BE0](v120);
    v117 = 0;
    memset(__b, 0, sizeof(__b));
    v81 = MEMORY[0x277D82BE0](v118);
    ...
    if (v46 && v45 && v44)
    {
      ...
      if (v38)
      {
        ...
        for (i = 0; i < [v44 longValue]; ++i)
        {
          ...
          v23 = [MEMORY[0x277CCABB0] numberWithDouble:v35];
          [v37 addObject:?];
          MEMORY[0x277D82BD8](v23);
        }

        v34 = [MEMORY[0x277CCAC98] sortDescriptorWithKey:@"self" ascending:1];
        v52[0] = v34;
        ...
        while (v31 < v30)
        {
          ...
          {
            v17 = [MEMORY[0x277CCABB0] numberWithLong:{v32, v21}];
            [v29 addObject:?];
            MEMORY[0x277D82BD8](v17);
            ++v31;
          }
...
- (id)sortArray:(id)array error:(id *)error errorDomain:(id)domain
{
  ...
  *&v118 = [location[0] objectForKey:OtherAffectedVectors];
  if (v118 == 0)
  {
    *(&v118 + 1) = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
    *&v118 = objc_alloc_init(MEMORY[0x277CBEAC0]);
    MEMORY[0x277D82BD8](0);
LABEL_32:
    if (v120 && v119)
    {
      ...
      if (v111)
      {
        ...
        for (i = 0; ; ++i)
        {
          ...
          v128[0] = v51;
          v50 = [MEMORY[0x277CCABB0] numberWithLong:i];
          v128[1] = v50;
          v104 = [MEMORY[0x277CBEA60] arrayWithObjects:v128 count:2];
          MEMORY[0x277D82BD8](v50);
          MEMORY[0x277D82BD8](v51);
          [v106 addObject:v104];
          objc_storeStrong(&v104, 0);
...
- (id)strideCopyArray:(id)array error:(id *)error errorDomain:(id)domain
{
  ...
  if (!v25)
  {
    objc_storeStrong(&v25, &unk_285210FE0);
  }
...
- (id)strideCopyAndSplitArray:(id)array error:(id *)error errorDomain:(id)domain
{
  ...
  if (!v65)
  {
    objc_storeStrong(&v65, &unk_285210FE0);
  }
  ...
  if (v64 && v66 && v67 && v68)
  {
    ...
    if (v35 == [v67 longValue])
    {
      ...
      if (v58)
      {
        ...
        MEMORY[0x277D82BD8](v25);
        v73 = [MEMORY[0x277CCABB0] numberWithLong:1];
        v63 = 1;
        objc_storeStrong(&v57, 0);
      }
...
- (id)twoArrayMathFunction:(id)function error:(id *)error errorDomain:(id)domain
{
  ...
  v59 = [location[0] objectForKey:Operation];
  if (!v62 || !v61 || !v60 || !v59)
  {
    v5 = objc_alloc(MEMORY[0x277CCA9B8]);
  ...
  for (i = 0; ; ++i)
  {
    ...
    v53 = [v57 objectAtIndex:i];
    v52 = [v56 objectAtIndex:i];
    [v52 doubleValue];
    if (v11 == 0.0 && (([v59 isEqual:Modulo] & 1) != 0 || (objc_msgSend(v59, "isEqual:", Division) & 1) != 0))
    {
      v12 = objc_alloc(MEMORY[0x277CCA9B8]);
...
LABEL_28:
    ...
    if ([v59 isEqual:Division])
    {
      [v53 doubleValue];
      v40 = v16;
      [v52 doubleValue];
      v18 = [MEMORY[0x277CCABB0] numberWithDouble:v40 / v17];
      v19 = v51;
      v51 = v18;
      MEMORY[0x277D82BD8](v19);
      goto LABEL_28;
    ...
    if ([v59 isEqual:Multiplication])
    {
      [v53 doubleValue];
      v39 = v20;
      [v52 doubleValue];
      v22 = [MEMORY[0x277CCABB0] numberWithDouble:v39 * v21];
      v23 = v51;
      v51 = v22;
      MEMORY[0x277D82BD8](v23);
      goto LABEL_28;
    ...
    if ([v59 isEqual:Addition])
    {
      [v53 doubleValue];
      v38 = v24;
      [v52 doubleValue];
      v26 = [MEMORY[0x277CCABB0] numberWithDouble:v38 + v25];
      v27 = v51;
      v51 = v26;
      MEMORY[0x277D82BD8](v27);
      goto LABEL_28;
    ...
    if ([v59 isEqual:Subtraction])
    {
      [v53 doubleValue];
      v37 = v28;
      [v52 doubleValue];
      v30 = [MEMORY[0x277CCABB0] numberWithDouble:v37 - v29];
      v31 = v51;
      v51 = v30;
      MEMORY[0x277D82BD8](v31);
      goto LABEL_28;
