...
- (_TtC15TextRecognition36CRTextRecognizerModelLatinCyrillicV3)initWithConfiguration:(id)configuration owner:(id)owner error:(id *)error;
@end
...
- (_TtC15TextRecognition36CRTextRecognizerModelLatinCyrillicV3)initWithConfiguration:(id)configuration owner:(id)owner error:(id *)error
{
  ...
  v15 = sub_1B4133F68(configurationCopy, v13);
