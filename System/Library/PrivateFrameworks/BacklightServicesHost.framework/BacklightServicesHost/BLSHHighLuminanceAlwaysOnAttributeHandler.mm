...
uint64_t __73__BLSHHighLuminanceAlwaysOnAttributeHandler_activateForSceneEnvironment___block_invoke(uint64_t a1)
{
  ...
  {
    __73__BLSHHighLuminanceAlwaysOnAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(v2, a1);
  }

  v3 = *v2;

  return [v3 setHighLuminanceAlwaysOn:1];
}
...
void __73__BLSHHighLuminanceAlwaysOnAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(id *a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138544642;
    ...
    v18 = v12;
    v19 = 2114;
    v20 = @"BLSHHighLuminanceAlwaysOnAttributeHandler.m";
    v21 = 1024;
    v22 = 31;
    v23 = 2114;
    v24 = v8;
