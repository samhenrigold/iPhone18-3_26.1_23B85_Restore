  ...
  while (v7)
  {
    ...
    if (HIDWORD(v9))
    {
      if (v8 != 0xFFFF && v8 <= 0x30000000 && -v7 >= v10)
      {
        ...
        SetAPIErrorMessage("ASPFTLParseBufferToCxt %d: Cannot add %d elements to context", v13, v14, v15, v16, v17, v18, v19, v8, v10, *__str, *&__str[8], v22);
      }
...
LABEL_2105:
          SetAPIErrorMessage(v9, a2, a3, a4, a5, a6, a7, a8);
          return v8;
        default:
          switch(v21)
          {
...
uint64_t ASPParseSnapshotBufferWithInplaceParser(uint64_t a1, int a2, char *__str, size_t *a4, uint64_t a5, unsigned int *a6)
{
      ...
      while (1)
      {
        ...
        if (v23)
        {
          *v23 = 0;
          ...
          __strcat_chk();
          __strcat_chk();
          _resolveColumnLabels_columnLabel = 0u;
          *algn_27CD31870 = 0u;
          xmmword_27CD31880 = 0u;
          unk_27CD31890 = 0u;
          xmmword_27CD318A0 = 0u;
          unk_27CD318B0 = 0u;
          v25 = 1;
          xmmword_27CD318C0 = 0u;
          unk_27CD318D0 = 0u;
          while (1)
          {
            v26 = v25;
          ...
          __strncpy_chk();
          *(&_resolveColumnLabels_columnLabel + v31) = 44;
LABEL_28:
          v22 = snprintf(v14, v12, "%s", &_resolveColumnLabels_columnLabel);
          goto LABEL_29;
        }
...
LABEL_31:
      ...
      xmmword_27CD31840 = 0u;
      unk_27CD31850 = 0u;
      xmmword_27CD31820 = 0u;
      unk_27CD31830 = 0u;
      xmmword_27CD31800 = 0u;
      unk_27CD31810 = 0u;
      _resolveReadWriteColumnLabels_columnLabel = 0u;
      *algn_27CD317F0 = 0u;
      v20 = strchr(v18, 87);
      v21 = 87;
      if (!v20)
      ...
      snprintf(&_resolveReadWriteColumnLabels_columnLabel, 0x80uLL, "%cO: Ops p 0/1/2/3,%cL: SumLatency p 0/1/2/3,%cM: MaxLatency p 0/1/2/3,", v21, v21, v21);
      v22 = snprintf(v14, v12, "%s", &_resolveReadWriteColumnLabels_columnLabel);
LABEL_29:
      if (v12 <= v22)
      {
        goto LABEL_33;
...
CFArrayRef ASP_Get_Controller_UID(__n128 a1, __n128 a2, __n128 a3)
{
  v14 = *MEMORY[0x277D85DE8];
  v12 = 0;
  TunnelBuffer_simple = fetchTunnelBuffer_simple(163, &v12, a1, a2, a3);
  Mutable = 0;
  if (TunnelBuffer_simple)
  {
    ...
    {
      v7 = v12 >> 3;
      Mutable = CFArrayCreateMutable(0, v12 >> 3, 0);
      if (v5 >= 8)
      {
        v8 = TunnelBuffer_simple;
        do
        {
          v9 = *v8++;
          snprintf(__str, 0x40uLL, "%016llx", v9);
...
CFArrayRef ASP_Get_Nand_ID(__n128 a1, __n128 a2, __n128 a3)
{
  v11 = 0;
  TunnelBuffer_simple = fetchTunnelBuffer_simple(56, &v11, a1, a2, a3);
  Mutable = 0;
  if (TunnelBuffer_simple)
  {
    v5 = v11;
    ...
    {
      v7 = v11 >> 3;
      Mutable = CFArrayCreateMutable(0, v11 >> 3, 0);
      if (v5 >= 8)
      {
        v8 = TunnelBuffer_simple;
        do
        {
          v9 = CFNumberCreate(0, kCFNumberSInt64Type, v8);
...
uint64_t asp_data_extraction_helper(unsigned int a1, uint64_t *a2, void *a3, __n128 a4, __n128 a5, __n128 a6)
{
  v15 = 0;
  if (!a2 || !a3)
  {
...
LABEL_6:
  ...
  if (a1 - 3 >= 7)
  {
    fprintf(*MEMORY[0x277D85DF8], "Error: Not supported option %d\n", a1);
    return 0;
  }

  v13 = dword_21AA21950[v11];
  TunnelBuffer = fetchTunnelBuffer(0, v13, qword_21AA21918[v11], &v15, 0, 0, a4, a5, a6);
  *a2 = TunnelBuffer;
  if (TunnelBuffer)
  {
    *a3 = v15;
  ...
  {
    fprintf(*MEMORY[0x277D85DF8], "Error: Failed to get tunnel buffer for cmd option %d.\n", v13);
    result = 0;
    *a3 = 0;
  }
...
uint64_t getStatsMagazineBufferFromPast(char **a1, uint64_t a2, int a3, uint64_t *a4, void *a5, __n128 a6, __n128 a7, __n128 a8)
{
  if (a3)
  {
    v9 = 10;
  ...
  if (a4 && a5)
  {
    TunnelBufferWithInVal = fetchTunnelBufferWithInVal(a1, v9, 0, a2, &v13, a6, a7, a8, 0, 0);
...
CFDictionaryRef ASP_GetIndirectionTableStatistics(__n128 a1, __n128 a2, __n128 a3)
{
  keys[3] = *MEMORY[0x277D85DE8];
  v21 = IND_POOL_KEY;
  v17 = 0;
  TunnelBuffer_simple = fetchTunnelBuffer_simple(10, &v17, a1, a2, a3);
  v4 = TunnelBuffer_simple;
  if (TunnelBuffer_simple)
  {
    v18 = 0.0;
    keys[0] = IND_POOL_SIZE_KEY;
    keys[1] = IND_POOL_FREE_KEY;
    ...
    if ((v17 & 0xFFFFFFF8) != 0)
    {
      ...
      while (v9 < (TunnelBuffer_simple + (v17 & 0xFFFFFFF8)));
      v19 = v7;
      valuePtr = v8;
      if (v8)
      {
    ...
    cf = CFNumberCreate(0, kCFNumberSInt64Type, &v19);
    v24 = CFNumberCreate(0, kCFNumberFloat32Type, &v18);
    ...
    free(v4);
    keys[0] = v15;
    v4 = CFDictionaryCreate(0, &v21, keys, 1, v13, v14);
    CFRelease(keys[0]);
  }
...
CFDictionaryRef ASP_GetNandPerfStats()
{
  ...
  v0 = malloc_type_calloc(1uLL, 0x2000uLL, 0x72E25EAuLL);
  if (v0)
  {
    v4 = v0;
    v5 = 0;
    if (populateTunnelOutputBufferWithoutSizeQuery(0, 770, 0, v0, 0x2000uLL, 0, 0, v1, v2, v3))
    {
      *keys = xmmword_278259128;
      v20 = @"ind_size_bytes";
      memset(values, 0, sizeof(values));
      memset(&valuePtr, 0, 512);
      if (statfs("/private/var", &valuePtr))
      {
        v6 = 0;
      }
      ...
      {
        v6 = valuePtr.f_blocks * valuePtr.f_bsize;
        if (v6)
        {
          v6 = 100 * valuePtr.f_bsize * (valuePtr.f_blocks - valuePtr.f_bavail) / v6;
        }
      }
      ...
      *&valuePtr.f_bsize = v6;
      ...
      do
      {
        ...
        v7 = v11 + 8 * HIDWORD(v10);
      }

      while (v7 < 0x2000);
      v12 = 0;
      valuePtr.f_blocks = v9;
      valuePtr.f_bfree = v8;
      do
      {
        if (*(&valuePtr.f_bsize + v12) == -1)
        {
          fprintf(*MEMORY[0x277D85DF8], "Missing perf stat at idx %d", v12);
          v5 = 0;
          goto LABEL_22;
        }
      ...
      while (v12 != 3);
      v13 = 0;
      valuePtr.f_blocks = 100 - 100 * v9 / v8;
      v14 = *MEMORY[0x277CBECE8];
      p_valuePtr = &valuePtr;
      do
      {
        values[v13++] = CFNumberCreate(v14, kCFNumberLongLongType, p_valuePtr);
        p_valuePtr = (p_valuePtr + 8);
      }
...
uint64_t print_asp_magazine_stats(char *a1, uint64_t a2, int a3, __n128 a4, __n128 a5, __n128 a6)
{
  v11 = 0;
  v12 = 0;
  if (getStatsMagazineBufferFromPast(0, a2, a3, &v12, &v11, a4, a5, a6))
  {
    if (a3)
    {
      v8 = 1;
    ...
    print_stats_buf(a1, v12, v11 >> 3, v8);
    free(v12);
    return 1;
  }
  ...
  else
  {
    ...
    fprintf(*MEMORY[0x277D85DF8], "Error: IO NVMe Smart cmd failed to extract ASP %s stats!\n", v10);
    return 0;
  }
}

uint64_t print_stats_buf(char *__filename, unint64_t *a2, int a3, uint64_t a4)
{
  v7 = __filename;
  if (__filename)
  {
