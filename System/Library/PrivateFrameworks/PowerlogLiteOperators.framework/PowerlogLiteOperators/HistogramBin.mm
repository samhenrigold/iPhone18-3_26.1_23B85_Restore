...
- (id)description
{
  ...
  dictionaryRepresentation = [(HistogramBin *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [dictionary setObject:v5 forKey:@"ids"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 16) & 1) == 0 || self->_ids != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
  }
