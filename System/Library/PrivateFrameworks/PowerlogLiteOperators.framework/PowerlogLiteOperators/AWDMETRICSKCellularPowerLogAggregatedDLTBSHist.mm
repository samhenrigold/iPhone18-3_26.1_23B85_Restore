...
LABEL_14:
  ...
  v16 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:{self->_durationMs, v18}];
...
LABEL_22:
  v17 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:{self->_numSubs, v18}];
  [dictionary setObject:v17 forKey:@"num_subs"];
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        [(AWDMETRICSKCellularPowerLogAggregatedDLTBSHist *)self addBin:*(*(&v12 + 1) + 8 * i), v12];
      }
