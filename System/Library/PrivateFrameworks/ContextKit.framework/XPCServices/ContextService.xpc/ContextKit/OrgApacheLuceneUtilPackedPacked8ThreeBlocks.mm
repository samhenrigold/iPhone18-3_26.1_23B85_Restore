...
- (int)getWithInt:(int)int withLongArray:(id)array withInt:(int)withInt withInt:(int)a6
{
  ...
  for (i = 3 * (v10 + int); v11 < i; v6 = (v6 + 1))
  {
    ...
    v16 = *(&self->blocks_->super.size_ + v15 + 4);
    v17 = v11 + 2;
    if (v11 + 2 < 0 || v17 >= size)
    {
    ...
    *(array + v6 + 2) = (*(&blocks->super.size_ + v11 + 4) << 16) | (v16 << 8) | *(&blocks->super.size_ + v17 + 4);
    v11 = (v11 + 3);
  }
...
- (void)setWithInt:(int)int withLong:(int64_t)long
{
  ...
  *(&blocks->super.size_ + v6 + 4) = BYTE2(long);
  v8 = self->blocks_;
  v9 = v8->super.size_;
  v10 = v6 + 1;
  if (v6 + 1 < 0 || v10 >= v9)
  ...
  *(&v8->super.size_ + v10 + 4) = BYTE1(long);
  v11 = self->blocks_;
  v12 = v11->super.size_;
  v13 = v6 + 2;
  if (v6 + 2 < 0 || v13 >= v12)
...
- (void)fillWithInt:(int)int withInt:(int)withInt withLong:(int64_t)long
{
  for (i = (3 * int); i < 3 * withInt; i = (i + 3))
  {
    ...
    *(&blocks->super.size_ + i + 4) = BYTE2(long);
    v9 = self->blocks_;
    v10 = i + 1;
    v11 = v9->super.size_;
    if (i < -1 || v10 >= v11)
    ...
    *(&v9->super.size_ + v10 + 4) = BYTE1(long);
    v12 = self->blocks_;
    v13 = v12->super.size_;
    v14 = i + 2;
    if (i + 2 < 0 || v14 >= v13)
