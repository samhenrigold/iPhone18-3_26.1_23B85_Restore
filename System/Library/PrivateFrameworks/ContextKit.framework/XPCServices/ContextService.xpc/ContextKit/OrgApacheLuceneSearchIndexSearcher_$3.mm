...
LABEL_11:
  ...
  v5 = [collection size];
  v7 = [IOSObjectArray arrayWithLength:v5 type:OrgApacheLuceneSearchTopDocs_class_(v5, v6)];
  v16 = 0u;
  v17 = 0u;
  v18 = 0u;
  v19 = 0u;
  ...
  return OrgApacheLuceneSearchTopDocs_mergeWithInt_withOrgApacheLuceneSearchTopDocsArray_(self->val$cappedNumHits_, v7);
}
