...
- (int64_t)getWithInt:(int)int
{
  ...
  return *(&values->super.size_ + int + 1);
}
...
- (int64_t)ramBytesUsed
{
  ...
  return OrgApacheLuceneUtilRamUsageEstimator_sizeOfWithIntArray_(self->values_) + v4;
}
...
- (int)getWithInt:(int)int withLongArray:(id)array withInt:(int)withInt withInt:(int)a6
{
  ...
  if (v10 + v8 > v8)
  {
    ...
    do
    {
      ...
      *(array + v6 + 2) = *(&values->super.size_ + ++v8);
      v6 = (v6 + 1);
    }
...
- (int)setWithInt:(int)int withLongArray:(id)array withInt:(int)withInt withInt:(int)a6
{
  ...
  if (v10 + v8 > v8)
  {
    ...
    do
    {
      ...
      *(&values->super.size_ + ++v8) = *(array + withIntCopy + 2);
...
{
  v3.receiver = self;
  v3.super_class = OrgApacheLuceneUtilPackedDirect32;
