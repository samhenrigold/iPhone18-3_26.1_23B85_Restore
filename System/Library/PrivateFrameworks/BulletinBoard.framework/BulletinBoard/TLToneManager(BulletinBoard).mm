      ...
      if (v10)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            v15 = [self bb_isToneEnabledForAlertType:v7 topic:subsectionID];
...
LABEL_14:
    ...
    {
      v16 = [self bb_isToneEnabledForAlertType:v7 topic:0];
    }
  }
...
- (uint64_t)bb_isToneEnabledForAlertConfiguration:()BulletinBoard
{
  v1 = [self bb_toneIdentifierForAlertConfiguration:?];
  v2 = [v1 isEqualToString:*MEMORY[0x277D72068]];
