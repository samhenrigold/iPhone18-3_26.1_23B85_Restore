...
- (id)description
{
  ...
  v7.receiver = self;
  v7.super_class = WOHealthBridgeKeyedNumber;
  v5 = [(WOHealthBridgeKeyedNumber *)&v7 description];
  dictionaryRepresentation = [(WOHealthBridgeKeyedNumber *)selfCopy dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  v4 = [MEMORY[0x277CCABB0] numberWithDouble:{selfCopy->_number, v6[0]}];
  [v3 setObject:? forKey:?];
...
- (BOOL)readFrom:(id)from
{
  ...
  v4 = WOHealthBridgeKeyedNumberReadFrom(selfCopy, location[0]);
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(location[0] + 2))
  {
    [(WOHealthBridgeKeyedNumber *)selfCopy setKey:*(location[0] + 2)];
  }

  selfCopy->_number = *(location[0] + 1);
  objc_storeStrong(location, 0);
}
