...
- (id)description
{
  ...
  dictionaryRepresentation = [(BCSChatSuggestWrapper *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (message)
  {
    dictionaryRepresentation = [(BCSChatSuggestMessage *)message dictionaryRepresentation];
...
LABEL_38:
      ...
      else if (v14 == 2)
      {
        ...
        v27[0] = 0;
        v27[1] = 0;
        if (!PBReaderPlaceMark() || !BCSChatSuggestMessageReadFrom(v17, from))
        {
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  *(v5 + 24) = v6;
  ...
  v8 = [(BCSChatSuggestMessage *)self->_message copyWithZone:zone];
  v9 = *(v5 + 16);
  *(v5 + 16) = v8;
...
- (void)mergeFrom:(id)from
{
  ...
  if (message)
  {
    ...
    message = [(BCSChatSuggestMessage *)message mergeFrom:?];
  }
  ...
  else
  {
    ...
    message = [(BCSChatSuggestWrapper *)self setMessage:?];
  }
