void mlir::detail::ValueBoundsOpInterfaceInterfaceTraits::FallbackModel<mlir::anonymous namespace::AffineApplyOpInterface>::populateBoundsForIndexValue(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v37[6] = *MEMORY[0x277D85DE8];
  v28 = a2;
  Map = mlir::affine::AffineApplyOp::getMap(&v28);
  if ((*(v28 + 46) & 0x80) != 0)
  {
    v6 = *(v28 + 72);
    v7 = *(v28 + 68);
  ...
  LODWORD(v36) = v12 + v7;
  mlir::affine::fullyComposeAffineMapAndOperands(&Map, &v35);
  Result = mlir::AffineMap::getResult(&Map, 0);
  v32 = &v34;
  v33 = 0x600000000;
  v29 = &v31;
  v30 = 0x600000000;
  NumDims = mlir::AffineMap::getNumDims(&Map);
  if (NumDims)
  {
    v14 = 0;
    v15 = 8 * NumDims;
    do
    {
      Expr = mlir::ValueBoundsConstraintSet::getExpr(a4, v35[v14 / 8], 0, 0);
      if (v33 >= HIDWORD(v33))
      {
        llvm::SmallVectorBase<unsigned int>::grow_pod();
      }
  ...
  LODWORD(v17) = mlir::AffineMap::getNumDims(&Map);
  v18 = mlir::AffineMap::getNumDims(&Map);
  v19 = mlir::AffineMap::getNumSymbols(&Map) + v18;
  if (v17 >= v19)
  {
    v21 = v30;
  }
  ...
  else
  {
    ...
    do
    {
      v20 = mlir::ValueBoundsConstraintSet::getExpr(a4, v35[v17], 0, 0);
      if (v30 >= HIDWORD(v30))
      {
        llvm::SmallVectorBase<unsigned int>::grow_pod();
      }
  ...
  v22 = mlir::AffineExpr::replaceDimsAndSymbols(&Result, v32, v33, v29, v21);
  v23[0] = a4;
  v23[1] = a3;
  v24 = 0;
  v25 = 0;
  mlir::ValueBoundsConstraintSet::BoundBuilder::operator==(v23, v22);
}

void mlir::detail::ValueBoundsOpInterfaceInterfaceTraits::FallbackModel<mlir::anonymous namespace::AffineMaxOpInterface>::populateBoundsForIndexValue(uint64_t a1, uint64_t a2, uint64_t a3, unint64_t a4)
{
  v38 = *MEMORY[0x277D85DE8];
  v26 = a2;
  Map = mlir::affine::AffineMaxOp::getMap(&v26);
  Results = mlir::AffineMap::getResults(&Map);
  if (v7)
  {
    v25 = *Results;
    ODSOperandIndexAndLength = mlir::affine::AffineMaxOp::getODSOperandIndexAndLength(&v26, 0);
    if ((*(v26 + 46) & 0x80) != 0)
    {
      v9 = *(v26 + 72);
    }
    ...
    mlir::affine::AffineMaxOp::getODSOperandIndexAndLength(&v26, 0);
    v34 = mlir::affine::AffineMaxOp::getMap(&v26);
    NumDims = mlir::AffineMap::getNumDims(&v34);
    mlir::ValueRange::ValueRange(&v27, v9 + 32 * ODSOperandIndexAndLength, NumDims);
    v11 = v28;
    Map = v33;
    v32 = 0x600000000;
    if (v28 >= 7)
    ...
    if (v11)
    {
      ...
      do
      {
        v15 = mlir::ValueRange::dereference_iterator(&v27, v13);
        *v14++ = mlir::ValueBoundsConstraintSet::getExpr(v29, v15, 0, 0);
        v13 = v28 + 1;
        v28 = v13;
      }
    ...
    LODWORD(v32) = v12 + v11;
    SymbolOperands = mlir::affine::AffineMaxOp::getSymbolOperands(&v26);
    v18 = v17;
    v27 = &v29;
    v28 = 0x600000000;
    if (v17 >= 7)
    ...
    if (v17)
    {
      ...
      do
      {
        v21 = mlir::ValueRange::dereference_iterator(&v34, v19);
        *v20++ = mlir::ValueBoundsConstraintSet::getExpr(v36, v21, 0, 0);
        v19 = v35 + 1;
        v35 = v19;
      }
    ...
    LODWORD(v28) = v22 + v18;
    v24 = mlir::AffineExpr::replaceDimsAndSymbols(&v25, Map, v32, v23, (v22 + v18));
    v34 = a4;
    v35 = a3;
    LOBYTE(v36) = 0;
    v37 = 0;
    mlir::ValueBoundsConstraintSet::BoundBuilder::operator>=(&v34, v24);
  }
}

void mlir::detail::ValueBoundsOpInterfaceInterfaceTraits::FallbackModel<mlir::anonymous namespace::AffineMinOpInterface>::populateBoundsForIndexValue(uint64_t a1, uint64_t a2, uint64_t a3, unint64_t a4)
{
  v38 = *MEMORY[0x277D85DE8];
  v26 = a2;
  Map = mlir::affine::AffineMinOp::getMap(&v26);
  Results = mlir::AffineMap::getResults(&Map);
  if (v7)
  {
    v25 = *Results;
    ODSOperandIndexAndLength = mlir::affine::AffineMinOp::getODSOperandIndexAndLength(&v26, 0);
    if ((*(v26 + 46) & 0x80) != 0)
    {
      v9 = *(v26 + 72);
    }
    ...
    mlir::affine::AffineMinOp::getODSOperandIndexAndLength(&v26, 0);
    v34 = mlir::affine::AffineMinOp::getMap(&v26);
    NumDims = mlir::AffineMap::getNumDims(&v34);
    mlir::ValueRange::ValueRange(&v27, v9 + 32 * ODSOperandIndexAndLength, NumDims);
    v11 = v28;
    Map = v33;
    ...
    LODWORD(v32) = v12 + v11;
    SymbolOperands = mlir::affine::AffineMinOp::getSymbolOperands(&v26);
    v18 = v17;
    v27 = &v29;
    v28 = 0x600000000;
    if (v17 >= 7)
...
void mlir::DialectRegistry::addExtension<mlir::affine::AffineDialect>(void (*)(mlir::MLIRContext *,mlir::affine::AffineDialect *))::Extension::~Extension(mlir::DialectExtensionBase *a1)
{
...
uint64_t mlir::memref::findDealloc(void *a1)
{
  if (*a1)
  {
    mlir::hasEffect<mlir::MemoryEffects::Free>();
  }
...
uint64_t *mlir::RegisteredOperationName::Model<mlir::memref::AssumeAlignmentOp>::setInherentAttr(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  return mlir::memref::AssumeAlignmentOp::setInherentAttr((v5 + 64), Value, v7, a4);
}

uint64_t mlir::RegisteredOperationName::Model<mlir::memref::AssumeAlignmentOp>::populateInherentAttrs(uint64_t a1, uint64_t a2, uint64_t a3)
{
  Context = mlir::Attribute::getContext((a2 + 24));
  v6 = (a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 64);

  return mlir::memref::AssumeAlignmentOp::populateInherentAttrs(Context, v6, a3);
}
...
uint64_t *mlir::RegisteredOperationName::Model<mlir::memref::AtomicRMWOp>::setInherentAttr(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  v5 = a2 + 16 * ((*(a2 + 44) >> 23) & 1);
  Value = mlir::StringAttr::getValue(&v9);
  return mlir::memref::AtomicRMWOp::setInherentAttr((v5 + 64), Value, v7, a4);
}

uint64_t mlir::RegisteredOperationName::Model<mlir::memref::AtomicRMWOp>::populateInherentAttrs(uint64_t a1, uint64_t a2, uint64_t a3)
{
  Context = mlir::Attribute::getContext((a2 + 24));
  v6 = (a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 64);

  return mlir::memref::AtomicRMWOp::populateInherentAttrs(Context, v6, a3);
}
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::memref::AtomicRMWOp>::refineReturnTypes(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  ...
  v24 = v26;
  v25 = 0x400000000;
  if (mlir::memref::AtomicRMWOp::inferReturnTypes(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, &v24))
  {
...
BOOL llvm::detail::UniqueFunctionBase<llvm::LogicalResult,mlir::Operation *,llvm::ArrayRef<mlir::Attribute>,llvm::SmallVectorImpl<mlir::OpFoldResult> &>::CallImpl<mlir::Op<mlir::memref::AtomicRMWOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::Type>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::AtLeastNOperands<2u>::Impl,mlir::OpTrait::OpInvariants,mlir::BytecodeOpInterface::Trait,mlir::InferTypeOpInterface::Trait,mlir::MemoryEffectOpInterface::Trait>::getFoldHookFn(void)::{lambda(mlir::Operation *,llvm::ArrayRef<mlir::Attribute>,llvm::SmallVectorImpl<mlir::OpFoldResult> &)#1} const>(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  ...
  v12 = a2;
  mlir::memref::detail::AtomicRMWOpGenericAdaptorBase::AtomicRMWOpGenericAdaptorBase(v13, a2);
  v14 = a3;
  v15 = a4;
  v9 = mlir::memref::AtomicRMWOp::fold(&v12);
...
BOOL mlir::OpTrait::HasParent<mlir::memref::GenericAtomicRMWOp>::Impl<mlir::memref::AtomicYieldOp>::verifyTrait(mlir::Block **a1)
{
  v38 = *MEMORY[0x277D85DE8];
  if (a1[2])
  {
...
uint64_t mlir::OpTrait::SingleBlockImplicitTerminator<mlir::memref::AtomicYieldOp>::Impl<mlir::memref::GenericAtomicRMWOp>::verifyRegionTrait(mlir::Operation *a1)
{
  ...
  if (v1)
  {
    ...
    while (1)
    {
      ...
      if (v6 != *v6)
      {
        ...
        v8 = *(v7 + 48);
        if (*(v8 + 16) != &mlir::detail::TypeIDResolver<mlir::memref::AtomicYieldOp,void>::id)
        {
          break;
        }
      }
...
void *mlir::RegisteredOperationName::Model<mlir::memref::LoadOp>::setInherentAttr(uint64_t a1, uint64_t a2, uint64_t a3, void *a4)
{
  ...
  v5 = a2 + 16 * ((*(a2 + 44) >> 23) & 1);
  Value = mlir::StringAttr::getValue(&v9);
  return mlir::memref::LoadOp::setInherentAttr((v5 + 64), Value, v7, a4);
}

uint64_t mlir::RegisteredOperationName::Model<mlir::memref::LoadOp>::populateInherentAttrs(uint64_t a1, uint64_t a2, uint64_t a3)
{
  Context = mlir::Attribute::getContext((a2 + 24));
  v6 = (a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 64);

  return mlir::memref::LoadOp::populateInherentAttrs(Context, v6, a3);
}
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::memref::LoadOp>::refineReturnTypes(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  ...
  v24 = v26;
  v25 = 0x400000000;
  if (mlir::memref::LoadOp::inferReturnTypes(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, &v24))
  {
    mlir::TypeRange::TypeRange(&v22, v24, v25);
    mlir::TypeRange::TypeRange(v21, *a11, *(a11 + 8));
    v13 = v23;
...
BOOL llvm::detail::UniqueFunctionBase<llvm::LogicalResult,mlir::Operation *,llvm::ArrayRef<mlir::Attribute>,llvm::SmallVectorImpl<mlir::OpFoldResult> &>::CallImpl<mlir::Op<mlir::memref::LoadOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::Type>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::AtLeastNOperands<1u>::Impl,mlir::OpTrait::OpInvariants,mlir::BytecodeOpInterface::Trait,mlir::OpTrait::MemRefsNormalizable,mlir::PromotableMemOpInterface::Trait,mlir::DestructurableAccessorOpInterface::Trait,mlir::InferTypeOpInterface::Trait,mlir::MemoryEffectOpInterface::Trait>::getFoldHookFn(void)::{lambda(mlir::Operation *,llvm::ArrayRef<mlir::Attribute>,llvm::SmallVectorImpl<mlir::OpFoldResult> &)#1} const>(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  ...
  mlir::memref::detail::LoadOpGenericAdaptorBase::LoadOpGenericAdaptorBase(v12, a2);
  v13 = a3;
  v14 = a4;
...
uint64_t mlir::RegisteredOperationName::Model<mlir::memref::AllocOp>::setInherentAttr(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v9 = a3;
  v5 = a2 + 16 * ((*(a2 + 44) >> 23) & 1);
  Value = mlir::StringAttr::getValue(&v9);
  return mlir::memref::AllocOp::setInherentAttr(v5 + 64, Value, v7, a4);
}
...
void mlir::RegisteredOperationName::Model<mlir::memref::AllocOp>::getPropertiesAsAttr(uint64_t a1, uint64_t a2)
{
  Context = mlir::Attribute::getContext((a2 + 24));
  v4 = (a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 64);

  mlir::memref::AllocOp::getPropertiesAsAttr(Context, v4);
}
...
uint64_t mlir::RegisteredOperationName::Model<mlir::memref::AllocaOp>::setInherentAttr(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v9 = a3;
  v5 = a2 + 16 * ((*(a2 + 44) >> 23) & 1);
  Value = mlir::StringAttr::getValue(&v9);
  return mlir::memref::AllocaOp::setInherentAttr(v5 + 64, Value, v7, a4);
}
...
void mlir::RegisteredOperationName::Model<mlir::memref::AllocaOp>::populateInherentAttrs(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  mlir::memref::AllocaOp::populateInherentAttrs(Context, v6, a3);
}
...
void mlir::RegisteredOperationName::Model<mlir::memref::AllocaOp>::getPropertiesAsAttr(uint64_t a1, uint64_t a2)
{
  Context = mlir::Attribute::getContext((a2 + 24));
  v4 = (a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 64);

  mlir::memref::AllocaOp::getPropertiesAsAttr(Context, v4);
}
...
uint64_t llvm::detail::UniqueFunctionBase<void,mlir::Operation *,mlir::OpAsmPrinter &,llvm::StringRef>::CallImpl<mlir::Op<mlir::memref::AllocaOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::MemRefType>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::VariadicOperands,mlir::OpTrait::AttrSizedOperandSegments,mlir::OpTrait::OpInvariants,mlir::BytecodeOpInterface::Trait,mlir::OpAsmOpInterface::Trait,mlir::PromotableAllocationOpInterface::Trait,mlir::DestructurableAllocationOpInterface::Trait,mlir::MemoryEffectOpInterface::Trait>::getPrintAssemblyFn(void)::{lambda(mlir::Operation *,mlir::OpAsmPrinter &,llvm::StringRef)#1} const>(uint64_t a1, uint64_t a2, mlir::OpAsmPrinter *a3, llvm::formatv_object_base *a4, llvm::formatv_object_base *a5)
{
  mlir::OpState::printOpName(a2, a3, a4, a5);
  v8 = a2;
  return mlir::memref::AllocaOp::print(&v8, a3);
}
...
BOOL mlir::Op<mlir::memref::AllocaOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::MemRefType>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::VariadicOperands,mlir::OpTrait::AttrSizedOperandSegments,mlir::OpTrait::OpInvariants,mlir::BytecodeOpInterface::Trait,mlir::OpAsmOpInterface::Trait,mlir::PromotableAllocationOpInterface::Trait,mlir::DestructurableAllocationOpInterface::Trait,mlir::MemoryEffectOpInterface::Trait>::verifyInvariants(mlir::OpTrait::impl *a1, mlir::Operation *a2)
{
  ...
  v6 = a1;
  if ((mlir::memref::AllocaOp::verifyInvariantsImpl(&v6) & 1) == 0)
  {
    return 0;
  }
...
{
  if ((mlir::OpTrait::impl::verifyOneRegion(a1, a2) & 1) == 0 || (mlir::OpTrait::impl::verifyZeroSuccessors(a1, v3) & 1) == 0 || (mlir::OpTrait::impl::verifyZeroOperands(a1, v4) & 1) == 0 || !mlir::OpTrait::SingleBlock<mlir::ODIE::Compiler::CoreML::IfOp>::verifyTrait(a1) || !mlir::OpTrait::impl::verifyNoRegionArguments(a1, v5))
  {
    return 0;
  }
...
uint64_t mlir::OpTrait::SingleBlockImplicitTerminator<mlir::memref::AllocaScopeReturnOp>::Impl<mlir::memref::AllocaScopeOp>::verifyRegionTrait(mlir::Operation *a1)
{
  v29[25] = *MEMORY[0x277D85DE8];
  v1 = *(a1 + 11) & 0x7FFFFF;
  if (v1)
  {
    ...
    v17 = 1283;
    v16[0] = "expects regions to end with '";
    v16[2] = "memref.alloca_scope.return";
    v16[3] = 26;
    v18[0] = v16;
    v18[2] = "', found '";
    v19 = 770;
...
{
  if (mlir::OpTrait::impl::verifyZeroRegions(a1, a2) & 1) != 0 && (mlir::OpTrait::impl::verifyZeroResults(a1, v3) & 1) != 0 && (mlir::OpTrait::impl::verifyZeroSuccessors(a1, v4) & 1) != 0 && mlir::OpTrait::HasParent<mlir::memref::AllocaScopeOp>::Impl<mlir::memref::AllocaScopeReturnOp>::verifyTrait(a1) && (v7 = a1, (mlir::memref::AllocaScopeReturnOp::verifyInvariantsImpl(&v7)))
  {
...
BOOL mlir::Op<mlir::memref::CastOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::BaseMemRefType>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::OneOperand,mlir::OpTrait::OpInvariants,mlir::CastOpInterface::Trait,mlir::OpAsmOpInterface::Trait,mlir::OpTrait::MemRefsNormalizable,mlir::ConditionallySpeculatable::Trait,mlir::OpTrait::AlwaysSpeculatableImplTrait,mlir::MemoryEffectOpInterface::Trait,mlir::OpTrait::SameOperandsAndResultShape,mlir::ViewLikeOpInterface::Trait>::foldSingleResultHook<mlir::memref::CastOp>(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  mlir::RegionRange::RegionRange(v16, v10, v9);
  v16[2] = a2;
  v16[3] = a3;
...
void llvm::detail::UniqueFunctionBase<void,mlir::Operation *,mlir::OpAsmPrinter &,llvm::StringRef>::CallImpl<mlir::Op<mlir::memref::CastOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::BaseMemRefType>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::OneOperand,mlir::OpTrait::OpInvariants,mlir::CastOpInterface::Trait,mlir::OpAsmOpInterface::Trait,mlir::OpTrait::MemRefsNormalizable,mlir::ConditionallySpeculatable::Trait,mlir::OpTrait::AlwaysSpeculatableImplTrait,mlir::MemoryEffectOpInterface::Trait,mlir::OpTrait::SameOperandsAndResultShape,mlir::ViewLikeOpInterface::Trait>::getPrintAssemblyFn(void)::{lambda(mlir::Operation *,mlir::OpAsmPrinter &,llvm::StringRef)#1} const>(uint64_t a1, mlir::Operation *a2, mlir::OpAsmPrinter *a3, llvm::formatv_object_base *a4, llvm::formatv_object_base *a5)
{
  mlir::OpState::printOpName(a2, a3, a4, a5);
  v7 = a2;
  mlir::memref::CastOp::print(&v7, a3);
}
...
uint64_t *mlir::RegisteredOperationName::Model<mlir::memref::CollapseShapeOp>::setInherentAttr(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  v5 = a2 + 16 * ((*(a2 + 44) >> 23) & 1);
  Value = mlir::StringAttr::getValue(&v9);
  return mlir::memref::CollapseShapeOp::setInherentAttr((v5 + 64), Value, v7, a4);
}

uint64_t mlir::RegisteredOperationName::Model<mlir::memref::CollapseShapeOp>::populateInherentAttrs(uint64_t a1, uint64_t a2, uint64_t a3)
{
  Context = mlir::Attribute::getContext((a2 + 24));
  v6 = (a2 + 16 * ((*(a2 + 44) >> 23) & 1) + 64);

  return mlir::memref::CollapseShapeOp::populateInherentAttrs(Context, v6, a3);
}
...
BOOL llvm::detail::UniqueFunctionBase<llvm::LogicalResult,mlir::Operation *,llvm::ArrayRef<mlir::Attribute>,llvm::SmallVectorImpl<mlir::OpFoldResult> &>::CallImpl<mlir::Op<mlir::memref::CollapseShapeOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::OneResult,mlir::OpTrait::OneTypedResult<mlir::MemRefType>::Impl,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::OneOperand,mlir::OpTrait::OpInvariants,mlir::BytecodeOpInterface::Trait,mlir::OpAsmOpInterface::Trait,mlir::ConditionallySpeculatable::Trait,mlir::OpTrait::AlwaysSpeculatableImplTrait,mlir::MemoryEffectOpInterface::Trait,mlir::ViewLikeOpInterface::Trait>::getFoldHookFn(void)::{lambda(mlir::Operation *,llvm::ArrayRef<mlir::Attribute>,llvm::SmallVectorImpl<mlir::OpFoldResult> &)#1} const>(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  v16 = *MEMORY[0x277D85DE8];
  v12 = a2;
  mlir::memref::detail::CollapseShapeOpGenericAdaptorBase::CollapseShapeOpGenericAdaptorBase(v13, a2);
  v14 = a3;
  v15 = a4;
  v9 = mlir::memref::CollapseShapeOp::fold(&v12, v13);
  if (v9 < 8 || a2 - 16 == (v9 & ((v9 << 61) >> 63) & 0xFFFFFFFFFFFFFFF8))
  {
    return v9 > 7;
  }
...
void *mlir::RegisteredOperationName::Model<mlir::memref::DeallocOp>::Model(void *a1, uint64_t a2)
{
  ...
  *v4 = mlir::detail::MemoryEffectOpInterfaceInterfaceTraits::Model<mlir::memref::DeallocOp>::getEffects;
  ...
  mlir::OperationName::Impl::Impl(a1, "memref.dealloc", 0xE, a2, &mlir::detail::TypeIDResolver<mlir::memref::DeallocOp,void>::id, &v12);
  v6 = v12;
  if (v13)
  {
    v7 = 16 * v13;
...
void llvm::detail::UniqueFunctionBase<void,mlir::Operation *,mlir::OpAsmPrinter &,llvm::StringRef>::CallImpl<mlir::Op<mlir::memref::DeallocOp,mlir::OpTrait::ZeroRegions,mlir::OpTrait::ZeroResults,mlir::OpTrait::ZeroSuccessors,mlir::OpTrait::OneOperand,mlir::OpTrait::OpInvariants,mlir::OpTrait::MemRefsNormalizable,mlir::MemoryEffectOpInterface::Trait>::getPrintAssemblyFn(void)::{lambda(mlir::Operation *,mlir::OpAsmPrinter &,llvm::StringRef)#1} const>(uint64_t a1, mlir::Operation *a2, mlir::OpAsmPrinter *a3, llvm::formatv_object_base *a4, llvm::formatv_object_base *a5)
{
  mlir::OpState::printOpName(a2, a3, a4, a5);
  v7 = a2;
  mlir::memref::DeallocOp::print(&v7, a3);
}
