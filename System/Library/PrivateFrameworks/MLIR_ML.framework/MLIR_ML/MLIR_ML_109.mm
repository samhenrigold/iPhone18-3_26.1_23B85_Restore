...
BOOL mlir::RegisteredOperationName::Model<mlir::mps::CallOp>::verifyInherentAttrs(uint64_t a1, uint64_t a2, uint64_t a3, void (*a4)(uint64_t *__return_ptr, uint64_t), uint64_t a5)
{
  ...
  if (!v9 || mlir::mps::__mlir_ods_local_attr_constraint_MPSOps4(v9, "inlineMode", 0xA, a4, a5))
  {
    ...
    if (!v10 || mlir::silc::__mlir_ods_local_attr_constraint_SilcOps7(v10, "symbolName", 0xA, a4, a5))
    {
      return 1;
    }
  }
...
unint64_t mlir::detail::CallOpInterfaceInterfaceTraits::Model<mlir::mps::CallOp>::getCallableForCallee(uint64_t a1, uint64_t a2)
{
...
uint64_t mlir::detail::CallOpInterfaceInterfaceTraits::Model<mlir::mps::CallOp>::resolveCallableInTable(uint64_t a1, mlir::SymbolTable *InterfaceFor, uint64_t a3)
{
  v3 = InterfaceFor;
  if (InterfaceFor)
  {
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::mps::CastOp>::refineReturnTypes(mlir::UnknownLoc *a1, mlir::MLIRContext *a2, int a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t *a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  v11 = a3;
  v27 = *MEMORY[0x277D85DE8];
  v20 = v22;
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::mps::ClampOp>::refineReturnTypes(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  v11 = a3;
  v27 = *MEMORY[0x277D85DE8];
  v20 = v22;
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::mps::ColToImOp>::refineReturnTypes(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, __int128 *a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  v11 = a3;
  v27 = *MEMORY[0x277D85DE8];
  v20 = v22;
...
BOOL mlir::detail::InferTypeOpInterfaceTrait<mlir::mps::ConcatOp>::refineReturnTypes(mlir::Float32Type *a1, mlir::MLIRContext *a2, uint64_t a3, char *a4, unint64_t a5, uint64_t a6, uint64_t *a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  v11 = a3;
  v27 = *MEMORY[0x277D85DE8];
  v20 = v22;
