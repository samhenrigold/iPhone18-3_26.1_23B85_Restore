...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = OTSupportSOSMessage;
  v4 = [(OTSupportSOSMessage *)&v8 description];
  dictionaryRepresentation = [(OTSupportSOSMessage *)self dictionaryRepresentation];
