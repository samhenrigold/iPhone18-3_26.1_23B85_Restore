...
uint64_t ___NETRBClientModifyLowLatencyFlow_block_invoke(uint64_t a1)
{
  ...
  {
    xpc_dictionary_set_string(*(a1 + 48), netrbXPCClientID[0], (*(a1 + 40) + 32));
    if (*(a1 + 56))
    {
      v3 = 1019;
    }
    ...
    xpc_dictionary_set_uint64(*(a1 + 48), netrbXPCKey[0], v3);
...
uint64_t ___NETRBClientModifyLowLatencyFlow_block_invoke_2(uint64_t a1, void *a2)
{
  if (a2 && MEMORY[0x2743E7A80](a2) == MEMORY[0x277D86468])
  {
    ...
    if (value && (v6 = value, MEMORY[0x2743E7A80]() == MEMORY[0x277D864C8]))
    {
