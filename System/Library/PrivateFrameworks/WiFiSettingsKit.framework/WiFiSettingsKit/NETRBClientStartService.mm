...
LABEL_5:
  ...
  v4 = v3;
  xpc_dictionary_set_uint64(v3, netrbXPCKey[0], 0x3E9uLL);
  xpc_dictionary_set_string(v4, netrbXPCClientID[0], (*(a1 + 40) + 32));
  xpc_dictionary_set_uint64(v4, netrbXPCOpMode[0], *(a1 + 72));
  xpc_dictionary_set_uint64(v4, netrbXPCBridgeType[0], *(a1 + 76));
  xpc_dictionary_set_value(v4, netrbXPCInterfaceParam[0], *(a1 + 48));
  v5 = *(a1 + 56);
  if (v5 && *v5)
  {
    if (!strncmp(*(a1 + 56), netrbClientAnyExternal, 0x10uLL))
    {
      v7 = netrbXPCAnyExternal[0];
      v6 = v4;
    }
