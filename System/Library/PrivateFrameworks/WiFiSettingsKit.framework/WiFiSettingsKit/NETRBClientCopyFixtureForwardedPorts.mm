...
LABEL_3:
  ...
  v3 = v2;
  xpc_dictionary_set_uint64(v2, netrbXPCKey[0], 0x3EDuLL);
...
uint64_t ___NETRBClientCopyFixtureForwardedPorts_block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (a2)
  {
    ...
    *(*(*(a1 + 32) + 8) + 24) = result;
    if (*(*(*(a1 + 32) + 8) + 24) == 2001)
    {
      *(*(*(a1 + 40) + 8) + 24) = xpc_dictionary_get_uint64(a2, netrbXPCForwardedLowPort[0]);
      result = xpc_dictionary_get_uint64(a2, netrbXPCForwardedHighPort[0]);
      *(*(*(a1 + 48) + 8) + 24) = result;
    }
  }
