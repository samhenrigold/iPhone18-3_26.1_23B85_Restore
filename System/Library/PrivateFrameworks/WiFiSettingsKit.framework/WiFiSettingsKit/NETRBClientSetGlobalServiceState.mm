...
LABEL_3:
  ...
  v3 = v2;
  xpc_dictionary_set_uint64(v2, netrbXPCKey[0], 0x3ECuLL);
  xpc_dictionary_set_string(v3, netrbXPCClientID[0], (*(a1 + 48) + 32));
  xpc_dictionary_set_uint64(v3, netrbXPCState[0], *(a1 + 56));
  NETRBInfoLog("client %p xpc send -> set state", *(a1 + 48));
...
{
  result = NETRBInfoLog("client %p set state xpc response received", *(a1 + 40));
  if (a2)
  {
