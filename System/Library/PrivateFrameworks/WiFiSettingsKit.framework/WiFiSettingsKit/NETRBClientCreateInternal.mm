...
void ___NETRBClientCreateInternal_block_invoke_2(uint64_t a1, void *a2)
{
  ...
  *(*(*(a1 + 32) + 8) + 24) = xpc_dictionary_get_uint64(a2, netrbXPCResponse[0]);
  if (*(a1 + 48))
  {
    **(a1 + 48) = xpc_dictionary_get_uint64(a2, netrbXPCErrorCode[0]);
  }

  if (*(*(*(a1 + 32) + 8) + 24) != 2001 || (v4 = *(a1 + 40), string = xpc_dictionary_get_string(a2, netrbXPCClientID[0]), snprintf((v4 + 32), 0x100uLL, "%s", string), *(*(a1 + 40) + 288) = 1, *(*(*(a1 + 32) + 8) + 24) != 2001))
  {
LABEL_6:
    v6 = *(a1 + 40);
