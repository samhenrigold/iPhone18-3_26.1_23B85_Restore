...
- (void)register
{
  ...
  if ([qword_1000157E0 containsObject:self])
  {
    v3 = objc_opt_class();
    name = [(CLICommand *)self name];
  ...
  {
    [qword_1000157E0 addObject:self];
    options = [(CLICommand *)self options];
    if (options)
    {
      v5 = qword_1000157E8;
    ...
    v8 = [qword_1000157D8 objectForKeyedSubscript:name2];
    ...
    [qword_1000157D8 setObject:self forKeyedSubscript:name2];
    v17 = 0u;
    v18 = 0u;
    v15 = 0u;
    v16 = 0u;
    ...
    if (v10)
    {
      ...
      do
      {
        for (i = 0; i != v11; i = i + 1)
        {
          ...
          [qword_1000157D8 setObject:self forKeyedSubscript:*(*(&v15 + 1) + 8 * i)];
        }
