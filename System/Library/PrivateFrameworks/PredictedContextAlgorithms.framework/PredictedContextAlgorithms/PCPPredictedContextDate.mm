...
- (id)description
{
  ...
  dictionaryRepresentation = [(PCPPredictedContextDate *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [dictionary setObject:v6 forKey:@"confidenceInterval"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if (has)
  {
    toCopy[1] = *&self->_confidenceInterval;
    *(toCopy + 24) |= 1u;
  }
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 24) & 2) == 0 || self->_date != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) == 0 || self->_confidenceInterval != *(equalCopy + 1))
    {
      goto LABEL_11;
    }
...
- (void)mergeFrom:(id)from
{
  ...
  if (v5)
  {
    self->_confidenceInterval = *(fromCopy + 1);
    *&self->_has |= 1u;
  }
}
