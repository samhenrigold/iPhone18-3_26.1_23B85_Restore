...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_28746A8E0;
  v15 = [MEMORY[0x277CBEB98] setWithArray:&unk_287465930];
  v19[0] = v15;
  v14 = [MEMORY[0x277CBEB98] setWithArray:&unk_287465948];
  v19[1] = v14;
...
{
  v4 = objc_opt_new();
  payloadVisibleName = [(RMModelAccountCalDAVDeclaration *)self payloadVisibleName];
  ...
  payloadHostName = [(RMModelAccountCalDAVDeclaration *)self payloadHostName];
  ...
  payloadPort = [(RMModelAccountCalDAVDeclaration *)self payloadPort];
  [(RMModelPayloadBase *)self serializeIntegerIntoDictionary:v4 usingKey:@"Port" value:payloadPort isRequired:0 defaultValue:0];

  payloadPath = [(RMModelAccountCalDAVDeclaration *)self payloadPath];
  [(RMModelPayloadBase *)self serializeStringIntoDictionary:v4 usingKey:@"Path" value:payloadPath isRequired:0 defaultValue:0];

  payloadAuthenticationCredentialsAssetReference = [(RMModelAccountCalDAVDeclaration *)self payloadAuthenticationCredentialsAssetReference];
