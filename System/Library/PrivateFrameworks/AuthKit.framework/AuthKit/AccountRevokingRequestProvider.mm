...
- (_TtC3akd30AccountRevokingRequestProvider)initWithContext:(id)context urlBagKey:(id)key shouldCacheResource:(BOOL)resource;
- (_TtC3akd30AccountRevokingRequestProvider)initWithContext:(id)context urlBagKey:(id)key shouldCacheResource:(BOOL)resource accountManager:(id)manager;
...
- (_TtC3akd30AccountRevokingRequestProvider)initWithContext:(id)context urlBagKey:(id)key shouldCacheResource:(BOOL)resource
{
  ...
  v9.receiver = self;
  v9.super_class = type metadata accessor for AccountRevokingRequestProvider();
...
- (_TtC3akd30AccountRevokingRequestProvider)initWithContext:(id)context urlBagKey:(id)key shouldCacheResource:(BOOL)resource accountManager:(id)manager
{
  resourceCopy = resource;
  v11.receiver = self;
  v11.super_class = type metadata accessor for AccountRevokingRequestProvider();
...
- (_TtC3akd30AccountRevokingRequestProvider)initWithContext:(id)context url:(id)url
{
  ...
  v12 = v11;
  v13 = type metadata accessor for AccountRevokingRequestProvider();
  v16.receiver = self;
  v16.super_class = v13;
