...
id __55__WFNANPublishTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v10 == 1)
  {
    ...
    else
    {
      ...
      v47 = [v46 localizedStringForKey:@"kWFLocNANNoPublishers" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      v48 = [v12 textLabel];
      [v48 setText:v47];
    }
  }
  ...
  else
  {
    ...
    if (![v7 row])
    {
      ...
      v42 = [v41 localizedStringForKey:@"kWFLocNANServiceName" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      v43 = v96;
...
LABEL_18:
    ...
    if ([v7 row] == 1)
    {
      ...
      v16 = [v15 localizedStringForKey:@"kWFLocNANServiceTypeAdaptive" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      [v14 insertSegmentWithTitle:v16 atIndex:0 animated:1];

      v17 = [v12 segmentedControl];
      v18 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
      v19 = [v18 localizedStringForKey:@"kWFLocNANServiceTypeRealtime" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      [v17 insertSegmentWithTitle:v19 atIndex:1 animated:1];

      v20 = [v12 segmentedControl];
      v21 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
      v22 = [v21 localizedStringForKey:@"kWFLocNANServiceTypeLowLatency" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
...
LABEL_6:
    ...
    if ([v7 row] == 2)
    {
      ...
      v50 = v49[138];
      v41 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANInstanceName" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      v43 = v93;
    ...
    if ([v7 row] == 3)
    {
      ...
      v53 = v52[139];
      v41 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANServiceSpecificInfo" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      v43 = v91;
    ...
    if ([v7 row] == 5)
    {
      ...
      v63 = v62[140];
      v41 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANPortNumber" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      v43 = v88;
    ...
    if ([v7 row] == 6)
    {
      ...
      v68 = [v67 localizedStringForKey:@"kWFLocNANProtocolTypeTCP" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      ...
      v71 = [v70 localizedStringForKey:@"kWFLocNANProtocolTypeUDP" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
    ...
    if ([v7 row] == 7)
    {
      ...
      v76 = v75[142];
      v41 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANPassphrase" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
      v43 = v85;
