...
LABEL_20:
  ...
  v14 = [v22 localizedStringForKey:v23 value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
  v15 = [v12 textLabel];
  [v15 setText:v14];
LABEL_21:
...
void __78__WFNANDiscoveryResultsTableViewController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = [v4 localizedStringForKey:@"kWFLocNANPassphrase" value:&stru_2882E4AD8 table:@"WiFiKitUILocalizableStrings"];
...
void __78__WFNANDiscoveryResultsTableViewController_tableView_didSelectRowAtIndexPath___block_invoke_3(uint64_t a1)
{
  ...
  if (WFCurrentLogLevel(v4, v6) >= 3 && v3)
  {
    ...
    if (os_log_type_enabled(v7, v5))
    {
      ...
      v13 = 138412290;
      v14 = v8;
      _os_log_impl(&dword_273ECD000, v7, v5, "Establishing a data session with discovery result %@", &v13, 0xCu);
    }
  }
  ...
  if (WFCurrentLogLevel(v12, v14) >= 3 && v11)
  {
    ...
    if (os_log_type_enabled(v15, v13))
    {
      ...
      *buf = 138412802;
      ...
      v31 = 2112;
      v32 = v18;
      _os_log_impl(&dword_273ECD000, v15, v13, "NAN data session %@ confirmed for peer (address: %@, serviceSpecificInfo: %@)", buf, 0x20u);
    }
  }
...
- (void)dataSession:(id)session failedToStartWithError:(int64_t)error
{
  ...
  if (WFCurrentLogLevel(v8, v10) >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v11, v9))
    {
      ...
      v17 = 2048;
      errorCopy = error;
      _os_log_impl(&dword_273ECD000, v11, v9, "NAN data session %@ failed to start with error %ld", &v15, 0x16u);
    }
  }
...
- (void)dataSession:(id)session terminatedWithReason:(int64_t)reason
{
  ...
  if (WFCurrentLogLevel(v8, v10) >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v11, v9))
    {
      ...
      v17 = 2048;
      reasonCopy = reason;
      _os_log_impl(&dword_273ECD000, v11, v9, "NAN data session %@ terminated with reason %ld", &v15, 0x16u);
    }
  }
...
- (void)dataSessionRequestStarted:(id)started
{
  ...
  if (WFCurrentLogLevel(v5, v7) >= 3 && v4)
  {
    ...
    if (os_log_type_enabled(v8, v6))
    {
      ...
      v10 = 138412290;
      v11 = v9;
      _os_log_impl(&dword_273ECD000, v8, v6, "NAN data session %@ started", &v10, 0xCu);
    }
  }
}
