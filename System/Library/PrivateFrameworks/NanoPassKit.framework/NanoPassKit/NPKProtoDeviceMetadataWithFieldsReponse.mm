...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoDeviceMetadataWithFieldsReponse;
  v4 = [(NPKProtoDeviceMetadataWithFieldsReponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoDeviceMetadataWithFieldsReponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (deviceMetadata)
  {
    [dictionary setObject:deviceMetadata forKey:@"deviceMetadata"];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v7 = [(NSData *)self->_deviceMetadata copyWithZone:zone];
  v8 = v6[1];
  v6[1] = v7;
...
LABEL_4:
  ...
  {
    v7 = [(NSData *)deviceMetadata isEqual:?];
  }
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(NPKProtoDeviceMetadataWithFieldsReponse *)self setDeviceMetadata:?];
    fromCopy = v5;
  }
}
