...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoStandalonePaymentProvisioningFlowChooseProductStepContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_products count])
  {
    ...
    [dictionary setObject:v4 forKey:@"products"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if ([(NPKProtoStandalonePaymentProvisioningFlowChooseProductStepContext *)self productsCount])
  {
    ...
    productsCount = [(NPKProtoStandalonePaymentProvisioningFlowChooseProductStepContext *)self productsCount];
    if (productsCount)
    {
      v5 = productsCount;
      for (i = 0; i != v5; ++i)
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoStandalonePaymentProvisioningFlowChooseProductStepContext *)self addProducts:*(*(&v9 + 1) + 8 * v8++), v9];
      }
