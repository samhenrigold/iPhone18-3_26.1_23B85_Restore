...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKIDVRemoteDeviceProtoCredentialPropertiesRequest;
  v4 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)&v8 description];
  dictionaryRepresentation = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if ([(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersCount])
  {
    ...
    configuredPartitionsIdentifiersCount = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersCount];
    if (configuredPartitionsIdentifiersCount)
    {
      v5 = configuredPartitionsIdentifiersCount;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersAtIndex:i];
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 2))
  {
    [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self setCredentialIdentifier:?];
  }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self addConfiguredPartitionsIdentifiers:*(*(&v10 + 1) + 8 * i), v10];
      }
