  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self addTransactionsBytes:*(*(&v19 + 1) + 8 * v9++)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self addTransactionPassIDs:*(*(&v15 + 1) + 8 * v14++), v15];
      }
