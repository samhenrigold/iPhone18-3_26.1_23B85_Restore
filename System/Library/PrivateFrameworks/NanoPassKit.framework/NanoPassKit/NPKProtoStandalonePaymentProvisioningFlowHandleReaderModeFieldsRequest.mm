...
- (void)addReaderModeFields:(id)fields;
- (void)copyTo:(id)to;
...
- (void)addReaderModeFields:(id)fields
{
  ...
  [(NSMutableArray *)readerModeFields addObject:fieldsCopy];
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest;
  v4 = [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)&v8 description];
  dictionaryRepresentation = [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [objc_alloc(MEMORY[0x277CBEB18]) initWithCapacity:{-[NSMutableArray count](self->_readerModeFields, "count")}];
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    ...
    [dictionary setObject:v6 forKey:@"readerModeFields"];
  }
...
- (void)copyTo:(id)to
{
  ...
  {
    [toCopy clearReaderModeFields];
    readerModeFieldsCount = [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self readerModeFieldsCount];
    if (readerModeFieldsCount)
    {
      v5 = readerModeFieldsCount;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self readerModeFieldsAtIndex:i];
        [toCopy addReaderModeFields:v7];
      }
    }
  }
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    readerModeFields = self->_readerModeFields;
    if (readerModeFields | equalCopy[1])
    {
      v7 = [(NSMutableArray *)readerModeFields isEqual:?];
    }
...
- (void)mergeFrom:(id)from
{
  ...
  {
    [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self setRequestHeader:?];
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self addReaderModeFields:*(*(&v12 + 1) + 8 * i), v12];
      }
