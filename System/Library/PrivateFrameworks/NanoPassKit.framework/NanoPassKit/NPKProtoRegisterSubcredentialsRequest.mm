...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoRegisterSubcredentialsRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if ([(NPKProtoRegisterSubcredentialsRequest *)self identifiersCount])
  {
    ...
    identifiersCount = [(NPKProtoRegisterSubcredentialsRequest *)self identifiersCount];
    if (identifiersCount)
    {
      v5 = identifiersCount;
      for (i = 0; i != v5; ++i)
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoRegisterSubcredentialsRequest *)self addIdentifiers:*(*(&v9 + 1) + 8 * v8++), v9];
      }
