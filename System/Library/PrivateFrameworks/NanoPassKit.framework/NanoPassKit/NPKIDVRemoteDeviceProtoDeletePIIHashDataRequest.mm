@interface NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest
...
@implementation NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest;
  v4 = [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)&v8 description];
  dictionaryRepresentation = [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if ([(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self configuredPartitionsIdentifiersCount])
  {
    [toCopy clearConfiguredPartitionsIdentifiers];
    configuredPartitionsIdentifiersCount = [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self configuredPartitionsIdentifiersCount];
    if (configuredPartitionsIdentifiersCount)
    {
      v5 = configuredPartitionsIdentifiersCount;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self configuredPartitionsIdentifiersAtIndex:i];
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 2))
  {
    [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self setCredentialIdentifier:?];
  }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self addConfiguredPartitionsIdentifiers:*(*(&v10 + 1) + 8 * i), v10];
      }
