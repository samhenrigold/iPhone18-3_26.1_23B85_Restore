...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoAvailableProductsResponse;
  v4 = [(NPKProtoAvailableProductsResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoAvailableProductsResponse *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 1))
  {
    [(NPKProtoAvailableProductsResponse *)self setAvailableProductsData:?];
    fromCopy = v5;
  }

  if (*(fromCopy + 2))
  {
    [(NPKProtoAvailableProductsResponse *)self setErrorData:?];
    fromCopy = v5;
  }
}
