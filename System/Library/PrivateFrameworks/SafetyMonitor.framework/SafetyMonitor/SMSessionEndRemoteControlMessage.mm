...
- (SMSessionEndRemoteControlMessage)initWithDate:(id)date messageID:(id)d sessionEndReason:(unint64_t)reason sessionID:(id)iD sourceDeviceType:(int64_t)type sourceDeviceID:(id)deviceID;
- (SMSessionEndRemoteControlMessage)initWithDictionary:(id)dictionary;
- (SMSessionEndRemoteControlMessage)initWithSessionEndReason:(unint64_t)reason sessionID:(id)d sourceDeviceType:(int64_t)type sourceDeviceID:(id)iD;
...
- (SMSessionEndRemoteControlMessage)initWithSessionEndReason:(unint64_t)reason sessionID:(id)d sourceDeviceType:(int64_t)type sourceDeviceID:(id)iD
{
  ...
  v14 = [(SMSessionEndRemoteControlMessage *)self initWithDate:v12 messageID:uUID sessionEndReason:reason sessionID:dCopy sourceDeviceType:type sourceDeviceID:iDCopy];
