...
void ___SettingsArchiveDirectory_block_invoke(uint64_t a1)
{
  v8[1] = *MEMORY[0x277D85DE8];
  v1 = PTPrototypeDirectory(a1);
  v2 = [v1 stringByAppendingPathComponent:@"Settings"];
  v3 = _SettingsArchiveDirectory___path;
  _SettingsArchiveDirectory___path = v2;

  v4 = [MEMORY[0x277CCAA00] defaultManager];
  v5 = _SettingsArchiveDirectory___path;
