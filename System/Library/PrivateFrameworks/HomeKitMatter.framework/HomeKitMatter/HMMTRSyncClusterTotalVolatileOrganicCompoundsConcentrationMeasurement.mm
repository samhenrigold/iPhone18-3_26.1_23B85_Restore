...
uint64_t __84__HMMTRSyncClusterTotalVolatileOrganicCompoundsConcentrationMeasurement_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v15_6787;
  logCategory__hmf_once_v15_6787 = v0;
  ...
  if ([cluster2 isEqualToNumber:&unk_283EE83D0])
  {
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        v60 = [(MTRClusterTotalVolatileOrganicCompoundsConcentrationMeasurement *)selfCopy readAttributeMeasurementUnitWithParams:v32];
...
LABEL_39:
  ...
  v49 = v65;
  (handlerCopy)[2](handlerCopy, &unk_283EE83B8, v65);
LABEL_30:
}
