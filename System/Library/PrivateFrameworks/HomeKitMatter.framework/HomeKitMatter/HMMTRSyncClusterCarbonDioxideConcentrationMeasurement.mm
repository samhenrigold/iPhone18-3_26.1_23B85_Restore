...
uint64_t __68__HMMTRSyncClusterCarbonDioxideConcentrationMeasurement_logCategory__block_invoke()
{
  ...
  v1 = logCategory__hmf_once_v15_7078;
  logCategory__hmf_once_v15_7078 = v0;
...
- (void)updatedValuePluginMeasuredValueForAttributeReport:(id)report responseHandler:(id)handler
{
  ...
  if ([cluster2 isEqualToNumber:&unk_283EE84C0])
  {
    attribute2 = [v10 attribute];
    v29 = [attribute2 isEqualToNumber:&unk_283EE84D8];
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        v60 = [(MTRClusterCarbonDioxideConcentrationMeasurement *)selfCopy readAttributeMeasurementUnitWithParams:v32];
        ...
        if (v35)
        {
          ...
          if (integerValue == 2)
          {
            ...
            [v31 floatValue];
            v50 = [v53 numberWithDouble:v54 * 0.000001];
            handlerCopy = v62;
          }
          ...
          else
          {
            ...
            if (integerValue == 1)
            {
              ...
              [v31 floatValue];
              v43 = [v51 numberWithDouble:v52 * 0.001];
            }
              ...
              if (integerValue)
              {
                ...
                if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138543874;
                  ...
                  v70 = 2112;
                  v71 = v35;
                  _os_log_impl(&dword_22AEAE000, v57, OS_LOG_TYPE_ERROR, "%{public}@Cannot convert %@ measured value read from %@ measurement unit to PPM.", buf, 0x20u);
                }

                objc_autoreleasePoolPop(v55);
                handlerCopy = v62;
                v48 = v65;
                (v62)[2](v62, &unk_283EE84A8, v65);
                v32 = v59;
                goto LABEL_39;
              }
          ...
          v48 = v65;
          (handlerCopy)[2](handlerCopy, v50, v65);
        }
...
LABEL_39:
  ...
  v48 = v65;
  (handlerCopy)[2](handlerCopy, &unk_283EE84A8, v65);
LABEL_30:
}
