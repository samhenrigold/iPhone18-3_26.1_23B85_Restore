@interface HMMTRSyncClusterOzoneConcentrationMeasurement
+ (id)logCategory;
...
@implementation HMMTRSyncClusterOzoneConcentrationMeasurement

+ (id)logCategory
{
  if (logCategory__hmf_once_t14_6982 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t14_6982, &__block_literal_global_6983);
  }

  v3 = logCategory__hmf_once_v15_6984;

  return v3;
}

uint64_t __60__HMMTRSyncClusterOzoneConcentrationMeasurement_logCategory__block_invoke()
{
  v0 = HMFCreateOSLogHandle();
  v1 = logCategory__hmf_once_v15_6984;
  logCategory__hmf_once_v15_6984 = v0;
...
- (void)updatedValuePluginMeasuredValueForAttributeReport:(id)report responseHandler:(id)handler
{
  ...
  if ([cluster2 isEqualToNumber:&unk_283EE8478])
  {
    attribute2 = [v10 attribute];
    v29 = [attribute2 isEqualToNumber:&unk_283EE8490];
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        v60 = [(MTRClusterOzoneConcentrationMeasurement *)selfCopy readAttributeMeasurementUnitWithParams:v32];
...
LABEL_39:
  ...
  v49 = v65;
  (handlerCopy)[2](handlerCopy, &unk_283EE8460, v65);
LABEL_30:
}
...
- (id)readAttributePluginMeasuredValueWithParams:(id)params
{
  ...
  v6 = [(MTRClusterOzoneConcentrationMeasurement *)self readAttributeMeasurementUnitWithParams:v5];
  ...
  {
    v60 = v6;
    v11 = [(MTRClusterOzoneConcentrationMeasurement *)self readAttributeMeasuredValueWithParams:v5];
