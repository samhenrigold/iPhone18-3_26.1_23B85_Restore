...
- (void)_bleServerAcceptConnecton:(id)connecton
{
  ...
  if (ucat->var0 <= 90)
  {
    ...
    LogPrintF(ucat, "[SKSetupMacSetupServer _bleServerAcceptConnecton:]", 90, "### Reject BLE connection when already connected: %@ vs %@", v7, v5);
  }
...
- (void)_bleServerEnsureStopped
{
  if (self->_bleServer)
  {
    ...
    if (ucat->var0 <= 30)
    {
      ...
      {
LABEL_4:
        LogPrintF(ucat, "[SKSetupMacSetupServer _bleServerEnsureStopped]", 30, "BLE server stop");
        goto LABEL_6;
      }
...
- (void)_bleServerEnsureStarted
{
  if (!self->_bleServer)
  {
    ...
    v7[1] = 3221225472;
    v7[2] = __48__SKSetupMacSetupServer__bleServerEnsureStarted__block_invoke;
    v7[3] = &unk_279BB8180;
    v7[4] = v3;
    v7[5] = self;
    ...
    if (ucat->var0 <= 30)
    {
      ...
      LogPrintF(ucat, "[SKSetupMacSetupServer _bleServerEnsureStarted]", 30, "BLE server start: %@", v3);
    }

LABEL_6:
    v6[0] = MEMORY[0x277D85DD0];
    v6[1] = 3221225472;
    v6[2] = __48__SKSetupMacSetupServer__bleServerEnsureStarted__block_invoke_2;
    v6[3] = &unk_279BB8838;
    v6[4] = v3;
    v6[5] = self;
...
void __48__SKSetupMacSetupServer__bleServerEnsureStarted__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (*v8 <= 30)
  {
    ...
    LogPrintF(v8, "[SKSetupMacSetupServer _bleServerEnsureStarted]_block_invoke", 30, "BLE server incoming connection: %@", v9);
    v9 = v11;
    v6 = *(a1 + 40);
  }
  ...
  if (v5 == v4[27])
  {
    ...
    if (v3)
    {
      if (v7 <= 90)
      {
        ...
        v8 = CUPrintNSError();
        LogPrintF(v6, "[SKSetupMacSetupServer _bleServerEnsureStarted]_block_invoke_2", 90, "### BLE server failed: %@", v8);
      }
...
LABEL_13:
    ...
    if (v7 <= 30)
    {
      ...
      LogPrintF(v6, "[SKSetupMacSetupServer _bleServerEnsureStarted]_block_invoke_2", 30, "BLE server started: %@", v5);
      v4 = *(a1 + 40);
    }
...
- (void)_bleAdvertiserEnsureStopped
{
  ...
  if (bleAdvertiser)
  {
    ...
    if (ucat->var0 <= 30)
    {
      ...
      {
LABEL_4:
        LogPrintF(ucat, "[SKSetupMacSetupServer _bleAdvertiserEnsureStopped]", 30, "BLE advertiser stop: %@", bleAdvertiser);
        bleAdvertiser = self->_bleAdvertiser;
        goto LABEL_6;
      }
...
- (void)_bleAdvertiserEnsureStarted
{
  if (!self->_bleAdvertiser)
  {
    ...
    if (ucat->var0 <= 30)
    {
      ...
      LogPrintF(ucat, "[SKSetupMacSetupServer _bleAdvertiserEnsureStarted]", 30, "BLE advertiser start: %@", v3);
    }

LABEL_6:
    v6[0] = MEMORY[0x277D85DD0];
    v6[1] = 3221225472;
    v6[2] = __52__SKSetupMacSetupServer__bleAdvertiserEnsureStarted__block_invoke;
    v6[3] = &unk_279BB8838;
    v6[4] = v3;
    v6[5] = self;
...
LABEL_9:
    ...
    if (*v5 <= 90)
    {
      ...
      v6 = CUPrintNSError();
      LogPrintF(v5, "[SKSetupMacSetupServer _bleAdvertiserEnsureStarted]_block_invoke", 90, "### BLE advertiser failed: %@", v6);
    }
