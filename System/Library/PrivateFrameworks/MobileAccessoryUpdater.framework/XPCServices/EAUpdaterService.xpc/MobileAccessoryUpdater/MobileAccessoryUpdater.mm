...
void sub_100001858(uint64_t a1, void *a2, void *a3, void *a4)
{
  v7 = a2;
  v8 = a3;
  v9 = a4;
...
Class sub_100001D60(uint64_t a1)
{
  sub_100001BF0();
...
NSError *sub_1000064B4(uint64_t a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
...
void *sub_100008F14(void *result)
{
  if (*(result[4] + 448) == 1)
  {
    v1 = result;
...
id sub_100009198(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    else
    {
      ...
      v10 = *(a1 + 40);
      v16 = sub_1000064B4(0, 20, @"Device unexpectedly disconnected", v11, v12, v13, v14, v15, v20);
      v17 = v10;
      v18 = v9;
    }
...
id sub_1000096C0(uint64_t a1)
{

  return [v1 rangeOfString:a1 options:1];
}

void sub_100009718(dispatch_queue_t queue@<X3>, void *a2@<X0>, uint64_t a3@<X1>, uint64_t a4@<X2>, void *a5@<X8>)
{
  a2[2] = v6;
  a2[3] = v5;
  a2[4] = a3;
...
void sub_10000B6BC(id a1)
{
  v1 = "$SIDEBUILD_PARENT_TRAIN";
  if (![[NSString isEqualToString:@"%s" stringWithFormat:?], "isEqualToString:", &stru_100021DB8]&& ![[NSString isEqualToString:@"%s" stringWithFormat:?], "isEqualToString:", @"$SIDEBUILD_PARENT_TRAIN"]|| (v1 = "LuckB", ![[NSString isEqualToString:@"%s" stringWithFormat:?], "isEqualToString:", &stru_100021DB8]) && ![[NSString isEqualToString:@"%s" stringWithFormat:?], "isEqualToString:", @"$RC_RELEASE"])
  {
    qword_10002ADB8 = v1;
  }
}

int64_t sub_10000BCB8(id a1, NSURL *a2, NSURL *a3)
{
  v6 = 0;
...
id sub_10000C2E8(uint64_t a1, void *a2)
{
...
id sub_10000C70C(uint64_t a1, void *a2)
{
  if (a2)
  {
...
id sub_10000CAAC(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
id sub_10000CB1C(uint64_t a1, double a2)
{
...
id sub_10000CBAC(uint64_t a1, void *a2)
{
...
id sub_10000CC70(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (a3)
  {
    return sub_10000FD08(a1);
  }
...
id generateHashForDataAtLocationAsData(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  if (v4 && v5)
  {
    ...
    do
    {
      ...
      v8 = [(NSFileHandle *)v5 uarpReadDataUpToLength:0x4000 error:a3, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41];
      [v8 bytes];
      [v8 length];
      CCDigestUpdate();
      v9 = [v8 length];
    ...
    v11 = &v12 - ((__chkstk_darwin() + 15) & 0xFFFFFFFFFFFFFFF0);
    CCDigestFinal();
    if ([(NSFileHandle *)v5 uarpCloseAndReturnError:a3])
    {
      return [[NSData alloc] initWithBytes:v11 length:OutputSize];
    }
...
id generateHashForDataAtLocation(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  v5 = [HashForDataAtLocationAsData bytes];
...
id sub_10000D458(NSString *a1, _BYTE *a2, void *a3)
{
  NSLog(a1);
  *a2 = -1;
...
id sub_10000DBB4(uint64_t a1, void *a2)
{
...
void sub_10000EB14(void ***a1)
{
  v1 = sub_100009684(a1);
  v1[1] = 3221225472;
  sub_100009718(v4, v1, v2, v3, v5);
}

void sub_10000EB54(void ***a1)
{
  v1 = sub_100009684(a1);
  v1[1] = 3221225472;
  sub_100009718(v4, v1, v2, v3, v5);
...
uint64_t sub_10000EB94(NSObject **a1, void ***a2, void **a3, void **a4)
{
  v5 = *a1;
...
NSError *sub_10000FB70(NSError *result, uint64_t a2, void *a3, NSError **a4, _BYTE *a5)
{
  if (a4)
  {
