...
- (BOOL)prepareFirmwareBundlesFromDropbox:(id)dropbox error:(id *)error
{
  ...
  if (!MGGetBoolAnswer())
  {
    v16 = @"Not Applicable.";
LABEL_16:
    sub_10000FB70(v34, v16, &v34[0]._reserved, error, &v25);
    return v25;
  }
...
LABEL_13:
    ...
    if (options)
    {
      ...
      if ([options objectForKey:@"LocalFWImage"])
      {
        ...
        if (v19 && !v21)
        {
          sub_10000FC2C(p_delegate, v19);
          goto LABEL_28;
        }

        if (v20 && !v22)
        {
          sub_10000FC68(p_delegate, v20);
          goto LABEL_28;
        }
