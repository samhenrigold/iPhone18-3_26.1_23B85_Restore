...
- (FirmwareBundle)initWithBundle:(id)bundle
{
  ...
  {
    [sub_1000108A8() parseFileName:v8 intoPath:? andExtension:?];
    v14 = -[NSDictionary fileSize]([+[NSFileManager defaultManager](NSFileManager attributesOfItemAtPath:"attributesOfItemAtPath:error:" error:sub_1000108B8(), 0], "fileSize");
  ...
  {
    v19 = [(FirmwareBundle *)v4 parseSRECFile:sub_1000108B8() withDefaultByteValue:v16];
    goto LABEL_16;
  }
...
LABEL_18:
  *(&v4->super.isa + v20) = v19;
  [sub_1000108A8() parseFileName:? intoPath:? andExtension:?];
  v4->_buildManifest = [NSDictionary dictionaryWithContentsOfFile:sub_1000108B8()];
  if (v9)
  {
    [sub_1000108A8() parseFileName:v9 intoPath:? andExtension:?];
    if ([v35 caseInsensitiveCompare:@"bin"])
    {
      v21 = [(FirmwareBundle *)v4 parseResourceFileIntoData:sub_1000108B8()];
    }

    else
    {
      v21 = [NSData dataWithContentsOfFile:sub_1000108B8()];
    }
  ...
  {
LABEL_25:
    [sub_1000108A8() parseFileName:v10 intoPath:? andExtension:?];
    if ([v35 caseInsensitiveCompare:@"bin"])
    {
      v22 = [(FirmwareBundle *)v4 parseResourceFileIntoData:sub_1000108B8()];
    }

    else
    {
      v22 = [NSData dataWithContentsOfFile:sub_1000108B8()];
    }
...
LABEL_29:
  if (v11)
  {
    [sub_1000108A8() parseFileName:v11 intoPath:? andExtension:?];
    if ([v35 caseInsensitiveCompare:@"bin"])
    {
      v23 = [(FirmwareBundle *)v4 parseResourceFileIntoData:sub_1000108B8()];
    }

    else
    {
      v23 = [NSData dataWithContentsOfFile:sub_1000108B8()];
    }
