...
- (EAFirmwareUpdater)initWithDeviceClass:(id)class assetType:(id)type skipDFU:(BOOL)u byteEscape:(BOOL)escape skipReconnect:(BOOL)reconnect skipVersionCheck:(BOOL)check options:(id)options serialNum:(id)self0
{
  ...
  v15->_currentSessionTimeTaken = &off_100031778;
  v15->_cumulativeBytesDownloaded = &off_100031778;
  v15->_totalBytesForCompleteUpdate = &off_100031778;
  v15->_cumulativeProgressPercent = &off_100031778;
  v15->_cumulativeTimeTaken = &off_100031778;
  v15->_cumulativeCloakTime = &off_100031778;
  v15->_resumeCount = &off_100031778;
...
- (id)validateAssetAttributes:(id)attributes
{
  if (attributes)
  {
    ...
    {
      sub_100014CA0(0, v11, v12, v13, v14, v15, v16, v17);
    }
  ...
  else
  {
    ...
    return sub_100006010(0, 3, @"No asset attributes", v3, v4, v5, v6, v7, v21);
  }
}
...
LABEL_88:
    v47 = sub_100006010(0, 21, v46, v5, v6, v7, v8, v9, v52);
    v11 = 0;
    v19 = 0;
    v45 = 1;
    goto LABEL_109;
...
LABEL_76:
          ...
          v50 = 21;
LABEL_106:
          v47 = sub_100006010(0, v50, v49, v20, v21, v22, v23, v24, v52);
          goto LABEL_107;
        }
  ...
  v47 = sub_100006010(0, 21, v48, v12, v13, v14, v15, v16, @"PersonalizationRequest");
  v19 = 0;
LABEL_107:
  if (!v47)
  {
...
LABEL_26:
  ...
  v34 = 19;
LABEL_36:
  v31 = sub_100006010(0, v34, v33, v15, v16, v17, v18, v19, "[EAFirmwareUpdater applyFirmware:progress:update:personalization:]");
  if (v31)
  {
    v36 = @"Event";
...
- (id)openSession
{
  ...
  return sub_100006010(0, v16, v15, v3, v4, v5, v6, v7, v18);
}
...
LABEL_14:
        ...
        [(EAFirmwareUpdater *)self updateComplete:v9 error:sub_100006010(0, 11, v8, v10, v11, v12, v13, v14, v15)];
      }
    }
  }
        ...
        if (result)
        {
          ...
          while (2)
          {
            ...
            do
            {
              ...
              {
                if (sub_10000921C([(EAFirmwareUpdater *)self bootloaderProtocol]) != 0x7FFFFFFFFFFFFFFFLL)
                {
                  return [(EAFirmwareUpdater *)self bootloaderProtocol];
                }

                if (sub_10000921C([(EAFirmwareUpdater *)self appProtocol]) != 0x7FFFFFFFFFFFFFFFLL)
                {
...
LABEL_13:
    v12 = sub_100006010(0, v15, v14, v3, v4, v5, v6, v7, v16);
    goto LABEL_11;
  }
