...
+ (id)hap_cacheInstanceForMetadata:(id)metadata
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = objc_opt_class();
      v14 = v25;
      _os_log_impl(&dword_22AADC000, v10, OS_LOG_TYPE_INFO, "%{public}@Object %@ of class %@ mismatches cache class %@:", &v18, 0x2Au);
    }
  ...
  if (([metadataCopy conformsToProtocol:&unk_283EACBD0] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = objc_opt_class();
      v16 = v23;
      _os_log_impl(&dword_22AADC000, v10, OS_LOG_TYPE_INFO, "%{public}@Object %@ of class %@ does not conform to NSCopying protocol", &v18, 0x20u);
    }
