...
- (NSString)description
{
  ...
  v12 = [v3 stringWithFormat:@"<HAPCharacteristicValueTransition HAPInstanceID=%@, controllerContext=%@, endBehavior=%@, linearTransition=%@, linearDerivedTransition=%@, valueUpdateTimeInterval=%@, notifyValueChangeThreshold=%@, notifyTimeIntervalThreshold=%@>", hAPInstanceID, controllerContext, endBehavior, linearTransition, linearDerivedTransition, valueUpdateTimeInterval, notifyValueChangeThreshold, notifyTimeIntervalThreshold];
...
LABEL_40:
  ...
  if (notifyValueChangeThreshold)
  {
    ...
    {
      bytes4 = [v7 bytes];
      v34 = bytes4 + [v7 length];
      while (1)
      {
        v35 = (v34 - bytes4) >= 255 ? 255 : v34 - bytes4;
        v9 = TLV8BufferAppend();
        if (v9)
        {
          goto LABEL_4;
  ...
  while (1)
  {
    ...
    if (v72[0] > 4u)
    {
      ...
      if (v72[0] > 6u)
      {
        ...
        v60 = v9;
        v16 = HAPTLVParseContiguousTlvs(7, bytes, v14, v70, &v60);
        v31 = v60;
...
LABEL_23:
        ...
        v63 = v9;
        v16 = HAPTLVParseContiguousTlvs(5, bytes, v14, v70, &v63);
        v31 = v63;
