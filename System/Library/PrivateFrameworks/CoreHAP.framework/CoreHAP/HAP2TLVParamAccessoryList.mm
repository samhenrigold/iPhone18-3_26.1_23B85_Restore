...
- (id)serializeWithError:(id *)error
{
  ...
  v27 = 0u;
  accessorySignatureList = [(HAP2TLVParamAccessoryList *)self accessorySignatureList];
  v6 = [accessorySignatureList countByEnumeratingWithState:&v26 objects:v30 count:16];
  if (!v6)
  {
LABEL_17:
...
LABEL_19:
    ...
    v7 = [accessorySignatureList countByEnumeratingWithState:&v26 objects:v30 count:16];
    v9 = 0;
    if (!v7)
    {
      goto LABEL_17;
