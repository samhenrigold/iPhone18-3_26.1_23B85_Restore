...
void __26__RPEndpoint_nullEndpoint__block_invoke()
{
  ...
  v1 = nullEndpoint_sObj;
  nullEndpoint_sObj = v0;
}
...
- (id)descriptionWithLevel:(int)level
{
  ...
  if (shouldPrintSensitiveData(v5, v6))
  {
    name = self->_name;
    if (name)
    {
    ...
    if (activityLevel)
    {
      ...
      {
        v25 = off_1E7C941E8[activityLevel - 1];
      }
    ...
    if (self->_operatingSystemVersion.majorVersion)
    {
      ...
      patchVersion = self->_operatingSystemVersion.patchVersion;
      v77 = v7;
      v49 = RPNSOperatingSystemVersionToString(&v75);
  ...
  {
    v70 = v7;
    NSAppendPrintF(&v70, ", SF %#ll{flags}", statusFlags, &unk_1B6F2E210);
    v64 = v70;
...
LABEL_16:
  ...
  patchVersion = self->_operatingSystemVersion.patchVersion;
  v20 = RPNSOperatingSystemVersionToString(&v46);
  v41 = v20;
  if (v8)
  {
    v21 = v20;
    ...
    {
      objc_msgSend_operatingSystemVersion(v8);
      v22 = RPNSOperatingSystemVersionToString(&v46);
      v23 = v21;
      v24 = v22;
      v25 = v24;
      if (v23 == v24)
...
LABEL_28:
  ...
  {
    objc_msgSend_operatingSystemVersion(v8);
    v28 = RPModelOSVersionToSourceVersionString(modelIdentifier, &v46);
  }
...
LABEL_34:
  ...
  v37 = vorrq_s8(vandq_s8(vshlq_u64(v36, xmmword_1B6F2E1B0), xmmword_1B6F2E1E0), vandq_s8(vshlq_u64(v36, xmmword_1B6F2E1C0), xmmword_1B6F2E1D0));
...
LABEL_18:
  ...
  patchVersion = self->_operatingSystemVersion.patchVersion;
  v20 = RPNSOperatingSystemVersionToString(&v38);
...
LABEL_25:
    ...
    RPStringToOperatingSystemVersion(productVersion3, &v38);
...
LABEL_26:
  ...
  RPStringToOperatingSystemVersion(productVersion4, &v38);
  v31 = RPModelOSVersionToSourceVersionString(model, &v38);
...
LABEL_26:
  ...
  patchVersion = self->_operatingSystemVersion.patchVersion;
  v29 = RPNSOperatingSystemVersionToString(&v44);
  if (deviceCopy)
  {
    ...
    objc_msgSend_operatingSystemVersion(deviceCopy);
    v30 = RPNSOperatingSystemVersionToString(&v44);
    v31 = v29;
    v32 = v30;
    v33 = v32;
    if (v31 == v32)
...
LABEL_38:
  ...
  patchVersion = 0;
LABEL_41:
  v36 = RPModelOSVersionToSourceVersionString(v16, &v44);
  v37 = *p_sourceVersion;
  *p_sourceVersion = v36;
...
LABEL_95:
  ...
  patchVersion = self->_operatingSystemVersion.patchVersion;
  v83 = RPNSOperatingSystemVersionToString(&v134);
  v125 = v83;
  if (!v43)
  {
    goto LABEL_107;
  ...
  {
    objc_msgSend_operatingSystemVersion(v43);
    v85 = RPNSOperatingSystemVersionToString(&v134);
    v86 = v84;
    v87 = v85;
    v88 = v87;
    if (v86 == v87)
...
LABEL_104:
  ...
  {
    objc_msgSend_operatingSystemVersion(v43);
    v90 = RPModelOSVersionToSourceVersionString(v74, &v134);
    sourceVersion = self->_sourceVersion;
...
LABEL_107:
  ...
  v109 = vandq_s8(vshlq_u32(vdupq_n_s32(deviceFlags), xmmword_1B6F2E1F0), xmmword_1B6F2E200);
...
- (unsigned)updateTrustStatusFlagsWithIdentity:(id)identity
{
  ...
  v6 = statusFlags | qword_1B6F2E3E0[v5];
  if (v6 == statusFlags)
  {
    return 0;
  }
