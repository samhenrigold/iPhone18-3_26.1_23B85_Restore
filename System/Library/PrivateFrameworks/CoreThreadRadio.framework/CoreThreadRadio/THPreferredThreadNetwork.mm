...
LABEL_8:
  ...
  if (ipv6NwSignature)
  {
    ...
    v18 = base64StringFromData_0(ipv4NwSignature2);
    v29[5] = v18;
    ...
    v21 = base64StringFromData_0(ipv6NwSignature2);
    v29[6] = v21;
  ...
  if (!v50)
  {
    ...
    else
    {
      ...
      if (!v26)
      {
        ...
        v41 = base64StringFromData_0(ipv6NwSignature2);
        v57[6] = v41;
    ...
    v29 = base64StringFromData_0(ipv6NwSignature3);
    v55[6] = v29;
...
+ (id)keyChainQueryForDeletePreferredNetworkRecordOperationForNetworkName:(id)name
{
  ...
  extendedPANID = [network2 extendedPANID];
  v8 = base64StringFromData_0(extendedPANID);
  v12[1] = v8;
...
+ (id)keyChainQueryForPreferredNetworkRecordsOperationForWifiNetworkWithSignature:(id)signature
{
  ...
  if (v5)
  {
    ...
    v7 = base64StringFromData_0(ipv4NwSignature2);
    v23[0] = v7;
...
LABEL_5:
  ...
  wifiPassword = base64StringFromData_0(wifiSSID);
  v19[1] = wifiPassword;
...
LABEL_5:
  ...
  v15 = base64StringFromData_0(ipv6NwSignature2);
  v17[1] = v15;
...
+ (id)keyChainQueryForDeletePreferredNetworkRecord:(id)record
{
  ...
  extendedPANID = [network2 extendedPANID];
  v4 = base64StringFromData_0(extendedPANID);
  v20[1] = v4;
  v19[2] = kSecAttrPort;
  networkSignature = [recordCopy networkSignature];
  ipv4NwSignature = [networkSignature ipv4NwSignature];
  v7 = base64StringFromData_0(ipv4NwSignature);
  v20[2] = v7;
  v19[3] = kSecAttrProtocol;
  networkSignature2 = [recordCopy networkSignature];
  ipv6NwSignature = [networkSignature2 ipv6NwSignature];
  v10 = base64StringFromData_0(ipv6NwSignature);
  v20[3] = v10;
...
LABEL_6:
  ...
  if (v7)
  {
    v27[0] = kSecAttrPort;
    ipv4NwSignature2 = [signatureCopy ipv4NwSignature];
    v9 = base64StringFromData_0(ipv4NwSignature2);
    v28[0] = v9;
    v27[1] = kSecAttrProtocol;
    ipv6NwSignature2 = [signatureCopy ipv6NwSignature];
    v11 = base64StringFromData_0(ipv6NwSignature2);
    v28[1] = v11;
