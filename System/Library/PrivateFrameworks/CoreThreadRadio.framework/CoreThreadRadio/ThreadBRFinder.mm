...
LABEL_35:
  ...
  if (v25 != 8)
  {
    ...
    {
      [ThreadBRFinder matchTheListWithServer:v10];
    }
  ...
  while (1)
  {
    ...
    if (v61 != 16)
    {
      ...
      if (v48)
      {
        ...
        {
          v10 = v63;
          [ThreadBRFinder matchTheListWithServer:v34];
          v42 = v64;
        }
      ...
      if ((!self->_networkNameToFind || v9) && ((p_extendedPANIDToFind = &self->_extendedPANIDToFind, !self->_extendedPANIDToFind) || v10) && (!v11 ? (v21 = self->_borderAgentIdToFind == 0) : (v21 = 1), v21 && v12))
      {
        ...
        else
        {
          ...
          if (v24 != 8)
          {
            ...
            {
              [(ThreadBRFinder *)v10 matchTheRecord:v11];
            }
...
- (void)matchTheListWithServer:(void *)a1 .cold.3(void *a1)
{
  v1 = [a1 network];
  v2 = [v1 extendedPANID];
  OUTLINED_FUNCTION_15();
...
- (void)matchTheListWithServer:(void *)a1 .cold.4(void *a1)
{
  v1 = [a1 network];
  v2 = [v1 extendedPANID];
  OUTLINED_FUNCTION_15();
