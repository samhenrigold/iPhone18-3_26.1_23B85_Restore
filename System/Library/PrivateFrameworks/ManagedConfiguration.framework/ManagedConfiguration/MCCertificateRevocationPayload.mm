...
- (MCCertificateRevocationPayload)initWithDictionary:(id)dictionary profile:(id)profile outError:(id *)error
{
  ...
  v51.receiver = self;
  v51.super_class = MCCertificateRevocationPayload;
  ...
  v50 = 0;
  v11 = [dictionaryCopy MCValidateAndRemoveArrayOfClass:objc_opt_class() withKey:@"EnabledForCerts" isRequired:0 outError:&v50];
  v12 = v50;
  if (v12)
  {
    goto LABEL_31;
  ...
  v14 = v13;
  v15 = *v47;
  v43 = *MEMORY[0x1E697AF48];
  v42 = *MEMORY[0x1E697AF50];
  v41 = v11;
  while (2)
  {
    for (i = 0; i != v14; ++i)
...
- (id)stubDictionary
{
  ...
  v21.receiver = self;
  v21.super_class = MCCertificateRevocationPayload;
