...
- (SKUIImageGridViewReuseView)init
{
  ...
  v7.receiver = self;
  v7.super_class = SKUIImageGridViewReuseView;
...
void *__77__SKUIImageGridViewReuseView_prefetchResourcesForViewElement_reason_context___block_invoke(uint64_t a1, uint64_t a2)
{
...
+ (CGSize)sizeThatFitsWidth:(double)width viewElement:(id)element context:(id)context
{
  [SKUIImageGridViewReuseView preferredSizeForViewElement:element context:context, width];
  result.height = v6;
  result.width = v5;
  return result;
}
...
- (void)reloadWithViewElement:(id)element width:(double)width context:(id)context
{
  ...
  v15 = 3221225472;
  v16 = __66__SKUIImageGridViewReuseView_reloadWithViewElement_width_context___block_invoke;
  v17 = &unk_2781FC080;
  v18 = elementCopy;
  v19 = contextCopy;
  selfCopy = self;
  ...
  [(SKUIImageGridViewReuseView *)self setImageViews:v11, v14, v15, v16, v17];
}
...
- (id)viewForElementIdentifier:(id)identifier
{
  ...
  flattenedChildren = [(SKUIViewElement *)self->_imageGridViewElement flattenedChildren];
  v11[0] = MEMORY[0x277D85DD0];
  v11[1] = 3221225472;
