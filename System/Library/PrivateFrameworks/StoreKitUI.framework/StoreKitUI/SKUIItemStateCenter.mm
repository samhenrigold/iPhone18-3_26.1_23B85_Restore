...
- (void)dealloc
{
  ...
  v7 = *SKUIWeakLinkedSymbolForString("MPMediaLibraryDidChangeNotification", v6);
  ...
  v10.receiver = self;
  v10.super_class = SKUIItemStateCenter;
  [(SKUIItemStateCenter *)&v10 dealloc];
}
...
void __59__SKUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_3(uint64_t a1)
{
  ...
  v14 = v7;
  v8 = v6;
  v9 = _os_log_send_and_compose_impl(v4, 0, 0, 0, &dword_215BAE000, v5, 2, "[%@]: Unable to find job for item with itemID: %lld. Resetting state.", &v11, 22);
...
void *__39__SKUIItemStateCenter_isGratisEligible__block_invoke_2(uint64_t a1, uint64_t a2, void *a3, _BYTE *a4)
{
  result = [a3 state];
  if ((result & 0x10) != 0)
  {
...
void *__47__SKUIItemStateCenter_isRunningInStoreDemoMode__block_invoke(void *result)
{
  v1 = result;
  v2 = *(result[4] + 160);
  if (v2 == 255)
...
void *__42__SKUIItemStateCenter_reloadMediaLibrary___block_invoke(uint64_t a1)
{
...
void __50__SKUIItemStateCenter_beginObservingLibraryItems___block_invoke_2(uint64_t a1)
{
  ...
  v3 = SKUIMediaPlayerFramework(v13, v2);
  v4 = SKUIWeakLinkedClassForString(&cfstr_Mpmedialibrary_0.isa, v3);
  v5 = [v4 defaultMediaLibrary];
  [v5 beginGeneratingLibraryChangeNotifications];

  v8 = SKUIMediaPlayerFramework(v6, v7);
  v9 = SKUIWeakLinkedSymbolForString("MPMediaLibraryDidChangeNotification", v8);
  v10 = *(a1 + 32);
  v11 = *v9;
      ...
      for (i = 0; i != v60; ++i)
      {
        ...
        if (!v6)
        {
          ...
          if (v20)
          {
            ...
            v72 = v26;
            LODWORD(v50) = 22;
            v27 = _os_log_send_and_compose_impl(v20, 0, 0, 0, &dword_215BAE000, v21, 2, "[%@]: Complete job: Could not find state for job: %@", &v69, v50);
            goto LABEL_31;
          }
...
LABEL_35:
        ...
        if ((v9 & 0x23) == 0)
        {
          ...
          v72 = v26;
          LODWORD(v50) = 22;
          v27 = _os_log_send_and_compose_impl(v28, 0, 0, 0, &dword_215BAE000, v21, 2, "[%@]: Completed without any relevant state flags for job: %@", &v69, v50);
LABEL_31:
          v31 = v27;
        ...
        if (!v8)
        {
          ...
          if (v33)
          {
            ...
            v72 = v38;
            LODWORD(v50) = 22;
            v39 = _os_log_send_and_compose_impl(v33, 0, 0, 0, &dword_215BAE000, v34, 2, "[%@]: Complete job: Canceled job: %@", &v69, v50);
...
LABEL_44:
        ...
        v76 = v11;
        LODWORD(v50) = 42;
        v17 = _os_log_send_and_compose_impl(v13, 0, 0, 0, &dword_215BAE000, v14, 2, "[%@]: Complete job: %@ phase: %ld state: %ld", &v69, v50);
...
LABEL_47:
        ...
        if ((v18 & 4) == 0)
        {
          ...
          if (v45)
          {
            ...
            v76 = v41;
            LODWORD(v50) = 42;
            v48 = _os_log_send_and_compose_impl(v45, 0, 0, 0, &dword_215BAE000, v44, 2, "[%@]: Adding installed state following finished job: %@ phase: %ld state: %ld", &v69, v50);
        ...
        if (v10)
        {
          ...
          if (v11)
          {
            ...
            if (v18)
            {
              ...
              v46 = v21;
              LODWORD(v27) = 42;
              v23 = _os_log_send_and_compose_impl(v18, 0, 0, 0, &dword_215BAE000, v17, 2, "[%@]: State job: %@ phase: %ld state: %ld", &v39, v27);
          ...
          if (v12)
          {
            ...
            if (v13)
            {
              ...
              if (v15 && ([v8 downloadPhaseIdentifier], v16 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v15, "setDownloadPhase:", v16), v16, objc_msgSend(v15, "downloadProgress"), v18 = v17, objc_msgSend(v8, "percentComplete"), *&v19 = v19, objc_msgSend(v15, "setDownloadProgress:", v19), objc_msgSend(v37, "addObject:", v15), objc_msgSend(*(*(v14 + 40) + 152), "itemHasParent:", v13)))
              {
                ...
                if (!v21)
                {
                  v21 = objc_alloc_init(SKUIItemState);
                  [v20 itemIdentifier];
                  v22 = v35 = v20;
                  [(SKUIItemState *)v21 setItemIdentifier:v22];

                  [(SKUIItemState *)v21 setStoreIdentifier:v35];
                  v23 = [v15 downloadPhase];
                  [(SKUIItemState *)v21 setDownloadPhase:v23];

                  v20 = v35;
                  -[SKUIItemState setDownloadContentFlags:](v21, "setDownloadContentFlags:", [v15 downloadContentFlags]);
                  [*(*(v14 + 40) + 88) setObject:v21 forKey:v35];
                }

                v24 = [*(*(v14 + 40) + 152) siblingItemsForItem:v13];
                [(SKUIItemState *)v21 downloadProgress];
                v26 = v25;
                v34 = v24;
                v27 = [v24 count];
                if ((v26 - (v18 / v27)) >= 0.0)
                ...
                *&v29 = (*&v29 / v27) + v28;
                ...
                [(SKUIItemState *)v21 setDownloadProgress:v29];
                if (([v33 isEqual:v32] & 1) == 0)
                {
                  [v8 downloadPhaseIdentifier];
                  v30 = v36 = v20;
                  [(SKUIItemState *)v21 setDownloadPhase:v30];
...
LABEL_15:
        ...
        v20 = v17;
        LODWORD(v24) = 12;
        v21 = _os_log_send_and_compose_impl(v15, 0, 0, 0, &dword_215BAE000, v16, 16, "[%@]: Skipped download without identifier.", &v35, v24);
...
LABEL_38:
        ...
        v31 = v29;
        LODWORD(v35) = 12;
        v32 = _os_log_send_and_compose_impl(v28, 0, 0, 0, &dword_215BAE000, v30, 16, "[%@]: Skipped download without identifier.", &v56, v35);
...
void *__56__SKUIItemStateCenter__restrictionsChangedNotification___block_invoke(void *result)
{
  v1 = result[4];
  if (*(v1 + 16) == 255)
  {
...
- (id)_addState:(unint64_t)state forItemIdentifier:(id)identifier
{
  ...
  v18 = objc_opt_class();
  v14 = v18;
  v15 = _os_log_send_and_compose_impl(v12, 0, 0, 0, &dword_215BAE000, oSLogObject, 16, "[%@]: _addState:forItemIdentifier: Tried to add a state for nil itemID.", &v17, 12);
      ...
      else if ((state & 0x10) != 0)
      {
        ...
        else
        {
          ...
          if (v26)
          {
            ...
            v37 = objc_opt_class();
            v28 = v37;
            v31 = _os_log_send_and_compose_impl(v30, 0, 0, 0, &dword_215BAE000, oSLogObject, 2, "[%@]: Ignoring non-app gratis purchase request.", &v36, 12);
...
void __83__SKUIItemStateCenter__setAvailableAppstoredUpdatesWithUpdates_decrementLoadCount___block_invoke(uint64_t a1, uint64_t a2)
{
  v47 = *MEMORY[0x277D85DE8];
  v3 = objc_opt_new();
  v34 = 0u;
  ...
  v37 = 0u;
  obj = *(a1 + 32);
  v33 = [obj countByEnumeratingWithState:&v34 objects:v46 count:16];
  if (v33)
  {
    v4 = *v35;
    v29 = v3;
    ...
    do
    {
      for (i = 0; i != v33; ++i)
      {
        ...
        v6 = *(*(&v34 + 1) + 8 * i);
        v7 = -[SKUIStoreIdentifier initWithLongLong:]([SKUIStoreIdentifier alloc], "initWithLongLong:", [v6 storeItemIdentifier]);
        v8 = [*(*(a1 + 40) + 88) objectForKey:v7];
        v9 = [(SKUIItemState *)v8 state];
        v10 = [v6 updateState];
        v11 = ((v9 & 2) == 0) | v9;
        v12 = v9 & 0xFFFFFFFFFFFFFFDCLL | 0x20;
        if ((v9 & 2) != 0)
        {
          v12 = v9;
        }
        ...
        v13 = v9 & 0xFFFFFFFFFFFFFFDELL | 0x20;
        if (v10)
        {
          v13 = v9;
        }
        ...
        if (!v8)
        {
          ...
          v16 = [(SKUIStoreIdentifier *)v7 numberValue];
          [(SKUIItemState *)v8 setItemIdentifier:v16];

          [(SKUIItemState *)v8 setStoreIdentifier:v7];
          [(SKUIItemState *)v8 setState:v15];
          [*(*(a1 + 40) + 88) setObject:v8 forKey:v7];
        }
        ...
        if (v9 != v15)
        {
          ...
          if (v21)
          {
            ...
            v45 = v15;
            LODWORD(v27) = 42;
            v25 = _os_log_send_and_compose_impl(v21, 0, 0, 0, &dword_215BAE000, v20, 2, "[%@]: Update item: %@ updateState: %ld state: %ld", &v38, v27);

            v3 = v29;
            if (v25)
            {
              v20 = [MEMORY[0x277CCACA8] stringWithCString:v25 encoding:4];
              free(v25);
              v26 = v20;
              SSFileLog();
              goto LABEL_33;
...
LABEL_33:
  ...
  if ([v3 count])
  {
    [*(a1 + 40) _notifyObserversOfStateChanges:v3];
  }
      ...
      do
      {
        ...
        if ((isEqualToString & 1) == 0)
        {
          ...
          if (v12)
          {
            ...
            if (!v14)
            {
              v14 = objc_alloc_init(SKUIItemState);
              [(SKUIItemState *)v14 setItemIdentifier:v12];
              [(SKUIItemState *)v14 setStoreIdentifier:v13];
              [*(*(v1 + 32) + 88) setObject:v14 forKey:v13];
            }

            v15 = [(SKUIItemState *)v14 state];
            if ((v15 & 2) == 0)
            {
              [(SKUIItemState *)v14 setState:v15 | 2];
              [v3 addObject:v14];
            }

            v16 = v14;
            v17 = [(SKUIItemState *)v14 downloadContentFlags];
            v18 = [v9 valueForProperty:v66];
            v19 = [v18 BOOLValue];

            if ((v17 & 2) != v19)
            {
              [(SKUIItemState *)v16 setDownloadContentFlags:v17 | v19];
              [v3 addObject:v16];
            }
            ...
            v27 = v25;
            v74 = v16;
            v28 = [(SKUIItemState *)v16 variantIdentifier];
            v73 = v27;
            v29 = objc_msgSend_isEqualToString_(v28);

            if ((v29 & 1) == 0)
            {
              [(SKUIItemState *)v16 setVariantIdentifier:v27];
              [v3 addObject:v16];
            }
        ...
        if (v5)
        {
          ...
          *&v12 = v12;
          ...
          if (v16)
          {
            ...
            v43 = v11;
            LODWORD(v23) = 42;
            v21 = _os_log_send_and_compose_impl(v16, 0, 0, 0, &dword_215BAE000, v17, 2, "[%@]: Set job: %@ phase: %ld state: %ld", &v36, v23);
