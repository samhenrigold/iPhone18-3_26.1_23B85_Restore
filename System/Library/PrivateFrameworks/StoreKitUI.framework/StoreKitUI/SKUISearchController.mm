...
LABEL_17:
  ...
  {
    searchBar4 = [(SKUISearchController *)self searchBar];
...
- (void)setActive:(BOOL)active
{
  ...
  text = [searchBar text];
  v15.receiver = self;
  v15.super_class = SKUISearchController;
  [(SKUISearchController *)&v15 setActive:activeCopy];
  searchField = [searchBar searchField];
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id)coordinator
{
  ...
  width = size.width;
  v9.receiver = self;
  v9.super_class = SKUISearchController;
  coordinatorCopy = coordinator;
  [(SKUISearchController *)&v9 viewWillTransitionToSize:coordinatorCopy withTransitionCoordinator:width, height];
  v8 = [(SKUISearchController *)self delegate:v9.receiver];
