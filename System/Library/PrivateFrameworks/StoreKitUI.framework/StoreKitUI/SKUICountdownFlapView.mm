...
- (SKUICountdownFlapView)initWithPosition:(int64_t)position flapTopColor:(id)color flapBottomColor:(id)bottomColor;
...
- (SKUICountdownFlapView)initWithPosition:(int64_t)position flapTopColor:(id)color flapBottomColor:(id)bottomColor
{
  ...
  if (v11)
  {
    ...
    _newLabel = [(SKUICountdownFlapView *)v12 _newLabel];
    ...
    _newLabel2 = [(SKUICountdownFlapView *)v12 _newLabel];
    ...
    _newLabel3 = [(SKUICountdownFlapView *)v12 _newLabel];
    ...
    _newLabel4 = [(SKUICountdownFlapView *)v12 _newLabel];
...
- (void)setFrame:(CGRect)frame
{
  ...
  [(SKUICountdownFlapView *)&v25 setFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  factor = self->_factor;
  position = self->_position;
  switch(position)
  {
