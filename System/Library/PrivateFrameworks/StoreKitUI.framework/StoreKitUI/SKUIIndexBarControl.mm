...
- (SKUIIndexBarControl)initWithCoder:(id)coder;
- (SKUIIndexBarControl)initWithFrame:(CGRect)frame;
...
- (SKUIIndexBarControl)initWithCoder:(id)coder
{
  ...
  v3 = [(SKUIIndexBarControl *)&v6 initWithCoder:coder];
  v4 = v3;
  if (v3)
  {
...
- (SKUIIndexBarControl)initWithFrame:(CGRect)frame
{
  v6.receiver = self;
  v6.super_class = SKUIIndexBarControl;
  v3 = [(SKUIIndexBarControl *)&v6 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  v4 = v3;
  if (v3)
  {
    _SKUIIndexBarControlInitialization(v3);
...
- (void)drawRect:(CGRect)rect
{
  ...
  v4 = [(SKUIIndexBarControl *)self _displayEntries:rect.origin.x];
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        CGRectGetMinX(v36);
        traitCollection = [(SKUIIndexBarControl *)self traitCollection];
...
- (void)tintColorDidChange
{
  ...
  tintColor = [(SKUIIndexBarControl *)self tintColor];
...
- (void)traitCollectionDidChange:(id)change
{
  ...
  changeCopy = change;
  [(SKUIIndexBarControl *)&v10 traitCollectionDidChange:changeCopy];
...
- (BOOL)beginTrackingWithTouch:(id)touch withEvent:(id)event
{
  ...
  eventCopy = event;
  touchCopy = touch;
  [(SKUIIndexBarControl *)&v9 beginTrackingWithTouch:touchCopy withEvent:eventCopy];
  [(SKUIIndexBarControl *)self _sendSelectionForTouch:touchCopy withEvent:eventCopy, v9.receiver, v9.super_class];
...
- (BOOL)continueTrackingWithTouch:(id)touch withEvent:(id)event
{
  ...
  eventCopy = event;
  touchCopy = touch;
  [(SKUIIndexBarControl *)&v9 continueTrackingWithTouch:touchCopy withEvent:eventCopy];
  [(SKUIIndexBarControl *)self _sendSelectionForTouch:touchCopy withEvent:eventCopy, v9.receiver, v9.super_class];
...
- (void)endTrackingWithTouch:(id)touch withEvent:(id)event
{
  ...
  eventCopy = event;
  touchCopy = touch;
  [(SKUIIndexBarControl *)&v9 endTrackingWithTouch:touchCopy withEvent:eventCopy];
  [(SKUIIndexBarControl *)self _sendSelectionForTouch:touchCopy withEvent:eventCopy, v9.receiver, v9.super_class];
...
- (void)cancelTrackingWithEvent:(id)event
{
  ...
  [(SKUIIndexBarControl *)&v5 cancelTrackingWithEvent:event];
  lastSelectedIndexPath = self->_lastSelectedIndexPath;
  self->_lastSelectedIndexPath = 0;
...
- (void)_enumerateEntryIndexPathsUsingBlock:(id)block
{
  ...
  if (blockCopy)
  {
    _numberOfSections = [(SKUIIndexBarControl *)self _numberOfSections];
    v13 = 0;
...
- (void)_configureNewEntry:(id)entry
{
  ...
  if (objc_opt_isKindOfClass())
  {
    defaultTextAttributes = [(SKUIIndexBarControl *)self defaultTextAttributes];
...
- (id)_displayEntries
{
  ...
  else
  {
    ...
    selfCopy = self;
    _allEntries = [(SKUIIndexBarControl *)self _allEntries];
    v17 = _allEntries;
    if ([_allEntries count])
    {
      ...
      v20 = v10 - (left + right);
      v21 = v12 - (top + bottom);
      [(SKUIIndexBarControl *)selfCopy _sizeForEntries:_allEntries];
      v23 = v22;
      v68.origin.x = v18;
      v68.origin.y = v19;
      v68.size.width = v20;
              ...
              do
              {
                ...
                for (i = 0; i != v49; ++i)
                {
                  ...
                  else
                  {
                    ...
                    do
                    {
                      _combinedEntry = [(SKUIIndexBarControl *)selfCopy _combinedEntry];
                      if (_combinedEntry)
                      {
                    ...
                    {
LABEL_20:
                      _combinedEntry2 = [(SKUIIndexBarControl *)selfCopy _combinedEntry];
                      if (_combinedEntry2)
                      {
            ...
            [(SKUIIndexBarControl *)selfCopy _sizeForEntries:v25];
            v39 = v38;
            v69.origin.x = v18;
            v69.origin.y = v19;
            v69.size.width = v20;
        ...
        {
          _displayEntriesThatFitInViewForGroupedEntries = [(SKUIIndexBarControl *)selfCopy _displayEntriesThatFitInViewForGroupedEntries];
        }
...
- (id)_displayEntriesThatFitInViewForGroupedEntries
{
  _allRequiredEntries = [(SKUIIndexBarControl *)self _allRequiredEntries];
  ...
  if (v4 >= 2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        _combinedEntry = [(SKUIIndexBarControl *)self _combinedEntry];
...
{
  pathCopy = path;
  v5 = [(NSMapTable *)self->_indexPathToEntryMapTable objectForKey:pathCopy];
  if (!v5)
  {
    WeakRetained = objc_loadWeakRetained(&self->_dataSource);
    v5 = [WeakRetained indexBarControl:self entryAtIndexPath:pathCopy];
    ...
    [(NSMapTable *)indexPathToEntryMapTable setObject:v5 forKey:pathCopy];
  }
...
- (void)_sendSelectionForTouch:(id)touch withEvent:(id)event
{
  ...
  v15 = v14;
  v17 = v16;
  _totalEntryCount = [(SKUIIndexBarControl *)self _totalEntryCount];
  v40.origin.x = v11;
  v40.origin.y = v13;
  v40.size.width = v15;
  v40.size.height = v17;
...
LABEL_11:
  ...
  v39 = 0;
  if (v27 < _totalEntryCount && (v33[0] = 0, v33[1] = v33, v33[2] = 0x2020000000, v33[3] = 0, v32[0] = MEMORY[0x277D85DD0], v32[1] = 3221225472, v32[2] = __56__SKUIIndexBarControl__sendSelectionForTouch_withEvent___block_invoke, v32[3] = &unk_2781FD490, v32[5] = &v34, v32[6] = v27, v32[4] = v33, [(SKUIIndexBarControl *)self _enumerateEntryIndexPathsUsingBlock:v32], _Block_object_dispose(v33, 8), (v28 = v35[5]) != 0))
  {
    v29 = v28;
  }
...
- (CGSize)_sizeForEntryAtIndexPath:(id)path
{
  v3 = [(SKUIIndexBarControl *)self _entryAtIndexPath:path];
  [v3 size];
  v5 = v4;
  v7 = v6;
...
- (CGRect)_visibleBounds
{
  _displayEntries = [(SKUIIndexBarControl *)self _displayEntries];
  [(SKUIIndexBarControl *)self bounds];
  v5 = v4;
  v7 = v6;
  v9 = v8;
