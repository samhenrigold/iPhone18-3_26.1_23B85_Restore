...
- (SKUIFamilyCircleController)init
{
  ...
  if (v3)
  {
    ...
    [defaultCenter addObserver:v3 selector:sel__accountStoreDidChange_ name:v5 object:defaultStore];
...
- (void)_reloadDataWithPromptStyle:(int64_t)style
{
  ...
  [(SKUIFamilyCircleController *)self setLastAccountID:uniqueIdentifier];

  [(SKUIFamilyCircleController *)self setReloadPromptStyle:style];
...
void __57__SKUIFamilyCircleController__reloadDataWithPromptStyle___block_invoke_2(uint64_t a1)
{
  ...
  v27[1] = v27;
  v27[2] = 0x3032000000;
  v27[3] = __Block_byref_object_copy__75;
  v27[4] = __Block_byref_object_dispose__75;
  v28 = 0;
  v25[0] = 0;
  v25[1] = v25;
  v25[2] = 0x3032000000;
  ...
  v17[1] = 3221225472;
  v17[2] = __57__SKUIFamilyCircleController__reloadDataWithPromptStyle___block_invoke_52;
  v17[3] = &unk_2781FF110;
  v19 = v27;
  v20 = v25;
  v5 = v2;
  ...
  v8 = SKUIFamilyCircleFramework(v6, v7);
  v9 = objc_alloc_init(SKUIWeakLinkedClassForString(&cfstr_Fafetchfamilyc.isa, v8));
  v13[0] = MEMORY[0x277D85DD0];
  v13[1] = 3221225472;
  v13[2] = __57__SKUIFamilyCircleController__reloadDataWithPromptStyle___block_invoke_2_57;
  v13[3] = &unk_2781FF138;
  v15 = v23;
  v16 = v21;
  v10 = v3;
  ...
  v11[1] = 3221225472;
  v11[2] = __57__SKUIFamilyCircleController__reloadDataWithPromptStyle___block_invoke_3;
  v11[3] = &unk_2781FF160;
  v11[4] = *(a1 + 32);
...
- (void)_setITunesFamily:(id)family error:(id)error iCloudFamily:(id)cloudFamily error:(id)a6
{
  ...
  defaultCenter = [MEMORY[0x277CCAB98] defaultCenter];
  [defaultCenter postNotificationName:@"SKUIFamilyCircleDidChangeNotification" object:self];
...
- (void)_setProfilePicture:(id)picture forMember:(id)member
{
  ...
  defaultCenter = [MEMORY[0x277CCAB98] defaultCenter];
  [defaultCenter postNotificationName:@"SKUIFamilyCircleProfilePictureDidChangeNotification" object:self];
}
