...
- (SKUIStorePageCollectionViewLayout)init
{
  ...
  v8.receiver = self;
  v8.super_class = SKUIStorePageCollectionViewLayout;
  ...
  if (v3)
  {
    ...
    v5 = *MEMORY[0x277D768F8];
    v9[0] = *MEMORY[0x277D768E8];
    v9[1] = v5;
    v10[0] = &unk_2828D2B28;
    v10[1] = &unk_2828D2B28;
    ...
    [(SKUIStorePageCollectionViewLayout *)v4 registerClass:objc_opt_class() forDecorationViewOfKind:0x28280D8E8];
    [(SKUIStorePageCollectionViewLayout *)v4 registerClass:objc_opt_class() forDecorationViewOfKind:0x282808328];
  }
...
{
  v5.receiver = self;
  v5.super_class = SKUIStorePageCollectionViewLayout;
...
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)path
{
  pathCopy = path;
  v29.receiver = self;
  v29.super_class = SKUIStorePageCollectionViewLayout;
  v5 = [(SKUIStorePageCollectionViewLayout *)&v29 initialLayoutAttributesForAppearingItemAtIndexPath:pathCopy];
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  ...
  {
    v7 = -[SKUIStorePageCollectionViewLayout _getCollectionViewUpdateItemForItemFromIndex:initalLayout:](self, "_getCollectionViewUpdateItemForItemFromIndex:initalLayout:", [pathCopy section], 1);
    ...
    collectionView = [(SKUIStorePageCollectionViewLayout *)self collectionView];
...
- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)path
{
  pathCopy = path;
  v28.receiver = self;
  v28.super_class = SKUIStorePageCollectionViewLayout;
  v5 = [(SKUIStorePageCollectionViewLayout *)&v28 finalLayoutAttributesForDisappearingItemAtIndexPath:pathCopy];
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  if (expandChildPageSectionsIndexSet && -[NSIndexSet containsIndex:](expandChildPageSectionsIndexSet, "containsIndex:", [pathCopy section]) && self->_updateItems)
  {
    v7 = -[SKUIStorePageCollectionViewLayout _getCollectionViewUpdateItemForItemFromIndex:initalLayout:](self, "_getCollectionViewUpdateItemForItemFromIndex:initalLayout:", [pathCopy section], 0);
    updateAction = [v7 updateAction];
...
- (id)invalidationContextForBoundsChange:(CGRect)change
{
  ...
  x = change.origin.x;
  v27.receiver = self;
  v27.super_class = SKUIStorePageCollectionViewLayout;
  ...
  {
    _indexPathsForPinningItems = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
    if ([_indexPathsForPinningItems count])
    {
      [v8 invalidateItemsAtIndexPaths:_indexPathsForPinningItems];
      [v8 invalidateDecorationElementsOfKind:0x28280D8E8 atIndexPaths:_indexPathsForPinningItems];
    }
  }
...
- (id)layoutAttributesForDecorationViewOfKind:(id)kind atIndexPath:(id)path
{
  ...
  if (objc_msgSend_isEqualToString_(kindCopy))
  {
    ...
    v10 = [(SKUIStorePageCollectionViewLayout *)self _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:pathCopy pinningConfiguration:v8 layoutInformation:v9];
...
LABEL_6:
    v12.receiver = self;
    v12.super_class = SKUIStorePageCollectionViewLayout;
    v10 = [(SKUIStorePageCollectionViewLayout *)&v12 layoutAttributesForDecorationViewOfKind:kindCopy atIndexPath:pathCopy];
  }
...
- (id)layoutAttributesForElementsInRect:(CGRect)rect
{
  ...
  v35.receiver = self;
  v35.super_class = SKUIStorePageCollectionViewLayout;
  v8 = [(UICollectionViewFlowLayout *)&v35 layoutAttributesForElementsInRect:?];
  v9 = [v8 mutableCopy];

  [(SKUIStorePageCollectionViewLayout *)self _appendAdditionalLayoutAttributesForPinningItemsInRect:v9 toArray:x, y, width, height];
  --self->_inLayoutAttributesForElementsCount;
  v31 = 0u;
  v32 = 0u;
  v33 = 0u;
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (![v15 representedElementCategory])
        {
          ...
          if (v18)
          {
            v19 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:indexPath];
            v20 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:indexPath];
          }
          ...
          v30 = 0;
          [(SKUIStorePageCollectionViewLayout *)self _configureCellLayoutAttributes:v15 forItemWithPinningConfiguration:v20 layoutInformation:v19 atIndexPath:indexPath allowPinning:v18 returningIsPinning:&v30];
          if (v30 == 1 && [(SKUIStorePageCollectionViewLayout *)self _allowsBackdropDecorationForItemPinningConfiguration:v20 atIndexPath:indexPath])
          {
            v21 = [(SKUIStorePageCollectionViewLayout *)self _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:indexPath pinningConfiguration:v20 layoutInformation:v19];
            if (v21)
            {
              v22 = v29;
              if (!v29)
        ...
        _indexPathsForBackgroundGradients = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForBackgroundGradients];
        v24 = [_indexPathsForBackgroundGradients containsObject:indexPath];

        if (v24)
        {
          v25 = [(SKUIStorePageCollectionViewLayout *)self _layoutAttributesForGradientDecorationViewAtIndexPath:indexPath currentAttributes:v15];
          if (v25)
          {
            v26 = v29;
            if (!v29)
  ...
  [(SKUIStorePageCollectionViewLayout *)self _alginCellsToTop:v10, v29];
...
- (id)layoutAttributesForItemAtIndexPath:(id)path
{
  ...
  if (!self->_inLayoutAttributesForElementsCount && ![v5 representedElementCategory])
  {
    ...
    {
      v9 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:pathCopy];
      v10 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:pathCopy];
    }
    ...
    [(SKUIStorePageCollectionViewLayout *)self _configureCellLayoutAttributes:v6 forItemWithPinningConfiguration:v10 layoutInformation:v9 atIndexPath:pathCopy allowPinning:v8 returningIsPinning:0];
  }
...
- (void)prepareForCollectionViewUpdates:(id)updates
{
  ...
  v15.receiver = self;
  v15.super_class = SKUIStorePageCollectionViewLayout;
...
{
  v14.receiver = self;
  v14.super_class = SKUIStorePageCollectionViewLayout;
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)change
{
  y = change.origin.y;
  v10.receiver = self;
  v10.super_class = SKUIStorePageCollectionViewLayout;
...
- (void)_updateItemsLayoutForRect:(CGRect)rect
{
  ...
  if (self->_overrideContentWidth >= 0.00000011920929)
  {
    ...
    v9.receiver = self;
    v9.super_class = SKUIStorePageCollectionViewLayout;
    [(SKUIStorePageCollectionViewLayout *)&v9 _updateItemsLayoutForRect:x, y, width, height];
  ...
  else
  {
    v10.receiver = self;
    v10.super_class = SKUIStorePageCollectionViewLayout;
    [(SKUIStorePageCollectionViewLayout *)&v10 _updateItemsLayoutForRect:rect.origin.x, rect.origin.y, rect.size.width, rect.size.height];
  }
}
...
- (id)layoutAttributesForUnpinnedItemAtIndexPath:(id)path
{
  ...
  if (!self->_inLayoutAttributesForElementsCount && ![v5 representedElementCategory])
  {
    ...
    [(SKUIStorePageCollectionViewLayout *)self _configureCellLayoutAttributes:v6 forItemWithPinningConfiguration:v10 layoutInformation:v9 atIndexPath:pathCopy allowPinning:0 returningIsPinning:0];
  }
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (![v15 representedElementCategory])
        {
          ...
          v24 = 0;
          [(SKUIStorePageCollectionViewLayout *)self _configureCellLayoutAttributes:v15 forItemWithPinningConfiguration:v20 layoutInformation:v19 atIndexPath:indexPath allowPinning:v18 returningIsPinning:&v24];
          if (v24 == 1)
          {
            [v15 frame];
            [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:v20 itemPinningConfiguration:indexPath atIndexPath:?];
            [v15 setFrame:?];
            v21 = v23;
            if (!v23)
            {
...
- (void)setAllowsPinningTransitions:(BOOL)transitions
{
  if (self->_allowsPinningTransitions != transitions)
  {
    ...
    [(SKUIStorePageCollectionViewLayout *)self invalidateLayoutWithContext:v5];
  }
}
  ...
  if (backdropGroupName != nameCopy)
  {
    ...
    if ((backdropGroupName & 1) == 0)
    {
      ...
      if ([_indexPathsForPinningItems count])
      {
        ...
        [v9 invalidateDecorationElementsOfKind:0x28280D8E8 atIndexPaths:_indexPathsForPinningItems];
...
- (BOOL)_allowsBackdropDecorationForItemPinningConfiguration:(id)configuration atIndexPath:(id)path
{
  v4 = [(SKUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:configuration atIndexPath:path];
  if (v4)
  {
    v5 = v4 == 3;
  }
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v13 = *(*(&v41 + 1) + 8 * v12);
        v14 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v13, v32];
        ...
        if (CGRectIntersectsRect(v48, v49))
        {
          ...
          v36.super_class = SKUIStorePageCollectionViewLayout;
...
void __71__SKUIStorePageCollectionViewLayout__calculatePinningLayoutInformation__block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  v8 = v7;
  v77.receiver = *(a1 + 32);
  v77.super_class = SKUIStorePageCollectionViewLayout;
...
LABEL_47:
  ...
  [(SKUIStorePageItemPinningLayoutInformation *)v56 setAvailablePinningFrame:MinX, rect, v41, v42];
  [(SKUIStorePageItemPinningLayoutInformation *)v56 setLayoutAttributesFrame:v11, v13, v15, v75];
  [(SKUIStorePageItemPinningLayoutInformation *)v56 setAfterPinningLocationYAdditions:v73];
  [(SKUIStorePageItemPinningLayoutInformation *)v56 setBeforePinningLocationYAdditions:*(*(*(a1 + 56) + 8) + 24)];
  v57 = *(*(a1 + 32) + 592);
  if (!v57)
  {
...
- (void)_configureCellLayoutAttributes:(id)attributes forItemWithPinningConfiguration:(id)configuration layoutInformation:(id)information atIndexPath:(id)path allowPinning:(BOOL)pinning returningIsPinning:(BOOL *)isPinning
{
  ...
  if (pinningCopy)
  {
    [(SKUIStorePageCollectionViewLayout *)self _targetFrameForStartingFrame:configurationCopy itemPinningConfiguration:informationCopy layoutInformation:pathCopy atIndexPath:&v39 returningIsPinning:v26, v27, v28, v29];
    v30 = v34;
    v31 = v35;
    v32 = v36;
    v33 = v37;
    if (v39)
    {
      ...
      if ([(SKUIStorePageCollectionViewLayout *)self _allowsBackdropDecorationForItemPinningConfiguration:configurationCopy atIndexPath:pathCopy])
      {
...
- (id)_layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:(id)path pinningConfiguration:(id)configuration layoutInformation:(id)information
{
  ...
  informationCopy = information;
  collectionView = [(SKUIStorePageCollectionViewLayout *)self collectionView];
  v12 = [(UICollectionViewLayoutAttributes *)SKUIStorePagePinnedBackdropLayoutAttributes layoutAttributesForDecorationViewOfKind:0x28280D8E8 withIndexPath:pathCopy];
  ...
  [(SKUIStorePageCollectionViewLayout *)self _targetFrameForStartingFrame:configurationCopy itemPinningConfiguration:informationCopy layoutInformation:pathCopy atIndexPath:&v41 returningIsPinning:?];
  v13 = v41;
  v14 = 0.0;
  if (v41 == 1)
  {
    [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:configurationCopy itemPinningConfiguration:pathCopy atIndexPath:?];
    [v12 setFrame:?];
    [v12 setZIndex:150];
    v15 = [(SKUIStorePageCollectionViewLayout *)self _pinningTransitionStyleForItemPinningConfiguration:configurationCopy atIndexPath:pathCopy];
    if (v15)
    {
      v16 = v15;
      _pinnedBackdropViewStyle = [(SKUIStorePageCollectionViewLayout *)self _pinnedBackdropViewStyle];
...
LABEL_13:
      ...
      else if (v16 == 1)
      {
        ...
        if (!v18)
        {
          ...
          v25 = v23 + v24;
          v40.receiver = self;
          v40.super_class = SKUIStorePageCollectionViewLayout;
...
- (id)_layoutAttributesForGradientDecorationViewAtIndexPath:(id)path currentAttributes:(id)attributes
{
  ...
  v10 = [(SKUIStorePageCollectionViewLayout *)self layoutAttributesForDecorationViewOfKind:0x282808328 atIndexPath:pathCopy];
  [collectionView bounds];
  [attributesCopy size];
  v12 = v11;
  [attributesCopy frame];
  if (v9 >= 2)
  {
    ...
    for (i = 1; i != v9; ++i)
    {
      ...
      v23 = [(SKUIStorePageCollectionViewLayout *)self layoutAttributesForItemAtIndexPath:v22];
...
- (CGRect)_pinningFrameForStartingFrame:(CGRect)frame itemPinningConfiguration:(id)configuration atIndexPath:(id)path
{
  ...
  y = frame.origin.y;
  x = frame.origin.x;
  [(SKUIStorePageCollectionViewLayout *)self _pinningContentInsetForItemPinningConfiguration:configuration atIndexPath:path];
  v10 = -v9;
  v13 = y - v12;
  v15 = width - (-v11 - v14);
  v16 = height - (v10 - v12);
...
- (CGRect)_targetFrameForStartingFrame:(CGRect)frame itemPinningConfiguration:(id)configuration layoutInformation:(id)information atIndexPath:(id)path returningIsPinning:(BOOL *)pinning
{
  ...
  informationCopy = information;
  pathCopy = path;
  [(SKUIStorePageCollectionViewLayout *)self _pinningContentInsetForItemPinningConfiguration:configurationCopy atIndexPath:pathCopy];
  v90 = x;
  v91 = width;
  v21 = x - v20;
  v23 = y - v22;
  ...
  [collectionView _effectiveContentInset];
  v31 = v29 + v30;
  v32 = [(SKUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:configurationCopy atIndexPath:pathCopy];
  v33 = 0;
  if (v32 <= 2)
  {
    if (v32 == 1)
    {
      ...
      if (v52 <= 0.00000011920929)
      {
        ...
        else
        {
          ...
          v89 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v80];
          v81 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v80];
          v82 = [(SKUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:v81 atIndexPath:v80];
          v33 = 0;
          if (v82 && v82 != 3)
          {
            [v89 layoutAttributesFrame];
            [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:v81 itemPinningConfiguration:v80 atIndexPath:?];
    ...
    v35 = v90;
    v34 = v91;
    [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:configurationCopy itemPinningConfiguration:pathCopy atIndexPath:v90, v41, v91, v25];
