...
- (void)main
{
  ...
  *&v70[14] = code;
  v10 = v8;
  v11 = _os_log_send_and_compose_impl(v4, 0, 0, 0, &dword_215BAE000, v7, 0, "%{public}@: [%{public}@] Starting redeem operation", v70, 22);
...
LABEL_49:
  ...
  if (v62[5])
  {
    ...
    *&v70[22] = 2114;
    ...
    v42 = v39;
    LODWORD(v52) = 32;
    v43 = _os_log_send_and_compose_impl(v35, 0, 0, 0, &dword_215BAE000, v38, 16, "%{public}@: [%{public}@] Redeem operation failed. Error: %{public}@", v70, v52);
...
LABEL_45:
  ...
  else
  {
    ...
    *&v70[14] = v48;
    v49 = v47;
    LODWORD(v52) = 22;
    v43 = _os_log_send_and_compose_impl(v44, 0, 0, 0, &dword_215BAE000, v38, 0, "%{public}@: [%{public}@] Redeem operation succeeded", v70, v52);
