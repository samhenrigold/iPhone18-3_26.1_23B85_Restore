...
+ (id)options
{
  if (options_once_4 != -1)
  {
    +[ADKeyedParameterList options];
  }

  v3 = options_sOptions_4;
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [objc_alloc(MEMORY[0x277CBEB18]) initWithCapacity:{-[NSMutableArray count](self->_parameterLists, "count")}];
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(ADKeyedParameterList *)self addParameterList:*(*(&v10 + 1) + 8 * i), v10];
      }
