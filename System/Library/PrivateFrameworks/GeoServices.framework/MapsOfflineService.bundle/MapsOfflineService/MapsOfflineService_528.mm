uint64_t *sub_1CEBA20(uint64_t *result, const void *a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
uint64_t *sub_1CEBB48(void *a1, int *a2, void *a3)
{
  v3 = *a2;
  v4 = a1[1];
  if (!*&v4)
...
void sub_1CEBD74(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EF140, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1CF6830()
{
  ...
  unk_27EF100 = 0;
  qword_27EF108 = 0;
  sub_68678C(&qword_27EF0F8, __p, &v11, 1uLL);
  if (v10 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF118 = 0;
  qword_27EF120 = 0;
  sub_68678C(&qword_27EF110, __p, &v11, 1uLL);
  if (v10 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF130 = 0;
  qword_27EF138 = 0;
  sub_68678C(&qword_27EF128, __p, &v11, 1uLL);
  if (v10 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1CEBD74(v1, v2, v3, v4, v5, v6, v7, v8);
...
uint64_t sub_1CF698C@<X0>(int a1@<W0>, _BYTE *a2@<X8>)
{
  sub_D7B0(v11);
  v5 = v12;
  *(&v12 + *(*&v12 - 24) + 8) = *(&v12 + *(*&v12 - 24) + 8) & 0xFFFFFEFB | 4;
  *(&v14[0].__locale_ + *(*&v5 - 24)) = a1;
...
void sub_1CF6C3C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  std::ios::~ios();
  _Unwind_Resume(a1);
}

unint64_t sub_1CF6C68@<X0>(unint64_t result@<X0>, void *a2@<X8>)
{
  v2 = result;
  v4 = *(result + 23);
  v5 = v4;
...
void sub_1CF7038(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
void *sub_1CF7A8C@<X0>(unsigned int a1@<W0>, void *a2@<X8>)
{
  v5 = 0;
  *__s = 0;
  if (a1 > 0x7F)
...
uint64_t *sub_1CF7E1C(uint64_t *result, __int128 *a2, __int128 *a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_1CF7F0C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27EF1A0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
