...
void sub_1EBB740()
{
  ...
  unk_27F0300 = 0;
  qword_27F0308 = 0;
  sub_68678C(&qword_27F02F8, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  *algn_27F0318 = 0;
  qword_27F0320 = 0;
  sub_68678C(&qword_27F0310, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0330 = 0;
  qword_27F0338 = 0;
  sub_68678C(&qword_27F0328, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1EB0C84(v0, v1, v2, v3, v4, v5, v6, v7);
...
void sub_1EBC45C(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t **a4@<X3>, uint64_t *a5@<X4>, void *a6@<X5>, int a7@<W6>, void *a8@<X8>)
{
  v15 = *(a2 + 16);
...
void sub_1EBD0B0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27F03F0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1EC7B6C()
{
  ...
  unk_27F03B0 = 0;
  qword_27F03B8 = 0;
  sub_68678C(&qword_27F03A8, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F03C8 = 0;
  qword_27F03D0 = 0;
  sub_68678C(&qword_27F03C0, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F03E0 = 0;
  qword_27F03E8 = 0;
  sub_68678C(&qword_27F03D8, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1EBD0B0(v0, v1, v2, v3, v4, v5, v6, v7);
  sub_3608D0(__p, "en_US");
  LODWORD(v12[0]) = 0;
  sub_3608D0(v12 + 1, "en-US_US");
  v13 = 0;
...
void sub_1EC83B0(uint64_t a1@<X0>, std::string *a3@<X8>)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    std::operator+<char>();
...
void sub_1EC8530(uint64_t a1@<X0>, uint64_t a2@<X1>, void *a5@<X8>)
{
  sub_1AC47FC(v7, *a2, (a2 + 8));
  a5[1] = 0;
  *a5 = a5 + 1;
  a5[4] = 0;
  a5[2] = 0;
...
void sub_1EC9098(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1EC96F4(va);
  _Unwind_Resume(a1);
...
void sub_1EC91F8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_197F740(va);
  sub_197F7C0(v13 - 56);
...
uint64_t sub_1EC92F8(unint64_t *a1, uint64_t a2)
{
...
void sub_1EC9414(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1EC9538(va);
  _Unwind_Resume(a1);
...
void sub_1EC9428(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
uint64_t sub_1EC9498(uint64_t a1, uint64_t a2)
{
  sub_1503170(a1, 0, 0);
  if (a1 != a2)
  {
...
uint64_t sub_1EC9588(char *a1, void *a2, uint64_t a3)
{
...
void sub_1EC97C0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_19C4D00(va);
  _Unwind_Resume(a1);
