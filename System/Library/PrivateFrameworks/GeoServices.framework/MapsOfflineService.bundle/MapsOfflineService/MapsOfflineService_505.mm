BOOL sub_1B2120C(uint64_t a1)
{
  ...
  v4 = *v1;
  v3 = *(v1 + 8);
  return v4 == 0x47524148435F5645 && v3 == 0x454552465F474E49;
}
...
void sub_1B21614(uint64_t *a1, _BYTE *a2)
{
  v4 = a1[1];
  v5 = a1[2];
  if (v4 == v5 << 6)
...
void sub_1B21A44(uint64_t a1@<X0>, unint64_t *a2@<X1>, void *a3@<X2>, uint64_t *a4@<X8>)
{
  *a4 = 0;
  a4[1] = 0;
  a4[2] = 0;
...
void sub_1B21BE0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  sub_1B22434(va);
  _Unwind_Resume(a1);
...
_DWORD *sub_1B21C48(uint64_t *a1, _DWORD *a2)
{
  v3 = a1[1];
  if (v3 >= a1[2])
  {
...
uint64_t sub_1B21C98(uint64_t a1, uint64_t a2)
{
  ...
  v5 = v9;
  for (i = v10; v5 != i; v5 += 800)
  {
    LODWORD(v13) = *v5;
    sub_19D4B88(v14, (v5 + 8));
...
void sub_1B222F8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1B223E0(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1B224BC(uint64_t result, char *a2, uint64_t a3, char a4)
{
  v6 = a2;
  v7 = result;
  v70 = a2;
...
int *sub_1B22FCC(int *result, char *a2, int *a3)
{
  if (result != a2)
  {
    v4 = a2;
...
BOOL sub_1B23294(int *a1, char *a2)
{
  v2 = a2;
  v3 = a1;
  v24 = a2;
...
void sub_1B23890(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_194DBA0(va);
  _Unwind_Resume(a1);
...
void *sub_1B238B0(void *a1, unint64_t *a2, uint64_t a3)
{
  v3 = *a2;
  v4 = a1[1];
  if (!*&v4)
...
uint64_t sub_1B23B98(uint64_t a1, uint64_t a2)
{
  ...
  *(a1 + 32) = *(a2 + 32);
  ...
  for (i = *(a2 + 16); i; i = *i)
  {
    sub_1B23C10(a1, i + 2, i + 1);
  }

  return a1;
}

void *sub_1B23C10(void *a1, unint64_t *a2, _OWORD *a3)
{
  v3 = *a2;
  v4 = a1[1];
  if (!*&v4)
...
void sub_1B23E3C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EDD70, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1B2E8F8()
{
  ...
  unk_27EDD30 = 0;
  qword_27EDD38 = 0;
  sub_68678C(&qword_27EDD28, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EDD48 = 0;
  qword_27EDD50 = 0;
  sub_68678C(&qword_27EDD40, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EDD60 = 0;
  qword_27EDD68 = 0;
  sub_68678C(&qword_27EDD58, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1B23E3C(v0, v1, v2, v3, v4, v5, v6, v7);
...
void sub_1B2F220(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27EDE20, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
