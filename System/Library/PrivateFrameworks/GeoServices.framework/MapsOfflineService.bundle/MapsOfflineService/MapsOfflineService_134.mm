std::string *sub_84C338(std::string *result, uint64_t a2)
{
  ...
  if (v2 >= 8)
  {
    ...
    {
      if (v5[81].__r_.__value_.__r.__words[0] != -1)
      {
        v7 = "_Stairs";
        goto LABEL_16;
      }

      if (v5[81].__r_.__value_.__r.__words[2] != -1)
      {
        v7 = "_Escalator";
        v8 = a2;
        v9 = 10;
      ...
      if (v5[81].__r_.__value_.__l.__size_ != -1)
      {
        v7 = "_Elevator";
        v8 = a2;
        v9 = 9;
      ...
      if (v5[82].__r_.__value_.__r.__words[0] != -1)
      {
        v7 = "_Bridge";
        goto LABEL_16;
      }

      if (v5[82].__r_.__value_.__l.__size_ != -1)
      {
        v7 = "_Tunnel";
LABEL_16:
        v8 = a2;
      ...
      if (v5[82].__r_.__value_.__r.__words[2] != -1)
      {
        v7 = "_Roundabout";
        v8 = a2;
        v9 = 11;
...
void sub_84DF2C(uint64_t a1, uint64_t a2, int a3)
{
...
void sub_84E5C0(uint64_t a1, uint64_t a2, int a3, int a4)
{
  if (*(a1 + 1939) == 1)
  {
    v4 = *(a1 + 1928);
...
void sub_84E9F8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, ...)
{
  va_start(va, a20);
  sub_540798(va);
  if (*(v20 - 57) < 0)
...
void sub_84EA5C(uint64_t a1, __int128 **a2, int a3)
{
  if (*(a1 + 1940) == 1)
  {
    sub_681008(a2, &__p);
...
void sub_84EF90(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_1A104(va);
  _Unwind_Resume(a1);
...
void sub_8514D8(std::string *a1, void ***a2, unsigned __int8 a3)
{
...
void sub_851634(uint64_t a1, void ***a2)
{
  if (*(a1 + 1936))
  {
    v4 = "Start_Route";
...
void sub_8516CC(uint64_t a1, void ***a2)
{
  if (*(a1 + 1936))
  {
...
void sub_851734(uint64_t a1, void ***a2)
{
...
void sub_851818(void *a1, void ***a2)
{
  if (*(a1[265] + 1560) == 11)
  {
    v4 = "Resume_Route";
...
void sub_851AA0(std::string *a1, const void **a2, void ***a3)
{
  sub_67E35C(a3, a2);
...
void sub_851C2C(uint64_t a1, void ***a2)
{
  if (*(a1 + 1935))
  {
    v4 = &qword_27AE1D0;
...
void sub_851C94(uint64_t a1, void ***a2)
{
  if (*(a1 + 1935))
  {
    v4 = &qword_27AE1E8;
...
void sub_851CFC(uint64_t a1, void ***a2)
{
...
void sub_851D48(uint64_t a1, void ***a2)
{
...
void sub_851D94(uint64_t a1, void ***a2)
{
...
void sub_851DE0(void *a1, void ***a2)
{
...
void sub_851E8C(uint64_t a1, void ***a2)
{
...
void sub_851F60(uint64_t a1, const void **a2, void ***a3)
{
  if (*(a1 + 1936) == 1)
  {
    sub_67E35C(a3, a2);
...
void sub_852064(uint64_t a1, void ***a2)
{
  v4 = *(a1 + 1928);
  v5 = &qword_27AE1B8;
  if (v4 != 87)
...
void sub_8520D4(uint64_t a1, const void **a2, void ***a3)
{
  sub_67E35C(a3, a2);
...
void sub_852150(uint64_t a1, const void **a2, void ***a3)
{
  sub_67E35C(a3, a2);
  sub_67F210(a3, "_ExitNumber", "{ExitNumber}", (a1 + 456));
  sub_67F210(a3, "_Intersection", "{Intersection}", (a1 + 304));
...
void sub_85257C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va1, a3);
  va_start(va, a3);
  v4 = va_arg(va1, void);
...
void sub_852A08(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, void *__p, uint64_t a22, int a23, __int16 a24, char a25, char a26)
{
  sub_540798(&a9);
  sub_540798(&a15);
  if (a26 < 0)
...
void sub_852CEC(uint64_t a1@<X0>, void *a2@<X8>)
{
  if ((*(a1 + 1928) - 82) <= 2)
  {
...
void sub_855384(uint64_t a1, uint64_t a2)
{
...
void sub_856DDC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va1, a3);
  va_start(va, a3);
  v4 = va_arg(va1, void);
...
void sub_857E58(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, ...)
{
  va_start(va, a10);
  sub_1F1A8(&a9);
  sub_540798(va);
...
void sub_857E74(uint64_t a1@<X0>, __int128 **a2@<X8>)
{
  if (*(a1 + 1940) != 1)
  {
...
void sub_85804C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, void *__p, uint64_t a15, int a16, __int16 a17, char a18, char a19)
{
  sub_1F1A8(&a10);
  if (a19 < 0)
  {
...
void sub_858088(uint64_t result, __int128 **a2, int a3, uint64_t a4)
{
  if (*(result + 1940) == 1)
  {
    sub_85BB8C(result, a2, a3);
  }

  else if (*(result + 1939) == 1)
  {
    sub_85B6F0(result, a2, a3, a4);
  }
}
...
void sub_859FC0(uint64_t a1@<X0>, __int128 **a2@<X8>)
{
  v5 = 0;
  v6 = 0;
