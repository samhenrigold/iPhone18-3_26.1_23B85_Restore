...
void sub_1F7114C()
{
  ...
  unk_27F0A00 = 0;
  qword_27F0A08 = 0;
  sub_68678C(&qword_27F09F8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
  ...
  *algn_27F0A18 = 0;
  qword_27F0A20 = 0;
  sub_68678C(&qword_27F0A10, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0A30 = 0;
  qword_27F0A38 = 0;
  sub_68678C(&qword_27F0A28, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1F66690(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
void sub_1F71C80(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27F0AA0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1F7C73C()
{
  ...
  unk_27F0A60 = 0;
  qword_27F0A68 = 0;
  sub_68678C(&qword_27F0A58, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F0A78 = 0;
  qword_27F0A80 = 0;
  sub_68678C(&qword_27F0A70, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0A90 = 0;
  qword_27F0A98 = 0;
  sub_68678C(&qword_27F0A88, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1F71C80(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
uint64_t sub_1F7C95C@<X0>(uint64_t a1@<X0>, void *a2@<X8>)
{
  sub_19594F8(&v29);
  if (*(a1 + 32) == 1)
  {
...
void sub_1F7CDF4(_Unwind_Exception *a1, uint64_t a2, void *__p, uint64_t a4, int a5, __int16 a6, char a7, char a8, char a9, void *a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, ...)
{
  std::locale::~locale((v22 - 88));
  if (SHIBYTE(a12) < 0)
  {
    operator delete(a10);
  }
...
void sub_1F7CEF4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1F7CF0C@<X0>(uint64_t result@<X0>, unint64_t *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
...
void sub_1F7CFA4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1B6D24C(va);
  _Unwind_Resume(a1);
...
void sub_1F7CFC8(uint64_t a1@<X0>, uint64_t *a2@<X1>, int a3@<W2>, void *a4@<X8>)
{
  v5 = *a2;
  v6 = a2[1];
  a4[1] = 0;
...
uint64_t sub_1F7D1A4(unint64_t *a1, uint64_t a2)
{
...
void sub_1F7D2D8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1F7D35C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1F7D3AC(void *a1, uint64_t a2)
{
  v2 = (a1[1] - *a1) >> 6;
  v3 = v2 + 1;
  if ((v2 + 1) >> 58)
...
void sub_1F7D4A8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1F7D5CC(va);
  _Unwind_Resume(a1);
...
void sub_1F7D4BC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
uint64_t sub_1F7D52C(uint64_t a1, uint64_t a2)
{
  sub_1642E0C(a1, 0, 0);
  if (a1 != a2)
  {
...
void sub_1F7D61C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27F0B00, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
