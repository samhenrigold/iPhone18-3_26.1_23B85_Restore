void sub_1D22668()
{
  ...
  unk_27EF270 = 0;
  qword_27EF278 = 0;
  sub_68678C(&qword_27EF268, __p, &v14, 1uLL);
  if (v13 < 0)
  {
  ...
  *algn_27EF288 = 0;
  qword_27EF290 = 0;
  sub_68678C(&qword_27EF280, __p, &v14, 1uLL);
  if (v13 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF2A0 = 0;
  qword_27EF2A8 = 0;
  sub_68678C(&qword_27EF298, __p, &v14, 1uLL);
  if (v13 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1D17BAC(v0, v1, v2, v3, v4, v5, v6, v7);
  sub_3608D0(__p, "en_US");
  LODWORD(v14) = 0;
  sub_3608D0(&v14 + 1, "en-US_US");
  v16 = 0;
  sub_3608D0(&v17, "en_AU");
  v19 = 1;
  sub_3608D0(v20, "en-AU_AU");
  v21 = 1;
  sub_3608D0(v22, "en_CA");
  v23 = 2;
  sub_3608D0(v24, "en-CA_CA");
  v25 = 2;
  sub_3608D0(v26, "en_GB");
  v27 = 3;
  sub_3608D0(v28, "en-GB_GB");
  v29 = 3;
  sub_3608D0(v30, "en_IE");
  v31 = 4;
  sub_3608D0(v32, "en-IE_IE");
  v33 = 4;
  sub_3608D0(v34, "en_NZ");
  v35 = 4;
  sub_3608D0(v36, "en-NZ_NZ");
  v37 = 4;
  sub_3608D0(v38, "en_ZA");
  v39 = 4;
  sub_3608D0(v40, "en-ZA_ZA");
  v41 = 4;
  sub_19664AC(&unk_27EF2C8, __p, 14);
  v8 = 56;
  do
  {
    if (*(&__p[v8 - 1] - 1) < 0)
  ...
  sub_3608D0(v80, "EG");
  v81 = 6;
  sub_1966844(&unk_27EF2F0, __p, 34);
  v9 = 136;
  do
  {
    if (*(&__p[v9 - 1] - 1) < 0)
  ...
  while (v9 * 8);
  sub_3608D0(__p, "earthstats.length");
  sub_3608D0(&v14, "earthstats.highest_point");
  sub_3608D0(&v15, "earthstats.lowest_point");
  qword_27EF318 = 0;
  unk_27EF320 = 0;
  qword_27EF328 = 0;
  sub_68678C(&qword_27EF318, __p, &v18, 3uLL);
  for (i = 0; i != -72; i -= 24)
  {
    if (*(&v17 + i + 7) < 0)
    {
  ...
  sub_1D119C4(__p, "navigation.trails", &qword_27EF318);
  sub_1D12C10(qword_27EF330, __p, 1);
  v11 = &v14;
  sub_195E3E8(&v11);
  if (v13 < 0)
  {
...
void sub_1D2302C(_Unwind_Exception *a1)
{
  *(v2 - 24) = v1;
  sub_1A3CCC4((v2 - 24));
  _Unwind_Resume(a1);
...
void sub_1D23888(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, std::__shared_weak_count *a15, uint64_t a16, std::__shared_weak_count *a17, char a18, uint64_t a19, uint64_t a20, uint64_t a21, std::__shared_weak_count *a22, char a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, char a49)
{
  v53 = 72;
  while (1)
  {
...
void sub_1D2403C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, std::__shared_weak_count *a12, uint64_t a13, std::__shared_weak_count *a14, uint64_t a15, std::__shared_weak_count *a16)
{
  if (a16)
  {
    sub_1220A18(a16);
...
void sub_1D240F0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  if (!a16)
  {
    JUMPOUT(0x1D240D0);
...
void sub_1D242F0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, void ***a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, void **a19)
{
  *(v20 - 40) = &a12;
  sub_1A3CCC4((v20 - 40));
  a12 = &a19;
...
void sub_1D24B3C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, std::__shared_weak_count *a11, uint64_t a12, uint64_t a13, std::__shared_weak_count *a14, uint64_t a15, std::__shared_weak_count *a16, uint64_t a17, uint64_t a18, uint64_t a19)
{
  v21 = 40;
  while (1)
  {
...
void sub_1D24DC4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, std::__shared_weak_count *a11, uint64_t a12, uint64_t a13, std::__shared_weak_count *a14, uint64_t a15, std::__shared_weak_count *a16, uint64_t a17, uint64_t a18, uint64_t a19)
{
  v21 = 40;
  while (1)
  {
...
uint64_t sub_1D25178(uint64_t a1, uint64_t *a2, int a3)
{
  *(a1 + 8) = a3;
  *a1 = off_27261B0;
  *(a1 + 16) = 0;
...
char *sub_1D251EC(void *a1, char *a2, uint64_t *a3, void *a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
    ...
    if (a5 <= (v9 - v10) >> 4)
    {
      ...
      if (v17 >= a5)
      {
        sub_1D253D0(a1, a2, a1[1], &a2[16 * a5]);
        v18 = &v7[2 * a5];
      }

      else
      {
        a1[1] = sub_1D25434(a1, (a3 + v16), a4, a1[1]);
        if (v17 < 1)
        {
          return v5;
        }

        sub_1D253D0(a1, v5, v10, &v5[16 * a5]);
        v18 = (v7 + v16);
      }

      sub_1D25558(v30, v7, v18, v5);
      return v5;
    }
...
void *sub_1D253D0(uint64_t a1, void *a2, unint64_t a3, uint64_t a4)
{
  v6 = *(a1 + 8);
  v7 = (a2 + v6 - a4);
  v8 = v6;
  ...
  *(a1 + 8) = v8;
  return sub_1D254F4(&v11, a2, v7, v6);
}

void *sub_1D25434(uint64_t a1, void *a2, void *a3, void *a4)
{
  v4 = a4;
  v10 = a4;
  v9 = a4;
...
uint64_t sub_1D254BC(uint64_t a1)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_1A7D994(a1);
...
void *sub_1D254F4(uint64_t a1, void *a2, void *a3, uint64_t a4)
{
  if (a3 != a2)
  {
    v7 = a3;
...
uint64_t *sub_1D25558(uint64_t a1, uint64_t *a2, uint64_t *a3, uint64_t *a4)
{
  v5 = a2;
  if (a2 != a3)
  {
...
uint64_t *sub_1D255D0(uint64_t *result, void *a2, void *a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_1D25638(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_1A3CCC4(&a9);
  _Unwind_Resume(a1);
...
void *sub_1D256C4(void *a1, uint64_t *a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27249C0;
...
void sub_1D25740(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27249C0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t *sub_1D257C4(uint64_t *a1, uint64_t *a2)
{
  v6 = *a2;
  v3 = v6;
  v7 = *(a2 + 1);
  ...
  *a2 = 0;
  ...
  a1[2] = 0;
  *a1 = 0;
  sub_1D25850(a1, v3, v4, (v4 - v3) >> 4);
  v8 = &v6;
  sub_1A3CCC4(&v8);
  return a1;
}

void sub_1D25834(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, void **a12)
{
  a12 = &a9;
  sub_1A3CCC4(&a12);
  _Unwind_Resume(a1);
...
uint64_t *sub_1D25850(uint64_t *result, void *a2, void *a3, unint64_t a4)
{
  if (a4)
  {
    sub_1A7D898(result, a4);
...
void sub_1D258B8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_1A3CCC4(&a9);
  _Unwind_Resume(a1);
...
void sub_1D258F8(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724A10;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D259C8(void *a1, char *a2, __int128 *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724A60;
  sub_1D25B10((a1 + 3), a2, a3);
  return a1;
}

void sub_1D25A44(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724A60;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1D25A98(uint64_t a1)
{
  *(a1 + 24) = &off_2722DC0;
  if (*(a1 + 71) < 0)
  {
...
uint64_t sub_1D25B10(uint64_t a1, char *a2, __int128 *a3)
{
  sub_3608D0(__p, a2);
  v6 = *a3;
  *a3 = 0;
  *(a3 + 1) = 0;
  sub_1A7B5A4(a1, __p, &v6);
  if (*(&v6 + 1))
  {
    sub_1220A18(*(&v6 + 1));
  }
...
void sub_1D25B80(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, void *__p, uint64_t a13, int a14, __int16 a15, char a16, char a17)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D25C14(void *a1, void **a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27249C0;
...
uint64_t *sub_1D25C70(uint64_t *a1, void **a2)
{
  v4 = 0;
  v5 = 0;
  v6 = 0;
  sub_1D25850(&v4, *a2, a2[1], (a2[1] - *a2) >> 4);
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
  sub_1D25850(a1, v4, v5, (v5 - v4) >> 4);
  v7 = &v4;
  sub_1A3CCC4(&v7);
  return a1;
}

void sub_1D25CE8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1A3CCC4(va);
  _Unwind_Resume(a1);
...
void sub_1D25D20(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724AB0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1D25D74(uint64_t a1)
{
  v1 = *(a1 + 32);
  if (v1)
  {
...
void sub_1D25DA8(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724B00;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D25E70(void *a1, __int128 *a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724B50;
...
void sub_1D25EEC(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724B50;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D25F68(uint64_t a1, __int128 *a2)
{
  v4 = *a2;
  v5 = *(a2 + 2);
  *(a2 + 8) = 0uLL;
...
void sub_1D25FC4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1A3CCC4(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1D25FDC(uint64_t a1, uint64_t **a2)
{
  *(a1 + 8) = 0;
  *a1 = off_2726270;
  *(a1 + 16) = 0;
  ...
  *(a1 + 32) = 0;
  if ((a1 + 16) != a2)
  {
    sub_1D2606C((a1 + 16), *a2, a2[1], (a2[1] - *a2) >> 4);
  }

  return a1;
}

void sub_1D26054(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A3CCC4(va);
  _Unwind_Resume(a1);
...
void sub_1D2606C(uint64_t *a1, uint64_t *a2, uint64_t *a3, unint64_t a4)
{
  v8 = *a1;
  if (a4 > (a1[2] - *a1) >> 4)
  {
  ...
  {
    sub_1D25558(&v17, a2, (a2 + v12), v8);
    a1[1] = sub_1D25434(a1, (a2 + v12), a3, a1[1]);
  }
}

void sub_1D261AC(uint64_t *a1)
{
  if (*a1)
  {
    sub_1A3CD18(a1);
...
void *sub_1D26270(void *a1, __int128 **a2, uint64_t *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724BA0;
  sub_1D26368((a1 + 3), a2, a3, a4);
  return a1;
}

void sub_1D262EC(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724BA0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D26368(uint64_t a1, __int128 **a2, uint64_t *a3, uint64_t *a4)
{
  memset(v14, 0, sizeof(v14));
  sub_353184(v14, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  v7 = a3[1];
  v12 = *a3;
  v13 = v7;
  if (v7)
...
void sub_1D2643C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12, char a13)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1D26470(uint64_t a1, __int128 **a2, void *a3, void *a4)
{
  *(a1 + 8) = 0;
  *a1 = off_2726070;
  *(a1 + 24) = 0;
  *(a1 + 32) = 0;
  *(a1 + 16) = 0;
  sub_353184(a1 + 16, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  v7 = a3[1];
  *(a1 + 40) = *a3;
  *(a1 + 48) = v7;
  if (v7)
...
void *sub_1D265A0(void *a1, __int128 **a2, uint64_t *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724BA0;
  sub_1D265FC((a1 + 3), a2, a3, a4);
  return a1;
}

uint64_t sub_1D265FC(uint64_t a1, __int128 **a2, uint64_t *a3, uint64_t *a4)
{
  memset(v14, 0, sizeof(v14));
  sub_353184(v14, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  v7 = a3[1];
...
void sub_1D266D0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12, char a13)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D26724(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724BF0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D2680C(void *a1, char *a2, unsigned int *a3, char *a4, char *a5)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724C40;
  sub_1EF5DC8((a1 + 3), *a2, *a3, *a4, *a5);
  return a1;
}

void sub_1D26898(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724C40;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D26968(void *a1, uint64_t *a2, uint64_t *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724C90;
  sub_1D26A40(a1 + 3, a2, a3);
  return a1;
}

void sub_1D269E4(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724C90;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D26A40(void *a1, uint64_t *a2, uint64_t *a3)
{
  v4 = *a2;
  v5 = a2[1];
  *a2 = 0;
...
void sub_1D26B04(uint64_t a1, void *a2)
{
  *a2 = &off_2726AA0;
  v3 = a2[4];
  if (v3)
...
void *sub_1D26BF4(void *a1, uint64_t *a2, int *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724CE0;
  sub_1D26CEC((a1 + 3), a2, a3, a4);
  return a1;
}

void sub_1D26C70(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724CE0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D26CEC(uint64_t a1, uint64_t *a2, int *a3, uint64_t *a4)
{
  v5 = *a2;
  v6 = a2[1];
  if (v6)
...
void *sub_1D26E08(void *a1, uint64_t *a2, uint64_t *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724D30;
  sub_1D26F00((a1 + 3), a2, a3);
  return a1;
}

void sub_1D26E84(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724D30;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D26F00(uint64_t a1, uint64_t *a2, uint64_t *a3)
{
  v4 = *a2;
  v5 = a2[1];
  if (v5)
...
void sub_1D26FC4(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724D80;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D270E4(void *a1, __int128 **a2, uint64_t *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724BA0;
  sub_1D27140((a1 + 3), a2, a3, a4);
  return a1;
}

uint64_t sub_1D27140(uint64_t a1, __int128 **a2, uint64_t *a3, uint64_t *a4)
{
  memset(v14, 0, sizeof(v14));
  sub_353184(v14, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  v7 = a3[1];
...
void sub_1D27214(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12, char a13)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D27268(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724E10;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1D272E4(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724E60;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D273E4(void *a1, __int128 **a2, __int128 *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724BA0;
  sub_1D27440((a1 + 3), a2, a3, a4);
  return a1;
}

uint64_t sub_1D27440(uint64_t a1, __int128 **a2, __int128 *a3, uint64_t *a4)
{
  memset(v12, 0, sizeof(v12));
  sub_353184(v12, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  v11 = *a3;
  *a3 = 0;
  *(a3 + 1) = 0;
  v7 = a4[1];
...
void sub_1D27508(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12, char a13)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D275B0(void *a1, __int128 *a2, unsigned int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724EB0;
  sub_1D276A8((a1 + 3), a2, a3);
  return a1;
}

void sub_1D2762C(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724EB0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D276A8(uint64_t a1, __int128 *a2, unsigned int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D27710(a1, &v5, *a3);
  if (*(&v5 + 1))
  {
    sub_1220A18(*(&v5 + 1));
  }
...
void sub_1D276F8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1D27710(uint64_t a1, uint64_t *a2, int a3)
{
  *(a1 + 8) = a3;
  *a1 = off_2726170;
  *(a1 + 16) = 0;
...
void *sub_1D277F8(void *a1, __int128 *a2, unsigned int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724F00;
  sub_1D278F0((a1 + 3), a2, a3);
  return a1;
}

void sub_1D27874(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724F00;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D278F0(uint64_t a1, __int128 *a2, unsigned int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D27958(a1, &v5, *a3);
  if (*(&v5 + 1))
  {
    sub_1220A18(*(&v5 + 1));
  }
...
void sub_1D27940(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1D27958(uint64_t a1, uint64_t *a2, int a3)
{
  *(a1 + 8) = a3;
  *a1 = off_27260F0;
  *(a1 + 16) = 0;
...
void *sub_1D27A40(void *a1, char *a2, uint64_t *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724F50;
  sub_1D27B88((a1 + 3), a2, a3);
  return a1;
}

void sub_1D27ABC(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724F50;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1D27B10(uint64_t a1)
{
  *(a1 + 24) = &off_2727430;
  if (*(a1 + 71) < 0)
  {
...
uint64_t sub_1D27B88(uint64_t a1, char *a2, uint64_t *a3)
{
  sub_3608D0(__p, a2);
  sub_204A7E8(a1, __p, a3);
  if (v7 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1D27BE0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void *sub_1D27C70(void *a1, __int128 *a2, unsigned int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724FA0;
  sub_1D27D68((a1 + 3), a2, a3);
  return a1;
}

void sub_1D27CEC(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724FA0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D27D68(uint64_t a1, __int128 *a2, unsigned int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D27DD0(a1, &v5, *a3);
  if (*(&v5 + 1))
  {
    sub_1220A18(*(&v5 + 1));
  }
...
void sub_1D27DB8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1D27DD0(uint64_t a1, uint64_t *a2, int a3)
{
  *(a1 + 8) = a3;
  *a1 = off_2726230;
  *(a1 + 16) = 0;
...
void sub_1D27E64(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2724FF0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D27F34(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724E60;
  sub_1D27F90((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D27F90(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D25178(a1, &v5, *a3);
  if (*(&v5 + 1))
  {
    sub_1220A18(*(&v5 + 1));
  }
...
void sub_1D27FE0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D28018(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725040;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D280E8(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724E60;
  sub_1D28144((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D28144(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D25178(a1, &v5, *a3);
...
void sub_1D28194(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D28220(void *a1, uint64_t *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724E60;
  sub_1D2827C((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D2827C(uint64_t a1, uint64_t *a2, int *a3)
{
  v4 = a2[1];
  v6 = *a2;
  v7 = v4;
...
void sub_1D282DC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D28314(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725090;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D283E4(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724E60;
  sub_1D28440((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D28440(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D25178(a1, &v5, *a3);
...
void sub_1D28490(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D2851C(void *a1, uint64_t *a2, uint64_t *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27250E0;
  sub_1D28614((a1 + 3), a2, a3);
  return a1;
}

void sub_1D28598(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27250E0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D28614(uint64_t a1, uint64_t *a2, uint64_t *a3)
{
  v4 = *a2;
  v5 = a2[1];
  if (v5)
...
void sub_1D286D8(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725130;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D287A8(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2724E60;
  sub_1D28804((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D28804(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D25178(a1, &v5, *a3);
...
void sub_1D28854(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D288D8(void *a1, uint64_t *a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2725180;
...
void sub_1D28954(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725180;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1D289A8(uint64_t a1)
{
  *(a1 + 24) = &off_2722150;
  v1 = *(a1 + 40);
  if (v1)
...
void *sub_1D289DC(void *a1, uint64_t *a2)
{
  v3 = a2[1];
  v5 = *a2;
  v6 = v3;
...
void sub_1D28A38(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D28AC4(void *a1, __int128 *a2, unsigned int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D28BBC((a1 + 3), a2, a3);
  return a1;
}

void sub_1D28B40(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27251D0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1D28BBC(uint64_t a1, __int128 *a2, unsigned int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
  if (*(&v5 + 1))
  {
    sub_1220A18(*(&v5 + 1));
  }
...
void sub_1D28C0C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1D28C24(uint64_t a1, uint64_t *a2, int a3)
{
  *(a1 + 8) = a3;
  *a1 = off_27261F0;
  *(a1 + 16) = 0;
...
void sub_1D28CB8(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725220;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D28D88(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D28DE4((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D28DE4(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
...
void sub_1D28E34(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void *sub_1D28EC0(void *a1, uint64_t *a2, uint64_t *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27250E0;
...
void sub_1D28F3C(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725270;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D2900C(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D29068((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D29068(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
...
void sub_1D290B8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D290F0(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27252C0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D291C0(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D2921C((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D2921C(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
...
void sub_1D2926C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D292A4(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725310;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D29374(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D293D0((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D293D0(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
...
void sub_1D29420(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D29458(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725360;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1D29528(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D29584((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D29584(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
...
void sub_1D295D4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1D29648(uint64_t a1)
{
  *(a1 + 8) = 0;
  *(a1 + 16) = 0;
  *a1 = off_27253B0;
...
void sub_1D296D8(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27253B0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1D2972C(uint64_t a1)
{
  *(a1 + 24) = &off_2727460;
  v2 = (a1 + 56);
  sub_195E3E8(&v2);
...
void *sub_1D29798(void *a1)
{
  ...
  *v2 = 0;
  ...
  a1[5] = 0;
  a1[6] = 0;
  sub_68678C((a1 + 4), &v6, &v9, 3uLL);
  for (j = 0; j != -9; j -= 3)
  {
    if (SHIBYTE(v8[j + 2]) < 0)
    {
      operator delete(v8[j]);
    }
  }
...
void sub_1D29904(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, int a20, __int16 a21, char a22, char a23)
{
  v24 = &a23;
  v25 = -72;
  v26 = &a23;
...
void *sub_1D29A3C(void *a1, __int128 *a2, int *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_27251D0;
  sub_1D29A98((a1 + 3), a2, a3);
  return a1;
}

uint64_t sub_1D29A98(uint64_t a1, __int128 *a2, int *a3)
{
  v5 = *a2;
  *a2 = 0uLL;
  sub_1D28C24(a1, &v5, *a3);
...
void sub_1D29AE8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_1D29B00(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EF390, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1D346DC(_Unwind_Exception *a1)
{
  v3 = (v1 + 95);
  v4 = -96;
  v5 = v3;
...
void sub_1D348C4(_Unwind_Exception *a1)
{
  v3 = (v1 + 191);
  v4 = -192;
  v5 = v3;
...
void sub_1D349F4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1D34B14(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, uint64_t a17, int a18, __int16 a19, char a20, char a21)
{
  v22 = &a21;
  v23 = -48;
  v24 = &a21;
...
void sub_1D34CB0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, int a23, __int16 a24, char a25, char a26)
{
  v27 = &a26;
  v28 = -120;
  v29 = &a26;
...
void sub_1D34D24()
{
  ...
  unk_27EF350 = 0;
  qword_27EF358 = 0;
  sub_68678C(&qword_27EF348, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF368 = 0;
  qword_27EF370 = 0;
  sub_68678C(&qword_27EF360, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF380 = 0;
  qword_27EF388 = 0;
  sub_68678C(&qword_27EF378, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1D29B00(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1D34E44(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1D34E70(uint64_t a1)
{
  if (*(a1 + 212) == 55)
  {
    return 4;
...
void sub_1D34ED0(uint64_t a1@<X0>, uint64_t a2@<X1>, double *a3@<X2>, int a4@<W3>, uint64_t a5@<X4>, uint64_t a6@<X8>)
{
  *a6 = 0;
  *(a6 + 104) = 0;
  v12 = (a6 + 104);
  *(a6 + 96) = 0;
  *(a6 + 136) = vdupq_n_s64(0x7FF8000000000000uLL);
  v13 = (a6 + 136);
  *(a6 + 112) = 0;
  *(a6 + 120) = 0;
  *(a6 + 128) = 0;
  ...
  *(a6 + 155) = sub_197280C(a1);
  v15 = *(a6 + 96);
  if (v15 == 1)
  {
    v16 = sub_1D0E89C(a6) >= *(a5 + 320);
    LOBYTE(v15) = *(a6 + 96);
  }
...
LABEL_44:
  ...
  {
LABEL_34:
    if ((*(a6 + 154) & *(a6 + 153) & 1) != 0 || (*(a6 + 96) & *(a6 + 152)) == 0)
    {
      v26 = *a2;
      v27 = *(a2 + 8);
    }
    ...
    *(a6 + 136) = v26;
    *(a6 + 144) = v27;
    if (!sub_19726C8(a1) && *(a6 + 96) == 1 && *(a6 + 152) == 1 && *(a6 + 153) == 1 && (*(a6 + 154) & 1) == 0)
    {
      *(a6 + 128) = 1;
    }
  }
...
LABEL_49:
    ...
    v42 = 0;
    v43 = 0;
    sub_1962488(&v41, v28, v29, 0xAAAAAAAAAAAAAAABLL * ((v29 - v28) >> 5));
    v31 = v41;
    v32 = v42;
    if (v42 - v41 == 96)
    {
    ...
    else
    {
      ...
      do
      {
        v37 = sub_1D0E7B8(v31);
        v39 = v38;
        v40 = sub_1BE3C40(v37, v38, *(a6 + 136), *(a6 + 144)) * 6372.79756;
        if (v36 > v40)
        {
          v33 = v37;
          v35 = v39;
  ...
  sub_1BEF404((a5 + 1464), a5 + 8, v13, &v44, v30);
  sub_1D3666C(v12);
  *(a6 + 104) = v44;
  *(a6 + 120) = v45;
  v45 = 0;
...
void sub_1D352C8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, void **a13)
{
  a13 = &a10;
  sub_1962638(&a13);
  sub_1963608(v13);
...
uint64_t sub_1D35314(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v6 = sub_1963A80(a1, a3);
  ...
  *(v6 + 1744) = 0u;
  *(v6 + 1760) = 0;
  sub_1919814(v6 + 1768, 0, 0);
  sub_18FA5D4(a1 + 2120, a2);
  sub_16C9C58((a1 + 2344), 0, 0);
  *(a1 + 2408) = 0u;
  *(a1 + 2400) = a1 + 2408;
  *(a1 + 2424) = 0;
  *(a1 + 2488) = 0;
  ...
  *(a1 + 2632) = 0;
  *(a1 + 2616) = 0u;
  *(a1 + 2640) = vdupq_n_s64(0x7FF8000000000000uLL);
  *(a1 + 2656) = 0;
  *(a1 + 2664) = 257;
  *(a1 + 2666) = 1;
  sub_16E58B4(&v63, 0, 0);
  ...
  if ((v10 & 0x200) != 0)
  {
    ...
    v15 = *(v14 + 13) & 0xFFFFFFFFFFFFFFFELL;
    if (*(v15 + 23) < 0)
    {
      sub_325C(&__str, *v15, *(v15 + 8));
    }

    else
    {
      v16 = *v15;
      __str.__r_.__value_.__r.__words[2] = *(v15 + 16);
  ...
  {
    v17 = v9[7];
    v18 = v17[20] & 0xFFFFFFFFFFFFFFFELL;
    if (*(v18 + 23) < 0)
    {
      sub_325C(&__str, *v18, *(v18 + 8));
    }

    else
    {
      v19 = *v18;
      __str.__r_.__value_.__r.__words[2] = *(v18 + 16);
...
LABEL_134:
    ...
    v58 = 0;
    v56 = 0x3FF0000000000000;
    std::string::operator=(&v60, (v31[3] & 0xFFFFFFFFFFFFFFFELL));
    v32 = v64;
    if ((v64 & 2) != 0)
    {
      v32 = 0;
...
LABEL_135:
  ...
  v24 = v9[8];
  v25 = sub_3608D0(&__str, "");
  v26 = *(v24 + 10);
  if (v26)
  {
    std::string::operator=(v25, (v24[6] & 0xFFFFFFFFFFFFFFFELL));
  }

  else if ((v26 & 4) != 0)
  {
    sub_1ED4BC4(v24[8], &v67);
    if (SHIBYTE(__str.__r_.__value_.__r.__words[2]) < 0)
    {
      operator delete(__str.__r_.__value_.__l.__data_);
    }
  ...
  if (SHIBYTE(__str.__r_.__value_.__r.__words[2]) < 0)
  {
    sub_325C(&v67, __str.__r_.__value_.__l.__data_, __str.__r_.__value_.__l.__size_);
  }
...
LABEL_138:
  ...
  *(a1 + 1720) = v44;
  ...
  sub_1A8DA2C(v46, &v53, a3);
  sub_1D361E8(a1 + 2344, &v53);
  sub_196318C(&v56, v57);
  sub_16C9ED4(&v53);
  if (*(a2 + 192))
  {
  ...
  *(a1 + 2496) = sub_1A8DFFC(v47);
  ...
  sub_1A8DDE8(v48, &v53);
  sub_1D36930((a1 + 2424), &v53);
  if (v57 == 1)
  {
    sub_139A0E0(&v53);
  }

  sub_1D34ED0(a2, a1 + 1712, &v63, v65, a3, &v53);
  sub_1D365CC(a1 + 2504, &v53);
  sub_1D3666C((a1 + 2608));
  *(a1 + 2608) = v60;
  memset(&v60, 0, sizeof(v60));
  v49 = *v62;
...
void sub_1D35D00(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, ...)
{
  va_start(va, a30);
  sub_1D35F44(va);
  sub_1963608(v30 + 2504);
  if (*(v30 + 2488) == 1)
  {
    sub_139A0E0(v30 + 2424);
  }

  sub_1962034(v30 + 2344);
  sub_18FA778((v30 + 2120));
  sub_191A17C((v30 + 1768));
  v33 = *(v30 + 1760);
  if (v33)
  {
    sub_1220A18(v33);
...
uint64_t sub_1D35E84(uint64_t a1, uint64_t a2)
{
  if (a1 != a2)
  {
    v4 = *(a1 + 8);
...
uint64_t sub_1D35F44(uint64_t a1)
{
  if (*(a1 + 127) < 0)
  {
    operator delete(*(a1 + 104));
  ...
  return sub_16E5B34(a1);
}

void sub_1D35F88(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
void sub_1D3608C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
