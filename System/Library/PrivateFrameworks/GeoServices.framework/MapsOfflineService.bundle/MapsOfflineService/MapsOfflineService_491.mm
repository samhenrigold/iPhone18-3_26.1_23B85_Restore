...
void sub_1A21CCC()
{
  ...
  *algn_27ED308 = 0;
  qword_27ED310 = 0;
  sub_68678C(&qword_27ED300, __p, v13, 1uLL);
  if (v12 < 0)
  {
  ...
  unk_27ED320 = 0;
  qword_27ED328 = 0;
  sub_68678C(&qword_27ED318, __p, v13, 1uLL);
  if (v12 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED338 = 0;
  qword_27ED340 = 0;
  sub_68678C(&qword_27ED330, __p, v13, 1uLL);
  if (v12 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1A17210(v1, v2, v3, v4, v5, v6, v7, v8);
...
void sub_1A22510(uint64_t a1@<X0>, int a4@<W3>, void *a5@<X8>)
{
  *a5 = 0;
  a5[1] = 0;
  v5 = *(a1 + 23);
...
void *sub_1A2261C(void *a1, int a2, std::string *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2722100;
  sub_1B154B4((a1 + 3), a2, a3);
  return a1;
}
...
void sub_1A22714(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ED3F8, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1A2D1D0()
{
  ...
  *algn_27ED3B8 = 0;
  qword_27ED3C0 = 0;
  sub_68678C(&qword_27ED3B0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ED3D0 = 0;
  qword_27ED3D8 = 0;
  sub_68678C(&qword_27ED3C8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED3E8 = 0;
  qword_27ED3F0 = 0;
  sub_68678C(&qword_27ED3E0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1A22714(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
void sub_1A2D31C(uint64_t a1@<X0>, int a2@<W1>, const void **a3@<X8>)
{
  *a3 = 0;
  ...
  while (1)
  {
    if ((atomic_load_explicit(byte_278C268, memory_order_acquire) & 1) == 0)
    {
      sub_1A2FA18(a1);
    }
...
void sub_1A2D4C4(int a1@<W1>, uint64_t a2@<X8>, unsigned int *a3@<X0>)
{
  if (a1)
  {
    v4 = sub_1B120C4(a3);
...
void sub_1A2D87C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A2D564(va);
  _Unwind_Resume(a1);
...
void sub_1A2D8F0(std::string *a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X8>)
{
  ...
  while (1)
  {
    ...
    v12 = vcvtq_f64_f32(v11[29]);
    if (sub_1D0E8F8(v12.f64, v7))
    {
      break;
    }
...
void sub_1A2E420(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_196005C(va);
...
void sub_1A2E458(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, __int128 *a4@<X3>, uint64_t a5@<X8>)
{
  if (*(a4 + 23) < 0)
  {
    sub_325C(&v34, *a4, *(a4 + 1));
  }
...
void sub_1A2E6F4(std::string *a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, __int128 *a4@<X3>, uint64_t a5@<X8>)
{
  sub_20BEBE8(__p, a1);
...
void sub_1A2ED30(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1A2EFE0(va);
  _Unwind_Resume(a1);
...
_BYTE *sub_1A2ED44(uint64_t a1, uint64_t a2, __int128 *a3)
{
  v5 = *a3;
  *(a2 + 16) = *(a3 + 2);
  *a2 = v5;
