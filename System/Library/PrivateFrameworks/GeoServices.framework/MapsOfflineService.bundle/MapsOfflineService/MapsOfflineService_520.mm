...
void sub_1C4BF5C()
{
  ...
  unk_27EE9E0 = 0;
  qword_27EE9E8 = 0;
  sub_68678C(&qword_27EE9D8, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  *algn_27EE9F8 = 0;
  qword_27EEA00 = 0;
  sub_68678C(&qword_27EE9F0, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EEA10 = 0;
  qword_27EEA18 = 0;
  sub_68678C(&qword_27EEA08, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1C414A0(v0, v1, v2, v3, v4, v5, v6, v7);
  ...
  v37 = 4;
  sub_19664AC(&unk_27EEA38, __p, 14);
  v8 = 56;
  do
  {
    if (*(&__p[v8 - 1] - 1) < 0)
  ...
  sub_3608D0(v76, "EG");
  v77 = 6;
  sub_1966844(&unk_27EEA60, __p, 34);
  v9 = 136;
  do
  {
    if (*(&__p[v9 - 1] - 1) < 0)
...
void sub_1C4C5FC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
void sub_1C4C7A0(uint64_t **a1, uint64_t a2)
{
  sub_3608D0(v11, "rev_country");
  LODWORD(v10[0]) = 8;
...
void sub_1C4C8EC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_197F740(va);
  sub_197F7C0(v13 - 56);
...
void sub_1C4C934(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  if (!(*(*a1 + 8))(a1))
  {
    sub_1B68F64();
  ...
  sub_3608D0(a2, &unk_236CB84);
}

void sub_1C4CD10(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, void *a13, uint64_t a14, uint64_t a15, void **a16, uint64_t a17, uint64_t a18, void *a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, void *a25, uint64_t a26, uint64_t a27, void *__p, uint64_t a29, int a30, __int16 a31, char a32, char a33, void *a34, uint64_t a35, uint64_t a36, void *a37, uint64_t a38, int a39, __int16 a40, char a41, char a42, void *a43, uint64_t a44, uint64_t a45, char a46)
{
  if (a33 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1C4D088(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2723A40;
...
void sub_1C4D110(uint64_t a1, uint64_t *a2)
{
  v2 = a2[1];
  v3 = *a2;
  v4 = v2;
...
void sub_1C4D1E0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12)
{
  if (a12)
  {
    sub_1220A18(a12);
...
uint64_t sub_1C4D218(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1C4D284(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2723AB0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1C4D300(uint64_t a1, uint64_t *a2, char *a3)
{
  v5 = *a2;
  v4 = a2[1];
  if (v4)
...
uint64_t sub_1C4D4A0(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2723B10;
...
void sub_1C4D64C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1C4D678(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1C4D6C4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EEAD0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1C546AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v80 = -13944;
  v81 = v74;
  do
...
void sub_1C58180()
{
  ...
  unk_27EEA90 = 0;
  qword_27EEA98 = 0;
  sub_68678C(&qword_27EEA88, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EEAA8 = 0;
  qword_27EEAB0 = 0;
  sub_68678C(&qword_27EEAA0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EEAC0 = 0;
  qword_27EEAC8 = 0;
  sub_68678C(&qword_27EEAB8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1C4D6C4(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1C582A0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1C582CC(std::string *a1@<X1>, uint64_t *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
          ...
          if (v18 != v17)
          {
            ...
            if (v18 - v7 != -1)
            {
              ...
              while (2)
              {
                if (v21 != v15)
                {
                  std::string::basic_string(&v30, a1, v15, v21 - v15, &v40);
                ...
                v15 = v21 + 1;
                v22 = (v4 & 0x80u) == 0 ? a1 : v5;
                v8 = (v4 & 0x80u) == 0 ? v4 : size;
                v23 = (v9 & 0x80u) == 0 ? &v37 : v10;
                v24 = (v9 & 0x80u) == 0 ? v9 : v11;
                if (v8 > v15 && v24)
                {
                  v25 = v22 + v8;
                  v26 = v22 + v15;
...
LABEL_19:
  if (v15 < v8)
  {
    std::string::basic_string(&v29, a1, v15, ~v15, &v40);
    ...
    {
      sub_325C(&__p, v29.__r_.__value_.__l.__data_, v29.__r_.__value_.__l.__size_);
      v32 = v15;
      v33 = v16;
      v35 = 0;
      v36 = 0;
...
void sub_1C585C4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, uint64_t a16, int a17, __int16 a18, char a19, char a20, uint64_t a21)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1C58638(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27EEB30, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
