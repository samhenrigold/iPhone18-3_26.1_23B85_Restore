void sub_AF64F0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void **a10, void **a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18)
{
  STACK[0x238] = a18 + 240;
...
uint64_t sub_AF930C(uint64_t a1, uint64_t a2)
{
  if (*a1 == -1)
  {
    return 0;
...
unint64_t sub_AF9E48(uint64_t *a1, unsigned int a2, __int128 *a3)
{
  v5 = a2;
  v6 = *a1;
  v7 = (a1[1] - *a1) >> 3;
...
unint64_t sub_AFA5A0(uint64_t *a1, unsigned int a2, unsigned int a3)
{
  v3 = *a1;
...
uint64_t sub_AFA818(uint64_t a1, int a2, unsigned int a3)
{
  ...
  *(a1 + 560) = *(a1 + 560) + 1.0;
  ...
  {
    *(v10 + 8 * (v6 >> 6)) = (1 << a3) | v11;
    sub_DD38(v5 + 352, v257);
    v6 = v257[0];
  }

  v218 = *(*(v5 + 304) + 4 * v6);
  result = sub_A9D53C(&v255, *(v5 + 24), v226);
  v13 = v255;
  if (v255 < v256)
  {
    v221 = v5;
    ...
    while (1)
    {
      *(v5 + 568) = *(v5 + 568) + 1.0;
      v220 = *v13;
      sub_AE5278((v5 + 128), 0);
      result = sub_A79708(&v243, *(v5 + 24), v226, v218, 0, 1);
      v15 = v247;
...
LABEL_308:
      ...
      *(v18 + 96) = v82;
      v242 = *(v51 + 8);
      result = sub_C435EC((v5 + 384), v242, v17);
      if ((result & 1) == 0)
      {
LABEL_118:
        if (*(v5 + 21))
...
LABEL_130:
        ...
        result = sub_AE55B4((v5 + 128), 0, (v94 + (v95 << 6)), (v102 + (v92[1] << 6)));
        goto LABEL_200;
      }
...
LABEL_157:
          if (!sub_AFBF70((v5 + 128), 0, v217 + v107 + v107 * v109, v107 + v107 * v109, v108, v114))
          {
            goto LABEL_161;
          }
          ...
          if (*(v5 + 216) <= v242)
          {
            sub_4D9168(v5 + 208, v242 + 1, 0);
            v115 = v242;
          }

          if ((*(*(v5 + 208) + ((v115 >> 3) & 0x1FFFFFF8)) >> v115))
          {
LABEL_161:
            v116 = *(v5 + 128);
            v117 = *(v5 + 136);
...
LABEL_163:
          ...
          {
            sub_DD38(v5 + 232, &v242);
            *(*(v5 + 208) + ((v242 >> 3) & 0x1FFFFFF8)) |= 1 << v242;
            v116 = *(v5 + 128);
            v117 = *(v5 + 136);
            v118 = v117 - v116;
            if (v117 == v116)
...
LABEL_193:
      if ((*(v247 + 15) & 2) != 0)
      {
        ...
        {
LABEL_198:
          v139 = v219 + *(v5 + 120) + *(v5 + 120) * v242;
          v140 = *(v5 + 128);
          if (v139 >= (*(v5 + 136) - v140) >> 3)
          {
            goto LABEL_200;
          }
          ...
          v149 = 0;
          v222 = v142 - v141;
          v223 = v219 + *(v5 + 120) + *(v5 + 120) * v242;
          while (2)
          {
            v150 = *(v5 + 128);
            if (v139 >= (*(v5 + 136) - v150) >> 3 || (v152 = (v150 + 8 * v139), v151 = *v152, v152[1] - *v152 <= v149))
            {
...
LABEL_306:
            ...
            if (v252 == 1)
            {
              result = sub_A7A1E8(*(v5 + 24), &v243, *(v247 + 2) + *(v155 + 28), 1u);
              if (result)
              {
                goto LABEL_228;
              }
...
uint64_t sub_AFC84C(uint64_t a1, unsigned int a2)
{
  v132 = a2;
  *(a1 + 688) = a2;
  v3 = *(a1 + 104);
...
void sub_AFE298(uint64_t a1, uint64_t a2, int a3)
{
  v4 = a2;
  if (*(a1 + 48) != 1)
  {
...
void sub_B00C78(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void **a10, void **a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18)
{
  STACK[0x208] = a18 + 240;
