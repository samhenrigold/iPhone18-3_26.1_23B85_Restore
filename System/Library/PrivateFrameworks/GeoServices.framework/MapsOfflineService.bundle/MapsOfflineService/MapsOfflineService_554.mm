...
void sub_1EDFB20()
{
  ...
  unk_27F04C0 = 0;
  qword_27F04C8 = 0;
  sub_68678C(&qword_27F04B8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
  ...
  *algn_27F04D8 = 0;
  qword_27F04E0 = 0;
  sub_68678C(&qword_27F04D0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F04F0 = 0;
  qword_27F04F8 = 0;
  sub_68678C(&qword_27F04E8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1ED5064(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1EDFC40(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1EDFCC8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1B5CF64(va);
  _Unwind_Resume(a1);
...
void sub_1EDFD78(uint64_t *a1@<X0>, uint64_t *a2@<X1>, char a3@<W2>, uint64_t *a4@<X8>)
{
  *a4 = 0;
  a4[1] = 0;
  a4[2] = 0;
  ...
  if (a2[1] != *a2)
  {
    ...
    do
    {
      ...
      v12 = v20;
      if ((a3 & 1) != 0 && ((v20 & 0x80u) == 0 ? (v13 = v20) : (v13 = v19[1]), !v13))
      {
        v14 = 0;
        v11 = 1;
        if ((v20 & 0x80) != 0)
...
void sub_1EDFEF8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, uint64_t a17, uint64_t a18, void *__p, uint64_t a20, int a21, __int16 a22, char a23, char a24)
{
  sub_195CE20(&a10);
  if (a24 < 0)
  {
...
uint64_t sub_1EDFF4C@<X0>(uint64_t *a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, void *a4@<X8>)
{
  sub_4E3D18(&v12);
  v8 = *(a2 + 23);
  if (v8 >= 0)
  ...
  sub_121C9AC(&v12, v9, v10);
  if (sub_1220160(a1, &v12))
  {
    sub_194E7E8(a4, __src, __len);
  }
  ...
  return sub_121C97C(&v12);
}

uint64_t sub_1EE001C@<X0>(uint64_t *a1@<X0>, uint64_t a2@<X1>, unsigned int a3@<W2>, uint64_t *a4@<X8>)
{
  sub_4E3D18(&v20);
  v8 = *(a2 + 23);
  if (v8 >= 0)
  ...
  sub_121C9AC(&v20, v9, v10);
  *a4 = 0;
  a4[1] = 0;
  a4[2] = 0;
  while (sub_1220160(a1, &v20))
  {
    sub_194E7E8(__dst, __src, __len);
    sub_1EE0334(__dst, &v13);
    sub_1A9C134(v14, &v13, __dst);
    sub_1EE01D0(a4, v14);
    if (v17 < 0)
    {
      operator delete(__p);
    ...
    v11 = a3 < 1 || 0xAAAAAAAAAAAAAAABLL * ((a4[1] - *a4) >> 4) < a3;
    if (v19 < 0)
    {
      operator delete(__dst[0]);
      if (!v11)
      {
        return sub_121C97C(&v20);
      }
    }
...
uint64_t *sub_1EE01D0(uint64_t *result, __int128 *a2)
{
  v3 = result;
  v4 = result[1];
  v5 = result[2];
  if (v4 >= v5)
  {
    ...
    *(a2 + 3) = 0;
    v16[2] = 48 * v9 + 48;
    sub_1A9C004(result, v16);
    v8 = v3[1];
    result = sub_1A9C0E4(v16);
  }
...
void sub_1EE0320(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A9C0E4(va);
  _Unwind_Resume(a1);
...
std::string *sub_1EE0334@<X0>(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  result = std::string::find(a1, 9, 0);
  if (result != -1)
  {
...
std::string *sub_1EE03D0@<X0>(std::string *result@<X0>, std::string *a2@<X8>)
{
  v2 = result;
  ...
  {
    v8 = result->__r_.__value_.__l.__size_;
  }
  ...
  if (v8 >= 1)
  {
    ...
    do
    {
      result = memchr(result, 35, v8);
      if (!result)
      {
        break;
      }

      if (result->__r_.__value_.__s.__data_[0] == 35)
      {
        if (result != v9 && result - v7 != -1)
        {
          return std::string::basic_string(a2, v2, 0, result - v7, &v10);
        }
  ...
  if ((v4 & 0x80000000) != 0)
  {
    ...
    return sub_325C(a2, v5, size);
  }

  else
  {
    *&a2->__r_.__value_.__l.__data_ = *&v2->__r_.__value_.__l.__data_;
...
void sub_1EE04E0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27F0560, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1EE74C8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v80 = -13944;
  v81 = v74;
  do
...
void sub_1EEAF9C()
{
  ...
  unk_27F0520 = 0;
  qword_27F0528 = 0;
  sub_68678C(&qword_27F0518, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F0538 = 0;
  qword_27F0540 = 0;
  sub_68678C(&qword_27F0530, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0550 = 0;
  qword_27F0558 = 0;
  sub_68678C(&qword_27F0548, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1EE04E0(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1EEB0BC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1EEB0E8(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v4 = *(a1 + 24);
  (***(a1 + 8))(__p);
  (**v4)(v4, __p, a3);
...
void sub_1EEB1A4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_1EEB1C0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27F05C0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
