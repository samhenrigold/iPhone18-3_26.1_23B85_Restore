...
void sub_1BEE824()
{
  ...
  unk_27EE600 = 0;
  qword_27EE608 = 0;
  sub_68678C(&qword_27EE5F8, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  *algn_27EE618 = 0;
  qword_27EE620 = 0;
  sub_68678C(&qword_27EE610, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EE630 = 0;
  qword_27EE638 = 0;
  sub_68678C(&qword_27EE628, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1BE3D68(v0, v1, v2, v3, v4, v5, v6, v7);
...
void sub_1BEF050(uint64_t *a1@<X0>, double *a2@<X1>, int a3@<W2>, unint64_t *a4@<X8>, __n128 a5@<Q0>)
{
  v8 = *a1;
  v7 = a1[1];
  ...
  if (v9 > 1)
  {
    ...
    else
    {
      ...
      do
      {
        ...
        if (v38 >= v39)
        {
          v20 = 0xAAAAAAAAAAAAAAABLL * ((v38 - __p) >> 3);
          v21 = v20 + 1;
          ...
          if (0x5555555555555556 * ((v39 - __p) >> 3) > v21)
          {
            v21 = 0x5555555555555556 * ((v39 - __p) >> 3);
          }

          if (0xAAAAAAAAAAAAAAABLL * ((v39 - __p) >> 3) >= 0x555555555555555)
          {
          ...
          *(v23 + 16) = v13;
          v19 = (24 * v20 + 24);
          memcpy((24 * v20 - (v38 - __p)), __p, v38 - __p);
          v24 = __p;
          __p = (24 * v20 - (v38 - __p));
          v38 = v19;
          v39 = 0;
    ...
    sub_1BEF538(v25, v19, &v40, v27, 1, a5);
    *a4 = 0;
    a4[1] = 0;
    a4[2] = 0;
    v28 = __p;
    v29 = 0xAAAAAAAAAAAAAAABLL * ((v38 - __p) >> 3);
    if (v29 >= a3)
    {
      v30 = a3;
    }
    ...
    if (v30 >= 1)
    {
      ...
      do
      {
        ...
        v34 = v28->n128_i32[v33];
        if (0xAAAAAAAAAAAAAAABLL * ((a1[1] - *a1) >> 5) <= v34)
        {
          sub_6FAB4();
        }
...
__n128 sub_1BEF538(__int128 *a1, __n128 *a2, uint64_t (**a3)(__n128 *, __n128 *), uint64_t a4, char a5, __n128 result)
{
LABEL_1:
  v9 = &a2[-2].n128_i64[1];
  v79 = a2 - 3;
...
LABEL_57:
    ...
    {
LABEL_62:
      result = sub_1BEF538(a1, v56, a3, -v13, a5 & 1);
      v11 = &v56[1].n128_i8[8];
LABEL_64:
      a5 = 0;
      a4 = -v13;
...
char *sub_1BF0708(char *a1, char *a2, uint64_t (**a3)(char *, __int128 *))
{
  v6 = 0;
  v17 = *a1;
  v18 = *(a1 + 2);
...
char *sub_1BF0D78(__n128 *a1, __n128 *a2, char *a3, uint64_t (**a4)(uint64_t, __n128 *), __n128 a5)
{
  if (a1 != a2)
  {
    v7 = a2;
...
__n128 sub_1BF0FB4(uint64_t a1, uint64_t (**a2)(uint64_t, __n128 *), uint64_t a3, __n128 *a4)
{
  v6 = a3 - 2;
  if (a3 >= 2)
  {
...
void sub_1BF11F4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EE6F0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
