void sub_1DC6EA0(uint64_t a1, __int128 **a2)
{
  v3 = *(a1 + 8);
  *v3 = 0;
  v3[1] = 0;
  v3[2] = 0;
  sub_353184(v3, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  *(a1 + 8) = v3 + 3;
}

void *sub_1DC6F00(char **a1, __int128 **a2)
{
  ...
  *(v7 + 8) = 0;
  *(v7 + 16) = 0;
  sub_353184(24 * v2, *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 3));
  v8 = v16 + 24;
  v9 = a1[1] - *a1;
  v10 = &v15[-v9];
  memcpy(&v15[-v9], *a1, v9);
...
void sub_1DC7028(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A7EC90(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1DC703C(void *a1, uint64_t a2)
{
  v2 = 0xAAAAAAAAAAAAAAABLL * ((a1[1] - *a1) >> 3);
  v3 = v2 + 1;
  if (v2 + 1 > 0xAAAAAAAAAAAAAAALL)
  ...
  v13 = 0;
  v14 = 24 * v2;
  sub_19A2664((24 * v2), a2);
  v15 = 24 * v2 + 24;
  v7 = a1[1];
  v8 = 24 * v2 + *a1 - v7;
  sub_1DC716C(a1, *a1, v7, v8);
  v9 = *a1;
  *a1 = v8;
  v10 = a1[2];
  v12 = v15;
...
void sub_1DC7158(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1DC72CC(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1DC716C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v16 = a4;
  v15 = a4;
  v13[0] = a1;
  ...
  return sub_1DC7248(v13);
}

uint64_t sub_1DC7248(uint64_t a1)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_1DC7280(a1);
...
void sub_1DC7300(uint64_t a1)
{
  v2 = *(a1 + 8);
  for (i = *(a1 + 16); i != v2; i = *(a1 + 16))
  {
    *(a1 + 16) = i - 24;
    sub_195A77C(i - 24, *(i - 16));
  }
}

void *sub_1DC7348(void *a1, __int128 **a2, void *a3)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
uint64_t sub_1DC73B0(uint64_t a1)
{
  v2 = *(a1 + 32);
  if (v2)
  {
...
uint64_t *sub_1DC73F4(uint64_t **a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
...
void *sub_1DC75A8(void *a1, uint64_t a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2725C08;
...
void sub_1DC7624(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725C08;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void *sub_1DC7684(void *a1, uint64_t a2)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_1DC7744(uint64_t a1@<X0>, const void **a2@<X1>, uint64_t a3@<X2>, std::string *a4@<X8>)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    if (*(a2 + 23) >= 0)
    ...
    *(&v7->__r_.__value_.__l.__data_ + v6) = 58;
    v9 = *(a3 + 23);
    if (v9 >= 0)
    {
      v10 = a3;
    ...
    *&__str.__r_.__value_.__l.__data_ = v13;
    ...
    v14 = std::string::append(&__str, "\t", 1uLL);
  ...
  sub_3608D0(a4, &unk_237BA93);
}

void sub_1DC7988(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, __int16 a13, char a14, char a15, void *__p, uint64_t a17, int a18, __int16 a19, char a20, char a21, uint64_t a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28)
{
  if (a21 < 0)
  {
    operator delete(__p);
...
void sub_1DC7A0C(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, std::string *a4@<X8>)
{
  if (*(a1 + 24))
  {
    goto LABEL_12;
  ...
  if (v8)
  {
    ...
    v32 = 0;
    sub_1A489AC(&v30, a3);
    if (std::string::find(a3, 45, 0) != -1)
    {
      if (*(a3 + 23) < 0)
      {
        sub_325C(&__str, *a3, *(a3 + 8));
      }
      ...
      std::string::basic_string(&v29, &__str, 0, v14, &v27);
      sub_794D4(&v30, &v29);
    ...
    if (v30 != v31)
    {
      ...
      *&v27.__r_.__value_.__l.__data_ = v23;
      ...
      v24 = std::string::append(&v27, ":L", 2uLL);
...
void sub_1DC7EF8(uint64_t a1@<X0>, void *a2@<X8>)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_3608D0(&v2, ":AvailableLangList");
    sub_1EDFCDC();
  }
...
void sub_1DC8084(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, int a13, __int16 a14, char a15, char a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void **a23)
{
  if (a16 < 0)
  {
    operator delete(__p);
...
void sub_1DC80F4(uint64_t a1@<X0>, void *a3@<X8>)
{
  if (*(a1 + 24) != 1)
  {
    std::operator+<char>();
...
void sub_1DC840C(uint64_t **a1, uint64_t a2)
{
  sub_3608D0(v11, "search_filter_luck_config");
  LODWORD(v10[0]) = 8;
...
void sub_1DC8558(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_197F740(va);
  sub_197F7C0(v13 - 56);
...
uint64_t sub_1DC877C(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2725CA0;
...
void sub_1DC8804(uint64_t a1, uint64_t *a2)
{
  v2 = a2[1];
  v3 = *a2;
  v4 = v2;
...
void sub_1DC88D4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12)
{
  if (a12)
  {
    sub_1220A18(a12);
...
uint64_t sub_1DC890C(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1DC8978(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725D10;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1DC89F4(uint64_t a1, uint64_t *a2, char *a3)
{
  v5 = *a2;
  v4 = a2[1];
  if (v4)
...
uint64_t sub_1DC8B94(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2725D70;
...
void sub_1DC8D40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1DC8D6C(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1DC8DB8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EF940, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1DD3874()
{
  ...
  unk_27EF900 = 0;
  qword_27EF908 = 0;
  sub_68678C(&qword_27EF8F8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF918 = 0;
  qword_27EF920 = 0;
  sub_68678C(&qword_27EF910, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF930 = 0;
  qword_27EF938 = 0;
  sub_68678C(&qword_27EF928, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1DC8DB8(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1DD3994(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1DD3A88(_Unwind_Exception *exception_object)
{
  v3 = *(v1 + 24);
  if (v3)
  {
...
void sub_1DD3AA8(uint64_t a1, uint64_t a2)
{
  *(a1 + 8) = 0;
  *a1 = off_2725DF0;
  *(a1 + 16) = 0;
...
void sub_1DD3B78(_Unwind_Exception *exception_object)
{
  v3 = *(v1 + 24);
  if (v3)
  {
...
BOOL sub_1DD3C50(uint64_t a1, uint64_t *a2)
{
  v2 = a2;
...
LABEL_6:
    ...
    v11 = 0;
    v6 = [[BlendedRankerModel alloc] initWithContentsOfURL:v5 error:&v11];
    v7 = v11;
    v8 = *(a1 + 16);
    v9 = *v8;
    *v8 = v6;
...
uint64_t sub_1DD3D5C(uint64_t a1)
{
  **(a1 + 16) = objc_alloc_init(BlendedRankerModel);

  return _objc_release_x1();
}

BOOL sub_1DD3DA4(uint64_t a1)
{
  v1 = **(a1 + 16);
  if (!v1)
  {
    NSLog(@"Blended Ranker Model not loaded");
...
void sub_1DD3E14(uint64_t a1, uint64_t a2, uint64_t *a3)
{
  memset(v17, 0, sizeof(v17));
  sub_1D0318C(v17, *a3, a3[1], 0xCCCCCCCCCCCCCCCDLL * ((a3[1] - *a3) >> 3));
  v5 = [**(a1 + 16) model];
  sub_1FE7E24(v17, v5, &__p);
  ...
  if (v19 != __p)
  {
    ...
    while (0xAAAAAAAAAAAAAAABLL * ((v19 - __p) >> 3) > v8);
  }
...
void sub_1DD3FBC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t *a16)
{
  a16 = &a9;
  sub_1B0155C(&a16);
  _Unwind_Resume(a1);
...
void sub_1DD4020(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2725E60;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1DD40C4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27EF9A0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
