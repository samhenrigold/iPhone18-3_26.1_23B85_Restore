...
void sub_1A6EBB4()
{
  ...
  *algn_27ED588 = 0;
  qword_27ED590 = 0;
  sub_68678C(&qword_27ED580, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  unk_27ED5A0 = 0;
  qword_27ED5A8 = 0;
  sub_68678C(&qword_27ED598, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED5B8 = 0;
  qword_27ED5C0 = 0;
  sub_68678C(&qword_27ED5B0, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1A63F38(v0, v1, v2, v3, v4, v5, v6, v7);
...
void sub_1A6F884(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ED678, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1A7A340()
{
  ...
  *algn_27ED638 = 0;
  qword_27ED640 = 0;
  sub_68678C(&qword_27ED630, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ED650 = 0;
  qword_27ED658 = 0;
  sub_68678C(&qword_27ED648, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED668 = 0;
  qword_27ED670 = 0;
  sub_68678C(&qword_27ED660, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1A6F884(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
void sub_1A7AAB4(const void **a1, uint64_t *a2)
{
  v5 = a1[1];
  v4 = a1[2];
  if (v5 >= v4)
...
void *sub_1A7AB94(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  if (v3 >= *(a1 + 16))
  {
...
void *sub_1A7ACE0(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  if (v3 >= *(a1 + 16))
  {
...
void sub_1A7AF44(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A7E1D4(va);
  _Unwind_Resume(a1);
...
void sub_1A7B4A4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  sub_1A7E25C(va);
  _Unwind_Resume(a1);
...
void sub_1A7C204(void **__return_ptr a1@<X8>, void *__src@<X1>, size_t __n@<X2>)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
  ...
  *(&__dst.__r_.__value_.__s + 23) = __n;
  ...
  for (i = v20; v6 != i; v6 += 24)
  {
    ...
    sub_3608D0(__p, ",");
    sub_1A7C7FC(&__dst, &__str, __p);
    sub_1A7CE30(a1, &__dst);
    p_dst = &__dst;
    sub_195E3E8(&p_dst);
    if (v16 < 0)
    {
