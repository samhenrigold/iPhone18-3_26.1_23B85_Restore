void sub_19ADFB0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D03C(va);
  _Unwind_Resume(a1);
...
void sub_19ADFC4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ECEB8, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_19B8A80()
{
  ...
  *algn_27ECE78 = 0;
  qword_27ECE80 = 0;
  sub_68678C(&qword_27ECE70, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ECE90 = 0;
  qword_27ECE98 = 0;
  sub_68678C(&qword_27ECE88, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECEA8 = 0;
  qword_27ECEB0 = 0;
  sub_68678C(&qword_27ECEA0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_19ADFC4(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
uint64_t sub_19B8BCC@<X0>(__int128 *a1@<X0>, double a2@<D0>, uint64_t a3@<X8>)
{
  v6 = *a1;
  sub_16E58B4(v7, 0, 0);
  v8 |= 0x1Eu;
  v10 = v6;
  v9 = v6;
  sub_1D0E674(v7, a3, a2);
  return sub_16E5B34(v7);
}

void sub_19B8C48(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_16E5B34(va);
  _Unwind_Resume(a1);
...
__int128 **sub_19B8C5C@<X0>(__int128 **result@<X0>, _BYTE *a2@<X8>)
{
  if (result[1] == *result)
  {
    *a2 = 0;
...
void sub_19B8DAC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, ...)
{
  va_start(va, a22);
  sub_16E5B34(va);
  _Unwind_Resume(a1);
...
void sub_19B8E88(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, uint64_t a14, ...)
{
  va_start(va, a14);
  if (__p)
  {
...
void *sub_19B8F8C@<X0>(void *result@<X0>, _BYTE *a2@<X8>)
{
  v2 = result;
  v4 = *(result + 196);
  if (!v4)
...
LABEL_30:
      if (!*(v2 + 196))
      {
        sub_1DED54C(v2, v13);
        v12 = v13[3];
        sub_19B8BCC(&v12, 1.0, v14);
        sub_19B91BC(a2, v14);
        a2[96] = 1;
        sub_16E5B34(v14);
        return sub_16E4E08(v13);
      }
    }
...
LABEL_26:
  ...
  if ((*(sub_73EEC(result) + 16) & 0x80) == 0)
  {
    if (*(v2 + 196) == 1)
    {
      *&v13[0] = sub_1DED7C0(v2);
      *(&v13[0] + 1) = v5;
      sub_19B8BCC(v13, 1.0, v14);
LABEL_24:
      sub_19B91BC(a2, v14);
      a2[96] = 1;
      return sub_16E5B34(v14);
  ...
  v8 = sub_73EEC(v2);
  sub_194DB28(v14, *(v8 + 104) & 0xFFFFFFFFFFFFFFFELL);
  if (v15)
  {
    v9 = v15;
  }
  ...
  sub_16E5A88(a2, v9);
  a2[96] = 1;
  return sub_179FDE8(v14);
}

void sub_19B9154(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_16E4E08(va);
  _Unwind_Resume(a1);
...
void *sub_19B9178@<X0>(void *result@<X0>, _BYTE *a2@<X8>)
{
  v2 = 0xAFD6A052BF5A814BLL * ((result[8] - result[7]) >> 3);
  if (v2 == 1)
  {
    return sub_19B8F8C(result[7], a2);
  }
...
void sub_19B92A4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27ECF18, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
