...
void sub_2009394()
{
  ...
  unk_27F1110 = 0;
  qword_27F1118 = 0;
  sub_68678C(&qword_27F1108, __p, &v10, 1uLL);
  if (v9 < 0)
  {
  ...
  *algn_27F1128 = 0;
  qword_27F1130 = 0;
  sub_68678C(&qword_27F1120, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1140 = 0;
  qword_27F1148 = 0;
  sub_68678C(&qword_27F1138, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1FFE8D8(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
void sub_2009668(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27F11B0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_2014124()
{
  ...
  unk_27F1170 = 0;
  qword_27F1178 = 0;
  sub_68678C(&qword_27F1168, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1188 = 0;
  qword_27F1190 = 0;
  sub_68678C(&qword_27F1180, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F11A0 = 0;
  qword_27F11A8 = 0;
  sub_68678C(&qword_27F1198, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_2009668(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
void sub_20145FC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, std::__shared_weak_count *a4, uint64_t a5, uint64_t a6, std::__shared_weak_count *a7, ...)
{
  va_start(va1, a7);
  va_start(va, a7);
  v8 = va_arg(va1, void);
...
void sub_2014810(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_20149F4(va);
  _Unwind_Resume(a1);
...
void sub_2014B40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_2014CDC(va);
  _Unwind_Resume(a1);
...
void sub_2015364(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, ...)
{
  va_start(va, a18);
  sub_1965BCC(va);
  __cxa_end_catch();
...
const void **sub_20154A8(void *a1, const void **a2, uint64_t a3)
{
...
void sub_20156F0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1965AC4(va);
  _Unwind_Resume(a1);
...
void sub_20159CC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27F1210, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
