...
void sub_19A1248()
{
  ...
  *algn_27ECD68 = 0;
  qword_27ECD70 = 0;
  sub_68678C(&qword_27ECD60, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  unk_27ECD80 = 0;
  qword_27ECD88 = 0;
  sub_68678C(&qword_27ECD78, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECD98 = 0;
  qword_27ECDA0 = 0;
  sub_68678C(&qword_27ECD90, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_199678C(v0, v1, v2, v3, v4, v5, v6, v7);
  ...
  v37 = 4;
  sub_19664AC(&unk_27ECDC0, __p, 14);
  v8 = 56;
  do
  {
    if (*(&__p[v8 - 1] - 1) < 0)
  ...
  sub_3608D0(v76, "EG");
  v77 = 6;
  sub_1966844(&unk_27ECDE8, __p, 34);
  v9 = 136;
  do
  {
    if (*(&__p[v9 - 1] - 1) < 0)
...
void sub_19A18E8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
void sub_19A1A74(uint64_t *a1@<X1>, void *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
  ...
  if (v3 >= 1)
  {
    ...
    do
    {
      ...
      v23 = v5 != v15;
      sub_19A1C88(a1, v5, v15, &__p);
      v24 = v29;
      if (v29 >= v30)
      {
        v25 = sub_19A1E98(&v28, &__p);
      }
...
void sub_19A1C40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char *a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, char a18)
{
  a10 = &a18;
  sub_19A240C(&a10);
  sub_19A2570(&a10);
...
uint64_t sub_19A1C88@<X0>(void *a1@<X0>, int a2@<W1>, int a3@<W2>, std::string *a4@<X8>)
{
  v8 = a2 << 6;
  result = sub_19A25E4(a4, (*a1 + v8));
  if (a3 <= a2)
  {
    v10 = a2;
  }
  ...
  for (i = v8 + 64; --v11; i += 64)
  {
    ...
    v17 = *a1 + i;
    v18 = *(v17 + 40);
    a4[1].__r_.__value_.__l.__size_ = *(v17 + 32);
    result = sub_19A1E10(&a4[1].__r_.__value_.__r.__words[2], v18, (v17 + 48));
  }

  if (a2 != a3)
  {
    v19 = 23;
    return sub_19A2754(&a4[1].__r_.__value_.__r.__words[2], &v19);
  }

  return result;
}

uint64_t sub_19A1D90(uint64_t a1)
{
  sub_195A77C(a1 + 40, *(a1 + 48));
  if (*(a1 + 23) < 0)
  {
    operator delete(*a1);
  }
...
void *sub_19A1DD0(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  if (v3 >= *(a1 + 16))
  {
    result = sub_19A2190(a1, a2);
  }
...
uint64_t sub_19A1E10(uint64_t result, int *a2, int *a3)
{
  if (a2 != a3)
  {
    v4 = a2;
    ...
    do
    {
      result = sub_19A26BC(v5, (v5 + 8), v4 + 7, v4 + 7);
      v6 = *(v4 + 1);
      if (v6)
      {
        do
...
uint64_t sub_19A1E98(uint64_t *a1, __int128 *a2)
{
  v2 = (a1[1] - *a1) >> 6;
  v3 = v2 + 1;
  if ((v2 + 1) >> 58)
...
void sub_19A1F94(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_19A20EC(va);
  _Unwind_Resume(a1);
...
void sub_19A1FA8(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 58))
  {
    operator new();
...
void sub_19A1FF0(uint64_t a1, __int128 *a2, __int128 *a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
void sub_19A2070(_Unwind_Exception *exception_object)
{
  if (v2)
  {
    v4 = v1 - 64;
...
uint64_t sub_19A20EC(uint64_t a1)
{
  v3 = *(a1 + 8);
...
uint64_t *sub_19A213C(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  *v3 = 0;
  v3[1] = 0;
  v3[2] = 0;
  result = sub_19A22C0(v3, *a2, a2[1], (a2[1] - *a2) >> 6);
  *(a1 + 8) = v3 + 3;
  return result;
}

void *sub_19A2190(char **a1, uint64_t *a2)
{
  ...
  *(v7 + 8) = 0;
  *(v7 + 16) = 0;
  sub_19A22C0((24 * v2), *a2, a2[1], (a2[1] - *a2) >> 6);
  v8 = v16 + 24;
  v9 = a1[1] - *a1;
  v10 = &v15[-v9];
  memcpy(&v15[-v9], *a1, v9);
...
void sub_19A22AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_19A24E8(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_19A22C0(uint64_t *result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_19A2328(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 + 8) = v10;
  sub_19A240C(&a9);
  _Unwind_Resume(a1);
...
void sub_19A2348(uint64_t *a1, unint64_t a2)
{
  if (!(a2 >> 58))
  {
    sub_19A1FA8(a1, a2);
...
uint64_t sub_19A2384(uint64_t a1, __int128 *a2, __int128 *a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
void sub_19A23E4(_Unwind_Exception *exception_object)
{
  if (v2)
  {
    v4 = v1 - 64;
...
void sub_19A2490(uint64_t a1, unint64_t a2)
{
...
uint64_t sub_19A25E4(uint64_t a1, __int128 *a2)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
  ...
  *(a1 + 24) = *(a2 + 24);
  sub_19A2664((a1 + 40), a2 + 40);
  return a1;
}

void sub_19A2648(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void *sub_19A2664(void *a1, uint64_t a2)
{
  a1[2] = 0;
  a1[1] = 0;
  *a1 = a1 + 1;
  sub_19A1E10(a1, *a2, (a2 + 8));
  return a1;
}

uint64_t sub_19A26BC(uint64_t **a1, uint64_t *a2, int *a3, _DWORD *a4)
{
...
uint64_t sub_19A2754(uint64_t a1, int *a2)
{
  v2 = *(a1 + 8);
  if (!v2)
  {
...
uint64_t *sub_19A27D8(uint64_t **a1, uint64_t *a2)
{
  v2 = a2[1];
  if (v2)
  {
...
void sub_19A284C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ECE58, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_19A9834(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v80 = -13944;
  v81 = v74;
  do
...
void sub_19AD308()
{
  ...
  *algn_27ECE18 = 0;
  qword_27ECE20 = 0;
  sub_68678C(&qword_27ECE10, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ECE30 = 0;
  qword_27ECE38 = 0;
  sub_68678C(&qword_27ECE28, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECE48 = 0;
  qword_27ECE50 = 0;
  sub_68678C(&qword_27ECE40, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_19A284C(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_19AD428(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
BOOL sub_19AD454(uint64_t a1)
{
  ...
  v4 = v1[1];
  v5 = *(v1 + 16);
  return v3 == 0x79726F6765746163 && v4 == 0x726567676972745FLL && v5 == 95;
}

BOOL sub_19AD4B8(uint64_t a1)
{
  if (*a1 != 10)
  {
    return 0;
  ...
  v5 = v1[2];
  v6 = *(v1 + 19);
  return v3 == 0x635F6573776F7262 && v4 == 0x5F79726F67657461 && v5 == 0x6974736567677573 && v6 == 0x5F6E6F6974736567;
}

BOOL sub_19AD540(uint64_t a1)
{
  if ((*a1 | 4) != 7)
  {
    return 0;
  ...
  v3 = *v1;
  v4 = *(v1 + 2);
  return v3 == 1701080681 && v4 == 24440;
}

void sub_19AD58C(char w0_0, double a2, double a3)
{
  sub_1F71298(w0_0, a2, a3);
  sub_19ADB7C(&__p);
  std::operator+<char>();
  if (v5 < 0)
  {
...
void sub_19AD5EC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
uint64_t sub_19AD614(uint64_t a1, std::string::size_type a2)
{
  sub_1961D34(&__str, *(a1 + 8), *(a1 + 16), *(a1 + 16) - *(a1 + 8));
  ...
  if (sub_1CF6DDC(&v22, &__p))
  {
    ...
    std::string::basic_string(&__p, &__str, v8, 0xFFFFFFFFFFFFFFFFLL, &v25);
    ...
    v21[0] = p_p;
    v21[1] = v9;
    sub_19AD89C(v21, 95, &v22);
    if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0)
    {
      operator delete(__p.__r_.__value_.__l.__data_);
    }

    if (0xAAAAAAAAAAAAAAABLL * ((v23 - v22) >> 3) < 3)
    {
      goto LABEL_29;
    }

    v11 = std::stoi(v22, 0, 10);
    if (0xAAAAAAAAAAAAAAABLL * ((v23 - v22) >> 3) < 2 || (v12 = v11, v13 = std::stoi(v22 + 1, 0, 10), 0xAAAAAAAAAAAAAAABLL * ((v23 - v22) >> 3) <= 2))
    {
      sub_6FAB4();
    }

    v14 = v13;
    if (std::stoi(v22 + 2, 0, 10) < 0)
    {
LABEL_29:
      v15 = 0;
      v17 = 0;
...
char *sub_19AD89C@<X0>(char **a1@<X0>, int a2@<W1>, const void **a3@<X8>)
{
  *a3 = 0;
  a3[1] = 0;
  a3[2] = 0;
  ...
  if (v15)
  {
    ...
    if (v16 >= a3[2])
    {
      result = sub_19ADE9C(a3, &v22, &v21);
    }

    else
    {
      sub_194E7E8(a3[1], v11, v12);
      result = v16 + 24;
    }
  }
  ...
  else
  {
    ...
    do
    {
      ...
      if (v18 >= a3[2])
      {
        v18 = sub_22990(a3, &v23, &v22);
      }

      else
      {
        sub_194E7E8(v18, v11, &v17[-v11]);
        v18 += 24;
      }
    ...
    if (v18 >= a3[2])
    {
      result = sub_22990(a3, &v23, &v22);
    }

    else
    {
      sub_194E7E8(v18, v11, v19);
      result = v18 + 24;
    }
  }
...
void sub_19ADA3C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19ADA7C(uint64_t a1)
{
  sub_3608D0(__p, "index_");
  v2 = sub_19AD614(a1, __p);
  if (v5 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_19ADAE0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
uint64_t sub_19ADAFC(uint64_t a1)
{
...
void sub_19ADB60(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
uint64_t sub_19ADB7C@<X0>(_BYTE *a4@<X8>)
{
  sub_19594F8(&v11);
...
void sub_19ADDBC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  std::ios::~ios();
  _Unwind_Resume(a1);
...
const void **sub_19ADDE0(const void **result, unint64_t a2)
{
  if (0xAAAAAAAAAAAAAAABLL * ((result[2] - *result) >> 3) < a2)
  {
    if (a2 < 0xAAAAAAAAAAAAAABLL)
    {
      sub_195CC74(result, a2);
    }
...
void *sub_19ADE9C(uint64_t a1, void **a2, size_t *a3)
{
