...
void sub_197D370()
{
  ...
  *algn_27ECBF8 = 0;
  qword_27ECC00 = 0;
  sub_68678C(&qword_27ECBF0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
  ...
  unk_27ECC10 = 0;
  qword_27ECC18 = 0;
  sub_68678C(&qword_27ECC08, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECC28 = 0;
  qword_27ECC30 = 0;
  sub_68678C(&qword_27ECC20, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_19728B4(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_197D490(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_197D4D4@<X0>(uint64_t result@<X0>, double **a2@<X1>, uint64_t *a3@<X8>)
{
  *a3 = 0;
  a3[1] = 0;
  a3[2] = 0;
  ...
  if (*result != v4)
  {
    do
    {
      ...
      if ((v7 & 0x100000000) != 0)
      {
        ...
        while (v8 != v9)
        {
          result = sub_1F71A74(&v10, v8);
          if (result)
          {
            result = sub_197D598(a3, v3);
            break;
          }
...
uint64_t sub_197D598(uint64_t *a1, uint64_t a2)
{
  v3 = a1[1];
  if (v3 >= a1[2])
  {
    result = sub_197DC18(a1, a2);
  }
...
void sub_197D5D8(uint64_t *a1, uint64_t a2, uint64_t *a3)
{
  v5 = sub_1D365C4(*a3);
  v15 = 0;
  v16 = 0;
  v14 = 0;
  sub_1962488(&v14, *(v5 + 104), *(v5 + 112), 0xAAAAAAAAAAAAAAABLL * ((*(v5 + 112) - *(v5 + 104)) >> 5));
  ...
  v9 = 0;
  v8 = 0uLL;
  sub_1962488(&v8, v14, v15, 0xAAAAAAAAAAAAAAABLL * ((v15 - v14) >> 5));
  v6 = a1[1];
  v10 = *a1;
  v11 = v6;
  if (v6)
...
void sub_197D7CC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, uint64_t a19, ...)
{
  va_start(va, a19);
  sub_19800BC(va);
  sub_197D814(&a9);
  v21 = sub_197E14C(v19 - 72);
  *(v19 - 72) = &a16;
  sub_1962638(v21);
  _Unwind_Resume(a1);
}

uint64_t sub_197D814(uint64_t a1)
{
  v2 = *(a1 + 48);
  if (v2)
  {
...
uint64_t *sub_197D928(uint64_t *result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
    sub_197D9B0(result, a4);
  }

  return result;
}

void sub_197D990(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 + 8) = v10;
  sub_197DB3C(&a9);
  _Unwind_Resume(a1);
...
void sub_197D9B0(uint64_t *a1, unint64_t a2)
{
...
void sub_197D9FC(uint64_t a1, unint64_t a2)
{
  if (a2 < 0x555555555555556)
  {
    operator new();
...
uint64_t sub_197DA54(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
void sub_197DAB4(_Unwind_Exception *exception_object)
{
  if (v2)
  {
    v4 = (v1 - 48);
...
uint64_t sub_197DADC(uint64_t a1, uint64_t a2)
{
  *a1 = *a2;
  *(a1 + 16) = 0;
  *(a1 + 24) = 0;
  *(a1 + 8) = 0;
  sub_1963658((a1 + 8), *(a2 + 8), *(a2 + 16), *(a2 + 16) - *(a2 + 8));
  v4 = *(a2 + 40);
  *(a1 + 32) = *(a2 + 32);
  *(a1 + 40) = v4;
  if (v4)
...
uint64_t *sub_197DBC0(uint64_t a1, uint64_t a2)
{
  v3 = *(a1 + 8);
  *v3 = *a2;
  *(v3 + 16) = 0;
  *(v3 + 24) = 0;
  *(v3 + 8) = 0;
  result = sub_1963658((v3 + 8), *(a2 + 8), *(a2 + 16), *(a2 + 16) - *(a2 + 8));
  *(a1 + 8) = v3 + 32;
  return result;
}

uint64_t sub_197DC18(uint64_t *a1, uint64_t a2)
{
  v2 = (a1[1] - *a1) >> 5;
  v3 = v2 + 1;
  if ((v2 + 1) >> 59)
  ...
  *(v8 + 24) = 0;
  *(v8 + 8) = 0;
  sub_1963658((32 * v2 + 8), *(a2 + 8), *(a2 + 16), *(a2 + 16) - *(a2 + 8));
  *&v17 = v17 + 32;
  v9 = a1[1];
  v10 = v16 + *a1 - v9;
  sub_197DD84(a1, *a1, v9, v10);
  v11 = *a1;
  *a1 = v10;
  v12 = a1[2];
  v14 = v17;
...
void sub_197DD28(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_197DEC8(va);
  _Unwind_Resume(a1);
...
void sub_197DD3C(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 59))
  {
    operator new();
...
uint64_t sub_197DD84(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v12 = a4;
  v11 = a4;
  v9[0] = a1;
  ...
  return sub_197DE48(v9);
}

uint64_t sub_197DE48(uint64_t a1)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_197DE80(a1);
...
uint64_t sub_197DEC8(uint64_t a1)
{
  sub_197DF00(a1, *(a1 + 8));
  if (*a1)
  {
...
void sub_197DF00(uint64_t a1, uint64_t a2)
{
  v2 = *(a1 + 16);
  while (v2 != a2)
  {
...
uint64_t sub_197E074(uint64_t result, void *a2)
{
  v2 = *(result + 8);
  *a2 = off_27217F8;
  a2[1] = v2;
...
uint64_t sub_197E0AC(uint64_t a1, uint64_t a2)
{
  if (sub_197E0F8(a2, &off_2721878))
  {
    return a1 + 8;
  }
...
BOOL sub_197E0F8(uint64_t a1, uint64_t a2)
{
  v2 = *(a1 + 8);
  v3 = *(a2 + 8);
  if (v2 == v3)
...
uint64_t sub_197E14C(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_197E1CC(uint64_t a1)
{
  *a1 = off_27218A8;
  v2 = *(a1 + 56);
  if (v2)
...
uint64_t *sub_197E384(uint64_t *a1, void *a2)
{
  *a2 = off_27218A8;
  a2[2] = 0;
  a2[3] = 0;
  a2[1] = 0;
  result = sub_1962488(a2 + 1, a1[1], a1[2], 0xAAAAAAAAAAAAAAABLL * ((a1[2] - a1[1]) >> 5));
  v5 = a1[5];
  a2[4] = a1[4];
  a2[5] = v5;
  if (v5)
...
void sub_197E4C4(double **a1, void *a2)
{
  sub_197D4D4(a2, a1 + 1, v9);
  sub_197E8A4(&v8);
  v3 = v9[0];
  if (v9[0] != v9[1])
  {
    ...
    v7 = 0;
    v6[0] = 0;
    sub_1963658(v6, *(v3 + 8), *(v3 + 16), *(v3 + 16) - *(v3 + 8));
    v12 = 0;
    operator new();
  }
...
uint64_t sub_197E858(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_197E968(uint64_t a1, uint64_t a2)
{
  ...
  return sub_198003C(v7);
}

void *sub_197EAC8(void *a1, unint64_t *a2, dispatch_object_t *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2721928;
  sub_197EBB0((a1 + 3), *a2, *a3, *a4);
  return a1;
}

void sub_197EB50(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2721928;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_197EBB0(uint64_t a1, unint64_t a2, dispatch_object_t object, uint64_t a4)
{
  *a1 = object;
  *(a1 + 8) = a4;
  *(a1 + 16) = 0;
...
void sub_197EC18(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_197DB3C(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_197EC30(uint64_t *result, unint64_t a2)
{
  if (0xAAAAAAAAAAAAAAABLL * ((result[2] - *result) >> 4) < a2)
  {
    if (a2 < 0x555555555555556)
    {
      sub_197D9FC(result, a2);
    }
...
void sub_197ECF8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_197ED9C(va);
  _Unwind_Resume(a1);
...
void sub_197ED0C(uint64_t a1, void *a2, void *a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v5 = a2;
...
uint64_t sub_197ED9C(uint64_t a1)
{
  v3 = *(a1 + 8);
...
uint64_t sub_197EDEC(uint64_t a1)
{
  dispatch_release(*a1);
...
void sub_197EFA4(_Unwind_Exception *a1)
{
  v3 = v1[2];
  if (v3)
  {
...
uint64_t *sub_197EFC4(uint64_t a1, uint64_t a2)
{
  v3 = *(a1 + 8);
  v2 = *(a1 + 16);
  *a2 = off_2721978;
  ...
  *(a2 + 40) = 0;
  *(a2 + 48) = 0;
  return sub_1963658((a2 + 32), *(a1 + 32), *(a1 + 40), *(a1 + 40) - *(a1 + 32));
}

void sub_197F03C(_Unwind_Exception *exception_object)
{
  v3 = *(v1 + 16);
  if (v3)
  {
...
void sub_197F098(uint64_t a1, __int128 *a2)
{
  v3 = *a2;
  *a2 = 0uLL;
  v2 = *(a1 + 8);
  sub_197F398(v4, a1 + 24, &v3);
  sub_197F1DC(v2, v4);
  if (v7)
  {
    sub_1220A18(v7);
...
void sub_197F114(_Unwind_Exception *a1, uint64_t a2, std::__shared_weak_count *a3, uint64_t a4, std::__shared_weak_count *a5, ...)
{
  va_start(va, a5);
  sub_21DD6D8(va);
  if (a5)
...
uint64_t sub_197F13C(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_197F1DC(uint64_t a1, uint64_t a2)
{
  os_unfair_lock_lock((a1 + 16));
  v4 = *(a1 + 32);
  if (v4 >= *(a1 + 40))
  {
    v5 = sub_197F268((a1 + 24), a2);
  }

  else
  {
    sub_197DADC(*(a1 + 32), a2);
    v5 = v4 + 48;
    *(a1 + 32) = v4 + 48;
  }
...
uint64_t sub_197F268(uint64_t *a1, uint64_t a2)
{
  ...
  v13 = 0;
  v14 = 48 * v2;
  sub_197DADC(48 * v2, a2);
  v15 = 48 * v2 + 48;
  v7 = a1[1];
  v8 = 48 * v2 + *a1 - v7;
  sub_197ED0C(a1, *a1, v7, v8);
  v9 = *a1;
  *a1 = v8;
  v10 = a1[2];
  v12 = v15;
...
void sub_197F384(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_197ED9C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_197F398(uint64_t a1, uint64_t a2, void *a3)
{
  *a1 = *a2;
  *(a1 + 16) = 0;
  *(a1 + 24) = 0;
...
uint64_t *sub_197F574(uint64_t a1, uint64_t a2)
{
  *a2 = off_2721A08;
  *(a2 + 8) = *(a1 + 8);
  *(a2 + 24) = 0;
  *(a2 + 32) = 0;
  *(a2 + 16) = 0;
  result = sub_1963658((a2 + 16), *(a1 + 16), *(a1 + 24), *(a1 + 24) - *(a1 + 16));
  v5 = *(a1 + 48);
  *(a2 + 40) = *(a1 + 40);
  *(a2 + 48) = v5;
  if (v5)
...
void sub_197F630(uint64_t a1)
{
  v2 = os_log_create("com.apple.geo.MapsOfflineService", "Search");
  ...
  v7 = 0;
  __p = 0;
  sub_1963658(&__p, *(a1 + 16), *(a1 + 24), *(a1 + 24) - *(a1 + 16));
  v8 = 0;
  v9 = 0;
  sub_197F1DC(v3, &v4);
  if (v9)
...
uint64_t sub_197F6F4(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_197F740(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_197F7C0(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_197F840(uint64_t a1)
{
  v2 = *(a1 + 56);
  if (!v2)
  {
...
uint64_t sub_197F894(uint64_t a1, uint64_t a2)
{
  result = sub_197F91C(a1 + 32, a2 + 32);
  v5 = *(a2 + 72);
  *(a1 + 64) = *(a2 + 64);
  *(a1 + 72) = v5;
  if (v5)
...
uint64_t sub_197F8DC(uint64_t a1)
{
  v2 = *(a1 + 72);
  if (v2)
  {
  ...
  return sub_198003C(a1 + 32);
}

uint64_t sub_197F91C(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
uint64_t sub_197FAD8(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2721AC8;
...
void sub_197FBD8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, std::__shared_weak_count *a11, uint64_t a12, uint64_t a13, std::__shared_weak_count *a14)
{
  if (a11)
  {
    sub_1220A18(a11);
...
uint64_t sub_197FBFC(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_197FC48(uint64_t a1, __int128 *a2)
{
  os_unfair_lock_lock((a1 + 16));
  sub_197FE58((a1 + 24), a2);
  os_unfair_lock_unlock((a1 + 16));
  v4 = *a1;
...
uint64_t sub_197FD10(uint64_t a1, uint64_t *a2, char *a3)
{
  *(a1 + 8) = 0u;
  *a1 = off_2721B48;
  v4 = *a3;
  ...
  *(a1 + 40) = 0u;
  *(a1 + 32) = 0;
  sub_197D928((a1 + 32), *a2, a2[1], 0xAAAAAAAAAAAAAAABLL * ((a2[1] - *a2) >> 4));
  *(a1 + 56) = v4;
  return a1;
}

void sub_197FDDC(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2721B48;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void **sub_197FE58(void **result, __int128 *a2)
{
  v3 = result;
  v4 = result[1];
  v5 = result[2];
...
void sub_197FF6C(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 60))
  {
    operator new();
...
uint64_t sub_198003C(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_19800BC(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
void sub_198013C(uint64_t a1, NSObject *a2)
{
  sub_1961D34(__p, *(a1 + 16), *(a1 + 24), *(a1 + 24) - *(a1 + 16));
  if (v5 >= 0)
  {
    v3 = __p;
  }
  ...
  *buf = 136315138;
  v7 = v3;
  _os_log_error_impl(&dword_0, a2, OS_LOG_TYPE_ERROR, "Failed to load trigger data for key: .%s", buf, 0xCu);
  if (v5 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_19801FC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ECC98, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_19871E4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v80 = -13944;
  v81 = v74;
  do
