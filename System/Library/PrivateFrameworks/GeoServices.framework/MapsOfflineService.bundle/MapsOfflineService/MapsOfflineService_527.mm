...
void sub_1CDE650()
{
  ...
  unk_27EEFF0 = 0;
  qword_27EEFF8 = 0;
  sub_68678C(&qword_27EEFE8, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  *algn_27EF008 = 0;
  qword_27EF010 = 0;
  sub_68678C(&qword_27EF000, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF020 = 0;
  qword_27EF028 = 0;
  sub_68678C(&qword_27EF018, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1CD3B94(v0, v1, v2, v3, v4, v5, v6, v7);
  ...
  v37 = 4;
  sub_19664AC(&unk_27EF048, __p, 14);
  v8 = 56;
  do
  {
    if (*(&__p[v8 - 1] - 1) < 0)
  ...
  sub_3608D0(v76, "EG");
  v77 = 6;
  sub_1966844(&unk_27EF070, __p, 34);
  v9 = 136;
  do
  {
    if (*(&__p[v9 - 1] - 1) < 0)
...
void sub_1CDECF0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
void sub_1CDEE94(uint64_t **a1, uint64_t a2)
{
  dispatch_group_enter(**a2);
  sub_3608D0(v11, "chain_localized_names");
  LODWORD(v10[0]) = 8;
...
void sub_1CDEFE0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_197F740(va);
  sub_197F7C0(v13 - 56);
...
double sub_1CDF028@<D0>(uint64_t a1@<X0>, uint64_t a3@<X8>)
{
  if (!(*(*a1 + 8))(a1))
  {
    sub_1EDFCDC();
...
void sub_1CDF2F4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, void *__p, uint64_t a30, int a31, __int16 a32, char a33, char a34)
{
  sub_1CDF4C4(&a9);
  sub_1334EAC(&a22);
  if (a34 < 0)
...
uint64_t sub_1CDF448(uint64_t a1, __int128 *a2, uint64_t a3)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
  ...
  sub_1334E2C(a1 + 24, a3);
  return a1;
}

void sub_1CDF4A8(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
uint64_t sub_1CDF4C4(uint64_t a1)
{
  sub_1334EAC((a1 + 24));
  if (*(a1 + 23) < 0)
  {
...
uint64_t sub_1CDF624(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2724248;
...
void sub_1CDF6AC(uint64_t a1, uint64_t *a2)
{
  v2 = a2[1];
  v3 = *a2;
  v4 = v2;
...
void sub_1CDF77C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12)
{
  if (a12)
  {
    sub_1220A18(a12);
...
uint64_t sub_1CDF7B4(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1CDF820(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27242B8;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1CDF89C(uint64_t a1, uint64_t *a2, char *a3)
{
  v5 = *a2;
  v4 = a2[1];
  if (v4)
...
uint64_t sub_1CDFA3C(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2724318;
...
void sub_1CDFBE8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1CDFC14(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_1CDFC60(uint64_t a1)
{
  sub_1CDFC9C(a1, *(a1 + 16));
  v2 = *a1;
  *a1 = 0;
  if (v2)
  {
...
void sub_1CDFC9C(uint64_t a1, void *a2)
{
  if (a2)
  {
    v2 = a2;
...
const void **sub_1CDFD30(void *a1, const void **a2, uint64_t a3)
{
...
void sub_1CDFFB0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1CDFFC4(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1CDFFC4(uint64_t a1)
{
  v2 = *a1;
  *a1 = 0;
  if (v2)
...
void *sub_1CE0010(void *a1, void *a2)
{
  sub_1334CC0(a1, 0, 0);
  if (a1 != a2)
  {
...
void sub_1CE00B0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EF0E0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1CE7098(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v80 = -13944;
  v81 = v74;
  do
...
void sub_1CEAB6C()
{
  ...
  unk_27EF0A0 = 0;
  qword_27EF0A8 = 0;
  sub_68678C(&qword_27EF098, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF0B8 = 0;
  qword_27EF0C0 = 0;
  sub_68678C(&qword_27EF0B0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF0D0 = 0;
  qword_27EF0D8 = 0;
  sub_68678C(&qword_27EF0C8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1CE00B0(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1CEAC8C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void *sub_1CEACB8@<X0>(void *result@<X0>, uint64_t a2@<X8>)
{
  if ((result[2] & 2) != 0)
  {
    v3 = result;
    sub_17958F8(v6, 0, 0);
    sub_194DB28(v6, v3[7] & 0xFFFFFFFFFFFFFFFELL);
    v4 = v7 & 0xFFFFFFFFFFFFFFFELL;
    if (*((v7 & 0xFFFFFFFFFFFFFFFELL) + 23) < 0)
    {
      sub_325C(a2, *v4, *(v4 + 8));
    }
...
void sub_1CEAD60(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_179644C(va);
  _Unwind_Resume(a1);
...
void *sub_1CEAD74@<X0>(void *result@<X0>, _BYTE *a2@<X8>)
{
  if ((result[2] & 2) != 0)
  {
    v3 = result;
...
uint64_t sub_1CEAE60(uint64_t a1, uint64_t a2)
{
  sub_17958F8(a1, 0, 0);
  if (a1 != a2)
  {
...
uint64_t sub_1CEAF00(uint64_t *a1)
{
  if (*(a1 + 23) >= 0)
  {
    v1 = a1;
...
void sub_1CEAFE4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
...
BOOL sub_1CEB018(uint64_t *a1)
{
  ...
  v5 = sub_1EBBF6C(v4, v2);

  return v5;
}

__n128 sub_1CEB0AC@<Q0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v4 = *(a1 + 23);
  if (v4 < 0)
  {
...
void sub_1CEB124(__int128 *a1@<X0>, __int128 *a2@<X1>, uint64_t a3@<X8>)
{
  *a3 = 0u;
  *(a3 + 16) = 0u;
  *(a3 + 32) = 1065353216;
  ...
  v6 = CFStringCreateWithCString(kCFAllocatorDefault, p_p, 0x8000100u);
  if (v80 < 0)
  {
    operator delete(__p);
  }
  ...
  if (Length)
  {
    ...
    if (v10)
    {
      v12 = v10 + 1;
      v64 = a3;
      sub_1CEB848(&__p, v10 + 1);
      sub_1CEB8C0(v89, Length + 1);
      if (__p)
      {
        v79 = __p;
        operator delete(__p);
      ...
      sub_1CEB848(&__p, v11 + 1);
      sub_1CEB8C0(v88, Length + 1);
      if (__p)
      {
        v79 = __p;
        operator delete(__p);
      ...
      v65 = CFStringGetLength(v6);
      v68 = CFStringGetLength(v8);
      theString = v6;
      v84 = 0;
      v85 = v65;
      ...
      v74 = 0;
      v75 = v68;
      v72 = CFStringGetCharactersPtr(v8);
      if (v72)
      {
        v14 = 0;
      }
      ...
      {
        v14 = CFStringGetCStringPtr(v8, 0x600u);
      }
        ...
        while (1)
        {
          ...
          if (v85 >= v21)
          {
            ...
            else
            {
              ...
              if (v87 < v21 || v86 >= v21)
              {
                ...
                v87 = v31;
                v94.length = v31 - v67;
                v94.location = v84 + v67;
                CFStringGetCharacters(theString, v94, &__p);
                v33 = v86;
                v20 = v68;
                v23 = v21 - 1;
              }
          ...
          if (!v73)
          {
            if (v77 < v35 || (v46 = v76, v76 >= v35))
            {
              ...
              v95.location = v22 - v30 + 1 + v74;
              v95.length = v36 + v30 + v25;
              CFStringGetCharacters(v71, v95, buffer);
              v46 = v76;
              v20 = v68;
              v23 = v21 - 1;
            }
...
LABEL_93:
        ...
        do
        {
          if (*(*(v52 + v56) + 8 * v50 + 8 * v53))
          {
            if (v54)
            {
              LODWORD(v69) = v50 + v53;
              HIDWORD(v69) = v55;
              sub_1CEBB48(v64, &v69, &v69);
              v52 = v88[0];
            }

            v51 += v53;
            v57 = *(*(v52 + v56) + 8 * v50 + 8 * v53);
            v48 = v57 == 1;
            v58 = v57 != 1;
            v59 = v48;
            v50 = v50 - v59 + v53;
...
void sub_1CEB740(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, void *__p, uint64_t a45, int a46, __int16 a47, char a48, char a49)
{
  __p = (v49 - 208);
  sub_1CEBA9C(&__p);
  __p = (v49 - 184);
...
uint64_t *sub_1CEB848(uint64_t *a1, unint64_t a2)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_1CEB8A4(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
uint64_t *sub_1CEB8C0(uint64_t *a1, unint64_t a2)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_1CEB97C(uint64_t *a1, unint64_t a2)
{
...
void sub_1CEB9C8(uint64_t a1, unint64_t a2)
{
  if (a2 < 0xAAAAAAAAAAAAAABLL)
  {
    operator new();
