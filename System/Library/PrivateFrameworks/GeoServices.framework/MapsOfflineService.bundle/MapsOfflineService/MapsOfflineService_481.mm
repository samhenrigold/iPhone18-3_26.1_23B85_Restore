void sub_1965DA8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  if (*(v3 + 143) < 0)
  {
...
uint64_t sub_1965E30(uint64_t a1)
{
  if (*(a1 + 167) < 0)
  {
...
uint64_t sub_1965ECC(uint64_t a1)
{
  sub_7E724(a1 + 1160, *(a1 + 1168));
  sub_23D9C(a1 + 1096);
  v4 = (a1 + 1032);
  sub_195E3E8(&v4);
  v4 = (a1 + 1008);
  ...
  sub_7E724(a1 + 952, *(a1 + 960));
  sub_7E724(a1 + 928, *(a1 + 936));
  v4 = (a1 + 904);
  sub_195E3E8(&v4);
  v4 = (a1 + 880);
  sub_1965604(&v4);
  ...
  v4 = (a1 + 632);
  sub_1964E4C(&v4);
  sub_7E724(a1 + 536, *(a1 + 544));
  sub_7E724(a1 + 512, *(a1 + 520));
  sub_7E724(a1 + 488, *(a1 + 496));
  sub_7E724(a1 + 464, *(a1 + 472));
  v4 = (a1 + 440);
  sub_195E3E8(&v4);
  v4 = (a1 + 416);
  sub_195E3E8(&v4);
...
uint64_t sub_196609C(uint64_t a1)
{
  if (*(a1 + 1687) < 0)
  {
...
uint64_t sub_19661E8(uint64_t a1)
{
  v2 = *(a1 + 656);
  if (v2)
  {
  ...
  return sub_19639B4(a1);
}

uint64_t **sub_1966280(uint64_t **a1, void *a2, uint64_t a3)
{
  a1[1] = 0;
  v4 = a1 + 1;
  a1[2] = 0;
...
char *sub_1966304(uint64_t **a1, void *a2, void *a3, uint64_t a4)
{
...
uint64_t sub_1966410(uint64_t a1, __int128 *a2)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
...
void sub_1966490(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
uint64_t sub_19664AC(uint64_t a1, const void **a2, uint64_t a3)
{
  *a1 = 0u;
  *(a1 + 16) = 0u;
  *(a1 + 32) = 1065353216;
...
const void **sub_1966524(void *a1, const void **a2, uint64_t a3)
{
...
void sub_1966760(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void **__p, uint64_t a11)
{
  if (__p)
  {
    sub_1965358(&a11, __p);
...
void sub_1966828(_Unwind_Exception *a1)
{
  *v1 = 0;
  sub_1965358(v3, v2);
  _Unwind_Resume(a1);
...
uint64_t sub_1966844(uint64_t a1, const void **a2, uint64_t a3)
{
  *a1 = 0u;
  *(a1 + 16) = 0u;
  *(a1 + 32) = 1065353216;
...
const void **sub_19668BC(void *a1, const void **a2, uint64_t a3)
{
  v5 = sub_1220A84(a1, a2);
  v6 = v5;
  v7 = a1[1];
...
void sub_1966AF8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void **__p, uint64_t a11)
{
  if (__p)
  {
    sub_1965358(&a11, __p);
...
void sub_1966BC0(_Unwind_Exception *a1)
{
  *v1 = 0;
  sub_1965358(v3, v2);
  _Unwind_Resume(a1);
...
void sub_1966BDC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ECB88, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1971698()
{
  ...
  *algn_27ECB48 = 0;
  qword_27ECB50 = 0;
  sub_68678C(&qword_27ECB40, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ECB60 = 0;
  qword_27ECB68 = 0;
  sub_68678C(&qword_27ECB58, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECB78 = 0;
  qword_27ECB80 = 0;
  sub_68678C(&qword_27ECB70, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1966BDC(v0, v1, v2, v3, v4, v5, v6, v7);
  ...
  v37 = 4;
  sub_19664AC(&unk_27ECBA0, __p, 14);
  v8 = 56;
  do
  {
    if (*(&__p[v8 - 1] - 1) < 0)
  ...
  sub_3608D0(v76, "EG");
  v77 = 6;
  sub_1966844(&unk_27ECBC8, __p, 34);
  v9 = 136;
  do
  {
    if (*(&__p[v9 - 1] - 1) < 0)
...
void sub_1971D38(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
void *sub_1971EC4@<X0>(uint64_t a1@<X0>, void *a2@<X8>)
{
  v4 = *(a1 + 192);
  if (!v4)
  {
  ...
  return sub_1869B98(a2, v9);
}

uint64_t sub_1971F44@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  sub_18FA5D4(v4, a1);
  sub_1971EC4(v4, v5);
  sub_18FA778(v4);
  ...
  return sub_1869C50(v5);
}

void sub_1971FE0(std::string *__str@<X0>, std::string *a2@<X8>)
{
...
LABEL_13:
  ...
  size = v7;
LABEL_16:
  std::string::basic_string(&__p, __str, size + 1, 0xFFFFFFFFFFFFFFFFLL, &v14);
  v10 = 0;
LABEL_21:
...
LABEL_30:
  ...
  sub_325C(a2, __p.__r_.__value_.__l.__data_, __p.__r_.__value_.__l.__size_);
LABEL_36:
...
void sub_1972158(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1972178(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  if (*(a1 + 56))
  {
    sub_1971FE0(*(*(a1 + 64) + 8), a2);
  }
...
double sub_197219C(uint64_t a1, unsigned int a2)
{
  sub_18FA5D4(v7, a1);
  sub_1971EC4(v7, v8);
  sub_18FA778(v7);
...
double sub_197225C(uint64_t a1)
{
  v1 = *(a1 + 184);
  if (!v1)
  {
...
uint64_t sub_19722B0(uint64_t a1)
{
  v1 = *(a1 + 192);
  if (!v1)
  {
...
uint64_t sub_19722D0(uint64_t a1)
{
  v1 = &off_278AB30;
  if (*(a1 + 192))
  {
...
uint64_t sub_19722F0(uint64_t a1)
{
  v1 = &off_278AB30;
  if (*(a1 + 192))
  {
...
uint64_t sub_1972310(uint64_t a1)
{
  v1 = *(a1 + 192);
  v2 = &off_278AB30;
  if (v1)
  ...
  v4 = *(v2 + 11);
  if (v4 & 0x400) != 0 || (v3 & 0x400) != 0 || (v3 & 0x800) != 0 || (v4 & 0x200000) != 0 && (v2[60][2])
  {
    return 1;
  }
...
uint64_t sub_1972380(uint64_t a1)
{
  if ((*(a1 + 40) & 8) != 0)
  {
    return (*(*(a1 + 192) + 40) >> 2) & 1;
  }
...
uint64_t sub_19723A0@<X0>(int a1@<W0>, uint64_t a2@<X8>)
{
  result = sub_18FD3D0(a2, 0, 0);
  *(result + 40) |= 0x20u;
  *(result + 208) = a1;
  return result;
}

uint64_t sub_19723E0(uint64_t a1)
{
  v1 = &off_278AB30;
  if (*(a1 + 192))
  {
...
uint64_t sub_1972400(uint64_t a1)
{
  if ((*(a1 + 40) & 8) != 0)
  {
    return (*(*(a1 + 192) + 41) >> 3) & 1;
  }
...
uint64_t sub_1972420(uint64_t *a1)
{
  v1 = sub_1D365A4(*a1);
  if ((*(v1 + 40) & 8) != 0)
  {
    return (*(*(v1 + 192) + 41) >> 3) & 1;
  }
...
uint64_t sub_1972458(uint64_t *a1)
{
  sub_1D36230(*a1, __p);
  v2 = v7;
  if ((v7 & 0x80u) != 0)
...
void sub_19724E0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
BOOL sub_197255C(uint64_t a1, _DWORD *a2)
{
  if ((*(a1 + 40) & 8) == 0)
  {
    return 0;
...
BOOL sub_197262C(uint64_t a1)
{
  v6 = 0;
  if (sub_197255C(a1, &v6))
  {
    return 1;
  }
...
BOOL sub_19726C8(uint64_t a1)
{
  v2 = 1;
  v7 = 1;
  if (!sub_197255C(a1, &v7))
  {
    v3 = *(a1 + 192);
    if (!v3)
    {
...
BOOL sub_1972764(uint64_t a1, _DWORD *a2)
{
  if ((*(a1 + 40) & 8) == 0)
  {
    return 0;
  ...
  if ((v3 & 0x800) != 0 && (v7 = *(v2 + 144), (*(v7 + 17) & 2) != 0) && (v8 = *(v7 + 200), (*(v8 + 16) & 4) != 0))
  {
    return *(v8 + 52) == *a2;
  }
...
uint64_t sub_197280C(uint64_t a1)
{
  v1 = *(a1 + 192);
  if (!v1)
  {
...
void sub_19728B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27ECC38, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
