...
void sub_EFA900(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1F1A8(va);
  _Unwind_Resume(a1);
...
void sub_EFA914(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1F1A8(va);
  _Unwind_Resume(a1);
...
void sub_EFB31C(uint64_t a1, uint64_t a2, int a3, int a4, uint64_t a5)
{
  v6 = 32;
  if (a3)
  {
  ...
  if (a4 && *(a1 + v7) != *(a1 + v6))
  {
    ...
    if (v8)
    {
      ...
      if (*(&v49 + 1) != v49)
      {
        if (((*(&v49 + 1) - v49) & 0x8000000000000000) == 0)
        {
          operator new();
        }
    ...
    if (*(&v49 + 1) != v49)
    {
      ...
      v10 = 0;
      v11 = 0;
      v12 = 0xAAAAAAAAAAAAAAABLL * ((*(&v49 + 1) - v49) >> 2);
      do
      {
        v14 = *(*(a2 + 40) + (v9 >> 29) + 8);
        if (*(v14 + 84) == 1)
...
void sub_EFC248(void *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  *a1 = a3;
  a1[1] = a2;
  a1[2] = sub_3AF6B4(a2);
...
LABEL_53:
  ...
  *(v54 + 4) |= 1u;
  ...
  sub_194EA1C(v54 + 6, (v55 + 7464), v57);
  sub_3AF114();
  ...
  *(a4 + 300) = v17;
  ...
  if (v27)
  {
    ...
    do
    {
      ...
      sub_EFD700(a1, v33, v34, a3, v29++, v32, *v19 + v28);
      v28 += 72;
    }
...
void sub_EFD614(uint64_t *a1, unsigned int *a2, uint64_t a3)
{
  if (sub_5CC07C(a2))
  {
    *(a3 + 40) |= 0x40000u;
...
void sub_EFD700(uint64_t *a1, uint64_t a2, int a3, unint64_t a4, unint64_t a5, uint64_t a6, uint64_t a7)
{
  v13 = sub_ECA8CC(a3);
  *(a6 + 40) |= 0x1000000u;
  *(a6 + 884) = v13;
  ...
  *(a6 + 917) = v20 ^ 1;
  ...
  sub_F0004C(a1, a2, a4, a5, a6, v21);
  sub_F00234(a1, a2, a6, a7);
  sub_F00308(a1, a2, a6);
...
void sub_EFE5DC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_51B6E0(va);
  _Unwind_Resume(a1);
...
void sub_EFEB14(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_EDE2F4(va);
  _Unwind_Resume(a1);
...
void sub_EFEB28(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_EDE2F4(va);
  _Unwind_Resume(a1);
...
void sub_EFEB3C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_EDE2F4(va);
  _Unwind_Resume(a1);
...
void sub_EFED60(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_53E440(va);
  _Unwind_Resume(a1);
...
void sub_EFF7BC(std::string *__return_ptr a1@<X8>, unint64_t __val@<X1>, unint64_t a3@<X2>, uint64_t a4@<X3>)
{
...
void sub_EFFA9C(uint64_t *a1, uint64_t *a2, uint64_t a3, __n128 a4)
{
  if (a2[1348] != a2[1349])
  {
    *(a3 + 40) |= 0x10000u;
  ...
  if (a2[1441] != a2[1442])
  {
    *(a3 + 40) |= 0x20000u;
    ...
    sub_EC9FFC(a2 + 1441, v11);
  }

  v15 = sub_3B1D8C(a1[1]);
  v16 = sub_3EB950(a2);
  sub_2AD1B4(v15, *(v16 + 136), *(v16 + 144), v74);
  *(a3 + 40) |= 0x10000u;
  v17 = *(a3 + 832);
  if (!v17)
  {
  ...
  sub_EC92BC(v74, v16, (a2 + 1293), v17);
  v21 = sub_4D1DB0(a2);
  sub_2AD1B4(v15, *(v21 + 136), *(v21 + 144), v65);
  *(a3 + 40) |= 0x20000u;
  v22 = *(a3 + 840);
  if (!v22)
  {
  ...
  sub_EC92BC(v65, v21, (a2 + 1386), v22);
  if (*(*a1 + 167) == 1)
  {
    ...
    *(a3 + 40) |= 0x10000u;
    ...
    else
    {
      ...
      v26.n128_f64[0] = sub_14BC9E8(v30);
      v27 = v31;
      *(a3 + 832) = v31;
      *(v31 + 16) |= 8u;
      v28 = *(v31 + 48);
...
LABEL_42:
            ...
            *(a3 + 40) |= 0x20000u;
            ...
            else
            {
              ...
              v42.n128_f64[0] = sub_14BC9E8(v46);
              v43 = v47;
              *(a3 + 840) = v47;
              *(v47 + 16) |= 8u;
              v44 = *(v47 + 48);
...
void sub_F00014(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, ...)
{
  va_start(va, a54);
  sub_2AE47C(va);
  _Unwind_Resume(a1);
...
void sub_F0004C(_BYTE *a1, void *a2, unint64_t a3, unint64_t a4, uint64_t a5, __n128 a6)
{
  v10 = a2[1534];
  v11 = a2[1535];
  while (v10 != v11)
  ...
  while (v16 != v17)
  {
    ...
    {
      sub_EFF7BC(&__p, a3, a4, v16);
      sub_F02130(a1, v16, &__p.__r_.__value_.__l.__data_, a5);
      v18 = a2[138];
      v19 = a2[139];
      while (v18 != v19)
      {
...
_BYTE *sub_F00234(uint64_t *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v8 = *(a2 + 1104);
  v9 = *(a2 + 1112);
  while (v8 != v9)
  ...
  return sub_F036B8(a1, a2, a3, a4 + 48);
}
...
void sub_F01470(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, ...)
{
  va_start(va, a31);
  sub_3E5388(va);
  _Unwind_Resume(a1);
...
void sub_F01D18(uint64_t *a1, void *a2, uint64_t a3, uint64_t a4, _DWORD *a5, uint64_t a6)
{
...
void sub_F0209C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
  sub_3E5388(va);
  if (*(v11 - 121) < 0)
...
void sub_F02CB4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02CC8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02CDC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02CF0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02D04(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02D18(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02D2C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
void sub_F02D40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_89FA8(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_F02D54(uint64_t *result, uint64_t a2, uint64_t a3)
{
  if ((*(*result + 3) & 1) == 0)
  {
...
void sub_F036A4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_120D5F0(va);
  _Unwind_Resume(a1);
...
_BYTE *sub_F036B8(_BYTE *result, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v4 = *result;
  if (*(*result + 3) == 1)
  {
    ...
    sub_47A6A8((result + 88), a2, v12, v28);
    *(a3 + 40) |= 0x100000u;
    v13 = *(a3 + 864);
    if (!v13)
    {
...
void sub_F04508(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, ...)
{
  va_start(va, a12);
  sub_EAD110(va);
  JUMPOUT(0xF04514);
  ...
  if (*(a1 + 82) == 1)
  {
    ...
    if (v140)
    {
      ...
      while (1)
      {
        ...
        {
          v7 = sub_12D15D8(v141[2]);
          v6 = sub_19593CC((v141 + 2), v7);
        }
  ...
  if (a3)
  {
    ...
    if (a4[13] >= v9)
    {
      ...
      do
      {
        ...
        v80 = 0;
        sub_F05CB4(a2, a3, *v8, &v80 + 1, &v80, &__p);
        v10 = __p;
        if (v79 == __p)
        {
          goto LABEL_74;
...
LABEL_74:
  ...
  sub_F06040(*(a1 + 32), a1, v7, *(*a1 + 160) > 3u);
}
...
void sub_F06468(uint64_t a1, uint64_t a2, int a3, int a4, uint64_t a5)
{
  v6 = 32;
  if (a3)
  {
...
void sub_F07394(void *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  *a1 = a3;
  a1[1] = a2;
  a1[2] = sub_3AF6B4(a2);
  ...
  *(a4 + 300) = v17;
  ...
  if (v27)
  {
    ...
    do
    {
      ...
      sub_F08838(a1, v33, v34, a3, v29++, v32, *v19 + v28);
      v28 += 72;
    }
