...
void sub_1D108DC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1B5CF64(va);
  _Unwind_Resume(a1);
...
void sub_1D108F0(uint64_t a1, __int128 **a2, uint64_t a3)
{
  v3 = *a2;
  if (*a2 != (a2 + 1))
  {
...
void sub_1D10B6C(void *a2@<X1>, char *x8_0@<X8>)
{
  v24 = 0;
  v25 = 0;
  v26 = 0;
  ...
  sub_1D12574(v21, v10, v6, 0xF83E0F83E0F83E1 * ((v6 - v10) >> 3));
  sub_1D10DE4(v21, &v22);
  v18 = v21;
  sub_1D126D0(&v18);
  v11 = -1431655765 * ((v23 - v22) >> 3);
  if (v11 >= 6)
  {
    v11 = 6;
  }
  ...
  v19 = 0;
  v20 = 0;
  sub_1D12754(&v18, v22, (v22 + 24 * v11), v11);
  nullsub_1();
  v13 = v12;
  __p = 0;
  v16 = 0;
...
void sub_1D11020(uint64_t **a1@<X1>, uint64_t **a2@<X2>, char *a3@<X8>, _DWORD *a4@<X0>)
{
  *(a3 + 1) = 0;
  v7 = a3 + 8;
  *(a3 + 2) = 0;
  *a3 = a3 + 8;
  ...
  v12 = *a2;
  for (i = a2[1]; v12 != i; v12 += 24)
  {
    sub_19AD608(a4, (v12 + 8));
    if (v7 == sub_19D5254(a3, v19))
    {
      if (SHIBYTE(v20) < 0)
      {
...
void sub_1D11264(uint64_t a1, __int128 **a2, uint64_t a3)
{
  nullsub_1();
  v6 = v5;
  v7 = sub_1C9DBE8(a2);
  ...
  v17 = 0;
  v18 = 0;
  sub_1D128F4(&v17, *v7, v7[1], 0xAAAAAAAAAAAAAAABLL * ((v7[1] - *v7) >> 3));
  v8 = sub_C62968(a2);
  v15 = 0;
  __p = 0;
  v16 = 0;
  sub_1D128F4(&__p, *v8, v8[1], 0xAAAAAAAAAAAAAAABLL * ((v8[1] - *v8) >> 3));
  sub_1D11020(&v17, &__p, &v20, v6);
  if (__p)
  {
    v15 = __p;
    operator delete(__p);
...
void *sub_1D119C4(void *a1, char *a2, __int128 **a3)
{
  v5 = sub_3608D0(a1, a2);
  v5[3] = 0;
  v5[4] = 0;
...
uint64_t sub_1D11A30(char *a1, void *a2, uint64_t a3)
{
...
void *sub_1D11AFC(void *a1, void *a2)
{
  sub_1502728(a1, 0, 0);
  if (a1 != a2)
  {
...
uint64_t sub_1D11C54(char *a1, void *a2, uint64_t a3)
{
  v3 = *sub_122356C(a1, &v5, a2);
  if (!v3)
  {
...
void *sub_1D11D20(void *a1, void *a2)
{
  sub_1504B80(a1, 0, 0);
  if (a1 != a2)
  {
...
uint64_t sub_1D11E78(char *a1, void *a2, uint64_t a3)
{
  v3 = *sub_122356C(a1, &v5, a2);
  if (!v3)
  {
...
uint64_t sub_1D11FFC(uint64_t a1, __int128 *a2)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
...
uint64_t sub_1D12100(uint64_t a1, __int128 **a2)
{
...
void sub_1D12444(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1D12524(va);
  _Unwind_Resume(a1);
...
void sub_1D124B4(uint64_t a1, void *a2, void *a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
void sub_1D125DC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 + 8) = v10;
  sub_1D126D0(&a9);
  _Unwind_Resume(a1);
...
uint64_t *sub_1D12754(uint64_t *result, __int128 *a2, __int128 *a3, unint64_t a4)
{
  if (a4)
  {
...
uint64_t sub_1D12820(char *a1, void *a2, uint64_t a3)
{
  v3 = *sub_122356C(a1, &v5, a2);
  if (!v3)
  {
...
uint64_t *sub_1D128F4(uint64_t *result, __int128 *a2, __int128 *a3, unint64_t a4)
{
  if (a4)
  {
    sub_1D127D4(result, a4);
...
uint64_t *sub_1D129D0(uint64_t *a1, uint64_t a2)
{
  a1[2] = 0;
  a1[1] = 0;
  *a1 = (a1 + 1);
...
uint64_t *sub_1D12A28(uint64_t *result, void *a2, void *a3)
{
  if (a2 != a3)
  {
    ...
    do
    {
      result = sub_1D12AB0(v5, (v5 + 8), v4 + 4, (v4 + 4));
      v6 = v4[1];
      if (v6)
      {
        do
...
uint64_t *sub_1D12AB0(uint64_t **a1, void *a2, unint64_t *a3, uint64_t a4)
{
...
uint64_t **sub_1D12C10(uint64_t **a1, void *a2, uint64_t a3)
{
  a1[1] = 0;
  v4 = a1 + 1;
  a1[2] = 0;
...
uint64_t *sub_1D12C94(uint64_t **a1, void *a2, void *a3, uint64_t a4)
{
...
uint64_t *sub_1D12EDC(uint64_t **a1, unint64_t *a2, uint64_t *a3)
{
  v3 = a1[1];
  if (!v3)
  {
...
uint64_t *sub_1D12FD0(uint64_t **a1, unint64_t *a2, uint64_t a3)
{
  v3 = a1[1];
  if (!v3)
  {
...
uint64_t *sub_1D1395C(uint64_t *a1, uint64_t a2)
{
...
uint64_t sub_1D13CA4(unint64_t *a1, __int128 *a2)
{
...
void sub_1D13DD8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1D141E8(va);
  _Unwind_Resume(a1);
...
void sub_1D1455C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, ...)
{
  va_start(va, a27);
  sub_1D14238(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_1D14630(uint64_t *a1, uint64_t a2)
{
  v4 = sub_1D12078(a1, a2);
...
void sub_1D14AD4(_Unwind_Exception *a1, uint64_t a2, std::__shared_weak_count *a3, uint64_t a4, std::__shared_weak_count *a5, ...)
{
  va_start(va, a5);
  sub_1D14BD4(va);
  sub_7E724(v5 - 72, *(v5 - 64));
  sub_19C591C(v5 - 48, *(v5 - 40));
  sub_1B5CF64((v5 - 24));
  if (a5)
  {
    sub_1220A18(a5);
...
uint64_t sub_1D14CC8(unint64_t *a1, __int128 *a2)
{
  v3 = a1[1];
  if (v3 >= a1[2])
  {
...
uint64_t *sub_1D14D08(uint64_t a1, __int128 *a2)
{
  v4 = *(a1 + 8);
  if (*(a2 + 23) < 0)
  {
...
uint64_t sub_1D14DBC(unint64_t *a1, __int128 *a2)
{
...
void sub_1D14F24(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_19C591C(v7 + 24, *(v7 + 32));
  if (*(v7 + 23) < 0)
  {
    operator delete(*v7);
  }
...
void sub_1D154A0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D14BD4(va);
  _Unwind_Resume(a1);
...
void sub_1D156D4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D157D4(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_1D156EC(uint64_t *result, unint64_t a2)
{
...
void sub_1D157C0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D141E8(va);
  _Unwind_Resume(a1);
...
void sub_1D15C7C(uint64_t a1, __int128 *a2)
{
  v2 = *a2;
  *a2 = 0uLL;
  sub_1D1088C(a1 + 32, &v2);
}
...
void sub_1D15EC4(_Unwind_Exception *a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, __int128 a11, uint64_t a13, uint64_t *a14, uint64_t a15, uint64_t a16, uint64_t *a17, uint64_t a18, uint64_t a19, uint64_t *a20, uint64_t a21, uint64_t a22, uint64_t *a23, uint64_t a24, uint64_t a25, uint64_t *a26, uint64_t a27, uint64_t a28, uint64_t *a29, uint64_t a30, uint64_t a31, uint64_t *a32, uint64_t a33, uint64_t a34, uint64_t *a35, uint64_t a36, uint64_t a37, ...)
{
  ...
  if (a2)
  {
    ...
    sub_7E724(v37 - 152, *(v37 - 144));
    sub_19C591C(v37 - 128, *(v37 - 120));
    __cxa_begin_catch(a1);
    if (a2 == 2)
    {
      nullsub_1();
...
void sub_1D16610(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D16710(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_1D16628(uint64_t *result, unint64_t a2)
{
...
void sub_1D166FC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D151FC(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1D16B24(uint64_t a1, uint64_t *a2)
{
  *a2 = off_27247D0;
  v4 = a2 + 4;
...
void sub_1D16FC4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_1D14238(va);
  __cxa_end_catch();
...
void sub_1D17398(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1D14238(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1D17868(uint64_t a1, uint64_t a2)
{
  sub_1A5F8F4(v10, a1 + 1704);
  sub_1D0EB6C(a1 + 8, v10, a2, v4, v5, v6, v7, v8);
  return sub_1A5F98C(v10);
}
...
void sub_1D17B1C()
{
  ...
  (*(v0 + 16))();
  sub_1A63DA4();
  sub_1A63D5C(&dword_0, v1, v2, "Exception thrown while processing place response. .%s", v3, v4, v5, v6);
}

void sub_1D17BAC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EF2B0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
