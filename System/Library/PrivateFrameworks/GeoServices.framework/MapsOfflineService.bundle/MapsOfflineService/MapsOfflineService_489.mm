...
void sub_19F45F4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ED188, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_19FF0B0()
{
  ...
  *algn_27ED148 = 0;
  qword_27ED150 = 0;
  sub_68678C(&qword_27ED140, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ED160 = 0;
  qword_27ED168 = 0;
  sub_68678C(&qword_27ED158, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED178 = 0;
  qword_27ED180 = 0;
  sub_68678C(&qword_27ED170, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_19F45F4(v0, v1, v2, v3, v4, v5, v6, v7);
...
void *sub_19FF9AC@<X0>(uint64_t a1@<X1>, void *a2@<X8>, uint64_t a3@<X0>)
{
  v5 = *(a1 + 176);
  if ((v5 - 1) > 1)
  {
    exception = __cxa_allocate_exception(0x10uLL);
    std::to_string(&v20, *(a1 + 176));
  ...
  v13 = v12[6];
  sub_19FF8F0(a1, &v22);
  sub_19AD58C(*(a3 + 4 * (*(a1 + 176) != 1)), v23, v24);
  v14 = &off_278B830;
  if (v13)
  {
    v14 = v13;
...
void sub_19FFBFC(uint64_t a1@<X1>, uint64_t *a2@<X8>, char a3@<W0>, double a4@<D0>, double a5@<D1>)
{
  v20 = sub_1F71298(a3, a4, a5);
  v21 = v7;
  sub_1F717B8(&v20, &v18);
  *a2 = 0;
  a2[1] = 0;
...
void sub_19FFE08(uint64_t *a1@<X0>, uint64_t a2@<X1>, int **a3@<X2>, int a4@<W3>, unsigned int *a5@<X4>, os_log_t *a6@<X5>, uint64_t **a7@<X8>)
{
  v39[0] = 0;
  v39[1] = 0;
  v38 = v39;
...
void sub_1A00150(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, void *a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, void *a21)
{
  sub_195A77C(&a15, a16);
  sub_1A001B4(a10);
  sub_195A77C(&a20, a21);
...
void sub_1A001F8(uint64_t **a1@<X8>)
{
  sub_1C1CB34(a1);
  nullsub_1();
  v3 = *v2;
...
uint64_t **sub_1A00424(uint64_t **a1, int *a2, _DWORD *a3)
{
  v3 = a1[1];
  if (!v3)
  {
...
void sub_1A004F0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27ED238, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
