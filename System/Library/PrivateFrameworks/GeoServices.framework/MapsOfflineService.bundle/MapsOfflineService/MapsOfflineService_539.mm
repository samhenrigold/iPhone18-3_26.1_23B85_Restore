...
void sub_1DBA0D4()
{
  ...
  unk_27EF7F0 = 0;
  qword_27EF7F8 = 0;
  sub_68678C(&qword_27EF7E8, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  *algn_27EF808 = 0;
  qword_27EF810 = 0;
  sub_68678C(&qword_27EF800, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF820 = 0;
  qword_27EF828 = 0;
  sub_68678C(&qword_27EF818, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1DAF618(v0, v1, v2, v3, v4, v5, v6, v7);
...
void sub_1DBAA94(void **a1@<X0>, int a2@<W1>, unsigned __int8 ***a3@<X8>)
{
  *a3 = 0;
  a3[1] = 0;
  a3[2] = 0;
...
void sub_1DBAD7C(void ***a1@<X0>, uint64_t *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
...
void sub_1DBAEB8(uint64_t a1@<X0>, void *a2@<X8>)
{
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      if (v17[0] != v17[1])
      {
        sub_1A489AC(v24, v17[0]);
        v26 = v12;
        v13 = sub_1DBBB84(&v22, v12, &unk_229EB70, &v26, &v25);
        LODWORD(v14) = *(v12 + 6);
        if (SHIBYTE(v19) < 0)
        {
  ...
  sub_1DBB348(a2, v24, &v22);
  sub_1CACCFC(&v22, v23[0]);
  v14 = v24;
  sub_195E3E8(&v14);
}
...
void sub_1DBB240(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1B4610C(va);
  _Unwind_Resume(a1);
...
void *sub_1DBB348(void *a1, __int128 **a2, uint64_t a3)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_1DBB3AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_1DBB3C4(uint64_t *a1, uint64_t a2)
{
  a1[2] = 0;
  a1[1] = 0;
  *a1 = (a1 + 1);
...
uint64_t *sub_1DBB41C(uint64_t *result, void *a2, void *a3)
{
  if (a2 != a3)
  {
    ...
    do
    {
      result = sub_1DBB4A4(v5, (v5 + 8), v4 + 4, (v4 + 4));
      v6 = v4[1];
      if (v6)
      {
        do
...
uint64_t *sub_1DBB4A4(uint64_t **a1, void *a2, void *a3, uint64_t a4)
{
...
uint64_t *sub_1DBB674(uint64_t *a1, uint64_t a2)
{
  a1[2] = 0;
  a1[1] = 0;
  *a1 = (a1 + 1);
...
uint64_t *sub_1DBB6CC(uint64_t *result, unsigned int *a2, unsigned int *a3)
{
  if (a2 != a3)
  {
    ...
    do
    {
      result = sub_1DBB754(v5, (v5 + 8), v4 + 8, (v4 + 8));
      v6 = *(v4 + 1);
      if (v6)
      {
        do
...
uint64_t *sub_1DBB754(uint64_t **a1, uint64_t *a2, unsigned int *a3, uint64_t a4)
{
  result = *sub_1DBB7D8(a1, a2, &v6, &v5, a3);
  if (!result)
  {
    sub_1DBB980();
  }
...
uint64_t *sub_1DBB7D8(uint64_t **a1, uint64_t *a2, uint64_t **a3, uint64_t *a4, unsigned int *a5)
{
  v5 = (a1 + 1);
...
void sub_1DBBA9C(void *a1, unint64_t a2)
{
  if (a2 > (a1[2] - *a1) >> 4)
  {
    if (!(a2 >> 60))
...
uint64_t *sub_1DBBB84(uint64_t **a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
...
void sub_1DBBDCC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EF8E0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1DC6888()
{
  ...
  unk_27EF8A0 = 0;
  qword_27EF8A8 = 0;
  sub_68678C(&qword_27EF898, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF8B8 = 0;
  qword_27EF8C0 = 0;
  sub_68678C(&qword_27EF8B0, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF8D0 = 0;
  qword_27EF8D8 = 0;
  sub_68678C(&qword_27EF8C8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1DBBDCC(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
unint64_t sub_1DC69F8(uint64_t a1, void *a2, void *a3, uint64_t a4, void *a5)
{
...
LABEL_12:
    ...
    if (v22 != v20)
    {
      do
      {
        result = sub_1A00424((*(*(v10 + 56) + 24) + 24 * v13), v21 + 7, v21 + 7);
        v23 = *(v21 + 1);
        if (v23)
        {
          do
...
void *sub_1DC6C88(uint64_t a1, __int128 **a2)
{
  v3 = *(a1 + 8);
  if (v3 >= *(a1 + 16))
  {
  ...
  *(a5 + 16) = 0;
  if (a2 != a3)
  {
    ...
    if (a1 + 56 != v10)
    {
      ...
      sub_1DC6CC8(v11, a2 + 3, a3, a4, v16);
