...
void sub_2049F20()
{
  ...
  unk_27F1390 = 0;
  qword_27F1398 = 0;
  sub_68678C(&qword_27F1388, __p, v12, 1uLL);
  if (v11 < 0)
  {
  ...
  *algn_27F13A8 = 0;
  qword_27F13B0 = 0;
  sub_68678C(&qword_27F13A0, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F13C0 = 0;
  qword_27F13C8 = 0;
  sub_68678C(&qword_27F13B8, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_203F464(v0, v1, v2, v3, v4, v5, v6, v7);
...
void sub_204A7EC(uint64_t *a1@<X1>, unint64_t a2@<X2>, unint64_t a3@<X3>, uint64_t *a4@<X4>, uint64_t a5@<X5>, uint64_t a6@<X6>, void **a7@<X8>)
{
  v39 = 0uLL;
  v40 = 0;
  if (a3 <= a2)
...
LABEL_23:
  ...
  *a7 = 0;
  ...
  do
  {
    if (LODWORD(v21[2].__r_.__value_.__l.__data_) == 4)
    {
      v23 = 25;
    }
...
void sub_204B2A8(uint64_t a1@<X0>, uint64_t a3@<X2>, void *a4@<X8>)
{
  v5 = sub_19D52D4((a3 + 1216), (a1 + 24));
  if (v5)
  {
    v6 = v5;
    if (((*(*v5[5] + 8))(v5[5]) & 1) == 0)
...
uint64_t sub_204B7E0(std::string **a1, uint64_t a2)
{
...
void sub_204B914(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_204BA94(va);
  _Unwind_Resume(a1);
...
void sub_204B984(uint64_t a1, std::string *a2, std::string *a3, std::string *a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
std::string *sub_204B9F4(std::string *a1, std::string *a2)
{
  sub_16452F4(a1, 0, 0);
  if (a1 != a2)
  {
    ...
    {
      sub_1645B54(a1, &a2->__r_.__value_.__l.__data_);
    }
  }
...
char **sub_204BB68(char **a1, char **a2, std::string **a3, uint64_t *a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
...
std::string **sub_204BEFC(int a1, std::string **a2, std::string **a3, char **a4)
{
  v5 = a2;
  if (a2 != a3)
  {
...
std::string *sub_204BF6C(__int128 **a1, std::string *a2, std::string *a3, __int128 *a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
...
void sub_204C128(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27F1480, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_2056BE4()
{
  ...
  unk_27F1440 = 0;
  qword_27F1448 = 0;
  sub_68678C(&qword_27F1438, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1458 = 0;
  qword_27F1460 = 0;
  sub_68678C(&qword_27F1450, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1470 = 0;
  qword_27F1478 = 0;
  sub_68678C(&qword_27F1468, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_204C128(v0, v1, v2, v3, v4, v5, v6, v7);
}
...
void sub_2056FE4(uint64_t a1@<X0>, void *a2@<X1>, char **a3@<X8>)
{
  v6 = sub_1DED05C(a1);
  v7 = v6;
  if (*(v6 + 55) >= 0)
