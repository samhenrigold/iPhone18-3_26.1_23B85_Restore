...
void sub_1C630F4()
{
  ...
  unk_27EEAF0 = 0;
  qword_27EEAF8 = 0;
  sub_68678C(&qword_27EEAE8, __p, &v10, 1uLL);
  if (v9 < 0)
  {
  ...
  *algn_27EEB08 = 0;
  qword_27EEB10 = 0;
  sub_68678C(&qword_27EEB00, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EEB20 = 0;
  qword_27EEB28 = 0;
  sub_68678C(&qword_27EEB18, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1C58638(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1C63214(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1C63240(uint64_t *a1, uint64_t *a2, uint64_t a3)
{
  nullsub_1();
  if (*v5 == 2)
  {
  ...
  if ((v8[5] & 0x20) == 0)
  {
    sub_1D36230(*a2, &v23);
    nullsub_1();
    sub_1C638F8(a1, &v23, __p);
    sub_1C63E84();
  }

  v9 = *(sub_1D365A4(*a2) + 192);
  if (!v9)
  {
    v9 = &off_278AB30;
  }
  ...
  if (v25 == 1)
  {
    v13 = v24 & 0xFFFFFFFFFFFFFFFELL;
    if (*((v24 & 0xFFFFFFFFFFFFFFFELL) + 23) < 0)
    {
      v15 = *(v13 + 8);
      if (v15)
      {
        sub_325C(&v21, *v13, v15);
        goto LABEL_27;
      }
    }

    else if (*((v24 & 0xFFFFFFFFFFFFFFFELL) + 23))
    {
      v14 = *v13;
      v22 = *(v13 + 16);
      v21 = v14;
...
void sub_1C638F8(uint64_t *a1@<X0>, __int128 *a2@<X1>, uint64_t a3@<X8>)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(&v13, *a2, *(a2 + 1));
  }
...
void sub_1C63A68(_Unwind_Exception *exception_object)
{
  if (*(v1 - 73) < 0)
  {
...
uint64_t sub_1C63A94(uint64_t a1)
{
  v3 = (a1 + 80);
  sub_1A3CCC4(&v3);
  v3 = (a1 + 56);
...
uint64_t sub_1C63B00(uint64_t a1)
{
  if (*(a1 + 48) == 1)
  {
...
void *sub_1C63C8C(void *a1, char *a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2723BC0;
...
void sub_1C63D08(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2723BC0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

void sub_1C63D5C(uint64_t a1)
{
  v2 = (a1 + 104);
  sub_1A3CCC4(&v2);
  v2 = (a1 + 80);
...
uint64_t sub_1C63DC8(uint64_t a1, char *a2)
{
  sub_3608D0(__p, a2);
  if (SHIBYTE(v6) < 0)
  {
...
void sub_1C63E68(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void *sub_1C63EF0(void *a1, __int128 *a2)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2723BC0;
...
uint64_t sub_1C63F4C(uint64_t a1, __int128 *a2)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
  ...
  *(a1 + 32) = 0;
  *(a1 + 40) = 0;
  sub_1C64068((a1 + 24), *(a2 + 3), *(a2 + 4), 0x2E8BA2E8BA2E8BA3 * ((*(a2 + 4) - *(a2 + 3)) >> 3));
  v5 = *(a2 + 48);
  *(a1 + 56) = 0;
  *(a1 + 48) = v5;
  *(a1 + 64) = 0;
  *(a1 + 72) = 0;
  sub_1C64394((a1 + 56), *(a2 + 7), *(a2 + 8), (*(a2 + 8) - *(a2 + 7)) >> 4);
  *(a1 + 80) = 0;
  *(a1 + 88) = 0;
  *(a1 + 96) = 0;
  sub_1C64394((a1 + 80), *(a2 + 10), *(a2 + 11), (*(a2 + 11) - *(a2 + 10)) >> 4);
  return a1;
}

void sub_1C64024(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A3CCC4(va);
  sub_1C63B4C(va);
...
uint64_t *sub_1C64068(uint64_t *result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
    sub_1C640F0(result, a4);
  }

  return result;
}

void sub_1C640D0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_1C63B4C(&a9);
  _Unwind_Resume(a1);
...
void sub_1C640F0(uint64_t *a1, unint64_t a2)
{
...
void sub_1C64140(uint64_t a1, unint64_t a2)
{
  if (a2 < 0x2E8BA2E8BA2E8BBLL)
  {
    operator new();
...
uint64_t sub_1C6419C(uint64_t a1, __int128 *a2, __int128 *a3, uint64_t a4)
{
  v4 = a4;
  v12 = a4;
  v13 = a4;
  ...
  if (a2 != a3)
  {
    ...
    do
    {
      ...
      *(v4 + 32) = 0;
      *(v4 + 40) = 0;
      sub_19A22C0((v4 + 24), *(v6 + 3), *(v6 + 4), (*(v6 + 4) - *(v6 + 3)) >> 6);
      *(v4 + 48) = 0;
      *(v4 + 56) = 0;
      *(v4 + 64) = 0;
      sub_19A22C0((v4 + 48), *(v6 + 6), *(v6 + 7), (*(v6 + 7) - *(v6 + 6)) >> 6);
      v8 = *(v6 + 9);
      *(v4 + 80) = *(v6 + 80);
      *(v4 + 72) = v8;
      v6 = (v6 + 88);
...
void sub_1C64294(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1C642D4(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1C642D4(uint64_t a1)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_1C64320(*a1, **(a1 + 16), **(a1 + 16), **(a1 + 8), **(a1 + 8));
  }

  return a1;
}

void sub_1C64320(uint64_t a1, uint64_t a2, void **a3, uint64_t a4, void **a5)
{
  if (a3 != a5)
  {
    v10[3] = v5;
...
uint64_t *sub_1C64394(uint64_t *result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_1C643FC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_1A3CCC4(&a9);
  _Unwind_Resume(a1);
...
void *sub_1C6441C(uint64_t a1, void *a2, void *a3, void *a4)
{
  v4 = a4;
  v10 = a4;
  v9 = a4;
...
uint64_t sub_1C644A4(uint64_t a1)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_1A7D994(a1);
...
void sub_1C644DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27EEB90, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1C6B4C4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v80 = -13944;
  v81 = v74;
  do
...
void sub_1C6EF98()
{
  ...
  unk_27EEB50 = 0;
  qword_27EEB58 = 0;
  sub_68678C(&qword_27EEB48, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EEB68 = 0;
  qword_27EEB70 = 0;
  sub_68678C(&qword_27EEB60, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EEB80 = 0;
  qword_27EEB88 = 0;
  sub_68678C(&qword_27EEB78, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1C644DC(v0, v1, v2, v3, v4, v5, v6, v7);
  ...
  v37 = 4;
  sub_19664AC(&unk_27EEBA8, __p, 14);
  v8 = 56;
  do
  {
    if (*(&__p[v8 - 1] - 1) < 0)
  ...
  sub_3608D0(v76, "EG");
  v77 = 6;
  sub_1966844(&unk_27EEBD0, __p, 34);
  v9 = 136;
  do
  {
    if (*(&__p[v9 - 1] - 1) < 0)
...
void sub_1C6F638(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
uint64_t sub_1C6F7C4(os_log_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4)
{
  v5[0] = off_2723C10;
  v5[1] = sub_1C6F9B4;
  v5[3] = v5;
  sub_1C6F870(a1, a2, a3, v5, a4);
  return sub_1C6FE10(v5);
}

void sub_1C6F85C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1C6FE10(va);
  _Unwind_Resume(a1);
...
void sub_1C6F870(os_log_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4, int a5)
{
  if (a5 == 2)
  {
    v5 = *a3;
    ...
    if (*a3 != v6)
    {
      ...
      while (v5 != v6);
      sub_1CF6F28(v12, &unk_236CF73, &__p);
...
void sub_1C6F974(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, char *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1C6F9B4(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  ...
  sub_1CF6F28(v9, &unk_236CF73, a2);
  __p.__r_.__value_.__r.__words[0] = v9;
  sub_195E3E8(&__p);
}

void sub_1C6FABC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, char *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15)
{
  __p = &a15;
  sub_195E3E8(&__p);
  _Unwind_Resume(a1);
...
uint64_t sub_1C6FB04(os_log_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4)
{
  v5[0] = off_2723CC0;
  v5[1] = sub_1C6FCF4;
  v5[3] = v5;
  sub_1C6FBB0(a1, a2, a3, v5, a4);
  return sub_1C6FF84(v5);
}

void sub_1C6FB9C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1C6FF84(va);
  _Unwind_Resume(a1);
...
void sub_1C6FBB0(os_log_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4, int a5)
{
  if (a5 == 2)
  {
    v5 = *a3;
...
void sub_1C6FCB4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, char *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1C6FCF4(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  v2 = *(a1 + 784);
  if (v2)
  {
...
uint64_t sub_1C6FD8C(uint64_t result, void *a2)
{
  v2 = *(result + 8);
  *a2 = off_2723C10;
  a2[1] = v2;
...
uint64_t sub_1C6FDC4(uint64_t a1, uint64_t a2)
{
  if (sub_197E0F8(a2, &off_2723C90))
  {
    return a1 + 8;
  }
...
uint64_t sub_1C6FE10(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_1C6FF00(uint64_t result, void *a2)
{
  v2 = *(result + 8);
  *a2 = off_2723CC0;
  a2[1] = v2;
...
uint64_t sub_1C6FF38(uint64_t a1, uint64_t a2)
{
  if (sub_197E0F8(a2, &off_2723D40))
  {
    return a1 + 8;
  }
...
uint64_t sub_1C6FF84(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
void sub_1C70004(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27EEC40, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
