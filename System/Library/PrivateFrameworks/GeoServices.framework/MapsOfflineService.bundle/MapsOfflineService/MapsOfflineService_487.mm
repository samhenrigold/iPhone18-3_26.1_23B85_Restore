...
void sub_19D3FBC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  *(a3 + 40) |= 0x40u;
  ...
  sub_13A97DC(v12, v15);
  if ((a6 + 24) != &qword_278C180)
  {
    sub_12A41D0(&qword_278C180);
    v16 = *(a6 + 32);
    if (v16)
    {
      v17 = *(a6 + 40);
      v18 = sub_19592E8(&qword_278C180, v16);
      sub_1201B48(&qword_278C180, v18, (v17 + 8), v16, *off_278C190 - dword_278C188);
...
void sub_19D4460(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, ...)
{
  ...
  sub_13AA3B8(&a17);
  sub_19D5204(va);
  sub_7E724(v27 - 160, *(v27 - 152));
  sub_7E724(v27 - 136, *(v27 - 128));
  if (*(v27 - 89) < 0)
  {
...
void sub_19D453C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1639390(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19D45EC(unint64_t *a1, uint64_t a2)
{
...
void sub_19D4708(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_19D4884(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_19D4930(uint64_t *a1, uint64_t *a2, const void ***a3)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_19D4994(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_19D4B04(va);
  _Unwind_Resume(a1);
...
void sub_19D4A14(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 + 8) = v10;
  sub_19D4B04(&a9);
  _Unwind_Resume(a1);
...
_BYTE *sub_19D4FC4(_BYTE *a1, __int128 *a2)
{
  *a1 = 0;
  a1[24] = 0;
  sub_19D5014(a1, a2);
...
void sub_19D5198(void *a1, void *a2)
{
  v4 = a1 + 1;
  sub_7E724(a1, a1[1]);
  *a1 = *a2;
...
void sub_19D53D0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27ED078, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_19DFE8C()
{
  ...
  *algn_27ED038 = 0;
  qword_27ED040 = 0;
  sub_68678C(&qword_27ED030, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ED050 = 0;
  qword_27ED058 = 0;
  sub_68678C(&qword_27ED048, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED068 = 0;
  qword_27ED070 = 0;
  sub_68678C(&qword_27ED060, __p, v12, 1uLL);
  if (v11 < 0)
  {
    operator delete(__p[0]);
  }

  sub_19D53D0(v2, v3, v4, v5, v6, v7, v8, v9);
}
...
void sub_19E06B8(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t **a3@<X2>, uint64_t a4@<X3>, uint64_t *a5@<X8>)
{
...
LABEL_11:
  ...
  if (v13 < v12)
  {
    ...
    if (v15[0] != v15[1])
    {
      sub_19E286C(a5, a5[1], v15[0], v15[1], 0xA3784A062B2E43DBLL * ((v15[1] - v15[0]) >> 3));
    }
...
void sub_19E085C(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t **a3@<X2>, uint64_t a4@<X3>, void *a5@<X4>, int a6@<W5>, void *a7@<X8>)
{
  v14 = *(a2 + 16);
...
void sub_19E10C4(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t **a3@<X2>, uint64_t a4@<X3>, void *a5@<X4>, int a6@<W5>, uint64_t *a7@<X8>)
{
...
void sub_19E14F8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, char *a14, uint64_t a15, uint64_t a16, uint64_t a17, char *a18, uint64_t a19, uint64_t a20, char a21)
{
  *(v21 - 88) = &a11;
  sub_19E2CA4((v21 - 88));
  *(v21 - 88) = &a14;
...
uint64_t sub_19E1B30@<X0>(std::string *a1@<X0>, _BYTE *a2@<X8>, uint64_t a3@<X1>, uint64_t a4@<X2>)
{
  sub_1A2D8F0(a1 + 1, a3, a4, v7);
  if (sub_1A2DF18(v7))
  {
    sub_19D4DB4(a2, v7);
    v5 = 1;
...
void sub_19E1BAC(uint64_t result@<X0>, uint64_t a2@<X1>, void *a3@<X2>, uint64_t a4@<X3>, uint64_t a5@<X8>)
{
  *(a5 + 80) = 0;
  *(a5 + 48) = 0u;
  *(a5 + 64) = 0u;
  ...
  *a5 = 0u;
  if (a3[1] != *a3)
  {
    ...
    if (v10[1] != v10[0])
    {
      sub_19E7A38(a5, 0, v10[0], v10[1], 0x7D6343EB1A1F58D1 * ((v10[1] - v10[0]) >> 4));
    }
...
uint64_t sub_19E20DC@<X0>(std::string *a1@<X0>, _BYTE *a2@<X8>, uint64_t a3@<X1>, uint64_t a4@<X2>, __int128 *a5@<X3>)
{
  sub_1A2E6F4(a1 + 1, a3, a4, a5, v8);
  if (sub_1A2E788(v8))
  {
    sub_195EB38(a2, v8);
    v6 = 1;
...
void sub_19E2144(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_196005C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19E2158@<X0>(std::string *a1@<X0>, _BYTE *a2@<X8>, uint64_t a3@<X1>, uint64_t a4@<X2>)
{
  sub_1A2E340(a1 + 1, a3, a4, v7);
  if (sub_1A2E788(v7))
  {
    sub_195EB38(a2, v7);
    v5 = 1;
...
void sub_19E21C0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_196005C(va);
  _Unwind_Resume(a1);
...
__int128 *sub_19E286C(__int128 **a1, __int128 *a2, __int128 *a3, __int128 *a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
...
void sub_19E2B6C(uint64_t result, uint64_t a2)
{
  for (i = *(result + 8); i != a2; sub_19E2BC0(result, i))
  {
    i -= 72;
  }
...
void sub_19E2BC0(uint64_t a1, uint64_t a2)
{
  sub_1B11224((a2 + 24));
  v3 = a2;
  sub_19E2C00(&v3);
...
uint64_t sub_19E2CF8(void *a1, uint64_t a2)
{
...
void sub_19E2E2C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_19E31C0(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19E3080(uint64_t a1, uint64_t a2)
{
  sub_1655F18(a1, 0, 0);
  if (a1 != a2)
  {
...
void sub_19E3294(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
void sub_19E32F4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_19A240C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19E330C(uint64_t *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
...
uint64_t sub_19E3690(uint64_t *a1, void *a2, uint64_t a3)
{
  v6 = a2[1];
  sub_19E3FE4(a1, a3, a1[1], a2[2]);
  v7 = *a1;
  v8 = a2[1];
  a2[2] += a1[1] - a3;
  a1[1] = a3;
...
void sub_19E3808(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_19E3B50(va);
  _Unwind_Resume(a1);
...
void sub_19E3B88(uint64_t *result)
{
  v2 = result[1];
  v1 = result[2];
  v3 = *v1;
...
uint64_t sub_19E3FE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v15 = a4;
  v16 = a4;
  v13[0] = a1;
...
void sub_19E4138(uint64_t result, uint64_t a2)
{
  while (1)
  {
    v4 = *(result + 16);
