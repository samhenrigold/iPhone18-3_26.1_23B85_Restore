...
void sub_1EC9A08(uint64_t a1, uint64_t *a2)
{
  v2 = a2[1];
  v3 = *a2;
  v4 = v2;
...
void sub_1EC9AD8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12)
{
  if (a12)
  {
    sub_1220A18(a12);
...
uint64_t sub_1EC9B10(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1EC9B7C(std::__shared_weak_count *a1)
{
  a1->__vftable = off_27269C0;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1EC9BF8(uint64_t a1, uint64_t *a2, char *a3)
{
  v5 = *a2;
  v4 = a2[1];
  if (v4)
...
uint64_t sub_1EC9D98(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_2726A20;
...
void sub_1EC9F44(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_1EC9F70(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1EC9FBC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  sub_1966280(qword_27F04A0, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
...
void sub_1ED4A78()
{
  ...
  unk_27F0460 = 0;
  qword_27F0468 = 0;
  sub_68678C(&qword_27F0458, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F0478 = 0;
  qword_27F0480 = 0;
  sub_68678C(&qword_27F0470, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0490 = 0;
  qword_27F0498 = 0;
  sub_68678C(&qword_27F0488, __p, &v10, 1uLL);
  if (v9 < 0)
  {
    operator delete(__p[0]);
  }

  sub_1EC9FBC(v0, v1, v2, v3, v4, v5, v6, v7);
}

void sub_1ED4B98(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1ED4BC4@<X0>(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  sub_D7B0(v51);
  v4 = *(a1 + 16);
  if ((v4 & 0x800) != 0)
  ...
  else
  {
    ...
    if ((v4 & 0x400) != 0)
    {
      v5 = *(a1 + 192) & 0xFFFFFFFFFFFFFFFELL;
      v6 = *(v5 + 23);
      if (v6 >= 0)
      {
        v7 = *(a1 + 192) & 0xFFFFFFFFFFFFFFFELL;
      }
  ...
  v11 = *(a1 + v10) & 0xFFFFFFFFFFFFFFFELL;
  v12 = *(v11 + 23);
  if (v12 >= 0)
  {
    v13 = v11;
...
LABEL_20:
  ...
  if ((v15 & 0x20) != 0)
  {
    ...
    if (v18 >= 0)
    {
      v19 = *(a1 + 152) & 0xFFFFFFFFFFFFFFFELL;
    }
  ...
  {
    v21 = sub_4A5C(&v52, " ", 1);
    v22 = *(a1 + 160) & 0xFFFFFFFFFFFFFFFELL;
    v23 = *(v22 + 23);
    v24 = v23 >= 0 ? *(a1 + 160) & 0xFFFFFFFFFFFFFFFELL : *v22;
    v25 = v23 >= 0 ? *(v22 + 23) : *(v22 + 8);
    sub_4A5C(v21, v24, v25);
    if ((*(a1 + 17) & 0x10) != 0)
    {
      v26 = sub_4A5C(&v52, " ", 1);
      v27 = 208;
LABEL_39:
      v28 = *(a1 + v27) & 0xFFFFFFFFFFFFFFFELL;
      v29 = *(v28 + 23);
      if (v29 >= 0)
      {
        v30 = v28;
  ...
  v35 = *(a1 + v34) & 0xFFFFFFFFFFFFFFFELL;
  v36 = *(v35 + 23);
  if (v36 >= 0)
  {
    v37 = v35;
...
LABEL_57:
  ...
  v42 = *(a1 + v41) & 0xFFFFFFFFFFFFFFFELL;
  v43 = *(v42 + 23);
  if (v43 >= 0)
  {
    v44 = v42;
...
void sub_1ED503C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  std::ios::~ios();
  _Unwind_Resume(a1);
}

void sub_1ED5064(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  __chkstk_darwin(a1, a2, a3, a4, a5, a6, a7, a8);
  sub_3608D0(&v1253, "AW");
  sub_3608D0(&v1250, "ABW");
  ...
  v12 = 233;
  sub_195E43C(&v1503, v13, __p);
  sub_1966280(qword_27F0500, v1255, 249);
  v8 = &v1504;
  v9 = -13944;
  do
  {
