...
{
  v14.receiver = self;
  v14.super_class = GEOMapDataSubscriptionRemoteSyncManager;
...
void __54__GEOMapDataSubscriptionRemoteSyncManager__connection__block_invoke(uint64_t a1)
{
  ...
  v3 = [GEOXPCConnection createServerConnectionFor:14 debugIdentifier:@"MapDataSubscriptionSyncManager" queue:v2 eventHandler:v6];
  v4 = *(a1 + 32);
  v5 = *(v4 + 24);
  *(v4 + 24) = v3;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GEOMapDataSubscriptionRemoteSyncManager;
