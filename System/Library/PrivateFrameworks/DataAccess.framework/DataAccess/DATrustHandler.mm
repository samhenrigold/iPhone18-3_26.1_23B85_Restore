...
- (void)handleTrust:(__SecTrust *)trust forHost:(id)host forAccount:(id)account withCompletionBlock:(id)block
{
  ...
  {
    *buf = 0;
    _os_log_impl(&dword_24844D000, v11, v13, "Checking to see if we should trust the server certificate", buf, 2u);
  }
  ...
  if (v17 != 5)
  {
    if (v17 != 4)
    {
      ...
      if (os_log_type_enabled(v19, v13))
      {
        *buf = 67109120;
        *&buf[4] = v17;
        _os_log_impl(&dword_24844D000, v19, v13, "Got SecTrustEvaluate result %u. Denying.", buf, 8u);
      }
...
LABEL_11:
    ...
    if (os_log_type_enabled(v19, v13))
    {
      *buf = 67109120;
      *&buf[4] = v17;
      _os_log_impl(&dword_24844D000, v19, v13, "Got SecTrustEvaluate result %u. Allowing.", buf, 8u);
    }
  ...
  if (bOOLValue)
  {
    ...
    if (os_log_type_enabled(v23, v25))
    {
      ...
      *&buf[4] = accountCopy;
      ...
      v28 = v25;
LABEL_31:
      _os_log_impl(&dword_24844D000, v27, v28, v26, buf, 0xCu);
    }
  }
...
uint64_t __68__DATrustHandler_handleTrustChallenge_forAccount_completionHandler___block_invoke()
{
  ...
  v1 = handleTrustChallenge_forAccount_completionHandler__sTrustChallengeQueue;
  handleTrustChallenge_forAccount_completionHandler__sTrustChallengeQueue = v0;
