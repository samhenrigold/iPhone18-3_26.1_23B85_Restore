...
{
  _daAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion__statusReportQueue = dispatch_queue_create("com.apple.dataaccess.statusreport", 0);
...
void __129__ACAccountStore_DAExtensions___daAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_3_41(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    v15[1] = 3221225472;
    v15[2] = __129__ACAccountStore_DAExtensions___daAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_4_42;
    v15[3] = &unk_278F13770;
    v11 = *(a1 + 56);
    v14 = *(a1 + 32);
    v12 = *(&v14 + 1);
