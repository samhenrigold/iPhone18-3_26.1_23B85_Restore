  ...
  if (([*(a1 + 32) finished] & 1) == 0)
  {
    ...
    if (v2)
    {
      ...
      if (os_log_type_enabled(v3, v5))
      {
        ...
        v21 = 2112;
        v22 = v9;
        _os_log_impl(&dword_248524000, v4, v5, "The token registration session became invalid for account ID %@: %@", &v19, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v3, *(MEMORY[0x277D03988] + 6)))
      {
        ...
        v19 = 138412290;
        v20 = v18;
        _os_log_impl(&dword_248524000, v4, v15, "Token registration session became invalid for account %@", &v19, 0xCu);
      }
  ...
  if (([*(a1 + 32) finished] & 1) == 0)
  {
    ...
    if (v2)
    {
      ...
      if (os_log_type_enabled(v3, v5))
      {
        ...
        v21 = 2112;
        v22 = v9;
        _os_log_impl(&dword_248524000, v4, v5, "The token registration task failed to load for account ID %@: %@", &v19, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v3, *(MEMORY[0x277D03988] + 6)))
      {
        ...
        v19 = 138412290;
        v20 = v18;
        _os_log_impl(&dword_248524000, v4, v15, "Token registration task finished for account %@", &v19, 0xCu);
      }
...
- (void)URLSession:(id)session dataTask:(id)task didReceiveData:(id)data
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    ...
    v9 = 138412290;
    v10 = v8;
    _os_log_impl(&dword_248524000, v6, v7, "The server returned a response of %@", &v9, 0xCu);
  }
}
...
- (BOOL)_canAuthenticateAgainstProtectionSpace:(id)space
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    v12 = 136315138;
    Name = sel_getName(a2);
    _os_log_impl(&dword_248524000, v5, v6, "%s", &v12, 0xCu);
  }
  ...
  if (os_log_type_enabled(v9, v6))
  {
    ...
    v14 = 2112;
    v15 = v10;
    _os_log_impl(&dword_248524000, v9, v6, "Can authenticate against protection space %@? %@", &v12, 0x16u);
  }
