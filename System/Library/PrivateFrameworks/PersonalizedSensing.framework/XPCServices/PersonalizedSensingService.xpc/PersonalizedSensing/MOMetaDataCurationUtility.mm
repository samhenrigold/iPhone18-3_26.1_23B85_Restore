    ...
    if (v14)
    {
      ...
      do
      {
        for (i = 0; i != v15; i = i + 1)
        {
          ...
          v18 = *(*(&v34 + 1) + 8 * i);
          if ([v18 relationship] != 4 || (objc_msgSend(v18, "score"), v19 = &off_1000C83B0, v20 < v9))
          {
            if ([v18 relationship] != 15 || (objc_msgSend(v18, "score"), v19 = &off_1000C83C8, v21 < v8))
            {
...
+ (void)getTheBestPersonRelationtshipTagFor:(void *)a1 useRelationshipInference:.cold.1(void *a1)
{
  ...
  *(&v8 + 4) = v1;
  OUTLINED_FUNCTION_0_1(&_mh_execute_header, v2, v3, "None of personalRelationships are confident enough to generate the best relationship tag for person %{private}@", v4, v5, v6, v7, v8, DWORD2(v8));
}
...
+ (void)getTheBestPersonRelationtshipTagFor:(void *)a1 useRelationshipInference:.cold.2(void *a1)
{
  ...
  LODWORD(v8) = 138477827;
  *(&v8 + 4) = v1;
  OUTLINED_FUNCTION_0_1(&_mh_execute_header, v2, v3, "No personalRelationship is available for person %{private}@", v4, v5, v6, v7, v8, DWORD2(v8));
}
