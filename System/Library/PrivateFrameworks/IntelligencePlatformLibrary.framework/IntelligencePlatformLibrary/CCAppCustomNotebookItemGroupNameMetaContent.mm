...
- (CCAppCustomNotebookItemGroupNameMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCAppCustomNotebookItemGroupNameMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCAppCustomNotebookItemGroupNameMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppCustomNotebookItemGroupNameMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCAppCustomNotebookItemGroupNameMetaContent *)self sourceItemIdentifier];
