...
- (CCFindMyDeviceMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCFindMyDeviceMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCFindMyDeviceMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCFindMyDeviceMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCFindMyDeviceMetaContent *)self sourceItemIdentifier];
