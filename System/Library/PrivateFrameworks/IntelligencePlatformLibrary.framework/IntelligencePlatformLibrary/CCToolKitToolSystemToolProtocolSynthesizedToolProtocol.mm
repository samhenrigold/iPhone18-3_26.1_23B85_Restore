...
- (CCToolKitToolSystemToolProtocolSynthesizedToolProtocol)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCToolKitToolSystemToolProtocolSynthesizedToolProtocol)initWithReplacingIntents:(id)intents error:(id *)error;
...
- (CCToolKitToolSystemToolProtocolSynthesizedToolProtocol)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  {
    v9 = [dictionaryCopy objectForKeyedSubscript:@"replacingIntents"];
    v10 = [[CCToolKitToolSystemToolProtocolSynthesizedToolProtocol alloc] initWithReplacingIntents:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    replacingIntents = [(CCToolKitToolSystemToolProtocolSynthesizedToolProtocol *)self replacingIntents];
    [v3 setObject:replacingIntents forKeyedSubscript:@"replacingIntents"];
  }
