...
- (CCAppCustomVoiceCommandNameMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCAppCustomVoiceCommandNameMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCAppCustomVoiceCommandNameMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppCustomVoiceCommandNameMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCAppCustomVoiceCommandNameMetaContent *)self sourceItemIdentifier];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_sourceItemIdentifier)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:30603 stringValue:self->_sourceItemIdentifier];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  if (identifier == 30603)
  {
    return @"AppCustomVoiceCommandNameMetaContent_sourceItemIdentifier";
  }
