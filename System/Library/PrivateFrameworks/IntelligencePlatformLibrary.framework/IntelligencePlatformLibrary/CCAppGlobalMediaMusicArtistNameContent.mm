...
- (CCAppGlobalMediaMusicArtistNameContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCAppGlobalMediaMusicArtistNameContent)initWithVocabularyStrings:(id)strings error:(id *)error;
...
- (CCAppGlobalMediaMusicArtistNameContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaMusicArtistNameContent alloc] initWithVocabularyStrings:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    vocabularyStrings = [(CCAppGlobalMediaMusicArtistNameContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_vocabularyStrings)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:3620 repeatedStringValue:self->_vocabularyStrings];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  v3 = @"AppGlobalMediaMusicArtistNameContent_vocabularyStrings";
  if (identifier != 3620)
  {
    v3 = 0;
  }
