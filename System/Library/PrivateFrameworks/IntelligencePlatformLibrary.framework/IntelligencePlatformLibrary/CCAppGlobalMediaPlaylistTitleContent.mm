...
- (CCAppGlobalMediaPlaylistTitleContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCAppGlobalMediaPlaylistTitleContent)initWithVocabularyStrings:(id)strings error:(id *)error;
...
- (CCAppGlobalMediaPlaylistTitleContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaPlaylistTitleContent alloc] initWithVocabularyStrings:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    vocabularyStrings = [(CCAppGlobalMediaPlaylistTitleContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_vocabularyStrings)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:34312 repeatedStringValue:self->_vocabularyStrings];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  v3 = @"AppGlobalMediaPlaylistTitleContent_vocabularyStrings";
  if (identifier != 34312)
  {
    v3 = 0;
  }
