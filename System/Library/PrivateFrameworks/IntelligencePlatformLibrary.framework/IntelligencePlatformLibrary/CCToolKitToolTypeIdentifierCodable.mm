...
- (CCToolKitToolTypeIdentifierCodable)initWithIdentifier:(id)identifier error:(id *)error;
- (CCToolKitToolTypeIdentifierCodable)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (NSString)identifier;
- (id)jsonDictionary;
...
- (CCToolKitToolTypeIdentifierCodable)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCToolKitToolTypeIdentifierCodable alloc] initWithIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  if (self->_identifier)
  {
    identifier = [(CCToolKitToolTypeIdentifierCodable *)self identifier];
