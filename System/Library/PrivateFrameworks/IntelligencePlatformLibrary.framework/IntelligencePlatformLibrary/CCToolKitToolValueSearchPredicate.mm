@interface CCToolKitToolValueSearchPredicate
- (BOOL)initializeFieldValuesFromData:(id)data error:(id *)error;
- (CCToolKitToolValueSearchPredicate)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCToolKitToolValueSearchPredicate)initWithValues:(id)values error:(id *)error;
- (NSArray)values;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type;
@end

@implementation CCToolKitToolValueSearchPredicate
...
- (CCToolKitToolValueSearchPredicate)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v24 = [[CCToolKitToolValueSearchPredicate alloc] initWithValues:v13 error:error];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_values)
  {
    ...
    v15 = 0u;
    v16 = 0u;
    values = [(CCToolKitToolValueSearchPredicate *)self values];
