...
- (CCToolKitToolComparisonPredicateComparisonPair)initWithFirst:(id)first second:(id)second error:(id *)error;
- (CCToolKitToolComparisonPredicateComparisonPair)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (CCToolKitToolComparisonPredicateComparisonPair)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  {
    v9 = [dictionaryCopy objectForKeyedSubscript:@"first"];
    if (v9)
    {
      v20[0] = 0;
    ...
    v13 = [dictionaryCopy objectForKeyedSubscript:@"second"];
    if (!v13)
    {
      v14 = 0;
      goto LABEL_13;
...
LABEL_13:
      v17 = [[CCToolKitToolComparisonPredicateComparisonPair alloc] initWithFirst:v9 second:v14 error:error];
      v12 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_first)
  {
    first = [(CCToolKitToolComparisonPredicateComparisonPair *)self first];
    jsonDictionary = [first jsonDictionary];
    [v3 setObject:jsonDictionary forKeyedSubscript:@"first"];
  }

  if (self->_second)
  {
    second = [(CCToolKitToolComparisonPredicateComparisonPair *)self second];
    jsonDictionary2 = [second jsonDictionary];
    [v3 setObject:jsonDictionary2 forKeyedSubscript:@"second"];
  }
