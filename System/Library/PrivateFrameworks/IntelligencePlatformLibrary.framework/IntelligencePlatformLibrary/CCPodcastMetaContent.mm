...
- (CCPodcastMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCPodcastMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCPodcastMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCPodcastMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCPodcastMetaContent *)self sourceItemIdentifier];
