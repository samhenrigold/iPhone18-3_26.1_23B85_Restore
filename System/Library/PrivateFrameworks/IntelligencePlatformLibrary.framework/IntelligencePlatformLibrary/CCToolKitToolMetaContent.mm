@interface CCToolKitToolMetaContent
- (BOOL)initializeFieldValuesFromData:(id)data error:(id *)error;
- (CCToolKitToolMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCToolKitToolMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
- (NSString)sourceItemIdentifier;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type;
@end

@implementation CCToolKitToolMetaContent
...
- (CCToolKitToolMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCToolKitToolMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCToolKitToolMetaContent *)self sourceItemIdentifier];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_sourceItemIdentifier)
  {
    ...
    blockCopy = block;
    v8 = [v6 alloc];
    v9 = [v8 initWithFieldType:*MEMORY[0x1E69939A8] stringValue:self->_sourceItemIdentifier];
