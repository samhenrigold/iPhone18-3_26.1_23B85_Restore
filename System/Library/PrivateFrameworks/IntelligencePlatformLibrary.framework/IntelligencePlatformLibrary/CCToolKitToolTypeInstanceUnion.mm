@interface CCToolKitToolTypeInstanceUnion
- (BOOL)initializeFieldValuesFromData:(id)data error:(id *)error;
- (CCToolKitToolTypeInstanceUnion)initWithItems:(id)items error:(id *)error;
- (CCToolKitToolTypeInstanceUnion)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (NSArray)items;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type;
@end

@implementation CCToolKitToolTypeInstanceUnion
...
- (CCToolKitToolTypeInstanceUnion)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
      ...
      if (v14)
      {
        ...
        do
        {
          for (i = 0; i != v15; ++i)
          {
            ...
            v18 = *(*(&v28 + 1) + 8 * i);
            v19 = [CCToolKitToolTypeInstance alloc];
            v27 = 0;
            v20 = [(CCToolKitToolTypeInstance *)v19 initWithJSONDictionary:v18 error:&v27];
            v21 = v27;
            if (v20)
            {
              v22 = v21 == 0;
    ...
    v24 = [[CCToolKitToolTypeInstanceUnion alloc] initWithItems:v13 error:error];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_items)
  {
    ...
    v15 = 0u;
    v16 = 0u;
    items = [(CCToolKitToolTypeInstanceUnion *)self items];
    ...
    [v3 setObject:v4 forKeyedSubscript:@"items"];
  }
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_items)
  {
    ...
    blockCopy = block;
    v8 = [v6 alloc];
    v9 = [v8 initWithFieldType:*MEMORY[0x1E69939A8] repeatedSubMessageValue:self->_items];
