...
- (CCAppCustomMediaAudiobookAuthorNameContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCAppCustomMediaAudiobookAuthorNameContent)initWithVocabularyString:(id)string vocabularyIdentifier:(id)identifier error:(id *)error;
...
- (CCAppCustomMediaAudiobookAuthorNameContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v11 = [[CCAppCustomMediaAudiobookAuthorNameContent alloc] initWithVocabularyString:v9 vocabularyIdentifier:v10 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    vocabularyString = [(CCAppCustomMediaAudiobookAuthorNameContent *)self vocabularyString];
    [v3 setObject:vocabularyString forKeyedSubscript:@"vocabularyString"];
  }

  if (self->_vocabularyIdentifier)
  {
    vocabularyIdentifier = [(CCAppCustomMediaAudiobookAuthorNameContent *)self vocabularyIdentifier];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  ...
  {
    return *(&off_1E73E67F0 + (identifier + 27285));
  }
}
