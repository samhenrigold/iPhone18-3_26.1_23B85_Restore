...
- (CCToolKitToolTypedValueEntityIdentifierValue)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCToolKitToolTypedValueEntityIdentifierValue)initWithType:(id)type identifier:(id)identifier displayRepresentation:(id)representation error:(id *)error;
- (NSString)identifier;
- (id)jsonDictionary;
...
LABEL_13:
      v17 = [[CCToolKitToolTypedValueEntityIdentifierValue alloc] initWithType:v9 identifier:v12 displayRepresentation:v14 error:error];
      v10 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_type)
  {
    type = [(CCToolKitToolTypedValueEntityIdentifierValue *)self type];
  ...
  if (self->_identifier)
  {
    identifier = [(CCToolKitToolTypedValueEntityIdentifierValue *)self identifier];
    [v3 setObject:identifier forKeyedSubscript:@"identifier"];
  }

  if (self->_displayRepresentation)
  {
    displayRepresentation = [(CCToolKitToolTypedValueEntityIdentifierValue *)self displayRepresentation];
      ...
      if ((v21 >> 3) != 3)
      {
        ...
        else
        {
          if (v23 == 1)
          {
            ...
            v38 = 0;
            v26 = [(CCItemMessage *)v24 initWithData:identifier error:&v38];
            v10 = v38;
            v27 = 16;
LABEL_27:
...
LABEL_28:
      ...
      identifier = CCPBReaderReadDataNoCopy();
      v37 = 0;
      v26 = [(CCItemMessage *)v29 initWithData:identifier error:&v37];
      v10 = v37;
      v27 = 32;
      goto LABEL_27;
    }
