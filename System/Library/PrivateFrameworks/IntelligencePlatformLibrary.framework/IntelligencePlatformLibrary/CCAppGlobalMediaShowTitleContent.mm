...
- (CCAppGlobalMediaShowTitleContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCAppGlobalMediaShowTitleContent)initWithVocabularyStrings:(id)strings error:(id *)error;
...
- (CCAppGlobalMediaShowTitleContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaShowTitleContent alloc] initWithVocabularyStrings:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    vocabularyStrings = [(CCAppGlobalMediaShowTitleContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_vocabularyStrings)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:36064 repeatedStringValue:self->_vocabularyStrings];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  v3 = @"AppGlobalMediaShowTitleContent_vocabularyStrings";
  if (identifier != 36064)
  {
    v3 = 0;
  }
