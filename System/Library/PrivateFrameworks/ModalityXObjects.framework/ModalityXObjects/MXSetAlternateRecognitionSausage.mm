...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = MXSetAlternateRecognitionSausage;
  v4 = [(MXSetAlternateRecognitionSausage *)&v8 description];
  dictionaryRepresentation = [(MXSetAlternateRecognitionSausage *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if ([(MXSetAlternateRecognitionSausage *)self positionalTokPhraseAltsCount])
  {
    ...
    positionalTokPhraseAltsCount = [(MXSetAlternateRecognitionSausage *)self positionalTokPhraseAltsCount];
    if (positionalTokPhraseAltsCount)
    {
      v5 = positionalTokPhraseAltsCount;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(MXSetAlternateRecognitionSausage *)self positionalTokPhraseAltAtIndex:i];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(MXSetAlternateRecognitionSausage *)self addPositionalTokPhraseAlt:*(*(&v9 + 1) + 8 * v8++), v9];
      }
