...
- (_TSF_TSDgPTPUnicastLinkLayerPtPPort)initWithService:(id)service pid:(int)pid;
...
- (_TSF_TSDgPTPUnicastLinkLayerPtPPort)initWithService:(id)service pid:(int)pid
{
  ...
  if (v4)
  {
    _destinationMACAddress = [(_TSF_TSDgPTPUnicastLinkLayerPtPPort *)v4 _destinationMACAddress];
