...
- (NSArray)arrayRepresentation
{
  ...
  v14 = 0u;
  historicalNotificationUserActions = [(CAFHistoricalNotificationUserActions *)self historicalNotificationUserActions];
  v5 = [historicalNotificationUserActions countByEnumeratingWithState:&v11 objects:v15 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v12;
    do
    {
      ...
      v6 = [historicalNotificationUserActions countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
...
void __54__CAFHistoricalNotificationUserActions_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v6 = 2114;
  v7 = a2;
  _os_log_error_impl(&dword_231618000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from HistoricalNotificationUserActions array - %{public}@", &v4, 0x16u);
}
