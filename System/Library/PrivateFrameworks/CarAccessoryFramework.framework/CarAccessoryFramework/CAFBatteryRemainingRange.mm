@interface CAFBatteryRemainingRange
+ (void)load;
- (BOOL)hasHidden;
- (BOOL)hidden;
...
@implementation CAFBatteryRemainingRange

+ (void)load
{
  v2.receiver = self;
  v2.super_class = &OBJC_METACLASS___CAFBatteryRemainingRange;
...
- (void)registerObserver:(id)observer
{
  ...
  v6.receiver = self;
  v6.super_class = CAFBatteryRemainingRange;
