...
{
  v2.receiver = self;
  v2.super_class = &OBJC_METACLASS___CAFRemainingRange;
...
- (void)registerObserver:(id)observer
{
  ...
  v6.receiver = self;
  v6.super_class = CAFRemainingRange;
...
- (BOOL)hidden
{
  hiddenCharacteristic = [(CAFRemainingRange *)self hiddenCharacteristic];
...
- (void)_characteristicDidUpdate:(id)update fromGroupUpdate:(BOOL)groupUpdate
{
  ...
  if (v11)
  {
    ...
    [characteristicType remainingRangeService:self didUpdateHidden:{-[CAFRemainingRange hidden](self, "hidden")}];
LABEL_4:
  }

  v12.receiver = self;
  v12.super_class = CAFRemainingRange;
