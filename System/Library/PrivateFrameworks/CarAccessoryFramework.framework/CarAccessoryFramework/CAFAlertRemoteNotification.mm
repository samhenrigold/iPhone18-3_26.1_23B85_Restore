...
- (void)_characteristicDidUpdate:(id)update fromGroupUpdate:(BOOL)groupUpdate
{
  ...
  if ([characteristicType isEqual:@"0x0000000030000001"])
  {
    ...
    if (v11)
    {
      ...
      userVisibleLabel = [(CAFAlertRemoteNotification *)self userVisibleLabel];
      [observers alertRemoteNotificationService:self didUpdateUserVisibleLabel:userVisibleLabel];
LABEL_25:
  ...
  if ([characteristicType2 isEqual:@"0x0000000030000005"])
  {
    ...
    {
      observers = [(CAFService *)self observers];
      userVisibleLabel = [(CAFAlertRemoteNotification *)self userVisibleDescription];
      [observers alertRemoteNotificationService:self didUpdateUserVisibleDescription:userVisibleLabel];
      goto LABEL_25;
    }
  }
  ...
  if ([characteristicType3 isEqual:@"0x0000000030000019"])
  {
    ...
    if (v23)
    {
      ...
      identifier = [(CAFAlertRemoteNotification *)self identifier];
      [observers2 alertRemoteNotificationService:self didUpdateIdentifier:identifier];
LABEL_24:

      observers = [(CAFService *)self observers];
      userVisibleLabel = [(CAFAlertRemoteNotification *)self name];
      [observers alertRemoteNotificationService:self didUpdateName:userVisibleLabel];
      goto LABEL_25;
    }
  }
  ...
  if ([characteristicType4 isEqual:@"0x0000000037000008"])
  {
    ...
    {
      observers = [(CAFService *)self observers];
      userVisibleLabel = [(CAFAlertRemoteNotification *)self symbolNameAndColor];
      [observers alertRemoteNotificationService:self didUpdateSymbolNameAndColor:userVisibleLabel];
      goto LABEL_25;
    }
  }
  ...
  if ([characteristicType5 isEqual:@"0x0000000037000007"])
  {
    ...
    {
      observers2 = [(CAFService *)self observers];
      identifier = [(CAFAlertRemoteNotification *)self displayPanelIdentifier];
      [observers2 alertRemoteNotificationService:self didUpdateDisplayPanelIdentifier:identifier];
      goto LABEL_24;
    }
  }
  ...
  if ([characteristicType6 isEqual:@"0x000000003700000B"])
  {
    ...
    {
      observers2 = [(CAFService *)self observers];
      identifier = [(CAFAlertRemoteNotification *)self displayZoneIdentifier];
      [observers2 alertRemoteNotificationService:self didUpdateDisplayZoneIdentifier:identifier];
      goto LABEL_24;
    }
  }
  ...
  if ([characteristicType7 isEqual:@"0x0000000037000002"])
  {
    uniqueIdentifier13 = [updateCopy uniqueIdentifier];
    notificationUserActionsCharacteristic = [(CAFAlertRemoteNotification *)self notificationUserActionsCharacteristic];
    uniqueIdentifier14 = [notificationUserActionsCharacteristic uniqueIdentifier];
    v45 = [uniqueIdentifier13 isEqual:uniqueIdentifier14];

    if (v45)
    {
      observers = [(CAFService *)self observers];
      userVisibleLabel = [(CAFAlertRemoteNotification *)self notificationUserActions];
      [observers alertRemoteNotificationService:self didUpdateNotificationUserActions:userVisibleLabel];
      goto LABEL_25;
    }
  }
  ...
  if ([characteristicType8 isEqual:@"0x0000000037000003"])
  {
    uniqueIdentifier15 = [updateCopy uniqueIdentifier];
    userActionCharacteristic = [(CAFAlertRemoteNotification *)self userActionCharacteristic];
    uniqueIdentifier16 = [userActionCharacteristic uniqueIdentifier];
    v50 = [uniqueIdentifier15 isEqual:uniqueIdentifier16];

    if (v50)
    {
      observers = [(CAFService *)self observers];
      [observers alertRemoteNotificationService:self didUpdateUserAction:{-[CAFAlertRemoteNotification userAction](self, "userAction")}];
      goto LABEL_26;
    }
  }
  ...
  if ([observers isEqual:@"0x0000000037000010"])
  {
    ...
    showsPrimaryActionHighlightCharacteristic = [(CAFAlertRemoteNotification *)self showsPrimaryActionHighlightCharacteristic];
    uniqueIdentifier18 = [showsPrimaryActionHighlightCharacteristic uniqueIdentifier];
    ...
    observers = [(CAFService *)self observers];
    [observers alertRemoteNotificationService:self didUpdateShowsPrimaryActionHighlight:{-[CAFAlertRemoteNotification showsPrimaryActionHighlight](self, "showsPrimaryActionHighlight")}];
  }
...
LABEL_27:
  v55.receiver = self;
  v55.super_class = CAFAlertRemoteNotification;
