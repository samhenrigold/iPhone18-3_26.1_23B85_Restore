  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(CPLRampingResponse *)self addResponse:*(*(&v9 + 1) + 8 * v8++), v9];
      }
...
- (void)copyTo:(id)to
{
  ...
  {
    [toCopy clearResponses];
    responsesCount = [(CPLRampingResponse *)self responsesCount];
    if (responsesCount)
    {
      v5 = responsesCount;
      for (i = 0; i != v5; ++i)
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_responses count])
  {
    ...
    [dictionary setObject:v4 forKey:@"response"];
  }
...
- (id)description
{
  ...
  dictionaryRepresentation = [(CPLRampingResponse *)self dictionaryRepresentation];
...
- (void)addResponse:(id)response
{
  ...
  [(NSMutableArray *)responses addObject:responseCopy];
}
