...
- (id)getDeviceActive:(id)active
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      v10 = 138412290;
      v11 = identifier;
      _os_log_impl(&dword_243BE5000, v7, OS_LOG_TYPE_INFO, "Device {%@} has SMS Forwarding enabled.", &v10, 0xCu);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      v10 = 138412290;
      v11 = identifier;
      _os_log_impl(&dword_243BE5000, v7, OS_LOG_TYPE_INFO, "Device {%@} has SMS Forwarding disabled.", &v10, 0xCu);
    }
  }
...
- (void)setDeviceActive:(id)active specifier:(id)specifier
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138412290;
      v19 = v10;
      _os_log_impl(&dword_243BE5000, v9, OS_LOG_TYPE_INFO, "Has smsAccount? {%@}", &v18, 0xCu);
    }
  }
  ...
  if (bOOLValue)
  {
    if (v12)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138412290;
        v19 = identifier;
        _os_log_impl(&dword_243BE5000, v13, OS_LOG_TYPE_INFO, "Enrolling device in SMS relay. specifier_identifier={%@}", &v18, 0xCu);
      }
    }
  ...
  else
  {
    if (v12)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 138412290;
        v19 = identifier3;
        _os_log_impl(&dword_243BE5000, v16, OS_LOG_TYPE_INFO, "Unenrolling device in SMS relay. specifier_identifier={%@}", &v18, 0xCu);
      }
    }
