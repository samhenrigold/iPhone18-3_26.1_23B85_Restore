...
- (_BlastDoorLPVideoMetadata)initWithCoder:(id)coder;
...
- (_BlastDoorLPVideoMetadata)init
{
  ...
  v6.receiver = self;
  v6.super_class = _BlastDoorLPVideoMetadata;
...
- (_BlastDoorLPVideoMetadata)initWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  v16.receiver = self;
  v16.super_class = _BlastDoorLPVideoMetadata;
...
- (BOOL)isEqual:(id)equal
{
  ...
  equalCopy = equal;
  v13.receiver = self;
  v13.super_class = _BlastDoorLPVideoMetadata;
  if ([(_BlastDoorLPVideoMetadata *)&v13 isEqual:equalCopy])
  {
    v5 = 1;
  }
