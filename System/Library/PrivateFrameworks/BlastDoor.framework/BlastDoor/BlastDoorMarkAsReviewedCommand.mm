...
- (BlastDoorMetadata)metadata
{
  ...
  sub_213FB568C(self + OBJC_IVAR___BlastDoorMarkAsReviewedCommand_markAsReviewedCommand, v5, type metadata accessor for Metadata);
  ...
  v10.receiver = v7;
  v10.super_class = v6;
  v8 = [(BlastDoorMarkAsReviewedCommand *)&v10 init];
