...
- (int64_t)performActionWithManagedObjectContext:(id)context error:(id *)error
{
  ...
  v57[1] = 3221225472;
  v57[2] = __106__PLModelMigrationAction_setInitialIsDetectedScreenshotValue_performActionWithManagedObjectContext_error___block_invoke;
  v57[3] = &unk_1E7575B30;
  v20 = v8;
  v58 = v20;
  v56[0] = MEMORY[0x1E69E9820];
  v56[1] = 3221225472;
  v56[2] = __106__PLModelMigrationAction_setInitialIsDetectedScreenshotValue_performActionWithManagedObjectContext_error___block_invoke_2;
  v56[3] = &unk_1E7572E50;
  v56[4] = self;
  v56[5] = v63;
  v55[0] = MEMORY[0x1E69E9820];
  v55[1] = 3221225472;
  v55[2] = __106__PLModelMigrationAction_setInitialIsDetectedScreenshotValue_performActionWithManagedObjectContext_error___block_invoke_3;
  v55[3] = &unk_1E756DD18;
  v55[4] = self;
  v55[5] = &v65;
  v55[6] = &v71;
  ...
  if (v23)
  {
    ...
    if (!v27)
    {
      ...
      v75 = 134217984;
      v76 = v30;
      v31 = _os_log_send_and_compose_impl(v29, 0, buf, 512, &dword_19BF1F000, v28, 0, "Set initial isDetectedScreenshot for %tu assets.", &v75);

      logger2 = [(PLModelMigrationActionBackground *)self logger];
      [logger2 logWithMessage:v31 fromCodeLocation:"PLModelMigrationActionBackground.m" type:{880, 0}];
...
LABEL_21:
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 134217984;
      *&buf[4] = v46;
      _os_log_impl(&dword_19BF1F000, v45, OS_LOG_TYPE_DEFAULT, "Set initial isDetectedScreenshot for %tu assets.", buf, 0xCu);
    }
...
LABEL_27:
  ...
  [logger4 logWithMessage:v43 fromCodeLocation:"PLModelMigrationActionBackground.m" type:{883, 16}];
