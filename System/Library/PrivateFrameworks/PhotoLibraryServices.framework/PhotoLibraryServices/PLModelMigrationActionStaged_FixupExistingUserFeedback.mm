...
- (int64_t)performActionWithManagedObjectContext:(id)context error:(id *)error
{
  ...
  if (v12)
  {
    ...
    v46[1] = 3221225472;
    v46[2] = __102__PLModelMigrationActionStaged_FixupExistingUserFeedback_performActionWithManagedObjectContext_error___block_invoke;
    v46[3] = &unk_1E756FF90;
    v46[4] = self;
    v48 = &v55;
    v49 = &v51;
      ...
      if (!v56[5])
      {
        ...
        if (v17)
        {
          ...
          else
          {
            ...
            [logger2 logWithMessage:v23 fromCodeLocation:"PLModelMigrationActionStaged.m" type:{93, 16}];
  ...
  else
  {
    ...
    if (v26)
    {
      ...
      else
      {
        ...
        [logger4 logWithMessage:v34 fromCodeLocation:"PLModelMigrationActionStaged.m" type:{97, 16}];
