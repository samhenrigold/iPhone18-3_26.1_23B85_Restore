...
- (int64_t)performActionWithManagedObjectContext:(id)context error:(id *)error
{
  ...
  v52 = &v51;
  v53 = 0x3032000000;
  v54 = __Block_byref_object_copy__53337;
  v55 = __Block_byref_object_dispose__53338;
  v56 = 0;
  ...
  if (v12)
  {
    ...
    v46[1] = 3221225472;
    v46[2] = __105__PLModelMigrationAction_MigrateProResPackedBadgeAttributes_performActionWithManagedObjectContext_error___block_invoke;
    v46[3] = &unk_1E756DBE0;
    v46[4] = self;
    v48 = &v51;
    v49 = &v57;
      ...
      if (!v52[5])
      {
        ...
        if (v17)
        {
          ...
          else
          {
            ...
            [logger2 logWithMessage:v23 fromCodeLocation:"PLModelMigrationActions_15000.m" type:{422, 16}];
  ...
  else
  {
    ...
    if (v26)
    {
      ...
      else
      {
        ...
        [logger4 logWithMessage:v34 fromCodeLocation:"PLModelMigrationActions_15000.m" type:{426, 16}];
