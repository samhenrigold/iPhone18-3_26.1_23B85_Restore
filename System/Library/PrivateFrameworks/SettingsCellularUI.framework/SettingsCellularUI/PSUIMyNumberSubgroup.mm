...
- (PSUIMyNumberSubgroup)initWithListController:(id)controller groupSpecifier:(id)specifier;
- (PSUIMyNumberSubgroup)initWithListController:(id)controller groupSpecifier:(id)specifier parentSpecifier:(id)parentSpecifier;
- (id)specifiers;
@end
...
- (PSUIMyNumberSubgroup)initWithListController:(id)controller groupSpecifier:(id)specifier parentSpecifier:(id)parentSpecifier
{
  ...
  v12.receiver = self;
  v12.super_class = PSUIMyNumberSubgroup;
