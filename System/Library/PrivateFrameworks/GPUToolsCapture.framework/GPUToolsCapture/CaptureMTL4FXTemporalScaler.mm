...
- (void)dealloc
{
  ...
  *(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = CaptureMTL4FXTemporalScaler;
  [(CaptureMTL4FXTemporalScaler *)&v12 dealloc];
}
...
- (void)setReset:(BOOL)reset
{
  ...
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setReset:resetCopy];
  v5 = v15;
  *(v15 + 8) = -20353;
  v6 = BYTE9(v16);
...
- (void)setPreExposure:(float)exposure
{
  ...
  *&v5 = exposure;
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setPreExposure:v5];
  v6 = v16;
  *(v16 + 8) = -20355;
  v7 = BYTE9(v17);
...
- (void)setMotionVectorScaleY:(float)y
{
  ...
  GTTraceContext_pushEncoderWithStream(self->_traceContext, &v15);
  *&v5 = y;
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setMotionVectorScaleY:v5];
  v6 = v16;
  *(v16 + 8) = -20358;
  v7 = BYTE9(v17);
  if (BYTE9(v17) > 0x30uLL)
...
- (void)setMotionVectorScaleX:(float)x
{
  ...
  GTTraceContext_pushEncoderWithStream(self->_traceContext, &v15);
  *&v5 = x;
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setMotionVectorScaleX:v5];
  v6 = v16;
  *(v16 + 8) = -20359;
  v7 = BYTE9(v17);
  if (BYTE9(v17) > 0x30uLL)
...
- (void)setJitterOffsetY:(float)y
{
  ...
  GTTraceContext_pushEncoderWithStream(self->_traceContext, &v15);
  *&v5 = y;
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setJitterOffsetY:v5];
  v6 = v16;
  *(v16 + 8) = -20361;
  v7 = BYTE9(v17);
  if (BYTE9(v17) > 0x30uLL)
...
- (void)setJitterOffsetX:(float)x
{
  ...
  GTTraceContext_pushEncoderWithStream(self->_traceContext, &v15);
  *&v5 = x;
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setJitterOffsetX:v5];
  v6 = v16;
  *(v16 + 8) = -20362;
  v7 = BYTE9(v17);
  if (BYTE9(v17) > 0x30uLL)
...
- (void)setDepthReversed:(BOOL)reversed
{
  ...
  v14 = 0u;
  GTTraceContext_pushEncoderWithStream(self->_traceContext, &v14);
  [(MTL4FXTemporalScalerSPI *)self->_baseObject setDepthReversed:reversedCopy];
  v5 = v15;
  *(v15 + 8) = -20368;
  v6 = BYTE9(v16);
  if (BYTE9(v16) > 0x30uLL)
