...
- (CaptureMTLDepthStencilState)initWithBaseObject:(id)object captureDevice:(id)device;
...
- (void)dealloc
{
  ...
  *(v3 + 13) = v4;
  traceStream = [(CaptureMTLDepthStencilState *)self traceStream];
  if (traceStream)
  {
  ...
  *(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = CaptureMTLDepthStencilState;
...
- (BOOL)conformsToProtocol:(id)protocol
{
  ...
  v5 = [(MTLDepthStencilStateSPI *)baseObject conformsToProtocol:protocolCopy];
