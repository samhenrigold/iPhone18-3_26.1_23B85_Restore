...
- (void)dealloc
{
  ...
  *(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = CaptureMTLEvent;
...
{
  v7.receiver = self;
  v7.super_class = CaptureMTLEvent;
  v3 = [(CaptureMTLEvent *)&v7 description];
  v4 = [(MTLEvent *)self->_baseObject description];
...
- (void)setEnableBarrier:(BOOL)barrier
{
  ...
  [(MTLEvent *)self->_baseObject setEnableBarrier:barrierCopy];
  v5 = v15;
  *(v15 + 8) = -15325;
  v6 = BYTE9(v16);
