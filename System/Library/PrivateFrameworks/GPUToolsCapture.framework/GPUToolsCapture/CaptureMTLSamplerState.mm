...
- (void)dealloc
{
  ...
  *(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = CaptureMTLSamplerState;
...
{
  v7.receiver = self;
  v7.super_class = CaptureMTLSamplerState;
  v3 = [(CaptureMTLSamplerState *)&v7 description];
  v4 = [(MTLSamplerStateSPI *)self->_baseObject description];
