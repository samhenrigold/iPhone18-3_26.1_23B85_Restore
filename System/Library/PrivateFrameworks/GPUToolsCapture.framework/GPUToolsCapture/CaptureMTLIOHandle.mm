...
- (CaptureMTLIOHandle)initWithBaseObject:(id)object captureContext:(GTTraceContext *)context;
...
- (void)dealloc
{
  ...
  *(v3 + 13) = v4;
  traceStream = [(CaptureMTLIOHandle *)self traceStream];
  if (traceStream)
  {
  ...
  *(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = CaptureMTLIOHandle;
...
- (BOOL)conformsToProtocol:(id)protocol
{
  ...
  v5 = [(MTLIOHandleSPI *)baseObject conformsToProtocol:protocolCopy];
...
{
  v7.receiver = self;
  v7.super_class = CaptureMTLIOHandle;
  v3 = [(CaptureMTLIOHandle *)&v7 description];
  v4 = [(MTLIOHandleSPI *)self->_baseObject description];
...
- (void)setLabel:(id)label
{
  ...
  [(MTLIOHandleSPI *)self->_baseObject setLabel:labelCopy];
  v5 = v18;
  *(v18 + 8) = -15305;
  v6 = BYTE9(v19);
...
- (CaptureMTLIOHandle)initWithBaseObject:(id)object captureContext:(GTTraceContext *)context
{
  ...
  v12.receiver = self;
  v12.super_class = CaptureMTLIOHandle;
  v8 = [(CaptureMTLIOHandle *)&v12 init];
  v9 = v8;
  if (v8)
  {
