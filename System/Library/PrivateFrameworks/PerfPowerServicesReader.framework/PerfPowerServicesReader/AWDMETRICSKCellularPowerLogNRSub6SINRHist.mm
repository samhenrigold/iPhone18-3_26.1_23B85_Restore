...
LABEL_14:
  ...
  v16 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:{self->_durationMs, v17}];
  [dictionary setObject:v16 forKey:@"duration_ms"];

  if ((*&self->_has & 8) != 0)
  {
LABEL_15:
    v13 = [MEMORY[0x277CCABB0] numberWithBool:{self->_isDataPreferred, v17}];
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        [(AWDMETRICSKCellularPowerLogNRSub6SINRHist *)self addBin:*(*(&v12 + 1) + 8 * i), v12];
      }
