...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  {
    [v10 clearBins];
    binsCount = [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self binsCount];
    if (binsCount)
    {
      v6 = binsCount;
      for (i = 0; i != v6; ++i)
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self addBin:*(*(&v12 + 1) + 8 * i), v12];
      }
