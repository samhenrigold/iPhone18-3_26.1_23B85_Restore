...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSMBin;
  v4 = [(AWDMETRICSMBin *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSMBin *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:self->_binId];
    [dictionary setObject:v5 forKey:@"bin_id"];
