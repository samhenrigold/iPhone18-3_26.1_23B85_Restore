...
{
  idCopy = id;
  if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_0"])
  {
    v4 = 0;
  }

  else if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_1"])
  {
    v4 = 1;
  }

  else if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_2"])
  {
    v4 = 2;
  }

  else if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_3"])
  {
    v4 = 3;
  }

  else if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_4"])
  {
    v4 = 4;
  }

  else if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_5"])
  {
    v4 = 5;
  }

  else if ([idCopy isEqualToString:@"VDD_CPU_PERFSTATE_END"])
  {
    v4 = 6;
  }
...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogCpuPerfLevelsMBin *)self dictionaryRepresentation];
