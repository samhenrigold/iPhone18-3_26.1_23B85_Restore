...
- (_SSBDatabaseUpdateFetchDataSessionHandler)initWithCompletionHandler:(void *)handler provider:(int)provider
{
  ...
  v16.receiver = self;
  v16.super_class = _SSBDatabaseUpdateFetchDataSessionHandler;
  v6 = [(_SSBDatabaseUpdateFetchDataSessionHandler *)&v16 init];
  if (v6)
  {
    ...
    *(v6 + 1) = *from;
    ...
    std::__function::__value_func<void ()(std::optional<Backend::Google::FetchThreatListUpdatesResponse> &&,NSError *)>::__value_func[abi:sn200100](v19, handler);
    ...
    *v9 = &unk_2838CE058;
    ...
    v24 = v9;
    Backend::Google::FetchThreatListUpdatesResponseParser::FetchThreatListUpdatesResponseParser(v8, &v17, v23);
    std::__function::__value_func<void ()(std::optional<Backend::Google::FetchThreatListUpdatesResponse> &&)>::~__value_func[abi:sn200100](v23);
    ...
    *(v6 + 1) = v8;
    ...
    std::__function::__value_func<void ()(std::optional<Backend::Google::FetchThreatListUpdatesResponse> &&,NSError *)>::~__value_func[abi:sn200100](v19);
    objc_destroyWeak(&to);
    if (*(&v14 + 1))
    {
