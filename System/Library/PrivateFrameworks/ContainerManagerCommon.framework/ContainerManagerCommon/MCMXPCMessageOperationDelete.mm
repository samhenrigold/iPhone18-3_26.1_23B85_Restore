...
- (MCMXPCMessageOperationDelete)initWithXPCObject:(id)object context:(id)context error:(unint64_t *)error
{
  ...
  objectCopy = object;
  v11.receiver = self;
  v11.super_class = MCMXPCMessageOperationDelete;
  v9 = [(MCMXPCMessageWithConcreteContainersArrayBase *)&v11 initWithXPCObject:objectCopy context:context error:error];
  if (v9)
  {
