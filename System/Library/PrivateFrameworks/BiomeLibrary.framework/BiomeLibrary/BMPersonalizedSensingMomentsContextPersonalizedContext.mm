...
- (id)_contextsJSONArray
{
  ...
  v14 = 0u;
  contexts = [(BMPersonalizedSensingMomentsContextPersonalizedContext *)self contexts];
  v5 = [contexts countByEnumeratingWithState:&v11 objects:v15 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v12;
    do
    {
      ...
      v6 = [contexts countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
...
- (BMPersonalizedSensingMomentsContextPersonalizedContext)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    v9 = v7;
    v60 = 0;
    v8 = [[BMPersonalizedSensingMomentsContextContextFetchDetails alloc] initWithJSONDictionary:v9 error:&v60];
    v14 = v60;
    if (v14)
    {
      if (error)
...
LABEL_37:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    if (error)
    {
      ...
      v69 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"fetchOptions"];
      v10 = v69;
  ...
  v11 = v9;
  v59 = 0;
  v10 = [[BMPersonalizedSensingMomentsContextMomentsContextFetchOptions alloc] initWithJSONDictionary:v11 error:&v59];
  v26 = v59;
  if (v26)
  {
    if (error)
    ...
    for (i = 0; i != v17; ++i)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (errorCopy4)
        {
          ...
          v21 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type null for element of %@, must not be null", @"contexts"];
          v64 = v21;
...
LABEL_47:
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        if (errorCopy4)
        {
          ...
          v21 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"contexts"];
          v62 = v21;
          v35 = MEMORY[0x1E695DF20];
          v36 = &v62;
          v37 = &v61;
      ...
      v21 = v20;
      v22 = [BMPersonalizedSensingMomentsContextMomentsContext alloc];
      v54 = 0;
      v23 = [(BMPersonalizedSensingMomentsContextMomentsContext *)v22 initWithJSONDictionary:v21 error:&v54];
      v24 = v54;
      if (v24)
      {
        v38 = v24;
...
LABEL_27:
  ...
  v10 = v50;
  v8 = v48;
  self = [(BMPersonalizedSensingMomentsContextPersonalizedContext *)selfCopy2 initWithFetchDetails:v48 fetchOptions:v50 contexts:v15];
  selfCopy3 = self;
  dictionaryCopy = v49;
LABEL_48:
...
id __65__BMPersonalizedSensingMomentsContextPersonalizedContext_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 _contextsJSONArray];
  v5 = BMConvertObjectToJSONString();

  return v5;
}

id __65__BMPersonalizedSensingMomentsContextPersonalizedContext_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 fetchOptions];
...
id __65__BMPersonalizedSensingMomentsContextPersonalizedContext_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 fetchDetails];
  v5 = [v4 jsonDictionary];
