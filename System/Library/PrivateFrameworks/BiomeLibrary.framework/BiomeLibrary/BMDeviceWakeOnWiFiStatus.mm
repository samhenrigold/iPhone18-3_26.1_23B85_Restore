...
+ (id)protoFields;
- (BMDeviceWakeOnWiFiStatus)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMDeviceWakeOnWiFiStatus)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceWakeOnWiFiStatus hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceWakeOnWiFiStatus hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMDeviceWakeOnWiFiStatus *)self starting];
...
- (BMDeviceWakeOnWiFiStatus)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMDeviceWakeOnWiFiStatus *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
