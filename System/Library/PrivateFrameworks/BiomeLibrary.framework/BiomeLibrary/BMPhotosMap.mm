...
+ (id)protoFields;
- (BMPhotosMap)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type;
- (BMPhotosMap)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMPhotosMap *)self identifier];
    ...
    {
      identifier3 = [(BMPhotosMap *)self identifier];
    ...
    subset = [(BMPhotosMap *)self subset];
    subset2 = [v5 subset];
    v15 = subset2;
    if (subset == subset2)
    {
    ...
    {
      subset3 = [(BMPhotosMap *)self subset];
      subset4 = [v5 subset];
...
- (id)jsonDictionary
{
  ...
  identifier = [(BMPhotosMap *)self identifier];
  subset = [(BMPhotosMap *)self subset];
  v5 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMPhotosMap type](self, "type")}];
  v11[0] = @"identifier";
  null = identifier;
  if (!identifier)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        v13 = [MEMORY[0x1E696AD98] numberWithInt:{bsearch_b(v11, BMPhotosMapTypeFromString_sortedStrings, 1uLL, 8uLL, &__block_literal_global_79429) != 0}];
      }
...
- (NSString)description
{
  ...
  identifier = [(BMPhotosMap *)self identifier];
  subset = [(BMPhotosMap *)self subset];
  v6 = BMPhotosMapTypeAsString([(BMPhotosMap *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosMap with identifier: %@, subset: %@, type: %@", identifier, subset, v6];
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMPhotosMap alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
