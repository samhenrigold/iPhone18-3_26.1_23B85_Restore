...
- (BMTextUnderstandingPoemEntity)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v9 = v7;
    v23 = 0;
    v8 = [[BMTextUnderstandingPoemEntityPerson alloc] initWithJSONDictionary:v9 error:&v23];
    v12 = v23;
    if (v12)
    {
      if (error)
...
LABEL_23:
    ...
    if (objc_opt_isKindOfClass())
    {
      v13 = v9;
      v22 = 0;
      v10 = [[BMTextUnderstandingPoemEntityTopic alloc] initWithJSONDictionary:v13 error:&v22];
      v14 = v22;
      if (!v14)
      {
...
id __40__BMTextUnderstandingPoemEntity_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
...
id __40__BMTextUnderstandingPoemEntity_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 person];
  v5 = [v4 jsonDictionary];
