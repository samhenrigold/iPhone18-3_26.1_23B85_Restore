...
+ (id)protoFields;
- (BMSafariBrowsingAssistantEligible)initWithJSONDictionary:(id)dictionary error:(id *)p_isa;
- (BMSafariBrowsingAssistantEligible)initWithWebpageViewIdentifier:(id)identifier;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    webpageViewIdentifier = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
    ...
    {
      webpageViewIdentifier3 = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
...
LABEL_14:
  ...
  v7 = 0;
LABEL_4:
  self = [(BMSafariBrowsingAssistantEligible *)self initWithWebpageViewIdentifier:v7];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v20.receiver = self;
  v20.super_class = BMSafariBrowsingAssistantEligible;
...
- (NSString)description
{
  ...
  webpageViewIdentifier = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
  v5 = [v3 initWithFormat:@"BMSafariBrowsingAssistantEligible with webpageViewIdentifier: %@", webpageViewIdentifier];
...
- (BMSafariBrowsingAssistantEligible)initWithWebpageViewIdentifier:(id)identifier
{
  ...
  v8.receiver = self;
  v8.super_class = BMSafariBrowsingAssistantEligible;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMSafariBrowsingAssistantEligible alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
