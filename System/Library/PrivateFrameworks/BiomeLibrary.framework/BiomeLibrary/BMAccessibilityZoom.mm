...
+ (id)protoFields;
- (BMAccessibilityZoom)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMAccessibilityZoom)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMAccessibilityZoom hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMAccessibilityZoom hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMAccessibilityZoom *)self starting];
...
- (BMAccessibilityZoom)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMAccessibilityZoom *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
