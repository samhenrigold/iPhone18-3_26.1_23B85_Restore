...
LABEL_13:
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = v6;
    v14 = 0;
    v7 = [[BMLifeEventActivity alloc] initWithJSONDictionary:v8 error:&v14];
    v9 = v14;
    if (!v9)
    {
...
id __43__BMLifeEventRetrospectiveActivity_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
