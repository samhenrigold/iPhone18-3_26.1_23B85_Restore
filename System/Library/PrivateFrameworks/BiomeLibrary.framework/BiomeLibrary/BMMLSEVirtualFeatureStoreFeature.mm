...
- (BMMLSEVirtualFeatureStoreFeature)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    v21 = v10;
    v59 = 0;
    v11 = [[BMMLSEVirtualFeatureStoreFeatureFeatureValue alloc] initWithJSONDictionary:v21 error:&v59];
    v22 = v59;
    if (v22)
    {
      if (error)
...
id __43__BMMLSEVirtualFeatureStoreFeature_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
