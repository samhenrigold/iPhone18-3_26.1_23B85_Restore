...
+ (id)protoFields;
- (BMGameControllerConnected)initWithIsControllerConnected:(id)connected numberOfControllersConnected:(id)controllersConnected;
- (BMGameControllerConnected)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMGameControllerConnected hasIsControllerConnected](self, "hasIsControllerConnected") || [v5 hasIsControllerConnected])
    {
      ...
      isControllerConnected = [(BMGameControllerConnected *)self isControllerConnected];
    ...
    if (-[BMGameControllerConnected hasNumberOfControllersConnected](self, "hasNumberOfControllersConnected") && [v5 hasNumberOfControllersConnected])
    {
      numberOfControllersConnected = [(BMGameControllerConnected *)self numberOfControllersConnected];
...
- (BMGameControllerConnected)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  v7 = [dictionaryCopy objectForKeyedSubscript:@"isControllerConnected"];
  ...
  v9 = [dictionaryCopy objectForKeyedSubscript:@"numberOfControllersConnected"];
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (error)
      {
        ...
        v18 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"numberOfControllersConnected"];
        v21 = v18;
...
- (BMGameControllerConnected)initWithIsControllerConnected:(id)connected numberOfControllersConnected:(id)controllersConnected
{
  ...
  controllersConnectedCopy = controllersConnected;
  v11.receiver = self;
  ...
  if (v8)
  {
    ...
    if (connectedCopy)
    {
      ...
      v8->_isControllerConnected = [connectedCopy BOOLValue];
    }
    ...
    if (controllersConnectedCopy)
    {
      v8->_hasNumberOfControllersConnected = 1;
      intValue = [controllersConnectedCopy intValue];
    }
    ...
    v8->_numberOfControllersConnected = intValue;
  }
