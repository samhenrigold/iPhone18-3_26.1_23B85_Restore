...
+ (id)protoFields;
- (BMPhotosFavorite)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type;
- (BMPhotosFavorite)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMPhotosFavorite *)self identifier];
    ...
    {
      identifier3 = [(BMPhotosFavorite *)self identifier];
    ...
    subset = [(BMPhotosFavorite *)self subset];
    subset2 = [v5 subset];
    v15 = subset2;
    if (subset == subset2)
    {
    ...
    {
      subset3 = [(BMPhotosFavorite *)self subset];
      subset4 = [v5 subset];
...
LABEL_12:
    ...
    type = [(BMPhotosFavorite *)self type];
    v12 = type == [v5 type];
    goto LABEL_12;
  }
...
- (id)jsonDictionary
{
  ...
  identifier = [(BMPhotosFavorite *)self identifier];
  subset = [(BMPhotosFavorite *)self subset];
  v5 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMPhotosFavorite type](self, "type")}];
  v11[0] = @"identifier";
  null = identifier;
  if (!identifier)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        v13 = [MEMORY[0x1E696AD98] numberWithInt:BMPhotosFavoriteTypeFromString(v11)];
      }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v29.receiver = self;
  v29.super_class = BMPhotosFavorite;
...
- (NSString)description
{
  ...
  identifier = [(BMPhotosFavorite *)self identifier];
  subset = [(BMPhotosFavorite *)self subset];
  v6 = BMPhotosFavoriteTypeAsString([(BMPhotosFavorite *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosFavorite with identifier: %@, subset: %@, type: %@", identifier, subset, v6];
...
- (BMPhotosFavorite)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type
{
  ...
  subsetCopy = subset;
  v13.receiver = self;
  v13.super_class = BMPhotosFavorite;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMPhotosFavorite alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
