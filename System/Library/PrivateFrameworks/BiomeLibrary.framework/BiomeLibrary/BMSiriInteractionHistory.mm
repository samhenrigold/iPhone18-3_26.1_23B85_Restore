...
+ (id)protoFields;
- (BMSiriInteractionHistory)initWithInteraction:(id)interaction entities:(id)entities;
- (BMSiriInteractionHistory)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (NSString)identifier
{
  ...
  interaction = [(BMSiriInteractionHistory *)self interaction];
  if (interaction)
  {
    interaction2 = [(BMSiriInteractionHistory *)self interaction];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      interaction3 = [(BMSiriInteractionHistory *)self interaction];
...
LABEL_11:
    ...
    entities = [(BMSiriInteractionHistory *)self entities];
    ...
    {
      entities3 = [(BMSiriInteractionHistory *)self entities];
...
- (id)jsonDictionary
{
  ...
  _entitiesJSONArray = [(BMSiriInteractionHistory *)self _entitiesJSONArray];
  v10[0] = @"interaction";
  null = jsonDictionary;
  if (!jsonDictionary)
  {
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (error)
      {
        ...
        v56[0] = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"interaction"];
        v8 = v56[0];
...
LABEL_19:
  ...
  v8 = v39;
  self = [(BMSiriInteractionHistory *)self initWithInteraction:v39 entities:v12];
  selfCopy2 = self;
  v7 = v40;
  dictionaryCopy = v41;
LABEL_36:
...
- (NSString)description
{
  ...
  interaction = [(BMSiriInteractionHistory *)self interaction];
  entities = [(BMSiriInteractionHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriInteractionHistory with interaction: %@, entities: %@", interaction, entities];
...
id __35__BMSiriInteractionHistory_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
...
id __35__BMSiriInteractionHistory_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 interaction];
