...
LABEL_4:
    ...
    if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (error)
        {
          ...
          v25 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"subtype"];
          v33 = v25;
    ...
    error = v30;
    v15 = [(BMProcessCrashException *)selfCopy initWithCodes:v8 type:v30 signal:v12 subtype:v14];
    selfCopy = v15;
LABEL_14:
...
LABEL_15:
  ...
  v19 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"codes"];
  v39[0] = v19;
