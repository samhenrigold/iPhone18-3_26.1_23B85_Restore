...
+ (id)protoFields;
- (BMSiriHomeHistory)initWithInteraction:(id)interaction entities:(id)entities;
- (BMSiriHomeHistory)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    interaction = [(BMSiriHomeHistory *)self interaction];
    ...
    {
      interaction3 = [(BMSiriHomeHistory *)self interaction];
...
LABEL_11:
    ...
    entities = [(BMSiriHomeHistory *)self entities];
    ...
    {
      entities3 = [(BMSiriHomeHistory *)self entities];
...
- (id)jsonDictionary
{
  ...
  _entitiesJSONArray = [(BMSiriHomeHistory *)self _entitiesJSONArray];
  v10[0] = @"interaction";
  null = jsonDictionary;
  if (!jsonDictionary)
  {
...
LABEL_19:
  ...
  v8 = v39;
  self = [(BMSiriHomeHistory *)self initWithInteraction:v39 entities:v12];
  selfCopy2 = self;
  v7 = v40;
  dictionaryCopy = v41;
LABEL_36:
...
- (NSString)description
{
  ...
  interaction = [(BMSiriHomeHistory *)self interaction];
  entities = [(BMSiriHomeHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriHomeHistory with interaction: %@, entities: %@", interaction, entities];
...
id __28__BMSiriHomeHistory_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
...
id __28__BMSiriHomeHistory_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 interaction];
