...
LABEL_45:
    ...
    if (!v14 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      v15 = 0;
LABEL_16:
      v16 = [(BMWalletPaymentsCommerceClassicOrderShippingRecipient *)selfCopy initWithGivenName:v38 familyName:v40 phoneNumber:v36 emailAddress:v13 address:v15];
      selfCopy = v16;
LABEL_41:
...
LABEL_43:
    ...
    if (objc_opt_isKindOfClass())
    {
      v17 = v14;
      v41 = 0;
      v15 = [[BMWalletPaymentsCommerceClassicOrderAddress alloc] initWithJSONDictionary:v17 error:&v41];
      v18 = v41;
      if (!v18)
      {
  ...
  v40 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"givenName"];
  v51[0] = v40;
...
id __64__BMWalletPaymentsCommerceClassicOrderShippingRecipient_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
