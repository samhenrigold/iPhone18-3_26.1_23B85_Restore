...
+ (id)protoFields;
- (BMOasisAnalyticsRelocalizationSucceededEvent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMOasisAnalyticsRelocalizationSucceededEvent)initWithQualityTrace:(id)trace metadata:(id)metadata payload:(id)payload;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    qualityTrace = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self qualityTrace];
    ...
    {
      qualityTrace3 = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self qualityTrace];
    ...
    metadata = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self metadata];
    ...
    {
      metadata3 = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self metadata];
...
LABEL_15:
    ...
    payload = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self payload];
    payload2 = [v5 payload];
    if (payload == payload2)
    {
      v12 = 1;
    ...
    {
      payload3 = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self payload];
      payload4 = [v5 payload];
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v26 = 0;
        v12 = [[BMOasisAnalyticsRelocalizationSucceededType alloc] initWithJSONDictionary:v16 error:&v26];
        v17 = v26;
        if (!v17)
        {
...
- (void)writeTo:(id)to
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMOasisAnalyticsRelocalizationSucceededType *)self->_payload writeTo:toCopy];
    PBDataWriterRecallMark();
  }
}
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v22.receiver = self;
  v22.super_class = BMOasisAnalyticsRelocalizationSucceededEvent;
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsRelocalizationSucceededType alloc] initByReadFrom:fromCopy];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  metadata = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self metadata];
  payload = [(BMOasisAnalyticsRelocalizationSucceededEvent *)self payload];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsRelocalizationSucceededEvent with qualityTrace: %@, metadata: %@, payload: %@", qualityTrace, metadata, payload];
...
- (BMOasisAnalyticsRelocalizationSucceededEvent)initWithQualityTrace:(id)trace metadata:(id)metadata payload:(id)payload
{
  ...
  payloadCopy = payload;
  v14.receiver = self;
  v14.super_class = BMOasisAnalyticsRelocalizationSucceededEvent;
...
{
  v7[3] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"qualityTrace_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_733_96425];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"metadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_735];
  v4 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"payload_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_737];
  v7[0] = v3;
  v7[1] = v4;
  v7[2] = v2;
  v5 = [MEMORY[0x1E695DEC8] arrayWithObjects:v7 count:3];
...
id __55__BMOasisAnalyticsRelocalizationSucceededEvent_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __55__BMOasisAnalyticsRelocalizationSucceededEvent_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 metadata];
  v5 = [v4 jsonDictionary];
...
id __55__BMOasisAnalyticsRelocalizationSucceededEvent_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 qualityTrace];
  v5 = [v4 jsonDictionary];
