@interface BMWalletPaymentsCommerceTrackedOrderShippingRecipient
+ (id)columns;
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version;
+ (id)protoFields;
- (BMWalletPaymentsCommerceTrackedOrderShippingRecipient)initWithFullName:(id)name phoneNumber:(id)number emailAddress:(id)address address:(id)a6 givenName:(id)givenName familyName:(id)familyName;
- (BMWalletPaymentsCommerceTrackedOrderShippingRecipient)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
@implementation BMWalletPaymentsCommerceTrackedOrderShippingRecipient
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    fullName = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self fullName];
    ...
    {
      fullName3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self fullName];
    ...
    phoneNumber = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self phoneNumber];
    ...
    {
      phoneNumber3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self phoneNumber];
    ...
    emailAddress = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self emailAddress];
    ...
    {
      emailAddress3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self emailAddress];
    ...
    address = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self address];
    address2 = [v5 address];
    v27 = address2;
    if (address == address2)
    {
    ...
    {
      address3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self address];
      address4 = [v5 address];
    ...
    givenName = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
    ...
    {
      givenName3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
...
LABEL_22:
    ...
    familyName = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
    ...
    {
      familyName3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
...
LABEL_54:
      ...
      v17 = v12;
      v57 = 0;
      v18 = [[BMWalletPaymentsCommerceTrackedOrderAddress alloc] initWithJSONDictionary:v17 error:&v57];
      v19 = v57;
      if (v19)
      {
        if (error)
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      error = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)selfCopy initWithFullName:v52 phoneNumber:v55 emailAddress:v11 address:v51 givenName:v14 familyName:error];
      selfCopy = v16;
LABEL_49:
...
{
  v3 = objc_opt_new();
  [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self writeTo:v3];
...
- (void)writeTo:(id)to
{
  ...
  if (self->_address)
  {
    ...
    [(BMWalletPaymentsCommerceTrackedOrderAddress *)self->_address writeTo:toCopy];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v24.receiver = self;
  v24.super_class = BMWalletPaymentsCommerceTrackedOrderShippingRecipient;
...
LABEL_31:
      ...
      v18 = [[BMWalletPaymentsCommerceTrackedOrderAddress alloc] initByReadFrom:fromCopy];
      if (!v18)
      {
        goto LABEL_38;
      }
...
- (NSString)description
{
  ...
  givenName = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
  familyName = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
  v10 = [v3 initWithFormat:@"BMWalletPaymentsCommerceTrackedOrderShippingRecipient with fullName: %@, phoneNumber: %@, emailAddress: %@, address: %@, givenName: %@, familyName: %@", fullName, phoneNumber, emailAddress, address, givenName, familyName];
...
- (BMWalletPaymentsCommerceTrackedOrderShippingRecipient)initWithFullName:(id)name phoneNumber:(id)number emailAddress:(id)address address:(id)a6 givenName:(id)givenName familyName:(id)familyName
{
  ...
  v23.receiver = self;
  v23.super_class = BMWalletPaymentsCommerceTrackedOrderShippingRecipient;
...
+ (id)columns
{
  ...
  v5 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"address_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_323];
...
id __64__BMWalletPaymentsCommerceTrackedOrderShippingRecipient_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMWalletPaymentsCommerceTrackedOrderShippingRecipient alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
