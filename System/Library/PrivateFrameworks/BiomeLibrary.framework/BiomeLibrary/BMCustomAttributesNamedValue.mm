...
LABEL_7:
  ...
  if (objc_opt_isKindOfClass())
  {
    v13 = v9;
    v21 = 0;
    v10 = [[BMCustomAttributesBasicValue alloc] initWithJSONDictionary:v13 error:&v21];
    v14 = v21;
    if (v14)
    {
      if (error)
...
id __39__BMCustomAttributesNamedValue_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
