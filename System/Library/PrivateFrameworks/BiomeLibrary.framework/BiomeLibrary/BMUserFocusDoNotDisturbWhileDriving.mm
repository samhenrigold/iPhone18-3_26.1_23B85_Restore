...
+ (id)protoFields;
- (BMUserFocusDoNotDisturbWhileDriving)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMUserFocusDoNotDisturbWhileDriving)initWithStarting:(id)starting reason:(int)reason;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      reason = [(BMUserFocusDoNotDisturbWhileDriving *)self reason];
      v7 = reason == [v5 reason];
    }
