...
- (id)jsonDictionary
{
  ...
  v15[2] = null3;
  v14[3] = @"applePayTransactionIdentifier";
...
LABEL_10:
      ...
      if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          if (error)
          {
            ...
            v26 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"applePayTransactionIdentifier"];
            v35 = v26;
      ...
      error = v31;
      v15 = [(BMWalletPaymentsCommerceClassicOrderTransaction *)selfCopy initWithAmount:v8 currencyCode:v31 paymentMethod:v12 applePayTransactionIdentifier:v14];
      selfCopy = v15;
LABEL_14:
...
LABEL_34:
    ...
    if (objc_opt_isKindOfClass())
    {
      v16 = v10;
      v33 = 0;
      v12 = [[BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod alloc] initWithJSONDictionary:v16 error:&v33];
      v17 = v33;
      if (!v17)
      {
...
id __58__BMWalletPaymentsCommerceClassicOrderTransaction_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
