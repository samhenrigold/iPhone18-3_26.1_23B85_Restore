...
+ (id)protoFields;
- (BMAppIntentInvocationValueTypeArrayCapabilities)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMAppIntentInvocationValueTypeArrayCapabilities)initWithValue:(int)value;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    value = [(BMAppIntentInvocationValueTypeArrayCapabilities *)self value];
    value2 = [v5 value];
...
- (BMAppIntentInvocationValueTypeArrayCapabilities)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_9:
    self = -[BMAppIntentInvocationValueTypeArrayCapabilities initWithValue:](self, "initWithValue:", [error intValue]);
    selfCopy = self;
    goto LABEL_10;
  }
...
LABEL_8:
  ...
  if (error)
  {
    ...
    v12 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber (corresponding to enum value), or NSString (string version of enum)", objc_opt_class(), @"value"];
    v15[0] = v12;
