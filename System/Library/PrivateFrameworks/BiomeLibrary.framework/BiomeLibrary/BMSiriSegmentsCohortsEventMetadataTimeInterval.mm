...
+ (id)protoFields;
- (BMSiriSegmentsCohortsEventMetadataTimeInterval)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMSiriSegmentsCohortsEventMetadataTimeInterval)initWithStartTimestampInSecondsSince1970:(id)since1970 numberOfSeconds:(id)seconds;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriSegmentsCohortsEventMetadataTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970") || [v5 hasStartTimestampInSecondsSince1970])
    {
      ...
      startTimestampInSecondsSince1970 = [(BMSiriSegmentsCohortsEventMetadataTimeInterval *)self startTimestampInSecondsSince1970];
    ...
    if (-[BMSiriSegmentsCohortsEventMetadataTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds") && [v5 hasNumberOfSeconds])
    {
      numberOfSeconds = [(BMSiriSegmentsCohortsEventMetadataTimeInterval *)self numberOfSeconds];
