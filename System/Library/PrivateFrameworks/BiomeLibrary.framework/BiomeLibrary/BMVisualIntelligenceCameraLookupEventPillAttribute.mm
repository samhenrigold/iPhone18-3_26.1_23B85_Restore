@interface BMVisualIntelligenceCameraLookupEventPillAttribute
+ (id)columns;
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version;
+ (id)protoFields;
- (BMVisualIntelligenceCameraLookupEventPillAttribute)initWithIsMaybe:(id)maybe pillType:(int)type;
...
@implementation BMVisualIntelligenceCameraLookupEventPillAttribute
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    if (!-[BMVisualIntelligenceCameraLookupEventPillAttribute hasIsMaybe](self, "hasIsMaybe") && ![v5 hasIsMaybe] || -[BMVisualIntelligenceCameraLookupEventPillAttribute hasIsMaybe](self, "hasIsMaybe") && objc_msgSend(v5, "hasIsMaybe") && (v6 = -[BMVisualIntelligenceCameraLookupEventPillAttribute isMaybe](self, "isMaybe"), v6 == objc_msgSend(v5, "isMaybe")))
    {
      pillType = [(BMVisualIntelligenceCameraLookupEventPillAttribute *)self pillType];
      v7 = pillType == [v5 pillType];
    }
...
- (BMVisualIntelligenceCameraLookupEventPillAttribute)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  v9 = [dictionaryCopy objectForKeyedSubscript:@"pillType"];
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      v11 = [MEMORY[0x1E696AD98] numberWithInt:BMVisualIntelligenceCameraLookupEventPillTypeFromString(v9)];
    }
  ...
  self = -[BMVisualIntelligenceCameraLookupEventPillAttribute initWithIsMaybe:pillType:](self, "initWithIsMaybe:pillType:", v8, [v10 intValue]);
  selfCopy = self;
LABEL_17:
...
{
  v3 = objc_opt_new();
  [(BMVisualIntelligenceCameraLookupEventPillAttribute *)self writeTo:v3];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v32.receiver = self;
  v32.super_class = BMVisualIntelligenceCameraLookupEventPillAttribute;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMVisualIntelligenceCameraLookupEventPillAttribute isMaybe](self, "isMaybe")}];
  v5 = BMVisualIntelligenceCameraLookupEventPillTypeAsString([(BMVisualIntelligenceCameraLookupEventPillAttribute *)self pillType]);
  v6 = [v3 initWithFormat:@"BMVisualIntelligenceCameraLookupEventPillAttribute with isMaybe: %@, pillType: %@", v4, v5];
...
- (BMVisualIntelligenceCameraLookupEventPillAttribute)initWithIsMaybe:(id)maybe pillType:(int)type
{
  maybeCopy = maybe;
  v9.receiver = self;
  v9.super_class = BMVisualIntelligenceCameraLookupEventPillAttribute;
  ...
  if (v7)
  {
    ...
    {
      v7->_hasIsMaybe = 1;
      v7->_isMaybe = [maybeCopy BOOLValue];
    }
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMVisualIntelligenceCameraLookupEventPillAttribute alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[5] = 0;
