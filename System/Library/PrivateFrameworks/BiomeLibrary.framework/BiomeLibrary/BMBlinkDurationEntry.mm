...
+ (id)protoFields;
- (BMBlinkDurationEntry)initWithDurationCategory:(int)category count:(id)count;
- (BMBlinkDurationEntry)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    durationCategory = [(BMBlinkDurationEntry *)self durationCategory];
    if (durationCategory != [v5 durationCategory])
    {
      goto LABEL_9;
    }
...
- (BMBlinkDurationEntry)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  v7 = [dictionaryCopy objectForKeyedSubscript:@"durationCategory"];
