...
- (BMSiriSegmentsCohorts)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v6 && (v7 = v6, objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    v9 = v7;
    v75 = 0;
    v8 = [[BMSiriSegmentsCohortsEventMetadata alloc] initWithJSONDictionary:v9 error:&v75];
    v24 = v75;
    if (v24)
    {
      if (error)
...
LABEL_52:
      ...
      v70 = 0;
      v19 = [(BMSiriSegmentsCohortsDeviceSegments *)v18 initWithJSONDictionary:v17 error:&v70];
      v20 = v70;
      if (v20)
      {
        v34 = v20;
...
LABEL_40:
    ...
    while (1)
    {
      ...
      v65 = 0;
      v43 = [(BMSiriSegmentsCohortsDeviceCohorts *)v42 initWithJSONDictionary:v41 error:&v65];
      v44 = v65;
      if (v44)
      {
        v53 = v44;
...
LABEL_48:
        ...
        v8 = v59;
        v27 = [(BMSiriSegmentsCohorts *)selfCopy initWithEventMetadata:v59 deviceSegmentsReported:v64 deviceCohortsReported:v17];
        selfCopy = v27;
        dictionaryCopy = v60;
LABEL_66:
...
id __32__BMSiriSegmentsCohorts_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __32__BMSiriSegmentsCohorts_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
...
id __32__BMSiriSegmentsCohorts_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 eventMetadata];
