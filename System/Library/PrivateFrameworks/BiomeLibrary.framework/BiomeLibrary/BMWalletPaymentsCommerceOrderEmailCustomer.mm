...
LABEL_54:
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      error = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)selfCopy initWithFullName:v52 phoneNumber:v55 emailAddress:v11 billingAddress:v51 givenName:v14 familyName:error];
      selfCopy = v16;
LABEL_49:
...
id __53__BMWalletPaymentsCommerceOrderEmailCustomer_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
