...
+ (id)protoFields;
- (BMDeviceNightShift)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMDeviceNightShift)initWithStarting:(id)starting reason:(int)reason;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    if (!-[BMDeviceNightShift hasStarting](self, "hasStarting") && ![v5 hasStarting] || -[BMDeviceNightShift hasStarting](self, "hasStarting") && objc_msgSend(v5, "hasStarting") && (v6 = -[BMDeviceNightShift starting](self, "starting"), v6 == objc_msgSend(v5, "starting")))
    {
      reason = [(BMDeviceNightShift *)self reason];
      v7 = reason == [v5 reason];
    }
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceNightShift starting](self, "starting")}];
  }
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMDeviceNightShift reason](self, "reason")}];
  v9[0] = @"starting";
  null = v3;
  if (!v3)
  {
...
- (BMDeviceNightShift)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      v11 = [MEMORY[0x1E696AD98] numberWithInt:BMDeviceNightShiftReasonFromString(v9)];
    }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v32.receiver = self;
  v32.super_class = BMDeviceNightShift;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceNightShift starting](self, "starting")}];
  v5 = BMDeviceNightShiftReasonAsString([(BMDeviceNightShift *)self reason]);
  v6 = [v3 initWithFormat:@"BMDeviceNightShift with starting: %@, reason: %@", v4, v5];
...
- (BMDeviceNightShift)initWithStarting:(id)starting reason:(int)reason
{
  ...
  v9.receiver = self;
  v9.super_class = BMDeviceNightShift;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMDeviceNightShift alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[5] = 0;
