...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self hasEventTimestampInMSSince1970])
  {
    v23 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriOnDeviceDigestExperimentMetricsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970")}];
  }
...
LABEL_29:
    ...
    if (v15 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      v22 = v15;
      v69 = 0;
      v64 = [[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval alloc] initWithJSONDictionary:v22 error:&v69];
      v24 = v69;
      if (v24)
      {
        if (errorCopy)
    ...
    v21 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)selfCopy3 initWithOddIdUUID:v63 deviceAggregationId:v60 userAggregationId:v66 eventTimestampInMSSince1970:v68 timeInterval:v64 userAggregationIdRotationTimestampInMs:v18 userAggregationIdExpirationTimestampInMs:v20];
    selfCopy3 = v21;
LABEL_23:
...
id __61__BMSiriOnDeviceDigestExperimentMetricsEventMetadata_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
