...
+ (id)protoFields;
- (BMAccessibilityVoiceControl)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMAccessibilityVoiceControl)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMAccessibilityVoiceControl hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMAccessibilityVoiceControl hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMAccessibilityVoiceControl *)self starting];
...
- (BMAccessibilityVoiceControl)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMAccessibilityVoiceControl *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
