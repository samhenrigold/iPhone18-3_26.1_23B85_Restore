...
+ (id)protoFields;
- (BMFeedbackTextToTextEvaluationData)initWithCommonMetadata:(id)metadata originalContent:(id)content generatedContent:(id)generatedContent;
- (BMFeedbackTextToTextEvaluationData)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
+ (id)columns
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"commonMetadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_454];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"originalContent_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_456];
  v4 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"generatedContent_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_458_26140];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    commonMetadata = [(BMFeedbackTextToTextEvaluationData *)self commonMetadata];
    ...
    {
      commonMetadata3 = [(BMFeedbackTextToTextEvaluationData *)self commonMetadata];
    ...
    originalContent = [(BMFeedbackTextToTextEvaluationData *)self originalContent];
    ...
    {
      originalContent3 = [(BMFeedbackTextToTextEvaluationData *)self originalContent];
...
LABEL_15:
    ...
    generatedContent = [(BMFeedbackTextToTextEvaluationData *)self generatedContent];
    ...
    {
      generatedContent3 = [(BMFeedbackTextToTextEvaluationData *)self generatedContent];
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v26 = 0;
        v12 = [[BMTextContent alloc] initWithJSONDictionary:v16 error:&v26];
        v17 = v26;
        if (!v17)
        {
...
- (void)writeTo:(id)to
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMTextContent *)self->_generatedContent writeTo:toCopy];
    PBDataWriterRecallMark();
  }
}
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v22.receiver = self;
  v22.super_class = BMFeedbackTextToTextEvaluationData;
...
- (NSString)description
{
  ...
  originalContent = [(BMFeedbackTextToTextEvaluationData *)self originalContent];
  generatedContent = [(BMFeedbackTextToTextEvaluationData *)self generatedContent];
  v7 = [v3 initWithFormat:@"BMFeedbackTextToTextEvaluationData with commonMetadata: %@, originalContent: %@, generatedContent: %@", commonMetadata, originalContent, generatedContent];
...
- (BMFeedbackTextToTextEvaluationData)initWithCommonMetadata:(id)metadata originalContent:(id)content generatedContent:(id)generatedContent
{
  ...
  v14.receiver = self;
  v14.super_class = BMFeedbackTextToTextEvaluationData;
...
id __45__BMFeedbackTextToTextEvaluationData_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __45__BMFeedbackTextToTextEvaluationData_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
...
id __45__BMFeedbackTextToTextEvaluationData_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
