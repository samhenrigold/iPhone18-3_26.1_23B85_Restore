...
+ (id)protoFields;
- (BMSiriMessageHistory)initWithInteraction:(id)interaction entities:(id)entities;
- (BMSiriMessageHistory)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (NSString)identifier
{
  ...
  interaction = [(BMSiriMessageHistory *)self interaction];
  if (interaction)
  {
    interaction2 = [(BMSiriMessageHistory *)self interaction];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      interaction3 = [(BMSiriMessageHistory *)self interaction];
...
LABEL_11:
    ...
    entities = [(BMSiriMessageHistory *)self entities];
    ...
    {
      entities3 = [(BMSiriMessageHistory *)self entities];
...
- (id)jsonDictionary
{
  ...
  _entitiesJSONArray = [(BMSiriMessageHistory *)self _entitiesJSONArray];
  v10[0] = @"interaction";
  null = jsonDictionary;
  if (!jsonDictionary)
  {
...
LABEL_19:
  ...
  v8 = v39;
  self = [(BMSiriMessageHistory *)self initWithInteraction:v39 entities:v12];
  selfCopy2 = self;
  v7 = v40;
  dictionaryCopy = v41;
LABEL_36:
...
- (NSString)description
{
  ...
  interaction = [(BMSiriMessageHistory *)self interaction];
  entities = [(BMSiriMessageHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriMessageHistory with interaction: %@, entities: %@", interaction, entities];
...
id __31__BMSiriMessageHistory_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
...
id __31__BMSiriMessageHistory_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 interaction];
