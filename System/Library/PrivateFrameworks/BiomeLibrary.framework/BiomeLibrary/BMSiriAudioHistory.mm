...
LABEL_19:
  ...
  v8 = v39;
  self = [(BMSiriAudioHistory *)self initWithInteraction:v39 entities:v12];
  selfCopy2 = self;
  v7 = v40;
  dictionaryCopy = v41;
LABEL_36:
...
id __29__BMSiriAudioHistory_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
...
id __29__BMSiriAudioHistory_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 interaction];
