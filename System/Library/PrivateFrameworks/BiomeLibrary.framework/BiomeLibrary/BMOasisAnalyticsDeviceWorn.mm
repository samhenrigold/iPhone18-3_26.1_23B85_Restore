...
+ (id)protoFields;
- (BMOasisAnalyticsDeviceWorn)initWithJSONDictionary:(id)dictionary error:(id *)p_isa;
- (BMOasisAnalyticsDeviceWorn)initWithPayload:(id)payload;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    payload = [(BMOasisAnalyticsDeviceWorn *)self payload];
    payload2 = [v5 payload];
    if (payload == payload2)
    {
      v10 = 1;
    ...
    {
      payload3 = [(BMOasisAnalyticsDeviceWorn *)self payload];
      payload4 = [v5 payload];
...
LABEL_13:
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = v6;
    v14 = 0;
    v7 = [[BMOasisAnalyticsDeviceWornPayload alloc] initWithJSONDictionary:v8 error:&v14];
    v9 = v14;
    if (!v9)
    {
...
- (void)writeTo:(id)to
{
  if (self->_payload)
  {
    ...
    [(BMOasisAnalyticsDeviceWornPayload *)self->_payload writeTo:toCopy];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMOasisAnalyticsDeviceWornPayload alloc] initByReadFrom:fromCopy];
        if (!v15)
        {
          goto LABEL_25;
        }
...
- (NSString)description
{
  ...
  payload = [(BMOasisAnalyticsDeviceWorn *)self payload];
  v5 = [v3 initWithFormat:@"BMOasisAnalyticsDeviceWorn with payload: %@", payload];
...
id __37__BMOasisAnalyticsDeviceWorn_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
