@interface BMSiriSegmentsCohortsEventMetadata
+ (id)columns;
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version;
+ (id)protoFields;
- (BMSiriSegmentsCohortsEventMetadata)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMSiriSegmentsCohortsEventMetadata)initWithOddId:(id)id deviceAggregationId:(id)aggregationId userAggregationId:(id)userAggregationId eventTimestampInMSSince1970:(id)since1970 timeInterval:(id)interval userAggregationIdRotationTimestampInMs:(id)ms userAggregationIdExpirationTimestampInMs:(id)inMs eventOrigin:(id)self0 isLongLivedIDUploadDisabled:(id)self1;
...
@implementation BMSiriSegmentsCohortsEventMetadata
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    oddId = [(BMSiriSegmentsCohortsEventMetadata *)self oddId];
    oddId2 = [v5 oddId];
    v8 = oddId2;
    if (oddId == oddId2)
    {
    ...
    {
      oddId3 = [(BMSiriSegmentsCohortsEventMetadata *)self oddId];
      oddId4 = [v5 oddId];
    ...
    deviceAggregationId = [(BMSiriSegmentsCohortsEventMetadata *)self deviceAggregationId];
    ...
    {
      deviceAggregationId3 = [(BMSiriSegmentsCohortsEventMetadata *)self deviceAggregationId];
    ...
    userAggregationId = [(BMSiriSegmentsCohortsEventMetadata *)self userAggregationId];
    ...
    {
      userAggregationId3 = [(BMSiriSegmentsCohortsEventMetadata *)self userAggregationId];
    ...
    if (-[BMSiriSegmentsCohortsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970") || [v5 hasEventTimestampInMSSince1970])
    {
      if (![(BMSiriSegmentsCohortsEventMetadata *)self hasEventTimestampInMSSince1970])
      {
        goto LABEL_44;
      }
      ...
      eventTimestampInMSSince1970 = [(BMSiriSegmentsCohortsEventMetadata *)self eventTimestampInMSSince1970];
    ...
    timeInterval = [(BMSiriSegmentsCohortsEventMetadata *)self timeInterval];
    ...
    {
      timeInterval3 = [(BMSiriSegmentsCohortsEventMetadata *)self timeInterval];
    ...
    if (!-[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && ![v5 hasUserAggregationIdRotationTimestampInMs] || -[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs") && (v32 = -[BMSiriSegmentsCohortsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"), v32 == objc_msgSend(v5, "userAggregationIdRotationTimestampInMs")))
    {
      if (!-[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs") && ![v5 hasUserAggregationIdExpirationTimestampInMs] || -[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs") && objc_msgSend(v5, "hasUserAggregationIdExpirationTimestampInMs") && (v33 = -[BMSiriSegmentsCohortsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs"), v33 == objc_msgSend(v5, "userAggregationIdExpirationTimestampInMs")))
      {
        if (!-[BMSiriSegmentsCohortsEventMetadata hasEventOrigin](self, "hasEventOrigin") && ![v5 hasEventOrigin] || -[BMSiriSegmentsCohortsEventMetadata hasEventOrigin](self, "hasEventOrigin") && objc_msgSend(v5, "hasEventOrigin") && (v34 = -[BMSiriSegmentsCohortsEventMetadata eventOrigin](self, "eventOrigin"), v34 == objc_msgSend(v5, "eventOrigin")))
        {
          if (!-[BMSiriSegmentsCohortsEventMetadata hasIsLongLivedIDUploadDisabled](self, "hasIsLongLivedIDUploadDisabled") && ![v5 hasIsLongLivedIDUploadDisabled])
          {
            LOBYTE(v12) = 1;
            goto LABEL_45;
          }
          ...
          if (-[BMSiriSegmentsCohortsEventMetadata hasIsLongLivedIDUploadDisabled](self, "hasIsLongLivedIDUploadDisabled") && [v5 hasIsLongLivedIDUploadDisabled])
          {
            isLongLivedIDUploadDisabled = [(BMSiriSegmentsCohortsEventMetadata *)self isLongLivedIDUploadDisabled];
...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasEventTimestampInMSSince1970])
  {
    v6 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970")}];
  }
  ...
  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasUserAggregationIdRotationTimestampInMs])
  {
    v32 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs")}];
  }
  ...
  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasUserAggregationIdExpirationTimestampInMs])
  {
    v31 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs")}];
  }
  ...
  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasEventOrigin])
  {
    v9 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMSiriSegmentsCohortsEventMetadata eventOrigin](self, "eventOrigin")}];
  }
  ...
  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasIsLongLivedIDUploadDisabled])
  {
    v10 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMSiriSegmentsCohortsEventMetadata isLongLivedIDUploadDisabled](self, "isLongLivedIDUploadDisabled")}];
  }
...
LABEL_59:
      ...
      v19 = v13;
      v93 = 0;
      v85 = [[BMSiriSegmentsCohortsEventMetadataTimeInterval alloc] initWithJSONDictionary:v19 error:&v93];
      v20 = v93;
      if (v20)
      {
        if (errorCopy2)
...
LABEL_56:
    ...
    v21 = [(BMSiriSegmentsCohortsEventMetadata *)selfCopy5 initWithOddId:v92 deviceAggregationId:v81 userAggregationId:v89 eventTimestampInMSSince1970:v91 timeInterval:v85 userAggregationIdRotationTimestampInMs:v78 userAggregationIdExpirationTimestampInMs:v77 eventOrigin:v34 isLongLivedIDUploadDisabled:v36];
    selfCopy5 = v21;
LABEL_53:
...
{
  v3 = objc_opt_new();
  [(BMSiriSegmentsCohortsEventMetadata *)self writeTo:v3];
...
- (void)writeTo:(id)to
{
  ...
  if (self->_timeInterval)
  {
    ...
    [(BMSiriSegmentsCohortsEventMetadataTimeInterval *)self->_timeInterval writeTo:toCopy];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v58.receiver = self;
  v58.super_class = BMSiriSegmentsCohortsEventMetadata;
...
LABEL_91:
        ...
        v45 = [[BMSiriSegmentsCohortsEventMetadataTimeInterval alloc] initByReadFrom:fromCopy];
        if (!v45)
        {
          goto LABEL_105;
        }
...
- (NSString)description
{
  ...
  v6 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970")}];
  timeInterval = [(BMSiriSegmentsCohortsEventMetadata *)self timeInterval];
  v8 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs")}];
  v9 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs")}];
  v10 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMSiriSegmentsCohortsEventMetadata eventOrigin](self, "eventOrigin")}];
  v11 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMSiriSegmentsCohortsEventMetadata isLongLivedIDUploadDisabled](self, "isLongLivedIDUploadDisabled")}];
...
- (BMSiriSegmentsCohortsEventMetadata)initWithOddId:(id)id deviceAggregationId:(id)aggregationId userAggregationId:(id)userAggregationId eventTimestampInMSSince1970:(id)since1970 timeInterval:(id)interval userAggregationIdRotationTimestampInMs:(id)ms userAggregationIdExpirationTimestampInMs:(id)inMs eventOrigin:(id)self0 isLongLivedIDUploadDisabled:(id)self1
{
  ...
  v33.receiver = self;
  v33.super_class = BMSiriSegmentsCohortsEventMetadata;
...
+ (id)columns
{
  ...
  v6 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"timeInterval_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_112977];
...
id __45__BMSiriSegmentsCohortsEventMetadata_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMSiriSegmentsCohortsEventMetadata alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[6] = 0;
