...
+ (id)protoFields;
- (BMOasisAnalyticsSubmapCreatedEvent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMOasisAnalyticsSubmapCreatedEvent)initWithQualityTrace:(id)trace metadata:(id)metadata payload:(id)payload;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    qualityTrace = [(BMOasisAnalyticsSubmapCreatedEvent *)self qualityTrace];
    ...
    {
      qualityTrace3 = [(BMOasisAnalyticsSubmapCreatedEvent *)self qualityTrace];
    ...
    metadata = [(BMOasisAnalyticsSubmapCreatedEvent *)self metadata];
    ...
    {
      metadata3 = [(BMOasisAnalyticsSubmapCreatedEvent *)self metadata];
...
LABEL_15:
    ...
    payload = [(BMOasisAnalyticsSubmapCreatedEvent *)self payload];
    payload2 = [v5 payload];
    if (payload == payload2)
    {
      v12 = 1;
    ...
    {
      payload3 = [(BMOasisAnalyticsSubmapCreatedEvent *)self payload];
      payload4 = [v5 payload];
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v26 = 0;
        v12 = [[BMOasisAnalyticsSubmapCreatedType alloc] initWithJSONDictionary:v16 error:&v26];
        v17 = v26;
        if (!v17)
        {
...
- (void)writeTo:(id)to
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMOasisAnalyticsSubmapCreatedType *)self->_payload writeTo:toCopy];
    PBDataWriterRecallMark();
  }
}
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsSubmapCreatedType alloc] initByReadFrom:fromCopy];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  metadata = [(BMOasisAnalyticsSubmapCreatedEvent *)self metadata];
  payload = [(BMOasisAnalyticsSubmapCreatedEvent *)self payload];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsSubmapCreatedEvent with qualityTrace: %@, metadata: %@, payload: %@", qualityTrace, metadata, payload];
...
id __45__BMOasisAnalyticsSubmapCreatedEvent_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __45__BMOasisAnalyticsSubmapCreatedEvent_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 metadata];
  v5 = [v4 jsonDictionary];
...
id __45__BMOasisAnalyticsSubmapCreatedEvent_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 qualityTrace];
  v5 = [v4 jsonDictionary];
