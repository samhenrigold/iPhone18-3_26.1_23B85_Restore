...
+ (id)protoFields;
- (BMWalletPaymentsCommerceTrackedOrderCustomer)initWithFullName:(id)name phoneNumber:(id)number emailAddress:(id)address billingAddress:(id)billingAddress givenName:(id)givenName familyName:(id)familyName;
- (BMWalletPaymentsCommerceTrackedOrderCustomer)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    fullName = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self fullName];
    ...
    {
      fullName3 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self fullName];
    ...
    phoneNumber = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self phoneNumber];
    ...
    {
      phoneNumber3 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self phoneNumber];
    ...
    emailAddress = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self emailAddress];
    ...
    {
      emailAddress3 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self emailAddress];
    ...
    billingAddress = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self billingAddress];
    ...
    {
      billingAddress3 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self billingAddress];
    ...
    givenName = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self givenName];
    ...
    {
      givenName3 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self givenName];
...
LABEL_22:
    ...
    familyName = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self familyName];
    ...
    {
      familyName3 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self familyName];
...
LABEL_54:
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      error = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)selfCopy initWithFullName:v52 phoneNumber:v55 emailAddress:v11 billingAddress:v51 givenName:v14 familyName:error];
      selfCopy = v16;
LABEL_49:
...
- (void)writeTo:(id)to
{
  ...
  if (self->_billingAddress)
  {
    ...
    [(BMWalletPaymentsCommerceTrackedOrderAddress *)self->_billingAddress writeTo:toCopy];
...
- (NSString)description
{
  ...
  givenName = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self givenName];
  familyName = [(BMWalletPaymentsCommerceTrackedOrderCustomer *)self familyName];
  v10 = [v3 initWithFormat:@"BMWalletPaymentsCommerceTrackedOrderCustomer with fullName: %@, phoneNumber: %@, emailAddress: %@, billingAddress: %@, givenName: %@, familyName: %@", fullName, phoneNumber, emailAddress, billingAddress, givenName, familyName];
...
id __55__BMWalletPaymentsCommerceTrackedOrderCustomer_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 billingAddress];
