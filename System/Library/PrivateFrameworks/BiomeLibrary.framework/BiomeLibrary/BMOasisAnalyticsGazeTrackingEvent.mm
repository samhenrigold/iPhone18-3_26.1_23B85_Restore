...
+ (id)protoFields;
- (BMOasisAnalyticsGazeTrackingEvent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMOasisAnalyticsGazeTrackingEvent)initWithMetadata:(id)metadata payload:(id)payload qualityTrace:(id)trace;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    metadata = [(BMOasisAnalyticsGazeTrackingEvent *)self metadata];
    ...
    {
      metadata3 = [(BMOasisAnalyticsGazeTrackingEvent *)self metadata];
    ...
    payload = [(BMOasisAnalyticsGazeTrackingEvent *)self payload];
    payload2 = [v5 payload];
    v15 = payload2;
    if (payload == payload2)
    {
    ...
    {
      payload3 = [(BMOasisAnalyticsGazeTrackingEvent *)self payload];
      payload4 = [v5 payload];
...
LABEL_15:
    ...
    qualityTrace = [(BMOasisAnalyticsGazeTrackingEvent *)self qualityTrace];
    ...
    {
      qualityTrace3 = [(BMOasisAnalyticsGazeTrackingEvent *)self qualityTrace];
...
- (BMOasisAnalyticsGazeTrackingEvent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v9 = v7;
    v28 = 0;
    v8 = [[BMOasisAnalyticsMetadata alloc] initWithJSONDictionary:v9 error:&v28];
    v14 = v28;
    if (v14)
    {
      if (error)
...
LABEL_4:
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = v9;
      v27 = 0;
      v10 = [[BMOasisAnalyticsGazeSample alloc] initWithJSONDictionary:v11 error:&v27];
      v15 = v27;
      if (v15)
      {
        if (error)
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v26 = 0;
        v12 = [[BMOasisAnalyticsQualityTrace alloc] initWithJSONDictionary:v16 error:&v26];
        v17 = v26;
        if (!v17)
        {
...
- (void)writeTo:(id)to
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMOasisAnalyticsGazeSample *)self->_payload writeTo:toCopy];
    PBDataWriterRecallMark();
  }
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsGazeSample alloc] initByReadFrom:fromCopy];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  payload = [(BMOasisAnalyticsGazeTrackingEvent *)self payload];
  qualityTrace = [(BMOasisAnalyticsGazeTrackingEvent *)self qualityTrace];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsGazeTrackingEvent with metadata: %@, payload: %@, qualityTrace: %@", metadata, payload, qualityTrace];
...
id __44__BMOasisAnalyticsGazeTrackingEvent_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __44__BMOasisAnalyticsGazeTrackingEvent_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 payload];
  v5 = [v4 jsonDictionary];
...
id __44__BMOasisAnalyticsGazeTrackingEvent_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 metadata];
  v5 = [v4 jsonDictionary];
