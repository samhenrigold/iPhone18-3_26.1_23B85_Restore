...
- (BMTextContent)initWithText:(id)text metadata:(id)metadata;
...
LABEL_11:
    ...
    {
      metadata3 = [(BMTextContent *)self metadata];
...
- (NSString)description
{
  ...
  text = [(BMTextContent *)self text];
  metadata = [(BMTextContent *)self metadata];
  v6 = [v3 initWithFormat:@"BMTextContent with text: %@, metadata: %@", text, metadata];
