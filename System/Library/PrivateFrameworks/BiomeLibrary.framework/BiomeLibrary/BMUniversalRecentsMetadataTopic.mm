...
+ (id)protoFields;
- (BMUniversalRecentsMetadataTopic)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMUniversalRecentsMetadataTopic)initWithTopicIdentifier:(id)identifier title:(id)title;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    topicIdentifier = [(BMUniversalRecentsMetadataTopic *)self topicIdentifier];
    topicIdentifier2 = [v5 topicIdentifier];
    v8 = topicIdentifier2;
    if (topicIdentifier == topicIdentifier2)
    {
    }

    else
    {
      topicIdentifier3 = [(BMUniversalRecentsMetadataTopic *)self topicIdentifier];
      topicIdentifier4 = [v5 topicIdentifier];
      v11 = [topicIdentifier3 isEqual:topicIdentifier4];
...
LABEL_11:
    ...
    title = [(BMUniversalRecentsMetadataTopic *)self title];
    title2 = [v5 title];
    if (title == title2)
    {
      v12 = 1;
    ...
    {
      title3 = [(BMUniversalRecentsMetadataTopic *)self title];
      title4 = [v5 title];
...
- (BMUniversalRecentsMetadataTopic)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  v7 = [dictionaryCopy objectForKeyedSubscript:@"topicIdentifier"];
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (error)
      {
        ...
        v18 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"title"];
        v21 = v18;
...
- (NSString)description
{
  ...
  topicIdentifier = [(BMUniversalRecentsMetadataTopic *)self topicIdentifier];
  title = [(BMUniversalRecentsMetadataTopic *)self title];
  v6 = [v3 initWithFormat:@"BMUniversalRecentsMetadataTopic with topicIdentifier: %@, title: %@", topicIdentifier, title];
...
- (BMUniversalRecentsMetadataTopic)initWithTopicIdentifier:(id)identifier title:(id)title
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_topicIdentifier, identifier);
