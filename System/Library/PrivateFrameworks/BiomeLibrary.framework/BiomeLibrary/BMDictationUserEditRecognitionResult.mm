...
- (id)_tokensJSONArray
{
  ...
  v13 = 0u;
  tokens = [(BMDictationUserEditRecognitionResult *)self tokens];
  v5 = [tokens countByEnumeratingWithState:&v10 objects:v14 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v11;
    do
    {
      ...
      v6 = [tokens countByEnumeratingWithState:&v10 objects:v14 count:16];
    }
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (p_isa)
        {
          ...
          v17 = [v23 initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"tokens", v28];
          v33 = v17;
...
id __47__BMDictationUserEditRecognitionResult_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 _tokensJSONArray];
