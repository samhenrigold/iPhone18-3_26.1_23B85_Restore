...
LABEL_4:
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = v9;
      v27 = 0;
      v10 = [[BMTextImageContent alloc] initWithJSONDictionary:v11 error:&v27];
      v15 = v27;
      if (v15)
      {
        if (error)
...
id __51__BMFeedbackTextImageToImageEvaluationData_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __51__BMFeedbackTextImageToImageEvaluationData_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
...
id __51__BMFeedbackTextImageToImageEvaluationData_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
