...
+ (id)protoFields;
- (BMMessagesSearchEventMessagesAppViewContext)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMMessagesSearchEventMessagesAppViewContext)initWithMillisecondsSinceSessionStarted:(id)started sessionId:(id)id queryId:(id)queryId appeared:(id)appeared disappeared:(id)disappeared;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMMessagesSearchEventMessagesAppViewContext hasMillisecondsSinceSessionStarted](self, "hasMillisecondsSinceSessionStarted") || [v5 hasMillisecondsSinceSessionStarted])
    {
      ...
      millisecondsSinceSessionStarted = [(BMMessagesSearchEventMessagesAppViewContext *)self millisecondsSinceSessionStarted];
    ...
    sessionId = [(BMMessagesSearchEventMessagesAppViewContext *)self sessionId];
    ...
    {
      sessionId3 = [(BMMessagesSearchEventMessagesAppViewContext *)self sessionId];
    ...
    queryId = [(BMMessagesSearchEventMessagesAppViewContext *)self queryId];
    queryId2 = [v5 queryId];
    v16 = queryId2;
    if (queryId == queryId2)
    {
    ...
    {
      queryId3 = [(BMMessagesSearchEventMessagesAppViewContext *)self queryId];
      queryId4 = [v5 queryId];
    ...
    appeared = [(BMMessagesSearchEventMessagesAppViewContext *)self appeared];
    ...
    {
      appeared3 = [(BMMessagesSearchEventMessagesAppViewContext *)self appeared];
...
LABEL_19:
    ...
    disappeared = [(BMMessagesSearchEventMessagesAppViewContext *)self disappeared];
    ...
    {
      disappeared3 = [(BMMessagesSearchEventMessagesAppViewContext *)self disappeared];
...
LABEL_4:
    ...
    if (v12 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      v17 = v12;
      v41 = 0;
      v13 = [[BMMessagesSearchEventMessagesAppViewAppeared alloc] initWithJSONDictionary:v17 error:&v41];
      v18 = v41;
      if (v18)
      {
        if (errorCopy2)
    ...
    if (!v14 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      v15 = 0;
LABEL_16:
      v16 = [(BMMessagesSearchEventMessagesAppViewContext *)self initWithMillisecondsSinceSessionStarted:v37 sessionId:v35 queryId:v38 appeared:v13 disappeared:v15];
      self = v16;
LABEL_44:
...
LABEL_49:
    ...
    if (objc_opt_isKindOfClass())
    {
      v21 = v14;
      v40 = 0;
      v15 = [[BMMessagesSearchEventMessagesAppViewDisappeared alloc] initWithJSONDictionary:v21 error:&v40];
      v22 = v40;
      if (!v22)
      {
...
- (void)writeTo:(id)to
{
  ...
  if (self->_appeared)
  {
    ...
    [(BMMessagesSearchEventMessagesAppViewAppeared *)self->_appeared writeTo:toCopy];
  ...
  {
    PBDataWriterPlaceMark();
    [(BMMessagesSearchEventMessagesAppViewDisappeared *)self->_disappeared writeTo:toCopy];
    PBDataWriterRecallMark();
  }
}
...
LABEL_29:
        ...
        case 4:
          ...
          v16 = [[BMMessagesSearchEventMessagesAppViewAppeared alloc] initByReadFrom:fromCopy];
          if (!v16)
          {
            goto LABEL_51;
          }
        ...
        case 5:
          ...
          v16 = [[BMMessagesSearchEventMessagesAppViewDisappeared alloc] initByReadFrom:fromCopy];
          if (!v16)
          {
            goto LABEL_51;
          }
...
- (NSString)description
{
  ...
  appeared = [(BMMessagesSearchEventMessagesAppViewContext *)self appeared];
  disappeared = [(BMMessagesSearchEventMessagesAppViewContext *)self disappeared];
  v9 = [v3 initWithFormat:@"BMMessagesSearchEventMessagesAppViewContext with millisecondsSinceSessionStarted: %@, sessionId: %@, queryId: %@, appeared: %@, disappeared: %@", v4, sessionId, queryId, appeared, disappeared];
...
id __54__BMMessagesSearchEventMessagesAppViewContext_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
...
id __54__BMMessagesSearchEventMessagesAppViewContext_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 appeared];
  v5 = [v4 jsonDictionary];
