...
+ (id)protoFields;
- (BMAppIntentInvocationValueTypeLinkEnumeration)initWithIdentifier:(id)identifier;
- (BMAppIntentInvocationValueTypeLinkEnumeration)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMAppIntentInvocationValueTypeLinkEnumeration *)self identifier];
    ...
    {
      identifier3 = [(BMAppIntentInvocationValueTypeLinkEnumeration *)self identifier];
...
- (BMAppIntentInvocationValueTypeLinkEnumeration)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMAppIntentInvocationValueTypeLinkEnumeration *)self initWithIdentifier:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (NSString)description
{
  ...
  identifier = [(BMAppIntentInvocationValueTypeLinkEnumeration *)self identifier];
  v5 = [v3 initWithFormat:@"BMAppIntentInvocationValueTypeLinkEnumeration with identifier: %@", identifier];
