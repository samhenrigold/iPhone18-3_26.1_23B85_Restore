...
+ (id)protoFields;
- (BMDeviceTrueTone)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMDeviceTrueTone)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceTrueTone hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceTrueTone hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMDeviceTrueTone *)self starting];
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceTrueTone starting](self, "starting")}];
    v9 = @"starting";
    if (v3)
    {
      v4 = v3;
...
- (BMDeviceTrueTone)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMDeviceTrueTone *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v25.receiver = self;
  v25.super_class = BMDeviceTrueTone;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceTrueTone starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMDeviceTrueTone with starting: %@", v4];
...
- (BMDeviceTrueTone)initWithStarting:(id)starting
{
  ...
  v7.receiver = self;
  v7.super_class = BMDeviceTrueTone;
