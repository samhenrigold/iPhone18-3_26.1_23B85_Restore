...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v26 = 0;
        v12 = [[BMOasisAnalyticsTrackingLostType alloc] initWithJSONDictionary:v16 error:&v26];
        v17 = v26;
        if (!v17)
        {
...
id __44__BMOasisAnalyticsTrackingLostEvent_columns__block_invoke_3(uint64_t a1, void *a2, uint64_t a3)
{
...
id __44__BMOasisAnalyticsTrackingLostEvent_columns__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 metadata];
  v5 = [v4 jsonDictionary];
...
id __44__BMOasisAnalyticsTrackingLostEvent_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 qualityTrace];
  v5 = [v4 jsonDictionary];
