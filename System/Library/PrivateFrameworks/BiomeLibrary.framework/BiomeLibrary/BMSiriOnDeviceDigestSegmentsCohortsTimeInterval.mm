...
+ (id)protoFields;
- (BMSiriOnDeviceDigestSegmentsCohortsTimeInterval)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMSiriOnDeviceDigestSegmentsCohortsTimeInterval)initWithStartTimestampInSecondsSince1970:(id)since1970 numberOfSeconds:(id)seconds;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970") || [v5 hasStartTimestampInSecondsSince1970])
    {
      ...
      startTimestampInSecondsSince1970 = [(BMSiriOnDeviceDigestSegmentsCohortsTimeInterval *)self startTimestampInSecondsSince1970];
    ...
    if (!-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds") && ![v5 hasNumberOfSeconds])
    {
      v8 = 1;
      goto LABEL_14;
    }
    ...
    if (-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds") && [v5 hasNumberOfSeconds])
    {
      numberOfSeconds = [(BMSiriOnDeviceDigestSegmentsCohortsTimeInterval *)self numberOfSeconds];
...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriOnDeviceDigestSegmentsCohortsTimeInterval *)self hasStartTimestampInSecondsSince1970])
  {
    v3 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970")}];
  }
  ...
  {
    v4 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval numberOfSeconds](self, "numberOfSeconds")}];
  }
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (error)
      {
        ...
        v18 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"numberOfSeconds"];
        v21 = v18;
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v32.receiver = self;
  v32.super_class = BMSiriOnDeviceDigestSegmentsCohortsTimeInterval;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970")}];
  v5 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval numberOfSeconds](self, "numberOfSeconds")}];
  v6 = [v3 initWithFormat:@"BMSiriOnDeviceDigestSegmentsCohortsTimeInterval with startTimestampInSecondsSince1970: %@, numberOfSeconds: %@", v4, v5];
...
- (BMSiriOnDeviceDigestSegmentsCohortsTimeInterval)initWithStartTimestampInSecondsSince1970:(id)since1970 numberOfSeconds:(id)seconds
{
  ...
  secondsCopy = seconds;
  v12.receiver = self;
  v12.super_class = BMSiriOnDeviceDigestSegmentsCohortsTimeInterval;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[5] = 0;
