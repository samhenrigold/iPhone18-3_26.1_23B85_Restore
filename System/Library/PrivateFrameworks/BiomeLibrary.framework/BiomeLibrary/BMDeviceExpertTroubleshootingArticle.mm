...
+ (id)protoFields;
- (BMDeviceExpertTroubleshootingArticle)initWithArticleId:(id)id url:(id)url;
- (BMDeviceExpertTroubleshootingArticle)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    articleId = [(BMDeviceExpertTroubleshootingArticle *)self articleId];
    articleId2 = [v5 articleId];
    v8 = articleId2;
    ...
    {
      articleId3 = [(BMDeviceExpertTroubleshootingArticle *)self articleId];
      articleId4 = [v5 articleId];
      v11 = [articleId3 isEqual:articleId4];
...
- (BMDeviceExpertTroubleshootingArticle)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  v7 = [dictionaryCopy objectForKeyedSubscript:@"articleId"];
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (error)
      {
        ...
        v18 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"url"];
        v21 = v18;
...
- (NSString)description
{
  ...
  v6 = [v3 initWithFormat:@"BMDeviceExpertTroubleshootingArticle with articleId: %@, url: %@", articleId, v5];
...
- (BMDeviceExpertTroubleshootingArticle)initWithArticleId:(id)id url:(id)url
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_articleId, id);
