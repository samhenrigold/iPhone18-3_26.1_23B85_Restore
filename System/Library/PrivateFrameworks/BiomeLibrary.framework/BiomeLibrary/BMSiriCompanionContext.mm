...
- (id)_appSignalsJSONArray
{
  ...
  v14 = 0u;
  appSignals = [(BMSiriCompanionContext *)self appSignals];
  v5 = [appSignals countByEnumeratingWithState:&v11 objects:v15 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v12;
    do
    {
      ...
      v6 = [appSignals countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
...
LABEL_8:
    ...
    while (1)
    {
      ...
      v34 = 0;
      v17 = [(BMSiriCompanionContextAppMetadata *)v16 initWithJSONDictionary:v15 error:&v34];
      v18 = v34;
      if (v18)
      {
        v25 = v18;
...
id __33__BMSiriCompanionContext_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 _appSignalsJSONArray];
