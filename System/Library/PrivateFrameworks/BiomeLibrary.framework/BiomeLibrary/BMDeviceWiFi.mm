...
+ (id)columns
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2E8]) initWithName:@"SSID" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
...
- (BMDeviceWiFi)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      v10 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"SSID"];
      v23[0] = v10;
...
{
  v6[2] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"SSID" number:1 type:13 subMessageClass:0];
  v6[0] = v2;
