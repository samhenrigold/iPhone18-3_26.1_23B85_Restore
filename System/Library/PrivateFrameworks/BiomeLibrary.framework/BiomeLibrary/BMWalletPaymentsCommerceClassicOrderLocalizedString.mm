...
- (id)_localizedStringsJSONArray
{
  ...
  v14 = 0u;
  localizedStrings = [(BMWalletPaymentsCommerceClassicOrderLocalizedString *)self localizedStrings];
  v5 = [localizedStrings countByEnumeratingWithState:&v11 objects:v15 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v12;
    do
    {
      ...
      v6 = [localizedStrings countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
...
- (BMWalletPaymentsCommerceClassicOrderLocalizedString)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      errorCopy = error;
      v30 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"key"];
      v71[0] = v30;
...
LABEL_14:
      ...
      while (1)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          v22 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"localizedStrings"];
          v62 = v22;
        ...
        v21 = v8;
        v22 = v20;
        v23 = [BMWalletPaymentsCommerceClassicOrderLocalizedStringLocalization alloc];
        v56 = 0;
        v24 = [(BMWalletPaymentsCommerceClassicOrderLocalizedStringLocalization *)v23 initWithJSONDictionary:v22 error:&v56];
        v25 = v56;
        if (v25)
        {
          v42 = v25;
...
LABEL_22:
          ...
          v11 = v50;
          error = errorCopy5;
          self = [(BMWalletPaymentsCommerceClassicOrderLocalizedString *)self initWithKey:errorCopy5 developmentLocalization:v50 localizedStrings:v15];
          selfCopy2 = self;
          dictionaryCopy = v52;
LABEL_41:
      ...
      v22 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type null for element of %@, must not be null", @"localizedStrings"];
      v64 = v22;
      v39 = MEMORY[0x1E695DF20];
      v40 = &v64;
      v41 = &v63;
...
LABEL_42:
  ...
  if (errorCopy3)
  {
    ...
    v35 = v34;
    self = selfCopy3;
    v12 = [v35 initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", v48, @"developmentLocalization"];
    v69 = v12;
...
id __62__BMWalletPaymentsCommerceClassicOrderLocalizedString_columns__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v3 = [a2 eventBodyKeepingBackingData:1];
  v4 = [v3 _localizedStringsJSONArray];
