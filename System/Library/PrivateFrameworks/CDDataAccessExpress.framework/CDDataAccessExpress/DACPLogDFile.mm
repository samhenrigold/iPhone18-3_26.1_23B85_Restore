...
- (void)_beginWatchingFile
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    *buf = 134217984;
    v22 = v9;
    _os_log_impl(&dword_242505000, v12, OS_LOG_TYPE_INFO, "Created new dispatch source %p", buf, 0xCu);
  }
...
void __34__DACPLogDFile__beginWatchingFile__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138412290;
    v9 = v3;
    _os_log_impl(&dword_242505000, v2, OS_LOG_TYPE_INFO, "Received file event for file %@", &v8, 0xCu);
  }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v8 = 138412290;
      v9 = v7;
      _os_log_impl(&dword_242505000, v6, OS_LOG_TYPE_INFO, "Log file has been deleted: %@", &v8, 0xCu);
    }
...
uint64_t __34__DACPLogDFile__beginWatchingFile__block_invoke_22(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v5[0] = 67109120;
    v5[1] = v3;
    _os_log_impl(&dword_242505000, v2, OS_LOG_TYPE_INFO, "Closing FD %d", v5, 8u);
  }
...
- (void)_closeFileWithFileEventDispatchSource:(id)source
{
  ...
  if ((self->_fd & 0x80000000) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 1024;
      v12 = fd;
      _os_log_impl(&dword_242505000, v5, OS_LOG_TYPE_INFO, "Closing file at %@, FD %d", &v9, 0x12u);
    }
...
LABEL_12:
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    buf.st_dev = 67109120;
    *&buf.st_mode = fd;
    _os_log_impl(&dword_242505000, v33, OS_LOG_TYPE_INFO, "FD: %d", &buf, 8u);
  }
...
LABEL_50:
    ...
    else
    {
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *&v51[8] = 2112;
        *&v51[10] = v42;
        _os_log_impl(&dword_242505000, v39, OS_LOG_TYPE_INFO, "Created symlink link: %@. Destination: %@", v50, 0x16u);
      }
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *&v51[16] = v35;
        ...
        v47 = 28;
LABEL_51:
        _os_log_impl(&dword_242505000, v46, OS_LOG_TYPE_ERROR, v41, v50, v47);
        goto LABEL_52;
      }
    }
                ...
                if (v39)
                {
                  ...
                  if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
                  {
                    *buf = 138412802;
                    ...
                    v54 = 2112;
                    v55 = v39;
                    _os_log_impl(&dword_242505000, v42, OS_LOG_TYPE_ERROR, "Could not move compressed file from %@ to %@. Error: %@", buf, 0x20u);
                  }
                }
