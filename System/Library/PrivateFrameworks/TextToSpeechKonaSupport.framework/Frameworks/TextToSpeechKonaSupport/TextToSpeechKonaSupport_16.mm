uint64_t add_tokens(uint64_t a1, uint64_t a2, int a3)
{
  ...
  while (1)
  {
    ...
    v21 = OUTLINED_FUNCTION_21_32(v18, v19, v20);
    if (v22)
    {
      return 0;
    }
...
LABEL_30:
        ...
        v64 = OUTLINED_FUNCTION_1_68();
        OUTLINED_FUNCTION_21_32(v64, v65, inserted);
        if (v22)
        {
          return 0;
        }

        v66 = OUTLINED_FUNCTION_1_68();
...
LABEL_74:
        ...
        if (*(v22 + 68))
        {
          OUTLINED_FUNCTION_11_48(v43, v44, v45, *(*(*(v22 + 40) + 16) + 8 * v52), v46, v47, v48, v49, v91, HIDWORD(v91), v92, v93, v94, v95, HIDWORD(v95), v96, v97);
          v64 = 0;
          while (v64 < rb_lines(*(v22 + 48)))
          {
            ...
            OUTLINED_FUNCTION_3_60();
            v65 = next_abs_split();
            OUTLINED_FUNCTION_8_52(v65, v66, v67, v68, v69, v70, v71, v72, v91, v92, v93, v94, v95, HIDWORD(v95), v96, v97);
            ++v64;
        ...
        {
          OUTLINED_FUNCTION_16_40();
          OUTLINED_FUNCTION_11_48(v74, v75, v76, *(v73 + 8 * *(v22 + 28)), v77, v78, v79, v80, v91, HIDWORD(v91), v92, v93, v94, v95, HIDWORD(v95), v96, v97);
          v81 = 0;
          while (v81 < rb_lines(*(v22 + 56)))
          {
            ...
            OUTLINED_FUNCTION_8_52(ptr_split, v83, v84, v85, v86, v87, v88, v89, v91, v92, v93, v94, v95, HIDWORD(v95), v96, v97);
            ++v81;
            if (checkInterrupt(v35))
            {
              goto LABEL_74;
...
unint64_t update_token(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  if (result)
  {
    ...
    v20 = OUTLINED_FUNCTION_21_32(v18, v19, v16);
    if (v21)
    {
      return 0;
    }
    ...
    else
    {
      ...
      OUTLINED_FUNCTION_21_32(a1, v4, v24);
      return !v21;
    }
  }
...
void OUTLINED_FUNCTION_8_52(int a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, int a6, unsigned int a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, int a13, unsigned int a14, uint64_t a15, uint64_t a16, ...)
{
  va_start(va, a16);
...
void OUTLINED_FUNCTION_11_48(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, unsigned int a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, unsigned int a15, uint64_t a16, uint64_t a17, ...)
{
  va_start(va, a17);
            ...
            while (2)
            {
              if (v201 < v196)
              {
                if (!v89[v201])
                {
                  *&v198 = *(v213 - 1);
                  *&v197 = *(a1 + 604) * *&v198;
                  OUTLINED_FUNCTION_4_57(*&v197 + (*(a1 + 600) * *v213), *(a1 + 608), v197, v198, *(v213 - 2));
                  continue;
                }
...
LABEL_244:
                ...
                *(a1 + 156) = 1;
LABEL_245:
                for (ii = &v195[v201]; ; OUTLINED_FUNCTION_4_57(*&v197 + (v217[3] * *ii), v217[9], v197, v198, *(ii - 2)))
                {
                  if (v201 >= v196)
                  {
                    goto LABEL_252;
...
LABEL_233:
                      ...
                      while (1)
                      {
                        ...
                        *&v198 = *(v211 - 1);
                        *&v197 = *algn_2806C5A0C * *&v198;
                        OUTLINED_FUNCTION_4_57((*algn_2806C5A0C * *&v198) + (*f1d * *v211), *&dword_2806C5A10, v197, v198, *(v211 - 2));
                      }
...
LABEL_14:
  ...
  if (v21)
  {
    ...
    while (1)
    {
      ...
      if (result)
      {
        if (*v26 != 1 || (v29 = OUTLINED_FUNCTION_4_60(), result = vf_puts(v29, v30, " (+)", 1), result))
        {
          v31 = OUTLINED_FUNCTION_4_60();
          v33 = vf_puts(v31, v32, "\n", 1);
          result = 0;
          v25 = (v26 + 16);
          if (v33)
  ...
  while (!feof(*(a1 + 16)))
  {
    ...
    if (dynaBufCurrentChar(a2, 0) == 10)
    {
      ...
      else
      {
        if (v7 != v10)
        {
          v13 = OUTLINED_FUNCTION_2_71();
          dynaBufMoveRel(v13, v14);
        }

        dynaBufAddChar(a2, 32, 0);
        v15 = OUTLINED_FUNCTION_1_76();
