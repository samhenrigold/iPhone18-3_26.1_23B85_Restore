...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityTotalDuration" withFullSignature:{"d", 0}];
  [validationsCopy validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityElapsedDuration" withFullSignature:{"d", 0}];
  [validationsCopy validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityUpdateWithElapsedDuration:" withFullSignature:{"v", "d", 0}];
  [validationsCopy validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityIsLiveContent" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"liveLabel" withFullSignature:{"@", 0}];
}
