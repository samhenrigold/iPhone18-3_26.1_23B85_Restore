...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"BridgeStoreExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityCaptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilitySubtitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityLockupView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityAppPromotionFormattedDateView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.AppPromotionFormattedDateView" hasInstanceMethod:@"accessibilityTextLabel" withFullSignature:{"@", 0}];
}
