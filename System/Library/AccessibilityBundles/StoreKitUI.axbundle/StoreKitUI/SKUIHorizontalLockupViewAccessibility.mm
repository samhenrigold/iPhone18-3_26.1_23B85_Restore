...
LABEL_23:
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v20 = [v19 _accessibilityFindSubviewDescendantsPassingTest:&__block_literal_global_0];
            ...
            {
              v21 = v17;
              v22 = &__block_literal_global_413;
              goto LABEL_22;
            }
            ...
            else
            {
              ...
              {
                v21 = v17;
                v22 = &__block_literal_global_420;
LABEL_22:
              ...
              {
                v21 = v17;
                v22 = &__block_literal_global_425;
                goto LABEL_22;
              }
...
LABEL_24:
            ...
            v8 = [(SKUIHorizontalLockupViewAccessibility *)self isAdvertisementView:v47]| v49;
            v16 = v48 + 1;
          }
...
- (id)_accessibilityHitTest:(CGPoint)test withEvent:(id)event
{
  ...
  v19.receiver = self;
  v19.super_class = SKUIHorizontalLockupViewAccessibility;
  v17 = [(SKUIHorizontalLockupViewAccessibility *)&v19 _accessibilityHitTest:eventCopy withEvent:x, y];
LABEL_13:
        ...
        if (v16)
        {
          ...
          do
          {
            for (i = 0; i != v17; ++i)
            {
              ...
              v21 = [(SKUIHorizontalLockupViewAccessibility *)self safeValueForKey:v9];
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0 && v21)
              {
                ...
                v25 = accessibilitySKUILocalizedString(@"preview.button");
        ...
        if (v18)
        {
          ...
          do
          {
            for (i = 0; i != v19; ++i)
            {
              ...
              if ([v22 isAccessibilityElement] && (NSClassFromString(&cfstr_Skuistyledimag_0.isa), (objc_opt_isKindOfClass() & 1) != 0))
              {
                if ([v22 _accessibilityViewIsVisible])
                {
                  if (![(SKUIHorizontalLockupViewAccessibility *)self isAdvertisementView:v22]|| (v23 = _AXSAutomationEnabled(), v24 = @"Ad", !v23))
                  {
...
LABEL_28:
              ...
              {
                objc_opt_class();
                if (objc_opt_isKindOfClass() & 1) != 0 && ([v22 isAccessibilityElement] & 1) != 0 || (NSClassFromString(&cfstr_Skuiofferview.isa), (objc_opt_isKindOfClass()))
                {
                  [array addObject:v22];
                }
