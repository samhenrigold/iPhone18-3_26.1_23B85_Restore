...
- (id)_accessibilitySupplementaryFooterViewsForThisCell:(BOOL)cell includeText:(BOOL)text
{
  ...
  array = [(SKUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityValueForKey:*MEMORY[0x29EDC7620]];
  if (!array)
  {
    array = [MEMORY[0x29EDB8DE8] array];
    v8 = [(SKUIVerticalLockupCollectionViewCellAccessibility *)self safeValueForKey:@"_lockupView"];
    ...
    [(SKUIVerticalLockupCollectionViewCellAccessibility *)selfCopy _accessibilitySetRetainedValue:array forKey:*MEMORY[0x29EDC7620]];
  }
...
- (id)_accessibilityHitTest:(CGPoint)test withEvent:(id)event
{
  ...
  v19.receiver = self;
  v19.super_class = SKUIVerticalLockupCollectionViewCellAccessibility;
  v14 = [(SKUIVerticalLockupCollectionViewCellAccessibility *)&v19 _accessibilityHitTest:eventCopy withEvent:x, y];
LABEL_14:
