...
- (CGPoint)accessibilityActivationPoint
{
  ...
  {
    v11.receiver = self;
    v11.super_class = SKUICardViewElementCollectionViewCellAccessibility;
...
{
  v3.receiver = self;
  v3.super_class = SKUICardViewElementCollectionViewCellAccessibility;
  return *MEMORY[0x29EDC7F70] | [(SKUICardViewElementCollectionViewCellAccessibility *)&v3 accessibilityTraits];
}
