...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"SKUIPhysicalCirclesView" hasInstanceVariable:@"_circleBodies" withType:"NSMutableArray"];
  [validationsCopy validateClass:@"SKUIPhysicalCirclesView" hasInstanceMethod:@"delegate" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"SKUIPhysicalCirclesView" hasInstanceMethod:@"removeCircleAtIndex: animated: completionBlock:" withFullSignature:{"v", "q", "B", "@?", 0}];
  [validationsCopy validateClass:@"SKUIPhysicalCirclesView" hasInstanceMethod:@"_reloadDidFinish" withFullSignature:{"v", 0}];
  [validationsCopy validateProtocol:@"SKUIPhysicalCirclesDelegate" hasOptionalInstanceMethod:@"circleView:didTapCircleAtIndex:"];
  ...
  [validationsCopy validateClass:@"SKUIOnboardingAffiliationCirclesViewController"];
  [validationsCopy validateClass:@"SKUIOnboardingAffiliationCirclesViewController" hasInstanceMethod:@"_completeDeletionForCircleAtIndex:" withFullSignature:{"v", "q", 0}];
  [validationsCopy validateClass:@"SKUIOnboardingAffiliationCirclesViewController" hasInstanceVariable:@"_affiliationItems" withType:"NSMutableArray"];
  [validationsCopy validateClass:@"SKUIOnboardingAffiliationItem"];
  [validationsCopy validateClass:@"SKUIOnboardingAffiliationItem" hasInstanceMethod:@"userAffinityCount" withFullSignature:{"q", 0}];
}
...
- (id)_accessibilityValueForCircle:(id)circle
{
  ...
  v8 = [v7 objectAtIndex:{-[SKUIPhysicalCirclesViewAccessibility _accessibilityIndexOfCircle:](self, "_accessibilityIndexOfCircle:", circleCopy)}];
...
- (id)accessibilityElementAtIndex:(int64_t)index
{
  _accessibilityCircleBodies = [(SKUIPhysicalCirclesViewAccessibility *)self _accessibilityCircleBodies];
...
- (BOOL)accessibilityScroll:(int64_t)scroll
{
  ...
  v10 = [(SKUIPhysicalCirclesViewAccessibility *)self _accessibilityPushingScrollStatusInDirection:scroll];
...
- (id)_accessibilityPushingScrollStatusInDirection:(int64_t)direction
{
  ...
  {
    v4 = accessibilitySKUILocalizedString(off_29F3043D0[direction - 1]);
  }
...
- (void)removeCircleAtIndex:(int64_t)index animated:(BOOL)animated completionBlock:(id)block
{
  ...
  blockCopy = block;
  v9 = [(SKUIPhysicalCirclesViewAccessibility *)self accessibilityElementAtIndex:index];
  ...
  v14.receiver = self;
  v14.super_class = SKUIPhysicalCirclesViewAccessibility;
  [(SKUIPhysicalCirclesViewAccessibility *)&v14 removeCircleAtIndex:index animated:animatedCopy completionBlock:blockCopy];
...
- (id)_accessibilityValueForAffinityCount:(int64_t)count
{
  ...
  {
    v4 = accessibilitySKUILocalizedString(off_29F3043F0[count]);
  }
