...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityArtworkView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferSubtitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDownloadProgressLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferTitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferSubtitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferTopLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDescriptionHeaderLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTextualBadges" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityStandardBadges" withFullSignature:{"@", 0}];
}
