...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityArtworkView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDeveloperLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferSubtitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDownloadProgressLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferTitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferSubtitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [validationsCopy validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVideoView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.VideoView" hasInstanceMethod:@"accessibilityPlayButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.VideoView" hasInstanceMethod:@"accessibilityPlayerViewController" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.VideoView" hasInstanceMethod:@"accessibilityIsPlaying" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.VideoView" hasInstanceMethod:@"accessibilityShouldBePlaying" withFullSignature:{"B", 0}];
}
