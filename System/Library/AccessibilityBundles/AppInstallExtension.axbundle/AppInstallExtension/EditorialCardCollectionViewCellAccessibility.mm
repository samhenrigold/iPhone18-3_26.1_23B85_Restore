...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppInstallExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityCaptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilitySubtitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityLockupView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.EditorialCardCollectionViewCell" hasInstanceMethod:@"accessibilityAppPromotionFormattedDateView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.AppPromotionFormattedDateView" hasInstanceMethod:@"accessibilityTextLabel" withFullSignature:{"@", 0}];
}
