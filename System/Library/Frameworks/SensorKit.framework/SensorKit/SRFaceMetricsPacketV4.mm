...
- (NSArray)wholeFaceExpressions
{
  ...
  v4[1] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"1F26EABE-8350-48C5-97F0-06EFD6FEC6C4" value:self->_packet->var18.var0.var0, [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"E24480FE-8ECF-412C-8A02-3E924971A840" value:self->_packet->var17.var50]];
