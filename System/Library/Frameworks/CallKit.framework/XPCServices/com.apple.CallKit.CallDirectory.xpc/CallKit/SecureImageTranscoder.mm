...
- (_TtC31com_apple_CallKit_CallDirectory21SecureImageTranscoder)init
{
  ...
  *(&self->super.isa + OBJC_IVAR____TtC31com_apple_CallKit_CallDirectory21SecureImageTranscoder_warmUpGIFBytes) = &off_1000351F8;
  v4 = BlastDoorInstanceTypeKnownSender;
  v5 = sub_100023894();
  v6 = objc_allocWithZone(v5);
  v7 = v4;
  v8 = sub_100023884();
  v9 = (self + OBJC_IVAR____TtC31com_apple_CallKit_CallDirectory21SecureImageTranscoder_blastDoor);
  v9[3] = v5;
  v9[4] = &off_1000352C0;
  *v9 = v8;
  v12.receiver = self;
...
- (void)generatePreviewImageFrom:(NSData *)from completionHandler:(id)handler
{
  v7 = sub_100014320(&qword_10003C700, &qword_100028730);
