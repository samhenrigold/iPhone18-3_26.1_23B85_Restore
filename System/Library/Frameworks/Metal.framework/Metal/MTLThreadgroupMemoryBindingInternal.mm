...
- (MTLThreadgroupMemoryBindingInternal)initWithName:(id)name type:(unint64_t)type access:(unint64_t)access isActive:(BOOL)active locationIndex:(unint64_t)index arraySize:(unint64_t)size dataType:(unint64_t)dataType dataSize:(unint64_t)self0 alignment:(unint64_t)self1;
...
{
  v15.receiver = self;
  v15.super_class = MTLThreadgroupMemoryBindingInternal;
...
- (id)formattedDescription:(unint64_t)description
{
  ...
  v9.receiver = self;
  v9.super_class = MTLThreadgroupMemoryBindingInternal;
