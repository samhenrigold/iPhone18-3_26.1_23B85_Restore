...
- (CTXPCDeactivateCrossPlatformTransportRequest)initWithEndpoint:(unint64_t)endpoint;
- (unint64_t)endpoint;
...
- (CTXPCDeactivateCrossPlatformTransportRequest)initWithEndpoint:(unint64_t)endpoint
{
  ...
  v8.receiver = self;
  v8.super_class = CTXPCDeactivateCrossPlatformTransportRequest;
...
- (void)performRequestWithHandler:(id)handler completionHandler:(id)completionHandler
{
  ...
  endpoint = [(CTXPCDeactivateCrossPlatformTransportRequest *)self endpoint];
  ...
  v11 = v9;
  [handlerCopy deactivateCrossPlatformTransport:endpoint completion:v10];
}
