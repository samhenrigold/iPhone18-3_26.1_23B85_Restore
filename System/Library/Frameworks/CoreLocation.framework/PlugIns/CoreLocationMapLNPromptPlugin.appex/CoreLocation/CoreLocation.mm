...
uint64_t *sub_100007EE8(uint64_t *result, const void *a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
__n128 sub_1000080C4(unint64_t a1, __n128 *a2, uint64_t a3, char a4, __n128 result)
{
LABEL_1:
  v9 = a2 - 2;
  v10 = a2 - 4;
...
LABEL_58:
    ...
    if ((a4 & 1) != 0 || *(v12 - 32) < v64)
    {
      ...
      *(v12 - 24) = v152;
      ...
      {
LABEL_79:
        result = sub_1000080C4(a1, (v12 - 32), a3, a4 & 1, result);
        a4 = 0;
      }
    }
...
uint64_t *sub_1000092C4(uint64_t *result, const void *a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
