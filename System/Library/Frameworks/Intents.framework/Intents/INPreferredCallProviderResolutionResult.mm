...
+ (id)confirmationRequiredWithPreferredCallProviderToConfirm:(int64_t)confirm;
+ (id)successWithResolvedPreferredCallProvider:(int64_t)provider;
...
+ (id)confirmationRequiredWithPreferredCallProviderToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INPreferredCallProviderUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedPreferredCallProvider:(int64_t)provider
{
  ...
  {
    NSLog(@"Success resolution with INPreferredCallProviderUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 73)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7281D58[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 73)
  {
