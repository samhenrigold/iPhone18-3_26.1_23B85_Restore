...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 54)
  {
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 54)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToPaymentMethodValue(*(*(&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      v10 = INIntentSlotValueTransformToPaymentMethodValue(objectCopy);
      if (v10)
      {
