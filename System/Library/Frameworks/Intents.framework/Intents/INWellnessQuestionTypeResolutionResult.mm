...
+ (id)confirmationRequiredWithWellnessQuestionTypeToConfirm:(int64_t)confirm;
+ (id)successWithResolvedWellnessQuestionType:(int64_t)type;
...
+ (id)confirmationRequiredWithWellnessQuestionTypeToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INWellnessQuestionTypeUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedWellnessQuestionType:(int64_t)type
{
  ...
  {
    NSLog(@"Success resolution with INWellnessQuestionTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 177)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7282F30[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 177)
  {
