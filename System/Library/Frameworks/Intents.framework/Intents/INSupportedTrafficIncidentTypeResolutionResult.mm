...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 229)
  {
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 229)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToSupportedTrafficIncidentType(*(*(&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      v10 = INIntentSlotValueTransformToSupportedTrafficIncidentType(objectCopy);
      if (v10)
      {
