...
- (_INPBInteger)initWithCoder:(id)coder;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    values = [(_INPBInteger *)self values];
    values2 = [equalCopy values];
    v7 = values2;
    if ((values != 0) != (values2 == 0))
    {
      values3 = [(_INPBInteger *)self values];
      if (!values3)
      {
...
LABEL_10:
      ...
      v9 = values3;
      values4 = [(_INPBInteger *)self values];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBInteger allocWithZone:](_INPBInteger init];
...
- (_INPBInteger)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBInteger *)self initWithData:selfCopy];
