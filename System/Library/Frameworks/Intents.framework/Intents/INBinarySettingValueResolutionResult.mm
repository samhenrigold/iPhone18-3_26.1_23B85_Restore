...
+ (id)confirmationRequiredWithBinarySettingValueToConfirm:(int64_t)confirm;
+ (id)successWithResolvedBinarySettingValue:(int64_t)value;
...
+ (id)confirmationRequiredWithBinarySettingValueToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INBinarySettingValueUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedBinarySettingValue:(int64_t)value
{
  ...
  {
    NSLog(@"Success resolution with INBinarySettingValueUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 234)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = *(&off_1E7287C40 + integerValue - 1);
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 234)
  {
