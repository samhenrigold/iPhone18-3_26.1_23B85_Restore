...
+ (id)confirmationRequiredWithTimerStateToConfirm:(int64_t)confirm;
+ (id)successWithResolvedTimerState:(int64_t)state;
...
+ (id)confirmationRequiredWithTimerStateToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INTimerStateUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedTimerState:(int64_t)state
{
  ...
  {
    NSLog(@"Success resolution with INTimerStateUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 190)
  {
