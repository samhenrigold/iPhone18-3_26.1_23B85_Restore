...
+ (id)confirmationRequiredWithBoundedSettingValueToConfirm:(int64_t)confirm;
+ (id)successWithResolvedBoundedSettingValue:(int64_t)value;
...
+ (id)confirmationRequiredWithBoundedSettingValueToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INBoundedSettingValueUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedBoundedSettingValue:(int64_t)value
{
  ...
  {
    NSLog(@"Success resolution with INBoundedSettingValueUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 235)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7287E78[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 235)
  {
