...
- (_INPBIntegerList)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  conditionType = [(_INPBIntegerList *)self conditionType];
...
- (BOOL)isEqual:(id)equal
{
  ...
  conditionType3 = [(_INPBIntegerList *)self conditionType];
  if (conditionType3)
  {
    v8 = conditionType3;
    conditionType4 = [(_INPBIntegerList *)self conditionType];
  ...
  conditionType = [(_INPBIntegerList *)self dataStrings];
  conditionType2 = [equalCopy dataStrings];
  if ((conditionType != 0) != (conditionType2 == 0))
  {
    dataStrings = [(_INPBIntegerList *)self dataStrings];
    if (!dataStrings)
    {
...
LABEL_15:
    ...
    v13 = dataStrings;
    dataStrings2 = [(_INPBIntegerList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBIntegerList allocWithZone:](_INPBIntegerList init];
...
{
  coderCopy = coder;
  data = [(_INPBIntegerList *)self data];
...
- (_INPBIntegerList)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBIntegerList *)self initWithData:selfCopy];
...
- (void)writeTo:(id)to
{
  ...
  if (conditionType)
  {
    conditionType2 = [(_INPBIntegerList *)self conditionType];
