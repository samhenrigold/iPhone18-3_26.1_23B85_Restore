...
+ (INCallCapabilityResolutionResult)confirmationRequiredWithCallCapabilityToConfirm:(INCallCapability)callCapabilityToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INCallCapabilityUnknown is not supported." userInfo:0];
...
+ (INCallCapabilityResolutionResult)successWithResolvedCallCapability:(INCallCapability)resolvedCallCapability
{
  ...
  {
    NSLog(@"Success resolution with INCallCapabilityUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 69)
  {
