...
+ (id)confirmationRequiredWithMessageEffectToConfirm:(int64_t)confirm;
+ (id)successWithResolvedMessageEffect:(int64_t)effect;
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 88)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7286988[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 88)
  {
