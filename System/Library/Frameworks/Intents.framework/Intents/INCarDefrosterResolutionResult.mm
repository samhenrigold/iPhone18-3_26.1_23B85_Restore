...
+ (INCarDefrosterResolutionResult)confirmationRequiredWithCarDefrosterToConfirm:(INCarDefroster)carDefrosterToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INCarDefrosterUnknown is not supported." userInfo:0];
...
+ (INCarDefrosterResolutionResult)successWithResolvedCarDefroster:(INCarDefroster)resolvedCarDefroster
{
  ...
  {
    NSLog(@"Success resolution with INCarDefrosterUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 122)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7282658[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 122)
  {
