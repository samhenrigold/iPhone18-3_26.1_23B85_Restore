...
+ (INRelativeReferenceResolutionResult)confirmationRequiredWithRelativeReferenceToConfirm:(INRelativeReference)relativeReferenceToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INRelativeReferenceUnknown is not supported." userInfo:0];
...
+ (INRelativeReferenceResolutionResult)successWithResolvedRelativeReference:(INRelativeReference)resolvedRelativeReference
{
  ...
  {
    NSLog(@"Success resolution with INRelativeReferenceUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 124)
  {
