...
- (INOpenSettingIntentResponse)initWithBackingStore:(id)store;
- (INOpenSettingIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
- (INOpenSettingIntentResponse)initWithCoder:(id)coder;
...
- (void)setPunchoutUrl:(id)url
{
  urlCopy = url;
  _responseMessagePBRepresentation = [(INIntentResponse *)self _responseMessagePBRepresentation];
  [_responseMessagePBRepresentation setPunchoutUrl:urlCopy];
...
{
  nameCopy = name;
  [nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeUnspecified"];
  v4 = [nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeReady"];
  if ([nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeInProgress"])
  {
    v4 = 2;
  }

  if ([nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeSuccess"])
  {
    v4 = 3;
  }

  if ([nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeFailure"])
  {
    v4 = 4;
  }

  if ([nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeFailureRequiringAppLaunch"])
  {
    v4 = 5;
  }

  if ([nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeFailureSettingUnsupported"])
  {
    v4 = 6;
  }

  if ([nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeFailureSettingNotFound"])
  {
    v5 = 7;
  }
  ...
  v6 = [nameCopy isEqualToString:@"INOpenSettingIntentResponseCodeFailureOtherWithReason"];
