...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 80)
  {
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 80)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToCallGroupConversation(*(*(&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      v10 = INIntentSlotValueTransformToCallGroupConversation(objectCopy);
      if (v10)
      {
