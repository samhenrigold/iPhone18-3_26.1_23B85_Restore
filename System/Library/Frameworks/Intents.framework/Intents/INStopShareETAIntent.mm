...
- (INStopShareETAIntent)initWithRecipients:(id)recipients;
- (NSArray)recipients;
...
{
  idCopy = id;
  _typedBackingStore = [(INStopShareETAIntent *)self _typedBackingStore];
  v11 = idCopy;
...
- (INStopShareETAIntent)initWithRecipients:(id)recipients
{
  recipientsCopy = recipients;
  v8.receiver = self;
  v8.super_class = INStopShareETAIntent;
  v5 = [(INIntent *)&v8 init];
  v6 = v5;
  if (v5)
  {
    [(INStopShareETAIntent *)v5 setRecipients:recipientsCopy];
  }
