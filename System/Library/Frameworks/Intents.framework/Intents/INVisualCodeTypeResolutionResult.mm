...
+ (INVisualCodeTypeResolutionResult)confirmationRequiredWithVisualCodeTypeToConfirm:(INVisualCodeType)visualCodeTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INVisualCodeTypeUnknown is not supported." userInfo:0];
...
+ (INVisualCodeTypeResolutionResult)successWithResolvedVisualCodeType:(INVisualCodeType)resolvedVisualCodeType
{
  ...
  {
    NSLog(@"Success resolution with INVisualCodeTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 114)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E72822F0[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 114)
  {
