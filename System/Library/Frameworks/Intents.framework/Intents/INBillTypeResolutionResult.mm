...
+ (INBillTypeResolutionResult)confirmationRequiredWithBillTypeToConfirm:(INBillType)billTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INBillTypeUnknown is not supported." userInfo:0];
...
+ (INBillTypeResolutionResult)successWithResolvedBillType:(INBillType)resolvedBillType
{
  ...
  {
    NSLog(@"Success resolution with INBillTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 57)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7280DF0[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 57)
  {
