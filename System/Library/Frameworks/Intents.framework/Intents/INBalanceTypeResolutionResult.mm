...
+ (INBalanceTypeResolutionResult)confirmationRequiredWithBalanceTypeToConfirm:(INBalanceType)balanceTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INBalanceTypeUnknown is not supported." userInfo:0];
...
+ (INBalanceTypeResolutionResult)successWithResolvedBalanceType:(INBalanceType)resolvedBalanceType
{
  ...
  {
    NSLog(@"Success resolution with INBalanceTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 64)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E727F950[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 64)
  {
