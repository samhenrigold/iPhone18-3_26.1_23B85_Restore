...
- (_INPBBool)initWithCoder:(id)coder;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    values = [(_INPBBool *)self values];
    values2 = [equalCopy values];
    v7 = values2;
    if ((values != 0) != (values2 == 0))
    {
      values3 = [(_INPBBool *)self values];
      if (!values3)
      {
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBBool allocWithZone:](_INPBBool init];
...
- (_INPBBool)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBBool *)self initWithData:selfCopy];
