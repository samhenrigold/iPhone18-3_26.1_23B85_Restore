...
- (INSetRadioStationIntentResponse)initWithCode:(INSetRadioStationIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  {
    v8 = v7;
    if (code > INSetRadioStationIntentResponseCodeFailureNotSubscribed)
    {
      v9 = 0;
    }
    ...
    {
      v9 = off_1E727E218[code];
    }

    v10 = v9;
    *buf = 136315906;
    v15 = "[INSetRadioStationIntentResponse initWithCode:userActivity:]";
    v16 = 2048;
    v17 = code;
    v18 = 2112;
    v19 = v10;
  ...
  v13.receiver = self;
  v13.super_class = INSetRadioStationIntentResponse;
