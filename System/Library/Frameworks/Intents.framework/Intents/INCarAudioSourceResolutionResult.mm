...
+ (INCarAudioSourceResolutionResult)confirmationRequiredWithCarAudioSourceToConfirm:(INCarAudioSource)carAudioSourceToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INCarAudioSourceUnknown is not supported." userInfo:0];
...
+ (INCarAudioSourceResolutionResult)successWithResolvedCarAudioSource:(INCarAudioSource)resolvedCarAudioSource
{
  ...
  {
    NSLog(@"Success resolution with INCarAudioSourceUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 121)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = *(&off_1E727E498 + integerValue - 1);
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 121)
  {
