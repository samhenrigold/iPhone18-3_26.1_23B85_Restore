...
+ (INOutgoingMessageTypeResolutionResult)confirmationRequiredWithOutgoingMessageTypeToConfirm:(INOutgoingMessageType)outgoingMessageTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INOutgoingMessageTypeUnknown is not supported." userInfo:0];
...
+ (INOutgoingMessageTypeResolutionResult)successWithResolvedOutgoingMessageType:(INOutgoingMessageType)resolvedOutgoingMessageType
{
  ...
  {
    NSLog(@"Success resolution with INOutgoingMessageTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 90)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (integerValue == 2)
      {
        v10 = @"outgoingMessageAudio";
      }

      if (integerValue == 1)
      {
        v10 = @"outgoingMessageText";
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 90)
  {
