...
+ (INRadioTypeResolutionResult)confirmationRequiredWithRadioTypeToConfirm:(INRadioType)radioTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INRadioTypeUnknown is not supported." userInfo:0];
...
+ (INRadioTypeResolutionResult)successWithResolvedRadioType:(INRadioType)resolvedRadioType
{
  ...
  {
    NSLog(@"Success resolution with INRadioTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 149)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E727FE08[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 149)
  {
