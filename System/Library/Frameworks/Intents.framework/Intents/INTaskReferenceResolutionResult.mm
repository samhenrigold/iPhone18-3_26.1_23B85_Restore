...
+ (id)confirmationRequiredWithTaskReferenceToConfirm:(int64_t)confirm;
+ (id)successWithResolvedTaskReference:(int64_t)reference;
...
+ (id)confirmationRequiredWithTaskReferenceToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INTaskReferenceUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedTaskReference:(int64_t)reference
{
  ...
  {
    NSLog(@"Success resolution with INTaskReferenceUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 136)
  {
