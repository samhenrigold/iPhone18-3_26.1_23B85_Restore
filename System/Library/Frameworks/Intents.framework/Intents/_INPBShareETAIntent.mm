...
- (_INPBShareETAIntent)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  intentMetadata = [(_INPBShareETAIntent *)self intentMetadata];
...
- (BOOL)isEqual:(id)equal
{
  ...
  intentMetadata3 = [(_INPBShareETAIntent *)self intentMetadata];
  if (intentMetadata3)
  {
    v8 = intentMetadata3;
    intentMetadata4 = [(_INPBShareETAIntent *)self intentMetadata];
  ...
  intentMetadata = [(_INPBShareETAIntent *)self recipients];
  intentMetadata2 = [equalCopy recipients];
  if ((intentMetadata != 0) != (intentMetadata2 == 0))
  {
    recipients = [(_INPBShareETAIntent *)self recipients];
    if (!recipients)
    {
...
LABEL_15:
    ...
    v13 = recipients;
    recipients2 = [(_INPBShareETAIntent *)self recipients];
...
{
  coderCopy = coder;
  data = [(_INPBShareETAIntent *)self data];
...
- (_INPBShareETAIntent)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBShareETAIntent *)self initWithData:selfCopy];
...
- (void)writeTo:(id)to
{
  ...
  if (intentMetadata)
  {
    intentMetadata2 = [(_INPBShareETAIntent *)self intentMetadata];
