...
+ (INAccountTypeResolutionResult)confirmationRequiredWithAccountTypeToConfirm:(INAccountType)accountTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INAccountTypeUnknown is not supported." userInfo:0];
...
+ (INAccountTypeResolutionResult)successWithResolvedAccountType:(INAccountType)resolvedAccountType
{
  ...
  {
    NSLog(@"Success resolution with INAccountTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 63)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7280DB8[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 63)
  {
