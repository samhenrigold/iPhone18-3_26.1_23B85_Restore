...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 138)
  {
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 138)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToSpatialEventTrigger(*(*(&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      v10 = INIntentSlotValueTransformToSpatialEventTrigger(objectCopy);
      if (v10)
      {
