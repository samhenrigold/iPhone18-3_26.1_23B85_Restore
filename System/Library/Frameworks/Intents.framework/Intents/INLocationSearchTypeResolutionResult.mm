...
+ (INLocationSearchTypeResolutionResult)confirmationRequiredWithLocationSearchTypeToConfirm:(INLocationSearchType)locationSearchTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INLocationSearchTypeUnknown is not supported." userInfo:0];
...
+ (INLocationSearchTypeResolutionResult)successWithResolvedLocationSearchType:(INLocationSearchType)resolvedLocationSearchType
{
  ...
  {
    NSLog(@"Success resolution with INLocationSearchTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 127)
  {
