...
- (_INPBLongList)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  conditionType = [(_INPBLongList *)self conditionType];
...
- (BOOL)isEqual:(id)equal
{
  ...
  conditionType3 = [(_INPBLongList *)self conditionType];
  if (conditionType3)
  {
    v8 = conditionType3;
    conditionType4 = [(_INPBLongList *)self conditionType];
  ...
  conditionType = [(_INPBLongList *)self dataStrings];
  conditionType2 = [equalCopy dataStrings];
  if ((conditionType != 0) != (conditionType2 == 0))
  {
    dataStrings = [(_INPBLongList *)self dataStrings];
    if (!dataStrings)
    {
...
LABEL_15:
    ...
    v13 = dataStrings;
    dataStrings2 = [(_INPBLongList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBLongList allocWithZone:](_INPBLongList init];
...
- (_INPBLongList)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBLongList *)self initWithData:selfCopy];
...
- (void)writeTo:(id)to
{
  ...
  if (conditionType)
  {
    conditionType2 = [(_INPBLongList *)self conditionType];
