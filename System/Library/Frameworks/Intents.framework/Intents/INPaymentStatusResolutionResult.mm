...
+ (INPaymentStatusResolutionResult)confirmationRequiredWithPaymentStatusToConfirm:(INPaymentStatus)paymentStatusToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INPaymentStatusUnknown is not supported." userInfo:0];
...
+ (INPaymentStatusResolutionResult)successWithResolvedPaymentStatus:(INPaymentStatus)resolvedPaymentStatus
{
  ...
  {
    NSLog(@"Success resolution with INPaymentStatusUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 58)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = *(&off_1E727E730 + integerValue - 1);
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 58)
  {
