...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 175)
  {
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 175)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToWellnessMetadataPair(*(*(&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      v10 = INIntentSlotValueTransformToWellnessMetadataPair(objectCopy);
      if (v10)
      {
