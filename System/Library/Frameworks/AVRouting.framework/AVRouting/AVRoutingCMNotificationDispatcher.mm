...
void *__93__AVRoutingCMNotificationDispatcher_addListenerWithWeakReference_callback_name_object_flags___block_invoke_2(uint64_t a1, void *a2)
{
...
void __107__AVRoutingCMNotificationDispatcher__copyAndRemoveObserverForWeakReferenceToListener_callback_name_object___block_invoke(void *a1)
{
  v2 = [AVRoutingCMNotificationDispatcherListenerKey listenerKeyWithWeakReferenceToListener:a1[4] callback:a1[7] name:a1[8] object:a1[9]];
  ...
  else
  {
    ...
    v14 = a1[9];
    v12 = a1[7];
    v11 = AVMethodExceptionReasonWithObjectAndSelector(a1[5], a1[10], @"Cannot remove a listener %@ (callback %p) for %@ from object %p that was never added.  Break on AVRoutingCMNotificationDispatcherUnbalancedUnregistrationBreak() to debug.", v4, v5, v6, v7, v8, a1[4]);
