...
- (NINearbyAccessoryConfiguration)initWithAccessoryData:(NSData *)accessoryData bluetoothPeerIdentifier:(NSUUID *)identifier error:(NSError *)error
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"NIConfiguration.mm" lineNumber:747 description:{@"Invalid parameter not satisfying: %@", @"accessoryData"}];
  ...
  [currentHandler2 handleFailureInMethod:a2 object:self file:@"NIConfiguration.mm" lineNumber:748 description:{@"Invalid parameter not satisfying: %@", @"identifier"}];
...
- (NINearbyAccessoryConfiguration)initWithDataExchangeDisabledAndUsingParameterOverrides:(id)overrides
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"NIConfiguration.mm" lineNumber:769 description:{@"Invalid parameter not satisfying: %@", @"parameterOverrides"}];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  {
    v10 = [objc_msgSend(MEMORY[0x1E695DF20] allocWithZone:{zone), "initWithDictionary:copyItems:", self->_debugParameters, 1}];
    v11 = v5[8];
    v5[8] = v10;
  }
