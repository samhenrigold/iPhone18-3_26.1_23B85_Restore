...
- (id)populateOrderedInputFeature
{
  v3 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@"%d, %f, %f, %d, %.3f, %.3f", self->_antennaMask, *&self->_timestamp, *&self->_uwbTime, self->_tofPicSecond, *&self->_rssiDbm, *&self->_soiRssiDbm];
