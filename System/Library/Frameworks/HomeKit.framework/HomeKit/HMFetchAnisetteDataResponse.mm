...
- (HMFetchAnisetteDataResponse)initWithCoder:(id)coder;
...
- (NSString)description
{
  ...
  anisetteData = [(HMFetchAnisetteDataResponse *)self anisetteData];
  v6 = [v3 stringWithFormat:@"[HMFetchAnisetteDataResponse: %@, anisette-data %@]", v4, anisetteData];
...
- (NSDictionary)messagePayload
{
  ...
  messageName = [(HMFetchAnisetteDataResponse *)self messageName];
  v7 = messageName;
  v8[0] = v3;
...
+ (id)objWithMessage:(id)message
{
  ...
  v6 = [messagePayload hmf_dataForKey:@"kHMFetchAnisetteDataResponse"];
...
+ (id)objWithDict:(id)dict
{
  ...
  dictCopy = dict;
  v5 = [dictCopy hmf_dataForKey:@"kHMFetchAnisetteDataResponse"];
  v13 = 0;
