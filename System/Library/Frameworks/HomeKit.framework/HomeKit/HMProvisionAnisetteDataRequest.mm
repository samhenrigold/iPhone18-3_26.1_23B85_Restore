...
- (NSString)description
{
  ...
  v6.receiver = self;
  v6.super_class = HMProvisionAnisetteDataRequest;
...
- (NSDictionary)messagePayload
{
  ...
  messageName = [(HMProvisionAnisetteDataRequest *)self messageName];
  v7 = messageName;
  v8[0] = v3;
...
+ (id)objWithMessage:(id)message
{
  ...
  v6 = [messagePayload hmf_dataForKey:@"kHMProvisionAnisetteDataRequest"];
...
+ (id)objWithDict:(id)dict
{
  ...
  dictCopy = dict;
  v5 = [dictCopy hmf_dataForKey:@"kHMProvisionAnisetteDataRequest"];
  v13 = 0;
