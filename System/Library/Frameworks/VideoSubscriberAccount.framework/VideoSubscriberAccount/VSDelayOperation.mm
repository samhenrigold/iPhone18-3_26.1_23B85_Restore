...
- (void)executionDidBegin
{
  ...
  v16[1] = 3221225472;
  v16[2] = __37__VSDelayOperation_executionDidBegin__block_invoke_15;
  v16[3] = &unk_278B74110;
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    *buf = 138412290;
    selfCopy = self;
    _os_log_impl(&dword_23AB8E000, v15, OS_LOG_TYPE_DEFAULT, "Delay operation timer will begin %@", buf, 0xCu);
  }
...
void __37__VSDelayOperation_executionDidBegin__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    v3 = VSDefaultLogObject(WeakRetained);
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      v4 = 138412290;
      v5 = v2;
      _os_log_impl(&dword_23AB8E000, v3, OS_LOG_TYPE_DEFAULT, "Delay operation timer did fire %@", &v4, 0xCu);
    }
...
void __37__VSDelayOperation_executionDidBegin__block_invoke_15(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      v4 = 138412290;
      v5 = v2;
      _os_log_impl(&dword_23AB8E000, v3, OS_LOG_TYPE_DEFAULT, "Delay operation timer cancelled %@", &v4, 0xCu);
    }
