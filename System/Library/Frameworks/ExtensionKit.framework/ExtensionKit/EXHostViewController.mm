...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  {
    [(EXHostViewController *)self embedViewController:remoteViewController];
  }
  ...
  else
  {
    ...
    [(EXHostViewController *)self embedViewController:sceneViewController];
  }

  v9.receiver = self;
  v9.super_class = EXHostViewController;
  [(EXHostViewController *)&v9 viewWillAppear:appearCopy];
}
...
- (void)viewDidDisappear:(BOOL)disappear
{
  v3.receiver = self;
  v3.super_class = EXHostViewController;
  [(EXHostViewController *)&v3 viewDidDisappear:disappear];
}
