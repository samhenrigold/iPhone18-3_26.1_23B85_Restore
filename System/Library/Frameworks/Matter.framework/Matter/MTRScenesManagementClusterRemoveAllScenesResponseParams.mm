...
- (MTRScenesManagementClusterRemoveAllScenesResponseParams)initWithDecodableStruct:(const DecodableType *)struct;
- (MTRScenesManagementClusterRemoveAllScenesResponseParams)initWithResponseValue:(id)value error:(id *)error;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  status = [(MTRScenesManagementClusterRemoveAllScenesResponseParams *)self status];
  [(MTRScenesManagementClusterRemoveAllScenesResponseParams *)v4 setStatus:status];

  groupID = [(MTRScenesManagementClusterRemoveAllScenesResponseParams *)self groupID];
  [(MTRScenesManagementClusterRemoveAllScenesResponseParams *)v4 setGroupID:groupID];
...
- (MTRScenesManagementClusterRemoveAllScenesResponseParams)initWithDecodableStruct:(const DecodableType *)struct
{
  ...
  if (v4)
  {
    v6 = [(MTRScenesManagementClusterRemoveAllScenesResponseParams *)v4 _setFieldsFromDecodableStruct:struct];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
