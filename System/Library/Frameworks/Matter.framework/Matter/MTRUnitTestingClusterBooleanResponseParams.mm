...
{
  v7.receiver = self;
  v7.super_class = MTRUnitTestingClusterBooleanResponseParams;
...
- (MTRUnitTestingClusterBooleanResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  v6 = responseValue;
  v15.receiver = self;
  v15.super_class = MTRUnitTestingClusterBooleanResponseParams;
  v7 = [(MTRUnitTestingClusterBooleanResponseParams *)&v15 init];
  if (!v7)
  {
    v10 = 0;
    goto LABEL_10;
  ...
  if (v14)
  {
    ...
    if (!v8)
    {
      ...
      if (!v8)
      {
        v8 = [(MTRUnitTestingClusterBooleanResponseParams *)v7 _setFieldsFromDecodableStruct:&v12];
        if (!v8)
        {
          v10 = v7;
          goto LABEL_8;
...
- (MTRUnitTestingClusterBooleanResponseParams)initWithDecodableStruct:(const DecodableType *)struct
{
  ...
  v4 = [(MTRUnitTestingClusterBooleanResponseParams *)&v10 init];
  v5 = v4;
  if (v4)
  {
