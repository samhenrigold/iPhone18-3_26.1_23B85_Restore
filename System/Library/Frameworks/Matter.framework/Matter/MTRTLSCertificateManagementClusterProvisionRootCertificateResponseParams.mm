...
- (MTRTLSCertificateManagementClusterProvisionRootCertificateResponseParams)initWithDecodableStruct:(const DecodableType *)struct;
- (MTRTLSCertificateManagementClusterProvisionRootCertificateResponseParams)initWithResponseValue:(id)value error:(id *)error;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  caid = [(MTRTLSCertificateManagementClusterProvisionRootCertificateResponseParams *)self caid];
  [(MTRTLSCertificateManagementClusterProvisionRootCertificateResponseParams *)v4 setCaid:caid];
...
- (MTRTLSCertificateManagementClusterProvisionRootCertificateResponseParams)initWithDecodableStruct:(const DecodableType *)struct
{
  ...
  if (v4)
  {
    v6 = [(MTRTLSCertificateManagementClusterProvisionRootCertificateResponseParams *)v4 _setFieldsFromDecodableStruct:struct];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
