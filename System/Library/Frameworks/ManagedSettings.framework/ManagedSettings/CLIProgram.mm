...
LABEL_6:
      ...
      if (v9)
      {
        ...
        if (v15)
        {
          sub_100006EF4(@"ambiguous command %@ - did you mean %@?", v16, v17, v18, v19, v20, v21, v22, v9);
        }

        else
        {
          sub_100006EF4(@"unknown command %@", v16, v17, v18, v19, v20, v21, v22, v9);
          sub_100004030(0);
        }
