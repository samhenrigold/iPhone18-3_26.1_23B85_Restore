...
- (BOOL)parsePayloadData:(id)data
{
  ...
  else
  {
    ...
    {
      v10 = 136315138;
      v11 = "[NEIKEv2CertificatePayload parsePayloadData:]";
      _os_log_error_impl(&dword_1BA83C000, v9, OS_LOG_TYPE_ERROR, "BACKTRACE %s called with null (payloadData.length >= sizeof(ikev2_payload_cert_hdr_t))", &v10, 0xCu);
    }
...
LABEL_6:
  ...
  {
    *v12 = 0;
    _os_log_error_impl(&dword_1BA83C000, v10, OS_LOG_TYPE_ERROR, "Certificate payload missing required fields", v12, 2u);
  }
...
- (id)descriptionWithIndent:(int)indent options:(unint64_t)options
{
  ...
  typeDescription = [(NEIKEv2CertificatePayload *)self typeDescription];
