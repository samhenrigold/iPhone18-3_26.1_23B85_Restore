...
LABEL_8:
    ...
    {
      *v11 = 0;
      _os_log_error_impl(&dword_1BA83C000, v8, OS_LOG_TYPE_ERROR, "NONCE payload missing required fields", v11, 2u);
    }
...
- (id)descriptionWithIndent:(int)indent options:(unint64_t)options
{
  ...
  typeDescription = [(NEIKEv2NoncePayload *)self typeDescription];
  ...
  [v7 appendPrettyObject:Property withName:@"Nonce" andIndent:v5 options:options];
