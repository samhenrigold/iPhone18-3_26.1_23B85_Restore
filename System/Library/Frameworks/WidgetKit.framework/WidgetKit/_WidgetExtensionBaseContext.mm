...
{
  v3.receiver = self;
  v3.super_class = type metadata accessor for _WidgetExtensionBaseContext();
...
- (_TtC9WidgetKit27_WidgetExtensionBaseContext)initWithInputItems:(id)items
{
  ...
  v7.receiver = self;
  v7.super_class = type metadata accessor for _WidgetExtensionBaseContext();
...
- (_TtC9WidgetKit27_WidgetExtensionBaseContext)initWithInputItems:(id)items listenerEndpoint:(id)endpoint contextUUID:(id)d
{
  ...
  return sub_1922211F0(items, endpoint, v10);
}
