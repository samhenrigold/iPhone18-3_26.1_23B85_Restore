...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphDeinterleaveOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphTensorShapeOps.mm");
  v12 = nameCopy;
  v43 = 260;
  v42[0] = __p;
  StringAttr = mlir::Builder::getStringAttr(builder, v42);
  v16 = mlir::FileLineColLoc::get(StringAttr, 0x64Cu, 0);
  if (v12)
  {
    v17 = v12;
  ...
  else
  {
    ...
    *&__dst[0].__r_.__value_.__l.__data_ = *"mpsx.deinterleave";
...
LABEL_16:
  ...
  v28 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mpsx::DeinterleaveOp,void>::id, Context);
  if ((v29 & 1) == 0)
  {
    v40 = 1283;
    v38.__r_.__value_.__r.__words[2] = "mpsx.deinterleave";
    v39 = 17;
    v37 = 259;
  ...
  mlir::mpsx::DeinterleaveOp::build(builder, v42, *v26, self->_interleaveFactor);
  v30 = mlir::OpBuilder::create(builder, v42);
  v31 = *(*(v30 + 6) + 16);
  mlir::OperationState::~OperationState(v42);
  if (v31 != &mlir::detail::TypeIDResolver<mlir::mpsx::DeinterleaveOp,void>::id)
  {
    v30 = 0;
  }
