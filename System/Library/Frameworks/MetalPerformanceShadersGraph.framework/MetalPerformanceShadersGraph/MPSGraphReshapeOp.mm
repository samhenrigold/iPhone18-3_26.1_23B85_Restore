...
{
  nameCopy = name;
  mpsFileLoc(v28, "[MPSGraphReshapeOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphTensorShapeOps.mm");
  v11 = nameCopy;
  v33 = 260;
  v32[0] = v28;
  StringAttr = mlir::Builder::getStringAttr(builder, v32);
  v15 = mlir::FileLineColLoc::get(StringAttr, 0x133u, 0);
  if (v11)
  {
  ...
  else
  {
    ...
    *(__dst.__r_.__value_.__r.__words + 7) = 1701863784;
    __dst.__r_.__value_.__r.__words[0] = *"mps.reshape";
...
LABEL_22:
  ...
  v32[0] = (mlir::OpBuilder::create<mlir::mps::ReshapeOp,mlir::Value,mlir::Value&>(builder, v23, v24, v24 + 1) - 16);
...
- (id)partialDerivativeForInputTensor:(id)tensor incomingGradient:(id)gradient inputIndex:(unint64_t)index name:(id)name
{
  ...
  v15 = [v13 stringWithFormat:@"%@/%@/reshape/shapeOp", nameCopy, name];
