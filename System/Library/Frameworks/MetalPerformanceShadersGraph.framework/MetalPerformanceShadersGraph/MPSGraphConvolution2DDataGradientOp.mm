...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphConvolution2DDataGradientOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphConvolutionOps.mm");
  v11 = nameCopy;
  v64 = 260;
  v63[0] = __p;
...
LABEL_15:
  ...
  v38 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::Conv2DDataGradientOp,void>::id, Context);
  if ((v39 & 1) == 0)
  {
    v61 = 1283;
    v59.__r_.__value_.__r.__words[2] = "mps.conv_2d_data_gradient";
    v60 = 25;
    v58 = 259;
  ...
  mlir::mps::Conv2DDataGradientOp::build(builderCopy, v63, *v23, v23[1], v23[2], groups, strideInX, v46, v33, v47, v49, paddingRight, paddingTop, paddingBottom, __SPAIR64__(dataLayout, paddingStyle), weightsLayout);
  v40 = mlir::OpBuilder::create(builderCopy, v63);
  v41 = *(*(v40 + 6) + 16);
  mlir::OperationState::~OperationState(v63);
  if (v41 == &mlir::detail::TypeIDResolver<mlir::mps::Conv2DDataGradientOp,void>::id)
  {
    v42 = v40;
  }
