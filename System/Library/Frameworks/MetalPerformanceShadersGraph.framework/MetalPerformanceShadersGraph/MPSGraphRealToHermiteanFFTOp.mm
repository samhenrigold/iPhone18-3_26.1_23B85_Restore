...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphRealToHermiteanFFTOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphFourierTransformOps.mm");
  v12 = nameCopy;
  v45 = 260;
  v44[0] = __p;
...
LABEL_15:
  ...
  v30 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::RealToHermiteanFFTOp,void>::id, Context);
  if ((v31 & 1) == 0)
  {
    v42 = 1283;
    v40.__r_.__value_.__r.__words[2] = "mps.real_to_hermitean_fft";
    v41 = 25;
    v39 = 259;
  ...
  mlir::mps::RealToHermiteanFFTOp::build(builder, v44, *v28, v28[1], v27, inverse);
  v32 = mlir::OpBuilder::create(builder, v44);
  v33 = *(*(v32 + 6) + 16);
  mlir::OperationState::~OperationState(v44);
  if (v33 != &mlir::detail::TypeIDResolver<mlir::mps::RealToHermiteanFFTOp,void>::id)
  {
    v32 = 0;
  }
