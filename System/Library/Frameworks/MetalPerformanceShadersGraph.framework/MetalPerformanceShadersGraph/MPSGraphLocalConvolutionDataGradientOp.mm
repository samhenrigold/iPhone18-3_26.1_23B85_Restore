...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(&__p, "[MPSGraphLocalConvolutionDataGradientOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphLocalConvolution.mm");
  ...
  {
    v38 = 1283;
    v37[2] = "mps.local_convolution_data_gradient";
    v37[3] = 35;
    v36 = 259;
  ...
  mlir::mps::LocalConvolutionDataGradientOp::build(builder, v40, *v21, v21[1], dataLayout, KernelSizeFromShape, v22);
