...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphUpdateRandomStateOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphRandomOps.mm");
  v11 = nameCopy;
  v44 = 260;
  v43[0] = __p;
...
LABEL_15:
  ...
  v26 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::UpdateRandomStateOp,void>::id, Context);
  if ((v27 & 1) == 0)
  {
    v41 = 1283;
    v39.__r_.__value_.__r.__words[2] = "mps.update_random_state";
    v40 = 23;
    v38 = 259;
  ...
  mlir::mps::SoftmaxOp::build(builder, v43, *v24, v24[1]);
  v28 = mlir::OpBuilder::create(builder, v43);
  v29 = *(*(v28 + 6) + 16);
  mlir::OperationState::~OperationState(v43);
  if (v29 == &mlir::detail::TypeIDResolver<mlir::mps::UpdateRandomStateOp,void>::id)
  {
    v30 = v28;
  }
