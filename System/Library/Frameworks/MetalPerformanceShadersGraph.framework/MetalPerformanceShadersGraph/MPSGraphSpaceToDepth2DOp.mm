...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphSpaceToDepth2DOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphTensorShapeOps.mm");
  v12 = nameCopy;
  v46 = 260;
  v45[0] = __p;
  StringAttr = mlir::Builder::getStringAttr(builder, v45);
  v16 = mlir::FileLineColLoc::get(StringAttr, 0x428u, 0);
  if (v12)
  {
    v17 = v12;
...
LABEL_16:
  ...
  v28 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::SpaceToDepth2DOp,void>::id, Context);
  if ((v29 & 1) == 0)
  {
    v43 = 1283;
    v41.__r_.__value_.__r.__words[2] = "mps.space_to_depth_2d";
    v42 = 21;
    v40 = 259;
  ...
  mlir::mps::SpaceToDepth2DOp::build(builder, v45, *v26, v26[1], v26[2], v26[3], self->_blockSize, self->_pixelShuffleOrder);
  v30 = mlir::OpBuilder::create(builder, v45);
  v31 = *(*(v30 + 6) + 16);
  mlir::OperationState::~OperationState(v45);
  if (v31 == &mlir::detail::TypeIDResolver<mlir::mps::SpaceToDepth2DOp,void>::id)
  {
    v32 = v30;
  }
