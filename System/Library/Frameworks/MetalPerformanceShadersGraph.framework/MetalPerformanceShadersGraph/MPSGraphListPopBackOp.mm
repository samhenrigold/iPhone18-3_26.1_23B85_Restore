...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphListPopBackOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphListOps.mm");
  v11 = nameCopy;
  v43 = 260;
  v42[0] = __p;
  ...
  else
  {
    *(&__dst[0].__r_.__value_.__s + 23) = 18;
    LOWORD(__dst[0].__r_.__value_.__r.__words[2]) = 27491;
    *&__dst[0].__r_.__value_.__l.__data_ = *"mpsx.list_pop_back";
...
LABEL_16:
  ...
  v27 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mpsx::ListPopBackOp,void>::id, Context);
  if ((v28 & 1) == 0)
  {
    v40 = 1283;
    v38.__r_.__value_.__r.__words[2] = "mpsx.list_pop_back";
    v39 = 18;
    v37 = 259;
  ...
  mlir::mpsx::ListPopBackOp::build(builder, v42, *v25);
  v29 = mlir::OpBuilder::create(builder, v42);
  v30 = *(*(v29 + 6) + 16);
  mlir::OperationState::~OperationState(v42);
  if (v30 == &mlir::detail::TypeIDResolver<mlir::mpsx::ListPopBackOp,void>::id)
  {
    v31 = v29;
  }
