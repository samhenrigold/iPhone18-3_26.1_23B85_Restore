...
{
  nameCopy = name;
  mpsFileLoc(v28, "[MPSGraphMatrixMultiplicationOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphMatrixMultiplicationOps.mm");
  v11 = nameCopy;
  v33 = 260;
  v32[0] = v28;
  StringAttr = mlir::Builder::getStringAttr(builder, v32);
  v15 = mlir::FileLineColLoc::get(StringAttr, 0x2Bu, 0);
  if (v11)
  {
  ...
  else
  {
    *(&__dst.__r_.__value_.__s + 23) = 10;
    LOWORD(__dst.__r_.__value_.__r.__words[1]) = 27765;
    __dst.__r_.__value_.__r.__words[0] = *"mps.matmul";
...
LABEL_22:
  ...
  v32[0] = (mlir::OpBuilder::create<mlir::mps::MatMulOp,mlir::Value &,mlir::Value &>(builder, v23, v24, v24 + 1) - 16);
