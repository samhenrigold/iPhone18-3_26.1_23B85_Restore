...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  nameCopy = name;
  mpsFileLoc(__p, "[MPSGraphCumulativeMinimumOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphCumulativeOps.mm");
  v12 = nameCopy;
  v48 = 260;
  v47[0] = __p;
  StringAttr = mlir::Builder::getStringAttr(builder, v47);
  v16 = mlir::FileLineColLoc::get(StringAttr, 0x4Fu, 0);
  if (v12)
  {
    v17 = v12;
  ...
  else
  {
    *(&__dst[0].__r_.__value_.__s + 23) = 22;
    qmemcpy(__dst, "mps.cumulative_minimum", 22);
...
LABEL_16:
  ...
  v30 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::CumulativeMinimumOp,void>::id, Context);
  if ((v31 & 1) == 0)
  {
    v45 = 1283;
    v43.__r_.__value_.__r.__words[2] = "mps.cumulative_minimum";
    v44 = 22;
    v42 = 259;
  ...
  mlir::mps::CumulativeMinimumOp::build(builder, v47, *v26, v26[1], exclusive, reverse);
  v32 = mlir::OpBuilder::create(builder, v47);
  v33 = *(*(v32 + 6) + 16);
  mlir::OperationState::~OperationState(v47);
  if (v33 == &mlir::detail::TypeIDResolver<mlir::mps::CumulativeMinimumOp,void>::id)
  {
    v34 = v32;
  }
