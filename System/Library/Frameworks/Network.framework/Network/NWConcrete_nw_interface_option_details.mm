...
- (NWConcrete_nw_interface_option_details)init
{
  ...
  v16.receiver = self;
  v16.super_class = NWConcrete_nw_interface_option_details;
...
{
  v2.receiver = self;
  v2.super_class = NWConcrete_nw_interface_option_details;
...
- (NSString)description
{
  ...
  v3 = CFStringCreateWithFormat(*MEMORY[0x1E695E480], 0, @"%@:%@ [%s, prio %d, fd %d, evaluator %@]", self->interface, self->remote, out, self->priority, self->sockfd, self->evaluator);
