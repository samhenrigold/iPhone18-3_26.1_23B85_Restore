...
- (NWConcrete_nw_protocol_establishment_report)init
{
  ...
  v16.receiver = self;
  v16.super_class = NWConcrete_nw_protocol_establishment_report;
  v2 = [(NWConcrete_nw_protocol_establishment_report *)&v16 init];
  v3 = v2;
  if (v2)
  {
    v4 = v2;
...
{
  v2.receiver = self;
  v2.super_class = NWConcrete_nw_protocol_establishment_report;
