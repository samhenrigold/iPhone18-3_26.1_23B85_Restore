...
- (NWConcrete_nw_protocol_definition)init
{
  ...
  v16.receiver = self;
  v16.super_class = NWConcrete_nw_protocol_definition;
...
- (NSString)description
{
  v2 = CFStringCreateWithCString(*MEMORY[0x1E695E480], self->identifier.name, 0x8000100u);
...
- (void)dealloc
{
  ...
  v7.receiver = self;
  v7.super_class = NWConcrete_nw_protocol_definition;
