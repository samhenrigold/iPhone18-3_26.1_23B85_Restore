@interface MTLFXTemporalDenoisedScaler
@end

@implementation MTLFXTemporalDenoisedScaler

id __57___MTLFXTemporalDenoisedScaler__emitTelemetry_forDevice___block_invoke(void *a1)
{
