...
+ (void)physicalDevice:(id)device getLightWithReply:(id)reply
{
  ...
  {
    [_GCSonyDualShockControllerProfile physicalDevice:deviceCopy getLightWithReply:?];
  }
...
+ (void)physicalDevice:(id)device getSensorsEnabledWithReply:(id)reply
{
  ...
  if (gc_isInternalBuild(replyCopy, v7))
  {
    [_GCSonyDualShockControllerProfile physicalDevice:deviceCopy getSensorsEnabledWithReply:?];
  }
...
+ (void)physicalDevice:(id)device getBatteryWithReply:(id)reply
{
  ...
  if (gc_isInternalBuild(replyCopy, v7))
  {
    [_GCSonyDualShockControllerProfile physicalDevice:deviceCopy getBatteryWithReply:?];
  }
