...
@implementation _GCSonyAccessControllerProfile

+ (_GCPhysicalDeviceManager)deviceManager
{
  block[0] = MEMORY[0x1E69E9820];
  block[1] = 3221225472;
  block[2] = __47___GCSonyAccessControllerProfile_deviceManager__block_invoke;
  block[3] = &__block_descriptor_40_e5_v8__0l;
  block[4] = self;
  if (deviceManager_onceToken_5 != -1)
  {
    dispatch_once(&deviceManager_onceToken_5, block);
  }

  v2 = deviceManager_deviceManager_5;
...
+ (id)logicalDevice:(id)device makeControllerPhysicalInputProfileWithIdentifier:(id)identifier
{
  ...
  v22 = 1;
  v24 = 1;
  v8 = [[GCExtendedGamepad alloc] initWithIdentifier:identifierCopy info:v11];
  for (j = 0; j != 1584; j += 72)
  {
