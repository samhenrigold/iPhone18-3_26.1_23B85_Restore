...
- (GCPlayerIndicatorXPCProxyClientEndpoint)initWithIdentifier:(id)identifier initialPlayerIndex:(int64_t)index
{
  ...
  v13.receiver = self;
  v13.super_class = GCPlayerIndicatorXPCProxyClientEndpoint;
  v7 = [(GCPlayerIndicatorXPCProxyClientEndpoint *)&v13 init];
  v9 = v7;
  if (v7)
  {
...
- (void)setRemoteEndpoint:(id)endpoint connection:(id)connection
{
  ...
  v19 = 3221225472;
  v20 = __72__GCPlayerIndicatorXPCProxyClientEndpoint_setRemoteEndpoint_connection___block_invoke;
  v21 = &unk_1E8418D18;
  ...
  if (isInternalBuild)
  {
    ...
    [GCPlayerIndicatorXPCProxyClientEndpoint setRemoteEndpoint:v17 connection:?];
  }
...
- (void)initWithIdentifier:(uint64_t)a1 initialPlayerIndex:(uint64_t)a2 .cold.1(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 2048;
    v8 = a2;
    _os_log_impl(&dword_1D2CD5000, v4, OS_LOG_TYPE_INFO, "GCPlayerIndicatorXPCProxyClientEndpoint initWithIdentifier: %@ initialPlayerIndex: %ld", &v5, 0x16u);
  }
}
