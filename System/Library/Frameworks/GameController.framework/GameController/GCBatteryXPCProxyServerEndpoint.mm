...
- (void)invalidateClient
{
  ...
  {
    OUTLINED_FUNCTION_8();
    OUTLINED_FUNCTION_0_0(&dword_1D2CD5000, v3, v4, "Dropping remote endpoint for %@", v5, v6, v7, v8);
  }
}
...
- (BOOL)acceptClient:(id)client onConnection:(id)connection error:(id *)error
{
  ...
  v25 = 3221225472;
  v26 = __67__GCBatteryXPCProxyServerEndpoint_acceptClient_onConnection_error___block_invoke;
  v27 = &unk_1E8418D18;
  ...
  if (isInternalBuild)
  {
    ...
    [GCBatteryXPCProxyServerEndpoint acceptClient:v23 onConnection:? error:?];
  }
    ...
    if (v6)
    {
      ...
      if (v9 <= 6)
      {
        ...
        if (v9 == 6)
        {
          ...
          [(GCBatteryXPCProxyRemoteClientEndpointInterface *)v8 refreshBattery];
        }
        ...
        else
        {
          ...
          [(GCBatteryXPCProxyRemoteClientEndpointInterface *)v8 newBattery:self->_battery];
...
- (void)setBattery:(uint64_t)a1 .cold.1(uint64_t a1)
{
  v2 = getGCLogger(a1);
  if (OUTLINED_FUNCTION_9(v2))
  {
    OUTLINED_FUNCTION_8();
    OUTLINED_FUNCTION_0_0(&dword_1D2CD5000, v3, v4, "Sending new battery to remote endpoint: %@", v5, v6, v7, v8);
  }
}

- (void)setBattery:(uint64_t)a1 .cold.2(uint64_t a1)
{
  v2 = getGCLogger(a1);
  if (OUTLINED_FUNCTION_9(v2))
  {
    OUTLINED_FUNCTION_8();
    OUTLINED_FUNCTION_0_0(&dword_1D2CD5000, v3, v4, "Sending battery refresh request to remote endpoint: %@", v5, v6, v7, v8);
  }
}
