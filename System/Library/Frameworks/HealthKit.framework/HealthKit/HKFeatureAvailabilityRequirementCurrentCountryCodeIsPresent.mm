...
- (id)requirementDescription
{
  ...
  v4 = [v2 stringWithFormat:@"A current country code must be present for %@", featureIdentifier];
...
- (id)isSatisfiedWithDataSource:(id)source error:(id *)error
{
  ...
  if (v9)
  {
    v10 = [(_HKFeatureAvailabilityRequirementCountryCodeIsPresent *)self isSatisfiedWithOnboardingEligibility:v9 error:error];
  }
