...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = HKCodableLocationCoordinate;
  v4 = [(HKCodableLocationCoordinate *)&v8 description];
  dictionaryRepresentation = [(HKCodableLocationCoordinate *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) == 0 || self->_latitude != *(equalCopy + 1))
    {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 24) & 2) == 0 || self->_longitude != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
...
- (unint64_t)hash
{
  if (*&self->_has)
  {
    ...
    *v2.i64 = floor(latitude + 0.5);
    v6 = (latitude - *v2.i64) * 1.84467441e19;
  ...
  if ((*&self->_has & 2) != 0)
  {
    ...
    *v2.i64 = floor(longitude + 0.5);
    v10 = (longitude - *v2.i64) * 1.84467441e19;
    *v3.i64 = *v2.i64 - trunc(*v2.i64 * 5.42101086e-20) * 1.84467441e19;
    v11.f64[0] = NAN;
    v11.f64[1] = NAN;
