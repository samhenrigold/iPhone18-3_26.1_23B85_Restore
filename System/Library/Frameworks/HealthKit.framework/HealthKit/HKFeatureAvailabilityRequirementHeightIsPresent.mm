...
- (void)registerObserver:(id)observer forDataSource:(id)source
{
  ...
  v12[1] = 3221225472;
  v12[2] = __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke_12;
  v12[3] = &unk_1E737BAB0;
  v11 = v9;
  v13 = v11;
...
- (void)isSatisfiedWithDataSource:(uint64_t)a1 error:.cold.1(uint64_t a1)
{
  ...
  OUTLINED_FUNCTION_1_5(&dword_19197B000, v3, v4, "[%{public}@] Error while pulling height characteristic: %{public}@", v5, v6, v7, v8);
}
