...
- (MPSImageThresholdToZero)initWithCoder:(NSCoder *)aDecoder device:(id)device;
- (MPSImageThresholdToZero)initWithDevice:(id)device;
- (MPSImageThresholdToZero)initWithDevice:(id)device thresholdValue:(float)thresholdValue linearGrayColorTransform:(const float *)transform;
...
{
  v9.receiver = self;
  v9.super_class = MPSImageThresholdToZero;
  ...
  if (result)
  {
    ...
    result->super._encode = sub_239977730;
...
{
  v19.receiver = self;
  v19.super_class = MPSImageThresholdToZero;
  ...
  if (*(&v5->super.super.super.isa + *MEMORY[0x277CD7358] + 2) << 16 == 0x10000)
  {
    ...
    v5->super._encode = sub_239977730;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.isa + *MEMORY[0x277CD7358] + 2) = 1;
  v15.receiver = self;
  v15.super_class = MPSImageThresholdToZero;
...
{
  v7.receiver = self;
  v7.super_class = MPSImageThresholdToZero;
