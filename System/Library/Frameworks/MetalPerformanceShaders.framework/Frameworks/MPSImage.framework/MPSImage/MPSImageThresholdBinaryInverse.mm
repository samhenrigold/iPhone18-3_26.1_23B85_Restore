...
{
  v19.receiver = self;
  v19.super_class = MPSImageThresholdBinaryInverse;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.isa + *MEMORY[0x277CD7358] + 2) = 1;
  v15.receiver = self;
  v15.super_class = MPSImageThresholdBinaryInverse;
...
- (MPSImageThresholdBinaryInverse)initWithDevice:(id)device
{
  ...
  return MEMORY[0x2821F9670](self, sel_initWithDevice_thresholdValue_maximumValue_linearGrayColorTransform_, device);
}
...
- (id)debugDescription
{
  ...
  return objc_msgSend_stringWithFormat_(v3, v5, @"%@\n\tthreshold: %f\n\tmaximumValue: %f\n\ttransform: {%f %f %f}", v4, self->filterInfo.threshold_value, self->filterInfo.max_value, self->filterInfo.matrix[0], self->filterInfo.matrix[1], self->filterInfo.matrix[2]);
}
