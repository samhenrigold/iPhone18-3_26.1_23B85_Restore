...
- (MPSCNNGroupNormalizationNode)initWithSource:(MPSNNImageNode *)source dataSource:(id)dataSource
{
  ...
  if (dataSource)
  {
    ...
    v19.receiver = self;
    v19.super_class = MPSCNNGroupNormalizationNode;
  ...
  else
  {
    if (MTLReportFailureTypeEnabled())
    {
      ...
      MTLReportFailure(0, "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShaders/MPSNeuralNetwork/Graph/MPSCNNNormalizationNodes.mm", 0x310, @"[%@ initWithSource:dataSource:] dataSource may not be NULL", v15, v16, v17, v18);
    }
