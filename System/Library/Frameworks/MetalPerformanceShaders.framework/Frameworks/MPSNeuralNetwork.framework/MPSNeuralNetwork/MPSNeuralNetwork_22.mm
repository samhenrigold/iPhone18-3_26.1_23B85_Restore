int32x4_t *sub_239CCBC78(int32x4_t *result, int32x4_t *a2, uint64_t a3)
{
  v3 = *(a3 + 8);
  v4 = *(a3 + 32);
  v699 = *(a3 + 48);
...
int32x4_t *sub_239CD298C(int32x4_t *result, unsigned __int32 *a2, uint64_t a3, double a4, int32x4_t a5)
{
  v544 = a2;
  v5 = *(a3 + 8);
  v560 = *(a3 + 32);
