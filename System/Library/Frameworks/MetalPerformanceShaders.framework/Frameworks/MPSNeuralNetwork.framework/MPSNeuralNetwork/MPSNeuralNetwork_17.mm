...
int16x8_t *sub_239C9E658(int16x8_t *result, int16x8_t *a2, uint64_t a3, int32x4_t a4, int32x4_t a5, double a6, int16x8_t a7, int32x4_t a8, int32x4_t a9, int16x8_t a10)
{
  v12 = *(a3 + 8);
  v993 = *(a3 + 32);
  v13 = *(a3 + 56);
