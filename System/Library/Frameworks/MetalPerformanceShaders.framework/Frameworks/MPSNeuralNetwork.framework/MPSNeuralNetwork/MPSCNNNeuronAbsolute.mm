...
- (MPSCNNNeuronAbsolute)initWithDevice:(id)device neuronDescriptor:(id)descriptor
{
  ...
  {
    MTLReportFailure(0, "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShaders/MPSNeuralNetwork/Filters/MPSCNNNeuron.mm", 0x66F, @"Cannot call this initializer on this class.\n", v8, v9, v10, v11);
  }
...
- (MPSCNNNeuronAbsolute)initWithDevice:(id)device neuronDescriptor:(id)descriptor aArray:(const float *)array
{
  ...
  if (MTLReportFailureTypeEnabled())
  {
    MTLReportFailure(0, "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShaders/MPSNeuralNetwork/Filters/MPSCNNNeuron.mm", 0x678, @"Cannot call this initializer on this class.\n", v8, v9, v10, v11);
  }
