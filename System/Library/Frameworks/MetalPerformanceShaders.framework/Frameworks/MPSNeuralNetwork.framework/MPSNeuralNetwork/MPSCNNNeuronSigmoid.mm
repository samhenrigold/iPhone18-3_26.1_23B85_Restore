...
- (MPSCNNNeuronSigmoid)initWithDevice:(id)device neuronDescriptor:(id)descriptor
{
  ...
  {
    MTLReportFailure(0, "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShaders/MPSNeuralNetwork/Filters/MPSCNNNeuron.mm", 0x615, @"Cannot call this initializer on this class.\n", v8, v9, v10, v11);
  }
...
- (MPSCNNNeuronSigmoid)initWithDevice:(id)device neuronDescriptor:(id)descriptor aArray:(const float *)array
{
  ...
  if (MTLReportFailureTypeEnabled())
  {
    MTLReportFailure(0, "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShaders/MPSNeuralNetwork/Filters/MPSCNNNeuron.mm", 0x61E, @"Cannot call this initializer on this class.\n", v8, v9, v10, v11);
  }
