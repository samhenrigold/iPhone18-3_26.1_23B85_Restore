...
- (NSBatchInsertResult)initWithSubresults:(id)subresults
{
  ...
  v49.receiver = self;
  v49.super_class = NSBatchInsertResult;
  ...
  do
  {
    ...
    do
    {
      ...
      if (v15 != [v14 resultType])
      {
        ...
        v35 = &v56;
LABEL_49:
        objc_exception_throw([v31 exceptionWithName:v32 reason:@"Mismatched result types during aggregation of batch insert results" userInfo:{objc_msgSend(v33, "dictionaryWithObjects:forKeys:count:", v34, v35, 1)}]);
      }
