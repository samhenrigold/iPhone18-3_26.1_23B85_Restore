...
- (void)handleOperationDidCompleteWithBundleIDs:(id)ds metrics:(id)metrics error:(id)error
{
  ...
  v19.receiver = self;
  v19.super_class = CKFetchWhitelistedBundleIDsOperation;
...
- (void)ckSignpostBegin
{
  ...
  if (v4)
  {
    ...
    if (v14 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v9))
    {
      ...
      v52 = 2114;
      v53 = v41;
      _os_signpost_emit_with_name_impl(&dword_1883EA000, v9, OS_SIGNPOST_INTERVAL_BEGIN, v14, "CKFetchWhitelistedBundleIDsOperation", "ID=%{signpost.description:attribute}@ Container=%{signpost.description:attribute}@ GroupID=%{signpost.description:attribute}@ GroupName=%{signpost.description:attribute,public}@ Behavior=%{signpost.description:attribute,public}@ QoS=%{signpost.description:attribute,public}@ ", &v42, 0x3Eu);
    }
  }
}
...
- (void)ckSignpostEndWithError:(id)error
{
  ...
  if (v6)
  {
    ...
    if (v16 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v11))
    {
      v17 = 138412290;
      v18 = errorCopy;
      _os_signpost_emit_with_name_impl(&dword_1883EA000, v11, OS_SIGNPOST_INTERVAL_END, v16, "CKFetchWhitelistedBundleIDsOperation", "Error=%{signpost.description:attribute}@ ", &v17, 0xCu);
    }
  }
}
