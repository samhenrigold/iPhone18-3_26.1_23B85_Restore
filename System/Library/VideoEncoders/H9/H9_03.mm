  ...
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID != CFGetTypeID(a4))
    {
      ...
      if (v24)
      {
        v49 = v27;
        v29 = 10365;
        printf("%lld %d AVE %s: %s:%d %s | wrong property type %p %lld %p %p %p %ld\n", CurrTime, 30, LevelStr, "AVE_Prop_HEVC_SetRequiredMVHEVCVideoParameterSetAlphaVideoLayerIDs", 10365, "CFArrayGetTypeID() == CFGetTypeID(pValue)", a1, v49, a2, a3, a4, v28);
        v30 = AVE_GetCurrTime();
...
LABEL_20:
      ...
      v38 = 10365;
LABEL_27:
      syslog(3, "%lld %d AVE %s: %s:%d %s | wrong property type %p %lld %p %p %p %ld", CurrTime, 30, LevelStr, "AVE_Prop_HEVC_SetRequiredMVHEVCVideoParameterSetAlphaVideoLayerIDs", v38, v37);
      return 4294965293;
    }
    ...
    if (Count == 2)
    {
      ...
      if (v43)
      {
        v50 = v44;
        v29 = 10386;
        printf("%lld %d AVE %s: %s:%d %s | wrong property type %p %lld %p %p %p %ld\n", CurrTime, 30, LevelStr, "AVE_Prop_HEVC_SetRequiredMVHEVCVideoParameterSetAlphaVideoLayerIDs", 10386, "CFNumberGetTypeID() == CFGetTypeID(pNum)", a1, v50, a2, a3, a4, v45);
        v30 = AVE_GetCurrTime();
        v31 = AVE_Log_GetLevelStr(4);
        CFGetTypeID(a4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    if (*(a1 + 2639))
    {
      ...
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v29)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber  %p %lld %p %p %p %p %d %d\n", v30, 30, v31, "AVE_Prop_HEVC_GetRequiredMVHEVCVideoParameterSetAlphaVideoLayerIDs", 10442, "pNum != __null", a1, a1[7], a2, allocator, a4, a5, v12 - 2724, *(a1 + v12));
          v32 = AVE_GetCurrTime();
          v35 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetInputPixelFormat(void *a1, const char **a2, const __CFString *a3, const __CFNumber *a4)
{
  valuePtr = 0;
  if (a1 && a2 && a3 && a4)
  {
        ...
        else
        {
          ...
          else
          {
            if (AVE_Log_CheckLevel(0x1Eu, 4))
            {
              ...
              if (v34)
              {
                printf("%lld %d AVE %s: %s:%d %s | failed to get pixel format details %p %lld %p %p %p %d\n", v35, 30, v36, "AVE_Prop_HEVC_SetInputPixelFormat", 10534, "pPixelFmt != __null", a1, a1[7], a2, a3, a4, valuePtr);
                v37 = AVE_GetCurrTime();
                v41 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetOutputBitDepth(_DWORD *a1, const char **a2, const __CFString *a3, const __CFNumber *a4)
{
  valuePtr = -1;
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      if ((valuePtr & 0xFFFFFFFD) == 8)
      {
        ...
        *(a1 + 10782) = 1;
        ...
        a1[6184] = v10;
        v11 = a1[26157];
        if ((v11 | 2) == 0xA && a1[2688] != 2 && (updated = AVE_UpdatePixelBufferDict(a1[17], a1[16], a1[179], 2, a1[2863], a1[2864], a1[360], a1[361], v10 | 8u, v11, 0x1414C4C20, *(a1 + 2)), updated))
        {
          v13 = updated;
          if (AVE_Log_CheckLevel(0x1Eu, 4))
          {
        ...
        else
        {
          if (AVE_Log_CheckLevel(0x1Eu, 7))
          {
            ...
            if (v31)
            {
              printf("%lld %d AVE %s: %p %lld SetProp %s: %d\n", v32, 30, v33, a1, *(a1 + 7), *a2, valuePtr);
              v32 = AVE_GetCurrTime();
              AVE_Log_GetLevelStr(7);
            }
      ...
      else
      {
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          if (v27)
          {
            printf("%lld %d AVE %s: %s:%d %s | out of range %p %lld %p %p %p %d\n", v28, 30, v29, "AVE_Prop_HEVC_SetOutputBitDepth", 10663, "OutputBitDepth == 8 || OutputBitDepth == 10", a1, *(a1 + 7), a2, a3, a4, valuePtr);
            v30 = AVE_GetCurrTime();
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v25)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v26, 30, v27, "AVE_Prop_HEVC_GetOutputBitDepth", 10742, "pNum != __null", a1, *(a1 + 7), a2, a3, a4, a5, valuePtr);
          v28 = AVE_GetCurrTime();
          v31 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetNumberOfSlices(void *a1, const char **a2, const __CFString *a3, const __CFNumber *a4)
{
  valuePtr = 0;
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID == CFGetTypeID(a4))
    {
          ...
          *(a1 + 26634) = valuePtr;
          ...
          if (SliceMap)
          {
            ...
            if (AVE_Log_CheckLevel(0x1Eu, 4))
            {
              ...
              if (v15)
              {
                printf("%lld %d AVE %s: %s:%d %s | fail to generate slice map %d %d %d %d %p %d\n", v16, 30, v17, "AVE_Prop_HEVC_SetNumberOfSlices", 10816, "ret == 0", valuePtr, *(a1 + 361), *(*(v10 + 8) + 16), *v12, a1 + 10252, v14);
                v18 = AVE_GetCurrTime();
                v40 = AVE_Log_GetLevelStr(4);
      ...
      else
      {
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          if (v28)
          {
            printf("%lld %d AVE %s: %s:%d %s | fail to find device capability %p %p %p %d\n", v29, 30, v30, "AVE_Prop_HEVC_SetNumberOfSlices", 10790, "pDevCap != __null", a1, a3, a4, *(a1 + 17));
            v31 = AVE_GetCurrTime();
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetNumberOfSlices", 10858, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetSAOMode", 10984, "pMode != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID != CFGetTypeID(a4))
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v18)
        {
          printf("%lld %d AVE %s: %s:%d %s | wrong property type %p %lld %p %p %p %ld\n", CurrTime, 30, LevelStr, "AVE_Prop_HEVC_SetMotionEstimationSearchMode", 11028, "CFNumberGetTypeID() == CFGetTypeID(pValue)", a1, v21, a2, a3, a4, v22);
          CurrTime = AVE_GetCurrTime();
          LevelStr = AVE_Log_GetLevelStr(4);
          CFGetTypeID(a4);
        }
    ...
    if ((valuePtr & 0x80000000) == 0)
    {
      ...
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v27)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to find search range mode %p %lld %p %p %p %d\n", v28, 30, v29, "AVE_Prop_HEVC_SetMotionEstimationSearchMode", 11044, "pSREntry != __null", a1, a1[7], a2, a3, a4, valuePtr);
          v30 = AVE_GetCurrTime();
          v33 = AVE_Log_GetLevelStr(4);
    ...
    if (AVE_Log_CheckLevel(0x1Eu, 4))
    {
      ...
      if (v23)
      {
        printf("%lld %d AVE %s: %s:%d %s | out of range %p %lld %p %p %p %d\n", v24, 30, v25, "AVE_Prop_HEVC_SetMotionEstimationSearchMode", 11037, "iMotionSearchRangeMode >= 0", a1, a1[7], a2, a3, a4, valuePtr);
        v26 = AVE_GetCurrTime();
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetMotionEstimationSearchMode", 11090, "pNum != __null", a1, a1[7], a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_GetSupportedMotionSearchModes(void *a1, const char **a2, const __CFAllocator *a3, const __CFString *a4, CFMutableArrayRef *a5)
{
  if (a1 && a2 && a4 && a5)
  {
    ...
    if (SearchRange)
    {
      ...
      else
      {
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          if (v28)
          {
            printf("%lld %d AVE %s: %s:%d %s | fail to create CFMutableArrayRef %p %lld %p %p %p %p\n", v29, 30, v30, "AVE_Prop_HEVC_GetSupportedMotionSearchModes", 11137, "pArray != __null", a1, a1[7], a2, a3, a4, a5);
            v31 = AVE_GetCurrTime();
            v39 = AVE_Log_GetLevelStr(4);
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v24)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to get search range %p %lld %p %p %p %p %d\n", v25, 30, v26, "AVE_Prop_HEVC_GetSupportedMotionSearchModes", 11132, "pSR != __null", a1, a1[7], a2, a3, a4, a5, *(a1 + 17));
          v27 = AVE_GetCurrTime();
          v38 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetEnableStatsCollect", 11240, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetEnableMCTF(_DWORD *a1, const char **a2, const __CFString *a3, const __CFBoolean *a4)
{
  if (a1 && a2 && a3 && a4)
  {
    TypeID = CFBooleanGetTypeID();
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      updated = AVE_UpdatePixelBufferDict(a1[17], a1[16], v13, 2, a1[2863], a1[2864], a1[360], a1[361], v15, v14, 0x1414C4C20, *(a1 + 2));
      if (updated)
      {
        v17 = updated;
        if (AVE_Log_CheckLevel(0x1Eu, 4))
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetLatencyMode", 11549, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetVideoResolutionAdaptationType", 11740, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
...
LABEL_31:
      ...
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v23)
        {
          printf("%lld %d AVE %s: %s:%d %s | out of range %p %lld %p %p %p %d\n", v24, 30, v25, "AVE_Prop_HEVC_SetiChatUsageString", 11819, "iFTUsageType != -1", a1, *(a1 + 7), a2, a3, a4, -1);
          v26 = AVE_GetCurrTime();
          v28 = AVE_Log_GetLevelStr(4);
...
LABEL_20:
        syslog(3, v20, CurrTime, 30, v34, "AVE_Prop_HEVC_SetUsage", v36, v37, v38, v39, v40, v41, v42, v43, v44, v45);
        return 4294966295;
      }
...
LABEL_30:
    ...
    if (AVE_Log_CheckLevel(0x1Eu, 4))
    {
      ...
      if (v21)
      {
        printf("%lld %d AVE %s: %s:%d %s | bUsageModeSet = %d and called again with new value  %p %lld %p %p %p %d %d\n", CurrTime, 30, v22, "AVE_Prop_HEVC_SetUsage", 12041, "bUsageModeChanged == false", *(a1 + 10780), a1, *(a1 + 7), a2, a3, a4, valuePtr, a1[2723]);
        v23 = AVE_GetCurrTime();
        v24 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetUsage", 12118, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetSourceFrameCount", 12492, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v21)
        {
          printf("%lld %d AVE %s: %s:%d %s | out of range %p %lld %p %p %p %d\n", v22, 30, v23, "AVE_Prop_HEVC_SetQuantizationScalingMatrixPreset", 12643, "iQSMatrixPreset > 0", a1, *(a1 + 7), a2, a3, a4, valuePtr);
          v24 = AVE_GetCurrTime();
          v32 = AVE_Log_GetLevelStr(4);
    ...
    else
    {
      ...
      if (!v11)
      {
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          v15 = 12721;
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v29, 30, v30, "AVE_Prop_HEVC_GetQuantizationScalingMatrixPreset", 12721, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          goto LABEL_31;
        }
...
uint64_t AVE_Prop_HEVC_SetEncoderEncryptionKeyID(char *a1, const char **a2, const __CFString *a3, const __CFData *a4)
{
  ...
  if (TypeID == CFGetTypeID(a4))
  {
      ...
      if (Length == 16)
      {
        ...
        *(a1 + 11980) = *v10;
        ...
        if (result)
        {
          ...
          if (v13)
          {
            printf("%lld %d AVE %s: %p %lld SetProp %s\n", v14, 30, v15, a1, *(a1 + 7), v16);
            v17 = AVE_GetCurrTime();
            v18 = AVE_Log_GetLevelStr(7);
            syslog(3, "%lld %d AVE %s: %p %lld SetProp %s", v17, 30, v18, a1, *(a1 + 7), *a2);
          }

          else
          {
            syslog(3, "%lld %d AVE %s: %p %lld SetProp %s", v14, 30, v15, a1, *(a1 + 7), v16);
          }
    ...
    if (AVE_Log_CheckLevel(0x1Eu, 4))
    {
      ...
      if (v28)
      {
        printf("%lld %d AVE %s: %s:%d %s | fail to get CFDataGetBytePtr  %p %lld %p %p %p\n", v29, 30, v30, "AVE_Prop_HEVC_SetEncoderEncryptionKeyID", 12996, "pData != __null", a1, *(a1 + 7), a2, a3, a4);
        v29 = AVE_GetCurrTime();
        v30 = AVE_Log_GetLevelStr(4);
      }
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      else
      {
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          if (v23)
          {
            printf("%lld %d AVE %s: %s:%d %s | No set features %p %lld %p %p %p 0x%x\n", v24, 30, v25, "AVE_Prop_HEVC_SetPerfFeatureOn", 13541, "iFeature != 0", a1, *(a1 + 7), a2, a3, a4, valuePtr);
            v26 = AVE_GetCurrTime();
            v28 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p 0x%x\n", v21, 30, v22, "AVE_Prop_HEVC_GetPerfFeatureOn", 13587, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      else
      {
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          if (v23)
          {
            printf("%lld %d AVE %s: %s:%d %s | No set features %p %lld %p %p %p 0x%x\n", v24, 30, v25, "AVE_Prop_HEVC_SetPerfFeatureOff", 13638, "iFeature != 0", a1, *(a1 + 7), a2, a3, a4, valuePtr);
            v26 = AVE_GetCurrTime();
            v28 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p 0x%x\n", v21, 30, v22, "AVE_Prop_HEVC_GetPerfFeatureOff", 13684, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetSVENum", 13781, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetSVEMap(char *a1, const char **a2, const __CFString *a3, const __CFString *a4)
{
  if (a1 && a2 && a3 && a4)
  {
    TypeID = CFStringGetTypeID();
    if (TypeID == CFGetTypeID(a4))
    {
      Str = AVE_CFStr_GetStr(a4, a1 + 106964, 0x80u);
      AVE_SNPrintf(a1 + 106964, 128, "%s", Str);
      v10 = AVE_DLB_ParseCfg(a1 + 106964, a1 + 2866);
      if (v10)
      {
        v11 = v10;
        if (AVE_Log_CheckLevel(0x1Eu, 4))
        {
          ...
          if (v12)
          {
            printf("%lld %d AVE %s: %s:%d %s | fail to parse DLB configuration %p %lld %p %p %p %d\n", CurrTime, 30, LevelStr, "AVE_Prop_HEVC_SetSVEMap", 13833, "ret == 0", a1, *(a1 + 7), a2, a3, a4, v11);
            v15 = AVE_GetCurrTime();
            v29 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetSVESchedMode", 13972, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetDLBType", 14069, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetSessionName(char *a1, const char **a2, const __CFString *a3, const __CFString *a4)
{
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      Str = AVE_CFStr_GetStr(a4, a1 + 107112, 0x200u);
      AVE_SNPrintf(a1 + 107112, 512, "%s", Str);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetInitialQPI", 14543, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetInitialQPP", 14642, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetInitialQPB", 14741, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetRCMode", 15130, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
  ...
  if (a1 && a2 && a4 && a5)
  {
    ...
    else
    {
      if (AVE_Log_CheckLevel(0x1Eu, 4))
      {
        ...
        if (v20)
        {
          printf("%lld %d AVE %s: %s:%d %s | fail to create CFNumber %p %lld %p %p %p %p %d\n", v21, 30, v22, "AVE_Prop_HEVC_GetBitRate", 15228, "pNum != __null", a1, *(a1 + 7), a2, allocator, a4, a5, valuePtr);
          v23 = AVE_GetCurrTime();
          v25 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetVBVBufferSize(void *a1, const char **a2, const __CFString *a3, const __CFNumber *a4)
{
  v8 = AVE_DW_Get();
  v38 = 0.0;
  valuePtr = 0.0;
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      {
        *(a1 + 13461) = valuePtr;
        v12 = AVE_RC_DecideVBVBufferSize(v9[104], v11, *(a1 + 13295), *(a1 + 140), &v38);
        if (v12)
        {
          v13 = v12;
          if (AVE_Log_CheckLevel(0x1Eu, 4))
          {
            ...
            if (v14)
            {
              printf("%lld %d AVE %s: %s:%d %s | Decide VBVMaxBufferSize fail %p %lld %p %p %p %f %f %f 0x%llx\n", v15, 30, v16, "AVE_Prop_HEVC_SetVBVBufferSize", 15384, "ret == 0", a1, *(a1 + 7), a2, a3, a4, v9[104], valuePtr, *(a1 + 13295), *(a1 + 140));
              v17 = AVE_GetCurrTime();
              v35 = AVE_Log_GetLevelStr(4);
...
uint64_t AVE_Prop_HEVC_SetVBVInitialDelay(void *a1, const char **a2, const __CFString *a3, const __CFNumber *a4)
{
  v8 = AVE_DW_Get();
  v38 = 0.0;
  valuePtr = 0.0;
  if (a1 && a2 && a3 && a4)
  {
    ...
    if (TypeID == CFGetTypeID(a4))
    {
      ...
      {
        *(a1 + 13462) = valuePtr;
        v26 = AVE_RC_DecideVBVInitialDelay(v9[105], v11, *(a1 + 13296), *(a1 + 152), *(a1 + 140), &v38);
        if (v26)
        {
          v25 = v26;
          if (AVE_Log_CheckLevel(0x1Eu, 4))
          {
            ...
            if (v27)
            {
              printf("%lld %d AVE %s: %s:%d %s | Decide VBVInitialDelay fail %p %lld %p %p %p %f %f %f %f 0x%llx\n", CurrTime, 30, LevelStr, "AVE_Prop_HEVC_SetVBVInitialDelay", 15495, "ret == 0", a1, *(a1 + 7), a2, a3, a4, v9[105], valuePtr, *(a1 + 13296), *(a1 + 152), *(a1 + 140));
              v30 = AVE_GetCurrTime();
              v37 = AVE_Log_GetLevelStr(4);
