...
+ (id)localizedComplicationName
{
  ...
  v3 = [v2 localizedStringForKey:@"COMPLICATION_TITLE" value:&stru_105F8 table:@"AnalogSeconds"];
...
- (void)getCurrentTimelineEntryWithHandler:(id)handler
{
  ...
  v10 = v6;
  v7 = [(NTKAnalogSecondsComplicationBundleDataSource *)self _graphicTemplateWithOverrideDate:v6];
  v8 = +[NSDate date];
