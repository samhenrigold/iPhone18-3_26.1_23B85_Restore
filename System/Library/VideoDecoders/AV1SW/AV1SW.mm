...
uint64_t sub_27754D440(uint64_t result, uint64_t a2, int *a3, int8x16_t *a4, uint64_t a5, uint64_t a6)
{
  v6 = *a3;
  v7 = a3[1];
  v8 = a3[2];
...
void sub_27754D554(uint64_t a1, uint64_t a2, int *a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  v6 = *a3;
  v7 = a3[1];
  v8 = a3[2];
...
uint64_t sub_27754D678(uint64_t result, uint64_t a2, _DWORD *a3, int8x16_t *a4, uint64_t a5, uint64_t a6)
{
  v6 = a3[1];
  v7 = (a6 + 128);
  v8 = (a4 - 4 * a5);
...
void sub_27754D768(uint64_t a1, uint64_t a2, _DWORD *a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  v6 = a3[1];
  v7 = (a6 + 128);
  v8 = (a4 - 4);
...
double sub_27754D868@<D0>(unsigned int a1@<W8>)
{
...
double sub_27754DC30@<D0>(unsigned int a1@<W8>)
{
...
double sub_27754DE48@<D0>(unsigned int a1@<W8>)
{
...
void sub_27754E1F0(unsigned int a1@<W8>)
{
  sub_27754DE48(a1);
  if (!v7)
  {
...
void sub_27754E244(unsigned int a1@<W8>)
{
  sub_27754DE48(a1);
  if (!v7)
  {
...
void sub_27754E334(unsigned int a1@<W8>)
{
  sub_27754DC30(a1);
  if (v3)
  {
...
void sub_27754E3B8(unsigned int a1@<W8>)
{
  sub_27754DC30(a1);
  if (v3)
  {
...
void sub_27754E540(unsigned int a1@<W8>)
{
  *&v8 = sub_27754D868(a1);
  if (v7)
  {
...
void sub_27754E62C(unsigned int a1@<W8>)
{
  *v8.i64 = sub_27754D868(a1);
  if (v7)
  {
    if ((v7 & 0x40) != 0)
    {
...
uint64_t sub_27754E93C(uint64_t result, uint64_t a2, int *a3, int8x8_t *a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8)
{
  v8 = a8;
  v9 = *a3;
  v10 = a3[1];
...
void sub_27754EA84(uint64_t a1, uint64_t a2, int *a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8)
{
  v8 = a8;
  v9 = *a3;
  v10 = a3[1];
...
uint64_t sub_27754EBD4(uint64_t result, uint64_t a2, _DWORD *a3, int8x8_t *a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8)
{
  v8 = a8;
  v9 = a3[1];
  v10 = (a6 + 128);
...
void sub_27754ECF4(uint64_t a1, uint64_t a2, _DWORD *a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8)
{
  v8 = a8;
  v9 = a3[1];
  v10 = (a6 + 128);
...
char *sub_27754EEB4(int8x8_t *a1, uint64_t a2, unsigned __int32 *a3, int8x8_t *a4, uint64_t a5, uint64_t a6, int16x8_t *a7, char a8, double a9, double a10, int8x16_t a11)
{
  v11 = *a7;
  v12 = a7[1];
  if ((a8 & 4) == 0)
  {
    sub_27754F028(v11, v12.n128_f64[0], a11, a1, a2, a3, a1, a5, a6, a7, a8);
    v88 = (v87 - 1);
    if (!v88)
    {
      return sub_27754F17C(v34, v35, *v41.i64, v42, v36, v37, v38);
    }

    sub_27754F028(v41, *v42.i64, v86, v34, v35, v36, (v37 + v35), v38, v88, v84, v85);
    v93 = (v92 - 1);
    if (v93)
    {
      sub_27754F028(v53, *v54.i64, v91, v46, v47, v48, (v49 + v47), v50, v93, v89, v90);
      v98 = (v97 - 1);
      if (v98)
      {
        v58 = sub_27754F238(v58, v59, v60, (v61 + v59), v62, v65, v66, v96, v98, v94, v95);
        v103 = (v102 - 1);
        if (v103)
        {
          v58 = sub_27754F238(v58, v59, v60, v61, v62, v65, v66, v101, v103, v99, v100);
          v69 = (v104 - 1);
          if (v69)
          {
            goto LABEL_6;
...
LABEL_16:
    v34 = sub_27754F17C(v46, v47, *v53.i64, v54, v48, v49, v50);
    return sub_27754F17C(v34, v35, *v41.i64, v42, v36, v37, v38);
  }

  sub_27754F028(v11, v12.n128_f64[0], a11, a1, a2, 0, a4, a5, a6, a7, a8);
  sub_27754F028(v21, v22, v23, v14, v15, v16, (v13 + v15), v17, v18, v19, v20);
  sub_27754F028(v31, v32, v33, v24, v25, v30, v24, v26, v27, v28, v29);
  v45 = (v44 - 1);
  if (v45)
  {
    sub_27754F028(v41, *v42.i64, v43, v34, v35, v36, (v37 + v35), v38, v45, v39, v40);
    v57 = (v56 - 1);
    if (v57)
    {
      sub_27754F028(v53, *v54.i64, v55, v46, v47, v48, (v49 + v47), v50, v57, v51, v52);
      v69 = (v68 - 1);
      if (v69)
      {
        v61 = (v61 + v59);
        ...
        {
LABEL_6:
          v58 = sub_27754F238(v58, v59, v60, v61, v62, v65, v66, v67, v69, v63, v64);
          v69 = (v71 - 1);
        }
        ...
        if ((v64 & 8) != 0)
        {
          v72 = sub_27754F238(v58, v59, 0, v70, v62, v65, v66, v67, v69, v63, v64);
          v34 = sub_27754F238(v72, v73, v74, v75, v76, v80, v81, v82, v77, v78, v79);
          return sub_27754F17C(v34, v35, *v41.i64, v42, v36, v37, v38);
        }
      }

LABEL_15:
      v46 = sub_27754F17C(v58, v59, *v65.i64, v66, v60, v61, v62);
      goto LABEL_16;
    }
...
void sub_27754F028(int16x8_t a1, double a2, int8x16_t a3, uint64_t a4, uint64_t a5, unsigned __int32 *a6, int8x8_t *a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  if (a11)
  {
    if (a6)
...
char *sub_27754F17C(int8x16_t *a1, uint64_t a2, double a3, int16x8_t a4, uint64_t a5, uint64_t a6, int a7)
{
  v33 = a1;
  do
  {
...
char *sub_27754F238(int8x16_t *a1, uint64_t a2, unsigned __int32 *a3, int8x8_t *a4, int a5, int16x8_t a6, int16x8_t a7, int8x16_t a8, uint64_t a9, uint64_t a10, char a11)
{
  v61 = a1;
  if (a11)
  {
...
void sub_27754F438(int8x8_t *a1, uint64_t a2, unsigned __int32 *a3, int8x8_t *a4, uint64_t a5, uint64_t a6, int16x8_t *a7, char a8, double a9, double a10, int8x16_t a11)
{
  v11 = *a7;
  v12 = a7[1];
  if ((a8 & 4) != 0)
  {
    sub_27754F574(v11, v12.n128_f64[0], a11, a1, a2, 0, a4, a5, a6, a7, a8);
    sub_27754F574(v21, v22, v23, v14, v15, v16, (v13 + v15), v17, v18, v19, v20);
    sub_27754F574(v31, v32, v33, v24, v25, v30, v24, v26, v27, v28, v29);
    v45 = (v44 - 1);
    if (v45)
    {
      sub_27754F574(v41, *v42.i64, v43, v34, v35, v36, (v37 + v35), v38, v45, v39, v40);
      v57 = (v56 - 1);
      if (v57)
      {
        v49 = (v49 + v47);
        ...
        {
LABEL_5:
          v46 = sub_27754F738(v46, v47, v48, v49, v50, v53, v54, v55, v57, v51, v52);
          v57 = (v59 - 1);
        }
        ...
        if ((v52 & 8) != 0)
        {
          v60 = sub_27754F738(v46, v47, 0, v58, v50, v53, v54, v55, v57, v51, v52);
          sub_27754F738(v60, v61, v62, v63, v64, v68, v69, v70, v65, v66, v67);
          return;
        }
      }

LABEL_12:
      sub_27754F6A8(v46, *v53.i64, v54, v47, v48, v49, v50);
      v34 = (v87 + v35);
    }
  }
  ...
  {
    sub_27754F574(v11, v12.n128_f64[0], a11, a1, a2, a3, a1, a5, a6, a7, a8);
    v75 = (v74 - 1);
    if (v75)
    {
      sub_27754F574(v41, *v42.i64, v73, v34, v35, v36, (v37 + v35), v38, v75, v71, v72);
      v80 = (v79 - 1);
      if (v80)
      {
        v46 = sub_27754F738(v46, v47, v48, (v49 + v47), v50, v53, v54, v78, v80, v76, v77);
        v85 = (v84 - 1);
        if (v85)
        {
          v46 = sub_27754F738(v46, v47, v48, v49, v50, v53, v54, v83, v85, v81, v82);
          v57 = (v86 - 1);
          if (v57)
          {
            goto LABEL_5;
  ...
  sub_27754F6A8(v34, *v41.i64, v42, v35, v36, v37, v38);
}

void sub_27754F574(int16x8_t a1, double a2, int8x16_t a3, uint64_t a4, uint64_t a5, unsigned __int32 *a6, int8x8_t *a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  if (a11)
  {
    if (a6)
...
void sub_27754F6A8(int8x16_t *a1, double a2, int16x8_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int a7)
{
  do
  {
    v11 = *v8;
...
char *sub_27754F738(int8x16_t *a1, uint64_t a2, unsigned __int32 *a3, int8x8_t *a4, int a5, int16x8_t a6, int16x8_t a7, int8x16_t a8, uint64_t a9, uint64_t a10, char a11)
{
  v53 = a1;
  if (a11)
  {
...
uint32x4_t *sub_27754F8F0(uint32x4_t *result, int8x16_t *a2, unsigned __int32 *a3, int8x8_t *a4, int a5, char a6, double a7, int8x16_t a8)
{
  v9 = a5 + 2;
  if (a6)
  {
...
LABEL_8:
    if (v9 < 10)
    {
      v12 = vbslq_s8(*(&unk_27A716E00 - v9), v8, v12);
      v16 = vmull_u8(*v12.i8, *v12.i8);
      v17 = vmull_high_u8(v12, v12);
    }
  }
...
int32x4_t *sub_27754F9C8(int32x4_t *result, int8x16_t *a2, unsigned __int32 *a3, int8x8_t *a4, int a5, char a6, double a7, int8x16_t a8)
{
  v9 = a5 + 2;
  if (a6)
  {
...
LABEL_8:
    if (v9 < 11)
    {
      v12 = vbslq_s8(*&algn_27A716DD0[-v9 + 47], v8, v12);
      v16 = vmull_u8(*v12.i8, *v12.i8);
      v17 = vmull_high_u8(v12, v12);
    }
  }
...
int32x4_t *sub_27754FACC(int32x4_t *result, int16x8_t *a2, int32x4_t *a3, int8x16_t *a4, unsigned __int32 *a5, int8x8_t *a6, int a7, char a8, double a9, int8x16_t a10)
{
  v11 = a7 + 2;
  if (a8)
  {
...
LABEL_8:
    if (v11 < 11)
    {
      v14 = vbslq_s8(*&algn_27A716DD0[-v11 + 47], v10, v14);
      v18 = vmull_u8(*v14.i8, *v14.i8);
      v19 = vmull_high_u8(v14, v14);
    }
  }
...
int16x8_t *sub_27754FBD8(int16x8_t *result, uint8x8_t *a2, uint64_t a3, void *a4, void *a5, int a6, int a7)
{
  v7 = *a4;
  v8 = a4[1];
  v10 = a4[2];
...
uint8x8_t *sub_27754FE04(uint8x8_t *result, void *a2, void *a3, int a4, unsigned int a5)
{
  v5 = *a2;
  v6 = a2[1];
  v7 = a2[2];
...
int16x8_t *sub_27754FF70(int16x8_t *result, uint8x8_t *a2, uint64_t a3, void *a4, void *a5, int a6, int a7)
{
  v7 = *a4;
  v8 = a4[1];
  v10 = *a5;
...
uint8x8_t *sub_2775500C4(uint8x8_t *result, uint64_t a2, void *a3, void *a4, int a5, int a6, unsigned int a7)
{
  v7 = vdupq_n_s16(a7);
  v8 = *a3;
  v9 = a3[1];
...
int8x8_t *sub_277550258(int8x8_t *result, uint64_t a2, uint8x8_t *a3, uint64_t a4, int16x8_t *a5, int16x8_t *a6, uint64_t a7, int a8, const __int16 *a9)
{
  v10 = (result + a2);
  v11 = (a3 + a4);
  v12 = a5 + 48;
...
char *sub_2775503A8(uint64_t a1, uint64_t a2, unint64_t *a3, uint64_t a4, uint64_t a5, uint64_t a6, int64x2_t *a7, char a8, double a9, double a10, double a11, double a12, int8x16_t a13, unsigned int a14)
{
  v14 = a7[1];
  *&v15 = vdupq_n_s32(38 - __clz(a14)).u64[0];
  ...
  if ((a8 & 4) == 0)
  {
    sub_277550554(v16, *v14.i64, v15, a12, a13, a1, a2, a3, a1, a5, a6, a7, a8);
    v107 = (v106 - 1);
    if (!v107)
    {
      return sub_2775506D8(v42, v43, v49, v44, v45, v46);
    }

    sub_277550554(*v49.i8, v102, v103, v104, v105, v42, v43, v44, v45 + v43, v46, v107, v100, v101);
    v115 = (v114 - 1);
    if (v115)
    {
      sub_277550554(*v63.i8, v110, v111, v112, v113, v56, v57, v58, v59 + v57, v60, v115, v108, v109);
      v123 = (v122 - 1);
      if (v123)
      {
        v70 = sub_2775507BC(v70, v71, v72, v73 + v71, v74, v77, v118, v119, v120, v121, v123, v116, v117);
        v131 = (v130 - 1);
        if (v131)
        {
          v70 = sub_2775507BC(v70, v71, v72, v73, v74, v77, v126, v127, v128, v129, v131, v124, v125);
          v83 = (v132 - 1);
          if (v83)
          {
            goto LABEL_6;
...
LABEL_16:
    v42 = sub_2775506D8(v56, v57, v63, v58, v59, v60);
    return sub_2775506D8(v42, v43, v49, v44, v45, v46);
  }

  sub_277550554(v16, *v14.i64, v15, a12, a13, a1, a2, 0, a4, a5, a6, a7, a8);
  sub_277550554(v25, v26, v27, v28, v29, v18, v19, v20, v17 + v19, v21, v22, v23, v24);
  sub_277550554(v37, v38, v39, v40, v41, v30, v31, v36, v30, v32, v33, v34, v35);
  v55 = (v54 - 1);
  if (v55)
  {
    sub_277550554(*v49.i8, v50, v51, v52, v53, v42, v43, v44, v45 + v43, v46, v55, v47, v48);
    v69 = (v68 - 1);
    if (v69)
    {
      sub_277550554(*v63.i8, v64, v65, v66, v67, v56, v57, v58, v59 + v57, v60, v69, v61, v62);
      v83 = (v82 - 1);
      if (v83)
      {
        v73 += v71;
        ...
        {
LABEL_6:
          v70 = sub_2775507BC(v70, v71, v72, v73, v74, v77, v78, v79, v80, v81, v83, v75, v76);
          v83 = (v85 - 1);
        }
        ...
        if ((v76 & 8) != 0)
        {
          v86 = sub_2775507BC(v70, v71, 0, v84, v74, v77, v78, v79, v80, v81, v83, v75, v76);
          v42 = sub_2775507BC(v86, v87, v88, v89, v90, v94, v95, v96, v97, v98, v91, v92, v93);
          return sub_2775506D8(v42, v43, v49, v44, v45, v46);
        }
      }

LABEL_15:
      v56 = sub_2775506D8(v70, v71, v77, v72, v73, v74);
      goto LABEL_16;
    }
...
void sub_277550554(int16x4_t a1, double a2, double a3, double a4, int8x16_t a5, uint64_t a6, uint64_t a7, unint64_t *a8, uint64_t a9, int a10, uint64_t a11, uint64_t a12, char a13)
{
  if (a13)
  {
    if (a8)
...
char *sub_2775506D8(uint16x8_t *a1, uint64_t a2, int16x8_t a3, uint64_t a4, uint64_t a5, int a6)
{
  v28 = a1;
  do
  {
...
char *sub_2775507BC(uint16x8_t *a1, uint64_t a2, unint64_t *a3, uint64_t a4, int a5, int16x8_t a6, double a7, double a8, double a9, int8x16_t a10, uint64_t a11, uint64_t a12, char a13)
{
  v70 = a1;
  if (a13)
  {
...
void sub_277550A14(uint64_t a1, uint64_t a2, unint64_t *a3, uint64_t a4, uint64_t a5, uint64_t a6, int64x2_t *a7, char a8, double a9, double a10, double a11, double a12, int8x16_t a13, unsigned int a14)
{
  v14 = a7[1];
  *&v15 = vdupq_n_s32(38 - __clz(a14)).u64[0];
  v16 = vzip1q_s64(*a7, v14).u64[0];
  if ((a8 & 4) != 0)
  {
    sub_277550B88(v16, *v14.i64, v15, a12, a13, a1, a2, 0, a4, a5, a6, a7, a8);
    sub_277550B88(v25, v26, v27, v28, v29, v18, v19, v20, v17 + v19, v21, v22, v23, v24);
    sub_277550B88(v37, v38, v39, v40, v41, v30, v31, v36, v30, v32, v33, v34, v35);
    v55 = (v54 - 1);
    if (v55)
    {
      sub_277550B88(*v49.i8, v50, v51, v52, v53, v42, v43, v44, v45 + v43, v46, v55, v47, v48);
      v69 = (v68 - 1);
      if (v69)
      {
        v59 += v57;
        ...
        {
LABEL_5:
          v56 = sub_277550D94(v56, v57, v58, v59, v60, v63, v64, v65, v66, v67, v69, v61, v62);
          v69 = (v71 - 1);
        }
        ...
        if ((v62 & 8) != 0)
        {
          v72 = sub_277550D94(v56, v57, 0, v70, v60, v63, v64, v65, v66, v67, v69, v61, v62);
          sub_277550D94(v72, v73, v74, v75, v76, v80, v81, v82, v83, v84, v77, v78, v79);
          return;
        }
      }

LABEL_12:
      sub_277550CE4(v56, v63, v57, v58, v59, v60);
      v42 = (v110 + v43);
    }
  }
  ...
  {
    sub_277550B88(v16, *v14.i64, v15, a12, a13, a1, a2, a3, a1, a5, a6, a7, a8);
    v92 = (v91 - 1);
    if (v92)
    {
      sub_277550B88(*v49.i8, v87, v88, v89, v90, v42, v43, v44, v45 + v43, v46, v92, v85, v86);
      v100 = (v99 - 1);
      if (v100)
      {
        v56 = sub_277550D94(v56, v57, v58, v59 + v57, v60, v63, v95, v96, v97, v98, v100, v93, v94);
        v108 = (v107 - 1);
        if (v108)
        {
          v56 = sub_277550D94(v56, v57, v58, v59, v60, v63, v103, v104, v105, v106, v108, v101, v102);
          v69 = (v109 - 1);
          if (v69)
          {
            goto LABEL_5;
  ...
  sub_277550CE4(v42, v49, v43, v44, v45, v46);
}

void sub_277550B88(int16x4_t a1, double a2, double a3, double a4, int8x16_t a5, uint64_t a6, uint64_t a7, unint64_t *a8, uint64_t a9, int a10, uint64_t a11, uint64_t a12, char a13)
{
  if (a13)
  {
    if (a8)
...
void sub_277550CE4(uint16x8_t *a1, int16x8_t a2, uint64_t a3, uint64_t a4, uint64_t a5, int a6)
{
  do
  {
    v12 = *v6;
...
char *sub_277550D94(uint16x8_t *a1, uint64_t a2, unint64_t *a3, uint64_t a4, int a5, int16x8_t a6, double a7, double a8, double a9, int8x16_t a10, uint64_t a11, uint64_t a12, char a13)
{
  v59 = a1;
  if (a13)
  {
...
uint32x4_t *sub_277550F94(uint32x4_t *result, int16x8_t *a2, unint64_t *a3, uint64_t a4, int a5, char a6, double a7, double a8, int8x16_t a9)
{
  v10 = a5 + 2;
  if (a6)
  {
...
uint32x4_t *sub_277551060(uint32x4_t *result, int16x8_t *a2, unint64_t *a3, uint64_t a4, int a5, char a6, double a7, double a8, int8x16_t a9)
{
  v10 = a5 + 2;
  if (a6)
  {
...
uint32x4_t *sub_277551150(uint32x4_t *result, int16x8_t *a2, uint32x4_t *a3, int16x8_t *a4, unint64_t *a5, uint64_t a6, int a7, char a8, double a9, double a10, int8x16_t a11)
{
  v12 = a7 + 2;
  if (a8)
  {
...
int16x8_t *sub_277551248(int16x8_t *result, uint16x8_t *a2, uint64_t a3, void *a4, void *a5, int a6, int a7)
{
  v7 = *a4;
  v8 = a4[1];
  v10 = a4[2];
...
uint16x4_t *sub_27755146C(uint16x4_t *result, void *a2, void *a3, int a4, unsigned int a5, unsigned int a6)
{
  v6 = *a2;
  v7 = a2[1];
  v8 = a2[2];
...
int16x8_t *sub_2775515D4(int16x8_t *result, uint16x8_t *a2, uint64_t a3, void *a4, void *a5, int a6, int a7)
{
  v7 = *a4;
  v8 = a4[1];
  v10 = *a5;
...
uint16x4_t *sub_277551720(uint16x4_t *result, uint64_t a2, void *a3, void *a4, int a5, int a6, unsigned int a7, unsigned int a8)
{
  v8 = vdupq_n_s16(a7);
  v9 = vdupq_n_s16(a8);
  v10 = *a3;
...
uint16x8_t *sub_2775518AC(uint16x8_t *result, uint64_t a2, int16x8_t *a3, uint64_t a4, int16x8_t *a5, int16x8_t *a6, uint64_t a7, int a8, const __int16 *a9, unsigned int a10)
{
  v11 = (result + a2);
  v12 = (a3 + a4);
  v13 = a5 + 48;
...
__int32 *sub_277551A00(__int32 *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  do
  {
    v7.i32[0] = *result;
...
uint8x8_t *sub_277551A40(uint8x8_t *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  do
  {
    v7 = *result;
...
uint8x16_t *sub_277551A90(uint8x16_t *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  do
  {
    v7 = *result;
...
uint8x16_t *sub_277551B00(uint8x16_t *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  do
  {
    v7 = *result;
...
uint8x8_t *sub_277551B60(uint8x8_t *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  do
  {
    v6 = __OFSUB__(a5--, 1);
...
void sub_277551ED0(uint64_t a1, uint64_t a2, _OWORD *a3)
{
  *a3 = 0u;
  a3[1] = 0u;
  JUMPOUT(0x277551FC8);
...
char *sub_277551F70(uint64_t a1, uint64_t a2, _OWORD *a3, uint64_t a4, uint64_t (*a5)(uint64_t, uint64_t, _OWORD *))
{
  *a3 = 0u;
  v5 = (a5)(a1, a2, a3 + 1, a4);
  *v6 = v7;
...
char *sub_277551FF0(uint64_t a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (!a4)
  {
    vld1q_dup_s16(a3);
  ...
  return sub_277551F70(a1, a2, a3, a4, sub_277551BB4);
}

void sub_277552980(uint64_t a1, uint64_t a2, _OWORD *a3)
{
  *a3 = 0u;
  a3[1] = 0u;
  a3[2] = 0u;
...
char *sub_2775529A4(uint64_t a1, uint64_t a2, _OWORD *a3, uint64_t a4, uint64_t (*a5)(uint64_t, uint64_t))
{
  *a3 = 0u;
  a3[1] = 0u;
  a3[2] = 0u;
...
uint8x8_t *sub_277552AF4(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_2775529A4(a1, a2, a3, a4, sub_277552128);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A40(a1, a2, a3, a4, 8);
}

char *sub_277552C10(uint64_t a1, uint64_t a2, _OWORD *a3, uint64_t a4, uint64_t (*a5)(uint64_t, uint64_t))
{
  *a3 = 0u;
  a3[1] = 0u;
  v5 = a3 + 2;
...
char *sub_277552D00(uint64_t a1, uint64_t a2, _OWORD *a3, uint64_t a4, uint64_t (*a5)(uint64_t, uint64_t))
{
  *a3 = 0u;
  a3[1] = 0u;
  a3[2] = 0u;
...
__int32 *sub_277552DF0(__int32 *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_277552D00(a1, a2, a3, a4, sub_277551C04);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A00(a1, a2, a3, a4, 8);
}

uint8x8_t *sub_277552F1C(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_277552C10(a1, a2, a3, a4, sub_27755226C);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A40(a1, a2, a3, a4, 4);
}

void sub_27755469C(void (*a1)(void)@<X4>, _OWORD *a2@<X7>, uint64_t a3@<X8>)
{
  *a2 = 0u;
  v3 = (a2 + a3);
  *v3 = 0u;
...
void sub_2775547B4(_OWORD *a1@<X7>, uint64_t a2@<X8>)
{
  *a1 = 0u;
  v2 = (a1 + a2);
  *v2 = 0u;
...
uint64_t sub_277554908@<X0>(uint64_t (*a1)(void)@<X4>, _OWORD *a2@<X7>, uint64_t a3@<X8>)
{
  *a2 = 0u;
  v3 = (a2 + a3);
  *v3 = 0u;
...
uint64_t sub_277554AD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t (*a6)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))
{
...
uint64_t sub_277554C68(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  ...
  v15 = sub_277554AD8(v7, v8, v9, v10, v11, v12);
  return sub_277554AD8(v15, v16, v17, v18, v19, v20);
}

uint8x16_t *sub_277554CD8(uint8x16_t *a1, uint64_t a2, const __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_277554C68(a1, a2, a3, a4, sub_277553048, sub_277553048);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A90(a1, a2, a3, a4, 16);
}

void sub_277554DEC(uint64_t a1, uint64_t a2, void *a3)
{
  *a3 = 0;
  v3 = a3 + 1;
  *v3++ = 0;
...
void sub_277554F40(uint64_t a1, uint64_t a2, _OWORD *a3, int a4)
{
  if (a4 >= v4)
  {
    a3[1] = 0uLL;
...
uint8x8_t *sub_277555044(uint64_t a1, uint64_t a2, void *a3, uint64_t a4, uint64_t (*a5)(uint64_t, uint64_t, void *))
{
  *a3 = 0;
  v5 = a3 + 1;
  *v5++ = 0;
...
char *sub_27755520C(uint64_t a1, uint64_t a2, _OWORD *a3, int a4, uint64_t (*a5)(uint64_t, uint64_t))
{
  v6 = 2;
  if (a4 >= v5)
  {
...
__int32 *sub_277555420(__int32 *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_27755520C(a1, a2, a3, a4, sub_277551C04);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A00(a1, a2, a3, a4, 16);
}

uint8x16_t *sub_27755553C(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_277555044(a1, a2, a3, a4, sub_2775533A0);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A90(a1, a2, a3, a4, 4);
}

void sub_277555618(uint64_t a1, uint64_t a2, _OWORD *a3)
{
  *a3 = 0u;
  v3 = a3 + 1;
  *v3++ = 0u;
  ...
  *v3 = 0u;
  v3[1] = 0u;
  JUMPOUT(0x277555A3CLL);
}

void sub_2775557B4(uint64_t a1, uint64_t a2, _OWORD *a3, int a4)
{
  if (a4 >= v4)
  {
    a3[1] = 0uLL;
...
char *sub_277555928(uint64_t a1, uint64_t a2, _OWORD *a3, uint64_t a4, uint64_t (*a5)(uint64_t, uint64_t, _OWORD *))
{
  *a3 = 0u;
  v5 = a3 + 1;
  *v5++ = 0u;
...
char *sub_277555C58(uint64_t a1, uint64_t a2, _OWORD *a3, int a4, uint64_t (*a5)(uint64_t, uint64_t))
{
  v6 = 2;
  if (a4 >= v5)
  {
...
uint8x8_t *sub_277555FBC(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_277555C58(a1, a2, a3, a4, sub_277552128);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A40(a1, a2, a3, a4, 16);
}

uint8x16_t *sub_2775560DC(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    return sub_277555928(a1, a2, a3, a4, sub_277553048);
  }

  vld1q_dup_s16(a3);
  *a3 = 0;
  return sub_277551A90(a1, a2, a3, a4, 8);
}

void sub_27755667C(_OWORD *a1@<X7>, uint64_t a2@<X8>)
{
  v2 = 2 * a2;
  *a1 = 0u;
  v3 = (a1 + v2);
...
void sub_277556B64(_OWORD *a1@<X7>, uint64_t a2@<X8>)
{
  v2 = 2 * a2;
  *a1 = 0u;
  v3 = (a1 + v2);
...
uint8x8_t *sub_277557548(uint8x8_t *result, uint64_t a2, _OWORD *a3, int a4)
{
  v4 = &word_27A716FA0;
  while (1)
  {
...
uint8x8_t *sub_2775576E4(uint8x8_t *result, uint64_t a2, _OWORD *a3, int a4)
{
...
uint8x8_t *sub_277557910(uint8x8_t *result, uint64_t a2, _OWORD *a3, int a4)
{
  v4 = vdup_n_s16(0x5A80u);
  v4.i16[1] = 27152;
  v5 = &word_27A716FB0;
...
uint8x8_t *sub_277557B5C(uint8x8_t *result, uint64_t a2, int16x8_t *a3, int a4)
{
  v4 = &word_27A716FB4;
  while (1)
  {
...
char *sub_277557CEC(uint8x8_t *a1, uint64_t a2, _OWORD *a3, int a4)
{
  v4 = &word_27A716FB4;
  while (1)
  {
...
void sub_277557E5C(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_27755667C(a3, 64);
    v5 = &v17;
    v6 = 24;
    if (v7 < v8 || (sub_27755667C((v4 + 16), 64), v5 = &v18, v6 = 16, v10 < v11) || (sub_27755667C((v9 + 32), 64), v5 = &v19, v6 = 8, v13 < v14))
    {
      do
      {
        v15 = __OFSUB__(v6, 4);
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551B00(a1, a2, a3, a4, 32);
  }
}

void sub_277557F7C(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_27755469C(sub_277553048, a3, 64);
    v6 = &v20;
    v7 = 24;
    if (v8 < v9 || (sub_27755469C(v5, (v4 + 16), 64), v6 = &v21, v7 = 16, v12 < v13) || (sub_27755469C(v11, (v10 + 32), 64), v6 = &v22, v7 = 8, v16 < v17))
    {
      do
      {
        v18 = __OFSUB__(v7, 8);
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551A90(a1, a2, a3, a4, 32);
  }
}

uint8x16_t *sub_277558084(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_277556B64(a3, 32);
    ...
    {
      sub_277556B64((v7 + 16), 32);
    }

    v15 = sub_277554AD8(v5, v6, v7, v8, v9, v10);
    v21 = sub_277554AD8(v15, v16, v17, v18, v19, v20);
    v27 = sub_277554AD8(v21, v22, v23, v24, v25, v26);
    return sub_277554AD8(v27, v28, v29, v30, v31, v32);
  }
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    return sub_277551B00(a1, a2, a3, a4, 16);
  }
}

void sub_277558154(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    v4 = 0uLL;
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551A40(a1, a2, a3, a4, 32);
  }
}

void sub_2775582BC(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_27755667C(a3, 16);
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551B00(a1, a2, a3, a4, 8);
  }
}

__n128 sub_2775583EC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int16x8_t *a7)
{
  result = *v7;
  v13 = *(v7 + 16);
...
void sub_277558524(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int16x8_t *a7)
{
  do
  {
    v8 = *(v7 + 128);
...
void sub_27755868C()
{
  ...
  *v17 = vqaddq_s16(v48, v50);
  ...
  sub_2775583EC(v51, v52, v53, v54, v55, v56, v17 + 17);
  sub_2775583EC(v57, v58, v59, v60, v61, v62, v63);
  sub_2775583EC(v64, v65, v66, v67, v68, v69, v70);
  sub_2775583EC(v71, v72, v73, v74, v75, v76, v77);
  sub_277558524(v79, v80, v81, v82, v83, v84, (v78 - 512));
}

void sub_27755896C(_OWORD *a1@<X7>, uint64_t a2@<X8>)
{
  v2 = 4 * a2;
  *a1 = 0u;
  v3 = (a1 + v2);
  ...
  *v70 = 0u;
  *(v70 - v69) = 0u;
  sub_2775583EC(v71, v72, v73, v74, v75, v76, v34 + 17);
  v79 = (v77 + 4 * v78);
  v81 = (v80 - 4 * v78);
  *v79 = 0u;
  *v81 = 0u;
  *(v79 - v78) = 0u;
  *(v81 + v78) = 0u;
  sub_2775583EC(v82, v83, v84, v85, v86, v87, v88);
  *(v90 - 2 * v89 + v89) = 0u;
  *(v93 + v89) = 0u;
  *(v91 - 2 * v89 + v89) = 0u;
  *(v92 + v89) = 0u;
  sub_2775583EC(v94, v95, v96, v97, v98, v99, v100);
  *v101 = 0u;
  *(v103 + v102) = 0u;
  *v104 = 0u;
  *(v105 + v102) = 0u;
  sub_2775583EC(v106, v107, v108, v109, v110, v111, v112);
  sub_277558524(v114, v115, v116, v117, v118, v119, (v113 - 512));
}

void sub_277558CE4(_OWORD *a1@<X7>, uint64_t a2@<X8>)
{
  v2 = 4 * a2;
  *a1 = 0u;
  v3 = (a1 + v2);
...
int16x8_t sub_27755910C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int16x8_t *a7, uint64_t a8, uint64_t a9)
{
  i64 = &a9;
  v11 = &STACK[0x3C0];
  v12 = &a7[7];
...
int8x8_t sub_277559314(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint8x8_t *a7, uint64_t a8, uint64_t a9)
{
  i64 = &a9;
  v10 = &STACK[0x3C0];
  v11 = (&a7[8 * a2] - a2);
...
int8x8_t sub_2775594F0(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_27755896C(a3, 64);
    sub_27755910C(v5, v6, v7, v8, v9, v10, v10, v11, v105);
    v15 = (v14 + 1024);
    v16 = 24;
    if (v17 < *v13 || (sub_27755896C((v12 + 16), 64), sub_27755910C(v18, v19, v20, v21, v22, v23, v23 + 64, v24, v106), v15 = (v27 + 2048), v16 = 16, v28 < *v26) || (sub_27755896C((v25 + 32), 64), sub_27755910C(v29, v30, v31, v32, v33, v34, v34 + 128, v35, v106), v15 = (v38 + 3072), v16 = 8, v39 < *v37))
    {
      do
      {
        v47 = __OFSUB__(v16, 2);
    ...
    {
      sub_27755896C((v36 + 48), 64);
      sub_27755910C(v40, v41, v42, v43, v44, v45, v45 + 192, v46, v106);
    }

    sub_27755868C();
    sub_277559314(v49, v50, v51, v52, v53, v54, v49, v55, v106);
    sub_27755868C();
    sub_277559314(v56, v57, v58, v59, v60, v61, v56 + 1, v62, v107);
    sub_27755868C();
    sub_277559314(v63, v64, v65, v66, v67, v68, v63 + 2, v69, v108);
    sub_27755868C();
    sub_277559314(v70, v71, v72, v73, v74, v75, v70 + 3, v76, v109);
    sub_27755868C();
    sub_277559314(v77, v78, v79, v80, v81, v82, v77 + 4, v83, v110);
    sub_27755868C();
    sub_277559314(v84, v85, v86, v87, v88, v89, v84 + 5, v90, v111);
    sub_27755868C();
    sub_277559314(v91, v92, v93, v94, v95, v96, v91 + 6, v97, v112);
    sub_27755868C();
    return sub_277559314(v98, v99, v100, v101, v102, v103, v98 + 7, v104, v113);
  }
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551B60(a1, a2, a3, a4, 64);
  }

  return result;
}

void sub_2775596A8(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_277558CE4(a3, 64);
    sub_27755910C(v4, v5, v6, v7, v8, v9, v9, v10, v48);
    v14 = (v13 + 1024);
    v15 = 24;
    if (v16 < *v12 || (sub_277558CE4((v11 + 16), 64), sub_27755910C(v17, v18, v19, v20, v21, v22, v22 + 64, v23, v49), v14 = (v26 + 2048), v15 = 16, v27 < *v25) || (sub_277558CE4((v24 + 32), 64), sub_27755910C(v28, v29, v30, v31, v32, v33, v33 + 128, v34, v50), v14 = (v37 + 3072), v15 = 8, v38 < *v36))
    {
      do
      {
        v46 = __OFSUB__(v15, 2);
    ...
    {
      sub_277558CE4((v35 + 48), 64);
      sub_27755910C(v39, v40, v41, v42, v43, v44, v44 + 192, v45, v51);
    }
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551B60(a1, a2, a3, a4, 32);
  }
}

int8x8_t sub_277559844(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_277556B64(a3, 64);
    v7 = (v6 + 512);
    v8 = 24;
    if (v9 < v10 || (sub_277556B64((v5 + 16), 64), v7 = (v12 + 1024), v8 = 16, v13 < v14) || (sub_277556B64((v11 + 32), 64), v7 = (v16 + 1536), v8 = 8, v17 < v18))
    {
      do
      {
        v19 = __OFSUB__(v8, 4);
    ...
    {
      sub_277556B64((v15 + 48), 64);
    }

    sub_27755868C();
    sub_277559314(v21, v22, v23, v24, v25, v26, v21, v27, v49);
    sub_27755868C();
    sub_277559314(v28, v29, v30, v31, v32, v33, v28 + 1, v34, v50);
    sub_27755868C();
    sub_277559314(v35, v36, v37, v38, v39, v40, v35 + 2, v41, v51);
    sub_27755868C();
    return sub_277559314(v42, v43, v44, v45, v46, v47, v42 + 3, v48, v52);
  }
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551B00(a1, a2, a3, a4, 64);
  }

  return result;
}

uint8x8_t *sub_27755997C(uint8x8_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_27755896C(a3, 32);
    sub_27755910C(v5, v6, v7, v8, v9, v10, v9, v11, v71);
    v18 = (v16 + 1024);
    v19 = 8;
    if (v15 < *v17)
    {
    ...
    {
      sub_27755896C((v14 + 16), 32);
      sub_27755910C(v20, v21, v22, v23, v24, v25, v24 + 64, v26, v72);
    }

    v29 = sub_277554AD8(v12, v13, v14, v15, v16, sub_277553048);
    v35 = sub_277554AD8(v29, v30, v31, v32, v33, v34);
    v41 = sub_277554AD8(v35, v36, v37, v38, v39, v40);
    v47 = sub_277554AD8(v41, v42, v43, v44, v45, v46);
    v53 = sub_277554AD8(v47, v48, v49, v50, v51, v52);
    v59 = sub_277554AD8(v53, v54, v55, v56, v57, v58);
    v65 = sub_277554AD8(v59, v60, v61, v62, v63, v64);
    return sub_277554AD8(v65, v66, v67, v68, v69, v70);
  }
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    return sub_277551B60(a1, a2, a3, a4, 16);
  }
}

int8x8_t sub_277559AA0(uint8x16_t *a1, uint64_t a2, __int16 *a3, uint64_t a4)
{
  if (a4)
  {
    sub_277554908(sub_277553048, a3, 64);
    v8 = (v7 + 256);
    v9 = 24;
    if (v10 < v11 || (sub_277554908(v6, (v5 + 16), 64), v8 = (v14 + 512), v9 = 16, v15 < v16) || (sub_277554908(v13, (v12 + 32), 64), v8 = (v19 + 768), v9 = 8, v20 < v21))
    {
      do
      {
        v22 = __OFSUB__(v9, 8);
    ...
    {
      sub_277554908(v18, (v17 + 48), 64);
    }

    sub_27755868C();
    sub_277559314(v24, v25, v26, v27, v28, v29, v24, v30, v38);
    sub_27755868C();
    return sub_277559314(v31, v32, v33, v34, v35, v36, v31 + 1, v37, v39);
  }
  ...
  else
  {
    vld1q_dup_s16(a3);
    *a3 = 0;
    sub_277551A90(a1, a2, a3, a4, 64);
  }

  return result;
}

void sub_277559C10(__n128 a1, __n128 a2, __n128 a3, uint64_t a4, __n128 *a5)
{
  *a5 = a1;
  a5[1] = a2;
  a5[2] = a3;
...
uint64_t sub_277559C44(double a1, int8x8_t a2, int16x8_t a3, __n128 a4, int8x16_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int8x8_t *a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13)
{
  v14 = byte_277559DF0;
  v15 = &unk_27A716FC0;
  v16 = 33620481;
...
void sub_277559DC0(__n128 a1, __n128 a2, __n128 a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  *a7 = a1;
  *(a7 + 16) = a2;
  *(a7 + 24) = a3;
...
void sub_277559DD0(__n128 a1, __n128 a2, __n128 a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  *a7 = a1;
  *(a7 + 16) = a2;
  *(a7 + 30) = a1;
...
uint64_t sub_277559E48(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4)
{
...
float *sub_277559E6C(float *result, uint64_t a2, float a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, float *a8)
{
  do
  {
    *result = a3;
...
double *sub_277559E88(double *result, uint64_t a2, double a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, double *a8)
{
  do
  {
    *result = a3;
...
__n128 *sub_277559EA4(__n128 *result, uint64_t a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, __n128 *a8)
{
  do
  {
    *result = a3;
...
uint64_t sub_277559EC0(uint64_t result, uint64_t a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, uint64_t a8)
{
...
uint64_t sub_277559EE0(uint64_t result, uint64_t a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, uint64_t a8)
{
  *&v8 = 0x8080808080808080;
  *(&v8 + 1) = 0x8080808080808080;
...
_DWORD *sub_277559F38(_DWORD *result, uint64_t a2, int *a3, uint64_t a4, int a5, uint64_t a6, _DWORD *a7)
{
  v7 = *a3;
  do
  {
...
void *sub_277559F58(void *result, uint64_t a2, uint64_t *a3, uint64_t a4, int a5, uint64_t a6, void *a7)
{
  v7 = *a3;
  do
  {
...
_OWORD *sub_277559F78(_OWORD *result, uint64_t a2, __int128 *a3, uint64_t a4, int a5, uint64_t a6, _OWORD *a7)
{
  v7 = *a3;
  do
  {
...
_OWORD *sub_277559F98(_OWORD *result, uint64_t a2, __int128 *a3, uint64_t a4, int a5, uint64_t a6, _OWORD *a7)
{
  v7 = *a3;
  v8 = a3[1];
  do
...
_OWORD *sub_277559FB8(_OWORD *result, uint64_t a2, __int128 *a3, uint64_t a4, int a5, uint64_t a6, _OWORD *a7)
{
  v7 = *a3;
  v8 = a3[1];
  v9 = a3[2];
...
_DWORD *sub_27755A00C(_DWORD *result, uint64_t a2, const char *a3, uint64_t a4, int a5, uint64_t a6, _DWORD *a7, uint64_t a8)
{
  do
  {
    v11 = vld4_dup_s8(a3);
...
int8x8_t *sub_27755A02C(int8x8_t *result, uint64_t a2, const char *a3, uint64_t a4, int a5, uint64_t a6, int8x8_t *a7, uint64_t a8)
{
  do
  {
    v11 = vld4_dup_s8(a3);
...
int8x16_t *sub_27755A04C(int8x16_t *result, uint64_t a2, const char *a3, uint64_t a4, int a5, uint64_t a6, int8x16_t *a7, uint64_t a8)
{
  do
  {
    v11 = vld4q_dup_s8(a3);
...
int8x16_t *sub_27755A06C(int8x16_t *result, uint64_t a2, const char *a3, uint64_t a4, int a5, uint64_t a6, int8x16_t *a7, uint64_t a8)
{
  do
  {
    v11 = vld4q_dup_s8(a3);
...
int8x16_t *sub_27755A09C(int8x16_t *result, uint64_t a2, const char *a3, uint64_t a4, int a5, uint64_t a6, int8x16_t *a7, uint64_t a8)
{
  do
  {
    v11 = vld4q_dup_s8(a3);
...
_DWORD *sub_27755A10C(_DWORD *result, uint64_t a2, const float *a3, int16x8_t a4, uint64_t a5, int a6, uint64_t a7, _DWORD *a8)
{
...
void *sub_27755A138(void *result, uint64_t a2, uint8x8_t *a3, int16x8_t a4, uint64_t a5, int a6, uint64_t a7, void *a8)
{
  *a4.i8 = *a3;
...
int8x16_t *sub_27755A164(int8x16_t *result, uint64_t a2, int16x8_t *a3, uint64_t a4, int a5, uint64_t a6, int8x16_t *a7)
{
  v7 = *a3;
...
int8x16_t *sub_27755A190(int8x16_t *result, uint64_t a2, uint8x16_t *a3, double a4, double a5, int16x8_t a6, uint64_t a7, int a8, uint64_t a9, int8x16_t *a10)
{
  v10 = *a3;
  v11 = a3[1];
...
int8x16_t *sub_27755A1C8(int8x16_t *result, uint64_t a2, uint8x16_t *a3, double a4, double a5, double a6, double a7, int16x8_t a8, uint64_t a9, int a10, uint64_t a11, int8x16_t *a12)
{
  v12 = *a3;
  v13 = a3[1];
  v14 = a3[2];
...
uint64_t sub_27755A258(int16x8_t a1, uint64_t a2, uint64_t a3, const float *a4, uint64_t (*a5)(uint64_t, uint64_t, __n128))
{
...
float *sub_27755A26C(float *result, uint64_t a2, float a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, float *a8)
{
  do
  {
    *result = a3;
...
uint64_t sub_27755A288(int16x8_t a1, uint64_t a2, uint64_t a3, uint8x8_t *a4, uint64_t (*a5)(uint64_t, uint64_t, __n128))
{
  *a1.i8 = *a4;
...
double *sub_27755A29C(double *result, uint64_t a2, double a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, double *a8)
{
  do
  {
    *result = a3;
...
uint64_t sub_27755A2B8(uint64_t a1, uint64_t a2, int16x8_t *a3, uint64_t (*a4)(uint64_t, uint64_t, __n128))
{
  v4 = *a3;
...
__n128 *sub_27755A2CC(__n128 *result, uint64_t a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, __n128 *a8)
{
  do
  {
    *result = a3;
...
uint64_t sub_27755A2E8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t (*a4)(uint64_t, uint64_t, __n128))
{
  v4 = *a3;
  v5 = *(a3 + 16);
  v4.i16[0] = vaddlvq_u8(*a3);
...
__n128 *sub_27755A304(__n128 *result, uint64_t a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, __n128 *a8)
{
  do
  {
    *result = a3;
...
uint64_t sub_27755A324(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t (*a4)(uint64_t, uint64_t, __n128))
{
  v4 = *a3;
  v5 = *(a3 + 16);
  v6 = *(a3 + 32);
...
__n128 *sub_27755A350(__n128 *result, uint64_t a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, __n128 *a8)
{
  do
  {
    *result = a3;
...
uint64_t sub_27755A3DC(uint64_t a1, uint64_t a2, char *a3, uint64_t (*a4)(uint64_t, uint64_t, char *, float))
{
  v4 = *a3;
...
unsigned __int32 *sub_27755A3F0(unsigned __int32 *result, uint64_t a2, unsigned int *a3, int16x4_t a4, uint64_t a5, int a6, uint64_t a7, unsigned __int32 *a8)
{
  v10 = *a3;
...
uint64_t sub_27755A448(uint64_t a1, uint64_t a2, uint8x8_t *a3, uint64_t (*a4)(uint64_t, uint64_t, __int8 *, float))
{
  v4 = *a3;
...
int8x8_t *sub_27755A458(int8x8_t *result, uint64_t a2, int16x4_t *a3, int16x4_t a4, uint64_t a5, int a6, uint64_t a7, int8x8_t *a8)
{
  v10 = *a3;
...
uint64_t sub_27755A4AC(uint64_t a1, uint64_t a2, uint8x16_t *a3, uint64_t (*a4)(uint64_t, uint64_t, __int8 *, float))
{
  v4 = *a3;
  v4.i16[0] = vaddlvq_u8(*a3);
...
int8x16_t *sub_27755A4BC(int8x16_t *result, uint64_t a2, uint8x16_t *a3, int16x4_t a4, uint64_t a5, int a6, uint64_t a7, int8x16_t *a8)
{
  v10 = *a3;
  v10.i16[0] = vaddlvq_u8(*a3);
...
uint64_t sub_27755A510(uint64_t a1, uint64_t a2, uint8x16_t *a3, uint64_t (*a4)(uint64_t, uint64_t, __int8 *, double))
{
  v4 = *a3;
  v5 = a3[1];
  v4.i16[0] = vaddlvq_u8(*a3);
...
int8x16_t *sub_27755A528(int8x16_t *result, uint64_t a2, uint8x16_t *a3, int16x4_t a4, uint64_t a5, int a6, uint64_t a7, int8x16_t *a8)
{
  v10 = *a3;
  v11 = a3[1];
  v10.i16[0] = vaddlvq_u8(*a3);
...
uint64_t sub_27755A588(uint64_t a1, uint64_t a2, uint8x16_t *a3, uint64_t (*a4)(uint64_t, uint64_t, __int8 *, double))
{
  v4 = *a3;
  v5 = a3[1];
  v6 = a3[2];
...
int8x16_t *sub_27755A5B0(int8x16_t *result, uint64_t a2, uint8x16_t *a3, int16x4_t a4, uint64_t a5, int a6, uint64_t a7, int8x16_t *a8)
{
  v10 = *a3;
  v11 = a3[1];
  v12 = a3[2];
...
_DWORD *sub_27755A668@<X0>(_DWORD *result@<X0>, uint64_t a2@<X1>, const char *a3@<X2>, int a4@<W4>, _DWORD *a5@<X6>, uint64_t a6@<X7>, const float *a7@<X8>, int64x2_t a8@<Q0>, int64x2_t a9@<Q2>, uint8x16_t a10@<Q4>)
{
...
void *sub_27755A6CC@<X0>(void *result@<X0>, uint64_t a2@<X1>, const char *a3@<X2>, int a4@<W4>, void *a5@<X6>, uint64_t a6@<X7>, const double *a7@<X8>, int64x2_t a8@<Q0>, int64x2_t a9@<Q1>, int64x2_t a10@<Q2>, int64x2_t a11@<Q3>, uint8x16_t a12@<Q4>)
{
...
int8x16_t *sub_27755A75C@<X0>(int8x16_t *result@<X0>, uint64_t a2@<X1>, const char *a3@<X2>, unsigned int a4@<W3>, int a5@<W4>, int8x16_t *a6@<X6>, uint64_t a7@<X7>, int8x16_t *a8@<X8>, uint8x16_t a9@<Q4>)
{
  v10 = *a8;
  v9 = a8 + 1;
  v11 = a4;
...
uint64_t sub_27755A898(__n128 a1, __n128 a2, __n128 a3, __n128 a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8, unsigned int a9)
{
  v9 = (a7 - a9);
  v10 = vld1q_dup_s8(v9);
  return ((&qword_27755AB00 - *(&qword_27755AB00 + __clz(a8) - 25)))(a1, a2, a3, a4, v10);
}

_DWORD *sub_27755A8D4@<X0>(_DWORD *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W4>, _DWORD *a5@<X6>, const float *a6@<X8>, uint8x8_t a7@<D4>)
{
  v9 = vld1_dup_f32(a6);
  v10 = vld1_dup_f32(v7);
  v11 = (a3 - 4);
...
int8x8_t *sub_27755A964@<X0>(int8x8_t *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W4>, int8x8_t *a5@<X6>, int8x8_t *a6@<X8>, uint8x8_t a7@<D4>)
{
  v9 = (a3 - 4);
...
int8x16_t *sub_27755AA24@<X0>(int8x16_t *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, unsigned int a4@<W3>, int a5@<W4>, int8x16_t *a6@<X6>, uint8x16_t *a7@<X8>, uint8x16_t a8@<Q4>)
{
  v10 = (a3 + a4);
  v11 = (a3 - 2);
...
uint64_t sub_27755AB0C(__n128 a1, __n128 a2, __n128 a3, __n128 a4, uint64_t a5, uint64_t a6, uint64_t a7, unsigned int a8, unsigned int a9)
{
  v9 = (a7 - a9);
  v10 = vld1q_dup_s8(v9);
  return ((&qword_27755ACD0 - *(&qword_27755ACD0 + __clz(a8) - 25)))(a1, a2, a3, a4, v10);
}

_DWORD *sub_27755AB44(_DWORD *result, uint64_t a2, const float *a3, double a4, double a5, double a6, double a7, uint8x8_t a8, uint64_t a9, int a10, uint64_t a11, _DWORD *a12, const char *a13)
{
  v13 = vld1_dup_f32(a3);
  v14 = vsubl_u8(v13, a8);
  do
...
int8x8_t *sub_27755AB94(int8x8_t *result, uint64_t a2, uint8x8_t *a3, double a4, double a5, double a6, double a7, uint8x8_t a8, uint64_t a9, int a10, uint64_t a11, int8x8_t *a12, const char *a13)
{
  v13 = vsubl_u8(*a3, a8);
  do
  {
...
int8x16_t *sub_27755ABFC(int8x16_t *result, uint64_t a2, uint8x16_t *a3, unsigned int a4, int a5, double a6, double a7, double a8, double a9, uint8x16_t a10, uint64_t a11, int8x16_t *a12, const char *a13)
{
  v13 = (result + a2);
  v14 = (a12 + a2);
  v15 = 2 * a2 - a4;
...
uint64_t sub_27755ACDC(__n128 a1, __n128 a2, __n128 a3, __n128 a4, __n128 a5, uint64_t a6, uint64_t a7, uint64_t a8, unsigned int a9)
{
  v9 = (a8 + a9);
  v10 = vld1q_dup_s8(v9);
  return ((&dword_27755AEB4 - *(&dword_27755AEB4 + __clz(a9) - 25)))(a1, a2, a3, a4, a5, v10);
}

_DWORD *sub_27755AD10@<X0>(_DWORD *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W4>, _DWORD *a5@<X6>, const float *a6@<X8>, int8x8_t a7@<D5>)
{
  v7 = vld1_dup_f32(a6);
  v8 = (a3 - 4);
  v9 = vmovl_u8(v7);
...
int8x8_t *sub_27755AD68@<X0>(int8x8_t *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W4>, int8x8_t *a5@<X6>, uint8x8_t *a6@<X8>, int8x8_t a7@<D5>)
{
  v7 = (a3 - 4);
  v8 = vmovl_u8(*a6);
  do
...
int8x16_t *sub_27755ADD8@<X0>(int8x16_t *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, unsigned int a4@<W3>, int a5@<W4>, int8x16_t *a6@<X6>, uint8x16_t *a7@<X8>, uint8x8_t a8@<D5>)
{
  v8 = (a3 - 4);
  v9 = (result + a2);
  v10 = (a6 + a2);
...
int8x16_t sub_27755AEC0(int8x16_t *a1, uint64_t a2, int8x16_t *a3, unsigned int a4)
{
  v4 = &a3->i8[a4];
  v5 = vld1q_dup_s8(v4);
  v6.i64[0] = 0x9000900090009;
  v6.i64[1] = 0x9000900090009;
  v7 = vbslq_s8(*(&unk_27A717028 - a4), v5, *a3);
...
int8x16_t sub_27755AF28(int8x16_t *a1, unsigned int a2, int8x16_t *a3)
{
  v3 = &a3->i8[a2];
  ...
  v6.i64[0] = 0x9000900090009;
  v6.i64[1] = 0x9000900090009;
  result = vbslq_s8(*(&unk_27A717028 - a2), v5, *a3);
...
int8x16_t *sub_27755AF84(int8x16_t *result, int a2, int8x16_t *a3, int a4, unsigned int a5)
{
  if (a5 == 3)
  {
    v22 = (a3 - 1);
  ...
  else
  {
    ...
    v18 = vbslq_s8(*(&unk_27A717028 - a4), v17, v7);
...
int8x16_t *sub_27755B170(int8x16_t *result, unsigned int a2, int a3)
{
  v3 = vdupq_n_s8(a2);
  do
  {
...
uint64_t sub_27755B184(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, uint64_t a6, unsigned int a7)
{
  v7 = (a3 + a7);
  vld1q_dup_s8(v7);
  return ((&dword_27755B3AC - *(&dword_27755B3AC + __clz(a4) - 25)))(a1, a2);
}

_DWORD *sub_27755B1AC(_DWORD *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5, int a6, int a7, unsigned int a8)
{
  while (1)
  {
    v9 = a8 >> 6;
...
int8x8_t *sub_27755B22C(int8x8_t *result, uint64_t a2, uint64_t a3, uint64_t a4, int a5, int a6, int a7, unsigned int a8)
{
  while (1)
  {
    v10 = a8 >> 6;
...
int8x16_t *sub_27755B2B4(int8x16_t *result, uint64_t a2, uint64_t a3, int a4, int a5, int a6, int a7, unsigned int a8)
{
  v10 = a4;
  v11 = (result + a2);
  v12 = 2 * a2 - a4;
...
int8x8_t *sub_27755B3B8(int8x8_t *result, uint64_t a2, uint64_t a3, int a4, int a5, unsigned int a6, signed int a7)
{
  v7 = (a3 + a7);
...
void *sub_27755B4E8(void *result, uint64_t a2, int a3)
{
  v3 = (a2 - 16);
  v4 = result + 1;
  do
...
_DWORD *sub_27755B544@<X0>(_DWORD *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, int a5@<W5>, int a6@<W6>, unsigned int a7@<W7>, signed int a8@<W8>, int64x2_t a9@<Q6>, int64x2_t a10@<Q7>)
{
...
void *sub_27755B664@<X0>(void *result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, int a5@<W5>, int a6@<W6>, unsigned int a7@<W7>, signed int a8@<W8>)
{
  v9 = vdupq_n_s16(a7);
...
int8x16_t *sub_27755B7A8@<X0>(int8x16_t *result@<X0>, uint64_t a2@<X1>, const char *a3@<X2>, uint64_t a4@<X3>, int a5@<W5>, int a6@<W6>, unsigned int a7@<W7>, signed int a8@<W8>)
{
  v12 = vdupq_n_s16(a7);
