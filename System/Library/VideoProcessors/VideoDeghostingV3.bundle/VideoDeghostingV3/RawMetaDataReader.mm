...
LABEL_18:
  ...
  if (!v13)
  {
    [(RawMetaDataReader *)self ExtractClippingInfoFromRawMetaData:a2];
LABEL_26:
    v15 = 0;
LABEL_29:
    free(v15);
...
- (BOOL)readIspScalerInfoFromSei:(id *)sei
{
  ...
  {
    [(RawMetaDataReader *)self readIspScalerInfoFromSei:a2];
  }
...
- (BOOL)readIspMappingInfoFromSei:(id *)sei
{
  if (!sei)
  {
    [(RawMetaDataReader *)self readIspMappingInfoFromSei:a2];
    return 0;
  }
...
- (BOOL)readIspOisInfoFromSei:(id *)sei
{
  if (!sei)
  {
    [(RawMetaDataReader *)self readIspOisInfoFromSei:a2];
    return 0;
  }
...
- (BOOL)readIspDistInfoFromSei:(id *)sei
{
  if (!sei)
  {
    [(RawMetaDataReader *)self readIspDistInfoFromSei:a2];
    return 0;
  }
...
- (BOOL)readIspExposureInfoFromSei:(id *)sei
{
  if (!sei)
  {
    [(RawMetaDataReader *)self readIspExposureInfoFromSei:a2];
    return 0;
  }
...
- (BOOL)readLtmInfoFromSei:(const __CFData *)sei
{
  ...
  {
    [(RawMetaDataReader *)self readLtmInfoFromSei:a2];
  }
...
- (BOOL)readIspConfigInfoFromSei:(id *)sei
{
  ...
  {
    [(RawMetaDataReader *)self readIspConfigInfoFromSei:a2];
  }
...
- (id)readMetaDataInfoFromSimulation:(id)simulation
{
  ...
  if (([v4 readIspScalerInfoFromSei:v34] & 1) == 0 || (v37 |= 1u, (objc_msgSend(v4, "readIspMappingInfoFromSei:", v34) & 1) == 0) || (v37 |= 1u, (objc_msgSend(v4, "readIspRegInfoFromSei:simMatrix:", v34, v6) & 1) == 0))
  {
    fig_log_get_emitter();
LABEL_30:
    FigDebugAssert3("%s assert: %s at %s (%s:%d) - %s%s(err=%d)", 0, v3, v27, v28, v29, v31, v32, LODWORD(v33[0]));
    v9 = 0;
    v7 = 0;
    v8 = 0;
    goto LABEL_22;
  ...
  v37 |= 0x20u;
  if (([v4 readIspOisInfoFromSei:v33] & 1) == 0)
  {
    fig_log_get_emitter();
    goto LABEL_30;
  }
  ...
  v37 |= 2u;
  if (([v4 readIspDistInfoFromSei:&v28] & 1) == 0 || (v37 |= 8u, (objc_msgSend(v4, "readIspExposureInfoFromSei:", &v35) & 1) == 0))
  {
    fig_log_get_emitter();
    goto LABEL_30;
  }
  ...
  v37 |= 4u;
  if (([v4 readLtmInfoFromSei:&v27] & 1) == 0)
  {
    fig_log_get_emitter();
    goto LABEL_30;
  }
  ...
  v13 = [v4[1] objectForKeyedSubscript:kFigCaptureStreamMetadata_ExposureTime];
  [v7 setObject:v13 forKeyedSubscript:v12];

  v14 = v4[1];
  v15 = kFigCaptureStreamMetadata_LuxLevel;
  v16 = [v14 objectForKeyedSubscript:kFigCaptureStreamMetadata_LuxLevel];
  [v7 setObject:v16 forKeyedSubscript:v15];

  v17 = &v33[WORD1(v33[0])];
  v18 = (v32 * 256.0);
  v19 = *v17 * 1000.0 / v18 + ((v31 - v28) / 1000000.0);
  v20 = v17[1] * 1000.0 / v18 + ((HIDWORD(v31) - HIDWORD(v28)) / 1000000.0);
  if (HIDWORD(v32))
  {
    v19 = v29 / 1000000.0;
    v20 = v30 / 1000000.0;
  ...
  v21 = v36 > 0xF09 || v29 != 0x7FFFFFFF;
  v22 = v36 > 0xF09 || v30 != 0x7FFFFFFF;
  if (v21)
  {
    v19 = ((v29 / 1000000.0) + v19) * 0.5;
  }

  v23 = ((v30 / 1000000.0) + v20) * 0.5;
  if (!v22)
  {
    v23 = v20;
  }
  ...
  {
    v25 = v27;
    [v7 setObject:v27 forKeyedSubscript:@"ClippingInfo"];
  }
...
+ (id)readMetaDataFromDictionary:(id)dictionary andValidWidth:(unint64_t)width andValidHeight:(unint64_t)height andLightSource:(opaqueCMSampleBuffer *)source andKeyPoints:(opaqueCMSampleBuffer *)points
{
  ...
  if (dictionaryCopy)
  {
    v36 = 0;
    v37 = 0;
    if ([RawMetaDataReader _getExposureInfo:dictionaryCopy info:v38])
    {
      LODWORD(v11) = v38[0];
      v12 = [NSNumber numberWithFloat:v11];
      [v34 setObject:v12 forKeyedSubscript:@"ExposureInfo"];
    }

    v13 = kFigCaptureStreamMetadata_ExposureTime;
    v32 = [v33 objectForKeyedSubscript:kFigCaptureStreamMetadata_ExposureTime];
    if (v32)
    {
      [v34 setObject:v32 forKeyedSubscript:v13];
    }

    v14 = [v33 objectForKeyedSubscript:kFigCaptureStreamMetadata_DistortionOpticalCenterV2];
    if (v14)
    {
      [v34 setObject:v14 forKeyedSubscript:@"OpticalCenter"];
    }

    v15 = kFigCaptureStreamMetadata_LuxLevel;
    v16 = [v33 objectForKeyedSubscript:kFigCaptureStreamMetadata_LuxLevel];
    if (v16)
    {
      [v34 setObject:v16 forKeyedSubscript:v15];
    }
    ...
    if (points)
    {
      ...
      if (v17)
      {
        ...
        if (Value)
        {
          v19 = [RawMetaDataReader _getRegistrationInfo:v33 validWidth:width validHeight:height keypointDictionary:Value ispInfo:v35];
          if ((v19 & [RawMetaDataReader _getKeypointsMappingInfoFrom:v33 validWidth:width validHeight:height KeyPointDictionary:Value IspInfo:v35]) == 1)
          {
            LODWORD(v37) = 1;
          }
        }
    ...
    if (v24 && [RawMetaDataReader _getLightSourceMappingInfoFrom:v33 imageValidWidth:width imageValidHeight:height lightSourceDictionary:v24 lightSourceValidWidth:Width lightSourceValidHeight:Height ispInfo:v35])
    {
      HIDWORD(v37) = 1;
    }

    HIDWORD(v36) = 1;
    v25 = [NSData dataWithBytes:&v36 length:16];
    if (v25)
    {
      [v34 setObject:v25 forKeyedSubscript:@"MetaConfig"];
      v26 = [NSData dataWithBytes:v35 length:576];
      if (v26)
      {
        [v34 setObject:v26 forKeyedSubscript:@"IspScalerInfo"];
        v27 = [v33 objectForKeyedSubscript:kFigCaptureStreamMetadata_ScalingFactor];
        if (v27)
        {
          [v34 setObject:v27 forKeyedSubscript:@"ScalingFactor"];
        }
        ...
        else
        {
          fig_log_get_emitter();
          LODWORD(v29) = 0;
          FigDebugAssert3("%s assert: %s at %s (%s:%d) - %s%s(err=%d)", v29, v7, v7, width, height, v32, v33, v34);
          v27 = 0;
        }
      }
...
LABEL_28:
  ...
  else
  {
    ...
    v16 = 0;
    v14 = 0;
    FigDebugAssert3("%s assert: %s at %s (%s:%d) - %s%s(err=%d)", 0, v7, v7, width, height, 0, 0, v34);
    v26 = 0;
    v25 = 0;
    v27 = 0;
  }
